...
haxwarn "║   https://github.com/haxtheweb/issues/issues                  ║"
haxecho "╟───────────────────────────────────────────────────────────────╢"
haxecho "║ ✻NOTES✻                                                       ║"
...
haxecho "╚✻✻✻✻✻✻✻✻✻✻✻✻✻✻✻✻✻✻✻✻✻✻✻✻✻✻✻✻✻✻✻✻✻✻✻✻✻✻✻✻✻✻✻✻✻✻✻✻✻✻✻✻✻✻✻✻✻✻✻✻✻✻✻╝"
# Community outro — mirrors the `create` CLI communityStatement so every HAX
# surface ends on the same Merlin voice (issue haxtheweb/issues#2973).
haxecho ""
haxecho "🧙  HAX @ Penn State: https://hax.psu.edu"
haxecho "🔮  Ideas to HAX Harder, Better, Faster, Stronger: https://github.com/haxtheweb/issues/issues"
haxecho "👔  Share on LinkedIn: https://bit.ly/hax-the-linkedin"
haxecho "🧵  Tweet on X: https://bit.ly/hax-the-x"
haxecho "💬  Join Community: https://discord.gg/EKYJAjqGhf"
haxecho "💡  Never. Stop. Innovating."
