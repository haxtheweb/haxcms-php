 ...
 */
function haxcmsSystemSimpleHtmlToElements($html)
{
    $elements = array();
    $dom = new DOMDocument();
 ...
 */
function haxcmsSystemCollectSiblingsUntil($elements, $startIndex, $stopTags)
{
    $siblings = array();
 ...
 */
function haxcmsSystemGetFallbackContent($type)
{
    switch ($type) {
        case 'portfolio':
...
return function ($context) {
    ...
    $elements = haxcmsSystemSimpleHtmlToElements($html);
    $items = array();
        ...
        case 'site': {
            ...
            if (count($h1s) === 0) {
                ...
                foreach ($h1s as $h1Data) {
                    ...
                    $h1Siblings = haxcmsSystemCollectSiblingsUntil($elements, $idx, array('H1'));
                    $h1Contents = '';
                    $h2 = null;
                    $h2StartIdx = null;
                    ...
                    $h1Item = $buildItem($h1Title, $h1Slug, $h1Order, $parentId, 0, $h1Contents !== '' ? $h1Contents : haxcmsSystemGetFallbackContent($type));
                    $items[] = $h1Item;
                    $h1Order += 1;
                    ...
                    if ($h2 !== null) {
                        ...
                        while ($currentH2Idx < count($elements)) {
                            ...
                            $h2Siblings = haxcmsSystemCollectSiblingsUntil($elements, $currentH2Idx, array('H1', 'H2'));
                            $h2Contents = '';
        ...
        case 'branch': {
            ...
            if (count($h1s) === 0) {
                ...
                foreach ($h1s as $h1Data) {
                    ...
                    $h1Item = $buildItem($h1Title, $h1Slug, $order, $parentId, 0, $h1Contents !== '' ? $h1Contents : haxcmsSystemGetFallbackContent($type));
                    $items[] = $h1Item;
                    $order += 1;
                }
            }
