 ...
 */
function haxcmsSystemGetHighestHeadingLevel($elements)
{
...
return function ($context) {
            ...
            if ($xmlIndex !== false) {
                ...
                if ($xmlString !== false) {
                    $mediaMap = function_exists('haxcmsImportLoadDocxMediaMapFromZip')
                        ...
                        : array();
                    $html = haxcmsSystemConvertDocxXmlToHtml($xmlString, $mediaMap);
                } else {
    ...
    switch ($method) {
        case 'site': {
            $highestLevel = haxcmsSystemGetHighestHeadingLevel($elements);
