import{html,Polymer}from"../../../@polymer/polymer/polymer-legacy.js";import"../../../@polymer/paper-slider/paper-slider.js";import"../../../@polymer/paper-tooltip/paper-tooltip.js";import"../../../@polymer/paper-item/paper-item.js";import"../../../@polymer/iron-icons/iron-icons.js";import"../../../@polymer/iron-icons/editor-icons.js";import"../../materializecss-styles/lib/colors.js";import"../../simple-colors/simple-colors.js";import"./hax-toolbar-item.js";import"./hax-toolbar-menu.js";import"./hax-context-item.js";import"./hax-context-item-menu.js";Polymer({_template:html`
  ...
  `,is:"hax-toolbar",listeners:{"hax-context-item-selected":"_haxContextOperation"},properties:{hideTransform:{type:Boolean,value:!1},selected:{type:Boolean,value:!1,reflectToAttritue:!0},haxProperties:{type:Object,value:{},observer:"_haxPropertiesChanged"},hideMore:{type:Boolean,value:!1},size:{type:Number,value:100,notify:!0},justifyIcon:{type:String,value:"editor:format-align-left"},inline:{type:Boolean,value:!1,reflectToAttritue:!0},justifyValue:{type:String,value:"",notify:!0}},_haxPropertiesChanged:function(){if(typeof window.HaxStore.instance.activeNode!==typeof void 0){if(""!=window.HaxStore.instance.activeNode.style.width){this.size=window.HaxStore.instance.activeNode.style.width.replace("%","")}else{this.size=100}if("right"==window.HaxStore.instance.activeNode.style.float){this.justifyValue="hax-align-right";this.justifyIcon="editor:format-align-right"}else if("0px auto"==window.HaxStore.instance.activeNode.style.margin&&"block"==window.HaxStore.instance.activeNode.style.display){this.justifyValue="hax-align-center";this.justifyIcon="editor:format-align-center"}else{this.justifyValue="hax-align-left";this.justifyIcon="editor:format-align-left"}}},_haxContextOperation:function(e){let detail=e.detail;switch(detail.eventName){case"hax-align-left":case"hax-align-center":case"hax-align-right":this.justifyIcon=detail.target.icon;break;case"close-menu":this.$.moremenu.$.menu.hideMenu();this.$.justify.$.menu.hideMenu();break;}}});