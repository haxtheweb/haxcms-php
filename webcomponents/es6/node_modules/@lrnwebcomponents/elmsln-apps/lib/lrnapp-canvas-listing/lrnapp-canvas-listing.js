import{html,Polymer}from"../../../../@polymer/polymer/polymer-legacy.js";import{dom}from"../../../../@polymer/polymer/lib/legacy/polymer.dom.js";import"../../../../@vaadin/vaadin-grid/vaadin-grid.js";import"../../../../@vaadin/vaadin-grid/vaadin-grid.js";import"../../../../@vaadin/vaadin-grid/vaadin-grid-column-group.js";import"../../../../@vaadin/vaadin-grid/vaadin-grid-filter.js";import"../../../../@vaadin/vaadin-grid/vaadin-grid-sorter.js";import"../../../../@vaadin/vaadin-grid/vaadin-grid-selection-column.js";import"../../../../@polymer/iron-ajax/iron-ajax.js";import"../../../../@polymer/iron-image/iron-image.js";import"../../../../@polymer/paper-tooltip/paper-tooltip.js";import"../../../lrnsys-layout/lib/lrnsys-dialog.js";import"../../../elmsln-loading/elmsln-loading.js";import"../../../lrndesign-avatar/lrndesign-avatar.js";Polymer({_template:html`
    <custom-style>
  ...
  `,is:"lrnapp-canvas-listing",properties:{elmslnCourses:{type:Array,notify:!0},canvasCourses:{type:Array,notify:!0},roster:{type:Array,notify:!0,value:!1},queryResponse:{type:Array,notify:!0},sourcePath:{type:String,notify:!0},activeCourse:{type:String,notify:!0,reflectToAttribute:!0}},_toArray:function(obj){return Object.keys(obj).map(function(key){return obj[key]})},collapseToggle:function(e){e.target.nextElementSibling.toggle()},_triggerDialog:function(e){let root=this;root.shadowRoot.querySelector("#details-dialog").toggleDialog();root.roster=!1;root.activeCourse=root.canvasCourses[e.target.id];root.shadowRoot.querySelector("#request").params.sis_course_id=root.activeCourse.sis_course_id;root.shadowRoot.querySelector("#request").generateRequest();root.shadowRoot.querySelector("#loadingContent").style.display="none"},handleResponse:function(){let root=this;root.elmslnCourses=root.queryResponse.data.elmslnCourses;root.canvasCourses=root.queryResponse.data.canvasCourses;root.$.loading.hidden=!0},handleRosterResponse:function(){let root=this;root.roster=root.queryResponse.data;root.shadowRoot.querySelector("#loadingContent").style.display="block"}});