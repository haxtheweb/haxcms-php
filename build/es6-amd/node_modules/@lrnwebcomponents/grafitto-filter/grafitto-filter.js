...
*/let GrafittoFilter=(0,_polymerLegacy.Polymer)({_template:_polymerLegacy.html`
    <div id="dom"><slot></slot></div>
  `,is:"grafitto-filter",behaviors:[_templatizerBehavior.Templatizer,_mutableDataBehavior.OptionalMutableDataBehavior],properties:{/**
...
(0,_polymerDom.dom)(this).appendChild(this.__clone.root)},/**
   ...
   *
   * @event filter
   */_onFilter:function(){this.fire("filter")}});_exports.GrafittoFilter=GrafittoFilter});