...
*/let FancyCarousel=(0,_polymerLegacy.Polymer)({_template:_polymerLegacy.html`
   ...
   */next:function(){var elem=this._getNextElement();if(elem&&!this._touchDir){this._startTransition(1,this.selected,elem)}}});_exports.FancyCarousel=FancyCarousel});