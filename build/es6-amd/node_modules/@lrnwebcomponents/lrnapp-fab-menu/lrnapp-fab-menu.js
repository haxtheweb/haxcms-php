define(["exports","require","../../@polymer/polymer/polymer-element.js","../simple-colors/simple-colors.js"],function(_exports,_require,_polymerElement,_simpleColors){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.LrnappFabMenu=void 0;_require=babelHelpers.interopRequireWildcard(_require);/**
 ...
 */class LrnappFabMenu extends _polymerElement.PolymerElement{constructor(){super();new Promise((res,rej)=>_require.default(["../../@polymer/paper-fab/paper-fab.js"],res,rej));new Promise((res,rej)=>_require.default(["../paper-fab-speed-dial/paper-fab-speed-dial.js"],res,rej));new Promise((res,rej)=>_require.default(["../paper-fab-speed-dial/lib/paper-fab-speed-dial-overlay.js"],res,rej))}static get template(){return _polymerElement.html`
