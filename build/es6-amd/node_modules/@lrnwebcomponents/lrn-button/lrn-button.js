 ...
 */class LrnButton extends _polymerElement.PolymerElement{// render function
...
static get properties(){return{/**
   ...
   */static get tag(){return"lrn-button"}constructor(){super();new Promise((res,rej)=>_require.default(["@polymer/paper-button/paper-button.js"],res,rej));new Promise((res,rej)=>_require.default(["@polymer/paper-tooltip/paper-tooltip.js"],res,rej))}/**
   * life cycle, element is afixed to the DOM
   */connectedCallback(){super.connectedCallback();(0,_renderStatus.afterNextRender)(this,function(){this.addEventListener("mousedown",this.tapEventOn);this.addEventListener("mouseover",this.tapEventOn);this.addEventListener("mouseout",this.tapEventOff);this.$.button.addEventListener("focused-changed",this.focusToggle)})}/**
