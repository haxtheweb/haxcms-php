 ...
 */let ItemOverlayOps=(0,_polymerLegacy.Polymer)({_template:_polymerLegacy.html`
    <style>
      :host {
        display: block;
        outline: none;
...
setTimeout(()=>{this._windowResize()},5);window.addEventListener("resize",this._windowResize.bind(this))},/**
   ...
   */_opTap:function(e){let normalizedEvent=(0,_polymerDom.dom)(e),local=normalizedEvent.localTarget;this.activeTitle=local.getAttribute("id");this.activeOp=local.getAttribute("id");this._resetActive();this.__anyOp=!0;local.classList.add("active");// we switch icons for these
...
let op={element:this,operation:this.activeOp};this.fire("item-overlay-op-changed",op)},/**
   ...
   */_optionSelected:function(e){let normalizedEvent=(0,_polymerDom.dom)(e),local=normalizedEvent.localTarget,ops={element:this,operation:this.activeOp,option:local.getAttribute("id")};this.fire("item-overlay-option-selected",ops);// don't reset for movement, just confirm / reject actions
if("move"!=this.activeOp){this._resetActive();this.activeOp=null}},/**
   * Reset the active selections
   */_resetActive:function(){this.$.add.classList.remove("active");this.$.edit.classList.remove("active");this.$.move.classList.remove("active");this.$.remove.classList.remove("active");this.$.duplicate.classList.remove("active")}});_exports.ItemOverlayOps=ItemOverlayOps});