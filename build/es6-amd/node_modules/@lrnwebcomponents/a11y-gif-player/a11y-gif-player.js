define(["exports","require","../../lit-element/lit-element.js","../schema-behaviors/schema-behaviors.js","../../@polymer/paper-tooltip/paper-tooltip.js"],function(_exports,_require,_litElement,_schemaBehaviors,_paperTooltip){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.A11yGifPlayer=void 0,_require=babelHelpers.interopRequireWildcard(_require);class A11yGifPlayer extends((0,_schemaBehaviors.SchemaBehaviors)(_litElement.LitElement)){constructor(){super(),this.alt=null,this.disabled=!1,this.src=null,this.tooltip="Toggle Animation",this.tooltipPlaying=null,this.srcWithoutAnimation=null,this.__playing=!1,new Promise((res,rej)=>_require.default(["../../@polymer/iron-image/iron-image.js"],res,rej))}static get styles(){return[_litElement.css`
        :host {
          display: inline-flex;
        }
        :host([hidden]) {
