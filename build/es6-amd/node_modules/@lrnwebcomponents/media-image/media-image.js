define(["exports","require","../../@polymer/polymer/polymer-element.js","../../@polymer/polymer/lib/utils/render-status.js","../hax-body-behaviors/lib/HAXWiring.js","../schema-behaviors/schema-behaviors.js"],function(_exports,_require,_polymerElement,_renderStatus,_HAXWiring,_schemaBehaviors){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.MediaImage=void 0,_require=babelHelpers.interopRequireWildcard(_require);class MediaImage extends((0,_schemaBehaviors.SchemaBehaviors)(_polymerElement.PolymerElement)){constructor(){super(),new Promise((res,rej)=>_require.default(["@polymer/iron-image/iron-image.js"],res,rej)),new Promise((res,rej)=>_require.default(["@polymer/iron-icons/iron-icons.js"],res,rej)),(0,_renderStatus.afterNextRender)(this,function(){this.HAXWiring=new _HAXWiring.HAXWiring,this.HAXWiring.setup(MediaImage.haxProperties,MediaImage.tag,this)})}static get template(){return _polymerElement.html`
      <style>
        :host {
          display: block;
