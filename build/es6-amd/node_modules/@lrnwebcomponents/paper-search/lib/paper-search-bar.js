define(["../../../@polymer/polymer/polymer-legacy.js","../../../@polymer/iron-a11y-keys-behavior/iron-a11y-keys-behavior.js"],function(_polymerLegacy,_ironA11yKeysBehavior){"use strict";(0,_polymerLegacy.Polymer)({is:"paper-search-bar",/**
   ...
   */properties:{/**
     ...
     */query:{type:String,notify:!0/* transition */ /* transition */,value:""},/**
     ...
     */placeholder:{type:String,value:"Search"}},behaviors:[_ironA11yKeysBehavior.IronA11yKeysBehavior],keyBindings:{enter:"_search"},focus:function(){this.$.input.focus()},// Private methods
_filter:function(e){this.fire("paper-search-filter")},_clear:function(){this.query="";this.$.input.focus();this.fire("paper-search-clear")},_search:function(){this.fire("paper-search-search")}})});