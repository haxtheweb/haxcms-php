define(["exports","require","../../@polymer/polymer/polymer-element.js","../../@polymer/polymer/lib/utils/render-status.js","../../@polymer/polymer/lib/elements/dom-repeat.js","../../@polymer/polymer/lib/elements/dom-if.js","../schema-behaviors/schema-behaviors.js","../hax-body-behaviors/lib/HAXWiring.js","../../@polymer/paper-toast/paper-toast.js","../simple-colors/simple-colors.js"],function(_exports,_require,_polymerElement,_renderStatus,_domRepeat,_domIf,_schemaBehaviors,_HAXWiring,_paperToast,_simpleColors){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.MultipleChoice=void 0,_require=babelHelpers.interopRequireWildcard(_require);class MultipleChoice extends((0,_schemaBehaviors.SchemaBehaviors)(_polymerElement.PolymerElement)){static get tag(){return"multiple-choice"}constructor(){super(),new Promise((res,rej)=>_require.default(["@polymer/iron-icons/iron-icons.js"],res,rej)),new Promise((res,rej)=>_require.default(["@polymer/iron-icon/iron-icon.js"],res,rej)),new Promise((res,rej)=>_require.default(["@polymer/paper-button/paper-button.js"],res,rej))}static get template(){return _polymerElement.html`
