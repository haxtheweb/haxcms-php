define(["exports","require","../../lit-element/lit-element.js","../schema-behaviors/schema-behaviors.js","../simple-colors/simple-colors.js"],(function(e,t,o,r,s){"use strict";Object.defineProperty(e,"__esModule",{value:!0}),e.MultipleChoice=void 0,t=babelHelpers.interopRequireWildcard(t);class MultipleChoice extends((0,r.SchemaBehaviors)(s.SimpleColors)){static get styles(){return[...super.styles,o.css`
        :host {
          display: block;
      ...
      `]}static get tag(){return"multiple-choice"}constructor(){super(),new Promise((e,o)=>t.default(["../../@polymer/paper-toast/paper-toast.js"],e,o)),new Promise((e,o)=>t.default(["../../@polymer/iron-icons/iron-icons.js"],e,o)),new Promise((e,o)=>t.default(["../../@polymer/iron-icon/iron-icon.js"],e,o)),new Promise((e,o)=>t.default(["../../@polymer/paper-button/paper-button.js"],e,o)),this.randomize=!1,this.hideButtons=!1,this.title="",this.disabled=!1,this.singleOption=!1,this.checkLabel="Check answer",this.resetLabel="Reset",this.hideTitle=!1,this.question="",this.answers=[],this.displayedAnswers=[],this.correctText="Great job!",this.correctIcon="icons:thumb-up",this.incorrectText="Better luck next time!",this.incorrectIcon="icons:thumb-down",this.quizName="default"}updated(e){super.updated&&super.updated(e),e.forEach((e,t)=>{if(["answers","displayedAnswers"].includes(t)){let e=`${t.replace(/([a-z0-9]|(?=[A-Z]))([A-Z])/g,"$1-$2").toLowerCase()}-changed`;this.dispatchEvent(new CustomEvent(e,{detail:{value:this[t]}}))}["answers","randomize"].includes(t)&&(this.displayedAnswers=[...this._computeDisplayedAnswers(this.answers,this.randomize)]),"singleOption"==t&&this.singleOptionChanged(this[t])})}singleOptionChanged(e){e?(new Promise((e,o)=>t.default(["../../@polymer/paper-radio-group/paper-radio-group.js"],e,o)),new Promise((e,o)=>t.default(["../../@polymer/paper-radio-button/paper-radio-button.js"],e,o))):new Promise((e,o)=>t.default(["../../@polymer/paper-checkbox/paper-checkbox.js"],e,o))}render(){return o.html`
      <meta property="oer:assessing" content="${this.relatedResource}" />
      ${this.hideTitle?"":o.html`
            <h3><span property="oer:name">${this.title}</span></h3>
          `}
      <div>${this.question}</div>
      ${this.singleOption?o.html`
            <paper-radio-group>
              ${this.displayedAnswers.map((e,t)=>o.html`
                  <paper-radio-button
