...
}showDataFunction(e){var eventData=e.detail,db=new PouchDB(eventData.dbType),remoteCouch=!1;///var remoteCouch = 'http://35.164.8.64:3000/todos';
...
/**
   ...
   */disconnectedCallback(){window.removeEventListener("user-engagement",this.userEngagmentFunction.bind(this));window.removeEventListener("show-data",this.showDataFunction.bind(this));super.disconnectedCallback()}}_exports.PouchDb=PouchDb;window.customElements.define(PouchDb.tag,PouchDb)});