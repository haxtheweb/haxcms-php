define(["exports","meta","require","../../@polymer/polymer/polymer-element.js","../../@polymer/polymer/lib/utils/render-status.js","../es-global-bridge/es-global-bridge.js","../../@polymer/polymer/lib/elements/dom-if.js"],function(_exports,meta,_require,_polymerElement,_renderStatus,_esGlobalBridge,_domIf){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.ImgPanZoom=void 0,meta=babelHelpers.interopRequireWildcard(meta),_require=babelHelpers.interopRequireWildcard(_require);class ImgPanZoom extends _polymerElement.PolymerElement{static get template(){return _polymerElement.html`
      <style>
        :host {
          display: block;
          position: relative;
