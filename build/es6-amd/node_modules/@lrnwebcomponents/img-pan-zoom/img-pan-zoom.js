define(["exports","meta","../../@polymer/polymer/polymer-legacy.js","../../@polymer/polymer/lib/utils/resolve-url.js","../es-global-bridge/es-global-bridge.js","./lib/img-loader.js"],function(_exports,meta,_polymerLegacy,_resolveUrl,_esGlobalBridge,_imgLoader){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.ImgPanZoom=void 0;meta=babelHelpers.interopRequireWildcard(meta);/**
...
*/let ImgPanZoom=(0,_polymerLegacy.Polymer)({_template:_polymerLegacy.html`
    <style>
      :host {
        display: block;
        position: relative;
...
_loadedChanged:function(){if(this.loaded){if(!this.init){this._initOpenSeadragon()}else{this._addImage()}}},_addImage:function(){this.viewer.addSimpleImage({url:this.src,index:0,replace:!0})},_addTiledImage:function(){this.viewer.addTiledImage({tileSource:this.src,index:0,replace:!0})}});_exports.ImgPanZoom=ImgPanZoom});