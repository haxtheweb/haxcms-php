define(["exports","../../@polymer/polymer/polymer-legacy.js","../materializecss-styles/materializecss-styles.js","../hax-body-behaviors/lib/HAXWiring.js","../schema-behaviors/schema-behaviors.js","../web-map/web-map.js"],function(_exports,_polymerLegacy,_materializecssStyles,_HAXWiring,_schemaBehaviors,_webMap){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.MapElement=void 0;/**
 ...
 */let MapElement=(0,_polymerLegacy.Polymer)({_template:_polymerLegacy.html`
    <style>
      :host {
        display: block;
      }
  ...
  `,is:"map-element",behaviors:[HAXBehaviors.PropertiesBehaviors,MaterializeCSSBehaviors.ColorBehaviors,SchemaBehaviors.Schema],properties:{/**
     * Title
     */title:{type:String}},/**
