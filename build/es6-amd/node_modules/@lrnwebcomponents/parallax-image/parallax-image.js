define(["exports","../../@polymer/polymer/polymer-legacy.js","../materializecss-styles/materializecss-styles.js","../hax-body-behaviors/lib/HAXWiring.js","../schema-behaviors/schema-behaviors.js"],function(_exports,_polymerLegacy,_materializecssStyles,_HAXWiring,_schemaBehaviors){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.ParallaxImage=void 0;/**
`parallax-image`
A LRN element
...
*/let ParallaxImage=(0,_polymerLegacy.Polymer)({_template:_polymerLegacy.html`
    <style>
      :host {
        display: block;
  ...
  `,is:"parallax-image",behaviors:[HAXBehaviors.PropertiesBehaviors,MaterializeCSSBehaviors.ColorBehaviors,SchemaBehaviors.Schema],properties:{/**
     * Image
