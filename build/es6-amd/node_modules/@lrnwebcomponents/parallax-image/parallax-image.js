define(["exports","../../@polymer/polymer/polymer-element.js","../../@polymer/polymer/lib/utils/render-status.js","../hax-body-behaviors/lib/HAXWiring.js","../schema-behaviors/schema-behaviors.js"],function(_exports,_polymerElement,_renderStatus,_HAXWiring,_schemaBehaviors){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.ParallaxImage=void 0;/**
 * `parallax-image`
 * @demo demo/index.html
 */class ParallaxImage extends(0,_schemaBehaviors.SchemaBehaviors)(_polymerElement.PolymerElement){constructor(){super();(0,_renderStatus.afterNextRender)(this,function(){this.HAXWiring=new _HAXWiring.HAXWiring;this.HAXWiring.setup(ParallaxImage.haxProperties,ParallaxImage.tag,this)})}static get template(){return _polymerElement.html`
    <style>
      :host {
        display: block;
    ...
    </a>`}static get tag(){return"parallax-image"}static get properties(){let props={/**
       * Image
