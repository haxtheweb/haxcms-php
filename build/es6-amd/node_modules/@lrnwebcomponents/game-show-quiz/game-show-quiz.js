define(["exports", "require", "../../@polymer/polymer/polymer-element.js", "../../@polymer/polymer/lib/mixins/mutable-data.js", "../../@polymer/polymer/lib/utils/render-status.js", "../../@polymer/polymer/lib/legacy/polymer.dom.js", "../hax-body-behaviors/lib/HAXWiring.js", "../hax-body/lib/haxutils.js", "../../@polymer/paper-button/paper-button.js", "../simple-toast/simple-toast.js", "../../@polymer/iron-ajax/iron-ajax.js", "../simple-colors/simple-colors.js", "../../@vaadin/vaadin-split-layout/vaadin-split-layout.js", "../multiple-choice/multiple-choice.js", "./lib/game-show-quiz-modal.js"], function (_exports, _require, _polymerElement, _mutableData, _renderStatus, _polymerDom, _HAXWiring, _haxutils, _paperButton, _simpleToast, _ironAjax, _simpleColors, _vaadinSplitLayout, _multipleChoice, _gameShowQuizModal) {
  ...
  class GameShowQuiz extends (0, _mutableData.MutableData)(_polymerElement.PolymerElement) {
    ...
    constructor() {
      ...
      new Promise((res, rej) => _require.default(["@lrnwebcomponents/responsive-grid/lib/responsive-grid-row.js"], res, rej));
      new Promise((res, rej) => _require.default(["@lrnwebcomponents/responsive-grid/lib/responsive-grid-col.js"], res, rej));
      ...
      new Promise((res, rej) => _require.default(["@lrnwebcomponents/chartist-render/chartist-render.js"], res, rej));
    }
    ...
    continueGameTap(e) {
      ...
      // logically
      if (typeof this.__activeTap !== typeof undefined && (0, _polymerDom.dom)(this.__activeTap).parentNode.nextElementSibling.firstElementChild != null) {
      ...
      if (this.remainingAttempts <= 0) {
        ...
        if (this.shadowRoot.querySelectorAll("responsive-grid-col paper-button[data-is-bonus]:not([disabled])").length === 0) {
          ...
          if (this.gameScoreBoardBackend) {
            this.$.gamebackend.url = `${this.gameScoreBoardBackend}/${this.title}/${this.points.total.earned}?token=${this.token}`;
