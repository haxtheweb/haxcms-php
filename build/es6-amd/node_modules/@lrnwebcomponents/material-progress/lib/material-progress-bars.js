define(["exports","../../../@polymer/polymer/polymer-element.js","../../../@polymer/polymer/lib/legacy/class.js","./material-progress-behavior.js"],function(_exports,_polymerElement,_class,_materialProgressBehavior){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.MaterialProgressBars=void 0;class MaterialProgressBars extends(0,_class.mixinBehaviors)([_materialProgressBehavior.MaterialProgressBehavior],_polymerElement.PolymerElement){static get template(){return _polymerElement.html`
    <style>
      #barsContainer {
        overflow: hidden;
    ...
    </div>`}static get tag(){return"material-progress-bars"}static get properties(){return{/**
