define(["../../../@polymer/polymer/polymer-legacy.js","./material-progress-behavior.js"],function(_polymerLegacy,_materialProgressBehavior){"use strict";var $_documentContainer=document.createElement("div");$_documentContainer.setAttribute("style","display: none;");$_documentContainer.innerHTML=`<dom-module id="material-progress-bars">
  ...
  <template>
     ...
     */max:{type:Number,value:100,observer:"_refresh"}},_getWidthForBar:function(barValue,barValuesSum,maxBarValue,barHeight){var realMax=Math.max(barValuesSum,this.max),width=(0<realMax?Math.floor(1e4*(barValue/realMax))/100:"0")+"%",negativeMargin=barHeight/2;return"calc("+width+" + "+negativeMargin+"px"+")"}})});