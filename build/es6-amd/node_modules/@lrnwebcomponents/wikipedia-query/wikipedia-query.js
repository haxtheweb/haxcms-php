define(["exports","../../@polymer/polymer/polymer-element.js","../../@polymer/iron-ajax/iron-ajax.js","../hax-body-behaviors/lib/HAXWiring.js","../citation-element/citation-element.js"],function(_exports,_polymerElement,_ironAjax,_HAXWiring,_citationElement){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.WikipediaQuery=void 0;/**
 * `wikipedia-query`
 * `Query and present information from wikipedia.`
 *
 * @demo demo/index.html
 */class WikipediaQuery extends _polymerElement.PolymerElement{/**
...
this.$.result.innerHTML=html}}}}_exports.WikipediaQuery=WikipediaQuery;window.customElements.define(WikipediaQuery.tag,WikipediaQuery)});