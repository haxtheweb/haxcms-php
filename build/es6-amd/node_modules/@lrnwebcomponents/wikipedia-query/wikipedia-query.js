define(["exports","require","../../@polymer/polymer/polymer-element.js","../../@polymer/polymer/lib/utils/render-status.js","../hax-body-behaviors/lib/HAXWiring.js","../../@polymer/iron-ajax/iron-ajax.js"],function(_exports,_require,_polymerElement,_renderStatus,_HAXWiring,_ironAjax){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.WikipediaQuery=void 0,_require=babelHelpers.interopRequireWildcard(_require);class WikipediaQuery extends _polymerElement.PolymerElement{constructor(){super(),new Promise((res,rej)=>_require.default(["@lrnwebcomponents/citation-element/citation-element.js"],res,rej)),(0,_renderStatus.afterNextRender)(this,function(){this.HAXWiring=new _HAXWiring.HAXWiring,this.HAXWiring.setup(WikipediaQuery.haxProperties,WikipediaQuery.tag,this)})}static get tag(){return"wikipedia-query"}static get template(){return _polymerElement.html`
      <style>
        :host {
          display: block;
