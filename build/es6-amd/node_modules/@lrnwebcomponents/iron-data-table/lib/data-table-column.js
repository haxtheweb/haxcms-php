define(["../../../@polymer/polymer/polymer-legacy.js","../../../@polymer/polymer/lib/legacy/polymer.dom.js","./data-table-column-filter.js"],function(_polymerLegacy,_polymerDom,_dataTableColumnFilter){"use strict";(0,_polymerLegacy.Polymer)({_template:_polymerLegacy.html`
    <template id="header">
  ...
  `,is:"data-table-column",properties:{/**
     ...
     */headerTemplate:{type:Object,readOnly:!0,value:function(){var custom=(0,_polymerDom.dom)(this).querySelector("template[is=header]");if(custom&&custom.parentElement){// set dataHost to the context where template has been defined
var column=custom.parentElement;custom._rootDataHost=column.dataHost._rootDataHost||column.dataHost;return custom}return(0,_polymerDom.dom)(this.root).querySelector("#header")}},/**
     ...
     */template:{type:Object,readOnly:!0,value:function(){var template=(0,_polymerDom.dom)(this).querySelector("template:not([is=header])");if(template){if(this.dataHost){// set dataHost to the context where template has been defined
