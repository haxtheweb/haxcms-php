...
</dom-module>`;document.head.appendChild($_documentContainer);(0,_polymerLegacy.Polymer)({is:"data-table-column-filter",properties:{label:String,value:{type:String,notify:!0/* transition */ /* transition */},hidden:Boolean},_valueChanged:function(e){// store value in a variable, referring to e.detail.value inside the debounce
