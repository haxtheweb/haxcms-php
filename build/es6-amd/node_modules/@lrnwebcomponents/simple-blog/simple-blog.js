define(["exports", "require", "../../@polymer/polymer/polymer-element.js", "../haxcms-elements/lib/core/HAXCMSThemeWiring.js", "../haxcms-elements/lib/core/haxcms-site-store.js", "../../mobx/lib/mobx.module.js", "../../@polymer/polymer/lib/utils/render-status.js", "../simple-colors/simple-colors.js", "./lib/simple-blog-listing.js", "./lib/simple-blog-post.js", "../../@polymer/iron-pages/iron-pages.js"], function (_exports, _require, _polymerElement, _HAXCMSThemeWiring, _haxcmsSiteStore, _mobxModule, _renderStatus, _simpleColors, _simpleBlogListing, _simpleBlogPost, _ironPages) {
  ...
  class SimpleBlog extends (0, _HAXCMSThemeWiring.HAXCMSTheme)(_polymerElement.PolymerElement) {
    ...
    constructor() {
      super();
      new Promise((res, rej) => _require.default(["@lrnwebcomponents/simple-blog/lib/simple-blog-header.js"], res, rej));
      new Promise((res, rej) => _require.default(["@polymer/paper-icon-button/paper-icon-button.js"], res, rej));
      new Promise((res, rej) => _require.default(["@lrnwebcomponents/simple-blog/lib/simple-blog-footer.js"], res, rej));
      this.__disposer = [];
      ...
      (0, _mobxModule.autorun)(reaction => {
        this._locationChanged(_haxcmsSiteStore.store.location);
