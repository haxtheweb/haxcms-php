...
static get template(){return _polymerElement.html`
   ...
   * Ready life cycle
   */constructor(){super();new Promise((res,rej)=>_require.default(["@lrnwebcomponents/haxcms-elements/lib/ui-components/active-item/site-active-title.js"],res,rej));this.__disposer=[];(0,_renderStatus.afterNextRender)(this,function(){window.addEventListener("scroll",this._scrollListener.bind(this));(0,_mobxModule.autorun)(reaction=>{const fields=(0,_mobxModule.toJS)(_haxcmsSiteStore.store.activeItemFields);this.hasImage=this._computeHasImage(fields);if(this.hasImage){this.image=fields.images[0].src}this.__disposer.push(reaction)})})}/**
