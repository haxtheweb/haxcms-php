 ...
 */class SimpleBlogOverview extends _polymerElement.PolymerElement{/**
   ...
   */static get tag(){return"simple-blog-overview"}constructor(){super();new Promise((res,rej)=>_require.default(["@polymer/paper-card/paper-card.js"],res,rej));new Promise((res,rej)=>_require.default(["@lrnwebcomponents/simple-datetime/simple-datetime.js"],res,rej))}// render function
