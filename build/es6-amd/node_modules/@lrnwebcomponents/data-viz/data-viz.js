define(["exports","../../@polymer/polymer/polymer-element.js"],function(_exports,_polymerElement){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.DataViz=void 0;/**
 * Copyright 2019
...
resultCompletion:!0,resultResponse:"sample",resultDuration:"sample"};this.dispatchEvent(new CustomEvent("show-data",{bubbles:!0,composed:!0,cancelable:!1,detail:eventData}))}/**
   ...
   */disconnectedCallback(){super.disconnectedCallback();window.removeEventListener("data-viz-hide",this.hideDataViz.bind(this));window.removeEventListener("data-viz-show",this.showDataViz.bind(this))}/**
   * Hide callback
