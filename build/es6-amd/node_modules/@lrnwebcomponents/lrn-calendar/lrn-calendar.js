define(["exports", "meta", "require", "../../@polymer/polymer/polymer-element.js", "../../@polymer/polymer/lib/utils/render-status.js", "../../@polymer/polymer/lib/legacy/polymer.dom.js", "../../@polymer/polymer/lib/utils/resolve-url.js", "../hax-body-behaviors/lib/HAXWiring.js", "../es-global-bridge/es-global-bridge.js", "../../@polymer/iron-ajax/iron-ajax.js"], function (_exports, meta, _require, _polymerElement, _renderStatus, _polymerDom, _resolveUrl, _HAXWiring, _esGlobalBridge, _ironAjax) {
   ...
   */
  class LrnCalendar extends _polymerElement.PolymerElement {
    static get template() {
    ...
    _viewTypeChanged(newValue, oldValue) {
      if (typeof newValue !== typeof undefined && typeof this.file !== typeof undefined && this.__icalLoaded) {
        this.getDateInfo();
        this.createCalendar();
      }
    }
    ...
    _dateStringChanged(newValue, oldValue) {
      if (typeof newValue !== typeof undefined && newValue != "" && this.__icalLoaded) {
    ...
    constructor() {
      ...
      new Promise((res, rej) => _require.default(["@polymer/paper-menu-button/paper-menu-button.js"], res, rej));
      new Promise((res, rej) => _require.default(["@polymer/paper-dropdown-menu/paper-dropdown-menu.js"], res, rej));
      new Promise((res, rej) => _require.default(["@lrnwebcomponents/lrnsys-layout/lrnsys-layout.js"], res, rej));
      new Promise((res, rej) => _require.default(["@lrnwebcomponents/lrnsys-layout/lib/lrnsys-drawer.js"], res, rej));
      new Promise((res, rej) => _require.default(["@lrnwebcomponents/lrnsys-layout/lib/lrnsys-dialog.js"], res, rej));
      new Promise((res, rej) => _require.default(["@lrnwebcomponents/lrnsys-layout/lib/lrnsys-collapselist.js"], res, rej));
      new Promise((res, rej) => _require.default(["@lrnwebcomponents/lrnsys-layout/lib/lrnsys-collapselist-item.js"], res, rej));
      new Promise((res, rej) => _require.default(["@lrnwebcomponents/lrn-calendar/lib/lrn-calendar-date.js"], res, rej));
      ...
      window.addEventListener("es-bridge-ical-loaded", this._icalLoaded.bind(this));
