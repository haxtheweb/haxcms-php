define(["exports","../../@polymer/polymer/polymer-element.js","../../@polymer/polymer/lib/utils/render-status.js","../simple-picker/simple-picker.js","../../@polymer/iron-meta/iron-meta.js"],function(_exports,_polymerElement,_renderStatus,_simplePicker,_ironMeta){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.SimpleIconPicker=void 0;class SimpleIconPicker extends _simplePicker.SimplePicker{static get template(){return _polymerElement.html`
    ...
    `}static get properties(){return{allowNull:{name:"allowNull",type:"Boolean",value:!1},hideOptionLabels:{name:"hideOptionLabels",type:"Boolean",value:!0,readOnly:!0},icons:{name:"icons",type:"Array",value:[]},options:{name:"options",type:"Array",computed:"_getOptions(icons,__iconList,allowNull)"},value:{name:"label",type:"String",value:null,reflectToAttribute:!0,notify:!0},__iconList:{name:"__iconList",type:"Array","read-only":!0}}}static get tag(){return"simple-icon-picker"}ready(){super.ready(),(0,_renderStatus.afterNextRender)(this,function(){const iconSets=new _ironMeta.IronMeta({type:"iconset"});if(0===this.icons.length&&void 0!==iconSets&&iconSets.list&&iconSets.list.length){var iconList=[];iconSets.list.forEach(function(item){item.getIconNames().forEach(icon=>{iconList.push(icon)})}),this.__iconList=iconList}})}_getOptions(icons=[],__iconList=[],allowNull=!1){"string"==typeof icons&&(icons=JSON.parse(icons)),0===icons.length&&(icons=__iconList);let options=!1===allowNull?[]:[[{alt:"null",value:null}]],h=!1===allowNull?0:1,cols=Math.sqrt(icons.length+h)<16?Math.ceil(Math.sqrt(icons.length+h)):15;for(let i=0;i<icons.length;i++){let j=h+i,row=Math.floor(j/cols),col=j-row*cols;void 0!==options[row]&&null!==options[row]||(options[row]=[]),options[row][col]={alt:icons[i],icon:icons[i],value:icons[i]}}return options}_handleChange(e){this.value=e.detail.value,this.dispatchEvent(new CustomEvent("change",{bubbles:!0,detail:this}))}_handleCollapse(e){this.dispatchEvent(new CustomEvent("collapse",{detail:this}))}_handleExpand(e){this.dispatchEvent(new CustomEvent("expand",{detail:this}))}_handleOptionFocus(e){this.dispatchEvent(new CustomEvent("option-focus",{detail:this}))}}_exports.SimpleIconPicker=SimpleIconPicker,window.customElements.define(SimpleIconPicker.tag,SimpleIconPicker)});