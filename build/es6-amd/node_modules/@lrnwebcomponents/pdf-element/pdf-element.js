define(["exports","../../@polymer/polymer/polymer-legacy.js","../../@polymer/paper-card/paper-card.js","../../@polymer/app-layout/app-toolbar/app-toolbar.js","../../@polymer/paper-input/paper-input.js","../../@polymer/iron-input/iron-input.js","../../@polymer/paper-spinner/paper-spinner.js","../../@polymer/paper-icon-button/paper-icon-button.js","../hax-body-behaviors/lib/HAXWiring.js","../schema-behaviors/schema-behaviors.js","../../pdfjs-dist/build/pdf.js","../../pdfjs-dist/build/pdf.worker.js","./lib/main.js"],function(_exports,_polymerLegacy,_paperCard,_appToolbar,_paperInput,_ironInput,_paperSpinner,_paperIconButton,_HAXWiring,_schemaBehaviors,_pdf,_pdfWorker,_main){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.PdfElement=void 0;/**
...
@hero hero.svg
*/let PdfElement=(0,_polymerLegacy.Polymer)({_template:_polymerLegacy.html`
    <style>
      :host {
        display: block;
        width: 100%;
...
var parsedFileName=currentThis.src.split("/").pop(),self=currentInstance;currentThis.sidebarOpen=!0;if(1<=page&&page<=currentInstance.totalPagesNum){self.currentPage=page;self.queueRenderPage(self.currentPage);currentInstance.currentPage=page;currentThis.currentPage=page;this.$.input.blur()}else{this.$.input.value=self.currentPage;this.$.input.blur()}},/*
   ...
   */download:function(){if(this.instance.pdfExists){this.instance.download()}}});_exports.PdfElement=PdfElement});