define(["exports","../../@polymer/polymer/polymer-legacy.js","../../@polymer/paper-input/paper-input.js","../../@polymer/paper-tooltip/paper-tooltip.js","../../@polymer/iron-icons/iron-icons.js","../../@polymer/iron-icon/iron-icon.js"],function(_exports,_polymerLegacy,_paperInput,_paperTooltip,_ironIcons,_ironIcon){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.PaperInputFlagged=void 0;/**
...
*/let PaperInputFlagged=(0,_polymerLegacy.Polymer)({_template:_polymerLegacy.html`
    <style>
      :host {
        display: block;
      }
...
this.__activeMessage=this.inputSuccess.message;return this.inputSuccess.status},/**
   ...
   */_iconFromStatus:function(status){switch(status){case"error":return"icons:error";break;case"warning":case"notice":return"icons:warning";break;case"info":return"icons:info-outline";break;default:return"icons:info";break;}}});_exports.PaperInputFlagged=PaperInputFlagged});