...
*/(0,_polymerLegacy.Polymer)({_template:_polymerLegacy.html`
  ...
  `,is:"lrndesign-stepper-button",properties:{/**
     * The button title.
     ...
     */collapsible:{type:Boolean,reflectToAttribute:!0,notify:!0,value:!1},opened:{type:Boolean,value:!1}},ready:function(){var root=this;setTimeout(function(){var target=root.shadowRoot.querySelector("iron-collapse");if(root.opened){console.log("opening in stepper");target.show()}},0)},/**
   ...
   */hasCollapse:function(bool,test){if(bool==test){return!0}else{return!1}}})});