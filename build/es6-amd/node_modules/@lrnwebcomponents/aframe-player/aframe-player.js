define(["exports","meta","../../@polymer/polymer/polymer-legacy.js","../../@polymer/polymer/lib/utils/resolve-url.js","../hax-body-behaviors/lib/HAXWiring.js","../schema-behaviors/schema-behaviors.js","../es-global-bridge/es-global-bridge.js"],function(_exports,meta,_polymerLegacy,_resolveUrl,_HAXWiring,_schemaBehaviors,_esGlobalBridge){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.AframePlayer=void 0;meta=babelHelpers.interopRequireWildcard(meta);/**
...
this.$.scene.removeFullScreenStyles();this.__entity=document.createElement("a-entity");this.__entity.setAttribute("gltf-model","url("+this.source+")");this._positionChanged();this.$.scene.appendChild(this.__entity)},/**
   ...
   */_positionChanged:function(position){if(this.__entity!==void 0)this.__entity.setAttribute("position",position)}});_exports.AframePlayer=AframePlayer});