define(["../../../@polymer/polymer/polymer-legacy.js","../../lrndesign-animationctrl/lrndesign-animationctrl.js","./TweenMax.min.js"],function(_polymerLegacy,_lrndesignAnimationctrl,_TweenMaxMin){"use strict";(0,_polymerLegacy.Polymer)({_template:_polymerLegacy.html`
    <style>
      :host {
        display: block;
      }
  ...
  `,is:"gene-crossover-2",properties:{tl:{type:Object,value:null},selected:{type:Boolean,value:!1},animationReady:{type:Boolean,value:!1}},observers:["_selectedChanged(selected, animationReady)"],_selectedChanged:function(selected,animationReady){if(!animationReady){return}if(selected){this.tl.play();this.lefttl.play();this.righttl.play()}else{this.tl.progress(0);this.lefttl.progress(0);this.righttl.progress(0);this.tl.pause();this.lefttl.pause();this.righttl.pause()}},ready:function(){var root=this,tl=new TimelineMax,lefttl=new TimelineMax,righttl=new TimelineMax,playButton=this.shadowRoot.querySelector("#play-button"),replayButton=this.shadowRoot.querySelector("#replay-button"),svg=this.shadowRoot.querySelector("#chromosomes"),synapsetext=svg.getElementById("synapsetext"),setonerightfour=svg.getElementById("setonerightfour"),setonerightthree=svg.getElementById("setonerightthree"),setonerighttwo=svg.getElementById("setonerighttwo"),setonerightone=svg.getElementById("setonerightone"),setoneleftfour=svg.getElementById("setoneleftfour"),setoneleftthree=svg.getElementById("setoneleftthree"),setonelefttwo=svg.getElementById("setonelefttwo"),setoneleftone=svg.getElementById("setoneleftone");// Set Animate
...
righttl.to([setonerighttwo],.1,{x:"-=10",display:"block",display:"none"}).to([setonerightthree],.3,{x:"-=10",display:"block",display:"none"}).to([setonerightfour],.3,{x:"-=10",display:"block"});this.tl=tl;this.lefttl=lefttl;this.righttl=righttl;this.animationReady=!0/* transition */ /* transition */;this.tl.pause();this.lefttl.pause();this.righttl.pause()}})});