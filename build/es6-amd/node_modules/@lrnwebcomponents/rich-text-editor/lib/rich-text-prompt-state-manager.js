 ...
 * @customElement
 * @polymer
 */class RichTextPromptStateManager extends _polymerElement.PolymerElement{/* REQUIRED FOR TOOLING DO NOT TOUCH */ // render function
...
if(!window.RichTextPromptStateManager.instance){window.RichTextPromptStateManager.instance=this;return this}}/**
   ...
   */clearTarget(){if(!this.target)return;this.for=null;let parent=this.target.parentNode;parent.insertBefore(this.target.firstChild,this.target);parent.removeChild(this.target);this.target=null}}_exports.RichTextPromptStateManager=RichTextPromptStateManager;window.customElements.define(RichTextPromptStateManager.tag,RichTextPromptStateManager)});