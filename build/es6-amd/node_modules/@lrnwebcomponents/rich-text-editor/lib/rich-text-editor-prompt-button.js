define(["exports","../../../@polymer/polymer/polymer-element.js","../../../@polymer/paper-tooltip/paper-tooltip.js","../../../@polymer/iron-icons/iron-icons.js","./rich-text-editor-toolbar-styles.js","./rich-text-editor-button.js","./rich-text-editor-prompt.js","./rich-text-editor-selection.js"],function(_exports,_polymerElement,_paperTooltip,_ironIcons,_richTextEditorToolbarStyles,_richTextEditorButton,_richTextEditorPrompt,_richTextEditorSelection){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.RichTextEditorPromptButton=void 0;/**
 ...
 * @customElement
 * @polymer
 */class RichTextEditorPromptButton extends _richTextEditorButton.RichTextEditorButton{// properties available to the custom element for data binding
...
this.__highlight=document.createElement("rich-text-editor-selection");this.__highlight.select(this.selection,this.selectedText);console.log("selectText",this.__highlight,this.selection,this.selectedText);this.updatePrompt();//make sure there is a unique id so that the prompt popover appears near the selection
if(!this.selectedText.getAttribute("id"))this.selectedText.setAttribute("id","prompt"+Date.now());this.dispatchEvent(new CustomEvent("select",{detail:this}))}}_exports.RichTextEditorPromptButton=RichTextEditorPromptButton;window.customElements.define(RichTextEditorPromptButton.tag,RichTextEditorPromptButton)});