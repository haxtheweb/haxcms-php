define(["exports","../../../@polymer/polymer/polymer-element.js","../../../@polymer/iron-resizable-behavior/iron-resizable-behavior.js","../../../@polymer/iron-a11y-keys/iron-a11y-keys.js","../../simple-popover/simple-popover.js","../../simple-fields/simple-fields.js","./rich-text-editor-toolbar-styles.js"],function(_exports,_polymerElement,_ironResizableBehavior,_ironA11yKeys,_simplePopover,_simpleFields,_richTextEditorToolbarStyles){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.richTextEditorPrompt=void 0;/**
...
});this.addEventListener("mouseout",e=>{//this._cancel(e);
})}/**
   * Loads element into array
   */setTarget(el){this.clearTarget();let fields=el.fields,vals=el.value;this.set("fields",fields);this.set("value",vals);this.__el=el;this.for=el.selectedText.getAttribute("id")}/**
   * Unloads element from array
   */clearTarget(){if(!this.for)return;this.for=null;this.set("fields",null);this.set("value",null);this.__selection=null;this.__el=null}/**
   * Handles button tap;
   */_cancel(e){e.preventDefault();this.__el.deselectText();this.clearTarget()}/**
   * Handles button tap;
   */_confirm(e){e.preventDefault();this.__el.value=this.value;this.__el.updateSelection();this.clearTarget()}}_exports.richTextEditorPrompt=richTextEditorPrompt;window.customElements.define(richTextEditorPrompt.tag,richTextEditorPrompt)});