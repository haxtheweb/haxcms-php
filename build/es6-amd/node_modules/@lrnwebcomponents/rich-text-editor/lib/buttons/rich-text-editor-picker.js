define(["exports", "../../../../@polymer/polymer/polymer-element.js", "./rich-text-editor-button.js", "../../../es-global-bridge/es-global-bridge.js", "../../../../@polymer/polymer/lib/utils/resolve-url.js", "../../../simple-picker/simple-picker.js"], function (_exports, _polymerElement, _richTextEditorButton, _esGlobalBridge, _resolveUrl, _simplePicker) {
  "use strict";
  ...
  class RichTextEditorPicker extends _richTextEditorButton.RichTextEditorButton {
    ...
    _isToggled(selection) {
      ...
      if (selection !== null && !selection.isCollapsed) {
        if (this.command === "formatBlock") {
          ...
          this.$.button.value = parent.closest(temp.join(",")) !== null ? parent.closest(temp.join(",")).tagName.toLowerCase() : null;
        }
      }
    ...
    _pickerChange(e) {
      ...
      if (val !== null && this.selection !== undefined && this.selection !== null) {
        this.commandVal = this.$.button.value;

        if (this.command = "formatBlock") {
          this.doTextOperation();
        } else if (this.command = "insertNode") {
          let node = !this.block ? document.createTextNode(val) : document.createElement(val);
    ...
    _getPickerOptions(options = [], allowNull = false, icon = null) {
      let items = allowNull === false && icon === null ? [{
        alt: "null",
        icon: icon,
        value: null
      }] : [],
