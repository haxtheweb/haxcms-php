...
*/let PaperAudioPlayer=(0,_polymerLegacy.Polymer)({_template:_polymerLegacy.html`
...
_changeColor:function(newValue){var player=this;player.$.left.style.backgroundColor=newValue;player.$.title.style.color=newValue;player.$.duration.style.color=newValue;player.$.progress.style.backgroundColor=newValue;player.$.replay.style.color=newValue},_hidePlayIcon:function(isPlaying,canBePlayed){return isPlaying?!0:!(canBePlayed||"none"===this.preload)},_setPreload:function(autoplay,preload){return autoplay?"auto":preload}});_exports.PaperAudioPlayer=PaperAudioPlayer});