define(["exports", "require", "../../@polymer/polymer/polymer-element.js", "../../@polymer/polymer/lib/utils/render-status.js", "../haxcms-elements/lib/core/HAXCMSThemeWiring.js", "../haxcms-elements/lib/core/haxcms-site-store.js", "../../mobx/lib/mobx.module.js"], function (_exports, _require, _polymerElement, _renderStatus, _HAXCMSThemeWiring, _haxcmsSiteStore, _mobxModule) {
   ...
   */
  class ExampleHaxcmsTheme extends (0, _HAXCMSThemeWiring.HAXCMSTheme)(_polymerElement.PolymerElement) {
    // render function
    static get template() {
    ...
    constructor() {
      ...
      new Promise((res, rej) => _require.default(["@lrnwebcomponents/haxcms-elements/lib/ui-components/layout/site-modal.js"], res, rej)); // create a blank array to store mobx reactions
