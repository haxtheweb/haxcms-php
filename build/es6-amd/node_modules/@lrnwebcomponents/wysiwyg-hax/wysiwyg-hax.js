define(["exports","../../@polymer/polymer/polymer-legacy.js","../cms-hax/cms-hax.js"],function(_exports,_polymerLegacy,_cmsHax){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.WysiwygHax=void 0;/*
`wysiwyg-hax`
Integration of wysiwyg edit form for a page with HAX.

*/let WysiwygHax=(0,_polymerLegacy.Polymer)({_template:_polymerLegacy.html`
    <style>
      :host {
        display: block;
      }
...
this.editMode=!1;window.HaxStore.write("editMode",this.editMode,this);setTimeout(()=>{this.editMode=!0;window.HaxStore.write("editMode",this.editMode,this)},200)}}},/**
   ...
   */_bodyContentUpdated:function(e){this.bodyValue=window.HaxStore.instance.activeHaxBody.haxToContent()}});_exports.WysiwygHax=WysiwygHax});