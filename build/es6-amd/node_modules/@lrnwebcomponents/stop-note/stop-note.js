define(["exports","../../@polymer/polymer/polymer-legacy.js","../materializecss-styles/materializecss-styles.js","../hax-body-behaviors/lib/HAXWiring.js","../schema-behaviors/schema-behaviors.js","../../@polymer/iron-icon/iron-icon.js","./lib/stop-icon.js"],function(_exports,_polymerLegacy,_materializecssStyles,_HAXWiring,_schemaBehaviors,_ironIcon,_stopIcon){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.StopNote=void 0;/**
 * `stop-note`
 ...
 * -
 */let StopNote=(0,_polymerLegacy.Polymer)({_template:_polymerLegacy.html`
    <style>
      :host {
        display: block;
        width: auto;
  ...
  `,is:"stop-note",behaviors:[HAXBehaviors.PropertiesBehaviors,MaterializeCSSBehaviors.ColorBehaviors,SchemaBehaviors.Schema],observers:["_iconChanged(icon)"],properties:{/**
     * Title Message
   ...
   */_iconChanged:function(icon){this.updateStyles()},/**
   * Evaluates url for correct targeting.
   */_urlTarget:function(url){if(url){const external=this._outsideLink(url);if(external){return"_blank"}}return!1},/**
