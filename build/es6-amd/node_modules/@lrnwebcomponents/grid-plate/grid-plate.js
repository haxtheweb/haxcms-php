define(["exports","require","../../@polymer/polymer/polymer-element.js","../../@polymer/polymer/lib/utils/render-status.js","../../@polymer/polymer/lib/legacy/polymer.dom.js","../../@polymer/polymer/lib/utils/async.js","../hax-body-behaviors/lib/HAXWiring.js","../../@polymer/iron-a11y-keys/iron-a11y-keys.js","../responsive-utility/responsive-utility.js"],function(_exports,_require,_polymerElement,_renderStatus,_polymerDom,_async,_HAXWiring,_ironA11yKeys,_responsiveUtility){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.GridPlate=void 0,_require=babelHelpers.interopRequireWildcard(_require);class GridPlate extends _polymerElement.PolymerElement{constructor(){super(),new Promise((res,rej)=>_require.default(["@polymer/paper-icon-button/paper-icon-button.js"],res,rej)),new Promise((res,rej)=>_require.default(["@polymer/iron-icons/iron-icons.js"],res,rej))}static get template(){return _polymerElement.html`
