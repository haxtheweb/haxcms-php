define(["../../../@polymer/polymer/polymer-legacy.js","../../../@polymer/iron-icons/iron-icons.js","../../../@polymer/iron-icon/iron-icon.js","../../../@polymer/paper-button/paper-button.js","../../../@polymer/app-layout/app-drawer/app-drawer.js","./hax-blox-browser.js","../../simple-colors/simple-colors.js","./hax-shared-styles.js"],function(_polymerLegacy,_ironIcons,_ironIcon,_paperButton,_appDrawer,_haxBloxBrowser,_simpleColors,_haxSharedStyles){"use strict";/**
 `hax-blox-picker`
...
*/(0,_polymerLegacy.Polymer)({_template:_polymerLegacy.html`
   ...
   * Attached life cycle
   */attached:function(){this.fire("hax-register-blox-picker",this)},/**
   * open the dialog
   */open:function(){this.$.bloxbrowser.resetBrowser();this.$.dialog.open()},/**
   * close the dialog
