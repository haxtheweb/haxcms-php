...
*/(0,_polymerLegacy.Polymer)({_template:_polymerLegacy.html`
  ...
  `,is:"hax-context-item",properties:{/**
   ...
   */_storeSelection:function(e){window.HaxStore._tmpSelection=window.HaxStore.getSelection()},/**
   * Fire an event that includes the eventName of what was just pressed.
   */_fireEvent:function(e){this.fire("hax-context-item-selected",{target:this,eventName:this.eventName,value:this.value})}})});