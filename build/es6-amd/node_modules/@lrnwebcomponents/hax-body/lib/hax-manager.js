define(["exports","require","../../../lit-element/lit-element.js","../../simple-colors/simple-colors.js","../../../@polymer/paper-styles/paper-styles.js","../../../@polymer/iron-pages/iron-pages.js","../../../@polymer/polymer/lib/elements/custom-style.js"],function(_exports,_require,_litElement,_simpleColors,_paperStyles,_ironPages,_customStyle){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.HaxManager=void 0,_require=babelHelpers.interopRequireWildcard(_require);class HaxManager extends _simpleColors.SimpleColors{static get styles(){return[...super.styles,_litElement.css`
        :host {
          display: block;
      ...
      `]}constructor(){super(),this.opened=!1,this.editExistingNode=!1,this.addTitle="Add content",this.activeStep=0,this.searching=!1,this.activePage=0,this.canSupportUploads=!1,this.appList=[],this.__allowUpload=!1,new Promise((res,rej)=>_require.default(["./hax-manager-deps.js"],res,rej))}render(){return _litElement.html`
      <custom-style>
        <style>
