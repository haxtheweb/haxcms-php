...
this.close()},/**
   ...
   */close:function(e){var normalizedEvent=(0,_polymerDom.dom)(e),local=normalizedEvent.localTarget;if(typeof e===typeof void 0||local===this.$.dialog||local===this.$.closedialog){// reset the active element which will force this to reset the manager
