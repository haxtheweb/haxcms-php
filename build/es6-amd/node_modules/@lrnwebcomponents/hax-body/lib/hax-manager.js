define(["exports", "require", "../../../@polymer/polymer/polymer-element.js", "../../../@polymer/polymer/lib/utils/render-status.js", "../../../@polymer/polymer/lib/legacy/polymer.dom.js", "../../../@polymer/paper-styles/paper-styles.js", "../../simple-colors/simple-colors.js", "./hax-shared-styles.js", "../../../@polymer/iron-pages/iron-pages.js"], function (_exports, _require, _polymerElement, _renderStatus, _polymerDom, _paperStyles, _simpleColors, _haxSharedStyles, _ironPages) {
   ...
   */
  class HaxManager extends _polymerElement.PolymerElement {
    constructor() {
      super();
      ...
      new Promise((res, rej) => _require.default(["@lrnwebcomponents/hax-body/lib/hax-preview.js"], res, rej));
      new Promise((res, rej) => _require.default(["@lrnwebcomponents/hax-body/lib/hax-app-browser.js"], res, rej));
      new Promise((res, rej) => _require.default(["@lrnwebcomponents/hax-body/lib/hax-gizmo-browser.js"], res, rej));
    ...
    ready() {
      super.ready(); // send an event that this is the manager
    ...
    close(e) {
      ...
      if (typeof e === typeof undefined || local === this.shadowRoot.querySelector("#dialog") || local === this.shadowRoot.querySelector("#closedialog")) {
