define(["exports","require","../../../lit-element/lit-element.js","../../utils/utils.js","../../../@polymer/polymer/lib/elements/custom-style.js"],(function(_exports,_require,_litElement,_utils,_customStyle){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.HaxTrayUpload=void 0,_require=babelHelpers.interopRequireWildcard(_require);class HaxTrayUpload extends((0,_utils.winEventsElement)(_litElement.LitElement)){static get styles(){return[_litElement.css`
      ...
      `]}static get tag(){return"hax-tray-upload"}static get properties(){return{canSupportUploads:{type:Boolean,attribute:"can-support-uploads"}}}constructor(){super(),this.__winEvents={"hax-store-property-updated":"_haxStorePropertyUpdated","hax-app-picker-selection":"_haxAppPickerSelection","place-holder-file-drop":"_placeHolderFileDrop"},this.canSupportUploads=!1,setTimeout(()=>{new Promise((res,rej)=>_require.default(["../../../@polymer/paper-button/paper-button.js"],res,rej)),new Promise((res,rej)=>_require.default(["../../../@polymer/paper-input/paper-input.js"],res,rej)),new Promise((res,rej)=>_require.default(["../../../@vaadin/vaadin-upload/vaadin-upload.js"],res,rej))},0)}_haxStorePropertyUpdated(e){e.detail&&"canSupportUploads"===e.detail.property&&(this[e.detail.property]=e.detail.value)}render(){return _litElement.html`
      <custom-style>
        <style>
