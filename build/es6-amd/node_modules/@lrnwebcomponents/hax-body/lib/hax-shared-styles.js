define(["../../../@polymer/polymer/polymer-element.js"],function(_polymerElement){"use strict";const styleElement=document.createElement("dom-module");styleElement.innerHTML=`<template>
  <style>
  :host, :host * ::slotted(*) {
    --hax-color-bg: #ffffff;
