...
*/(0,_polymerLegacy.Polymer)({_template:_polymerLegacy.html`
   ...
   */_selectedUpdated:function(newValue,oldValue){if(typeof null!==typeof newValue&&typeof oldValue!==typeof void 0&&typeof null!==typeof oldValue){let children=(0,_polymerDom.dom)(this).children;// check for tag match since we have to filter out text nodes
