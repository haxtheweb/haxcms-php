...
*/class HaxContextItemMenu extends _polymerElement.PolymerElement{constructor(){super();new Promise((res,rej)=>_require.default(["../../../@polymer/paper-tooltip/paper-tooltip.js"],res,rej));new Promise((res,rej)=>_require.default(["../../../@polymer/paper-item/paper-item.js"],res,rej));new Promise((res,rej)=>_require.default(["../../../@polymer/neon-animation/neon-animation.js"],res,rej))}static get template(){return _polymerElement.html`
   ...
   */_selectedUpdated(newValue,oldValue){if(typeof null!==typeof newValue&&typeof oldValue!==typeof void 0&&typeof null!==typeof oldValue){let children=(0,_polymerDom.dom)(this).children;// check for tag match since we have to filter out text nodes
...
if(this._blockEvent){this._blockEvent=!1}}}}_exports.HaxContextItemMenu=HaxContextItemMenu;window.customElements.define(HaxContextItemMenu.tag,HaxContextItemMenu)});