...
*/(0,_polymerLegacy.Polymer)({_template:_polymerLegacy.html`
   ...
   */_searchValuesEvent:function(e){if(typeof e.detail!==typeof void 0){var requestParams=this.requestParams;for(var property in e.detail){requestParams[property]=e.detail[property]}this.set("requestParams",{});this.set("requestParams",requestParams)}},/**
   * Active app has changed.
   */_resetAppSearch:function(newValue,oldValue){if(typeof newValue!==typeof void 0&&null!==newValue){let app=newValue;var requestParams={};this.label=app.details.title;// disasble auto for a moment while we switch inputs
...
if(typeof app.connection.auto!==typeof void 0){this.auto=app.connection.auto}else{this.auto=!0/* transition */ /* transition */}}},/**
   * Attached life cycle.
   */attached:function(){document.body.addEventListener("hax-store-property-updated",this._haxStorePropertyUpdated.bind(this));document.body.addEventListener("hax-app-search-values-changed",this._searchValuesEvent.bind(this))},/**
   * Detached life cycle.
   */detached:function(){document.body.removeEventListener("hax-store-property-updated",this._haxStorePropertyUpdated.bind(this));document.body.removeEventListener("hax-app-search-values-changed",this._searchValuesEvent.bind(this))},/**
   * Store updated, sync.
   ...
   */_requestDataChanged:function(newValue,oldValue){if({}!=typeof newValue&&typeof oldValue!==typeof void 0){let media=[],map=this.resultMap,data=[];// look for the items element to draw our data from at its root
...
this.set("media",[]);this.set("media",media)}}},_loadingChanged:function(newValue,oldValue){if(newValue){this.set("media",[]);this.notifyPath("media.*");setTimeout(()=>{this.$.itemlist.fire("iron-resize")},1e3)}},/**
   * Callback for when media has been processed for display
   */_mediaChanged:function(newValue,oldValue){if(typeof oldValue!==typeof void 0){setTimeout(()=>{this.$.itemlist.fire("iron-resize")},325)}},/**
