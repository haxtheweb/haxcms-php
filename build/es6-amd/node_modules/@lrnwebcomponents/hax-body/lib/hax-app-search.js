define(["exports","require","../../../lit-element/lit-element.js","../../simple-colors/simple-colors.js","../../../@polymer/iron-ajax/iron-ajax.js","../../utils/utils.js"],(function(_exports,_require,_litElement,_simpleColors,_ironAjax,_utils){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.HaxAppSearch=void 0,_require=babelHelpers.interopRequireWildcard(_require);class HaxAppSearch extends((0,_utils.winEventsElement)(_simpleColors.SimpleColors)){static get styles(){return[...super.styles,_litElement.css`
      ...
      `]}constructor(){super(),this.__winEvents={"hax-store-property-updated":"_haxStorePropertyUpdated"},this.auto=!1,this.headers={},this.method="GET",this.loading=!1,this.requestData={},this.media=[],this.resultMap={},new Promise((res,rej)=>_require.default(["../../../@polymer/paper-input/paper-input.js"],res,rej)),new Promise((res,rej)=>_require.default(["../../dropdown-select/dropdown-select.js"],res,rej)),new Promise((res,rej)=>_require.default(["../../hexagon-loader/hexagon-loader.js"],res,rej)),new Promise((res,rej)=>_require.default(["./hax-app-search-inputs.js"],res,rej)),new Promise((res,rej)=>_require.default(["./hax-app-search-result.js"],res,rej))}render(){return _litElement.html`
      <iron-ajax
        id="request"
        handle-as="json"
