define(["exports","require","../../../lit-element/lit-element.js","../../simple-colors/simple-colors.js","../../../@polymer/iron-ajax/iron-ajax.js","../../../@polymer/polymer/lib/elements/custom-style.js"],function(_exports,_require,_litElement,_simpleColors,_ironAjax,_customStyle){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.HaxAppSearch=void 0,_require=babelHelpers.interopRequireWildcard(_require);class HaxAppSearch extends _simpleColors.SimpleColors{static get styles(){return[...super.styles,_litElement.css`
        :host {
          display: block;
        }
      ...
      `]}constructor(){super(),this.auto=!1,this.headers={},this.method="GET",this.loading=!1,this.requestData={},this.media=[],this.resultMap={},new Promise((res,rej)=>_require.default(["../../../@polymer/paper-input/paper-input.js"],res,rej)),new Promise((res,rej)=>_require.default(["../../../@polymer/paper-card/paper-card.js"],res,rej)),new Promise((res,rej)=>_require.default(["../../../@polymer/paper-styles/paper-styles.js"],res,rej)),new Promise((res,rej)=>_require.default(["../../hexagon-loader/hexagon-loader.js"],res,rej)),new Promise((res,rej)=>_require.default(["./hax-app-search-inputs.js"],res,rej)),new Promise((res,rej)=>_require.default(["./hax-app-search-result.js"],res,rej)),document.body.addEventListener("hax-store-property-updated",this._haxStorePropertyUpdated.bind(this))}render(){return _litElement.html`
      <custom-style>
        <style>
          paper-card {
            --paper-card-header: {
