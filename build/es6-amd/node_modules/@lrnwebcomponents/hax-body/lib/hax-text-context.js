define(["exports", "require", "../../../@polymer/polymer/polymer-element.js", "../../../@polymer/polymer/lib/utils/render-status.js", "../../simple-colors/simple-colors.js", "./hax-shared-styles.js"], function (_exports, _require, _polymerElement, _renderStatus, _simpleColors, _haxSharedStyles) {
   ...
   */
  class HaxTextContext extends _polymerElement.PolymerElement {
    constructor() {
      super();
      ...
      new Promise((res, rej) => _require.default(["@lrnwebcomponents/md-extra-icons/md-extra-icons.js"], res, rej));
      ...
      new Promise((res, rej) => _require.default(["@lrnwebcomponents/hax-body/lib/hax-context-item-textop.js"], res, rej));
    ...
    _haxContextOperation(e) {
      let detail = e.detail;
      let selection = window.HaxStore.getSelection(); // support a simple insert event to bubble up or everything else
