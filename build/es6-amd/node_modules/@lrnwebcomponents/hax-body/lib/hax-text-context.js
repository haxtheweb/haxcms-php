...
*/(0,_polymerLegacy.Polymer)({_template:_polymerLegacy.html`
  ...
  `,is:"hax-text-context",listeners:{"hax-context-item-selected":"_haxContextOperation"},properties:{_showIndent:{type:Boolean,computed:"_computeShowIndent(selectedValue, polyfillSafe)"},/**
...
// inside the menu that isn't from a paper-item
this.$.toolbar.$.moremenu.$.menu.hideMenu();break;case"text-link":var href="";if(typeof selection.focusNode.parentNode.href!==typeof void 0){href=selection.focusNode.parentNode.href}// @todo put in a dialog instead of this
let url=prompt("Enter a URL:",href);if(url){document.execCommand("createLink",!1,url)}break;case"text-unlink":document.execCommand("unlink");break;/**
   ...
   */_isSafari:function(){let ua=navigator.userAgent.toLowerCase();// test to find safari to account for it's handling
