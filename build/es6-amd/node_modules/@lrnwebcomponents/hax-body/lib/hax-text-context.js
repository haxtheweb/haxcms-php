define(["exports", "../../../lit-element/lit-element.js", "../../../@polymer/paper-item/paper-item.js", "../../../@polymer/iron-icon/iron-icon.js", "./hax-context-item-menu.js", "./hax-context-item.js", "./hax-context-item-textop.js", "./hax-toolbar.js", "../../simple-popover/lib/simple-popover-selection.js", "../../simple-popover/lib/SimpleTourFinder.js", "./hax-store.js", "../../../mobx/dist/mobx.esm.js"], function (_exports, _litElement, _paperItem, _ironIcon, _haxContextItemMenu, _haxContextItem, _haxContextItemTextop, _haxToolbar, _simplePopoverSelection, _SimpleTourFinder, _haxStore, _mobxEsm) {
  "use strict";
  ...
  class HaxTextContext extends (0, _SimpleTourFinder.SimpleTourFinder)(_litElement.LitElement) {
    ...
    constructor() {
      ...
      (0, _mobxEsm.autorun)(() => {
        ...
        if (_haxStore.HAXStore.isTextElement(activeNode) && this.shadowRoot.querySelector('#textformat paper-item[value="' + activeNode.tagName.toLowerCase() + '"]')) {
    ...
    render() {
      ...
      <hax-toolbar ?hide-more="${!this.hasSelectedText}" id="toolbar">
        ...
        >
          ...
          ${this.formattingList.map(val => (0, _litElement.html)` <paper-item slot="options" value="${val.value}">
    ...
    updateTextIconSelection(tag) {
      ...
      let localItem = this.shadowRoot.querySelector('#textformat paper-item[value="' + this.realSelectedValue + '"]');
