define(["exports", "../../../lit-element/lit-element.js", "../../simple-icon/lib/simple-icon-lite.js", "../../hax-iconset/lib/simple-hax-iconset.js", "./hax-context-item-menu.js", "./hax-context-item.js", "./hax-context-item-textop.js", "./hax-toolbar.js", "../../simple-popover/lib/simple-popover-selection.js", "../../simple-popover/lib/SimpleTourFinder.js", "./hax-store.js", "../../../mobx/dist/mobx.esm.js"], function (_exports, _litElement, _simpleIconLite, _simpleHaxIconset, _haxContextItemMenu, _haxContextItem, _haxContextItemTextop, _haxToolbar, _simplePopoverSelection, _SimpleTourFinder, _haxStore, _mobxEsm) {
  ...
  class HaxTextContext extends (0, _SimpleTourFinder.SimpleTourFinder)(_litElement.LitElement) {
    ...
    constructor() {
      ...
      (0, _mobxEsm.autorun)(() => {
        ...
        if (activeNode && activeNode.tagName) {
          let schema = _haxStore.HAXStore.haxSchemaFromTag(activeNode.tagName);
        ...
        if (activeNode && _haxStore.HAXStore.isTextElement(activeNode) && this.shadowRoot.querySelector('button[value="' + activeNode.tagName.toLowerCase() + '"]')) {
          this.updateTextIconSelection(activeNode.tagName.toLowerCase());
        } else if (activeNode && activeNode.tagName === "LI" && this.shadowRoot.querySelector('button[value="' + activeNode.parentNode.tagName.toLowerCase() + '"]')) {
          this.updateTextIconSelection(activeNode.parentNode.tagName.toLowerCase());
        }
      });
    }
    ...
    updateTextIconSelection(tag) {
      ...
      let localItem = this.shadowRoot.querySelector('button[value="' + this.realSelectedValue + '"]');
