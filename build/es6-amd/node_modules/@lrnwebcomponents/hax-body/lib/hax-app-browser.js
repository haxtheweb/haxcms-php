define(["exports", "require", "../../../@polymer/polymer/polymer-element.js", "../../../@polymer/polymer/lib/utils/render-status.js", "../../../@polymer/polymer/lib/utils/async.js", "../../simple-colors/simple-colors.js", "../../grafitto-filter/grafitto-filter.js", "../../../@polymer/iron-list/iron-list.js", "../../../@polymer/iron-pages/iron-pages.js", "./hax-shared-styles.js"], function (_exports, _require, _polymerElement, _renderStatus, _async, _simpleColors, _grafittoFilter, _ironList, _ironPages, _haxSharedStyles) {
   ...
   */
  class HaxAppBrowser extends _polymerElement.PolymerElement {
    constructor() {
      super();
      ...
      new Promise((res, rej) => _require.default(["@lrnwebcomponents/dropdown-select/dropdown-select.js"], res, rej));
      new Promise((res, rej) => _require.default(["@lrnwebcomponents/hax-body/lib/hax-app-browser-item.js"], res, rej));
      new Promise((res, rej) => _require.default(["@lrnwebcomponents/hax-body/lib/hax-app-search.js"], res, rej));
    }
    ...
    ready() {
      ...
      (0, _renderStatus.afterNextRender)(this, function () {
        this.shadowRoot.querySelector("#inputfilter").addEventListener("value-changed", e => {
    ...
    resetBrowser() {
      _async.microTask.run(() => {
        ...
        if (this.shadowRoot.querySelector("#filter").shadowRoot.querySelector("#ironlist")) {
          this.shadowRoot.querySelector("#filter").shadowRoot.querySelector("#ironlist").filtered = this.__appList;
        }
        ...
        setTimeout(() => {
          if (this.shadowRoot.querySelector("#filter").shadowRoot.querySelector("#ironlist")) {
            this.shadowRoot.querySelector("#filter").shadowRoot.querySelector("#ironlist").dispatchEvent(new CustomEvent("iron-resize", {
              bubbles: true,
              cancelable: true,
              composed: true,
              detail: true
