 ...
 */class HaxAppBrowser extends _polymerElement.PolymerElement{constructor(){super();new Promise((res,rej)=>_require.default(["../../../@polymer/paper-input/paper-input.js"],res,rej));new Promise((res,rej)=>_require.default(["../../../@polymer/paper-item/paper-item.js"],res,rej));new Promise((res,rej)=>_require.default(["../../../@polymer/iron-pages/iron-pages.js"],res,rej));new Promise((res,rej)=>_require.default(["../../dropdown-select/dropdown-select.js"],res,rej));new Promise((res,rej)=>_require.default(["./hax-app-browser-item.js"],res,rej));new Promise((res,rej)=>_require.default(["./hax-app-search.js"],res,rej))}static get template(){return _polymerElement.html`
