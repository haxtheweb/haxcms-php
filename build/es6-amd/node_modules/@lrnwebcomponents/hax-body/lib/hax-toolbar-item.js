define(["../../../@polymer/polymer/polymer-legacy.js","../../../@polymer/paper-button/paper-button.js","../../../@polymer/paper-tooltip/paper-tooltip.js","../../simple-colors/simple-colors.js","./hax-shared-styles.js"],function(_polymerLegacy,_paperButton,_paperTooltip,_simpleColors,_haxSharedStyles){"use strict";(0,_polymerLegacy.Polymer)({_template:_polymerLegacy.html`
  ...
  `,is:"hax-toolbar-item",properties:{/**
     * corner
   ...
   */_tooltipChanged:function(newValue,oldValue){if(""==newValue||null==newValue){this.$.tooltip.setAttribute("aria-hidden","true")}else{this.$.tooltip.setAttribute("aria-hidden","false")}}})});