define(["exports", "meta", "require", "../../../@polymer/polymer/polymer-element.js", "../../../@polymer/polymer/lib/utils/render-status.js", "../../../@polymer/polymer/lib/legacy/polymer.dom.js", "../../../@polymer/polymer/lib/utils/resolve-url.js", "../../../@polymer/polymer/lib/utils/settings.js", "./shadows-safari.js", "./haxutils.js", "../../../@polymer/iron-ajax/iron-ajax.js", "../../simple-toast/simple-toast.js", "../../media-behaviors/media-behaviors.js", "../../hax-body-behaviors/hax-body-behaviors.js", "../../code-sample/code-sample.js"], function (_exports, meta, _require, _polymerElement, _renderStatus, _polymerDom, _resolveUrl, _settings, _shadowsSafari, _haxutils, _ironAjax, _simpleToast, _mediaBehaviors, _haxBodyBehaviors, _codeSample) {
  ...
  class HaxStore extends (0, _haxBodyBehaviors.HAXElement)((0, _mediaBehaviors.MediaBehaviorsVideo)(_polymerElement.PolymerElement)) {
    static get template() {
      ...
      if (ready && typeof appDataResponse !== typeof undefined && appDataResponse != null) {
        ...
        if (typeof appDataResponse.autoloader !== typeof undefined) {
          ...
          for (var i in appDataResponse.autoloader) {
            let CEname = i;
            let CEimport = appDataResponse.autoloader[i]; // helps support array or object based appstore
    ...
    connectedCallback() {
      ...
      (0, _renderStatus.afterNextRender)(this, function () {
        ...
        new Promise((res, rej) => _require.default(["@lrnwebcomponents/hal-9000/hal-9000.js"], res, rej)); // set this global flag so we know it's safe to start trusting data
    ...
    _initVoiceCommands() {
      ...
      commands[`${this.shadowRoot.querySelector("#hal").respondsTo} scroll up`] = () => {
        window.scrollBy({
      ...
      commands[`${this.shadowRoot.querySelector("#hal").respondsTo} scroll (down)`] = () => {
        window.scrollBy({
          top: window.innerHeight * 0.5,
          left: 0,
          behavior: "smooth"
      ...
      commands[`hey ${this.shadowRoot.querySelector("#hal").respondsTo}`] = () => {
        this.shadowRoot.querySelector("#hal").speak("Yeah what do you want");
      };

      commands[`${this.shadowRoot.querySelector("#hal").respondsTo} find media`] = () => {
    ...
    constructor() {
      ...
      new Promise((res, rej) => _require.default(["@lrnwebcomponents/hax-body/lib/hax-app.js"], res, rej));
      new Promise((res, rej) => _require.default(["@lrnwebcomponents/hax-body/lib/hax-stax.js"], res, rej));
      new Promise((res, rej) => _require.default(["@lrnwebcomponents/hax-body/lib/hax-blox.js"], res, rej));
      new Promise((res, rej) => _require.default(["@lrnwebcomponents/hax-body/lib/hax-stax-browser.js"], res, rej));
      new Promise((res, rej) => _require.default(["@lrnwebcomponents/hax-body/lib/hax-blox-browser.js"], res, rej)); // claim the instance spot. This way we can easily
      ...
      this.haxToast = window.SimpleToast.requestAvailability(); // notice hax property definitions coming from anywhere
      ...
      document.body.addEventListener("hax-insert-content-array", this._haxStoreInsertMultiple.bind(this));
      window.addEventListener("hax-add-voice-command", this._addVoiceCommand.bind(this));
    ...
    closeAllDrawers(active = false) {
      ...
      let drawers = ["haxManager", "haxBloxPicker", "haxStaxPicker", "haxPreferences", "haxExport"];
      ...
      if (e.detail) {
        ...
        if (details.replace && details.replacement) {
          ...
          if (this.activeContainerNode && this.activeContainerNode.tagName === "GRID-PLATE") {
            ...
            (0, _polymerDom.dom)(this.activeContainerNode).appendChild(node);
            this.activeHaxBody.$.textcontextmenu.highlightOps = false;
            this.activeHaxBody.__updateLockFocus = node; // wait so that the DOM can have the node to then attach to
    ...
    if (typeof tmpProps !== typeof undefined) {
      for (var j in tmpProps) {
        ...
        if (!tmpProps[j].readOnly && !tmpProps[j].computed && value !== tmpProps[j].value) {
          ...
          if (value != null && (typeof value === typeof Object || value.constructor === Array)) {
            propvals[nodeName] = JSON.stringify(value).replace(new RegExp('"', "g"), "&quot;");
          } // only write things that aren't empty
          else if (value != null && value != "null") {
              if (value === true || value === "true") {
  ...
  window.HaxStore.toast = (message, duration = 4000, classStyle = "", closeText = null, eventCallback = null) => {
