define(["exports","require","../../../@polymer/polymer/polymer-element.js"],function(_exports,_require,_polymerElement){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.HaxToolbar=void 0,_require=babelHelpers.interopRequireWildcard(_require);class HaxToolbar extends _polymerElement.PolymerElement{constructor(){super(),new Promise((res,rej)=>_require.default(["../../../@polymer/paper-slider/paper-slider.js"],res,rej)),new Promise((res,rej)=>_require.default(["../../../@polymer/paper-tooltip/paper-tooltip.js"],res,rej)),new Promise((res,rej)=>_require.default(["../../../@polymer/paper-item/paper-item.js"],res,rej)),new Promise((res,rej)=>_require.default(["../../../@polymer/iron-icons/iron-icons.js"],res,rej)),new Promise((res,rej)=>_require.default(["../../../@polymer/iron-icons/editor-icons.js"],res,rej)),new Promise((res,rej)=>_require.default(["./hax-toolbar-item.js"],res,rej)),new Promise((res,rej)=>_require.default(["./hax-toolbar-menu.js"],res,rej)),new Promise((res,rej)=>_require.default(["./hax-context-item.js"],res,rej)),new Promise((res,rej)=>_require.default(["./hax-context-item-menu.js"],res,rej)),this.addEventListener("hax-context-item-selected",this._haxContextOperation.bind(this))}static get template(){return _polymerElement.html`
      <style>
        :host {
          display: flex;
