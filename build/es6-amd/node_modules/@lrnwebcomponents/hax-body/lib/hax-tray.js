define(["exports", "require", "../../../lit-element/lit-element.js", "../../utils/utils.js", "../../a11y-collapse/lib/a11y-collapse-group.js", "../../a11y-collapse/a11y-collapse.js", "../../hax-body-behaviors/lib/HAXFields.js", "./hax-map.js", "./hax-preferences-dialog.js", "../../simple-popover/lib/SimpleTourFinder.js", "./hax-store.js", "../../simple-popover/simple-popover.js", "../../../mobx/dist/mobx.esm.js"], function (_exports, _require, _litElement, _utils, _a11yCollapseGroup, _a11yCollapse, _HAXFields, _haxMap, _haxPreferencesDialog, _SimpleTourFinder, _haxStore, _simplePopover, _mobxEsm) {
  "use strict";
  ...
  class HaxTray extends (0, _SimpleTourFinder.SimpleTourFinder)((0, _utils.winEventsElement)(_litElement.LitElement)) {
    ...
    constructor() {
      ...
      setTimeout(() => {
        new Promise((res, rej) => _require.default(["./hax-tray-button.js"], res, rej)); // @todo replace all icons w/ simple-iconset
