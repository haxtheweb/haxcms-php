define(["exports","require","../../../@polymer/polymer/polymer-element.js","../../../@polymer/polymer/lib/utils/render-status.js","../../../@polymer/paper-button/paper-button.js","../../../@polymer/paper-card/paper-card.js","./hax-shared-styles.js"],function(_exports,_require,_polymerElement,_renderStatus,_paperButton,_paperCard,_haxSharedStyles){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0/* transition */ /* transition */});_exports.HaxStaxBrowserItem=void 0;_require=babelHelpers.interopRequireWildcard(_require);/**
 * `hax-stax-browser-item`
 * `A button on the hax-gizmo-browser app display`
 */class HaxStaxBrowserItem extends _polymerElement.PolymerElement{constructor(){super();new Promise((res,rej)=>_require.default(["../../../@polymer/iron-image/iron-image.js"],res,rej))}static get template(){return _polymerElement.html`
