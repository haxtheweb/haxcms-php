define(["exports", "require", "../../../@polymer/polymer/polymer-element.js", "../../../@polymer/polymer/lib/legacy/polymer.dom.js", "./haxutils.js", "../../../@polymer/iron-media-query/iron-media-query.js", "../../simple-colors/simple-colors.js", "./hax-shared-styles.js"], function (_exports, _require, _polymerElement, _polymerDom, _haxutils, _ironMediaQuery, _simpleColors, _haxSharedStyles) {
   ...
   */
  class HaxPreview extends _polymerElement.PolymerElement {
    constructor() {
      super();
      ...
      new Promise((res, rej) => _require.default(["@vaadin/vaadin-split-layout/vaadin-split-layout.js"], res, rej));
      new Promise((res, rej) => _require.default(["@lrnwebcomponents/eco-json-schema-form/eco-json-schema-form.js"], res, rej));
      new Promise((res, rej) => _require.default(["@lrnwebcomponents/code-editor/code-editor.js"], res, rej));
      ...
      new Promise((res, rej) => _require.default(["@lrnwebcomponents/hax-body/lib/hax-upload-field.js"], res, rej));
      new Promise((res, rej) => _require.default(["@lrnwebcomponents/simple-picker/simple-picker.js"], res, rej));
      new Promise((res, rej) => _require.default(["@lrnwebcomponents/simple-icon-picker/simple-icon-picker.js"], res, rej));
      new Promise((res, rej) => _require.default(["@lrnwebcomponents/paper-input-flagged/paper-input-flagged.js"], res, rej));
    }
    ...
    _computedEditSource(newValue, oldValue) {
      if (typeof newValue !== typeof undefined) {
        if (typeof this.previewNode.tagName !== typeof undefined && window.HaxStore.instance.elementList[this.previewNode.tagName.toLowerCase()]) {
    ...
    _formKeyChanged(newValue, oldValue) {
      ...
      if (typeof oldValue !== typeof undefined) {
        ...
        if (typeof this.previewNode !== typeof undefined && typeof this.previewNode.tagName !== typeof undefined && typeof window.HaxStore.instance.elementList[this.previewNode.tagName.toLowerCase()] !== typeof undefined) {
          let element = this.element;
          let props = window.HaxStore.instance.elementList[this.previewNode.tagName.toLowerCase()];
          ...
          for (var prop in props.settings[newValue]) {
            ...
            if (typeof props.settings[this.formKey][prop].slot !== typeof undefined && !slotsApplied) {
              ...
              for (var i in (0, _polymerDom.dom)(previewNode).getEffectiveChildNodes()) {
                ...
                if (typeof (0, _polymerDom.dom)(previewNode).getEffectiveChildNodes()[i] !== typeof undefined && (0, _polymerDom.dom)(previewNode).getEffectiveChildNodes()[i].nodeType === 1 && (0, _polymerDom.dom)(previewNode).getEffectiveChildNodes()[i].slot === props.settings[this.formKey][prop].slot) {
                  if (typeof (0, _polymerDom.dom)(previewNode).getEffectiveChildNodes()[i].innerHTML !== typeof undefined) {
    ...
    _previewNodeChanged(newValue, oldValue) {
      ...
      if (typeof oldValue !== typeof undefined && newValue != oldValue) {
        ...
        if (typeof newValue.tagName !== typeof undefined && typeof window.HaxStore.instance.elementList[newValue.tagName.toLowerCase()] !== typeof undefined) {
          const element = this.element;
          let props = window.HaxStore.instance.elementList[newValue.tagName.toLowerCase()];
          let schema = {};
          ...
          for (var prop in props.settings[this.formKey]) {
            if (typeof props.settings[this.formKey][prop].slot !== typeof undefined) {
              ...
              for (var i in (0, _polymerDom.dom)(newValue).getEffectiveChildNodes()) {
                // test for element nodes to be safe
                if (typeof (0, _polymerDom.dom)(newValue).getEffectiveChildNodes()[i] !== typeof undefined && (0, _polymerDom.dom)(newValue).getEffectiveChildNodes()[i].nodeType === 1 && (0, _polymerDom.dom)(newValue).getEffectiveChildNodes()[i].slot === props.settings[this.formKey][prop].slot) {
                  if (typeof (0, _polymerDom.dom)(newValue).getEffectiveChildNodes()[i].innerHTML !== typeof undefined) {
    ...
    _elementChanged(newValue, oldValue) {
      if (typeof newValue !== typeof undefined) {
        ...
        let preview = (0, _polymerDom.dom)(this);
    ...
    _valueChanged(valueChange) {
      ...
      if (typeof node.tagName !== typeof undefined && typeof window.HaxStore.instance.elementList[node.tagName.toLowerCase()] !== typeof undefined) {
        for (var path in valueChange.base) {
          ...
          if (propSettings.length > 0) {
            ...
            if (propData.attribute) {
              let attributeName = window.HaxStore.camelToDash(propData.attribute); // special supporting for boolean because html is weird :p
              ...
              const cloneIt = tmpel.cloneNode(true); // inject the slotted content but use text nodes if this is a text element
