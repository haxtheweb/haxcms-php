define(["exports","require","../../../@polymer/polymer/polymer-element.js","../../../@polymer/polymer/lib/legacy/polymer.dom.js","./haxutils.js","../../simple-colors/simple-colors.js","./hax-shared-styles.js"],function(_exports,_require,_polymerElement,_polymerDom,_haxutils,_simpleColors,_haxSharedStyles){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.HaxPreview=void 0;_require=babelHelpers.interopRequireWildcard(_require);/**
 * `hax-preview`
 ...
 */class HaxPreview extends _polymerElement.PolymerElement{constructor(){super();new Promise((res,rej)=>_require.default(["../../../@polymer/paper-card/paper-card.js"],res,rej));new Promise((res,rej)=>_require.default(["../../../@polymer/paper-tabs/paper-tabs.js"],res,rej));new Promise((res,rej)=>_require.default(["../../../@polymer/paper-tabs/paper-tab.js"],res,rej));new Promise((res,rej)=>_require.default(["../../../@polymer/paper-button/paper-button.js"],res,rej));new Promise((res,rej)=>_require.default(["../../../@polymer/iron-icons/iron-icons.js"],res,rej));new Promise((res,rej)=>_require.default(["../../../@vaadin/vaadin-split-layout/vaadin-split-layout.js"],res,rej));new Promise((res,rej)=>_require.default(["../../eco-json-schema-form/eco-json-schema-form.js"],res,rej));new Promise((res,rej)=>_require.default(["../../eco-json-schema-form/lib/eco-json-schema-object.js"],res,rej));new Promise((res,rej)=>_require.default(["../../code-editor/code-editor.js"],res,rej));new Promise((res,rej)=>_require.default(["../../../@polymer/paper-input/paper-textarea.js"],res,rej));new Promise((res,rej)=>_require.default(["../../../app-datepicker/app-datepicker.js"],res,rej));new Promise((res,rej)=>_require.default(["../../../@polymer/paper-toggle-button/paper-toggle-button.js"],res,rej));new Promise((res,rej)=>_require.default(["./hax-upload-field.js"],res,rej));new Promise((res,rej)=>_require.default(["../../simple-picker/simple-picker.js"],res,rej));new Promise((res,rej)=>_require.default(["../../simple-icon-picker/simple-icon-picker.js"],res,rej));new Promise((res,rej)=>_require.default(["../../paper-input-flagged/paper-input-flagged.js"],res,rej))}static get template(){return _polymerElement.html`
      ...
      </vaadin-split-layout>`}static get tag(){return"hax-preview"}static get observers(){return["_valueChanged(value.*)"]}static get properties(){return{/**
