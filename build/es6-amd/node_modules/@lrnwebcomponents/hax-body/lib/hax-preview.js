 ...
 */(0,_polymerLegacy.Polymer)({_template:_polymerLegacy.html`
  ...
  `,is:"hax-preview",observers:["_valueChanged(value.*)"],properties:{/**
     ...
     */humanName:{type:String}},created:function(){new Promise((res,rej)=>_require.default(["../../code-editor/code-editor.js"],res,rej));new Promise((res,rej)=>_require.default(["../../../@polymer/paper-input/paper-textarea.js"],res,rej));new Promise((res,rej)=>_require.default(["../../../app-datepicker/app-datepicker.js"],res,rej));new Promise((res,rej)=>_require.default(["../../../@polymer/paper-toggle-button/paper-toggle-button.js"],res,rej));new Promise((res,rej)=>_require.default(["./hax-upload-field.js"],res,rej));new Promise((res,rej)=>_require.default(["../../simple-picker/simple-picker.js"],res,rej));new Promise((res,rej)=>_require.default(["../../simple-icon-picker/simple-icon-picker.js"],res,rej));new Promise((res,rej)=>_require.default(["../../paper-input-flagged/paper-input-flagged.js"],res,rej))},/**
