 ...
 */(0,_polymerLegacy.Polymer)({_template:_polymerLegacy.html`
  ...
  `,is:"hax-preview",observers:["_valueChanged(value.*)"],properties:{/**
     ...
     */humanName:{type:String}},created:function(){new Promise((res,rej)=>_require.default(["@lrnwebcomponents/code-editor/code-editor.js"],res,rej));new Promise((res,rej)=>_require.default(["@polymer/paper-input/paper-textarea.js"],res,rej));new Promise((res,rej)=>_require.default(["app-datepicker/app-datepicker.js"],res,rej));new Promise((res,rej)=>_require.default(["@polymer/paper-toggle-button/paper-toggle-button.js"],res,rej));new Promise((res,rej)=>_require.default(["@lrnwebcomponents/hax-body/lib/hax-upload-field.js"],res,rej));new Promise((res,rej)=>_require.default(["@lrnwebcomponents/simple-picker/simple-picker.js"],res,rej));new Promise((res,rej)=>_require.default(["@lrnwebcomponents/simple-icon-picker/simple-icon-picker.js"],res,rej));new Promise((res,rej)=>_require.default(["@lrnwebcomponents/paper-input-flagged/paper-input-flagged.js"],res,rej))},/**
   * Trigger cancel on manager as it is the parent here.
   */cancel:function(e){window.HaxStore.instance.haxManager.cancel(e)},/**
   * Trigger insert on manager as it is the parent here.
   */insert:function(e){window.HaxStore.instance.haxManager.insertHaxElement(e)},/**
   * Make a boolean to match the preview node's existance.
   */_computedHasPreviewNode:function(previewNode){if(typeof previewNode.tagName===typeof void 0){return!1}else{return!0}},/**
   * Edit source.
   ...
   */_formKeyChanged:function(newValue,oldValue){// ensure this doesn't run the 1st pass
...
try{this.previewNode.set(property,element.properties[property])}catch(e){console.warn(`${property} is busted some how`);console.log(e)}}else if("prefix"===property){this.previewNode.setAttribute("prefix",element.properties[property])}else{console.warn(`${property} is busted some how`)}}this.set("value."+property,element.properties[property]);this.notifyPath("value."+property)}}var slotsApplied=!1;for(var prop in props.settings[newValue]){let previewNode=this.previewNode;if(typeof props.settings[this.formKey][prop].slot!==typeof void 0&&!slotsApplied){slotsApplied=!0;// walk through the slots looking for the value of it
...
if(typeof(0,_polymerDom.dom)(previewNode).getEffectiveChildNodes()[i]!==typeof void 0&&1===(0,_polymerDom.dom)(previewNode).getEffectiveChildNodes()[i].nodeType&&(0,_polymerDom.dom)(previewNode).getEffectiveChildNodes()[i].slot===props.settings[this.formKey][prop].slot){if(typeof(0,_polymerDom.dom)(previewNode).getEffectiveChildNodes()[i].innerHTML!==typeof void 0){schema.properties[props.settings[this.formKey][prop].slot].value=(0,_polymerDom.dom)(previewNode).getEffectiveChildNodes()[i].innerHTML;this.set("value."+props.settings[this.formKey][prop].slot,(0,_polymerDom.dom)(previewNode).getEffectiveChildNodes()[i].innerHTML);this.notifyPath("value."+props.settings[this.formKey][prop].slot)}}}}}}this.set("schema",{});this.set("schema",schema)}},/**
   ...
   */_previewNodeChanged:function(newValue,oldValue){// ensure this doesn't run the 1st pass
...
if(typeof(0,_polymerDom.dom)(newValue).getEffectiveChildNodes()[i]!==typeof void 0&&1===(0,_polymerDom.dom)(newValue).getEffectiveChildNodes()[i].nodeType&&(0,_polymerDom.dom)(newValue).getEffectiveChildNodes()[i].slot===props.settings[this.formKey][prop].slot){if(typeof(0,_polymerDom.dom)(newValue).getEffectiveChildNodes()[i].innerHTML!==typeof void 0){schema.properties[props.settings[this.formKey][prop].slot].value=(0,_polymerDom.dom)(newValue).getEffectiveChildNodes()[i].innerHTML;this.set("value."+props.settings[this.formKey][prop].slot,(0,_polymerDom.dom)(newValue).getEffectiveChildNodes()[i].innerHTML);this.notifyPath("value."+props.settings[this.formKey][prop].slot)}}}}}this.set("schema",{});this.set("schema",schema)}}},/**
   ...
   */_elementChanged:function(newValue,oldValue){if(typeof newValue!==typeof void 0){// wipe the preview area and assocaited node
...
this.set("previewNode",newNode)}}else{this.modeTab="advanced";this.set("previewNode",{})}},/**
   ...
   */_valueChanged:function(valueChange){var node=this.previewNode;// sanity check and then get props and mesh with form value response
