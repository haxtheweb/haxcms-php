define(["require","../../../@polymer/polymer/polymer-legacy.js","../../../@polymer/polymer/lib/utils/render-status.js","../../dl-behavior/dl-behavior.js","./hax-shared-styles.js"],function(_require,_polymerLegacy,_renderStatus,_dlBehavior,_haxSharedStyles){"use strict";_require=babelHelpers.interopRequireWildcard(_require);/**
`hax-export-dialog`
...
*/(0,_polymerLegacy.Polymer)({_template:_polymerLegacy.html`
  ...
  `,is:"hax-export-dialog",behaviors:[mtz.FileDownloadBehaviors],properties:{/**
     * Title when open.
...
document.body.addEventListener("hax-store-property-updated",this._haxStorePropertyUpdated.bind(this));this.shadowRoot.querySelector("#download").addEventListener("tap",this.download.bind(this));this.shadowRoot.querySelector("#downloadfull").addEventListener("tap",this.downloadfull.bind(this));this.shadowRoot.querySelector("#import").addEventListener("tap",this.importContent.bind(this));this.shadowRoot.querySelector("#copy").addEventListener("tap",this.selectBody.bind(this));this.shadowRoot.querySelector("#closedialog").addEventListener("tap",this.close.bind(this));this.shadowRoot.querySelector("#elementexport").addEventListener("tap",this.htmlToHaxElements.bind(this))})},/**
   * Detached life cycle
   */detached:function(){document.body.removeEventListener("hax-store-property-updated",this._haxStorePropertyUpdated.bind(this));this.shadowRoot.querySelector("#download").removeEventListener("tap",this.download.bind(this));this.shadowRoot.querySelector("#downloadfull").removeEventListener("tap",this.downloadfull.bind(this));this.shadowRoot.querySelector("#import").removeEventListener("tap",this.importContent.bind(this));this.shadowRoot.querySelector("#copy").removeEventListener("tap",this.selectBody.bind(this));this.shadowRoot.querySelector("#closedialog").removeEventListener("tap",this.close.bind(this));this.shadowRoot.querySelector("#elementexport").removeEventListener("tap",this.htmlToHaxElements.bind(this))},/**
   * Store updated, sync.
   ...
   * Download file.
   */download:function(e){const data=this.contentToFile(!1);this.downloadFromData(data,"html","my-new-code");window.HaxStore.toast("HTML content downloaded")},/**
   * Download file.
   */downloadfull:function(e){const data=this.contentToFile(!0);this.downloadFromData(data,"html","my-new-webpage");window.HaxStore.toast("Working offline copy downloaded")},/**
   * Download file.
   */importContent:function(e){// import contents of this text area into the activeHaxBody
...
content=`
   ...
   * Toggle ourselves.
   */toggleDialog:function(){if(this.shadowRoot.querySelector("#dialog").opened){this.close()}else{this.shadowRoot.querySelector("#textarea").editorValue=this.contentToFile(!1);window.HaxStore.instance.closeAllDrawers(this)}},created:function(){new Promise((res,rej)=>_require.default(["@polymer/paper-dialog/paper-dialog.js"],res,rej))},/**
   * open the dialog
   */open:function(){new Promise((res,rej)=>_require.default(["@polymer/iron-icon/iron-icon.js"],res,rej));new Promise((res,rej)=>_require.default(["@polymer/iron-icons/iron-icons.js"],res,rej));new Promise((res,rej)=>_require.default(["@polymer/paper-input/paper-input.js"],res,rej));new Promise((res,rej)=>_require.default(["@polymer/paper-button/paper-button.js"],res,rej));new Promise((res,rej)=>_require.default(["@lrnwebcomponents/code-editor/code-editor.js"],res,rej));new Promise((res,rej)=>_require.default(["@lrnwebcomponents/hexagon-loader/hexagon-loader.js"],res,rej));this.shadowRoot.querySelector("#dialog").open();this.shadowRoot.querySelector("#buttons").style.display="none";this.shadowRoot.querySelector("#loading").setAttribute("loading","loading");this.shadowRoot.querySelector("#wrapper").appendChild(this.shadowRoot.querySelector("#textarea"));// silly but we need the code editor to figure itself out real quick as to sizing
setTimeout(()=>{this.shadowRoot.querySelector("#loading").removeAttribute("loading");this.shadowRoot.querySelector("#buttons").style.display="unset"},800)},/**
   * close the dialog
   */close:function(){this.shadowRoot.querySelector("#dialog").close()}})});