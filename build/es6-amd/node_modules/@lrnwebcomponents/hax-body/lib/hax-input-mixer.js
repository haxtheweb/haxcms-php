define(["exports", "require", "../../../@polymer/polymer/polymer-element.js", "../../../@polymer/polymer/lib/utils/render-status.js", "../../../@polymer/polymer/lib/legacy/polymer.dom.js", "./hax-shared-styles.js"], function (_exports, _require, _polymerElement, _renderStatus, _polymerDom, _haxSharedStyles) {
   ...
   */
  class HaxImportMixer extends _polymerElement.PolymerElement {
    constructor() {
      super();
    ...
    ready() {
      super.ready(); // prime methods even though invisible most likely
    ...
    _inputMethodChanged(newValue, oldValue) {
      if (newValue != null && typeof oldValue !== typeof undefined) {
        let method = newValue;
        let methods = this.validInputMethods(); // ensure this is a valid method of input
        ...
        if (methods.includes(method)) {
          ...
          setTimeout(() => {
            if (typeof this.shadowRoot.querySelector("#input").hideMenu === "function") {
