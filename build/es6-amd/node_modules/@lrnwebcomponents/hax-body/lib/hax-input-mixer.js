...
*/(0,_polymerLegacy.Polymer)({_template:_polymerLegacy.html`
  ...
  `,is:"hax-input-mixer",listeners:{"hax-context-item-selected":"_haxContextOperation"},properties:{/**
   ...
   */ready:function(){// prime methods even though invisible most likely
this._resetInputMethods()},/**
   * Input method changes, allow our templates to rebind correctly.
   */_inputMethodChanged:function(newValue,oldValue){if(null!=newValue&&typeof oldValue!==typeof void 0){let method=newValue,methods=this.validInputMethods();// ensure this is a valid method of input
...
setTimeout(()=>{if("function"===typeof this.shadowRoot.querySelector("#input").hideMenu){this.shadowRoot.querySelector("#input").hideMenu()}this.shadowRoot.querySelector("#input").focus()},200)}}},/**
   ...
   */validInputMethods:function(){var methods=["flipboolean","boolean","select","textfield","textarea","datepicker","haxupload","colorpicker","iconpicker","alt","number","code-editor","array"];return methods},/**
   * Reset all our meta attributes.
   */_resetInputMethods:function(){let methods=this.validInputMethods();for(var i=0;i<methods.length;i++){this["__input"+methods[i]]=!1}},/**
