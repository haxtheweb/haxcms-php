define(["exports","require","../../../@polymer/polymer/polymer-element.js","../../../@polymer/polymer/lib/utils/render-status.js","../../../@polymer/polymer/lib/legacy/polymer.dom.js"],function(_exports,_require,_polymerElement,_renderStatus,_polymerDom){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.HaxImportMixer=void 0,_require=babelHelpers.interopRequireWildcard(_require);class HaxImportMixer extends _polymerElement.PolymerElement{constructor(){super(),new Promise((res,rej)=>_require.default(["../../simple-colors/lib/simple-colors-picker.js"],res,rej)),new Promise((res,rej)=>_require.default(["../../../@polymer/paper-input/paper-textarea.js"],res,rej)),new Promise((res,rej)=>_require.default(["../../../@polymer/paper-input/paper-input.js"],res,rej)),new Promise((res,rej)=>_require.default(["../../../@polymer/paper-checkbox/paper-checkbox.js"],res,rej)),new Promise((res,rej)=>_require.default(["../../../@polymer/paper-slider/paper-slider.js"],res,rej)),new Promise((res,rej)=>_require.default(["../../../@polymer/paper-tooltip/paper-tooltip.js"],res,rej)),new Promise((res,rej)=>_require.default(["./hax-context-item-menu.js"],res,rej)),new Promise((res,rej)=>_require.default(["./hax-context-item.js"],res,rej))}static get template(){return _polymerElement.html`
      <style>
        :host {
          display: block;
          margin: 0;
