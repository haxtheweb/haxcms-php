...
*/(0,_polymerLegacy.Polymer)({_template:_polymerLegacy.html`
  ...
  `,is:"hax-panel",listeners:{"hax-item-selected":"_processItemEvent"},observers:["_globalPreferencesChanged(globalPreferences.*)"],properties:{/**
   ...
   */attached:function(){this.fire("hax-register-panel",this);document.body.addEventListener("hax-store-property-updated",this._haxStorePropertyUpdated.bind(this));document.body.addEventListener("hax-active-hover-name",this._activeNameChange.bind(this));document.body.addEventListener("hax-panel-operation",this._processItemEvent.bind(this))},/**
   * Detached life cycle
   */detached:function(){document.body.removeEventListener("hax-store-property-updated",this._haxStorePropertyUpdated.bind(this));document.body.removeEventListener("hax-active-hover-name",this._activeNameChange.bind(this));document.body.removeEventListener("hax-panel-operation",this._processItemEvent.bind(this))},_activeNameChange:function(e){this.activeOperationName=e.detail},/**
   * Global preference changed.
   */_globalPreferencesChanged:function(value){if(typeof value!==typeof void 0){if(null!=value.value&&typeof value.value.haxShowExportButton!==typeof void 0){this.hideExportButton=!value.value.haxShowExportButton}if(null!=value.value&&typeof value.value.haxDeveloperMode!==typeof void 0){this.haxDeveloperMode=value.value.haxDeveloperMode}}},/**
   * Store updated, sync.
   ...
   */_processItemEvent:function(e){let detail=e.detail;// support a simple insert event to bubble up or everything else
...
break;}},/**
   * _editModeChanged
   */_editModeChanged:function(newValue,oldValue){if(typeof newValue!==typeof void 0&&newValue){this.__tipText="Save";this.$.button.icon="save"}else{this.__tipText="Edit";this.$.button.icon="create"}},/**
   * Toggle the drawer when the button is clicked.
   */_clickEditButton:function(e){this.toggle()},/**
   * Toggle the drawer when the button is clicked.
   */_clickSaveButton:function(e){this.toggle();this.fire("hax-save",e.detail)},/**
   * HTML Export trigger.
   */_htmlExportDialog:function(e){window.HaxStore.instance.haxExport.toggleDialog()},/**
   * Preferences trigger.
   */_preferencesDialog:function(e){window.HaxStore.instance.haxPreferences.toggleDialog()},/**
   * Toggle the panel.
   */toggle:function(e){window.HaxStore.write("editMode",!this.editMode,this);this.$.drawer.opened=this.editMode;if(!this.$.drawer.opened){window.HaxStore.instance.closeAllDrawers()}}})});