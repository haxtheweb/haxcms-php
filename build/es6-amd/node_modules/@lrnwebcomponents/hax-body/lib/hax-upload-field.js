define(["exports","require","../../../lit-element/lit-element.js","../../simple-colors/simple-colors.js","../../utils/utils.js","../../simple-picker/simple-picker.js"],(function(_exports,_require,_litElement,_simpleColors,_utils,_simplePicker){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.HaxUploadField=void 0,_require=babelHelpers.interopRequireWildcard(_require);class HaxUploadField extends((0,_utils.winEventsElement)(_simpleColors.SimpleColors)){static get styles(){return[...super.styles,_litElement.css`:host{display:block;visibility:visible;transition:.3s all ease;box-sizing:border-box;pointer-events:all;overflow:visible;--simple-camera-snap-width:300px;--simple-camera-snap-height:calc(300px * 9 / 16);--simple-camera-snap-color:var(--eco-json-form-color, #222);--simple-camera-snap-background:var(--eco-json-form-bg, white);--simple-camera-snap-border-radius:2px;--lumo-font-family:var(
