define(["exports","require","../../../lit-element/lit-element.js","../../simple-colors/simple-colors.js","../../simple-picker/simple-picker.js"],function(_exports,_require,_litElement,_simpleColors,_simplePicker){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.HaxUploadField=void 0,_require=babelHelpers.interopRequireWildcard(_require);class HaxUploadField extends _simpleColors.SimpleColors{static get styles(){let styles=[];return super.styles&&(styles=super.styles),styles.push(_litElement.css`
      :host {
        display: block;
        visibility: visible;
    ...
    `),styles}constructor(){super(),this.label=null,new Promise((res,rej)=>_require.default(["../../../@polymer/paper-input/paper-input.js"],res,rej)),new Promise((res,rej)=>_require.default(["../../../@polymer/paper-icon-button/paper-icon-button.js"],res,rej)),new Promise((res,rej)=>_require.default(["../../../@vaadin/vaadin-upload/vaadin-upload.js"],res,rej))}render(){return _litElement.html`
