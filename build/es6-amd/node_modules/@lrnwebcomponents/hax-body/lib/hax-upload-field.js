define(["exports", "require", "../../../@polymer/polymer/polymer-element.js", "../../simple-colors/simple-colors.js", "./hax-shared-styles.js"], function (_exports, _require, _polymerElement, _simpleColors, _haxSharedStyles) {
  ...
  class HaxUploadField extends _polymerElement.PolymerElement {
    constructor() {
      super();
    ...
    disconnectedCallback() {
      this.shadowRoot.querySelector("#fileupload").removeEventListener("upload-before", this._fileAboutToUpload.bind(this));
      this.shadowRoot.querySelector("#fileupload").removeEventListener("upload-response", this._fileUploadResponse.bind(this));
