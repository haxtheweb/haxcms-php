 ...
 */(0,_polymerLegacy.Polymer)({_template:_polymerLegacy.html`
  ...
  `,is:"hax-schema-form",properties:{/**
     ...
     * JSON Schema.
     */advancedSchema:{type:Object,value:{schema:{}}}},attached:function(){(0,_renderStatus.afterNextRender)(this,function(){new Promise((res,rej)=>_require.default(["@polymer/paper-input/paper-textarea.js"],res,rej));new Promise((res,rej)=>_require.default(["app-datepicker/app-datepicker.js"],res,rej));new Promise((res,rej)=>_require.default(["@lrnwebcomponents/simple-picker/simple-picker.js"],res,rej));new Promise((res,rej)=>_require.default(["@lrnwebcomponents/simple-icon-picker/simple-icon-picker.js"],res,rej));new Promise((res,rej)=>_require.default(["@lrnwebcomponents/simple-colors/lib/simple-colors-picker.js"],res,rej));new Promise((res,rej)=>_require.default(["@lrnwebcomponents/paper-input-flagged/paper-input-flagged.js"],res,rej))})},/**
