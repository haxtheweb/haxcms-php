define(["exports","require","../../../@polymer/polymer/polymer-element.js","../../../@polymer/polymer/lib/utils/render-status.js","../../../@polymer/polymer/lib/utils/async.js","../../simple-colors/simple-colors.js","../../grafitto-filter/grafitto-filter.js","../../../@polymer/iron-list/iron-list.js","./hax-shared-styles.js"],function(_exports,_require,_polymerElement,_renderStatus,_async,_simpleColors,_grafittoFilter,_ironList,_haxSharedStyles){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.HaxGizmoBrowser=void 0,_require=babelHelpers.interopRequireWildcard(_require);class HaxGizmoBrowser extends _polymerElement.PolymerElement{constructor(){super(),new Promise((res,rej)=>_require.default(["@polymer/paper-input/paper-input.js"],res,rej)),new Promise((res,rej)=>_require.default(["@lrnwebcomponents/dropdown-select/dropdown-select.js"],res,rej)),new Promise((res,rej)=>_require.default(["@lrnwebcomponents/hax-body/lib/hax-gizmo-browser-item.js"],res,rej))}static get template(){return _polymerElement.html`
