define(["exports", "require", "../../../@polymer/polymer/polymer-element.js", "../../../@polymer/polymer/lib/utils/render-status.js", "../../../@polymer/polymer/lib/utils/async.js", "../../simple-colors/simple-colors.js", "../../grafitto-filter/grafitto-filter.js", "../../../@polymer/iron-list/iron-list.js", "./hax-shared-styles.js"], function (_exports, _require, _polymerElement, _renderStatus, _async, _simpleColors, _grafittoFilter, _ironList, _haxSharedStyles) {
   ...
   */
  class HaxGizmoBrowser extends _polymerElement.PolymerElement {
    constructor() {
      super();
      ...
      new Promise((res, rej) => _require.default(["@lrnwebcomponents/hax-body/lib/hax-gizmo-browser-item.js"], res, rej));
    }
      ...
      if (typeof this.shadowRoot.querySelector("#filter") !== typeof undefined) {
        _async.microTask.run(() => {
          ...
          if (this.shadowRoot.querySelector("#filter").shadowRoot.querySelector("#ironlist")) {
            this.shadowRoot.querySelector("#filter").shadowRoot.querySelector("#ironlist").filtered = this.__gizmoList;
          }
