define(["exports", "require", "../../../@polymer/polymer/polymer-element.js", "../../../@polymer/polymer/lib/utils/render-status.js", "../../simple-colors/simple-colors.js", "./hax-shared-styles.js"], function (_exports, _require, _polymerElement, _renderStatus, _simpleColors, _haxSharedStyles) {
  ...
  * @demo demo/index.html
  ...
  @microcopy - the mental model for this element
   -
  */
  class HaxPreferencesDialog extends _polymerElement.PolymerElement {
    constructor() {
      super();
      ...
      new Promise((res, rej) => _require.default(["@polymer/app-layout/app-drawer/app-drawer.js"], res, rej)); // add event listener
    ...
    ready() {
      super.ready(); // JSON schema object needs delayed to ensure page repaints the form
