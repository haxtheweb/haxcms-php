define(["exports", "meta", "require", "../../../@polymer/polymer/polymer-element.js", "../../../@polymer/polymer/lib/utils/async.js", "../../../@polymer/polymer/lib/utils/flattened-nodes-observer.js", "../../../@polymer/polymer/lib/utils/resolve-url.js", "../../hax-body-behaviors/hax-body-behaviors.js"], function (_exports, meta, _require, _polymerElement, async, _flattenedNodesObserver, _resolveUrl, _haxBodyBehaviors) {
   ...
   */
  class HaxAutoloader extends (0, _haxBodyBehaviors.HAXElement)(_polymerElement.PolymerElement) {
    static get template() {
    ...
    ready() {
      super.ready(); // fire an event that this is the manager
    ...
    processNewElements(e) {
      ...
      let effectiveChildren = _flattenedNodesObserver.FlattenedNodesObserver.getFlattenedNodes(this).filter(n => n.nodeType === Node.ELEMENT_NODE);
        ...
        if (typeof effectiveChildren[i].tagName !== typeof undefined && typeof this.processedList[effectiveChildren[i].tagName] === typeof undefined) {
          ...
          try {
            ...
            if (typeof effectiveChildren[i].getHaxProperties === "function") {
              ...
              new Promise((res, rej) => _require.default([`${basePath}../../${name}/${name}.js`], res, rej)).then(response => {
