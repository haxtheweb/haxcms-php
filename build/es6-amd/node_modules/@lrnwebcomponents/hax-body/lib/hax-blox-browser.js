define(["../../../@polymer/polymer/polymer-legacy.js","../../../@polymer/iron-list/iron-list.js","./hax-blox-browser-item.js","./hax-icons.js"],function(_polymerLegacy,_ironList,_haxBloxBrowserItem,_haxIcons){"use strict";/**
`hax-blox-browser`
...
*/(0,_polymerLegacy.Polymer)({_template:_polymerLegacy.html`
  ...
  `,is:"hax-blox-browser",properties:{/**
     * The list of blox
     */bloxList:{type:Array,observer:"_bloxListChanged"}},ready:function(){document.body.addEventListener("hax-store-property-updated",this._haxStorePropertyUpdated.bind(this))},/**
   * Attached life cycle
...
if(typeof this[e.detail.property]!==typeof void 0&&null!=this[e.detail.property]&&typeof this[e.detail.property].length!==typeof void 0){this.set(e.detail.property,[])}this.set(e.detail.property,e.detail.value)}},/**
   ...
   */_bloxListChanged:function(newValue,oldValue){if(typeof newValue!==typeof void 0){this.set("__bloxList",newValue)}},/**
   * Reset this browser.
   */resetBrowser:function(){setTimeout(()=>{this.$.ironlist.fire("iron-resize");window.dispatchEvent(new Event("resize"))},100)}})});