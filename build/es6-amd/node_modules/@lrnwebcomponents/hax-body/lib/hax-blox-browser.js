define(["exports","require","../../../@polymer/polymer/polymer-element.js"],function(_exports,_require,_polymerElement){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0/* transition */ /* transition */});_exports.HaxBloxBrowser=void 0;_require=babelHelpers.interopRequireWildcard(_require);/**
 * `hax-blox-browser`
 ...
 */class HaxBloxBrowser extends _polymerElement.PolymerElement{constructor(){super();new Promise((res,rej)=>_require.default(["../../../@polymer/iron-list/iron-list.js"],res,rej));new Promise((res,rej)=>_require.default(["./hax-blox-browser-item.js"],res,rej));new Promise((res,rej)=>_require.default(["./hax-icons.js"],res,rej))}static get template(){return _polymerElement.html`
      <style>
        :host {
          display: block;
        }
