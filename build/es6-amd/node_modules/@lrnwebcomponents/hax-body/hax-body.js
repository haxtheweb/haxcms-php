define(["exports","require","../../lit-element/lit-element.js","../simple-colors/simple-colors.js","../../@polymer/polymer/lib/utils/wrap.js","../../@polymer/polymer/lib/utils/flattened-nodes-observer.js","../../@polymer/polymer/lib/utils/flush.js","./lib/haxutils.js","./lib/hax-text-context.js","./lib/hax-ce-context.js","./lib/hax-plate-context.js","./lib/hax-input-mixer.js"],function(_exports,_require,_litElement,_simpleColors,_wrap,_flattenedNodesObserver,_flush,_haxutils,_haxTextContext,_haxCeContext,_haxPlateContext,_haxInputMixer){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.HaxBody=void 0,_require=babelHelpers.interopRequireWildcard(_require);class HaxBody extends _simpleColors.SimpleColors{static get styles(){return[_litElement.css`
        :host,
        :host * ::slotted(*) {
          line-height: 1.8;
        }
      ...
      `]}constructor(){super(),this.editMode=!1,this.globalPreferences={},this.haxRayMode=!1,this.activeNode=null,this.activeContainerNode=null,new Promise((res,rej)=>_require.default(["../../@polymer/iron-a11y-keys/iron-a11y-keys.js"],res,rej)),new Promise((res,rej)=>_require.default(["../../@polymer/paper-item/paper-item.js"],res,rej)),new Promise((res,rej)=>_require.default(["../grid-plate/grid-plate.js"],res,rej))}static get tag(){return"hax-body"}render(){return _litElement.html`
