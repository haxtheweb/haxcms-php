define(["exports", "require", "../../@polymer/polymer/polymer-element.js", "../../@polymer/polymer/lib/legacy/polymer.dom.js", "../../@polymer/polymer/lib/utils/flattened-nodes-observer.js", "../../@polymer/polymer/lib/utils/flush.js", "../../@polymer/polymer/lib/utils/render-status.js", "../../@polymer/polymer/lib/utils/async.js", "./lib/haxutils.js", "../simple-colors/simple-colors.js", "./lib/hax-text-context.js", "./lib/hax-ce-context.js", "./lib/hax-plate-context.js", "./lib/hax-input-mixer.js", "./lib/hax-shared-styles.js"], function (_exports, _require, _polymerElement, _polymerDom, _flattenedNodesObserver, _flush, _renderStatus, async, _haxutils, _simpleColors, _haxTextContext, _haxCeContext, _haxPlateContext, _haxInputMixer, _haxSharedStyles) {
   ...
   */
  class HaxBody extends _polymerElement.PolymerElement {
    constructor() {
      super();
      new Promise((res, rej) => _require.default(["@polymer/iron-a11y-keys/iron-a11y-keys.js"], res, rej));
      new Promise((res, rej) => _require.default(["@polymer/paper-item/paper-item.js"], res, rej));
      new Promise((res, rej) => _require.default(["@lrnwebcomponents/grid-plate/grid-plate.js"], res, rej));
    }
    ...
    hoverEvent(e) {
      if (this.editMode) {
        ...
        if (!this.$.platecontextmenu.classList.contains("hax-active-hover")) {
          let normalizedEvent = (0, _polymerDom.dom)(e);
    ...
    haxToContent() {
      ...
      let children = (0, _polymerDom.dom)(this.$.body).getDistributedNodes();
    ...
    haxChangeTagName(node, tagName, newNode) {
      ...
      try {
        ...
        setTimeout(() => {
          let children = (0, _polymerDom.dom)(replacement).getEffectiveChildNodes(); // see if there's a child element and focus that instead if there is
        ...
        while (fragment.firstChild !== null) {
          if (typeof fragment.firstChild.tagName !== typeof undefined) {
            ...
            if (window.HaxStore.instance._isSandboxed && fragment.firstChild.tagName.toLowerCase() === "iframe") {
              ...
              (0, _polymerDom.dom)(this).appendChild(replacement);
            } else {
              (0, _polymerDom.dom)(this).appendChild(fragment.firstChild);
            }
          } else {
    ...
    _applyContentEditable(status, target = this.$.body) {
      let children = (0, _polymerDom.dom)(target).getDistributedNodes(); // fallback for content nodes if not polymer managed nodes above
