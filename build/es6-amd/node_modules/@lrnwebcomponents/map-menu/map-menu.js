define(["exports","require","../../@polymer/polymer/polymer-element.js","../../@polymer/polymer/lib/utils/render-status.js","../smooth-scroll/smooth-scroll.js","./lib/map-menu-builder.js"],function(_exports,_require,_polymerElement,_renderStatus,_smoothScroll,_mapMenuBuilder){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.MapMenu=void 0,_require=babelHelpers.interopRequireWildcard(_require);class MapMenu extends _polymerElement.PolymerElement{constructor(){super(),new Promise((res,rej)=>_require.default(["@lrnwebcomponents/map-menu/lib/map-menu-container.js"],res,rej))}static get template(){return _polymerElement.html`
      <style>
        :host {
