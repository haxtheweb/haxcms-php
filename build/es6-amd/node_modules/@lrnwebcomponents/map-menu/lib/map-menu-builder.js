define(["exports", "require", "../../../@polymer/polymer/polymer-element.js", "../../../@polymer/polymer/lib/elements/dom-repeat.js", "../../../@polymer/polymer/lib/elements/dom-if.js"], function (_exports, _require, _polymerElement, _domRepeat, _domIf) {
  ...
  class MapMenuBuilder extends _polymerElement.PolymerElement {
    constructor() {
      super();
      new Promise((res, rej) => _require.default(["@lrnwebcomponents/map-menu/lib/map-menu-submenu.js"], res, rej));
      new Promise((res, rej) => _require.default(["@lrnwebcomponents/map-menu/lib/map-menu-item.js"], res, rej));
      new Promise((res, rej) => _require.default(["@lrnwebcomponents/map-menu/lib/map-menu-header.js"], res, rej));
    }
