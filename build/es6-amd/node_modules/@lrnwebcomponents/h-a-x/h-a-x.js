...
if(!delayRender){this.render()}window.addEventListener("hax-store-ready",this.storeReady.bind(this));// dynamically import definitions for all needed tags
new Promise((res,rej)=>_require.default(["@lrnwebcomponents/hax-body/hax-body.js"],res,rej));new Promise((res,rej)=>_require.default(["@lrnwebcomponents/hax-body/lib/hax-panel.js"],res,rej));new Promise((res,rej)=>_require.default(["@lrnwebcomponents/hax-body/lib/hax-autoloader.js"],res,rej));new Promise((res,rej)=>_require.default(["@lrnwebcomponents/hax-body/lib/hax-app.js"],res,rej));new Promise((res,rej)=>_require.default(["@lrnwebcomponents/hax-body/lib/hax-manager.js"],res,rej));new Promise((res,rej)=>_require.default(["@lrnwebcomponents/hax-body/lib/hax-app-picker.js"],res,rej));new Promise((res,rej)=>_require.default(["@lrnwebcomponents/hax-body/lib/hax-toolbar.js"],res,rej));new Promise((res,rej)=>_require.default(["@lrnwebcomponents/hax-body/lib/hax-preferences-dialog.js"],res,rej));new Promise((res,rej)=>_require.default(["@lrnwebcomponents/hax-body/lib/hax-stax-picker.js"],res,rej));new Promise((res,rej)=>_require.default(["@lrnwebcomponents/hax-body/lib/hax-blox-picker.js"],res,rej));new Promise((res,rej)=>_require.default(["@polymer/iron-icons/iron-icons.js"],res,rej));new Promise((res,rej)=>_require.default(["@polymer/iron-icons/editor-icons.js"],res,rej));new Promise((res,rej)=>_require.default(["@polymer/iron-icons/device-icons.js"],res,rej));new Promise((res,rej)=>_require.default(["@polymer/iron-icons/hardware-icons.js"],res,rej));new Promise((res,rej)=>_require.default(["@polymer/iron-icons/communication-icons.js"],res,rej));new Promise((res,rej)=>_require.default(["@lrnwebcomponents/lrn-icons/lrn-icons.js"],res,rej));new Promise((res,rej)=>_require.default(["@polymer/iron-icons/social-icons.js"],res,rej));new Promise((res,rej)=>_require.default(["@polymer/iron-icons/av-icons.js"],res,rej));new Promise((res,rej)=>_require.default(["@polymer/iron-icons/places-icons.js"],res,rej));new Promise((res,rej)=>_require.default(["@polymer/iron-icons/maps-icons.js"],res,rej));new Promise((res,rej)=>_require.default(["@polymer/iron-image/iron-image.js"],res,rej));new Promise((res,rej)=>_require.default(["@lrnwebcomponents/hax-body/lib/hax-export-dialog.js"],res,rej))}/**
   * life cycle, element is afixed to the DOM
   */connectedCallback(){if(super.connectedCallback){super.connectedCallback()}// this ensures it's only applied once
if(!this.__HAXApplied&&!window.__HAXApplied){window.__HAXApplied=this.__HAXApplied=this.applyHAX()}}_copyAttribute(name,to){const recipients=this.shadowRoot.querySelectorAll(to),value=this.getAttribute(name),fname=null==value?"removeAttribute":"setAttribute";for(const node of recipients){node[fname](name,value)}}_setProperty({name,value}){this[name]=value}storeReady(e){window.HaxStore.instance.appStore=JSON.parse(this.getAttribute("app-store"));// import into the active body if there's content
