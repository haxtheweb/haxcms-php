...
<hax-body>
    ...
    constructor(delayRender = false) {
      ...
      new Promise((res, rej) => _require.default(["@lrnwebcomponents/hax-body/hax-body.js"], res, rej));
      new Promise((res, rej) => _require.default(["@lrnwebcomponents/hax-body/lib/hax-panel.js"], res, rej));
      new Promise((res, rej) => _require.default(["@lrnwebcomponents/hax-body/lib/hax-autoloader.js"], res, rej));
      new Promise((res, rej) => _require.default(["@lrnwebcomponents/hax-body/lib/hax-app.js"], res, rej));
      new Promise((res, rej) => _require.default(["@lrnwebcomponents/hax-body/lib/hax-manager.js"], res, rej));
      new Promise((res, rej) => _require.default(["@lrnwebcomponents/hax-body/lib/hax-app-picker.js"], res, rej));
      new Promise((res, rej) => _require.default(["@lrnwebcomponents/hax-body/lib/hax-toolbar.js"], res, rej));
      new Promise((res, rej) => _require.default(["@lrnwebcomponents/hax-body/lib/hax-preferences-dialog.js"], res, rej));
      new Promise((res, rej) => _require.default(["@lrnwebcomponents/hax-body/lib/hax-stax-picker.js"], res, rej));
      new Promise((res, rej) => _require.default(["@lrnwebcomponents/hax-body/lib/hax-blox-picker.js"], res, rej));
      ...
      new Promise((res, rej) => _require.default(["@lrnwebcomponents/lrn-icons/lrn-icons.js"], res, rej));
      ...
      new Promise((res, rej) => _require.default(["@lrnwebcomponents/hax-iconset/hax-iconset.js"], res, rej));
      new Promise((res, rej) => _require.default(["@lrnwebcomponents/hax-body/lib/hax-export-dialog.js"], res, rej));
    }
    /**
