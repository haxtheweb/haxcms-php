define(["exports","meta","../../@polymer/polymer/polymer-element.js","../../@polymer/polymer/lib/utils/render-status.js","../../@polymer/polymer/lib/utils/resolve-url.js","../hax-body-behaviors/lib/HAXWiring.js","../schema-behaviors/schema-behaviors.js","../../@polymer/paper-styles/shadow.js"],function(_exports,meta,_polymerElement,_renderStatus,_resolveUrl,_HAXWiring,_schemaBehaviors,_shadow){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.LrndesignBlockquote=void 0,meta=babelHelpers.interopRequireWildcard(meta);class LrndesignBlockquote extends((0,_schemaBehaviors.SchemaBehaviors)(_polymerElement.PolymerElement)){constructor(){super(),(0,_renderStatus.afterNextRender)(this,function(){this.HAXWiring=new _HAXWiring.HAXWiring,this.HAXWiring.setup(LrndesignBlockquote.haxProperties,LrndesignBlockquote.tag,this)})}static get template(){return _polymerElement.html`
      <style>
        :host {
