 ...
 */let LrndesignBlockquote=(0,_polymerLegacy.Polymer)({_template:_polymerLegacy.html`
    <custom-style>
   ...
   * Notice display mode change activated so load the font
   */_displayModeChanged:function(newValue,oldValue){if("hypercard"==newValue){this.$.wrap.style.cssText="";this.$.thumb.style.cssText="";let style=document.createElement("style"),basePath=(0,_resolveUrl.pathFromUrl)(decodeURIComponent(meta.url));style.innerHTML=`@font-face {
