...
setTimeout(()=>{this.shadowRoot.querySelector("#sorter").direction="asc"},200)},/**
   ...
   */_changeActiveItem:function(e){document.body.classList.add("scroll-disabled");var normalizedEvent=(0,_polymerDom.dom)(e),local=normalizedEvent.localTarget,newstudent,newassignment;// use button id in order to move around in the grid as far as active
...
if(-1==index){index=keys.indexOf(parseInt(key))}if(-1==i&&0<index||1==i&&index<keys.length-1){return items[keys[index+i]]}else{return-1}},/**
   ...
   */_setActiveSubmission:function(e){var normalizedEvent=(0,_polymerDom.dom)(e),local=normalizedEvent.localTarget;this.__rememberClick=local;var item=local.id.split("-");// find the active elements
