define(["exports","../../../../@polymer/polymer/polymer-legacy.js","../../../../@polymer/paper-styles/color.js","../../../../@polymer/paper-styles/typography.js"],function(_exports,_polymerLegacy,_color,_typography){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0/* transition */ /* transition */});_exports.PaperChip=void 0;/**
...
@demo demo/chip.html
*/let PaperChip=(0,_polymerLegacy.Polymer)({_template:_polymerLegacy.html`
    <style>
      :host {
    ...
    <slot></slot>
  `,is:"paper-chip",properties:{selectable:{type:Boolean,value:!1,reflectToAttribute:!0}}});_exports.PaperChip=PaperChip});