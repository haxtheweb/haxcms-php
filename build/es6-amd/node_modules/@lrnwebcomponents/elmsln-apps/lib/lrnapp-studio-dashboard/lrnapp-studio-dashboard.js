define(["exports","../../../../@polymer/polymer/polymer-element.js","../../../../@polymer/paper-card/paper-card.js","../../../materializecss-styles/materializecss-styles.js","./lrnapp-block-recent-project.js","./lrnapp-block-recent-submissions.js","./lrnapp-block-recent-comments.js","./lrnapp-block-need-feedback.js"],function(_exports,_polymerElement,_paperCard,_materializecssStyles,_lrnappBlockRecentProject,_lrnappBlockRecentSubmissions,_lrnappBlockRecentComments,_lrnappBlockNeedFeedback){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.LrnappStudioDashboard=void 0;class LrnappStudioDashboard extends _polymerElement.PolymerElement{static get template(){return _polymerElement.html`
    ...
    </div>`}static get tag(){return"lrnapp-studio-dashboard"}static get properties(){return{username:{type:String,reflectToAttribute:!0},basePath:{type:String,notify:!0,reflectToAttribute:!0},csrfToken:{type:String,notify:!0,reflectToAttribute:!0},sourcePath:{type:String,notify:!0,reflectToAttribute:!0}}}_getEndPoint(basePath){return basePath+"lrnapp-studio-dashboard/blocks"}_getDataSource(csrfToken,basePath,dataPoint){return basePath+"lrnapp-studio-dashboard/blocks/"+dataPoint+"?token="+csrfToken}/**
   * Simple way to convert from object to array.
   */_toArray(obj){return Object.keys(obj).map(function(key){return obj[key]})}}_exports.LrnappStudioDashboard=LrnappStudioDashboard;window.customElements.define(LrnappStudioDashboard.tag,LrnappStudioDashboard)});