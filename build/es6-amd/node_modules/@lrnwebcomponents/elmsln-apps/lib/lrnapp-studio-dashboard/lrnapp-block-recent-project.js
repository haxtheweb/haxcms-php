define(["exports","../../../../@polymer/polymer/polymer-element.js","../../../../@polymer/iron-ajax/iron-ajax.js","../../../../@polymer/iron-icon/iron-icon.js","../../../../@polymer/iron-list/iron-list.js","../../../../@polymer/paper-card/paper-card.js","../../../../@polymer/polymer/lib/elements/dom-if.js","../../../../@polymer/paper-item/paper-item-shared-styles.js","../../../../@polymer/paper-button/paper-button.js","../../../lrnsys-button/lrnsys-button.js","../../../elmsln-loading/elmsln-loading.js","../../../materializecss-styles/materializecss-styles.js"],function(_exports,_polymerElement,_ironAjax,_ironIcon,_ironList,_paperCard,_domIf,_paperItemSharedStyles,_paperButton,_lrnsysButton,_elmslnLoading,_materializecssStyles){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.LrnappBlockRecentProject=void 0;class LrnappBlockRecentProject extends _polymerElement.PolymerElement{static get template(){return _polymerElement.html`
    ...
    </template>`}static get tag(){return"lrnapp-block-recent-project"}static get properties(){return{sourcePath:{type:String,notify:!0},response:{type:Object,notify:!0},project:{type:Object,notify:!0},hasProject:{type:Boolean,notify:!0,reflectToAttribute:!0,computed:"_getHasProject(project)"}}}/**
   ...
   * Generate an array.
   */_toArray(obj){return Object.keys(obj).map(function(key){return obj[key]})}}_exports.LrnappBlockRecentProject=LrnappBlockRecentProject;window.customElements.define(LrnappBlockRecentProject.tag,LrnappBlockRecentProject)});