...
window.location.href=this.basePath+"lrnapp-studio-submission/submissions/"+active}handleResponse(e){this.$.loading.hidden=!0}_toArray(obj){return Object.keys(obj).map(function(key){return obj[key]})}}_exports.LrnappBlockNeedFeedback=LrnappBlockNeedFeedback;window.customElements.define(LrnappBlockNeedFeedback.tag,LrnappBlockNeedFeedback)});