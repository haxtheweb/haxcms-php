...
*/(0,_polymerLegacy.Polymer)({_template:_polymerLegacy.html`
  ...
  `,is:"lrnapp-book-progress-dashboard",properties:{/**
   ...
   */_routeDataChanged:function(newValue,oldValue){if(typeof newValue!==typeof void 0){this.requestParams[newValue.type]=newValue.id;// if we're visible kick off the call
if(this.progressChanged){this.$.dataajax.generateRequest()}}},/**
   * Showing element state has changed
   */_showProgressChanged:function(newValue,oldValue){// ensure we are visible
if(newValue&&typeof this.routeData!==typeof void 0){this.$.dataajax.generateRequest()}},/**
   * Response data.
   */handleDataResponse:function(obj){let response=obj.detail.response.data;// show the info
