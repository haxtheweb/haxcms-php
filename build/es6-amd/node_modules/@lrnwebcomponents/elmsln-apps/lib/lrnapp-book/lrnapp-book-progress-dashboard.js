...
*/class LrnappBookProgressDashboard extends _polymerElement.PolymerElement{static get template(){return _polymerElement.html`
    ...
    </div>`}static get tag(){return"lrnapp-book-progress-dashboard"}static get properties(){return{/**
...
this.userData=response.userdata;this.dashboardItems=this._toArray(response.items)}/**
   ...
   */_toArray(obj){return Object.keys(obj).map(function(key){return obj[key]})}}_exports.LrnappBookProgressDashboard=LrnappBookProgressDashboard;window.customElements.define(LrnappBookProgressDashboard.tag,LrnappBookProgressDashboard)});