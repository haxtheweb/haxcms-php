...
*/class LrnappBook extends(0,_HAXCMSThemeWiring.HAXCMSTheme)(_polymerElement.PolymerElement){static get template(){return _polymerElement.html`
    ...
    </app-drawer-layout>`}static get tag(){return"lrnapp-book"}static get properties(){return{/**
...
if(this.editMode&&!newValue.page.meta.canUpdate){this.editMode=!1}}}/**
   ...
   */_toArray(obj){return Object.keys(obj).map(function(key){return obj[key]})}}_exports.LrnappBook=LrnappBook;window.customElements.define(LrnappBook.tag,LrnappBook)});