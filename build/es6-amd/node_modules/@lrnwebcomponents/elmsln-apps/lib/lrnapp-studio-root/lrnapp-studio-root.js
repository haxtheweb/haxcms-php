define(["../../../../@polymer/polymer/polymer-legacy.js","../../../../@polymer/app-route/app-location.js","../../../../@polymer/app-route/app-route.js","../../../../@polymer/iron-icon/iron-icon.js","../../../../@polymer/iron-list/iron-list.js","../../../../@polymer/iron-ajax/iron-ajax.js","../../../../@polymer/paper-card/paper-card.js","../../../../@polymer/iron-selector/iron-selector.js","../../../../@polymer/iron-pages/iron-pages.js","../../../lrnsys-button/lrnsys-button.js","../../../elmsln-loading/elmsln-loading.js","../lrnapp-studio-dashboard/lrnapp-studio-dashboard.js","../lrnapp-studio-kanban/lrnapp-studio-kanban.js","../lrnapp-open-studio/lrnapp-open-studio.js"],function(_polymerLegacy,_appLocation,_appRoute,_ironIcon,_ironList,_ironAjax,_paperCard,_ironSelector,_ironPages,_lrnsysButton,_elmslnLoading,_lrnappStudioDashboard,_lrnappStudioKanban,_lrnappOpenStudio){"use strict";(0,_polymerLegacy.Polymer)({_template:_polymerLegacy.html`
  ...
  `,is:"lrnapp-studio-root",properties:{/**
...
window.location.reload()}},/**
     ...
     */_deleteToast:function(deletetoast,old){if(typeof deletetoast!==typeof void 0){if("error"==deletetoast){this.$.toast.show("That submission on longer exists!")}else{this.$.toast.show("Submission deleted successfully!")}this.set("queryParams.deletetoast",void 0);this.notifyPath("queryParams.deletetoast")}},_dashboardClicked:function(e){this.set("route.path",this.basePath+"/lrnapp-studio-dashboard");this.notifyPath("route.path")},_kanbanClicked:function(e){this.set("route.path",this.basePath+"/lrnapp-studio-kanban");this.notifyPath("route.path")},_openstudioClicked:function(e){this.set("route.path",this.basePath+"/lrnapp-open-studio");this.notifyPath("route.path")},/**
