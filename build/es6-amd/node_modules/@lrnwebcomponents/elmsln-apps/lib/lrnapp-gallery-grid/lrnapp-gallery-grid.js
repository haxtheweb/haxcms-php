define(["../../../../@polymer/polymer/polymer-legacy.js","../../../../@polymer/iron-ajax/iron-ajax.js","../../../../@polymer/iron-scroll-threshold/iron-scroll-threshold.js","../../../../@polymer/iron-image/iron-image.js","../../../../@polymer/paper-button/paper-button.js","../../../elmsln-loading/elmsln-loading.js","../../../materializecss-styles/materializecss-styles.js"],function(_polymerLegacy,_ironAjax,_ironScrollThreshold,_ironImage,_paperButton,_elmslnLoading,_materializecssStyles){"use strict";(0,_polymerLegacy.Polymer)({_template:_polymerLegacy.html`
   ...
   */_triggerDialog:function(e){// make sure we found an image as we're going through here
if("IMG"==e.target.nextElementSibling.nodeName){this.activeImage=e.target.nextElementSibling.src;this.activeTitle=e.target.parentElement.title;this.activeAuthor=e.target.parentElement.author;this.activeComments=e.target.parentElement.comments;this.activeUrl=e.target.parentElement.openUrl;this.shadowRoot.querySelector("#dialog").toggle()}},_loadMoreData:function(e){this.shadowRoot.querySelector("#ajax").generateRequest();this.shadowRoot.querySelector("#threshold").clearTriggers()},/**
