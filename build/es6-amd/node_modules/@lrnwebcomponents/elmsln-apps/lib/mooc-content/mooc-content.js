 ...
 */class MoocContent extends _polymerElement.PolymerElement{static get template(){return _polymerElement.html`
    ...
    </main>`}static get tag(){return"mooc-content"}static get observers(){return["_routeChanged(data, route, endPoint)"]}static get properties(){return{/**
       * Source of data
...
var data=this.outlineData.data;if(("undefined"===typeof data?"undefined":typeof data)!==("undefined"===typeof void 0?"undefined":typeof void 0)){this.$.outlinemodal.innerHTML=data.outline;this.aliases=data.aliases}}/**
...
(0,_polymerDom.dom)(this.$.hackycontainer).appendChild(customStyle)}}_exports.MoocContent=MoocContent;window.customElements.define(MoocContent.tag,MoocContent)});