define(["../../../../@polymer/polymer/polymer-legacy.js","../../../../@polymer/paper-input/paper-input.js","../../../lrnsys-button/lrnsys-button.js","./lrnapp-studio-submission-media-editoverlay.js","./lrnapp-studio-submission-edit-images.js","./lrnapp-studio-submission-edit-files.js","./lrnapp-studio-submission-edit-video.js","./lrnapp-studio-submission-edit-links.js","./lrnapp-studio-submission-edit-textarea.js"],function(_polymerLegacy,_paperInput,_lrnsysButton,_lrnappStudioSubmissionMediaEditoverlay,_lrnappStudioSubmissionEditImages,_lrnappStudioSubmissionEditFiles,_lrnappStudioSubmissionEditVideo,_lrnappStudioSubmissionEditLinks,_lrnappStudioSubmissionEditTextarea){"use strict";(0,_polymerLegacy.Polymer)({_template:_polymerLegacy.html`
    <style>
      :host {
        display: block;
        padding: 16px;
  ...
  `,is:"lrnapp-studio-submission-edit",properties:{submission:{type:Object,notify:!0/* transition */ /* transition */},uploadFilesUrl:{type:String},newlink:{type:String},newvideo:{type:String},videoGenerateSourceUrl:{type:String},submission:{type:Object,notify:!0}},observers:["_bodyChanged(title)"],_publishClicked:function(e){this.set("submission.attributes.state","submission_ready");this.notifyPath("submission.attributes.state");this.fire("submissionPublishClicked")},_saveDraftClicked:function(e){this.set("submission.attributes.state","submission_in_progress");this.notifyPath("submission.attributes.state");this.fire("submissionSaveDraftClicked")},_deleteClicked:function(e){this.fire("submissionDeleteClicked")},/**
