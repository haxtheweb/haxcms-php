define(["../../../../@polymer/polymer/polymer-legacy.js","../../../../@polymer/iron-icon/iron-icon.js"],function(_polymerLegacy,_ironIcon){"use strict";(0,_polymerLegacy.Polymer)({_template:_polymerLegacy.html`
    <style>
      :host {
        display: block;
        font-size: 12px;
