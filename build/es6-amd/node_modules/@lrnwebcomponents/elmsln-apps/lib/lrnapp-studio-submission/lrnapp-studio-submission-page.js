define(["../../../../@polymer/polymer/polymer-legacy.js","../../../../@polymer/polymer/lib/legacy/polymer.dom.js","../../../../@polymer/polymer/lib/utils/async.js","../../../../@polymer/app-route/app-route.js","../../../../@polymer/iron-ajax/iron-ajax.js","../../../../@polymer/app-layout/app-toolbar/app-toolbar.js","../../../../@polymer/marked-element/marked-element.js","../../../../@polymer/iron-icon/iron-icon.js","../../../../@polymer/paper-dialog/paper-dialog.js","../../../../@polymer/paper-button/paper-button.js","../../../../@polymer/paper-badge/paper-badge.js","../../../../@polymer/paper-toast/paper-toast.js","../../../../@vaadin/vaadin-split-layout/vaadin-split-layout.js","../../../lrnsys-layout/lib/lrnsys-dialog.js","../../../lrnsys-button/lrnsys-button.js","../../../lrnsys-comment/lib/lrnsys-comment-list.js","../../../elmsln-loading/elmsln-loading.js","./lrnapp-studio-submission-object.js","./lrnapp-studio-submission-comments.js","./lrnapp-studio-submission-comment.js"],function(_polymerLegacy,_polymerDom,async,_appRoute,_ironAjax,_appToolbar,_markedElement,_ironIcon,_paperDialog,_paperButton,_paperBadge,_paperToast,_vaadinSplitLayout,_lrnsysDialog,_lrnsysButton,_lrnsysCommentList,_elmslnLoading,_lrnappStudioSubmissionObject,_lrnappStudioSubmissionComments,_lrnappStudioSubmissionComment){"use strict";async=babelHelpers.interopRequireWildcard(async);(0,_polymerLegacy.Polymer)({_template:_polymerLegacy.html`
   ...
   */_backToStudio:function(e){window.location.href=this.basePath+"lrnapp-open-studio"},/**
   * Go back to the studio relative to the app's path.
   */_backToKanban:function(e){window.location.href=this.basePath+"lrnapp-studio-kanban"},/**
   * Trigger the page router to invoke edit state.
   */_setEditRoute:function(e){this.set("route.path","edit");this.notifyPath("route.path")},/**
   * Trigger the page router to invoke edit state.
   */_resetRoute:function(e){this.set("route.path","");this.notifyPath("route.path")},/**
   * if we should show new badge based on new comment count.
   */displayNewBadge:function(count){if(0==count){return!0}return!1},_computeCommentsUrl:function(id,endPoint,csrfToken){return endPoint+"/api/submissions/"+id+"/comments?token="+csrfToken},_computeCommentsOpsUrl:function(id,endPoint,csrfToken){return endPoint+"/api/submissions/"+id+"/comments"},_computeCommentsStubUrl:function(id,endPoint,csrfToken){return endPoint+"/api/submissions/"+id+"/comments/create-stub?token="+csrfToken},_urlVarsChanged:function(id,endPoint){this.reqUrl=endPoint+"/api/submissions/"+id},_paramsChanged:function(csrfToken){var params=this.reqParams||{};params.token=csrfToken;this.reqParams=params},_handleResponse:function(data){// empty response means no access or deleted item
if(data.detail.response.data){this.set("submission",[]);this.set("submission",data.detail.response.data);async.microTask.run(()=>{window.dispatchEvent(new Event("resize"))})}},_isReply:function(data){this.thread=submission.relationships.comments.data.attributes.thread},_submissionSaveDraftClicked:function(e){this.saving=!0;this.shadowRoot.querySelector("#ajaxUpdateRequest").generateRequest()},_submissionPublishClicked:function(e){this.shadowRoot.querySelector("#publishdialog").open()},_submissionPublishConfirmed:function(e){this.saving=!0;this.shadowRoot.querySelector("#ajaxUpdateRequest").generateRequest()},_submissionDeleteClicked:function(e){this.shadowRoot.querySelector("#deletedialog").open()},_submissionDeleteConfirmed:function(e){this.saving=!0;this.$.ajaxDeleteRequest.generateRequest()},_handleUpdateResponse:function(res){var root=this,status=res.detail.response.status,submission=res.detail.response.data;root.saving=!1;if(200===status){root.set("submission",{});root.set("submission",submission);root.set("route.path","");// display a submission published notification
...
window.location.href=this.endPoint+"/submissions/"+submission.id}},_handleDeleteResponse:function(res){var root=this,status=res.detail.response.status;root.saving=!1;if(200===status){window.location.href=this.basePath+"lrnapp-studio-kanban?deletetoast"}},_computeShowComments:function(submission){try{var type=submission.meta.submissionType;if("critique"!==type&&"submission_ready"==submission.attributes.state){return!0}}catch(error){}return!1},/**
   ...
   */_toArray:function(obj){if("object"===typeof obj&&null!==obj){return Object.keys(obj).map(function(key){return obj[key]})}return[]}})});