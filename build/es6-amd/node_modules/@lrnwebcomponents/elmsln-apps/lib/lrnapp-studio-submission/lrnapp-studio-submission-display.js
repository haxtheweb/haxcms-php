define(["../../../../@polymer/polymer/polymer-legacy.js","../../../../@polymer/paper-card/paper-card.js","../../../../@polymer/marked-element/marked-element.js","../../../../@polymer/iron-image/iron-image.js","../../../image-inspector/image-inspector.js","../../../lrndesign-avatar/lrndesign-avatar.js","../../../word-count/word-count.js","../../../lrnsys-button/lrnsys-button.js","../../../lrndesign-contentblock/lrndesign-contentblock.js","../../../lrnsys-layout/lib/lrnsys-dialog.js"],function(_polymerLegacy,_paperCard,_markedElement,_ironImage,_imageInspector,_lrndesignAvatar,_wordCount,_lrnsysButton,_lrndesignContentblock,_lrnsysDialog){"use strict";(0,_polymerLegacy.Polymer)({_template:_polymerLegacy.html`
  ...
  `,is:"lrnapp-studio-submission-display",properties:{/**
     * Object that has all the details of a submission that
     * is being viewed.
     */submission:{type:Object,notify:!0/* transition */ /* transition */}},date:function(time){if(time){var parts=time.split("-");let times=time.split("T"),month=parts[2].split("T");times=times[1].split("-");return parts[1]+"/"+month[0]+" - "+times[0]}},/**
   ...
   */_isGif:function(url){if(-1!=url.indexOf(".gif")){return!0}return!1}})});