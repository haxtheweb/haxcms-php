define(["exports","require","../../@polymer/polymer/polymer-element.js","../../@polymer/polymer/lib/legacy/polymer.dom.js","../../@polymer/iron-ajax/iron-ajax.js","../../@polymer/iron-list/iron-list.js","./lib/site-card.js","../../@polymer/paper-button/paper-button.js"],function(_exports,_require,_polymerElement,_polymerDom,_ironAjax,_ironList,_siteCard,_paperButton){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.SitesListing=void 0,_require=babelHelpers.interopRequireWildcard(_require);class SitesListing extends _polymerElement.PolymerElement{constructor(){super(),new Promise((res,rej)=>_require.default(["@lrnwebcomponents/elmsln-loading/elmsln-loading.js"],res,rej))}static get template(){return _polymerElement.html`
      <style>
        :host {
          height: 100vh;
          display: flex;
