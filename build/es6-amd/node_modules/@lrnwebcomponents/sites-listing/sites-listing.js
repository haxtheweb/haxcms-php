define(["exports","require","../../@polymer/polymer/polymer-element.js","../../@polymer/polymer/lib/legacy/polymer.dom.js","../../@polymer/iron-ajax/iron-ajax.js"],function(_exports,_require,_polymerElement,_polymerDom,_ironAjax){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.SitesListing=void 0;_require=babelHelpers.interopRequireWildcard(_require);/**
 * Copyright 2018 The Pennsylvania State University
 * @license Apache-2.0, see License.md for full text.
 */ /**
 * `sites-listing`
 * @demo demo/index.html
 */class SitesListing extends _polymerElement.PolymerElement{constructor(){super();new Promise((res,rej)=>_require.default(["../../@polymer/iron-list/iron-list.js"],res,rej));new Promise((res,rej)=>_require.default(["../../@polymer/paper-button/paper-button.js"],res,rej));new Promise((res,rej)=>_require.default(["../elmsln-loading/elmsln-loading.js"],res,rej));new Promise((res,rej)=>_require.default(["./lib/site-card.js"],res,rej))}static get template(){return _polymerElement.html`
      <style>
        :host {
          height: 100vh;
          display: flex;
