define(["exports", "../../@polymer/polymer/polymer-element.js", "../../@polymer/iron-ajax/iron-ajax.js"], function (_exports, _polymerElement, _ironAjax) {
   ...
   */
  class JwtLogin extends _polymerElement.PolymerElement {
    static get template() {
    ...
    _jwtChanged(newValue, oldValue) {
      if ((newValue == null || newValue == "") && typeof oldValue !== typeof undefined) {
    ...
    ready() {
      super.ready(); // set jwt from local storage bin
