...
if(this.syncBody){(0,_flattenedNodesObserver.FlattenedNodesObserver)(window.HaxStore.instance.activeHaxBody,info=>{if(!this.__lock){this.__lock=!0;this.dispatchEvent(new CustomEvent("hax-body-content-changed",{bubbles:!0,cancelable:!0,composed:!0,detail:window.HaxStore.instance.activeHaxBody.haxToContent()}));setTimeout(()=>{this.__lock=!1},100)}})}}/**
   * Store updated, sync.
...
window.location=this.redirectLocation},1e3)}}}}_exports.CmsHax=CmsHax;window.customElements.define(CmsHax.tag,CmsHax)});