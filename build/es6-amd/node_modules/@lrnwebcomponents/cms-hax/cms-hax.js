...
*/let CmsHax=(0,_polymerLegacy.Polymer)({_template:_polymerLegacy.html`
    <style>
      :host {
        display: block;
        font-size: 16px;
...
if(this.syncBody){(0,_flattenedNodesObserver.FlattenedNodesObserver)(window.HaxStore.instance.activeHaxBody,info=>{if(!this.__lock){this.__lock=!0;this.fire("hax-body-content-changed",window.HaxStore.instance.activeHaxBody.haxToContent());setTimeout(()=>{this.__lock=!1},100)}})}},/**
   * Store updated, sync.
...
window.location=this.redirectLocation},1e3)}}}});_exports.CmsHax=CmsHax});