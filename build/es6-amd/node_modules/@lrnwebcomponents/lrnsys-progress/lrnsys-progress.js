define(["exports","meta","../../@polymer/polymer/polymer-legacy.js","../../@polymer/polymer/lib/utils/resolve-url.js","../../@polymer/paper-progress/paper-progress.js","./lib/lrnsys-progress-circle.js"],function(_exports,meta,_polymerLegacy,_resolveUrl,_paperProgress,_lrnsysProgressCircle){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.LrnsysProgress=void 0;meta=babelHelpers.interopRequireWildcard(meta);/**
 ...
 */let LrnsysProgress=(0,_polymerLegacy.Polymer)({_template:_polymerLegacy.html`
    <custom-style>
...
const active=this.active;this.set("active",0);this.set("active",active);this.notifyPath("active");return response}});_exports.LrnsysProgress=LrnsysProgress});