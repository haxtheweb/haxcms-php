define(["../../../@polymer/polymer/polymer-legacy.js","../../../@polymer/polymer/lib/legacy/polymer.dom.js","../../../@polymer/polymer/lib/utils/async.js","../../../@polymer/iron-dropdown/iron-dropdown.js"],function(_polymerLegacy,_polymerDom,async,_ironDropdown){"use strict";async=babelHelpers.interopRequireWildcard(async);/**
...
*/(function(Polymer){Polymer({_template:_polymerLegacy.html`
      <style>
        iron-dropdown {
    ...
    `,is:"paper-fab-morph",properties:{/**
       ...
       */horizontalAlign:{type:String,value:"left",reflectToAttribute:!0/* transition */ /* transition */},/**
       * The orientation against which to align the dropdown
