...
*/(function(Polymer){Polymer({_template:_polymerLegacy.html`
    ...
    `,is:"paper-fab-speed-dial",properties:{/**
       ...
       */closeAnimationConfig:{type:Array,value:function(){return[{name:"fade-out-animation",timing:{duration:200}}]}}},observers:["_updateDropdown(direction, offset)"],ready:function(){var fab=(0,_polymerDom.dom)(this.$.fabContainer).getDistributedNodes()[0];fab.addEventListener("tap",function(){this.$.dropdown.open()}.bind(this));var content=(0,_polymerDom.dom)(this.$.contentContainer).getDistributedNodes()[0];content.addEventListener("tap",function(){this.$.dropdown.close()}.bind(this))},/**
