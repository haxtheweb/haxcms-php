define(["exports", "require", "../../@polymer/polymer/polymer-element.js", "../../@polymer/polymer/lib/utils/render-status.js", "../../@polymer/polymer/lib/utils/flattened-nodes-observer.js", "../hax-body-behaviors/lib/HAXWiring.js", "../schema-behaviors/schema-behaviors.js", "../simple-modal/simple-modal.js", "../hax-iconset/hax-iconset.js"], function (_exports, _require, _polymerElement, _renderStatus, _flattenedNodesObserver, _HAXWiring, _schemaBehaviors, _simpleModal, _haxIconset) {
  ...
  */
  class LrnVocab extends (0, _schemaBehaviors.SchemaBehaviors)(_polymerElement.PolymerElement) {
    constructor() {
      super();
    ...
    openDialog(e) {
      let children = _flattenedNodesObserver.FlattenedNodesObserver.getFlattenedNodes(this).filter(n => n.nodeType === Node.ELEMENT_NODE);
