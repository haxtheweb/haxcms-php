define(["exports","require","../../@polymer/polymer/polymer-element.js","../../@polymer/polymer/lib/utils/render-status.js","../../@polymer/polymer/lib/utils/flattened-nodes-observer.js","../hax-body-behaviors/lib/HAXWiring.js","../schema-behaviors/schema-behaviors.js","../simple-modal/simple-modal.js"],function(_exports,_require,_polymerElement,_renderStatus,_flattenedNodesObserver,_HAXWiring,_schemaBehaviors,_simpleModal){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.LrnVocab=void 0,_require=babelHelpers.interopRequireWildcard(_require);class LrnVocab extends((0,_schemaBehaviors.SchemaBehaviors)(_polymerElement.PolymerElement)){constructor(){super(),new Promise((res,rej)=>_require.default(["@polymer/paper-button/paper-button.js"],res,rej))}static get template(){return _polymerElement.html`
      <style>
        :host {
          display: inline-flex;
