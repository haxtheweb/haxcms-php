...
static get properties(){return{/**
   ...
   */constructor(){super();const name="annyang",basePath=(0,_resolveUrl.pathFromUrl)(decodeURIComponent(meta.url)),location=`${basePath}lib/annyang/annyang.min.js`;window.addEventListener(`es-bridge-${name}-loaded`,this._annyangLoaded.bind(this));window.ESGlobalBridge.requestAvailability();window.ESGlobalBridge.instance.load(name,location);// check for speech synthesis API
