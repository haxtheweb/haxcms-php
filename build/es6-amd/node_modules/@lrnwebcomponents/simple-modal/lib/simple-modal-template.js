define(["exports","../../../@polymer/polymer/polymer-element.js","../simple-modal.js"],function(_exports,_polymerElement,_simpleModal){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0/* transition */ /* transition */});_exports.SimpleModalTemplate=void 0;/**
...
static get template(){return _polymerElement.html`
   ...
   */associateEvents(target,evt="tap",bubbles=!0,cancelable=!0){let root=this;target.addEventListener(evt,e=>{root.openModal(target,bubbles,cancelable)});return root.modal}/**
