define(["exports", "meta", "../../@polymer/polymer/polymer-element.js", "../../@polymer/polymer/lib/utils/resolve-url.js", "../es-global-bridge/es-global-bridge.js", "./lib/chartist-render-shared-styles.js"], function (_exports, meta, _polymerElement, _resolveUrl, _esGlobalBridge, _chartistRenderSharedStyles) {
   ...
   *
   */
  class ChartistRender extends _polymerElement.PolymerElement {
    // render function
    static get template() {
    ...
    _renderChart() {
      ...
      if (root !== undefined && typeof Chartist === "object" && root.$.chart !== null && root.data !== null) {
        if (root.type == "bar") {
    ...
    makeA11yTable(svg) {
      ...
      let table = ['<table summary="Each column is a series of data, and the first column is the data label.">', "<caption>" + title + "</caption>", "<tbody>"];
