...
static get properties(){return{dataSource:{name:"dataSource",type:"String"},data:{name:"data",type:"Array",notify:!0},method:{name:"method",type:"String",value:"GET"},search:{type:"String",notify:!0},results:{type:"Array",computed:"searched(data, search, index, minScore, limit)",notify:!0},noStopWords:{type:"Boolean",value:!1,notify:!0},fields:{type:"Array",value:[]},indexNoStopWords:{type:"Object"},index:{type:"Object",computed:"_createIndex(data, fields, noStopWords, __lunrLoaded)"},__lunrLoaded:{type:"Boolean"},limit:{type:"Number",value:500},minScore:{type:"Number",value:0},log:{type:"Boolean",value:!1}}}constructor(){super();const name="lunr",basePath=(0,_resolveUrl.pathFromUrl)(meta.url),location=`${basePath}../../lunr/lunr.js`;window.addEventListener(`es-bridge-${name}-loaded`,this._lunrLoaded.bind(this));window.ESGlobalBridge.requestAvailability();window.ESGlobalBridge.instance.load(name,location);if(window.ESGlobalBridge.imports&&window.ESGlobalBridge.imports[name]){this.__lunrLoaded=!0}}_lunrLoaded(e){// callback when loaded
this.__lunrLoaded=!0}/**
