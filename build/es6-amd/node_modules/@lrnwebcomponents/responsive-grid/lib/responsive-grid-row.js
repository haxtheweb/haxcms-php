...
*/let ResponsiveGridRow=(0,_polymerLegacy.Polymer)({_template:_polymerLegacy.html`
    <style>
      :host {
        display: block;
        width: 100%;
  ...
  `,is:"responsive-grid-row",properties:{/**
     ...
     */screen:{type:String,value:"xs",notify:!0,reflectToAttribute:!0}},attached:function(){let root=this;window.ResponsiveUtility.requestAvailability();root.fire("responsive-element",{element:root,attribute:"screen",relativeToParent:root.responsiveToParent})}});_exports.ResponsiveGridRow=ResponsiveGridRow});