define(["exports","../../../@polymer/polymer/polymer-element.js","../../responsive-utility/responsive-utility.js","./responsive-grid-col.js","./responsive-grid-clear.js"],function(_exports,_polymerElement,_responsiveUtility,_responsiveGridCol,_responsiveGridClear){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.ResponsiveGridRow=void 0;/**   
`responsive-grid-row`
A LRN element
...
*/class ResponsiveGridRow extends _polymerElement.PolymerElement{static get template(){return _polymerElement.html`
      <style>
        :host {
          display: block;
          width: 100%;
    ...
    `}static get tag(){return"responsive-grid-row"}static get properties(){return{/**
       ...
       */screen:{type:String,value:"xs",notify:!0,reflectToAttribute:!0}}}connectedCallback(){super.connectedCallback();window.ResponsiveUtility.requestAvailability();this.dispatchEvent(new CustomEvent("responsive-element",{bubbles:!0,cancelable:!0,composed:!0,detail:{element:root,attribute:"screen",relativeToParent:root.responsiveToParent}}))}}_exports.ResponsiveGridRow=ResponsiveGridRow;window.customElements.define(ResponsiveGridRow.tag,ResponsiveGridRow)});