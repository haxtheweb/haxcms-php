  ...
  */
  class LrnsysComment extends _polymerElement.PolymerElement {
    constructor() {
      ...
      new Promise((res, rej) => _require.default(["@lrnwebcomponents/moment-element/moment-element.js"], res, rej));
    }
    ...
    _editTrigger(e) {
      ...
      if (typeof this.comment !== typeof undefined && this.comment.actions.edit) {
        async.microTask.run(() => {
          ...
          this.$.commenteditor.hidden = !this.editform; // simple icon toggle
