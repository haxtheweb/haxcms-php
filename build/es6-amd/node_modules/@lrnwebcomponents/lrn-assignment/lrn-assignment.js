define(["exports","../../@polymer/polymer/polymer-legacy.js","../../@polymer/paper-card/paper-card.js","../../@polymer/paper-button/paper-button.js"],function(_exports,_polymerLegacy,_paperCard,_paperButton){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.LrnAssignments=_exports.LrnAssignment=void 0;/**
`lrn-assignment`

* @demo demo/index.html
*/let LrnAssignment=(0,_polymerLegacy.Polymer)({_template:_polymerLegacy.html`
    <style>
      :host {
        display: flex;
        width: 100%;
  ...
  `,is:"lrn-assignment",properties:{/**
     ...
     */details:{type:String},/**
     * url
     */url:{type:String},open:{type:Boolean,value:!1},complete:{type:Boolean,value:!1},actions:{type:Object}}});_exports.LrnAssignment=LrnAssignment;let LrnAssignments=(0,_polymerLegacy.Polymer)({_template:_polymerLegacy.html`
    <style>
      :host {
        display: flex;
        flex-wrap: wrap;
