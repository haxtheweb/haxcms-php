define(["exports","../../../@polymer/polymer/polymer-element.js","./a11y-media-behaviors.js","../../../@polymer/iron-a11y-keys/iron-a11y-keys.js","../../simple-search/lib/simple-search-content.js"],function(_exports,_polymerElement,_a11yMediaBehaviors,_ironA11yKeys,_simpleSearchContent){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.A11yMediaTranscriptCue=void 0;class A11yMediaTranscriptCue extends _a11yMediaBehaviors.A11yMediaBehaviors{static get properties(){return{active:{type:Boolean,reflectToAttribute:!0,computed:"_getActiveCue(cue,activeCues)",notify:!0,reflectToAttribute:!0},activeCues:{type:Array,value:null,notify:!0},cue:{type:Array,value:null},disabled:{type:Boolean,value:!1},text:{type:String,value:""}}}static get tag(){return"a11y-media-transcript-cue"}static get behaviors(){return[_a11yMediaBehaviors.A11yMediaBehaviors]}static get template(){return _polymerElement.html`
    ...
    `}connectedCallback(){super.connectedCallback()}ready(){super.ready();let search=this.search;this.disabled||(this.__target=this,this.setAttribute("aria-role","button"),this.setAttribute("controls",this.mediaId)),this.disableSearch||void 0===this.search||null===this.search||this.$.content.enableSearch(search),this.addEventListener("click",this._handleTap)}_getActiveCue(cue,activeCues){return!(null===activeCues||!activeCues.includes(cue.order.toString()))}_handleTap(e){this.dispatchEvent(new CustomEvent("cue-seek",{detail:this.cue.seek}))}}_exports.A11yMediaTranscriptCue=A11yMediaTranscriptCue,window.customElements.define(A11yMediaTranscriptCue.tag,A11yMediaTranscriptCue)});