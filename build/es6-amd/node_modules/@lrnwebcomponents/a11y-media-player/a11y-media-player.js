...
/**
   ...
   */
new Promise((res,rej)=>_require.default(["./lib/a11y-media-state-manager.js"],res,rej)),new Promise((res,rej)=>_require.default(["./lib/a11y-media-button.js"],res,rej)),new Promise((res,rej)=>_require.default(["./lib/a11y-media-transcript-cue.js"],res,rej)),new Promise((res,rej)=>_require.default(["./lib/a11y-media-youtube.js"],res,rej));class A11yMediaPlayer extends _simpleColors.SimpleColors{static get styles(){return[...super.styles,_litElement.css`:host{display:block;width:calc(100% - 2px);--a11y-media-player-height:unset;--a11y-media-color:var(
          ...
          );--paper-listbox-color:var(--a11y-media-settings-menu-color);--paper-listbox-padding:0;--paper-item-selected-color:var(
            --a11y-media-settings-menu-hover-color
          );--paper-item-focused-color:var(
            --a11y-media-settings-menu-hover-color
          );--paper-menu-button-background-color:var(
            --a11y-media-settings-menu-bg-color
          );--paper-menu-button-color:var(--a11y-media-settings-menu-color);--paper-menu-button-dropdown-background:var(
            --a11y-media-settings-menu-bg-color
          );--paper-menu-button-dropdown-background-color:var(
            --a11y-media-settings-menu-bg-color
          );--paper-menu-button-dropdown-color:var(
            --a11y-media-settings-menu-color
          );--paper-menu-button-dropdown-margin-top:0!important;--paper-menu-button-dropdown-margin-bottom:0!important;border:1px solid var(--a11y-media-border-color,var(--simple-colors-default-theme-grey-3));--a11y-media-settings-menu-color:var(--a11y-media-color);--a11y-media-settings-menu-bg-color:var(--a11y-media-bg-color);--a11y-media-settings-menu-hover-color:var(--a11y-media-hover-color);--a11y-media-settings-menu-hover-bg-color:var(
          ...
          );--paper-slider-active-color:var(--a11y-media-accent-color);--paper-slider-secondary-color:var(--a11y-media-faded-accent-color);--paper-slider-pin-color:var(--a11y-media-bg-color);--paper-slider-pin-start-color:var(--a11y-media-bg-color);--paper-slider-pin-end-color:var(--a11y-media-bg-color);--paper-slider-knob-color:var(--a11y-media-accent-color);--paper-slider-knob-start-color:var(--a11y-media-accent-color);--paper-slider-knob-end-color:var(--a11y-media-bg-accent-color);--paper-slider-knob-border-color:var(--a11y-media-accent-color);--paper-slider-knob-start-border-color:var(--a11y-media-bg-color);--paper-slider-knob-end-border-color:var(--a11y-media-bg-color);--paper-toast-color:var(--a11y-media-color);--paper-toast-background-color:var(--a11y-media-bg-color);--a11y-media-transcript-color:var(
