...
/**
   ...
   */
new Promise((res,rej)=>_require.default(["./lib/a11y-media-state-manager.js"],res,rej)),new Promise((res,rej)=>_require.default(["./lib/a11y-media-button.js"],res,rej)),new Promise((res,rej)=>_require.default(["./lib/a11y-media-transcript-cue.js"],res,rej)),new Promise((res,rej)=>_require.default(["./lib/a11y-media-youtube.js"],res,rej));class A11yMediaPlayer extends _simpleColors.SimpleColors{static get styles(){return[...super.styles,_litElement.css`
        :host {
          display: block;
          width: calc(100% - 2px);
