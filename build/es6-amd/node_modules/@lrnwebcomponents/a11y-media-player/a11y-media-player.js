...
class A11yMediaPlayer extends _simpleColors.SimpleColors{static get styles(){return[...super.styles,_litElement.css`
      ...
      <div class="sr-only" ?hidden="${void 0===this.mediaCaption}">
        ${this.mediaCaption}
      </div>
        ...
        >
          <div id="player" .style="${this.playerStyle}">
            ...
            <a11y-media-youtube
              ...
              t="${(0,_ifDefined.ifDefined)(this.t)}"
              video-id="${(0,_ifDefined.ifDefined)(this.videoId)}"
            ...
            >
              <div
                id="cc-text"
                ?hidden="${0===Object.keys(this.captionCues||[]).length}"
              >
      ...
      <img
        id="print-thumbnail"
        aria-hidden="true"
        src="${(0,_ifDefined.ifDefined)(this.poster)}"
      />
      <div
