define(["exports","require","../../@polymer/polymer/polymer-element.js","../../@polymer/polymer/lib/utils/render-status.js","../hax-body-behaviors/lib/HAXWiring.js","../schema-behaviors/schema-behaviors.js"],function(_exports,_require,_polymerElement,_renderStatus,_HAXWiring,_schemaBehaviors){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.FlashCard=void 0;_require=babelHelpers.interopRequireWildcard(_require);/**
 ...
 */class FlashCard extends(0,_schemaBehaviors.SchemaBehaviors)(_polymerElement.PolymerElement){static get template(){return _polymerElement.html`
    ...
    </paper-card>`}static get tag(){return"flash-card"}static get properties(){let props={/**
       * Title
       */title:{type:String}};if(super.properties){props=Object.assign(props,super.properties)}return props}constructor(){super();new Promise((res,rej)=>_require.default(["../../@polymer/paper-card/paper-card.js"],res,rej))}/**
   ...
   * Flip back
   */_flipback(e){this.shadowRoot.querySelected("#card").classList.remove("flipped")}}_exports.FlashCard=FlashCard;window.customElements.define(FlashCard.tag,FlashCard)});