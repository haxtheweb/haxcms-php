define(["exports","../../@polymer/polymer/polymer-legacy.js","../../@polymer/paper-card/paper-card.js","../materializecss-styles/materializecss-styles.js","../hax-body-behaviors/lib/HAXWiring.js","../schema-behaviors/schema-behaviors.js"],function(_exports,_polymerLegacy,_paperCard,_materializecssStyles,_HAXWiring,_schemaBehaviors){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.FlashCard=void 0;/**
...
*/let FlashCard=(0,_polymerLegacy.Polymer)({_template:_polymerLegacy.html`
...
let props={canScale:!0,canPosition:!0,canEditSource:!1,gizmo:{title:"Sample gizmo",description:"The user will be able to see this for selection in a UI.",icon:"av:play-circle-filled",color:"grey",groups:["Video","Media"],handles:[{type:"video",url:"source"}],meta:{author:"Your organization on github"}},settings:{quick:[{property:"title",title:"Title",description:"The title of the element",inputMethod:"textfield",icon:"editor:title"}],configure:[{property:"title",title:"Title",description:"The title of the element",inputMethod:"textfield",icon:"editor:title"}],advanced:[]}};this.setHaxProperties(props)},/**
   ...
   * Flip back
   */_flipback:function(e){this.$.card.classList.remove("flipped")}});_exports.FlashCard=FlashCard});