 ...
 */class CitationElement extends(0,_schemaBehaviors.SchemaBehaviors)(_polymerElement.PolymerElement){static get template(){return _polymerElement.html`
    <style>
      :host {
        display: block;
...
if((0,_polymerDom.dom)(this).previousElementSibling.getAttribute("resource")){this.relatedResource=(0,_polymerDom.dom)(this).previousElementSibling.getAttribute("resource")}else{let uuid=this.generateResourceID();this.relatedResource=uuid;(0,_polymerDom.dom)(this).previousElementSibling.setAttribute("resource",uuid)}// set prefix on the main element itself
...
if((0,_polymerDom.dom)(this).parentNode.getAttribute("resource")){this.relatedResource=(0,_polymerDom.dom)(this).parentNode.getAttribute("resource")}else{let uuid=this.generateResourceID();this.relatedResource=uuid;(0,_polymerDom.dom)(this).parentNode.setAttribute("resource",uuid)}// set prefix on the main element itself
(0,_polymerDom.dom)(this).parentNode.setAttribute("prefix",this.getAttribute("prefix"))}}/**
   ...
   */_licenseUpdated(newValue,oldValue){if(typeof newValue!==typeof void 0){var list=new _licenseElement.licenseList;if(typeof list[newValue]!==typeof void 0){this.licenseName=list[newValue].name;this.licenseLink=list[newValue].link;this.licenseImage=list[newValue].image}}}}_exports.CitationElement=CitationElement;window.customElements.define(CitationElement.tag,CitationElement)});