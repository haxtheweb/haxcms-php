...
*/let CitationElement=(0,_polymerLegacy.Polymer)({_template:_polymerLegacy.html`
    <style>
      :host {
        display: block;
...
if("select"==mode){var select={};for(var i in list){select[i]=list[i].name}return select}return list},/**
   ...
   */_licenseUpdated:function(newValue,oldValue){if(typeof newValue!==typeof void 0){var list=this.licenseList();if(typeof list[newValue]!==typeof void 0){this.licenseName=list[newValue].name;this.licenseLink=list[newValue].link;this.licenseImage=list[newValue].image}}}});_exports.CitationElement=CitationElement});