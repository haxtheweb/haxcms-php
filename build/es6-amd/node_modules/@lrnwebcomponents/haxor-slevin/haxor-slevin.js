define(["exports", "require", "../../@polymer/polymer/polymer-element.js", "../haxcms-elements/lib/core/HAXCMSThemeWiring.js", "../haxcms-elements/lib/core/haxcms-site-store.js", "../../mobx/lib/mobx.module.js", "../simple-colors/simple-colors.js", "../haxcms-elements/lib/ui-components/query/site-query.js", "../../@polymer/iron-pages/iron-pages.js", "../../@polymer/iron-icon/iron-icon.js", "../../@polymer/polymer/lib/elements/dom-repeat.js"], function (_exports, _require, _polymerElement, _HAXCMSThemeWiring, _haxcmsSiteStore, _mobxModule, _simpleColors, _siteQuery, _ironPages, _ironIcon, _domRepeat) {
   ...
   */
  class HaxorSlevin extends (0, _HAXCMSThemeWiring.HAXCMSTheme)(_polymerElement.PolymerElement) {
    // render function
    static get template() {
    ...
    constructor() {
      ...
      new Promise((res, rej) => _require.default(["@lrnwebcomponents/simple-blog-card/simple-blog-card.js"], res, rej));
      ...
      new Promise((res, rej) => _require.default(["@lrnwebcomponents/social-share-link/social-share-link.js"], res, rej));
    ...
    connectedCallback() {
      ...
      (0, _mobxModule.autorun)(reaction => {
        this._noticeLocationChange(_haxcmsSiteStore.store.location);
