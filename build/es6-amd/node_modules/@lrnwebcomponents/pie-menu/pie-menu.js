define(["exports","../../@polymer/polymer/polymer-legacy.js","../../@polymer/polymer/lib/legacy/polymer.dom.js","../../@polymer/iron-icons/iron-icons.js"],function(_exports,_polymerLegacy,_polymerDom,_ironIcons){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.PieMenu=void 0;/**
`pie-menu`
...
*/let PieMenu=(0,_polymerLegacy.Polymer)({_template:_polymerLegacy.html`
    <style>
      :host,
      :host > div {
        width: 200px;
   ...
   */_itemTapped:function(e){var normalizedEvent=(0,_polymerDom.dom)(e),localLink=normalizedEvent.localTarget;// make sure we normalize tap vs click vs keyboard
