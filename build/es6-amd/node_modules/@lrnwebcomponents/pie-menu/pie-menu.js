define(["exports","require","../../@polymer/polymer/polymer-element.js","../../@polymer/polymer/lib/legacy/polymer.dom.js"],function(_exports,_require,_polymerElement,_polymerDom){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.PieMenu=void 0,_require=babelHelpers.interopRequireWildcard(_require);class PieMenu extends _polymerElement.PolymerElement{constructor(){super(),new Promise((res,rej)=>_require.default(["@polymer/iron-icons/iron-icons.js"],res,rej))}static get template(){return _polymerElement.html`
      <style>
        :host,
        :host > div {
          width: 200px;
