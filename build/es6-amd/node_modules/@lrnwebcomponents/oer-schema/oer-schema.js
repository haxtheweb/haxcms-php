define(["exports","../../@polymer/polymer/polymer-legacy.js","../schema-behaviors/schema-behaviors.js","../hax-body-behaviors/lib/HAXWiring.js"],function(_exports,_polymerLegacy,_schemaBehaviors,_HAXWiring){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.OerSchema=void 0;/**
`oer-schema`
A LRN element to wrap an oer schema prefix onto materials.

* @demo demo/index.html
*/let OerSchema=(0,_polymerLegacy.Polymer)({_template:_polymerLegacy.html`
    <style>
      :host {
  ...
  `,is:"oer-schema",behaviors:[HAXBehaviors.PropertiesBehaviors,SchemaBehaviors.Schema],properties:{/**
