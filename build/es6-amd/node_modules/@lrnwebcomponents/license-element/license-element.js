define(["exports","../../@polymer/polymer/polymer-element.js","../../@polymer/polymer/lib/utils/render-status.js","../hax-body-behaviors/lib/HAXWiring.js","../schema-behaviors/schema-behaviors.js"],function(_exports,_polymerElement,_renderStatus,_HAXWiring,_schemaBehaviors){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.licenseList=_exports.LicenseElement=void 0;/**
 * `license-element`
 ...
 */class LicenseElement extends(0,_schemaBehaviors.SchemaBehaviors)(_polymerElement.PolymerElement){static get template(){return _polymerElement.html`
    ...
    </div>`}static get tag(){return"license-element"}static get properties(){let props={/**
       * Title of the work.
       */title:{type:String},/**
...
if(typeof link!==typeof void 0&&""!==link){return!0}return!1}/**
   ...
   */_licenseUpdated(newValue,oldValue){if(typeof newValue!==typeof void 0){var list=new licenseList;if(typeof list[newValue]!==typeof void 0){this.licenseName=list[newValue].name;this.licenseLink=list[newValue].link;this.licenseImage=list[newValue].image}}}}_exports.LicenseElement=LicenseElement;window.customElements.define(LicenseElement.tag,LicenseElement);/**
