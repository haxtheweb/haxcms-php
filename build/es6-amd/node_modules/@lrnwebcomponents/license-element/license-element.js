define(["exports","../../@polymer/polymer/polymer-legacy.js","../hax-body-behaviors/lib/HAXWiring.js","../schema-behaviors/schema-behaviors.js"],function(_exports,_polymerLegacy,_HAXWiring,_schemaBehaviors){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.LicenseElement=void 0;/**
`license-element`
...
*/let LicenseElement=(0,_polymerLegacy.Polymer)({_template:_polymerLegacy.html`
    <style>
      :host {
        display: block;
        font-size: 16px;
...
if("select"==mode){var select={};for(var i in list){select[i]=list[i].name}return select}return list},/**
   ...
   */_licenseUpdated:function(newValue,oldValue){if(typeof newValue!==typeof void 0){var list=this.licenseList();if(typeof list[newValue]!==typeof void 0){this.licenseName=list[newValue].name;this.licenseLink=list[newValue].link;this.licenseImage=list[newValue].image}}}});_exports.LicenseElement=LicenseElement});