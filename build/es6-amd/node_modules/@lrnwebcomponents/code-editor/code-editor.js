define(["exports", "meta", "require", "../../@polymer/polymer/polymer-element.js", "../../@polymer/polymer/lib/utils/flattened-nodes-observer.js", "../../@polymer/polymer/lib/legacy/polymer.dom.js", "../../@polymer/polymer/lib/utils/render-status.js", "../schema-behaviors/schema-behaviors.js"], function (_exports, meta, _require, _polymerElement, _flattenedNodesObserver, _polymerDom, _renderStatus, _schemaBehaviors) {
   ...
   */
  class CodeEditor extends (0, _schemaBehaviors.SchemaBehaviors)(_polymerElement.PolymerElement) {
    constructor() {
      super();
      this.__libPath = decodeURIComponent(meta.url) + "/../../../monaco-editor/min/vs";
      new Promise((res, rej) => _require.default(["@lrnwebcomponents/code-editor/lib/monaco-element/monaco-element.js"], res, rej));
      new Promise((res, rej) => _require.default(["@lrnwebcomponents/code-editor/lib/code-pen-button.js"], res, rej));
