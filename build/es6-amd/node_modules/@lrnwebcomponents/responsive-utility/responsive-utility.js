define(["exports","../../@polymer/polymer/polymer-legacy.js","../../@polymer/polymer/lib/utils/async.js","../../@polymer/iron-resizable-behavior/iron-resizable-behavior.js"],function(_exports,_polymerLegacy,async,_ironResizableBehavior){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.ResponsiveUtility=void 0;async=babelHelpers.interopRequireWildcard(async);window.ResponsiveUtility={};window.ResponsiveUtility.instance=null;let ResponsiveUtility=(0,_polymerLegacy.Polymer)({_template:_polymerLegacy.html`
    <style>
      :host {
        display: inline;
      }
