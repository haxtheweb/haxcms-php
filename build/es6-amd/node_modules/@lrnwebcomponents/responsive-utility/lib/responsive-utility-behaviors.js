define(["../responsive-utility.js"],function(_responsiveUtility){"use strict";/**
...
window.ResponsiveUtilityBehaviors={properties:{/*
   ...
   */attached:function(){window.ResponsiveUtility.requestAvailability();this.fire("responsive-element",{element:this,sm:this.sm,md:this.md,lg:this.lg,xl:this.xl,responsiveToParent:this.responsiveToParent,attribute:this.attribute})},/**
   * detached the element
   */detached:function(){this.fire("responsive-element-deleted",this)}}});