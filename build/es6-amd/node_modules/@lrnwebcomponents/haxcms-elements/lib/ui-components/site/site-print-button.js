...
new Promise((res,rej)=>_require.default(["@lrnwebcomponents/haxcms-elements/lib/ui-components/layout/site-footer.js"],res,rej));const type=this.type;let content="";if("page"===type){// oh there you are
content=`
