  ...
  class HAXCMSSiteEditor extends _litElement.LitElement {
    ...
    firstUpdated(changedProperties) {
      (0, _mobxEsm.autorun)(reaction => {
        this.editMode = (0, _mobxEsm.toJS)(_haxcmsSiteStore.store.editMode); // force import on editMode enabled

        if (this.editMode && (0, _mobxEsm.toJS)(_haxStore.HAXStore.activeHaxBody)) {
