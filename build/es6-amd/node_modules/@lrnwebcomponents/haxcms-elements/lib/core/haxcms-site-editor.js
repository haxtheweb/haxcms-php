  ...
  class HAXCMSSiteEditor extends _polymerElement.PolymerElement {
    ...
    ready() {
      ...
      (0, _renderStatus.afterNextRender)(this, function () {
        ...
        new Promise((res, rej) => _require.default(["@lrnwebcomponents/hax-body/lib/hax-schema-form.js"], res, rej));
    ...
    saveOutline(e) {
      console.log(e); // now let's work on the outline
    ...
    saveManifest(e) {
      ...
      if (values.cssVariable) {
        values.hexCode = window.SimpleColorsUtilities.colors[values.cssVariable.replace("--simple-colors-default-theme-", "").replace("-7", "")][6];
      }
