  ...
  class HAXCMSEditorBuilder extends _polymerElement.PolymerElement {
    ...
    applyContext(context = null) {
      ...
      if (context !== "published") {
        ...
        new Promise((res, rej) => _require.default([`${basePath}backends/${_haxcmsSiteStore.store.cmsSiteEditor.tag}.js`], res, rej)).then(e => {
          let haxCmsSiteEditorElement = document.createElement(_haxcmsSiteStore.store.cmsSiteEditor.tag);
