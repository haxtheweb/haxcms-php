 ...
 */class HAXCMSSiteEditorUI extends _polymerElement.PolymerElement{/**
   ...
   */static get tag(){return"haxcms-site-editor-ui"}constructor(){super();new Promise((res,rej)=>_require.default(["@polymer/paper-tooltip/paper-tooltip.js"],res,rej));new Promise((res,rej)=>_require.default(["@polymer/paper-icon-button/paper-icon-button.js"],res,rej));new Promise((res,rej)=>_require.default(["@lrnwebcomponents/simple-modal/simple-modal.js"],res,rej));new Promise((res,rej)=>_require.default(["@lrnwebcomponents/haxcms-elements/lib/core/haxcms-outline-editor-dialog.js"],res,rej));new Promise((res,rej)=>_require.default(["@polymer/iron-icons/editor-icons.js"],res,rej));new Promise((res,rej)=>_require.default(["@polymer/paper-fab/paper-fab.js"],res,rej))}// render function
static get template(){return _polymerElement.html`
    ...
    `}static get properties(){return{/**
       ...
       */manifestEditMode:{type:Boolean,reflectToAttribute:!0,observer:"_manifestEditModeChanged",value:!1,notify:!0},activeTitle:{type:String}}}connectedCallback(){super.connectedCallback();this.__disposer=[];(0,_renderStatus.afterNextRender)(this,function(){(0,_mobxModule.autorun)(reaction=>{const activeItem=(0,_mobxModule.toJS)(_haxcmsSiteStore.store.activeItem);if(activeItem&&activeItem.id){this.activeTitle=activeItem.title;this.pageAllowed=!0}else{this.pageAllowed=!1}this.__disposer.push(reaction)})})}disconnectedCallback(){for(var i in this.__disposer){this.__disposer[i].dispose()}super.disconnectedCallback()}/**
   * toggle state on button tap
   */_editButtonTap(e){this.editMode=!this.editMode;_haxcmsSiteStore.store.cmsSiteEditor.instance.haxCmsSiteEditorElement.editMode=this.editMode;// save button shifted to edit
if(!this.editMode){this.dispatchEvent(new CustomEvent("haxcms-save-node",{bubbles:!0,composed:!0,cancelable:!1,detail:_haxcmsSiteStore.store.activeItem}))}}_editDetailsButtonTap(e){var normalizedEvent=(0,_polymerDom.dom)(e);const evt=new CustomEvent("haxcms-load-node-fields",{bubbles:!0,composed:!0,cancelable:!1,detail:normalizedEvent.localTarget});window.dispatchEvent(evt)}/**
   * toggle menu state
   */_menuButtonTap(e){this.menuMode=!this.menuMode}_cancelButtonTap(e){this.editMode=!1;_haxcmsSiteStore.store.cmsSiteEditor.instance.haxCmsSiteEditorElement.editMode=!1;this.dispatchEvent(new CustomEvent("hax-cancel",{bubbles:!0,composed:!0,cancelable:!1,detail:e.detail}))}/**
   * Add button hit
...
this.__editIcon="editor:mode-edit";this.__editText="Edit"}if(typeof oldValue!==typeof void 0){this.dispatchEvent(new CustomEvent("haxcms-edit-mode-changed",{bubbles:!0,composed:!0,cancelable:!1,detail:newValue}));window.HaxStore.write("editMode",newValue,this)}}/**
