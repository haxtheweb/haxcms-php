...
setTimeout(()=>{if(0===(0,_polymerDom.dom)(this).getEffectiveChildNodes().length){let frag=document.createRange().createContextualFragment(_haxcmsSiteStore.store.activeItemContent);(0,_polymerDom.dom)(this).appendChild(frag)}},50);(0,_elementMixin.updateStyles)();// store disposer so we can clean up later
