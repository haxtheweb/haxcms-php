      ...
      connectedCallback() {
        ...
        (0, _renderStatus.afterNextRender)(this, function () {
          ...
          (0, _mobxModule.autorun)(reaction => {
            ...
            if (__routerManifest && typeof __routerManifest.title !== typeof undefined) {
              document.title = __routerManifest.title;
            }

            if (__routerManifest && typeof __routerManifest.metadata !== typeof undefined && typeof __routerManifest.metadata.cssVariable !== typeof undefined) {
              // json outline schema changed, allow other things to react
              // fake way of forcing an update of these items
              let ary = __routerManifest.metadata.cssVariable.replace("--simple-colors-default-theme-", "").split("-");
