    ...
    return class extends SuperClass {
      ...
      connectedCallback() {
        ...
        (0, _renderStatus.afterNextRender)(this, function () {
          ...
          (0, _mobxModule.autorun)(reaction => {
            const __routerManifest = (0, _mobxModule.toJS)(_haxcmsSiteStore.store.routerManifest);

            if (__routerManifest && (0, _haxutils.varExists)(__routerManifest, "title")) {
              document.title = __routerManifest.title;
            }

            if (__routerManifest && (0, _haxutils.varExists)(__routerManifest, "metadata.theme.variables.cssVariable")) {
              // json outline schema changed, allow other things to react
              // fake way of forcing an update of these items
              let ary = __routerManifest.metadata.theme.variables.cssVariable.replace("--simple-colors-default-theme-", "").split("-");

              ary.pop(); // simple colors "accent color" property

              this.accentColor = ary.join("-"); // set this directly instead of messing w/ accentColor

              document.body.style.setProperty("--haxcms-color", (0, _haxutils.varGet)(__routerManifest, "metadata.theme.variables.hexCode", "#FFFFFF"));
            }
