define(["exports","require","../../../../../@polymer/polymer/polymer-element.js","../../../../../@polymer/polymer/lib/utils/settings.js","../../../../../@polymer/polymer/lib/utils/render-status.js","../../../../../@polymer/iron-ajax/iron-ajax.js","../../../../json-outline-schema/json-outline-schema.js","../../../../simple-toast/simple-toast.js","../../../../simple-modal/simple-modal.js","../../../../jwt-login/jwt-login.js","../../../../simple-colors/simple-colors.js","../../../../simple-colors/lib/simple-colors-picker.js","../../../../sites-listing/sites-listing.js","../../../../map-menu/map-menu.js"],function(_exports,_require,_polymerElement,_settings,_renderStatus,_ironAjax,_jsonOutlineSchema,_simpleToast,_simpleModal,_jwtLogin,_simpleColors,_simpleColorsPicker,_sitesListing,_mapMenu){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.HAXCMSSiteListing=void 0;_require=babelHelpers.interopRequireWildcard(_require);/**
...
static get template(){return _polymerElement.html`
   ...
   */__sitesResponseChanged(newValue){if(newValue){this.title=newValue.title;setTimeout(()=>{if(this.jwt){this.shadowRoot.querySelector("#siteslisting").shadowRoot.querySelector("#list").querySelector("[data-site-id=\"item-new\"]").hidden=!1;this.shadowRoot.querySelector("#mapmenu").shadowRoot.querySelector("#builder").shadowRoot.querySelector("#item-new").hidden=!1;this.shadowRoot.querySelector("#add").hidden=!1}else{this.shadowRoot.querySelector("#siteslisting").shadowRoot.querySelector("#list").querySelector("[data-site-id=\"item-new\"]").hidden=!0;this.shadowRoot.querySelector("#mapmenu").shadowRoot.querySelector("#builder").shadowRoot.querySelector("#item-new").hidden=!0;this.shadowRoot.querySelector("#add").hidden=!0}},100)}}_dataSourceChanged(newValue){if(newValue){this._dataSource=newValue+"?"+Math.floor(Date.now()/1e3)}}/**
...
this.shadowRoot.querySelector("#edit").click()}}}}_exports.HAXCMSSiteListing=HAXCMSSiteListing;window.customElements.define(HAXCMSSiteListing.tag,HAXCMSSiteListing)});