...
static get template(){return _polymerElement.html`
   ...
   */_sitesResponseChanged(newValue,oldValue){if(newValue){if(typeof newValue.items!==typeof void 0){this.title=newValue.title;this.set("sites",[]);this.set("sites",newValue.items);this.notifyPath("sites.*")}}}cleanLocation(location){return location.replace("/_sites/","").replace("/","")}static get properties(){return{__loading:{type:Boolean},jwtBody:{type:Object,value:{}},/**
       ...
       * Edit mode
       */editMode:{type:Boolean,notify:!0,reflectToAttribute:!0,value:!1,observer:"_editModeChanged"},hasSelectedItems:{type:Boolean,value:!1}}}/**
