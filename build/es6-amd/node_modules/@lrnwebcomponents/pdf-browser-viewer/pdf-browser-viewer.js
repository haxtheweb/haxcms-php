define(["exports","../../@polymer/polymer/polymer-legacy.js","../../@polymer/paper-card/paper-card.js","../../@polymer/paper-button/paper-button.js"],function(_exports,_polymerLegacy,_paperCard,_paperButton){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.PdfBrowserViewer=void 0;/**
@license
...
*/let PdfBrowserViewer=(0,_polymerLegacy.Polymer)({_template:_polymerLegacy.html`
    <style>
      :host {
        display: none;
      }
   ...
   */_download:function(){window.location=this.file}});_exports.PdfBrowserViewer=PdfBrowserViewer});