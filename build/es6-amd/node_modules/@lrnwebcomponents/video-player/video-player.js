define(["exports", "require", "../../@polymer/polymer/polymer-element.js", "../simple-colors/simple-colors.js", "../../@polymer/polymer/lib/utils/render-status.js", "../hax-body-behaviors/lib/HAXWiring.js", "../a11y-behaviors/a11y-behaviors.js", "../../@polymer/polymer/lib/elements/dom-repeat.js", "../../@polymer/polymer/lib/elements/dom-if.js", "../schema-behaviors/schema-behaviors.js", "../media-behaviors/media-behaviors.js"], function (_exports, _require, _polymerElement, _simpleColors, _renderStatus, _HAXWiring, _a11yBehaviors, _domRepeat, _domIf, _schemaBehaviors, _mediaBehaviors) {
   ...
   */
  class VideoPlayer extends (0, _mediaBehaviors.MediaBehaviorsVideo)((0, _a11yBehaviors.A11yBehaviors)((0, _schemaBehaviors.SchemaBehaviors)(_simpleColors.SimpleColors))) {
    // render function
    static get template() {
    ...
    constructor() {
      super();
      new Promise((res, rej) => _require.default(["@lrnwebcomponents/a11y-media-player/a11y-media-player.js"], res, rej));
    ...
    _getTrackData(track, tracks) {
      let temp = typeof tracks === "string" ? JSON.parse(tracks).slice() : tracks.slice();
    ...
    _computeSRC(source) {
      if (source !== null && typeof source !== undefined) {
        let type = this.sourceType !== undefined ? this.sourceType : window.MediaBehaviors.Video.getVideoType(source); // ensure that this is a valid url / cleaned up a bit
