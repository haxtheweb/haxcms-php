define(["exports", "require", "../../@polymer/polymer/polymer-element.js", "../../@polymer/polymer/lib/utils/render-status.js", "../simple-colors/simple-colors.js", "../hax-body-behaviors/lib/HAXWiring.js", "../schema-behaviors/schema-behaviors.js", "../a11y-behaviors/a11y-behaviors.js"], function (_exports, _require, _polymerElement, _renderStatus, _simpleColors, _HAXWiring, _schemaBehaviors, _a11yBehaviors) {
   ...
   */
  class SelfCheck extends (0, _schemaBehaviors.SchemaBehaviors)((0, _a11yBehaviors.A11yBehaviors)(_simpleColors.SimpleColors)) {
    constructor() {
      super();
    ...
    connectedCallback() {
      ...
      (0, _renderStatus.afterNextRender)(this, function () {
        ...
        new Promise((res, rej) => _require.default(["@lrnwebcomponents/user-action/user-action.js"], res, rej));
      });
    }
