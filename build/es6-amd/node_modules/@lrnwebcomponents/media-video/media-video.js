define(["exports","../../@polymer/polymer/polymer-legacy.js","../../@polymer/polymer/lib/legacy/polymer.dom.js"],function(_exports,_polymerLegacy,_polymerDom){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.MediaVideo=void 0;/**
 ...
 */let MediaVideo=(0,_polymerLegacy.Polymer)({_template:_polymerLegacy.html`
    <style>
      :host {
        display: block;
      }
...
video.setAttribute("src",videoIframeSrc)},_stopIframeVideo:function(video){video.setAttribute("src","")}});_exports.MediaVideo=MediaVideo});