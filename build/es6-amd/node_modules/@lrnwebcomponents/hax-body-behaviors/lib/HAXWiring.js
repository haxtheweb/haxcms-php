            ...
            if (typeof settings[value].property !== typeof undefined) {
              ...
              switch (settings[value].inputMethod) {
                ...
                case "iconpicker":
                  ...
                  let opts = settings[value].options !== undefined && settings[value].options !== null ? settings[value].options : [];
              ...
              } else if (typeof target.attributes[settings[value].attribute] !== typeof undefined) {
              ...
              for (var i in (0, _polymerDom.dom)(target).childNodes) {
                ...
                if (typeof (0, _polymerDom.dom)(target).childNodes[i] !== typeof undefined) {
                  ...
                  } else if ((0, _polymerDom.dom)(target).childNodes[i].nodeType !== 1 && typeof (0, _polymerDom.dom)(target).childNodes[i].textContent !== typeof undefined && (0, _polymerDom.dom)(target).childNodes[i].textContent !== "") {
