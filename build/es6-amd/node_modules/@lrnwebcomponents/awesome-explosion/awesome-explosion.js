define(["exports","../../@polymer/polymer/polymer-legacy.js"],function(_exports,_polymerLegacy){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.AwesomeExplosion=void 0;/**
 ...
 */let AwesomeExplosion=(0,_polymerLegacy.Polymer)({_template:_polymerLegacy.html`
    <style>
      :host {
   ...
   */_playSound:function(){if(typeof window.audio===typeof void 0){window.audio=new Audio(this.sound)}window.audio.play()}});_exports.AwesomeExplosion=AwesomeExplosion});