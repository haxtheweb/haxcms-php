define(["../../../@polymer/polymer/polymer-legacy.js","../../../@polymer/paper-button/paper-button.js"],function(_polymerLegacy,_paperButton){"use strict";/**
...
*/(0,_polymerLegacy.Polymer)({_template:_polymerLegacy.html`
  ...
  `,is:"editable-table-editor-insdel",listeners:{tap:"_onTap"},properties:{/**
   ...
   * Handle item tap
   */_onTap:function(e){let root=this,action=root.action,type=root.type,before=root.before,index=root.index,event=action+"-"+type.toLowerCase();if("insert"===action&&before&&"Row"===type){index--}else if("insert"===action&&!before&&"Row"!==type){index++}root.fire(event,index)}})});