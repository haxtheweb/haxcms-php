define(["../../../@polymer/polymer/polymer-legacy.js","../../../@polymer/paper-button/paper-button.js","../../../@polymer/paper-tooltip/paper-tooltip.js","../../../@polymer/iron-icons/iron-icons.js","./editable-table-iconset.js"],function(_polymerLegacy,_paperButton,_paperTooltip,_ironIcons,_editableTableIconset){"use strict";/**
...
*/(0,_polymerLegacy.Polymer)({_template:_polymerLegacy.html`
   ...
   */_getPressed:function(filtered){return filtered?"true":"false"},/**
   * listen for button tap
   */_onFilterTapped:function(){let root=this;root.fire("toggle-filter",root)}})});