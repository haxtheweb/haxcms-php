define(["../../../@polymer/polymer/polymer-legacy.js","../../../@polymer/paper-button/paper-button.js","../../../@polymer/iron-icons/iron-icons.js","./editable-table-iconset.js"],function(_polymerLegacy,_paperButton,_ironIcons,_editableTableIconset){"use strict";/**
`editable-table-sort`
...
*/(0,_polymerLegacy.Polymer)({_template:_polymerLegacy.html`
  ...
  `,is:"editable-table-sort",listeners:{tap:"_onSortTapped"},properties:{/**
   ...
   */_onSortTapped:function(){let root=this;root.fire("change-sort-mode",root)},/**
   * changes the sort mode
   */setSortMode:function(mode){this.sortMode=mode;this.__checked="asc"===mode?!0:"desc"===mode?mode:!1},/**
   * Is the column number is the same as the current sort column?
   */_isSorting:function(columnNumber,sortColumn){return columnNumber===sortColumn}})});