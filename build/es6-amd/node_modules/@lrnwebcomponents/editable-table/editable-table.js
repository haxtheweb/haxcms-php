...
*/let EditableTable=(0,_polymerLegacy.Polymer)({_template:_polymerLegacy.html`
    <style>
      :host {
        display: block;
        width: 100%;
   ...
   */toggleEditMode:function(edit){let temp;edit=edit!==void 0?edit:!this.editMode;if(edit){this.querySelector("editable-table-display").toggleFilter();this.querySelector("editable-table-display").sortData(!1);temp=this.querySelector("editable-table-display").getData();console.log(temp)}else{temp=this.querySelector("editable-table-editor").getData()}for(prop in temp){if("data"!==prop){this[prop]=temp[prop]}else{this.set("data",temp[prop])}}this.editMode=edit}});_exports.EditableTable=EditableTable});