define(["exports","meta","../../@polymer/polymer/polymer-legacy.js","../../@polymer/polymer/lib/utils/resolve-url.js","../es-global-bridge/es-global-bridge.js","./lib/md5.min.js"],function(_exports,meta,_polymerLegacy,_resolveUrl,_esGlobalBridge,md5){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.PaperAvatar=void 0;meta=babelHelpers.interopRequireWildcard(meta);md5=babelHelpers.interopRequireWildcard(md5);/**
`paper-avatar`
...
*/let PaperAvatar=(0,_polymerLegacy.Polymer)({is:"paper-avatar",_template:_polymerLegacy.html`
    <style>
      :host {
