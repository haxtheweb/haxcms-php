  ...
  */
  class EcoJsonSchemaObject extends (0, _class.mixinBehaviors)([_appLocalizeBehavior.AppLocalizeBehavior], _polymerElement.PolymerElement) {
    ...
    _buildSchemaProperties() {
      var ctx = this;
      this._schemaProperties = Object.keys(this.schema.properties || []).map(key => {
    ...
    _buildForm() {
      ...
      this._schemaProperties.forEach(property => {
        ...
        if (typeof this.$ !== typeof undefined) {
          (0, _polymerDom.dom)(this).appendChild(el);
          ...
          if (property.description) {
            ...
            (0, _polymerDom.dom)(this).appendChild(tip);
          }
    ...
    _errorChanged() {
      (0, _polymerDom.dom)(this).childNodes.forEach(el => {
