define(["exports","../../../@polymer/polymer/polymer-element.js","../../../@polymer/polymer/lib/legacy/polymer.dom.js","../../../@polymer/polymer/lib/utils/render-status.js","../../../@polymer/app-localize-behavior/app-localize-behavior.js","../../../@polymer/polymer/lib/legacy/class.js","../../a11y-tabs/a11y-tabs.js"],function(_exports,_polymerElement,_polymerDom,_renderStatus,_appLocalizeBehavior,_class,_a11yTabs){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.EcoJsonSchemaTabs=void 0;class EcoJsonSchemaTabs extends((0,_class.mixinBehaviors)([_appLocalizeBehavior.AppLocalizeBehavior],_polymerElement.PolymerElement)){static get tag(){return"eco-json-schema-tabs"}static get template(){return _polymerElement.html`
    ...
    `}static get properties(){return{autofocus:{type:Boolean,value:!1},hideLineNumbers:{type:Boolean,value:!1},schema:{type:Object,notify:!0,observer:"_schemaChanged"},value:{type:Array,notify:!0,value:{}},__validatedSchema:{type:Array,value:[],notify:!0}}}_valueChanged(e){let val={};this.__validatedSchema.forEach(item=>{val[item.property]=item.value}),this.notifyPath("value.*"),this.set("value",val),this.dispatchEvent(new CustomEvent("value-changed",{bubbles:!0,cancelable:!0,composed:!0,detail:this}))}_schemaChanged(oldValue,newValue){JSON.stringify(oldValue)!==JSON.stringify(newValue)&&this._setValues(),this.dispatchEvent(new CustomEvent("schema-changed",{bubbles:!0,cancelable:!0,composed:!0,detail:this}))}_setValues(){let schema=[];for(let prop in this.schema.items.properties){let tab={property:prop,title:this.schema.items.properties[prop].title,icon:this.schema.items.properties[prop].icon,properties:this.schema.items.properties[prop].items?this.schema.items.properties[prop].items.properties:{},value:this.value&&this.value[prop]?JSON.parse(JSON.stringify(this.value[prop])):{}};for(let subprop in tab.properties)tab.properties.value&&delete tab.properties.value,this.value&&this.value[prop]&&(tab.properties[subprop].value=this.value[prop][subprop]);schema.push(tab)}this.notifyPath("__validatedSchema.*"),this.__validatedSchema=[],this.__validatedSchema=schema}}_exports.EcoJsonSchemaTabs=EcoJsonSchemaTabs,window.customElements.define(EcoJsonSchemaTabs.tag,EcoJsonSchemaTabs)});