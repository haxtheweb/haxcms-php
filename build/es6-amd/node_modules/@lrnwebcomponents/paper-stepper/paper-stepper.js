define(["exports","../../@polymer/polymer/polymer-legacy.js"],function(_exports,_polymerLegacy){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.PaperStepper=void 0;/**
 ...
 */let PaperStepper=(0,_polymerLegacy.Polymer)({is:"paper-stepper",properties:{selected:{type:Number,notify:!0,value:0},/**
...
_tapPrevious:function(){this.$.selector.selectPrevious()},_tapNext:function(){this.$.selector.selectNext()},/**
   ...
   */_computeProgressValue:function(selected,items){return selected+1},_onItemsChanged:function(e){this._items=this.$.selector.items}});_exports.PaperStepper=PaperStepper});