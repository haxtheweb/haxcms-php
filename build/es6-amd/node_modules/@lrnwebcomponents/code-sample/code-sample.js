define(["exports", "../../@polymer/polymer/polymer-element.js", "../hax-body-behaviors/lib/HAXWiring.js", "../../@polymer/polymer/lib/utils/flattened-nodes-observer.js", "./lib/themes/one-dark.js", "./lib/highlightjs/highlight.js", "./lib/highlightjs/languages/javascript.js", "./lib/highlightjs/languages/xml.js"], function (_exports, _polymerElement, _HAXWiring, _flattenedNodesObserver, _oneDark, _highlight, _javascript, _xml) {
  "use strict";
  ...
  class CodeSample extends _polymerElement.PolymerElement {
    // render function
    static get template() {
    ...
    connectedCallback() {
      ...
      setTimeout(() => {
        if (this.querySelector("template")) {
          this._observer = new _flattenedNodesObserver.FlattenedNodesObserver(this.$.content, () => this._updateContent());
    ...
    _getCodeTemplate() {
      const nodes = _flattenedNodesObserver.FlattenedNodesObserver.getFlattenedNodes(this.$.content);
