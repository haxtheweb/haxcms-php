...
*/class LrnsysDialog extends _polymerElement.PolymerElement{static get template(){return _polymerElement.html`
   ...
   */tapEventOn(e){const root=this;if(typeof root.hoverClass!==typeof void 0){var classes=root.hoverClass.split(" ");classes.forEach(function(item,index){if(""!=item){root.$.dialogtrigger.classList.add(item)}})}}/**
   * Handle a mouse out event and remove the hoverclasses
   * from the classList array for paper-button.
   */tapEventOff(e){const root=this;if(typeof root.hoverClass!==typeof void 0){var classes=root.hoverClass.split(" ");classes.forEach(function(item,index){if(""!=item){root.$.dialogtrigger.classList.remove(item)}})}}/**
...
classes.forEach((item,index)=>{if(""!=item){if(this.focusState){this.$.dialogtrigger.classList.add(item)}else{this.$.dialogtrigger.classList.remove(item)}}})}this.focusState=!this.focusState}/**
   ...
   * detached lifecycle
   */disconnectedCallback(){this.$.dialogtrigger.removeEventListener("focused-changed",this.focusToggle.bind(this));this.removeEventListener("mousedown",this.tapEventOn.bind(this));this.removeEventListener("mouseover",this.tapEventOn.bind(this));this.removeEventListener("mouseout",this.tapEventOff.bind(this));super.disconnectedCallback()}}_exports.LrnsysDialog=LrnsysDialog;window.customElements.define(LrnsysDialog.tag,LrnsysDialog)});