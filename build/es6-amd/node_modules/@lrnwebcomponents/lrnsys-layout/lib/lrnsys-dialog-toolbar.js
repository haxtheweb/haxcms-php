define(["../../../@polymer/polymer/polymer-legacy.js","../../../@polymer/app-layout/app-toolbar/app-toolbar.js","./lrnsys-dialog-toolbar-button.js"],function(_polymerLegacy,_appToolbar,_lrnsysDialogToolbarButton){"use strict";(0,_polymerLegacy.Polymer)({_template:_polymerLegacy.html`
   ...
   * Button tapped
   */_tapHandler:function(e){this.fire("button-clicked",e.detail)},/**
   * Ready.
   */ready:function(){// listen to see if buttons have been initialized in the secondary toolbar
this.$.secondary.addEventListener("button-initialized",e=>{this._secondaryHasChildren=!0/* transition */ /* transition */})}})});