define(["exports","require","../../@polymer/polymer/polymer-element.js","../../@polymer/polymer/lib/utils/render-status.js","../../@polymer/polymer/lib/legacy/polymer.dom.js"],function(_exports,_require,_polymerElement,_renderStatus,_polymerDom){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.DropdownSelect=void 0,_require=babelHelpers.interopRequireWildcard(_require);class DropdownSelect extends _polymerElement.PolymerElement{constructor(){super(),new Promise((res,rej)=>_require.default(["@polymer/paper-dropdown-menu/paper-dropdown-menu.js"],res,rej)),new Promise((res,rej)=>_require.default(["@polymer/paper-item/paper-item.js"],res,rej)),new Promise((res,rej)=>_require.default(["@polymer/paper-listbox/paper-listbox.js"],res,rej))}static get template(){return _polymerElement.html`
      <style>
        :host {
          display: block;
        }
