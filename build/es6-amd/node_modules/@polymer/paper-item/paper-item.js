...
/**
  ...
  */
(0,_polymerFn.Polymer)({_template:_htmlTag.html`<style include=paper-item-shared-styles>:host{@apply --layout-horizontal;@apply --layout-center;@apply --paper-font-subhead;@apply --paper-item;}</style><slot></slot>`,is:"paper-item",behaviors:[_paperItemBehavior.PaperItemBehavior]})}));