...
/**
  ...
  */
const LegacyPolymerElementBase=(0,_legacyElementMixin.LegacyElementMixin)(HTMLElement);(0,_polymerFn.Polymer)({_template:_htmlTag.html`<style include=paper-dropdown-menu-shared-styles></style><paper-menu-button id=menuButton vertical-align=[[verticalAlign]] horizontal-align=[[horizontalAlign]] dynamic-align=[[dynamicAlign]] vertical-offset="[[_computeMenuVerticalOffset(noLabelFloat, verticalOffset)]]" disabled=[[disabled]] no-animations=[[noAnimations]] on-iron-select=_onIronSelect on-iron-deselect=_onIronDeselect opened={{opened}} close-on-activate allow-outside-scroll=[[allowOutsideScroll]] restore-focus-on-close=[[restoreFocusOnClose]]><div class=dropdown-trigger slot=dropdown-trigger><paper-ripple></paper-ripple><paper-input id=input type=text invalid=[[invalid]] readonly=readonly disabled=[[disabled]] value=[[value]] placeholder=[[placeholder]] error-message=[[errorMessage]] always-float-label=[[alwaysFloatLabel]] no-label-float=[[noLabelFloat]] label=[[label]] input-role=button input-aria-haspopup=listbox autocomplete=off><iron-icon icon=paper-dropdown-menu:arrow-drop-down suffix slot=suffix></iron-icon></paper-input></div><slot id=content name=dropdown-content slot=dropdown-content></slot></paper-menu-button>`,is:"paper-dropdown-menu",behaviors:[_ironButtonState.IronButtonState,_ironControlState.IronControlState,_ironFormElementBehavior.IronFormElementBehavior,_ironValidatableBehavior.IronValidatableBehavior],properties:{selectedItemLabel:{type:String,notify:!0,readOnly:!0},selectedItem:{type:Object,notify:!0,readOnly:!0},value:{type:String,notify:!0},label:{type:String},placeholder:{type:String},errorMessage:{type:String},opened:{type:Boolean,notify:!0,value:!1,observer:"_openedChanged"},allowOutsideScroll:{type:Boolean,value:!1},noLabelFloat:{type:Boolean,value:!1,reflectToAttribute:!0},alwaysFloatLabel:{type:Boolean,value:!1},noAnimations:{type:Boolean,value:!1},horizontalAlign:{type:String,value:"right"},verticalAlign:{type:String,value:"top"},verticalOffset:Number,dynamicAlign:{type:Boolean},restoreFocusOnClose:{type:Boolean,value:!0}},listeners:{tap:"_onTap"},keyBindings:{"up down":"open",esc:"close"},observers:["_selectedItemChanged(selectedItem)"],_attachDom(dom){const wrappedThis=(0,_wrap.wrap)(this);return wrappedThis.attachShadow({mode:"open",delegatesFocus:!0,shadyUpgradeFragment:dom}),wrappedThis.shadowRoot.appendChild(dom),LegacyPolymerElementBase.prototype._attachDom.call(this,dom)},focus(){this.$.input._focusableElement.focus()},attached:function(){var contentElement=this.contentElement;contentElement&&contentElement.selectedItem&&this._setSelectedItem(contentElement.selectedItem)},get contentElement(){for(var nodes=(0,_polymerDom.dom)(this.$.content).getDistributedNodes(),i=0,l=nodes.length;i<l;i++)if(nodes[i].nodeType===Node.ELEMENT_NODE)return nodes[i]},open:function(){this.$.menuButton.open()},close:function(){this.$.menuButton.close()},_onIronSelect:function(event){this._setSelectedItem(event.detail.item)},_onIronDeselect:function(event){this._setSelectedItem(null)},_onTap:function(event){gestures.findOriginalTarget(event)===this&&this.open()},_selectedItemChanged:function(selectedItem){var value="";value=selectedItem?selectedItem.label||selectedItem.getAttribute("label")||selectedItem.textContent.trim():"",this.value=value,this._setSelectedItemLabel(value)},_computeMenuVerticalOffset:function(noLabelFloat,opt_verticalOffset){return opt_verticalOffset||(noLabelFloat?-4:8)},_getValidity:function(_value){return this.disabled||!this.required||this.required&&!!this.value},_openedChanged:function(){var openState=this.opened?"true":"false",e=this.contentElement;e&&e.setAttribute("aria-expanded",openState)}})}));