...
import{LitElement as r,html as t,css as i}from"../../../lit/index.js";import{DDDSuper as e}from"../../d-d-d/d-d-d.js";import"../../rpg-character/rpg-character.js";export class GithubRpgContributors extends(e(r)){static get tag(){return"github-rpg-contributors"}constructor(){super(),this.org="",this.repo="",this.limit=50,this.contributors=[]}static get properties(){return{...super.properties,org:{type:String},repo:{type:String},limit:{type:Number,reflect:!0},contributors:{type:Array}}}static get styles(){return[super.styles,i`
    ...
    `]}updated(r){super.updated(r),(r.has("org")||r.has("repo")&&this.org&&this.repo)&&this.fetchContributors()}fetchContributors(){const r=`https://api.github.com/repos/${this.org}/${this.repo}/contributors`;try{fetch(r).then((r=>r.ok?r.json():{})).then((r=>{r&&(this.contributors=[...r])}))}catch(r){console.error("error",r)}}render(){return t`
  <div class="wrapper">
  ...
  `))}
  </div>`}static get haxProperties(){return new URL(`./lib/${this.tag}.haxProperties.json`,import.meta.url).href}}globalThis.customElements.define(GithubRpgContributors.tag,GithubRpgContributors);