 ...
 */
import{LitElement as t,html as o,css as e}from"../../lit/index.js";import"../simple-icon/lib/simple-icons.js";import"../simple-icon/lib/simple-icon-button-lite.js";class ScrollButton extends t{constructor(){super(),this.icon="icons:expand-less",this.t={backToTop:"Back to top"},globalThis.dispatchEvent(new CustomEvent("i18n-manager-register-element",{detail:{context:this,namespace:"scroll-button",localesPath:new URL("./locales/scroll-button.es.json",import.meta.url).href+"/../",updateCallback:"render"}})),this._label=this.t.backToTop,this.label="",this.position="top",import("../simple-tooltip/simple-tooltip.js")}static get tag(){return"scroll-button"}static get styles(){return[e`
        :host {
          display: block;
