...
import{html as e,css as t}from"../../lit/index.js";import{HAXCMSLitElementTheme as i}from"../haxcms-elements/lib/core/HAXCMSLitElementTheme.js";import{HAXCMSRememberRoute as a}from"../haxcms-elements/lib/core/utils/HAXCMSRememberRoute.js";import{HAXCMSThemeParts as o}from"../haxcms-elements/lib/core/utils/HAXCMSThemeParts.js";import{PrintBranchMixin as r}from"../haxcms-elements/lib/core/utils/PrintBranchMixin.js";import{PDFPageMixin as d}from"../haxcms-elements/lib/core/utils/PDFPageMixin.js";import{QRCodeMixin as n}from"../haxcms-elements/lib/core/utils/QRCodeMixin.js";import{HAXCMSMobileMenuMixin as s}from"../haxcms-elements/lib/core/utils/HAXCMSMobileMenu.js";import{HAXCMSOperationButtons as l}from"../haxcms-elements/lib/core/utils/HAXCMSOperationButtons.js";import{LTIResizingMixin as c}from"../haxcms-elements/lib/core/utils/LTIResizingMixin.js";import{store as p}from"../haxcms-elements/lib/core/haxcms-site-store.js";import"../haxcms-elements/lib/ui-components/active-item/site-active-title.js";import"../haxcms-elements/lib/ui-components/active-item/site-active-tags.js";import"../haxcms-elements/lib/ui-components/navigation/site-breadcrumb.js";import{autorun as m,toJS as h}from"../../mobx/dist/mobx.esm.js";import"../simple-icon/simple-icon.js";import"../simple-icon/lib/simple-icons.js";import{normalizeEventPath as g}from"../utils/lib/events.js";import{MicroFrontendRegistry as b}from"../micro-frontend-registry/micro-frontend-registry.js";import"../haxcms-elements/lib/ui-components/layout/site-modal.js";import"../haxcms-elements/lib/ui-components/navigation/site-menu-content.js";import{DDDSuper as u}from"../d-d-d/d-d-d.js";class CleanTwo extends(c(l(a(d(r(n(o(s(u(i)))))))))){static get styles(){return[super.styles,t`
        ...
        <div class="content-wrapper">
          <div class="content">
            ...
            <header class="header">
              ...
              ${this.PDFPageButton()}
              ${b.has("@system/siteToHtml")?e`${this.PrintSiteButton()}${this.PrintBranchButton()}`:e`<replace-tag
    ...
    `}__prevPageLabelChanged(e){this.prevPage=e.detail.value}__nextPageLabelChanged(e){this.nextPage=e.detail.value}static get properties(){let e={};return super.properties&&(e=super.properties),{...e,searchTerm:{type:String},prevPage:{type:String},nextPage:{type:String},pageTimestamp:{type:Number}}}static get tag(){return"clean-two"}constructor(){super(),this.xl=1800,this.HAXCMSThemeSettings.autoScroll=!0,this.searchTerm="",this.__disposer=this.__disposer?this.__disposer:[],this.__disposer.push(m(e=>{const t=h(p.activeManifestIndex);Promise.resolve().then(()=>{this.activeManifestIndex=t})})),this.__disposer.push(m(e=>{if(p.activeItem&&p.activeItem.metadata&&p.activeItem.metadata.updated){const e=h(p.activeItem.metadata.updated);Promise.resolve().then(()=>{this.pageTimestamp=e})}}))}siteModalForceClick(e){setTimeout(()=>{const e=globalThis.document.querySelector("clean-two");e&&e.shadowRoot&&e.shadowRoot.querySelector("site-modal")&&e.shadowRoot.querySelector("site-modal").shadowRoot&&e.shadowRoot.querySelector("site-modal").shadowRoot.querySelector("simple-icon-button-lite")&&e.shadowRoot.querySelector("site-modal").shadowRoot.querySelector("simple-icon-button-lite").click()},500)}siteModalClick(e){import("../haxcms-elements/lib/ui-components/site/site-search.js").then(e=>{"displays/search"!==p.getInternalRoute()&&globalThis.history.replaceState({},null,"x/displays/search");const t=new URLSearchParams(p.currentRouterLocation.search),i=globalThis.SimpleModal.requestAvailability().querySelector("site-search").shadowRoot.querySelector("simple-fields-field");i.focus(),t.get("search")&&(i.value=t.get("search"),setTimeout(()=>{i.select()},0))})}disconnectedCallback(){globalThis.document.body.style.removeProperty("overflow"),super.disconnectedCallback()}}globalThis.customElements.define(CleanTwo.tag,CleanTwo);export{CleanTwo};