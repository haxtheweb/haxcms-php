 ...
 */
import{html as t,css as e}from"../../lit/index.js";import{HAXCMSLitElementTheme as i}from"../haxcms-elements/lib/core/HAXCMSLitElementTheme.js";import{HAXCMSThemeParts as a}from"../haxcms-elements/lib/core/utils/HAXCMSThemeParts.js";import{HAXCMSRememberRoute as o}from"../haxcms-elements/lib/core/utils/HAXCMSRememberRoute.js";import{QRCodeMixin as n}from"../haxcms-elements/lib/core/utils/QRCodeMixin.js";import{HAXCMSMobileMenuMixin as d}from"../haxcms-elements/lib/core/utils/HAXCMSMobileMenu.js";import{LTIResizingMixin as r}from"../haxcms-elements/lib/core/utils/LTIResizingMixin.js";import{store as s}from"../haxcms-elements/lib/core/haxcms-site-store.js";import{autorun as l,toJS as h}from"../../mobx/dist/mobx.esm.js";import"../scroll-button/scroll-button.js";import"../haxcms-elements/lib/ui-components/active-item/site-active-title.js";import"../haxcms-elements/lib/ui-components/active-item/site-active-tags.js";import"../haxcms-elements/lib/ui-components/navigation/site-breadcrumb.js";import"./lib/clean-one-search-box.js";import{PrintBranchMixin as c}from"../haxcms-elements/lib/core/utils/PrintBranchMixin.js";import{MicroFrontendRegistry as p}from"../micro-frontend-registry/micro-frontend-registry.js";import{PDFPageMixin as m}from"../haxcms-elements/lib/core/utils/PDFPageMixin.js";import{DDDSuper as u}from"../d-d-d/d-d-d.js";import{DDDVariables as g,DDDPaletteStyles as b}from"../d-d-d/lib/DDDStyles.js";import{UserScaffoldInstance as v}from"../user-scaffold/user-scaffold.js";class CleanOne extends(u(r(c(m(n(a(d(o(u(i)))))))))){static get styles(){return[super.styles,e`
        :host {
        ...
        <nav class="menu-outline" aria-label="Site menu">
          <div id="site-search-input" role="search" part="search-btn">
            <clean-one-search-box
              part="${this.editMode?"search-box edit-mode-active":"search-box"}"
              ?inert="${this.editMode}"
        ...
        <div id="body" class="site-body" part="site-body">
          ...
          <div class="site-inner">
            <header class="site-header">
              <div
                class="btn-container"
                part="${this.editMode?"btn-container edit-mode-active":"btn-container"}"
                ?inert="${this.editMode}"
                aria-disabled="${this.editMode?"true":"false"}"
              >
                <div class="pull-left">
                  ${["xs","sm"].includes(this.responsiveSize)?"":this.HAXCMSMobileMenuButton()}
                  ${p.has("@system/siteToHtml")?this.PrintBranchButton("bottom"):t`
                        <site-print-button
          ...
          <footer>
            <nav aria-label="Page navigation">
              ...
              <site-menu-button
                ...
                ?hide-label="${["xs","sm"].includes(this.responsiveSize)}"
              ></site-menu-button>
              ${["xs","sm"].includes(this.responsiveSize)?this.HAXCMSMobileMenuButton("top"):""}
            </nav>
          </footer>
        </div>
        <scroll-button
