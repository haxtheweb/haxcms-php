import{LitElement as t,html as e,css as i}from"../../../lit/index.js";export class PolarisTile extends t{static get tag(){return"polaris-tile"}constructor(){super(),this.type=null,this.line1=null,this.line2=null,this.image=null,this.link=null,this.editMode=!1}static get properties(){return{type:{type:String,reflect:!0},line1:{type:String},line2:{type:String},image:{type:String},link:{type:String},editMode:{type:Boolean}}}static get styles(){return i`
      :host {
    ...
    `}haxHooks(){return{editModeChanged:"haxeditModeChanged",activeElementChanged:"haxactiveElementChanged"}}haxeditModeChanged(t){this.editMode=t}_clickLink(t){this.editMode&&(t.preventDefault(),t.stopPropagation(),t.stopImmediatePropagation())}haxactiveElementChanged(t,e){return this.editMode=e,!1}static get haxProperties(){return new URL(`./${this.tag}.haxProperties.json`,import.meta.url).href}}globalThis.customElements.define(PolarisTile.tag,PolarisTile);