import{SimpleColors as e}from"../../../simple-colors/simple-colors.js";import{html as t,css as s}from"../../../../lit/index.js";import{autorun as a,toJS as r}from"../../../../mobx/dist/mobx.esm.js";import{varGet as i}from"../../../utils/lib/object-path.js";import{store as o}from"./AppHaxStore.js";import"./app-hax-site-bar.js";import"./app-hax-site-details.js";export class AppHaxSearchResults extends e{static get tag(){return"app-hax-search-results"}constructor(){super(),this.searchItems=[],this.displayItems=[],this.searchTerm="",this.dark=!1,a(()=>{const e=r(o.searchTerm);Promise.resolve().then(()=>{this.searchTerm=e})}),a(()=>{const e=r(o.darkMode);Promise.resolve().then(()=>{this.dark=e})}),a(()=>{const e=r(o.manifest);Promise.resolve().then(()=>{const t=e;t&&t.items&&(this.searchItems=t.items,this.displayItems=[...this.searchItems])})})}static get properties(){return{...super.properties,searchTerm:{type:String,reflect:!0},searchItems:{type:Array},displayItems:{type:Array}}}updated(e){super.updated&&super.updated(e),e.forEach((e,t)=>{"searchTerm"===t&&(this.displayItems=this.searchItems.filter(e=>!!(e.title.toLowerCase().includes(this.searchTerm.toLowerCase())||e.description.toLowerCase().includes(this.searchTerm.toLowerCase())||e.author.toLowerCase().includes(this.searchTerm.toLowerCase())||e.slug.toLowerCase().includes(this.searchTerm.toLowerCase()))))})}static get styles(){return[super.styles,s`
        :host {
          overflow: hidden;
        }
        ul,
