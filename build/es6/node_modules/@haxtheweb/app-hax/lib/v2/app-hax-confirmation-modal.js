import{LitElement as t,html as o,css as e}from"../../../../lit/index.js";import{DDDSuper as d}from"../../../d-d-d/d-d-d.js";import"../../../simple-modal/simple-modal.js";import"../../../simple-icon/lib/simple-icon-lite.js";import"../../../simple-icon/lib/simple-icons.js";import{store as a}from"./AppHaxStore.js";export class AppHaxConfirmationModal extends(d(t)){static get tag(){return"app-hax-confirmation-modal"}constructor(){super(),this.open=!1,this.title="",this.message="",this.confirmText="Confirm",this.cancelText="Cancel",this.confirmAction=null,this.cancelAction=null,this.dangerous=!1,this._confirmed=!1}static get properties(){return{open:{type:Boolean,reflect:!0},title:{type:String},message:{type:String},confirmText:{type:String},cancelText:{type:String},dangerous:{type:Boolean}}}static get styles(){return[super.styles,e`
        :host {
      ...
      `]}openModal(){document.body.style.overflow="hidden",this._confirmed=!1,this.open=!0;const t=this.shadowRoot.querySelector("simple-modal");t&&(t.opened=!0)}closeModal(){const t=this.shadowRoot.querySelector("simple-modal");t?t.opened=!1:this.handleModalClosed()}handleModalClosed(t){document.body.style.overflow="",this.open=!1,this._confirmed||(a.appEl&&a.appEl.playSound&&a.appEl.playSound("error"),this.cancelAction&&"function"==typeof this.cancelAction&&this.cancelAction()),this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}confirmModal(){this._confirmed=!0;const t=this.shadowRoot.querySelector("simple-modal");t?t.opened=!1:document.body.style.overflow="",a.appEl&&a.appEl.playSound&&a.appEl.playSound("success"),this.confirmAction&&"function"==typeof this.confirmAction&&this.confirmAction()}render(){return o`
      <simple-modal
        .opened="${this.open}"
        title="${this.title}"
