import{LitElement as t,html as i,css as e}from"../../../../lit/index.js";import"../../../simple-tooltip/simple-tooltip.js";import{store as d}from"./AppHaxStore.js";export class AppHaxUseCase extends t{static get tag(){return"app-hax-use-case"}constructor(){super(),this.title="",this.description="",this.source="",this.demoLink="",this.iconImage=[],this.isSelected=!1,this.showContinue=!1}static get properties(){return{title:{type:String},description:{type:String},source:{type:String},demoLink:{type:String},iconImage:{type:Array},isSelected:{type:Boolean,reflect:!0},showContinue:{type:Boolean}}}updated(t){}static get styles(){return[e`
        :host {
          display: flex;
      ...
      `]}toggleDisplay(){this.isSelected=!this.isSelected,this.showContinue=this.isSelected,this.dispatchEvent(new CustomEvent("toggle-display",{detail:{isSelected:this.isSelected},bubbles:!0,composed:!0})),this.isSelected&&setTimeout((()=>{this.continueAction()}),100)}continueAction(){this.dispatchEvent(new CustomEvent("continue-action",{detail:{title:this.title,description:this.description,source:this.source,template:this.title},bubbles:!0,composed:!0}))}openDemo(){this.demoLink&&globalThis.open(this.demoLink,"_blank")}render(){return i`
      <div class="card">
        <div class="image">
          <img src="${this.source}" alt="${this.title}" />
          <div class="icons">
            ${this.iconImage.map((t=>i`
        ...
        <div class="cardBottom">
          ...
          ${this.isSelected?"":i`<button class="demo" @click=${()=>this.openDemo()}>
                Demo
              </button>`}
        </div>
      </div>
