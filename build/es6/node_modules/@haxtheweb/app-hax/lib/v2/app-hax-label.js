import{LitElement as t,html as e,css as a}from"../../../../lit/index.js";export class AppHaxLabel extends t{static get tag(){return"app-hax-label"}constructor(){super(),this.title="HAX site list",this.subtitle="Let's build something awesome!"}static get properties(){return{title:{type:String},subtitle:{type:String}}}static get styles(){return a`
      :host {
