import{LitElement as e,html as t,css as d}from"../../../../lit/index.js";import{DDDSuper as n}from"../../../d-d-d/d-d-d.js";import"../../../simple-icon/lib/simple-icon-lite.js";export class AppHaxUserMenu extends(n(e)){static get tag(){return"app-hax-user-menu"}constructor(){super(),this.isOpen=!1,this.icon="account-circle"}static get properties(){return{isOpen:{type:Boolean,reflect:!0,attribute:"is-open"},icon:{type:String,reflect:!0}}}static get styles(){return[super.styles,d`
        :host {
