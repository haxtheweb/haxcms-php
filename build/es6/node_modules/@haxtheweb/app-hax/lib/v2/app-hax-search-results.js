import{SimpleColors as t}from"../../../simple-colors/simple-colors.js";import{html as e,css as a}from"../../../../lit/index.js";import{autorun as r,toJS as s}from"../../../../mobx/dist/mobx.esm.js";import{varGet as d}from"../../../utils/utils.js";import{store as i}from"./AppHaxStore.js";import"./app-hax-site-bar.js";import"./app-hax-site-details.js";import"../../../simple-tooltip/simple-tooltip.js";export class AppHaxSearchResults extends t{static get tag(){return"app-hax-search-results"}constructor(){super(),this.searchItems=[],this.displayItems=[],this.searchTerm="",this.dark=!1,this.currentIndex=1,this.totalItems=0,this.sortOption="newest",r(()=>{this.searchTerm=s(i.searchTerm)}),r(()=>{this.dark=s(i.darkMode)}),r(()=>{const t=s(i.manifest);t&&t.items&&(this.searchItems=t.items,this.displayItems=[...this.searchItems],i.loadThemesData())})}static get properties(){return{...super.properties,searchTerm:{type:String,reflect:!0},searchItems:{type:Array},displayItems:{type:Array},siteUrl:{type:String,attribute:"site-url"},currentIndex:{type:Number},totalItems:{type:Number},sortOption:{type:String,attribute:"sort-option"}}}static get styles(){return[super.styles,a`
        :host {
          display: block;
          width: 100%;
          overflow: visible;
