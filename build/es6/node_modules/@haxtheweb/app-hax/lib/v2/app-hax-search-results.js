import{SimpleColors as e}from"../../../simple-colors/simple-colors.js";import{html as t,css as r}from"../../../../lit/index.js";import{autorun as a,toJS as s}from"../../../../mobx/dist/mobx.esm.js";import{varGet as d}from"../../../utils/utils.js";import{store as o}from"./AppHaxStore.js";import"./app-hax-site-bar.js";import"./app-hax-site-details.js";import"../../../simple-tooltip/simple-tooltip.js";export class AppHaxSearchResults extends e{static get tag(){return"app-hax-search-results"}constructor(){super(),this.searchItems=[],this.displayItems=[],this.searchTerm="",this.dark=!1,this.isPointerDown=!1,this.startX=0,this.scrollLeftVal=0,this.isDragging=!1,this.currentIndex=1,this.totalItems=0,a((()=>{this.searchTerm=s(o.searchTerm)})),a((()=>{this.dark=s(o.darkMode)})),a((()=>{const e=s(o.manifest);e&&e.items&&(this.searchItems=e.items,this.displayItems=[...this.searchItems],o.loadThemesData())}))}static get properties(){return{...super.properties,searchTerm:{type:String,reflect:!0},searchItems:{type:Array},displayItems:{type:Array},siteUrl:{type:String,attribute:"site-url"},isPointerDown:{type:Boolean},startX:{type:Number},scrollLeftVal:{type:Number},isDragging:{type:Boolean},currentIndex:{type:Number},totalItems:{type:Number}}}updated(e){super.updated&&super.updated(e),e.forEach(((e,t)=>{"searchTerm"===t&&(this.displayItems=this.searchItems.filter((e=>!!(e.title.toLowerCase().includes(this.searchTerm.toLowerCase())||e.description.toLowerCase().includes(this.searchTerm.toLowerCase())||e.author.toLowerCase().includes(this.searchTerm.toLowerCase())||e.slug.toLowerCase().includes(this.searchTerm.toLowerCase())))))}))}static get styles(){return[super.styles,r`
        :host {
          display: block;
          width: 100%;
          overflow: visible;
      ...
      >
        ...
        ${this.totalItems>1?t`
              <div class="pager-container">
                ${Array.from({length:e.end-e.start+1},((r,a)=>{const s=e.start+a;return t`
                      <button
