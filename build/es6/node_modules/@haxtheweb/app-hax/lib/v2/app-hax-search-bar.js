import{LitElement as e,html as t,css as o}from"../../../../lit/index.js";import"../../../simple-tooltip/simple-tooltip.js";import{store as r}from"./AppHaxStore.js";export class AppHaxSearchBar extends e{static get tag(){return"app-hax-search-bar"}constructor(){super(),this.searchTerm="",this.disabled=!1,this.showSearch=!1}static get properties(){return{searchTerm:{type:String},showSearch:{type:Boolean,reflect:!0,attribute:"show-search"},disabled:{type:Boolean,reflect:!0}}}updated(e){e.forEach(((e,t)=>{"searchItems"===t?this.displayItems=[...this.searchItems]:"searchTerm"===t?r.searchTerm=this.searchTerm:"showSearch"===t&&void 0!==e&&!1===this[t]&&(this.searchTerm="")}))}static get styles(){return[o`
        :host {
          overflow: hidden;
          position: relative;
