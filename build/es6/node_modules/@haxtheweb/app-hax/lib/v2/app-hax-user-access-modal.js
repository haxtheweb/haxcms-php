...
import{html as e,css as t}from"../../../../lit/index.js";import{DDD as a}from"../../../d-d-d/d-d-d.js";import{I18NMixin as d}from"../../../i18n-manager/lib/I18NMixin.js";import"../../../rpg-character/rpg-character.js";import"../../../simple-icon/lib/simple-icons.js";import"../../../simple-icon/lib/simple-icon-button.js";import{store as r}from"./AppHaxStore.js";class AppHaxUserAccessModal extends(d(a)){static get tag(){return"app-hax-user-access-modal"}constructor(){super(),this.username="",this.loading=!1,this.error="",this.siteTitle="",this.t={userAccess:"User Access",enterUsername:"Enter username to grant access",usernamePlaceholder:"Username",addUser:"Add User",cancel:"Cancel",userAccessGranted:"User access granted successfully!",userNotFound:"User not found or unauthorized",loadingAddingUser:"Adding user...",grantAccessTo:"Grant access to:"}}static get properties(){return{...super.properties,username:{type:String},loading:{type:Boolean},error:{type:String},siteTitle:{type:String}}}static get styles(){return[super.styles,t`
    ...
    `}_handleUsernameInput(e){this.username=e.target.value,this.error&&(this.error="")}_handleKeydown(e){"Enter"===e.key&&this.username.trim()&&!this.loading?this._handleAddUser():"Escape"===e.key&&this._handleCancel()}async _handleAddUser(){if(this.username.trim()){this.loading=!0,this.error="";try{const e=await this._addUserAccess(this.username.trim());e.ok?(r.appEl&&r.appEl.playSound&&r.appEl.playSound("success"),this._showSuccessToast(),this._closeModal(),this.username=""):403===e.status?this.error=this.t.userNotFound:this.error=`Error: ${e.status} ${e.statusText}`}catch(e){console.error("Error adding user access:",e),this.error="Network error occurred. Please try again."}finally{this.loading=!1}}}_handleCancel(){this._closeModal()}async _addUserAccess(e){const t=`${globalThis.location.origin}/api/haxiam/addUserAccess`;return fetch(t,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${globalThis.jwt||r.jwt||""}`},body:JSON.stringify({username:e,siteId:r.activeSite?.id||null,sitePath:r.activeSite?.location||null})})}_showSuccessToast(){r.toast(this.t.userAccessGranted,4e3,{hat:"construction",userName:this.username})}_closeModal(){document.body.style.overflow="",globalThis.dispatchEvent(new CustomEvent("simple-modal-hide",{bubbles:!0,composed:!0,cancelable:!0,detail:{}}))}firstUpdated(){super.firstUpdated(),r.activeSite?.title&&(this.siteTitle=r.activeSite.title),setTimeout((()=>{const e=this.shadowRoot.querySelector("input");e&&e.focus()}),100)}connectedCallback(){super.connectedCallback(),this.username="",this.error="",this.loading=!1,document.body.style.overflow="hidden"}}globalThis.customElements.define(AppHaxUserAccessModal.tag,AppHaxUserAccessModal);export{AppHaxUserAccessModal};