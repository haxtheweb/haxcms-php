...
import{LitElement as e,html as t,css as o}from"../../lit/index.js";import"../simple-icon/lib/simple-icons.js";import"../simple-icon/lib/simple-icon-lite.js";import"../simple-icon/lib/simple-icon-button-lite.js";import{DDDSuper as i}from"../d-d-d/d-d-d.js";const l=["--simple-modal-resize","--simple-modal-width","--simple-modal-z-index","--simple-modal-height","--simple-modal-min-width","--simple-modal-min-height","--simple-modal-max-width","--simple-modal-max-height","--simple-modal-titlebar-color","--simple-modal-titlebar-height","--simple-modal-titlebar-line-height","--simple-modal-titlebar-background","--simple-modal-titlebar-padding","--simple-modal-header-color","--simple-modal-header-background","--simple-modal-header-padding","--simple-modal-content-container-color","--simple-modal-content-container-background","--simple-modal-content-padding","--simple-modal-buttons-color","--simple-modal-buttons-background","--simple-modal-buttons-padding","--simple-modal-button-color","--simple-modal-button-background"];class SimpleModal extends e{static get styles(){return[o`
    ...
    </web-dialog>`}static get properties(){return{...super.properties,title:{type:String},opened:{type:Boolean,reflect:!0},closeLabel:{attribute:"close-label",type:String},closeIcon:{type:String,attribute:"close-icon"},invokedBy:{type:Object},modal:{type:Boolean},showClose:{type:Boolean,attribute:"show-close"},mode:{type:String,reflect:!0}}}static get tag(){return"simple-modal"}constructor(){super(),this.windowControllers=new AbortController,this.title="",this.opened=!1,this.closeLabel="Close",this.closeIcon="close",this.modal=!1,this.showClose=!1}firstUpdated(){import("../../web-dialog/index.js").then((e=>{setTimeout((()=>{this.shadowRoot.querySelector("web-dialog").shadowRoot.querySelector("#backdrop").style.backgroundColor="var(--ddd-theme-default-potential70)"}),0)}))}updated(e){e.forEach(((e,t)=>{"opened"==t&&this._openedChanged(this[t])}))}connectedCallback(){super.connectedCallback(),this.close=this.close.bind(this),this.showEvent=this.showEvent.bind(this),setTimeout((()=>{globalThis.addEventListener("simple-modal-hide",this.close,{signal:this.windowControllers.signal}),globalThis.addEventListener("simple-modal-show",this.showEvent,{signal:this.windowControllers.signal})}),0)}disconnectedCallback(){this.windowControllers.abort(),super.disconnectedCallback()}showEvent(e){globalThis.dispatchEvent(new CustomEvent("simple-toast-hide",{bubbles:!0,composed:!0,cancelable:!1,detail:!1})),this.opened?(this.innerHTML="",setTimeout((()=>{this.show(e.detail.title,e.detail.mode,e.detail.elements,e.detail.invokedBy,e.detail.id,e.detail.modalClass,e.detail.styles,e.detail.clone,e.detail.modal,e.detail.showClose)}),0)):this.show(e.detail.title,e.detail.mode,e.detail.elements,e.detail.invokedBy,e.detail.id,e.detail.modalClass,e.detail.styles,e.detail.clone,e.detail.modal,e.detail.showClose)}show(e,t,o,i,d=null,a=null,s=null,n=!1,r=!1,m=!1){let c;this.invokedBy=i,this.modal=r,this.showClose=m,this.title=e,this.mode=t;let h=["header","content","buttons","custom"];for(var p in d?this.setAttribute("id",d):this.removeAttribute("id"),this.setAttribute("style",""),s&&l.forEach((e=>{this.style.setProperty(e,s[e]||"inherit")})),a?this.setAttribute("class",a):this.removeAttribute("class"),h)o[h[p]]&&(c=n?o[h[p]].cloneNode(!0):o[h[p]],c.setAttribute("slot",h[p]),this.appendChild(c));this.opened=!0}close(){document.body.style.overflow="",document.documentElement.style.overflow="",this.opened=!1,globalThis.ShadyCSS&&!globalThis.ShadyCSS.nativeShadow&&(this.shadowRoot.querySelector("web-dialog").shadowRoot.querySelector("#backdrop").style.position="relative")}open(){this.opened=!0;const e=this.shadowRoot.querySelector("web-dialog");this.modal?(e.$backdrop.removeEventListener("click",e.onBackdropClick),e.removeEventListener("keydown",e.onKeyDown,{capture:!0})):(e.$backdrop.addEventListener("click",e.onBackdropClick),e.addEventListener("keydown",e.onKeyDown,{capture:!0,passive:!0})),globalThis.ShadyCSS&&!globalThis.ShadyCSS.nativeShadow&&(this.shadowRoot.querySelector("web-dialog").shadowRoot.querySelector("#backdrop").style.position="fixed",this.shadowRoot.querySelector("web-dialog").shadowRoot.querySelector("#backdrop").style.top=0,this.shadowRoot.querySelector("web-dialog").shadowRoot.querySelector("#backdrop").style.bottom=0,this.shadowRoot.querySelector("web-dialog").shadowRoot.querySelector("#backdrop").style.left=0,this.shadowRoot.querySelector("web-dialog").shadowRoot.querySelector("#backdrop").style.right=0)}_openedChanged(e){if(void 0===e||e){if(e){document.body.style.overflow="hidden",this.querySelectorAll("[dialog-dismiss]").forEach((e=>{e.addEventListener("click",(e=>{const t=new CustomEvent("simple-modal-dismissed",{bubbles:!0,composed:!0,cancelable:!0,detail:{opened:!1,invokedBy:this.invokedBy}});this.dispatchEvent(t),this.close()}))})),this.querySelectorAll("[dialog-confirm]").forEach((e=>{e.addEventListener("click",(e=>{const t=new CustomEvent("simple-modal-confirmed",{composed:!0,bubbles:!0,cancelable:!0,detail:{opened:!1,invokedBy:this.invokedBy}});this.dispatchEvent(t),this.close()}))}));const e=new CustomEvent("simple-modal-opened",{bubbles:!0,composed:!0,cancelable:!0,detail:{opened:!0,invokedBy:this.invokedBy}});this.dispatchEvent(e),setTimeout((()=>{this._focusModalContent()}),0)}}else{for(document.body.style.overflow="",document.documentElement.style.overflow="",this.title="";null!==this.firstChild;)this.removeChild(this.firstChild);this.invokedBy&&setTimeout((()=>{this.invokedBy.focus()}),500),this.showClose=!1;const e=new CustomEvent("simple-modal-closed",{bubbles:!0,cancelable:!0,detail:{opened:!1,invokedBy:this.invokedBy}});this.dispatchEvent(e)}}_focusModalContent(e=0){if(!this.opened)return;const t=this.querySelector(["[slot='content'] [autofocus]","[slot='content'] button:not([disabled])","[slot='content'] [href]","[slot='content'] input:not([disabled]):not([type='hidden'])","[slot='content'] select:not([disabled])","[slot='content'] textarea:not([disabled])","[slot='content'] [tabindex]:not([tabindex='-1'])","[slot='buttons'] button:not([disabled])","[slot='buttons'] [tabindex]:not([tabindex='-1'])"].join(", "));if(t&&"function"==typeof t.focus)return void t.focus();const o=this.shadowRoot.querySelector("#close");if(o&&o.shadowRoot){const e=o.shadowRoot.querySelector("button");if(e&&"function"==typeof e.focus)return void e.focus()}const i=this.shadowRoot.querySelector("#dialog");if(i&&"function"==typeof i.focus)return i.hasAttribute("tabindex")||i.setAttribute("tabindex","-1"),void i.focus();e<20&&setTimeout((()=>{this._focusModalContent(e+1)}),25)}_getAriaLabelledby(e){return e?"simple-modal-title":null}_getAriaLabel(e){return e?null:"Modal Dialog"}}globalThis.customElements.define(SimpleModal.tag,SimpleModal);export{SimpleModal,l as SimpleModalCssVars};globalThis.SimpleModal=globalThis.SimpleModal||{},globalThis.SimpleModal.requestAvailability=()=>(!globalThis.SimpleModal.instance&&globalThis.document&&globalThis.document.body&&(globalThis.SimpleModal.instance=globalThis.document.createElement("simple-modal"),globalThis.document.body.appendChild(globalThis.SimpleModal.instance)),globalThis.SimpleModal.instance);export const SimpleModalStore=globalThis.SimpleModal.requestAvailability();