      ...
      >
        <div class="item-leading-operations">
          ${this.hasChildren(e.id)?i`<simple-icon-button-lite
              ...
              ></simple-icon-button-lite>`:i`<span class="collapse-spacer collapse-slot" aria-hidden="true"></span>`}
          <simple-icon-button-lite
            ?disabled="${this.isLocked(t)}"
