 ...
 */
import{LitElement as e,html as t,css as s,nothing as i}from"../../../../../lit/index.js";import{store as l}from"../../core/haxcms-site-store.js";import{HAXCMSI18NMixin as a}from"../../core/utils/HAXCMSI18NMixin.js";import"../../../../simple-fields/lib/simple-tags.js";import"../../../../simple-fields/lib/simple-fields-field.js";import"../../../../simple-icon/lib/simple-icon-button-lite.js";import"../../../../simple-icon/lib/simple-icon-lite.js";import"../../../../grid-plate/grid-plate.js";import{mediaKeys as r}from"../magic/site-view.js";import{autorun as o}from"../../../../../mobx/dist/mobx.esm.js";import{SimpleColors as p}from"../../../../simple-colors/simple-colors.js";export function loadViewsForm(){const e=l.getManifest(!0);var t=[{text:"Select page",value:null}];return e.items.forEach(s=>{let i=s,l="- ";for(;i&&null!=i.parent;)i=e.items.find(e=>e.id==i.parent),i&&(l="--"+l);t.push({text:l+s.title,value:s.id})}),[{property:"settings",inputMethod:"collapse",properties:[{property:"displayFormat",title:"Display format",accordion:!0,expanded:!1,properties:[{property:"displayedAs",title:"Displayed as",description:"How the entire display should be rendered",inputMethod:"select",options:{list:"List",table:"Table",card:"Card",contentplayer:"Content Player"}},{property:"displayOf",title:"Results as",description:"How do you want each result to appear",inputMethod:"select",options:{title:"Title",full:"Full content",fullRemote:"Full content (remote load)",blocks:"Blocks"}}]},{property:"filters",title:"Filters",accordion:!0,expanded:!1,properties:[{property:"parent",title:"Parent",description:"Limit results to those that have this item as it's parent",inputMethod:"select",itemsList:t},{property:"tags",title:"Tags",description:"Filter by tags, comma separated",inputMethod:"text"},{property:"title",title:"Title",description:"Filter by title",inputMethod:"text"},{property:"blockFilter",title:"Block filter",description:"Filter by block type",inputMethod:"select",options:r}]}]}]}export class SiteViewsRoute extends(a(p)){static get tag(){return"site-views-route"}static get styles(){return[super.styles,s`
        :host {
          display: block;
          font-size: 16px;
        }
