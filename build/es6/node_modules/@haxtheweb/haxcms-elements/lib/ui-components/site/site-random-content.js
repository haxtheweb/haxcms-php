 ...
 */
import{html as e,css as t,nothing as n}from"../../../../../lit/index.js";import{unsafeHTML as i}from"../../../../../lit/directives/unsafe-html.js";import{store as o}from"../../core/haxcms-site-store.js";import{HAXCMSI18NMixin as a}from"../../core/utils/HAXCMSI18NMixin.js";import{HAXCMSLitElementTheme as d}from"../../core/HAXCMSLitElementTheme.js";import{autorun as s,toJS as l}from"../../../../../mobx/dist/mobx.esm.js";import{DDD as r}from"../../../../d-d-d/d-d-d.js";import"../../../../simple-icon/lib/simple-icon-button-lite.js";export class SiteRandomContent extends(a(r)){static get tag(){return"site-random-content"}constructor(){super(),this.windowControllers=new AbortController,this.HAXCMSI18NMixinBase="../../../",this.page=null,this.randomElement=null,this.allElements=[],this.currentElementIndex=0,this.loading=!1,this.editMode=!1,this.t.noContent="No content available to display",this.t.noPage="No page selected",this.t.shuffle="Shuffle content",this.t.loading="Loading content...",this.__disposer=this.__disposer?this.__disposer:[],s((e=>{o.manifest&&this.page&&this.loadPageElements(),this.__disposer.push(e)})),s((e=>{this.editMode=l(o.editMode),this.__disposer.push(e)}))}static get styles(){return[super.styles,t`
        :host {
          display: block;
