 ...
 */
import{html as e,css as t,nothing as n}from"../../../../../lit/index.js";import{unsafeHTML as i}from"../../../../../lit/directives/unsafe-html.js";import{store as a}from"../../core/haxcms-site-store.js";import{HAXCMSI18NMixin as o}from"../../core/utils/HAXCMSI18NMixin.js";import{autorun as d,toJS as s}from"../../../../../mobx/dist/mobx.esm.js";import{DDD as l}from"../../../../d-d-d/d-d-d.js";import"../../../../simple-icon/lib/simple-icon-button-lite.js";export class SiteRandomContent extends(o(l)){static get tag(){return"site-random-content"}constructor(){super(),this.windowControllers=new AbortController,this.HAXCMSI18NMixinBase="../../../",this.page=null,this.randomElement=null,this.allElements=[],this.currentElementIndex=0,this.loading=!1,this.editMode=!1,this.t.noContent="No content available to display",this.t.noPage="No page selected",this.t.shuffle="Shuffle content",this.t.loading="Loading content...",this.__disposer=this.__disposer?this.__disposer:[],this.__disposer.push(d(e=>{Promise.resolve().then(()=>{a.manifest&&this.page&&this.loadPageElements()})})),this.__disposer.push(d(e=>{const t=s(a.editMode);Promise.resolve().then(()=>{this.editMode=t})}))}static get styles(){return[super.styles,t`
        :host {
          display: block;
