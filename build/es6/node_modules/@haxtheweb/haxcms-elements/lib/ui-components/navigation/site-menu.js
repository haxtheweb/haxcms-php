 ...
 */
import{LitElement as e,html as t,css as a}from"../../../../../lit/index.js";import{store as i}from"../../core/haxcms-site-store.js";import{autorun as o,toJS as r}from"../../../../../mobx/dist/mobx.esm.js";import"../../../../map-menu/map-menu.js";import{localStorageGet as s}from"../../../../utils/utils.js";import{HAXCMSThemeParts as n}from"../../core/utils/HAXCMSThemeParts.js";class SiteMenu extends(n(e)){static get styles(){return[super.styles,a`
        :host {
          display: block;
        }
        map-menu {
      ...
      `]}static get tag(){return"site-menu"}constructor(){super(),this.hideActiveIndicator=!1,this.preventAutoScroll=!1,this.trackIcon="",this.__disposer=[],o((e=>{this.routerManifest=Object.assign({},r(i.routerManifest)),this.__disposer.push(e)}))}render(){return t`
      <map-menu
