import{html as e,css as t,unsafeCSS as a}from"../../../../lit/index.js";import{store as o}from"./haxcms-site-store.js";import{HAXStore as i}from"../../../hax-body/lib/hax-store.js";import{autorun as s,toJS as n}from"../../../../mobx/dist/mobx.esm.js";import{ResponsiveUtilityBehaviors as r}from"../../../responsive-utility/lib/responsive-utility-behaviors.js";import{localStorageSet as l,winEventsElement as d,validURL as c}from"../../../utils/utils.js";import"../../../simple-icon/simple-icon.js";import"../../../simple-icon/lib/simple-icons.js";import{HAXCMSThemeParts as m}from"./utils/HAXCMSThemeParts.js";import{HAXCMSI18NMixin as p}from"./utils/HAXCMSI18NMixin.js";import"../../../rpg-character/rpg-character.js";import"./ui/app-hax-top-bar.js";import"./ui/app-hax-user-menu.js";import"./ui/app-hax-user-menu-button.js";import{DDD as h}from"../../../d-d-d/d-d-d.js";import{SuperDaemonInstance as u}from"../../../super-daemon/super-daemon.js";import"../../../super-daemon/lib/super-daemon-search.js";import{MicroFrontendRegistry as g}from"../../../micro-frontend-registry/micro-frontend-registry.js";import{enableServices as b}from"../../../micro-frontend-registry/lib/microServices.js";import{UserScaffoldInstance as v}from"../../../user-scaffold/user-scaffold.js";import{HAXCMSKeyboardShortcutsInstance as x}from"./utils/HAXCMSKeyboardShortcuts.js";import"../../../simple-modal/simple-modal.js";import"../../../simple-toolbar/lib/simple-toolbar-button.js";import"./haxcms-site-insights.js";import"../../../simple-fields/lib/simple-fields-form.js";import"./micros/haxcms-button-add.js";import"./haxcms-darkmode-toggle.js";import"../ui-components/site/site-remote-content.js";import"../../../page-flag/page-flag.js";import"../../../../wired-elements/lib/wired-button.js";const y=new URL("../assets/images/Logout.svg",import.meta.url).href;class HAXCMSSiteEditorUI extends(m(p(d(r(h))))){static get styles(){return[super.styles,t`
      ...
      <app-hax-top-bar part="top-bar" ?edit-mode="${this.editMode}">
        ...
        <div slot="center" class="toolbar-buttons">
          ...
          ></simple-toolbar-button>
          <simple-toolbar-button
            ?hidden="${!this.editMode||o.isPlatformAudience("novice")||!o.platformAllows("saveAndEdit")}"
            class="top-bar-button"
          ...
          ></simple-toolbar-button>
          <haxcms-button-add
            ?hidden="${this.editMode||!o.platformAllows("addPage")}"
            id="addpagebutton"
            class="top-bar-button"
          ...
          ></haxcms-button-add>
          <simple-toolbar-button
            ?hidden="${this.editMode||!o.platformAllows("outlineDesigner")}"
            id="outlinebutton"
            class="top-bar-button"
            icon="hax:site-map"
            icon-position="${this.getIconPosition(this.responsiveSize)}"
          ...
          <simple-toolbar-button
            ?hidden="${this.editMode||!o.platformAllows("styleGuide")}"
            ?disabled="${this.editMode}"
            id="styleguidebutton"
          ...
          <simple-toolbar-button
            ?hidden="${this.editMode||!o.platformAllows("insights")}"
            ?disabled="${this.editMode}"
            id="insightsbutton"
          ...
          <simple-toolbar-button
            ...
            id="manifestbtn"
            ?disabled="${this.editMode}"
            ?hidden="${this.editMode||!o.platformAllows("manifest")}"
        ...
        >
          ...
          >
            ...
            >
            <simple-icon-lite
              class="characterbtn-menu-icon ${this.userMenuOpen?"":"rotated"}"
