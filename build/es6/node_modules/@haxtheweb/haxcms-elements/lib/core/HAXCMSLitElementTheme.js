 ...
 */
import{css as t,LitElement as e,render as i,unsafeCSS as s,html as o,svg as n,mathml as r}from"../../../../lit/index.js";import{HAXCMSTheme as l}from"./HAXCMSThemeWiring.js";import{ResponsiveUtilityBehaviors as h}from"../../../responsive-utility/lib/responsive-utility-behaviors.js";import{store as a}from"./haxcms-site-store.js";import{autorun as d,toJS as c}from"../../../../mobx/dist/mobx.esm.js";import"../../../simple-icon/lib/simple-icons.js";import{SimpleIconsetStore as p}from"../../../simple-icon/lib/simple-iconset.js";import{editableTableDisplayStyles as m}from"../../../editable-table/lib/editable-table-behaviors.js";import{copyToClipboard as g}from"../../../utils/utils.js";class HAXCMSLitElementTheme extends(l(h(e))){constructor(){super(),this.isSafari=void 0!==globalThis.safari,this.editMode=!1,this.isLoggedIn=!1,this.__disposer=this.__disposer?this.__disposer:[],d((t=>{this.editMode=c(a.editMode),this.__disposer.push(t)})),d((t=>{c(a.activeItemContent);this.HAXCMSThemeSettings.autoScroll&&this.shadowRoot&&this.HAXCMSThemeSettings.scrollTarget&&this.HAXCMSThemeSettings.scrollTarget.scrollIntoView&&(this.isSafari?this.HAXCMSThemeSettings.scrollTarget.scrollIntoView():setTimeout((()=>{this.HAXCMSThemeSettings.scrollTarget.scrollIntoView(this.HAXCMSThemeSettings.scrollSettings)}),0)),setTimeout((()=>{let t=this.querySelectorAll("h1,h2,h3,h4,h5,h6");t.length>0&&t.forEach((t=>{t.addEventListener("click",this.copyLink.bind(this)),t.addEventListener("pointerenter",this.hoverIntentEnter.bind(this)),t.addEventListener("pointerleave",this.hoverIntentLeave.bind(this))}))}),100),this.__disposer.push(t)}))}render(){return o`
