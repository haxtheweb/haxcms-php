import{html as e,css as t}from"../../../../../lit/index.js";import{autorun as i,toJS as s}from"../../../../../mobx/dist/mobx.esm.js";import{DDD as o}from"../../../../d-d-d/d-d-d.js";import{store as a}from"../haxcms-site-store.js";import{HAXStore as d}from"../../../../hax-body/lib/hax-store.js";import{HAXCMSKeyboardShortcutsInstance as r}from"../utils/HAXCMSKeyboardShortcuts.js";import"../../../../simple-icon/lib/simple-icon-lite.js";class HAXCMSAboutDialogUI extends o{static get tag(){return"haxcms-about-dialog-ui"}static get properties(){return{haxVersion:{type:String,attribute:"hax-version"},keyboardShortcuts:{type:Array},markdownShortcuts:{type:Array}}}constructor(){super(),this.haxVersion="Loading…",this.keyboardShortcuts=[],this.markdownShortcuts=[],this.__disposer=[],this.__keyboardShortcutsUpdatedHandler=this._handleKeyboardShortcutsUpdated.bind(this),this._loadKeyboardShortcuts(),this._loadMarkdownShortcuts()}connectedCallback(){super.connectedCallback(),globalThis.addEventListener("haxcms-keyboard-shortcuts-updated",this.__keyboardShortcutsUpdatedHandler);const e=i(()=>{const e=s(a.version);this.haxVersion=e||"Loading…"});this.__disposer.push(e),this._loadKeyboardShortcuts(),this._loadMarkdownShortcuts()}disconnectedCallback(){for(globalThis.removeEventListener("haxcms-keyboard-shortcuts-updated",this.__keyboardShortcutsUpdatedHandler);this.__disposer.length;){const e=this.__disposer.pop();e&&"function"==typeof e?e():e&&"function"==typeof e.dispose&&e.dispose()}super.disconnectedCallback()}_loadKeyboardShortcuts(){const e=r.getShortcutsForDisplay();this.keyboardShortcuts=e.slice().sort((e,t)=>`${e.label} ${e.description}`.localeCompare(`${t.label} ${t.description}`))}_handleKeyboardShortcutsUpdated(){this._loadKeyboardShortcuts()}_loadMarkdownShortcuts(){const e=d.keyboardShortcuts||{},t=Object.keys(e),i=["#","##","###","####","#####","######","1.","-","*","+",">","```","---","***","___"];t.forEach(e=>{i.includes(e)||i.push(e)}),this.markdownShortcuts=i.filter(t=>e[t]).map(t=>({trigger:t,description:this._markdownShortcutDescription(e[t])}))}_markdownShortcutDescription(e){if(!e||!e.tag)return"Insert block";const t=e.tag.toLowerCase();switch(t){case"h2":return"Heading 2";case"h3":return"Heading 3";case"h4":return"Heading 4";case"h5":return"Heading 5";case"h6":return"Heading 6";case"ol":return"Numbered list";case"ul":return"Bulleted list";case"hr":return"Horizontal rule";case"code":return"Code block";case"blockquote":return"Blockquote";default:return`Insert ${t}`}}_shortcutsForContext(e){return this.keyboardShortcuts.filter(t=>t.context===e)}_renderShortcutList(t){return t&&0!==t.length?e`<ul class="shortcut-list">
      ${t.map(t=>e`<li>
      ...
      `]}render(){const t=this._shortcutsForContext("edit"),i=this._shortcutsForContext("view"),s=this._shortcutsForContext("global");return e`
