import{LitElement as e,html as t,css as d}from"../../../../../../lit/index.js";const a=new URL("./images/sunIcon.png",import.meta.url).href,o=new URL("./images/moonIcon.png",import.meta.url).href;export class DarkmodeToggle extends e{constructor(){super(),this.checked=!1,this.label="Dark mode",this.disabled=!1}static get tag(){return"darkmode-toggle"}_toggle(){this.disabled||(this.checked=!this.checked,this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0})))}_handleKeydown(e){"Enter"!==e.key&&" "!==e.key||(e.preventDefault(),this._toggle())}static get properties(){return{checked:{type:Boolean,reflect:!0},disabled:{type:Boolean,reflect:!0},label:{type:String}}}render(){const e=this.checked?o:a;return t`
      <button
      ...
      >
        <img class="icon" src="${e}" alt="" aria-hidden="true" />
