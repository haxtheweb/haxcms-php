import{html as i,css as t}from"../../../../lit/index.js";import{DDD as a}from"../../../d-d-d/d-d-d.js";import"../../../simple-icon/lib/simple-icon-button-lite.js";class HAXCMSSiteSettingsDashboard extends a{static get tag(){return"haxcms-site-settings-dashboard"}static get properties(){return{allowStyleGuide:{type:Boolean,attribute:"allow-style-guide"},allowInsights:{type:Boolean,attribute:"allow-insights"}}}constructor(){super(),this.allowStyleGuide=!1,this.allowInsights=!1}static get styles(){return[super.styles,t`
        :host {
          display: block;
      ...
      `]}_actionTap(i){this.dispatchEvent(new CustomEvent("haxcms-site-settings-dashboard-action",{bubbles:!0,composed:!0,cancelable:!1,detail:{action:i}}))}render(){return i`
      <div class="dashboard">
