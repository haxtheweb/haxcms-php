...
import{LitElement as r,html as t,css as e}from"../../lit/index.js";import{DDDSuper as a}from"../d-d-d/d-d-d.js";import{I18NMixin as i}from"../i18n-manager/lib/I18NMixin.js";export class AuthorCard extends(a(i(r))){static get tag(){return"author-card"}constructor(){super(),this.name="",this.title="",this.description="",this.image="",this.profileUrl="",this.socialLink="",this.socialHandle="",this.dark=!1,this.accentColor="blue",this.primaryColor="blue",this.t=this.t||{},this.t={...this.t,visitProfile:"Visit profile",profileAlt:"Visit profile"},this.registerLocalization({context:this,localesPath:new URL("./locales/author-card.ar.json",import.meta.url).href+"/../",locales:["ar","es","hi","zh","pt","bn","ru","fr","ja"]})}static get properties(){return{...super.properties,name:{type:String},title:{type:String},description:{type:String},image:{type:String},profileUrl:{type:String,attribute:"profile-url"},socialLink:{type:String,attribute:"social-link"},socialHandle:{type:String,attribute:"social-handle"},dark:{type:Boolean},accentColor:{type:String,attribute:"accent-color",reflect:!0},primaryColor:{type:String,attribute:"primary-color",reflect:!0}}}static get styles(){return[super.styles,e`
    ...
    `}haxHooks(){return{mediaSourceUpdated:"haxmediaSourceUpdated"}}haxmediaSourceUpdated(r,t){r&&t&&"function"==typeof t._mediaSrcMatches&&t._mediaSrcMatches(this.image,r)&&t._pokeMatchingImgs(this.shadowRoot,r)}static get haxProperties(){return new URL(`./lib/${this.tag}.haxProperties.json`,import.meta.url).href}}globalThis.customElements.define(AuthorCard.tag,AuthorCard);