import{LitElement as e,html as t,css as i,svg as r}from"../../lit/index.js";import{SchemaBehaviors as a}from"../schema-behaviors/schema-behaviors.js";import{lazyImageLoader as d}from"../lazy-image-helpers/lazy-image-helpers.js";import{I18NMixin as o}from"../i18n-manager/lib/I18NMixin.js";import"../simple-icon/lib/simple-icon-lite.js";import"../simple-icon/lib/simple-icons.js";import"../simple-icon/lib/simple-icon-button-lite.js";import{DDD as s}from"../d-d-d/d-d-d.js";class SelfCheck extends(o(d(a(s)))){constructor(){super(),this.correct=!1,this.alt="",this.image="",this.question="",this.accentColor="primary",this.title="Self-Check",this.fullWidthImage=!1,this.hasLearningObjective="",this.assessing="",this.t={revealAnswer:"Reveal Answer",close:"Close",moreInformation:"More information"},this.registerLocalization({context:this,basePath:import.meta.url})}static get styles(){return[super.styles,i`
    ...
    `}updated(e){super.updated&&super.updated(e),e.forEach((e,t)=>{"elementVisible"==t&&this.elementVisible&&(import("../user-action/user-action.js"),import("../simple-tooltip/simple-tooltip.js"))})}static get tag(){return"self-check"}firstUpdated(e){super.firstUpdated&&super.firstUpdated(e),this.setAttribute("typeof","oer:Assessment")}static get properties(){return{...super.properties,title:{type:String},question:{type:String},image:{type:String,reflect:!0},alt:{type:String,reflect:!0},describedBy:{type:String,attribute:"described-by"},link:{type:String},correct:{type:Boolean,reflect:!0},accentColor:{type:String,attribute:"accent-color",reflect:!0},hasLearningObjective:{type:String,attribute:"has-learning-objective"},assessing:{type:String,attribute:"assessing"}}}haxHooks(){return{activeElementChanged:"haxactiveElementChanged",mediaSourceUpdated:"haxmediaSourceUpdated"}}haxmediaSourceUpdated(e,t){e&&t&&"function"==typeof t._mediaSrcMatches&&t._mediaSrcMatches(this.image,e)&&t._pokeMatchingImgs(this.shadowRoot,e)}haxactiveElementChanged(e,t){let i=this.shadowRoot.querySelector("#title");return t?i.setAttribute("contenteditable",!0):(i.removeAttribute("contenteditable"),this.title=i.innerText),!1}openAnswer(e){this.correct=!this.correct}static get haxProperties(){return new URL(`./lib/${this.tag}.haxProperties.json`,import.meta.url).href}}globalThis.customElements.define(SelfCheck.tag,SelfCheck);export{SelfCheck};