...
import{LitElement as t,html as e,css as o}from"../../../lit/index.js";import"../../simple-icon/lib/simple-icon-lite.js";import"../../simple-icon/lib/simple-icons.js";import{store as r}from"../../haxcms-elements/lib/core/haxcms-site-store.js";import{autorun as a,toJS as i}from"../../../mobx/dist/mobx.esm.js";class BootstrapBreadcrumb extends t{static get styles(){return[o`
      ...
      `]}static get tag(){return"bootstrap-breadcrumb"}static get properties(){return{items:{type:Array},homeItem:{type:Object},colorTheme:{type:String,reflect:!0,attribute:"color-theme"}}}constructor(){super(),this.items=[],this._activeItem={},this.homeItem={};let t=this.getBasePath(decodeURIComponent(import.meta.url));this._bootstrapPath=t+"bootstrap/dist/css/bootstrap.min.css",this.__disposer=this.__disposer?this.__disposer:[],this.__disposer.push(a(t=>{let e=i(r.manifest.items[0]),o=i(r.activeItem);this.homeItem!==e&&(this.homeItem=e),o&&this._activeItem!==o&&(this.items=[],this._activeItem=o,this.items.push(o),o.parent&&this.addParentToItems(o))}))}render(){return e`
