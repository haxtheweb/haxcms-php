...
import{LitElement as t,html as e,css as o}from"../../../lit/index.js";import"../../simple-icon/lib/simple-icon-lite.js";import"../../simple-icon/lib/simple-icons.js";import{store as r}from"../../haxcms-elements/lib/core/haxcms-site-store.js";import{autorun as a,toJS as s}from"../../../mobx/dist/mobx.esm.js";class BootstrapBreadcrumb extends t{static get styles(){return[o`
      ...
      `]}static get tag(){return"bootstrap-breadcrumb"}static get properties(){return{items:{type:Array},homeItem:{type:Object},colorTheme:{type:String,reflect:!0,attribute:"color-theme"}}}constructor(){super(),this.items=[],this._activeItem={},this.homeItem={},this._bootstrapPath=this._resolveBootstrapStylesheetPath(),this.__disposer=this.__disposer?this.__disposer:[],this.__disposer.push(a(t=>{const e=s(r.manifest.items[0]),o=s(r.activeItem);Promise.resolve().then(()=>{let t=e,r=o;this.homeItem!==t&&(this.homeItem=t),r&&this._activeItem!==r&&(this.items=[],this._activeItem=r,this.items.push(r),r.parent&&this.addParentToItems(r))})}))}render(){return e`
