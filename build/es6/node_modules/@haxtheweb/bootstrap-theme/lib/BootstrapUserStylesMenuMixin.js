import{css as t,html as e}from"../../../lit/index.js";import{normalizeEventPath as o}from"../../utils/utils.js";const BootstrapUserStylesMenuMixin=function(s){return class extends s{constructor(){super(),this.hideUserStylesMenu=!0,this.fontSize=1,this.fontFamily=0,this.colorTheme="0";let t=this.getBasePath(decodeURIComponent(import.meta.url));this._bootstrapPath=t+"bootstrap/dist/css/bootstrap.min.css",this.addEventListener("click",this.checkUserStylesMenuOpen.bind(this))}static get styles(){let e=[];return super.styles&&(e=super.styles),[e,t`
          :host([color-theme="0"]) {
          }
