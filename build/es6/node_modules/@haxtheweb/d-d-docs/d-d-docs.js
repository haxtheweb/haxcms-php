...
import"../accent-card/accent-card.js";import"../course-design/lib/block-quote.js";import"../course-design/lib/learning-component.js";import{DDD as e}from"../d-d-d/d-d-d.js";import"../d-d-d/lib/ddd-card.js";import"../d-d-d/lib/ddd-steps-list-item.js";import"../d-d-d/lib/ddd-steps-list.js";import{getDDDPaletteOptionByValue as t,getDDDPaletteOptions as a}from"../d-d-d/lib/DDDPaletteRegistry.js";import{ApplicationAttributeData as s,DDDAllStyles as d}from"../d-d-d/lib/DDDStyles.js";import"../d-d-d/lib/hax-palette-picker.js";import"../figure-label/figure-label.js";import"../media-image/media-image.js";import"../page-section/page-section.js";import"../self-check/self-check.js";import"../simple-cta/simple-cta.js";import"../stop-note/stop-note.js";import"../video-player/video-player.js";import{css as l,html as i}from"../../lit/index.js";export const styleGuideTopics={DDDelementsList:"DDDelementsList",Breakpoints:"Breakpoints",DataAttributes:"DataAttributes",Borders:"Borders",DefaultColors:"DefaultColors",DefaultFunctionalColors:"DefaultFunctionalColors",Palettes:"Palettes",PalettePicker:"PalettePicker",Gradients:"Gradients",Radius:"Radius",Shadows:"Shadows",Spacing:"Spacing",HeaderSample:"HeaderSample",Typography:"Typography",RichText:"RichText",InstructionalComponents:"InstructionalComponents",Cards:"Cards",StepsList:"Steps List",Buttons:"Buttons",PageSections:"PageSections"};class DDDocs extends e{constructor(){super(),this.option="*",this.options=Object.keys(styleGuideTopics),this.palettePickerOptions=a();const e=t("0","0",this.palettePickerOptions);this.palettePickerValue=e?e.dataPalette:"0"}static get properties(){return{option:{type:String},options:{type:Array},palettePickerOptions:{type:Array,attribute:!1},palettePickerValue:{type:String}}}static get styles(){return[super.styles,d,l`
      ...
      `]}renderDataAttributes(){return i`${Object.keys(s).map(e=>i`
          <h2>${e}</h2>
          <div>
            ${Object.keys(s[e]).map(t=>i`
      ...
      >
        ...
        <details style="max-width: 100%; margin: 0 64px;">
          ...
          ${Array(6).fill().map((e,a)=>0===a?i`<h2
                ...
                >
                  Sample Header
                </h2>`:2===a?i`<h2 data-primary="${t}" data-design-treatment="bg">
                  Sample Header
                </h2>`:3===a?i`<h2 data-primary="${t}" data-instructional-action>
                  Sample Header
                </h2>`:4===a?i`<h2
                  data-primary="${t}"
