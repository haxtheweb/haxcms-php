 ...
 */
import{html as e,css as t}from"../../lit/index.js";import{DDD as s}from"../d-d-d/d-d-d.js";import{DDDAllStyles as a,ApplicationAttributeData as d}from"../d-d-d/lib/DDDStyles.js";import"../page-section/page-section.js";import"../simple-cta/simple-cta.js";import"../video-player/video-player.js";import"../figure-label/figure-label.js";import"../stop-note/stop-note.js";import"../course-design/lib/learning-component.js";import"../course-design/lib/block-quote.js";import"../self-check/self-check.js";import"../media-image/media-image.js";import"../accent-card/accent-card.js";import"../d-d-d/lib/ddd-card.js";export const styleGuideTopics={DDDelementsList:"DDDelementsList",Breakpoints:"Breakpoints",DataAttributes:"DataAttributes",Borders:"Borders",DefaultColors:"DefaultColors",DefaultFunctionalColors:"DefaultFunctionalColors",Gradients:"Gradients",Radius:"Radius",Shadows:"Shadows",Spacing:"Spacing",HeaderSample:"HeaderSample",Typography:"Typography",RichText:"RichText",InstructionalComponents:"InstructionalComponents",Cards:"Cards",Buttons:"Buttons",PageSections:"PageSections"};class DDDocs extends s{constructor(){super(),this.option="*",this.options=Object.keys(styleGuideTopics)}static get properties(){return{option:{type:String},options:{type:Array}}}static get styles(){return[super.styles,a,t`
        /* used for demo */
        :host {
          display: block;
        }
    ...
    <h3>ddd-card</h3>
          ...
          </ddd-card>`}renderButtons(){let t=[];for(let s=0;s<22;s++){Math.floor(14*Math.random());t.push(e`
        <div class="grid-3 ">
