 ...
 */
import"../accent-card/accent-card.js";import"../course-design/lib/block-quote.js";import"../course-design/lib/learning-component.js";import{DDD as e}from"../d-d-d/d-d-d.js";import"../d-d-d/lib/ddd-card.js";import"../d-d-d/lib/ddd-steps-list-item.js";import"../d-d-d/lib/ddd-steps-list.js";import{getDDDPaletteOptionByValue as t,getDDDPaletteOptions as a}from"../d-d-d/lib/DDDPaletteRegistry.js";import{ApplicationAttributeData as s,DDDAllStyles as d}from"../d-d-d/lib/DDDStyles.js";import{DDDBorders as l}from"../d-d-d/lib/DDDBorders.js";import{DDDMarginPadding as i}from"../d-d-d/lib/DDDMarginPadding.js";import{DDDFontSizing as r}from"../d-d-d/lib/DDDFontSizing.js";import{DDDLineHeight as o}from"../d-d-d/lib/DDDLineHeight.js";import"../d-d-d/lib/hax-palette-picker.js";import{DDDPATTERNS as n,INTERNAL_CONTRACTS as c,getPatternsByLevel as p,getContractsForElement as m,resolveHaxCapabilityReport as h}from"../d-d-d/lib/DDDPatternLibrary.js";import"../a11y-collapse/a11y-collapse.js";import"../a11y-figure/a11y-figure.js";import"../a11y-tabs/a11y-tabs.js";import"../author-card/author-card.js";import"../audio-player/audio-player.js";import"../editable-table/editable-table.js";import"../grid-plate/grid-plate.js";import"../image-compare-slider/image-compare-slider.js";import"../image-gallery/image-gallery.js";import"../lrndesign-timeline/lrndesign-timeline.js";import"../media-playlist/media-playlist.js";import"../person-testimonial/person-testimonial.js";import"../simple-icon/lib/simple-icon-lite.js";import"../simple-fields/lib/simple-tag.js";import"../simple-fields/simple-fields.js";import"../count-up/count-up.js";import"../simple-pager/simple-pager.js";import"../page-contents-menu/page-contents-menu.js";import"../simple-login/simple-login.js";import"../simple-toast/simple-toast.js";import"../simple-progress/simple-progress.js";import"../multiple-choice/multiple-choice.js";import"../flash-card/lib/flash-card-set.js";import"../progress-donut/progress-donut.js";import"../a11y-carousel/a11y-carousel.js";import"../lrndesign-chart/lib/lrndesign-bar.js";import"../social-share-link/social-share-link.js";import"../q-r/q-r.js";import"../date-card/date-card.js";import"../post-card/post-card.js";import"../promise-progress/promise-progress.js";import"../collection-list/collection-list.js";import"../vocab-term/vocab-term.js";import"../oer-schema/oer-schema.js";import"../figure-label/figure-label.js";import"../media-image/media-image.js";import"../page-section/page-section.js";import"../self-check/self-check.js";import"../simple-cta/simple-cta.js";import"../stop-note/stop-note.js";import"../video-player/video-player.js";import{css as u,html as g}from"../../lit/index.js";import{unsafeHTML as v}from"../../lit/directives/unsafe-html.js";export const styleGuideTopics={DDDelementsList:"DDDelementsList",Breakpoints:"Breakpoints",DataAttributes:"DataAttributes",Borders:"Borders",DefaultColors:"DefaultColors",DefaultFunctionalColors:"DefaultFunctionalColors",Palettes:"Palettes",PalettePicker:"PalettePicker",Gradients:"Gradients",Radius:"Radius",Shadows:"Shadows",Spacing:"Spacing",HeaderSample:"HeaderSample",Typography:"Typography",RichText:"RichText",InstructionalComponents:"InstructionalComponents",Cards:"Cards",StepsList:"Steps List",Buttons:"Buttons",PageSections:"PageSections",Atoms:"Atoms",Molecules:"Molecules",Organisms:"Organisms",Templates:"Templates",InternalContracts:"InternalContracts"};class DDDocs extends e{constructor(){super(),this.option="*",this.options=Object.keys(styleGuideTopics),this.palettePickerOptions=a();const e=t("0","0",this.palettePickerOptions);this.palettePickerValue=e?e.dataPalette:"0"}static get properties(){return{option:{type:String},options:{type:Array},palettePickerOptions:{type:Array,attribute:!1},palettePickerValue:{type:String}}}static get styles(){return[super.styles,d,l,i,r,o,u`
        /* used for demo */
        :host {
          display: block;
        }
      ...
      `]}renderDataAttributes(){return g`${Object.keys(s).map(e=>g`
          <h2>${e}</h2>
          <div>
            ${Object.keys(s[e]).map(t=>g`
      ...
      >
        ${Object.keys(s.primary).map(e=>g`
            ...
            >
          `)}
      </div> `}renderHeaderSample(){let e=[];for(let t=0;t<22;t++)e.push(g`
        <details style="max-width: 100%; margin: 0 64px;">
          ...
          ${Array(6).fill().map((e,a)=>0===a?g`<h2
                ...
                >
                  Sample Header
                </h2>`:2===a?g`<h2 data-primary="${t}" data-design-treatment="bg">
                  Sample Header
                </h2>`:3===a?g`<h2 data-primary="${t}" data-instructional-action>
                  Sample Header
                </h2>`:4===a?g`<h2
                  data-primary="${t}"
      ...
      `);return e}renderDDDelementsList(){return g`
    ...
    `}renderDefaultFunctionalColors(){return g`
      <h2 class="fs-s mt-0 mb-2 pb-5 bb-sm">
    ...
    `}renderCards(){return g` <h3>ddd-card</h3>
      <ddd-card
      ...
      </ddd-card>`}renderStepsList(){return g`
    ...
    `}renderButtons(){let e=[];for(let t=0;t<22;t++){Math.floor(14*Math.random());e.push(g`
        <div class="grid-3 ">
    ...
    `}renderInstructionalComponents(){return g`
      <div class="b-xs">
        <div class="m-10">
          <h3>figure-label</h3>
          <figure-label
    ...
    `}_renderPatternCard(e){const t=h().flaggedPatterns.find(t=>t.id===e.id);return g`
      <div class="pattern-card">
        <div class="pattern-card-header">
          <span class="pattern-card-title">${e.title}</span>
          <span class="pattern-card-level">${e.level}</span>
        </div>
        <p class="pattern-card-desc">${e.description}</p>
        ${t?g`<div class="pattern-gap">
              HAX-capability gap: ${t.excludedComponents.join(", ")} is not HAX-capable. This pattern is documented but not
        ...
        <div class="pattern-recipe-wrapper">
          <simple-icon-button-lite
            ...
            icon="content-copy"
            label="Copy HTML"
            @click="${()=>this._copyToClipboard(e.html,e.id)}"
          ></simple-icon-button-lite>
          <pre class="pattern-recipe">${e.html}</pre>
        </div>
        <div class="pattern-meta">
          ${(e.tokens||[]).map(e=>g`<simple-tag
                value="${e}"
                accent-color="grey"
                readonly
              ></simple-tag>`)}
          ...
          <simple-cta
            ?disabled="${!!t}"
            @click="${()=>this._insertPattern(e)}"
            >Insert</simple-cta
          >
          <span
            class="pattern-copy-feedback"
            id="copy-feedback-${e.id}"
            hidden
            >Copied!</span
          >
        </div>
      </div>
    `}_renderPatternsByLevel(e,t){const a=p(e);return g`
      <h2 class="fs-s mt-0 mb-2 pb-5 bb-sm">${t}</h2>
      <div class="pattern-section">
        ${a.map(e=>this._renderPatternCard(e))}
      </div>
    `}async _copyToClipboard(e,t){try{await globalThis.navigator.clipboard.writeText(e)}catch(e){}const a=this.shadowRoot.querySelector(`#copy-feedback-${t}`);a&&(a.hidden=!1,a.style.animation="none",a.offsetWidth,a.style.animation="",clearTimeout(this[`__copyTimer-${t}`]),this[`__copyTimer-${t}`]=setTimeout(()=>{a.hidden=!0},1600))}async _insertPattern(e){if(globalThis.HaxStore&&"function"==typeof globalThis.HaxStore.requestAvailability)try{const t=globalThis.HaxStore.requestAvailability();if(t&&"function"==typeof t.htmlToHaxElements&&t.activeHaxBody){const a=await t.htmlToHaxElements(e.html);return void t.activeHaxBody.dispatchEvent(new CustomEvent("hax-insert-content-array",{bubbles:!0,cancelable:!0,composed:!0,detail:a}))}}catch(e){}try{await globalThis.navigator.clipboard.writeText(e.html)}catch(e){}}renderAtoms(){return this._renderPatternsByLevel("atom","Atoms")}renderMolecules(){return this._renderPatternsByLevel("molecule","Molecules")}renderOrganisms(){return this._renderPatternsByLevel("organism","Organisms")}renderTemplates(){return this._renderPatternsByLevel("template","Templates")}renderInternalContracts(){return g`
      ...
      <div class="pattern-section">
        ${c.map(e=>g`
            <div class="contract-card">
              <p class="contract-card-title">${e.title}</p>
              <p class="contract-card-surface">Surface: ${e.surface}</p>
              <p class="contract-card-structure">${e.structure}</p>
              ${e.example?g`<p class="contract-example-label">Example</p>
                    <div class="contract-example">
                      ${v(e.example)}
                      <div class="pattern-meta" style="margin-top: var(--ddd-spacing-3)">
                        <simple-cta
                          hide-icon
                          @click="${()=>this._copyToClipboard(e.example,e.id)}"
                          >Copy</simple-cta
                        >
                        <span
                          class="pattern-copy-feedback"
              ...
              <p class="contract-card-targets">
                Applies to: ${(e.targetElements||[]).join(", ")}
              </p>
            </div>
          `)}
      </div>
    `}selectOption(){return g`
