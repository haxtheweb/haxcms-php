 ...
 */
import"../accent-card/accent-card.js";import"../course-design/lib/block-quote.js";import"../course-design/lib/learning-component.js";import{DDD as e}from"../d-d-d/d-d-d.js";import"../d-d-d/lib/ddd-card.js";import"../d-d-d/lib/ddd-steps-list-item.js";import"../d-d-d/lib/ddd-steps-list.js";import{getDDDPaletteOptionByValue as t,getDDDPaletteOptions as s}from"../d-d-d/lib/DDDPaletteRegistry.js";import{ApplicationAttributeData as a,DDDAllStyles as d}from"../d-d-d/lib/DDDStyles.js";import"../d-d-d/lib/hax-palette-picker.js";import"../figure-label/figure-label.js";import"../media-image/media-image.js";import"../page-section/page-section.js";import"../self-check/self-check.js";import"../simple-cta/simple-cta.js";import"../stop-note/stop-note.js";import"../video-player/video-player.js";import{css as l,html as i}from"../../lit/index.js";export const styleGuideTopics={DDDelementsList:"DDDelementsList",Breakpoints:"Breakpoints",DataAttributes:"DataAttributes",Borders:"Borders",DefaultColors:"DefaultColors",DefaultFunctionalColors:"DefaultFunctionalColors",Palettes:"Palettes",PalettePicker:"PalettePicker",Gradients:"Gradients",Radius:"Radius",Shadows:"Shadows",Spacing:"Spacing",HeaderSample:"HeaderSample",Typography:"Typography",RichText:"RichText",InstructionalComponents:"InstructionalComponents",Cards:"Cards",StepsList:"Steps List",Buttons:"Buttons",PageSections:"PageSections"};class DDDocs extends e{constructor(){super(),this.option="*",this.options=Object.keys(styleGuideTopics),this.palettePickerOptions=s();const e=t("0","0",this.palettePickerOptions);this.palettePickerValue=e?e.dataPalette:"0"}static get properties(){return{option:{type:String},options:{type:Array},palettePickerOptions:{type:Array,attribute:!1},palettePickerValue:{type:String}}}static get styles(){return[super.styles,d,l`
        /* used for demo */
        :host {
          display: block;
        }
      ...
      `]}renderDataAttributes(){return i`${Object.keys(a).map(e=>i`
          <h2>${e}</h2>
          <div>
            ${Object.keys(a[e]).map(t=>i`
      ...
      >
        ${Object.keys(a.primary).map(e=>i`
            ...
            >
          `)}
      </div> `}renderHeaderSample(){let e=[];for(let t=0;t<22;t++)e.push(i`
        <details style="max-width: 100%; margin: 0 64px;">
          ...
          ${Array(6).fill().map((e,s)=>i`
                <div
                  class="my-16"
                  data-accent
                  data-primary="${t}"
                  style="--ddd-theme-accent: var(--ddd-accent-${s}); border: var(--ddd-border-sm); border-color: var(--ddd-theme-primary);"
                >
          ...
          ${Array(6).fill().map((e,s)=>0===s?i`<h2
                ...
                >
                  Sample Header
                </h2>`:2===s?i`<h2 data-primary="${t}" data-design-treatment="bg">
                  Sample Header
                </h2>`:3===s?i`<h2 data-primary="${t}" data-instructional-action>
                  Sample Header
                </h2>`:4===s?i`<h2
                  data-primary="${t}"
      ...
      `);return e}renderDDDelementsList(){return i`
    ...
    `}renderDefaultFunctionalColors(){return i`
      <h2 class="fs-s mt-0 mb-2 pb-5 bb-sm">
    ...
    `}_onPalettePickerValueChanged(e){e.detail&&(e.detail.value||"0"===e.detail.value)&&e.detail.value.toString?this.palettePickerValue=e.detail.value.toString():this.palettePickerValue="0"}renderPalettePicker(){const e=t(this.palettePickerValue,"0",this.palettePickerOptions),s=e?e.dataPalette:"0",a=e?e.label:"",d=e?e.key:"",l=e&&Array.isArray(e.swatches)?e.swatches:[1,2,3,4,5,6,7];return i`
      ...
      <div class="palette-picker-layout">
        ...
        <div class="palette-picker-preview-stack">
          <div class="palette-picker-preview" data-palette="${s}">
    ...
    `}renderCards(){return i` <h3>ddd-card</h3>
      <ddd-card
      ...
      </ddd-card>`}renderStepsList(){return i`
    ...
    `}renderButtons(){let e=[];for(let t=0;t<22;t++){Math.floor(14*Math.random());e.push(i`
        <div class="grid-3 ">
    ...
    `}renderInstructionalComponents(){return i`
      <div class="b-xs">
        <div class="m-10">
          <h3>figure-label</h3>
          <figure-label
