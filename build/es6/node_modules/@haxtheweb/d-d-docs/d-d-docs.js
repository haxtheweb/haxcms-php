 ...
 */
import"../accent-card/accent-card.js";import"../course-design/lib/block-quote.js";import"../course-design/lib/learning-component.js";import{DDD as e}from"../d-d-d/d-d-d.js";import"../d-d-d/lib/ddd-card.js";import"../d-d-d/lib/ddd-steps-list-item.js";import"../d-d-d/lib/ddd-steps-list.js";import{ApplicationAttributeData as t,DDDAllStyles as s}from"../d-d-d/lib/DDDStyles.js";import"../figure-label/figure-label.js";import"../media-image/media-image.js";import"../page-section/page-section.js";import"../self-check/self-check.js";import"../simple-cta/simple-cta.js";import"../stop-note/stop-note.js";import"../video-player/video-player.js";import{css as a,html as d}from"../../lit/index.js";export const styleGuideTopics={DDDelementsList:"DDDelementsList",Breakpoints:"Breakpoints",DataAttributes:"DataAttributes",Borders:"Borders",DefaultColors:"DefaultColors",DefaultFunctionalColors:"DefaultFunctionalColors",Palettes:"Palettes",Gradients:"Gradients",Radius:"Radius",Shadows:"Shadows",Spacing:"Spacing",HeaderSample:"HeaderSample",Typography:"Typography",RichText:"RichText",InstructionalComponents:"InstructionalComponents",Cards:"Cards",StepsList:"Steps List",Buttons:"Buttons",PageSections:"PageSections"};class DDDocs extends e{constructor(){super(),this.option="*",this.options=Object.keys(styleGuideTopics)}static get properties(){return{option:{type:String},options:{type:Array}}}static get styles(){return[super.styles,s,a`
        /* used for demo */
        :host {
          display: block;
        }
      ...
      `]}renderDataAttributes(){return d`${Object.keys(t).map((e=>d`
          <h2>${e}</h2>
          <div>
            ${Object.keys(t[e]).map((t=>d`
      ...
      >
        ${Object.keys(t.primary).map((e=>d`
            <simple-cta data-primary="${e}" data-pulse
              >Primary-${e}</simple-cta
            >
            <simple-cta data-primary="${e}" data-pulse light
              >Primary-${e}</simple-cta
            >
          `))}
      </div> `}renderHeaderSample(){let e=[];for(let t=0;t<22;t++)e.push(d`
        <details style="max-width: 100%; margin: 0 64px;">
          ...
          ${Array(6).fill().map(((e,s)=>0===s?d`<h2
                ...
                >
                  Sample Header
                </h2>`:2===s?d`<h2 data-primary="${t}" data-design-treatment="bg">
                  Sample Header
                </h2>`:3===s?d`<h2 data-primary="${t}" data-instructional-action>
                  Sample Header
                </h2>`:4===s?d`<h2
                  data-primary="${t}"
      ...
      `);return e}renderDDDelementsList(){return d`
    ...
    `}renderDefaultFunctionalColors(){return d`
      <h2 class="fs-s mt-0 mb-2 pb-5 bb-sm">
    ...
    `}renderCards(){return d` <h3>ddd-card</h3>
      <ddd-card
      ...
      </ddd-card>`}renderStepsList(){return d`
    ...
    `}renderButtons(){let e=[];for(let t=0;t<22;t++){Math.floor(14*Math.random());e.push(d`
        <div class="grid-3 ">
    ...
    `}renderInstructionalComponents(){return d`
      <div class="b-xs">
        <div class="m-10">
          <h3>figure-label</h3>
          <figure-label
