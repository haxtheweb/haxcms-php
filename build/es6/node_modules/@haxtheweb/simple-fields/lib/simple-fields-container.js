import{LitElement as e,html as t,css as i}from"../../../lit/index.js";import{SimpleFieldsBaseStyles as s,SimpleFieldsLabelStyles as l,SimpleFieldsDescriptionStyles as r,SimpleFieldsRowStyles as o,SIMPLE_FIELDS_INLINE_DESCRIPTION_MAX_WORDS as a}from"./simple-fields-ui.js";import"../../simple-icon/lib/simple-icon-button-lite.js";import"../../simple-tooltip/simple-tooltip.js";const SimpleFieldsContainerBehaviors=function(e){return class extends e{static get tag(){return"simple-fields-container"}static get styles(){return[...s,...l,...r,...o,i`
          .info-toggle {
      ...
      `}get fieldId(){return`${this.id||"field"}.input`}get fieldMainTemplate(){return t`
        <div
          class="${this.inline||["checkbox","color","radio"].includes(this.type||"text")?"field-main inline":"field-main"} ${this.isRowBasedField?"row-layout":""}"
          part="field-main"
        >
          ${this.labelTemplate}
      ...
      `}get hasInlineDescription(){return!this._isScalableTextField&&(!!this.description&&this.description.trim().split(/\s+/).filter(Boolean).length<=a)}get hasInfoTooltip(){return!this._isScalableTextField&&(!!this.description&&this.description.trim().split(/\s+/).filter(Boolean).length>a)}get inlineDescriptionTemplate(){return this.hasInlineDescription?t` <span id="description" part="field-desc"
            >${this.description}</span
          >`:""}get infoToggleTemplate(){if(!this.hasInfoTooltip)return"";const e=`${this.fieldId}-info`.replaceAll(".","-");return t`
