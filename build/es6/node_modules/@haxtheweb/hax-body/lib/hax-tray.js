import{html as t,css as e}from"../../../lit/index.js";import{winEventsElement as i,camelCaseToDash as a,wipeSlot as o,normalizeEventPath as s,localStorageSet as r}from"../../utils/utils.js";import{HaxSchematizer as l,HaxElementizer as n}from"../../hax-body-behaviors/lib/HAXFields.js";import{SimpleTourFinder as d}from"../../simple-popover/lib/SimpleTourFinder.js";import{HAXStore as h}from"./hax-store.js";import{autorun as c,toJS as p}from"../../../mobx/dist/mobx.esm.js";import{HaxComponentStyles as u,HaxTrayDetail as m}from"./hax-ui-styles.js";import"../../simple-fields/simple-fields.js";import"../../simple-fields/lib/simple-fields-tab.js";import"../../simple-icon/lib/simple-icons.js";import"../../hax-iconset/lib/simple-hax-iconset.js";import"./hax-tray-upload.js";import"./hax-app-search.js";import"./hax-gizmo-browser.js";import"./hax-gizmo-browser.js";import"./hax-view-source.js";import"./hax-stax-browser.js";import"./hax-map.js";import"./hax-tray-button.js";import"./hax-toolbar-menu.js";import{SuperDaemonInstance as g}from"../../super-daemon/super-daemon.js";import{I18NMixin as v}from"../../i18n-manager/lib/I18NMixin.js";import{Undo as b}from"../../undo-manager/undo-manager.js";import"../../simple-toolbar/lib/simple-toolbar-menu-item.js";import{SimpleColors as y}from"../../simple-colors/simple-colors.js";class HaxTray extends(v(d(i(y)))){static get tag(){return"hax-tray"}constructor(){super(),this.tourController=new AbortController,this.dragController=new AbortController,this.tourName="hax",this.__winEvents={"can-redo-changed":"_redoChanged","can-undo-changed":"_undoChanged","hax-drop-focus-event":"_expandSettingsPanel","hax-toggle-active-node-lock":"_handleActiveNodeLock"},this.trayIcon="image:tune",this.resizeDrag=!1,this.hideToolbar=!1,this.dark=!1,this.__moveX=0,this.t={structure:"Structure",htmlSource:"HTML Source",structureTip:"View Page Structure",edit:"Edit",save:"Save",saveAndEdit:"Save and edit",move:"Move",close:"Close",menuAlignment:"Menu Alignment",menuLeft:"Move",menuRight:"Move",menuPosition:"Menu position",changeSideVisually:"Change which side of the screen the menu is affixed to visually.",expand:"Expand",collapse:"Collapse",menuSize:"Menu size",menuSizeDescription:"Expand or collapse the menu visually.",merlin:"Merlin",summonMerlin:"Summon Merlin",settings:"Settings",source:"Source",undo:"Undo",redo:"Redo",media:"Media",blocks:"Blocks",cancel:"Cancel",cancelWithoutSaving:"Cancel without saving",configure:"Configure",advanced:"Advanced",developer:"Developer",alignment:"Alignment",left:"Left",center:"Center",right:"Right",search:"Search",templates:"Templates",width:"Width"},this.registerLocalization({context:this,namespace:"hax",updateCallback:"_updateTrayDetail"}),this._initial=!0,this.activeValue={settings:{configure:{},advanced:{},developer:{}}},this.collapsed=!0,this.locked=!1,this.activeSchema=[{property:"settings",inputMethod:"collapse",properties:[]}],this.canUndo=!1,this.canRedo=!1,this.trayDetail="content-edit",this.activeTagName="",this.traySizeIcon="hax:arrow-expand-right",this.__setup=!1,this.addEventListener("hax-tray-button-click",this._processTrayEvent.bind(this)),c((()=>{this.activeGizmo=p(h.activeGizmo)})),c((()=>{this.activeNode=p(h.activeNode)})),c((()=>{this.elementAlign=p(h.elementAlign),globalThis.document&&globalThis.document.body&&("left"===this.elementAlign?globalThis.document.body.style.setProperty("--hax-tray-element-align-margin","0 0 0 var(--hax-tray-element-custom-width, calc(\n            var(--hax-tray-width) - var(--hax-tray-menubar-min-width)\n          ))"):globalThis.document.body.style.setProperty("--hax-tray-element-align-margin","0 var(--hax-tray-element-custom-width, calc(\n            var(--hax-tray-width) - var(--hax-tray-menubar-min-width)\n          )) 0 0"))})),c((()=>{this.tourOpened=p(h.tourOpened)})),c((()=>{this.globalPreferences=p(h.globalPreferences),this.haxUiTheme=(this.globalPreferences||{}).haxUiTheme||"hax",this.dark="haxdark"===this.haxUiTheme,globalThis.document.body.setAttribute("hax-ui-theme",this.haxUiTheme)})),c((()=>{this.editMode=p(h.editMode)}))}_expandSettingsPanel(t){this.hideToolbar||this.shadowRoot.querySelector("#content-edit").click()}_redoChanged(t){this.canRedo=t.detail.value}_undoChanged(t){this.canUndo=t.detail.value}_handleActiveNodeLock(t){if(!t.detail||!t.detail.node)return;if(this.activeNode!==t.detail.node)return;const e=this.locked;if(this.locked=!!t.detail.lock,e!==this.locked){if(this.shadowRoot&&this.shadowRoot.querySelector("#settingsform"))try{this.__lockAllSettings(this.locked)}catch(t){}h&&"function"==typeof h.refreshActiveNodeForm&&h.refreshActiveNodeForm(),this.requestUpdate()}}static get styles(){return[...super.styles||[],...m,...u,e`
    ...
    ></simple-fields>`}get contentAddTemplate(){let e="content-add"!==this.trayDetail;return t`<div class="block-add-wrapper">
      <hax-tray-upload ?hidden="${e||!h.platformAllows("uploadMedia")}" show-sources></hax-tray-upload>
      ${h.platformAllows("pageTemplates")?t`<hax-stax-browser
        id="pagesbrowser"
        ?hidden="${e}"
        label="${this.t.pages||"Pages"}"
        template-type="page"
      ></hax-stax-browser>`:""}
      ${h.platformAllows("blockTemplates")?t`<hax-stax-browser
        id="staxbrowser"
        ?hidden="${e}"
