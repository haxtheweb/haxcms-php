...
import{LitElement as t,html as e,css as o}from"../../../lit/index.js";import{RichTextEditorToolbarBehaviors as i}from"../../rich-text-editor/lib/toolbars/rich-text-editor-toolbar.js";import{HaxTextEditorButton as n}from"./hax-text-editor-button.js";import{HAXStore as r}from"./hax-store.js";import{HaxContextBehaviors as s}from"./hax-context-behaviors.js";import"./hax-text-editor-paste-button.js";import{I18NMixin as a}from"../../i18n-manager/lib/I18NMixin.js";import"./buttons/hax-text-editor-alignment-picker.js";import"./buttons/hax-text-editor-heading-picker.js";import"./buttons/hax-text-editor-tag-toggle.js";class HaxTextEditorToolbar extends(i(a(s(t)))){static get styles(){return[...super.baseStyles,...super.stickyStyles,o`
      ...
      `]}_platformAllowsTag(t){return!t||(!(!r.requiredPrimitives||!r.requiredPrimitives.has(t))||r.platformAllows(t))}_buttonTag(t){return t?t.tag?t.tag:t.element&&t.element.gizmo&&t.element.gizmo.tag?t.element.gizmo.tag:null:null}_filterButtonsByTag(t=[]){return t.filter(t=>{const e=this._buttonTag(t);return!e||this._platformAllowsTag(e)})}get tourTemplate(){return e` <div slot="tour" data-stop-content>
