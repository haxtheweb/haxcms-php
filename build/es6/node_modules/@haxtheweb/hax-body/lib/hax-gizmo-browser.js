                  ...
                  ${this.filtered.map(((i,a)=>t`${i&&i.tags&&i.tags.includes(e)?t` <simple-popover-selection
                          ...
                          >
                            <hax-tray-button
                              ...
                              slot="button"
                            ></hax-tray-button>
                            ${this.activePreview===a.toString()?t`
                                  <hax-element-demo
                                    render-tag="${i.tag}"
                                    slot="options"
                                  ></hax-element-demo>
