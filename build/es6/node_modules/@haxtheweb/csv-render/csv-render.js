...
import{html as t,css as e}from"../../lit/index.js";import{SimpleColors as o}from"../simple-colors/simple-colors.js";import"../simple-icon/lib/simple-icon-lite.js";import"../simple-icon/lib/simple-icons.js";import"../simple-icon/lib/simple-icon-button-lite.js";import{IntersectionObserverMixin as i}from"../intersection-element/lib/IntersectionObserverMixin.js";class CsvRender extends(i(o)){static get styles(){return[super.styles,e`
      ...
      `]}constructor(){super(),this.loading=!1,this.table=[],this.tableHeadings=[],this.tableData=""}updated(t){super.updated&&super.updated(t),t.forEach((t,e)=>{"elementVisible"==e&&this.elementVisible&&(import("../hexagon-loader/hexagon-loader.js"),import("../simple-tooltip/simple-tooltip.js")),["dataSource","elementVisible"].includes(e)&&this.dataSource&&this.elementVisible&&(clearTimeout(this.__debouce),this.loading=!0,this.__debouce=setTimeout(()=>{this.loadCSVData()},500))})}disconnectedCallback(){clearTimeout(this.__debouce),super.disconnectedCallback&&super.disconnectedCallback()}render(){return t`
      <hexagon-loader
        id="loading"
