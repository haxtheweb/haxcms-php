 ...
 */
import{html as e,css as t}from"../../lit/index.js";import{HAXCMSLitElementTheme as i}from"../haxcms-elements/lib/core/HAXCMSLitElementTheme.js";import"../haxcms-elements/lib/ui-components/site/site-title.js";import"../haxcms-elements/lib/ui-components/navigation/site-menu.js";import"../simple-icon/simple-icon.js";import"../simple-icon/lib/simple-icons.js";import"../simple-icon/lib/simple-icon-button-lite.js";import{LTIResizingMixin as o}from"../haxcms-elements/lib/core/utils/LTIResizingMixin.js";import{DDDSuper as a}from"../d-d-d/d-d-d.js";class LearnTwoTheme extends(o(a(i))){static get styles(){let e=[];return super.styles&&(e=super.styles),[e,t`
        :host {
          color: light-dark(
    ...
    `}static get properties(){return{...super.properties,opened:{type:Boolean,reflect:!0}}}toggleDrawer(e){this.opened=!this.opened}_closeDrawer(e){this.opened=!1}}globalThis.customElements.define(LearnTwoTheme.tag,LearnTwoTheme);export{LearnTwoTheme};