      ...
      >
        ${this.displayedAnswers.map((t=>e`
          ...
          ${this.showAnswer&&!this.isCorrect()?e` <p class="feedback">${this.incorrectText}</p>
                ${this.querySelector&&this.querySelector('[slot="feedbackIncorrect"]')?e`<slot name="feedbackIncorrect" property="oer:incorrectFeedback"></slot>`:""}`:""}
          ${this.showAnswer&&this.isCorrect()?e` <p class="feedback">${this.correctText}</p>
                ${this.querySelector&&this.querySelector('[slot="feedbackCorrect"]')?e`<slot name="feedbackCorrect" property="oer:correctFeedback"></slot>`:""}`:""}
          ${this.showAnswer?e`
