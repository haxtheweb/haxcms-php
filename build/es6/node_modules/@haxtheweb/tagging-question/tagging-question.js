 ...
 */
import{html as e,css as t}from"../../lit/index.js";import{QuestionElement as s}from"../multiple-choice/lib/QuestionElement.js";class TaggingQuestion extends s{static get tag(){return"tagging-question"}constructor(){super(),this.guessDataValue="selectedAnswers",this.dragEnter=!1,this.dragEnterAnswer=!1,this.dragging=!1,this.selectedAnswers=[]}static get styles(){return[super.styles,t`
        :host {
          display: block;
        }
        .tag-container {
  ...
  `:""}
    ...
    `}randomizeOptions(e){for(let t=e.length-1;t>0;t--){const s=Math.floor(Math.random()*(t+1));[e[t],e[s]]=[e[s],e[t]]}return e}handleDrag(e){const t=e.target.textContent.trim();e.dataTransfer.setData("text/plain",t),this.dragging=!0}handleDragEnd(e){const t=e.target.textContent.trim();e.dataTransfer.setData("text/plain",t),this.dragging=!1,this.dragEnter=!1,this.dragEnterAnswer=!1}allowDrop(e){e.preventDefault(),this.dragEnter=!0,this.dragEnterAnswer=!1}allowDropAnswer(e){e.preventDefault(),this.dragEnterAnswer=!0,this.dragEnter=!1}handleDrop(e){e.preventDefault(),this.dragging=!1,this.dragEnter=!1,this.dragEnterAnswer=!1;const t=e.dataTransfer.getData("text/plain");let s=this.answers.find((e=>e.label===t));const r=this.displayedAnswers.findIndex((e=>e.label===t)),i=this.selectedAnswers.findIndex((e=>e.label===t));-1!==r&&e.target&&"possible-container"!==e.target.getAttribute("id")?this.handleTagMove(s,"possible-container"):-1!==i&&e.target&&"user-choice-container"!==e.target.getAttribute("id")&&this.handleTagMove(s,"user-choice-container")}handleTagMove(e,t){"user-choice-container"===t?this.removeTag(e):this.addTag(e)}handleTagClick(e){1===this.selectedAnswers.filter((t=>t.label===e.label)).length?this.handleTagMove(e,"user-choice-container"):1===this.displayedAnswers.filter((t=>t.label===e.label)).length&&this.handleTagMove(e,"possible-container")}addTag(e){this.showAnswer||(this.selectedAnswers.push(e),this.displayedAnswers=this.displayedAnswers.filter((t=>t.label!==e.label)),this.requestUpdate())}removeTag(e){this.showAnswer||(this.selectedAnswers=this.selectedAnswers.filter((t=>t.label!==e.label)),this.displayedAnswers.push(e),this.requestUpdate())}checkAnswerCallback(){this.showAnswer=!0,this.shadowRoot.querySelector("#feedback").focus();this.answers.filter((e=>e.correct)).length===this.selectedAnswers.filter((e=>e.correct)).length&&this.selectedAnswers.filter((e=>e.correct)).length===this.selectedAnswers.length&&this.makeItRain()}resetAnswer(){this.showAnswer=!1,globalThis.dispatchEvent(new CustomEvent("simple-toast-hide",{bubbles:!0,composed:!0,cancelable:!1,detail:!1}));this.answers.filter((e=>e.correct)).length===this.selectedAnswers.filter((e=>e.correct)).length&&this.selectedAnswers.filter((e=>e.correct)).length===this.selectedAnswers.length&&(this.displayedAnswers=[...this.answers],this.selectedAnswers=[],this.randomizeOptions(this.displayedAnswers))}static get properties(){return{...super.properties,dragging:{type:Boolean,reflect:!0},dragEnter:{type:Boolean,reflect:!0,attribute:"drag-enter"},dragEnterAnswer:{type:Boolean,reflect:!0,attribute:"drag-enter-answer"},selectedAnswers:{type:Array}}}static get haxProperties(){return new URL(`./lib/${this.tag}.haxProperties.json`,import.meta.url).href}}globalThis.customElements.define(TaggingQuestion.tag,TaggingQuestion);export{TaggingQuestion};