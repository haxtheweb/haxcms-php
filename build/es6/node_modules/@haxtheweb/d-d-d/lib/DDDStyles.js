import"../../hax-iconset/lib/simple-hax-iconset.js";import"../../simple-icon/lib/simple-icons.js";import{SimpleIconsetStore as d}from"../../simple-icon/lib/simple-iconset.js";import{css as a,html as e,unsafeCSS as t}from"../../../lit/index.js";import{getDDDStyleGuideOptionsForTag as r,getDDDStyleGuidePresetByKey as i,getDDDStyleGuidePresetManagedAttributes as o,getDDDStyleGuideSchemaOverride as n}from"./DDDStyleGuidePresets.js";function applyStyleGuideDefaultsToProperties(d,a){if(!a||!d)return null;const e=function getStyleGuideDefaultDemoSchemaForTag(d){const a=n(d);return a&&a.demoSchema&&a.demoSchema[0]?a.demoSchema[0]:null}(d);if(!e)return null;const t=a.demoSchema&&a.demoSchema[0]?a.demoSchema[0]:{},r=t.properties?t.properties:{};return a.demoSchema=[{tag:t.tag||e.tag||d,content:"string"==typeof t.content?t.content:"string"==typeof e.content?e.content:"",properties:{...e.properties||{},...r}}],e}function applyStyleGuideDefaultsToStore(d,a,e){if(!d||!a)return;const t=applyStyleGuideDefaultsToProperties(a,e);t&&(d.styleGuideSchema||(d.styleGuideSchema={}),d.styleGuideSchema[a]||(d.styleGuideSchema[a]={}),d.styleGuideSchema[a].demoSchema=[{tag:t.tag||a,content:"string"==typeof t.content?t.content:"",properties:{...t.properties||{}}}],d.elementList&&d.elementList[a]&&d.elementList[a]!==e&&applyStyleGuideDefaultsToProperties(a,d.elementList[a]))}function dddStyleGuideValueChanged(d,a={}){if(!a.form||!a.form.formElements)return;const e=a.form,t=d&&d.detail?d.detail.value:void 0,r=i(t),n=r&&r.properties?r.properties:null;Object.keys(e.formElements).filter(d=>0===d.indexOf("settings.configure.ddd-styles.")).forEach(d=>{const a=e.formElements[d];!(-1!==d.indexOf(".ddd-styleguide")||-1!==d.indexOf(".data-style-guide"))&&a&&(a.field&&void 0!==a.field.disabled&&(n?(void 0===a.field.__dddStyleGuidePrevDisabled&&(a.field.__dddStyleGuidePrevDisabled=!!a.field.disabled),a.field.disabled=!0):void 0!==a.field.__dddStyleGuidePrevDisabled&&(a.field.disabled=a.field.__dddStyleGuidePrevDisabled,delete a.field.__dddStyleGuidePrevDisabled)),a.element&&void 0!==a.element.disabled&&(n?(void 0===a.element.__dddStyleGuidePrevDisabled&&(a.element.__dddStyleGuidePrevDisabled=!!a.element.disabled),a.element.disabled=!0):void 0!==a.element.__dddStyleGuidePrevDisabled&&(a.element.disabled=a.element.__dddStyleGuidePrevDisabled,delete a.element.__dddStyleGuidePrevDisabled)))}),o().forEach(d=>{const a=n&&void 0!==n[d]?n[d]:void 0,t=function getFormElementBySuffix(d,a){const e=Object.keys(d.formElements||{}).find(d=>d.endsWith(`.${a}`));return e?d.formElements[e]:null}(e,d);t&&t.element?t.element.value=a:"function"==typeof e._setValue&&e._setValue(`settings.configure.${d}`,a)})}globalThis&&globalThis.addEventListener&&globalThis.addEventListener("hax-store-ready",d=>{if(globalThis.HaxStore){const d=globalThis.HaxStore.requestAvailability();d.__dddStyleGuideDefaultSchemaReady||(d.__dddStyleGuideDefaultSchemaReady=!0,globalThis.addEventListener("hax-register-properties",a=>{a&&a.detail&&a.detail.tag&&a.detail.properties&&applyStyleGuideDefaultsToStore(d,a.detail.tag,a.detail.properties)})),Object.keys(d.elementList||{}).forEach(a=>{applyStyleGuideDefaultsToStore(d,a,d.elementList[a])}),d.designSystemHAXProperties=(a,e)=>{let t=[],i=[],o=[],n=[],p=[],l=[];a.canScale&&t.push({attribute:"data-width",title:"Width",description:"Scaled relative to width of container",inputMethod:"slider",min:a.canScale.min?a.canScale.min:25,max:a.canScale.max?a.canScale.max:100,step:a.canScale.step?a.canScale.step:25});let s=d.isInlineElement(e);if(a.gizmo&&a.gizmo.meta&&a.gizmo.meta.inlineOnly&&(s=!0),!a.hideDefaultSettings&&!s&&!1!==a.designSystem){const d=r(e);d.length>0&&i.push({attribute:"data-style-guide",title:"Style guide",description:"Preset style combinations from the style guide",inputMethod:"radio",onValueChanged:dddStyleGuideValueChanged,itemsList:d}),["media-image","img"].includes(e)?t.push({attribute:"data-float-position",title:"Float Position",description:"Alignment relative to other items on large screens",inputMethod:"select",options:{"":"-- default --",left:"Left",center:"Center",right:"Right"}}):t.push({attribute:"data-text-align",title:"Text align",description:"Horizontal alignment of text",inputMethod:"select",options:{"":"-- default --",left:"Left",center:"Center",right:"Right",justify:"Justify"}}),t.push({attribute:"data-padding",title:"Padding",description:"Padding for added aesthetics",inputMethod:"radio",itemsList:[...HAXOptionSampleFactory("padding")]}),t.push({attribute:"data-margin",title:"Margin",description:"Margin for added aesthetics",inputMethod:"radio",itemsList:[...HAXOptionSampleFactory("margin")]})}return!0!==a.designSystem&&!0!==a.designSystem.designTreatment||(["p","blockquote"].includes(e)?o.push({attribute:"data-design-treatment",title:"Design treatment",description:"Minor aesthetic treatments for emphasis",inputMethod:"radio",itemsList:[...HAXOptionSampleFactory("design-treatment").filter(d=>!(!d||!d.value.startsWith("dropCap")))]}):["h1","h2","h3","h4","h5","h6"].includes(e)&&o.push({attribute:"data-design-treatment",title:"Design treatment",description:"Minor aesthetic treatments for emphasis",inputMethod:"radio",itemsList:[...HAXOptionSampleFactory("design-treatment").filter(d=>!(!d||d.value.startsWith("dropCap")))]})),!0!==a.designSystem&&!0!==a.designSystem.accent||l.push({attribute:"data-accent",title:"Accent color",description:"Offset items visually for aesthetic purposes",inputMethod:"radio",itemsList:[...HAXOptionSampleFactory("accent")]}),!0!==a.designSystem&&!0!==a.designSystem.primary||l.push({attribute:"data-primary",title:"Primary color",description:"Primary color to apply color, often for meaning or aesthetic",inputMethod:"radio",itemsList:[...HAXOptionSampleFactory("primary")]}),!0!==a.designSystem&&!0!==a.designSystem.designTreatment||["h1","h2","h3","h4","h5","h6"].includes(e)&&o.push({attribute:"data-instructional-action",title:"Instructional Context",description:"Indicated to users visually",inputMethod:"radio",itemsList:[...HAXOptionSampleFactory("instructional-action")]}),!0!==a.designSystem&&!0!==a.designSystem.text||(n.push({attribute:"data-font-family",title:"Font family",inputMethod:"radio",itemsList:[...HAXOptionSampleFactory("font-family")]}),n.push({attribute:"data-font-weight",title:"Font weight",description:"Ensure it is only for aesthetic purposes",inputMethod:"radio",itemsList:[...HAXOptionSampleFactory("font-weight")]}),n.push({attribute:"data-font-size",title:"Font size",description:"Ensure sizing is only for aesthetic purposes",inputMethod:"radio",itemsList:[...HAXOptionSampleFactory("font-size")]})),!0!==a.designSystem&&!0!==a.designSystem.card||(p=[{attribute:"data-border-radius",title:"Border radius",description:"Border radius to apply",inputMethod:"radio",itemsList:[...HAXOptionSampleFactory("border-radius")]},{attribute:"data-border",title:"Border",description:"Thickness of the border",inputMethod:"radio",itemsList:[...HAXOptionSampleFactory("border")]},{attribute:"data-box-shadow",title:"Box shadow",description:"Subtly raises off the page",inputMethod:"radio",itemsList:[...HAXOptionSampleFactory("box-shadow")]}]),a.settings.configure.push({inputMethod:"collapse",property:"ddd-styles",properties:[{title:"Style Guide",collapsed:!0,accordion:!0,property:"ddd-styleguide",disabled:0===i.length,properties:i,hidden:0===i.length},{title:"Design treatment",collapsed:!0,accordion:!0,property:"ddd-designtreatment",disabled:0===o.length,properties:o,hidden:0===o.length},{title:"Colors",collapsed:!0,accordion:!0,property:"ddd-card",disabled:0===l.length,properties:l,hidden:0===l.length},{title:"Font",collapsed:!0,accordion:!0,property:"ddd-font",disabled:0===n.length,properties:n,hidden:0===n.length},{title:"Spacing",collapsed:!0,accordion:!0,property:"ddd-spacing",disabled:0===t.length,properties:t,hidden:0===t.length},{title:"Box appearance",collapsed:!0,accordion:!0,property:"ddd-box",disabled:0===p.length,properties:p,hidden:0===p.length}]}),a}}},{once:!0});export const learningComponentNouns={content:"Content",assessment:"Assessment",quiz:"Quiz",submission:"Submission",lesson:"Lesson",module:"Module",task:"Task",activity:"Activity",project:"Project",practice:"Practice",unit:"Unit",objectives:"Learning Objectives"};export const learningComponentVerbs={connection:"Connection",knowledge:"Did You Know?",strategy:"Learning Strategy",discuss:"Discuss",listen:"Listen",make:"Make",observe:"Observe",present:"Present",read:"Read",reflect:"Reflect",research:"Research",watch:"Watch",write:"Write"};export const learningComponentTypes={...learningComponentVerbs,...learningComponentNouns};export const learningComponentColors={content:"blue-grey",assessment:"red",quiz:"blue",submission:"deep-purple",lesson:"purple",module:"red",task:"blue-grey",activity:"orange",project:"deep-orange",practice:"brown",unit:"light-green",objectives:"indigo",connection:"green",knowledge:"cyan",strategy:"teal",discuss:"blue",listen:"purple",make:"orange",observe:"yellow",present:"light-blue",read:"lime",reflect:"amber",research:"deep-orange",watch:"pink",write:"deep-purple"};export function iconFromPageType(d){switch(d){case"content":return"lrn:page";case"assessment":return"lrn:assessment";case"quiz":return"lrn:quiz";case"submission":return"icons:move-to-inbox";case"lesson":return"hax:lesson";case"module":return"hax:module";case"unit":return"hax:unit";case"task":return"hax:task";case"activity":return"hax:ticket";case"project":return"hax:bulletin-board";case"practice":return"hax:shovel";case"connection":return"courseicons:chem-connection";case"knowledge":return"courseicons:knowledge";case"strategy":case"discuss":case"make":case"observe":case"present":case"read":case"reflect":case"research":case"watch":return"courseicons:strategy";case"listen":return"courseicons:listen";case"write":return"lrn:write"}return"courseicons:learning-objectives"}export const ApplicationAttributeData={primary:{0:"Pugh blue",1:"Beaver blue",2:"Nittany navy",3:"Potential midnight",4:"Coaly gray",5:"Limestone gray",6:"Slate gray",7:"Creek teal",8:"Sky blue",9:"Shrine tan",10:"Roar golden",11:"Original 87 pink",12:"Discovery coral",13:"Wonder purple",14:"Artherton violet",15:"Invent orange",16:"Keystone yellow",17:"Opportunity green",18:"Future lime",19:"Forest green",20:"Landgrant brown",21:"Global Neon",22:"Error",23:"Warning",24:"Info",25:"Success"},accent:{0:"Sky Max",1:"Slate Max",2:"Limestone Max",3:"Shrine Max",4:"Roar Max",5:"Creek Max",6:"White",7:"Error Light",8:"Warning Light",9:"Info Light",10:"Success Light",11:"Alert Immediate",12:"Alert Urgent",13:"Alert All Clear",14:"Alert Non Emergency"},margin:{center:"Center",xs:"X-Small",s:"Small",m:"Medium",l:"Large",xl:"X-Large"},padding:{xs:"X-Small",s:"Small",m:"Medium",l:"Large",xl:"X-Large"},border:{xs:"X-Small",sm:"Small",md:"Medium",lg:"Large"},"border-radius":{xs:"Rounded",md:"Rounder",xl:"Roundest"},"box-shadow":{sm:"Drop shadow"},"design-treatment":{vert:"Vertical line","horz-10p":"Horizontal line 10%","horz-25p":"Horizontal line 25%","horz-50p":"Horizontal line 50%","horz-full":"Horizontal line 100%","horz-md":"Horizontal line Medium","horz-lg":"Horizontal line Large",bg:"Background color","dropCap-sm":"Drop Cap - Small","dropCap-md":"Drop Cap - Medium","dropCap-lg":"Drop Cap - Large"},"font-family":{primary:"Roboto",secondary:"Roboto Slab",navigation:"Roboto Condensed"},"font-weight":{light:"Light",medium:"Medium",bold:"Bold"},"font-size":{"3xs":"Smaller",s:"Large",m:"Larger",l:"Largest"},"instructional-action":learningComponentTypes};export function HAXOptionSampleFactory(d){return Object.keys(ApplicationAttributeData[d]).map(a=>({value:a,html:["primary","accent"].includes(d)?e`<d-d-d-sample
            @click="${updatePreviewColorVar}"
            type="${d}"
            option="${a}"
          ></d-d-d-sample>`:e`<d-d-d-sample type="${d}" option="${a}"></d-d-d-sample>`}))}function updatePreviewColorVar(d){let a=d.target;globalThis.document.body.style.setProperty(`--ddd-sample-theme-${a.type}`,`var(--ddd-${a.type}-${a.option})`)}export const instructionalStyles=Object.keys(learningComponentColors).map(e=>{let r=learningComponentColors[e];return a`
      [data-instructional-action="${t(e)}"] {
...
`;export const DDDGlobalStyles=a`
  :root {
...
`;export const DDDDataAttributes=[a`
  ...
  `,...instructionalStyles];export const DDDReset=a`
  h1,
  h2,
  h3,
  h4,
...
`;export const DDDMarginPadding=a`
  .m-auto {
    margin: auto;
  }
  .m-0 {
...
`;export const DDDLetterSpacing=a`
  .ls-16-sm {
...
`;export const DDDBorderRadius=a`
  .r-0 {
...
`;export const DDDPaletteStyles=a`
/** Default Palette */
html, :root {
