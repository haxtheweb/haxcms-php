import{LitElement as t,html as d,css as r,nothing as a}from"../../../lit/index.js";import{DDDSuper as e}from"../d-d-d.js";import{I18NMixin as i}from"../../i18n-manager/lib/I18NMixin.js";export class DddCard extends(i(e(t))){static get tag(){return"ddd-card"}constructor(){super(),this.title=null,this.src=null,this.href=null,this.target="",this.rel="noopener nofollow noreferrer",this.alt="",this.label=null,this.noArrow=!1,this.t={explore:"Explore"},this.registerLocalization({context:this,localesPath:new URL(`../locales/${this.tag}.es.json`,import.meta.url).href+"/../",locales:["es"]})}static get properties(){return{...super.properties,title:{type:String},alt:{type:String},src:{type:String},href:{type:String},rel:{type:String},target:{type:String},label:{type:String},noArrow:{type:Boolean,attribute:"no-arrow"}}}static get styles(){return[super.styles,r`
        :host {
      ...
      <div class="card">
        <div class="image" part="image">
          ${this.src?d`<img src="${this.src}" alt="${this.alt}" part="img" loading="lazy" decoding="async" fetchpriority="low" />`:a}
        </div>
        ...
        ${this.href?d`
          <a 
            ...
            <button part="button" tabindex="-1">
              ${this.label||this.t.explore} ${this.noArrow?a:">"}
            </button>
          </a>
        `:a}
        </div>
