import{css as t,html as e,unsafeCSS as i}from"../../../lit/index.js";import{SimpleToastEl as a}from"../../simple-toast/lib/simple-toast-el.js";import"../../future-terminal-text/future-terminal-text.js";import"../../simple-icon/lib/simple-icons.js";import"../../simple-icon/simple-icon.js";import"../../hax-iconset/lib/simple-hax-iconset.js";import{I18NMixin as s}from"../../i18n-manager/lib/I18NMixin.js";const l=new URL("./images/SpeechBubbleL.svg",import.meta.url).href,o=new URL("./images/SpeechBubbleMiddle.svg",import.meta.url).href,n=new URL("./images/SpeechBubbleR.svg",import.meta.url).href;export class SuperDaemonToast extends(s(a)){static get tag(){return"super-daemon-toast"}constructor(){super(),this.t={saved:"Saved"},this.registerLocalization({context:this,namespace:"super-daemon",basePath:import.meta.url}),this.awaitingMerlinInput=!1,this.windowControllers=new AbortController,this.text="Saved",this.merlin=!1,this.classStyle="",this.future=!1,this.duration=3e3,this.accentColor="grey",this.dark=!1,this.eventCallback=null,this.fire=!1,this.hat="coffee",this.walking=!1}static get styles(){return[super.styles,t`
        :host {
