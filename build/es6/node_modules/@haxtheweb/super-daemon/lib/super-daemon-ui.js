import{html as e,css as t,nothing as i}from"../../../lit/index.js";import{SimpleFilterMixin as s}from"../../simple-filter/simple-filter.js";import{I18NMixin as o}from"../../i18n-manager/lib/I18NMixin.js";import{SimpleColors as r}from"../../simple-colors/simple-colors.js";import{UserScaffoldInstance as a}from"../../user-scaffold/user-scaffold.js";import{autorun as n,toJS as l}from"../../../mobx/dist/mobx.esm.js";import"../../../@lit-labs/virtualizer/lit-virtualizer.js";import"./super-daemon-row.js";import"./super-daemon-search.js";export class SuperDaemonUI extends(s(o(r))){constructor(){super(),this.focused=!1,this.like="",this.voiceSearch=!1,this.iconAccent="purple",this.multiMatch=!0,this.t=this.t||{},this.t={...this.t,noResultsForThisTerm:this._defaultTextEmpty,voiceSearch:"Voice search",results:"Results",loadingResults:"Loading results",insertBlocks:"Insert blocks",findMedia:"Find media",submitIdeas:"Submit your ideas",dropFilesHere:"Drop files here",typeWhatYouWant:"Type what you want to do",opensMemoryPalace:"opens Merlin",clickToDoAnything:"Click to do anything!"},this.registerLocalization({context:this,namespace:"super-daemon",basePath:import.meta.url}),this.opened=!1,this.items=[],this.mini=!1,this.wand=!1,this.loading=!0,this.listeningForInput=!1,this.programSearch="",this.commandContext="*",this.programName=null,this.shadowRootOptions={...r.shadowRootOptions,delegatesFocus:!0},this.activeDrag=!1,this.activeType=null,this.where="index",this.icon="hardware:keyboard-return",this._selectedIndex=-1,this._activeDescendant="",n((()=>{const e=l(a.action),t=l(a.data),i=globalThis.SuperDaemonManager.requestAvailability();a.active&&a.memory.isLoggedIn&&null===i.programName&&"drag"===e.type?(this.activeDrag=!0,this.activeType=t.value||t.architype):a.active&&a.memory.isLoggedIn&&null===i.programName&&"dragleave"===e.type&&(this.activeDrag=!1,this.activeType=null)}))}static get tag(){return"super-daemon-ui"}static get properties(){return{...super.properties,icon:{type:String},iconAccent:{type:String,attribute:"icon-accent"},voiceSearch:{type:Boolean,reflect:!0,attribute:"voice-search"},listeningForInput:{type:Boolean,reflect:!0,attribute:"listening-for-input"},activeDrag:{type:Boolean},activeType:{type:String},mini:{type:Boolean,reflect:!0},wand:{type:Boolean,reflect:!0},loading:{type:Boolean,reflect:!0},programSearch:{type:String,attribute:"program-search"},programName:{type:String,attribute:"program-name"},commandContext:{type:String,attribute:"command-context"},opened:{type:Boolean,reflect:!0},focused:{type:Boolean,reflect:!0},_selectedIndex:{type:Number,state:!0},_activeDescendant:{type:String,state:!0}}}static get styles(){let e=[];return super.styles&&(e=super.styles),[e,t`
        :host {
          display: block;
        }
        super-daemon-search {
      ...
      `]}updated(e){super.updated&&super.updated(e),e.forEach(((e,t)=>{if("filtered"==t&&void 0!==e){this.filtered.length>0&&(this.loading=!1),this._announceResults(),this._updateActiveDescendant(-1);const e=globalThis.SuperDaemonManager.requestAvailability();(e.santaMode||this.listeningForInput)&&(clearTimeout(this._selectTimeout),this._selectTimeout=setTimeout((()=>{(1===this.filtered.length||this.filtered&&this.filtered[0]&&this.filtered[0].title.toLocaleLowerCase()==e.value.toLocaleLowerCase())&&(this.shadowRoot.querySelector("super-daemon-row").selected(),e.listeningForInput=!0)}),600))}"opened"==t&&this.shadowRoot&&this.opened&&(this.activeType=null,this.activeDrag=!1,this.focusInput(),this.mini&&!this.wand&&this.shadowRoot.querySelector(".results").scrollTo(0,0)),"commandContext"==t&&this.dispatchEvent(new CustomEvent("super-daemon-command-context-changed",{detail:{value:this[t]}})),"like"==t&&this.dispatchEvent(new CustomEvent("like-changed",{detail:{value:this[t]}}))}))}focusInput(){this.shadowRoot.querySelector("super-daemon-search").focusInput()}selectInput(){this.shadowRoot.querySelector("super-daemon-search").selectInput()}setupProgram(){this.programSearch="",this.focusInput(),this.selectInput(),this.shadowRoot.querySelector(".results").scrollTo(0,0)}_updateActiveDescendant(e){this._selectedIndex=e,this._activeDescendant=e>=0?`option-${e}`:"",this.requestUpdate(),requestAnimationFrame((()=>{this.shadowRoot.querySelectorAll("super-daemon-row").forEach(((t,i)=>{const s=i===e;t.active=s})),e>=0&&this.shadowRoot.querySelector("lit-virtualizer")&&this.shadowRoot.querySelector("lit-virtualizer").scrollToIndex(e,"center")}))}_announceResults(){const e=this.filtered.length,t=`${e} ${1===e?"result":"results"} available`,i=globalThis.document.createElement("div");i.setAttribute("aria-live","polite"),i.setAttribute("aria-atomic","true"),i.style.position="absolute",i.style.left="-10000px",i.style.width="1px",i.style.height="1px",i.style.overflow="hidden",i.textContent=t,globalThis.document.body.appendChild(i),setTimeout((()=>{i.parentNode&&globalThis.document.body.removeChild(i)}),1e3)}itemSelected(e){this.like="",this.programSearch=""}_resultsKeydown(e){if(this.filtered.length>0&&this.shadowRoot.querySelector("super-daemon-row[active]"))switch(e.key){case"ArrowUp":case"ArrowLeft":this.shadowRoot.querySelector("super-daemon-row[active]")===this.shadowRoot.querySelector("super-daemon-row")?(this.shadowRoot.querySelector("lit-virtualizer").scrollToIndex(this.filtered.length-1,"center"),requestAnimationFrame((()=>{this.shadowRoot.querySelector("super-daemon-row:last-of-type").focus()}))):this.shadowRoot.querySelector("super-daemon-row[active]").previousElementSibling.focus();break;case"ArrowDown":case"ArrowRight":this.shadowRoot.querySelector("super-daemon-row[active]")===this.shadowRoot.querySelector("super-daemon-row:last-of-type")?(this.shadowRoot.querySelector("lit-virtualizer").scrollToIndex(0,"center"),requestAnimationFrame((()=>{this.shadowRoot.querySelector("super-daemon-row").focus()}))):this.shadowRoot.querySelector("super-daemon-row[active]").nextElementSibling.focus()}}focusedChanged(e){this.focused=e.detail.value}inputfilterChanged(e){this.programName?this.programSearch=e.target.value:this.like=e.target.value}listeningForInputChanged(e){e.detail.value&&this.shadowRoot.querySelector(".results").scrollTo(0,0)}commandContextChanged(e){this.commandContext=e.detail.value}_inputKeydown(e){if(this.filtered.length>0)switch(e.key){case"Enter":e.preventDefault(),this._selectedIndex>=0?this.shadowRoot.querySelectorAll("super-daemon-row")[this._selectedIndex].selected():this.shadowRoot.querySelector("super-daemon-row").selected();break;case"ArrowUp":e.preventDefault();const t=this._selectedIndex<=0?this.filtered.length-1:this._selectedIndex-1;this._updateActiveDescendant(t);break;case"ArrowDown":e.preventDefault();const i=this._selectedIndex>=this.filtered.length-1?0:this._selectedIndex+1;this._updateActiveDescendant(i);break;case"Escape":e.preventDefault(),this._updateActiveDescendant(-1),this.dispatchEvent(new CustomEvent("super-daemon-close",{bubbles:!0,composed:!0,cancelable:!0}))}else"Enter"===e.key&&this.programName&&""!==this.programSearch.trim()&&(this.dispatchEvent(new CustomEvent("super-daemon-program-enter",{bubbles:!0,cancelable:!0,composed:!0,detail:{programName:this.programName,input:this.programSearch.trim()}})),e.preventDefault());switch(e.key){case"!":case"/":case"\\":case">":case"<":"\\"===e.key&&""==this.like||"!"===e.key&&""==this.like?(this.commandContext="/",e.preventDefault()):"<"===e.key&&""==this.like?(this.commandContext=">",e.preventDefault()):""==this.like&&(this.commandContext=e.key,e.preventDefault());break;case"Backspace":""==this.programSearch&&this.programName?(this.dispatchEvent(new CustomEvent("super-daemon-run-program",{bubbles:!0,cancelable:!0,composed:!0,detail:!1})),e.preventDefault()):!this.programName&&""==this.like&&this.commandContext&&(this.commandContext="*",e.preventDefault())}}dropEvent(e){e.preventDefault(),this.activeDrag=!1,this.activeType=null;globalThis.SuperDaemonManager.requestAvailability().waveWand(["","/",e,"hax-agent","Agent"],this.shadowRoot.querySelector("#merlin"),"coin2")}dragenterEvent(e){e.preventDefault(),this.shadowRoot.querySelector("super-daemon-search").dragover=!0}dragoverEvent(e){e.preventDefault(),this.shadowRoot.querySelector("super-daemon-search").dragover=!0}dragleaveEvent(e){e.preventDefault(),this.shadowRoot.querySelector("super-daemon-search").dragover=!1}render(){return e`
      <super-daemon-search
        role="combobox"
        ...
        ${this.loading?e`<div class="loading">
              ...
              ${this.filtered.length&&0!==this.filtered.length?e`
                    <lit-virtualizer
                      ...
                      scroller
                      .items=${this.filtered}
                      .renderItem=${(t,s)=>t?e`<super-daemon-row
                          role="option"
                          id="option-${s}"
                          tabindex="-1"
                          aria-selected="${this._selectedIndex===s}"
                          data-row-index="${s}"
                          .value="${t.value||{}}"
                          icon="${t.icon}"
                          image="${t.image}"
