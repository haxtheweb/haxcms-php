import{html as e,css as t,nothing as s}from"../../../lit/index.js";import{SimpleFilterMixin as i}from"../../simple-filter/simple-filter.js";import{I18NMixin as o}from"../../i18n-manager/lib/I18NMixin.js";import{SimpleColors as r}from"../../simple-colors/simple-colors.js";import{UserScaffoldInstance as a}from"../../user-scaffold/user-scaffold.js";import{autorun as n,toJS as l}from"../../../mobx/dist/mobx.esm.js";import"../../../@lit-labs/virtualizer/lit-virtualizer.js";import"./super-daemon-row.js";import"./super-daemon-search.js";export class SuperDaemonUI extends(i(o(r))){constructor(){super(),this.focused=!1,this.like="",this.voiceSearch=!1,this.iconAccent="purple",this.multiMatch=!0,this.t=this.t||{},this.t={...this.t,noResultsForThisTerm:this._defaultTextEmpty,voiceSearch:"Voice search",results:"Results",loadingResults:"Loading results",insertBlocks:"Insert blocks",findMedia:"Find media",submitIdeas:"Submit your ideas",dropFilesHere:"Drop files here",typeWhatYouWant:"Type what you want to do",opensMemoryPalace:"opens Merlin",clickToDoAnything:"Click to do anything!"},this.registerLocalization({context:this,namespace:"super-daemon",basePath:import.meta.url+"/../../"}),this.opened=!1,this.items=[],this.mini=!1,this.wand=!1,this.loading=!0,this.listeningForInput=!1,this.programSearch="",this.commandContext="*",this.programName=null,this.programPlaceholder=null,this.shadowRootOptions={...r.shadowRootOptions,delegatesFocus:!0},this.activeDrag=!1,this.activeType=null,this.where="index",this.icon="hardware:keyboard-return",this._selectedIndex=-1,this._activeDescendant="",n(()=>{const e=l(a.action),t=l(a.data);Promise.resolve().then(()=>{const s=e,i=t,o=globalThis.SuperDaemonManager.requestAvailability();a.active&&a.memory.isLoggedIn&&null===o.programName&&"drag"===s.type?(this.activeDrag=!0,this.activeType=i.value||i.architype):a.active&&a.memory.isLoggedIn&&null===o.programName&&"dragleave"===s.type&&(this.activeDrag=!1,this.activeType=null)})})}static get tag(){return"super-daemon-ui"}static get properties(){return{...super.properties,icon:{type:String},iconAccent:{type:String,attribute:"icon-accent"},voiceSearch:{type:Boolean,reflect:!0,attribute:"voice-search"},listeningForInput:{type:Boolean,reflect:!0,attribute:"listening-for-input"},activeDrag:{type:Boolean},activeType:{type:String},mini:{type:Boolean,reflect:!0},wand:{type:Boolean,reflect:!0},loading:{type:Boolean,reflect:!0},programSearch:{type:String,attribute:"program-search"},programName:{type:String,attribute:"program-name"},programPlaceholder:{type:String,attribute:"program-placeholder"},commandContext:{type:String,attribute:"command-context"},opened:{type:Boolean,reflect:!0},focused:{type:Boolean,reflect:!0},_selectedIndex:{type:Number,state:!0},_activeDescendant:{type:String,state:!0}}}static get styles(){let e=[];return super.styles&&(e=super.styles),[e,t`
      ...
      `]}willUpdate(e){super.willUpdate&&super.willUpdate(e),e.has("items")&&this.shadowRoot&&(clearTimeout(this.__debounce),this.filtered=this._computeFiltered(this.items,this.where,this.like,this.caseSensitive,this.multiMatch))}updated(e){super.updated&&super.updated(e),e.forEach((e,t)=>{if("filtered"==t&&void 0!==e){this.filtered.length>0&&(this.loading=!1),this._announceResults(),this._updateActiveDescendant(-1);const e=globalThis.SuperDaemonManager.requestAvailability();(e.santaMode||this.listeningForInput)&&(clearTimeout(this._selectTimeout),this._selectTimeout=setTimeout(()=>{(1===this.filtered.length||this.filtered&&this.filtered[0]&&this.filtered[0].title.toLocaleLowerCase()==e.value.toLocaleLowerCase())&&(this.shadowRoot.querySelector("super-daemon-row").selected(),e.listeningForInput=!0)},600))}if("opened"==t&&this.shadowRoot&&this.opened&&(this.activeType=null,this.activeDrag=!1,this.focusInput(),this.mini&&!this.wand)){const e=this.shadowRoot.querySelector(".results-list");e?e.scrollTo(0,0):this.shadowRoot.querySelector(".results").scrollTo(0,0)}"commandContext"==t&&this.dispatchEvent(new CustomEvent("super-daemon-command-context-changed",{detail:{value:this[t]}})),"like"==t&&this.dispatchEvent(new CustomEvent("like-changed",{detail:{value:this[t]}}))})}focusInput(){this.shadowRoot.querySelector("super-daemon-search").focusInput()}selectInput(){this.shadowRoot.querySelector("super-daemon-search").selectInput()}_renderResultRow(t,i){return t?e`<super-daemon-row
      role="option"
      id="option-${i}"
      tabindex="-1"
    ...
    >`:s}setupProgram(e=""){this.programSearch=e;const t=this.shadowRoot.querySelector("super-daemon-search");if(t){t.value=e;const s=t.shadowRoot.querySelector("#inputfilter");s&&(s.value=e)}this.focusInput(),e||this.selectInput(),this.shadowRoot.querySelector(".results").scrollTo(0,0)}_updateActiveDescendant(e){this._selectedIndex=e,this._activeDescendant=e>=0?`option-${e}`:"",this.requestUpdate(),requestAnimationFrame(()=>{const t=this.shadowRoot.querySelectorAll("super-daemon-row");if(t.forEach((t,s)=>{t.active=s===e}),e>=0){const s=this.shadowRoot.querySelector("lit-virtualizer");s&&"function"==typeof s.scrollToIndex?s.scrollToIndex(e,"center"):t[e]&&"function"==typeof t[e].scrollIntoView&&t[e].scrollIntoView({block:"nearest"})}})}_announceResults(){const e=this.filtered.length,t=`${e} ${1===e?"result":"results"} available`,s=globalThis.document.createElement("div");s.setAttribute("aria-live","polite"),s.setAttribute("aria-atomic","true"),s.style.position="absolute",s.style.left="-10000px",s.style.width="1px",s.style.height="1px",s.style.overflow="hidden",s.textContent=t,globalThis.document.body.appendChild(s),setTimeout(()=>{s.parentNode&&globalThis.document.body.removeChild(s)},1e3)}itemSelected(e){this.like="",this.programSearch=""}_resultsKeydown(e){if(this.filtered.length>0&&this.shadowRoot.querySelector("super-daemon-row[active]")){const t=this.shadowRoot.querySelector("lit-virtualizer");switch(e.key){case"ArrowUp":case"ArrowLeft":this.shadowRoot.querySelector("super-daemon-row[active]")===this.shadowRoot.querySelector("super-daemon-row")?(t&&"function"==typeof t.scrollToIndex&&t.scrollToIndex(this.filtered.length-1,"center"),requestAnimationFrame(()=>{const e=this.shadowRoot.querySelector("super-daemon-row:last-of-type");e&&(e.focus(),"function"==typeof e.scrollIntoView&&e.scrollIntoView({block:"nearest"}))})):this.shadowRoot.querySelector("super-daemon-row[active]").previousElementSibling.focus();break;case"ArrowDown":case"ArrowRight":this.shadowRoot.querySelector("super-daemon-row[active]")===this.shadowRoot.querySelector("super-daemon-row:last-of-type")?(t&&"function"==typeof t.scrollToIndex&&t.scrollToIndex(0,"center"),requestAnimationFrame(()=>{const e=this.shadowRoot.querySelector("super-daemon-row");e&&(e.focus(),"function"==typeof e.scrollIntoView&&e.scrollIntoView({block:"nearest"}))})):this.shadowRoot.querySelector("super-daemon-row[active]").nextElementSibling.focus()}}}focusedChanged(e){this.focused=e.detail.value}_isWelcomeProgram(){return"Show getting started tasks"===this.programName}_isInputIntentKey(e){return!(!e.key||1!==e.key.length||e.ctrlKey||e.metaKey||e.altKey)}inputfilterChanged(e){const t=e.target&&"string"==typeof e.target.value?e.target.value:"";this._isWelcomeProgram()&&""!==t?(this.dispatchEvent(new CustomEvent("super-daemon-run-program",{bubbles:!0,cancelable:!0,composed:!0,detail:!1})),this.dispatchEvent(new CustomEvent("super-daemon-command-context-changed",{detail:{value:"*"}})),this.like=t,this.programSearch=""):this.programName?this.programSearch=t:this.like=t,this.dispatchEvent(new CustomEvent("value-changed",{bubbles:!0,composed:!0,detail:{value:t}}))}listeningForInputChanged(e){e.detail.value&&this.shadowRoot.querySelector(".results").scrollTo(0,0)}commandContextChanged(e){this.commandContext=e.detail.value}_inputKeydown(e){if(this._isWelcomeProgram()&&""===this.programSearch&&this._isInputIntentKey(e)){if(this.dispatchEvent(new CustomEvent("super-daemon-run-program",{bubbles:!0,cancelable:!0,composed:!0,detail:!1})),["!","/","\\",">","<"].includes(e.key)){let t=e.key;return"\\"===e.key||"!"===e.key?t="/":"<"===e.key&&(t=">"),this.dispatchEvent(new CustomEvent("super-daemon-command-context-changed",{detail:{value:t}})),void e.preventDefault()}this.dispatchEvent(new CustomEvent("super-daemon-command-context-changed",{detail:{value:"*"}}))}if(this.filtered.length>0)switch(e.key){case"Enter":e.preventDefault(),this._selectedIndex>=0?this.shadowRoot.querySelectorAll("super-daemon-row")[this._selectedIndex].selected():this.shadowRoot.querySelector("super-daemon-row").selected();break;case"ArrowUp":e.preventDefault();const t=this._selectedIndex<=0?this.filtered.length-1:this._selectedIndex-1;this._updateActiveDescendant(t);break;case"ArrowDown":e.preventDefault();const s=this._selectedIndex>=this.filtered.length-1?0:this._selectedIndex+1;this._updateActiveDescendant(s);break;case"Escape":e.preventDefault(),this._updateActiveDescendant(-1),this.dispatchEvent(new CustomEvent("super-daemon-close",{bubbles:!0,composed:!0,cancelable:!0}))}else"Enter"===e.key&&this.programName&&""!==this.programSearch.trim()&&(this.dispatchEvent(new CustomEvent("super-daemon-program-enter",{bubbles:!0,cancelable:!0,composed:!0,detail:{programName:this.programName,input:this.programSearch.trim()}})),e.preventDefault());switch(e.key){case"!":case"/":case"\\":case">":case"<":"\\"===e.key&&""==this.like||"!"===e.key&&""==this.like?(this.commandContext="/",e.preventDefault()):"<"===e.key&&""==this.like?(this.commandContext=">",e.preventDefault()):""==this.like&&(this.commandContext=e.key,e.preventDefault());break;case"Backspace":""==this.programSearch&&this.programName?(this.dispatchEvent(new CustomEvent("super-daemon-run-program",{bubbles:!0,cancelable:!0,composed:!0,detail:!1})),e.preventDefault()):!this.programName&&""==this.like&&this.commandContext&&(this.commandContext="*",e.preventDefault())}}dropEvent(e){e.preventDefault(),this.activeDrag=!1,this.activeType=null;globalThis.SuperDaemonManager.requestAvailability().waveWand(["","/",e,"hax-agent","Agent"],this.shadowRoot.querySelector("#merlin"),"coin2")}dragenterEvent(e){e.preventDefault(),this.shadowRoot.querySelector("super-daemon-search").dragover=!0}dragoverEvent(e){e.preventDefault(),this.shadowRoot.querySelector("super-daemon-search").dragover=!0}dragleaveEvent(e){e.preventDefault(),this.shadowRoot.querySelector("super-daemon-search").dragover=!1}render(){return e`
      ...
      >
        ${this.loading?e`<div class="loading">
              ...
              ${this.filtered.length&&0!==this.filtered.length?this.mini?e`
                      <div
                        class="results-list"
                        role="listbox"
                        id="results-listbox"
