import{html as e,css as t}from"../../../lit/index.js";import{I18NMixin as i}from"../../i18n-manager/lib/I18NMixin.js";import{mimeTypeToName as s}from"../../utils/utils.js";import{SimpleColors as o}from"../../simple-colors/simple-colors.js";import"../../simple-fields/lib/simple-fields-field.js";import"../../simple-icon/lib/simple-icons.js";import"../../simple-icon/lib/simple-icon-button-lite.js";import"../../hax-iconset/lib/simple-hax-iconset.js";import"../../simple-icon/simple-icon.js";import"../../simple-icon/lib/simple-icon-lite.js";export class SuperDaemonSearch extends(i(o)){static get tag(){return"super-daemon-search"}constructor(){super(),this.focused=!1,this.icon="hardware:keyboard-return",this.iconAccent="purple",this.voiceSearch=!1,this.programSearch="",this.mini=!1,this.wand=!1,this.loading=!1,this.listeningForInput=!1,this.commandContext="*",this.value=null,this.disabled=!1,this.dragover=!1,this.droppable=!1,this.droppableType=null,this.t=this.t||{},this.t={...this.t,voiceSearch:"Voice search",filterCommands:"Filter commands",commands:"Commands",howMayIHelp:"How may I help you?",slashCommandsActive:"Slash commands active",developerConsoleActive:"Developer console active"},this.registerLocalization({context:this,namespace:"super-daemon",basePath:import.meta.url}),this.possibleActions=["🔮 Insert blocks","🕵 Find media 📺"]}static get properties(){return{icon:{type:String},disabled:{type:Boolean,reflect:!0},iconAccent:{type:String,attribute:"icon-accent"},voiceSearch:{type:Boolean,reflect:!0,attribute:"voice-search"},possibleActions:{type:Array},listeningForInput:{type:Boolean,reflect:!0,attribute:"listening-for-input"},droppable:{type:Boolean,reflect:!0},dragover:{type:Boolean,reflect:!0},droppableType:{type:String,attribute:"droppable-type"},value:{type:String},mini:{type:Boolean,reflect:!0},wand:{type:Boolean,reflect:!0},programName:{type:String,attribute:"program-name"},commandContext:{type:String,attribute:"command-context"},focused:{type:Boolean,reflect:!0}}}voiceSearchClick(){if(!this.disabled){const e=globalThis.SuperDaemonManager.requestAvailability();this.listeningForInput?e.listeningForInput=!1:(e.hal.speak(this.t.howMayIHelp,e.santaMode).then((t=>{e.playSound(),e.listeningForInput=!0})),this.focusInput())}}_inputKeydown(e){if(!this.disabled)switch(e.key){case"!":case"/":case"\\":case">":case"<":"\\"===e.key&&""==this.value||"!"===e.key&&""==this.value?(this.commandContext="/",e.preventDefault()):"<"===e.key&&""==this.value?(this.commandContext=">",e.preventDefault()):""==this.value&&(this.commandContext=e.key,e.preventDefault());break;case"Backspace":""==this.programSearch&&this.programName?(this.dispatchEvent(new CustomEvent("super-daemon-run-program",{bubbles:!0,cancelable:!0,composed:!0,detail:!1})),e.preventDefault()):!this.programName&&""==this.value&&this.commandContext&&(this.commandContext="*",e.preventDefault())}}inputfilterChanged(e){switch(e.target.value){case"!":case"/":case"\\":case">":case"<":"\\"===e.target.value&&""==this.value||"!"===e.target.value&&""==this.value?(this.commandContext="/",e.preventDefault()):"<"===e.target.value&&""==this.value?(this.commandContext=">",e.preventDefault()):""==this.value&&(this.commandContext=e.target.value,e.preventDefault()),e.target.value="";break;default:this.disabled||(e.stopPropagation(),e.stopImmediatePropagation(),this.value=e.target.value)}}render(){return e` ${"*"!=this.commandContext?e`<simple-icon-lite
      ...
      ${this.voiceSearch?e`<simple-icon-button-lite
          ...
          ></simple-icon-button-lite>`:""}`}suggestPossibleAction(e=!1){return e?`📂 Drop '${s(e)}' here for options`:this.randomOption(this.possibleActions)}randomOption(e=[]){return e.length>0?e[Math.floor(Math.random()*Math.floor(e.length))]:void 0}firstUpdated(e){super.firstUpdated&&super.firstUpdated(e),this.shadowRoot.querySelector("#inputfilter").placeholder=this.suggestPossibleAction()||"Type to search..."}updated(e){super.updated(e),e.has("focused")&&this.dispatchEvent(new CustomEvent("focused-changed",{composed:!0,detail:{value:this.focused}})),(e.has("wand")||e.has("t"))&&this._updatePossibleActions(),e.has("droppableType")&&this.shadowRoot&&(this.shadowRoot.querySelector("#inputfilter").placeholder=this.suggestPossibleAction(this.droppableType)),e.has("droppable")&&!this.droppable&&(this.dragover=!1),e.has("t")&&this.shadowRoot&&(this.shadowRoot.querySelector("#inputfilter").placeholder=this.suggestPossibleAction()),e.has("value")&&void 0!==e.get("value")&&this.dispatchEvent(new CustomEvent("value-changed",{composed:!0,detail:{value:this.value}})),e.has("listeningForInput")&&this.dispatchEvent(new CustomEvent("listening-for-input-changed",{composed:!0,detail:{value:this.listeningForInput}})),e.has("commandContext")&&this.dispatchEvent(new CustomEvent("command-context-changed",{composed:!0,detail:{value:this.commandContext}}))}_updatePossibleActions(){if(this.t.insertBlocks){if(this.wand){const e=globalThis.SuperDaemonManager.requestAvailability();e.opened?this.possibleActions=[`🧑 ${this.t.submitIdeas}💡`,`📁 ${this.t.dropFilesHere} 📄`,`🕵 ${this.t.typeWhatYouWant}`]:this.possibleActions=[`🧙‍♂️ ${e.key1} + ${e.key2} ${this.t.opensMemoryPalace}`,`🔮 ${this.t.clickToDoAnything}`,`📁 ${this.t.dropFilesHere} 📄`]}else this.possibleActions=[`🔮 ${this.t.insertBlocks}`,`🕵 ${this.t.findMedia} 📺`];this.shadowRoot&&(this.shadowRoot.querySelector("#inputfilter").placeholder=this.suggestPossibleAction())}}fieldFocusLoss(e){this.focused=!1}fieldFocus(e){this.focused=!0}focusInput(){setTimeout((()=>{this.shadowRoot.querySelector("#inputfilter").focus(),this.shadowRoot.querySelector("#inputfilter").cursorAtEnd()}),0)}selectInput(){setTimeout((()=>{this.shadowRoot.querySelector("#inputfilter").select()}),0)}static get styles(){let e=[];return super.styles&&(e=super.styles),[e,t`
        :host {
          display: flex;
          margin: 0;
        }
      ...
      `]}getActiveTitle(e){switch(e){case"/":return this.t.slashCommandsActive||"Slash commands active";case">":return this.t.developerConsoleActive||"Developer console active"}return""}getActiveIcon(e){switch(e){case"/":return"hax:wand";case">":return"hax:console-line"}return""}}globalThis.customElements.define(SuperDaemonSearch.tag,SuperDaemonSearch);