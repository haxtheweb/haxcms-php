import{LitElement as e,html as r,css as a,unsafeCSS as t}from"../../../lit/index.js";export class JourneyMenu extends e{static get tag(){return"journey-menu"}static get properties(){return{items:{type:Array},activeID:{type:String}}}static get styles(){return a`
      :host {
    ...
    `}render(){let e=[];return Array.isArray(this.items)&&(e=this.items),r`
      <nav>
        <ul>
          ${e.map(e=>r`
              <li>
