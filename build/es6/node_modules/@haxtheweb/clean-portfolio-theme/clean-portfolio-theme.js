 ...
 */
    ...
    `]}testEditMode(t){this.editMode?(t.preventDefault(),t.stopPropagation(),t.stopImmediatePropagation()):t.currentTarget.blur()}_renderListing(){const t=this.selectedTag?this.items.filter(t=>{let e=d(t.metadata.tags);return!!e&&e.includes(this.selectedTag)}):this.items,i=this.selectedTag?this.categoryTags.filter(e=>t.some(t=>{let i=d(t.metadata.tags);return!!i&&i.includes(e)})):this.categoryTags;return e`
      ...
      ${i.length>0?i.map(i=>e`
              ...
              <div class="listing-grid">
                ${t.filter(t=>{let e=d(t.metadata.tags);return!!e&&e.includes(i)}).map(t=>{let i=d(t.metadata.tags).split(",")[1];return e`
      ...
      ${!this.selectedTag&&this.items.some(t=>!d(t.metadata.tags))?e`
        <div class="listing-category"></div>
        <div class="listing-grid">
          ${this.items.filter(t=>!d(t.metadata.tags)).map(t=>e`
