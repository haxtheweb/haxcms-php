 ...
 */
import{LitElement as t,html as e,css as o}from"../../lit/index.js";import"../haxcms-elements/lib/ui-components/active-item/site-active-media-banner.js";import{HAXCMSLitElementTheme as i}from"../haxcms-elements/lib/core/HAXCMSLitElementTheme.js";import{store as a}from"../haxcms-elements/lib/core/haxcms-site-store.js";import{DDDSuper as r}from"../d-d-d/d-d-d.js";import{toJS as l,autorun as s}from"../../mobx/dist/mobx.esm.js";export class CleanPortfolioTheme extends(r(i)){static PortfolioFonts=["https://fonts.googleapis.com/css2?family=Work+Sans:ital,wght@0,100..900;1,100..900&display=swap","https://fonts.googleapis.com/css2?family=Source+Code+Pro:ital,wght@0,200..900;1,200..900&family=Work+Sans:ital,wght@0,100..900;1,100..900&display=swap","https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,400..900;1,400..900&family=Source+Code+Pro:ital,wght@0,200..900;1,200..900&family=Work+Sans:ital,wght@0,100..900;1,100..900&display=swap"];loadFonts(){globalThis&&globalThis.document&&CleanPortfolioTheme.PortfolioFonts.forEach((t=>{const e=globalThis.document.createElement("link");e.setAttribute("href",t),e.setAttribute("rel","stylesheet"),e.setAttribute("fetchpriority","low"),globalThis.document.head.appendChild(e)}))}static get tag(){return"clean-portfolio-theme"}constructor(){super(),this.siteTitle="",this.activeLayout="Text",s((t=>{this.siteTitle=l(a.siteTitle),this.__disposer.push(t)})),s((t=>{a.manifest;let e=a.getItemChildren(null);e&&e.length>0&&(this.topItems=[...e]),this.__disposer.push(t)}))}static get properties(){return{...super.properties,title:{type:String},activeLayout:{type:String},topItems:{type:Array}}}static get styles(){return[super.styles,o`
      :host {
    ...
    `}renderMedia(){return console.log(document.querySelector("header")),e`
    ...
    `}ChangeLayout(){"Text"==this.activeLayout?this.activeLayout="Listing":"Listing"==this.activeLayout?this.activeLayout="Media":this.activeLayout="Text"}render(){return this.loadFonts(),e`
      ...
      ${"Text"==this.activeLayout?this.renderText():"Media"==this.activeLayout?this.renderMedia():this.renderListing()}
