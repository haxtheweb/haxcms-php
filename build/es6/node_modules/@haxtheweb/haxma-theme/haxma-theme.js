 ...
 */
import{html as e,css as t}from"../../lit/index.js";import{HAXCMSLitElementTheme as a}from"../haxcms-elements/lib/core/HAXCMSLitElementTheme.js";import{store as i}from"../haxcms-elements/lib/core/haxcms-site-store.js";import{autorun as o,toJS as r}from"../../mobx/dist/mobx.esm.js";import"../haxcms-elements/lib/ui-components/site/site-title.js";import"../haxcms-elements/lib/ui-components/active-item/site-active-title.js";import"../haxcms-elements/lib/ui-components/navigation/site-menu-button.js";import"../haxcms-elements/lib/ui-components/navigation/site-breadcrumb.js";import"../haxcms-elements/lib/ui-components/site/site-search.js";import"../haxcms-elements/lib/ui-components/layout/site-modal.js";import"../haxcms-elements/lib/ui-components/navigation/site-menu.js";import"../haxcms-elements/lib/ui-components/navigation/site-top-menu.js";import"../haxcms-elements/lib/ui-components/navigation/site-menu-content.js";import{HAXCMSThemeParts as n}from"../haxcms-elements/lib/core/utils/HAXCMSThemeParts.js";import{DDDSuper as s}from"../d-d-d/d-d-d.js";export class HaxmaTheme extends(n(s(a))){static get tag(){return"haxma-theme"}constructor(){super(),this._items=[],this.activeItem={},this.manifest={},this.mobileNavOpen=!1,this.searchOpen=!1,this.nextPage="",this.prevPage="",this.__disposer=this.__disposer||[],this.__disposer.push(o(e=>{const t=r(i.manifest);Promise.resolve().then(()=>{this.manifest=t})})),this.__disposer.push(o(e=>{const t=r(i.activeItem);Promise.resolve().then(()=>{this.activeItem=t})})),this.__disposer.push(o(e=>{const t=r(i.manifest&&i.manifest.items?i.manifest.items:[]);Promise.resolve().then(()=>{this._items=t})}))}static get properties(){return{...super.properties,_items:{type:Array},activeItem:{type:Object},manifest:{type:Object},mobileNavOpen:{type:Boolean,reflect:!0,attribute:"mobile-nav-open"},searchOpen:{type:Boolean,reflect:!0,attribute:"search-open"},nextPage:{type:String},prevPage:{type:String}}}HAXCMSGlobalStyleSheetContent(){return[...super.HAXCMSGlobalStyleSheetContent(),t`
        :root {
