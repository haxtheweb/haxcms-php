      ...
      <div id="player-section">
        ...
        >
          <div id="player" .style="${this.playerStyle}">
            ...
            ${this.videoId&&this.__playerReady?t`
                  <a11y-media-youtube
                    id="youtube-${this.id}"
                ...
                `:""}
            ${0!==Object.keys(this.captionCues||[]).length&&this.showCustomCaptions?t`
                  <div id="cc-custom" aria-live="polite" class="screen-only">
                    <div id="cc-text">
                      ${this.captionCues?Object.keys(this.captionCues).map(e=>t`${this.captionCues[e].text?this.captionCues[e].text:""}`):""}
                    </div>
                  </div>
                `:t``}
          </div>
        ...
        <div id="controls" controls="innerplayer">
          ...
          <div id="controls-right">
            ...
            ></a11y-media-button>
            ${this.isYoutube?t` <a11y-media-button
                  accent-color="${this.accentColor}"
                  ?dark="${this.dark}"
                  class="hide-sticky"
      ...
      >
        <div id="transcript-and-controls" ?hidden="${this.hideTranscript}">
          ...
          <div id="transcript" aria-live="polite">
            ...
            ${this.transcriptCues.length>0?t`
                  <div class="transcript-from-track">
                    ${this.transcriptCues.map((e,i)=>t`
                        <a11y-media-transcript-cue
                          ...
                          @keydown="${t=>this._handleCueKeydown(t,e)}"
