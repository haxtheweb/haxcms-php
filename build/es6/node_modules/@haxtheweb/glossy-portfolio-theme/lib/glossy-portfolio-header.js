 ...
 */
import{LitElement as e,html as t,css as i}from"../../../lit/index.js";import{DDDSuper as o}from"../../d-d-d/d-d-d.js";import{I18NMixin as s}from"../../i18n-manager/lib/I18NMixin.js";import{store as r}from"../../haxcms-elements/lib/core/haxcms-site-store.js";import{autorun as l,toJS as n}from"../../../mobx/dist/mobx.esm.js";export class GlossyPortfolioHeader extends(o(s(e))){static get tag(){return"glossy-portfolio-header"}constructor(){super(),this.title="Title",this.homeLink="",this.__disposer=this.__disposer||[],this.isOverflow=!1,this.isOpen=!1,this.scrollPosition=0,this.__onScroll=this.scrollFunction.bind(this),this.__disposer.push(l(e=>{const t=n(r.getItemChildren(null));Promise.resolve().then(()=>{let e=t;e&&e.length>0&&(this.topItems=[...e])})})),this.__disposer.push(l(e=>{const t=n(r.homeLink);Promise.resolve().then(()=>{this.homeLink=t})})),this.__disposer.push(l(e=>{const t=n(r.logo);Promise.resolve().then(()=>{this.logo=t})}))}static get properties(){return{...super.properties,title:{type:String},thumbnail:{type:String},link:{type:String},topItems:{type:Array},isOverflow:{type:Boolean},isOpen:{type:Boolean}}}static get styles(){return[super.styles,i`
