      ...
      >
        ...
        <div class="logo-hamburger desktop">
          <a class="logo-link desktop" href="${this.homeLink}" @focus=${this.fullOpacity}>
            <img class="logo desktop" src="${r.manifest&&r.manifest.metadata&&r.manifest.metadata.site?r.manifest.metadata.site.logo:""}" @error=${this.handleImageError} alt="Logo" />
          </a>
        </div>
      ...
      <div class="container mobile">
        <div class="logo-hamburger mobile">
          <a class="logo-link mobile" href="${this.homeLink}" @click="${this.closeHamburger}">
            <img class="logo mobile" src="${r.manifest&&r.manifest.metadata&&r.manifest.metadata.site?r.manifest.metadata.site.logo:""}" @error=${this.handleImageError} alt="Logo" />
          </a> 
