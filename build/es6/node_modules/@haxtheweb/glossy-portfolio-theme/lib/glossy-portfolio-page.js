 ...
 */
import{LitElement as e,html as t,css as i}from"../../../lit/index.js";import{DDDSuper as a}from"../../d-d-d/d-d-d.js";import{I18NMixin as r}from"../../i18n-manager/lib/I18NMixin.js";export class GlossyPortfolioPage extends(a(r(e))){static get tag(){return"glossy-portfolio-page"}constructor(){super(),this.title="Title",this.t=this.t||{},this.t={...this.t,title:"Title"}}static get properties(){return{...super.properties,title:{type:String}}}static get styles(){return[super.styles,i`
      :host {
        display: block;
        /* line-height: 2rem; */
        margin: 0;
...
`}static get haxProperties(){return new URL(`./lib/${this.tag}.haxProperties.json`,import.meta.url).href}}globalThis.customElements.define(GlossyPortfolioPage.tag,GlossyPortfolioPage);