import{DDD as t}from"../../d-d-d/d-d-d.js";import"../../simple-icon/lib/simple-icon-lite.js";import"../../simple-icon/lib/simple-icons.js";import{css as e,html as i}from"../../../lit/index.js";export class BlockQuote extends t{static get properties(){return{...super.properties,citation:{type:String},image:{type:String},alt:{type:String}}}static get haxProperties(){return new URL(`./${this.tag}.haxProperties.json`,import.meta.url).href}constructor(){super(),this.citation="",this.image="",this.alt=""}render(){return i`
      <div id="wrap">
        ${this.image?i` <img id="image" src="${this.image}" alt="${this.alt}" /> `:""}
        <div id="quote_wrap">
          <div id="inner_wrap">
            <div id="quote">
              <simple-icon-lite
            ...
            <div id="citation">
              ${this.citation?i` <p><span class="dash">--</span> ${this.citation}</p> `:""}
            </div>
          </div>
        </div>
      </div>
