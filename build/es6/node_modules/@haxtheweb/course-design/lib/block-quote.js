import{DDD as d}from"../../d-d-d/d-d-d.js";import"../../simple-icon/lib/simple-icon-lite.js";import"../../simple-icon/lib/simple-icons.js";import{css as t,html as e}from"../../../lit/index.js";export class BlockQuote extends d{static get properties(){return{...super.properties,citation:{type:String},image:{type:String},alt:{type:String},dataTextAlign:{type:String,attribute:"data-text-align",reflect:!0},noBorder:{type:Boolean,attribute:"no-border",reflect:!0}}}static get haxProperties(){return new URL(`./${this.tag}.haxProperties.json`,import.meta.url).href}constructor(){super(),this.citation="",this.image="",this.alt="",this.dataTextAlign="center",this.noBorder=!1}render(){return e`
      <div id="wrap">
        ${this.image?e` <img id="image" src="${this.image}" alt="${this.alt}" /> `:""}
        <div id="quote_wrap">
          <div id="inner_wrap">
            <div id="quote">
              <simple-icon-lite
            ...
            <div id="citation">
              ${this.citation?e` <p><span class="dash">--</span> ${this.citation}</p> `:""}
            </div>
          </div>
        </div>
      </div>
    `}static get tag(){return"block-quote"}static get styles(){return[super.styles,t`
        :host {
