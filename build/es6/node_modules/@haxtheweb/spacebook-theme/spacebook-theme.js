 ...
 */
import{html as e,css as t}from"../../lit/index.js";import{HAXCMSLitElementTheme as o}from"../haxcms-elements/lib/core/HAXCMSLitElementTheme.js";import{store as a}from"../haxcms-elements/lib/core/haxcms-site-store.js";import{autorun as i,toJS as r}from"../../mobx/dist/mobx.esm.js";import"../haxcms-elements/lib/ui-components/site/site-title.js";import"../haxcms-elements/lib/ui-components/active-item/site-active-title.js";import"../haxcms-elements/lib/ui-components/navigation/site-menu-button.js";import"../haxcms-elements/lib/ui-components/navigation/site-breadcrumb.js";import"../haxcms-elements/lib/ui-components/site/site-search.js";import"../haxcms-elements/lib/ui-components/layout/site-modal.js";import"../haxcms-elements/lib/ui-components/navigation/site-menu.js";import{HAXCMSThemeParts as n}from"../haxcms-elements/lib/core/utils/HAXCMSThemeParts.js";import{DDDSuper as s}from"../d-d-d/d-d-d.js";export class SpacebookTheme extends(n(s(o))){static get tag(){return"spacebook-theme"}constructor(){super(),this._items=[],this.activeItem={},this.manifest={},this.mobileNavOpen=!1,this.searchOpen=!1,this.nextPageTitle="",this.prevPageTitle="",this.homeLink="",i((e=>{this.manifest=r(a.manifest),this.__disposer.push(e)})),i((e=>{this.activeItem=r(a.activeItem),this.__disposer.push(e)})),i((e=>{this.homeLink=r(a.homeLink),this.__disposer.push(e)})),i((e=>{this._items=r(a.manifest&&a.manifest.items?a.manifest.items:[]),this.__disposer.push(e)}))}static get properties(){return{...super.properties,_items:{type:Array},activeItem:{type:Object},manifest:{type:Object},homeLink:{type:String},mobileNavOpen:{type:Boolean,reflect:!0,attribute:"mobile-nav-open"},searchOpen:{type:Boolean,reflect:!0,attribute:"search-open"},nextPage:{type:String},prevPage:{type:String}}}HAXCMSGlobalStyleSheetContent(){return[...super.HAXCMSGlobalStyleSheetContent(),t`
        :root {
