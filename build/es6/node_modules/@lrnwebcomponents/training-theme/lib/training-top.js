import{LitElement as t,html as e,css as i}from"../../../lit/index.js";export class TrainingTop extends t{constructor(){super(),this.title="",this.presenter="",this.id="",this.time=""}static get tag(){return"training-top"}static get properties(){return{title:{type:String},presenter:{type:String},id:{type:String},time:{type:String}}}static get styles(){return i`
      :host {
        display: inline-flex;
      }
      .wrapper {
