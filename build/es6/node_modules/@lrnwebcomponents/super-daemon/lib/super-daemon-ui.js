import{LitElement as e,html as t,css as o,nothing as i}from"../../../lit/index.js";import"../../simple-icon/lib/simple-icons.js";import"../../simple-icon/lib/simple-icon-lite.js";import"../../simple-fields/lib/simple-fields-field.js";import"../../simple-fields/lib/simple-tag.js";import{SimpleFilterMixin as s}from"../../simple-filter/simple-filter.js";import{I18NMixin as a}from"../../i18n-manager/lib/I18NMixin.js";import"./super-daemon-row.js";export class SuperDaemonUI extends(s(a(e))){constructor(){super(),this.multiMatch=!0,this._defaultTextEmpty="No results for this term",this.t.noResultsForThisTerm=this._defaultTextEmpty,this.t.whatAreYouLookingFor="What are you looking for?",this.t.filterCommands="Filter commands",this.t.commands="Commands",this.t.loadingResults="Loading results",this.t.commonTasksText="Merlin helps show you what's possible. Here are some common answers..",this.opened=!1,this.items=[],this.mini=!1,this.loading=!1,this.programSearch="",this.commandContext="*",this.programName=null,this.shadowRootOptions={...e.shadowRootOptions,delegatesFocus:!0},this.where="index",this.icon="hardware:keyboard-return",this.questionTags=[{value:"*",label:"Show me what's possible!"},{value:"help",label:"I need help!"},{value:"media",label:"Insert media.."},{value:"edit",label:"Edit this page"}]}static get tag(){return"super-daemon-ui"}static get properties(){return{...super.properties,icon:{type:String},mini:{type:Boolean,reflect:!0},loading:{type:Boolean,reflect:!0},programSearch:{type:String,attribute:"program-search"},programName:{type:String,attribute:"program-name"},commandContext:{type:String,attribute:"command-context"},opened:{type:Boolean,reflect:!0},questionTags:{type:Array,attribute:"question-tags"}}}static get styles(){let e=[];return super.styles&&(e=super.styles),[...e,o`
        :host {
          display: block;
        }
        .question-tags {
      ...
      >
        ${this.loading?t`<div class="loading">${this.t.loadingResults}..</div>`:t`
              ${this.filtered.length&&0!==this.filtered.length?t`
                    ${this.filtered.map(((e,o)=>t`
                        <super-daemon-row
                          data-row-index="${o}"
                          .value="${e.value}"
                          icon="${e.icon}"
                          image="${e.image}"
                          text-character="${e.textCharacter}"
                          title="${e.title}"
                          .tags="${e.tags}"
                          event-name="${e.eventName}"
                          path="${e.path}"
                          ?more="${e.more&&!this.mini}"
                          ?mini="${this.mini}"
                          >${e.more?e.more:i}</super-daemon-row
                        >
                      `))}
