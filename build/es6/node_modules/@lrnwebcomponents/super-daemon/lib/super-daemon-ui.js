import{html as e,css as t,nothing as o}from"../../../lit/index.js";import"../../simple-icon/lib/simple-icons.js";import"../../hax-iconset/lib/simple-hax-iconset.js";import"../../simple-icon/simple-icon.js";import"../../simple-icon/lib/simple-icon-lite.js";import"../../simple-fields/lib/simple-fields-field.js";import"../../simple-fields/lib/simple-tag.js";import{SimpleFilterMixin as i}from"../../simple-filter/simple-filter.js";import{I18NMixin as s}from"../../i18n-manager/lib/I18NMixin.js";import{SimpleColors as r}from"../../simple-colors/simple-colors.js";import"./super-daemon-row.js";export class SuperDaemonUI extends(i(s(r))){constructor(){super(),this.voiceSearch=!1,this.iconAccent="purple",this.multiMatch=!0,this._defaultTextEmpty="No results for this term",this.t=this.t||{},this.t={...this.t,noResultsForThisTerm:this._defaultTextEmpty,whatAreYouLookingFor:"Type what you are looking to do here..",voiceSearch:"Voice search",filterCommands:"Filter commands",commands:"Commands",loadingResults:"Loading results",commonTasksText:"Merlin helps show you what's possible. Here are some common answers.."},this.opened=!1,this.items=[],this.mini=!1,this.loading=!1,this.listeningForInput=!1,this.programSearch="",this.commandContext="*",this.programName=null,this.shadowRootOptions={...r.shadowRootOptions,delegatesFocus:!0},this.where="index",this.icon="hardware:keyboard-return",this.questionTags=[]}static get tag(){return"super-daemon-ui"}static get properties(){return{...super.properties,icon:{type:String},iconAccent:{type:String,attribute:"icon-accent"},voiceSearch:{type:Boolean,reflect:!0,attribute:"voice-search"},listeningForInput:{type:Boolean,reflect:!0,attribute:"listening-for-input"},mini:{type:Boolean,reflect:!0},loading:{type:Boolean,reflect:!0},programSearch:{type:String,attribute:"program-search"},programName:{type:String,attribute:"program-name"},commandContext:{type:String,attribute:"command-context"},opened:{type:Boolean,reflect:!0},questionTags:{type:Array}}}static get styles(){let e=[];return super.styles&&(e=super.styles),[...e,t`
      ...
      <div class="search">
      ${this.voiceSearch?e`<simple-icon-button
              class="voice"
