import{LitElement as e,html as t,css as i}from"../../../lit/index.js";import"../../simple-icon/lib/simple-icons.js";import"../../simple-icon/lib/simple-icon-lite.js";import"../../simple-fields/lib/simple-tag.js";export class SuperDaemonRow extends e{constructor(){super(),this.title=null,this.path=null,this.icon=null,this.image=null,this.key=null,this.eventName=null,this.more=!1,this.showDetails=!1,this.value={},this.tags=[],this.shadowRootOptions={...e.shadowRootOptions,delegatesFocus:!0},this.active=!1}static get tag(){return"super-daemon-row"}static get properties(){return{title:{type:String},path:{type:String},icon:{type:String},mini:{type:Boolean,reflect:!0},image:{type:String},more:{type:Boolean},showDetails:{type:Boolean},key:{type:String},eventName:{type:String,attribute:"event-name"},value:{type:Object},tags:{type:Array},active:{type:Boolean,reflect:!0}}}static get styles(){let e=[];return super.styles&&(e=super.styles),[...e,i`
        :host {
          display: block;
          margin: 8px 16px;
        }
