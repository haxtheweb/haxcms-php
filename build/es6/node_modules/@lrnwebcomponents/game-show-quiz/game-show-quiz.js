...
import { wipeSlot } from "../hax-body/lib/haxutils.js";
...
class GameShowQuiz extends MutableData(PolymerElement) {
  ...
  continueGameTap(e) {
    ...
    // logically
    if (typeof this.__activeTap !== typeof undefined && dom(this.__activeTap).parentNode.nextElementSibling.firstElementChild != null) {
      dom(this.__activeTap).parentNode.nextElementSibling.firstElementChild.focus();
