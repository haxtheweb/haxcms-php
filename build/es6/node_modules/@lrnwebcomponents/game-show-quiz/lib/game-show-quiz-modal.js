 ...
 */class GameShowQuizModal extends LitElement{static get tag(){return"game-show-quiz-modal"}static get properties(){return{title:{type:String}}}constructor(){super();import("../../../@polymer/paper-dialog/paper-dialog.js")}render(){return html`
   ...
   */toggle(){this.shadowRoot.querySelector("paper-dialog").toggle()}}window.customElements.define(GameShowQuizModal.tag,GameShowQuizModal);export{GameShowQuizModal};