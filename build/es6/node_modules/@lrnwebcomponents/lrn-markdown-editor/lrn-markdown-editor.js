 ...
 */import{html,Polymer}from"../../@polymer/polymer/polymer-legacy.js";import"../../@polymer/paper-tabs/paper-tabs.js";import"../../@polymer/marked-element/marked-element.js";import"../../@polymer/iron-pages/iron-pages.js";import"./lib/lrn-markdown-editor-editor.js";/**
 * `lrn-markdown-editor`
 ...
 */let LrnMarkdownEditor=Polymer({_template:html`
  ...
  `,is:"lrn-markdown-editor",properties:{content:{type:String,notify:!0/* transition */ /* transition */},selected:{type:String,value:"0",reflectToAttribute:!0},layout:{type:String,value:0},cookies:{type:Boolean,value:!0},elReady:{type:Boolean,value:!1}},observers:["_selectedChanged(selected)"],_selectedChanged:function(selected){var root=this,cookieName=root._getCookieName();// get current cookies
