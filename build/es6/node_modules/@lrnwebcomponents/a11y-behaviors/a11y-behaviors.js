export const A11yBehaviors = function (SuperClass) {
  return class extends SuperClass {
    ...
    getTextContrastColor(bgColor) {
      ...
      const colorBuffer = bgColor.replace("#", ""); // convert rrggbb to decimal

      const rgb = parseInt(colorBuffer, 16); // extract RGB

      const r = rgb >> 16 & 0xff;
      const g = rgb >> 8 & 0xff;
      const b = rgb >> 0 & 0xff; // calculate luma
    ...
    computeTextPropContrast(textprop, bgprop) {
      ...
      if (this[bgprop].includes("#")) {
        const color = this.getTextContrastColor(this[bgprop]); // Set color and background color vars
