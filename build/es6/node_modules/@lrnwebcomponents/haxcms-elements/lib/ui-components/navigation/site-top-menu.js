 ...
 */
import{html as t,css as i,LitElement as e}from"../../../../../lit/index.js";import{store as o}from"../../core/haxcms-site-store.js";import{autorun as s,toJS as n}from"../../../../../mobx/dist/mobx.esm.js";import"../query/site-query.js";import"../../../../simple-icon/simple-icon.js";import"../../../../simple-icon/lib/simple-icons.js";import"../../../../simple-icon/lib/simple-icon-button.js";class SiteTopMenu extends e{static get tag(){return"site-top-menu"}constructor(){super(),this.windowControllers=new AbortController,this.__disposer=[],this.manifest={},this.activeId=null,this.sticky=!1,this.indicator="line",this.notitle=!1,this.showindex=!1,this.mobileMenuOpen=!1,this.arrowSize=6,this.sort={order:"ASC"},this.conditions={parent:null},this.mobileTitle="Navigation",this.editMode=!1,this.__items=[]}static get styles(){return[i`
        :host {
          display: block;
      ...
      <div id="wrapper" class="wrapper">
        ...
        ${this.__items.map(((i,e)=>t`
          ${!0===i.metadata.hideInMenu||!1===i.metadata.published?"":t`
            <li class="spacing">
              <a
                data-id="${i.id}"
                class="link"
              ...
              >
                <button id="item-${i.id}" part="button">
                  ...
                  <span class="link-title" itemprop="name">${i.title}</span>
                </button>
              </a>
            </li>
          `} `))}
    ...
    `}updated(t){super.updated&&super.updated(t),t.has("activeId")&&this._activeIdChanged(this.activeId),t.has("mobileMenuOpen")&&this.manageOpen(this.mobileMenuOpen)}static get properties(){return{__items:{type:Array},manifest:{type:Object},activeId:{type:String},sticky:{type:Boolean,reflect:!0},indicator:{type:String,reflect:!0},notitle:{type:Boolean,reflect:!0},showindex:{type:Boolean,reflect:!0},arrowSize:{type:Number,attribute:"arrow-size"},sort:{type:Object},conditions:{type:Object},mobileTitle:{type:String,attribute:"mobile-title"},editMode:{type:Boolean,reflect:!0,attribute:"edit-mode"},mobileMenuOpen:{type:Boolean,reflect:!0,attribute:"mobile-menu-open"}}}humanIndex(t){return t+1}toggleOpen(t){this.mobileMenuOpen=!this.mobileMenuOpen}manageOpen(t){var i=this.shadowRoot.querySelector("#wrapper");t?i.classList.add("responsive"):i.classList.remove("responsive")}_activeIdChanged(t){if(this.mobileMenuOpen=!1,"none"!=this.indicator)if(t){this.shadowRoot.querySelector("#indicator").classList.add("activated");let i=null;if(this.shadowRoot.querySelector('[data-id="'+t+'"]'))i=this.shadowRoot.querySelector('[data-id="'+t+'"]');else{let e=this.manifest.items.find((i=>i.id==t));for(;null===i&&e&&null!=e.parent;)e=this.manifest.items.find((t=>t.id==e.parent)),e&&this.shadowRoot.querySelector('[data-id="'+e.id+'"]')&&(i=this.shadowRoot.querySelector('[data-id="'+e.id+'"]'))}this._prevEl&&this._prevEl.classList.remove("active"),i&&(i.classList.add("active"),setTimeout((()=>{let t=i.getBoundingClientRect();"arrow"==this.indicator?(this.shadowRoot.querySelector("#indicator").style.left=t.left+i.offsetWidth/2-this.arrowSize+"px",this.shadowRoot.querySelector("#indicator").style.top=t.bottom):(this.shadowRoot.querySelector("#indicator").style.left=t.left+"px",this.shadowRoot.querySelector("#indicator").style.top=t.bottom,this.shadowRoot.querySelector("#indicator").style.width=i.offsetWidth+"px"),this._prevEl=i}),0))}else this.shadowRoot.querySelector("#indicator").classList.remove("activated")}firstUpdated(t){super.firstUpdated&&super.firstUpdated(t),this.shadowRoot.querySelector("#menu").addEventListener("click",this.toggleOpen.bind(this)),s((t=>{this.manifest=n(o.manifest),this.__disposer.push(t)})),s((t=>{this.editMode=n(o.editMode),this.__disposer.push(t)})),setTimeout((()=>{s((t=>{this.activeId=n(o.activeId),this.__disposer.push(t)}))}),50),window.addEventListener("resize",(()=>{this._activeIdChanged(this.activeId)}),{signal:this.windowControllers.signal}),setTimeout((()=>{window.dispatchEvent(new Event("resize"))}),3e3)}disconnectedCallback(){for(var t in this.__disposer)this.__disposer[t].dispose();this.windowControllers.abort(),super.disconnectedCallback()}}customElements.define(SiteTopMenu.tag,SiteTopMenu);export{SiteTopMenu};