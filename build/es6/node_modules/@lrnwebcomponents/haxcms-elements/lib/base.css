body, html, :root {
  ...
  --simple-modal-button-background: #37474f;
  ...
  --hax-preview-button-bg: var(--haxcms-system-bg, black);
  --hax-preview-button-color: white;
  ...
  --simple-toast-left: 0;
  --simple-toast-color: white;
  --simple-toast-bg: var(--haxcms-system-bg, black);
  --simple-toast-margin: 0 0 0 49px;
  --simple-toast-border: 1px solid black;
}
...
p {
  font-size: var(--haxcms-base-styles-p-line-height, 40px);
  font-size: var(--haxcms-base-styles-p-min-height, 26px);
  font-size: var(--haxcms-base-styles-p-font-size, 24px);
  line-height: var(--haxcms-base-styles-p-line-height, 1.8);
  letter-spacing: var(--haxcms-base-styles-p-letter-spacing, .5px);
}
a {
  color: var(--haxcms-base-styles-a-color, #000);
  font-size: var(--haxcms-base-styles-a-font-size, 24px);
  font-weight: var(--haxcms-base-styles-a-font-weight, normal);
}
a:visited {
  color: var(--haxcms-base-styles-a-color-visited, #2196f3);
}
a:active,
a:focus,
a:hover {
  color: var(--haxcms-base-styles-a-color-active, #2196f3);
  font-weight: var(--haxcms-base-styles-a-font-weight-active, normal);
}
ol,
ul
ol li,
ul li {
  padding-bottom: var(--haxcms-base-styles-list-padding-bottom, 1.5em);
  line-height: var(--haxcms-base-styles-list-line-height, 40px);
  font-size: var(--haxcms-base-styles-list-font-size, 24px);
  max-width: var(--haxcms-base-styles-list-max-width, 28em);
}
ol li:last-child,
ul li:last-child {
  padding-bottom: var(--haxcms-base-styles-list-last-child-padding-bottom, 1em);
}
