...
import{css as t,LitElement as e,render as a,unsafeCSS as o}from"../../../../lit/index.js";import{HAXCMSTheme as r}from"./HAXCMSThemeWiring.js";import{ResponsiveUtilityBehaviors as i}from"../../../responsive-utility/lib/responsive-utility-behaviors.js";import{store as n}from"./haxcms-site-store.js";import{autorun as l,toJS as c}from"../../../../mobx/dist/mobx.esm.js";import"../../../simple-icon/lib/simple-icons.js";import{SimpleIconsetStore as d}from"../../../simple-icon/lib/simple-iconset.js";import{editableTableDisplayStyles as s}from"../../../editable-table/lib/editable-table-behaviors.js";import{learningComponentColors as h,iconFromPageType as b}from"../../../course-design/lib/learning-component.js";class HAXCMSLitElementTheme extends(r(i(e))){constructor(){super(),this.editMode=!1,this.isLoggedIn=!1,this.__disposer=this.__disposer?this.__disposer:[],l((t=>{this.editMode=c(n.editMode),this.__disposer.push(t)})),l((t=>{c(n.activeItemContent);this.HAXCMSThemeSettings.autoScroll&&this.shadowRoot&&this.HAXCMSThemeSettings.scrollTarget&&this.HAXCMSThemeSettings.scrollTarget.scrollIntoView&&this.HAXCMSThemeSettings.scrollTarget.scrollIntoView({block:"start",inline:"nearest",behavior:"smooth"}),setTimeout((()=>{let t=this.querySelectorAll("h1,h2,h3,h4,h5,h6");t.length>0&&t.forEach((t=>{t.addEventListener("click",this.copyLink.bind(this)),t.addEventListener("pointerenter",this.hoverIntentEnter.bind(this)),t.addEventListener("pointerleave",this.hoverIntentLeave.bind(this))}))}),100),this.__disposer.push(t)}))}hoverIntentEnter(t){this.__styleTag=globalThis.document.createElement("style");let e=d.getIcon("icons:link");this.__styleTag.innerHTML=`\n    #${t.target.getAttribute("id")} { cursor: copy; text-decoration: dotted underline}\n    #${t.target.getAttribute("id")} {\n      background-image: url("${e}");\n      background-position: right;\n      background-repeat: no-repeat;\n      background-size: 36px;\n    }`,t.target.appendChild(this.__styleTag)}hoverIntentLeave(t){this.__styleTag&&this.__styleTag.remove()}HAXCMSGlobalStyleSheetEditModeContent(){return[t``]}HAXCMSGlobalStyleSheetContent(){let e=["red","blue","green","orange","purple"].map((e=>t`
          ...
          .haxcms-theme-element [data-style-decoration~="${o(e)}"] {
            --haxcms-style-element-background-color: var(
              --simple-colors-default-theme-${o(e)}-7,
              ${o(e)}
            );
          }
        `)),a=Object.keys(h).map((e=>{let a=h[e];return t`
          h1[data-instructional-action="${o(e)}"],
          h2[data-instructional-action="${o(e)}"],
          h3[data-instructional-action="${o(e)}"],
          h4[data-instructional-action="${o(e)}"],
          h5[data-instructional-action="${o(e)}"],
          h6[data-instructional-action="${o(e)}"] {
          ...
          h1[data-instructional-action="${o(e)}"]::after,
          h2[data-instructional-action="${o(e)}"]::after,
          h3[data-instructional-action="${o(e)}"]::after,
          h4[data-instructional-action="${o(e)}"]::after,
          h5[data-instructional-action="${o(e)}"]::after,
          h6[data-instructional-action="${o(e)}"]::after {
            -webkit-mask-image: url("${o(d.getIcon(b(e)))}");
          }
          hr[data-instructional-action="${o(e)}"] {
            --hax-action-color: var(
          ...
          hr[data-instructional-action="${o(e)}"]::after {
            -webkit-mask-image: url("${o(d.getIcon(b(e)))}");
          }
        `}));return[t`
      ...
      `,...e,...a,s]}copyLink(t){let e=t.target;e||(e=t.path[0]),!e.id&&e.parentNode&&e.parentNode.id&&(e=e.parentNode);void 0!==globalThis.safari?e.scrollIntoView():e.scrollIntoView({behavior:"smooth",block:"start",inline:"nearest"});let a=globalThis.document.createElement("textarea");a.value=globalThis.location.origin+globalThis.location.pathname+"#"+e.getAttribute("id"),globalThis.history.pushState({},null,a.value),globalThis.dispatchEvent(new PopStateEvent("popstate")),globalThis.document.body.appendChild(a),a.select(),globalThis.document.execCommand("copy"),globalThis.document.body.removeChild(a),globalThis.dispatchEvent(new CustomEvent("haxcms-toast-show",{cancelable:!0,detail:{text:"Link copied to clipboard",duration:3e3}}))}static get properties(){let t={};return super.properties&&(t=super.properties),{...t,hexColor:{type:String,attribute:"hex-color"},color:{type:String,reflect:!0},editMode:{type:Boolean,reflect:!0,attribute:"edit-mode"},isLoggedIn:{type:Boolean,reflect:!0,attribute:"is-logged-in"},contentContainer:{type:Object},_location:{type:Object}}}static get styles(){let e=[];return super.styles&&(e=super.styles),[...e,t`
        :host([edit-mode]) {
          opacity: 1;
      ...
      `]}firstUpdated(t){super.firstUpdated&&super.firstUpdated(t),null==this.contentContainer&&(this.contentContainer=this.shadowRoot.querySelector("#contentcontainer")),a(this.HAXCMSGlobalStyleSheetContent(),n.themeStyleElement),setTimeout((()=>{setTimeout((()=>{if(this._location&&this._location.hash){let t=this.querySelector(this._location.hash);if(t){void 0!==globalThis.safari?t.scrollIntoView():t.scrollIntoView({behavior:"smooth",block:"start",inline:"nearest"})}}}),0);let t=this.querySelectorAll("h1,h2,h3,h4,h5,h6");t.length>0&&t.forEach((t=>{t.addEventListener("click",this.copyLink.bind(this)),t.addEventListener("pointerenter",this.hoverIntentEnter.bind(this)),t.addEventListener("pointerleave",this.hoverIntentLeave.bind(this))}))}),1500)}updated(t){super.updated&&super.updated(t),t.forEach(((t,e)=>{"_location"==e&&(this._locationChanged(this[e],t),setTimeout((()=>{if(this._location&&this._location.hash){let t=this.querySelector(this._location.hash);if(t){void 0!==globalThis.safari?t.scrollIntoView():t.scrollIntoView({behavior:"smooth",block:"start",inline:"nearest"})}}}),0)),"color"==e&&this._colorChanged(this[e],t),"contentContainer"==e&&(this.dispatchEvent(new CustomEvent("content-container-changed",{bubbles:!0,cancelable:!0,composed:!0,detail:this[e]})),this._contentContainerChanged(this[e],t)),"isLoggedIn"==e&&this.dispatchEvent(new CustomEvent("is-logged-in-changed",{bubbles:!0,cancelable:!0,composed:!0,detail:this[e]})),"editMode"==e&&(this.dispatchEvent(new CustomEvent("edit-mode-changed",{bubbles:!0,cancelable:!0,composed:!0,detail:this[e]})),this._editModeChanged(this[e],t),!this.__themeStylesAppliedToHaxBody&&this.HAXCMSGlobalStyleSheetEditModeContent&&(this.__themeStylesAppliedToHaxBody=!0,globalThis.HaxStore&&globalThis.HaxStore.requestAvailability()&&a(this.HAXCMSGlobalStyleSheetEditModeContent(),globalThis.HaxStore.requestAvailability().activeHaxBody.shadowRoot.querySelector("#hax-body-style-element"))))}))}}export{HAXCMSLitElementTheme};