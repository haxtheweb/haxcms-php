 ...
 */class HAXCMSSiteEditorUI extends PolymerElement{/**
   ...
   */static get tag(){return"haxcms-site-editor-ui"}constructor(){super();import("../../../../@polymer/paper-tooltip/paper-tooltip.js");import("../../../../@polymer/paper-icon-button/paper-icon-button.js");import("../../../simple-modal/simple-modal.js");import("./haxcms-outline-editor-dialog.js");import("../../../../@polymer/iron-icons/editor-icons.js");import("../../../../@polymer/paper-fab/paper-fab.js")}// render function
static get template(){return html`
    ...
    `}static get properties(){return{/**
       ...
       */painting:{type:Boolean,value:!0/* transition */ /* transition */,reflectToAttribute:!0},/**
       * page allowed
       ...
       */manifestEditMode:{type:Boolean,reflectToAttribute:!0,observer:"_manifestEditModeChanged",value:!1,notify:!0},activeTitle:{type:String}}}connectedCallback(){super.connectedCallback();this.__disposer=[];afterNextRender(this,function(){autorun(reaction=>{const activeItem=toJS(store.activeItem);if(activeItem&&activeItem.id){this.activeTitle=activeItem.title;this.pageAllowed=!0}else{this.pageAllowed=!1}this.__disposer.push(reaction)})})}disconnectedCallback(){for(var i in this.__disposer){this.__disposer[i].dispose()}super.disconnectedCallback()}/**
   * toggle state on button tap
   */_editButtonTap(e){this.editMode=!this.editMode;store.cmsSiteEditor.instance.haxCmsSiteEditorElement.editMode=this.editMode;// save button shifted to edit
if(!this.editMode){this.dispatchEvent(new CustomEvent("haxcms-save-node",{bubbles:!0,composed:!0,cancelable:!1,detail:store.activeItem}))}}_editDetailsButtonTap(e){var normalizedEvent=dom(e);const evt=new CustomEvent("haxcms-load-node-fields",{bubbles:!0,composed:!0,cancelable:!1,detail:normalizedEvent.localTarget});window.dispatchEvent(evt)}/**
   * toggle menu state
   */_menuButtonTap(e){this.menuMode=!this.menuMode}_cancelButtonTap(e){this.editMode=!1;store.cmsSiteEditor.instance.haxCmsSiteEditorElement.editMode=!1;this.dispatchEvent(new CustomEvent("hax-cancel",{bubbles:!0,composed:!0,cancelable:!1,detail:e.detail}))}/**
   * Add button hit
