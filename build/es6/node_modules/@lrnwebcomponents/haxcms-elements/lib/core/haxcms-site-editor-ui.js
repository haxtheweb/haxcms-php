...
<<<<<<< Updated upstream
      `]}static get tag(){return"haxcms-site-editor-ui"}_internalLinkChanged(e){if(e.detail.value&&i.findItem(e.detail.value)){const t=d(i.findItem(e.detail.value));s.haxTray.shadowRoot.querySelector("[name='settings.configure.href']").value=t.slug}}_expandSettingsPanel(e){this.shadowRoot.querySelector("#content-edit").click()}constructor(){if(super(),this.__winEvents={"can-redo-changed":"_redoChanged","can-undo-changed":"_undoChanged","hax-drop-focus-event":"_expandSettingsPanel","hax-store-ready":"haxStoreReady","jwt-logged-in":"_jwtLoggedIn"},this.rpgHat="none",this.darkMode=!1,this.__settingsText="",this.__editText="",this.userMenuOpen=!1,this.soundIcon="",this.__disposer=this.__disposer||[],this.t=this.t||{},u.allowedCallback=()=>!0,u.noResultsSlot=()=>e`Expecting to see results?
        <a
          @click="${e=>{s._haxStoreContribute("merlin","POP,enhancement",u.commandContext+" "+u.like)}}"
          >Make a suggestion</a
        >
        for what you thought you would see here!`,u.appendContext("CMS"),s.ready){let e=document.createElement("site-remote-content");s.haxAutoloader.appendChild(e);let t=document.createElement("citation-element");s.haxAutoloader.appendChild(t);let o=document.createElement("page-flag");s.haxAutoloader.appendChild(o),s.primativeHooks.a||(s.primativeHooks.a={}),s.primativeHooks.a.setupActiveElementForm=e=>{const t=i.getManifestItems(!0);var o=[{text:`-- ${this.t.selectPage} --`,value:null}];t.forEach((e=>{if(e.id!=this.itemId){let i=e,a="- ";for(;i&&null!=i.parent;)i=t.find((e=>e.id==i.parent)),i&&(a="--"+a);o.push({text:a+e.title,value:e.id})}})),e.settings.configure.splice(1,0,{property:"data-uuid",title:"Internal content",description:"Link to content internal to this site",inputMethod:"select",itemsList:o}),setTimeout((()=>{s.haxTray.shadowRoot.querySelector("[name='settings.configure.data-uuid']").addEventListener("value-changed",this._internalLinkChanged.bind(this))}),100)}}this.t={...this.t,selectPage:"Select page",backToSiteList:"Back to site list",cancel:"Cancel",editDetails:"Page details",add:"Add",editSettings:"Edit settings",source:"Source",viewSource:"View source",findMedia:"Find media",undo:"Undo",redo:"Redo",media:"Media",outline:"Outline",blocks:"Blocks",addBlock:"Add block",addPage:"Add page",addChildPage:"Add child page",clonePage:"Clone page",importDocxFile:"Import docx file",delete:"Delete page",shareSite:"Share site",siteSettings:"Site settings",close:"Close",settings:"Settings",editPage:"Edit page",edit:"Edit",configureBlock:"Configure block",configure:"Configure",save:"Save",saveChanges:"Save changes",newJourney:"New Journey",accountInfo:"Account Info",outlineDesigner:"Outline designer",pageOutline:"Page outline",more:"More",siteActions:"Site actions",insights:"Insights dashboard (beta)",merlin:"Merlin",summonMerlin:"Summon Merlin",logOut:"Log out",menu:"Menu",showMore:"More"},this.backText="Site list",this.painting=!0,this.pageAllowed=!1,this.editMode=!1,this.__editIcon="hax:page-edit",this.icon="hax:site-settings",this.manifestEditMode=!1,this.backLink="../../",this.activeTagName="",this.activeNode=null,window.appSettings&&window.appSettings.backLink&&(this.backLink=window.appSettings.backLink),n((()=>{const e=d(s.activeGizmo);e&&e.title&&(this.activeTagName=e.title)})),n((()=>{this.activeNode=d(s.activeNode)})),n((()=>{const e=d(i.badDevice);if(!1===e){const e=document.createElement("link");e.setAttribute("href","https://fonts.googleapis.com/css2?family=Press+Start+2P&display=swap"),e.setAttribute("rel","stylesheet"),e.setAttribute("fetchpriority","low"),document.head.appendChild(e)}else!0===e&&document.body.classList.add("bad-device")})),n((()=>{this.darkMode=d(i.darkMode),this.dark=this.darkMode,d(i.darkMode)?(u.dark=!0,u.toastInstance.darkMode=!0,s.globalPreferences.haxUiTheme="haxdark"):(s.globalPreferences.haxUiTheme="hax",u.dark=!1,u.toastInstance.darkMode=!1)})),n((()=>{this.soundIcon=d(i.soundStatus)?new URL("../../../app-hax/lib/assets/images/FullVolume.svg",import.meta.url).href:new URL("../../../app-hax/lib/assets/images/Silence.svg",import.meta.url).href})),setTimeout((()=>{import("./haxcms-outline-editor-dialog.js"),import("./haxcms-share-dialog.js"),import("./haxcms-site-dashboard.js")}),0)}haxStoreReady(e){if(e.detail){let e=document.createElement("site-remote-content");s.haxAutoloader.appendChild(e)}}soundToggle(){const e=!d(i.soundStatus);i.soundStatus=e,r("app-hax-soundStatus",e),e?(i.toast("Can you hear me now? Good.",2e3,{hat:"random"}),i.playSound("click")):i.toast("Sound off.. hey.. HELLO!?!",2e3,{fire:!0})}closeMenu(){this.userMenuOpen=!1}toggleMenu(){this.userMenuOpen=!this.userMenuOpen,i.playSound("click")}getIconPosition(e){return["xl","lg"].includes(e)?"left":"top"}render(){return e`
=======
      `]}static get tag(){return"haxcms-site-editor-ui"}_expandSettingsPanel(e){this.shadowRoot.querySelector("#content-edit").click()}async processFileUpload(e,t){x(["core"]);const o=e.dataTransfer.files[0],a=new FormData;a.append("upload",o);const n=await g.call("@core/docxToHtml",a);n&&n.data&&n.data.contents&&"appendChild"===t&&!1===i.editMode&&(i.editMode=!0,setTimeout((async()=>{let e=await s.activeHaxBody.haxToContent();s.activeHaxBody.importContent(e+n.data.contents)}),100))}async insertUrl(e,t){if(!1===i.editMode&&(i.editMode=!0),t){const t=await g.call("@core/metadata",{q:e});if(t.data&&(t.data["og:title"]||t.data.title)){let o={title:t.data["og:title"]||t.data.title,source:e};s.insertLogicFromValues(o,this)}}}constructor(){if(super(),this.__winEvents={"can-redo-changed":"_redoChanged","can-undo-changed":"_undoChanged","hax-drop-focus-event":"_expandSettingsPanel","hax-store-ready":"haxStoreReady","jwt-logged-in":"_jwtLoggedIn","super-daemon-close":"sdCloseEvent"},this.rpgHat="none",this.darkMode=!1,this.__editText="Edit",this.userMenuOpen=!1,this.soundIcon="",this.__disposer=this.__disposer||[],this.t=this.t||{},b.allowedCallback=()=>!0,b.keyHandlerCallback=()=>{const e=this.shadowRoot.querySelector("#merlin");return i.playSound("click"),"super-daemon-modal"==e.getAttribute("data-event")?s.haxTray.collapsed=!1:(b.mini=!0,b.wand=!0,b.activeNode=this.shadowRoot.querySelector("#merlin")),b.runProgram("","*"),!0},b.noResultsSlot=()=>e`<div class="no-results">Expecting to see an option Merlin didn't provide?</div>
        <a
          @click="${e=>{s._haxStoreContribute("merlin","POP,enhancement",b.commandContext+" "+b.value)}}"
          >Make a suggestion to improve results</a
        >`,b.appendContext("CMS"),b.defineOption({title:"Magic Wand",icon:"hax:hax2022",priority:-1e4,tags:["Agent","help","merlin"],eventName:"super-daemon-run-program",path:"HAX/agent",value:{name:"Agent",machineName:"hax-agent",program:(e,t)=>{const o=l(v.action),i=l(v.data);let a=[];if("drop"===o.type)switch(h(i.value)){case".docx":case".doc":console.log(t),a=[{title:"Insert 'doc' content as HTML",icon:"hax:hax2022",tags:["agent"],value:{target:this,method:"processFileUpload",args:[t,"appendChild"]},eventName:"super-daemon-element-method",path:"HAX/agent/insert"}]}else a=[{title:"URL with page title",icon:"hax:hax2022",tags:["agent"],value:{target:this,method:"insertUrl",args:[e,!0]},eventName:"super-daemon-element-method",path:"HAX/agent/insert"},{title:"Insert url alone",icon:"hax:hax2022",tags:["agent"],value:{target:this,method:"insertUrl",args:[e,!1]},eventName:"super-daemon-element-method",path:"HAX/agent/insert"}];return a}}}),s.ready){let e=document.createElement("site-remote-content");s.haxAutoloader.appendChild(e);let t=document.createElement("citation-element");s.haxAutoloader.appendChild(t);let o=document.createElement("page-flag");s.haxAutoloader.appendChild(o);let a=document.createElement("site-view");s.haxAutoloader.appendChild(a),s.primativeHooks.a||(s.primativeHooks.a={}),s.primativeHooks.a.setupActiveElementForm=e=>{const t=i.getManifestItems(!0);var o=[{text:`-- ${this.t.selectPage} --`,value:null}];t.forEach((e=>{if(e.id!=this.itemId){let i=e,a="- ";for(;i&&null!=i.parent;)i=t.find((e=>e.id==i.parent)),i&&(a="--"+a);o.push({text:a+e.title,value:e.id})}}))}}this.t={...this.t,selectPage:"Select page",backToSiteList:"Back to site list",mySites:"My sites",cancel:"Cancel",unsavedChangesWillBeLostIfSelectingOkAreYouSure:"Unsaved changes will be lost if selecting OK, are you sure?",editDetails:"Page details",add:"Add",editSettings:"Edit settings",source:"Source",viewSource:"View source",confirmHtmlSourceExit:"HTML Source changes will not be saved without pressing the `Update HTML` button, Save without HTML code editor changes?",findMedia:"Find media",undo:"Undo",redo:"Redo",media:"Media",outline:"Outline",blocks:"Blocks",addBlock:"Add block",addPage:"Add page",addChildPage:"Add child page",clonePage:"Clone page",importDocxFile:"Import docx file",delete:"Delete page",shareSite:"Share site",siteSettings:"Site settings",close:"Close",settings:"Settings",edit:"Edit",configureBlock:"Configure block",configure:"Configure",save:"Save",newJourney:"New Journey",accountInfo:"Account Info",outlineDesigner:"Outline designer",pageOutline:"Page outline",more:"More",siteActions:"Site actions",insights:"Insights dashboard (beta)",viewBuilder:"View builder (alpha)",merlin:"Merlin",summonMerlin:"Summon Merlin",logOut:"Log out",menu:"Menu",showMore:"More"},this.backText="Site list",this.painting=!0,this.pageAllowed=!1,this.editMode=!1,this.__editIcon="hax:page-edit",this.icon="hax:site-settings",this.manifestEditMode=!1,this.backLink="../../",this.activeTagName="",this.activeNode=null,this.activeDrag=!1,this.activeType=null,window.appSettings&&window.appSettings.backLink&&(this.backLink=window.appSettings.backLink),n((()=>{const e=l(v.action),t=l(v.data);v.active&&v.memory.isLoggedIn&&null===b.programName&&"drag"===e.type?(this.activeDrag=!0,this.activeType=t.value||t.architype):v.active&&v.memory.isLoggedIn&&null===b.programName&&"dragleave"===e.type&&(this.activeDrag=!1,this.activeType=null)})),n((()=>{const e=l(s.activeGizmo);e&&e.title&&(this.activeTagName=e.title)})),n((()=>{this.activeNode=l(s.activeNode)})),n((()=>{const e=l(i.badDevice);if(!1===e){const e=document.createElement("link");e.setAttribute("href","https://fonts.googleapis.com/css2?family=Press+Start+2P&display=swap"),e.setAttribute("rel","stylesheet"),e.setAttribute("fetchpriority","low"),document.head.appendChild(e)}else!0===e&&document.body.classList.add("bad-device")})),n((()=>{this.darkMode=l(i.darkMode),this.dark=this.darkMode,l(i.darkMode)?(b.dark=!0,b.toastInstance.darkMode=!0,s.globalPreferences.haxUiTheme="haxdark"):(s.globalPreferences.haxUiTheme="hax",b.dark=!1,b.toastInstance.darkMode=!1)})),n((()=>{this.soundIcon=l(i.soundStatus)?new URL("../../../app-hax/lib/assets/images/FullVolume.svg",import.meta.url).href:new URL("../../../app-hax/lib/assets/images/Silence.svg",import.meta.url).href})),setTimeout((()=>{import("./haxcms-outline-editor-dialog.js"),import("./haxcms-share-dialog.js")}),0)}haxStoreReady(e){if(e.detail){let e=document.createElement("site-remote-content");s.haxAutoloader.appendChild(e)}}soundToggle(){const e=!l(i.soundStatus);i.soundStatus=e,r("app-hax-soundStatus",e),e?(i.toast("Can you hear me now? Good.",2e3,{hat:"random"}),i.playSound("click")):i.toast("Sound off.. hey.. HELLO!?!",2e3,{fire:!0})}closeMenu(){this.userMenuOpen=!1}toggleMenu(){this.userMenuOpen=!this.userMenuOpen,i.playSound("click")}getIconPosition(e){return["xl","lg"].includes(e)?"left":"top"}render(){return e`
>>>>>>> Stashed changes
