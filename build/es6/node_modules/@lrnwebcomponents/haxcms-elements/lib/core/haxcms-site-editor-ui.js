import{html as e,css as t,unsafeCSS as o}from"../../../../lit/index.js";import{store as a}from"./haxcms-site-store.js";import{HaxStore as i,HAXStore as s}from"../../../hax-body/lib/hax-store.js";import{autorun as n,toJS as l}from"../../../../mobx/dist/mobx.esm.js";import{localStorageSet as d}from"../../../utils/utils.js";import"../../../simple-icon/simple-icon.js";import"../../../simple-icon/lib/simple-icons.js";import{HAXCMSThemeParts as r}from"./utils/HAXCMSThemeParts.js";import{HAXCMSI18NMixin as p}from"./utils/HAXCMSI18NMixin.js";import"../../../rpg-character/rpg-character.js";import"../../../app-hax/lib/v1/app-hax-top-bar.js";import"../../../app-hax/lib/v1/app-hax-user-menu.js";import"../../../app-hax/lib/v1/app-hax-user-menu-button.js";import"../../../../wired-elements/lib/wired-button.js";import{SimpleColors as c}from"../../../simple-colors/simple-colors.js";import{SuperDaemonInstance as h}from"../../../super-daemon/super-daemon.js";import"../../../simple-modal/simple-modal.js";import"./haxcms-site-insights.js";import"../../../simple-fields/lib/simple-fields-form.js";import"./micros/haxcms-button-add.js";import"./haxcms-darkmode-toggle.js";import"../ui-components/site/site-remote-content.js";import"../../../page-flag/page-flag.js";const m=new URL("../../../app-hax/lib/assets/images/HAXLogo.svg",import.meta.url).href,u=(new URL("../../../app-hax/lib/assets/images/ButtonBGLM.svg",import.meta.url).href,new URL("../../../app-hax/lib/assets/images/ButtonBGDM.svg",import.meta.url).href,new URL("../../../app-hax/lib/assets/images/Logout.svg",import.meta.url).href);class HAXCMSSiteEditorUI extends(r(p(c))){static get styles(){return[...super.styles,t`
      ...
      `]}static get tag(){return"haxcms-site-editor-ui"}_internalLinkChanged(e){if(e.detail.value&&a.findItem(e.detail.value)){const t=l(a.findItem(e.detail.value));s.haxTray.shadowRoot.querySelector("[name='settings.configure.href']").value=t.slug}}constructor(){if(super(),this.windowControllers=new AbortController,this.rpgHat="none",this.darkMode=!1,this.__settingsText="",this.__editText="",this.userMenuOpen=!1,this.soundIcon="",this.__disposer=this.__disposer||[],this.t=this.t||{},h.allowedCallback=()=>!0,h.noResultsSlot=()=>e`Expecting to see results?
        <a
          @click="${e=>{s._haxStoreContribute("merlin","POP,enhancement",h.commandContext+" "+h.like)}}"
          >Make a suggestion</a
        >
        for what you thought you would see here!`,h.appendContext("CMS"),window.addEventListener("hax-store-ready",this.haxStoreReady.bind(this),{signal:this.windowControllers.signal}),s.ready){let e=document.createElement("site-remote-content");s.haxAutoloader.appendChild(e);let t=document.createElement("citation-element");s.haxAutoloader.appendChild(t);let o=document.createElement("page-flag");s.haxAutoloader.appendChild(o),s.primativeHooks.a||(s.primativeHooks.a={}),s.primativeHooks.a.setupActiveElementForm=e=>{const t=a.getManifestItems(!0);var o=[{text:`-- ${this.t.selectPage} --`,value:null}];t.forEach((e=>{if(e.id!=this.itemId){let a=e,i="- ";for(;a&&null!=a.parent;)a=t.find((e=>e.id==a.parent)),a&&(i="--"+i);o.push({text:i+e.title,value:e.id})}})),e.settings.configure.splice(1,0,{property:"data-uuid",title:"Internal content",description:"Link to content internal to this site",inputMethod:"select",itemsList:o}),setTimeout((()=>{s.haxTray.shadowRoot.querySelector("[name='settings.configure.data-uuid']").addEventListener("value-changed",this._internalLinkChanged.bind(this))}),100)}}this.t={...this.t,selectPage:"Select page",backToSiteList:"Back to site list",cancelEditing:"Cancel editing",editDetails:"Page details",addPage:"Add page",addChildPage:"Add child page",duplicatePage:"Duplicate page",importDocxFile:"Import docx file",deletePage:"Delete page",shareSite:"Share site",closeSiteSettings:"Close site settings",editSiteSettings:"Site settings",savePageContent:"Save page",editPageContent:"Edit page",newJourney:"New Journey",accountInfo:"Account Info",outlineDesigner:"Outline designer",more:"More",insights:"Insights",logOut:"Log out",menu:"Menu",showMore:"More"},this.backText="Site list",this.painting=!0,this.pageAllowed=!1,this.editMode=!1,this.__editIcon="hax:page-edit",this.icon="hax:site-settings",this.manifestEditMode=!1,this.backLink="../../",window.appSettings&&window.appSettings.backLink&&(this.backLink=window.appSettings.backLink),n((()=>{const e=l(a.badDevice);if(!1===e){const e=document.createElement("link");e.setAttribute("href","https://fonts.googleapis.com/css2?family=Press+Start+2P&display=swap"),e.setAttribute("rel","stylesheet"),e.setAttribute("fetchpriority","low"),document.head.appendChild(e)}else!0===e&&document.body.classList.add("bad-device")})),n((()=>{this.darkMode=l(a.darkMode),this.dark=this.darkMode,l(a.darkMode)?s.globalPreferences.haxUiTheme="haxdark":s.globalPreferences.haxUiTheme="hax"})),n((()=>{this.soundIcon=l(a.soundStatus)?new URL("../../../app-hax/lib/assets/images/FullVolume.svg",import.meta.url).href:new URL("../../../app-hax/lib/assets/images/Silence.svg",import.meta.url).href})),setTimeout((()=>{import("./haxcms-outline-editor-dialog.js"),import("./haxcms-share-dialog.js"),import("./haxcms-site-dashboard.js")}),0)}haxStoreReady(e){if(e.detail){let e=document.createElement("site-remote-content");s.haxAutoloader.appendChild(e)}}soundToggle(){const e=!l(a.soundStatus);a.soundStatus=e,d("app-hax-soundStatus",e),e?(a.toast("Can you hear me now? Good.",2e3,{hat:"random"}),a.playSound("click")):a.toast("Sound off.. hey.. HELLO!?!",2e3,{fire:!0})}toggleMenu(){this.userMenuOpen=!this.userMenuOpen,a.playSound("click")}render(){return e`
      <app-hax-top-bar part="top-bar">
