...
setTimeout(()=>{if(0===dom(this).getEffectiveChildNodes().length){console.log("append");let frag=document.createRange().createContextualFragment(store.activeItemContent);dom(this).appendChild(frag)}},50);updateStyles();// store disposer so we can clean up later
