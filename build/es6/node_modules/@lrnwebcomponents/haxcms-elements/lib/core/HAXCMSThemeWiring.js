  ...
  return class extends SuperClass {
    ...
    connectedCallback() {
      ...
      afterNextRender(this, function () {
        ...
        updateStyles(); // keep editMode in sync globally
        ...
        autorun(reaction => {
          ...
          if (__routerManifest && varExists(__routerManifest, "metadata.theme.variables.cssVariable")) {
            ...
            document.body.style.setProperty("--haxcms-color", varGet(__routerManifest, "metadata.theme.variables.hexCode", "#FFFFFF"));
          }
