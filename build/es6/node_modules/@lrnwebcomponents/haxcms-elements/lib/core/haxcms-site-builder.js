...
static get template(){return html`
    ...
    `}static get properties(){return{/**
       ...
       */loading:{type:Boolean,value:!1,reflectToAttribute:!0/* transition */ /* transition */},/**
...
setTimeout(()=>{let frag=document.createRange().createContextualFragment(html);dom(this.themeElement).appendChild(frag);this.dispatchEvent(new CustomEvent("json-outline-schema-active-body-changed",{bubbles:!0,composed:!0,cancelable:!1,detail:html}))},5);// if there are, dynamically import them
