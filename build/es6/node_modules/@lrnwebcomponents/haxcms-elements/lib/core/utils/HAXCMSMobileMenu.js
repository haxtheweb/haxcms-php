import{css as e,html as t}from"../../../../../lit/index.js";import{store as i}from"../haxcms-site-store.js";import{HAXCMSI18NMixin as s}from"./HAXCMSI18NMixin.js";import"../../../../simple-icon/simple-icon.js";import"../../../../simple-icon/lib/simple-icons.js";import"../../../../simple-icon/lib/simple-icon-button-lite.js";import"../../../../simple-tooltip/simple-tooltip.js";import{autorun as o,toJS as n}from"../../../../../mobx/dist/mobx.esm.js";import{localStorageSet as m,localStorageGet as u}from"../../../../utils/utils.js";const HAXCMSMobileMenuMixin=function(l){return class extends(s(l)){constructor(){super(),this.menuOpen=!0,this.t=this.t||{},this.t.closeMenu="Close menu",this.t.openMenu="Open menu";let e=u("hax-mobile-menu-menuOpen",null);null!==e&&(!0===e?this.menuOpen=!0:!1===e&&(this.menuOpen=!1)),this.__disposer=this.__disposer?this.__disposer:[],o((e=>{const t=n(i.activeId);this.shadowRoot&&this.shadowRoot.querySelector("#haxcmsmobilemenunav")&&this.menuOpen&&t&&["sm","xs"].includes(this.responsiveSize)&&this.__HAXCMSMobileMenuToggle(),this.__disposer.push(e)}))}static get styles(){let t=[];return super.styles&&(t=super.styles),[...t,e`
