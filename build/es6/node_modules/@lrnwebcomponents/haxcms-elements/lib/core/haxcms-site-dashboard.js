 ...
 */
import{LitElement as t,html as e,css as o}from"../../../../lit/index.js";import{store as i}from"./haxcms-site-store.js";import{varGet as s,varExists as a}from"../../../utils/utils.js";import{autorun as r,toJS as d}from"../../../../mobx/dist/mobx.esm.js";import"../../../simple-tooltip/simple-tooltip.js";import"../../../simple-fields/lib/simple-fields-form.js";import"../../../simple-icon/simple-icon.js";import"../../../simple-icon/lib/simple-icons.js";import"../../../simple-icon/lib/simple-icon-button.js";import{HaxSchematizer as l,HaxElementizer as n}from"../../../hax-body-behaviors/lib/HAXFields.js";class HAXCMSSiteDashboard extends t{static get tag(){return"haxcms-site-dashboard"}constructor(){super(),this.manifest={},this.__disposer=[],r((t=>{this.jwt=d(i.jwt),this.__disposer.push(t)})),r((t=>{this.dashboardOpened=d(i.dashboardOpened),this.__disposer.push(t)})),r((t=>{this.manifest=d(i.manifest),this.__disposer.push(t)}))}static get styles(){return[o`
        :host {
          z-index: 1;
