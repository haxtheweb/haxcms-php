...
static get template(){return html`
    ...
    `}static get properties(){return{/**
       ...
       */activeItem:{type:Object,notify:!0/* transition */ /* transition */,observer:"_activeItemChanged"},/**
       * Logged in state
   ...
   * Request a user login if we need one or log out
   */_loginUserRoutine(e){this.$.jwt.toggleLogin()}/**
...
if(e.detail.value){this.set("activeItem.metadata.theme",e.detail.value);this.notifyPath("activeItem.metadata.theme")}}/**
   ...
   */_addTap(e){let itemNew=this.$.siteslisting.$.list.querySelector("[data-site-id=\"item-new\"]");if(itemNew){itemNew.click()}}/**
   * Toggle edit state
   */_editTap(e){this.editMode=!this.editMode}/**
   * _settingsTap
   */_settingsTap(e){this._loadConfig();this.$.settingsdialog.opened=!0}/**
...
document.body.removeEventListener("sites-listing-item-selected",this._itemSelected.bind(this));document.body.removeEventListener("haxcms-load-site",this.loadActiveSite.bind(this));this.$.mapmenu.removeEventListener("selected",this._mapMenuSelection.bind(this));this.$.newsitetheme.removeEventListener("change",this._themeChanged.bind(this));this.$.newsitecolor.removeEventListener("change",this._colorChanged.bind(this));this.$.jwt.removeEventListener("jwt-logged-in",this._loginStateChange.bind(this));this.$.siteslisting.removeEventListener("item-overlay-option-selected",this._itemOptionSelected.bind(this));this.$.siteslisting.removeEventListener("item-overlay-op-changed",this._itemOpChanged.bind(this));super.disconnectedCallback()}/**
   * created life cycle
   */constructor(){super();setPassiveTouchGestures(!0);window.JSONOutlineSchema.requestAvailability();window.SimpleModal.requestAvailability();window.SimpleToast.requestAvailability();window.HAXCMS={}}/**
   * Ready life cycle
...
this.set("configParams.jwt",this.jwt);this.notifyPath("configParams.jwt");this.set("configParams.token",this.createParams.token);this.notifyPath("configParams.token");this.$.getconfigrequest.generateRequest()}/**
   * Save configuration
   */_saveConfig(e){window.HAXCMS.config.values=this.$.settingsform.value;// pass along the jwt for user "session" purposes
...
this.$.edit.click()}}}}window.customElements.define(HAXCMSSiteListing.tag,HAXCMSSiteListing);export{HAXCMSSiteListing};