...
this._setChildren(child,data)})}}/**
   ...
   */get routerManifest(){const manifest=this.manifest;document.body.dispatchEvent(new CustomEvent("json-outline-schema-changed",{bubbles:!0/* transition */ /* transition */,composed:!0,cancelable:!1,detail:manifest}));if(manifest&&"undefined"!==typeof manifest.items){let userData=JSON.parse(window.localStorage.getItem("HAXCMSSystemData"));var accessData={};// establish on first pass if needed
