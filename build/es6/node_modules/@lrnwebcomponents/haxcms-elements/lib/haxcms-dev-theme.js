import{html,PolymerElement}from"../../../@polymer/polymer/polymer-element.js";import{dom}from"../../../@polymer/polymer/lib/legacy/polymer.dom.js";import"../../../@polymer/paper-card/paper-card.js";import"../../../@polymer/paper-button/paper-button.js";import"../../../@polymer/iron-icons/iron-icons.js";import"../../../@polymer/iron-list/iron-list.js";import"../../simple-colors/simple-colors.js";import"../../hax-body/lib/hax-shared-styles.js";import{HAXCMSTheme}from"./HAXCMSThemeWiring.js";class HAXCMSDevTheme extends HAXCMSTheme(PolymerElement){static get tag(){return"haxcms-dev-theme"}static get template(){return html`
    ...
    `}_itemTapped(e){var normalizedEvent=dom(e),local=normalizedEvent.localTarget,activeId=local.getAttribute("data-id");if("PAPER-BUTTON"===local.tagName&&typeof activeId!==typeof void 0){console.log(this.manifest);console.log(this.setActiveItemFromID(activeId))}}}window.customElements.define(HAXCMSDevTheme.tag,HAXCMSDevTheme);export{HAXCMSDevTheme};