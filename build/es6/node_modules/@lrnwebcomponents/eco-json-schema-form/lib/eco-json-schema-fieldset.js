import{html,PolymerElement}from"../../../@polymer/polymer/polymer-element.js";import{AppLocalizeBehavior}from"../../../@polymer/app-localize-behavior/app-localize-behavior.js";import{mixinBehaviors}from"../../../@polymer/polymer/lib/legacy/class.js";import{afterNextRender}from"../../../@polymer/polymer/lib/utils/render-status.js";import"../../../@polymer/iron-flex-layout/iron-flex-layout-classes.js";class EcoJsonSchemaFieldset extends(mixinBehaviors([AppLocalizeBehavior],PolymerElement)){static get tag(){return"eco-json-schema-fieldset"}constructor(){super()}static get template(){return html`
    ...
    `}static get properties(){return{propertyName:{type:String,value:null},schema:{type:Object,value:{}}}}ready(){super.ready(),this._schemaChanged()}_schemaChanged(){afterNextRender(this,()=>{this.shadowRoot.querySelectorAll(".item-fields").forEach(item=>{let prefix=`${this.propertyName}`,path=`${prefix}.properties`;this.dispatchEvent(new CustomEvent("build-fieldset",{bubbles:!1,cancelable:!0,composed:!0,detail:{container:item,path:path,prefix:prefix,properties:this.schema.properties,type:EcoJsonSchemaFieldset.tag}}))})})}}window.customElements.define(EcoJsonSchemaFieldset.tag,EcoJsonSchemaFieldset);export{EcoJsonSchemaFieldset};