import{html,PolymerElement}from"../../../@polymer/polymer/polymer-element.js";import{AppLocalizeBehavior}from"../../../@polymer/app-localize-behavior/app-localize-behavior.js";import{mixinBehaviors}from"../../../@polymer/polymer/lib/legacy/class.js";import"../../a11y-tabs/a11y-tabs.js";import{afterNextRender}from"../../../@polymer/polymer/lib/utils/render-status.js";class EcoJsonSchemaTabs extends(mixinBehaviors([AppLocalizeBehavior],PolymerElement)){static get tag(){return"eco-json-schema-tabs"}static get template(){return html`
    ...
    `}static get properties(){return{propertyName:{type:String,value:null},schema:{type:Object,value:{}}}}ready(){super.ready(),this._schemaChanged()}_schemaChanged(){afterNextRender(this,()=>{this.shadowRoot.querySelectorAll(".item-fields").forEach(item=>{let index=item.getAttribute("data-index"),propertyName=this.propertyName,tab=this.schema.properties[index],prefix=`${propertyName}.${tab.name}`,path=`${propertyName}.properties.${index}`;this.dispatchEvent(new CustomEvent("build-fieldset",{bubbles:!1,cancelable:!0,composed:!0,detail:{container:item,path:path,prefix:prefix,properties:tab.schema.properties,type:EcoJsonSchemaTabs.tag}}))})})}}window.customElements.define(EcoJsonSchemaTabs.tag,EcoJsonSchemaTabs);export{EcoJsonSchemaTabs};