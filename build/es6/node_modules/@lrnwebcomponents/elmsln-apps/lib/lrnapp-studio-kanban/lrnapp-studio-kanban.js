import{html,PolymerElement}from"../../../../@polymer/polymer/polymer-element.js";import{afterNextRender}from"../../../../@polymer/polymer/lib/utils/render-status.js";import{dom}from"../../../../@polymer/polymer/lib/legacy/polymer.dom.js";import"../../../../@polymer/iron-ajax/iron-ajax.js";import"../../../../@polymer/app-route/app-location.js";import"../../../../@polymer/app-route/app-route.js";import"../../../../@polymer/iron-icon/iron-icon.js";import"../../../../@polymer/paper-badge/paper-badge.js";import"../../../../@polymer/paper-toggle-button/paper-toggle-button.js";import"../../../../@polymer/app-layout/app-toolbar/app-toolbar.js";import"../../../../@polymer/paper-card/paper-card.js";import"../../../../@polymer/iron-list/iron-list.js";import"../../../../@polymer/paper-toast/paper-toast.js";import"../../../../@polymer/paper-button/paper-button.js";import"../../../../@polymer/paper-dialog/paper-dialog.js";import"../../../lrnsys-render-html/lrnsys-render-html.js";import"../../../lrnsys-layout/lib/lrnsys-dialog.js";import"../../../lrnsys-button/lrnsys-button.js";import"../../../elmsln-loading/elmsln-loading.js";import"../../../materializecss-styles/materializecss-styles.js";import"./lrnapp-studio-project-button.js";import"./lrnapp-studio-assignment-button.js";class LrnappStudioKanban extends PolymerElement{static get template(){return html`
    ...
    </paper-dialog>`}static get tag(){return"lrnapp-studio-kanban"}static get properties(){return{/**
...
if(0==submission.status&&0==submission.submission.length){if(!update){this.shadowRoot.querySelector("#"+this.activeAssignment+"-toggle").disabled=!0;this.shadowRoot.querySelector("#"+this.activeAssignment+"-toggle").checked=!1}this.shadowRoot.querySelector("#"+this.activeAssignment+"-toggle").title="Submission not started";this.shadowRoot.querySelector("#"+this.activeAssignment+"-toggle-text").textContent="Submission not started"}else if(0==submission.status){if(!update){this.shadowRoot.querySelector("#"+this.activeAssignment+"-toggle").disabled=!1;this.shadowRoot.querySelector("#"+this.activeAssignment+"-toggle").checked=!1}this.shadowRoot.querySelector("#"+this.activeAssignment+"-toggle").title="Submission started";this.shadowRoot.querySelector("#"+this.activeAssignment+"-toggle-text").textContent="Submission in progress"}else{if(!update){this.shadowRoot.querySelector("#"+this.activeAssignment+"-toggle").disabled=!1;this.shadowRoot.querySelector("#"+this.activeAssignment+"-toggle").checked=!0}this.shadowRoot.querySelector("#"+this.activeAssignment+"-toggle").title="Submission ready";this.shadowRoot.querySelector("#"+this.activeAssignment+"-toggle-text").textContent="Submission ready"}}}/**
   ...
   */_toArray(obj){return Object.keys(obj).map(function(key){return obj[key]})}}window.customElements.define(LrnappStudioKanban.tag,LrnappStudioKanban);export{LrnappStudioKanban};