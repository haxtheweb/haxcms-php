import{html,Polymer}from"../../../../@polymer/polymer/polymer-legacy.js";import"../../../../@polymer/paper-styles/color.js";import"../../../../@polymer/paper-styles/typography.js";/**
...
@demo demo/chip.html
*/let PaperChip=Polymer({_template:html`
    <style>
      :host {
    ...
    <slot></slot>
  `,is:"paper-chip",properties:{selectable:{type:Boolean,value:!1,reflectToAttribute:!0/* transition */ /* transition */}}});export{PaperChip};