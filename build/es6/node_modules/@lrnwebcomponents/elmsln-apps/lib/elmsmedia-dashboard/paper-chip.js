...
*/class PaperChip extends PolymerElement{static get template(){return html`
    ...
    <slot></slot>`}static get tag(){return"paper-chip"}static get properties(){return{selectable:{type:Boolean,value:!1,reflectToAttribute:!0}}}}window.customElements.define(PaperChip.tag,PaperChip);export{PaperChip};