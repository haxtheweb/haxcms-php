import{html,PolymerElement}from"../../../../@polymer/polymer/polymer-element.js";import{dom}from"../../../../@polymer/polymer/lib/legacy/polymer.dom.js";import"../../../../@polymer/iron-ajax/iron-ajax.js";import"../../../../@polymer/iron-list/iron-list.js";import"../../../../@polymer/paper-button/paper-button.js";import"../../../elmsln-loading/elmsln-loading.js";import"../../../lrndesign-gallerycard/lrndesign-gallerycard.js";class LrnappBlockNeedFeedback extends PolymerElement{static get template(){return html`
    ...
    </iron-list>`}static get tag(){return"lrnapp-block-need-feedback"}static get properties(){return{sourcePath:{type:String,notify:!0},response:{type:Array,notify:!0}}}/**
...
window.location.href=this.basePath+"lrnapp-studio-submission/submissions/"+active}handleResponse(e){this.$.loading.hidden=!0}_toArray(obj){return Object.keys(obj).map(function(key){return obj[key]})}}window.customElements.define(LrnappBlockNeedFeedback.tag,LrnappBlockNeedFeedback);export{LrnappBlockNeedFeedback};