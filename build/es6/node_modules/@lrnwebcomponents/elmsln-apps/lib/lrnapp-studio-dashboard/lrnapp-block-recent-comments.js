import{html,PolymerElement}from"../../../../@polymer/polymer/polymer-element.js";import"../../../../@polymer/iron-ajax/iron-ajax.js";import"../../../../@polymer/paper-item/paper-item.js";import"../../../../@polymer/polymer/lib/elements/dom-repeat.js";import"../../../elmsln-loading/elmsln-loading.js";import"./lrnapp-block-recent-comments-comment.js";class LrnappBlockRecentComments extends PolymerElement{static get template(){return html`
    ...
    </template>`}static get tag(){return"lrnapp-block-recent-comments"}static get properties(){return{sourcePath:{type:String,notify:!0},response:{type:Array,notify:!0}}}handleResponse(e){this.$.loading.hidden=!0}_getViewLink(nid){return this.basePath+"lrnapp-studio-submission/submissions/"+nid}_toArray(obj){return Object.keys(obj).map(function(key){return obj[key]})}}window.customElements.define(LrnappBlockRecentComments.tag,LrnappBlockRecentComments);export{LrnappBlockRecentComments};