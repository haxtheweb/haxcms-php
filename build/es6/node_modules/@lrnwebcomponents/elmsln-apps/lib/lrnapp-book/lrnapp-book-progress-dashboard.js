...
this.userData=response.userdata;this.dashboardItems=this._toArray(response.items)}/**
   ...
   */_toArray(obj){return Object.keys(obj).map(function(key){return obj[key]})}}window.customElements.define(LrnappBookProgressDashboard.tag,LrnappBookProgressDashboard);export{LrnappBookProgressDashboard};