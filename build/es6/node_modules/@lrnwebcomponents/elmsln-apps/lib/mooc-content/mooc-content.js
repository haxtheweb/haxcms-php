 ...
 */Polymer({_template:html`
    ...
    </main>`,is:"mooc-content",observers:["_routeChanged(data, route, endPoint)"],properties:{/**
     * Source of data
   ...
   */_modalTap:function _modalTap(e){var normalizedEvent=dom(e),local=normalizedEvent.localTarget;// verify that it is a buttonß
if("LRNSYS-BUTTON"===local.tagName){if(null!=this.activeNodeItem){this.activeNodeItem.classList.remove("book-menu-item-active")}this.activeNodeItem=local;this.activeNodeItem.classList.add("book-menu-item-active");this.$.outlinepopover.toggleDialog()}},/**
   ...
   */_contentLoading:function _contentLoading(newValue,oldValue){var _this=this;if(("undefined"===typeof newValue?"undefined":typeof newValue)!==("undefined"===typeof void 0?"undefined":typeof void 0)&&!newValue){setTimeout(function(){_this.loading=!1;_this._resetScroll("anchor");_this.$["main-content"].focus()},500)}else{this.loading=!0}},/**
...
if(typeof this.outlineData.data===("undefined"===typeof void 0?"undefined":typeof void 0)){this.$.fulloutlinepath.generateRequest()}async.microTask.run(()=>{window.dispatchEvent(new Event("resize"))})}}},/**
   * Callback to push the data into the page.
...
if(null!=this.shadowRoot.querySelector("#hackycsspotterhates")){dom(this.$.hackycontainer).innerHTML=""}// construct a new style tag and inject it overtop of what was there previously
