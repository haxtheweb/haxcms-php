  ...
  _scopeChanged(newValue, oldValue) {
    ...
    if (newValue === "sibling" && dom(this).previousElementSibling !== null) {
      ...
      if (dom(this).previousElementSibling.getAttribute("resource")) {
        this.relatedResource = dom(this).previousElementSibling.getAttribute("resource");
      } else {
      ...
      dom(this).previousElementSibling.setAttribute("prefix", this.getAttribute("prefix"));
