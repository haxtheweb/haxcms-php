import{html,PolymerElement}from"../../../@polymer/polymer/polymer-element.js";import{A11yMediaPlayerBehaviors}from"./a11y-media-player-behaviors.js";export{A11yMediaHtml5};class A11yMediaHtml5 extends A11yMediaPlayerBehaviors{static get properties(){return{controls:{type:String,value:"video"},icon:{type:String,value:null},label:{type:String,value:null},disabled:{type:Boolean,value:null}}}static get tag(){return"a11y-media-html5"}static get behaviors(){return[A11yMediaBehaviors]}static get template(){return html`
      <style>
        :host {
          height: 100%;
          display: flex;
