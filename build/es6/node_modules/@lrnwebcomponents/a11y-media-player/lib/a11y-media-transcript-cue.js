import{html,PolymerElement}from"../../../@polymer/polymer/polymer-element.js";import{A11yMediaBehaviors}from"./a11y-media-behaviors.js";import"../../../@polymer/iron-a11y-keys/iron-a11y-keys.js";import"../../simple-search/lib/simple-search-content.js";export{A11yMediaTranscriptCue};class A11yMediaTranscriptCue extends A11yMediaBehaviors{static get properties(){return{active:{type:Boolean,reflectToAttribute:!0,computed:"_getActiveCue(cue,activeCues)",notify:!0,reflectToAttribute:!0},activeCues:{type:Array,value:null,notify:!0},cue:{type:Array,value:null},disabled:{type:Boolean,value:!1},text:{type:String,value:""}}}static get tag(){return"a11y-media-transcript-cue"}static get behaviors(){return[A11yMediaBehaviors]}static get template(){return html`
    ...
    `}connectedCallback(){super.connectedCallback()}ready(){super.ready();let root=this,search=root.search;if(!root.disabled){root.__target=this;root.setAttribute("aria-role","button");root.setAttribute("controls",this.mediaId)}if(!root.disableSearch&&root.search!==void 0&&null!==root.search){root.$.content.enableSearch(search)}root.addEventListener("click",root._handleTap)}_getActiveCue(cue,activeCues){return null!==activeCues&&activeCues.includes(cue.order.toString())?!0:!1}_handleTap(){let root=this;this.dispatchEvent(new CustomEvent("cue-seek",{detail:root.cue.seek}))}}window.customElements.define(A11yMediaTranscriptCue.tag,A11yMediaTranscriptCue);