...
class SimpleColorsStyles extends PolymerElement {
  ...
  addCssVariables() {
    ...
    this.__sheet.insertRule(this.makeRule("html", this.addColorShades("default", "accent", greys, false) + this.addThemeVariables("default", false)), this.__sheet.cssRules.length);

    this.__sheet.insertRule(this.makeRule("html", this.addColorShades("fixed", "accent", greys, false) + this.addThemeVariables("fixed", false)), this.__sheet.cssRules.length);

    this.__sheet.insertRule(this.makeRule("[dark]", this.addColorShades("default", "accent", greys, true) + this.addThemeVariables("default", true)), this.__sheet.cssRules.length);
  }
  /**
  ...
  addAccentVariables() {
    for (let color in this.colors) {
      this.__sheet.insertRule(this.makeRule('[accent-color="' + color + '"]', [this.addColorShades("default", "accent", this.colors[color], false), this.addColorShades("fixed", "accent", this.colors[color], false)].join("")), this.__sheet.cssRules.length);

      this.__sheet.insertRule(this.makeRule('[dark][accent-color="' + color + '"]', [this.addColorShades("default", "accent", this.colors[color], true)].join("")), this.__sheet.cssRules.length);
    }
  }
