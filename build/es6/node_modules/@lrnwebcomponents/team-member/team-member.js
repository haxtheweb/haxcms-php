import{html as e,PolymerElement as i}from"../../@polymer/polymer/polymer-element.js";import{SchemaBehaviors as t}from"../schema-behaviors/schema-behaviors.js";import"../simple-icon/simple-icon.js";import"../hax-iconset/lib/simple-hax-iconset.js";class TeamMember extends(t(i)){static get template(){return e`
    ...
    `}static get tag(){return"team-member"}static get haxProperties(){return{canScale:!0,canPosition:!0,canEditSource:!0,gizmo:{title:"Team Member",description:"The user will be able to see this for selection in a UI.",icon:"av:play-circle-filled",color:"grey",tags:["other","Content","Presentation"],handles:[],meta:{author:"HAXTheWeb core team"}},settings:{configure:[{property:"title",title:"Title",description:"The title of the element",inputMethod:"textfield",icon:"editor:title"}],advanced:[]}}}static get properties(){return{...super.properties,image:{type:String},fullName:{type:String},firstLine:{type:String,value:!1},secondLine:{type:String,value:!1},dribble:{type:String,value:!1},facebook:{type:String,value:!1},github:{type:String,value:!1},google:{type:String,value:!1},instagram:{type:String,value:!1},linkedin:{type:String,value:!1},pinterest:{type:String,value:!1},tumblr:{type:String,value:!1},twitch:{type:String,value:!1},twitter:{type:String,value:!1},whatsapp:{type:String,value:!1}}}}customElements.define(TeamMember.tag,TeamMember);export{TeamMember};