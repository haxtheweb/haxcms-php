 ...
 */class HaxBloxBrowser extends PolymerElement{constructor(){super();import("../../../@polymer/iron-list/iron-list.js");import("./hax-blox-browser-item.js");import("./hax-icons.js")}static get template(){return html`
      <style>
        :host {
          display: block;
        }
...
if(typeof this[e.detail.property]!==typeof void 0&&null!=this[e.detail.property]&&typeof this[e.detail.property].length!==typeof void 0){this.set(e.detail.property,[])}this.set(e.detail.property,e.detail.value)}}/**
   ...
   * Reset this browser.
   */resetBrowser(){setTimeout(()=>{this.shadowRoot.querySelector("#ironlist").dispatchEvent(new CustomEvent("iron-resize",{bubbles:!0/* transition */ /* transition */,cancelable:!0,composed:!0,detail:!0}));window.dispatchEvent(new Event("resize"))},100)}}window.customElements.define(HaxBloxBrowser.tag,HaxBloxBrowser);export{HaxBloxBrowser};