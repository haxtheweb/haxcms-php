...
*/Polymer({_template:html`
   ...
   * Set haxProperties.
   */setHaxProperties:function(props){// be aggressive w/ reset
this.set("haxProperties",{});this.set("haxProperties",props)},/**
   * ce size changed.
   */_ceSizeChanged:function(newValue,oldValue){if(typeof newValue!==typeof void 0&&typeof oldValue!==typeof void 0){this.fire("hax-context-item-selected",{eventName:"hax-size-change",value:newValue})}},/**
   * HAX properties changed, update buttons available.
   */_haxPropertiesChanged:function(newValue,oldValue){if(typeof oldValue!==typeof void 0&&typeof newValue.settings!==typeof void 0){// clear current slot for the tag
...
if(typeof setting.property!==typeof void 0){item.propertyToBind=setting.property}else if(typeof setting.attribute!==typeof void 0){item.propertyToBind=setting.attribute}else{item.slotToBind=setting.slot}slot.appendChild(item)}}}});