...
*/class HAXApp extends HTMLElement{constructor(){super();this.data={};this.eventName="hax-register-app"}static get tag(){return"hax-app"}/**
   ...
   */connectedCallback(){if(typeof this.data!==typeof void 0){this.dispatchEvent(new CustomEvent(this.eventName,{bubbles:!0/* transition */ /* transition */,composed:!0,cancelable:!1,detail:this.data}))}}}window.customElements.define(HAXApp.tag,HAXApp);export{HAXApp};