import{html,PolymerElement}from"../../../@polymer/polymer/polymer-element.js";import{afterNextRender}from"../../../@polymer/polymer/lib/utils/render-status.js";import{SimpleColors}from"../../simple-colors/simple-colors.js";import"../../../@polymer/paper-button/paper-button.js";import"./hax-shared-styles.js";/**
...
*/class HaxGizmoBrowserItem extends PolymerElement{constructor(){super();import("../../../@polymer/iron-icons/iron-icons.js");import("../../../@polymer/iron-icons/editor-icons.js");import("../../../@polymer/iron-icons/device-icons.js");import("../../../@polymer/iron-icons/hardware-icons.js");import("../../../@polymer/iron-icons/communication-icons.js");import("../../../@polymer/iron-icons/social-icons.js");import("../../../@polymer/iron-icons/av-icons.js");import("../../../@polymer/iron-icons/maps-icons.js");import("../../../@polymer/iron-icons/places-icons.js");import("../../../@polymer/iron-image/iron-image.js")}static get template(){return html`
    ...
    `}static get tag(){return"hax-gizmo-browser-item"}connectedCallback(){super.connectedCallback();afterNextRender(this,function(){this.addEventListener("mousedown",this.tapEventOn.bind(this));this.addEventListener("mouseover",this.tapEventOn.bind(this));this.addEventListener("mouseout",this.tapEventOff.bind(this));this.addEventListener("focusin",this.tapEventOn.bind(this));this.addEventListener("focusout",this.tapEventOff.bind(this))})}disconnectedCallback(){this.removeEventListener("mousedown",this.tapEventOn.bind(this));this.removeEventListener("mouseover",this.tapEventOn.bind(this));this.removeEventListener("mouseout",this.tapEventOff.bind(this));this.removeEventListener("focusin",this.tapEventOn.bind(this));this.removeEventListener("focusout",this.tapEventOff.bind(this));super.disconnectedCallback()}static get properties(){return{/**
       ...
       */elevation:{type:Number,value:1,reflectToAttribute:!0/* transition */ /* transition */}}}_getHexColor(color){let name=color.replace("-text",""),tmp=new SimpleColors;if(tmp.colors[name]){return tmp.colors[name][6]}return"#000000"}/**
