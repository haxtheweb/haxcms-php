...
*/Polymer({_template:html`
  ...
  `,is:"hax-gizmo-browser-item",listeners:{mousedown:"tapEventOn",mouseover:"tapEventOn",mouseout:"tapEventOff",focusin:"tapEventOn",focusout:"tapEventOff"},properties:{/**
     * Title
     */title:{type:String},/**
   ...
   */_fireEvent:function(e){var normalizedEvent=dom(e),local=normalizedEvent.localTarget;let gizmo={tag:this.tag},element=window.HaxStore.haxElementPrototype(gizmo);window.HaxStore.write("activeHaxElement",element,this)}});