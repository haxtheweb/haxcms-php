import{LitElement as t,html as e,css as i}from"../../../lit/index.js";import{winEventsElement as a,camelCaseToDash as o,wipeSlot as s,normalizeEventPath as n,localStorageSet as l}from"../../utils/utils.js";import{HaxSchematizer as r,HaxElementizer as d}from"../../hax-body-behaviors/lib/HAXFields.js";import{SimpleTourFinder as c}from"../../simple-popover/lib/SimpleTourFinder.js";import{HAXStore as h}from"./hax-store.js";import{autorun as p,toJS as u}from"../../../mobx/dist/mobx.esm.js";import{HaxComponentStyles as m,HaxTrayDetail as g}from"./hax-ui-styles.js";import"../../simple-fields/simple-fields.js";import"../../simple-fields/lib/simple-fields-tab.js";import"../../simple-icon/lib/simple-icons.js";import"../../hax-iconset/lib/simple-hax-iconset.js";import"./hax-tray-upload.js";import"./hax-app-browser.js";import"./hax-gizmo-browser.js";import"./hax-gizmo-browser.js";import"./hax-view-source.js";import"./hax-stax-browser.js";import"./hax-map.js";import"./hax-preferences-dialog.js";import"./hax-tray-button.js";import"./hax-toolbar-menu.js";import{SuperDaemonInstance as v}from"../../super-daemon/super-daemon.js";import{I18NMixin as b}from"../../i18n-manager/lib/I18NMixin.js";import{Undo as x}from"../../undo-manager/undo-manager.js";import"../../iframe-loader/lib/loading-indicator.js";import"../../simple-toolbar/lib/simple-toolbar-menu-item.js";class HaxTray extends(b(c(a(t)))){static get tag(){return"hax-tray"}constructor(){super(),this.tourName="hax",this.__winEvents={"can-redo-changed":"_redoChanged","can-undo-changed":"_undoChanged","hax-drop-focus-event":"_expandSettingsPanel"},this.t={structure:"Outline",structureTip:"View Page Structure",edit:"Edit",save:"Save",move:"Move",close:"Close",moveMenu:"Toggles Menu Aligmnent",menuAlignment:"Menu Alignment",menuLeft:"Move",menuRight:"Move",menuPosition:"Menu position",changeSideVisually:"Change which side of the screen the menu is affixed to visually.",expand:"Expand",collapse:"Collapse",menuSize:"Menu size",menuSizeDescription:"Expand or collapse the menu visually.",takeATour:"Help",superMenu:"Super menu",settings:"Settings",source:"Source",undo:"Undo",redo:"Redo",media:"Media",blocks:"Blocks",cancel:"Cancel",cancelWithoutSaving:"Cancel without saving",configure:"Configure",advanced:"Advanced",alignment:"Alignment",left:"Left",center:"Center",right:"Right",search:"Search",templates:"Templates",width:"Width"},this.registerLocalization({context:this,namespace:"hax",updateCallback:"_updateTrayDetail"}),this._initial=!0,this.activeValue={settings:{configure:{},advanced:{__position:"hax-align-left",__scale:100}}},this.collapsed=!0,this.activeTab="item-0",this.activeSchema=[],this.canUndo=!1,this.canRedo=!1,this.trayDetail="content-edit",this.activeTagName="",this.traySizeIcon="hax:arrow-expand-right",this.__setup=!1,setTimeout((()=>{this.addEventListener("hax-tray-button-click",this._processTrayEvent.bind(this))}),0),p((()=>{this.activeGizmo=u(h.activeGizmo)})),p((()=>{this.activeNode=u(h.activeNode)})),p((()=>{this.elementAlign=u(h.elementAlign)})),p((()=>{this.tourOpened=u(h.tourOpened)})),p((()=>{this.loading=!u(h.appStoreLoaded)})),p((()=>{this.globalPreferences=u(h.globalPreferences),this.haxUiTheme=(this.globalPreferences||{}).haxUiTheme||"hax",document.body.setAttribute("hax-ui-theme",this.haxUiTheme)})),p((()=>{this.editMode=u(h.editMode)}))}_expandSettingsPanel(t){this.shadowRoot.querySelector("#content-edit").click()}_redoChanged(t){this.canRedo=t.detail.value}_undoChanged(t){this.canUndo=t.detail.value}static get styles(){return[...super.styles||[],...g,...m,i`
    ...
    ></hax-map>`}get mediaTemplate(){let t="media-add"!==this.trayDetail;return e` <hax-tray-upload ?hidden="${t}"></hax-tray-upload>
      ...
      <hax-app-browser id="appbrowser" ?hidden="${t}"></hax-app-browser>`}__simpleFieldsClick(t){try{this.activeTab=this.shadowRoot.querySelector("#settingsform").shadowRoot.querySelector("simple-fields").activeTab}catch(t){this.activeTab="item-0"}}_refreshAddData(){this.shadowRoot.querySelector("#gizmobrowser").resetList(u(h.gizmoList)),this.shadowRoot.querySelector("#staxbrowser").staxList=[...u(h.staxList)]}_processTrayEvent(t){var e=n(t)[0],i=t.detail.eventName;switch(this.collapsed||this.trayDetail!==i||(i="toggle-tray-size"),i){case"insert-stax":this.dispatchEvent(new CustomEvent("hax-insert-content-array",{bubbles:!0,cancelable:!0,composed:!0,detail:e.stax}));break;case"insert-tag":let i,a={tag:t.detail.value},o=h.haxSchemaFromTag(t.detail.value);if(h.recentGizmoList.push(o.gizmo),(e.getAttribute("data-demo-schema")||t.detail.demoSchema)&&o&&o.demoSchema&&o.demoSchema[0])i=o.demoSchema[0];else{let t=JSON.parse(e.getAttribute("event-properties")),o=e.getAttribute("event-content");null==t&&(t={}),null==o&&(o=""),i=h.haxElementPrototype(a,t,o)}this.dispatchEvent(new CustomEvent("hax-insert-content",{bubbles:!0,cancelable:!0,composed:!0,detail:i}));break;case"advanced-settings":case"content-map":case"content-edit":case"content-add":case"media-add":this.trayDetail=t.detail.eventName,this.collapsed=!1;break;case"toggle-element-align":let s=["left","right"],n=s[t.detail.index]?s[t.detail.index]:"left";t.detail.index>1&&(this.collapsed=!0),this.style.setProperty("--hax-tray-custom-y",null),this.style.setProperty("--hax-tray-custom-x",null),h.elementAlign=n,l("hax-tray-elementAlign",n);break;case"toggle-tray-size":this.collapsed=!this.collapsed;break;case"super-daemon":v.opened=!v.opened;break;case"start-tour":this.startTour();break;case"stop-tour":window.SimpleTourManager.requestAvailability().stopTour("hax");break;case"undo":h.activeHaxBody.undo();break;case"redo":h.activeHaxBody.redo();break;case"view-source":this.trayDetail=t.detail.eventName,this.shadowRoot.querySelector("#view-source").openSource(),this.collapsed=!1}}startTour(){this.__tour=this.__tour||window.SimpleTourManager.requestAvailability(),window.addEventListener("tour-changed",this._handleTourChanged.bind(this)),this.__tour.startTour("hax")}stopTour(){this.__tour=this.__tour||window.SimpleTourManager.requestAvailability(),this.__tour.stopTour("hax"),window.removeEventListener("tour-changed",this._handleTourChanged.bind(this))}_handleTourChanged(t){this.tourOpened=t.detail.active==this.tourName}static get properties(){return{...super.properties,offsetMargin:{type:String,attribute:"offset-margin"},collapsed:{type:Boolean,reflect:!0},traySizeIcon:{type:String},loading:{type:Boolean,reflect:!0},activeValue:{type:Object},activeSchema:{type:Object},elementAlign:{type:String,reflect:!0,attribute:"element-align"},light:{type:Boolean,reflect:!0},canUndo:{type:Boolean,attribute:"can-undo"},canRedo:{type:Boolean,attribute:"can-redo"},haxUiTheme:{type:String},hidePreferencesButton:{type:Boolean,reflect:!0,attribute:"hide-preferences-button"},hidePanelOps:{type:Boolean,reflect:!0,attribute:"hide-panel-ops"},globalPreferences:{type:Object},activeNode:{type:Object},activeTagName:{type:String},activeGizmo:{type:Object},editMode:{type:Boolean,reflect:!0,attribute:"edit-mode"},trayDetail:{type:String,reflect:!0,attribute:"tray-detail"},trayLabel:{type:String},tourOpened:{type:String},__tour:{type:Object}}}firstUpdated(t){super.firstUpdated&&super.firstUpdated(t),this.__setup||(this.shadowRoot.querySelector("#settingsform").schematizer=r,this.shadowRoot.querySelector("#settingsform").elementizer=d,setTimeout((()=>{this.shadowRoot.querySelector(".wrapper").style.margin=this.offsetMargin}),1e3),this.__setup=!0,this.shadowRoot.querySelector("#settingsform").addEventListener("click",this.__simpleFieldsClick.bind(this)),this.shadowRoot.querySelector("#settingsform").addEventListener("value-changed",this.__valueChangedEvent.bind(this)),this.dispatchEvent(new CustomEvent("hax-register-core-piece",{bubbles:!0,cancelable:!0,composed:!0,detail:{piece:"haxTray",object:this}})),this.dispatchEvent(new CustomEvent("hax-add-voice-command",{bubbles:!0,composed:!0,cancelable:!1,detail:{command:":name: (collapse)(open)(expand)(toggle) Blocks (menu)",context:this.shadowRoot.querySelector("#content-add"),callback:"click"}})),this.dispatchEvent(new CustomEvent("hax-add-voice-command",{bubbles:!0,composed:!0,cancelable:!1,detail:{command:":name: (collapse)(open)(expand)(toggle) element settings (menu)",context:this.shadowRoot.querySelector("#advanced-settings"),callback:"click"}})),this.dispatchEvent(new CustomEvent("hax-add-voice-command",{bubbles:!0,composed:!0,cancelable:!1,detail:{command:":name: (collapse)(open)(expand)(toggle) search (menu)",context:this.shadowRoot.querySelector("#media-add"),callback:"click"}})))}async updated(t){super.updated&&super.updated(t),t.forEach((async(t,e)=>{"editMode"==e&&(this.editMode&&await h.refreshActiveNodeForm(),this._editModeChanged(this.editMode)),"offsetMargin"==e&&setTimeout((()=>{this.shadowRoot.querySelector(".wrapper").style.margin=this.offsetMargin}),0),"trayDetail"==e&&this._updateTrayDetail(this[e]),"collapsed"==e&&this[e]&&this._editModeChanged(this.editMode),"activeGizmo"==e&&"view-source"!==this.trayDetail&&(this.activeGizmo?(this.activeTagName=this.activeGizmo.title,t&&["content-map","content-edit","content-add"].includes(this.trayDetail)||(this.trayDetail="content-edit")):["content-add","content-map"].includes(this.trayDetail)||(this.trayDetail="content-add")),"activeNode"==e&&this.activeNode&&this.activeNode.tagName&&this.editMode&&await h.refreshActiveNodeForm()}))}async _setupForm(){this.loading=!0;let t=this.activeNode;if(this._initial=!0,this.activeValue={settings:{configure:{},advanced:{__position:"hax-align-left",__scale:100}}},this.shadowRoot.querySelector("#settingsform").fields=[],this.shadowRoot.querySelector("#settingsform").value={},t&&t.tagName&&h.elementList[t.tagName.toLowerCase()]){let e={...h.elementList[t.tagName.toLowerCase()]};void 0===e.gizmo.title?this.humanName=t.tagName.replace("-"," ").toLowerCase():this.humanName=e.gizmo.title;for(let t in this.activeHaxElement.properties)e.settings.configure.forEach((e=>{e.property===t&&(this.activeValue.settings.configure[t]=this.activeHaxElement.properties[t]),e.attribute===t&&(this.activeValue.settings.configure[t]=this.activeHaxElement.properties[t]),e.slot===t&&(this.activeValue.settings.configure[t]=this.activeHaxElement.properties[t])})),e.settings.advanced.forEach((e=>{e.property===t&&(this.activeValue.settings.advanced[t]=this.activeHaxElement.properties[t]),e.attribute===t&&(this.activeValue.settings.advanced[t]=this.activeHaxElement.properties[t]),e.slot===t&&(this.activeValue.settings.advanced[t]=this.activeHaxElement.properties[t])}));let i=document.createElement("div");i.innerHTML=this.activeHaxElement.content,i.childNodes.forEach((t=>{1===t.nodeType&&"undefined"!==t.innerHTML&&(e.settings.configure.forEach((e=>{e.slot===t.getAttribute("slot")?this.activeValue.settings.configure[e.slot]=t.innerHTML:""!=e.slot||null!=t.getAttribute("slot")&&"null"!=t.getAttribute("slot")||(this.activeValue.settings.configure[e.slot]=t.innerHTML)})),e.settings.advanced.forEach((e=>{e.slot===t.getAttribute("slot")?this.activeValue.settings.advanced[e.slot]=t.innerHTML:""!=e.slot||null!=t.getAttribute("slot")&&"null"!=t.getAttribute("slot")||(this.activeValue.settings.advanced[e.slot]=t.innerHTML)})))})),""!=t.style.width?this.activeValue.settings.advanced.__scale=t.style.width.replace("%",""):this.activeValue.settings.advanced.__scale=100,"block"==t.style.display&&"0px auto"==t.style.margin&&"right"==t.style.float?this.activeValue.settings.advanced.__position="hax-align-right":"block"==t.style.display&&"0px auto"==t.style.margin?this.activeValue.settings.advanced.__position="hax-align-center":this.activeValue.settings.advanced.__position="hax-align-left",this.activeHaxElement.properties.__scale=this.activeValue.settings.advanced.__scale,this.activeHaxElement.properties.__position=this.activeValue.settings.advanced.__position;let a=!!e.type&&"grid"===e.type;e.settings.configure.forEach(((t,i)=>{e.settings.configure[i].attribute&&(e.settings.configure[i].property=e.settings.configure[i].attribute),e.settings.configure[i].slot&&(e.settings.configure[i].property=e.settings.configure[i].slot)})),e.settings.advanced.forEach(((t,i)=>{e.settings.advanced[i].attribute&&(e.settings.advanced[i].property=e.settings.advanced[i].attribute),e.settings.advanced[i].slot&&(e.settings.advanced[i].property=e.settings.advanced[i].slot)})),e.canPosition&&e.settings.advanced.unshift({property:"__position",title:this.t.alignment,inputMethod:"select",value:this.activeValue.settings.advanced.__position,options:{"hax-align-left":this.t.left,"hax-align-center":this.t.center,"hax-align-right":this.t.right}}),e.canScale&&e.settings.advanced.unshift({property:"__scale",title:this.t.width,inputMethod:"slider",value:this.activeValue.settings.advanced.__scale,min:e.canScale.min?e.canScale.min:12.5,max:e.canScale.max?e.canScale.max:100,step:e.canScale.step?e.canScale.step:12.5}),this.activeSchema=[{property:"settings",inputMethod:"tabs",properties:[]}];let setProps=(t,e,i=[])=>{let o=a?i.filter((t=>!(""===t.slot||t.slot||t.attribute&&"slot"==t.attribute))):i;this.activeSchema[0].properties.push({property:t,title:e,properties:o.length>0?o:void 0,disabled:o.length<1})};h.testHook(t,"setupActiveElementForm")&&await h.runHook(t,"setupActiveElementForm",[e]),setProps("configure",this.t.configure,e.settings.configure),setProps("advanced",this.t.advanced,e.settings.advanced),this.__activePropSchema=e,this.shadowRoot.querySelector("#settingsform").fields=this.activeSchema,this.shadowRoot.querySelector("#settingsform").value=this.activeValue,this.loading=!1}}_toArray(t){return null==t?[]:Object.keys(t).map((function(e){return t[e]}))}updateMap(){this.shadowRoot&&this.shadowRoot.querySelector("hax-map")&&"content-map"==this.trayDetail&&this.shadowRoot.querySelector("hax-map").updateHAXMap()}_updateTrayDetail(t){t&&this.shadowRoot&&this.shadowRoot.querySelector(".detail")&&(this.shadowRoot.querySelector(".detail").style.width="",this.shadowRoot.querySelector(".detail").style.height=""),"content-add"==t?(this.trayLabel=this.t.blocks,this._refreshAddData()):"media-add"==t?this.trayLabel=this.t.media:"content-map"==t?(this.trayLabel=this.t.structure,this.shadowRoot.querySelector("hax-map").updateHAXMap()):"advanced-settings"==t?(this.trayLabel=this.t.settings,this.shadowRoot.querySelector("hax-preferences-dialog").reloadPreferencesForm()):"content-edit"!=t||this.activeTagName&&""!=this.activeTagName&&this.activeNode&&this.activeNode.tagName?t&&""!=t?this.trayLabel=void 0:this.trayDetail="content-edit":this.trayDetail="content-add",this.requestUpdate()}__valueChangedEvent(t){if(this.editMode&&t.detail.value&&t.detail.value.settings){let i=t.detail.value.settings,a="grid"=={...h.elementList[this.activeNode.tagName.toLowerCase()]}.type,n={advanced:"advanced",configure:"configure"};var e;clearTimeout(this.__contextPropDebounce),this.__contextPropDebounce=setTimeout((()=>{for(let l in n)for(let n in i[l])if(e=!1,null==i[l][n]||i[l][n].readOnly)"data-hax-lock"===n&&(this.dispatchEvent(new CustomEvent("hax-toggle-active-node-lock",{bubbles:!0,composed:!0,cancelable:!0,detail:{lock:!1,node:this.activeNode}})),this.__lockAllSettings(!1)),this.activeNode.removeAttribute(o(n));else{if("prefix"===n&&""!=i[l][n])this.activeNode.setAttribute("prefix",i[l][n]),e=!0;else if("data-hax-lock"===n)this.dispatchEvent(new CustomEvent("hax-toggle-active-node-lock",{bubbles:!0,composed:!0,cancelable:!0,detail:{lock:i[l][n],node:this.activeNode}})),this.__lockAllSettings(i[l][n]);else if("innerText"===n)this.activeNode.innerText=i[l][n],e=!0;else if("advanced"===l&&"__position"===n)e=!0,this._initial||(clearTimeout(this.__contextValueDebounce),this.__contextValueDebounce=setTimeout((()=>{this.dispatchEvent(new CustomEvent("hax-context-item-selected",{bubbles:!0,composed:!0,detail:{eventName:i[l][n],value:i[l][n]}}))}),50));else if("advanced"===l&&"__scale"===n)e=!0,this._initial||(clearTimeout(this.__contextSizeDebounce),this.__contextSizeDebounce=setTimeout((()=>{this.dispatchEvent(new CustomEvent("hax-context-item-selected",{bubbles:!0,composed:!0,detail:{eventName:"hax-size-change",value:i[l][n]}}))}),50));else if(this.activeNode.hasOwnProperty(n)||this.activeNode.properties&&this.activeNode.properties.hasOwnProperty(n)||null!=i[l][n]&&i[l][n].constructor===Array||null!=i[l][n]&&i[l][n].constructor===Object)try{i[l][n].constructor===Array?this.activeNode[n]=[...i[l][n]]:i[l][n].constructor===Object?this.activeNode[n]={...i[l][n]}:this.activeNode[n]=i[l][n],e=!0}catch(t){console.warn(t),e=!1}else if(!a)for(let a in this.__activePropSchema.settings[l])if(this.__activePropSchema.settings[l][a].slot==n){let o="span";if(this.__activePropSchema.settings[l][a].slotWrapper)o=this.__activePropSchema.settings[l][a].slotWrapper;else if(this.__activePropSchema.settings[l][a].allowedSlotWrappers&&this.__activePropSchema.settings[l][a].allowedSlotWrappers[0])o=this.__activePropSchema.settings[l][a].allowedSlotWrappers[0];else if("code-editor"===this.activeNode.tagName.toLowerCase())o="template";else{let t=["span","div","p"],e=this.__activePropSchema.settings[l][a].excludedSlotWrappers||[];e&&(t=t.filter((t=>!e.includes(t))))}var t=document.createElement(o);if(this.__activePropSchema.settings[l][a].slotAttributes)for(let e in this.__activePropSchema.settings[l][a].slotAttributes)t.setAttribute(e,this.__activePropSchema.settings[l][a].slotAttributes[e]);""!==this.__activePropSchema.settings[l][a].slot&&(t.slot=this.__activePropSchema.settings[l][a].slot),t.innerHTML=i[l][n];const r=t.cloneNode(!0);e=!0,h.isTextElement(this.activeNode)?this.activeNode.innerHTML=t.innerHTML:(s(this.activeNode,this.__activePropSchema.settings[l][a].slot),this.activeNode.appendChild(r))}if(!e&&""!=o(n))try{!0===i[l][n]?this.activeNode.setAttribute(o(n),o(n)):!1===i[l][n]||""===i[l][n]?this.activeNode.removeAttribute(o(n)):this.activeNode.setAttribute(o(n),i[l][n])}catch(t){console.warn(t),console.warn(n,i[l][n])}}}),100)}setTimeout((()=>{this._initial&&(this._initial=!1)}),51)}__lockAllSettings(t){this.shadowRoot.querySelectorAll("simple-fields-tab *[is-simple-field-type]:not([name='settings.advanced.data-hax-lock'])").forEach((e=>{e.disabled=t}))}_editModeChanged(t){!this.hidePanelOps&&this.shadowRoot&&this.shadowRoot.querySelector("#button")&&(this.shadowRoot.querySelector("#button").icon=t?"save":"create")}_clickEditButton(t){h.editMode=!0,window.dispatchEvent(new CustomEvent("simple-modal-hide",{bubbles:!0,cancelable:!0,detail:{}}))}_clickSaveButton(t){h.editMode=!1,this.dispatchEvent(new CustomEvent("hax-save",{bubbles:!0,cancelable:!0,composed:!0,detail:t.detail})),window.dispatchEvent(new CustomEvent("simple-modal-hide",{bubbles:!0,cancelable:!0,detail:{}}))}}customElements.define(HaxTray.tag,HaxTray);export{HaxTray};