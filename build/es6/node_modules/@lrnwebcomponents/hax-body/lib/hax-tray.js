import{LitElement as e,html as t,css as i}from"../../../lit/index.js";import{winEventsElement as a,camelCaseToDash as o,wipeSlot as s,normalizeEventPath as n,localStorageSet as l}from"../../utils/utils.js";import{HaxSchematizer as r,HaxElementizer as d}from"../../hax-body-behaviors/lib/HAXFields.js";import{SimpleTourFinder as h}from"../../simple-popover/lib/SimpleTourFinder.js";import{HAXStore as c}from"./hax-store.js";import{autorun as p,toJS as u}from"../../../mobx/dist/mobx.esm.js";import{HaxComponentStyles as m,HaxTrayDetail as g}from"./hax-ui-styles.js";import"../../simple-fields/simple-fields.js";import"../../simple-fields/lib/simple-fields-tab.js";import"../../simple-icon/lib/simple-icons.js";import"../../hax-iconset/lib/simple-hax-iconset.js";import"./hax-tray-upload.js";import"./hax-app-search.js";import"./hax-gizmo-browser.js";import"./hax-gizmo-browser.js";import"./hax-view-source.js";import"./hax-stax-browser.js";import"./hax-map.js";import"./hax-tray-button.js";import"./hax-toolbar-menu.js";import{SuperDaemonInstance as v}from"../../super-daemon/super-daemon.js";import{I18NMixin as b}from"../../i18n-manager/lib/I18NMixin.js";import{Undo as x}from"../../undo-manager/undo-manager.js";import"../../iframe-loader/lib/loading-indicator.js";import"../../simple-toolbar/lib/simple-toolbar-menu-item.js";class HaxTray extends(b(h(a(e)))){static get tag(){return"hax-tray"}constructor(){super(),this.tourController=new AbortController,this.dragController=new AbortController,this.tourName="hax",this.__winEvents={"can-redo-changed":"_redoChanged","can-undo-changed":"_undoChanged","hax-drop-focus-event":"_expandSettingsPanel"},this.resizeDrag=!1,this.__moveX=0,this.t={structure:"Outline",structureTip:"View Page Structure",edit:"Edit",properties:"Properties",save:"Save",move:"Move",close:"Close",moveMenu:"Toggles Menu Aligmnent",menuAlignment:"Menu Alignment",menuLeft:"Move",menuRight:"Move",menuPosition:"Menu position",changeSideVisually:"Change which side of the screen the menu is affixed to visually.",expand:"Expand",collapse:"Collapse",menuSize:"Menu size",menuSizeDescription:"Expand or collapse the menu visually.",merlin:"Merlin",summonMerlin:"Summon Merlin",settings:"Settings",source:"Source",undo:"Undo",redo:"Redo",media:"Media",blocks:"Blocks",cancel:"Cancel",cancelWithoutSaving:"Cancel without saving",configure:"Configure",advanced:"Advanced",developer:"Developer",alignment:"Alignment",left:"Left",center:"Center",right:"Right",search:"Search",templates:"Templates",width:"Width"},this.registerLocalization({context:this,namespace:"hax",updateCallback:"_updateTrayDetail"}),this._initial=!0,this.activeValue={settings:{configure:{},advanced:{__position:"hax-align-left",__scale:100},developer:{}}},this.collapsed=!0,this.activeSchema=[{property:"settings",inputMethod:"collapse",properties:[]}],this.canUndo=!1,this.canRedo=!1,this.trayDetail="content-edit",this.activeTagName="",this.traySizeIcon="hax:arrow-expand-right",this.__setup=!1,this.addEventListener("hax-tray-button-click",this._processTrayEvent.bind(this)),p((()=>{this.activeGizmo=u(c.activeGizmo)})),p((()=>{this.activeNode=u(c.activeNode)})),p((()=>{this.elementAlign=u(c.elementAlign)})),p((()=>{this.tourOpened=u(c.tourOpened)})),p((()=>{this.loading=!u(c.appStoreLoaded)})),p((()=>{this.globalPreferences=u(c.globalPreferences),this.haxUiTheme=(this.globalPreferences||{}).haxUiTheme||"hax",document.body.setAttribute("hax-ui-theme",this.haxUiTheme)})),p((()=>{this.editMode=u(c.editMode)}))}_expandSettingsPanel(e){this.shadowRoot.querySelector("#content-edit").click()}_redoChanged(e){this.canRedo=e.detail.value}_undoChanged(e){this.canUndo=e.detail.value}static get styles(){return[...super.styles||[],...g,...m,i`
      ...
      `]}get trayStatus(){let e=this.collapsed?"collapsed":"view-source"==this.trayDetail?"full-panel":"side-panel";return c.trayStatus=e,c.trayDetail=this.trayDetail,e}render(){return t`
    ...
    `}get saveButtons(){return this.hidePanelOps?"":t`
      ...
      </hax-tray-button>`}_clickMediaButton(e){console.log(v.context),v.runProgram("/",{},null,null,"","sources"),v.open()}get moreButtons(){return t`<hax-tray-button
        id="exportbtn"
        icon="hax:html-code"
        label="${this.t.source}"
    ...
    ></hax-map>`}_refreshAddData(){this.shadowRoot.querySelector("#gizmobrowser").resetList(u(c.gizmoList)),this.shadowRoot.querySelector("#staxbrowser").staxList=[...u(c.staxList)]}_processTrayEvent(e){var t=n(e)[0],i=e.detail.eventName;switch("HAX-TRAY-BUTTON"==t.tagName&&e.detail.eventName===this.trayDetail?this.collapsed=!this.collapsed:this.collapsed=!1,i){case"insert-stax":this.dispatchEvent(new CustomEvent("hax-insert-content-array",{bubbles:!0,cancelable:!0,composed:!0,detail:t.stax}));break;case"insert-tag":let i,a={tag:e.detail.value},o=c.haxSchemaFromTag(e.detail.value);if(c.recentGizmoList.push(o.gizmo),(t.getAttribute("data-demo-schema")||e.detail.demoSchema)&&o&&o.demoSchema&&o.demoSchema[0])i=o.demoSchema[0];else{let o=JSON.parse(t.getAttribute("event-properties")),s=t.getAttribute("event-content");e.detail.properties&&(o=e.detail.properties),null==o&&(o={}),null==s&&(s=""),i=c.haxElementPrototype(a,o,s)}this.dispatchEvent(new CustomEvent("hax-insert-content",{bubbles:!0,cancelable:!0,composed:!0,detail:i}));break;case"toggle-element-align":let s=["left","right"],n=s[e.detail.index]?s[e.detail.index]:"left";this.style.setProperty("--hax-tray-custom-y",null),this.style.setProperty("--hax-tray-custom-x",null),c.elementAlign=n,l("hax-tray-elementAlign",n);break;case"super-daemon":v.open(),this.collapsed=!1;break;case"content-map":case"content-edit":case"content-add":this.trayDetail=e.detail.eventName;break;case"start-tour":this.startTour();break;case"stop-tour":window.SimpleTourManager.requestAvailability().stopTour("hax");break;case"undo":c.activeHaxBody.undo();break;case"redo":c.activeHaxBody.redo();break;case"view-source":this.trayDetail=e.detail.eventName,this.shadowRoot.querySelector("#view-source").openSource(),this.collapsed=!1}}startTour(){this.__tour=this.__tour||window.SimpleTourManager.requestAvailability(),this.tourController=new AbortController,window.addEventListener("tour-changed",this._handleTourChanged.bind(this),{signal:this.tourController.signal}),this.__tour.startTour("hax")}stopTour(){this.__tour=this.__tour||window.SimpleTourManager.requestAvailability(),this.__tour.stopTour("hax"),this.tourController.abort()}_handleTourChanged(e){this.tourOpened=e.detail.active==this.tourName}static get properties(){return{...super.properties,offsetMargin:{type:String,attribute:"offset-margin"},resizeDrag:{type:Boolean,attribute:"resize-drag",reflect:!0},collapsed:{type:Boolean,reflect:!0},traySizeIcon:{type:String},loading:{type:Boolean,reflect:!0},activeValue:{type:Object},activeSchema:{type:Array},elementAlign:{type:String,reflect:!0,attribute:"element-align"},light:{type:Boolean,reflect:!0},canUndo:{type:Boolean,attribute:"can-undo"},canRedo:{type:Boolean,attribute:"can-redo"},haxUiTheme:{type:String},hidePanelOps:{type:Boolean,reflect:!0,attribute:"hide-panel-ops"},globalPreferences:{type:Object},activeNode:{type:Object},activeTagName:{type:String},activeGizmo:{type:Object},editMode:{type:Boolean,reflect:!0,attribute:"edit-mode"},trayDetail:{type:String,reflect:!0,attribute:"tray-detail"},trayLabel:{type:String},tourOpened:{type:String},__tour:{type:Object}}}firstUpdated(e){super.firstUpdated&&super.firstUpdated(e),this.__setup||(this.shadowRoot.querySelector("#settingsform").schematizer=r,this.shadowRoot.querySelector("#settingsform").elementizer=d,setTimeout((()=>{this.shadowRoot.querySelector(".wrapper").style.margin=this.offsetMargin}),1e3),this.__setup=!0,this.shadowRoot.querySelector("#settingsform").addEventListener("value-changed",this.__valueChangedEvent.bind(this)),this.dispatchEvent(new CustomEvent("hax-register-core-piece",{bubbles:!0,cancelable:!0,composed:!0,detail:{piece:"haxTray",object:this}})),this.dispatchEvent(new CustomEvent("hax-add-voice-command",{bubbles:!0,composed:!0,cancelable:!1,detail:{command:":name: (collapse)(open)(expand)(toggle) Blocks (menu)",context:this.shadowRoot.querySelector("#content-add"),callback:"click"}})))}async updated(e){super.updated&&super.updated(e),e.forEach((async(e,t)=>{"editMode"==t&&(this.editMode&&await c.refreshActiveNodeForm(),this._editModeChanged(this.editMode)),"offsetMargin"==t&&setTimeout((()=>{this.shadowRoot.querySelector(".wrapper").style.margin=this.offsetMargin}),0),"trayDetail"==t&&this._updateTrayDetail(this[t]),"collapsed"==t&&this[t]&&this._editModeChanged(this.editMode),"activeGizmo"==t&&"view-source"!==this.trayDetail&&(this.activeGizmo?(this.activeTagName=this.activeGizmo.title,e&&["content-map","content-edit","content-add"].includes(this.trayDetail)||(this.trayDetail="content-edit")):["content-add","content-map"].includes(this.trayDetail)||(this.trayDetail="content-add")),"activeNode"==t&&this.activeNode&&this.activeNode.tagName&&this.editMode&&await c.refreshActiveNodeForm()}))}async _setupForm(){this.loading=!0;let e=this.activeNode;if(this._initial=!0,this.activeValue={settings:{configure:{},advanced:{__position:"hax-align-left",__scale:100},developer:{}}},e&&e.tagName&&c.elementList[e.tagName.toLowerCase()]){let t={...c.elementList[e.tagName.toLowerCase()]};void 0===t.gizmo.title?this.humanName=e.tagName.replace("-"," ").toLowerCase():this.humanName=t.gizmo.title;for(let e in this.activeHaxElement.properties)t.settings.configure.forEach((t=>{t.property===e&&(this.activeValue.settings.configure[e]=this.activeHaxElement.properties[e]),t.attribute===e&&(this.activeValue.settings.configure[e]=this.activeHaxElement.properties[e]),t.slot===e&&(this.activeValue.settings.configure[e]=this.activeHaxElement.properties[e])})),t.settings.advanced.forEach((t=>{t.property===e&&(this.activeValue.settings.advanced[e]=this.activeHaxElement.properties[e]),t.attribute===e&&(this.activeValue.settings.advanced[e]=this.activeHaxElement.properties[e]),t.slot===e&&(this.activeValue.settings.advanced[e]=this.activeHaxElement.properties[e])})),t.settings.developer.forEach((t=>{t.property===e&&(this.activeValue.settings.developer[e]=this.activeHaxElement.properties[e]),t.attribute===e&&(this.activeValue.settings.developer[e]=this.activeHaxElement.properties[e]),t.slot===e&&(this.activeValue.settings.developer[e]=this.activeHaxElement.properties[e])}));let i=document.createElement("div");i.innerHTML=this.activeHaxElement.content,i.childNodes.forEach((e=>{1===e.nodeType&&"undefined"!==e.innerHTML&&(t.settings.configure.forEach((t=>{t.slot===e.getAttribute("slot")?this.activeValue.settings.configure[t.slot]=e.innerHTML:""!=t.slot||null!=e.getAttribute("slot")&&"null"!=e.getAttribute("slot")||(this.activeValue.settings.configure[t.slot]=e.innerHTML)})),t.settings.advanced.forEach((t=>{t.slot===e.getAttribute("slot")?this.activeValue.settings.advanced[t.slot]=e.innerHTML:""!=t.slot||null!=e.getAttribute("slot")&&"null"!=e.getAttribute("slot")||(this.activeValue.settings.advanced[t.slot]=e.innerHTML)})),t.settings.developer.forEach((t=>{t.slot===e.getAttribute("slot")?this.activeValue.settings.developer[t.slot]=e.innerHTML:""!=t.slot||null!=e.getAttribute("slot")&&"null"!=e.getAttribute("slot")||(this.activeValue.settings.developer[t.slot]=e.innerHTML)})))})),""!=e.style.width?this.activeValue.settings.advanced.__scale=e.style.width.replace("%",""):this.activeValue.settings.advanced.__scale=100,"block"==e.style.display&&"0px auto"==e.style.margin&&"right"==e.style.float?this.activeValue.settings.advanced.__position="hax-align-right":"block"==e.style.display&&"0px auto"==e.style.margin?this.activeValue.settings.advanced.__position="hax-align-center":this.activeValue.settings.advanced.__position="hax-align-left",this.activeHaxElement.properties.__scale=this.activeValue.settings.advanced.__scale,this.activeHaxElement.properties.__position=this.activeValue.settings.advanced.__position;let a=!!t.type&&"grid"===t.type;t.settings.configure.forEach(((e,i)=>{t.settings.configure[i].attribute&&(t.settings.configure[i].property=t.settings.configure[i].attribute),t.settings.configure[i].slot&&(t.settings.configure[i].property=t.settings.configure[i].slot)})),t.settings.advanced.forEach(((e,i)=>{t.settings.advanced[i].attribute&&(t.settings.advanced[i].property=t.settings.advanced[i].attribute),t.settings.advanced[i].slot&&(t.settings.advanced[i].property=t.settings.advanced[i].slot)})),t.settings.developer.forEach(((e,i)=>{t.settings.developer[i].attribute&&(t.settings.developer[i].property=t.settings.developer[i].attribute),t.settings.developer[i].slot&&(t.settings.developer[i].property=t.settings.developer[i].slot)})),t.canPosition&&t.settings.advanced.unshift({property:"__position",title:this.t.alignment,inputMethod:"select",value:this.activeValue.settings.advanced.__position,options:{"hax-align-left":this.t.left,"hax-align-center":this.t.center,"hax-align-right":this.t.right}}),t.canScale&&t.settings.advanced.unshift({property:"__scale",title:this.t.width,inputMethod:"slider",value:this.activeValue.settings.advanced.__scale,min:t.canScale.min?t.canScale.min:12.5,max:t.canScale.max?t.canScale.max:100,step:t.canScale.step?t.canScale.step:12.5}),this.activeSchema=[{property:"settings",inputMethod:"collapse",properties:[]}];let setProps=(e,t,i=[])=>{let o=a?i.filter((e=>!(""===e.slot||e.slot||e.attribute&&"slot"==e.attribute))):i;this.activeSchema[0].properties.push({property:e,title:t,properties:o.length>0?o:void 0,disabled:o.length<1,expanded:"configure"===e&&(!c.isTextElement(this.activeNode)||c.isInlineElement(this.activeNode)),accordion:!0})};c.testHook(e,"setupActiveElementForm")&&await c.runHook(e,"setupActiveElementForm",[t]),setProps("configure",this.t.configure,t.settings.configure),setProps("advanced",this.t.advanced,t.settings.advanced),setProps("developer",this.t.developer,t.settings.developer),this.__activePropSchema=t,this.shadowRoot.querySelector("#settingsform").fields=[],this.shadowRoot.querySelector("#settingsform").value={},this.shadowRoot.querySelector("#settingsform").fields=this.activeSchema,this.shadowRoot.querySelector("#settingsform").value=this.activeValue,this.loading=!1}}_toArray(e){return null==e?[]:Object.keys(e).map((function(t){return e[t]}))}updateMap(){this.shadowRoot&&this.shadowRoot.querySelector("hax-map")&&"content-map"==this.trayDetail&&this.shadowRoot.querySelector("hax-map").updateHAXMap()}_updateTrayDetail(e){e&&this.shadowRoot&&this.shadowRoot.querySelector(".detail")&&(this.shadowRoot.querySelector(".detail").style.width="",this.shadowRoot.querySelector(".detail").style.height=""),"content-add"==e?(this.trayLabel=this.t.blocks,this._refreshAddData()):"content-map"==e?(this.trayLabel=this.t.structure,this.shadowRoot.querySelector("hax-map").updateHAXMap()):"content-edit"!=e||this.activeTagName&&""!=this.activeTagName&&this.activeNode&&this.activeNode.tagName?e&&""!=e?this.trayLabel=void 0:this.trayDetail="content-edit":this.trayDetail="content-add",this.requestUpdate()}__valueChangedEvent(e){if(this.editMode&&e.detail.value&&e.detail.value.settings){let i=e.detail.value.settings,a="grid"=={...c.elementList[this.activeNode.tagName.toLowerCase()]}.type,n={configure:"configure",advanced:"advanced",developer:"developer"};var t;clearTimeout(this.__contextPropDebounce),this.__contextPropDebounce=setTimeout((()=>{for(let l in n)for(let n in i[l])if(t=!1,null==i[l][n]||i[l][n].readOnly)"data-hax-lock"===n&&(this.dispatchEvent(new CustomEvent("hax-toggle-active-node-lock",{bubbles:!0,composed:!0,cancelable:!0,detail:{lock:!1,node:this.activeNode}})),this.__lockAllSettings(!1)),this.activeNode.removeAttribute(o(n));else{if("prefix"===n&&""!=i[l][n])this.activeNode.setAttribute("prefix",i[l][n]),t=!0;else if("data-hax-lock"===n)this.dispatchEvent(new CustomEvent("hax-toggle-active-node-lock",{bubbles:!0,composed:!0,cancelable:!0,detail:{lock:i[l][n],node:this.activeNode}})),this.__lockAllSettings(i[l][n]);else if("innerText"===n)this.activeNode.innerText=i[l][n],t=!0;else if("advanced"===l&&"__position"===n)t=!0,this._initial||this.dispatchEvent(new CustomEvent("hax-context-item-selected",{bubbles:!0,composed:!0,detail:{eventName:i[l][n],value:i[l][n]}}));else if("advanced"===l&&"__scale"===n)t=!0,this._initial||this.dispatchEvent(new CustomEvent("hax-context-item-selected",{bubbles:!0,composed:!0,detail:{eventName:"hax-size-change",value:i[l][n]}}));else if("advanced"===l&&"padding-top"===n||"padding-bottom"===n||"padding-left"===n||"padding-right"===n||"margin-top"===n||"margin-bottom"===n||"margin-left"===n||"margin-right"===n)this._initial||this.dispatchEvent(new CustomEvent("hax-context-item-selected",{bubbles:!0,composed:!0,detail:{eventName:"hax-style-setting-change",value:i[l]}}));else if(this.activeNode.hasOwnProperty(n)||this.activeNode.properties&&this.activeNode.properties.hasOwnProperty(n)||null!=i[l][n]&&i[l][n].constructor===Array||null!=i[l][n]&&i[l][n].constructor===Object)try{i[l][n].constructor===Array?this.activeNode[n]=[...i[l][n]]:i[l][n].constructor===Object?this.activeNode[n]={...i[l][n]}:this.activeNode[n]=i[l][n],t=!0}catch(e){console.warn(e),t=!1}else if(!a)for(let a in this.__activePropSchema.settings[l])if(this.__activePropSchema.settings[l][a].slot==n){let o="span";if(this.__activePropSchema.settings[l][a].slotWrapper)o=this.__activePropSchema.settings[l][a].slotWrapper;else if(this.__activePropSchema.settings[l][a].allowedSlotWrappers&&this.__activePropSchema.settings[l][a].allowedSlotWrappers[0])o=this.__activePropSchema.settings[l][a].allowedSlotWrappers[0];else if("code-editor"===this.activeNode.tagName.toLowerCase())o="template";else{let e=["span","div","p"],t=this.__activePropSchema.settings[l][a].excludedSlotWrappers||[];t&&(e=e.filter((e=>!t.includes(e))))}var e=document.createElement(o);if(this.__activePropSchema.settings[l][a].slotAttributes)for(let t in this.__activePropSchema.settings[l][a].slotAttributes)e.setAttribute(t,this.__activePropSchema.settings[l][a].slotAttributes[t]);""!==this.__activePropSchema.settings[l][a].slot&&(e.slot=this.__activePropSchema.settings[l][a].slot),e.innerHTML=i[l][n];const r=e.cloneNode(!0);t=!0,c.isTextElement(this.activeNode)?this.activeNode.innerHTML=e.innerHTML:(s(this.activeNode,this.__activePropSchema.settings[l][a].slot),this.activeNode.appendChild(r))}if(!t&&""!=o(n))try{!0===i[l][n]?this.activeNode.setAttribute(o(n),o(n)):!1===i[l][n]||""===i[l][n]?this.activeNode.removeAttribute(o(n)):this.activeNode.setAttribute(o(n),i[l][n])}catch(e){console.warn(e),console.warn(n,i[l][n])}}}),100)}setTimeout((()=>{this._initial&&(this._initial=!1)}),51)}__lockAllSettings(e){this.shadowRoot.querySelectorAll("simple-fields-tab *[is-simple-field-type]:not([name='settings.advanced.data-hax-lock'])").forEach((t=>{t.disabled=e}))}_editModeChanged(e){!this.hidePanelOps&&this.shadowRoot&&this.shadowRoot.querySelector("#button")&&(this.shadowRoot.querySelector("#button").icon=e?"save":"create")}_clickEditButton(e){c.editMode=!0,window.dispatchEvent(new CustomEvent("simple-modal-hide",{bubbles:!0,cancelable:!0,detail:{}}))}_clickSaveButton(e){c.editMode=!1,this.dispatchEvent(new CustomEvent("hax-save",{bubbles:!0,cancelable:!0,composed:!0,detail:e.detail})),window.dispatchEvent(new CustomEvent("simple-modal-hide",{bubbles:!0,cancelable:!0,detail:{}}))}}customElements.define(HaxTray.tag,HaxTray);export{HaxTray};