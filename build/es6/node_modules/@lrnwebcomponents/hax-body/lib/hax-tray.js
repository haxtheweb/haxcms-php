import{LitElement as t,html as e,css as a}from"../../../lit-element/lit-element.js";import{winEventsElement as i,camelCaseToDash as o,wipeSlot as s,normalizeEventPath as n}from"../../utils/utils.js";import{HaxSchematizer as r,HaxElementizer as l}from"../../hax-body-behaviors/lib/HAXFields.js";import{SimpleTourFinder as d}from"../../simple-popover/lib/SimpleTourFinder.js";import{HAXStore as c}from"./hax-store.js";import{autorun as h,toJS as p}from"../../../mobx/dist/mobx.esm.js";import{HaxComponentStyles as u,HaxTrayDetail as m}from"./hax-ui-styles.js";import"../../simple-fields/simple-fields.js";import"../../simple-icon/lib/simple-icons.js";import"../../hax-iconset/lib/simple-hax-iconset.js";import"../../simple-toolbar/simple-toolbar.js";import"../../simple-toolbar/lib/simple-button-grid.js";import"./hax-tray-upload.js";import"./hax-gizmo-browser.js";import"./hax-app-browser.js";import"./hax-stax-browser.js";import"./hax-map.js";import"./hax-preferences-dialog.js";import"./hax-toolbar.js";import"./hax-toolbar-menu.js";import{I18NMixin as g}from"../../i18n-manager/lib/I18NMixin.js";import{Undo as b}from"../../undo-manager/undo-manager.js";class HaxTray extends(g(d(i(t)))){static get tag(){return"hax-tray"}constructor(){super(),this.tourName="hax",this.__winEvents={"can-redo-changed":"_redoChanged","can-undo-changed":"_undoChanged","hax-drop-focus-event":"_expandSettingsPanel"},this.t={structure:"Structure",structureTip:"View Page Structure",editSelected:"Edit selected",edit:"Edit",save:"Save",move:"Move",moveMenu:"Move menu",menuAlignment:"Menu Alignment",topLeft:"Top Left",topRight:"Top Right",bottomLeft:"Bottom Left",bottomRight:"Bottom Right",menuPosition:"Menu position",changeSideVisually:"Change which side of the screen the menu is affixed to visually.",expand:"Expand",collapse:"Collapse",menuSize:"Menu size",menuSizeDescription:"Expand or collapse the menu visually.",takeATour:"Take a Tour",settings:"Settings",source:"Source",undo:"Undo",redo:"Redo",media:"Media",blocks:"Blocks",cancel:"Cancel",cancelWithoutSaving:"Cancel without saving",configure:"Configure",advanced:"Advanced",layout:"Layout",alignment:"Alignment",left:"Left",center:"Center",right:"Right",search:"Search",templates:"Templates",width:"Width"},this.registerLocalization({context:this,namespace:"hax",updateCallback:"_updateTrayDetail"}),this._initial=!0,this.activeValue={settings:{layout:{__position:"hax-align-left",__scale:100},configure:{},advanced:{}}},this.collapsed=!1,this.activeTab="item-0",this.activeSchema=[],this.canUndo=!1,this.canRedo=!1,this.elementAlign="right",this.trayDetail="content-edit",this.activeTagName="",this.traySizeIcon="hax:arrow-expand-right",this.__setup=!1,setTimeout(()=>{import("./hax-tray-button.js"),this.addEventListener("hax-tray-button-click",this._processTrayEvent.bind(this))},0),h(()=>{this.activeGizmo=p(c.activeGizmo)}),h(()=>{this.activeNode=p(c.activeNode)}),h(()=>{this.tourOpened=p(c.tourOpened)}),h(()=>{this.globalPreferences=p(c.globalPreferences),this.haxUiTheme=(this.globalPreferences||{}).haxUiTheme||"hax",document.body.setAttribute("hax-ui-theme",this.haxUiTheme)}),h(()=>{this.editMode=p(c.editMode)})}_expandSettingsPanel(t){this.shadowRoot.querySelector("#content-edit").click()}_redoChanged(t){this.canRedo=t.detail.value}_undoChanged(t){this.canUndo=t.detail.value}static get styles(){return[...super.styles||[],...m,...u,a`
        :host {
          display: block;
          z-index: 1000;
          position: absolute;
