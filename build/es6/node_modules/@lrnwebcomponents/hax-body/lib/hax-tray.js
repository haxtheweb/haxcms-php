import{LitElement as e,html as t,css as a}from"../../../lit-element/lit-element.js";import{winEventsElement as o,camelCaseToDash as i,wipeSlot as s,nodeToHaxElement as n,haxElementToNode as l}from"../../utils/utils.js";import"../../a11y-collapse/lib/a11y-collapse-group.js";import"../../a11y-collapse/a11y-collapse.js";import{HaxSchematizer as r,HaxElementizer as c}from"../../hax-body-behaviors/lib/HAXFields.js";import"./hax-map.js";import"./hax-preferences-dialog.js";import{SimpleTourFinder as d}from"../../simple-popover/lib/SimpleTourFinder.js";import{HAXStore as p}from"./hax-store.js";import"../../simple-popover/simple-popover.js";import{autorun as h,toJS as m}from"../../../mobx/dist/mobx.esm.js";class HaxTray extends(d(o(e))){static get tag(){return"hax-tray"}constructor(){super(),this.tourName="hax",this.__winEvents={"can-redo-changed":"_redoChanged","can-undo-changed":"_undoChanged","hax-drop-focus-event":"_expandSettingsPanel"},this.activeValue={settings:{layout:{__position:"hax-align-left",__scale:100},configure:{},advanced:{}}},this.collapsed=!1,this.activeTab="item-0",this.activeSchema=[],this.canUndo=!1,this.canRedo=!1,this.elementAlign="right",this.activeTagName="Select an element to configure",this.activeTagIcon="icons:settings",this.__setup=!1,this.__tipText="Edit content",setTimeout(()=>{import("./hax-tray-button.js"),import("../../../@polymer/iron-icon/iron-icon.js"),import("../../../@polymer/iron-icons/iron-icons.js"),import("../../../@polymer/iron-icons/editor-icons.js"),import("../../../@polymer/iron-icons/device-icons.js"),import("../../../@polymer/iron-icons/hardware-icons.js"),import("../../../@polymer/iron-icons/communication-icons.js"),import("../../../@polymer/iron-icons/social-icons.js"),import("../../../@polymer/iron-icons/image-icons.js"),import("../../../@polymer/iron-icons/av-icons.js"),import("../../../@polymer/iron-icons/maps-icons.js"),import("../../../@polymer/iron-icons/places-icons.js"),import("../../md-extra-icons/md-extra-icons.js"),import("../../hax-iconset/hax-iconset.js"),import("../../lrn-icons/lrn-icons.js"),import("./hax-tray-upload.js"),import("../../simple-fields/simple-fields.js"),this.addEventListener("hax-tray-button-click",this._processTrayEvent.bind(this)),import("./hax-gizmo-browser.js"),import("./hax-app-browser.js"),import("./hax-blox-browser.js"),import("./hax-stax-browser.js")},0),h(()=>{this.activeGizmo=m(p.activeGizmo)}),h(()=>{this.activeNode=m(p.activeNode)}),h(()=>{this.globalPreferences=m(p.globalPreferences)}),h(()=>{this.editMode=m(p.editMode)})}_expandSettingsPanel(e){this.shadowRoot.querySelector("#settingscollapse").expand()}_redoChanged(e){this.canRedo=e.detail.value}_undoChanged(e){this.canUndo=e.detail.value}static get styles(){return[a`
        :host {
    ...
    `}__simpleFieldsClick(e){try{this.activeTab=this.shadowRoot.querySelector("#settingsform").shadowRoot.querySelector("simple-fields").activeTab}catch(e){this.activeTab="item-0"}}_refreshLists(e){this.shadowRoot.querySelector("#bloxbrowser").bloxList=[...p.bloxList],this.shadowRoot.querySelector("#staxbrowser").staxList=[...p.staxList]}_processTrayEvent(e){let t=e.detail;var a=null;switch(a=e.path&&e.path[0]?e.path[0]:e.originalTarget?e.originalTarget:e.target,t.eventName){case"insert-stax":this.shadowRoot.querySelector("#settingscollapse").expand(),this.dispatchEvent(new CustomEvent("hax-insert-content-array",{bubbles:!0,cancelable:!0,composed:!0,detail:a.stax}));break;case"insert-blox":let e="";for(var o=0;o<a.blox.length;o++){let t=l({tag:a.blox[o].tag,content:a.blox[o].content,properties:a.blox[o].properties});e+=p.nodeToContent(t)}let i={tag:"grid-plate",properties:{layout:a.layout},content:e};this.shadowRoot.querySelector("#settingscollapse").expand(),this.dispatchEvent(new CustomEvent("hax-insert-content",{bubbles:!0,cancelable:!0,composed:!0,detail:i}));break;case"insert-tag":let s={tag:t.value},n=JSON.parse(a.getAttribute("event-properties")),r=a.getAttribute("event-content");null==n&&(n={}),null==r&&(r="");let c=p.haxElementPrototype(s,n,r);this.shadowRoot.querySelector("#settingscollapse").expand(),this.dispatchEvent(new CustomEvent("hax-insert-content",{bubbles:!0,cancelable:!0,composed:!0,detail:c}));break;case"open-preferences":this.shadowRoot.querySelector("simple-popover[for='prefbtn']").hidden=!this.shadowRoot.querySelector("simple-popover[for='prefbtn']").hidden,this.shadowRoot.querySelector("hax-preferences-dialog").reloadPreferencesForm();break;case"toggle-element-align":this.elementAlign="right"===this.elementAlign?"left":"right";break;case"toggle-tray-size":this.collapsed=!this.collapsed;break;case"open-map":this.shadowRoot.querySelector("simple-popover[for='mapbtn']").hidden=!this.shadowRoot.querySelector("simple-popover[for='mapbtn']").hidden,this.shadowRoot.querySelector("hax-map").updateHAXMap();break;case"open-export-dialog":p.write("openDrawer",p.haxExport,this);break;case"start-tour":window.SimpleTourManager.requestAvailability().startTour("hax");break;case"undo":p.activeHaxBody.undo();break;case"redo":p.activeHaxBody.redo();break;case"cancel":p.editMode=!1,this.dispatchEvent(new CustomEvent("hax-cancel",{bubbles:!0,cancelable:!0,composed:!0,detail:t}))}}static get properties(){return{...super.properties,__tipText:{type:String},menuAlignName:{type:String},offsetMargin:{type:String},collapsed:{type:Boolean,reflect:!0},traySizeIcon:{type:String},traySizeText:{type:String},activeValue:{type:Object},activeSchema:{type:Object},elementAlign:{type:String,reflect:!0,attribute:"element-align"},light:{type:Boolean,reflect:!0},canUndo:{type:Boolean,attribute:"can-undo"},canRedo:{type:Boolean,attribute:"can-redo"},hidePreferencesButton:{type:Boolean,reflect:!0,attribute:"hide-preferences-button"},hidePanelOps:{type:Boolean,reflect:!0,attribute:"hide-panel-ops"},globalPreferences:{type:Object},activeNode:{type:Object},activeTagIcon:{type:String},activeTagName:{type:String},activeGizmo:{type:Object},editMode:{type:Boolean,reflect:!0,attribute:"edit-mode"}}}firstUpdated(e){super.firstUpdated&&super.firstUpdated(e),this.__setup||(this.shadowRoot.querySelector("#settingsform").schematizer=r,this.shadowRoot.querySelector("#settingsform").elementizer=c,setTimeout(()=>{this.shadowRoot.querySelector(".wrapper").style.margin=this.offsetMargin},1e3),this.__setup=!0,this.shadowRoot.querySelector("#settingsform").addEventListener("click",this.__simpleFieldsClick.bind(this)),this.shadowRoot.querySelector("#settingsform").addEventListener("value-changed",this.__valueChangedEvent.bind(this)),this.dispatchEvent(new CustomEvent("hax-register-core-piece",{bubbles:!0,cancelable:!0,composed:!0,detail:{piece:"haxTray",object:this}})),this.dispatchEvent(new CustomEvent("hax-add-voice-command",{bubbles:!0,composed:!0,cancelable:!1,detail:{command:":name: (collapse)(open)(expand)(toggle) add content (menu)",context:this.shadowRoot.querySelector('#addcollapse div[slot="heading"]'),callback:"click"}})),this.dispatchEvent(new CustomEvent("hax-add-voice-command",{bubbles:!0,composed:!0,cancelable:!1,detail:{command:":name: (collapse)(open)(expand)(toggle) element settings (menu)",context:this.shadowRoot.querySelector('#settingscollapse div[slot="heading"]'),callback:"click"}})),this.dispatchEvent(new CustomEvent("hax-add-voice-command",{bubbles:!0,composed:!0,cancelable:!1,detail:{command:":name: (collapse)(open)(expand)(toggle) search (menu)",context:this.shadowRoot.querySelector('#searchapps div[slot="heading"]'),callback:"click"}})),this.dispatchEvent(new CustomEvent("hax-add-voice-command",{bubbles:!0,composed:!0,cancelable:!1,detail:{command:":name: (collapse)(open)(expand)(toggle) templates (menu)",context:this.shadowRoot.querySelector('#templateslayouts div[slot="heading"]'),callback:"click"}})))}updated(e){e.forEach((e,t)=>{"editMode"==t&&this._editModeChanged(this[t]),"offsetMargin"==t&&setTimeout(()=>{this.shadowRoot.querySelector(".wrapper").style.margin=this.offsetMargin},0),"collapsed"==t&&(this[t]?(this.traySizeIcon="hax:hax:arrow-expand-left",this.traySizeText="Expand",this.shadowRoot.querySelector("a11y-collapse-group").setAttribute("aria-disabled","true"),this.shadowRoot.querySelector("a11y-collapse-group").setAttribute("tabindex","-1"),this._editModeChanged(this.editMode)):(this.traySizeIcon="hax:hax:arrow-expand-right",this.traySizeText="Collapse",this.shadowRoot.querySelector("a11y-collapse-group").removeAttribute("aria-disabled"),this.shadowRoot.querySelector("a11y-collapse-group").removeAttribute("tabindex"))),"elementAlign"==t&&("left"==this[t]?this.menuAlignName="Right align menu":this.menuAlignName="Left align menu"),"activeGizmo"==t&&(this.activeGizmo?(this.activeTagName=this.activeGizmo.title+" Settings",this.activeTagIcon=this.activeGizmo.icon,e||this.shadowRoot.querySelector("#settingscollapse").expanded||this.shadowRoot.querySelector('#settingscollapse div[slot="heading"]').click()):(this.activeTagName="Select an element",this.activeTagIcon="icons:settings",this.shadowRoot.querySelector("#addcollapse").expanded||this.shadowRoot.querySelector('#addcollapse div[slot="heading"]').click())),"activeNode"==t&&(this.activeNode&&this.activeNode.tagName?(this.shadowRoot.querySelector("#settingscollapse").disabled=!1,this.refreshActiveNodeForm()):(this.activeTagName="Select an element to configure",this.activeTagIcon="icons:settings",this.shadowRoot.querySelector("#settingscollapse").disabled=!0))})}refreshActiveNodeForm(){this.activeHaxElement=n(this.activeNode,null),this._setupForm()}_setupForm(){let e=this.activeNode;if(this.activeValue={settings:{layout:{__position:"hax-align-left",__scale:100},configure:{},advanced:{}}},this.shadowRoot.querySelector("#settingsform").fields=[],this.shadowRoot.querySelector("#settingsform").value={},e.tagName&&p.elementList[e.tagName.toLowerCase()]){let a=p.elementList[e.tagName.toLowerCase()];for(var t in void 0===a.gizmo.title?this.humanName=e.tagName.replace("-"," ").toLowerCase():this.humanName=a.gizmo.title,this.activeHaxElement.properties)a.settings.configure.forEach(e=>{e.property===t&&(this.activeValue.settings.configure[t]=this.activeHaxElement.properties[t]),e.attribute===t&&(this.activeValue.settings.configure[t]=this.activeHaxElement.properties[t]),e.slot===t&&(this.activeValue.settings.configure[t]=this.activeHaxElement.properties[t])}),a.settings.advanced.forEach(e=>{e.property===t&&(this.activeValue.settings.advanced[t]=this.activeHaxElement.properties[t]),e.attribute===t&&(this.activeValue.settings.advanced[t]=this.activeHaxElement.properties[t]),e.slot===t&&(this.activeValue.settings.advanced[t]=this.activeHaxElement.properties[t])});let o=document.createElement("div");o.innerHTML=this.activeHaxElement.content,o.childNodes.forEach(e=>{1===e.nodeType&&"undefined"!==e.innerHTML&&(a.settings.configure.forEach(t=>{t.slot===e.getAttribute("slot")?this.activeValue.settings.configure[t.slot]=e.innerHTML:""!=t.slot||null!=e.getAttribute("slot")&&"null"!=e.getAttribute("slot")||(this.activeValue.settings.configure[t.slot]=e.innerHTML)}),a.settings.advanced.forEach(t=>{t.slot===e.getAttribute("slot")?this.activeValue.settings.advanced[t.slot]=e.innerHTML:""!=t.slot||null!=e.getAttribute("slot")&&"null"!=e.getAttribute("slot")||(this.activeValue.settings.advanced[t.slot]=e.innerHTML)}))}),""!=e.style.width?this.activeValue.settings.layout.__scale=e.style.width.replace("%",""):this.activeValue.settings.layout.__scale=100,"block"==e.style.display&&"0px auto"==e.style.margin&&"right"==e.style.float?this.activeValue.settings.layout.__position="hax-align-right":"block"==e.style.display&&"0px auto"==e.style.margin?this.activeValue.settings.layout.__position="hax-align-center":this.activeValue.settings.layout.__position="hax-align-left",this.activeHaxElement.properties.__scale=this.activeValue.settings.layout.__scale,this.activeHaxElement.properties.__position=this.activeValue.settings.layout.__position,a.settings.configure.forEach((e,t)=>{a.settings.configure[t].attribute&&(a.settings.configure[t].property=a.settings.configure[t].attribute),a.settings.configure[t].slot&&(a.settings.configure[t].property=a.settings.configure[t].slot)}),a.settings.advanced.forEach((e,t)=>{a.settings.advanced[t].attribute&&(a.settings.advanced[t].property=a.settings.advanced[t].attribute),a.settings.advanced[t].slot&&(a.settings.advanced[t].property=a.settings.advanced[t].slot)}),a.settings.layout=[],a.canPosition&&a.settings.layout.push({property:"__position",title:"Alignment",description:"Align content relative to other content",inputMethod:"select",value:this.activeValue.settings.layout.__position,options:{"hax-align-left":"Left","hax-align-center":"Center","hax-align-right":"Right"}}),a.canScale&&a.settings.layout.push({property:"__scale",title:"Width",description:"Scale and resize content",inputMethod:"slider",value:this.activeValue.settings.layout.__scale,min:a.canScale.min?a.canScale.min:12.5,max:a.canScale.max?a.canScale.max:100,step:a.canScale.step?a.canScale.step:12.5}),this.activeSchema=[{property:"settings",inputMethod:"tabs",properties:[]}];a.settings.configure.length>0?this.activeSchema[0].properties.push({property:"configure",title:"Configure",description:"Configure the element",properties:a.settings.configure}):this.activeSchema[0].properties.push({property:"configure",title:"Configure",description:"Configure the element",disabled:!0}),a.settings.layout.length>0?this.activeSchema[0].properties.push({property:"layout",title:"Layout",description:"Position the element relative to other items",properties:a.settings.layout}):this.activeSchema[0].properties.push({property:"layout",title:"Layout",description:"Position the element relative to other items",disabled:!0}),a.settings.advanced.length>0?this.activeSchema[0].properties.push({property:"advanced",title:"Advanced",description:"Advanced element settings",properties:a.settings.advanced}):this.activeSchema[0].properties.push({property:"advanced",title:"Advanced",description:"Advanced element settings",disabled:!0}),this.__activePropSchema=a,this.shadowRoot.querySelector("#settingsform").fields=this.activeSchema,this.shadowRoot.querySelector("#settingsform").value=this.activeValue}}_toArray(e){return null==e?[]:Object.keys(e).map((function(t){return e[t]}))}__valueChangedEvent(e){if(this.editMode&&e.detail.value&&e.detail.value.settings){let l=e.detail.value.settings,r={advanced:"advanced",configure:"configure",layout:"layout"};var t;for(let c in r)for(let r in l[c])if(t=!1,null==l[c][r]||l[c][r].readOnly)this.activeNode.removeAttribute(i(r));else{if("prefix"===r&&""!=l[c][r])this.activeNode.setAttribute("prefix",l[c][r]),t=!0;else if("layout"===c&&"__position"===r)t=!0,clearTimeout(this.__contextValueDebounce),this.__contextValueDebounce=setTimeout(()=>{this.dispatchEvent(new CustomEvent("hax-context-item-selected",{bubbles:!0,composed:!0,detail:{eventName:l[c][r],value:l[c][r]}}))},50);else if("layout"===c&&"__scale"===r)t=!0,clearTimeout(this.__contextSizeDebounce),this.__contextSizeDebounce=setTimeout(()=>{this.dispatchEvent(new CustomEvent("hax-context-item-selected",{bubbles:!0,composed:!0,detail:{eventName:"hax-size-change",value:l[c][r]}}))},50);else if(this.activeNode.hasOwnProperty(r)||this.activeNode.properties&&this.activeNode.properties.hasOwnProperty(r)||null!=l[c][r]&&l[c][r].constructor===Array||null!=l[c][r]&&l[c][r].constructor===Object)try{l[c][r].constructor===Array?this.activeNode[r]=[...l[c][r]]:l[c][r].constructor===Object?this.activeNode[r]={...l[c][r]}:this.activeNode[r]=l[c][r],t=!0}catch(e){console.warn(e),t=!1}else for(var a in this.__activePropSchema.settings[c])if(this.__activePropSchema.settings[c][a].slot==r){let e="span";this.__activePropSchema.settings[c][a].slotWrapper?e=this.__activePropSchema.settings[c][a].slotWrapper:"code-editor"===this.activeNode.tagName.toLowerCase()&&(e="template");var o=document.createElement(e);if(this.__activePropSchema.settings[c][a].slotAttributes)for(var n in this.__activePropSchema.settings[c][a].slotAttributes)o.setAttribute(n,this.__activePropSchema.settings[c][a].slotAttributes[n]);""!==this.__activePropSchema.settings[c][a].slot&&(o.slot=this.__activePropSchema.settings[c][a].slot),o.innerHTML=l[c][r];const i=o.cloneNode(!0);t=!0,p.isTextElement(this.activeNode)?this.activeNode.innerHTML=o.innerHTML:(s(this.activeNode,this.__activePropSchema.settings[c][a].slot),this.activeNode.appendChild(i))}if(!t)try{!0===l[c][r]?this.activeNode.setAttribute(i(r),i(r)):!1===l[c][r]||""===l[c][r]?this.activeNode.removeAttribute(i(r)):this.activeNode.setAttribute(i(r),l[c][r])}catch(e){console.warn(e),console.warn(r,l[c][r])}}}}_editModeChanged(e){void 0!==e&&e?(this.__tipText="Save content",this.shadowRoot.querySelector("#button").icon="save"):(this.__tipText="Edit content",this.shadowRoot.querySelector("#button").icon="create")}_clickEditButton(e){p.editMode=!0,window.dispatchEvent(new CustomEvent("simple-modal-hide",{bubbles:!0,cancelable:!0,detail:{}}))}_clickSaveButton(e){p.editMode=!1,this.dispatchEvent(new CustomEvent("hax-save",{bubbles:!0,cancelable:!0,composed:!0,detail:e.detail})),window.dispatchEvent(new CustomEvent("simple-modal-hide",{bubbles:!0,cancelable:!0,detail:{}}))}}window.customElements.define(HaxTray.tag,HaxTray);export{HaxTray};