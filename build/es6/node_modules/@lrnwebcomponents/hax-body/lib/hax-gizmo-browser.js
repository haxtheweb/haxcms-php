import{LitElement,html,css}from"../../../lit-element/lit-element.js";import"../../grafitto-filter/grafitto-filter.js";import{winEventsElement}from"../../utils/utils.js";class HaxGizmoBrowser extends(winEventsElement(LitElement)){static get styles(){return[css`
      ...
      `]}constructor(){super(),this.__winEvents={"hax-store-property-updated":"_haxStorePropertyUpdated"},this.__gizmoList=[],this.filtered=[],import("../../../@polymer/paper-input/paper-input.js")}render(){return html`
      <custom-style>
        <style>
          paper-input {
