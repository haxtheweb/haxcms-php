import{LitElement as t,html as e,css as i}from"../../../lit-element/lit-element.js";import"./hax-toolbar-item.js";import{HAXStore as n}from"./hax-store.js";class HaxContextItem extends t{constructor(){super(),this.danger=!1,this.light=!1,this.action=!1,this.large=!1,this.disabled=!1,this.more=!1,this.mini=!1,this.menu=!1,this.direction="top",this.icon="editor:text-fields",this.iconClass="",this.label="",this.eventName="button",this.inputMethod=null,this.propertyToBind=null,this.slotToBind=null,this.default=!1,this.value=""}static get styles(){return[i`
        :host {
          display: inline-flex;
        }
        :host([menu]) {
