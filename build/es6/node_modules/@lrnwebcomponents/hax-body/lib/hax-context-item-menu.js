import{html,Polymer}from"../../../@polymer/polymer/polymer-legacy.js";import{dom}from"../../../@polymer/polymer/lib/legacy/polymer.dom.js";import"../../../@polymer/paper-tooltip/paper-tooltip.js";import"../../../@polymer/paper-item/paper-item.js";import"../../../@polymer/neon-animation/neon-animation.js";import"./hax-toolbar-menu.js";import"./hax-shared-styles.js";/**
...
*/Polymer({_template:html`
  ...
  `,is:"hax-context-item-menu",properties:{/**
   ...
   */_selectedUpdated:function(newValue,oldValue){if(typeof null!==typeof newValue&&typeof oldValue!==typeof void 0&&typeof null!==typeof oldValue){let children=dom(this).children;// check for tag match since we have to filter out text nodes
...
if(!this._blockEvent&&typeof item.attributes!==typeof void 0&&typeof item.attributes.value!==typeof void 0&&typeof item.attributes.value.value!==typeof void 0){// weird but this makes the menu close when we fire up an event
