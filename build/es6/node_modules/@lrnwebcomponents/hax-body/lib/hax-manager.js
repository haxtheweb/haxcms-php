import{html,css}from"../../../lit-element/lit-element.js";import{SimpleColors}from"../../simple-colors/simple-colors.js";import"../../../@polymer/paper-styles/paper-styles.js";import"../../../@polymer/iron-pages/iron-pages.js";import"../../../@polymer/polymer/lib/elements/custom-style.js";class HaxManager extends SimpleColors{static get styles(){return[...super.styles,css`
      ...
      `]}constructor(){super(),this.opened=!1,this.editExistingNode=!1,this.addTitle="Upload media",this.activeStep=0,this.searching=!1,this.activePage=0,this.canSupportUploads=!1,this.appList=[],this.__allowUpload=!1,import("./hax-manager-deps.js")}render(){return html`
      <custom-style>
        <style>
