...
import { wipeSlot } from "./haxutils.js";
        ...
        for (var prop in props.settings[newValue]) {
          ...
          if (typeof props.settings[this.formKey][prop].slot !== typeof undefined && !slotsApplied) {
            ...
            for (var i in dom(previewNode).getEffectiveChildNodes()) {
              ...
              if (typeof dom(previewNode).getEffectiveChildNodes()[i] !== typeof undefined && dom(previewNode).getEffectiveChildNodes()[i].nodeType === 1 && dom(previewNode).getEffectiveChildNodes()[i].slot === props.settings[this.formKey][prop].slot) {
                if (typeof dom(previewNode).getEffectiveChildNodes()[i].innerHTML !== typeof undefined) {
                  schema.properties[props.settings[this.formKey][prop].slot].value = dom(previewNode).getEffectiveChildNodes()[i].innerHTML;
        ...
        for (var prop in props.settings[this.formKey]) {
          if (typeof props.settings[this.formKey][prop].slot !== typeof undefined) {
            ...
            for (var i in dom(newValue).getEffectiveChildNodes()) {
              // test for element nodes to be safe
              if (typeof dom(newValue).getEffectiveChildNodes()[i] !== typeof undefined && dom(newValue).getEffectiveChildNodes()[i].nodeType === 1 && dom(newValue).getEffectiveChildNodes()[i].slot === props.settings[this.formKey][prop].slot) {
                if (typeof dom(newValue).getEffectiveChildNodes()[i].innerHTML !== typeof undefined) {
                  schema.properties[props.settings[this.formKey][prop].slot].value = dom(newValue).getEffectiveChildNodes()[i].innerHTML;
