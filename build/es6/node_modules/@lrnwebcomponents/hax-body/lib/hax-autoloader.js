import{html,Polymer}from"../../../@polymer/polymer/polymer-legacy.js";import*as async from"../../../@polymer/polymer/lib/utils/async.js";import{FlattenedNodesObserver}from"../../../@polymer/polymer/lib/utils/flattened-nodes-observer.js";import{pathFromUrl}from"../../../@polymer/polymer/lib/utils/resolve-url.js";import"../../hax-body-behaviors/hax-body-behaviors.js";/**
`hax-autoloader`
...
*/Polymer({_template:html`
    ...
    <slot></slot>
  `,is:"hax-autoloader",behaviors:[HAXBehaviors.PropertiesBehaviors],properties:{/**
...
if(0<info.addedNodes.length){async.microTask.run(()=>{this.processNewElements(info.addedNodes)})}})},/**
   ...
   */processNewElements:function(e){// when new nodes show up in the slots then fire the needed pieces
