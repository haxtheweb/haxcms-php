import{LitElement,html,css}from"../../../lit-element/lit-element.js";import"../../../@polymer/paper-button/paper-button.js";import"../../../@polymer/paper-tooltip/paper-tooltip.js";import"../../../@polymer/iron-icon/iron-icon.js";import"../../../@polymer/polymer/lib/elements/custom-style.js";class HAXPanelItem extends LitElement{constructor(){super(),this.disabled=!1,this.edged="",this.icon="editor:text-fields",this.label="editor:text-fields",this.eventName="button",this.value=""}static get properties(){return{light:{type:Boolean,reflect:!0},voiceCommand:{type:String,attribute:"voice-command"},disabled:{type:Boolean},edged:{type:String,reflect:!0},icon:{type:String,reflect:!0},label:{type:String,reflect:!0},eventName:{type:String,reflect:!0,attribute:"event-name"},value:{type:String,reflect:!0}}}static get tag(){return"hax-panel-item"}static get styles(){return[css`
        :host {
          display: inline-flex;
        }
        paper-button {
