import{html,css}from"../../../lit-element/lit-element.js";import{SimpleColors}from"../../simple-colors/simple-colors.js";import"../../simple-picker/simple-picker.js";class HaxUploadField extends SimpleColors{static get styles(){let styles=[];return super.styles&&(styles=super.styles),styles.push(css`
      :host {
        display: block;
        visibility: visible;
    ...
    `),styles}constructor(){super(),this.label=null,import("../../../@polymer/paper-input/paper-input.js"),import("../../../@polymer/paper-icon-button/paper-icon-button.js"),import("../../../@vaadin/vaadin-upload/vaadin-upload.js")}render(){return html`
