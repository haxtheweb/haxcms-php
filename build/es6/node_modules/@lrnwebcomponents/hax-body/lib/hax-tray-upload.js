import{LitElement,html,css}from"../../../lit-element/lit-element.js";import{winEventsElement}from"../../utils/utils.js";import"../../../@polymer/polymer/lib/elements/custom-style.js";class HaxTrayUpload extends(winEventsElement(LitElement)){static get styles(){return[css`
        vaadin-upload {
      ...
      `]}static get tag(){return"hax-tray-upload"}static get properties(){return{canSupportUploads:{type:Boolean,attribute:"can-support-uploads"}}}constructor(){super(),this.__winEvents={"hax-store-property-updated":"_haxStorePropertyUpdated","hax-app-picker-selection":"_haxAppPickerSelection","place-holder-file-drop":"_placeHolderFileDrop"},this.canSupportUploads=!1,setTimeout(()=>{import("../../../@polymer/paper-button/paper-button.js"),import("../../../@polymer/paper-input/paper-input.js"),import("../../../@vaadin/vaadin-upload/vaadin-upload.js")},0)}_haxStorePropertyUpdated(e){e.detail&&"canSupportUploads"===e.detail.property&&(this[e.detail.property]=e.detail.value)}render(){return html`
      <custom-style>
        <style>
