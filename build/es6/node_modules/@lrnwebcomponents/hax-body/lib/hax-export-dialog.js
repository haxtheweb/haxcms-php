import{html,Polymer}from"../../../@polymer/polymer/polymer-legacy.js";import"../../../@polymer/paper-dialog/paper-dialog.js";import"../../../@polymer/iron-icon/iron-icon.js";import"../../../@polymer/iron-icons/iron-icons.js";import"../../../@polymer/paper-input/paper-input.js";import"../../../@polymer/paper-button/paper-button.js";import"../../dl-behavior/dl-behavior.js";import"../../simple-colors/simple-colors.js";import"../../code-editor/code-editor.js";import"../../hexagon-loader/hexagon-loader.js";import"./hax-shared-styles.js";Polymer({_template:html`
  ...
  `,is:"hax-export-dialog",behaviors:[mtz.FileDownloadBehaviors],properties:{title:{type:String,value:"Source view"},globalPreferences:{type:Object,value:{}}},attached:function(){this.fire("hax-register-export",this);document.body.addEventListener("hax-store-property-updated",this._haxStorePropertyUpdated.bind(this));this.$.download.addEventListener("tap",this.download.bind(this));this.$.downloadfull.addEventListener("tap",this.downloadfull.bind(this));this.$.import.addEventListener("tap",this.importContent.bind(this));this.$.copy.addEventListener("tap",this.selectBody.bind(this));this.$.closedialog.addEventListener("tap",this.close.bind(this));this.$.elementexport.addEventListener("tap",this.htmlToHaxElements.bind(this))},detached:function(){document.body.removeEventListener("hax-store-property-updated",this._haxStorePropertyUpdated.bind(this));this.$.download.removeEventListener("tap",this.download.bind(this));this.$.downloadfull.removeEventListener("tap",this.downloadfull.bind(this));this.$.import.removeEventListener("tap",this.importContent.bind(this));this.$.copy.removeEventListener("tap",this.selectBody.bind(this));this.$.closedialog.removeEventListener("tap",this.close.bind(this));this.$.elementexport.removeEventListener("tap",this.htmlToHaxElements.bind(this))},_haxStorePropertyUpdated:function(e){if(e.detail&&typeof e.detail.value!==typeof void 0&&e.detail.property){if("object"===typeof e.detail.value){this.set(e.detail.property,null)}this.set(e.detail.property,e.detail.value)}},download:function(){const data=this.contentToFile(!1);this.downloadFromData(data,"html","my-new-code");window.HaxStore.toast("HTML content downloaded")},downloadfull:function(){const data=this.contentToFile(!0);this.downloadFromData(data,"html","my-new-webpage");window.HaxStore.toast("Working offline copy downloaded")},importContent:function(){const htmlBody=this.$.textarea.value;window.HaxStore.toast("Content updated");return window.HaxStore.instance.activeHaxBody.importContent(htmlBody)},selectBody:function(){this.$.hiddentextarea.value=this.$.textarea.value;this.$.hiddentextarea.removeAttribute("hidden");this.$.hiddentextarea.focus();this.$.hiddentextarea.select();document.execCommand("copy");this.$.hiddentextarea.setAttribute("hidden","hidden");window.HaxStore.toast("Copied HTML content")},htmlToHaxElements:function(){let elements=window.HaxStore.htmlToHaxElements(this.$.textarea.value);var str=JSON.stringify(elements,null,2);let val=this.$.textarea.value;this.$.hiddentextarea.removeAttribute("hidden");this.$.hiddentextarea.value=str;this.$.hiddentextarea.focus();this.$.hiddentextarea.select();document.execCommand("copy");this.$.hiddentextarea.value=val;this.$.hiddentextarea.setAttribute("hidden","hidden");window.HaxStore.toast("Copied hax elements to clipboard")},contentToFile:function(full){var content="";if(full){let elementList=window.HaxStore.instance.elementList,url="https://lrnwebcomponents.github.io/hax-body/components";content=`
      ...
      `;var ignoreList=["iframe","a","img","hr","p"];for(var index in elementList){if(-1===ignoreList.indexOf(index)){content+="<script type=\"module\" src=\""+url+"/"+index+"/"+index+".js\" />"+"\n"}}content+="</head><body>";content+=window.HaxStore.instance.activeHaxBody.haxToContent();content+="</body></html>"}else{content=window.HaxStore.instance.activeHaxBody.haxToContent()}return content},toggleDialog:function(){if(this.$.dialog.opened){this.close()}else{this.$.textarea.editorValue=this.contentToFile(!1);window.HaxStore.instance.closeAllDrawers(this)}},open:function(){this.$.dialog.open();this.$.buttons.style.display="none";this.$.loading.setAttribute("loading","loading");this.$.wrapper.appendChild(this.$.textarea);setTimeout(()=>{this.$.loading.removeAttribute("loading");this.$.buttons.style.display="unset"},800)},close:function(){this.$.dialog.close()}});