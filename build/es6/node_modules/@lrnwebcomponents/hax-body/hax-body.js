import{html,css}from"../../lit-element/lit-element.js";import{SimpleColors}from"../simple-colors/simple-colors.js";import{encapScript,wipeSlot,generateResourceID}from"../utils/utils.js";var gravityScrollTimer=null;class HaxBody extends SimpleColors{static get styles(){return[...super.styles,css`:host,:host * ::slotted(*){line-height:1.8}:host * ::slotted(ol),:host * ::slotted(ul),:host ol,:host ul{padding-left:20px;margin-left:20px}:host * ::slotted(ul),:host ul{list-style-type:disc}:host * ::slotted(li),:host li{margin-bottom:6px}:host{display:block;position:relative;min-height:32px;min-width:32px;outline:0;--hax-contextual-action-color:var(
