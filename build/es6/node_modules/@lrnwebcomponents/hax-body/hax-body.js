import{html,css}from"../../lit-element/lit-element.js";import{SimpleColors}from"../simple-colors/simple-colors.js";import{wrap}from"../../@polymer/polymer/lib/utils/wrap.js";import{FlattenedNodesObserver}from"../../@polymer/polymer/lib/utils/flattened-nodes-observer.js";import{flush}from"../../@polymer/polymer/lib/utils/flush.js";import{encapScript,wipeSlot}from"./lib/haxutils.js";import"./lib/hax-text-context.js";import"./lib/hax-ce-context.js";import"./lib/hax-plate-context.js";import"./lib/hax-input-mixer.js";class HaxBody extends SimpleColors{static get styles(){return[css`
        :host,
        :host * ::slotted(*) {
          line-height: 1.8;
        }
      ...
      `]}constructor(){super(),this.editMode=!1,this.globalPreferences={},this.haxRayMode=!1,this.activeNode=null,this.activeContainerNode=null,import("../../@polymer/iron-a11y-keys/iron-a11y-keys.js"),import("../../@polymer/paper-item/paper-item.js"),import("../grid-plate/grid-plate.js")}static get tag(){return"hax-body"}render(){return html`
