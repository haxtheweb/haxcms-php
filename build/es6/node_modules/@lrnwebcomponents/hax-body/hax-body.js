import{html as e,css as t}from"../../lit-element/lit-element.js";import{SimpleColors as i}from"../simple-colors/simple-colors.js";import{UndoManagerBehaviors as o}from"../undo-manager/undo-manager.js";import{HAXStore as a}from"./lib/hax-store.js";import{autorun as n,toJS as s}from"../../mobx/dist/mobx.esm.js";import{encapScript as l,wipeSlot as r,generateResourceID as d,nodeToHaxElement as c,haxElementToNode as h,camelToDash as u,wrap as m,unwrap as p,ReplaceWithPolyfill as g,normalizeEventPath as v}from"../utils/utils.js";import{HaxUiBaseStyles as b}from"./lib/hax-ui-styles.js";import{I18NMixin as x}from"../i18n-manager/lib/I18NMixin.js";Element.prototype.replaceWith||(Element.prototype.replaceWith=g),CharacterData.prototype.replaceWith||(CharacterData.prototype.replaceWith=g),DocumentType.prototype.replaceWith||(DocumentType.prototype.replaceWith=g),String.prototype.replaceAll||(String.prototype.replaceAll=function(e,t){return this.split(e).join(t)});var _=null;class HaxBody extends(x(o(i))){static get tag(){return"hax-body"}static get styles(){return[...super.styles,t`
      ...
      `]}constructor(){if(super(),this.__ignoreActive=!1,this.__dragMoving=!1,this.___moveLock=!1,this.editMode=!1,this.haxMover=!1,this.activeNode=null,this.t={addContent:"Add Content"},this.registerLocalization({context:this,namespace:"hax"}),!window.HaxUiStyles){window.HaxUiStyles=document.createElement("div");let e=document.createElement("style"),t=b.map((e=>e.cssText)).join("");e.setAttribute("data-hax",!0),e.setAttribute("type","text/css"),e.styleSheet?e.styleSheet.cssText=t:e.appendChild(document.createTextNode(t)),document.getElementsByTagName("head")[0].appendChild(e)}setTimeout((()=>{import("./lib/hax-context-container.js"),import("./lib/hax-ce-context.js"),import("./lib/hax-text-context.js"),import("./lib/hax-plate-context.js"),import("../grid-plate/grid-plate.js"),this.polyfillSafe=a.computePolyfillSafe(),this.addEventListener("place-holder-replace",this.replacePlaceholder.bind(this)),this.addEventListener("focusin",this._focusIn.bind(this)),this.addEventListener("mousemove",this._mouseMove.bind(this)),this.addEventListener("mouseleave",this._mouseLeave.bind(this)),this.addEventListener("touchstart",this._mouseMove.bind(this),{passive:!0}),this.addEventListener("mousedown",this._mouseDown.bind(this)),this.addEventListener("mouseup",this._mouseUp.bind(this)),this.addEventListener("dragenter",this.dragEnterBody.bind(this)),this.addEventListener("dragend",this.dragEndBody.bind(this)),this.addEventListener("drop",this.dropEvent.bind(this))}),0),n((()=>{this.editMode=s(a.editMode)})),n((()=>{this.activeNode=s(a.activeNode)})),n((()=>{s(a.activeEditingElement)}))}dragEndBody(e){this.__manageFakeEndCap(!1),a._lockContextPosition=!1,this.querySelectorAll(".hax-hovered").forEach((e=>{e.classList.remove("hax-hovered")}))}_mouseLeave(e){this.editMode&&a.ready&&(clearTimeout(this.__mouseQuickTimer),clearTimeout(this.__mouseTimer),this.__activeHover=null,this._hideContextMenu(this.contextMenus.add),this.classList.remove("hax-add-content-visible"))}_mouseMove(e){if(this.editMode&&a.ready){var t=v(e);clearTimeout(this.__mouseQuickTimer),this.__mouseQuickTimer=setTimeout((()=>{if(this.__activeHover&&this.__activeHover!=t[0].closest("[data-hax-ray]:not(li)")&&!t[0].closest("#addincontext")){let i;for(var e=0;e<t.length;e++)t[e].getAttribute&&"addincontext"==t[e].getAttribute("id")&&(i=!0);i||(this.__activeHover=null,this._hideContextMenu(this.contextMenus.add),this.classList.remove("hax-add-content-visible"))}}),300),clearTimeout(this.__mouseTimer),this.__mouseTimer=setTimeout((()=>{this.__addActiveVisible();let i=t[0].closest("[data-hax-ray]:not(li)");if(i){this.__activeHover=i;let t=this.__activeHover.getBoundingClientRect(),o=this.contextMenus.add.getBoundingClientRect(),a=(e.pageY-(t.top+window.scrollY))/t.height,n=-o.height-1;a>.3?(n=t.height+1,this.__addAbove=!1):this.__addAbove=!0,this._positionContextMenu(this.contextMenus.add,this.__activeHover,t.width/2-o.width/2,n),this.classList.add("hax-add-content-visible")}else if(t[0].closest(".column")&&t[3]&&t[3].closest("grid-plate")){let i,o,a=this.contextMenus.add.getBoundingClientRect(),n=-a.height-1;if(t[0].closest(".column:not(.has-nodes"))this.__addAbove=!1,this.__slot=t[0].closest(".column").getAttribute("id").replace("col","col-"),this.__activeHover=t[0].closest(".column").parentNode.parentNode.host,i=t[0].closest(".column").getBoundingClientRect(),n=i.height/2-a.height/2,o=t[0].closest(".column"),this.__slotInGrid=!0;else{this.__activeHover=t[0].closest(".column").parentNode.parentNode.host,o=this.__activeHover,i=this.__activeHover.getBoundingClientRect(),(e.pageY-(i.top+window.scrollY))/i.height>.3?(n=i.height+1,this.__addAbove=!1):this.__addAbove=!0}this._positionContextMenu(this.contextMenus.add,o,i.width/2-a.width/2,n),this.classList.add("hax-add-content-visible")}else t[0].closest("#bodycontainer")&&(this.__activeHover=null,this._hideContextMenu(this.contextMenus.add),this.classList.remove("hax-add-content-visible"))}),400)}}_mouseDown(e){if(this.editMode){this.__mouseDown=!0;let t=e.target;t.closest("[draggable]")?t=t.closest("[draggable]"):t.closest("[slot]")?t=t.closest("[slot]"):t.closest("[data-hax-ray]")?t=t.closest("[data-hax-ray]"):t.closest("[contenteditable]")?t=t.closest("[contenteditable]"):a.validTagList.includes(t.tagName.toLowerCase())||"HAX-BODY"===t.tagName||t.haxUIElement||console.warn(t),!t.haxUIElement&&this.__focusLogic(t)&&(e.stopPropagation(),e.stopImmediatePropagation())}}_mouseUp(e){setTimeout((()=>{this.__mouseDown=!1}),0),clearTimeout(_),this.__manageFakeEndCap(!1)}clickEvent(e){clearTimeout(_)}blurEvent(e){this.editMode&&a.activeEditingElement}__manageFakeEndCap(e=!0){if(e&&!this.__fakeEndCap){let e=document.createElement("fake-hax-body-end");e.style.width="100%",e.style.height="20px",e.style.zIndex="2",e.style.display="block",this.__fakeEndCap=e,this.haxMover=!0,this.appendChild(this.__fakeEndCap),this.__applyNodeEditableState(this.__fakeEndCap,!0)}else!e&&this.__fakeEndCap&&(this.__fakeEndCap.remove(),this.haxMover=!1,this.__fakeEndCap=null)}dragEnterBody(e){this.__manageFakeEndCap(!0)}render(){return e`
