...
class LrnsysProgress extends PolymerElement {
  ...
  static get properties() {
    return {
      ...
      completeSound: {
        type: String,
        value: pathFromUrl(decodeURIComponent(import.meta.url)) + "lib/assets/complete.mp3",
        reflectToAttribute: true
      },
      ...
      finishedSound: {
        type: String,
        value: pathFromUrl(decodeURIComponent(import.meta.url)) + "lib/assets/finished.mp3",
        reflectToAttribute: true
      },
