 ...
 */
import{LitElement as t,html as e,css as i}from"../../lit/index.js";import{SchemaBehaviors as o}from"../schema-behaviors/schema-behaviors.js";import{IntersectionObserverMixin as r}from"../intersection-element/lib/IntersectionObserverMixin.js";import{I18NMixin as s}from"../i18n-manager/lib/I18NMixin.js";class A11yGifPlayer extends(s(r(o(t)))){constructor(){super(),this.__gifLoaded=!1,this.disabled=!1,this.__playing=!1,this._updateFromSlot(),this.t={toggleAnimation:"Toggle animation"},this.registerLocalization({context:this,basePath:import.meta.url,locales:["es"]})}static get styles(){return[i`
        :host {
          display: block;
        }
        :host([hidden]) {
