import{LitElement,html,css}from"../../lit-element/lit-element.js";import{SchemaBehaviors}from"../schema-behaviors/schema-behaviors.js";import"../../@polymer/paper-tooltip/paper-tooltip.js";class A11yGifPlayer extends(SchemaBehaviors(LitElement)){constructor(){super(),this.alt=null,this.disabled=!1,this.src=null,this.tooltip="Toggle Animation",this.tooltipPlaying=null,this.srcWithoutAnimation=null,this.__playing=!1,import("../../@polymer/iron-image/iron-image.js")}static get styles(){return[css`
        :host {
          display: inline-flex;
        }
        :host([hidden]) {
