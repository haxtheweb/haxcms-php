...
</dom-module>`;document.head.appendChild($_documentContainer);/* styles scoped to inside a custom element must be in a style module */Polymer({is:"map-area",extends:"area",properties:{alt:{type:String,reflectToAttribute:!0/* transition */ /* transition */},coords:{type:String,reflectToAttribute:!0},href:{type:String,reflectToAttribute:!0},shape:{type:String,/* to HTML5's default, circle, poly and rect, add marker, line */value:"default",reflectToAttribute:!0},rel:{type:String,reflectToAttribute:!0},type:{type:String,reflectToAttribute:!0},target:{type:String,reflectToAttribute:!0}},attached:function(){// if the map has been attached, set this layer up wrt Leaflet map
