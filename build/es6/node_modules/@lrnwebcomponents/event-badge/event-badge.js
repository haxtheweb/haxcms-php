 ...
 */
import{css as A,svg as a}from"../../lit/index.js";import{SimpleColors as t}from"../simple-colors/simple-colors.js";class EventBadge extends t{static get tag(){return"event-badge"}constructor(){super(),this.title="haxor",this.name="bto.pro",this.position="1337 dev",this.organization="Penn State",this.image="https://avatars1.githubusercontent.com/u/329735?s=400&v=4",this.tvcolor="light-blue",this.accentColor="blue",this.knobcolor="purple",this.logo=null,this.sepia=!1,this.blackwhite=!1}updated(A){super.updated(A),console.log(this.offsetWidth),console.log(this.offsetHeight)}static get properties(){return{...super.properties,title:{type:String},image:{type:String},name:{type:String},position:{type:String},logo:{type:String},organization:{type:String},tvcolor:{type:String},knobcolor:{type:String},sepia:{type:Boolean,reflect:!0},blackwhite:{type:Boolean,reflect:!0}}}static get styles(){return[...super.styles,A`
        :host {
          display: inline-flex;
        }
        :host([sepia]) {
