import{html,PolymerElement}from"../../@polymer/polymer/polymer-element.js";import*as async from"../../@polymer/polymer/lib/utils/async.js";import{updateStyles}from"../../@polymer/polymer/lib/mixins/element-mixin.js";import{HAXCMSTheme}from"../haxcms-elements/lib/core/HAXCMSThemeWiring.js";import{store}from"../haxcms-elements/lib/core/haxcms-site-store.js";import{autorun,toJS}from"../../mobx/lib/mobx.module.js";import"../../@polymer/app-layout/app-header/app-header.js";import"../../@polymer/app-layout/app-toolbar/app-toolbar.js";import"../../@polymer/app-layout/app-drawer/app-drawer.js";import"../../@polymer/app-layout/app-drawer-layout/app-drawer-layout.js";import"../../@polymer/app-layout/app-header-layout/app-header-layout.js";import"../simple-colors/simple-colors.js";import"../hax-body/lib/hax-shared-styles.js";import"../haxcms-elements/lib/ui-components/navigation/site-menu.js";import"../haxcms-elements/lib/ui-components/navigation/site-menu-button.js";import"../haxcms-elements/lib/ui-components/site/site-print-button.js";import"../haxcms-elements/lib/ui-components/site/site-title.js";import"../haxcms-elements/lib/ui-components/active-item/site-active-title.js";class OutlinePlayer extends HAXCMSTheme(PolymerElement){static get tag(){return"outline-player"}static get template(){return html`
    ...
    `}static get properties(){return{opened:{type:Boolean,reflectToAttribute:!0},closed:{type:Boolean,notify:!0,reflectToAttribute:!0,value:!1},activeId:{type:String,observer:"_activeIdChanged"},narrow:{type:Boolean,reflectToAttribute:!0}}}_toggleMenu(){this.$.drawer.toggle();this.closed=!this.$.drawer.opened;async.microTask.run(()=>{window.dispatchEvent(new Event("resize"));updateStyles()})}_activeIdChanged(){if(this.opened&&this.narrow){this.$.drawer.toggle()}window.scrollTo({top:0,left:0,behavior:"smooth"})}connectedCallback(){super.connectedCallback();this.__disposer=[];autorun(reaction=>{this.activeId=toJS(store.activeId);this.__disposer.push(reaction)})}disconnectedCallback(){for(var i in this.__disposer){this.__disposer[i].dispose()}super.disconnectedCallback()}}window.customElements.define(OutlinePlayer.tag,OutlinePlayer);export{OutlinePlayer};