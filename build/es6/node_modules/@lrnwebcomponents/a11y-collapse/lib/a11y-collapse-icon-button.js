 ...
 */class A11yCollapseIconButton extends PolymerElement{static get tag(){return"a11y-collapse-icon-button"}static get template(){return html`
    ...
    `}static get properties(){return{/**
       ...
       */rotated:{type:Boolean,value:!1}}}connectedCallback(){super.connectedCallback();afterNextRender(this,function(){this.$.expand.addEventListener("click",this._onTap.bind(this))})}disconnectedCallback(){this.$.expand.removeEventListener("click",this._onTap.bind(this));super.disconnectedCallback()}/**
   * Handle tap
