...
*/class PaperFabSpeedDial extends PolymerElement{static get template(){return html`
    ...
    `}static get tag(){return"paper-fab-speed-dial"}static get properties(){return{/**
       ...
       */closeAnimationConfig:{type:Array,value(){return[{name:"fade-out-animation",timing:{duration:200}}]}}}}static get observers(){return["_updateDropdown(direction, offset)"]}ready(){super.ready();var fab=dom(this.$.fabContainer).getDistributedNodes()[0];fab.addEventListener("click",function(){this.$.dropdown.open()}.bind(this));var content=dom(this.$.contentContainer).getDistributedNodes()[0];content.addEventListener("click",function(){this.$.dropdown.close()}.bind(this))}/**
