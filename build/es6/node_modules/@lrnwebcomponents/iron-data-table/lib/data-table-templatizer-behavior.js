import{Templatizer}from"../../../@polymer/polymer/lib/legacy/templatizer-behavior.js";import{dom}from"../../../@polymer/polymer/lib/legacy/polymer.dom.js";var saulis=window.saulis||{};export{saulis};/** @polymerBehavior */saulis.DataTableTemplatizerBehaviorImpl={properties:{expanded:Boolean,index:Number,item:Object,selected:Boolean,table:Object,template:Object,//singleton
_instances:{type:Array,value:[]},//singleton
_forwardedParentProps:{type:Object,value:{}},_instance:{type:Object,computed:"_templatize(template)"}},observers:["_expandedChanged(_instance, expanded)","_indexChanged(_instance, index)","_itemChanged(_instance, item)","_itemPathChanged(_instance, item.*)","_selectedChanged(_instance, selected)"],created:function(){this._instanceProps={column:!0/* transition */ /* transition */,expanded:!0,index:!0,item:!0,selected:!0}},_templatize:function(template){this.templatize(template);// fix _rootDataHost to the context where template has been defined
...
for(var key in this._forwardedParentProps){instance[key]=this._forwardedParentProps[key]}this._instances.push(instance);dom(this).insertBefore(instance.root,dom(this).firstElementChild);return instance},_expandedChanged:function(instance,expanded){// store original expanded value to detect when value change has
...
this.table.fire("item-changed",{item:inst.item,path:path.substring(5),value:value})}.bind(this))}}};/** @polymerBehavior */saulis.DataTableTemplatizerBehavior=[Templatizer,saulis.DataTableTemplatizerBehaviorImpl];