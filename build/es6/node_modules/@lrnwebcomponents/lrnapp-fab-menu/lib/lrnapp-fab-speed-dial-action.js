import{html,PolymerElement}from"../../../@polymer/polymer/polymer-element.js";import"../../../@polymer/paper-fab/paper-fab.js";import"../../../@polymer/iron-flex-layout/iron-flex-layout-classes.js";import{SimpleColors}from"../../simple-colors/simple-colors.js";/*
...
*/class LrnappFabSpeedDialAction extends PolymerElement{static get tag(){return"lrnapp-fab-speed-dial-action"}static get template(){return html`
    ...
    `}static get properties(){return{/**
       ...
       * Class for the color
       */hexColor:{type:String,computed:"_getHexColor(color)"}}}_getHexColor(color){let name=color.replace("-text",""),tmp=new SimpleColors;if(tmp.colors[name]){return tmp.colors[name][6]}return"#000000"}}window.customElements.define(LrnappFabSpeedDialAction.tag,LrnappFabSpeedDialAction);export{LrnappFabSpeedDialAction};