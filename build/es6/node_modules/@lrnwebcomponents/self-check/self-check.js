import{LitElement as e,html as i,css as t,svg as r}from"../../lit/index.js";import{SchemaBehaviors as d}from"../schema-behaviors/schema-behaviors.js";import{lazyImageLoader as a}from"../lazy-image-helpers/lazy-image-helpers.js";import{I18NMixin as o}from"../i18n-manager/lib/I18NMixin.js";import"../simple-icon/simple-icon.js";import"../simple-icon/lib/simple-icons.js";import"../simple-icon/lib/simple-icon-button.js";import{DDD as s}from"../d-d-d/d-d-d.js";class SelfCheck extends(o(a(d(s)))){constructor(){super(),this.correct=!1,this.alt="",this.image="",this.question="",this.accentColor="blue",this.title="Self-Check",this.fullWidthImage=!1,this.t={revealAnswer:"Reveal Answer",close:"Close",moreInformation:"More information"},this.registerLocalization({context:this,basePath:import.meta.url,locales:["he","ja","es"]})}static get styles(){return[super.styles,t`
        :host {
          display: block;
