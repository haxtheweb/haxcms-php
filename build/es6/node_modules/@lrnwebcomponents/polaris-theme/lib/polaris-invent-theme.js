...
import{html as e,css as t}from"../../../lit/index.js";import{HAXCMSLitElementTheme as i}from"../../haxcms-elements/lib/core/HAXCMSLitElementTheme.js";import{HAXCMSThemeParts as o}from"../../haxcms-elements/lib/core/utils/HAXCMSThemeParts.js";import{HAXCMSMobileMenuMixin as a}from"../../haxcms-elements/lib/core/utils/HAXCMSMobileMenu.js";import{HAXCMSOperationButtons as r}from"../../haxcms-elements/lib/core/utils/HAXCMSOperationButtons.js";import{store as s}from"../../haxcms-elements/lib/core/haxcms-site-store.js";import{MicroFrontendRegistry as n}from"../../micro-frontend-registry/micro-frontend-registry.js";import{HAXCMSRememberRoute as l}from"../../haxcms-elements/lib/core/utils/HAXCMSRememberRoute.js";import{QRCodeMixin as p}from"../../haxcms-elements/lib/core/utils/QRCodeMixin.js";import{EmailPageMixin as d}from"../../haxcms-elements/lib/core/utils/EmailPageMixin.js";import{PrintBranchMixin as c}from"../../haxcms-elements/lib/core/utils/PrintBranchMixin.js";import{PDFPageMixin as m}from"../../haxcms-elements/lib/core/utils/PDFPageMixin.js";import"../../scroll-button/scroll-button.js";import"../../haxcms-elements/lib/ui-components/site/site-title.js";import"../../haxcms-elements/lib/ui-components/active-item/site-active-title.js";import"../../haxcms-elements/lib/ui-components/active-item/site-active-tags.js";import"../../haxcms-elements/lib/ui-components/navigation/site-menu.js";import"../../haxcms-elements/lib/ui-components/layout/site-modal.js";import"../../haxcms-elements/lib/ui-components/layout/site-region.js";import{autorun as h,toJS as g}from"../../../mobx/dist/mobx.esm.js";import{DDDSuper as b}from"../../d-d-d/d-d-d.js";import{HAXCMSToastInstance as x}from"../../haxcms-elements/lib/core/haxcms-toast.js";class PolarisInventTheme extends(r(l(d(m(c(p(o(a(b(i)))))))))){static get styles(){return[super.styles,t`
    ...
    `}static get properties(){let e={};return super.properties&&(e=super.properties),{...e,searchTerm:{type:String},siteDescription:{type:String},imageLink:{type:String},image:{type:String},imageAlt:{type:String},pageTimestamp:{type:Number}}}static get tag(){return"polaris-invent-theme"}appStoreReady(e){if(globalThis.HaxStore&&globalThis.HaxStore.requestAvailability()){let e=globalThis.HaxStore.requestAvailability();["polaris-cta","polaris-mark","polaris-story-card","polaris-tile"].map((t=>{let i=document.createElement(t);e.haxAutoloader.appendChild(i)})),this.windowControllersLoaded.abort()}}constructor(){super(),x.style.setProperty("--rpg-character-toast-display","none"),x.style.setProperty("--rpg-character-toast-mid-background-image","none"),x.style.setProperty("--rpg-character-toast-right-background-image","none"),x.style.setProperty("--rpg-character-toast-left-background-image","none"),x.style.setProperty("--rpg-character-toast-mid-padding",0),x.style.setProperty("--rpg-character-toast-height","96px"),x.style.backgroundColor="white",this.windowControllersLoaded=new AbortController,globalThis.addEventListener("hax-store-app-store-loaded",this.appStoreReady.bind(this),{once:!0,passive:!0,signal:this.windowControllersLoaded.signal}),this.HAXCMSThemeSettings.autoScroll=!0,this.searchTerm="",this.imageAlt="",this.image="",this.imageLink="",this.__disposer=this.__disposer?this.__disposer:[],h((e=>{this.imageLink=g(s.themeData.variables.imageLink),this.__disposer.push(e)})),h((e=>{this.image=g(s.themeData.variables.image),this.__disposer.push(e)})),h((e=>{this.imageAlt=g(s.themeData.variables.imageAlt),this.__disposer.push(e)})),h((e=>{this.siteDescription=g(s.siteDescription),this.__disposer.push(e)})),h((e=>{this.activeManifestIndex=g(s.activeManifestIndex),this.__disposer.push(e)})),h((e=>{s.activeItem&&s.activeItem.metadata&&s.activeItem.metadata.updated&&(this.pageTimestamp=g(s.activeItem.metadata.updated)),this.__disposer.push(e)}))}siteModalClick(e){import("../../haxcms-elements/lib/ui-components/site/site-search.js").then((e=>{"search"!==s.getInternalRoute()&&globalThis.history.replaceState({},null,"x/search");const t=new URLSearchParams(s.currentRouterLocation.search),i=globalThis.SimpleModal.requestAvailability().querySelector("site-search").shadowRoot.querySelector("simple-fields-field");i.focus(),t.get("search")&&(i.value=t.get("search"),setTimeout((()=>{i.select()}),0))}))}disconnectedCallback(){for(var e in this.__disposer)this.__disposer[e].dispose();super.disconnectedCallback()}}customElements.define(PolarisInventTheme.tag,PolarisInventTheme);export{PolarisInventTheme};