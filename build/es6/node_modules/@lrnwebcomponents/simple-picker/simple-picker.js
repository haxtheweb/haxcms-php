...
target.focus();active.tabindex=-1;//prevent tabbing between options.
   ...
   */_handleListboxEvent(e,type){console.log("_handleListboxEvent",type);this.dispatchEvent(new CustomEvent(type,{detail:this}));if("click"===type)this._toggleListbox(!this.expanded)}/**
