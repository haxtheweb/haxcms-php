 ...
 */
import{LitElement as d,css as a}from"../../lit/index.js";import{SimpleColorsSuper as i}from"../simple-colors/simple-colors.js";export const styleGuideTopics={Typography:"Typography",FW:"FW",FS:"FS",BS:"BS",Breakpoints:"Breakpoints",MP:"MP",PolarisColors:"PolarisColors",PolarisFunctionalColors:"PolarisFunctionalColors"};class DDD extends(i(d)){constructor(){super(),this.option="*",this.options=Object.keys(styleGuideTopics),this.loadFonts(["https://fonts.googleapis.com/css2?family=Roboto:ital,wght@0,400;0,500;0,700;0,900;1,400;1,500;1,700;1,900&display=swap","https://fonts.googleapis.com/css2?family=Roboto+Slab:wght@700&display=swap","https://fonts.googleapis.com/css2?family=Roboto+Condensed:wght@300;700&display=swap"])}loadFonts(d){d.forEach((d=>{const a=document.createElement("link");a.setAttribute("href",d),a.setAttribute("rel","stylesheet"),a.setAttribute("fetchpriority","low"),document.head.appendChild(a)}))}static get properties(){return{option:{type:String},options:{type:Array}}}static get styles(){let d=[];return super.styles&&(d=super.styles),[...d,a`
      :host{
          /* base polaris colors */
      ...
      `]}static get tag(){return"d-d-d"}static get haxProperties(){return{api:"1",type:"element",editingElement:"core",hideDefaultSettings:!1,canScale:!0,canPosition:!0,canEditSource:!0,contentEditable:!1,gizmo:{title:"Design, Develop, Destroy",description:"Design system implementation for HAX",icon:"icons:android",color:"purple",tags:["Other","developer","design"],handles:[],meta:{author:"HAXTheWeb core team"}},settings:{configure:[{property:"option",title:"Option to render",type:"select",options:{"*":"Full styleguide",...styleGuideTopics}}],advanced:[],developer:[]},saveOptions:{unsetAttributes:[]},documentation:{howTo:null,purpose:null},demoSchema:[{tag:"d-d-d",content:"",properties:{}}]}}}customElements.define(DDD.tag,DDD);export{DDD};