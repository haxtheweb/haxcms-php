...
import{LitElement as d,css as a}from"../../lit/index.js";import{SimpleColorsSuper as i}from"../simple-colors/simple-colors.js";export const styleGuideTopics={Borders:"Borders",Breakpoints:"Breakpoints",PolarisColors:"PolarisColors",PolarisFunctionalColors:"PolarisFunctionalColors",Gradients:"Gradients",Radius:"Radius",Shadows:"Shadows",Spacing:"Spacing",Typography:"Typography"};export const DDDFonts=["https://fonts.googleapis.com/css2?family=Roboto:ital,wght@0,400;0,500;0,700;0,900;1,400;1,500;1,700;1,900&display=swap","https://fonts.googleapis.com/css2?family=Roboto+Slab:wght@700&display=swap","https://fonts.googleapis.com/css2?family=Roboto+Condensed:wght@300;400;700&display=swap"];export const DDDSuper=function(d){return class extends(i(d)){constructor(){super()}loadDDDFonts(d){d.forEach((d=>{const a=document.createElement("link");a.setAttribute("href",d),a.setAttribute("rel","stylesheet"),a.setAttribute("fetchpriority","low"),document.head.appendChild(a)}))}static get styles(){let d=[];return super.styles&&(d=super.styles),[...d,a`
      ...
      `]}}};class DDD extends(DDDSuper(d)){constructor(){super(),this.loadDDDFonts(DDDFonts)}static get tag(){return"d-d-d"}}customElements.define(DDD.tag,DDD);export{DDD};globalThis.DDDSharedStyles=globalThis.DDDSharedStyles||{},globalThis.DDDSharedStyles.requestAvailability=()=>{if(null==globalThis.DDDSharedStyles.instance&&globalThis.document){let d=DDD.styles.map((d=>d.cssText)).join("");globalThis.DDDSharedStyles.instance=globalThis.document.createElement("style"),globalThis.DDDSharedStyles.instance.classList.add("ddd-global-styles"),globalThis.DDDSharedStyles.instance.innerHTML=`${d}`,globalThis.document.head.appendChild(globalThis.DDDSharedStyles.instance)}return globalThis.DDDSharedStyles.instance};export const DDDSharedStylesGlobal=globalThis.DDDSharedStyles.requestAvailability();