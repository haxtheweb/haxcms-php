import{DDDSuper as t}from"../d-d-d.js";import{DDDDataAttributes as e,ApplicationAttributeData as a}from"./DDDStyles.js";import{html as d,css as r,LitElement as i}from"../../../lit/index.js";export class DDDSample extends(t(i)){constructor(){super(),this.type=null,this.option=0}static get styles(){return[super.styles,...e,r`
        :host {
          display: flex;
      ...
      `]}updated(t){if(super.updated&&super.updated(t),t.has("type")&&this.shadowRoot){let t;t=["accent","primary","padding","margin","border-radius","box-shadow","border"].includes(this.type)?this.shadowRoot.querySelector("span.sample"):"font-size"===this.type?this.shadowRoot.querySelector("div.wrapper"):this.shadowRoot.querySelector("span.label");for(let e in a)t.removeAttribute(`data-${e}`);setTimeout((()=>{t.setAttribute(`data-${this.type}`,this.option)}),0)}if(t.has("option")&&this.shadowRoot&&this.type){let t=this.shadowRoot.querySelector(`span[data-${this.type}]`);t&&t.setAttribute(`data-${this.type}`,this.option)}}render(){return d`
    <div class="wrapper">
