 ...
 */
import{html as s,css as d}from"../../../lit/index.js";import{DDD as t}from"../d-d-d.js";import{EditableTable as a}from"../../editable-table/editable-table.js";export const styleGuideTopics={Borders:"Borders",Breakpoints:"Breakpoints",PolarisColors:"PolarisColors",PolarisFunctionalColors:"PolarisFunctionalColors",BS:"BS",MP:"MP",Typography:"Typography"};class DDDocs extends t{constructor(){super(),this.option="*",this.options=Object.keys(styleGuideTopics)}static get properties(){return{option:{type:String},options:{type:Array}}}static get styles(){return[...super.styles,d`
        /* used for demo */
        .flex {
          display: flex;
        }
    ...
    `}renderGradients(){}renderTypography(){return s`
