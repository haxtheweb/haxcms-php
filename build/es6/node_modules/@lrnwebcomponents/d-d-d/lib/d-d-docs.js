 ...
 */
import{html as s,css as t}from"../../../lit/index.js";import{DDD as a}from"../d-d-d.js";export const styleGuideTopics={Borders:"Borders",Breakpoints:"Breakpoints",PolarisColors:"PolarisColors",PolarisFunctionalColors:"PolarisFunctionalColors",Gradients:"Gradients",Radius:"Radius",Shadows:"Shadows",Spacing:"Spacing",Typography:"Typography",RichText:"RichText"};class DDDocs extends a{constructor(){super(),this.option="*",this.options=Object.keys(styleGuideTopics)}static get properties(){return{option:{type:String},options:{type:Array}}}static get styles(){return[...super.styles,t`
        /* used for demo */
        :host{
