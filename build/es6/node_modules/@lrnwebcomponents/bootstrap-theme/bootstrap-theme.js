 ...
 */
import{LitElement as e,html as t,css as o}from"../../lit-element/lit-element.js";import{HAXCMSLitElementTheme as i}from"../haxcms-elements/lib/core/HAXCMSLitElementTheme.js";import{HAXCMSMobileMenuMixin as s}from"../haxcms-elements/lib/core/utils/HAXCMSMobileMenu.js";import{BootstrapUserStylesMenuMixin as r}from"./lib/BootstrapUserStylesMenuMixin.js";import{HAXCMSUserStylesMenuMixin as n}from"../haxcms-elements/lib/core/utils/HAXCMSUserStylesMenu.js";import{HAXCMSThemeParts as a}from"../haxcms-elements/lib/core/utils/HAXCMSThemeParts.js";import"../simple-icon/lib/simple-icon-lite.js";import"../simple-icon/lib/simple-icons.js";import"./lib/BootstrapBreadcrumb.js";import"./lib/BootstrapFooter.js";import"./lib/BootstrapMenu.js";import"./lib/BootstrapSearch.js";import{store as l}from"../haxcms-elements/lib/core/haxcms-site-store.js";import{autorun as c,toJS as h}from"../../mobx/dist/mobx.esm.js";class BootstrapTheme extends(a(r(s(i)))){static get tag(){return"bootstrap-theme"}static get styles(){return[...super.styles,o`
        :host {
          display: block;
    ...
    `}_wrapSections(){this._themeElements&&this._applyClasses(this._themeElements)}_applyClasses(e){e.forEach(e=>{this.headerTags.includes(e.nodeName)&&e.classList.add("display-6")})}_applyMutationObserver(){this._observer=new MutationObserver((e,t)=>{e.forEach(e=>{e.addedNodes?(e.addedNodes.forEach(e=>{this._themeElements.push(e)}),this._wrapSections()):e.removedNodes&&e.removedNodes.forEach(e=>{this._themeElements.splice(this._themeElements.indexOf(e),1)})})}),this._observer.observe(this,{childList:!0})}_generateBootstrapLink(){this._bootstrapLink&&document.head.removeChild(this._bootstrapLink);let e=this.getBasePath(decodeURIComponent(import.meta.url));console.log(e);let t=document.createElement("link");return t.setAttribute("rel","stylesheet"),t.setAttribute("href",e+"bootstrap/dist/css/bootstrap.min.css"),document.head.appendChild(t),t}disconnectedCallback(){this._bootstrapLink&&document.head.removeChild(this._bootstrapLink),super.disconnectedCallback()}firstUpdated(e){super.firstUpdated&&super.firstUpdated(e),this._loadScripts(),this._bootstrapLink=this._generateBootstrapLink(),this._applyMutationObserver(),this._wrapSections()}_loadScripts(){let e=this.getBasePath(decodeURIComponent(import.meta.url));window.ESGlobalBridge.requestAvailability(),window.ESGlobalBridge.instance.load("jquery",e+"jquery/dist/jquery.min.js"),window.addEventListener("es-bridge-jquery-loaded",this._jqueryLoaded.bind(this))}_bootstrapLoaded(e){this._bootstrap=!0}_loadBootstrap(){let e=this.getBasePath(decodeURIComponent(import.meta.url));window.ESGlobalBridge.instance.load("bootstrap",e+"bootstrap/dist/js/bootstrap.bundle.min.js"),window.addEventListener("es-bridge-bootstrap-loaded",this._bootstrapLoaded.bind(this))}_jqueryLoaded(e){this._jquery=!0,this._loadBootstrap()}getBasePath(e){return e.substring(0,e.lastIndexOf("/@lrnwebcomponents/")+1)}prevPage(e){super.prevPage(e)}nextPage(e){super.nextPage(e)}updated(e){super.updated&&super.updated(e),e.forEach((e,t)=>{})}}customElements.define(BootstrapTheme.tag,BootstrapTheme);export{BootstrapTheme};