import{css as e,html as s}from"../../../lit-element/lit-element.js";import{normalizeEventPath as t}from"../../utils/utils.js";const BootstrapUserStylesMenuMixin=function(o){return class extends o{constructor(){super(),this.hideUserStylesMenu=!0,this.fontSize=1,this.fontFamily=0,this.colorTheme=0,this.addEventListener("click",this.checkUserStylesMenuOpen.bind(this))}static get styles(){let s=[];return super.styles&&(s=super.styles),[...s,e`
          :host([font-family="0"]) {
