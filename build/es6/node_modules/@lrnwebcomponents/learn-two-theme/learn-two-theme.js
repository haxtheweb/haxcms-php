...
</app-drawer-layout>`}static get properties(){return{}}static get tag(){return"learn-two-theme"}static get properties(){let props=super.properties;props.opened={type:Boolean,reflectToAttribute:!0};return props}toggleDrawer(){this.$.drawer.toggle()}}window.customElements.define(LearnTwoTheme.tag,LearnTwoTheme);export{LearnTwoTheme};