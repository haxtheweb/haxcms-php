import{html,PolymerElement}from"../../@polymer/polymer/polymer-element.js";import"../../@polymer/paper-icon-button/paper-icon-button.js";import"../../@polymer/paper-button/paper-button.js";import"../../@polymer/iron-icon/iron-icon.js";import"../../@polymer/paper-tooltip/paper-tooltip.js";import"../simple-colors/simple-colors.js";import"../../@polymer/app-layout/app-drawer/app-drawer.js";import"../../@polymer/app-layout/app-drawer-layout/app-drawer-layout.js";import"../map-menu/map-menu.js";import"../haxcms-elements/lib/theme/site-breadcrumb.js";import"../haxcms-elements/lib/theme/site-rss.js";import{HAXCMSTheme}from"../haxcms-elements/lib/HAXCMSThemeWiring.js";class LearnTwoTheme extends HAXCMSTheme(PolymerElement){static get template(){return html`
      <style>
        :host {
          display: block;
    ...
    `}static get properties(){return{}}static get tag(){return"learn-two-theme"}connectedCallback(){super.connectedCallback();this.$.menu.addEventListener("active-item",this.mapMenuActiveChanged.bind(this))}disconnectedCallback(){super.disconnectedCallback();this.$.menu.removeEventListener("active-item",this.mapMenuActiveChanged.bind(this))}static get properties(){let props=super.properties;props.opened={type:Boolean,reflectToAttribute:!0};return props}mapMenuActiveChanged(e){e.detail.trackIcon="icons:check";let userData=JSON.parse(window.localStorage.getItem("HAXCMSSystemData"));userData.manifests[this.manifest.id].accessData[e.detail.id]={timestamp:Math.floor(Date.now()/1e3),trackIcon:"icons:check"};for(var i in this.manifest.items){if(this.manifest.items[i].id===e.detail.id){this.manifest.items[i].metadata.accessData=userData.manifests[this.manifest.id].accessData[e.detail.id]}}window.localStorage.setItem("HAXCMSSystemData",JSON.stringify(userData))}toggleDrawer(){this.$.drawer.toggle()}}window.customElements.define(LearnTwoTheme.tag,LearnTwoTheme);export{LearnTwoTheme};