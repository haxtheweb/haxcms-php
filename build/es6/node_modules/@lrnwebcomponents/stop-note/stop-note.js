import{html as t,css as e}from"../../lit/index.js";import{remoteLinkBehavior as o}from"../utils/lib/remoteLinkBehavior.js";import{SimpleIconsetStore as i}from"../simple-icon/lib/simple-iconset.js";import{I18NMixin as s}from"../i18n-manager/lib/I18NMixin.js";import"../simple-icon/simple-icon.js";import{DDD as r}from"../d-d-d/d-d-d.js";import{DDDMarginPadding as n,DDDBorders as a}from"../d-d-d/lib/DDDStyles.js";i.registerIconset("stopnoteicons",`${new URL("./stop-note.js",import.meta.url).href}/../lib/svgs/stopnoteicons/`);export const StopNoteIconList={stop:"stopnoteicons:stop-icon",warning:"stopnoteicons:warning-icon",success:"stopnoteicons:confirm-icon",info:"stopnoteicons:book-icon"};class StopNote extends(s(o(r))){static get styles(){return[super.styles,a,n,e`
        :host {
          display: block;
          width: auto;
