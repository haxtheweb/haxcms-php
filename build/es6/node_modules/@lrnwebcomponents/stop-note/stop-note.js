import{LitElement as t,html as e,css as o}from"../../lit/index.js";import{remoteLinkBehavior as i}from"../utils/lib/remoteLinkBehavior.js";import{SimpleIconsetStore as s}from"../simple-icon/lib/simple-iconset.js";import{I18NMixin as n}from"../i18n-manager/lib/I18NMixin.js";import"../simple-icon/simple-icon.js";import{SimpleColors as r}from"../simple-colors/simple-colors.js";s.registerIconset("stopnoteicons",`${new URL("./stop-note.js",import.meta.url).href}/../lib/svgs/stopnoteicons/`);class StopNote extends(n(i(r))){static get styles(){return[...super.styles,o`
        :host {
          display: block;
          width: auto;
