...
*/class ResponsiveGridRow extends PolymerElement{static get template(){return html`
    ...
    `}static get tag(){return"responsive-grid-row"}static get properties(){return{/**
       ...
       */screen:{type:String,value:"xs",notify:!0,reflectToAttribute:!0}}}connectedCallback(){super.connectedCallback();window.ResponsiveUtility.requestAvailability();this.dispatchEvent(new CustomEvent("responsive-element",{bubbles:!0,cancelable:!0,composed:!0,detail:{element:root,attribute:"screen",relativeToParent:root.responsiveToParent}}))}}window.customElements.define(ResponsiveGridRow.tag,ResponsiveGridRow);export{ResponsiveGridRow};