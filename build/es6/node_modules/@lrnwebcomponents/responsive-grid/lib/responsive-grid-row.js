import{html,Polymer}from"../../../@polymer/polymer/polymer-legacy.js";import"../../responsive-utility/responsive-utility.js";import"./responsive-grid-col.js";import"./responsive-grid-clear.js";/**   
`responsive-grid-row`
A LRN element
...
*/let ResponsiveGridRow=Polymer({_template:html`
    <style>
      :host {
        display: block;
        width: 100%;
  ...
  `,is:"responsive-grid-row",properties:{/**
     ...
     */responsiveToParent:{type:Boolean,value:!1,reflectToAttribute:!0/* transition */ /* transition */},/*
     * screen size: xs, sm, md, lg, or xl
     */screen:{type:String,value:"xs",notify:!0,reflectToAttribute:!0}},attached:function(){let root=this;window.ResponsiveUtility.requestAvailability();root.fire("responsive-element",{element:root,attribute:"screen",relativeToParent:root.responsiveToParent})}});export{ResponsiveGridRow};