...
import { addDebouncer, dom, flush } from "../../@polymer/polymer/lib/legacy/polymer.dom.js";
...
class GrafittoFilter extends mixinBehaviors([Templatizer, OptionalMutableDataBehavior], PolymerElement) {
  static get template() {
    return html`
