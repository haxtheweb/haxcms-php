...
import "../item-overlay-ops/item-overlay-ops.js";
import "../lrnsys-outline/lrnsys-outline.js";
import "../simple-colors/simple-colors.js";
import "../simple-modal/simple-modal.js";
import "../editable-list/editable-list.js";
  ...
  _detailsModeChanged(newValue, oldValue) {
    if (typeof newValue !== typeof undefined) {
      ...
      if (this.selectedView === 0) {
        async.microTask.run(() => {
          setTimeout(() => {
            this.$.ironlist.dispatchEvent(new CustomEvent("iron-resize", {
              bubbles: true,
              cancelable: true,
              composed: true,
              detail: true
