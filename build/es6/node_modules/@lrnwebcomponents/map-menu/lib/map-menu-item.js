import{LitElement as e,html as t,css as i}from"../../../lit/index.js";import"../../simple-icon/lib/simple-icon-lite.js";import"../../simple-icon/lib/simple-icons.js";import{I18NMixin as n}from"../../i18n-manager/lib/I18NMixin.js";class MapMenuItem extends(n(e)){static get styles(){return[i`
        :host {
          display: block;
      ...
      <a tabindex="-1" href="${this.url}">
        <button id="wrapper" noink>
          ${this.icon?t` <simple-icon-lite icon="${this.icon}"></simple-icon-lite> `:t`<div class="no-icon"></div>`}
