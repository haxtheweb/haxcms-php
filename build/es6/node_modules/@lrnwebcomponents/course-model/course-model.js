 ...
 */
import{LitElement as i,html as e,css as t}from"../../lit/index.js";import"../../@google/model-viewer/dist/model-viewer.js";import"./lib/model-option.js";import"./lib/model-info.js";class CourseModel extends i{static get tag(){return"course-model"}static get properties(){return{visible:{type:String,reflect:!0},title:{type:String},src:{type:String},alt:{type:String}}}static get haxProperties(){return new URL(`./lib/${this.tag}.haxProperties.json`,import.meta.url).href}constructor(){super(),this.visible="model",this.title="",this.src="",this.addEventListener("model-select",this._srcChanged)}static get styles(){return[t`
        :host {
          display: block;
        }
    ...
    `}_openInfo(i){"model-info"==this.visible?this.visible="model":"model-info"!=this.visible&&(this.visible="model-info")}_openText(i){"model-text"==this.visible?this.visible="model":"model-text"!=this.visible&&(this.visible="model-text")}_openAnimation(i){"model-animation"==this.visible?this.visible="model":"model-animation"!=this.visible&&(this.visible="model-animation")}_openCheck(i){"model-check"==this.visible?this.visible="model":"model-check"!=this.visible&&(this.visible="model-check")}_srcChanged(i){this.src=i.detail.src,this.title=i.detail.title,this.visible="model"}}customElements.define(CourseModel.tag,CourseModel);export{CourseModel};