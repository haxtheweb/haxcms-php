...
class MtzMarkedEditor extends mixinBehaviors([IronFormElementBehavior, IronValidatableBehavior], PolymerElement) {
  static get template() {
    return html`
      <style>
        :host {
  ...
  connectedCallback() {
    ...
    this.__textarea = dom(this).queryDistributedElements('[slot="textarea"]')[0];
  }
