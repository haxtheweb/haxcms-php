 ...
 */
import{html as e,css as t}from"../../lit/index.js";import{HAXCMSLitElementTheme as s}from"../haxcms-elements/lib/core/HAXCMSLitElementTheme.js";import{HAXCMSRememberRoute as a}from"../haxcms-elements/lib/core/utils/HAXCMSRememberRoute.js";import{HAXCMSThemeParts as i}from"../haxcms-elements/lib/core/utils/HAXCMSThemeParts.js";import{store as o}from"../haxcms-elements/lib/core/haxcms-site-store.js";import{autorun as n,toJS as l}from"../../mobx/dist/mobx.esm.js";class TerribleThemes extends(a(i(s))){constructor(){super(),this.__disposer=[],n((e=>{this.activeManifestIndex=l(o.activeManifestIndex),this.__disposer.push(e)}))}static get styles(){let e=[];return super.styles&&(e=super.styles),[...e,t`
        :host {
          color: #242A31;
          width: 100%;
          margin: 0;
...
<tr><!-- Footer -->
    ...
    `}static get tag(){return"terrible-themes"}firstUpdated(e){super.firstUpdated&&super.firstUpdated(e)}disconnectedCallback(){for(var e in this.__disposer)this.__disposer[e].dispose();super.disconnectedCallback()}prevPage(e){super.prevPage(e)}nextPage(e){super.nextPage(e)}}customElements.define(TerribleThemes.tag,TerribleThemes);export{TerribleThemes};