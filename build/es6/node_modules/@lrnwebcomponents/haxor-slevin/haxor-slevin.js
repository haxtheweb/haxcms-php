...
import { HAXCMSTheme } from "../haxcms-elements/lib/core/HAXCMSThemeWiring.js";
...
class HaxorSlevin extends HAXCMSTheme(PolymerElement) {
  ...
  constructor() {
    ...
    import("../simple-blog-card/simple-blog-card.js");
  ...
  connectedCallback() {
    ...
    autorun(reaction => {
      ...
      if (store.activeItem && store.activeItem.metadata && store.activeItem.metadata.fields && store.activeItem.metadata.fields.subtitle) {
      ...
      if (store.activeItem && store.activeItem.metadata && store.activeItem.metadata.fields && store.activeItem.metadata.fields.images && store.activeItem.metadata.fields.images[0] && store.activeItem.metadata.fields.images[0].src) {
