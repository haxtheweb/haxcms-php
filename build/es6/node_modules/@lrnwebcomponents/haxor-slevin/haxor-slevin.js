 ...
 */
import{html as e,css as t}from"../../lit/index.js";import{HAXCMSLitElementTheme as i}from"../haxcms-elements/lib/core/HAXCMSLitElementTheme.js";import{store as a}from"../haxcms-elements/lib/core/haxcms-site-store.js";import{autorun as s,toJS as o}from"../../mobx/dist/mobx.esm.js";import{HAXCMSThemeParts as r}from"../haxcms-elements/lib/core/utils/HAXCMSThemeParts.js";import{SimpleColorsSuper as n}from"../simple-colors/simple-colors.js";import{varExists as l,varGet as c}from"../utils/utils.js";import"../anchor-behaviors/anchor-behaviors.js";import"../simple-icon/lib/simple-icon-lite.js";import"../simple-icon/lib/simple-icon-button-lite.js";import"../simple-icon/lib/simple-icons.js";import"../haxcms-elements/lib/ui-components/layout/site-region.js";import"../full-width-image/full-width-image.js";import"../haxcms-elements/lib/ui-components/query/site-query.js";import"../date-card/lib/date-chip.js";import"../accent-card/accent-card.js";import"../../@polymer/iron-pages/iron-pages.js";class HaxorSlevin extends(r(n(i))){static get styles(){return[...super.styles,t`
        :host {
          display: block;
          ...
          <div id="home">
            ...
            ></site-query>
              ${this.__mainPosts.map((t=>e`
                <a class="article-link" href="${t.slug}">
                <accent-card 
                image-align="center"
                image-valign="top" 
                accent-background
                ...
                <p slot="content">
                  <date-chip unix timestamp="${t.metadata.created}" accent-color="${this.color}"></date-chip>
                  ${t.description}
                </p>
              </accent-card></a>`))}
          </div>
          <main class="contentcontainer-wrapper">
            ...
            ></site-query>
              ${this.__followUpPosts.map((t=>e`
                ...
                <div slot="subheading"><simple-datetime unix timestamp="${t.metadata.created}"></simple-datetime></div>
                <div slot="content">
                  <p>
                  ${t.description}
                  </p>
