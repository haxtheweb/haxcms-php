 ...
 */class ProductOffering extends(r(t)){constructor(){super(),this.alt="",this.accentColor="blue",this.dark=!1}static get styles(){let e=[];return super.styles&&(e=super.styles),[...e,i`
        :host {
          display: block;
