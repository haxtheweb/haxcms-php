import{LitElement,html,css}from"../../lit-element/lit-element.js";import"../cms-hax/cms-hax.js";class WysiwygHax extends LitElement{static get styles(){return[css`:host{display:block}`]}render(){return html`<textarea class=${this.fieldClass} id=${this.fieldId} name=${this.fieldName} hidden="">
      ${this.bodyValue}
