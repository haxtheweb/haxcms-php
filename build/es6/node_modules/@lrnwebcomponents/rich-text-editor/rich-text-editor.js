 ...
 */import{html,PolymerElement}from"../../@polymer/polymer/polymer-element.js";import{HAXWiring}from"../hax-body-behaviors/lib/HAXWiring.js";import"../../@polymer/iron-a11y-keys/iron-a11y-keys.js";import"./lib/rich-text-editor-styles.js";import"./lib/rich-text-editor-toolbar.js";/**
 * `rich-text-editor`
...
let id=document.querySelector("rich-text-editor-toolbar#"+this.editorId),editor=null!==id?id:document.querySelector("rich-text-editor-toolbar");if(null===editor){editor=document.createElement("rich-text-editor-toolbar");this.parentNode.appendChild(editor)}editor.addEditableRegion(this)}/**
