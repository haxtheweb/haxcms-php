 ...
 */import{html,PolymerElement}from"../../../@polymer/polymer/polymer-element.js";import"../../../@polymer/paper-button/paper-button.js";import"../../../@polymer/paper-tooltip/paper-tooltip.js";import"../../../@polymer/iron-icons/iron-icons.js";import"./rich-text-editor-styles.js";/**
...
static get properties(){return{/**
       ...
       */commandVal:{name:"commandVal",type:"Object",value:null,notify:!0/* transition */ /* transition */},/**
   ...
   */ready(){super.ready();let root=this;root.addEventListener("mousedown",function(e){e.preventDefault()});root.addEventListener("keydown",function(e){e.preventDefault()})}/**
   ...
   */doTextOperation(){let root=this,selection=root.selection;if(root.toggled&&null!==root.toggledCommand){document.execCommand(root.toggledCommand,!1,root.toggledCommand||"")}else if(null!==root.command){document.execCommand(root.command,!1,root.commandVal||"")}root.selection=selection}/**
   * determine if the button is toggled
   *
   * @param {object} the text selection
   * @returns {boolean} whether the button is toggled
   *
   */_isToggled(selection){let toggled=null!==this.command&&this.toggles?document.queryCommandState(this.command):!1,label=this._regOrToggled(this.label,this.toggledLabel,toggled);if(this.$.label!==void 0)this.$.label.innerHTML=label;if(this.$.tooltip!==void 0)this.$.tooltip.innerHTML=label;return toggled}/**
   * determine if the button is toggled
   *
   * @param {object} the text selection
   * @returns {string} the label based on whether or not the button is toggled
   *
   */_getLabel(selection){let toggled=null!==this.command&&this.toggles?document.queryCommandState(this.command):!1,label=this._regOrToggled(this.label,this.toggledLabel,toggled);return label}/**
   * Handles button tap;
