 ...
 */import{html,PolymerElement}from"../../../@polymer/polymer/polymer-element.js";import"../../../@polymer/iron-a11y-keys/iron-a11y-keys.js";import"../../simple-popover/simple-popover.js";import"../../simple-fields/simple-fields.js";import"./rich-text-editor-button-styles.js";// register globally so we can make sure there is only one
...
if(!window.richTextEditorPrompt.instance){window.richTextEditorPrompt.instance=this;return this}}/**
   ...
   * Handles button tap;
   */_confirm(e){e.preventDefault();this.__el.value=this.value;this.__el.updateSelection();this.clearTarget()}}window.customElements.define(richTextEditorPrompt.tag,richTextEditorPrompt);export{richTextEditorPrompt};