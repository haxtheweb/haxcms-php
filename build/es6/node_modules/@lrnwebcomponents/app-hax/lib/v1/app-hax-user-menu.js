import{LitElement as e,html as t,css as o}from"../../../../lit/index.js";export class AppHaxUserMenu extends e{static get tag(){return"app-hax-user-menu"}constructor(){super(),this.isOpen=!1,this.icon="account-circle"}static get properties(){return{isOpen:{type:Boolean,reflect:!0},icon:{type:String,reflect:!0}}}static get styles(){return o`
      :host {
    ...
    `}toggleMenu(){this.isOpen=!this.isOpen}render(){return t`
