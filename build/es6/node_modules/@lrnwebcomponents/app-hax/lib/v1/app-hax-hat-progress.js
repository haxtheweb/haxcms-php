import{html as e,css as t}from"../../../../lit/index.js";import{SimpleColors as s}from"../../../simple-colors/simple-colors.js";import{autorun as r,toJS as o}from"../../../../mobx/dist/mobx.esm.js";import{store as i}from"./AppHaxStore.js";import"../../../promise-progress/promise-progress.js";export class AppHaxHatProgress extends s{static get tag(){return"app-hax-hat-progress"}constructor(){super(),this.promises=[],this.max=100,r((()=>{this.promises=o(i.newSitePromiseList)})),r((()=>{this.dark=o(i.darkMode)}))}static get properties(){return{...super.properties,promises:{type:Array}}}process(){this.shadowRoot.querySelector("#progress2").process()}firstUpdated(e){super.firstUpdated&&super.firstUpdated(e),this.dispatchEvent(new CustomEvent("progress-ready",{detail:!0})),setTimeout((()=>{this.shadowRoot.querySelector("#progress2").addEventListener("value-changed",(e=>{this.shadowRoot.querySelector("#value").textContent=e.detail.value})),this.shadowRoot.querySelector("#progress2").addEventListener("max-changed",(e=>{this.max=e.detail.value})),this.shadowRoot.querySelector("#progress2").addEventListener("promise-progress-finished",(e=>{if(e.detail.value){this.shadowRoot.querySelector(".game")&&this.shadowRoot.querySelector(".game").remove();const e=i.AppHaxAPI.lastResponse.createSite.data,t=document.createElement("button");this.shadowRoot.querySelector("#value").textContent=this.max,t.textContent="Let's go!",t.classList.add("game"),t.addEventListener("pointerdown",(()=>{i.appEl.playSound("click")})),t.addEventListener("click",(()=>{window.location=o(i.sitesBase).concat(e.slug)})),this.shadowRoot.querySelector("#progress2").parentNode.appendChild(t),i.toast(`${e.title} ready!`,1500,{hat:"random",walking:!0}),setTimeout((()=>{i.toast("redirecting in 3..",1e4,{hat:"random",walking:!0}),setTimeout((()=>{i.toast("redirecting in 2..",1e4,{hat:"random",walking:!0}),setTimeout((()=>{i.toast("redirecting in 1..",1e4,{hat:"random",walking:!0}),setTimeout((()=>{window.location=o(i.sitesBase).concat(e.slug)}),1e3)}),1e3)}),1e3)}),1800),this.dispatchEvent(new CustomEvent("promise-progress-finished",{composed:!0,bubbles:!0,cancelable:!0,detail:!0}))}}))}),0)}static get styles(){return[...super.styles,t`
        :host {
          display: block;
          height: 400px;
          width: 400px;
