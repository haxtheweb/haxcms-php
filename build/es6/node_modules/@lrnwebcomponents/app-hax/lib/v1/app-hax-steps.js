import{html as t,css as e,unsafeCSS as s}from"../../../../lit/index.js";import{SimpleColors as i}from"../../../simple-colors/simple-colors.js";import{autorun as o,toJS as a}from"../../../../mobx/dist/mobx.esm.js";import{store as p}from"./AppHaxStore.js";import{localStorageSet as r}from"../../../utils/utils.js";import"../../../../scrollable-component/index.js";import"../../../simple-icon/lib/simple-icon-lite.js";import{MicroFrontendRegistry as n}from"../../../micro-frontend-registry/micro-frontend-registry.js";import{enableServices as l}from"../../../micro-frontend-registry/lib/microServices.js";import"./app-hax-site-button.js";import"./app-hax-hat-progress.js";import"./app-hax-button.js";const c=new URL("../assets/images/Home.svg",import.meta.url).href,h=new URL("../assets/images/DisabledCircle.svg",import.meta.url).href,d=new URL("../assets/images/TransparentCircle.svg",import.meta.url).href,m=new URL("../assets/images/EnabledCircle.svg",import.meta.url).href,u={portfolio:["haxor-slevin","bootstrap-theme"],blog:["haxor-slevin"],course:["clean-one","clean-two","learn-two-theme"],website:["polaris-theme"],import:["clean-one","clean-two","learn-two-theme"]};export class AppHaxSteps extends i{static get tag(){return"app-hax-steps"}constructor(){super(),this.unlockComingSoon=!1,this.unlockTerrible=!1,this.windowControllers=new AbortController,this.nameTyped="",this.stepRoutes=[],this._progressReady=!1,this.step=null,this.loaded=!1,this.themeNames=[],this.appSettings={},o((()=>{this.appSettings=a(p.appSettings);const t=a(p.site.structure);this.themeNames=Object.keys(this.appSettings.themes).filter((e=>t&&u[t]&&u[t].includes(e)))})),o((()=>{this.dark=a(p.darkMode)})),o((()=>{r("app-hax-step",a(p.step))})),o((()=>{r("app-hax-site",a(p.site)),this.step=p.stepTest(this.step)})),o((()=>{a(p.createSiteSteps)&&a(p.location)&&(this.step=p.stepTest(this.step))})),o((()=>{const t=a(p.routes);this.stepRoutes=t.filter((t=>t.step))}))}static get properties(){return{...super.properties,step:{type:Number,reflect:!0},stepRoutes:{type:Array},themeNames:{type:Array},unlockComingSoon:{type:Boolean,reflect:!0,attribute:"unlock-coming-soon"},unlockTerrible:{type:Boolean,reflect:!0,attribute:"unlock-terrible"},loaded:{type:Boolean,reflect:!0},appSettings:{type:Object},nameTyped:{type:String}}}chooseStructure(t){if(!t.target.comingSoon){const{value:e}=t.target;p.site.structure=e,"course"===e&&(p.site.type="own",p.site.theme="clean-one"),"blog"===e&&(p.site.type="own",p.site.theme="haxor-slevin"),"portfolio"===e&&(p.site.type="own",p.site.theme="haxor-slevin"),"website"===e&&(p.site.type="own",p.site.theme="polaris-theme"),p.appEl.playSound("click2")}}chooseType(t){if(!t.target.comingSoon){const{type:e}=t.target;p.site.type=e,p.appEl.playSound("click2")}}async docxImport(t){if(!t.target.comingSoon){const{type:e}=t.target;import("../../../file-system-broker/lib/docx-file-system-broker.js").then((async t=>{l(["haxcms"]);const s=window.FileSystemBroker.requestAvailability(),i=await s.loadFile("docx"),o=new FormData;o.append("method","site"),o.append("type",a(p.site.structure)),o.append("upload",i),this.setProcessingVisual();const r=await n.call("@haxcms/docxToSite",o);p.toast("Processed!",300),200==r.status&&r.data&&""!=r.data.contents?(p.items=r.data.items,r.data.files&&(p.itemFiles=r.data.files),this.nameTyped=r.data.filename.replace(".docx","").replace("outline","").replace(/\s/g,"").replace(/-/g,"").toLowerCase(),setTimeout((()=>{this.shadowRoot.querySelector("#sitename").value=this.nameTyped,this.shadowRoot.querySelector("#sitename").select()}),800),p.site.type=e,p.site.theme="clean-one",p.appEl.playSound("click2")):(p.appEl.playSound("error"),p.toast("File did not return valid HTML structure"))}))}}async evoImport(t){if(!t.target.comingSoon){const{type:e}=t.target;import("../../../file-system-broker/file-system-broker.js").then((async t=>{l(["haxcms"]);const s=window.FileSystemBroker.requestAvailability(),i=await s.loadFile("zip"),o=new FormData;o.append("method","site"),o.append("type",a(p.site.structure)),o.append("upload",i),this.setProcessingVisual();const r=await n.call("@haxcms/evolutionToSite",o,null,null,"?jwt="+a(p.AppHaxAPI.jwt));p.toast("Processed!",300),200==r.status&&r.data&&""!=r.data.contents?(p.items=r.data.items,this.nameTyped=r.data.filename.replace(".zip","").replace("outline","").replace(/\s/g,"").replace(/-/g,"").toLowerCase(),setTimeout((()=>{this.shadowRoot.querySelector("#sitename").value=this.nameTyped,this.shadowRoot.querySelector("#sitename").select()}),800),p.site.type=e,p.site.theme="clean-one",p.appEl.playSound("click2")):(p.appEl.playSound("error"),p.toast("File did not return valid HTML structure"))}))}}async gbImport(t){if(!t.target.comingSoon){const{type:e}=t.target;let s=window.prompt("URL for the Gitbook repo");l(["haxcms"]),this.setProcessingVisual();const i=await n.call("@haxcms/gitbookToSite",{md:s});p.toast("Processed!",300),200==i.status&&i.data&&""!=i.data.contents?(p.items=i.data.items,i.data.files&&(p.itemFiles=i.data.files),this.nameTyped=i.data.filename.replace(/\s/g,"").replace(/-/g,"").toLowerCase(),setTimeout((()=>{this.shadowRoot.querySelector("#sitename").value=this.nameTyped,this.shadowRoot.querySelector("#sitename").select()}),800),p.site.type=e,p.site.theme="clean-one",p.appEl.playSound("click2")):(p.appEl.playSound("error"),p.toast("Repo did not return valid structure"))}}async importFromURL(t){const{type:e,prompt:s,callback:i,param:o}=t.target;if(!t.target.comingSoon){let t=window.prompt(s);l(["haxcms"]),this.setProcessingVisual();const a={};a[o]=t;const r=await n.call(i,a);p.toast("Processed!",300),200==r.status&&r.data&&""!=r.data.contents?(p.items=r.data.items,r.data.files&&(p.itemFiles=r.data.files),this.nameTyped=r.data.filename.replace(/\s/g,"").replace(/-/g,"").toLowerCase(),setTimeout((()=>{this.shadowRoot.querySelector("#sitename").value=this.nameTyped,this.shadowRoot.querySelector("#sitename").select()}),800),p.site.type=e,p.site.theme="clean-one",p.appEl.playSound("click2")):(p.appEl.playSound("error"),p.toast("Repo did not return valid structure"))}}async notionImport(t){if(!t.target.comingSoon){const{type:e}=t.target;let s=window.prompt("URL for the Github Notion repo");l(["haxcms"]),this.setProcessingVisual();const i=await n.call("@haxcms/notionToSite",{repoUrl:s});p.toast("Processed!",300),200==i.status&&i.data&&""!=i.data.contents?(p.items=i.data.items,i.data.files&&(p.itemFiles=i.data.files),this.nameTyped=i.data.filename.replace(/\s/g,"").replace(/-/g,"").toLowerCase(),setTimeout((()=>{this.shadowRoot.querySelector("#sitename").value=this.nameTyped,this.shadowRoot.querySelector("#sitename").select()}),800),p.site.type=e,p.site.theme="clean-one",p.appEl.playSound("click2")):(p.appEl.playSound("error"),p.toast("Repo did not return valid structure"))}}async pressbooksImport(t){if(!t.target.comingSoon){const{type:e}=t.target;import("../../../file-system-broker/lib/docx-file-system-broker.js").then((async t=>{l(["haxcms"]);const s=window.FileSystemBroker.requestAvailability(),i=await s.loadFile("html"),o=new FormData;o.append("method","site"),o.append("type",a(p.site.structure)),o.append("upload",i),this.setProcessingVisual();const r=await n.call("@haxcms/pressbooksToSite",o);p.toast("Processed!",300),200==r.status&&r.data&&""!=r.data.contents?(p.items=r.data.items,r.data.files&&(p.itemFiles=r.data.files),this.nameTyped=r.data.filename.replace(".html","").replace("outline","").replace(/\s/g,"").replace(/-/g,"").toLowerCase(),setTimeout((()=>{this.shadowRoot.querySelector("#sitename").value=this.nameTyped,this.shadowRoot.querySelector("#sitename").select()}),800),p.site.type=e,p.site.theme="clean-one",p.appEl.playSound("click2")):(p.appEl.playSound("error"),p.toast("File did not return valid HTML structure"))}))}}setProcessingVisual(){let t=document.createElement("simple-icon-lite");t.icon="hax:loading",t.style.setProperty("--simple-icon-height","40px"),t.style.setProperty("--simple-icon-width","40px"),t.style.height="150px",t.style.marginLeft="8px",p.toast("Processing",6e4,{hat:"construction",slot:t})}chooseTheme(t){if(!t.target.comingSoon){const{value:e}=t.target;p.site.theme=e,p.appEl.playSound("click2")}}chooseName(){if(""!==this.nameTyped){const t=this.shadowRoot.querySelector("#sitename").value;p.site.name=t,p.appEl.playSound("click2")}}progressReady(t){t.detail&&(this._progressReady=!0,5===this.step&&setTimeout((()=>{this.shadowRoot.querySelector("app-hax-hat-progress").process()}),300))}updated(t){super.updated&&super.updated(t),t.forEach(((t,e)=>{if(4===this.step&&"step"===e&&this.shadowRoot&&(this.shadowRoot.querySelector("#sitename").value=a(p.site.name)),5===this.step&&"step"===e&&this.shadowRoot&&this._progressReady&&setTimeout((()=>{this.shadowRoot.querySelector("app-hax-hat-progress").process()}),600),"step"===e&&(p.step=this.step),"unlockTerrible"===e&&this[e]){Object.keys(u).forEach((t=>{u[t]=[...u[t],"terrible-themes","terrible-productionz-themes","terrible-outlet-themes","terrible-best-themes","terrible-resume-themes"]}));const t=a(p.site.structure);this.themeNames=Object.keys(this.appSettings.themes).filter((e=>t&&u[t]&&u[t].includes(e)))}}))}connectedCallback(){super.connectedCallback(),window.addEventListener("resize",this.maintainScroll.bind(this),{signal:this.windowControllers.signal}),window.addEventListener("popstate",this.popstateListener.bind(this),{signal:this.windowControllers.signal})}disconnectedCallback(){this.windowControllers.abort(),super.disconnectedCallback()}popstateListener(t){if("popstate"===t.type&&null===t.state)try{setTimeout((()=>{const e=t.target.document.location.pathname.split("/").pop();if(e.includes("createSite")){const t=parseInt(e.replace("createSite-step-",""));t<p.stepTest(t)?this.shadowRoot.querySelector("#link-step-"+t).click():t>p.stepTest(t)&&(p.toast("Please select an option"),this.step=p.stepTest(t),this.shadowRoot.querySelector("#link-step-"+this.step).click())}}),0)}catch(t){}}maintainScroll(){this.shadowRoot&&this.step&&(this.scrollToThing(`#step-${this.step}`,{behavior:"instant",block:"start",inline:"nearest"}),setTimeout((()=>{this.scrollToThing(`#step-${this.step}`,{behavior:"instant",block:"start",inline:"nearest"})}),100))}firstUpdated(t){super.firstUpdated&&super.firstUpdated(t),setTimeout((()=>{null===this.step&&(this.step=1),this.scrollToThing(`#step-${this.step}`,{behavior:"instant",block:"start",inline:"nearest"})}),100),o((()=>{if(a(p.createSiteSteps)&&a(p.appReady)){const t=a(p.location);t.route&&t.route.step&&t.route.name&&setTimeout((()=>{this.scrollToThing("#".concat(t.route.name),{behavior:"smooth",block:"start",inline:"nearest"}),4===t.route.step&&4===p.stepTest(4)&&setTimeout((()=>{this.shadowRoot.querySelector("#sitename").focus(),this.scrollToThing("#step-4",{behavior:"instant",block:"start",inline:"nearest"})}),800)}),300)}})),o((()=>{if(this.shadowRoot&&a(p.createSiteSteps)&&a(p.appReady)){const t=a(p.activeItem);t&&t.name&&t.step&&!this.__overrideProgression&&this.shadowRoot.querySelector("#link-".concat(t.name)).click()}}))}scrollToThing(t,e){const s=void 0!==window.safari;this.shadowRoot.querySelector(".carousel-with-snapping-item.active-step")&&this.shadowRoot.querySelector(".carousel-with-snapping-item.active-step").classList.remove("active-step"),s?this.shadowRoot.querySelector(t).scrollIntoView():this.shadowRoot.querySelector(t).scrollIntoView(e),this.shadowRoot.querySelector(t).classList.add("active-step")}static get styles(){return[...super.styles,e`
        :host {
          display: block;
        }
          ...
          <div class="carousel-with-snapping-track">
            ...
            <div class="carousel-with-snapping-item" id="step-4">
              <input
                ...
                maxlength="30"
                placeholder="${a(p.site.structure)} name.."
