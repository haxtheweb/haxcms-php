          ...
          ${this.stepRoutes.map(((e,s)=>t`<li
              ...
              >
                <a
                  ...
                  >${s+1}</a
                >
                <simple-tooltip for="link-${e.id}" position="bottom"
