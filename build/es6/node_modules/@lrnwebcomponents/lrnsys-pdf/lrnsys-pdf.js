 ...
 */import{html,PolymerElement}from"../../@polymer/polymer/polymer-element.js";import{SchemaBehaviors}from"../schema-behaviors/schema-behaviors.js";/**
 * `lrnsys-pdf`
 * @demo demo/index.html
 */class LrnsysPdf extends SchemaBehaviors(PolymerElement){constructor(){super();import("../pdf-browser-viewer/pdf-browser-viewer.js")}static get template(){return html`
    <style>
      :host {
        display: block;
      }
    ...
    ></pdf-browser-viewer>`}static get tag(){return"lrnsys-pdf"}static get properties(){let props={/**
