import{html,PolymerElement}from"../../../@polymer/polymer/polymer-element.js";import{LrndesignGalleryBehaviors}from"./lrndesign-gallery-behaviors.js";import"./lrndesign-gallery-details.js";import"./lrndesign-gallery-zoom.js";export{LrndesignGalleryCarousel};class LrndesignGalleryCarousel extends LrndesignGalleryBehaviors{static get tag(){return"lrndesign-gallery-carousel"}static get behaviors(){return[LrndesignGalleryBehaviors]}static get template(){return html`
    ...
    `}static get properties(){return{__imageStyle:{type:String,computed:"_getImageStyle(extraWide,responsiveSize)"}}}ready(){super.ready();if(this.selected.scroll){let target=this.$.carouselitem;this._scrollIntoView([this._getParentOffset(target)]);if(!this.selected.zoomed)target.focus()}}goToItem(index){let root=this;if("number"===typeof index&&0<=index&&index<root.items.length){root.selected=root.items[index]}}_getImageStyle(extraWide,responsiveSize){if(extraWide||"xs"===responsiveSize){return"padding-bottom: "+100/this.aspectRatio+"%;"}else{if("xl"===responsiveSize){return"width: "+400*this.aspectRatio+"px; height: 400px;"}else if("lg"===responsiveSize){return"width: "+300*this.aspectRatio+"px; height: 300px;"}else if("md"===responsiveSize){return"width: "+200*this.aspectRatio+"px; height: 200px;"}else{return"width: "+200*this.aspectRatio+"px; height: 200px;"}}}_getIndex(index,step){return index+step}_hideNav(items){return items!==void 0?2>items.length:!0}_onPrev(){this.goToItem(parseInt(this.$.carouselprev.getAttribute("index")))}_onNext(){this.goToItem(parseInt(this.$.carouselnext.getAttribute("index")))}_onNavTapped(e){this.goToItem(e.model.item.index)}_updateDetails(){this.$.itembody.innerHTML=this.item.details}}window.customElements.define(LrndesignGalleryCarousel.tag,LrndesignGalleryCarousel);