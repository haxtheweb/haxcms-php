...
// in `update`.
this._needsShimAdoptedStyleSheets=!0/* transition */ /* transition */}}connectedCallback(){super.connectedCallback();// Note, first update/render handles styleElement so we only call this if
