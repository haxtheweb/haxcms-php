...
input.style.removeProperty("max-width");inputField.style.removeProperty("display");inputField.scrollTop=scrollTop;if(this.__previousInputHeight&&this.__previousInputHeight!==inputHeight){this.dispatchEvent(new CustomEvent("iron-resize",{bubbles:!0/* transition */ /* transition */}))}this.__previousInputHeight=inputHeight}/**
