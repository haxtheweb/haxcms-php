 ...
 */export const ArrayDataProviderMixin=superClass=>class ArrayDataProviderMixin extends superClass{static get properties(){return{/**
   ...
   * @param {Array}  items
   */_checkPaths(arrayToCheck,action,items){if(!items.length){return!1}let result=!0/* transition */ /* transition */;for(var i in arrayToCheck){const path=arrayToCheck[i].path;// skip simple paths
