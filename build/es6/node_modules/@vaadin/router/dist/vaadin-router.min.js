...
class D {
  ...
  resolve(t) {
    ...
    function c(t, u = o.value.route, a) {
      ...
      }(e, o.value), s = Object.assign({}, e, o.value), Promise.resolve(r(s)).then(e => null !== e && void 0 !== e && e !== p ? (s.result = e.result || e, s) : c(t, u, e))) : (i = o, Promise.resolve(p));
    }
...
class it extends D {
  constructor(t, e) {
    ...
    it.setTriggers.apply(it, Object.keys(o).map(t => o[t])), this.baseUrl, this.ready, this.ready = Promise.resolve(t), this.location, this.location = Y({
      resolver: this
    }), this.p = 0, this.m = this.v.bind(this), this.setOutlet(t), this.subscribe(), this._ = new WeakMap(), this.g = new WeakMap();
  }
  ...
  A(t, e = t) {
    return this.D(e).then(n => {
      ...
      return n.next().then(t => {
        ...
        return t && t !== p ? this.A(r, t) : this.F(n);
      });
    });
  }
  ...
  M(t, e) {
    this.O(), this.G();
    const n = this.B(t, e);
    this.X = [], this.Y = Array.from(n.children).filter(e => this.g.get(e) && e !== t.result);
    let r = n;

    for (let e = t.q; e < t.chain.length; e++) {
      const o = t.chain[e].element;
      o && (r.appendChild(o), this.g.set(o, !0), r === n && this.X.push(o), r = o);
    }
  }
