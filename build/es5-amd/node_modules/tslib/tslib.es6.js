define(["exports"], function (_exports) {
  ...
  ***************************************************************************** */
  ...
  function __esDecorate(ctor, descriptorIn, decorators, contextIn, initializers, extraInitializers) {
    ...
    for (var i = decorators.length - 1; i >= 0; i--) {
      ...
      if (kind === "accessor") {
        ...
        if (result === null || babelHelpers.typeof(result) !== "object") throw new TypeError("Object expected");
  ...
  function __propKey(x) {
    return babelHelpers.typeof(x) === "symbol" ? x : "".concat(x);
  }
  ;
  function __setFunctionName(f, name, prefix) {
    if (babelHelpers.typeof(name) === "symbol") name = name.description ? "[".concat(name.description, "]") : "";
