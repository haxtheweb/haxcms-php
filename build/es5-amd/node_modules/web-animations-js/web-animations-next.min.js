...
!function () {
  ...
  !function (a, b) {
    ...
    var f = function f(a) {
      if (a._animation = void 0, babelHelpers.instanceof(a, window.SequenceEffect) || babelHelpers.instanceof(a, window.GroupEffect)) for (var b = 0; b < a.children.length; b++) f(a.children[b]);
    };
