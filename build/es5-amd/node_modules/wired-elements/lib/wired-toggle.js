define(["exports", "./wired-base.js", "./wired-lib.js", "../../lit/index.js", "../../lit/decorators.js"], function (_exports, _wiredBase, _wiredLib, _index, _decorators) {
  ...
  var _templateObject_59d28af03dc711eda79ddd1a980dc0e1, _templateObject2_59d28af03dc711eda79ddd1a980dc0e1;
  ...
  var WiredToggle = /*#__PURE__*/function (_WiredBase) {
    ...
    babelHelpers.createClass(WiredToggle, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_59d28af03dc711eda79ddd1a980dc0e1 || (_templateObject_59d28af03dc711eda79ddd1a980dc0e1 = babelHelpers.taggedTemplateLiteral(["\n    <div style=\"position: relative;\">\n      <svg></svg>\n      <input type=\"checkbox\" .checked=\"", "\" ?disabled=\"", "\"  @change=\"", "\">\n    </div>\n    "])), this.checked, this.disabled, this.onChange);
      }
    }, {
      key: "focus",
      ...
      key: "styles",
      get: function get() {
        return [_wiredBase.BaseCSS, (0, _index.css)(_templateObject2_59d28af03dc711eda79ddd1a980dc0e1 || (_templateObject2_59d28af03dc711eda79ddd1a980dc0e1 = babelHelpers.taggedTemplateLiteral(["\n      :host {\n        display: inline-block;\n        cursor: pointer;\n        position: relative;\n        outline: none;\n      }\n      :host([disabled]) {\n        opacity: 0.4 !important;\n        cursor: default;\n        pointer-events: none;\n      }\n      :host([disabled]) svg {\n        background: rgba(0, 0, 0, 0.07);\n      }\n      input {\n        position: absolute;\n        top: 0;\n        left: 0;\n        width: 100%;\n        height: 100%;\n        box-sizing: border-box;\n        cursor: pointer;\n        opacity: 0;\n      }\n      .knob {\n        transition: transform 0.3s ease;\n      }\n      .knob path {\n        stroke-width: 0.7;\n      }\n      .knob.checked {\n        transform: translateX(48px);\n      }\n      path.knobfill {\n        stroke-width: 3 !important;\n        fill: transparent;\n      }\n      .knob.unchecked path.knobfill {\n        stroke: var(--wired-toggle-off-color, gray);\n      }\n      .knob.checked path.knobfill {\n        stroke: var(--wired-toggle-on-color, rgb(63, 81, 181));\n      }\n      "])))];
      }
    }]);
    return WiredToggle;
