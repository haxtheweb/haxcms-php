define(["exports", "./wired-base.js", "./wired-lib.js", "../../lit/index.js", "../../lit/decorators.js"], function (_exports, _wiredBase, _wiredLib, _index, _decorators) {
  ...
  var _templateObject_42e1fe50d3e211ed8e5073e3aa96f674, _templateObject2_42e1fe50d3e211ed8e5073e3aa96f674;
  ...
  var WiredButton = /*#__PURE__*/function (_WiredBase) {
    ...
    babelHelpers.createClass(WiredButton, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_42e1fe50d3e211ed8e5073e3aa96f674 || (_templateObject_42e1fe50d3e211ed8e5073e3aa96f674 = babelHelpers.taggedTemplateLiteral(["\n    <button ?disabled=\"", "\">\n      <slot @slotchange=\"", "\"></slot>\n      <div id=\"overlay\">\n        <svg></svg>\n      </div>\n    </button>\n    "])), this.disabled, this.wiredRender);
      }
    }, {
      key: "focus",
      ...
      key: "styles",
      get: function get() {
        return [_wiredBase.BaseCSS, (0, _index.css)(_templateObject2_42e1fe50d3e211ed8e5073e3aa96f674 || (_templateObject2_42e1fe50d3e211ed8e5073e3aa96f674 = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: inline-block;\n          font-size: 14px;\n        }\n        path {\n          transition: transform 0.05s ease;\n        }\n        button {\n          position: relative;\n          user-select: none;\n          border: none;\n          background: none;\n          font-family: inherit;\n          font-size: inherit;\n          cursor: pointer;\n          letter-spacing: 1.25px;\n          text-transform: uppercase;\n          text-align: center;\n          padding: 10px;\n          color: inherit;\n          outline: none;\n        }\n        button[disabled] {\n          opacity: 0.6 !important;\n          background: rgba(0, 0, 0, 0.07);\n          cursor: default;\n          pointer-events: none;\n        }\n        button:active path {\n          transform: scale(0.97) translate(1.5%, 1.5%);\n        }\n        button:focus path {\n          stroke-width: 1.5;\n        }\n        button::-moz-focus-inner {\n          border: 0;\n        }\n      "])))];
      }
    }]);
    return WiredButton;
