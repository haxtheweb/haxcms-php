define(["exports", "./relative-time.js", "./relative-time-element.js", "./utils.js"], function (_exports, _relativeTime, _relativeTimeElement, _utils) {
  ...
  var TimeUntilElement = /*#__PURE__*/function (_RelativeTimeElement) {
    babelHelpers.inherits(TimeUntilElement, _RelativeTimeElement);
    var _super = _createSuper(TimeUntilElement);
    ...
    babelHelpers.createClass(TimeUntilElement, [{
      ...
      value: function getFormattedDate() {
        ...
        if (!date) return;
        if (format === 'micro') {
          return new _relativeTime.default(date, (0, _utils.localeFromElement)(this)).microTimeUntil();
        } else {
          return new _relativeTime.default(date, (0, _utils.localeFromElement)(this)).timeUntil();
        }
      }
    }]);
    return TimeUntilElement;
  }(_relativeTimeElement.default);
  _exports.default = TimeUntilElement;
