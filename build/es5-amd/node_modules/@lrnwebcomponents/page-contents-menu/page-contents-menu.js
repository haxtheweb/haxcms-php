define(["exports", "require", "../../lit-element/lit-element.js", "../utils/utils.js"], function (_exports, _require, _litElement, _utils) {
  ...
  var _templateObject_715deb50b2b411eb9e5c9b5d1881fac2, _templateObject2_715deb50b2b411eb9e5c9b5d1881fac2, _templateObject3_715deb50b2b411eb9e5c9b5d1881fac2, _templateObject4_715deb50b2b411eb9e5c9b5d1881fac2, _templateObject5_715deb50b2b411eb9e5c9b5d1881fac2, _templateObject6_715deb50b2b411eb9e5c9b5d1881fac2, _templateObject7_715deb50b2b411eb9e5c9b5d1881fac2;
  ...
  var PageContentsMenu = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(PageContentsMenu, [{
      ...
      function render() {
        ...
        return (0, _litElement.html)(_templateObject_715deb50b2b411eb9e5c9b5d1881fac2 || (_templateObject_715deb50b2b411eb9e5c9b5d1881fac2 = babelHelpers.taggedTemplateLiteral(["\n      <section class=\"wrapper\" role=\"navigation\">\n        <div class=\"header\">\n          <a\n            class=\"svg\"\n            @click=\"", "\"\n            @keypress=\"", "\"\n            id=\"popovertarget\"\n            aria-label=\"", "\"\n          >\n            <svg\n              preserveAspectRatio=\"xMidYMid meet\"\n              height=\"1em\"\n              width=\"1em\"\n              fill=\"none\"\n              xmlns=\"http://www.w3.org/2000/svg\"\n              viewBox=\"0 0 24 24\"\n              stroke-width=\"2\"\n              stroke-linecap=\"round\"\n              stroke-linejoin=\"round\"\n              stroke=\"currentColor\"\n              class=\"icon-7f6730be--text-3f89f380\"\n            >\n              <g>\n                <line x1=\"21\" y1=\"10\" x2=\"7\" y2=\"10\"></line>\n                <line x1=\"21\" y1=\"6\" x2=\"3\" y2=\"6\"></line>\n                <line x1=\"21\" y1=\"14\" x2=\"3\" y2=\"14\"></line>\n                <line x1=\"21\" y1=\"18\" x2=\"7\" y2=\"18\"></line>\n              </g>\n            </svg>\n          </a>\n          <simple-tooltip\n            for=\"popovertarget\"\n            offset=\"32\"\n            ?hidden=\"", "\"\n          >\n            ", "\n          </simple-tooltip>\n          ", "\n        </div>\n        ", "\n      </section>\n    "])), this.toggleSettings, this.keyToggle, this.label, !this.mobile || !this.hideSettings, this.label, !this.mobile ? (0, _litElement.html)(_templateObject2_715deb50b2b411eb9e5c9b5d1881fac2 || (_templateObject2_715deb50b2b411eb9e5c9b5d1881fac2 = babelHelpers.taggedTemplateLiteral([" <h2 class=\"label\">", "</h2> "])), this.label) : "", this.mobile ? (0, _litElement.html)(_templateObject3_715deb50b2b411eb9e5c9b5d1881fac2 || (_templateObject3_715deb50b2b411eb9e5c9b5d1881fac2 = babelHelpers.taggedTemplateLiteral(["\n              <simple-popover\n                class=\"dropdown pull-left font-settings js-toolbar-action settings-container\"\n                ?hidden=\"", "\"\n                position=\"", "\"\n                auto\n              >\n                <ol class=\"contents\">\n                  ", "\n                </ol>\n              </simple-popover>\n            "])), this.hideSettings, this.position, this.items.map(function (item, index) {
          return _this2.renderItem(item, index);
        })) : (0, _litElement.html)(_templateObject4_715deb50b2b411eb9e5c9b5d1881fac2 || (_templateObject4_715deb50b2b411eb9e5c9b5d1881fac2 = babelHelpers.taggedTemplateLiteral(["\n              <ol class=\"contents\">\n                ", "\n              </ol>\n            "])), this.items.map(function (item, index) {
          return _this2.renderItem(item, index);
        })));
      }
    }, {
      ...
      value: function renderItem(item, index) {
        if (item.link == null && item.object) {
          ...
          return (0, _litElement.html)(_templateObject5_715deb50b2b411eb9e5c9b5d1881fac2 || (_templateObject5_715deb50b2b411eb9e5c9b5d1881fac2 = babelHelpers.taggedTemplateLiteral(["\n        <li class=\"item\">\n          <a\n            class=\"link indent-", " ", "\"\n            tabindex=\"0\"\n            @click=\"", "\"\n            @keypress=\"", "\"\n            data-index=\"", "\"\n            >", "</a\n          >\n        </li>\n      "])), item.indent, item.active, this.scrollToObject, this.keyScroll, index, item.title);
        }

        return (0, _litElement.html)(_templateObject6_715deb50b2b411eb9e5c9b5d1881fac2 || (_templateObject6_715deb50b2b411eb9e5c9b5d1881fac2 = babelHelpers.taggedTemplateLiteral(["\n      <li class=\"item\">\n        <a\n          class=\"link indent-", " ", "\"\n          href=\"", "\"\n          @click=\"", "\"\n          @keypress=\"", "\"\n          data-index=\"", "\"\n          >", "</a\n        >\n      </li>\n    "])), item.indent, item.active, item.link, this.scrollToObject, this.keyScroll, index, item.title);
