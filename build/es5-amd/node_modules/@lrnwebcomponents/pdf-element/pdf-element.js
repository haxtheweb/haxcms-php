...
var parsedFileName=currentThis.src.split("/").pop(),self=currentInstance;currentThis.sidebarOpen=!0;if(1<=page&&page<=currentInstance.totalPagesNum){self.currentPage=page;self.queueRenderPage(self.currentPage);currentInstance.currentPage=page;currentThis.currentPage=page;this.shadowRoot.querySelector("#input").blur()}else{this.shadowRoot.querySelector("#input").value=self.currentPage;this.shadowRoot.querySelector("#input").blur()}}/*
   ...
   */},{key:"download",value:function download(){if(this.instance.pdfExists){this.instance.download()}}}],[{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_2ea5c0a079ce11eaa754f3847e308e7c())}},{key:"tag",get:function get(){return"pdf-element"}},{key:"properties",get:function get(){return _objectSpread({},babelHelpers.get(babelHelpers.getPrototypeOf(PdfElement),"properties",this),{/**
