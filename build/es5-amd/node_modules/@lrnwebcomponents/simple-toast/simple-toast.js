define(["exports", "../../lit/index.js", "../simple-colors/simple-colors.js", "./lib/simple-toast-el.js"], function (_exports, _index, _simpleColors, _simpleToastEl) {
  ...
  var _templateObject_c5740640a7e811ed8d60b559aaaec7a9, _templateObject2_c5740640a7e811ed8d60b559aaaec7a9;
  ...
  var SimpleToast = /*#__PURE__*/function (_SimpleColors) {
    ...
    babelHelpers.createClass(SimpleToast, [{
      ...
      // render function
      function render() {
        return (0, _index.html)(_templateObject_c5740640a7e811ed8d60b559aaaec7a9 || (_templateObject_c5740640a7e811ed8d60b559aaaec7a9 = babelHelpers.taggedTemplateLiteral([" <simple-toast-el\n      id=\"toast\"\n      accent-color=\"", "\"\n      ?dark=\"", "\"\n      text=\"", "\"\n      duration=\"", "\"\n      ?opened=\"", "\"\n      @opened-changed=\"", "\"\n      .class=\"", "\"\n    >\n      <slot></slot>\n      <button .hidden=\"", "\" @click=\"", "\">\n        ", "\n      </button>\n    </simple-toast-el>"])), this.accentColor, this.dark, this.text, this.duration, this.opened, this.openedChanged, this.classStyle, !this.closeButton, this.hide, this.closeText);
      }
