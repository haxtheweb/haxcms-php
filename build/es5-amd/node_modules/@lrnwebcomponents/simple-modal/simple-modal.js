define(["exports", "../../lit/index.js", "../simple-icon/lib/simple-icons.js", "../simple-icon/lib/simple-icon-lite.js", "../simple-icon/lib/simple-icon-button-lite.js", "../../web-dialog/index.js"], function (_exports, _index, _simpleIcons, _simpleIconLite, _simpleIconButtonLite, _index2) {
  ...
  var _templateObject_91b966f0403311edb9fff3e6b08a0a9a, _templateObject2_91b966f0403311edb9fff3e6b08a0a9a, _templateObject3_91b966f0403311edb9fff3e6b08a0a9a;
  ...
  var SimpleModal = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(SimpleModal, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_91b966f0403311edb9fff3e6b08a0a9a || (_templateObject_91b966f0403311edb9fff3e6b08a0a9a = babelHelpers.taggedTemplateLiteral([" <web-dialog\n      id=\"dialog\"\n      center\n      role=\"dialog\"\n      part=\"dialog\"\n      aria-describedby=\"simple-modal-content\"\n      aria-label=\"", "\"\n      aria-labelledby=\"", "\"\n      aria-modal=\"true\"\n      ?open=\"", "\"\n      @open=\"", "\"\n      @close=\"", "\"\n    >\n      <div id=\"titlebar\" part=\"titlebar\">\n        <h2 id=\"simple-modal-title\" ?hidden=\"", "\" part=\"title\">\n          ", "\n        </h2>\n        <div></div>\n        ", "\n      </div>\n      <div id=\"headerbar\" part=\"headerbar\"><slot name=\"header\"></slot></div>\n      <div id=\"simple-modal-content\" part=\"content\">\n        <slot name=\"content\"></slot>\n      </div>\n      <slot name=\"custom\" part=\"custom\"></slot>\n      <div class=\"buttons\" part=\"buttons\">\n        <slot name=\"buttons\"></slot>\n      </div>\n    </web-dialog>"])), this._getAriaLabel(this.title), this._getAriaLabelledby(this.title), this.opened, this.open, this.close, !this.title, this.title, !this.modal ? (0, _index.html)(_templateObject2_91b966f0403311edb9fff3e6b08a0a9a || (_templateObject2_91b966f0403311edb9fff3e6b08a0a9a = babelHelpers.taggedTemplateLiteral(["<simple-icon-button-lite\n              id=\"close\"\n              dark\n              icon=\"", "\"\n              @click=\"", "\"\n              label=\"", "\"\n              part=\"close\"\n            >\n            </simple-icon-button-lite>"])), this.closeIcon, this.close, this.closeLabel) : "");
