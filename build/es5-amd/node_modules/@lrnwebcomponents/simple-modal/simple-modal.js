define(["exports", "require", "../../lit-element/lit-element.js", "../../@polymer/paper-dialog/paper-dialog.js", "../../@polymer/polymer/lib/elements/custom-style.js"], function (_exports, _require, _litElement, _paperDialog, _customStyle) {
  ...
  function _templateObject2_8058d3e034ed11eabe39ef50dfa8db3f() {
    ...
    _templateObject2_8058d3e034ed11eabe39ef50dfa8db3f = function _templateObject2_8058d3e034ed11eabe39ef50dfa8db3f() {
      return data;
    };
  ...
  function _templateObject_8058d3e034ed11eabe39ef50dfa8db3f() {
    ...
    _templateObject_8058d3e034ed11eabe39ef50dfa8db3f = function _templateObject_8058d3e034ed11eabe39ef50dfa8db3f() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(SimpleModal, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_8058d3e034ed11eabe39ef50dfa8db3f(), this._getAriaLabel(this.title), this._getAriaLabelledby(this.title), this.opened, this.openedChangedEvent, this.modal, !this.title, this.title, !this.opened, this.closeLabel, this.closeIcon);
      ...
      //styles function
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_8058d3e034ed11eabe39ef50dfa8db3f())];
      }
    }, {
      key: "properties",
      get: function get() {
