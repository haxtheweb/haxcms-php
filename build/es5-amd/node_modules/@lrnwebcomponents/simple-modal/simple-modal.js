define(["exports", "require", "../../lit-element/lit-element.js", "../../@polymer/paper-dialog/paper-dialog.js", "../../@polymer/polymer/lib/elements/custom-style.js"], function (_exports, _require, _litElement, _paperDialog, _customStyle) {
  ...
  function _templateObject2_6f05f8b0319211eab4d6d523fb58366a() {
    ...
    _templateObject2_6f05f8b0319211eab4d6d523fb58366a = function _templateObject2_6f05f8b0319211eab4d6d523fb58366a() {
      return data;
    };
  ...
  function _templateObject_6f05f8b0319211eab4d6d523fb58366a() {
    ...
    _templateObject_6f05f8b0319211eab4d6d523fb58366a = function _templateObject_6f05f8b0319211eab4d6d523fb58366a() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(SimpleModal, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_6f05f8b0319211eab4d6d523fb58366a(), this._getAriaLabel(this.title), this._getAriaLabelledby(this.title), this.opened, this.openedChangedEvent, this.modal, !this.title, this.title, !this.opened, this.closeLabel, this.closeIcon);
      ...
      //styles function
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_6f05f8b0319211eab4d6d523fb58366a())];
      }
    }, {
      key: "properties",
      get: function get() {
