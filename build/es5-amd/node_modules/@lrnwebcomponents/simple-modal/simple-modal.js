define(["exports", "require", "../../lit-element/lit-element.js"], function (_exports, _require, _litElement) {
  ...
  function _templateObject2_b8eb9a90157411eb91e46d84b27d8456() {
    ...
    _templateObject2_b8eb9a90157411eb91e46d84b27d8456 = function _templateObject2_b8eb9a90157411eb91e46d84b27d8456() {
      return data;
    };
  ...
  function _templateObject_b8eb9a90157411eb91e46d84b27d8456() {
    var data = babelHelpers.taggedTemplateLiteral([" <paper-dialog\n      id=\"dialog\"\n      always-on-top\n      aria-describedby=\"simple-modal-content\"\n      aria-label=\"", "\"\n      aria-labelledby=\"", "\"\n      aria-modal=\"true\"\n      role=\"dialog\"\n      ?opened=\"", "\"\n      @opened-changed=\"", "\"\n      ?modal=\"", "\"\n      with-backdrop\n    >\n      <div id=\"titlebar\">\n        <h2 id=\"simple-modal-title\" ?hidden=\"", "\">", "</h2>\n        <div></div>\n        <button\n          id=\"close\"\n          dialog-dismiss\n          ?hidden=\"", "\"\n          label=\"", "\"\n        >\n          <iron-icon aria-hidden=\"true\" icon=\"", "\"></iron-icon>\n        </button>\n      </div>\n      <div id=\"headerbar\"><slot name=\"header\"></slot></div>\n      <paper-dialog-scrollable id=\"simple-modal-content\">\n        <slot name=\"content\"></slot>\n      </paper-dialog-scrollable>\n      <div class=\"buttons\">\n        <slot name=\"buttons\"></slot>\n      </div>\n    </paper-dialog>"]);

    _templateObject_b8eb9a90157411eb91e46d84b27d8456 = function _templateObject_b8eb9a90157411eb91e46d84b27d8456() {
      return data;
    };
  ...
  var SimpleModal = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(SimpleModal, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_b8eb9a90157411eb91e46d84b27d8456(), this._getAriaLabel(this.title), this._getAriaLabelledby(this.title), this.opened, this.openedChangedEvent, this.modal, !this.title, this.title, !this.opened, this.closeLabel, this.closeIcon);
      ...
      //styles function
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_b8eb9a90157411eb91e46d84b27d8456())];
      }
    }, {
      key: "properties",
      get: function get() {
