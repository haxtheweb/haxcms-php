define(["exports", "../../lit-element/lit-element.js", "../simple-icon/lib/simple-icons.js", "../simple-icon/lib/simple-icon-lite.js", "../simple-icon/lib/simple-icon-button-lite.js", "../../web-dialog/index.js"], function (_exports, _litElement, _simpleIcons, _simpleIconLite, _simpleIconButtonLite, _index) {
  ...
  function _templateObject2_25ef13303ee511ebb7f7a1171f0cd59d() {
    ...
    _templateObject2_25ef13303ee511ebb7f7a1171f0cd59d = function _templateObject2_25ef13303ee511ebb7f7a1171f0cd59d() {
      return data;
    };
  ...
  function _templateObject_25ef13303ee511ebb7f7a1171f0cd59d() {
    ...
    _templateObject_25ef13303ee511ebb7f7a1171f0cd59d = function _templateObject_25ef13303ee511ebb7f7a1171f0cd59d() {
      return data;
    };
  ...
  var SimpleModal = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(SimpleModal, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_25ef13303ee511ebb7f7a1171f0cd59d(), this._getAriaLabel(this.title), this._getAriaLabelledby(this.title), this.opened, this.open, this.close, !this.title, this.title, this.closeIcon, this.close, this.closeLabel);
      ...
      //styles function
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_25ef13303ee511ebb7f7a1171f0cd59d())];
      }
    }, {
      key: "properties",
      get: function get() {
