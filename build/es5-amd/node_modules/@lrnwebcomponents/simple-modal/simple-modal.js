define(["exports", "../../lit-element/lit-element.js", "../simple-icon/lib/simple-icons.js", "../simple-icon/lib/simple-icon-lite.js", "../simple-icon/lib/simple-icon-button-lite.js", "../../web-dialog/index.js"], function (_exports, _litElement, _simpleIcons, _simpleIconLite, _simpleIconButtonLite, _index) {
  ...
  function _templateObject2_bb6a73b02dd211eba8a9dbdc0fc9b6e0() {
    ...
    _templateObject2_bb6a73b02dd211eba8a9dbdc0fc9b6e0 = function _templateObject2_bb6a73b02dd211eba8a9dbdc0fc9b6e0() {
      return data;
    };
  ...
  function _templateObject_bb6a73b02dd211eba8a9dbdc0fc9b6e0() {
    ...
    _templateObject_bb6a73b02dd211eba8a9dbdc0fc9b6e0 = function _templateObject_bb6a73b02dd211eba8a9dbdc0fc9b6e0() {
      return data;
    };
  ...
  var SimpleModal = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(SimpleModal, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_bb6a73b02dd211eba8a9dbdc0fc9b6e0(), this._getAriaLabel(this.title), this._getAriaLabelledby(this.title), this.opened, this.open, this.close, !this.title, this.title, this.closeIcon, this.close, this.closeLabel);
      ...
      //styles function
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_bb6a73b02dd211eba8a9dbdc0fc9b6e0())];
      }
    }, {
      key: "properties",
      get: function get() {
