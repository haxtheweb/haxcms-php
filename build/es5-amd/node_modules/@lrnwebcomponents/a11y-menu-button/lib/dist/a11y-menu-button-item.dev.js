...
function _templateObject3_010eeff0e4f511ed85766367b4d3e9fc() {
  var data = _taggedTemplateLiteral(['\n        <li role="none">\n          <button\n            role="menuitem"\n            controls="', '"\n            ?disabled="', '"\n            part="button"\n          >\n            <slot></slot>\n          </button>\n        </li>\n      ']);
  _templateObject3_010eeff0e4f511ed85766367b4d3e9fc = function _templateObject3_010eeff0e4f511ed85766367b4d3e9fc() {
    return data;
  };
  return data;
}
function _templateObject2_010eeff0e4f511ed85766367b4d3e9fc() {
  var data = _taggedTemplateLiteral([' <li role="none">\n        <a role="menuitem" href="', '" ?disabled="', '"\n            part="button">\n          <slot></slot>\n        </a>\n      </li>']);
  _templateObject2_010eeff0e4f511ed85766367b4d3e9fc = function _templateObject2_010eeff0e4f511ed85766367b4d3e9fc() {
    return data;
  };
  return data;
}
function _templateObject_010eeff0e4f511ed85766367b4d3e9fc() {
  ...
  _templateObject_010eeff0e4f511ed85766367b4d3e9fc = function _templateObject_010eeff0e4f511ed85766367b4d3e9fc() {
    return data;
  };
  return data;
}
  ...
  return /*#__PURE__*/(
    function (_SuperClass) {
      ...
      _createClass(_class, [{
        ...
        key: "styles",
        get: function get() {
          return [(0, _litElement.css)(_templateObject_010eeff0e4f511ed85766367b4d3e9fc())];
        }
      }, {
        key: "tag",
        get: function get() {
      ...
      _createClass(_class, [{
        ...
        key: "linkTemplate",
        get: function get() {
          return (0, _litElement.html)(_templateObject2_010eeff0e4f511ed85766367b4d3e9fc(), this.href, this.disabled);
        }
        /**
        ...
        key: "buttonTemplate",
        get: function get() {
          return (0, _litElement.html)(_templateObject3_010eeff0e4f511ed85766367b4d3e9fc(), this.controls, this.disabled);
        }
      }]);
      return _class;
    }(SuperClass)
