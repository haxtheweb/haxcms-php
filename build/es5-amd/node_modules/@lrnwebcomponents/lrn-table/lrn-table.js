define(["exports", "require", "../../lit-element/lit-element.js", "../schema-behaviors/schema-behaviors.js"], function (_exports, _require, _litElement, _schemaBehaviors) {
  ...
  function _templateObject2_612d83003efe11eb800233a440abe59f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n        .hidden-title {\n          display: none;\n        }\n      "]);

    _templateObject2_612d83003efe11eb800233a440abe59f = function _templateObject2_612d83003efe11eb800233a440abe59f() {
      return data;
    };
  ...
  function _templateObject_612d83003efe11eb800233a440abe59f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <div typeof=\"oer:SupportingMaterial\">\n        <div class=\"hidden-title\" property=\"oer:name\">", "</div>\n        <div property=\"oer:description\">\n          <slot></slot>\n          <csv-render\n            data-source=\"", "\"\n            caption=\"", "\"\n            summary=\"", "\"\n          ></csv-render>\n        </div>\n      </div>\n    "]);

    _templateObject_612d83003efe11eb800233a440abe59f = function _templateObject_612d83003efe11eb800233a440abe59f() {
      return data;
    };
  ...
  var LrnTable = /*#__PURE__*/function (_SchemaBehaviors) {
    ...
    babelHelpers.createClass(LrnTable, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_612d83003efe11eb800233a440abe59f(), this.title, this.csvFile, this.title, this.description);
      }
    }], [{
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_612d83003efe11eb800233a440abe59f())];
      }
    }, {
      key: "tag",
      get: function get() {
