define(["exports", "meta", "require", "../../lit/index.js", "../schema-behaviors/schema-behaviors.js"], function (_exports, meta, _require, _index, _schemaBehaviors) {
  ...
  var _templateObject_df784c60ce3e11ec9ab909cdcceed78a, _templateObject2_df784c60ce3e11ec9ab909cdcceed78a;
  ...
  var LrnTable = /*#__PURE__*/function (_SchemaBehaviors) {
    ...
    babelHelpers.createClass(LrnTable, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_df784c60ce3e11ec9ab909cdcceed78a || (_templateObject_df784c60ce3e11ec9ab909cdcceed78a = babelHelpers.taggedTemplateLiteral(["\n      <div typeof=\"oer:SupportingMaterial\">\n        <div class=\"hidden-title\" property=\"oer:name\">", "</div>\n        <div property=\"oer:description\">\n          <slot></slot>\n          <csv-render\n            data-source=\"", "\"\n            caption=\"", "\"\n            summary=\"", "\"\n          ></csv-render>\n        </div>\n      </div>\n    "])), this.title, this.csvFile, this.title, this.description);
      }
    }], [{
      key: "styles",
      get: function get() {
        return [(0, _index.css)(_templateObject2_df784c60ce3e11ec9ab909cdcceed78a || (_templateObject2_df784c60ce3e11ec9ab909cdcceed78a = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n        .hidden-title {\n          display: none;\n        }\n      "])))];
      }
    }, {
      key: "tag",
      get: function get() {
