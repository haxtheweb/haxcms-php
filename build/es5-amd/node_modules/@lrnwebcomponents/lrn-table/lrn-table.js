define(["exports", "meta", "require", "../../lit/index.js", "../schema-behaviors/schema-behaviors.js"], function (_exports, meta, _require, _index, _schemaBehaviors) {
  ...
  var _templateObject_fd243c209b5111ed81cd11846941acb3, _templateObject2_fd243c209b5111ed81cd11846941acb3;
  ...
  var LrnTable = /*#__PURE__*/function (_SchemaBehaviors) {
    ...
    babelHelpers.createClass(LrnTable, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_fd243c209b5111ed81cd11846941acb3 || (_templateObject_fd243c209b5111ed81cd11846941acb3 = babelHelpers.taggedTemplateLiteral(["\n      <div typeof=\"oer:SupportingMaterial\">\n        <div class=\"hidden-title\" property=\"oer:name\">", "</div>\n        <div property=\"oer:description\">\n          <slot></slot>\n          <csv-render\n            data-source=\"", "\"\n            caption=\"", "\"\n            summary=\"", "\"\n          ></csv-render>\n        </div>\n      </div>\n    "])), this.title, this.csvFile, this.title, this.description);
      }
    }], [{
      key: "styles",
      get: function get() {
        return [(0, _index.css)(_templateObject2_fd243c209b5111ed81cd11846941acb3 || (_templateObject2_fd243c209b5111ed81cd11846941acb3 = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n        .hidden-title {\n          display: none;\n        }\n      "])))];
      }
    }, {
      key: "tag",
      get: function get() {
