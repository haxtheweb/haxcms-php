...
value:function render(){return(0,_litElement.html)(_templateObject_18cb27d0703b11ea9571e3a900ccc2fd())}// haxProperty definition
}],[{key:"styles",//styles function
get:function get(){return[].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(SimpleFields),"styles",this)),[(0,_litElement.css)(_templateObject2_18cb27d0703b11ea9571e3a900ccc2fd())])}},{key:"haxProperties",get:function get(){return{}}// properties available to the custom element for data binding
   ...
   * @returns object schema properties
   * @memberof SimpleFieldsLite
   */},{key:"_fieldsToSchema",value:function _fieldsToSchema(fields){var _this5=this,schema={};if(fields&&fields.forEach){fields.forEach(function(field){var prop=!field.property?"":field.property;schema[prop]=_this5._fieldToSchema(field)})}return schema}},{key:"convertedSchema",get:function get(){var schema={$schema:"http://json-schema.org/schema#",title:this.label,type:"object",required:[],properties:this._fieldsToSchema(this.fields)};return schema}}]);return SimpleFields}(_simpleFieldsLite.SimpleFieldsLite);_exports.SimpleFields=SimpleFields;window.customElements.define(SimpleFields.tag,SimpleFields)});