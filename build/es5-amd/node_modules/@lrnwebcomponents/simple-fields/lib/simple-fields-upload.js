define(["exports", "meta", "require", "../../../lit/index.js", "./simple-fields-field.js", "./simple-fields-ui.js", "./simple-fields-fieldset.js", "./simple-fields-url-combo.js", "../../simple-icon/lib/simple-icon-lite.js", "../../simple-icon/lib/simple-icons.js", "../../simple-toolbar/simple-toolbar.js", "../../simple-toolbar/lib/simple-toolbar-button.js", "../../../@vaadin/vaadin-upload/vaadin-upload.js", "../../responsive-utility/responsive-utility.js", "../../i18n-manager/lib/I18NMixin.js"], function (_exports, meta, _require, _index, _simpleFieldsField, _simpleFieldsUi, _simpleFieldsFieldset, _simpleFieldsUrlCombo, _simpleIconLite, _simpleIcons, _simpleToolbar, _simpleToolbarButton, _vaadinUpload, _responsiveUtility, _I18NMixin2) {
  ...
  var _templateObject_4caa1ce0e8f211edb01b473406559cea, _templateObject2_4caa1ce0e8f211edb01b473406559cea, _templateObject3_4caa1ce0e8f211edb01b473406559cea, _templateObject4_4caa1ce0e8f211edb01b473406559cea;
  ...
  var SimpleFieldsUpload = /*#__PURE__*/function (_I18NMixin) {
    ...
    babelHelpers.createClass(SimpleFieldsUpload, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_4caa1ce0e8f211edb01b473406559cea || (_templateObject_4caa1ce0e8f211edb01b473406559cea = babelHelpers.taggedTemplateLiteral(["\n      <fieldset part=\"fieldset\">", " ", "</fieldset>\n    "])), this.legend, this.fields);
      }
    }, {
      key: "sources",
      get: function get() {
        return (0, _index.html)(_templateObject2_4caa1ce0e8f211edb01b473406559cea || (_templateObject2_4caa1ce0e8f211edb01b473406559cea = babelHelpers.taggedTemplateLiteral(["\n      <simple-toolbar-button\n        id=\"browse\"\n        ?disabled=\"", "\"\n        label=\"", "..\"\n        ?show-text-label=\"", "\"\n        icon=\"icons:file-upload\"\n        show-text-label\n        @click=\"", "\"\n        controls=\"fieldset\"\n        part=\"browse\"\n      >\n      </simple-toolbar-button>\n      <simple-toolbar-button\n        icon=\"image:camera-alt\"\n        ?disabled=\"", "\"\n        label=\"", "..\"\n        ?show-text-label=\"", "\"\n        @mousedown=\"", "\"\n        @focus=\"", "\"\n        @click=\"", "\"\n        controls=\"fieldset\"\n        part=\"take-photo\"\n        ?hidden=\"", "\"\n      >\n      </simple-toolbar-button>\n      <simple-toolbar-button\n        icon=\"hardware:keyboard-voice\"\n        ?disabled=\"", "\"\n        label=\"", "..\"\n        ?show-text-label=\"", "\"\n        @mousedown=\"", "\"\n        @focus=\"", "\"\n        @click=\"", "\"\n        controls=\"fieldset\"\n        part=\"record-audio\"\n        ?hidden=\"", "\"\n      >\n      </simple-toolbar-button>\n    "])), this.disabled, this.t.upload, this.responsiveSize.indexOf("s") < 0, this._handleBrowse, this.disabled, this.t.takePhoto, this.responsiveSize.indexOf("s") < 0, function (e) {
          ...
          return e.preventDefault();
        }, this._handleAudioOption, !navigator.mediaDevices || this.noVoiceRecord);
      }
      /**
      ...
      key: "fields",
      get: function get() {
        return (0, _index.html)(_templateObject3_4caa1ce0e8f211edb01b473406559cea || (_templateObject3_4caa1ce0e8f211edb01b473406559cea = babelHelpers.taggedTemplateLiteral(["\n      <div id=\"upload-options\">\n        <vaadin-upload\n          capture=\"\"\n          class=\"option-", "\"\n          form-data-name=\"file-upload\"\n          id=\"fileupload\"\n          @upload-before=\"", "\"\n          @upload-response=\"", "\"\n          part=\"upload\"\n          ?nodrop=\"", "\"\n        >\n          <button\n            ?disabled=\"", "\"\n            id=\"add-hidden\"\n            slot=\"add-button\"\n            hidden\n          ></button>\n          <div\n            slot=\"drop-label\"\n            part=\"browse-area\"\n            ?hidden=\"", "\"\n          >\n            <simple-fields-url-combo\n              id=\"url\"\n              ?autofocus=\"", "\"\n              autocomplete=\"both\"\n              value=\"", "\"\n              label=\"URL\"\n              type=\"url\"\n              auto-validate=\"\"\n              part=\"url\"\n              ?disabled=\"", "\"\n              ?always-expanded=\"", "\"\n              display-as=\"", "\"\n              .itemsList=\"", "\"\n              @click=\"", "\"\n              @mousedown=\"", "\"\n              @focus=\"", "\"\n              @value-changed=\"", "\"\n            >\n            </simple-fields-url-combo>\n          </div>\n          <div id=\"upload\">\n            <span part=\"drop-area-text\">", "</span>\n            ", "\n          </div>\n          <simple-toolbar-button\n            id=\"cancel\"\n            icon=\"icons:clear\"\n            ?disabled=\"", "\"\n            label=\"", "\"\n            @mousedown=\"", "\"\n            @focus=\"", "\"\n            @click=\"", "\"\n            controls=\"fieldset\"\n            slot=\"drop-label\"\n            part=\"cancel-media\"\n            ?hidden=\"", "\"\n          >\n          </simple-toolbar-button>\n          <div\n            id=\"camerahole\"\n            ?hidden=\"", "\"\n            part=\"camera\"\n            slot=\"drop-label\"\n            part=\"camera-preview\"\n          ></div>\n          <div\n            id=\"voicerecorder\"\n            ?hidden=\"", "\"\n            slot=\"drop-label\"\n            part=\"voice-preview\"\n          ></div>\n          ", "\n        </vaadin-upload>\n      </div>\n    "])), this.option, this._fileAboutToUpload, this._fileUploadResponse, this.disabled, this.disabled, this.option == "selfie" || this.option == "audio" || this.hideInput, this.autofocus, this.value || "", this.disabled, this.responsiveSize.indexOf("s") < 0, this.responsiveSize.indexOf("l") > -1 ? "grid" : "", this.itemsList, function (e) {
          return e.stopImmediatePropagation();
        }, function (e) {
          return e.stopImmediatePropagation();
        }, function (e) {
          return e.stopImmediatePropagation();
        }, this.valueChanged, this.t.dropMediaHereOr, this.sources, this.disabled, this.t.cancel, function (e) {
          return e.preventDefault();
        }, function (e) {
          return e.preventDefault();
