define(["exports", "require", "../../../lit-element/lit-element.js", "./simple-fields-field.js", "./simple-fields-ui.js", "./simple-fields-fieldset.js", "../../simple-icon/lib/simple-icon-lite.js", "../../simple-icon/lib/simple-icons.js", "../../simple-toolbar/simple-toolbar.js", "../../simple-toolbar/lib/simple-toolbar-button.js", "../../../@vaadin/vaadin-upload/vaadin-upload.js"], function (_exports, _require, _litElement, _simpleFieldsField, _simpleFieldsUi, _simpleFieldsFieldset, _simpleIconLite, _simpleIcons, _simpleToolbar, _simpleToolbarButton, _vaadinUpload) {
  ...
  var _templateObject_809e4410b99a11ebbf7975e2d57542c0, _templateObject2_809e4410b99a11ebbf7975e2d57542c0, _templateObject3_809e4410b99a11ebbf7975e2d57542c0, _templateObject4_809e4410b99a11ebbf7975e2d57542c0;
  ...
  var SimpleFieldsUpload = /*#__PURE__*/function (_SimpleFieldsFieldset) {
    ...
    babelHelpers.createClass(SimpleFieldsUpload, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_809e4410b99a11ebbf7975e2d57542c0 || (_templateObject_809e4410b99a11ebbf7975e2d57542c0 = babelHelpers.taggedTemplateLiteral(["\n      <fieldset part=\"fieldset\">", " ", "</fieldset>\n    "])), this.legend, this.fields);
      }
      /**
      ...
      key: "fields",
      get: function get() {
        return (0, _litElement.html)(_templateObject2_809e4410b99a11ebbf7975e2d57542c0 || (_templateObject2_809e4410b99a11ebbf7975e2d57542c0 = babelHelpers.taggedTemplateLiteral(["\n      <div id=\"url-browse\">\n        <simple-fields-field\n          id=\"url\"\n          ?autofocus=\"", "\"\n          autocomplete=\"", "\"\n          value=\"", "\"\n          @value-changed=\"", "\"\n          label=\"URL\"\n          .description=\"", "\"\n          type=\"url\"\n          auto-validate=\"\"\n          part=\"url\"\n          @click=\"", "\"\n          @mousedown=\"", "\"\n          @focus=\"", "\"\n        >\n          <simple-toolbar-button\n            id=\"browse\"\n            label=\"Browse...\"\n            show-text-label\n            @click=\"", "\"\n            controls=\"fieldset\"\n            slot=\"suffix\"\n            part=\"browse\"\n          >\n          </simple-toolbar-button>\n        </simple-fields-field>\n      </div>\n      <div id=\"upload-options\">\n        <vaadin-upload\n          capture\n          class=\"option-", "\"\n          form-data-name=\"file-upload\"\n          id=\"fileupload\"\n          @upload-before=\"", "\"\n          @upload-response=\"", "\"\n          part=\"upload\"\n        >\n          <button id=\"add-hidden\" slot=\"add-button\" hidden></button>\n          <div\n            id=\"drop-camera\"\n            slot=\"drop-label\"\n            part=\"drop-area\"\n            ?hidden=\"", "\"\n          >\n            <span id=\"drop\" part=\"drop-area-text\">\n              <simple-icon-lite\n                icon=\"file-upload\"\n                part=\"drop-area-icon\"\n              ></simple-icon-lite>\n              Drop media here ", "\n            </span>\n            <simple-toolbar-button\n              icon=\"image:camera-alt\"\n              label=\"Take photo\"\n              show-text-label\n              @mousedown=\"", "\"\n              @focus=\"", "\"\n              @click=\"", "\"\n              controls=\"fieldset\"\n              part=\"take-photo\"\n              ?hidden=\"", "\"\n            >\n            </simple-toolbar-button>\n            <simple-toolbar-button\n              icon=\"image:camera-alt\"\n              label=\"Record Audio\"\n              show-text-label\n              @mousedown=\"", "\"\n              @focus=\"", "\"\n              @click=\"", "\"\n              controls=\"fieldset\"\n              part=\"record-audio\"\n              ?hidden=\"", "\"\n            >\n            </simple-toolbar-button>\n          </div>\n          <simple-toolbar-button\n            id=\"cancel-camera\"\n            icon=\"icons:clear\"\n            label=\"Cancel\"\n            @mousedown=\"", "\"\n            @focus=\"", "\"\n            @click=\"", "\"\n            controls=\"fieldset\"\n            slot=\"drop-label\"\n            part=\"cancel-media\"\n            ?hidden=\"", "\"\n          >\n          </simple-toolbar-button>\n          <div\n            id=\"camerahole\"\n            ?hidden=\"", "\"\n            part=\"camera\"\n            slot=\"drop-label\"\n            part=\"camera-preview\"\n          ></div>\n          <div\n            id=\"voicerecorder\"\n            ?hidden=\"", "\"\n            slot=\"drop-label\"\n            part=\"voice-preview\"\n          ></div>\n        </vaadin-upload>\n      </div>\n    "])), this.autofocus, this.autocomplete, this.value || "", this.valueChanged, this.description, function (e) {
          return e.preventDefault();
        }, function (e) {
          return e.preventDefault();
        }, function (e) {
          return e.preventDefault();
        }, this._handleBrowse, this.option, this._fileAboutToUpload, this._fileUploadResponse, this.option == "selfie" || this.option == "audio", !navigator.mediaDevices ? "" : (0, _litElement.html)(_templateObject3_809e4410b99a11ebbf7975e2d57542c0 || (_templateObject3_809e4410b99a11ebbf7975e2d57542c0 = babelHelpers.taggedTemplateLiteral([" or "]))), function (e) {
          return e.preventDefault();
        }, function (e) {
          return e.preventDefault();
