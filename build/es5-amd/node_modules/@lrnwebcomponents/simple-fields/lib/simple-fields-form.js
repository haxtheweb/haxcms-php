...
value:function render(){return(0,_litElement.html)(_templateObject_211706c0703b11ea9571e3a900ccc2fd())}},{key:"updated",value:function updated(changedProperties){var _this=this;changedProperties.forEach(function(oldValue,propName){if(_this.autoload&&!_this.loadResponse&&!_this.loading){if("loadEndpoint"===propName||"autoload"===propName){_this.loadData()}}// we have response data from an end point this should create the form
