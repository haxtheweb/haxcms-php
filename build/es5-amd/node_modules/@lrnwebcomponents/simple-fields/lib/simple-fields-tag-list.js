define(["exports", "../../../lit-element/lit-element.js", "./simple-fields-field.js", "./simple-tag.js"], function (_exports, _litElement, _simpleFieldsField, _simpleTag) {
  ...
  function _templateObject4_44d4e97099b011eb851ed31c596cbbd8() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            <simple-tag\n              cancel-button\n              .data=", "\n              value=\"", "\"\n              accent-color=\"", "\"\n              @simple-tag-clicked=\"", "\"\n            ></simple-tag>\n          "]);

    _templateObject4_44d4e97099b011eb851ed31c596cbbd8 = function _templateObject4_44d4e97099b011eb851ed31c596cbbd8() {
      return data;
    };
  ...
  function _templateObject3_44d4e97099b011eb851ed31c596cbbd8() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      ", "\n      <slot name=\"taglist\">\n        ", "\n      </slot>\n    "]);

    _templateObject3_44d4e97099b011eb851ed31c596cbbd8 = function _templateObject3_44d4e97099b011eb851ed31c596cbbd8() {
      return data;
    };
  ...
  function _templateObject2_44d4e97099b011eb851ed31c596cbbd8() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <span class=\"input-option\" part=\"option-inner\">\n        <input\n          @keydown=\"", "\"\n          @keyup=\"", "\"\n          ?autofocus=\"", "\"\n          aria-descrbedby=\"", "\"\n          .aria-invalid=\"", "\"\n          @blur=\"", "\"\n          @change=\"", "\"\n          class=\"field box-input\"\n          ?disabled=\"", "\"\n          @focus=\"", "\"\n          ?hidden=\"", "\"\n          id=\"", "\"\n          @input=\"", "\"\n          name=\"", "\"\n          .placeholder=\"", "\"\n          ?readonly=\"", "\"\n          ?required=\"", "\"\n          tabindex=\"0\"\n          type=\"text\"\n          value=\"", "\"\n          part=\"option-input\"\n        />\n      </span>\n    "]);

    _templateObject2_44d4e97099b011eb851ed31c596cbbd8 = function _templateObject2_44d4e97099b011eb851ed31c596cbbd8() {
      return data;
    };
  ...
  function _templateObject_44d4e97099b011eb851ed31c596cbbd8() {
    ...
    _templateObject_44d4e97099b011eb851ed31c596cbbd8 = function _templateObject_44d4e97099b011eb851ed31c596cbbd8() {
      return data;
    };
  ...
  var SimpleFieldsTagList = /*#__PURE__*/function (_SimpleFieldsFieldBeh) {
    ...
    babelHelpers.createClass(SimpleFieldsTagList, null, [{
      ...
      key: "styles",
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(SimpleFieldsTagList), "styles", this)), [(0, _litElement.css)(_templateObject_44d4e97099b011eb851ed31c596cbbd8())]);
      }
    }, {
      key: "properties",
      get: function get() {
    ...
    babelHelpers.createClass(SimpleFieldsTagList, [{
      ...
      value: function getInput() {
        return (0, _litElement.html)(_templateObject2_44d4e97099b011eb851ed31c596cbbd8(), this._handleKeydown, this._handleKeyup, this.autofocus, this.describedBy || "", this.error ? "true" : "false", this._onFocusout, this._handleFieldChange, this.disabled, this._onFocusin, this.hidden, this.id, this._handleFieldChange, this.id, this.placeholder || "", this.readonly, this.required, this.value);
      }
    }, {
      key: "removeTag",
      ...
      get: function get() {
        ...
        return (0, _litElement.html)(_templateObject3_44d4e97099b011eb851ed31c596cbbd8(), babelHelpers.get(babelHelpers.getPrototypeOf(SimpleFieldsTagList.prototype), "prefixTemplate", this), this.tagList.map(function (tag) {
          return (0, _litElement.html)(_templateObject4_44d4e97099b011eb851ed31c596cbbd8(), tag, tag.term, tag.color, _this4.removeTag);
        }));
      }
    }, {
