define(["exports", "../../../lit-element/lit-element.js", "./simple-fields-container.js", "../../simple-icon/lib/simple-icon-lite.js", "../../simple-icon/lib/simple-icons.js"], function (_exports, _litElement, _simpleFieldsContainer, _simpleIconLite, _simpleIcons) {
  ...
  function _templateObject10_55673140552111ebb34d8b93068ed409() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <textarea\n        aria-invalid=\"", "\"\n        ?autofocus=\"", "\"\n        class=\"field box-input\"\n        @change=\"", "\"\n        @keydown=\"", "\"\n        ?disabled=\"", "\"\n        @focus=\"", "\"\n        @blur=\"", "\"\n        ?hidden=\"", "\"\n        id=\"", "\"\n        @input=\"", "\"\n        name=\"", "\"\n        ?readonly=\"", "\"\n        ?required=\"", "\"\n        rows=\"1\"\n      >\n", "</textarea\n      >\n    "]);

    _templateObject10_55673140552111ebb34d8b93068ed409 = function _templateObject10_55673140552111ebb34d8b93068ed409() {
      return data;
    };
  ...
  function _templateObject9_55673140552111ebb34d8b93068ed409() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            <option\n              .id=\"", ".", "\"\n              ?selected=\"", "\"\n              .value=\"", "\"\n            >\n              ", "\n            </option>\n          "]);

    _templateObject9_55673140552111ebb34d8b93068ed409 = function _templateObject9_55673140552111ebb34d8b93068ed409() {
      return data;
    };
  ...
  function _templateObject8_55673140552111ebb34d8b93068ed409() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <select\n        ?autofocus=\"", "\"\n        aria-descrbedby=\"", "\"\n        aria-invalid=\"", "\"\n        @change=\"", "\"\n        class=\"field\"\n        ?disabled=\"", "\"\n        @focus=\"", "\"\n        @blur=\"", "\"\n        ?hidden=\"", "\"\n        id=\"", "\"\n        ?multiple=\"", "\"\n        name=\"", "\"\n        ?readonly=\"", "\"\n        ?required=\"", "\"\n      >\n        ", "\n      </select>\n    "]);

    _templateObject8_55673140552111ebb34d8b93068ed409 = function _templateObject8_55673140552111ebb34d8b93068ed409() {
      return data;
    };
  ...
  function _templateObject7_55673140552111ebb34d8b93068ed409() {
    var data = babelHelpers.taggedTemplateLiteral(["\n              <div class=\"option inline\">\n                <label for=\"", ".", "\" class=\"radio-label\"\n                  >", "</label\n                >", "\n              </div>\n            "]);

    _templateObject7_55673140552111ebb34d8b93068ed409 = function _templateObject7_55673140552111ebb34d8b93068ed409() {
      return data;
    };
  ...
  function _templateObject6_55673140552111ebb34d8b93068ed409() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <fieldset>\n        <legend class=\"label-main\" ?hidden=\"", "\">\n          ", "", "\n        </legend>\n        <div id=\"options\">\n          ", "\n        </div>\n        ", "\n      </fieldset>\n    "]);

    _templateObject6_55673140552111ebb34d8b93068ed409 = function _templateObject6_55673140552111ebb34d8b93068ed409() {
      return data;
    };
  ...
  function _templateObject5_55673140552111ebb34d8b93068ed409() {
    var data = babelHelpers.taggedTemplateLiteral([" <div id=\"fieldmeta\" aria-live=\"polite\"></div> "]);

    _templateObject5_55673140552111ebb34d8b93068ed409 = function _templateObject5_55673140552111ebb34d8b93068ed409() {
      return data;
    };
  ...
  function _templateObject4_55673140552111ebb34d8b93068ed409() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <div\n        class=\"", "\"\n      >\n        ", "\n        <div>\n          ", "\n          ", "\n          ", "\n        </div>\n      </div>\n    "]);

    _templateObject4_55673140552111ebb34d8b93068ed409 = function _templateObject4_55673140552111ebb34d8b93068ed409() {
      return data;
    };
  ...
  function _templateObject3_55673140552111ebb34d8b93068ed409() {
    var data = babelHelpers.taggedTemplateLiteral(["\n              <simple-icon-lite\n                icon=\"", "\"\n                @click=\"", "\"\n              >\n              </simple-icon-lite>\n            "]);

    _templateObject3_55673140552111ebb34d8b93068ed409 = function _templateObject3_55673140552111ebb34d8b93068ed409() {
      return data;
    };
  ...
  function _templateObject2_55673140552111ebb34d8b93068ed409() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <span class=\"input-option\">\n        <input\n          ?autofocus=\"", "\"\n          aria-descrbedby=\"", "\"\n          .aria-invalid=\"", "\"\n          @change=\"", "\"\n          ?checked=\"", "\"\n          class=\"field ", "\"\n          ?disabled=\"", "\"\n          @focus=\"", "\"\n          @blur=\"", "\"\n          ?hidden=\"", "\"\n          id=\"", "\"\n          @input=\"", "\"\n          name=\"", "\"\n          .placeholder=\"", "\"\n          ?readonly=\"", "\"\n          ?required=\"", "\"\n          type=\"", "\"\n          value=\"", "\"\n        />\n        ", "\n      </span>\n    "]);

    _templateObject2_55673140552111ebb34d8b93068ed409 = function _templateObject2_55673140552111ebb34d8b93068ed409() {
      return data;
    };
  ...
  function _templateObject_55673140552111ebb34d8b93068ed409() {
    ...
    _templateObject_55673140552111ebb34d8b93068ed409 = function _templateObject_55673140552111ebb34d8b93068ed409() {
      return data;
    };
  ...
  var SimpleFieldsField = /*#__PURE__*/function (_SimpleFieldsContaine) {
    ...
    babelHelpers.createClass(SimpleFieldsField, [{
      ...
      key: "styles",
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(SimpleFieldsField), "styles", this)), [(0, _litElement.css)(_templateObject_55673140552111ebb34d8b93068ed409())]);
      }
    }, {
      key: "properties",
      get: function get() {
    ...
    babelHelpers.createClass(SimpleFieldsField, [{
      ...
      value: function getInput(option) {
        ...
        return (0, _litElement.html)(_templateObject2_55673140552111ebb34d8b93068ed409(), this.autofocus, this.describedBy || "", this.error ? "true" : "false", this._handleFieldChange, checked, ["checkbox", "color", "file", "radio", "range"].includes(this.type) ? "" : "box-input", this.disabled, this._onFocusin, this._onFocusout, this.hidden, !option ? this.id : option.value, this._handleFieldChange, this.id, this.placeholder || "", this.readonly, this.required, this.type, !option ? this.value : (option || {}).value, this.type !== "checkbox" && this.type !== "radio" ? "" : (0, _litElement.html)(_templateObject3_55673140552111ebb34d8b93068ed409(), icon, function (e) {
      ...
      key: "fieldMeta",
      get: function get() {
        return (0, _litElement.html)(_templateObject5_55673140552111ebb34d8b93068ed409());
      }
      /**
      ...
      get: function get() {
        ...
        return (0, _litElement.html)(_templateObject6_55673140552111ebb34d8b93068ed409(), !this.label, this.label, this.error || this.required ? "*" : "", (this.sortedOptions || []).map(function (option) {
          return (0, _litElement.html)(_templateObject7_55673140552111ebb34d8b93068ed409(), _this5.id, option.value, option.text, _this5.getInput(option));
        }), this.fieldBottom);
      }
    }, {
      key: "inputTemplate",
      ...
      get: function get() {
        ...
        return (0, _litElement.html)(_templateObject8_55673140552111ebb34d8b93068ed409(), this.autofocus, this.describedBy, this.error ? "true" : "false", this._handleFieldChange, this.disabled, this._onFocusin, this._onFocusout, this.hidden, this.id, this.multiple, this.id, this.readonly, this.required, (this.sortedOptions || []).map(function (option) {
          return (0, _litElement.html)(_templateObject9_55673140552111ebb34d8b93068ed409(), _this7.id, option.value, _this7.multiple ? _this7.value && _this7.value.includes(option.value) : _this7.value === option.value, option.value, option.text);
        }));
      }
      /**
      ...
      get: function get() {
        return (0, _litElement.html)(_templateObject10_55673140552111ebb34d8b93068ed409(), this.error ? "true" : "false", this.autofocus, this._handleFieldChange, function (e) {
