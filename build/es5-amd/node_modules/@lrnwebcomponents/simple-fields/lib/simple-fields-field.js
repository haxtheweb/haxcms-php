define(["exports", "../../../lit/index.js", "./simple-fields-container.js", "../../simple-icon/lib/simple-icon-lite.js", "../../simple-icon/lib/simple-icons.js", "../../simple-icon/simple-icon.js"], function (_exports, _index, _simpleFieldsContainer, _simpleIconLite, _simpleIcons, _simpleIcon) {
  ...
  var _templateObject_f2f69620ce4311eca4dffb3bcb5f42ec, _templateObject2_f2f69620ce4311eca4dffb3bcb5f42ec, _templateObject3_f2f69620ce4311eca4dffb3bcb5f42ec, _templateObject4_f2f69620ce4311eca4dffb3bcb5f42ec, _templateObject5_f2f69620ce4311eca4dffb3bcb5f42ec, _templateObject6_f2f69620ce4311eca4dffb3bcb5f42ec, _templateObject7_f2f69620ce4311eca4dffb3bcb5f42ec, _templateObject8_f2f69620ce4311eca4dffb3bcb5f42ec, _templateObject9_f2f69620ce4311eca4dffb3bcb5f42ec, _templateObject10_f2f69620ce4311eca4dffb3bcb5f42ec;
  ...
  var SimpleFieldsFieldBehaviors = function SimpleFieldsFieldBehaviors(SuperClass) {
    return /*#__PURE__*/function (_SimpleFieldsContaine) {
      ...
      babelHelpers.createClass(_class, [{
        ...
        key: "fieldMeta",
        get: function get() {
          return (0, _index.html)(_templateObject2_f2f69620ce4311eca4dffb3bcb5f42ec || (_templateObject2_f2f69620ce4311eca4dffb3bcb5f42ec = babelHelpers.taggedTemplateLiteral(["\n        <div id=\"fieldmeta\" aria-live=\"polite\" part=\"field-meta\"></div>\n      "])));
        }
        /**
        ...
        get: function get() {
          ...
          return (0, _index.html)(_templateObject3_f2f69620ce4311eca4dffb3bcb5f42ec || (_templateObject3_f2f69620ce4311eca4dffb3bcb5f42ec = babelHelpers.taggedTemplateLiteral(["\n        <fieldset\n          part=\"fieldset\"\n          class=\"", "\"\n        >\n          <legend\n            class=\"label-main\"\n            ?hidden=\"", "\"\n            part=\"fieldset-legend\"\n          >\n            ", "", "\n          </legend>\n          <div id=\"options\" part=\"fieldset-options\">\n            ", "\n          </div>\n          ", "\n        </fieldset>\n      "])), !!this.blockOptions ? "block-options" : "inline-options", !this.label, this.label, this.error || this.required ? "*" : "", (this.sortedOptions || []).map(function (option) {
            return (0, _index.html)(_templateObject4_f2f69620ce4311eca4dffb3bcb5f42ec || (_templateObject4_f2f69620ce4311eca4dffb3bcb5f42ec = babelHelpers.taggedTemplateLiteral(["\n                <div class=\"option\" part=\"option\">\n                  <label\n                    for=\"", ".", "\"\n                    class=\"radio-label\"\n                    part=\"option-label\"\n                    >", "</label\n                  >", "\n                </div>\n              "])), _this3.id, option.value, option.text, _this3.getInput(option));
          }), this.fieldBottom);
        }
      }, {
        ...
        value: function getInput(option) {
          ...
          return (0, _index.html)(_templateObject5_f2f69620ce4311eca4dffb3bcb5f42ec || (_templateObject5_f2f69620ce4311eca4dffb3bcb5f42ec = babelHelpers.taggedTemplateLiteral(["\n        <span class=\"input-option\" part=\"option-inner\">\n          <input\n            ?autofocus=\"", "\"\n            aria-descrbedby=\"", "\"\n            .aria-invalid=\"", "\"\n            @blur=\"", "\"\n            @change=\"", "\"\n            ?checked=\"", "\"\n            class=\"field ", "\"\n            ?disabled=\"", "\"\n            @focus=\"", "\"\n            ?hidden=\"", "\"\n            id=\"", ".", "\"\n            @input=\"", "\"\n            name=\"", "\"\n            .placeholder=\"", "\"\n            ?readonly=\"", "\"\n            ?required=\"", "\"\n            tabindex=\"0\"\n            type=\"", "\"\n            value=\"", "\"\n            part=\"option-input\"\n          />\n          ", "\n        </span>\n      "])), this.autofocus, this.describedBy || "", this.error ? "true" : "false", this._onFocusout, this._handleFieldChange, checked, ["checkbox", "color", "file", "radio", "range"].includes(this.type) ? "" : "box-input", this.disabled, this._onFocusin, this.hidden, this.id, !option ? "" : option.value, this._handleFieldChange, this.id, this.placeholder || "", this.readonly, this.required, this.type, !option ? this.value : (option || {}).value, this.type !== "checkbox" && this.type !== "radio" ? "" : (0, _index.html)(_templateObject6_f2f69620ce4311eca4dffb3bcb5f42ec || (_templateObject6_f2f69620ce4311eca4dffb3bcb5f42ec = babelHelpers.taggedTemplateLiteral(["\n                <simple-icon-lite\n                  icon=\"", "\"\n                  @click=\"", "\"\n                  part=\"option-icon\"\n                >\n                </simple-icon-lite>\n              "])), icon, function (e) {
            e.preventDefault();
            e.stopPropagation();
        ...
        get: function get() {
          return (0, _index.html)(_templateObject9_f2f69620ce4311eca4dffb3bcb5f42ec || (_templateObject9_f2f69620ce4311eca4dffb3bcb5f42ec = babelHelpers.taggedTemplateLiteral(["\n        <textarea\n          aria-invalid=\"", "\"\n          ?autofocus=\"", "\"\n          @blur=\"", "\"\n          class=\"field box-input\"\n          @change=\"", "\"\n          @keydown=\"", "\"\n          ?disabled=\"", "\"\n          @focus=\"", "\"\n          ?hidden=\"", "\"\n          id=\"", "\"\n          @input=\"", "\"\n          name=\"", "\"\n          ?readonly=\"", "\"\n          ?required=\"", "\"\n          rows=\"1\"\n          tabindex=\"0\"\n          part=\"textarea\"\n        >\n  ", "</textarea\n        >\n      "])), this.error ? "true" : "false", this.autofocus, this._onFocusout, this._handleFieldChange, function (e) {
