define(["exports", "../../../lit/index.js", "./simple-fields-fieldset.js", "./simple-fields-ui.js", "../../simple-toolbar/lib/simple-toolbar-button.js", "../../simple-icon/simple-icon.js", "../../simple-icon/lib/simple-icons.js", "./simple-fields-array-item.js", "../../responsive-utility/responsive-utility.js"], function (_exports, _index, _simpleFieldsFieldset, _simpleFieldsUi, _simpleToolbarButton, _simpleIcon, _simpleIcons, _simpleFieldsArrayItem, _responsiveUtility) {
  ...
  var _templateObject_8d399b80509711edb124eb517be36dbf, _templateObject2_8d399b80509711edb124eb517be36dbf, _templateObject3_8d399b80509711edb124eb517be36dbf;
  ...
  var SimpleFieldsArray = /*#__PURE__*/function (_SimpleFieldsFieldset) {
    ...
    babelHelpers.createClass(SimpleFieldsArray, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_8d399b80509711edb124eb517be36dbf || (_templateObject_8d399b80509711edb124eb517be36dbf = babelHelpers.taggedTemplateLiteral(["\n      <fieldset part=\"fieldset\">", "", "</fieldset>\n    "])), this.legend, this.fields);
      }
    }, {
      key: "fields",
      get: function get() {
        ...
        return (0, _index.html)(_templateObject2_8d399b80509711edb124eb517be36dbf || (_templateObject2_8d399b80509711edb124eb517be36dbf = babelHelpers.taggedTemplateLiteral(["\n      <div id=\"top\" part=\"top\">\n        ", "\n        <simple-toolbar-button\n          id=\"expand\"\n          controls=\"item-fields\"\n          icon=\"more-vert\"\n          ?disabled=\"", "\"\n          @click=\"", "\"\n          ?toggled=\"", "\"\n          toggles\n          ?show-text-label=\"", "\"\n          label=\"", "\"\n          part=\"expand\"\n        >\n        </simple-toolbar-button>\n      </div>\n      <div id=\"item-fields\" aria-live=\"polite\" part=\"items\">\n        <slot></slot>\n        <simple-toolbar-button\n          id=\"add\"\n          icon=\"add\"\n          ?disabled=\"", "\"\n          controls=\"item-fields\"\n          @click=\"", "\"\n          part=\"add\"\n          icon=\"more-vert\"\n          ?toggled=\"", "\"\n          toggles\n          ?show-text-label=\"", "\"\n          label=\"Add Item\"\n        >\n        </simple-toolbar-button>\n      </div>\n    "])), this.descriptionTemplate, this.disabled, function (e) {
      ...
      key: "styles",
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(SimpleFieldsArray), "styles", this)), babelHelpers.toConsumableArray(_simpleFieldsUi.SimpleFieldsButtonStyles), [(0, _index.css)(_templateObject3_8d399b80509711edb124eb517be36dbf || (_templateObject3_8d399b80509711edb124eb517be36dbf = babelHelpers.taggedTemplateLiteral(["\n        :host([expanded]) #expand::part(icon) {\n          transform: rotate(90deg);\n          transition: all 0.5s ease;\n        }\n        #item-fields {\n          margin: var(--simple-fields-margin-small, 8px) 0;\n          clear: both;\n          z-index: 3;\n        }\n        #top {\n          display: flex;\n          align-items: flex-end;\n          justify-content: flex-end;\n        }\n        #add {\n          float: right;\n        }\n      "])))]);
      }
    }, {
      key: "properties",
      get: function get() {
