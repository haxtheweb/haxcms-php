define(["exports", "../../../lit-element/lit-element.js", "./simple-fields-fieldset.js", "../../../@polymer/paper-button/paper-button.js", "../../../@polymer/iron-icon/iron-icon.js", "../../../@polymer/iron-icons/iron-icons.js", "./simple-fields-array-item.js"], function (_exports, _litElement, _simpleFieldsFieldset, _paperButton, _ironIcon, _ironIcons, _simpleFieldsArrayItem) {
  ...
  function _templateObject2_165a29005a5c11ea9b0bfd873cbf79fd() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        fieldset {\n          padding: 0 20px;\n        }\n        #item-fields {\n          clear: both;\n          margin: 10px 0;\n          z-index: 3;\n        }\n        paper-button {\n          z-index: 1;\n          margin: 0;\n          float: right;\n          text-transform: unset;\n        }\n      "]);

    _templateObject2_165a29005a5c11ea9b0bfd873cbf79fd = function _templateObject2_165a29005a5c11ea9b0bfd873cbf79fd() {
      return data;
    };
  ...
  function _templateObject_165a29005a5c11ea9b0bfd873cbf79fd() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <paper-button\n        id=\"expand\"\n        controls=\"item-fields\"\n        @click=\"", "\"\n      >\n        ", "\n        <iron-icon\n          aria-hidden=\"true\"\n          icon=\"", "\"\n        ></iron-icon>\n      </paper-button>\n      <div id=\"item-fields\" aria-live=\"polite\">\n        <slot></slot>\n        <paper-button\n          id=\"add\"\n          controls=\"item-fields\"\n          @click=\"", "\"\n        >\n          Add Item\n          <iron-icon aria-hidden=\"true\" icon=\"add\"></iron-icon>\n        </paper-button>\n      </div>\n    "]);

    _templateObject_165a29005a5c11ea9b0bfd873cbf79fd = function _templateObject_165a29005a5c11ea9b0bfd873cbf79fd() {
      return data;
    };
  ...
  function (_SimpleFieldsFieldset) {
    ...
    babelHelpers.createClass(SimpleFieldsArray, [{
      ...
      get: function get() {
        ...
        return (0, _litElement.html)(_templateObject_165a29005a5c11ea9b0bfd873cbf79fd(), function (e) {
      ...
      key: "styles",
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(SimpleFieldsArray), "styles", this)), [(0, _litElement.css)(_templateObject2_165a29005a5c11ea9b0bfd873cbf79fd())]);
      }
    }, {
      key: "properties",
      get: function get() {
