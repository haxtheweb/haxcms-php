define(["exports", "../../../lit-element/lit-element.js", "./simple-fields-fieldset.js", "../../simple-icon/simple-icon.js", "../../simple-icon/lib/simple-icons.js", "./simple-fields-array-item.js"], function (_exports, _litElement, _simpleFieldsFieldset, _simpleIcon, _simpleIcons, _simpleFieldsArrayItem) {
  ...
  function _templateObject3_e1d9e4f0247111eb9734a78ef81f0b0d() {
    ...
    _templateObject3_e1d9e4f0247111eb9734a78ef81f0b0d = function _templateObject3_e1d9e4f0247111eb9734a78ef81f0b0d() {
      return data;
    };
  ...
  function _templateObject2_e1d9e4f0247111eb9734a78ef81f0b0d() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <div id=\"top\">\n        ", "\n        <button\n          id=\"expand\"\n          controls=\"item-fields\"\n          @click=\"", "\"\n        >\n          ", "\n          <simple-icon\n            class=\"", "\"\n            aria-hidden=\"true\"\n            icon=\"expand-more\"\n          ></simple-icon>\n        </button>\n      </div>\n      <div id=\"item-fields\" aria-live=\"polite\">\n        <slot></slot>\n        <button\n          id=\"add\"\n          controls=\"item-fields\"\n          @click=\"", "\"\n        >\n          Add Item\n          <simple-icon aria-hidden=\"true\" icon=\"add\"></simple-icon>\n        </button>\n      </div>\n    "]);

    _templateObject2_e1d9e4f0247111eb9734a78ef81f0b0d = function _templateObject2_e1d9e4f0247111eb9734a78ef81f0b0d() {
      return data;
    };
  ...
  function _templateObject_e1d9e4f0247111eb9734a78ef81f0b0d() {
    var data = babelHelpers.taggedTemplateLiteral([" <fieldset>", "", "</fieldset> "]);

    _templateObject_e1d9e4f0247111eb9734a78ef81f0b0d = function _templateObject_e1d9e4f0247111eb9734a78ef81f0b0d() {
      return data;
    };
  ...
  var SimpleFieldsArray = /*#__PURE__*/function (_SimpleFieldsFieldset) {
    ...
    babelHelpers.createClass(SimpleFieldsArray, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_e1d9e4f0247111eb9734a78ef81f0b0d(), this.legend, this.fields);
      }
    }, {
      key: "fields",
      get: function get() {
        ...
        return (0, _litElement.html)(_templateObject2_e1d9e4f0247111eb9734a78ef81f0b0d(), this.desc, function (e) {
      ...
      key: "styles",
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(SimpleFieldsArray), "styles", this)), [(0, _litElement.css)(_templateObject3_e1d9e4f0247111eb9734a78ef81f0b0d())]);
      }
    }, {
      key: "properties",
      get: function get() {
