...
function _templateObject10_e4612b4027c411edb7faa9deadcbafd2() {
  var data = _taggedTemplateLiteral(['\n        <textarea\n          aria-invalid="', '"\n          ?autofocus="', '"\n          @blur="', '"\n          class="field box-input"\n          @change="', '"\n          @keydown="', '"\n          ?disabled="', '"\n          @focus="', '"\n          ?hidden="', '"\n          id="', '"\n          @input="', '"\n          name="', '"\n          ?readonly="', '"\n          ?required="', '"\n          rows="1"\n          tabindex="0"\n          part="textarea"\n        >\n  ', "</textarea\n        >\n      "]);

  _templateObject10_e4612b4027c411edb7faa9deadcbafd2 = function _templateObject10_e4612b4027c411edb7faa9deadcbafd2() {
    return data;
  };
...
function _templateObject9_e4612b4027c411edb7faa9deadcbafd2() {
  var data = _taggedTemplateLiteral(['\n              <option\n                part="select-option"\n                .id="', ".", '"\n                ?selected="', '"\n                .value="', '"\n              >\n                ', "\n              </option>\n            "]);

  _templateObject9_e4612b4027c411edb7faa9deadcbafd2 = function _templateObject9_e4612b4027c411edb7faa9deadcbafd2() {
    return data;
  };
...
function _templateObject8_e4612b4027c411edb7faa9deadcbafd2() {
  var data = _taggedTemplateLiteral(['\n        <select\n          ?autofocus="', '"\n          aria-descrbedby="', '"\n          aria-invalid="', '"\n          @blur="', '"\n          @change="', '"\n          class="field"\n          ?disabled="', '"\n          @focus="', '"\n          ?hidden="', '"\n          id="', '"\n          ?multiple="', '"\n          name="', '"\n          ?readonly="', '"\n          ?required="', '"\n          tabindex="0"\n          part="select"\n        >\n          ', '\n        </select>\n        <simple-icon-lite icon="arrow-drop-down"></simple-icon-lite>\n      ']);

  _templateObject8_e4612b4027c411edb7faa9deadcbafd2 = function _templateObject8_e4612b4027c411edb7faa9deadcbafd2() {
    return data;
  };
...
function _templateObject7_e4612b4027c411edb7faa9deadcbafd2() {
  var data = _taggedTemplateLiteral(['\n                <div class="option inline" part="option">\n                  <label\n                    for="', ".", '"\n                    class="radio-label"\n                    part="option-label"\n                    >', "</label\n                  >", "\n                </div>\n              "]);

  _templateObject7_e4612b4027c411edb7faa9deadcbafd2 = function _templateObject7_e4612b4027c411edb7faa9deadcbafd2() {
    return data;
  };
...
function _templateObject6_e4612b4027c411edb7faa9deadcbafd2() {
  var data = _taggedTemplateLiteral(['\n        <fieldset part="fieldset">\n          <legend\n            class="label-main"\n            ?hidden="', '"\n            part="fieldset-legend"\n          >\n            ', "", '\n          </legend>\n          <div id="options" part="fieldset-options">\n            ', "\n          </div>\n          ", "\n        </fieldset>\n      "]);

  _templateObject6_e4612b4027c411edb7faa9deadcbafd2 = function _templateObject6_e4612b4027c411edb7faa9deadcbafd2() {
    return data;
  };
...
function _templateObject5_e4612b4027c411edb7faa9deadcbafd2() {
  var data = _taggedTemplateLiteral(['\n        <div id="fieldmeta" aria-live="polite" part="field-meta"></div>\n      ']);

  _templateObject5_e4612b4027c411edb7faa9deadcbafd2 = function _templateObject5_e4612b4027c411edb7faa9deadcbafd2() {
    return data;
  };
...
function _templateObject4_e4612b4027c411edb7faa9deadcbafd2() {
  var data = _taggedTemplateLiteral(['\n        <div\n          class="', '"\n          part="field-main"\n        >\n          ', '\n          <div id="field-main-inner" part="field-main-inner">\n            ', "\n            ", "\n            ", "\n          </div>\n        </div>\n      "]);

  _templateObject4_e4612b4027c411edb7faa9deadcbafd2 = function _templateObject4_e4612b4027c411edb7faa9deadcbafd2() {
    return data;
  };
...
function _templateObject3_e4612b4027c411edb7faa9deadcbafd2() {
  var data = _taggedTemplateLiteral(['\n                <simple-icon-lite\n                  icon="', '"\n                  @click="', '"\n                  part="option-icon"\n                >\n                </simple-icon-lite>\n              ']);

  _templateObject3_e4612b4027c411edb7faa9deadcbafd2 = function _templateObject3_e4612b4027c411edb7faa9deadcbafd2() {
    return data;
  };
...
function _templateObject2_e4612b4027c411edb7faa9deadcbafd2() {
  var data = _taggedTemplateLiteral(['\n        <span class="input-option" part="option-inner">\n          <input\n            ?autofocus="', '"\n            aria-descrbedby="', '"\n            .aria-invalid="', '"\n            @blur="', '"\n            @change="', '"\n            ?checked="', '"\n            class="field ', '"\n            ?disabled="', '"\n            @focus="', '"\n            ?hidden="', '"\n            id="', '"\n            @input="', '"\n            name="', '"\n            .placeholder="', '"\n            ?readonly="', '"\n            ?required="', '"\n            tabindex="0"\n            type="', '"\n            value="', '"\n            part="option-input"\n          />\n          ', "\n        </span>\n      "]);

  _templateObject2_e4612b4027c411edb7faa9deadcbafd2 = function _templateObject2_e4612b4027c411edb7faa9deadcbafd2() {
    return data;
  };
...
function _templateObject_e4612b4027c411edb7faa9deadcbafd2() {
  ...
  _templateObject_e4612b4027c411edb7faa9deadcbafd2 = function _templateObject_e4612b4027c411edb7faa9deadcbafd2() {
    return data;
  };
...
var SimpleFieldsFieldBehaviors = function SimpleFieldsFieldBehaviors(SuperClass) {
  return /*#__PURE__*/function (_SimpleFieldsContaine) {
    ...
    _createClass(_class, [{
      ...
      key: "styles",
      get: function get() {
        return [].concat(_toConsumableArray(_get(_getPrototypeOf(_class), "styles", this)), [(0, _litElement.css)(_templateObject_e4612b4027c411edb7faa9deadcbafd2())]);
      }
    }, {
      key: "properties",
      get: function get() {
    ...
    _createClass(_class, [{
      ...
      value: function getInput(option) {
        ...
        return (0, _litElement.html)(_templateObject2_e4612b4027c411edb7faa9deadcbafd2(), this.autofocus, this.describedBy || "", this.error ? "true" : "false", this._onFocusout, this._handleFieldChange, checked, ["checkbox", "color", "file", "radio", "range"].includes(this.type) ? "" : "box-input", this.disabled, this._onFocusin, this.hidden, !option ? this.id : option.value, this._handleFieldChange, this.id, this.placeholder || "", this.readonly, this.required, this.type, !option ? this.value : (option || {}).value, this.type !== "checkbox" && this.type !== "radio" ? "" : (0, _litElement.html)(_templateObject3_e4612b4027c411edb7faa9deadcbafd2(), icon, function (e) {
      ...
      key: "fieldMeta",
      get: function get() {
        return (0, _litElement.html)(_templateObject5_e4612b4027c411edb7faa9deadcbafd2());
      }
      /**
      ...
      get: function get() {
        ...
        return (0, _litElement.html)(_templateObject6_e4612b4027c411edb7faa9deadcbafd2(), !this.label, this.label, this.error || this.required ? "*" : "", (this.sortedOptions || []).map(function (option) {
          return (0, _litElement.html)(_templateObject7_e4612b4027c411edb7faa9deadcbafd2(), _this5.id, option.value, option.text, _this5.getInput(option));
        }), this.fieldBottom);
      }
    }, {
      key: "inputTemplate",
      ...
      get: function get() {
        ...
        return (0, _litElement.html)(_templateObject8_e4612b4027c411edb7faa9deadcbafd2(), this.autofocus, this.describedBy, this.error ? "true" : "false", this._onFocusout, this._handleFieldChange, this.disabled, this._onFocusin, this.hidden, this.id, this.multiple, this.id, this.readonly, this.required, (this.sortedOptions || []).map(function (option) {
          return (0, _litElement.html)(_templateObject9_e4612b4027c411edb7faa9deadcbafd2(), _this7.id, option.value, _this7.multiple ? _this7.value && _this7.value.includes(option.value) : _this7.value === option.value, option.value, option.text);
        }));
      }
      /**
      ...
      get: function get() {
        return (0, _litElement.html)(_templateObject10_e4612b4027c411edb7faa9deadcbafd2(), this.error ? "true" : "false", this.autofocus, this._onFocusout, this._handleFieldChange, function (e) {
