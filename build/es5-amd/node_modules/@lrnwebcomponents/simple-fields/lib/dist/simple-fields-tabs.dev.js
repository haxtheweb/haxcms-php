...
function _templateObject2_d1ed1a00403311edb9fff3e6b08a0a9a() {
  ...
  _templateObject2_d1ed1a00403311edb9fff3e6b08a0a9a = function _templateObject2_d1ed1a00403311edb9fff3e6b08a0a9a() {
    return data;
  };
...
function _templateObject_d1ed1a00403311edb9fff3e6b08a0a9a() {
  var data = _taggedTemplateLiteral(['\n      <span class="label', '" part="tab-label"\n        >', "", "</span\n      >\n    "]);

  _templateObject_d1ed1a00403311edb9fff3e6b08a0a9a = function _templateObject_d1ed1a00403311edb9fff3e6b08a0a9a() {
    return data;
  };
...
var SimpleFieldsTabs = /*#__PURE__*/function (_A11yTabs) {
  ...
  _createClass(SimpleFieldsTabs, [{
    ...
    value: function _tabLabel(tab) {
      return (0, _litElement.html)(_templateObject_d1ed1a00403311edb9fff3e6b08a0a9a(), tab.error ? " error" : "", tab.label, tab.error ? "*" : "");
    }
  }, {
    key: "tabQuery",
    ...
    key: "styles",
    get: function get() {
      return [].concat(_toConsumableArray(this.A11yTabsCoreStyles), _toConsumableArray(_simpleFieldsUi.SimpleFieldsButtonStyles), [(0, _litElement.css)(_templateObject2_d1ed1a00403311edb9fff3e6b08a0a9a())]);
    }
  }, {
    key: "properties",
    get: function get() {
