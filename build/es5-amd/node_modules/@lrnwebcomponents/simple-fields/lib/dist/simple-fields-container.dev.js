...
function _templateObject10_00211740a0ca11eda392efd0bad1b4bf() {
  var data = _taggedTemplateLiteral(['\n        <slot name="suffix"></slot>\n        ', "\n      "]);
  _templateObject10_00211740a0ca11eda392efd0bad1b4bf = function _templateObject10_00211740a0ca11eda392efd0bad1b4bf() {
    return data;
  };
  return data;
}
function _templateObject9_00211740a0ca11eda392efd0bad1b4bf() {
  var data = _taggedTemplateLiteral(['\n        <slot name="prefix"></slot>\n        ', "\n      "]);
  _templateObject9_00211740a0ca11eda392efd0bad1b4bf = function _templateObject9_00211740a0ca11eda392efd0bad1b4bf() {
    return data;
  };
  return data;
}
function _templateObject8_00211740a0ca11eda392efd0bad1b4bf() {
  var data = _taggedTemplateLiteral(['\n        <label\n          for="', '"\n          class="label-main"\n          ?hidden="', '"\n          part="label"\n        >\n          <slot name="label-prefix"></slot>\n          <slot name="label"></slot>\n          ', "", "\n        </label>\n      "]);
  _templateObject8_00211740a0ca11eda392efd0bad1b4bf = function _templateObject8_00211740a0ca11eda392efd0bad1b4bf() {
    return data;
  };
  return data;
}
function _templateObject7_00211740a0ca11eda392efd0bad1b4bf() {
  var data = _taggedTemplateLiteral(['\n        <div id="fieldmeta" aria-live="polite" part="field-meta">\n          <slot name="field-meta"></slot>\n        </div>\n      ']);
  _templateObject7_00211740a0ca11eda392efd0bad1b4bf = function _templateObject7_00211740a0ca11eda392efd0bad1b4bf() {
    return data;
  };
  return data;
}
function _templateObject6_00211740a0ca11eda392efd0bad1b4bf() {
  var data = _taggedTemplateLiteral(['\n        <div\n          class="', '"\n          part="field-main"\n        >\n          ', '\n          <div part="field-inner">\n            ', '\n            <slot name="field"></slot>\n            ', "\n          </div>\n        </div>\n      "]);
  _templateObject6_00211740a0ca11eda392efd0bad1b4bf = function _templateObject6_00211740a0ca11eda392efd0bad1b4bf() {
    return data;
  };
  return data;
}
function _templateObject5_00211740a0ca11eda392efd0bad1b4bf() {
  ...
  _templateObject5_00211740a0ca11eda392efd0bad1b4bf = function _templateObject5_00211740a0ca11eda392efd0bad1b4bf() {
    return data;
  };
  return data;
}
function _templateObject4_00211740a0ca11eda392efd0bad1b4bf() {
  var data = _taggedTemplateLiteral(['\n        <div\n          id="error-message"\n          ?hidden="', '"\n          role="alert"\n          part="error-msg"\n        >\n          ', "\n        </div>\n      "]);
  _templateObject4_00211740a0ca11eda392efd0bad1b4bf = function _templateObject4_00211740a0ca11eda392efd0bad1b4bf() {
    return data;
  };
  return data;
}
function _templateObject3_00211740a0ca11eda392efd0bad1b4bf() {
  var data = _taggedTemplateLiteral(['\n        <div id="description" part="field-desc">\n          <slot name="description"></slot>\n          ', "\n        </div>\n      "]);
  _templateObject3_00211740a0ca11eda392efd0bad1b4bf = function _templateObject3_00211740a0ca11eda392efd0bad1b4bf() {
    return data;
  };
  return data;
}
function _templateObject2_00211740a0ca11eda392efd0bad1b4bf() {
  ...
  _templateObject2_00211740a0ca11eda392efd0bad1b4bf = function _templateObject2_00211740a0ca11eda392efd0bad1b4bf() {
    return data;
  };
  return data;
}
...
function _templateObject_00211740a0ca11eda392efd0bad1b4bf() {
  var data = _taggedTemplateLiteral([" ", " ", " "]);
  _templateObject_00211740a0ca11eda392efd0bad1b4bf = function _templateObject_00211740a0ca11eda392efd0bad1b4bf() {
    return data;
  };
  return data;
}
    ...
    function (_SuperClass) {
      ...
      _createClass(_class, [{
        ...
        value: function render() {
          return (0, _litElement.html)(_templateObject_00211740a0ca11eda392efd0bad1b4bf(), this.fieldMainTemplate, this.fieldBottom);
        }
      }], [{
        key: "tag",
        get: function get() {
        ...
        key: "styles",
        get: function get() {
          return [].concat(_toConsumableArray(_simpleFieldsUi.SimpleFieldsBaseStyles), _toConsumableArray(_simpleFieldsUi.SimpleFieldsLabelStyles), _toConsumableArray(_simpleFieldsUi.SimpleFieldsDescriptionStyles), [(0, _litElement.css)(_templateObject2_00211740a0ca11eda392efd0bad1b4bf())]);
        }
      }, {
        key: "properties",
        get: function get() {
      ...
      _createClass(_class, [{
        ...
        get: function get() {
          return (0, _litElement.html)(_templateObject3_00211740a0ca11eda392efd0bad1b4bf(), this.description);
        }
        /**
        ...
        key: "errorTemplate",
        get: function get() {
          return (0, _litElement.html)(_templateObject4_00211740a0ca11eda392efd0bad1b4bf(), !this.error, this.errorMessage);
        }
        /**
         *
        ...
        key: "fieldBottom",
        get: function get() {
          return (0, _litElement.html)(_templateObject5_00211740a0ca11eda392efd0bad1b4bf(), this.descriptionTemplate, this.errorTemplate, this.fieldMeta);
        }
        /**
         * gets field's id
         *
        ...
        get: function get() {
          return (0, _litElement.html)(_templateObject6_00211740a0ca11eda392efd0bad1b4bf(), this.inline || ["checkbox", "color", "radio"].includes(this.type || "text") ? "field-main inline" : "field-main", this.labelTemplate, this.prefixTemplate, this.suffixTemplate);
        }
        /**
         *
         * gets field metadata
        ...
        key: "fieldMeta",
        get: function get() {
          return (0, _litElement.html)(_templateObject7_00211740a0ca11eda392efd0bad1b4bf());
        }
      }, {
        key: "hasFieldset",
        get: function get() {
        ...
        key: "labelTemplate",
        get: function get() {
          return (0, _litElement.html)(_templateObject8_00211740a0ca11eda392efd0bad1b4bf(), this.fieldId, this.type === "fieldset", this.label, this.error || this.required ? "*" : "");
        }
      }, {
        key: "multicheck",
        get: function get() {
        ...
        key: "prefixTemplate",
        get: function get() {
          return (0, _litElement.html)(_templateObject9_00211740a0ca11eda392efd0bad1b4bf(), this.prefix);
        }
        /**
        ...
        key: "suffixTemplate",
        get: function get() {
          return (0, _litElement.html)(_templateObject10_00211740a0ca11eda392efd0bad1b4bf(), this.suffix);
        }
      }]);
      return _class;
    }(SuperClass)
