...
function _templateObject10_9b7ae640509711edb124eb517be36dbf() {
  var data = _taggedTemplateLiteral(['\n        <slot name="suffix"></slot>\n        ', "\n      "]);

  _templateObject10_9b7ae640509711edb124eb517be36dbf = function _templateObject10_9b7ae640509711edb124eb517be36dbf() {
    return data;
  };
...
function _templateObject9_9b7ae640509711edb124eb517be36dbf() {
  var data = _taggedTemplateLiteral(['\n        <slot name="prefix"></slot>\n        ', "\n      "]);

  _templateObject9_9b7ae640509711edb124eb517be36dbf = function _templateObject9_9b7ae640509711edb124eb517be36dbf() {
    return data;
  };
...
function _templateObject8_9b7ae640509711edb124eb517be36dbf() {
  var data = _taggedTemplateLiteral(['\n        <label\n          for="', '"\n          class="label-main"\n          ?hidden="', '"\n          part="label"\n        >\n          <slot name="label-prefix"></slot>\n          <slot name="label"></slot>\n          ', "", "\n        </label>\n      "]);

  _templateObject8_9b7ae640509711edb124eb517be36dbf = function _templateObject8_9b7ae640509711edb124eb517be36dbf() {
    return data;
  };
...
function _templateObject7_9b7ae640509711edb124eb517be36dbf() {
  var data = _taggedTemplateLiteral(['\n        <div id="fieldmeta" aria-live="polite" part="field-meta">\n          <slot name="field-meta"></slot>\n        </div>\n      ']);

  _templateObject7_9b7ae640509711edb124eb517be36dbf = function _templateObject7_9b7ae640509711edb124eb517be36dbf() {
    return data;
  };
...
function _templateObject6_9b7ae640509711edb124eb517be36dbf() {
  var data = _taggedTemplateLiteral(['\n        <div\n          class="', '"\n          part="field-main"\n        >\n          ', '\n          <div part="field-inner">\n            ', '\n            <slot name="field"></slot>\n            ', "\n          </div>\n        </div>\n      "]);

  _templateObject6_9b7ae640509711edb124eb517be36dbf = function _templateObject6_9b7ae640509711edb124eb517be36dbf() {
    return data;
  };
...
function _templateObject5_9b7ae640509711edb124eb517be36dbf() {
  ...
  _templateObject5_9b7ae640509711edb124eb517be36dbf = function _templateObject5_9b7ae640509711edb124eb517be36dbf() {
    return data;
  };
...
function _templateObject4_9b7ae640509711edb124eb517be36dbf() {
  var data = _taggedTemplateLiteral(['\n        <div\n          id="error-message"\n          ?hidden="', '"\n          role="alert"\n          part="error-msg"\n        >\n          ', "\n        </div>\n      "]);

  _templateObject4_9b7ae640509711edb124eb517be36dbf = function _templateObject4_9b7ae640509711edb124eb517be36dbf() {
    return data;
  };
...
function _templateObject3_9b7ae640509711edb124eb517be36dbf() {
  var data = _taggedTemplateLiteral(['\n        <div id="description" part="field-desc">\n          <slot name="description"></slot>\n          ', "\n        </div>\n      "]);

  _templateObject3_9b7ae640509711edb124eb517be36dbf = function _templateObject3_9b7ae640509711edb124eb517be36dbf() {
    return data;
  };
...
function _templateObject2_9b7ae640509711edb124eb517be36dbf() {
  ...
  _templateObject2_9b7ae640509711edb124eb517be36dbf = function _templateObject2_9b7ae640509711edb124eb517be36dbf() {
    return data;
  };
...
function _templateObject_9b7ae640509711edb124eb517be36dbf() {
  var data = _taggedTemplateLiteral([" ", " ", " "]);

  _templateObject_9b7ae640509711edb124eb517be36dbf = function _templateObject_9b7ae640509711edb124eb517be36dbf() {
    return data;
  };
  ...
  return /*#__PURE__*/function (_SuperClass) {
    ...
    _createClass(_class, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_9b7ae640509711edb124eb517be36dbf(), this.fieldMainTemplate, this.fieldBottom);
      }
    }], [{
      key: "tag",
      get: function get() {
      ...
      key: "styles",
      get: function get() {
        return [].concat(_toConsumableArray(_simpleFieldsUi.SimpleFieldsBaseStyles), _toConsumableArray(_simpleFieldsUi.SimpleFieldsLabelStyles), _toConsumableArray(_simpleFieldsUi.SimpleFieldsDescriptionStyles), [(0, _litElement.css)(_templateObject2_9b7ae640509711edb124eb517be36dbf())]);
      }
    }, {
      key: "properties",
      get: function get() {
    ...
    _createClass(_class, [{
      ...
      get: function get() {
        return (0, _litElement.html)(_templateObject3_9b7ae640509711edb124eb517be36dbf(), this.description);
      }
      /**
      ...
      key: "errorTemplate",
      get: function get() {
        return (0, _litElement.html)(_templateObject4_9b7ae640509711edb124eb517be36dbf(), !this.error, this.errorMessage);
      }
      /**
       *
      ...
      key: "fieldBottom",
      get: function get() {
        return (0, _litElement.html)(_templateObject5_9b7ae640509711edb124eb517be36dbf(), this.descriptionTemplate, this.errorTemplate, this.fieldMeta);
      }
      /**
       * gets field's id
       *
      ...
      get: function get() {
        return (0, _litElement.html)(_templateObject6_9b7ae640509711edb124eb517be36dbf(), this.inline || ["checkbox", "color", "radio"].includes(this.type || "text") ? "field-main inline" : "field-main", this.labelTemplate, this.prefixTemplate, this.suffixTemplate);
      }
      /**
       *
       * gets field metadata
      ...
      key: "fieldMeta",
      get: function get() {
        return (0, _litElement.html)(_templateObject7_9b7ae640509711edb124eb517be36dbf());
      }
    }, {
      key: "hasFieldset",
      get: function get() {
      ...
      key: "labelTemplate",
      get: function get() {
        return (0, _litElement.html)(_templateObject8_9b7ae640509711edb124eb517be36dbf(), this.fieldId, this.type === "fieldset", this.label, this.error || this.required ? "*" : "");
      }
    }, {
      key: "multicheck",
      get: function get() {
      ...
      key: "prefixTemplate",
      get: function get() {
        return (0, _litElement.html)(_templateObject9_9b7ae640509711edb124eb517be36dbf(), this.prefix);
      }
      /**
      ...
      key: "suffixTemplate",
      get: function get() {
        return (0, _litElement.html)(_templateObject10_9b7ae640509711edb124eb517be36dbf(), this.suffix);
      }
    }]);
