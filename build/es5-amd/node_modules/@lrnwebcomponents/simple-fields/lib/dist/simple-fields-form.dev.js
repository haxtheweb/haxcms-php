...
function _templateObject_ba7cf3e0ad1d11ebb47045b99ace3b6f() {
  var data = _taggedTemplateLiteral(['\n      <form part="form">\n        <slot name="before"></slot>\n        <simple-fields\n          id="sf"\n          .autofocus="', '"\n          ?watchColorPrefs="', '"\n          language="', '"\n          .resources="', '"\n          .schema="', '"\n          .fields="', '"\n          .schematizer="', '"\n          .elementizer="', '"\n          .value="', '"\n          @value-changed="', '"\n          part="fields"\n        >\n        </simple-fields>\n        <slot></slot>\n      </form>\n    ']);

  _templateObject_ba7cf3e0ad1d11ebb47045b99ace3b6f = function _templateObject_ba7cf3e0ad1d11ebb47045b99ace3b6f() {
    return data;
  };
...
var SimpleFieldsForm = /*#__PURE__*/function (_SimpleFieldsFormLite) {
  ...
  _createClass(SimpleFieldsForm, [{
    ...
    value: function render() {
      return (0, _litElement.html)(_templateObject_ba7cf3e0ad1d11ebb47045b99ace3b6f(), !this.disableAutofocus, this.watchColorPrefs, this.language || "", this.resources, this.schema, this.fields, this.fieldsConversion, this.elementizer, this.value, this._valueChanged);
    }
    /**
