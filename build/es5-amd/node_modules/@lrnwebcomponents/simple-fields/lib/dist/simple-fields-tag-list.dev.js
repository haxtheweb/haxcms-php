...
function _templateObject4_7927aa902ee311eda9c37b2c2696a94a() {
  var data = _taggedTemplateLiteral(["\n            <simple-tag\n              cancel-button\n              .data=", '\n              value="', '"\n              accent-color="', '"\n              @simple-tag-clicked="', '"\n            ></simple-tag>\n          ']);

  _templateObject4_7927aa902ee311eda9c37b2c2696a94a = function _templateObject4_7927aa902ee311eda9c37b2c2696a94a() {
    return data;
  };
...
function _templateObject3_7927aa902ee311eda9c37b2c2696a94a() {
  var data = _taggedTemplateLiteral(["\n      ", '\n      <slot name="taglist">\n        ', "\n      </slot>\n    "]);

  _templateObject3_7927aa902ee311eda9c37b2c2696a94a = function _templateObject3_7927aa902ee311eda9c37b2c2696a94a() {
    return data;
  };
...
function _templateObject2_7927aa902ee311eda9c37b2c2696a94a() {
  var data = _taggedTemplateLiteral(['\n      <span class="input-option" part="option-inner">\n        <input\n          @keydown="', '"\n          @keyup="', '"\n          ?autofocus="', '"\n          aria-descrbedby="', '"\n          .aria-invalid="', '"\n          @blur="', '"\n          @change="', '"\n          class="field box-input"\n          ?disabled="', '"\n          @focus="', '"\n          ?hidden="', '"\n          id="', '"\n          @input="', '"\n          name="', '"\n          .placeholder="', '"\n          ?readonly="', '"\n          ?required="', '"\n          tabindex="0"\n          type="text"\n          value="', '"\n          part="option-input"\n        />\n      </span>\n    ']);

  _templateObject2_7927aa902ee311eda9c37b2c2696a94a = function _templateObject2_7927aa902ee311eda9c37b2c2696a94a() {
    return data;
  };
...
function _templateObject_7927aa902ee311eda9c37b2c2696a94a() {
  ...
  _templateObject_7927aa902ee311eda9c37b2c2696a94a = function _templateObject_7927aa902ee311eda9c37b2c2696a94a() {
    return data;
  };
...
var SimpleFieldsTagList = /*#__PURE__*/function (_SimpleFieldsFieldBeh) {
  ...
  _createClass(SimpleFieldsTagList, null, [{
    ...
    key: "styles",
    get: function get() {
      return [].concat(_toConsumableArray(_get(_getPrototypeOf(SimpleFieldsTagList), "styles", this)), [(0, _litElement.css)(_templateObject_7927aa902ee311eda9c37b2c2696a94a())]);
    }
  }, {
    key: "properties",
    get: function get() {
  ...
  _createClass(SimpleFieldsTagList, [{
    ...
    get: function get() {
      ...
      return (0, _litElement.html)(_templateObject3_7927aa902ee311eda9c37b2c2696a94a(), _get(_getPrototypeOf(SimpleFieldsTagList.prototype), "prefixTemplate", this), this.tagList.map(function (tag) {
        return (0, _litElement.html)(_templateObject4_7927aa902ee311eda9c37b2c2696a94a(), tag, tag.term, tag.color, _this5.removeTag);
      }));
    }
  }, {
