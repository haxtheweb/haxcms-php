...
function _templateObject4_becdbef0af6311ebbe560fe9c4727db1() {
  var data = _taggedTemplateLiteral(["\n            <simple-tag\n              cancel-button\n              .data=", '\n              value="', '"\n              accent-color="', '"\n              @simple-tag-clicked="', '"\n            ></simple-tag>\n          ']);

  _templateObject4_becdbef0af6311ebbe560fe9c4727db1 = function _templateObject4_becdbef0af6311ebbe560fe9c4727db1() {
    return data;
  };
...
function _templateObject3_becdbef0af6311ebbe560fe9c4727db1() {
  var data = _taggedTemplateLiteral(["\n      ", '\n      <slot name="taglist">\n        ', "\n      </slot>\n    "]);

  _templateObject3_becdbef0af6311ebbe560fe9c4727db1 = function _templateObject3_becdbef0af6311ebbe560fe9c4727db1() {
    return data;
  };
...
function _templateObject2_becdbef0af6311ebbe560fe9c4727db1() {
  var data = _taggedTemplateLiteral(['\n      <span class="input-option" part="option-inner">\n        <input\n          @keydown="', '"\n          @keyup="', '"\n          ?autofocus="', '"\n          aria-descrbedby="', '"\n          .aria-invalid="', '"\n          @blur="', '"\n          @change="', '"\n          class="field box-input"\n          ?disabled="', '"\n          @focus="', '"\n          ?hidden="', '"\n          id="', '"\n          @input="', '"\n          name="', '"\n          .placeholder="', '"\n          ?readonly="', '"\n          ?required="', '"\n          tabindex="0"\n          type="text"\n          value="', '"\n          part="option-input"\n        />\n      </span>\n    ']);

  _templateObject2_becdbef0af6311ebbe560fe9c4727db1 = function _templateObject2_becdbef0af6311ebbe560fe9c4727db1() {
    return data;
  };
...
function _templateObject_becdbef0af6311ebbe560fe9c4727db1() {
  ...
  _templateObject_becdbef0af6311ebbe560fe9c4727db1 = function _templateObject_becdbef0af6311ebbe560fe9c4727db1() {
    return data;
  };
...
var SimpleFieldsTagList = /*#__PURE__*/function (_SimpleFieldsFieldBeh) {
  ...
  _createClass(SimpleFieldsTagList, null, [{
    ...
    key: "styles",
    get: function get() {
      return [].concat(_toConsumableArray(_get(_getPrototypeOf(SimpleFieldsTagList), "styles", this)), [(0, _litElement.css)(_templateObject_becdbef0af6311ebbe560fe9c4727db1())]);
    }
  }, {
    key: "properties",
    get: function get() {
  ...
  _createClass(SimpleFieldsTagList, [{
    ...
    value: function getInput() {
      return (0, _litElement.html)(_templateObject2_becdbef0af6311ebbe560fe9c4727db1(), this._handleKeydown, this._handleKeyup, this.autofocus, this.describedBy || "", this.error ? "true" : "false", this._onFocusout, this._handleFieldChange, this.disabled, this._onFocusin, this.hidden, this.id, this._handleFieldChange, this.id, this.placeholder || "", this.readonly, this.required, this.value);
    }
  }, {
    key: "removeTag",
    ...
    get: function get() {
      ...
      return (0, _litElement.html)(_templateObject3_becdbef0af6311ebbe560fe9c4727db1(), _get(_getPrototypeOf(SimpleFieldsTagList.prototype), "prefixTemplate", this), this.tagList.map(function (tag) {
        return (0, _litElement.html)(_templateObject4_becdbef0af6311ebbe560fe9c4727db1(), tag, tag.term, tag.color, _this5.removeTag);
      }));
    }
  }, {
