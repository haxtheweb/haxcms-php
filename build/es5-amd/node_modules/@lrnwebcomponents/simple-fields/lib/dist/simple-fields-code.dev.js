...
function _templateObject2_5f49c070ce0511ec9811713d37552719() {
  var data = _taggedTemplateLiteral(['\n      <div class="field-main" part="field-main">\n        ', '\n        <code-editor\n          ?autofocus="', '"\n          ?disabled="', '"\n          font-size="', '"\n          editor-value="', '"\n          theme="', '"\n          language="', '"\n          mode="', '"\n          ?read-only="', '"\n          @value-changed="', '"\n          @focused-changed="', '"\n          @code-editor-focus="', '"\n          @code-editor-blur="', '"\n          part="editor"\n        >\n        </code-editor>\n        <input name="', '" type="hidden" value="', '" />\n      </div>\n    ']);

  _templateObject2_5f49c070ce0511ec9811713d37552719 = function _templateObject2_5f49c070ce0511ec9811713d37552719() {
    return data;
  };
...
function _templateObject_5f49c070ce0511ec9811713d37552719() {
  ...
  _templateObject_5f49c070ce0511ec9811713d37552719 = function _templateObject_5f49c070ce0511ec9811713d37552719() {
    return data;
  };
...
var SimpleFieldsCode = /*#__PURE__*/function (_SimpleFieldsContaine) {
  ...
  _createClass(SimpleFieldsCode, [{
    ...
    key: "styles",
    get: function get() {
      return [].concat(_toConsumableArray(_get(_getPrototypeOf(SimpleFieldsCode), "styles", this)), [(0, _litElement.css)(_templateObject_5f49c070ce0511ec9811713d37552719())]);
    }
  }, {
    key: "properties",
    get: function get() {
  ...
  _createClass(SimpleFieldsCode, [{
    ...
    get: function get() {
      ...
      return (0, _litElement.html)(_templateObject2_5f49c070ce0511ec9811713d37552719(), this.labelTemplate, this.autofocus, this.disabled, this.fontSize, this.__editorValue || "", this.theme || "auto", this.language, this.mode, this.readonly || this.disabled, this._onChange, this._onFocusChange, function (e) {
