...
function _templateObject3_1cfecb50930211eb82a7a575782a1009() {
  var data = _taggedTemplateLiteral(["\n        :host([expanded]) #expand::part(icon) {\n          transform: rotate(90deg);\n          transition: all 0.5s ease;\n        }\n        #item-fields {\n          margin: var(--simple-fields-margin-small, 8px) 0;\n          clear: both;\n          z-index: 3;\n        }\n        #top {\n          display: flex;\n          align-items: flex-end;\n          justify-content: flex-end;\n        }\n        #add {\n          float: right;\n        }\n      "]);

  _templateObject3_1cfecb50930211eb82a7a575782a1009 = function _templateObject3_1cfecb50930211eb82a7a575782a1009() {
    return data;
  };
...
function _templateObject2_1cfecb50930211eb82a7a575782a1009() {
  var data = _taggedTemplateLiteral(['\n      <div id="top" part="top">\n        ', '\n        <simple-toolbar-button\n          id="expand"\n          controls="item-fields"\n          icon="more-vert"\n          @click="', '"\n          ?toggled="', '"\n          toggles\n          show-text-label\n          label="', '"\n          part="expand"\n        >\n        </simple-toolbar-button>\n      </div>\n      <div id="item-fields" aria-live="polite" part="items">\n        <slot></slot>\n        <simple-toolbar-button\n          id="add"\n          icon="add"\n          controls="item-fields"\n          @click="', '"\n          part="add"\n          icon="more-vert"\n          ?toggled="', '"\n          toggles\n          show-text-label\n          label="Add Item"\n        >\n        </simple-toolbar-button>\n      </div>\n    ']);

  _templateObject2_1cfecb50930211eb82a7a575782a1009 = function _templateObject2_1cfecb50930211eb82a7a575782a1009() {
    return data;
  };
...
function _templateObject_1cfecb50930211eb82a7a575782a1009() {
  var data = _taggedTemplateLiteral(['\n      <fieldset part="fieldset">', "", "</fieldset>\n    "]);

  _templateObject_1cfecb50930211eb82a7a575782a1009 = function _templateObject_1cfecb50930211eb82a7a575782a1009() {
    return data;
  };
...
var SimpleFieldsArray = /*#__PURE__*/function (_SimpleFieldsFieldset) {
  ...
  _createClass(SimpleFieldsArray, [{
    ...
    value: function render() {
      return (0, _litElement.html)(_templateObject_1cfecb50930211eb82a7a575782a1009(), this.legend, this.fields);
    }
  }, {
    key: "fields",
    get: function get() {
      ...
      return (0, _litElement.html)(_templateObject2_1cfecb50930211eb82a7a575782a1009(), this.descriptionTemplate, function (e) {
    ...
    key: "styles",
    get: function get() {
      return [].concat(_toConsumableArray(_get(_getPrototypeOf(SimpleFieldsArray), "styles", this)), _toConsumableArray(_simpleFieldsUi.SimpleFieldsButtonStyles), [(0, _litElement.css)(_templateObject3_1cfecb50930211eb82a7a575782a1009())]);
    }
  }, {
    key: "properties",
    get: function get() {
