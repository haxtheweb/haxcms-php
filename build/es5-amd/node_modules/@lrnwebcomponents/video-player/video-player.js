define(["exports", "meta", "../../lit/index.js", "../simple-colors/simple-colors.js", "../schema-behaviors/schema-behaviors.js", "../media-behaviors/media-behaviors.js", "../intersection-element/lib/IntersectionObserverMixin.js", "../a11y-media-player/a11y-media-player.js", "../i18n-manager/lib/I18NMixin.js"], function (_exports, meta, _index, _simpleColors, _schemaBehaviors, _mediaBehaviors, _IntersectionObserverMixin, _a11yMediaPlayer, _I18NMixin) {
  ...
  var _templateObject_ec788ec09e8b11ed8df835f388f76963, _templateObject2_ec788ec09e8b11ed8df835f388f76963, _templateObject3_ec788ec09e8b11ed8df835f388f76963, _templateObject4_ec788ec09e8b11ed8df835f388f76963, _templateObject5_ec788ec09e8b11ed8df835f388f76963, _templateObject6_ec788ec09e8b11ed8df835f388f76963, _templateObject7_ec788ec09e8b11ed8df835f388f76963, _templateObject8_ec788ec09e8b11ed8df835f388f76963, _templateObject9_ec788ec09e8b11ed8df835f388f76963, _templateObject10_ec788ec09e8b11ed8df835f388f76963, _templateObject11_ec788ec09e8b11ed8df835f388f76963;
  ...
  var VideoPlayer = /*#__PURE__*/function (_IntersectionObserver) {
    ...
    babelHelpers.createClass(VideoPlayer, [{
      ...
      // render function
      function render() {
        return (0, _index.html)(_templateObject_ec788ec09e8b11ed8df835f388f76963 || (_templateObject_ec788ec09e8b11ed8df835f388f76963 = babelHelpers.taggedTemplateLiteral([" ", ""])), this.elementVisible ? (0, _index.html)(_templateObject2_ec788ec09e8b11ed8df835f388f76963 || (_templateObject2_ec788ec09e8b11ed8df835f388f76963 = babelHelpers.taggedTemplateLiteral(["", ""])), !this.isA11yMedia ? (0, _index.html)(_templateObject3_ec788ec09e8b11ed8df835f388f76963 || (_templateObject3_ec788ec09e8b11ed8df835f388f76963 = babelHelpers.taggedTemplateLiteral([" <div\n                class=\"responsive-video-container\"\n                .lang=\"", "\"\n              >\n                ", "\n                ", "\n              </div>\n              <div id=\"videocaption\" class=\"video-caption\">\n                <p>\n                  ", "\n                  <span class=\"media-type print-only\"\n                    >(", ")</span\n                  >\n                </p>\n                <slot name=\"caption\"></slot>\n              </div>\n              <slot hidden></slot>"])), this.lang || undefined, this.sandboxed ? (0, _index.html)(_templateObject4_ec788ec09e8b11ed8df835f388f76963 || (_templateObject4_ec788ec09e8b11ed8df835f388f76963 = babelHelpers.taggedTemplateLiteral([""]))) : (0, _index.html)(_templateObject5_ec788ec09e8b11ed8df835f388f76963 || (_templateObject5_ec788ec09e8b11ed8df835f388f76963 = babelHelpers.taggedTemplateLiteral([" <webview\n                      resource=\"", "-video\"\n                      .src=\"", "\"\n                      .width=\"", "\"\n                      .height=\"", "\"\n                      frameborder=\"0\"\n                    >\n                    </webview>"])), this.schemaResourceID, this.sourceData && this.sourceData[0] && this.sourceData[0].src || undefined, this.width || undefined, this.height || undefined), !(!this.sandboxed && this.iframed) ? (0, _index.html)(_templateObject6_ec788ec09e8b11ed8df835f388f76963 || (_templateObject6_ec788ec09e8b11ed8df835f388f76963 = babelHelpers.taggedTemplateLiteral([""]))) : (0, _index.html)(_templateObject7_ec788ec09e8b11ed8df835f388f76963 || (_templateObject7_ec788ec09e8b11ed8df835f388f76963 = babelHelpers.taggedTemplateLiteral(["\n                      <iframe\n                        loading=\"lazy\"\n                        resource=\"", "-video\"\n                        .src=\"", "\"\n                        width=\"", "\"\n                        height=\"", "\"\n                        frameborder=\"0\"\n                        webkitallowfullscreen=\"\"\n                        mozallowfullscreen=\"\"\n                        allowfullscreen=\"\"\n                      ></iframe>\n                    "])), this.schemaResourceID, this.sourceData && this.sourceData[0] && this.sourceData[0].src || undefined, this.width, this.height), this.mediaTitle, this.t.embeddedMedia) : (0, _index.html)(_templateObject8_ec788ec09e8b11ed8df835f388f76963 || (_templateObject8_ec788ec09e8b11ed8df835f388f76963 = babelHelpers.taggedTemplateLiteral([" <a11y-media-player\n                accent-color=\"", "\"\n                ?audio-only=\"", "\"\n                ?dark=\"", "\"\n                ?dark-transcript=\"", "\"\n                ?disable-interactive=\"", "\"\n                ?hide-timestamps=\"", "\"\n                ?hide-transcript=\"", "\"\n                ?hide-youtube-link=\"", "\"\n                id=\"", "\"\n                @play=\"", "\"\n                @pause=\"", "\"\n                lang=\"", "\"\n                ?learning-mode=\"", "\"\n                ?linkable=\"", "\"\n                preload=\"metadata\"\n                media-title=\"", "\"\n                .sources=\"", "\"\n                ?stand-alone=\"", "\"\n                sticky-corner=\"", "\"\n                .thumbnail-src=\"", "\"\n                .tracks=\"", "\"\n                .crossorigin=\"", "\"\n                .width=\"", "\"\n                .height=\"", "\"\n                youtube-id=\"", "\"\n              >\n              </a11y-media-player\n              ><slot hidden></slot>"])), this.accentColor, this.audioOnly, this.dark, this.darkTranscript, this.disableInteractive, this.hideTimestamps, this.hideTranscript, this.hideYoutubeLink, this.playerId, this.playEvent, this.pauseEvent, this.lang || "en", this.learningMode, this.linkable, this.mediaTitle || "", this.sourceProperties, this.standAlone, this.stickyCorner || "none", this.thumbnailSrc, this.trackProperties, this.crossorigin || "anonymous", this.width, this.height, this.youtubeId)) : "");
      }
      ...
      key: "html5",
      get: function get() {
        return (0, _index.html)(_templateObject9_ec788ec09e8b11ed8df835f388f76963 || (_templateObject9_ec788ec09e8b11ed8df835f388f76963 = babelHelpers.taggedTemplateLiteral(["\n      ", "\n      ", "\n    "])), this.sourceData.filter(function (item) {
          return item.type !== "youtube";
        }).map(function (sd) {
          (0, _index.html)(_templateObject10_ec788ec09e8b11ed8df835f388f76963 || (_templateObject10_ec788ec09e8b11ed8df835f388f76963 = babelHelpers.taggedTemplateLiteral(["\n            <source\n              .src=\"", "\"\n              .type=\"", "\"\n            />\n          "])), sd.src || undefined, sd.type || undefined);
      ...
      //styles function
      function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(VideoPlayer), "styles", this)), [(0, _index.css)(_templateObject11_ec788ec09e8b11ed8df835f388f76963 || (_templateObject11_ec788ec09e8b11ed8df835f388f76963 = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n          margin: 0 0 15px;\n          line-height: 16px !important;\n          font-size: 16px !important;\n        }\n\n        .video-caption {\n          font-style: italic;\n          margin: 0;\n          padding: 8px;\n        }\n      "])))]);
      }
    }, {
      key: "haxProperties",
      get: function get() {
