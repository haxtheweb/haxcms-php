...
function make_xlsx_lib(e) {
  ...
  (function () {
    for (var e in ka) if (Object.prototype.hasOwnProperty.call(ka, e)) ga[e] = Ea[e] = ka[e];
  })();
  var wa = Y(ga, "n");
  var Sa = Y(Ea, "n");
  var Ba = {
  ...
  function In(e) {
    var r = e._R(4);
    var t = [];
    for (var a = 0; a != r / 2; ++a) t.push(yn(e));
    return t;
  }
  function Rn(e) {
    return In(e);
  ...
  function _s(e, r, t) {
    ...
    var a = [],
      n = e.l + r,
      i = e._R(t.biff > 8 ? 4 : 2);
    while (i-- !== 0) a.push(Ei(e, t.biff > 8 ? 12 : 6, t));
  ...
  var hf = function () {
    ...
    function o(e, a) {
      ...
      for (u = 0; u < o.length; ++u) {
        ...
        if (o.indexOf(o[u]) !== u) for (h = 0; h < 1024; ++h) if (o.indexOf(o[u] + "_" + h) == -1) {
          o[u] += "_" + h;
          break;
        }
      }
      ...
      for (; o !== i.length; ++o) {
        ...
        if (k.length > 0) switch (S) {
          ...
          case "C":
            var C = false,
              T = false;
            for (c = 1; c < w.length; ++c) switch (w[c].charAt(0)) {
              case "X":
  ...
  function kl(e) {
    var r = Math.abs(e - El(e)),
      t = pl;
    if (r > .005) for (pl = vl; pl < dl; ++pl) if (Math.abs(e - El(e)) <= r) {
      r = Math.abs(e - El(e));
      t = pl;
    }
    pl = t;
  ...
  function Rl(e) {
    ...
    [[5, 8], [23, 26], [41, 44], [50, 392]].forEach(function (t) {
      for (var a = t[0]; a <= t[1]; ++a) if (e[a] != null) r[r.length] = or("numFmt", null, {
        numFmtId: a,
        formatCode: We(e[a])
      });
    });
    ...
    (e[0].match(Re) || []).forEach(function (e) {
      ...
      switch (Pe(i[0])) {
        ...
        case "<xf/>":
          a = i;
          delete a[0];
          for (s = 0; s < Fl.length; ++s) if (a[Fl[s]]) a[Fl[s]] = parseInt(a[Fl[s]], 10);
          for (s = 0; s < Dl.length; ++s) if (a[Dl[s]]) a[Dl[s]] = Ke(a[Dl[s]]);
          if (a.numFmtId > 392) {
  ...
  function ro(e, r) {
    ...
    [[5, 8], [23, 26], [41, 44], [50, 392]].forEach(function (t) {
      for (var a = t[0]; a <= t[1]; ++a) if (r[a] != null) et(e, "BrtFmt", Hl(a, r[a]));
    });
    et(e, "BrtEndFmts");
  }
  function to(e) {
  ...
  function Qc(e, r, t) {
    var a = e._R(t.biff == 12 ? 4 : 2);
    var n = [];
    for (var i = 0; i != a; ++i) n.push((t.biff == 12 ? Kt : Si)(e, 8));
    return n;
  }
  function Jc(e, r, t) {
    var a = 0,
  ...
  function xh(e, r, t, a, n, i, s) {
    ...
    var k = [];
    var w = c.match(gh);
    if (w) for (d = 0; d != w.length; ++d) k[d] = kt(w[d].slice(w[d].indexOf('"') + 1));
    var S = c.match(kh);
    if (S) Oh(f, S, a);
    var B = c.match(Ch);
  ...
  function Ah(e) {
    ...
    for (var t = 0; t != e.length; ++t) r += '<mergeCell ref="' + Et(e[t]) + '"/>';
    return r + "</mergeCells>";
  }
  function yh(e, r, t, a) {
    var n = Oe(e);
  ...
  var zh = function () {
    ...
    return function f(l, o, c, u, h, d) {
      ...
      for (var H = l.split(r), W = 0, V = H.length; W != V; ++W) {
        ...
        var X = p.length;
        if (X === 0) continue;
        for (v = 0; v < X; ++v) if (p.charCodeAt(v) === 62) break;
        ++v;
        ...
        for (v = 0; v != b.length; ++v) {
          ...
          if (c.cellFormula) {
            ...
            var j = bt(B.r);
            for (E = 0; E < F.length; ++E) if (j.r >= F[E][0].s.r && j.r <= F[E][0].e.r) if (j.c >= F[E][0].s.c && j.c <= F[E][0].e.c) S.F = F[E][1];
          }
    ...
    Zr(e, function N(e, r, b) {
      ...
      switch (b) {
        ...
        case 494:
          ...
          for (g = e.rfx.s.r; g <= e.rfx.e.r; ++g) for (E = e.rfx.s.c; E <= e.rfx.e.c; ++E) {
            if (f.dense) {
              if (!l[g]) l[g] = [];
              if (!l[g][E]) l[g][E] = {
                t: "z",
  ...
  function bv(e) {
    ...
    for (var t = 0; t < e.SheetNames.length; ++t) bh(e.Sheets[e.SheetNames[t]], e.SheetNames[t], t);
  }
  var mv = /<\w+:workbook/;
  function gv(e, r) {
  ...
  function lp(e, r) {
    ...
    a = a.replace(/<!--([\s\S]*?)-->/gm, "");
    var K = "";
    while (s = fp.exec(a)) switch (s[3] = (K = s[3]).toLowerCase()) {
      case "data":
        if (K == "data") {
          if (s[1] === "/") {
      ...
      case "numberformat":
        ...
        for (var J = 0; J != 392; ++J) if (D._table[J] == T.nf) break;
        if (J == 392) for (J = 57; J != 392; ++J) if (D._table[J] == null) {
          D.load(T.nf, J);
          break;
        }
        break;
      case "column":
        ...
        if (!H && U.wpx > 10) {
          H = true;
          pl = hl;
          for (var Z = 0; Z < L.length; ++Z) if (L[Z]) wl(L[Z]);
        }
        if (H) wl(U);
        L[U.Index - 1 || L.length] = U;
        for (var q = 0; q < +U.Span; ++q) L[L.length] = ce(U);
        break;
      case "namedrange":
        if (s[1] === "/") break;
        if (!j.Names) j.Names = [];
  ...
  function Sp(e, r) {
    ...
    t.push("");
    t.push("");
    for (var a = 0; a < e.SheetNames.length; ++a) t.push(or("Worksheet", wp(a, r, e), {
      ...
      if (q && q.f) {
        ...
        switch (te) {
          ...
          case "Format":
            {
              if (R.biff == 4) {
                z[G++] = re[1];
                for (var pe = 0; pe < G + 163; ++pe) if (D._table[pe] == re[1]) break;
          ...
          case "BIFF2FORMAT":
            {
              z[G++] = re;
              for (var be = 0; be < G + 163; ++be) if (D._table[be] == re) break;
          ...
          case "HLink":
            {
              for (g = re[0].s.r; g <= re[0].e.r; ++g) for (m = re[0].s.c; m <= re[0].e.c; ++m) {
  ...
  function Ip(e, r) {
    ...
    if (e.Props) {
      s = K(e.Props);
      for (i = 0; i < s.length; ++i) (Object.prototype.hasOwnProperty.call(wa, s[i]) ? t : Object.prototype.hasOwnProperty.call(Sa, s[i]) ? a : n).push([s[i], e.Props[s[i]]]);
    }
    if (e.Custprops) {
      s = K(e.Custprops);
      for (i = 0; i < s.length; ++i) if (!Object.prototype.hasOwnProperty.call(e.Props || {}, s[i])) (Object.prototype.hasOwnProperty.call(wa, s[i]) ? t : Object.prototype.hasOwnProperty.call(Sa, s[i]) ? a : n).push([s[i], e.Custprops[s[i]]]);
    }
    var f = [];
  ...
  function jp(e, r, t) {
    ...
    [[5, 8], [23, 26], [41, 44], [50, 392]].forEach(function (a) {
      for (var n = a[0]; n <= a[1]; ++n) if (r[n] != null) Mp(e, "Format", is(n, r[n], t));
    });
  }
  function $p(e, r) {
    var t = Jr(19);
  ...
  var fb = function () {
    ...
    return function t(a, n) {
      ...
      fp.lastIndex = 0;
      s = s.replace(/<!--([\s\S]*?)-->/gm, "").replace(/<!DOCTYPE[^\[]*\[[^\]]*\]>/gm, "");
      while (E = fp.exec(s)) switch (E[3] = E[3].replace(/_.*$/, "")) {
        case "table":
          ;
        case "工作表":
          if (E[1] === "/") {
        ...
        case "行":
          ...
          if (N < 10) for (K = 0; K < N; ++K) if (y > 0) P[_ + K] = {
            level: y
          };
          x = -1;
          break;
        ...
        case "数据":
          if (E[0].charAt(E[0].length - 2) === "/") {
            ...
            if (i.cellFormula) {
              ...
              if (w.formula) k.f = nh(w.formula);else for (K = 0; K < L.length; ++K) if (_ >= L[K][0].s.r && _ <= L[K][0].e.r) if (x >= L[K][0].s.c && x <= L[K][0].e.c) k.F = L[K][1];
            }
  ...
  function fm(e, r, t) {
    ...
    var v = lt(s);
    if (n) for (d = 0; d < h.length; ++d) i[ht(d + f) + v] = {
      t: "s",
      v: h[d]
    };
    i["!ref"] = Et(c);
  ...
  if (E && typeof require != "undefined") (function () {
    ...
    var t = function t(e, _t3) {
      ...
      for (var p = i.s.c; p <= i.e.c; ++p) if (!(d[p] || {}).hidden) h[p] = ht(p);
      var b = i.s.r;
      var m = false;
      a._read = function () {
        if (!m) {
