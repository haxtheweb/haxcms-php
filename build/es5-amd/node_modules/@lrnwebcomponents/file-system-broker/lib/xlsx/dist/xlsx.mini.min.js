...
function make_xlsx_lib(e) {
  ...
  function Ur(e, t) {
    ...
    switch (t) {
      ...
      case "cstr":
        e = 0;
        a = "";
        while ((l = Ir(this, this.l + e++)) !== 0) s.push(p(l));
        a = s.join("");
        break;
      case "_wstr":
        e = 0;
  ...
  (function () {
    for (var e in zt) if (Object.prototype.hasOwnProperty.call(zt, e)) It[e] = Lt[e] = zt[e];
  })();
  var Bt = J(It, "n");
  var Wt = J(Lt, "n");
  var $t = {
  ...
  function ga(e, r, t, a) {
    var n = [];
    if (typeof e == "string") n = nr(e, a);else for (var i = 0; i < e.length; ++i) n = n.concat(e[i].map(function (e) {
      return {
        v: e
      };
    }));
        ...
        for (h = 0; h < c.length; ++h) {
          ...
          switch (v[h]) {
            ...
            case "C":
              var C = String(f[u][h] || "");
              S._W(1, C, "sbcs");
              for (d = 0; d < 250 - C.length; ++d) S._W(1, 32);
              break;
          }
        }
      }
  ...
  function an(e) {
    var r = Math.abs(e - tn(e)),
      t = Za;
    if (r > .005) for (Za = Ka; Za < qa; ++Za) if (Math.abs(e - tn(e)) <= r) {
      r = Math.abs(e - tn(e));
      t = Za;
    }
    Za = t;
    ...
    (e[0].match(Oe) || []).forEach(function (e) {
      ...
      switch (Re(i[0])) {
        ...
        case "<xf/>":
          ...
          for (s = 0; s < gn.length; ++s) if (a[gn[s]]) a[gn[s]] = Ge(a[gn[s]]);
          if (a.numFmtId > 392) {
  ...
  function _i(e, r, t, a, n, i, s) {
    ...
    var k = [];
    var y = f.match(pi);
    if (y) for (d = 0; d != y.length; ++d) k[d] = gt(y[d].slice(y[d].indexOf('"') + 1));
    var x = f.match(vi);
    if (x) Oi(l, x, a);
    var _ = f.match(ki);
  ...
  var $i = function () {
    ...
    return function l(o, c, f, u, h, d) {
      ...
      for (var W = o.split(r), $ = 0, U = W.length; $ != U; ++$) {
        ...
        var j = m.length;
        if (j === 0) continue;
        for (p = 0; p < j; ++p) if (m.charCodeAt(p) === 62) break;
        ++p;
        ...
        for (p = 0; p != v.length; ++p) {
          ...
          if (f.cellFormula) {
            ...
            var X = dt(_.r);
            for (w = 0; w < M.length; ++w) if (X.r >= M[w][0].s.r && X.r <= M[w][0].e.r) if (X.c >= M[w][0].s.c && X.c <= M[w][0].e.c) x.F = M[w][1];
          }
  ...
  function Ui(e, r, t, a) {
    ...
    var m = {
      ...
      v,
      g = -1;
    for (h = s.s.c; h <= s.e.c; ++h) f[h] = ct(h);
        ...
        case "数据":
          if (w[0].charAt(w[0].length - 2) === "/") {
            ...
            if (i.cellFormula) {
              ...
              if (y.formula) k.f = ods_to_csf_formula(y.formula);else for (Y = 0; Y < z.length; ++Y) if (A >= z[Y][0].s.r && A <= z[Y][0].e.r) if (E >= z[Y][0].s.c && E <= z[Y][0].e.c) k.F = z[Y][1];
            }
  ...
  var Us = function () {
    ...
    var a = function a(_a2, n, i) {
      ...
      for (l = 0; l < c.s.r; ++l) s.push("        <table:table-row></table:table-row>\n");
      for (; l <= c.e.r; ++l) {
  ...
  function Pl(e, r) {
    ...
    for (var p = n.s.c; p <= n.e.c; ++p) if (!(h[p] || {}).hidden) u[p] = ct(p);
  ...
  function Ll(e) {
    ...
    for (l = n.s.c; l <= n.e.c; ++l) s[l] = ct(l);
  ...
  function zl(e, r, t) {
    ...
    var p = it(s);
    if (n) for (d = 0; d < h.length; ++d) i[ct(d + l) + p] = {
      t: "s",
      v: h[d]
    };
    i["!ref"] = vt(f);
