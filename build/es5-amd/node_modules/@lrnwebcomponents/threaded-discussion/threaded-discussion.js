define(["exports", "require", "../../lit-element/lit-element.js"], function (_exports, _require, _litElement) {
  ...
  function _templateObject6_ab4a5a50e0c411ea988d4b7e2b2c0fe2() {
    ...
    _templateObject6_ab4a5a50e0c411ea988d4b7e2b2c0fe2 = function _templateObject6_ab4a5a50e0c411ea988d4b7e2b2c0fe2() {
      return data;
    };
  ...
  function _templateObject5_ab4a5a50e0c411ea988d4b7e2b2c0fe2() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            <div class=\"thread\">\n              ", "\n              ", "\n              <threaded-discussion-form\n                button-label=\"", "\"\n                class=\"reply-form\"\n                @comment-demo=\"", "\"\n                @comment-submitted=\"", "\"\n                ?demo=\"", "\"\n                field=\"", "\"\n                ?disabled=\"", "\"\n                ?hidden=\"", "\"\n                .icon=\"", "\"\n                .submit=\"", "\"\n                textarea-label=\"", "\"\n                .thread=\"", "\"\n              >\n              </threaded-discussion-form>\n            </div>\n          "]);

    _templateObject5_ab4a5a50e0c411ea988d4b7e2b2c0fe2 = function _templateObject5_ab4a5a50e0c411ea988d4b7e2b2c0fe2() {
      return data;
    };
  ...
  function _templateObject4_ab4a5a50e0c411ea988d4b7e2b2c0fe2() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <div id=\"threads\">\n        <div class=\"thread\" ?hidden=\"", "\">\n          ", "\n        </div>\n        ", "\n      </div>\n    "]);

    _templateObject4_ab4a5a50e0c411ea988d4b7e2b2c0fe2 = function _templateObject4_ab4a5a50e0c411ea988d4b7e2b2c0fe2() {
      return data;
    };
  ...
  function _templateObject3_ab4a5a50e0c411ea988d4b7e2b2c0fe2() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                <p>", "</p>\n              "]);

    _templateObject3_ab4a5a50e0c411ea988d4b7e2b2c0fe2 = function _templateObject3_ab4a5a50e0c411ea988d4b7e2b2c0fe2() {
      return data;
    };
  ...
  function _templateObject2_ab4a5a50e0c411ea988d4b7e2b2c0fe2() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <div\n        aria-describedby=\"", "\"\n        class=\"comment ", "\"\n        id=\"comment-", "\"\n      >\n        <div class=\"comment-header\">\n          <lrndesign-avatar\n            .accent-color=\"", "\"\n            .label=\"", " ", "\"\n            .src=\"", "\"\n            two-chars\n          >\n          </lrndesign-avatar>\n          <div>\n            <p class=\"comment-name\">", " ", "</p>\n            <p class=\"comment-date\">", "</p>\n          </div>\n        </div>\n        <div class=\"comment-body\">\n          ", "\n        </div>\n      </div>\n    "]);

    _templateObject2_ab4a5a50e0c411ea988d4b7e2b2c0fe2 = function _templateObject2_ab4a5a50e0c411ea988d4b7e2b2c0fe2() {
      return data;
    };
  ...
  function _templateObject_ab4a5a50e0c411ea988d4b7e2b2c0fe2() {
    ...
    _templateObject_ab4a5a50e0c411ea988d4b7e2b2c0fe2 = function _templateObject_ab4a5a50e0c411ea988d4b7e2b2c0fe2() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(ThreadedDiscussion, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_ab4a5a50e0c411ea988d4b7e2b2c0fe2(), this.latest ? "" : this.threads, this.commentButtonLabel || "Submit", this._handleDemo, this._handleSubmit, this.demo, this.map.body || "body", this.commentIcon, this.hidden, this.disabled, this._getPath(this.submit, this.params), this.commentTextareaLabel || "Enter comment", !this.latest ? "" : this.threads);
      }
    }, {
      key: "getComment",
      value: function getComment(comment, thread) {
        return (0, _litElement.html)(_templateObject2_ab4a5a50e0c411ea988d4b7e2b2c0fe2(), thread || "", thread ? "comment-reply" : "", comment.id, comment.color, comment.firstName, comment.lastName, comment.avatar, comment.firstName, comment.lastName, this._getDate(comment.date), (comment.body || "").split(/[\r\n]+/).map(function (p) {
          return (0, _litElement.html)(_templateObject3_ab4a5a50e0c411ea988d4b7e2b2c0fe2(), p);
        }));
      }
    }, {
      key: "threads",
      get: function get() {
        ...
        return (0, _litElement.html)(_templateObject4_ab4a5a50e0c411ea988d4b7e2b2c0fe2(), !this.__loading, this.loadingText, this.sortData(this.__data).map(function (thread) {
          return (0, _litElement.html)(_templateObject5_ab4a5a50e0c411ea988d4b7e2b2c0fe2(), _this2.getComment(thread), (thread.replies || []).map(function (reply) {
      ...
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject6_ab4a5a50e0c411ea988d4b7e2b2c0fe2())];
      }
    }, {
      key: "tag",
      get: function get() {
