define(["exports", "require", "../../lit/index.js", "../../@github/time-elements/dist/index.js", "./lib/threaded-discussion-form.js"], function (_exports, _require, _index, _index2, _threadedDiscussionForm) {
  ...
  var _templateObject_bfdab3e0ce4111eca480a9d3109f406a, _templateObject2_bfdab3e0ce4111eca480a9d3109f406a, _templateObject3_bfdab3e0ce4111eca480a9d3109f406a, _templateObject4_bfdab3e0ce4111eca480a9d3109f406a, _templateObject5_bfdab3e0ce4111eca480a9d3109f406a, _templateObject6_bfdab3e0ce4111eca480a9d3109f406a, _templateObject7_bfdab3e0ce4111eca480a9d3109f406a, _templateObject8_bfdab3e0ce4111eca480a9d3109f406a;
  ...
  var ThreadedDiscussion = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(ThreadedDiscussion, [{
      ...
      get: function get() {
        ...
        return (0, _index.html)(_templateObject2_bfdab3e0ce4111eca480a9d3109f406a || (_templateObject2_bfdab3e0ce4111eca480a9d3109f406a = babelHelpers.taggedTemplateLiteral(["\n      <div id=\"threads\">\n        <div class=\"thread\" ?hidden=\"", "\">\n          ", "\n        </div>\n        ", "\n      </div>\n    "])), !this.__loading, this.loadingText, this.sortData(this.__data).map(function (thread) {
          return (0, _index.html)(_templateObject3_bfdab3e0ce4111eca480a9d3109f406a || (_templateObject3_bfdab3e0ce4111eca480a9d3109f406a = babelHelpers.taggedTemplateLiteral(["\n            <div class=\"thread\">\n              ", "\n              ", "\n              <threaded-discussion-form\n                button-label=\"", "\"\n                class=\"reply-form\"\n                @comment-demo=\"", "\"\n                @comment-submitted=\"", "\"\n                ?demo=\"", "\"\n                field=\"", "\"\n                ?disabled=\"", "\"\n                ?hidden=\"", "\"\n                .icon=\"", "\"\n                .submit=\"", "\"\n                textarea-label=\"", "\"\n                .thread=\"", "\"\n              >\n              </threaded-discussion-form>\n            </div>\n          "])), _this2.getComment(thread), (thread.replies || []).map(function (reply) {
      ...
      value: function getComment(comment, thread) {
        return (0, _index.html)(_templateObject4_bfdab3e0ce4111eca480a9d3109f406a || (_templateObject4_bfdab3e0ce4111eca480a9d3109f406a = babelHelpers.taggedTemplateLiteral(["\n      <div\n        aria-describedby=\"", "\"\n        class=\"comment ", "\"\n        id=\"comment-", "\"\n      >\n        <div class=\"comment-header\">\n          <lrndesign-avatar\n            .accent-color=\"", "\"\n            .label=\"", " ", "\"\n            .src=\"", "\"\n            two-chars\n          >\n          </lrndesign-avatar>\n          <div>\n            <p class=\"comment-name\">", " ", "</p>\n            <p class=\"comment-date\">\n              ", "\n            </p>\n          </div>\n        </div>\n        <div class=\"comment-body\">\n          ", "\n        </div>\n      </div>\n    "])), thread || "", thread ? "comment-reply" : "", comment.id, comment.color, comment.firstName, comment.lastName, comment.avatar, comment.firstName, comment.lastName, this.relativeDates ? (0, _index.html)(_templateObject5_bfdab3e0ce4111eca480a9d3109f406a || (_templateObject5_bfdab3e0ce4111eca480a9d3109f406a = babelHelpers.taggedTemplateLiteral(["\n                    <relative-time .datetime=\"", "\">\n                      ", "\n                    </relative-time>\n                  "])), comment.date, this._getDate(comment.date)) : (0, _index.html)(_templateObject6_bfdab3e0ce4111eca480a9d3109f406a || (_templateObject6_bfdab3e0ce4111eca480a9d3109f406a = babelHelpers.taggedTemplateLiteral(["\n                    <local-time\n                      month=\"", "\"\n                      day=\"", "\"\n                      year=\"", "\"\n                      hour=\"", "\"\n                      minute=\"", "\"\n                      second=\"", "\"\n                      time-zone-name=\"short\"\n                      .datetime=\"", "\"\n                    >\n                      ", "\n                    </local-time>\n                  "])), this.dateFormat && this.dateFormat.month ? this.dateFormat.month : "long", this.dateFormat && this.dateFormat.day ? this.dateFormat.day : "numeric", this.dateFormat && this.dateFormat.year ? this.dateFormat.year : "numeric", this.dateFormat && this.dateFormat.hour ? this.dateFormat.hour : "2-digit", this.dateFormat && this.dateFormat.minute ? this.dateFormat.minute : "2-digit", this.dateFormat && this.dateFormat.second ? this.dateFormat.second : "2-digit", comment.date, this._getDate(comment.date)), (comment.body || "").split(/[\r\n]+/).map(function (p) {
          return (0, _index.html)(_templateObject7_bfdab3e0ce4111eca480a9d3109f406a || (_templateObject7_bfdab3e0ce4111eca480a9d3109f406a = babelHelpers.taggedTemplateLiteral([" <p>", "</p> "])), p);
        }));
      }
    }, {
      key: "updated",
