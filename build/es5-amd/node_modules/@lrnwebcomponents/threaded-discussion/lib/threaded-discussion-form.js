define(["exports", "../../../lit-element/lit-element.js", "../../simple-icon/lib/simple-icon-lite.js", "../../simple-icon/lib/simple-icons.js"], function (_exports, _litElement, _simpleIconLite, _simpleIcons) {
  ...
  function _templateObject_98244510625811eb9a9521b3fdb3953c() {
    ...
    _templateObject_98244510625811eb9a9521b3fdb3953c = function _templateObject_98244510625811eb9a9521b3fdb3953c() {
      return data;
    };
  ...
  var ThreadedDiscussionForm = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(ThreadedDiscussionForm, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_98244510625811eb9a9521b3fdb3953c(), this.submit, this.hidden || this.disabled, this.thread ? "reply-form" : "comment-form", this._handleSubmit, this.field, this.textareaLabel, this.field, this.field, this.thread, this.buttonLabel, !this.icon, this.icon);
      }
    }], [{
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_98244510625811eb9a9521b3fdb3953c())];
      }
    }, {
      key: "tag",
      get: function get() {
