define(["exports", "../../../lit-element/lit-element.js", "../../simple-icon/lib/simple-icon-lite.js", "../../simple-icon/lib/simple-icons.js"], function (_exports, _litElement, _simpleIconLite, _simpleIcons) {
  ...
  function _templateObject2_459aaa7099b011eb851ed31c596cbbd8() {
    ...
    _templateObject2_459aaa7099b011eb851ed31c596cbbd8 = function _templateObject2_459aaa7099b011eb851ed31c596cbbd8() {
      return data;
    };
  ...
  function _templateObject_459aaa7099b011eb851ed31c596cbbd8() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <form \n        action=\"", "\"\n        ?hidden=", "\n        class=\"", "\"\n        @submit=\"", "\">\n        <label for=\"", "\">", "</label>\n        <textarea\n          id=\"", "\"\n          name=\"", "\"\n          aria-describedby=\"", "\"\n        ></textarea>\n        <button type=\"submit\">\n          ", "\n          <simple-icon-lite  \n            aria-hidden=\"true\" \n            ?hidden=\"", "\"\n            icon=\"", "\"></simple-icon-lite>\n        </button>\n      </div>\n    "]);

    _templateObject_459aaa7099b011eb851ed31c596cbbd8 = function _templateObject_459aaa7099b011eb851ed31c596cbbd8() {
      return data;
    };
  ...
  var ThreadedDiscussionForm = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(ThreadedDiscussionForm, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_459aaa7099b011eb851ed31c596cbbd8(), this.submit, this.hidden || this.disabled, this.thread ? "reply-form" : "comment-form", this._handleSubmit, this.field, this.textareaLabel, this.field, this.field, this.thread, this.buttonLabel, !this.icon, this.icon);
      }
    }], [{
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_459aaa7099b011eb851ed31c596cbbd8())];
      }
    }, {
      key: "tag",
      get: function get() {
