define(["exports", "require", "../../../lit-element/lit-element.js"], function (_exports, _require, _litElement) {
  ...
  function _templateObject2_b3ceae60e0c411ea988d4b7e2b2c0fe2() {
    ...
    _templateObject2_b3ceae60e0c411ea988d4b7e2b2c0fe2 = function _templateObject2_b3ceae60e0c411ea988d4b7e2b2c0fe2() {
      return data;
    };
  ...
  function _templateObject_b3ceae60e0c411ea988d4b7e2b2c0fe2() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <form \n        action=\"", "\"\n        ?hidden=", "\n        class=\"", "\"\n        @submit=\"", "\">\n        <label for=\"", "\">", "</label>\n        <textarea\n          id=\"", "\"\n          name=\"", "\"\n          aria-describedby=\"", "\"\n        ></textarea>\n        <button type=\"submit\">\n          ", "\n          <iron-icon  \n            aria-hidden=\"true\" \n            ?hidden=\"", "\"\n            icon=\"", "\"></iron-icon>\n        </button>\n      </div>\n    "]);

    _templateObject_b3ceae60e0c411ea988d4b7e2b2c0fe2 = function _templateObject_b3ceae60e0c411ea988d4b7e2b2c0fe2() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(ThreadedDiscussionForm, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_b3ceae60e0c411ea988d4b7e2b2c0fe2(), this.submit, this.hidden || this.disabled, this.thread ? "reply-form" : "comment-form", this._handleSubmit, this.field, this.textareaLabel, this.field, this.field, this.thread, this.buttonLabel, !this.icon, this.icon);
      }
    }], [{
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_b3ceae60e0c411ea988d4b7e2b2c0fe2())];
      }
    }, {
      key: "tag",
      get: function get() {
