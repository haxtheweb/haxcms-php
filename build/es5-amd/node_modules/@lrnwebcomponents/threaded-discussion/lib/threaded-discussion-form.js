define(["exports", "../../../lit-element/lit-element.js", "../../simple-icon/simple-icon.js", "../../simple-icon/lib/simple-icons.js"], function (_exports, _litElement, _simpleIcon, _simpleIcons) {
  ...
  function _templateObject2_fa2660a025cb11eba454134bebd3d7b6() {
    ...
    _templateObject2_fa2660a025cb11eba454134bebd3d7b6 = function _templateObject2_fa2660a025cb11eba454134bebd3d7b6() {
      return data;
    };
  ...
  function _templateObject_fa2660a025cb11eba454134bebd3d7b6() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <form \n        action=\"", "\"\n        ?hidden=", "\n        class=\"", "\"\n        @submit=\"", "\">\n        <label for=\"", "\">", "</label>\n        <textarea\n          id=\"", "\"\n          name=\"", "\"\n          aria-describedby=\"", "\"\n        ></textarea>\n        <button type=\"submit\">\n          ", "\n          <simple-icon  \n            aria-hidden=\"true\" \n            ?hidden=\"", "\"\n            icon=\"", "\"></simple-icon>\n        </button>\n      </div>\n    "]);

    _templateObject_fa2660a025cb11eba454134bebd3d7b6 = function _templateObject_fa2660a025cb11eba454134bebd3d7b6() {
      return data;
    };
  ...
  var ThreadedDiscussionForm = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(ThreadedDiscussionForm, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_fa2660a025cb11eba454134bebd3d7b6(), this.submit, this.hidden || this.disabled, this.thread ? "reply-form" : "comment-form", this._handleSubmit, this.field, this.textareaLabel, this.field, this.field, this.thread, this.buttonLabel, !this.icon, this.icon);
      }
    }], [{
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_fa2660a025cb11eba454134bebd3d7b6())];
      }
    }, {
      key: "tag",
      get: function get() {
