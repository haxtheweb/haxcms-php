define(["exports", "../../../../lit-element/lit-element.js", "../../../../@polymer/iron-ajax/iron-ajax.js", "../../../../@polymer/paper-toast/paper-toast.js", "../../../lrnsys-button/lrnsys-button.js"], function (_exports, _litElement, _ironAjax, _paperToast, _lrnsysButton) {
  ...
  function _templateObject4_db197b60387911eab76ec18634c4f6e2() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n      "]);

    _templateObject4_db197b60387911eab76ec18634c4f6e2 = function _templateObject4_db197b60387911eab76ec18634c4f6e2() {
      return data;
    };
  ...
  function _templateObject3_db197b60387911eab76ec18634c4f6e2() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            <paper-toast id=\"toast\"></paper-toast>\n          "]);

    _templateObject3_db197b60387911eab76ec18634c4f6e2 = function _templateObject3_db197b60387911eab76ec18634c4f6e2() {
      return data;
    };
  ...
  function _templateObject2_db197b60387911eab76ec18634c4f6e2() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            <lrnsys-button\n              raised=\"\"\n              class=\"", "\"\n              button-class=\"", "\"\n              icon=\"", "\"\n              @click=\"", "\"\n              label=\"Create project\"\n            ></lrnsys-button>\n            <iron-ajax\n              id=\"ajaxCreateStub\"\n              url=\"", "\"\n              method=\"POST\"\n              handle-as=\"json\"\n              @response=\"", "\"\n            ></iron-ajax>\n          "]);

    _templateObject2_db197b60387911eab76ec18634c4f6e2 = function _templateObject2_db197b60387911eab76ec18634c4f6e2() {
      return data;
    };
  ...
  function _templateObject_db197b60387911eab76ec18634c4f6e2() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      ", "\n      ", "\n    "]);

    _templateObject_db197b60387911eab76ec18634c4f6e2 = function _templateObject_db197b60387911eab76ec18634c4f6e2() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(LrnappStudioProjectButton, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_db197b60387911eab76ec18634c4f6e2(), this.createProjectsUrl ? (0, _litElement.html)(_templateObject2_db197b60387911eab76ec18634c4f6e2(), this.classes, this.classes, this.icon, this._createProject, this.createProjectsUrl, this._ajaxCreateStubHandler) : "", this.displayErrors ? (0, _litElement.html)(_templateObject3_db197b60387911eab76ec18634c4f6e2()) : "");
      }
    }], [{
      key: "styles",
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject4_db197b60387911eab76ec18634c4f6e2())];
      }
    }, {
      key: "tag",
      get: function get() {
