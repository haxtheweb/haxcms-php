define(["exports", "../../../../lit-element/lit-element.js", "../../../../@polymer/polymer/lib/elements/custom-style.js", "../../../../@polymer/iron-ajax/iron-ajax.js", "../../../../@polymer/app-route/app-location.js", "../../../../@polymer/app-route/app-route.js", "../../../../@polymer/iron-icon/iron-icon.js", "../../../../@polymer/iron-icons/editor-icons.js", "../../../../@polymer/iron-icons/communication-icons.js", "../../../../@polymer/iron-icons/iron-icons.js", "../../../../@polymer/paper-badge/paper-badge.js", "../../../../@polymer/paper-toggle-button/paper-toggle-button.js", "../../../../@polymer/app-layout/app-toolbar/app-toolbar.js", "../../../../@polymer/app-layout/app-header/app-header.js", "../../../../@polymer/paper-card/paper-card.js", "../../../../@polymer/paper-toast/paper-toast.js", "../../../../@polymer/paper-button/paper-button.js", "../../../../@polymer/paper-dialog/paper-dialog.js", "../../../lrnsys-render-html/lrnsys-render-html.js", "../../../lrnsys-layout/lib/lrnsys-dialog.js", "../../../lrnsys-button/lrnsys-button.js", "../../../elmsln-loading/elmsln-loading.js", "../../../materializecss-styles/materializecss-styles.js", "./lrnapp-studio-project-button.js", "./lrnapp-studio-assignment-button.js", "../lrnapp-studio-submission/lrnapp-studio-submission-button.js"], function (_exports, _litElement, _customStyle, _ironAjax, _appLocation, _appRoute, _ironIcon, _editorIcons, _communicationIcons, _ironIcons, _paperBadge, _paperToggleButton, _appToolbar, _appHeader, _paperCard, _paperToast, _paperButton, _paperDialog, _lrnsysRenderHtml, _lrnsysDialog, _lrnsysButton, _elmslnLoading, _materializecssStyles, _lrnappStudioProjectButton, _lrnappStudioAssignmentButton, _lrnappStudioSubmissionButton) {
  ...
  function _templateObject4_95e9a31022a011eab708bfb8085c8420() {
    ...
    _templateObject4_95e9a31022a011eab708bfb8085c8420 = function _templateObject4_95e9a31022a011eab708bfb8085c8420() {
      return data;
    };
  ...
  function _templateObject3_95e9a31022a011eab708bfb8085c8420() {
    ...
    _templateObject3_95e9a31022a011eab708bfb8085c8420 = function _templateObject3_95e9a31022a011eab708bfb8085c8420() {
      return data;
    };
  ...
  function _templateObject2_95e9a31022a011eab708bfb8085c8420() {
    ...
    _templateObject2_95e9a31022a011eab708bfb8085c8420 = function _templateObject2_95e9a31022a011eab708bfb8085c8420() {
      return data;
    };
  ...
  function _templateObject_95e9a31022a011eab708bfb8085c8420() {
    ...
    _templateObject_95e9a31022a011eab708bfb8085c8420 = function _templateObject_95e9a31022a011eab708bfb8085c8420() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(LrnappStudioKanban, [{
      ...
      value: function render() {
        ...
        return (0, _litElement.html)(_templateObject_95e9a31022a011eab708bfb8085c8420(), this.sourcePath, this.projectResponseChanged, this._handleProjectResponse, this.sourcePath, this.backendResponseChanged, this._handleUpdateResponse, this.route, this.routeChangedEvent, this.queryParams, this.queryParamsChangedEvent, this.route, this.routeChangedEvent, this.endPoint, this.data, this.dataChangedEvent, this.tail, this.tailChangedEvent, this.queryParams, this.queryParamsChangedEvent, !this.projectResponse.data.canCreateProjects, this.endPoint, this.csrfToken, this._toArray(this.projectResponse.data.projects).map(function (project) {
          return (0, _litElement.html)(_templateObject2_95e9a31022a011eab708bfb8085c8420(), project.id, project.attributes.title, project.id, !project.meta.canUpdate, _this2._makeProjectEditLink, project.id, project.id, !project.meta.canUpdate, _this2.endPoint, _this2.csrfToken, project.id, !project.meta.canDelete, _this2._deleteProjectDialog, _this2._toArray(project.relationships.assignments).map(function (assignment) {
            return (0, _litElement.html)(_templateObject3_95e9a31022a011eab708bfb8085c8420(), project.id, assignment.id, _this2.assignmentClick, assignment.meta.relatedSubmissions.complete.icon, assignment.attributes.title, project.id, assignment.id, !assignment.meta.canCritique, assignment.meta.critiqueLink, project.id, assignment.id, !assignment.meta.canUpdate, _this2._makeAssignmentEditLink, project.id, assignment.id, !assignment.meta.canDelete, _this2._deleteAssignmentDialog);
          }));
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject4_95e9a31022a011eab708bfb8085c8420())];
      }
    }, {
      key: "tag",
      get: function get() {
