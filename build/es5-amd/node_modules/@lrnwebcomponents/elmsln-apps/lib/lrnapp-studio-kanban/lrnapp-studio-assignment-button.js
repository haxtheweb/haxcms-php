define(["exports", "../../../../lit-element/lit-element.js", "../../../../@polymer/iron-ajax/iron-ajax.js", "../../../../@polymer/paper-toast/paper-toast.js", "../../../lrnsys-button/lrnsys-button.js"], function (_exports, _litElement, _ironAjax, _paperToast, _lrnsysButton) {
  ...
  function _templateObject3_47be1750332811ea9673c9ed9148a8db() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n      "]);

    _templateObject3_47be1750332811ea9673c9ed9148a8db = function _templateObject3_47be1750332811ea9673c9ed9148a8db() {
      return data;
    };
  ...
  function _templateObject2_47be1750332811ea9673c9ed9148a8db() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            <paper-toast id=\"toast\"></paper-toast>\n          "]);

    _templateObject2_47be1750332811ea9673c9ed9148a8db = function _templateObject2_47be1750332811ea9673c9ed9148a8db() {
      return data;
    };
  ...
  function _templateObject_47be1750332811ea9673c9ed9148a8db() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <lrnsys-button\n        @click=\"", "\"\n        icon-class=\"", "\"\n        alt=\"", "\"\n        class=\"", "\"\n        button-class=\"", "\"\n        hover-class=\"", "\"\n        icon=\"", "\"\n      ></lrnsys-button>\n      <iron-ajax\n        id=\"ajaxCreateStub\"\n        url=\"", "/api/assignments/create-stub?token=", "\"\n        method=\"POST\"\n        body=\"", "\"\n        handle-as=\"json\"\n        @response=\"", "\"\n      ></iron-ajax>\n      ", "\n    "]);

    _templateObject_47be1750332811ea9673c9ed9148a8db = function _templateObject_47be1750332811ea9673c9ed9148a8db() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(LrnappStudioAssignmentButton, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_47be1750332811ea9673c9ed9148a8db(), this._createAssignment, this.iconClass, this.alt, this.classes, this.classes, this.hoverClass, this.icon, this.endPoint, this.csrfToken, this.projectId, this._ajaxCreateStubHandler, this.displayErrors ? (0, _litElement.html)(_templateObject2_47be1750332811ea9673c9ed9148a8db()) : "");
      }
    }], [{
      key: "styles",
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject3_47be1750332811ea9673c9ed9148a8db())];
      }
    }, {
      key: "tag",
      get: function get() {
