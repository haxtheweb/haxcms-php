define(["exports", "../../../../@polymer/polymer/polymer-element.js", "../../../simple-icon/simple-icon.js", "../../../simple-icon/lib/simple-icons.js", "../../../hax-iconset/lib/simple-hax-iconset.js"], function (_exports, _polymerElement, _simpleIcon, _simpleIcons, _simpleHaxIconset) {
  ...
  var _templateObject_5a9a6170e8f211edb01b473406559cea;
  ...
  var LrnappStudioSubmissionEditAddAsset = /*#__PURE__*/function (_PolymerElement) {
    ...
    babelHelpers.createClass(LrnappStudioSubmissionEditAddAsset, null, [{
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_5a9a6170e8f211edb01b473406559cea || (_templateObject_5a9a6170e8f211edb01b473406559cea = babelHelpers.taggedTemplateLiteral(["\n      <style>\n        :host {\n          cursor: pointer;\n        }\n        :host([display=\"box\"]) {\n          display: block;\n          width: 200px;\n          height: 200px;\n          background: lightgray;\n          display: flex;\n          align-items: center;\n          justify-content: center;\n          position: relative;\n        }\n        :host([display=\"pill\"]) {\n          display: block;\n          background: lightgray;\n          display: inline-flex;\n          align-items: center;\n          justify-content: center;\n          position: relative;\n        }\n        simple-icon {\n          color: gray;\n          --simple-icon-height: 50px;\n          --simple-icon-width: 50px;\n        }\n        :host([display=\"pill\"]) simple-icon {\n          --simple-icon-height: 50px;\n          --simple-icon-width: 50px;\n        }\n      </style>\n      <button>\n        <simple-icon icon=\"[[icon]]\"></simple-icon>\n      </button>\n    "])));
      }
    }, {
      key: "tag",
      get: function get() {
