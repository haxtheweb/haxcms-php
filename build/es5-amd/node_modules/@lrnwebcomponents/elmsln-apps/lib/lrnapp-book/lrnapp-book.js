define(["exports", "../../../../@polymer/polymer/polymer-element.js", "../../../haxcms-elements/lib/core/HAXCMSPolymerElementTheme.js", "../../../../@polymer/iron-icons/iron-icons.js", "../../../../@polymer/iron-icons/hardware-icons.js", "../../../../@polymer/paper-icon-button/paper-icon-button.js", "../../../../@polymer/paper-styles/color.js", "../../../paper-search/lib/paper-search-bar.js", "../../../../@polymer/paper-tooltip/paper-tooltip.js", "../../../../@polymer/paper-slider/paper-slider.js", "../../../simple-toast/simple-toast.js", "../../../../@polymer/app-layout/app-layout.js", "../../../../@polymer/app-layout/app-drawer/app-drawer.js", "../../../../@polymer/app-layout/app-header/app-header.js", "../../../../@polymer/app-layout/app-toolbar/app-toolbar.js", "../../../../@polymer/app-layout/app-scroll-effects/app-scroll-effects.js", "../../../materializecss-styles/materializecss-styles.js", "../../../lrndesign-stepper/lrndesign-stepper.js", "../../../lrnsys-progress/lrnsys-progress.js", "../../../elmsln-loading/elmsln-loading.js", "../../../page-scroll-position/page-scroll-position.js", "../../../material-progress/material-progress.js", "../../../map-menu/map-menu.js", "./lrnapp-book-progress-dashboard.js"], function (_exports, _polymerElement, _HAXCMSPolymerElementTheme, _ironIcons, _hardwareIcons, _paperIconButton, _color, _paperSearchBar, _paperTooltip, _paperSlider, _simpleToast, _appLayout, _appDrawer, _appHeader, _appToolbar, _appScrollEffects, _materializecssStyles, _lrndesignStepper, _lrnsysProgress, _elmslnLoading, _pageScrollPosition, _materialProgress, _mapMenu, _lrnappBookProgressDashboard) {
  ...
  function _templateObject_47bacc900b1311eaa3b2eff4bd15c191() {
    ...
    _templateObject_47bacc900b1311eaa3b2eff4bd15c191 = function _templateObject_47bacc900b1311eaa3b2eff4bd15c191() {
      return data;
    };
  ...
  */
  ...
  function (_HAXCMSPolymerElement) {
    babelHelpers.inherits(LrnappBook, _HAXCMSPolymerElement);
    ...
    babelHelpers.createClass(LrnappBook, [{
      ...
      value: function ready() {
        ...
        this.shadowRoot.querySelector("#bodyloading").hidden = true; // scroll top into view
      ...
      value: function connectedCallback() {
        ...
        this.shadowRoot.querySelector("#progress").addEventListener("node-percent-milestone", this.testMilestone.bind(this));
        this.shadowRoot.querySelector("#mapmenu").addEventListener("link-clicked", this._menuItemClicked.bind(this));
      }
      /**
       * detached life cycle
       */
      ...
      value: function disconnectedCallback() {
        this.shadowRoot.querySelector("#progress").removeEventListener("node-percent-milestone", this.testMilestone.bind(this));
        this.shadowRoot.querySelector("#mapmenu").removeEventListener("link-clicked", this._menuItemClicked.bind(this));
      ...
      value: function _editModeChanged(newValue, oldValue) {
        if (babelHelpers.typeof(newValue) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {
          if (newValue === true) {
            this.shadowRoot.querySelector("#currenttitle").contentEditable = true; // block scroll tracking during edit mode
            ...
            this.shadowRoot.querySelector("#currenttitle").contentEditable = false; // allow scrolling to take place now

            this.resetScroll = false; // we were in edit mode, now time to save for real

            if (oldValue === true) {
              // see if title changed
              if (this.shadowRoot.querySelector("#currenttitle").innerHTML !== this.currentPageData.title) {
                this.currentPageData.title = this.shadowRoot.querySelector("#currenttitle").innerHTML;
              }
      ...
      value: function _currentPageDataUpdated(newValue, oldValue) {
        if (babelHelpers.typeof(newValue) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined)) && babelHelpers.typeof(newValue.content) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {
          ...
          this.currentTitle = newValue.title; // reset scroll position back to top of this content

          this._resetScroll(); // hide the loading area


          this.shadowRoot.querySelector("#bodyloading").hidden = true; // manage state associated w/ edit mode if we were in edit mode previously
      ...
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_47bacc900b1311eaa3b2eff4bd15c191());
      }
    }, {
      key: "tag",
      get: function get() {
