...
*/(0,_polymerLegacy.Polymer)({_template:(0,_polymerLegacy.html)(_templateObject_e1fe022068f411e996b0af119cd7f5ea()),is:"lrnapp-book",behaviors:[HAXCMSBehaviors.Theme],properties:{/**
     * Path for getting progress dashboard data
     */progressDashboardPath:{type:String},/**
     * Option to display the search bar.
     */showSearch:{type:Boolean,reflectToAttribute:!0/* transition */ /* transition */,value:!1},/**
   ...
   * Ready event.
   */ready:function ready(e){var _this=this;this.setupHAXTheme(!0,this.$.contentcontainer);window.dispatchEvent(new CustomEvent("haxcms-router-manifest-subscribe",{detail:{callback:"_haxcmsRouterManifestSubscribeHandler",scope:this,setup:!0}}));window.SimpleToast.requestAvailability();this.$.bodyloading.hidden=!0;// scroll top into view
setTimeout(function(){_this._resetScroll()},500)},/**
   * attached life cycle
   */attached:function attached(){this.$.progress.addEventListener("node-percent-milestone",this.testMilestone.bind(this));this.$.mapmenu.addEventListener("link-clicked",this._menuItemClicked.bind(this))},/**
   * detached life cycle
   */detached:function detached(){this.setupHAXTheme(!1);this.$.progress.removeEventListener("node-percent-milestone",this.testMilestone.bind(this));this.$.mapmenu.removeEventListener("link-clicked",this._menuItemClicked.bind(this))},_haxcmsRouterManifestSubscribeHandler:function _haxcmsRouterManifestSubscribeHandler(e){this._routerManifest={};this._routerManifest=e.detail},_menuItemClicked:function _menuItemClicked(e){var i=this.manifest.items.findIndex(function(j){return j.id===e.detail.id});this.activePage=i},/**
   * When element is told to be full width it'll close things.
   */_fullWidthChanged:function _fullWidthChanged(newValue,oldValue){this.updateStyles()},/**
   * Handle click on dashboard to trigger loading data.
   */progressdashboardopen:function progressdashboardopen(e){this.$.progressdashboard.showProgress=!0},/**
   * Generate path to point to the right endpoint for updating items.
   */_computePageUpdatePath:function _computePageUpdatePath(data,sourcePath){return sourcePath.replace("%",data.id)},/**
   * React when state changes for editMode
   */_editModeChanged:function _editModeChanged(newValue,oldValue){if(babelHelpers.typeof(newValue)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){if(!0===newValue){this.$.currenttitle.contentEditable=!0;// block scroll tracking during edit mode
...
if(this.$.currenttitle.innerHTML!==this.currentPageData.title){this.currentPageData.title=this.$.currenttitle.innerHTML}var _evt=new CustomEvent("simple-toast-show",{bubbles:!0,cancelable:!0,detail:{text:"Saved",duration:0}});this.dispatchEvent(_evt)}}}},/**
   ...
   */_activeOutlineChanged:function _activeOutlineChanged(newValue,oldValue){if(babelHelpers.typeof(newValue)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))&&babelHelpers.typeof(oldValue)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){// trigger loading state
this.rebuildOutline=!0}},/**
   * Reset scroll position visually and internally data wise.
   */_resetScroll:function _resetScroll(){this.resetScroll=!0;this.scrollPosition=0;this.$.anchor.scrollIntoView({block:"start",behavior:"smooth",inline:"nearest"})},/**
...
if(babelHelpers.typeof(this.outlineItems)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))&&newValue+1==this.outlineItems.length){this.hasNextPage=!1}else{this.hasNextPage=!0;if(babelHelpers.typeof(this.outlineItems)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){this.nextLabel=this.outlineItems[newValue+1].title}}}},/**
   ...
   */_outlineItemsChanged:function _outlineItemsChanged(newValue,oldValue){// these need set immediately
...
if(this.activePage+1!=newValue.length){this.nextLabel=newValue[this.activePage+1].title}}},/**
   ...
   */testMilestone:function testMilestone(e){// we should preload the next page
if(75==e.detail.percentage){console.log("@todo preload the next page and present grayed out right of UI.")}},/**
   ...
   */_scrollChanged:function _scrollChanged(newValue,oldValue){// only evaluate scroll if value is greater then previous
...
if(75<=newValue){this.outlineItems[this.activePage].metadata.value=this.outlineItems[this.activePage].metadata.max;this.set("outlineItems."+this.activePage+".metadata.value",this.outlineItems[this.activePage].metadata.max)}else{this.outlineItems[this.activePage].metadata.value=newValue;this.set("outlineItems."+this.activePage+".metadata.value",newValue)}}},/**
   ...
   */_nextBtn:function _nextBtn(e){// make sure we are able to move forward more
if(this.activePage<this.outlineItems.length-1){this.set("outlineItems."+this.activePage+".metadata.value",this.outlineItems[this.activePage].metadata.max);this.activePage=this.activePage+1}},/**
   ...
   */_prevBtn:function _prevBtn(e){if(0<this.activePage){this.activePage=this.activePage-1}},/**
   * Toggle the book drawer
   */toggleBook:function toggleBook(e){// if we are in edit mode then we ned to close this
this.$.bookdrawer.toggle();this.fullWidth=!this.$.bookdrawer.opened},/**
   * Handle the response.
   */_manifestChanged:function _manifestChanged(newValue,oldValue){if(babelHelpers.typeof(newValue)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){var items=newValue.items,outlineTitle=newValue.title;// set active to 0 because once we update the outlineItems it will try to
...
this.set("outlineTitle",outlineTitle);this.$.outlineloading.hidden=!0;this.pageParams.load=!0}},/**
   ...
   */_currentPageDataUpdated:function _currentPageDataUpdated(newValue,oldValue){if(babelHelpers.typeof(newValue)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))&&babelHelpers.typeof(newValue.content)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){// set page title; easiest for sure
