...
*/(0,_polymerLegacy.Polymer)({_template:(0,_polymerLegacy.html)(_templateObject_42a25ff0685411e9b25d1735312af746()),is:"lrnapp-book-progress-dashboard",properties:{/**
     ...
     */showProgress:{type:Boolean,value:!1,reflectToAttribute:!0/* transition */ /* transition */,observer:"_showProgressChanged"}},/**
   * Notice route data has changed.
   */_routeDataChanged:function _routeDataChanged(newValue,oldValue){if(babelHelpers.typeof(newValue)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){this.requestParams[newValue.type]=newValue.id;// if we're visible kick off the call
if(this.progressChanged){this.$.dataajax.generateRequest()}}},/**
   * Showing element state has changed
   */_showProgressChanged:function _showProgressChanged(newValue,oldValue){// ensure we are visible
if(newValue&&babelHelpers.typeof(this.routeData)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){this.$.dataajax.generateRequest()}},/**
   * Response data.
   */handleDataResponse:function handleDataResponse(obj){var response=obj.detail.response.data;// show the info
