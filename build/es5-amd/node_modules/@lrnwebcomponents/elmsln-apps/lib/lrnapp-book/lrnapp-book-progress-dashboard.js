...
this.userData=response.userdata;this.dashboardItems=this._toArray(response.items)}/**
   ...
   */},{key:"_toArray",value:function _toArray(obj){if(null==obj){return[]}return Object.keys(obj).map(function(key){return obj[key]})}}],[{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_33710880833211e9b574fb683655f262())}},{key:"tag",get:function get(){return"lrnapp-book-progress-dashboard"}},{key:"properties",get:function get(){return{/**
