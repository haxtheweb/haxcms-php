...
window.location.href=this.basePath+"lrnapp-studio-submission/submissions/"+active}/**
   ...
   */},{key:"_toArray",value:function _toArray(obj){if(null==obj){return[]}return Object.keys(obj).map(function(key){return obj[key]})}}],[{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_5112daf07ea311e9a4cd6542c946a6e6())}},{key:"tag",get:function get(){return"lrnapp-open-studio-table"}},{key:"properties",get:function get(){var _ref;return _ref={elmslnCourse:{type:String},elmslnSection:{type:String},basePath:{type:String},csrfToken:{type:String},endPoint:{type:String},/**
