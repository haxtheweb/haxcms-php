...
window.location.href=this.basePath+"lrnapp-studio-submission/submissions/"+active}/**
   ...
   */},{key:"_toArray",value:function _toArray(obj){return Object.keys(obj).map(function(key){return obj[key]})}}],[{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_8958e6c06daf11e98b2b231443c29fcf())}},{key:"tag",get:function get(){return"lrnapp-open-studio-table"}},{key:"properties",get:function get(){return{/**
       ...
       */activeSubmission:{type:String,value:null,notify:!0}}}}]);return LrnappOpenStudioTable}(_polymerElement.PolymerElement);_exports.LrnappOpenStudioTable=LrnappOpenStudioTable;window.customElements.define(LrnappOpenStudioTable.tag,LrnappOpenStudioTable)});