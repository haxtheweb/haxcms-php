...
window.location.href=this.basePath+"lrnapp-studio-submission/submissions/"+active}},{key:"handleResponse",value:function handleResponse(e){this.$.loading.hidden=!0}},{key:"_toArray",value:function _toArray(obj){return Object.keys(obj).map(function(key){return obj[key]})}}],[{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_89efa8806daf11e98b2b231443c29fcf())}},{key:"tag",get:function get(){return"lrnapp-block-need-feedback"}},{key:"properties",get:function get(){return{sourcePath:{type:String,notify:!0},response:{type:Array,notify:!0}}}}]);return LrnappBlockNeedFeedback}(_polymerElement.PolymerElement);_exports.LrnappBlockNeedFeedback=LrnappBlockNeedFeedback;window.customElements.define(LrnappBlockNeedFeedback.tag,LrnappBlockNeedFeedback)});