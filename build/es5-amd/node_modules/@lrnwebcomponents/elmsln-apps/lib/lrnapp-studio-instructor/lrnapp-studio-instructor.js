define(["exports", "../../../../lit-element/lit-element.js", "../../../../@polymer/app-route/app-location.js", "../../../../@polymer/app-route/app-route.js", "../../../../@polymer/app-layout/app-header/app-header.js", "../../../../@polymer/app-layout/app-toolbar/app-toolbar.js", "../../../../@polymer/iron-ajax/iron-ajax.js", "../../../../@polymer/paper-toggle-button/paper-toggle-button.js", "../../../../@polymer/paper-item/paper-item.js", "../../../../@polymer/paper-badge/paper-badge.js", "../../../../@polymer/paper-button/paper-button.js", "../../../../@polymer/paper-input/paper-input.js", "../../../../@polymer/paper-icon-button/paper-icon-button.js", "../../../simple-tooltip/simple-tooltip.js", "../../../../@vaadin/vaadin-grid/vaadin-grid.js", "../../../../@vaadin/vaadin-grid/vaadin-grid-filter.js", "../../../../@vaadin/vaadin-grid/vaadin-grid-sorter.js", "../../../../@vaadin/vaadin-grid/vaadin-grid-column-group.js", "../../../../@vaadin/vaadin-grid/vaadin-grid-selection-column.js", "../../../elmsln-loading/elmsln-loading.js", "../../../lrndesign-chart/lib/lrndesign-bar.js", "../../../lrndesign-chart/lib/lrndesign-line.js", "../../../lrndesign-chart/lib/lrndesign-pie.js", "../../../simple-picker/simple-picker.js", "../../../lrnsys-button/lrnsys-button.js", "../../../lrndesign-avatar/lrndesign-avatar.js", "../../../../@polymer/paper-dialog/paper-dialog.js", "../../../materializecss-styles/materializecss-styles.js", "../lrnapp-studio-submission/lrnapp-studio-submission.js", "../../../materializecss-styles/lib/colors.js"], function (_exports, _litElement, _appLocation, _appRoute, _appHeader, _appToolbar, _ironAjax, _paperToggleButton, _paperItem, _paperBadge, _paperButton, _paperInput, _paperIconButton, _simpleTooltip, _vaadinGrid, _vaadinGridFilter, _vaadinGridSorter, _vaadinGridColumnGroup, _vaadinGridSelectionColumn, _elmslnLoading, _lrndesignBar, _lrndesignLine, _lrndesignPie, _simplePicker, _lrnsysButton, _lrndesignAvatar, _paperDialog, _materializecssStyles, _lrnappStudioSubmission, _colors) {
  ...
  function _templateObject6_db03d080387911eab76ec18634c4f6e2() {
    ...
    _templateObject6_db03d080387911eab76ec18634c4f6e2 = function _templateObject6_db03d080387911eab76ec18634c4f6e2() {
      return data;
    };
  ...
  function _templateObject5_db03d080387911eab76ec18634c4f6e2() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                <div>\n                  <h3>No submission for this assignment</h3>\n                  <p>\n                    This student has not submitted anything for this assignment\n                    at this time.\n                  </p>\n                </div>\n              "]);

    _templateObject5_db03d080387911eab76ec18634c4f6e2 = function _templateObject5_db03d080387911eab76ec18634c4f6e2() {
      return data;
    };
  ...
  function _templateObject4_db03d080387911eab76ec18634c4f6e2() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                <lrnapp-studio-submission-page\n                  base-path=\"", "\"\n                  .route=\"", "\"\n                  @route-changed=\"", "\"\n                  id=\"", "\"\n                  end-point=\"", "lrnapp-studio-submission\"\n                  csrf-token=\"", "\"\n                  data=\"", "\"\n                  hide-menu-bar\n                ></lrnapp-studio-submission-page>\n              "]);

    _templateObject4_db03d080387911eab76ec18634c4f6e2 = function _templateObject4_db03d080387911eab76ec18634c4f6e2() {
      return data;
    };
  ...
  function _templateObject3_db03d080387911eab76ec18634c4f6e2() {
    ...
    _templateObject3_db03d080387911eab76ec18634c4f6e2 = function _templateObject3_db03d080387911eab76ec18634c4f6e2() {
      return data;
    };
  ...
  function _templateObject2_db03d080387911eab76ec18634c4f6e2() {
    var data = babelHelpers.taggedTemplateLiteral(["\n          <paper-item value=\"", "\"\n            >", "</paper-item\n          >\n        "]);

    _templateObject2_db03d080387911eab76ec18634c4f6e2 = function _templateObject2_db03d080387911eab76ec18634c4f6e2() {
      return data;
    };
  ...
  function _templateObject_db03d080387911eab76ec18634c4f6e2() {
    ...
    _templateObject_db03d080387911eab76ec18634c4f6e2 = function _templateObject_db03d080387911eab76ec18634c4f6e2() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(LrnappStudioInstructor, [{
      ...
      value: function render() {
        ...
        return (0, _litElement.html)(_templateObject_db03d080387911eab76ec18634c4f6e2(), this.route, this.routeChangedEvent, this.route, this.routeChangedEvent, this.endPoint, this.data, this.dataChangedEvent, this.tail, this.tailChangedEvent, this.sourceProjectPath, this._projectDataChanged, this._handleProjectResponse, this.sourceStudentPath, this.studentParams, this._studentDataChanged, this._handleStudentResponse, this.activeProject, this._toArray(this.projects).map(function (project) {
          return (0, _litElement.html)(_templateObject2_db03d080387911eab76ec18634c4f6e2(), project.id, project.attributes.title);
          ...
          return (0, _litElement.html)(_templateObject3_db03d080387911eab76ec18634c4f6e2(), _this2._setActiveSubmission, _this2._setActiveComment);
        }), this._changeActiveItem, this._changeActiveItem, this.activeData.student.name, this.activeData.student.avatar, this.activeData.student.sis.sortable_name, this._changeActiveItem, this._changeActiveItem, this.activeData.assignment.title, this.activeData.submission && this.data.submission ? (0, _litElement.html)(_templateObject4_db03d080387911eab76ec18634c4f6e2(), this.basePath, this.tail, this.tailChangedEvent, this.data.submission, this.basePath, this.csrfToken, this.data) : (0, _litElement.html)(_templateObject5_db03d080387911eab76ec18634c4f6e2()));
      }
    }, {
       ...
       */
      get: function get() {
        return [_colors.materialCssStyles, (0, _litElement.css)(_templateObject6_db03d080387911eab76ec18634c4f6e2())];
      }
    }, {
      key: "tag",
      get: function get() {
