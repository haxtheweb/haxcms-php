define(["exports","meta","../../@polymer/polymer/polymer-element.js","../es-global-bridge/es-global-bridge.js","../../@polymer/polymer/lib/utils/resolve-url.js"],function(_exports,meta,_polymerElement,_esGlobalBridge,_resolveUrl){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.Hal9000=void 0;meta=babelHelpers.interopRequireWildcard(meta);function _templateObject_8c215a206b8111e98ce155804ade6153(){var data=babelHelpers.taggedTemplateLiteral(["\n      <style>\n        :host {\n          display: block;\n        }\n\n        :host([hidden]) {\n          display: none;\n        }\n        [hidden] {\n          display: none;\n        }\n      </style>\n      <slot></slot>\n    "]);_templateObject_8c215a206b8111e98ce155804ade6153=function _templateObject_8c215a206b8111e98ce155804ade6153(){return data};return data}/**
 * `hal-9000`
...
get:function get(){return(0,_polymerElement.html)(_templateObject_8c215a206b8111e98ce155804ade6153())}// properties available to the custom element for data binding
   ...
   */}]);function Hal9000(){var _this;babelHelpers.classCallCheck(this,Hal9000);_this=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(Hal9000).call(this));var name="annyang",basePath=(0,_resolveUrl.pathFromUrl)(decodeURIComponent(meta.url)),location="".concat(basePath,"lib/annyang/annyang.min.js");window.addEventListener("es-bridge-".concat(name,"-loaded"),_this._annyangLoaded.bind(babelHelpers.assertThisInitialized(babelHelpers.assertThisInitialized(_this))));window.ESGlobalBridge.requestAvailability();window.ESGlobalBridge.instance.load(name,location);// check for speech synthesis API
