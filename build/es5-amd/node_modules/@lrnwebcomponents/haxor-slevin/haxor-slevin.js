define(["exports", "require", "../../lit-element/lit-element.js", "../haxcms-elements/lib/core/HAXCMSLitElementTheme.js", "../haxcms-elements/lib/core/haxcms-site-store.js", "../../mobx/dist/mobx.esm.js", "../utils/utils.js", "../anchor-behaviors/anchor-behaviors.js", "../simple-icon/lib/simple-icon-lite.js", "../simple-icon/lib/simple-icons.js"], function (_exports, _require, _litElement, _HAXCMSLitElementTheme, _haxcmsSiteStore, _mobxEsm, _utils, _anchorBehaviors, _simpleIconLite, _simpleIcons) {
  ...
  function _templateObject5_5b3c35e03efe11eb800233a440abe59f() {
    ...
    _templateObject5_5b3c35e03efe11eb800233a440abe59f = function _templateObject5_5b3c35e03efe11eb800233a440abe59f() {
      return data;
    };
  ...
  function _templateObject4_5b3c35e03efe11eb800233a440abe59f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                  <simple-blog-card\n                    alt=\"", "\"\n                    color=\"", "\"\n                    .title=\"", "\"\n                    size=\"small\"\n                    .link=\"", "\"\n                    .image=\"", "\"\n                    .author=\"", "\"\n                    .timestamp=\"", "\"\n                    .readtime=\"", "\"\n                    .authorimage=\"", "\"\n                    .placeholder=\"", "\"\n                    .authorlink=\"", "\"\n                  >\n                    ", "\n                  </simple-blog-card>\n                "]);

    _templateObject4_5b3c35e03efe11eb800233a440abe59f = function _templateObject4_5b3c35e03efe11eb800233a440abe59f() {
      return data;
    };
  ...
  function _templateObject3_5b3c35e03efe11eb800233a440abe59f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                  <simple-blog-card\n                    alt=\"", "\"\n                    color=\"", "\"\n                    .title=\"", "\"\n                    size=\"small\"\n                    .link=\"", "\"\n                    .image=\"", "\"\n                    .author=\"", "\"\n                    .timestamp=\"", "\"\n                    .readtime=\"", "\"\n                    .authorimage=\"", "\"\n                    .placeholder=\"", "\"\n                    .authorlink=\"", "\"\n                  >\n                    ", "\n                  </simple-blog-card>\n                "]);

    _templateObject3_5b3c35e03efe11eb800233a440abe59f = function _templateObject3_5b3c35e03efe11eb800233a440abe59f() {
      return data;
    };
  ...
  function _templateObject2_5b3c35e03efe11eb800233a440abe59f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                  <simple-blog-card\n                    alt=\"", "\"\n                    color=\"", "\"\n                    .title=\"", "\"\n                    size=\"large\"\n                    .link=\"", "\"\n                    .image=\"", "\"\n                    .author=\"", "\"\n                    .timestamp=\"", "\"\n                    .readtime=\"", "\"\n                    .authorimage=\"", "\"\n                    .placeholder=\"", "\"\n                    .authorlink=\"", "\"\n                  >\n                    ", "\n                  </simple-blog-card>\n                "]);

    _templateObject2_5b3c35e03efe11eb800233a440abe59f = function _templateObject2_5b3c35e03efe11eb800233a440abe59f() {
      return data;
    };
  ...
  function _templateObject_5b3c35e03efe11eb800233a440abe59f() {
    ...
    _templateObject_5b3c35e03efe11eb800233a440abe59f = function _templateObject_5b3c35e03efe11eb800233a440abe59f() {
      return data;
    };
  ...
  var HaxorSlevin = /*#__PURE__*/function (_HAXCMSLitElementThem) {
    ...
    babelHelpers.createClass(HaxorSlevin, [{
      ...
      value: function render() {
        ...
        return (0, _litElement.html)(_templateObject_5b3c35e03efe11eb800233a440abe59f(), this.siteModalClick, this._goBack, this.icon, this.title, this.image, this.selectedPage, this.__mainPostsChanged, this.__mainPosts.map(function (post) {
          return (0, _litElement.html)(_templateObject2_5b3c35e03efe11eb800233a440abe59f(), post.metadata.fields && post.metadata.fields.images && post.metadata.fields.images[0] && post.metadata.fields.images[0].alt ? post.metadata.fields.images[0].alt : "", _this2.color, post.title, post.slug, _this2._showImage(post.metadata.fields && post.metadata.fields.images && post.metadata.fields.images[0] && post.metadata.fields.images[0].alt ? post.metadata.fields.images[0].alt : false), _this2.author.name, post.metadata.created, post.metadata.readtime, _this2.author.image, _this2.image, _this2.author.socialLink, post.description);
        }), this.__extraPostsChanged, this.__extraPosts.map(function (post) {
          return (0, _litElement.html)(_templateObject3_5b3c35e03efe11eb800233a440abe59f(), post.metadata.fields && post.metadata.fields.images && post.metadata.fields.images[0] && post.metadata.fields.images[0].alt ? post.metadata.fields.images[0].alt : "", _this2.color, post.title, post.slug, _this2._showImage(post.metadata.fields && post.metadata.fields.images && post.metadata.fields.images[0] && post.metadata.fields.images[0].alt ? post.metadata.fields.images[0].alt : false), _this2.author.name, post.metadata.created, post.metadata.readtime, _this2.author.image, _this2.image, _this2.author.socialLink, post.description);
      ...
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject5_5b3c35e03efe11eb800233a440abe59f())];
      }
    }, {
      key: "tag",
      get: function get() {
