define(["exports", "require", "../../lit-element/lit-element.js", "../haxcms-elements/lib/core/HAXCMSLitElementTheme.js", "../haxcms-elements/lib/core/haxcms-site-store.js", "../../mobx/dist/mobx.esm.js", "../utils/utils.js", "../anchor-behaviors/anchor-behaviors.js", "../simple-icon/simple-icon.js", "../simple-icon/lib/simple-icons.js"], function (_exports, _require, _litElement, _HAXCMSLitElementTheme, _haxcmsSiteStore, _mobxEsm, _utils, _anchorBehaviors, _simpleIcon, _simpleIcons) {
  ...
  function _templateObject5_a270c0a03e5611eb8f599fdde369446c() {
    ...
    _templateObject5_a270c0a03e5611eb8f599fdde369446c = function _templateObject5_a270c0a03e5611eb8f599fdde369446c() {
      return data;
    };
  ...
  function _templateObject4_a270c0a03e5611eb8f599fdde369446c() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                  <simple-blog-card\n                    alt=\"", "\"\n                    color=\"", "\"\n                    .title=\"", "\"\n                    size=\"small\"\n                    .link=\"", "\"\n                    .image=\"", "\"\n                    .author=\"", "\"\n                    .timestamp=\"", "\"\n                    .readtime=\"", "\"\n                    .authorimage=\"", "\"\n                    .placeholder=\"", "\"\n                    .authorlink=\"", "\"\n                  >\n                    ", "\n                  </simple-blog-card>\n                "]);

    _templateObject4_a270c0a03e5611eb8f599fdde369446c = function _templateObject4_a270c0a03e5611eb8f599fdde369446c() {
      return data;
    };
  ...
  function _templateObject3_a270c0a03e5611eb8f599fdde369446c() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                  <simple-blog-card\n                    alt=\"", "\"\n                    color=\"", "\"\n                    .title=\"", "\"\n                    size=\"small\"\n                    .link=\"", "\"\n                    .image=\"", "\"\n                    .author=\"", "\"\n                    .timestamp=\"", "\"\n                    .readtime=\"", "\"\n                    .authorimage=\"", "\"\n                    .placeholder=\"", "\"\n                    .authorlink=\"", "\"\n                  >\n                    ", "\n                  </simple-blog-card>\n                "]);

    _templateObject3_a270c0a03e5611eb8f599fdde369446c = function _templateObject3_a270c0a03e5611eb8f599fdde369446c() {
      return data;
    };
  ...
  function _templateObject2_a270c0a03e5611eb8f599fdde369446c() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                  <simple-blog-card\n                    alt=\"", "\"\n                    color=\"", "\"\n                    .title=\"", "\"\n                    size=\"large\"\n                    .link=\"", "\"\n                    .image=\"", "\"\n                    .author=\"", "\"\n                    .timestamp=\"", "\"\n                    .readtime=\"", "\"\n                    .authorimage=\"", "\"\n                    .placeholder=\"", "\"\n                    .authorlink=\"", "\"\n                  >\n                    ", "\n                  </simple-blog-card>\n                "]);

    _templateObject2_a270c0a03e5611eb8f599fdde369446c = function _templateObject2_a270c0a03e5611eb8f599fdde369446c() {
      return data;
    };
  ...
  function _templateObject_a270c0a03e5611eb8f599fdde369446c() {
    ...
    _templateObject_a270c0a03e5611eb8f599fdde369446c = function _templateObject_a270c0a03e5611eb8f599fdde369446c() {
      return data;
    };
  ...
  var HaxorSlevin = /*#__PURE__*/function (_HAXCMSLitElementThem) {
    ...
    babelHelpers.createClass(HaxorSlevin, [{
      ...
      value: function render() {
        ...
        return (0, _litElement.html)(_templateObject_a270c0a03e5611eb8f599fdde369446c(), this.siteModalClick, this._goBack, this.accentColor, this.icon, this.title, this.image, this.selectedPage, this.__mainPostsChanged, this.__mainPosts.map(function (post) {
          return (0, _litElement.html)(_templateObject2_a270c0a03e5611eb8f599fdde369446c(), post.metadata.fields && post.metadata.fields.images && post.metadata.fields.images[0] && post.metadata.fields.images[0].alt ? post.metadata.fields.images[0].alt : "", _this2.color, post.title, post.slug, _this2._showImage(post.metadata.fields && post.metadata.fields.images && post.metadata.fields.images[0] && post.metadata.fields.images[0].alt ? post.metadata.fields.images[0].alt : false), _this2.author.name, post.metadata.created, post.metadata.readtime, _this2.author.image, _this2.image, _this2.author.socialLink, post.description);
        }), this.__extraPostsChanged, this.__extraPosts.map(function (post) {
          return (0, _litElement.html)(_templateObject3_a270c0a03e5611eb8f599fdde369446c(), post.metadata.fields && post.metadata.fields.images && post.metadata.fields.images[0] && post.metadata.fields.images[0].alt ? post.metadata.fields.images[0].alt : "", _this2.color, post.title, post.slug, _this2._showImage(post.metadata.fields && post.metadata.fields.images && post.metadata.fields.images[0] && post.metadata.fields.images[0].alt ? post.metadata.fields.images[0].alt : false), _this2.author.name, post.metadata.created, post.metadata.readtime, _this2.author.image, _this2.image, _this2.author.socialLink, post.description);
          ...
          return (0, _litElement.html)(_templateObject4_a270c0a03e5611eb8f599fdde369446c(), post.metadata.fields && post.metadata.fields.images && post.metadata.fields.images[0] && post.metadata.fields.images[0].alt ? post.metadata.fields.images[0].alt : "", _this2.color, post.title, post.slug, _this2._showImage(post.metadata.fields && post.metadata.fields.images && post.metadata.fields.images[0] && post.metadata.fields.images[0].alt ? post.metadata.fields.images[0].alt : false), _this2.author.name, post.metadata.created, post.metadata.readtime, _this2.author.image, _this2.image, _this2.author.socialLink, post.description);
      ...
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject5_a270c0a03e5611eb8f599fdde369446c())];
      }
    }, {
      key: "tag",
      get: function get() {
