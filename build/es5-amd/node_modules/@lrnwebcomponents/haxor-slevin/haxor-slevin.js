define(["exports", "require", "../../lit/index.js", "../haxcms-elements/lib/core/HAXCMSLitElementTheme.js", "../haxcms-elements/lib/core/haxcms-site-store.js", "../../mobx/dist/mobx.esm.js", "../utils/utils.js", "../anchor-behaviors/anchor-behaviors.js", "../simple-icon/lib/simple-icon-lite.js", "../simple-icon/lib/simple-icons.js"], function (_exports, _require, _index, _HAXCMSLitElementTheme, _haxcmsSiteStore, _mobxEsm, _utils, _anchorBehaviors, _simpleIconLite, _simpleIcons) {
  ...
  var _templateObject_4c025b20509711edb124eb517be36dbf, _templateObject2_4c025b20509711edb124eb517be36dbf, _templateObject3_4c025b20509711edb124eb517be36dbf, _templateObject4_4c025b20509711edb124eb517be36dbf, _templateObject5_4c025b20509711edb124eb517be36dbf;
    ...
    babelHelpers.createClass(HaxorSlevin, [{
      ...
      value: function render() {
        ...
        return (0, _index.html)(_templateObject_4c025b20509711edb124eb517be36dbf || (_templateObject_4c025b20509711edb124eb517be36dbf = babelHelpers.taggedTemplateLiteral(["\n      <header class=\"header-wrapper\">\n        <div>\n          <site-modal\n            @site-modal-click=\"", "\"\n            icon=\"icons:search\"\n            title=\"Search site\"\n            button-label=\"Search\"\n            dark\n          >\n            <site-search></site-search>\n          </site-modal>\n        </div>\n        <div>\n          <button\n            class=\"backbutton\"\n            @click=\"", "\"\n            title=\"Back to blog post list\"\n          >\n            <simple-icon-lite\n              icon=\"", "\"\n              style=\"color:white;\"\n            ></simple-icon-lite>\n            <span class=\"hide-small\">", "</span>\n          </button>\n        </div>\n        <div class=\"header-image\">\n          <img\n            loading=\"lazy\"\n            class=\"image\"\n            src=\"", "\"\n            style=\"height:46px;width:100%;margin: 4px 0 2px 0;\"\n          />\n        </div>\n      </header>\n      <div class=\"wrapper\">\n        <iron-pages .selected=\"", "\">\n          <div id=\"home\">\n            <site-query\n              @result-changed=\"", "\"\n              limit=\"2\"\n              sort='{\"created\": \"ASC\"}'\n            ></site-query>\n            <div class=\"simple-blog-card-wrapper\">\n              ", "\n            </div>\n            <site-query\n              @result-changed=\"", "\"\n              start-index=\"2\"\n              limit=\"4\"\n              sort='{\"created\": \"ASC\"}'\n            ></site-query>\n            <div class=\"simple-blog-card-wrapper\">\n              ", "\n            </div>\n          </div>\n          <main class=\"contentcontainer-wrapper\">\n            <article id=\"contentcontainer\">\n              <site-git-corner position=\"right\"></site-git-corner>\n              <site-active-title></site-active-title>\n              <h3 class=\"subtitle\" .hidden=\"", "\">\n                ", "\n              </h3>\n              <section id=\"slot\">\n                <slot></slot>\n              </section>\n            </article>\n            <site-query\n              @result-changed=\"", "\"\n              limit=\"3\"\n              start-index=\"", "\"\n              sort='{\"created\": \"ASC\"}'\n            ></site-query>\n            <div class=\"simple-blog-card-wrapper\">\n              ", "\n            </div>\n            <nav class=\"social-float hide-small ", "\">\n              <ul>\n                <li>\n                  <social-share-link\n                    title=\"Share on twitter\"\n                    button-style\n                    mode=\"icon-only\"\n                    message=\"", "\"\n                    type=\"Twitter\"\n                  >\n                  </social-share-link>\n                </li>\n                <li>\n                  <social-share-link\n                    title=\"Share on LinkedIn\"\n                    button-style\n                    mode=\"icon-only\"\n                    message=\"", "\"\n                    url=\"", "\"\n                    type=\"LinkedIn\"\n                  >\n                  </social-share-link>\n                </li>\n                <li>\n                  <social-share-link\n                    title=\"Share on Facebook\"\n                    button-style\n                    mode=\"icon-only\"\n                    url=\"", "\"\n                    message=\"", "\"\n                    type=\"Facebook\"\n                  >\n                  </social-share-link>\n                </li>\n                <li>\n                  <social-share-link\n                    title=\"Share on Pinterest\"\n                    button-style\n                    mode=\"icon-only\"\n                    message=\"", "\"\n                    image=\"", "\"\n                    url=\"", "\"\n                    type=\"Pinterest\"\n                  >\n                  </social-share-link>\n                </li>\n              </ul>\n            </nav>\n            <footer class=\"annoy-user ", "\">\n              <div class=\"annoy-inner\">\n                <simple-icon-lite\n                  icon=\"", "\"\n                  class=\"hide-small\"\n                  style=\"color:black;\"\n                ></simple-icon-lite>\n                <span class=\"hide-small\">\n                  Never miss a story from <strong>", "</strong> use RSS\n                  today!\n                </span>\n                <span class=\"rss\">\n                  <site-rss-button type=\"atom\"></site-rss-button>\n                  <site-rss-button type=\"rss\"></site-rss-button>\n                </span>\n                <site-share-widget\n                  alt=\"Share on social media\"\n                ></site-share-widget>\n              </div>\n            </footer>\n          </main>\n        </iron-pages>\n      </div>\n    "])), this.siteModalClick, this._goBack, this.icon, this.title, this.image, this.selectedPage, this.__mainPostsChanged, this.__mainPosts.map(function (post) {
          ...
          return (0, _index.html)(_templateObject4_4c025b20509711edb124eb517be36dbf || (_templateObject4_4c025b20509711edb124eb517be36dbf = babelHelpers.taggedTemplateLiteral(["\n                  <simple-blog-card\n                    alt=\"", "\"\n                    color=\"", "\"\n                    .title=\"", "\"\n                    size=\"small\"\n                    .link=\"", "\"\n                    .image=\"", "\"\n                    .author=\"", "\"\n                    .timestamp=\"", "\"\n                    .readtime=\"", "\"\n                    .authorimage=\"", "\"\n                    .placeholder=\"", "\"\n                    .authorlink=\"", "\"\n                  >\n                    ", "\n                  </simple-blog-card>\n                "])), post.metadata.fields && post.metadata.fields.images && post.metadata.fields.images[0] && post.metadata.fields.images[0].alt ? post.metadata.fields.images[0].alt : "", _this2.color, post.title, post.slug, _this2._showImage(post.metadata.fields && post.metadata.fields.images && post.metadata.fields.images[0] && post.metadata.fields.images[0].alt ? post.metadata.fields.images[0].alt : false), _this2.author.name, post.metadata.created, post.metadata.readtime, _this2.author.image, _this2.image, _this2.author.socialLink, post.description);
