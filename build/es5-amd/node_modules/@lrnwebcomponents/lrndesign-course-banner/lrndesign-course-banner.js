define(["exports", "require", "../../@polymer/polymer/polymer-element.js"], function (_exports, _require, _polymerElement) {
  ...
  function _templateObject_23256be03ee511ebb7f7a1171f0cd59d() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <style>\n        :host {\n          display: block;\n        }\n        /**\n       * Dialog\n       */\n        .course-image {\n        }\n        .course-heading {\n          position: relative;\n          background-color: rgba(30, 30, 30, 0.8);\n          text-align: left;\n          margin: -5em 0 0 0;\n          padding: 16px;\n          color: #ffffff;\n          height: 64px;\n        }\n        .course-avatar {\n          float: left;\n          display: inline-flex;\n          padding: 0 16px 0 0;\n        }\n        .course-name {\n          font-size: 16px;\n          line-height: 16px;\n          min-width: 96px;\n        }\n        .course-title {\n          font-size: 16px;\n          line-height: 16px;\n          display: none;\n        }\n        .name-wrapper {\n          display: flow-root;\n          overflow: hidden;\n          text-overflow: clip;\n        }\n        @media screen and (min-width: 420px) {\n          .course-name {\n            font-size: 24px;\n          }\n          .course-title {\n            display: block;\n          }\n        }\n      </style>\n      <img\n        class=\"course-image\"\n        style=\"width:100%; height:200px; background-color: lightgray;\"\n        loading=\"lazy\"\n        src$=\"[[image]]\"\n      />\n      <div class=\"course-heading\">\n        <lrndesign-avatar\n          class=\"course-avatar\"\n          label=\"[[name]]\"\n          jdenticon=\"\"\n          color=\"[[color]]\"\n        >\n        </lrndesign-avatar>\n        <div class=\"name-wrapper\">\n          <div class=\"course-name\">[[name]]</div>\n          <div class=\"course-title\">[[title]]</div>\n        </div>\n      </div>\n    "]);

    _templateObject_23256be03ee511ebb7f7a1171f0cd59d = function _templateObject_23256be03ee511ebb7f7a1171f0cd59d() {
      return data;
    };
  ...
  var LrndesignCourseBanner = /*#__PURE__*/function (_PolymerElement) {
    ...
    babelHelpers.createClass(LrndesignCourseBanner, null, [{
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_23256be03ee511ebb7f7a1171f0cd59d());
      }
    }, {
      key: "tag",
      get: function get() {
