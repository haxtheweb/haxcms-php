define(["exports","../../@polymer/polymer/polymer-legacy.js","../hax-body-behaviors/lib/HAXWiring.js","../schema-behaviors/schema-behaviors.js","../../aframe/dist/aframe-master.js"],function(_exports,_polymerLegacy,_HAXWiring,_schemaBehaviors,_aframeMaster){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.AframePlayer=void 0;function _templateObject_ba29c950620511e99fc533744445c188(){var data=babelHelpers.taggedTemplateLiteral(["\n    <custom-style>\n      <style is=\"custom-style\">\n        :host {\n          display: block;\n          position: relative;\n        }\n        .a-hidden {\n          display: hidden;\n        }\n      </style>\n    </custom-style>\n    <a-scene\n      id=\"scene\"\n      class=\"embedded\"\n      embedded\n      arjs$=\"[[ar]]\"\n      style$=\"height:[[height]];width:[[width]];\"\n    >\n      <a-sky color$=\"[[skyColor]]\"></a-sky>\n      <a-marker-camera preset=\"hiro\"></a-marker-camera>\n      <a-entity\n        id=\"entity\"\n        gltf-model$=\"[[source]]\"\n        position=\"0 0 0\"\n      ></a-entity>\n    </a-scene>\n  "],["\n    <custom-style>\n      <style is=\"custom-style\">\n        :host {\n          display: block;\n          position: relative;\n        }\n        .a-hidden {\n          display: hidden;\n        }\n      </style>\n    </custom-style>\n    <a-scene\n      id=\"scene\"\n      class=\"embedded\"\n      embedded\n      arjs$=\"[[ar]]\"\n      style$=\"height:[[height]];width:[[width]];\"\n    >\n      <a-sky color\\$=\"[[skyColor]]\"></a-sky>\n      <a-marker-camera preset=\"hiro\"></a-marker-camera>\n      <a-entity\n        id=\"entity\"\n        gltf-model\\$=\"[[source]]\"\n        position=\"0 0 0\"\n      ></a-entity>\n    </a-scene>\n  "]);_templateObject_ba29c950620511e99fc533744445c188=function _templateObject_ba29c950620511e99fc533744445c188(){return data};return data}/**
 * `aframe-player`
 * `A wrapper to do data binding into aframe`
 *
 * @demo demo/index.html
 */var AframePlayer=(0,_polymerLegacy.Polymer)({_template:(0,_polymerLegacy.html)(_templateObject_ba29c950620511e99fc533744445c188()),is:"aframe-player",behaviors:[HAXBehaviors.PropertiesBehaviors,SchemaBehaviors.Schema],properties:{/**
...
this.$.scene.removeFullScreenStyles();var props={canScale:!1,canPosition:!1,canEditSource:!1,gizmo:{title:"3D player",description:"A 3D file / augmented reality player.",icon:"av:play-circle-filled",color:"amber",groups:["3D","Augmented reality"],handles:[{type:"3d",source:"source"}],meta:{author:"LRNWebComponents"}},settings:{quick:[{property:"height",title:"height",description:"height of the object",inputMethod:"textfield",type:"bar",icon:"image:photo-size-select-small",required:!0},{property:"width",title:"Width",description:"Width of the object",inputMethod:"textfield",type:"bar",icon:"image:straighten",required:!0}],configure:[{property:"source",title:"Source",description:"The URL for this AR file.",inputMethod:"textfield",type:"bar",icon:"link",required:!0},{property:"x",title:"X",description:"X position of the element in AR.",inputMethod:"textfield",type:"bar",icon:"communication:location-on",required:!0},{property:"y",title:"Y",description:"Y position of the element in AR.",inputMethod:"textfield",type:"bar",icon:"communication:location-on",required:!0},{property:"z",title:"Z",description:"Z position of the element in AR.",inputMethod:"textfield",type:"bar",icon:"communication:location-on",required:!0},{property:"skyColor",title:"Sky color",description:"Select the color of the sky in the scene.",inputMethod:"colorpicker",type:"bar",icon:"editor:format-color-fill"}],advanced:[]}};this.setHaxProperties(props)},/**
   ...
   */_positionChanged:function _positionChanged(position){this.$.entity.setAttribute("position",position)}});_exports.AframePlayer=AframePlayer});