define(["exports", "require", "../../lit/index.js"], function (_exports, _require, _index) {
  ...
  var _templateObject_ddf9ce00a0c911eda392efd0bad1b4bf, _templateObject2_ddf9ce00a0c911eda392efd0bad1b4bf;
  ...
  var RCoder = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(RCoder, [{
      ...
      // render function
      function render() {
        return (0, _index.html)(_templateObject_ddf9ce00a0c911eda392efd0bad1b4bf || (_templateObject_ddf9ce00a0c911eda392efd0bad1b4bf = babelHelpers.taggedTemplateLiteral([" <code-editor id=\"editor\" language=\"r\"></code-editor>\n      <button\n        id=\"button\"\n        ?disabled=\"", "\"\n        @click=\"", "\"\n        raised\n      >\n        Process\n      </button>\n      <div id=\"output\"></div>"])), !this.__connected, this.process);
      }
      ...
      //styles function
      function get() {
        return [(0, _index.css)(_templateObject2_ddf9ce00a0c911eda392efd0bad1b4bf || (_templateObject2_ddf9ce00a0c911eda392efd0bad1b4bf = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n\n        :host([hidden]) {\n          display: none;\n        }\n\n        #editor {\n          height: var(--r-coder-editor-height, 300px);\n          width: var(--r-coder-editor-width, 100%);\n        }\n\n        #button {\n          margin: var(--r-code-button-margin, 10px 0);\n        }\n      "])))];
      }
    }, {
      key: "haxProperties",
      get: function get() {
