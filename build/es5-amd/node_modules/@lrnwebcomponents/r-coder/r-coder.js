define(["exports", "require", "../../lit/index.js"], function (_exports, _require, _index) {
  ...
  var _templateObject_5e6e81403dc711eda79ddd1a980dc0e1, _templateObject2_5e6e81403dc711eda79ddd1a980dc0e1;
  ...
  var RCoder = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(RCoder, [{
      ...
      function render() {
        return (0, _index.html)(_templateObject_5e6e81403dc711eda79ddd1a980dc0e1 || (_templateObject_5e6e81403dc711eda79ddd1a980dc0e1 = babelHelpers.taggedTemplateLiteral([" <code-editor id=\"editor\" language=\"r\"></code-editor>\n      <button\n        id=\"button\"\n        ?disabled=\"", "\"\n        @click=\"", "\"\n        raised\n      >\n        Process\n      </button>\n      <div id=\"output\"></div>"])), !this.__connected, this.process);
      ...
      get: //styles function
      function get() {
        return [(0, _index.css)(_templateObject2_5e6e81403dc711eda79ddd1a980dc0e1 || (_templateObject2_5e6e81403dc711eda79ddd1a980dc0e1 = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n\n        :host([hidden]) {\n          display: none;\n        }\n\n        #editor {\n          height: var(--r-coder-editor-height, 300px);\n          width: var(--r-coder-editor-width, 100%);\n        }\n\n        #button {\n          margin: var(--r-code-button-margin, 10px 0);\n        }\n      "])))];
      }
    }, {
      key: "haxProperties",
      get: function get() {
