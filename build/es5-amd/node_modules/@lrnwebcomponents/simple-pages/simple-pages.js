define(["exports", "meta", "require", "../../lit/index.js"], function (_exports, meta, _require, _index) {
  ...
  var _templateObject_d506f6f0e4f411ed85766367b4d3e9fc, _templateObject2_d506f6f0e4f411ed85766367b4d3e9fc;
  ...
  var SimplePages = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(SimplePages, [{
      ...
      // render function
      function render() {
        return (0, _index.html)(_templateObject_d506f6f0e4f411ed85766367b4d3e9fc || (_templateObject_d506f6f0e4f411ed85766367b4d3e9fc = babelHelpers.taggedTemplateLiteral([" <iron-pages\n      selected=\"", "\"\n      selected-attribute=\"", "\"\n      @selected-changed=\"", "\"\n    >\n      <slot></slot>\n    </iron-pages>"])), this.selected, this.selectedAttribute, this._selectedChanged);
      }
      ...
      //styles function
      function get() {
        return [(0, _index.css)(_templateObject2_d506f6f0e4f411ed85766367b4d3e9fc || (_templateObject2_d506f6f0e4f411ed85766367b4d3e9fc = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n\n        :host([hidden]) {\n          display: none;\n        }\n\n        iron-pages:not(:defined) {\n          display: none;\n        }\n      "])))];
      }
    }, {
      key: "properties",
      get: function get() {
