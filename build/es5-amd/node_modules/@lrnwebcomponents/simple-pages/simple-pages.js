define(["exports", "meta", "require", "../../lit/index.js"], function (_exports, meta, _require, _index) {
  ...
  var _templateObject_84ac0850403311edb9fff3e6b08a0a9a, _templateObject2_84ac0850403311edb9fff3e6b08a0a9a;
  ...
  var SimplePages = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(SimplePages, [{
      ...
      function render() {
        return (0, _index.html)(_templateObject_84ac0850403311edb9fff3e6b08a0a9a || (_templateObject_84ac0850403311edb9fff3e6b08a0a9a = babelHelpers.taggedTemplateLiteral([" <iron-pages\n      selected=\"", "\"\n      selected-attribute=\"", "\"\n      @selected-changed=\"", "\"\n    >\n      <slot></slot>\n    </iron-pages>"])), this.selected, this.selectedAttribute, this._selectedChanged);
      ...
      get: //styles function
      function get() {
        return [(0, _index.css)(_templateObject2_84ac0850403311edb9fff3e6b08a0a9a || (_templateObject2_84ac0850403311edb9fff3e6b08a0a9a = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n\n        :host([hidden]) {\n          display: none;\n        }\n\n        iron-pages:not(:defined) {\n          display: none;\n        }\n      "])))];
      }
    }, {
      key: "properties",
      get: function get() {
