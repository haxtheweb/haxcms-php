define(["exports","../../@polymer/polymer/polymer-legacy.js","../../@polymer/polymer/lib/legacy/polymer.dom.js","../../@polymer/polymer/lib/utils/flattened-nodes-observer.js"],function(_exports,_polymerLegacy,_polymerDom,_flattenedNodesObserver){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.WordCount=void 0;function _templateObject_647fc5d062ec11e9ba56c1f762879bb4(){var data=babelHelpers.taggedTemplateLiteral(["\n    <style>\n      :host {\n        display: block;\n        --word-count-color: #888888;\n        --word-count-color-hover: #000000;\n      }\n      :host:after {\n        content: attr(words-text);\n        font-size: 10px;\n        position: relative;\n        transition: 0.3s font-size, color ease;\n        display: flex;\n        line-height: 16px;\n        flex-direction: row-reverse;\n        margin: 12px;\n        color: var(--word-count-color);\n        @apply --word-count-text;\n      }\n      :host(:hover):after {\n        font-size: 12px;\n        font-weight: bold;\n        color: var(--word-count-color-hover);\n        @apply --word-count-text-hover;\n      }\n      :host(:focus):after {\n        font-size: 12px;\n        font-weight: bold;\n        color: var(--word-count-color-hover);\n        @apply --word-count-text-hover;\n      }\n      :host(:active):after {\n        font-size: 12px;\n        font-weight: bold;\n        color: var(--word-count-color-hover);\n        @apply --word-count-text-hover;\n      }\n    </style>\n    <slot></slot>\n  "]);_templateObject_647fc5d062ec11e9ba56c1f762879bb4=function _templateObject_647fc5d062ec11e9ba56c1f762879bb4(){return data};return data}/**
 * `word-count`
 * `Count the words on whatever this wraps`
 *
 * @demo demo/index.html
 */var WordCount=(0,_polymerLegacy.Polymer)({_template:(0,_polymerLegacy.html)(_templateObject_647fc5d062ec11e9ba56c1f762879bb4()),is:"word-count",hostAttributes:{tabindex:"0"},properties:{/**
     * Words
     */words:{type:Number},/**
     * Prefix text.
