define(["exports", "meta", "../../../lit-element/lit-element.js", "./elmsln-studio-styles.js", "./elmsln-studio-utilities.js", "./elmsln-studio-submission-card.js", "../../simple-fields/lib/simple-fields-field.js", "../../accent-card/lib/accent-card-clickable.js"], function (_exports, meta, _litElement, _elmslnStudioStyles, _elmslnStudioUtilities, _elmslnStudioSubmissionCard, _simpleFieldsField, _accentCardClickable) {
  ...
  function _templateObject7_0bd5d100994411ebb1a5332c5e6bdde2() {
    ...
    _templateObject7_0bd5d100994411ebb1a5332c5e6bdde2 = function _templateObject7_0bd5d100994411ebb1a5332c5e6bdde2() {
      return data;
    };
  ...
  function _templateObject6_0bd5d100994411ebb1a5332c5e6bdde2() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                        <nav-card-item\n                          accent-color=\"", "\"\n                          .avatar=\"", "\"\n                          initials=\"", "\"\n                        >\n                          <elmsln-studio-link\n                            id=\"comment-", "\"\n                            aria-describedby=\"comment-", "-desc\"\n                            slot=\"label\"\n                            href=\"", "\"\n                          >\n                            ", "\n                          </elmsln-studio-link>\n\n                          <relative-time\n                            id=\"comment-", "\"\n                            slot=\"description\"\n                            datetime=\"", "\"\n                          >\n                            ", "\n                          </relative-time>\n                        </nav-card-item>\n                      "]);

    _templateObject6_0bd5d100994411ebb1a5332c5e6bdde2 = function _templateObject6_0bd5d100994411ebb1a5332c5e6bdde2() {
      return data;
    };
  ...
  function _templateObject5_0bd5d100994411ebb1a5332c5e6bdde2() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                <div slot=\"body\" ?hidden=\"", "\">\n                  ", "\n                </div>\n                <div slot=\"linklist\">\n                  ", "\n                </div>\n                <button\n                  class=\"load-more\"\n                  slot=\"footer\"\n                  ?disabled=\"", "\"\n                  ?hidden=\"", "\"\n                  @click=\"", "\"\n                >\n                  Load More ", " /\n                  ", "\n                </button>\n              "]);

    _templateObject5_0bd5d100994411ebb1a5332c5e6bdde2 = function _templateObject5_0bd5d100994411ebb1a5332c5e6bdde2() {
      return data;
    };
  ...
  function _templateObject4_0bd5d100994411ebb1a5332c5e6bdde2() {
    var data = babelHelpers.taggedTemplateLiteral(["<div class=\"feature\">", "</div>"]);

    _templateObject4_0bd5d100994411ebb1a5332c5e6bdde2 = function _templateObject4_0bd5d100994411ebb1a5332c5e6bdde2() {
      return data;
    };
  ...
  function _templateObject3_0bd5d100994411ebb1a5332c5e6bdde2() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                    <accent-card-clickable\n                      id=\"accent-", "\"\n                      href=\"", "\"\n                      class=\"card submission-card\"\n                      image-src=\"", "\"\n                      .image-alt=\"", "\"\n                      ?horizontal=\"", "\"\n                      .image-align=\"", "\"\n                      .image-valign=\"", "\"\n                      .gravity=\"", "\"\n                      no-border\n                    >\n                      <elmsln-studio-link\n                        data-clickable\n                        href=\"", "\"\n                        id=\"assignment-", "\"\n                        slot=\"heading\"\n                      >\n                        ", "\n                      </elmsln-studio-link>\n                      <elmsln-studio-link\n                        id=\"student-", "\"\n                        href=\"/submissions", "\"\n                        slot=\"subheading\"\n                      >\n                        ", "\n                      </elmsln-studio-link>\n                      <local-time\n                        slot=\"corner\"\n                        id=\"date-", "\"\n                        datetime=\"", "\"\n                        month=\"long\"\n                        day=\"numeric\"\n                        year=\"", "\"\n                      >\n                        ", "\n                      </local-time>\n                      <div slot=\"content\" id=\"project-", "\">\n                        ", "\n                        ", "\n                      </div>\n                      <elmsln-studio-link\n                        slot=\"footer\"\n                        href=\"", "\"\n                      >\n                        Feedback\n                        <span class=\"sr-only\">(", ")</span>\n                        <simple-icon-lite\n                          icon=\"", "\"\n                        ></simple-icon-lite>\n                      </elmsln-studio-link>\n                    </accent-card-clickable>\n                  "]);

    _templateObject3_0bd5d100994411ebb1a5332c5e6bdde2 = function _templateObject3_0bd5d100994411ebb1a5332c5e6bdde2() {
      return data;
    };
  ...
  function _templateObject2_0bd5d100994411ebb1a5332c5e6bdde2() {
    var data = babelHelpers.taggedTemplateLiteral(["\n              <div id=\"cards\" class=\"", "\">\n                <div\n                  class=\"no-submissions\"\n                  ?hidden=\"", "\"\n                >\n                  No submissions for applied filters.\n                </div>\n                ", "\n              </div>\n            "]);

    _templateObject2_0bd5d100994411ebb1a5332c5e6bdde2 = function _templateObject2_0bd5d100994411ebb1a5332c5e6bdde2() {
      return data;
    };
  ...
  function _templateObject_0bd5d100994411ebb1a5332c5e6bdde2() {
    ...
    _templateObject_0bd5d100994411ebb1a5332c5e6bdde2 = function _templateObject_0bd5d100994411ebb1a5332c5e6bdde2() {
      return data;
    };
  ...
  var ElmslnStudioSubmissions = /*#__PURE__*/function (_ElmslnStudioUtilitie) {
    ...
    babelHelpers.createClass(ElmslnStudioSubmissions, [{
      ...
      value: function render() {
        ...
        return (0, _litElement.html)(_templateObject_0bd5d100994411ebb1a5332c5e6bdde2(), this.projectOptions, this.projectFilter || "", function (e) {
        ...
        }, !this.submissions ? this.loading("grey") : (0, _litElement.html)(_templateObject2_0bd5d100994411ebb1a5332c5e6bdde2(), this.list ? "list" : "grid", this.filteredSubmissions.length > 0, this.filteredSubmissions.map(function (s, i) {
          return (0, _litElement.html)(_templateObject3_0bd5d100994411ebb1a5332c5e6bdde2(), i, _this2.getActivityLink(s, true), _this2.getCoverImage(s), s.imageAlt || undefined, s.feature || _this2.list ? true : false, _this2._getAlign(s.imageGravity || undefined), _this2._getValign(s.imageGravity || undefined), s.imageGravity || undefined, _this2.getActivityLink(s, true), s.id, s.assignment, s.id, !s.userId ? "" : "?student=".concat(s.userId), [s.firstName, s.lastName].join(" "), s.id, s.date, _this2.list ? "numeric" : undefined, _this2.dateFormat(s.date, "short"), s.id, s.project, !s.feature ? "" : (0, _litElement.html)(_templateObject4_0bd5d100994411ebb1a5332c5e6bdde2(), s.feature), _this2.getActivityLink(s), s.feedback.length, _this2.getFeedbackIcon(s.feedback.length));
        })), this.isFiltered ? "Related Comments" : "Recent Comments", !this.comments ? this.loading("grey", "body") : (0, _litElement.html)(_templateObject5_0bd5d100994411ebb1a5332c5e6bdde2(), this.filteredComments.length > 0, this.isFiltered ? "No comments for applied filters." : "No comments.", (this.filteredComments || []).slice(0, this.commentLoad).map(function (f) {
          return (0, _litElement.html)(_templateObject6_0bd5d100994411ebb1a5332c5e6bdde2(), _this2.accentColor(_this2.fullName(f)), f.avatar, _this2.fullName(f), f.id, f.id, _this2.getActivityLink(f), _this2.getActivityTitle(f), f.id, f.date, _this2.dateFormat(f.date, "long"));
      ...
      key: "styles",
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(ElmslnStudioSubmissions), "styles", this)), [(0, _litElement.css)(_templateObject7_0bd5d100994411ebb1a5332c5e6bdde2())]);
      }
    }, {
      key: "properties",
      get: function get() {
