define(["exports", "require", "../../../lit/index.js", "../../accent-card/accent-card.js", "../../../@github/time-elements/dist/index.js", "../../nav-card/nav-card.js", "../../hexagon-loader/hexagon-loader.js", "../../simple-icon/lib/simple-icon-lite.js", "../../hax-iconset/lib/simple-hax-iconset.js", "./elmsln-studio-link.js", "./elmsln-studio-button.js"], function (_exports, _require, _index, _accentCard, _index2, _navCard, _hexagonLoader, _simpleIconLite, _simpleHaxIconset, _elmslnStudioLink, _elmslnStudioButton) {
  ...
  var _templateObject_221efb40ce3f11ec9ab909cdcceed78a, _templateObject2_221efb40ce3f11ec9ab909cdcceed78a, _templateObject3_221efb40ce3f11ec9ab909cdcceed78a, _templateObject4_221efb40ce3f11ec9ab909cdcceed78a, _templateObject5_221efb40ce3f11ec9ab909cdcceed78a, _templateObject6_221efb40ce3f11ec9ab909cdcceed78a, _templateObject7_221efb40ce3f11ec9ab909cdcceed78a, _templateObject8_221efb40ce3f11ec9ab909cdcceed78a, _templateObject9_221efb40ce3f11ec9ab909cdcceed78a, _templateObject10_221efb40ce3f11ec9ab909cdcceed78a, _templateObject11_221efb40ce3f11ec9ab909cdcceed78a, _templateObject12_221efb40ce3f11ec9ab909cdcceed78a, _templateObject13_221efb40ce3f11ec9ab909cdcceed78a, _templateObject14_221efb40ce3f11ec9ab909cdcceed78a, _templateObject15_221efb40ce3f11ec9ab909cdcceed78a;
    ...
    return /*#__PURE__*/function (_SuperClass) {
      ...
      babelHelpers.createClass(_class, [{
        ...
        value: function getFigures(sources) {
          ...
          var images = (sources || []).map(function (source) {
            return {
              ...
              info: source[alt] && source[longdesc] ? (0, _index.html)(_templateObject_221efb40ce3f11ec9ab909cdcceed78a || (_templateObject_221efb40ce3f11ec9ab909cdcceed78a = babelHelpers.taggedTemplateLiteral(["\n                  <p>", ":</p>\n                  <div>", "</div>\n                "])), source[alt], source[longdesc]) : source[alt] ? (0, _index.html)(_templateObject2_221efb40ce3f11ec9ab909cdcceed78a || (_templateObject2_221efb40ce3f11ec9ab909cdcceed78a = babelHelpers.taggedTemplateLiteral([" ", " "])), source[alt]) : (0, _index.html)(_templateObject3_221efb40ce3f11ec9ab909cdcceed78a || (_templateObject3_221efb40ce3f11ec9ab909cdcceed78a = babelHelpers.taggedTemplateLiteral([" ", " "])), source[longdesc])
            };
          });
        ...
        value: function getThumnailGrid(s) {
          ...
          return (0, _index.html)(_templateObject4_221efb40ce3f11ec9ab909cdcceed78a || (_templateObject4_221efb40ce3f11ec9ab909cdcceed78a = babelHelpers.taggedTemplateLiteral(["\n        <div class=\"thumbnail-grid\">\n          ", "\n        </div>\n      "])), (s.sources || []).map(function (source, i) {
            return (0, _index.html)(_templateObject5_221efb40ce3f11ec9ab909cdcceed78a || (_templateObject5_221efb40ce3f11ec9ab909cdcceed78a = babelHelpers.taggedTemplateLiteral(["\n              <img-view-modal\n                class=\"thumbnail\"\n                ?disabled=\"", "\"\n                page=\"", "\"\n                title=\"", " by ", " ", "\"\n                .toolbars=\"", "\"\n                .figures=\"", "\"\n              >\n                <button\n                  ?disabled=\"", "\"\n                  id=\"view-thumb-", "\"\n                  .style=\"", "\"\n                >\n                  <span class=\"sr-only\">", "</span>\n                  <div class=\"zoombg\"></div>\n                  <simple-icon-lite\n                    icon=\"zoom-in\"\n                    class=\"zoomicon\"\n                  ></simple-icon-lite>\n                  <div class=\"imgbg\"></div>\n                </button>\n                <simple-tooltip for=\"view-thumb-", "\"\n                  >View Thumbnail</simple-tooltip\n                >\n              </img-view-modal>\n            "])), disabled, i, s.assignment, s.firstName, s.lastName, _this2.defaultModalToolbars, _this2.getFigures(s.sources), disabled, s.id, _this2.getThumbailStyle(source.src), source.alt, s.id);
          }));
        }
      }, {
        ...
        value: function rubricTable(rubric) {
          return !rubric ? "" : (0, _index.html)(_templateObject7_221efb40ce3f11ec9ab909cdcceed78a || (_templateObject7_221efb40ce3f11ec9ab909cdcceed78a = babelHelpers.taggedTemplateLiteral(["\n            <table class=\"rubric-table\">\n              <caption>\n                Rubric\n              </caption>\n              ", "\n              <tbody>\n                ", "\n              </tbody>\n            </table>\n          "])), !rubric.key || !rubric.key ? "" : (0, _index.html)(_templateObject8_221efb40ce3f11ec9ab909cdcceed78a || (_templateObject8_221efb40ce3f11ec9ab909cdcceed78a = babelHelpers.taggedTemplateLiteral(["\n                    <thead>\n                      <th scope=\"col\">Criteria</th>\n                      ", "\n                    </thead>\n                  "])), rubric.key.map(function (col) {
            return (0, _index.html)(_templateObject9_221efb40ce3f11ec9ab909cdcceed78a || (_templateObject9_221efb40ce3f11ec9ab909cdcceed78a = babelHelpers.taggedTemplateLiteral(["<th scope=\"col\">\n                          ", "\n                        </th>"])), col.description && (col.points || col.points > -1) ? "".concat(col.description, " (").concat(col.points, ")") : col.description || col.points);
          })), Object.keys(rubric.values || {}).map(function (key) {
            return (0, _index.html)(_templateObject10_221efb40ce3f11ec9ab909cdcceed78a || (_templateObject10_221efb40ce3f11ec9ab909cdcceed78a = babelHelpers.taggedTemplateLiteral(["\n                      <tr>\n                        <th scope=\"row\">", "</th>\n                        ", "\n                      </tr>\n                    "])), key, (rubric.values[key] || []).map(function (col) {
              return (0, _index.html)(_templateObject11_221efb40ce3f11ec9ab909cdcceed78a || (_templateObject11_221efb40ce3f11ec9ab909cdcceed78a = babelHelpers.taggedTemplateLiteral(["<td>", "</td>"])), col);
            }));
          }));
        }
      }, {
        ...
        value: function message404(type, backLabel, backHref) {
          return (0, _index.html)(_templateObject12_221efb40ce3f11ec9ab909cdcceed78a || (_templateObject12_221efb40ce3f11ec9ab909cdcceed78a = babelHelpers.taggedTemplateLiteral([" <div id=\"primary\" class=\"primary-404\">\n        <p id=\"message-404\">\n          ", " with this URL does not exist. Return to\n          <elmsln-studio-link href=\"", "\">\n            ", "</elmsln-studio-link\n          >\n          to search for assignment.\n        </p>\n      </div>"])), type, backHref, backLabel);
        }
      }, {
        key: "prevNextNav",
        value: function prevNextNav(prevLabel, prevHref, nextLabel, nextHref) {
          return (0, _index.html)(_templateObject13_221efb40ce3f11ec9ab909cdcceed78a || (_templateObject13_221efb40ce3f11ec9ab909cdcceed78a = babelHelpers.taggedTemplateLiteral(["\n        <div id=\"prev-next-nav\">\n          <elmsln-studio-link\n            href=\"", "\"\n            ?disabled=\"", "\"\n            icon=\"chevron-left\"\n          >\n            <span class=\"prev-next-label\">\n              <span>Previous</span>\n              <span>", "</span>\n            </span>\n          </elmsln-studio-link>\n          <elmsln-studio-link\n            href=\"", "\"\n            ?disabled=\"", "\"\n            icon=\"chevron-right\"\n          >\n            <span slot=\"before\" class=\"prev-next-label\">\n              <span>Next</span>\n              <span>", "</span>\n            </span>\n          </elmsln-studio-link>\n        </div>\n      "])), prevHref, !prevHref, prevLabel, nextHref, !nextHref, nextLabel);
        }
      }, {
        key: "loading",
        value: function loading(color, slot) {
          var size = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "small";
          return !slot ? (0, _index.html)(_templateObject14_221efb40ce3f11ec9ab909cdcceed78a || (_templateObject14_221efb40ce3f11ec9ab909cdcceed78a = babelHelpers.taggedTemplateLiteral(["<hexagon-loader\n            loading\n            item-count=\"3\"\n            size=\"", "\"\n            color=\"", "\"\n          >\n          </hexagon-loader>"])), size, color) : (0, _index.html)(_templateObject15_221efb40ce3f11ec9ab909cdcceed78a || (_templateObject15_221efb40ce3f11ec9ab909cdcceed78a = babelHelpers.taggedTemplateLiteral(["<hexagon-loader\n            loading\n            item-count=\"3\"\n            size=\"", "\"\n            color=\"", "\"\n            slot=\"", "\"\n          >\n          </hexagon-loader>"])), size, color, slot);
        }
        /**
