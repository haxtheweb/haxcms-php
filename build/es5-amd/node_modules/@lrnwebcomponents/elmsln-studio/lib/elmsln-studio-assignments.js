define(["exports", "../../../lit-element/lit-element.js", "./elmsln-studio-utilities.js", "./elmsln-studio-styles.js"], function (_exports, _litElement, _elmslnStudioUtilities, _elmslnStudioStyles) {
  ...
  function _templateObject6_28be5fd03ee511ebb7f7a1171f0cd59d() {
    ...
    _templateObject6_28be5fd03ee511ebb7f7a1171f0cd59d = function _templateObject6_28be5fd03ee511ebb7f7a1171f0cd59d() {
      return data;
    };
  ...
  function _templateObject5_28be5fd03ee511ebb7f7a1171f0cd59d() {
    var data = babelHelpers.taggedTemplateLiteral(["\n          <nav-card-item\n            id=\"act-", "-item\"\n            accent-color=\"", "\"\n            allow-grey\n            avatar=\"", "\"\n            invert\n          >\n            <elmsln-studio-link\n              id=\"act-", "\"\n              class=\"assignment-link\"\n              aria-describedby=\"act-", "-desc act-", "-item\"\n              slot=\"label\"\n              href=\"/assignments/", "\"\n            >\n              ", "\n            </elmsln-studio-link>\n            <div id=\"act-", "-desc\" slot=\"description\">\n              Due:\n              <local-time\n                month=\"long\"\n                day=\"numeric\"\n                year=\"numeric\"\n                hour=\"2-digit\"\n                minute=\"2-digit\"\n                second=\"2-digit\"\n                time-zone-name=\"short\"\n                datetime=\"", "\"\n              >\n                ", "\n              </local-time>\n            </div>\n          </nav-card-item>\n          <simple-tooltip for=\"act-", "\" position=\"left\">\n            ", "\n          </simple-tooltip>\n        "]);

    _templateObject5_28be5fd03ee511ebb7f7a1171f0cd59d = function _templateObject5_28be5fd03ee511ebb7f7a1171f0cd59d() {
      return data;
    };
  ...
  function _templateObject4_28be5fd03ee511ebb7f7a1171f0cd59d() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                          <nav-card flat no-border class=\"card secondary\">\n                            <span slot=\"heading\" ?hidden=\"", "\">\n                              ", "\n                            </span>\n                            <div slot=\"linklist\">\n                              ", "\n                            </div>\n                          </nav-card>\n                        "]);

    _templateObject4_28be5fd03ee511ebb7f7a1171f0cd59d = function _templateObject4_28be5fd03ee511ebb7f7a1171f0cd59d() {
      return data;
    };
  ...
  function _templateObject3_28be5fd03ee511ebb7f7a1171f0cd59d() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                          <div class=\"assignment\">\n                            ", "\n                          </div>\n                        "]);

    _templateObject3_28be5fd03ee511ebb7f7a1171f0cd59d = function _templateObject3_28be5fd03ee511ebb7f7a1171f0cd59d() {
      return data;
    };
  ...
  function _templateObject2_28be5fd03ee511ebb7f7a1171f0cd59d() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                <div class=\"lesson\">\n                  <h2>", "</h2>\n                  ", "\n                </div>\n              "]);

    _templateObject2_28be5fd03ee511ebb7f7a1171f0cd59d = function _templateObject2_28be5fd03ee511ebb7f7a1171f0cd59d() {
      return data;
    };
  ...
  function _templateObject_28be5fd03ee511ebb7f7a1171f0cd59d() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <h1 class=\"sr-only\">Assignments</h1>\n      <div id=\"lessons\">\n        ", "\n      </div>\n    "]);

    _templateObject_28be5fd03ee511ebb7f7a1171f0cd59d = function _templateObject_28be5fd03ee511ebb7f7a1171f0cd59d() {
      return data;
    };
  ...
  var ElmslnStudioAssignments = /*#__PURE__*/function (_ElmslnStudioUtilitie) {
    ...
    babelHelpers.createClass(ElmslnStudioAssignments, [{
      ...
      value: function render() {
        ...
        return (0, _litElement.html)(_templateObject_28be5fd03ee511ebb7f7a1171f0cd59d(), !this.lessons ? this.loading("green", undefined, "large") : Object.keys(this.lessons || {}).map(function (l) {
          return (0, _litElement.html)(_templateObject2_28be5fd03ee511ebb7f7a1171f0cd59d(), _this2.lessons[l].lesson, (_this2.lessons[l].assignments || []).map(function (p) {
            return !p.assignments ? (0, _litElement.html)(_templateObject3_28be5fd03ee511ebb7f7a1171f0cd59d(), _this2.renderAssignment(p)) : (0, _litElement.html)(_templateObject4_28be5fd03ee511ebb7f7a1171f0cd59d(), !p.project, p.project, _this2.sortDates(p.assignments || [], true).map(function (a) {
      ...
      key: "styles",
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(ElmslnStudioAssignments), "styles", this)), [(0, _litElement.css)(_templateObject6_28be5fd03ee511ebb7f7a1171f0cd59d())]);
      }
    }, {
      key: "properties",
      get: function get() {
