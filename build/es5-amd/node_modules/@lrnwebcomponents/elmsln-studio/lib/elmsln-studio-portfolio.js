define(["exports", "../../../lit/index.js", "./elmsln-studio-styles.js", "./elmsln-studio-utilities.js", "../../img-view-modal/img-view-modal.js", "../../hax-iconset/hax-iconset.js", "../../threaded-discussion/threaded-discussion.js"], function (_exports, _index, _elmslnStudioStyles, _elmslnStudioUtilities, _imgViewModal, _haxIconset, _threadedDiscussion) {
  ...
  var _templateObject_bcf70b10403311edb9fff3e6b08a0a9a, _templateObject2_bcf70b10403311edb9fff3e6b08a0a9a, _templateObject3_bcf70b10403311edb9fff3e6b08a0a9a, _templateObject4_bcf70b10403311edb9fff3e6b08a0a9a, _templateObject5_bcf70b10403311edb9fff3e6b08a0a9a, _templateObject6_bcf70b10403311edb9fff3e6b08a0a9a, _templateObject7_bcf70b10403311edb9fff3e6b08a0a9a, _templateObject8_bcf70b10403311edb9fff3e6b08a0a9a, _templateObject9_bcf70b10403311edb9fff3e6b08a0a9a, _templateObject10_bcf70b10403311edb9fff3e6b08a0a9a, _templateObject11_bcf70b10403311edb9fff3e6b08a0a9a, _templateObject12_bcf70b10403311edb9fff3e6b08a0a9a;
  ...
  var ElmslnStudioPortfolio = /*#__PURE__*/function (_ElmslnStudioUtilitie) {
    ...
    babelHelpers.createClass(ElmslnStudioPortfolio, [{
      ...
      function render() {
        ...
        return (0, _index.html)(_templateObject_bcf70b10403311edb9fff3e6b08a0a9a || (_templateObject_bcf70b10403311edb9fff3e6b08a0a9a = babelHelpers.taggedTemplateLiteral(["\n      <div id=\"breadcrumb\">\n        <elmsln-studio-link href=\"submissions\">Submissions</elmsln-studio-link>\n        <span> > </span>\n        ", "\n        ", "\n        <span> > </span>\n        <span\n          >", "</span\n        >\n      </div>\n      <div\n        id=\"primary\"\n        class=\"", "\"\n      >\n        <article id=\"portfolio-project\">\n          <h1>\n            <lrndesign-avatar\n              accent-color=\"", "\"\n              aria-hidden=\"true\"\n              label=\"", "\"\n              .src=\"", "\"\n              two-chars\n            >\n            </lrndesign-avatar>\n            <span class=\"student-name\"\n              >", "</span\n            >\n            ", "\n          </h1>\n          <div id=\"project-buttons\">\n            <button\n              id=\"sort\"\n              aria-pressed=\"", "\"\n              class=\"", "\"\n              @click=\"", "\"\n              controls=\"portfolio-project\"\n            >\n              <simple-icon-lite icon=\"sort\"></simple-icon-lite>\n              <simple-tooltip for=\"sort\"\n                >Sort Submissions\n                ", "</simple-tooltip\n              >\n            </button>\n          </div>\n          ", "\n        </article>\n      </div>\n      <div\n        id=\"secondary\"\n        ?hidden=", "\n      >\n        <aside>\n          <div class=\"instructions callout\">\n            <h2 class=\"callout-label\">\n              <simple-icon-lite\n                icon=\"info\"\n                aria-hidden=\"true\"\n              ></simple-icon-lite>\n              Giving Feedback\n            </h2>\n            <div>\n              <ul>\n                <li>Things to look for: blah, blah, blah</li>\n                <li>How to say it: blah, blah, blah</li>\n                <li>Other info.</li>\n              </ul>\n            </div>\n          </div>\n          <h2 class=\"discussion-label\">Feedback</h2>\n          <div class=\"discussion callout\">\n            <p class=\"callout-label\">\n              <simple-icon-lite\n                icon=\"communication:comment\"\n                aria-hidden=\"true\"\n              ></simple-icon-lite>\n              Post New Feedback\n            </p>\n            <threaded-discussion\n              comment-icon=\"send\"\n              ?demo=\"", "\"\n              .data=\"", "\"\n              latest\n            >\n            </threaded-discussion>\n          </div>\n        </aside>\n      </div>\n      ", "\n    "])), !this.portfolio ? "" : (0, _index.html)(_templateObject2_bcf70b10403311edb9fff3e6b08a0a9a || (_templateObject2_bcf70b10403311edb9fff3e6b08a0a9a = babelHelpers.taggedTemplateLiteral(["\n              ", "\n            "])), !this.portfolio.projectId || !this.portfolio.project ? "" : (0, _index.html)(_templateObject3_bcf70b10403311edb9fff3e6b08a0a9a || (_templateObject3_bcf70b10403311edb9fff3e6b08a0a9a = babelHelpers.taggedTemplateLiteral(["\n                    <elmsln-studio-link\n                      href=\"", "\"\n                      >", "</elmsln-studio-link\n                    >\n                    <span> > </span>\n                  "])), "submissions?project=".concat(this.portfolio.projectId), this.portfolio.project || "Project")), !this.portfolio || !this.assignment ? (0, _index.html)(_templateObject4_bcf70b10403311edb9fff3e6b08a0a9a || (_templateObject4_bcf70b10403311edb9fff3e6b08a0a9a = babelHelpers.taggedTemplateLiteral(["<em>Assignment</em>"]))) : (0, _index.html)(_templateObject5_bcf70b10403311edb9fff3e6b08a0a9a || (_templateObject5_bcf70b10403311edb9fff3e6b08a0a9a = babelHelpers.taggedTemplateLiteral(["\n              <elmsln-studio-link\n                href=\"", "\"\n                >", "</elmsln-studio-link\n              >\n            "])), "submissions?".concat(!this.portfolio.projectId || !this.portfolio.project ? "" : "project=".concat(this.portfolio.projectId, "&"), "assignment=").concat(this.assignment.assignmentId), this.assignment.assignment || "Assignment"), !this.portfolio ? (0, _index.html)(_templateObject6_bcf70b10403311edb9fff3e6b08a0a9a || (_templateObject6_bcf70b10403311edb9fff3e6b08a0a9a = babelHelpers.taggedTemplateLiteral(["<em>Student</em>"]))) : this.fullName(this.portfolio), this.comment && this.comment !== "" ? "view-discussion" : "", !this.portfolio ? "grey" : this.accentColor(this.fullName(this.portfolio)), !this.portfolio ? "undefined" : this.fullName(this.portfolio), this.portfolio && this.portfolio.avatar ? this.portfolio.avatar : undefined, !this.portfolio ? "Loading..." : this.fullName(this.portfolio), !this.portfolio || !this.portfolio.project ? "" : (0, _index.html)(_templateObject7_bcf70b10403311edb9fff3e6b08a0a9a || (_templateObject7_bcf70b10403311edb9fff3e6b08a0a9a = babelHelpers.taggedTemplateLiteral(["\n                  <span class=\"project-name\">", "</span>\n                "])), this.portfolio.project), this.sortLatest ? "false" : "true", !this.sortLatest ? "" : "sort-latest", function (e) {
          ...
          return (0, _index.html)(_templateObject8_bcf70b10403311edb9fff3e6b08a0a9a || (_templateObject8_bcf70b10403311edb9fff3e6b08a0a9a = babelHelpers.taggedTemplateLiteral(["\n              <section\n                class=\"", "\"\n              >\n                <div class=\"submission-header\">\n                  <h2 id=\"sub-", "\">\n                    <span class=\"assignment-name\">", "</span>\n                    <span class=\"submission-date\"\n                      >Submitted:\n                      <local-time\n                        month=\"long\"\n                        day=\"numeric\"\n                        year=\"numeric\"\n                        hour=\"2-digit\"\n                        minute=\"2-digit\"\n                        second=\"2-digit\"\n                        time-zone-name=\"short\"\n                        .datetime=\"", "\"\n                      >\n                        ", "\n                      </local-time>\n                    </span>\n                  </h2>\n                  <elmsln-studio-button\n                    id=\"sub-", "-toggle-button\"\n                    class=\"view-discussion-button\"\n                    aria-describedby=\"sub-", "\"\n                    icon=\"", "\"\n                    path=\"", "\"\n                  >\n                    <span class=\"sr-only\"\n                      >", "</span\n                    >\n                    <span class=\"sr-only\"\n                      >Give / View Feedback (", ")</span\n                    >\n                  </elmsln-studio-button>\n                </div>\n                <div class=\"submission-body\">\n                  ", "\n                </div>\n              </section>\n            "])), _this2.submissionFilter === s.id ? "section-discussion" : "", s.id, s.assignment, s.date, _this2.dateFormat(s.date), s.id, s.id, _this2.submissionFilter === s.id && _this2.comment ? "close" : _this2.getFeedbackIcon(s.feedback.length), _this2.getActivityLink(s, _this2.submissionFilter === s.id && _this2.comment), _this2.submissionFilter === s.id && _this2.comment ? "Close Feedback" : "View Feedback (".concat(s.feedback.length, ")"), s.feedback.length, s.links && s.links.length > 0 ? (0, _index.html)(_templateObject9_bcf70b10403311edb9fff3e6b08a0a9a || (_templateObject9_bcf70b10403311edb9fff3e6b08a0a9a = babelHelpers.taggedTemplateLiteral(["\n                        <ul class=\"submission-links\">\n                          ", "\n                        </ul>\n                      "])), s.links.map(function (link) {
            return (0, _index.html)(_templateObject10_bcf70b10403311edb9fff3e6b08a0a9a || (_templateObject10_bcf70b10403311edb9fff3e6b08a0a9a = babelHelpers.taggedTemplateLiteral(["\n                              <li>\n                                <elmsln-studio-link\n                                  href=\"", "\"\n                                  target=\"_blank\"\n                                  ?disabled=\"", "\"\n                                >\n                                  <simple-icon-lite\n                                    aria-hidden=\"true\"\n                                    icon=\"", "\"\n                                  ></simple-icon-lite>\n                                  ", "\n                                </elmsln-studio-link>\n                              </li>\n                            "])), link.url, _this2.submissionFilter !== s.id && _this2.comment ? true : false, link.type === "pdf" ? "hax:file-pdf" : "link", link.text || link.url);
          })) : !s.sources || s.sources.length === 0 ? (0, _index.html)(_templateObject11_bcf70b10403311edb9fff3e6b08a0a9a || (_templateObject11_bcf70b10403311edb9fff3e6b08a0a9a = babelHelpers.taggedTemplateLiteral([" ", " "])), s.body) : _this2.getThumnailGrid(s, _this2.submissionFilter !== s.id && _this2.comment));
