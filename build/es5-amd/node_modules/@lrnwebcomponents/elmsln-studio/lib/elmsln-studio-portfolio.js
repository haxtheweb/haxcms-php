define(["exports", "../../../lit-element/lit-element.js", "./elmsln-studio-styles.js", "./elmsln-studio-utilities.js", "../../lrndesign-gallery/lrndesign-gallery.js", "../../hax-iconset/hax-iconset.js", "./elmsln-studio-link.js", "./elmsln-studio-button.js"], function (_exports, _litElement, _elmslnStudioStyles, _elmslnStudioUtilities, _lrndesignGallery, _haxIconset, _elmslnStudioLink, _elmslnStudioButton) {
  ...
  function _templateObject11_f09bbdb0d0e811eaaf77ab7a62972e0b() {
    ...
    _templateObject11_f09bbdb0d0e811eaaf77ab7a62972e0b = function _templateObject11_f09bbdb0d0e811eaaf77ab7a62972e0b() {
      return data;
    };
  ...
  function _templateObject10_f09bbdb0d0e811eaaf77ab7a62972e0b() {
    ...
    _templateObject10_f09bbdb0d0e811eaaf77ab7a62972e0b = function _templateObject10_f09bbdb0d0e811eaaf77ab7a62972e0b() {
      return data;
    };
  ...
  function _templateObject9_f09bbdb0d0e811eaaf77ab7a62972e0b() {
    var data = babelHelpers.taggedTemplateLiteral(["\n              <label class=\"sr-only\" for=\"", "\">", "</label>\n            "]);

    _templateObject9_f09bbdb0d0e811eaaf77ab7a62972e0b = function _templateObject9_f09bbdb0d0e811eaaf77ab7a62972e0b() {
      return data;
    };
  ...
  function _templateObject8_f09bbdb0d0e811eaaf77ab7a62972e0b() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <div id=\"", "-div\" ?hidden=", " class=\"comment-form\">\n        ", "\n        <textarea\n          id=\"", "\"\n          aria-desccribedby=\"", "\"\n          class=\"comment-textarea\"\n        ></textarea>\n        <button\n          controls=\"", "\"\n          @click=\"", "\"\n          class=\"comment-submit\"\n        >\n          <iron-icon icon=\"send\" aria-hidden=\"true\"></iron-icon>\n          Submit\n        </button>\n      </div>\n    "]);

    _templateObject8_f09bbdb0d0e811eaaf77ab7a62972e0b = function _templateObject8_f09bbdb0d0e811eaaf77ab7a62972e0b() {
      return data;
    };
  ...
  function _templateObject7_f09bbdb0d0e811eaaf77ab7a62972e0b() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                <div class=\"thread\">\n                  ", "\n                  ", "\n                </div>\n              "]);

    _templateObject7_f09bbdb0d0e811eaaf77ab7a62972e0b = function _templateObject7_f09bbdb0d0e811eaaf77ab7a62972e0b() {
      return data;
    };
  ...
  function _templateObject6_f09bbdb0d0e811eaaf77ab7a62972e0b() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                            ", "\n                          "]);

    _templateObject6_f09bbdb0d0e811eaaf77ab7a62972e0b = function _templateObject6_f09bbdb0d0e811eaaf77ab7a62972e0b() {
      return data;
    };
  ...
  function _templateObject5_f09bbdb0d0e811eaaf77ab7a62972e0b() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                            <lrndesign-gallery\n                              class=\"submission-image\"\n                              layout=\"grid\"\n                              .sources=\"", "\"\n                            ></lrndesign-gallery>\n                          "]);

    _templateObject5_f09bbdb0d0e811eaaf77ab7a62972e0b = function _templateObject5_f09bbdb0d0e811eaaf77ab7a62972e0b() {
      return data;
    };
  ...
  function _templateObject4_f09bbdb0d0e811eaaf77ab7a62972e0b() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                                  <li>\n                                    <elmsln-studio-link\n                                      href=\"", "\"\n                                      target=\"_blank\"\n                                    >\n                                      <iron-icon\n                                        aria-hidden=\"true\"\n                                        icon=\"", "\"\n                                      ></iron-icon>\n                                      ", "\n                                    </elmsln-studio-link>\n                                  </li>\n                                "]);

    _templateObject4_f09bbdb0d0e811eaaf77ab7a62972e0b = function _templateObject4_f09bbdb0d0e811eaaf77ab7a62972e0b() {
      return data;
    };
  ...
  function _templateObject3_f09bbdb0d0e811eaaf77ab7a62972e0b() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                            <ul class=\"submission-links\">\n                              ", "\n                            </ul>\n                          "]);

    _templateObject3_f09bbdb0d0e811eaaf77ab7a62972e0b = function _templateObject3_f09bbdb0d0e811eaaf77ab7a62972e0b() {
      return data;
    };
  ...
  function _templateObject2_f09bbdb0d0e811eaaf77ab7a62972e0b() {
    ...
    _templateObject2_f09bbdb0d0e811eaaf77ab7a62972e0b = function _templateObject2_f09bbdb0d0e811eaaf77ab7a62972e0b() {
      return data;
    };
  ...
  function _templateObject_f09bbdb0d0e811eaaf77ab7a62972e0b() {
    ...
    _templateObject_f09bbdb0d0e811eaaf77ab7a62972e0b = function _templateObject_f09bbdb0d0e811eaaf77ab7a62972e0b() {
      return data;
    };
  ...
  function (_ElmslnStudioUtilitie) {
    ...
    babelHelpers.createClass(ElmslnStudioPortfolio, [{
      ...
      value: function render() {
        ...
        return (0, _litElement.html)(_templateObject_f09bbdb0d0e811eaaf77ab7a62972e0b(), !this.portfolio, this.comment && this.comment !== "" ? "view-discussion" : "", this.accentColor(this.fullName(this.portfolio)), this.fullName(this.portfolio), this.portfolio && this.portfolio.avatar ? this.portfolio.avatar : undefined, this.fullName(this.portfolio), this.portfolio.project, !this.portfolio ? "" : (this.portfolio.submissions || []).map(function (s) {
          return (0, _litElement.html)(_templateObject2_f09bbdb0d0e811eaaf77ab7a62972e0b(), _this2.submissionFilter === s.id ? "section-discussion" : "", s.id, s.assignment, _this2.dateFormat(s.date), s.id, _this2._getFeedbackIcon(s.feedback.length), s.link, s.feedback.length, s.links && s.links.length > 0 ? (0, _litElement.html)(_templateObject3_f09bbdb0d0e811eaaf77ab7a62972e0b(), s.links.map(function (link) {
            return (0, _litElement.html)(_templateObject4_f09bbdb0d0e811eaaf77ab7a62972e0b(), link.url, link.type === "pdf" ? "hax:file-pdf" : "link", link.text || link.url);
          })) : s.sources && s.sources.length > 0 ? (0, _litElement.html)(_templateObject5_f09bbdb0d0e811eaaf77ab7a62972e0b(), s.sources) : (0, _litElement.html)(_templateObject6_f09bbdb0d0e811eaaf77ab7a62972e0b(), s.body));
          ...
          return (0, _litElement.html)(_templateObject7_f09bbdb0d0e811eaaf77ab7a62972e0b(), _this2.makeComment(f), f.replies.map(function (r) {
      ...
      value: function makeWrite(id) {
        ...
        return (0, _litElement.html)(_templateObject8_f09bbdb0d0e811eaaf77ab7a62972e0b(), id, hidden, label ? (0, _litElement.html)(_templateObject9_f09bbdb0d0e811eaaf77ab7a62972e0b(), id, label) : "", id, describedby, id, function (e) {
      ...
      value: function makeComment(c) {
        ...
        return (0, _litElement.html)(_templateObject10_f09bbdb0d0e811eaaf77ab7a62972e0b(), c.id, c.feedbackId ? "comment-reply" : "", c.feedbackId || "", c.feedbackId ? "comment-read" : "", this.accentColor(this.fullName(c)), this.fullName(c), c.avatar, this.fullName(c), this.dateFormat(c.date), c.body, c.feedbackId, c.id, function (e) {
      ...
      key: "styles",
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(ElmslnStudioPortfolio), "styles", this)), [(0, _litElement.css)(_templateObject11_f09bbdb0d0e811eaaf77ab7a62972e0b())]);
      }
    }, {
      key: "properties",
      get: function get() {
