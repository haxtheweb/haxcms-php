define(["exports", "../../../lit-element/lit-element.js", "./elmsln-studio-styles.js", "./elmsln-studio-utilities.js", "../../img-view-modal/img-view-modal.js", "../../hax-iconset/hax-iconset.js", "../../threaded-discussion/threaded-discussion.js"], function (_exports, _litElement, _elmslnStudioStyles, _elmslnStudioUtilities, _imgViewModal, _haxIconset, _threadedDiscussion) {
  ...
  function _templateObject12_be3a83a02dd211eba8a9dbdc0fc9b6e0() {
    ...
    _templateObject12_be3a83a02dd211eba8a9dbdc0fc9b6e0 = function _templateObject12_be3a83a02dd211eba8a9dbdc0fc9b6e0() {
      return data;
    };
  ...
  function _templateObject11_be3a83a02dd211eba8a9dbdc0fc9b6e0() {
    var data = babelHelpers.taggedTemplateLiteral([" ", " "]);

    _templateObject11_be3a83a02dd211eba8a9dbdc0fc9b6e0 = function _templateObject11_be3a83a02dd211eba8a9dbdc0fc9b6e0() {
      return data;
    };
  ...
  function _templateObject10_be3a83a02dd211eba8a9dbdc0fc9b6e0() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                              <li>\n                                <elmsln-studio-link\n                                  href=\"", "\"\n                                  target=\"_blank\"\n                                  ?disabled=\"", "\"\n                                >\n                                  <simple-icon-lite\n                                    aria-hidden=\"true\"\n                                    icon=\"", "\"\n                                  ></simple-icon-lite>\n                                  ", "\n                                </elmsln-studio-link>\n                              </li>\n                            "]);

    _templateObject10_be3a83a02dd211eba8a9dbdc0fc9b6e0 = function _templateObject10_be3a83a02dd211eba8a9dbdc0fc9b6e0() {
      return data;
    };
  ...
  function _templateObject9_be3a83a02dd211eba8a9dbdc0fc9b6e0() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                        <ul class=\"submission-links\">\n                          ", "\n                        </ul>\n                      "]);

    _templateObject9_be3a83a02dd211eba8a9dbdc0fc9b6e0 = function _templateObject9_be3a83a02dd211eba8a9dbdc0fc9b6e0() {
      return data;
    };
  ...
  function _templateObject8_be3a83a02dd211eba8a9dbdc0fc9b6e0() {
    ...
    _templateObject8_be3a83a02dd211eba8a9dbdc0fc9b6e0 = function _templateObject8_be3a83a02dd211eba8a9dbdc0fc9b6e0() {
      return data;
    };
  ...
  function _templateObject7_be3a83a02dd211eba8a9dbdc0fc9b6e0() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                  <span class=\"project-name\">", "</span>\n                "]);

    _templateObject7_be3a83a02dd211eba8a9dbdc0fc9b6e0 = function _templateObject7_be3a83a02dd211eba8a9dbdc0fc9b6e0() {
      return data;
    };
  ...
  function _templateObject6_be3a83a02dd211eba8a9dbdc0fc9b6e0() {
    var data = babelHelpers.taggedTemplateLiteral(["<em>Student</em>"]);

    _templateObject6_be3a83a02dd211eba8a9dbdc0fc9b6e0 = function _templateObject6_be3a83a02dd211eba8a9dbdc0fc9b6e0() {
      return data;
    };
  ...
  function _templateObject5_be3a83a02dd211eba8a9dbdc0fc9b6e0() {
    var data = babelHelpers.taggedTemplateLiteral(["\n              <elmsln-studio-link\n                href=\"", "\"\n                >", "</elmsln-studio-link\n              >\n            "]);

    _templateObject5_be3a83a02dd211eba8a9dbdc0fc9b6e0 = function _templateObject5_be3a83a02dd211eba8a9dbdc0fc9b6e0() {
      return data;
    };
  ...
  function _templateObject4_be3a83a02dd211eba8a9dbdc0fc9b6e0() {
    var data = babelHelpers.taggedTemplateLiteral(["<em>Assignment</em>"]);

    _templateObject4_be3a83a02dd211eba8a9dbdc0fc9b6e0 = function _templateObject4_be3a83a02dd211eba8a9dbdc0fc9b6e0() {
      return data;
    };
  ...
  function _templateObject3_be3a83a02dd211eba8a9dbdc0fc9b6e0() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                    <elmsln-studio-link\n                      href=\"", "\"\n                      >", "</elmsln-studio-link\n                    >\n                    <span> > </span>\n                  "]);

    _templateObject3_be3a83a02dd211eba8a9dbdc0fc9b6e0 = function _templateObject3_be3a83a02dd211eba8a9dbdc0fc9b6e0() {
      return data;
    };
  ...
  function _templateObject2_be3a83a02dd211eba8a9dbdc0fc9b6e0() {
    var data = babelHelpers.taggedTemplateLiteral(["\n              ", "\n            "]);

    _templateObject2_be3a83a02dd211eba8a9dbdc0fc9b6e0 = function _templateObject2_be3a83a02dd211eba8a9dbdc0fc9b6e0() {
      return data;
    };
  ...
  function _templateObject_be3a83a02dd211eba8a9dbdc0fc9b6e0() {
    ...
    _templateObject_be3a83a02dd211eba8a9dbdc0fc9b6e0 = function _templateObject_be3a83a02dd211eba8a9dbdc0fc9b6e0() {
      return data;
    };
  ...
  var ElmslnStudioPortfolio = /*#__PURE__*/function (_ElmslnStudioUtilitie) {
    ...
    babelHelpers.createClass(ElmslnStudioPortfolio, [{
      ...
      value: function render() {
        ...
        return (0, _litElement.html)(_templateObject_be3a83a02dd211eba8a9dbdc0fc9b6e0(), !this.portfolio ? "" : (0, _litElement.html)(_templateObject2_be3a83a02dd211eba8a9dbdc0fc9b6e0(), !this.portfolio.projectId || !this.portfolio.project ? "" : (0, _litElement.html)(_templateObject3_be3a83a02dd211eba8a9dbdc0fc9b6e0(), "/submissions?project=".concat(this.portfolio.projectId), this.portfolio.project || "Project")), !this.portfolio || !this.assignment ? (0, _litElement.html)(_templateObject4_be3a83a02dd211eba8a9dbdc0fc9b6e0()) : (0, _litElement.html)(_templateObject5_be3a83a02dd211eba8a9dbdc0fc9b6e0(), "/submissions?".concat(!this.portfolio.projectId || !this.portfolio.project ? "" : "project=".concat(this.portfolio.projectId, "&"), "assignment=").concat(this.assignment.assignmentId), this.assignment.assignment || "Assignment"), !this.portfolio ? (0, _litElement.html)(_templateObject6_be3a83a02dd211eba8a9dbdc0fc9b6e0()) : this.fullName(this.portfolio), this.comment && this.comment !== "" ? "view-discussion" : "", !this.portfolio ? "grey" : this.accentColor(this.fullName(this.portfolio)), !this.portfolio ? "undefined" : this.fullName(this.portfolio), this.portfolio && this.portfolio.avatar ? this.portfolio.avatar : undefined, !this.portfolio ? "Loading..." : this.fullName(this.portfolio), !this.portfolio || !this.portfolio.project ? "" : (0, _litElement.html)(_templateObject7_be3a83a02dd211eba8a9dbdc0fc9b6e0(), this.portfolio.project), this.sortLatest ? "false" : "true", !this.sortLatest ? "" : "sort-latest", function (e) {
          ...
          return (0, _litElement.html)(_templateObject8_be3a83a02dd211eba8a9dbdc0fc9b6e0(), _this2.submissionFilter === s.id ? "section-discussion" : "", s.id, s.assignment, s.date, _this2.dateFormat(s.date), s.id, s.id, _this2.submissionFilter === s.id && _this2.comment ? "close" : _this2.getFeedbackIcon(s.feedback.length), _this2.getActivityLink(s, _this2.submissionFilter === s.id && _this2.comment), _this2.submissionFilter === s.id && _this2.comment ? "Close Feedback" : "View Feedback (".concat(s.feedback.length, ")"), s.feedback.length, s.links && s.links.length > 0 ? (0, _litElement.html)(_templateObject9_be3a83a02dd211eba8a9dbdc0fc9b6e0(), s.links.map(function (link) {
            return (0, _litElement.html)(_templateObject10_be3a83a02dd211eba8a9dbdc0fc9b6e0(), link.url, _this2.submissionFilter !== s.id && _this2.comment, link.type === "pdf" ? "hax:file-pdf" : "link", link.text || link.url);
          })) : !s.sources || s.sources.length === 0 ? (0, _litElement.html)(_templateObject11_be3a83a02dd211eba8a9dbdc0fc9b6e0(), s.body) : _this2.getThumnailGrid(s, _this2.submissionFilter !== s.id && _this2.comment));
      ...
      key: "styles",
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(ElmslnStudioPortfolio), "styles", this)), [(0, _litElement.css)(_templateObject12_be3a83a02dd211eba8a9dbdc0fc9b6e0())]);
      }
    }, {
      key: "properties",
      get: function get() {
