define(["exports", "../../../lit-element/lit-element.js", "./elmsln-studio-styles.js", "./elmsln-studio-utilities.js", "../../img-view-modal/img-view-modal.js", "../../hax-iconset/hax-iconset.js", "../../threaded-discussion/threaded-discussion.js", "./elmsln-studio-link.js", "./elmsln-studio-button.js"], function (_exports, _litElement, _elmslnStudioStyles, _elmslnStudioUtilities, _imgViewModal, _haxIconset, _threadedDiscussion, _elmslnStudioLink, _elmslnStudioButton) {
  ...
  function _templateObject8_bb4f5420157411eb91e46d84b27d8456() {
    ...
    _templateObject8_bb4f5420157411eb91e46d84b27d8456 = function _templateObject8_bb4f5420157411eb91e46d84b27d8456() {
      return data;
    };
  ...
  function _templateObject7_bb4f5420157411eb91e46d84b27d8456() {
    var data = babelHelpers.taggedTemplateLiteral([" ", " "]);

    _templateObject7_bb4f5420157411eb91e46d84b27d8456 = function _templateObject7_bb4f5420157411eb91e46d84b27d8456() {
      return data;
    };
  ...
  function _templateObject6_bb4f5420157411eb91e46d84b27d8456() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                                      <li>\n                                        <elmsln-studio-link\n                                          href=\"", "\"\n                                          target=\"_blank\"\n                                        >\n                                          <iron-icon\n                                            aria-hidden=\"true\"\n                                            icon=\"", "\"\n                                          ></iron-icon>\n                                          ", "\n                                        </elmsln-studio-link>\n                                      </li>\n                                    "]);

    _templateObject6_bb4f5420157411eb91e46d84b27d8456 = function _templateObject6_bb4f5420157411eb91e46d84b27d8456() {
      return data;
    };
  ...
  function _templateObject5_bb4f5420157411eb91e46d84b27d8456() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                                <ul class=\"submission-links\">\n                                  ", "\n                                </ul>\n                              "]);

    _templateObject5_bb4f5420157411eb91e46d84b27d8456 = function _templateObject5_bb4f5420157411eb91e46d84b27d8456() {
      return data;
    };
  ...
  function _templateObject4_bb4f5420157411eb91e46d84b27d8456() {
    ...
    _templateObject4_bb4f5420157411eb91e46d84b27d8456 = function _templateObject4_bb4f5420157411eb91e46d84b27d8456() {
      return data;
    };
  ...
  function _templateObject3_bb4f5420157411eb91e46d84b27d8456() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                  <elmsln-studio-link\n                    href=\"", "\"\n                    >", "</elmsln-studio-link\n                  >\n                  <span> > </span>\n                "]);

    _templateObject3_bb4f5420157411eb91e46d84b27d8456 = function _templateObject3_bb4f5420157411eb91e46d84b27d8456() {
      return data;
    };
  ...
  function _templateObject2_bb4f5420157411eb91e46d84b27d8456() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                  <elmsln-studio-link\n                    href=\"", "\"\n                    >", "</elmsln-studio-link\n                  >\n                  <span> > </span>\n                "]);

    _templateObject2_bb4f5420157411eb91e46d84b27d8456 = function _templateObject2_bb4f5420157411eb91e46d84b27d8456() {
      return data;
    };
  ...
  function _templateObject_bb4f5420157411eb91e46d84b27d8456() {
    ...
    _templateObject_bb4f5420157411eb91e46d84b27d8456 = function _templateObject_bb4f5420157411eb91e46d84b27d8456() {
      return data;
    };
  ...
  var ElmslnStudioPortfolio = /*#__PURE__*/function (_ElmslnStudioUtilitie) {
    ...
    babelHelpers.createClass(ElmslnStudioPortfolio, [{
      ...
      value: function render() {
        ...
        return !this.portfolio ? "" : (0, _litElement.html)(_templateObject_bb4f5420157411eb91e46d84b27d8456(), !this.portfolio.projectId || !this.portfolio.project ? "" : (0, _litElement.html)(_templateObject2_bb4f5420157411eb91e46d84b27d8456(), "/submissions?project=".concat(this.portfolio.projectId), this.portfolio.project), !this.assignment || !this.assignment.assignment ? "" : (0, _litElement.html)(_templateObject3_bb4f5420157411eb91e46d84b27d8456(), "/submissions?".concat(!this.portfolio.projectId || !this.portfolio.project ? "" : "project=".concat(this.portfolio.projectId, "&"), "assignment=").concat(this.assignment.assignmentId), this.assignment.assignment), this.fullName(this.portfolio), !this.portfolio, this.comment && this.comment !== "" ? "view-discussion" : "", this.accentColor(this.fullName(this.portfolio)), this.fullName(this.portfolio), this.portfolio && this.portfolio.avatar ? this.portfolio.avatar : undefined, this.fullName(this.portfolio), this.portfolio.project, this.sortLatest ? "false" : "true", !this.sortLatest ? "" : "sort-latest", function (e) {
          ...
          return (0, _litElement.html)(_templateObject4_bb4f5420157411eb91e46d84b27d8456(), _this2.submissionFilter === s.id ? "section-discussion" : "", s.id, s.assignment, _this2.dateFormat(s.date), s.id, _this2._getFeedbackIcon(s.feedback.length), _this2.getActivityLink(s, _this2.comment), s.feedback.length, s.links && s.links.length > 0 ? (0, _litElement.html)(_templateObject5_bb4f5420157411eb91e46d84b27d8456(), s.links.map(function (link) {
            return (0, _litElement.html)(_templateObject6_bb4f5420157411eb91e46d84b27d8456(), link.url, link.type === "pdf" ? "hax:file-pdf" : "link", link.text || link.url);
          })) : !s.sources || s.sources.length === 0 ? (0, _litElement.html)(_templateObject7_bb4f5420157411eb91e46d84b27d8456(), s.body) : _this2.getThumnailGrid(s));
      ...
      key: "styles",
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(ElmslnStudioPortfolio), "styles", this)), [(0, _litElement.css)(_templateObject8_bb4f5420157411eb91e46d84b27d8456())]);
      }
    }, {
      key: "properties",
      get: function get() {
