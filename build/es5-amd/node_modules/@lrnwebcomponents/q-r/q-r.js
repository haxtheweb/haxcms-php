define(["exports","require","../../@polymer/polymer/polymer-element.js","../../@polymer/polymer/lib/utils/render-status.js","../hax-body-behaviors/lib/HAXWiring.js"],function(_exports,_require,_polymerElement,_renderStatus,_HAXWiring){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.QR=void 0;_require=babelHelpers.interopRequireWildcard(_require);function _templateObject_c7e906007d9411e9af96c300eb9706aa(){var data=babelHelpers.taggedTemplateLiteral(["\n      <style>\n        :host {\n          display: block;\n        }\n        #link {\n          visibility: hidden;\n          opacity: 0;\n        }\n      </style>\n      <qr-code\n        id=\"qr\"\n        data$=\"[[data]]\"\n        modulesize$=\"[[modulesize]]\"\n        margin$=\"[[margin]]\"\n        format$=\"[[format]]\"\n      ></qr-code>\n      <a href$=\"[[data]]\" id=\"link\">[[title]]</a>\n    "]);_templateObject_c7e906007d9411e9af96c300eb9706aa=function _templateObject_c7e906007d9411e9af96c300eb9706aa(){return data};return data}/**
 * `q-r`
 * `Polymer wrapper for a qr code.`
 *
 * @demo demo/index.html
 */var QR=/*#__PURE__*/function(_PolymerElement){babelHelpers.inherits(QR,_PolymerElement);function QR(){var _this;babelHelpers.classCallCheck(this,QR);_this=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(QR).call(this));new Promise(function(res,rej){return _require.default(["./lib/qr-code.js"],res,rej)});(0,_renderStatus.afterNextRender)(babelHelpers.assertThisInitialized(babelHelpers.assertThisInitialized(_this)),function(){this.HAXWiring=new _HAXWiring.HAXWiring;this.HAXWiring.setup(QR.haxProperties,QR.tag,this)});return _this}babelHelpers.createClass(QR,null,[{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_c7e906007d9411e9af96c300eb9706aa())}},{key:"tag",get:function get(){return"q-r"}},{key:"properties",get:function get(){return{/**
