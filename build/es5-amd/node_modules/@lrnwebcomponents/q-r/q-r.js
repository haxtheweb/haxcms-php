define(["exports","meta","../../@polymer/polymer/polymer-legacy.js","../../@polymer/polymer/lib/utils/resolve-url.js","../hax-body-behaviors/lib/HAXWiring.js","../es-global-bridge/es-global-bridge.js"],function(_exports,meta,_polymerLegacy,_resolveUrl,_HAXWiring,_esGlobalBridge){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.QR=_exports.QRCodeElement=void 0;meta=babelHelpers.interopRequireWildcard(meta);function _templateObject_dbcf8a306a8f11e9a3fbc91c56f16a14(){var data=babelHelpers.taggedTemplateLiteral(["\n    <style>\n      :host {\n        display: block;\n      }\n      #link {\n        visibility: hidden;\n        opacity: 0;\n      }\n    </style>\n    <qr-code\n      id=\"qr\"\n      data$=\"[[data]]\"\n      modulesize$=\"[[modulesize]]\"\n      margin$=\"[[margin]]\"\n      format$=\"[[format]]\"\n    ></qr-code>\n    <a href$=\"[[data]]\" id=\"link\">[[title]]</a>\n  "]);_templateObject_dbcf8a306a8f11e9a3fbc91c56f16a14=function _templateObject_dbcf8a306a8f11e9a3fbc91c56f16a14(){return data};return data}/**
 * `q-r`
 * `Polymer wrapper for a qr code.`
 *
 * @demo demo/index.html
 */var QR=(0,_polymerLegacy.Polymer)({_template:(0,_polymerLegacy.html)(_templateObject_dbcf8a306a8f11e9a3fbc91c56f16a14()),is:"q-r",behaviors:[HAXBehaviors.PropertiesBehaviors],properties:{/**
