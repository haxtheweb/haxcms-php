define(["exports", "../../lit/index.js"], function (_exports, _index) {
  ...
  var _templateObject_285004a02ee311eda9c37b2c2696a94a, _templateObject2_285004a02ee311eda9c37b2c2696a94a;
  ...
  var FigureLabel = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(FigureLabel, [{
      ...
      function render() {
        return (0, _index.html)(_templateObject_285004a02ee311eda9c37b2c2696a94a || (_templateObject_285004a02ee311eda9c37b2c2696a94a = babelHelpers.taggedTemplateLiteral([" <div id=\"wrap\">\n      <div id=\"title\">", "</div>\n      <div id=\"description\">", "</div>\n    </div>"])), this.title, this.description);
      ...
      get: //styles function
      function get() {
        return [(0, _index.css)(_templateObject2_285004a02ee311eda9c37b2c2696a94a || (_templateObject2_285004a02ee311eda9c37b2c2696a94a = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n\n        :host([hidden]) {\n          display: none;\n        }\n\n        #wrap {\n          display: flex;\n          margin-bottom: 1em;\n        }\n\n        #title {\n          background-color: var(--figure-label-title-background-color, #f2f2f2);\n          padding: 10.8px 13.5px 10.8px;\n          font-size: 13.5px;\n        }\n\n        #description {\n          border: solid 1px\n            var(--figure-label-description-background-color, #f2f2f2);\n          padding: 10.8px 13.5px 10.8px;\n          font-size: 13.5px;\n        }\n      "])))];
      }
    }, {
      key: "haxProperties",
      get: function get() {
