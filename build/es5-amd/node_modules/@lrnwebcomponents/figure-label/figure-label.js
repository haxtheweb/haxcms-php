define(["exports", "../../lit-element/lit-element.js"], function (_exports, _litElement) {
  ...
  function _templateObject_7d67b4d0d98f11e98eef6d0e6bb4a010() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <style>\n        :host {\n          display: block;\n        }\n\n        :host([hidden]) {\n          display: none;\n        }\n\n        #wrap {\n          display: flex;\n          margin-bottom: 1em;\n        }\n\n        #title {\n          background-color: #f2f2f2;\n          padding: 10.8px 13.5px 10.8px;\n          font-size: 13.5px;\n        }\n\n        #description {\n          border: solid 1px #f2f2f2;\n          padding: 10.8px 13.5px 10.8px;\n          font-size: 13.5px;\n        }\n      </style>\n      <div id=\"wrap\">\n        <div id=\"title\">", "</div>\n        <div id=\"description\">", "</div>\n      </div>\n    "]);

    _templateObject_7d67b4d0d98f11e98eef6d0e6bb4a010 = function _templateObject_7d67b4d0d98f11e98eef6d0e6bb4a010() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(FigureLabel, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_7d67b4d0d98f11e98eef6d0e6bb4a010(), this.title, this.description);
