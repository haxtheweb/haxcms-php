define(["exports", "../../lit/index.js", "./lib/lorem-data-behaviors.js"], function (_exports, _index, _loremDataBehaviors) {
  ...
  var _templateObject_de5f8af0e4f411ed85766367b4d3e9fc, _templateObject2_de5f8af0e4f411ed85766367b4d3e9fc, _templateObject3_de5f8af0e4f411ed85766367b4d3e9fc;
  ...
  var LoremData = /*#__PURE__*/function (_LoremDataBehaviors) {
    ...
    babelHelpers.createClass(LoremData, [{
      ...
      value: function render() {
        ...
        return (0, _index.html)(_templateObject_de5f8af0e4f411ed85766367b4d3e9fc || (_templateObject_de5f8af0e4f411ed85766367b4d3e9fc = babelHelpers.taggedTemplateLiteral(["\n      <button @click=\"", "\">Save All</button>\n      ", "\n      <button @click=\"", "\">Save All</button>\n    "])), this.saveAll, Object.keys(this.schemas || []).map(function (key) {
          return (0, _index.html)(_templateObject2_de5f8af0e4f411ed85766367b4d3e9fc || (_templateObject2_de5f8af0e4f411ed85766367b4d3e9fc = babelHelpers.taggedTemplateLiteral(["\n          <p>\n            <label>\n              <a href=\"", "\" download=\"", "\"\n                >", ":\n              </a>\n              <br />\n              <textarea>", "</textarea>\n            </label>\n          </p>\n        "])), _this2.saveDataUrl(_this2.schemas[key]), key, key, _this2.getJson(_this2.schemas[key]));
        }), this.saveAll);
      }
      /**
      ...
      key: "styles",
      get: function get() {
        return [(0, _index.css)(_templateObject3_de5f8af0e4f411ed85766367b4d3e9fc || (_templateObject3_de5f8af0e4f411ed85766367b4d3e9fc = babelHelpers.taggedTemplateLiteral(["\n        label {\n          font-size: 80%;\n          font-family: sans-serif;\n        }\n        textarea {\n          width: 100%;\n          height: 200px;\n        }\n      "])))];
      }
    }, {
      key: "tag",
      get: function get() {
