define(["exports", "../../lit/index.js", "./lib/date.format.js"], function (_exports, _index, _dateFormat) {
  ...
  var _templateObject_5db1b3b0d3e211ed8e5073e3aa96f674, _templateObject2_5db1b3b0d3e211ed8e5073e3aa96f674;
  ...
  var SimpleDatetime = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(SimpleDatetime, [{
       ...
       */
      function render() {
        return (0, _index.html)(_templateObject_5db1b3b0d3e211ed8e5073e3aa96f674 || (_templateObject_5db1b3b0d3e211ed8e5073e3aa96f674 = babelHelpers.taggedTemplateLiteral([" <time datetime=\"", "\">", "</time> "])), this.date, this.date);
      }
    }, {
      key: "updated",
      value:
      ...
      key: "styles",
      get: function get() {
        return [(0, _index.css)(_templateObject2_5db1b3b0d3e211ed8e5073e3aa96f674 || (_templateObject2_5db1b3b0d3e211ed8e5073e3aa96f674 = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n          font-size: 14px;\n          color: #b3b3b1;\n          line-height: 30px;\n        }\n      "])))];
      }
    }, {
      key: "tag",
      get: function get() {
