define(["exports", "../../lit-element/lit-element.js", "./lib/date.format.js"], function (_exports, _litElement, _dateFormat) {
  ...
  function _templateObject2_8d1f8820380411eaa561b792cdf1a8cd() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n          font-size: 14px;\n          color: #b3b3b1;\n          line-height: 30px;\n        }\n      "]);

    _templateObject2_8d1f8820380411eaa561b792cdf1a8cd = function _templateObject2_8d1f8820380411eaa561b792cdf1a8cd() {
      return data;
    };
  ...
  function _templateObject_8d1f8820380411eaa561b792cdf1a8cd() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <time datetime=\"", "\">", "</time>\n    "]);

    _templateObject_8d1f8820380411eaa561b792cdf1a8cd = function _templateObject_8d1f8820380411eaa561b792cdf1a8cd() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(SimpleDatetime, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_8d1f8820380411eaa561b792cdf1a8cd(), this.date, this.date);
      }
    }, {
      key: "updated",
      ...
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_8d1f8820380411eaa561b792cdf1a8cd())];
      }
    }, {
      key: "tag",
      get: function get() {
