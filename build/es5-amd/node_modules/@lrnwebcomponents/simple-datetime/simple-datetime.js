define(["exports", "../../lit-element/lit-element.js", "./lib/date.format.js"], function (_exports, _litElement, _dateFormat) {
  ...
  function _templateObject2_d46f4b20247111eb9734a78ef81f0b0d() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n          font-size: 14px;\n          color: #b3b3b1;\n          line-height: 30px;\n        }\n      "]);

    _templateObject2_d46f4b20247111eb9734a78ef81f0b0d = function _templateObject2_d46f4b20247111eb9734a78ef81f0b0d() {
      return data;
    };
  ...
  function _templateObject_d46f4b20247111eb9734a78ef81f0b0d() {
    var data = babelHelpers.taggedTemplateLiteral([" <time datetime=\"", "\">", "</time> "]);

    _templateObject_d46f4b20247111eb9734a78ef81f0b0d = function _templateObject_d46f4b20247111eb9734a78ef81f0b0d() {
      return data;
    };
  ...
  var SimpleDatetime = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(SimpleDatetime, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_d46f4b20247111eb9734a78ef81f0b0d(), this.date, this.date);
      }
    }, {
      key: "updated",
      ...
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_d46f4b20247111eb9734a78ef81f0b0d())];
      }
    }, {
      key: "tag",
      get: function get() {
