define(["exports", "meta", "../../lit/index.js", "../simple-colors/simple-colors.js"], function (_exports, meta, _index, _simpleColors) {
  ...
  var _templateObject_b85453c039ed11ed89d1c353cb18487d, _templateObject2_b85453c039ed11ed89d1c353cb18487d, _templateObject3_b85453c039ed11ed89d1c353cb18487d, _templateObject4_b85453c039ed11ed89d1c353cb18487d;
  ...
  var RpgCharacter = /*#__PURE__*/function (_SimpleColors) {
    ...
    babelHelpers.createClass(RpgCharacter, [{
      ...
      value: function render() {
        ...
        return (0, _index.html)(_templateObject_b85453c039ed11ed89d1c353cb18487d || (_templateObject_b85453c039ed11ed89d1c353cb18487d = babelHelpers.taggedTemplateLiteral(["\n      <div class=\"wrapper\">\n        ", "\n        ", "\n        ", " ", "\n        ", " ", "\n        ", " ", "\n        ", "\n        ", " ", "\n        ", "\n        ", "\n      </div>\n      ", "\n      <style>\n        #cardcircle {\n          fill: var(\n            --simple-colors-default-theme-", "-8,\n            var(--simple-colors-default-theme-accent-8, yellow)\n          );\n        }\n        div {\n          width: ", ";\n        }\n        .wrapper {\n          height: ", ";\n        }\n      </style>\n    "])), this.renderPiece(skin), this.base === 1 ? this.renderPiece(hair) : "", this.renderPiece(face), this.renderPiece(faceItem), this.renderPiece(shirt), this.renderPiece(pants), this.renderPiece(accessories), this.renderPiece(base), this.leg !== "" ? this.renderPiece(leg) : "", this.renderPiece(hatColor), this.fire ? this.renderPiece(fire) : "", hatFileName !== "none" ? this.renderPiece(hat) : "", this.circle ? this.renderPiece(circle) : "", this.demo ? (0, _index.html)(_templateObject2_b85453c039ed11ed89d1c353cb18487d || (_templateObject2_b85453c039ed11ed89d1c353cb18487d = babelHelpers.taggedTemplateLiteral(["<div id=\"demo\">", "</div>"])), this.seed) : "", this.accentColor, this.width + "px", this.height + "px");
      }
    }, {
      key: "renderPiece",
      value: function renderPiece(piece) {
        return (0, _index.svg)(_templateObject3_b85453c039ed11ed89d1c353cb18487d || (_templateObject3_b85453c039ed11ed89d1c353cb18487d = babelHelpers.taggedTemplateLiteral(["\n    <svg xmlns=\"http://www.w3.org/2000/svg\" part=\"rpg-character-item\" viewBox=\"0 0 ", " ", "\" preserveAspectRatio=\"xMidYMid meet\">\n      <image\n        href=\"", "\"\n        width=\"", "px\"\n        height=\"", "px\"\n        focusable=\"false\"\n        preserveAspectRatio=\"xMidYMid meet\"\n      ></image>\n    </svg>"])), this.width, this.height, piece, this.width, this.height);
      }
    }, {
      key: "updated",
      ...
      get: function get() {
        ...
        return [].concat(babelHelpers.toConsumableArray(styles), [(0, _index.css)(_templateObject4_b85453c039ed11ed89d1c353cb18487d || (_templateObject4_b85453c039ed11ed89d1c353cb18487d = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: inline-block;\n          margin: 0;\n          padding: 0;\n          text-align: initial;\n          position: relative;\n        }\n        svg,\n        img {\n          position: absolute;\n          margin: 0;\n          padding: 0;\n          text-align: initial;\n        }\n        div {\n          transition: 0.3s ease-in-out background-color;\n          margin: 0;\n          padding: 0;\n          text-align: initial;\n        }\n        #demo {\n          height: 30px;\n          padding-top: 10px;\n          text-align: center;\n          background-color: black;\n          color: white;\n          font-weight: bold;\n        }\n      "])))]);
      }
    }, {
      key: "haxProperties",
      get: function get() {
