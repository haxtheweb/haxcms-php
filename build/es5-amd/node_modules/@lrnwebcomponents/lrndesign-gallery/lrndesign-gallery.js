define(["exports", "../../lit-element/lit-element.js", "./lib/lrndesign-gallery-behaviors.js", "../responsive-utility/responsive-utility.js", "./lib/lrndesign-gallery-carousel.js", "./lib/lrndesign-gallery-grid.js", "./lib/lrndesign-gallery-masonry.js"], function (_exports, _litElement, _lrndesignGalleryBehaviors, _responsiveUtility, _lrndesignGalleryCarousel, _lrndesignGalleryGrid, _lrndesignGalleryMasonry) {
  ...
  var _templateObject_291387a0b99a11ebbf7975e2d57542c0, _templateObject2_291387a0b99a11ebbf7975e2d57542c0, _templateObject3_291387a0b99a11ebbf7975e2d57542c0, _templateObject4_291387a0b99a11ebbf7975e2d57542c0, _templateObject5_291387a0b99a11ebbf7975e2d57542c0;
  ...
  var LrndesignGallery = /*#__PURE__*/function (_LrndesignGalleryBeha) {
    ...
    babelHelpers.createClass(LrndesignGallery, [{
      ...
      function render() {
        ...
        return (0, _litElement.html)(_templateObject_291387a0b99a11ebbf7975e2d57542c0 || (_templateObject_291387a0b99a11ebbf7975e2d57542c0 = babelHelpers.taggedTemplateLiteral([" <div\n        id=\"gallery\"\n        style=\"--lrndesign-gallery-image-aspect:", ";--lrndesign-gallery-image-height:", "%\"\n      >\n        <div slot=\"title\"><slot name=\"title\"></slot></div>\n        <div slot=\"description\"><slot name=\"description\"></slot></div>\n        ", "\n      </div>\n      <slot hidden></slot>"])), this.aspectRatio, 100 / this.aspectRatio, this.layout === "masonry" ? (0, _litElement.html)(_templateObject2_291387a0b99a11ebbf7975e2d57542c0 || (_templateObject2_291387a0b99a11ebbf7975e2d57542c0 = babelHelpers.taggedTemplateLiteral(["\n              <lrndesign-gallery-masonry\n                accent-color=\"", "\"\n                .aspect-ratio=\"", "\"\n                .extra-wide=\"", "\"\n                ?dark=\"", "\"\n                .gallery-id=\"", "\"\n                @item-changed=\"", "\"\n                responsive-size=\"", "\"\n                .selected=\"", "\"\n                .sources=\"", "\"\n              >\n              </lrndesign-gallery-masonry>\n            "])), this.accentColor, this.aspect, this.extra, this.dark, this.id, function (e) {
          return _this2.goToItem(e.detail);
        }, this.responsiveSize, this.selected, this.items) : this.grid || this.layout === "grid" ? (0, _litElement.html)(_templateObject3_291387a0b99a11ebbf7975e2d57542c0 || (_templateObject3_291387a0b99a11ebbf7975e2d57542c0 = babelHelpers.taggedTemplateLiteral(["\n              <lrndesign-gallery-grid\n                accent-color=\"", "\"\n                .aspect-ratio=\"", "\"\n                .extra-wide=\"", "\"\n                ?dark=\"", "\"\n                .gallery-id=\"", "\"\n                @item-changed=\"", "\"\n                responsive-size=\"", "\"\n                .selected=\"", "\"\n                sizing=\"", "\"\n                .sources=\"", "\"\n              >\n              </lrndesign-gallery-grid>\n            "])), this.accentColor, this.aspect, this.extra, this.dark, this.id, function (e) {
          return _this2.goToItem(e.detail);
        }, this.responsiveSize, this.selected, this.sizing === "cover" || "contain", this.items) : (0, _litElement.html)(_templateObject4_291387a0b99a11ebbf7975e2d57542c0 || (_templateObject4_291387a0b99a11ebbf7975e2d57542c0 = babelHelpers.taggedTemplateLiteral([" <lrndesign-gallery-carousel\n              accent-color=\"", "\"\n              .aspect-ratio=\"", "\"\n              .extra-wide=\"", "\"\n              ?dark=\"", "\"\n              .gallery-id=\"", "\"\n              @item-changed=\"", "\"\n              responsive-size=\"", "\"\n              .selected=\"", "\"\n              sizing=\"", "\"\n              .sources=\"", "\"\n            >\n            </lrndesign-gallery-carousel>"])), this.accentColor, this.aspect, this.extra, this.dark, this.id, function (e) {
          return _this2.goToItem(e.detail);
      ...
      get: //styles function
      function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(LrndesignGallery), "styles", this)), [(0, _litElement.css)(_templateObject5_291387a0b99a11ebbf7975e2d57542c0 || (_templateObject5_291387a0b99a11ebbf7975e2d57542c0 = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n\n        :host([hidden]) {\n          display: none;\n        }\n\n        ::slotted(figure) {\n          display: block;\n          margin-top: 15px;\n          margin-bottom: 15px;\n          max-width: 400px;\n          max-height: 400px;\n          display: block;\n          border: 1px solid #ddd;\n          page-break-inside: avoid;\n        }\n\n        @media screen {\n          ::slotted(figure) {\n            display: none;\n          }\n        }\n      "])))]);
      }
    }, {
      key: "haxProperties",
      get: function get() {
