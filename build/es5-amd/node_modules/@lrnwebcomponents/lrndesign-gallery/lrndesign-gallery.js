define(["exports","../../@polymer/polymer/polymer-element.js","./lib/lrndesign-gallery-behaviors.js","../hax-body-behaviors/lib/HAXWiring.js","../schema-behaviors/schema-behaviors.js","../simple-colors/simple-colors.js","./lib/lrndesign-gallery-carousel.js","./lib/lrndesign-gallery-grid.js"],function(_exports,_polymerElement,_lrndesignGalleryBehaviors,_HAXWiring,_schemaBehaviors,_simpleColors,_lrndesignGalleryCarousel,_lrndesignGalleryGrid){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.LrndesignGallery=void 0;function _templateObject_74aa8dd0773411e985b279adc908722c(){var data=babelHelpers.taggedTemplateLiteral(["\n      <style include=\"simple-colors\">\n        :host {\n          display: block;\n        }\n        :host([hidden]) {\n          display: none;\n        }\n      </style>\n      <div id=\"gallery\">\n        <template is=\"dom-if\" if=\"[[!grid]]\" restamp>\n          <lrndesign-gallery-carousel\n            accent-color$=\"[[accentColor]]\"\n            aspect-ratio$=\"[[aspectRatio]]\"\n            title$=\"[[title]]\"\n            dark$=\"[[dark]]\"\n            gallery-id$=\"[[id]]\"\n            responsive-size$=\"[[responsiveSize]]\"\n            sizing$=\"[[sizing]]\"\n            sources=\"[[sources]]\"\n            title$=\"[[title]]\"\n          >\n            <slot></slot>\n          </lrndesign-gallery-carousel>\n        </template>\n        <template is=\"dom-if\" if=\"[[grid]]\">\n          <lrndesign-gallery-grid\n            accent-color$=\"[[accentColor]]\"\n            aspect-ratio$=\"[[aspectRatio]]\"\n            dark$=\"[[dark]]\"\n            gallery-id$=\"[[id]]\"\n            responsive-size$=\"[[responsiveSize]]\"\n            sizing$=\"[[sizing]]\"\n            sources=\"[[sources]]\"\n            title$=\"[[title]]\"\n          >\n            <slot></slot>\n          </lrndesign-gallery-grid>\n        </template>\n      </div>\n    "]);_templateObject_74aa8dd0773411e985b279adc908722c=function _templateObject_74aa8dd0773411e985b279adc908722c(){return data};return data}/**
 * `lrndesign-gallery`
...
},{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_74aa8dd0773411e985b279adc908722c())}// haxProperty definition
