define(["exports", "../../lit/index.js", "./lib/lrndesign-gallery-behaviors.js", "../responsive-utility/responsive-utility.js", "./lib/lrndesign-gallery-carousel.js", "./lib/lrndesign-gallery-grid.js", "./lib/lrndesign-gallery-masonry.js"], function (_exports, _index, _lrndesignGalleryBehaviors, _responsiveUtility, _lrndesignGalleryCarousel, _lrndesignGalleryGrid, _lrndesignGalleryMasonry) {
  ...
  var _templateObject_d4d559f0cd8111ecaf720fdc1a41727f, _templateObject2_d4d559f0cd8111ecaf720fdc1a41727f, _templateObject3_d4d559f0cd8111ecaf720fdc1a41727f, _templateObject4_d4d559f0cd8111ecaf720fdc1a41727f, _templateObject5_d4d559f0cd8111ecaf720fdc1a41727f, _templateObject6_d4d559f0cd8111ecaf720fdc1a41727f, _templateObject7_d4d559f0cd8111ecaf720fdc1a41727f;
  ...
  var LrndesignGallery = /*#__PURE__*/function (_LrndesignGalleryBeha) {
    ...
    babelHelpers.createClass(LrndesignGallery, [{
      ...
      function render() {
        ...
        return (0, _index.html)(_templateObject_d4d559f0cd8111ecaf720fdc1a41727f || (_templateObject_d4d559f0cd8111ecaf720fdc1a41727f = babelHelpers.taggedTemplateLiteral([" <div\n        id=\"gallery\"\n        style=\"--lrndesign-gallery-image-aspect:", ";--lrndesign-gallery-image-height:", "%\"\n      >\n        <div slot=\"title\"><slot name=\"title\"></slot></div>\n        <div slot=\"description\"><slot name=\"description\"></slot></div>\n        ", "\n      </div>\n      ", ""])), this.aspectRatio, 100 / this.aspectRatio, this.editMode ? (0, _index.html)(_templateObject2_d4d559f0cd8111ecaf720fdc1a41727f || (_templateObject2_d4d559f0cd8111ecaf720fdc1a41727f = babelHelpers.taggedTemplateLiteral(["<div id=\"figures\"><slot></slot></div>"]))) : this.layout === "masonry" ? (0, _index.html)(_templateObject3_d4d559f0cd8111ecaf720fdc1a41727f || (_templateObject3_d4d559f0cd8111ecaf720fdc1a41727f = babelHelpers.taggedTemplateLiteral(["\n              <lrndesign-gallery-masonry\n                accent-color=\"", "\"\n                .aspect-ratio=\"", "\"\n                .extra-wide=\"", "\"\n                ?dark=\"", "\"\n                .gallery-id=\"", "\"\n                @item-changed=\"", "\"\n                responsive-size=\"", "\"\n                .selected=\"", "\"\n                .sources=\"", "\"\n              >\n              </lrndesign-gallery-masonry>\n            "])), this.accentColor, this.aspect, this.extra, this.dark, this.id, function (e) {
          return _this2.goToItem(e.detail);
        }, this.responsiveSize, this.selected, this.items) : this.grid || this.layout === "grid" ? (0, _index.html)(_templateObject4_d4d559f0cd8111ecaf720fdc1a41727f || (_templateObject4_d4d559f0cd8111ecaf720fdc1a41727f = babelHelpers.taggedTemplateLiteral(["\n              <lrndesign-gallery-grid\n                accent-color=\"", "\"\n                .aspect-ratio=\"", "\"\n                .extra-wide=\"", "\"\n                ?dark=\"", "\"\n                .gallery-id=\"", "\"\n                @item-changed=\"", "\"\n                responsive-size=\"", "\"\n                .selected=\"", "\"\n                sizing=\"", "\"\n                .sources=\"", "\"\n              >\n              </lrndesign-gallery-grid>\n            "])), this.accentColor, this.aspect, this.extra, this.dark, this.id, function (e) {
          return _this2.goToItem(e.detail);
        }, this.responsiveSize, this.selected, this.sizing === "cover" || "contain", this.items) : (0, _index.html)(_templateObject5_d4d559f0cd8111ecaf720fdc1a41727f || (_templateObject5_d4d559f0cd8111ecaf720fdc1a41727f = babelHelpers.taggedTemplateLiteral([" <lrndesign-gallery-carousel\n              accent-color=\"", "\"\n              .aspect-ratio=\"", "\"\n              .extra-wide=\"", "\"\n              ?dark=\"", "\"\n              .gallery-id=\"", "\"\n              @item-changed=\"", "\"\n              responsive-size=\"", "\"\n              .selected=\"", "\"\n              sizing=\"", "\"\n              .sources=\"", "\"\n            >\n            </lrndesign-gallery-carousel>"])), this.accentColor, this.aspect, this.extra, this.dark, this.id, function (e) {
          return _this2.goToItem(e.detail);
        }, this.responsiveSize, this.selected, this.sizing === "cover" || "contain", this.items), this.editMode ? "" : (0, _index.html)(_templateObject6_d4d559f0cd8111ecaf720fdc1a41727f || (_templateObject6_d4d559f0cd8111ecaf720fdc1a41727f = babelHelpers.taggedTemplateLiteral(["<slot hidden></slot>"]))));
      ...
      get: //styles function
      function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(LrndesignGallery), "styles", this)), [(0, _index.css)(_templateObject7_d4d559f0cd8111ecaf720fdc1a41727f || (_templateObject7_d4d559f0cd8111ecaf720fdc1a41727f = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n\n        :host([hidden]) {\n          display: none;\n        }\n\n        ::slotted(figure) {\n          display: flex;\n          flex-direction: column;\n          align-items: stretch;\n          justify-content: space-between;\n          margin-top: 15px;\n          margin-bottom: 15px;\n          padding: 5px;\n          max-width: 400px;\n          border: 1px solid #ddd;\n          page-break-inside: avoid;\n        }\n\n        :host([edit-mode]) #figures {\n          display: grid;\n          grid-gap: 5px;\n          grid-template-columns: repeat(auto-fill, minmax(200px, 1fr));\n        }\n\n        :host([edit-mode]) ::slotted(figure) {\n          padding: 5px;\n          margin: 0;\n          width: calc(100% - 10px);\n        }\n\n        @media screen {\n          :host(:not([edit-mode])) ::slotted(figure) {\n            display: none;\n          }\n        }\n      "])))]);
      }
    }, {
      key: "haxProperties",
      get: function get() {
