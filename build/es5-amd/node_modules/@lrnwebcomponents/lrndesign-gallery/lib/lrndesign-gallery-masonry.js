define(["exports", "../../../lit-element/lit-element.js", "./lrndesign-gallery-behaviors.js", "./lrndesign-gallery-zoom.js", "./lrndesign-gallery-details.js", "../../utils/utils.js"], function (_exports, _litElement, _lrndesignGalleryBehaviors, _lrndesignGalleryZoom, _lrndesignGalleryDetails, _utils) {
  ...
  function _templateObject4_2b4ef5c03ee511ebb7f7a1171f0cd59d() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                    <lrndesign-gallery-zoom\n                      .id=\"", "\"\n                      .details=\"", "\"\n                      .heading=\"", "\"\n                      .src=\"", "\"\n                      .tooltip=\"", "\"\n                      .zoom-alt=\"", "\"\n                      style=\"", "\"\n                    >\n                      <img\n                        .alt=\"", "\"\n                        fade\n                        .src=\"", "\"\n                        @load=\"", "\"\n                      />\n                      <div class=\"zoombg\"></div>\n                      <simple-icon-lite\n                        icon=\"zoom-in\"\n                        class=\"zoomicon\"\n                      ></simple-icon-lite>\n                    </lrndesign-gallery-zoom>\n                  "]);

    _templateObject4_2b4ef5c03ee511ebb7f7a1171f0cd59d = function _templateObject4_2b4ef5c03ee511ebb7f7a1171f0cd59d() {
      return data;
    };
  ...
  function _templateObject3_2b4ef5c03ee511ebb7f7a1171f0cd59d() {
    var data = babelHelpers.taggedTemplateLiteral(["\n              <div>\n                ", "\n              </div>\n            "]);

    _templateObject3_2b4ef5c03ee511ebb7f7a1171f0cd59d = function _templateObject3_2b4ef5c03ee511ebb7f7a1171f0cd59d() {
      return data;
    };
  ...
  function _templateObject2_2b4ef5c03ee511ebb7f7a1171f0cd59d() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <div id=\"grid\">\n        <p class=\"sr-only\">A list of columns buttons items:</p>\n        <div id=\"galleryscreen\">\n          ", "\n        </div>\n      </div>\n    "]);

    _templateObject2_2b4ef5c03ee511ebb7f7a1171f0cd59d = function _templateObject2_2b4ef5c03ee511ebb7f7a1171f0cd59d() {
      return data;
    };
  ...
  function _templateObject_2b4ef5c03ee511ebb7f7a1171f0cd59d() {
    ...
    _templateObject_2b4ef5c03ee511ebb7f7a1171f0cd59d = function _templateObject_2b4ef5c03ee511ebb7f7a1171f0cd59d() {
      return data;
    };
  ...
  var LrndesignGalleryMasonry = /*#__PURE__*/function (_LrndesignGalleryBeha) {
    ...
    babelHelpers.createClass(LrndesignGalleryMasonry, null, [{
      ...
      key: "styles",
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(LrndesignGalleryMasonry), "styles", this)), [(0, _litElement.css)(_templateObject_2b4ef5c03ee511ebb7f7a1171f0cd59d())]);
    ...
    babelHelpers.createClass(LrndesignGalleryMasonry, [{
      ...
      value: function render() {
        ...
        return (0, _litElement.html)(_templateObject2_2b4ef5c03ee511ebb7f7a1171f0cd59d(), (this.__items || []).map(function (row, i) {
          return (0, _litElement.html)(_templateObject3_2b4ef5c03ee511ebb7f7a1171f0cd59d(), (row.cols || []).map(function (col, j) {
            return (0, _litElement.html)(_templateObject4_2b4ef5c03ee511ebb7f7a1171f0cd59d(), col.id, col.details, col.heading, col.large, col.tooltip, col.zoomAlt, _this2._getStyle(col.aspect, row.aspect), col.alt, col.src, function (e) {
