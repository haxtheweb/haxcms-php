define(["exports", "../../../lit-element/lit-element.js", "./lrndesign-gallery-behaviors.js", "./lrndesign-gallery-zoom.js", "./lrndesign-gallery-details.js"], function (_exports, _litElement, _lrndesignGalleryBehaviors, _lrndesignGalleryZoom, _lrndesignGalleryDetails) {
  ...
  function _templateObject4_af4d44f0e0c411ea988d4b7e2b2c0fe2() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                    <lrndesign-gallery-zoom\n                      .id=\"", "\"\n                      .details=\"", "\"\n                      .heading=\"", "\"\n                      .src=\"", "\"\n                      .tooltip=\"", "\"\n                      .zoom-alt=\"", "\"\n                      style=\"", "\"\n                    >\n                      <img\n                        .alt=\"", "\"\n                        fade\n                        .src=\"", "\"\n                        @load=\"", "\"\n                      />\n                      <div class=\"zoombg\"></div>\n                      <iron-icon icon=\"zoom-in\" class=\"zoomicon\"></iron-icon>\n                    </lrndesign-gallery-zoom>\n                  "]);

    _templateObject4_af4d44f0e0c411ea988d4b7e2b2c0fe2 = function _templateObject4_af4d44f0e0c411ea988d4b7e2b2c0fe2() {
      return data;
    };
  ...
  function _templateObject3_af4d44f0e0c411ea988d4b7e2b2c0fe2() {
    var data = babelHelpers.taggedTemplateLiteral(["\n              <div>\n                ", "\n              </div>\n            "]);

    _templateObject3_af4d44f0e0c411ea988d4b7e2b2c0fe2 = function _templateObject3_af4d44f0e0c411ea988d4b7e2b2c0fe2() {
      return data;
    };
  ...
  function _templateObject2_af4d44f0e0c411ea988d4b7e2b2c0fe2() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <div id=\"grid\">\n        <p class=\"sr-only\">A list of columns buttons items:</p>\n        <div id=\"galleryscreen\">\n          ", "\n        </div>\n      </div>\n    "]);

    _templateObject2_af4d44f0e0c411ea988d4b7e2b2c0fe2 = function _templateObject2_af4d44f0e0c411ea988d4b7e2b2c0fe2() {
      return data;
    };
  ...
  function _templateObject_af4d44f0e0c411ea988d4b7e2b2c0fe2() {
    ...
    _templateObject_af4d44f0e0c411ea988d4b7e2b2c0fe2 = function _templateObject_af4d44f0e0c411ea988d4b7e2b2c0fe2() {
      return data;
    };
  ...
  function (_LrndesignGalleryBeha) {
    ...
    babelHelpers.createClass(LrndesignGalleryMasonry, null, [{
      ...
      key: "styles",
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(LrndesignGalleryMasonry), "styles", this)), [(0, _litElement.css)(_templateObject_af4d44f0e0c411ea988d4b7e2b2c0fe2())]);
    ...
    babelHelpers.createClass(LrndesignGalleryMasonry, [{
      ...
      value: function render() {
        ...
        return (0, _litElement.html)(_templateObject2_af4d44f0e0c411ea988d4b7e2b2c0fe2(), (this.__items || []).map(function (row, i) {
          return (0, _litElement.html)(_templateObject3_af4d44f0e0c411ea988d4b7e2b2c0fe2(), (row.cols || []).map(function (col, j) {
            return (0, _litElement.html)(_templateObject4_af4d44f0e0c411ea988d4b7e2b2c0fe2(), col.id, col.details, col.heading, col.large, col.tooltip, col.zoomAlt, _this2._getStyle(col.aspect, row.aspect), col.alt, col.src, function (e) {
