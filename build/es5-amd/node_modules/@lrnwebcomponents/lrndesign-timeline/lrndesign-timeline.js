define(["exports", "../../lit/index.js", "../simple-colors/simple-colors.js", "../responsive-utility/responsive-utility.js", "../utils/utils.js"], function (_exports, _index, _simpleColors, _responsiveUtility, _utils) {
  ...
  var _templateObject_5008ef40509711edb124eb517be36dbf, _templateObject2_5008ef40509711edb124eb517be36dbf, _templateObject3_5008ef40509711edb124eb517be36dbf, _templateObject4_5008ef40509711edb124eb517be36dbf;
  ...
  var LrndesignTimeline = /*#__PURE__*/function (_SimpleColors) {
    ...
    babelHelpers.createClass(LrndesignTimeline, [{
      ...
      function render() {
        ...
        return (0, _index.html)(_templateObject_5008ef40509711edb124eb517be36dbf || (_templateObject_5008ef40509711edb124eb517be36dbf = babelHelpers.taggedTemplateLiteral([" <article>\n      <h1 id=\"title\">", "</h1>\n      <slot></slot>\n      <div id=\"timeline\">\n        <div id=\"events\" @scroll=\"", "\">\n          ", "\n        </div>\n      </div>\n    </article>"])), this.timelineTitle, this._checkScroll, this.eventsList.map(function (event, index) {
          return (0, _index.html)(_templateObject2_5008ef40509711edb124eb517be36dbf || (_templateObject2_5008ef40509711edb124eb517be36dbf = babelHelpers.taggedTemplateLiteral(["\n              <section\n                class=\"event\"\n                ?has-media=\"", "\"\n                tabindex=\"0\"\n                @focus=\"", "\"\n              >\n                <div class=\"event-overview\">\n                  <div class=\"heading\"><h2>", "</h2></div>\n                  <div class=\"media-outer\">\n                    ", "\n                  </div>\n                </div>\n                <div class=\"details\">", "</div>\n              </section>\n            "])), event.imagesrc && event.imagesrc !== "", _this2._setScroll, event.heading, !event.imagesrc || event.imagesrc === "" ? "" : (0, _index.html)(_templateObject3_5008ef40509711edb124eb517be36dbf || (_templateObject3_5008ef40509711edb124eb517be36dbf = babelHelpers.taggedTemplateLiteral(["\n                          <div>\n                            <div>\n                              <img\n                                alt=\"", "\"\n                                src=\"", "\"\n                              />\n                            </div>\n                          </div>\n                        "])), event.imagealt, event.imagesrc), event.details);
        }));
