define(["exports", "require", "../../lit/index.js", "../schema-behaviors/schema-behaviors.js", "../simple-modal/lib/simple-modal-handler.js"], function (_exports, _require, _index, _schemaBehaviors, _simpleModalHandler) {
  ...
  var _templateObject_d342b230402311ed986805f5d42d8678, _templateObject2_d342b230402311ed986805f5d42d8678, _templateObject3_d342b230402311ed986805f5d42d8678, _templateObject4_d342b230402311ed986805f5d42d8678, _templateObject5_d342b230402311ed986805f5d42d8678, _templateObject6_d342b230402311ed986805f5d42d8678, _templateObject7_d342b230402311ed986805f5d42d8678, _templateObject8_d342b230402311ed986805f5d42d8678, _templateObject9_d342b230402311ed986805f5d42d8678, _templateObject10_d342b230402311ed986805f5d42d8678, _templateObject11_d342b230402311ed986805f5d42d8678;
  ...
  var MediaImage = /*#__PURE__*/function (_SchemaBehaviors) {
    ...
    babelHelpers.createClass(MediaImage, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_d342b230402311ed986805f5d42d8678 || (_templateObject_d342b230402311ed986805f5d42d8678 = babelHelpers.taggedTemplateLiteral(["\n      ", "\n      <media-image-image\n        ?round=\"", "\"\n        resource=\"", "-image\"\n        source=\"", "\"\n        modal-title=\"", "\"\n        alt=\"", "\"\n        .described-by=\"", "\"\n        @click=\"", "\"\n      ></media-image-image>\n      <media-image-citation>\n        <slot name=\"citation\"> ", " </slot>\n      </media-image-citation>\n      ", "\n    "])), this.__figureLabel ? (0, _index.html)(_templateObject2_d342b230402311ed986805f5d42d8678 || (_templateObject2_d342b230402311ed986805f5d42d8678 = babelHelpers.taggedTemplateLiteral(["\n            <figure-label\n              title=\"", "\"\n              description=\"", "\"\n            ></figure-label>\n          "])), this.figureLabelTitle, this.figureLabelDescription) : "", this.round, this.schemaResourceID, this.source, this.modalTitle, this.alt, this.describedBy, this._handleClick, this.citation, this._hasCaption ? (0, _index.html)(_templateObject3_d342b230402311ed986805f5d42d8678 || (_templateObject3_d342b230402311ed986805f5d42d8678 = babelHelpers.taggedTemplateLiteral(["\n            <media-image-caption>\n              <slot name=\"caption\"> ", " </slot>\n            </media-image-caption>\n          "])), this.caption) : "");
      }
    }, {
      key: "haxHooks",
  ...
  var MediaImageImage = /*#__PURE__*/function (_SimpleModalHandler) {
    ...
    babelHelpers.createClass(MediaImageImage, [{
      ...
      key: "render",
      value: function render() {
        return (0, _index.html)(_templateObject5_d342b230402311ed986805f5d42d8678 || (_templateObject5_d342b230402311ed986805f5d42d8678 = babelHelpers.taggedTemplateLiteral(["\n      <div class=\"image-wrap\">\n        <img\n          src=\"", "\"\n          alt=\"", "\"\n          aria-describedby=\"", "\"\n          loading=\"lazy\"\n        />\n      </div>\n    "])), this.source, this.alt, this.describedBy || "");
      }
    }, {
      key: "updated",
      value: function updated(changedProperties) {
       ...
       */
      function get() {
        return [(0, _index.css)(_templateObject6_d342b230402311ed986805f5d42d8678 || (_templateObject6_d342b230402311ed986805f5d42d8678 = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n        :host(:hover) {\n          cursor: pointer;\n        }\n        .image-wrap {\n          max-height: 600px;\n          overflow: hidden;\n        }\n        .image-wrap img {\n          width: 100%;\n        }\n        :host([round]) .image-wrap {\n          border-radius: 50%;\n        }\n      "])))];
      }
    }, {
      key: "properties",
      get: function get() {
  ...
  var MediaImageCitation = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(MediaImageCitation, [{
      key: "render",
      value: function render() {
        return (0, _index.html)(_templateObject7_d342b230402311ed986805f5d42d8678 || (_templateObject7_d342b230402311ed986805f5d42d8678 = babelHelpers.taggedTemplateLiteral([" <div class=\"citation\"><slot></slot></div> "])));
      }
    }], [{
      key: "styles",
      get:
       ...
       */
      function get() {
        return [(0, _index.css)(_templateObject8_d342b230402311ed986805f5d42d8678 || (_templateObject8_d342b230402311ed986805f5d42d8678 = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n          overflow: auto;\n          max-height: 100px;\n        }\n\n        .citation {\n          font-size: 12.8px;\n          font-style: italic;\n          color: #4c4c4c;\n          margin: 15px 0 15px;\n        }\n      "])))];
      }
    }, {
      key: "tag",
      get: function get() {
  ...
  var MediaImageCaption = /*#__PURE__*/function (_LitElement2) {
    ...
    babelHelpers.createClass(MediaImageCaption, [{
      key: "render",
      value: function render() {
        return (0, _index.html)(_templateObject9_d342b230402311ed986805f5d42d8678 || (_templateObject9_d342b230402311ed986805f5d42d8678 = babelHelpers.taggedTemplateLiteral(["\n      <div class=\"caption\">\n        ", "\n      </div>\n    "])), !this.__hasContent ? (0, _index.html)(_templateObject10_d342b230402311ed986805f5d42d8678 || (_templateObject10_d342b230402311ed986805f5d42d8678 = babelHelpers.taggedTemplateLiteral([" <slot id=\"slot\"></slot> "]))) : "");
      }
    }], [{
      key: "styles",
      get:
       ...
       */
      function get() {
        return [(0, _index.css)(_templateObject11_d342b230402311ed986805f5d42d8678 || (_templateObject11_d342b230402311ed986805f5d42d8678 = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n          overflow: auto;\n          max-height: 200px;\n        }\n\n        .caption {\n          padding-bottom: 25px;\n          border-bottom: dashed 2px lightgray;\n          margin-bottom: 25px;\n          line-height: 1.5;\n          font-size: 18px;\n        }\n\n        .caption ::slotted(*) {\n          margin-top: 0;\n        }\n        .caption ::slotted(*:last-child) {\n          margin-bottom: 0;\n        }\n      "])))];
      }
    }, {
      key: "tag",
      get: function get() {
