 ...
 * -
 */var StopNote=(0,_polymerLegacy.Polymer)({_template:(0,_polymerLegacy.html)(_templateObject_5fc34f3062ec11e9ba56c1f762879bb4()),is:"stop-note",behaviors:[HAXBehaviors.PropertiesBehaviors,MaterializeCSSBehaviors.ColorBehaviors,SchemaBehaviors.Schema],observers:["_iconChanged(icon)"],properties:{/**
     * Title Message
     ...
     * Icon selected
     */icon:{type:String,value:"stopnoteicons:stop-icon",reflectToAttribute:!0}},/**
   * Update styles based on icon selected.
   */_iconChanged:function _iconChanged(icon){this.updateStyles()},/**
   * Evaluates url for correct targeting.
   */_urlTarget:function _urlTarget(url){if(url){var external=this._outsideLink(url);if(external){return"_blank"}}return!1},/**
