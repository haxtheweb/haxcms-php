define(["exports", "require", "../../@polymer/polymer/polymer-element.js"], function (_exports, _require, _polymerElement) {
  ...
  function _templateObject_3dfde7e0332811ea9673c9ed9148a8db() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <style>\n        paper-dropdown-menu,\n        paper-listbox {\n          width: 250px;\n        }\n        paper-dropdown-menu {\n          height: 200px;\n          margin: auto;\n          display: block;\n        }\n      </style>\n      <paper-dropdown-menu\n        id=\"menu\"\n        label$=\"[[label]]\"\n        on-click=\"_menubuttonTap\"\n        on-selected-item-changed=\"_setSelectedValue\"\n      >\n        <paper-listbox\n          id=\"listbox\"\n          slot=\"dropdown-content\"\n          selected=\"{{selectedIndex}}\"\n        >\n          <slot></slot>\n        </paper-listbox>\n      </paper-dropdown-menu>\n    "], ["\n      <style>\n        paper-dropdown-menu,\n        paper-listbox {\n          width: 250px;\n        }\n        paper-dropdown-menu {\n          height: 200px;\n          margin: auto;\n          display: block;\n        }\n      </style>\n      <paper-dropdown-menu\n        id=\"menu\"\n        label\\$=\"[[label]]\"\n        on-click=\"_menubuttonTap\"\n        on-selected-item-changed=\"_setSelectedValue\"\n      >\n        <paper-listbox\n          id=\"listbox\"\n          slot=\"dropdown-content\"\n          selected=\"{{selectedIndex}}\"\n        >\n          <slot></slot>\n        </paper-listbox>\n      </paper-dropdown-menu>\n    "]);

    _templateObject_3dfde7e0332811ea9673c9ed9148a8db = function _templateObject_3dfde7e0332811ea9673c9ed9148a8db() {
      return data;
    };
  ...
  function (_PolymerElement) {
    ...
    babelHelpers.createClass(SelectMenu, [{
      ...
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_3dfde7e0332811ea9673c9ed9148a8db());
      }
    }, {
      key: "tag",
      get: function get() {
