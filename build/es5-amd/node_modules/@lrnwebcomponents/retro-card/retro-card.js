define(["exports", "../../lit-element/lit-element.js", "../simple-colors/simple-colors.js"], function (_exports, _litElement, _simpleColors) {
  ...
  function _templateObject3_bab4b8402dd211eba8a9dbdc0fc9b6e0() {
    ...
    _templateObject3_bab4b8402dd211eba8a9dbdc0fc9b6e0 = function _templateObject3_bab4b8402dd211eba8a9dbdc0fc9b6e0() {
      return data;
    };
  ...
  function _templateObject2_bab4b8402dd211eba8a9dbdc0fc9b6e0() {
    var data = babelHelpers.taggedTemplateLiteral(["<span class=\"project-tag\">", "</span>"]);

    _templateObject2_bab4b8402dd211eba8a9dbdc0fc9b6e0 = function _templateObject2_bab4b8402dd211eba8a9dbdc0fc9b6e0() {
      return data;
    };
  ...
  function _templateObject_bab4b8402dd211eba8a9dbdc0fc9b6e0() {
    ...
    _templateObject_bab4b8402dd211eba8a9dbdc0fc9b6e0 = function _templateObject_bab4b8402dd211eba8a9dbdc0fc9b6e0() {
      return data;
    };
  ...
  var RetroCard = /*#__PURE__*/function (_SimpleColors) {
    ...
    babelHelpers.createClass(RetroCard, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_bab4b8402dd211eba8a9dbdc0fc9b6e0(), this.color, this.url, this._clickCard, this.__source, this.title, this.subtitle, this.__cardTags.map(function (tag) {
          return (0, _litElement.html)(_templateObject2_bab4b8402dd211eba8a9dbdc0fc9b6e0(), tag.trim());
        }));
      ...
      //styles function
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(RetroCard), "styles", this)), [(0, _litElement.css)(_templateObject3_bab4b8402dd211eba8a9dbdc0fc9b6e0())]);
      }
    }, {
      key: "haxProperties",
      get: function get() {
