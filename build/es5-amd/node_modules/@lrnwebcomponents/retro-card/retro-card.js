define(["exports", "../../lit-element/lit-element.js", "../simple-colors/simple-colors.js"], function (_exports, _litElement, _simpleColors) {
  ...
  function _templateObject3_25349cd03ee511ebb7f7a1171f0cd59d() {
    ...
    _templateObject3_25349cd03ee511ebb7f7a1171f0cd59d = function _templateObject3_25349cd03ee511ebb7f7a1171f0cd59d() {
      return data;
    };
  ...
  function _templateObject2_25349cd03ee511ebb7f7a1171f0cd59d() {
    var data = babelHelpers.taggedTemplateLiteral(["<span class=\"project-tag\">", "</span>"]);

    _templateObject2_25349cd03ee511ebb7f7a1171f0cd59d = function _templateObject2_25349cd03ee511ebb7f7a1171f0cd59d() {
      return data;
    };
  ...
  function _templateObject_25349cd03ee511ebb7f7a1171f0cd59d() {
    ...
    _templateObject_25349cd03ee511ebb7f7a1171f0cd59d = function _templateObject_25349cd03ee511ebb7f7a1171f0cd59d() {
      return data;
    };
  ...
  var RetroCard = /*#__PURE__*/function (_SimpleColors) {
    ...
    babelHelpers.createClass(RetroCard, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_25349cd03ee511ebb7f7a1171f0cd59d(), this.color, this.url, this._clickCard, this.__source, this.title, this.subtitle, this.__cardTags.map(function (tag) {
          return (0, _litElement.html)(_templateObject2_25349cd03ee511ebb7f7a1171f0cd59d(), tag.trim());
        }));
      ...
      //styles function
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(RetroCard), "styles", this)), [(0, _litElement.css)(_templateObject3_25349cd03ee511ebb7f7a1171f0cd59d())]);
      }
    }, {
      key: "haxProperties",
      get: function get() {
