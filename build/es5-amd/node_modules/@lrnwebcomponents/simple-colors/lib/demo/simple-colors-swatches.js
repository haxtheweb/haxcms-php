define(["exports", "require", "../../../../lit-element/lit-element.js", "../../simple-colors.js"], function (_exports, _require, _litElement, _simpleColors) {
  ...
  function _templateObject4_b5a39570e0c411ea988d4b7e2b2c0fe2() {
    ...
    _templateObject4_b5a39570e0c411ea988d4b7e2b2c0fe2 = function _templateObject4_b5a39570e0c411ea988d4b7e2b2c0fe2() {
      return data;
    };
  ...
  function _templateObject3_b5a39570e0c411ea988d4b7e2b2c0fe2() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                    <button\n                      id=\"", "\"\n                      controls=\"swatchinfo\"\n                      style=\"background-color: ", ";\"\n                      title=\"", "\"\n                      @click=\"", "\"\n                    >\n                      <div>", "</div>\n                    </button>\n                  "]);

    _templateObject3_b5a39570e0c411ea988d4b7e2b2c0fe2 = function _templateObject3_b5a39570e0c411ea988d4b7e2b2c0fe2() {
      return data;
    };
  ...
  function _templateObject2_b5a39570e0c411ea988d4b7e2b2c0fe2() {
    var data = babelHelpers.taggedTemplateLiteral(["\n              <div class=\"row\">\n                ", "\n              </div>\n            "]);

    _templateObject2_b5a39570e0c411ea988d4b7e2b2c0fe2 = function _templateObject2_b5a39570e0c411ea988d4b7e2b2c0fe2() {
      return data;
    };
  ...
  function _templateObject_b5a39570e0c411ea988d4b7e2b2c0fe2() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <div>\n        <p>Click on the swatches above to learn more.</p>\n        <div class=\"rows\">\n          ", "\n        </div>\n        <simple-modal-template id=\"modal\" title=\"", "\">\n          <p slot=\"content\">\n            <simple-colors-swatch-info\n              swatch-id=\"", "\"\n              swatch-name=\"", "\"\n            >\n            </simple-colors-swatch-info>\n          </p>\n        </simple-modal-template>\n      </div>\n    "]);

    _templateObject_b5a39570e0c411ea988d4b7e2b2c0fe2 = function _templateObject_b5a39570e0c411ea988d4b7e2b2c0fe2() {
      return data;
    };
  ...
  function (_SimpleColors) {
    ...
    babelHelpers.createClass(simpleColorsSwatches, [{
      ...
      value: function render() {
        ...
        return (0, _litElement.html)(_templateObject_b5a39570e0c411ea988d4b7e2b2c0fe2(), Object.keys(this.colors).map(function (color) {
          return (0, _litElement.html)(_templateObject2_b5a39570e0c411ea988d4b7e2b2c0fe2(), _this2.colors.grey.map(function (shade, index) {
            return (0, _litElement.html)(_templateObject3_b5a39570e0c411ea988d4b7e2b2c0fe2(), _this2._getId(color, index), _this2.colors[color][index], _this2._getTitle(color, index), function (e) {
      ...
      key: "styles",
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(simpleColorsSwatches), "styles", this)), [(0, _litElement.css)(_templateObject4_b5a39570e0c411ea988d4b7e2b2c0fe2())]);
      }
    }, {
      key: "properties",
      get: function get() {
