define(["exports", "require", "../../../../lit/index.js", "../../simple-colors.js"], function (_exports, _require, _index, _simpleColors) {
  ...
  var _templateObject_7637ac30cd5f11ec99f033b292664e90, _templateObject2_7637ac30cd5f11ec99f033b292664e90, _templateObject3_7637ac30cd5f11ec99f033b292664e90, _templateObject4_7637ac30cd5f11ec99f033b292664e90;
  ...
  var simpleColorsSwatches = /*#__PURE__*/function (_SimpleColors) {
    ...
    babelHelpers.createClass(simpleColorsSwatches, [{
      ...
      function render() {
        ...
        return (0, _index.html)(_templateObject_7637ac30cd5f11ec99f033b292664e90 || (_templateObject_7637ac30cd5f11ec99f033b292664e90 = babelHelpers.taggedTemplateLiteral(["\n      <div>\n        <p>Click on the swatches above to learn more.</p>\n        <div class=\"rows\">\n          ", "\n        </div>\n        <simple-modal-template id=\"modal\" title=\"", "\">\n          <p slot=\"content\">\n            <simple-colors-swatch-info\n              swatch-id=\"", "\"\n              swatch-name=\"", "\"\n            >\n            </simple-colors-swatch-info>\n          </p>\n        </simple-modal-template>\n      </div>\n    "])), Object.keys(this.colors).map(function (color) {
          return (0, _index.html)(_templateObject2_7637ac30cd5f11ec99f033b292664e90 || (_templateObject2_7637ac30cd5f11ec99f033b292664e90 = babelHelpers.taggedTemplateLiteral(["\n              <div class=\"row\">\n                ", "\n              </div>\n            "])), _this2.colors.grey.map(function (shade, index) {
            return (0, _index.html)(_templateObject3_7637ac30cd5f11ec99f033b292664e90 || (_templateObject3_7637ac30cd5f11ec99f033b292664e90 = babelHelpers.taggedTemplateLiteral(["\n                    <button\n                      id=\"", "\"\n                      controls=\"swatchinfo\"\n                      style=\"background-color: ", ";\"\n                      title=\"", "\"\n                      @click=\"", "\"\n                    >\n                      <div>", "</div>\n                    </button>\n                  "])), _this2._getId(color, index), _this2.colors[color][index], _this2._getTitle(color, index), function (e) {
      ...
      key: "styles",
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(simpleColorsSwatches), "styles", this)), [(0, _index.css)(_templateObject4_7637ac30cd5f11ec99f033b292664e90 || (_templateObject4_7637ac30cd5f11ec99f033b292664e90 = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n          margin: 15px 0;\n        }\n        :host([hidden]) {\n          display: none;\n        }\n        :host simple-modal-template {\n          --simple-modal-titlebar-color: var(--simple-colors-swatch-contrast);\n          --simple-modal-titlebar-background: var(--simple-colors-swatch-color);\n        }\n        :host .row {\n          display: flex;\n          align-items: stretch;\n        }\n        :host button {\n          width: calc(8% - 6px);\n          height: 80px;\n          margin: 3px;\n          border: 1px solid black;\n          border-radius: 3px;\n          padding: 0;\n          display: flex;\n          flex-direction: column;\n          justify-content: flex-end;\n          align-items: stretch;\n        }\n        :host button div {\n          margin: 0;\n          padding: 2px;\n          font-size: 10px;\n          background: black;\n          color: white;\n          width: calc(100% - 4px);\n        }\n        :host button:focus,\n        :host button:hover {\n          opacity: 0.7;\n          cursor: pointer;\n        }\n      "])))]);
      }
    }, {
      key: "properties",
      get: function get() {
