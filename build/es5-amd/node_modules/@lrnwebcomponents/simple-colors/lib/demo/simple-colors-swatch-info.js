define(["exports", "../../../../lit/index.js", "../../simple-colors.js"], function (_exports, _index, _simpleColors) {
  ...
  var _templateObject_0cfa15b0e4f511ed85766367b4d3e9fc, _templateObject2_0cfa15b0e4f511ed85766367b4d3e9fc, _templateObject3_0cfa15b0e4f511ed85766367b4d3e9fc, _templateObject4_0cfa15b0e4f511ed85766367b4d3e9fc, _templateObject5_0cfa15b0e4f511ed85766367b4d3e9fc;
  ...
  var simpleColorsSwatchInfo = /*#__PURE__*/function (_SimpleColors) {
    ...
    babelHelpers.createClass(simpleColorsSwatchInfo, [{
      ...
      key: "styles",
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(simpleColorsSwatchInfo), "styles", this)), [(0, _index.css)(_templateObject5_0cfa15b0e4f511ed85766367b4d3e9fc || (_templateObject5_0cfa15b0e4f511ed85766367b4d3e9fc = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n          margin: 15px 0;\n        }\n        :host([hidden]) {\n          display: none;\n        }\n        :host table {\n          width: 100%;\n          border: 1px solid black;\n          border-radius: 3px;\n          border-collapse: collapse;\n          margin: 0 0 15px;\n        }\n        :host table caption {\n          font-weight: bold;\n          background-color: #222;\n          color: white;\n        }\n        :host table th {\n          background-color: #e0e0e0;\n        }\n        :host table caption,\n        :host table th,\n        :host table td {\n          padding: 5px;\n          border: 1px solid black;\n          text-align: left;\n          line-height: 160%;\n        }\n        :host table td span {\n          padding: 5px;\n          white-space: nowrap;\n          margin: 5px 0;\n        }\n      "])))]);
      }
    }, {
      key: "properties",
      get: function get() {
