define(["exports", "../../../lit-element/lit-element.js", "../simple-colors.js", "../../simple-picker/simple-picker.js"], function (_exports, _litElement, _simpleColors, _simplePicker) {
  ...
  function _templateObject2_cab00f102dd211eba8a9dbdc0fc9b6e0() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: inline-block;\n        }\n        :host([hidden]) {\n          display: none;\n        }\n      "]);

    _templateObject2_cab00f102dd211eba8a9dbdc0fc9b6e0 = function _templateObject2_cab00f102dd211eba8a9dbdc0fc9b6e0() {
      return data;
    };
  ...
  function _templateObject_cab00f102dd211eba8a9dbdc0fc9b6e0() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <simple-picker\n        id=\"picker\"\n        ?block-label=\"", "\"\n        ?disabled=\"", "\"\n        ?expanded=\"", "\"\n        ?hide-option-labels=\"", "\"\n        @change=\"", "\"\n        @collapse=\"", "\"\n        @expand=\"", "\"\n        @option-focus=\"", "\"\n        aria-labelledby=\"", "\"\n        .label=\"", "\"\n        .options=\"", "\"\n        .value=\"", "\"\n      >\n      </simple-picker>\n    "]);

    _templateObject_cab00f102dd211eba8a9dbdc0fc9b6e0 = function _templateObject_cab00f102dd211eba8a9dbdc0fc9b6e0() {
      return data;
    };
  ...
  var SimpleColorsPicker = /*#__PURE__*/function (_SimpleColors) {
    ...
    babelHelpers.createClass(SimpleColorsPicker, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_cab00f102dd211eba8a9dbdc0fc9b6e0(), this.blockLabel, this.disabled, this.expanded, this.shades, this._handleChange, this._handleCollapse, this._handleExpand, this._handleOptionFocus, this.ariaLabelledby, this.label, this.options, this.value);
      }
    }], [{
      key: "styles",
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(SimpleColorsPicker), "styles", this)), [(0, _litElement.css)(_templateObject2_cab00f102dd211eba8a9dbdc0fc9b6e0())]);
      }
    }]);
