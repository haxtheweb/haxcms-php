define(["exports", "meta", "require", "../../simple-fields/simple-fields.js", "./HAXFields.js"], function (_exports, meta, _require, _simpleFields, _HAXFields) {
  ...
  var HAXWiring = /*#__PURE__*/babelHelpers.createClass(function HAXWiring() {
          ...
          case 8:
            ...
            if (props.api == "1") {
              ...
              if (babelHelpers.typeof(props.settings) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {
                ...
                if (babelHelpers.typeof(props.settings.developer) === (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {
                  props.settings.developer = [];
                }
                for (_i2 = 0; _i2 < props.settings.developer.length; _i2++) {
                  props.settings.developer[_i2] = _this.validateSetting(props.settings.developer[_i2]);
                  if (!props.settings.developer[_i2]) {
                    props.settings.developer.splice(_i2, 1);
                  }
                }
    ...
    this.getHaxJSONSchema = function (type, haxProperties) {
      ...
      schema.properties = new _simpleFields.SimpleFields().fieldsToSchema(settings);
