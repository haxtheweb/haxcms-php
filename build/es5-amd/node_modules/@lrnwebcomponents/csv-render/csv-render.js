define(["exports", "require", "../../lit-element/lit-element.js", "../simple-colors/simple-colors.js", "../simple-icon/simple-icon.js", "../simple-icon/lib/simple-icons.js", "../simple-icon/lib/simple-icon-button.js", "../intersection-element/lib/IntersectionObserverMixin.js"], function (_exports, _require, _litElement, _simpleColors, _simpleIcon, _simpleIcons, _simpleIconButton, _IntersectionObserverMixin) {
  ...
  function _templateObject6_bfe6a400247111eb9734a78ef81f0b0d() {
    var data = babelHelpers.taggedTemplateLiteral([" <td>", "</td> "]);

    _templateObject6_bfe6a400247111eb9734a78ef81f0b0d = function _templateObject6_bfe6a400247111eb9734a78ef81f0b0d() {
      return data;
    };
  ...
  function _templateObject5_bfe6a400247111eb9734a78ef81f0b0d() {
    var data = babelHelpers.taggedTemplateLiteral(["\n              <tr>\n                ", "\n              </tr>\n            "]);

    _templateObject5_bfe6a400247111eb9734a78ef81f0b0d = function _templateObject5_bfe6a400247111eb9734a78ef81f0b0d() {
      return data;
    };
  ...
  function _templateObject4_bfe6a400247111eb9734a78ef81f0b0d() {
    var data = babelHelpers.taggedTemplateLiteral([" <th scope=\"col\">", "</th> "]);

    _templateObject4_bfe6a400247111eb9734a78ef81f0b0d = function _templateObject4_bfe6a400247111eb9734a78ef81f0b0d() {
      return data;
    };
  ...
  function _templateObject3_bfe6a400247111eb9734a78ef81f0b0d() {
    var data = babelHelpers.taggedTemplateLiteral(["\n              <caption>\n                ", "\n              </caption>\n            "]);

    _templateObject3_bfe6a400247111eb9734a78ef81f0b0d = function _templateObject3_bfe6a400247111eb9734a78ef81f0b0d() {
      return data;
    };
  ...
  function _templateObject2_bfe6a400247111eb9734a78ef81f0b0d() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <hexagon-loader\n        id=\"loading\"\n        accent-color=\"", "\"\n        ?loading=\"", "\"\n        item-count=\"4\"\n        size=\"small\"\n      ></hexagon-loader>\n      <a href=\"", "\" id=\"download\" tabindex=\"-1\">\n        <simple-icon-button\n          id=\"ficon\"\n          icon=\"file-download\"\n        ></simple-icon-button>\n      </a>\n      <simple-tooltip for=\"ficon\" offset=\"14\" position=\"top\"\n        >Download table data</simple-tooltip\n      >\n      <table class=\"table\" summary=\"", "\">\n        ", "\n        <thead>\n          <tr>\n            ", "\n          </tr>\n        </thead>\n        <tbody>\n          ", "\n        </tbody>\n      </table>\n    "]);

    _templateObject2_bfe6a400247111eb9734a78ef81f0b0d = function _templateObject2_bfe6a400247111eb9734a78ef81f0b0d() {
      return data;
    };
  ...
  function _templateObject_bfe6a400247111eb9734a78ef81f0b0d() {
    ...
    _templateObject_bfe6a400247111eb9734a78ef81f0b0d = function _templateObject_bfe6a400247111eb9734a78ef81f0b0d() {
      return data;
    };
  ...
  var CsvRender = /*#__PURE__*/function (_IntersectionObserver) {
    ...
    babelHelpers.createClass(CsvRender, null, [{
       ...
       */
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(CsvRender), "styles", this)), [(0, _litElement.css)(_templateObject_bfe6a400247111eb9734a78ef81f0b0d())]);
      }
      /**
       * HTMLElement
       */
    ...
    babelHelpers.createClass(CsvRender, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_bfe6a400247111eb9734a78ef81f0b0d(), this.accentColor, this.loading, this.dataSource, this.summary, this.caption ? (0, _litElement.html)(_templateObject3_bfe6a400247111eb9734a78ef81f0b0d(), this.caption) : "", this.tableHeadings.map(function (heading) {
          return (0, _litElement.html)(_templateObject4_bfe6a400247111eb9734a78ef81f0b0d(), heading);
        }), this.table.map(function (row) {
          return (0, _litElement.html)(_templateObject5_bfe6a400247111eb9734a78ef81f0b0d(), row.map(function (col) {
            return (0, _litElement.html)(_templateObject6_bfe6a400247111eb9734a78ef81f0b0d(), col);
          }));
        }));
      }
    }, {
