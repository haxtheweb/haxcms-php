define(["exports", "require", "../../lit-element/lit-element.js", "../simple-colors/simple-colors.js"], function (_exports, _require, _litElement, _simpleColors) {
  ...
  function _templateObject6_faaae9105a5b11ea9b0bfd873cbf79fd() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                    <td>", "</td>\n                  "]);

    _templateObject6_faaae9105a5b11ea9b0bfd873cbf79fd = function _templateObject6_faaae9105a5b11ea9b0bfd873cbf79fd() {
      return data;
    };
  ...
  function _templateObject5_faaae9105a5b11ea9b0bfd873cbf79fd() {
    var data = babelHelpers.taggedTemplateLiteral(["\n              <tr>\n                ", "\n              </tr>\n            "]);

    _templateObject5_faaae9105a5b11ea9b0bfd873cbf79fd = function _templateObject5_faaae9105a5b11ea9b0bfd873cbf79fd() {
      return data;
    };
  ...
  function _templateObject4_faaae9105a5b11ea9b0bfd873cbf79fd() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                  <th scope=\"col\">", "</th>\n                "]);

    _templateObject4_faaae9105a5b11ea9b0bfd873cbf79fd = function _templateObject4_faaae9105a5b11ea9b0bfd873cbf79fd() {
      return data;
    };
  ...
  function _templateObject3_faaae9105a5b11ea9b0bfd873cbf79fd() {
    var data = babelHelpers.taggedTemplateLiteral(["\n              <caption>\n                ", "\n              </caption>\n            "]);

    _templateObject3_faaae9105a5b11ea9b0bfd873cbf79fd = function _templateObject3_faaae9105a5b11ea9b0bfd873cbf79fd() {
      return data;
    };
  ...
  function _templateObject2_faaae9105a5b11ea9b0bfd873cbf79fd() {
    ...
    _templateObject2_faaae9105a5b11ea9b0bfd873cbf79fd = function _templateObject2_faaae9105a5b11ea9b0bfd873cbf79fd() {
      return data;
    };
  ...
  function _templateObject_faaae9105a5b11ea9b0bfd873cbf79fd() {
    ...
    _templateObject_faaae9105a5b11ea9b0bfd873cbf79fd = function _templateObject_faaae9105a5b11ea9b0bfd873cbf79fd() {
      return data;
    };
  ...
  function (_SimpleColors) {
    ...
    babelHelpers.createClass(CsvRender, null, [{
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject_faaae9105a5b11ea9b0bfd873cbf79fd())];
      }
      /**
       * HTMLElement
       */
    ...
    babelHelpers.createClass(CsvRender, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_faaae9105a5b11ea9b0bfd873cbf79fd(), this.dataSource, this.tableDataChanged, this.handleResponse, this.accentColor, this.dataSource, this.summary, this.caption ? (0, _litElement.html)(_templateObject3_faaae9105a5b11ea9b0bfd873cbf79fd(), this.caption) : "", this.tableHeadings.map(function (heading) {
          return (0, _litElement.html)(_templateObject4_faaae9105a5b11ea9b0bfd873cbf79fd(), heading);
        }), this.table.map(function (row) {
          return (0, _litElement.html)(_templateObject5_faaae9105a5b11ea9b0bfd873cbf79fd(), row.map(function (col) {
            return (0, _litElement.html)(_templateObject6_faaae9105a5b11ea9b0bfd873cbf79fd(), col);
          }));
        }));
      }
    }, {
