define(["exports", "require", "../../lit-element/lit-element.js", "../simple-colors/simple-colors.js"], function (_exports, _require, _litElement, _simpleColors) {
  ...
  function _templateObject6_2be7d3b00ca211eaa0151532aa92855f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                    <td>", "</td>\n                  "]);

    _templateObject6_2be7d3b00ca211eaa0151532aa92855f = function _templateObject6_2be7d3b00ca211eaa0151532aa92855f() {
      return data;
    };
  ...
  function _templateObject5_2be7d3b00ca211eaa0151532aa92855f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n              <tr>\n                ", "\n              </tr>\n            "]);

    _templateObject5_2be7d3b00ca211eaa0151532aa92855f = function _templateObject5_2be7d3b00ca211eaa0151532aa92855f() {
      return data;
    };
  ...
  function _templateObject4_2be7d3b00ca211eaa0151532aa92855f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                  <th scope=\"col\">", "</th>\n                "]);

    _templateObject4_2be7d3b00ca211eaa0151532aa92855f = function _templateObject4_2be7d3b00ca211eaa0151532aa92855f() {
      return data;
    };
  ...
  function _templateObject3_2be7d3b00ca211eaa0151532aa92855f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n              <caption>\n                ", "\n              </caption>\n            "]);

    _templateObject3_2be7d3b00ca211eaa0151532aa92855f = function _templateObject3_2be7d3b00ca211eaa0151532aa92855f() {
      return data;
    };
  ...
  function _templateObject2_2be7d3b00ca211eaa0151532aa92855f() {
    ...
    _templateObject2_2be7d3b00ca211eaa0151532aa92855f = function _templateObject2_2be7d3b00ca211eaa0151532aa92855f() {
      return data;
    };
  ...
  function _templateObject_2be7d3b00ca211eaa0151532aa92855f() {
    ...
    _templateObject_2be7d3b00ca211eaa0151532aa92855f = function _templateObject_2be7d3b00ca211eaa0151532aa92855f() {
      return data;
    };
  ...
  function (_SimpleColors) {
    ...
    babelHelpers.createClass(CsvRender, null, [{
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject_2be7d3b00ca211eaa0151532aa92855f())];
      }
      /**
       * HTMLElement
       */
    ...
    babelHelpers.createClass(CsvRender, [{
      ...
      value: function render() {
        ...
        return (0, _litElement.html)(_templateObject2_2be7d3b00ca211eaa0151532aa92855f(), this.dataSource, this.tableDataChanged, this.handleResponse, this.accentColor, this.dataSource, this.summary, this.caption ? (0, _litElement.html)(_templateObject3_2be7d3b00ca211eaa0151532aa92855f(), this.caption) : "", this.tableHeadings.map(function (heading) {
          return (0, _litElement.html)(_templateObject4_2be7d3b00ca211eaa0151532aa92855f(), _this3.heading);
        }), this.table.map(function (row) {
          return (0, _litElement.html)(_templateObject5_2be7d3b00ca211eaa0151532aa92855f(), row.map(function (col) {
            return (0, _litElement.html)(_templateObject6_2be7d3b00ca211eaa0151532aa92855f(), col);
          }));
        }));
      }
    }, {
