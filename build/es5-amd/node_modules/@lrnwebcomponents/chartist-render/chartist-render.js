define(["exports","meta","../../@polymer/polymer/polymer-element.js","../../@polymer/polymer/lib/utils/resolve-url.js","../es-global-bridge/es-global-bridge.js","./lib/chartist-render-shared-styles.js"],function(_exports,meta,_polymerElement,_resolveUrl,_esGlobalBridge,_chartistRenderSharedStyles){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.ChartistRender=void 0;meta=babelHelpers.interopRequireWildcard(meta);function _templateObject_cb1be92075c211e99fd5555145028221(){var data=babelHelpers.taggedTemplateLiteral(["\n      <style include=\"chartist-render-shared-styles\">\n        :host {\n          display: block;\n        }\n      </style>\n      <div id=\"chart\" chart$=\"[[__chartId]]\" class$=\"ct-chart [[scale]]\"></div>\n    "]);_templateObject_cb1be92075c211e99fd5555145028221=function _templateObject_cb1be92075c211e99fd5555145028221(){return data};return data}/**
 * `chartist-render`
...
get:function get(){return(0,_polymerElement.html)(_templateObject_cb1be92075c211e99fd5555145028221())}// properties available to the custom element for data binding
