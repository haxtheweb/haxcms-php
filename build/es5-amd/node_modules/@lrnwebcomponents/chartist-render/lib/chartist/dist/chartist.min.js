  ...
  return function (a, b, c) {
    ...
    c.namespaces = {
      ...
      for (a = a || {}, b = 1; b < arguments.length; b++) {
        d = arguments[b];
        for (var f in d) e = d[f], "object" != babelHelpers.typeof(e) || null === e || babelHelpers.instanceof(e, Array) ? a[f] = e : a[f] = c.extend(a[f], e);
      }
      return a;
      ...
      for (var b = 0; b < a.series.length; b++) "object" == babelHelpers.typeof(a.series[b]) && void 0 !== a.series[b].data ? a.series[b].data.reverse() : babelHelpers.instanceof(a.series[b], Array) && a.series[b].reverse();
      ...
      function e(a) {
        if (void 0 !== a) if (babelHelpers.instanceof(a, Array)) for (var b = 0; b < a.length; b++) e(a[b]);else {
          var c = d ? +a[d] : +a;
