 ...
 *  -
 */var LrnsysOutline=(0,_polymerLegacy.Polymer)((_Polymer={_template:(0,_polymerLegacy.html)(_templateObject_ad3d5ea068f411e996b0af119cd7f5ea()),is:"lrnsys-outline",listeners:(_listeners={"delete-item":"_handleRemoveItem","indent-item":"_handleIndentItem","focus-item":"_handleFocusItem","add-item":"_handleAddItem","move-item":"_handleMoveItem","change-item":"_handleChangeItem"},babelHelpers.defineProperty(_listeners,"focus-item","_handleFocusItem"),babelHelpers.defineProperty(_listeners,"blur-item","_handleBlurItem"),_listeners),properties:{data:{type:Array,value:null},items:{type:Array,value:null,notify:!0},activeItem:{type:Object,notify:!0}},/**
   * Display directions for keyboard usage
   */openDirections:function openDirections(e){this.$.modal.opened=!0},/**
   * Display directions for keyboard usage
   */closeDirections:function closeDirections(e){var _this=this;this.$.modal.opened=!1;async.microTask.run(function(){setTimeout(function(){_this.$.dialogtrigger.focus()},50)})},/**
   * Attached lifecycle
   */attached:function attached(){window.SimpleModal.requestAvailability();this.__modal=this.$.modal;document.body.addEventListener("iron-overlay-canceled",this._accessibleFocus.bind(this));// fix stack order
document.body.appendChild(this.$.modal)},/**
   * Set ourselves as having focus after the modal closes.
   */_accessibleFocus:function _accessibleFocus(e){var _this2=this;// this is OUR modal, we found her, oh modal, We've missed
