...
*/(0,_polymerLegacy.Polymer)({_template:(0,_polymerLegacy.html)(_templateObject_1d8f67c066fc11e984d945fe2fe0aa60()),is:"lrnsys-outline-item",listeners:{change:"_onChange"},properties:{indentLevel:{type:Number,value:0},index:{type:Number,value:0},parent:{type:String,value:null},title:{type:String,value:null,notify:!0/* transition */ /* transition */,reflectToAttribute:!0},/**
     * Tracks if focus state is applied
     */focusState:{type:Boolean,value:!1,reflectToAttribute:!0}},_focusin:function _focusin(e){this.focusState=!0},_focusout:function _focusout(e){this.focusState=!1},/**
   * attached life cycle
   */attached:function attached(){this.fire("attached-item",{item:this})},/**
   * ready life cycle
   */ready:function ready(){var _this=this;this.__inputTarget=this.$.input;this.fire("focus-item",this);this.addEventListener("focus",function(e){_this.fire("focus-item",_this)});this.addEventListener("mouseover",function(e){_this.fire("focus-item",_this)});this.addEventListener("blur",function(e){_this.fire("blur-item",_this)});this.addEventListener("mouseout",function(e){_this.fire("blur-item",_this)});this.$.input.addEventListener("focused-changed",this._focusin.bind(this));this.addEventListener("focusin",this._focusin.bind(this));this.addEventListener("focusout",this._focusout.bind(this))},/**
   * detached life cycle
   */detached:function detached(){var _this2=this;this.removeEventListener("focus",function(e){_this2.fire("focus-item",_this2)});this.removeEventListener("mouseover",function(e){_this2.fire("focus-item",_this2)});this.removeEventListener("blur",function(e){_this2.fire("blur-item",_this2)});this.removeEventListener("mouseout",function(e){_this2.fire("blur-item",_this2)});this.$.input.removeEventListener("focused-changed",this._focusin.bind(this));this.removeEventListener("focusin",this._focusin.bind(this));this.removeEventListener("focusout",this._focusout.bind(this))},focus:function focus(){this.$.input.focus();return this},value:function value(){this.title=this.$.input.value;return this.title},delete:function _delete(){this.fire("delete-item",{item:this})},setIndent:function setIndent(amount){this.fire("indent-item",{item:this,increase:0<amount})},add:function add(){var i=this.$.input.shadowRoot.querySelector("#"+this.$.input._inputId).inputElement.selectionStart,j=this.title;this.fire("add-item",{item:this,value:j.slice(0,i),new:j.slice(i,j.length)});this.title=j.slice(0,i)},move:function move(amount){this.fire("move-item",{item:this,moveUp:0>amount})},moveUp:function moveUp(e){this.move(-1)},moveDown:function moveDown(e){this.move(1)},moveOut:function moveOut(e){this.setIndent(-1)},moveIn:function moveIn(e){this.setIndent(1)},setSelection:function setSelection(start,end){var s=start!==void 0?start:0,n=end!==void 0?end:s;try{this.$.input.querySelector("input").setSelectionRange(s,n)}catch(e){console.log(e)}this.focus()},_onChange:function _onChange(){this.fire("change-item",{item:this,value:this.title})},_onEsc:function _onEsc(){this.focus();this._focusout()},_onEnter:function _onEnter(){var i=this.$.input.shadowRoot.querySelector("#"+this.$.input._inputId).inputElement.selectionStart,j=this.title;this.fire("add-item",{item:this,value:j.slice(0,i),new:j.slice(i,j.length)});this.title=j.slice(0,i);this._focusout()},_onBackspace:function _onBackspace(e){if(this._getSelection().toString()==this.title){e.detail.keyboardEvent.preventDefault();this.fire("delete-item",{item:this})}else if(0==this.$.input.shadowRoot.querySelector("#"+this.$.input._inputId).inputElement.selectionStart){this.fire("indent-item",{item:this,increase:!1})}},/**
   * Selection normalizer
   */_getSelection:function _getSelection(){// try and obtain the selection from the nearest shadow
