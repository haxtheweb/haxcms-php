...
value:function render(){var _this2=this;return(0,_litElement.html)(_templateObject_7294fcf0761c11ea91ce2d62f2e9789f(),this.iconClass,this.tabs.map(function(tab,i){return(0,_litElement.html)(_templateObject2_7294fcf0761c11ea91ce2d62f2e9789f(),_this2._tabButton(tab))}))}// haxProperty definition
}],[{key:"styles",//styles function
get:function get(){return[(0,_litElement.css)(_templateObject3_7294fcf0761c11ea91ce2d62f2e9789f())]}},{key:"haxProperties",get:function get(){return{}}// properties available to the custom element for data binding
   ...
   * @returns object
   * @memberof A11yTabs
   */},{key:"_tabButton",value:function _tabButton(tab){var _this6=this;return(0,_litElement.html)(_templateObject4_7294fcf0761c11ea91ce2d62f2e9789f(),tab.id,tab.id,tab.id===this.activeTab?"active":"",function(e){return _this6._handleTab(tab)},tab.id===this.activeTab||tab.disabled,tab.flag,this._tabIcon(tab,"flagIcon"),this._tabLabel(tab),this._tabFlag(tab),this._tabIcon(tab,"icon"),this._tabTooltip(tab))}/**
   * makes tab flag
   *
   * @param {string} flag tab's flag
   * @returns object
   * @memberof A11yTabs
   */},{key:"_tabFlag",value:function _tabFlag(tab){return(0,_litElement.html)(_templateObject5_7294fcf0761c11ea91ce2d62f2e9789f(),!tab.flag,tab.flag)}/**
   * makes tab icon
   *
   * @param {string} icon tab's icon
   * @returns object
   * @memberof A11yTabs
   */},{key:"_tabIcon",value:function _tabIcon(tab,icon){return(0,_litElement.html)(_templateObject6_7294fcf0761c11ea91ce2d62f2e9789f(),!tab[icon],tab[icon])}/**
   * makes tab label
   *
   * @param {string} flag tab's flag
   * @returns object
   * @memberof A11yTabs
   */},{key:"_tabLabel",value:function _tabLabel(tab){return(0,_litElement.html)(_templateObject7_7294fcf0761c11ea91ce2d62f2e9789f(),tab.label)}/**
   * makes tab tooltip
   *
   ...
   * @returns object
   * @memberof A11yTabs
   */},{key:"_tabTooltip",value:function _tabTooltip(tab){return(0,_litElement.html)(_templateObject8_7294fcf0761c11ea91ce2d62f2e9789f(),tab.id,tab.label)}/**
