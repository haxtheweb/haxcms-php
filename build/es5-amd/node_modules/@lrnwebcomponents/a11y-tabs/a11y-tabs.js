define(["exports", "../../lit-element/lit-element.js", "../responsive-utility/lib/responsive-utility-behaviors.js", "../simple-icon/lib/simple-icon-lite.js", "../simple-icon/lib/simple-icons.js", "../simple-tooltip/simple-tooltip.js", "./lib/a11y-tab.js"], function (_exports, _litElement, _responsiveUtilityBehaviors, _simpleIconLite, _simpleIcons, _simpleTooltip, _a11yTab) {
  ...
  function _templateObject9_a78d9cf02dd211eba8a9dbdc0fc9b6e0() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <simple-tooltip for=\"", "-button\"> ", " </simple-tooltip>\n    "]);

    _templateObject9_a78d9cf02dd211eba8a9dbdc0fc9b6e0 = function _templateObject9_a78d9cf02dd211eba8a9dbdc0fc9b6e0() {
      return data;
    };
  ...
  function _templateObject8_a78d9cf02dd211eba8a9dbdc0fc9b6e0() {
    var data = babelHelpers.taggedTemplateLiteral([" <span class=\"label\">", "</span> "]);

    _templateObject8_a78d9cf02dd211eba8a9dbdc0fc9b6e0 = function _templateObject8_a78d9cf02dd211eba8a9dbdc0fc9b6e0() {
      return data;
    };
  ...
  function _templateObject7_a78d9cf02dd211eba8a9dbdc0fc9b6e0() {
    var data = babelHelpers.taggedTemplateLiteral(["\n          <simple-icon-lite\n            class=\"icon\"\n            ?hidden=\"", "\"\n            .icon=\"", "\"\n          >\n          </simple-icon-lite>\n        "]);

    _templateObject7_a78d9cf02dd211eba8a9dbdc0fc9b6e0 = function _templateObject7_a78d9cf02dd211eba8a9dbdc0fc9b6e0() {
      return data;
    };
  ...
  function _templateObject6_a78d9cf02dd211eba8a9dbdc0fc9b6e0() {
    var data = babelHelpers.taggedTemplateLiteral(["\n          <simple-icon-lite\n            class=\"icon\"\n            ?hidden=\"", "\"\n            .icon=\"", "\"\n            .title=\"", "\"\n          >\n          </simple-icon-lite>\n        "]);

    _templateObject6_a78d9cf02dd211eba8a9dbdc0fc9b6e0 = function _templateObject6_a78d9cf02dd211eba8a9dbdc0fc9b6e0() {
      return data;
    };
  ...
  function _templateObject5_a78d9cf02dd211eba8a9dbdc0fc9b6e0() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <span class=\"flag-type\" ?hidden=\"", "\"> ", " </span>\n    "]);

    _templateObject5_a78d9cf02dd211eba8a9dbdc0fc9b6e0 = function _templateObject5_a78d9cf02dd211eba8a9dbdc0fc9b6e0() {
      return data;
    };
  ...
  function _templateObject4_a78d9cf02dd211eba8a9dbdc0fc9b6e0() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <button\n        id=\"", "-button\"\n        aria-selected=\"", "\"\n        aria-controls=\"", "\"\n        class=\"", "\"\n        .flag=\"", "\"\n        @click=\"", "\"\n        @keydown=\"", "\"\n        ?disabled=\"", "\"\n        tabindex=\"", "\"\n        role=\"tab\"\n      >\n        ", " ", "\n        ", " ", "\n      </button>\n      ", "\n    "]);

    _templateObject4_a78d9cf02dd211eba8a9dbdc0fc9b6e0 = function _templateObject4_a78d9cf02dd211eba8a9dbdc0fc9b6e0() {
      return data;
    };
  ...
  function _templateObject3_a78d9cf02dd211eba8a9dbdc0fc9b6e0() {
    ...
    _templateObject3_a78d9cf02dd211eba8a9dbdc0fc9b6e0 = function _templateObject3_a78d9cf02dd211eba8a9dbdc0fc9b6e0() {
      return data;
    };
  ...
  function _templateObject2_a78d9cf02dd211eba8a9dbdc0fc9b6e0() {
    var data = babelHelpers.taggedTemplateLiteral([" <li>", "</li> "]);

    _templateObject2_a78d9cf02dd211eba8a9dbdc0fc9b6e0 = function _templateObject2_a78d9cf02dd211eba8a9dbdc0fc9b6e0() {
      return data;
    };
  ...
  function _templateObject_a78d9cf02dd211eba8a9dbdc0fc9b6e0() {
    var data = babelHelpers.taggedTemplateLiteral([" <ul id=\"tabs\" role=\"tablist\">\n        ", "\n      </ul>\n      <div id=\"content\">\n        <slot></slot>\n      </div>"]);

    _templateObject_a78d9cf02dd211eba8a9dbdc0fc9b6e0 = function _templateObject_a78d9cf02dd211eba8a9dbdc0fc9b6e0() {
      return data;
    };
  ...
  var A11yTabs = /*#__PURE__*/function (_ResponsiveUtilityBeh) {
    ...
    babelHelpers.createClass(A11yTabs, [{
      ...
      value: function render() {
        ...
        return (0, _litElement.html)(_templateObject_a78d9cf02dd211eba8a9dbdc0fc9b6e0(), this.tabs.map(function (tab, i) {
          return (0, _litElement.html)(_templateObject2_a78d9cf02dd211eba8a9dbdc0fc9b6e0(), _this2._tabButton(tab, i));
        }));
      ...
      //styles function
      get: function get() {
        return [(0, _litElement.css)(_templateObject3_a78d9cf02dd211eba8a9dbdc0fc9b6e0())];
      }
    }, {
      key: "haxProperties",
      get: function get() {
    ...
    babelHelpers.createClass(A11yTabs, [{
      ...
      value: function _tabButton(tab, i) {
        ...
        return (0, _litElement.html)(_templateObject4_a78d9cf02dd211eba8a9dbdc0fc9b6e0(), tab.id, tab.id === this.activeTab ? "true" : "false", tab.id, tab.id === this.activeTab && !this.disabled ? "active" : "", tab.flag, function (e) {
      ...
      value: function _tabFlag(tab) {
        return (0, _litElement.html)(_templateObject5_a78d9cf02dd211eba8a9dbdc0fc9b6e0(), !tab.flag, tab.flag);
      }
      /**
       * makes tab icon
       *
      ...
      value: function _tabIcon(tab, icon) {
        return tab.flag ? (0, _litElement.html)(_templateObject6_a78d9cf02dd211eba8a9dbdc0fc9b6e0(), !tab[icon], tab[icon], tab.flag) : (0, _litElement.html)(_templateObject7_a78d9cf02dd211eba8a9dbdc0fc9b6e0(), !tab[icon], tab[icon]);
      }
      /**
       * makes tab label
       *
      ...
      value: function _tabLabel(tab) {
        return (0, _litElement.html)(_templateObject8_a78d9cf02dd211eba8a9dbdc0fc9b6e0(), tab.label);
      }
      /**
       * makes tab tooltip
       *
      ...
      value: function _tabTooltip(tab) {
        return (0, _litElement.html)(_templateObject9_a78d9cf02dd211eba8a9dbdc0fc9b6e0(), tab.id, tab.label);
      }
    }, {
      key: "buttons",
      get: function get() {
