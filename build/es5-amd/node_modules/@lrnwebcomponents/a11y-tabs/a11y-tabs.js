define(["exports", "../../lit-element/lit-element.js", "../responsive-utility/lib/responsive-utility-behaviors.js", "../simple-icon/lib/simple-icon-lite.js", "../simple-icon/lib/simple-icons.js", "../simple-tooltip/simple-tooltip.js", "./lib/a11y-tab.js"], function (_exports, _litElement, _responsiveUtilityBehaviors, _simpleIconLite, _simpleIcons, _simpleTooltip, _a11yTab) {
  ...
  var _templateObject_5f0fb4a0af6311ebbe560fe9c4727db1, _templateObject2_5f0fb4a0af6311ebbe560fe9c4727db1, _templateObject3_5f0fb4a0af6311ebbe560fe9c4727db1, _templateObject4_5f0fb4a0af6311ebbe560fe9c4727db1, _templateObject5_5f0fb4a0af6311ebbe560fe9c4727db1, _templateObject6_5f0fb4a0af6311ebbe560fe9c4727db1, _templateObject7_5f0fb4a0af6311ebbe560fe9c4727db1, _templateObject8_5f0fb4a0af6311ebbe560fe9c4727db1, _templateObject9_5f0fb4a0af6311ebbe560fe9c4727db1, _templateObject10_5f0fb4a0af6311ebbe560fe9c4727db1;
  ...
  var A11yTabs = /*#__PURE__*/function (_ResponsiveUtilityBeh) {
    ...
    babelHelpers.createClass(A11yTabs, [{
      ...
      function render() {
        ...
        return (0, _litElement.html)(_templateObject_5f0fb4a0af6311ebbe560fe9c4727db1 || (_templateObject_5f0fb4a0af6311ebbe560fe9c4727db1 = babelHelpers.taggedTemplateLiteral([" <ul id=\"tabs\" role=\"tablist\" part=\"tablist\">\n        ", "\n      </ul>\n      <div id=\"content\" part=\"content\">\n        <slot></slot>\n      </div>"])), this.tabs.map(function (tab, i) {
          return (0, _litElement.html)(_templateObject2_5f0fb4a0af6311ebbe560fe9c4727db1 || (_templateObject2_5f0fb4a0af6311ebbe560fe9c4727db1 = babelHelpers.taggedTemplateLiteral(["\n            <li part=\"tablist-item\">", "</li>\n          "])), _this2._tabButton(tab, i));
        }));
      ...
      value: function _handleKey(i, e) {
        ...
        var focus = function focus() {
          ...
          _this6.__tabFocus = _this6.__tabFocus + dir; // If we're at the end, go to the start

          if (_this6.__tabFocus >= _this6.buttons.length) {
            _this6.__tabFocus = 0; // If we're at the start, move to the end
          } else if (_this6.__tabFocus < 0) {
            _this6.__tabFocus = _this6.buttons.length - 1;
          }

          if (_this6.buttons[_this6.__tabFocus].disabled && _this6.__tabFocus !== i) focus(dir);
        }; // Move right
      ...
      value: function _tabButton(tab, i) {
        ...
        return (0, _litElement.html)(_templateObject3_5f0fb4a0af6311ebbe560fe9c4727db1 || (_templateObject3_5f0fb4a0af6311ebbe560fe9c4727db1 = babelHelpers.taggedTemplateLiteral(["\n      <button\n        id=\"", "-button\"\n        aria-selected=\"", "\"\n        aria-controls=\"", "\"\n        class=\"", "\"\n        .flag=\"", "\"\n        @click=\"", "\"\n        @keydown=\"", "\"\n        ?disabled=\"", "\"\n        tabindex=\"", "\"\n        role=\"tab\"\n        part=\"", "\"\n      >\n        ", " ", "\n        ", " ", "\n      </button>\n      ", "\n    "])), tab.id, tab.id === this.activeTab ? "true" : "false", tab.id, tab.id === this.activeTab && !this.disabled ? "active" : "", tab.flag, function (e) {
          return _this7._handleTab(tab);
        }, function (e) {
          return _this7._handleKey(i, e);
      ...
      value: function _tabFlag(tab) {
        return (0, _litElement.html)(_templateObject4_5f0fb4a0af6311ebbe560fe9c4727db1 || (_templateObject4_5f0fb4a0af6311ebbe560fe9c4727db1 = babelHelpers.taggedTemplateLiteral(["\n      <span class=\"flag-type\" ?hidden=\"", "\" part=\"flag\">\n        ", "\n      </span>\n    "])), !tab.flag, tab.flag);
      }
      /**
       * makes tab icon
       *
      ...
      value: function _tabIcon(tab, icon) {
        return tab.flag ? (0, _litElement.html)(_templateObject5_5f0fb4a0af6311ebbe560fe9c4727db1 || (_templateObject5_5f0fb4a0af6311ebbe560fe9c4727db1 = babelHelpers.taggedTemplateLiteral(["\n          <simple-icon-lite\n            class=\"icon\"\n            ?hidden=\"", "\"\n            .icon=\"", "\"\n            .title=\"", "\"\n            part=\"icon\"\n          >\n          </simple-icon-lite>\n        "])), !tab[icon], tab[icon], tab.flag) : (0, _litElement.html)(_templateObject6_5f0fb4a0af6311ebbe560fe9c4727db1 || (_templateObject6_5f0fb4a0af6311ebbe560fe9c4727db1 = babelHelpers.taggedTemplateLiteral(["\n          <simple-icon-lite\n            class=\"icon\"\n            ?hidden=\"", "\"\n            .icon=\"", "\"\n            part=\"icon\"\n          >\n          </simple-icon-lite>\n        "])), !tab[icon], tab[icon]);
      }
      /**
       * makes tab label
       *
      ...
      value: function _tabLabel(tab) {
        return (0, _litElement.html)(_templateObject7_5f0fb4a0af6311ebbe560fe9c4727db1 || (_templateObject7_5f0fb4a0af6311ebbe560fe9c4727db1 = babelHelpers.taggedTemplateLiteral([" <span class=\"label\" part=\"label\">", "</span> "])), tab.label);
      }
      /**
       * makes tab tooltip
       *
