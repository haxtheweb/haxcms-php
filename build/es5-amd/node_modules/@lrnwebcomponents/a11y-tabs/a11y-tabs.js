define(["exports", "../../lit-element/lit-element.js", "../responsive-utility/lib/responsive-utility-behaviors.js", "../../@polymer/paper-button/paper-button.js", "../../@polymer/iron-icons/iron-icons.js", "../simple-tooltip/simple-tooltip.js", "./lib/a11y-tab.js"], function (_exports, _litElement, _responsiveUtilityBehaviors, _paperButton, _ironIcons, _simpleTooltip, _a11yTab) {
  ...
  function _templateObject8_6db949c0bbd111eaab461bc64f8f74eb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <simple-tooltip for=\"", "-button\">\n        ", "\n      </simple-tooltip>\n    "]);

    _templateObject8_6db949c0bbd111eaab461bc64f8f74eb = function _templateObject8_6db949c0bbd111eaab461bc64f8f74eb() {
      return data;
    };
  ...
  function _templateObject7_6db949c0bbd111eaab461bc64f8f74eb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <span class=\"label\">", "</span>\n    "]);

    _templateObject7_6db949c0bbd111eaab461bc64f8f74eb = function _templateObject7_6db949c0bbd111eaab461bc64f8f74eb() {
      return data;
    };
  ...
  function _templateObject6_6db949c0bbd111eaab461bc64f8f74eb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <iron-icon\n        class=\"icon\"\n        ?hidden=\"", "\"\n        .icon=\"", "\"\n        .title=\"", "\"\n      >\n      </iron-icon>\n    "]);

    _templateObject6_6db949c0bbd111eaab461bc64f8f74eb = function _templateObject6_6db949c0bbd111eaab461bc64f8f74eb() {
      return data;
    };
  ...
  function _templateObject5_6db949c0bbd111eaab461bc64f8f74eb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <span class=\"flag-type\" ?hidden=\"", "\">\n        ", "\n      </span>\n    "]);

    _templateObject5_6db949c0bbd111eaab461bc64f8f74eb = function _templateObject5_6db949c0bbd111eaab461bc64f8f74eb() {
      return data;
    };
  ...
  function _templateObject4_6db949c0bbd111eaab461bc64f8f74eb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <paper-button\n        id=\"", "-button\"\n        controls=\"", "\"\n        class=\"", "\"\n        @click=\"", "\"\n        ?disabled=\"", "\"\n        .flag=\"", "\"\n      >\n        ", " ", "\n        ", " ", "\n      </paper-button>\n      ", "\n    "]);

    _templateObject4_6db949c0bbd111eaab461bc64f8f74eb = function _templateObject4_6db949c0bbd111eaab461bc64f8f74eb() {
      return data;
    };
  ...
  function _templateObject3_6db949c0bbd111eaab461bc64f8f74eb() {
    ...
    _templateObject3_6db949c0bbd111eaab461bc64f8f74eb = function _templateObject3_6db949c0bbd111eaab461bc64f8f74eb() {
      return data;
    };
  ...
  function _templateObject2_6db949c0bbd111eaab461bc64f8f74eb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n    <li>", "</li>\n  "]);

    _templateObject2_6db949c0bbd111eaab461bc64f8f74eb = function _templateObject2_6db949c0bbd111eaab461bc64f8f74eb() {
      return data;
    };
  ...
  function _templateObject_6db949c0bbd111eaab461bc64f8f74eb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n\n<ul id=\"tabs\">\n  ", "\n</ul>\n<div id=\"content\">\n  <slot></slot>\n</div>"]);

    _templateObject_6db949c0bbd111eaab461bc64f8f74eb = function _templateObject_6db949c0bbd111eaab461bc64f8f74eb() {
      return data;
    };
  ...
  function (_ResponsiveUtilityBeh) {
    ...
    babelHelpers.createClass(A11yTabs, [{
      ...
      value: function render() {
        ...
        return (0, _litElement.html)(_templateObject_6db949c0bbd111eaab461bc64f8f74eb(), this.tabs.map(function (tab, i) {
          return (0, _litElement.html)(_templateObject2_6db949c0bbd111eaab461bc64f8f74eb(), _this2._tabButton(tab));
        }));
      ...
      //styles function
      get: function get() {
        return [(0, _litElement.css)(_templateObject3_6db949c0bbd111eaab461bc64f8f74eb())];
      }
    }, {
      key: "haxProperties",
      get: function get() {
    ...
    babelHelpers.createClass(A11yTabs, [{
      ...
      value: function _tabButton(tab) {
        ...
        return (0, _litElement.html)(_templateObject4_6db949c0bbd111eaab461bc64f8f74eb(), tab.id, tab.id, tab.id === this.activeTab && !this.disabled ? "active" : "", function (e) {
      ...
      value: function _tabFlag(tab) {
        return (0, _litElement.html)(_templateObject5_6db949c0bbd111eaab461bc64f8f74eb(), !tab.flag, tab.flag);
      }
      /**
       * makes tab icon
       *
      ...
      value: function _tabIcon(tab, icon) {
        return (0, _litElement.html)(_templateObject6_6db949c0bbd111eaab461bc64f8f74eb(), !tab[icon], tab[icon], tab[flag]);
      }
      /**
       * makes tab label
       *
      ...
      value: function _tabLabel(tab) {
        return (0, _litElement.html)(_templateObject7_6db949c0bbd111eaab461bc64f8f74eb(), tab.label);
      }
      /**
       * makes tab tooltip
       *
      ...
      value: function _tabTooltip(tab) {
        return (0, _litElement.html)(_templateObject8_6db949c0bbd111eaab461bc64f8f74eb(), tab.id, tab.label);
      }
    }, {
      key: "iconsOnly",
      get: function get() {
