...
value:function render(){var _this2=this;return(0,_litElement.html)(_templateObject_34235d205fdf11ea861a59385fcbfce1(),this._showIcons(this.__hasIcons,this.iconBreakpoint,this.layoutBreakpoint,this.responsiveSize),this.tabs.map(function(tab,i){return(0,_litElement.html)(_templateObject2_34235d205fdf11ea861a59385fcbfce1(),tab.id,tab.id,tab.id===_this2.activeTab?"active":"",function(e){return _this2._handleTab(tab)},tab.id===_this2.activeTab||tab.disabled,tab.flag,!tab.flagIcon,tab.flagIcon,tab.label,!tab.flag,tab.flag,!tab.icon,tab.icon,tab.id,tab.label)}))}// haxProperty definition
}],[{key:"styles",//styles function
get:function get(){return[(0,_litElement.css)(_templateObject3_34235d205fdf11ea861a59385fcbfce1())]}},{key:"haxProperties",get:function get(){return{}}// properties available to the custom element for data binding
