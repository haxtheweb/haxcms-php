define(["exports", "meta", "../../lit/index.js", "../responsive-utility/lib/responsive-utility-behaviors.js", "../simple-icon/lib/simple-icon-lite.js", "../simple-icon/lib/simple-icons.js", "../simple-tooltip/simple-tooltip.js", "./lib/a11y-tab.js"], function (_exports, meta, _index, _responsiveUtilityBehaviors, _simpleIconLite, _simpleIcons, _simpleTooltip, _a11yTab) {
  ...
  var _templateObject_453a3600509711edb124eb517be36dbf, _templateObject2_453a3600509711edb124eb517be36dbf, _templateObject3_453a3600509711edb124eb517be36dbf, _templateObject4_453a3600509711edb124eb517be36dbf, _templateObject5_453a3600509711edb124eb517be36dbf, _templateObject6_453a3600509711edb124eb517be36dbf, _templateObject7_453a3600509711edb124eb517be36dbf, _templateObject8_453a3600509711edb124eb517be36dbf, _templateObject9_453a3600509711edb124eb517be36dbf, _templateObject10_453a3600509711edb124eb517be36dbf;
  ...
  var A11yTabs = /*#__PURE__*/function (_ResponsiveUtilityBeh) {
    ...
    babelHelpers.createClass(A11yTabs, [{
      ...
      function render() {
        ...
        return (0, _index.html)(_templateObject_453a3600509711edb124eb517be36dbf || (_templateObject_453a3600509711edb124eb517be36dbf = babelHelpers.taggedTemplateLiteral([" <ul id=\"tabs\" role=\"tablist\" part=\"tablist\">\n        ", "\n      </ul>\n      <div id=\"content\" part=\"content\">\n        <slot></slot>\n      </div>"])), this.tabs.map(function (tab, i) {
          return (0, _index.html)(_templateObject2_453a3600509711edb124eb517be36dbf || (_templateObject2_453a3600509711edb124eb517be36dbf = babelHelpers.taggedTemplateLiteral(["\n            <li part=\"tablist-item\">", "</li>\n          "])), _this2._tabButton(tab, i));
        }));
      }
      /**
      ...
      value: function _tabButton(tab, i) {
        ...
        return (0, _index.html)(_templateObject3_453a3600509711edb124eb517be36dbf || (_templateObject3_453a3600509711edb124eb517be36dbf = babelHelpers.taggedTemplateLiteral(["\n      <button\n        id=\"", "-button\"\n        aria-selected=\"", "\"\n        aria-controls=\"", "\"\n        class=\"", "\"\n        .flag=\"", "\"\n        @click=\"", "\"\n        @keydown=\"", "\"\n        ?disabled=\"", "\"\n        tabindex=\"", "\"\n        role=\"tab\"\n        part=\"", " tab tab-", "\"\n      >\n        ", " ", "\n        ", " ", "\n      </button>\n      ", "\n    "])), tab.id, tab.id === this.activeTab ? "true" : "false", tab.id, tab.id === this.activeTab && !this.disabled ? "active" : "", tab.flag, function (e) {
      ...
      value: function _tabFlag(tab) {
        return (0, _index.html)(_templateObject4_453a3600509711edb124eb517be36dbf || (_templateObject4_453a3600509711edb124eb517be36dbf = babelHelpers.taggedTemplateLiteral(["\n      <span class=\"flag-type\" ?hidden=\"", "\" part=\"flag\">\n        ", "\n      </span>\n    "])), !tab.flag, tab.flag);
      }
      /**
       * makes tab icon
       *
      ...
      value: function _tabIcon(tab, icon) {
        return tab.flag ? (0, _index.html)(_templateObject5_453a3600509711edb124eb517be36dbf || (_templateObject5_453a3600509711edb124eb517be36dbf = babelHelpers.taggedTemplateLiteral(["\n          <simple-icon-lite\n            class=\"icon\"\n            ?hidden=\"", "\"\n            .icon=\"", "\"\n            .title=\"", "\"\n            part=\"icon\"\n          >\n          </simple-icon-lite>\n        "])), !tab[icon], tab[icon], tab.flag) : (0, _index.html)(_templateObject6_453a3600509711edb124eb517be36dbf || (_templateObject6_453a3600509711edb124eb517be36dbf = babelHelpers.taggedTemplateLiteral(["\n          <simple-icon-lite\n            class=\"icon\"\n            ?hidden=\"", "\"\n            .icon=\"", "\"\n            part=\"icon\"\n          >\n          </simple-icon-lite>\n        "])), !tab[icon], tab[icon]);
      }
      /**
       * makes tab label
       *
      ...
      value: function _tabLabel(tab) {
        return (0, _index.html)(_templateObject7_453a3600509711edb124eb517be36dbf || (_templateObject7_453a3600509711edb124eb517be36dbf = babelHelpers.taggedTemplateLiteral([" <span class=\"label\" part=\"label\">", "</span> "])), tab.label);
      }
      /**
       * makes tab tooltip
       *
