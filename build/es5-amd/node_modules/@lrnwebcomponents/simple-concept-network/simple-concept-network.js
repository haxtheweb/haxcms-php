define(["exports","require","../../@polymer/polymer/polymer-element.js","../../@polymer/polymer/lib/utils/render-status.js","../simple-colors/simple-colors.js","../hax-body-behaviors/lib/HAXWiring.js","../a11y-behaviors/a11y-behaviors.js"],function(_exports,_require,_polymerElement,_renderStatus,_simpleColors,_HAXWiring,_a11yBehaviors){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.SimpleConceptNetwork=void 0;_require=babelHelpers.interopRequireWildcard(_require);function _templateObject_067b5420833211e9b574fb683655f262(){var data=babelHelpers.taggedTemplateLiteral(["\n      <style>\n        :host {\n          display: block;\n        }\n        :host([visualization=\"network\"]) simple-concept-network-node {\n          position: relative;\n        }\n        :host([visualization=\"network\"])\n          simple-concept-network-node:nth-child(1) {\n          top: 150px;\n          left: 176px;\n        }\n        :host([visualization=\"network\"])\n          simple-concept-network-node:nth-child(2) {\n          top: 0px;\n          left: 60px;\n        }\n        :host([visualization=\"network\"])\n          simple-concept-network-node:nth-child(3) {\n          top: 75px;\n          left: 60px;\n        }\n        :host([visualization=\"network\"])\n          simple-concept-network-node:nth-child(4) {\n          top: 230px;\n          left: -56px;\n        }\n        :host([visualization=\"network\"])\n          simple-concept-network-node:nth-child(5) {\n          top: 300px;\n          left: -282px;\n        }\n        :host([visualization=\"network\"])\n          simple-concept-network-node:nth-child(6) {\n          top: 230px;\n          left: -515px;\n        }\n        :host([visualization=\"network\"])\n          simple-concept-network-node:nth-child(7) {\n          top: 75px;\n          left: -630px;\n        }\n        :host([visualization=\"network\"]) {\n          display: block;\n          min-height: 450px;\n        }\n      </style>\n      <template is=\"dom-repeat\" items=\"[[nodes]]\" as=\"node\">\n        <simple-concept-network-node\n          accent-color$=\"[[node.color]]\"\n          colored-text$=\"[[coloredText]]\"\n          dark$=\"[[dark]]\"\n          visualization$=\"[[visualization]]\"\n          src$=\"[[node.src]]\"\n          icon$=\"[[node.icon]]\"\n          image$=\"[[node.image]]\"\n          label$=\"[[node.label]]\"\n          disabled$=\"[[node.disabled]]\"\n        ></simple-concept-network-node>\n      </template>\n    "]);_templateObject_067b5420833211e9b574fb683655f262=function _templateObject_067b5420833211e9b574fb683655f262(){return data};return data}/**
...
*/var SimpleConceptNetwork=/*#__PURE__*/function(_A11yBehaviors){babelHelpers.inherits(SimpleConceptNetwork,_A11yBehaviors);function SimpleConceptNetwork(){var _this;babelHelpers.classCallCheck(this,SimpleConceptNetwork);_this=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(SimpleConceptNetwork).call(this));new Promise(function(res,rej){return _require.default(["./lib/simple-concept-network-node.js"],res,rej)});(0,_renderStatus.afterNextRender)(babelHelpers.assertThisInitialized(_this),function(){this.HAXWiring=new _HAXWiring.HAXWiring;this.HAXWiring.setup(SimpleConceptNetwork.haxProperties,SimpleConceptNetwork.tag,this)});return _this}babelHelpers.createClass(SimpleConceptNetwork,[{key:"_valueChanged",/**
   ...
   */value:function _valueChanged(e){for(var i in e.base){for(var j in e.base[i]){this.notifyPath("nodes."+i+"."+j)}}}}],[{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_067b5420833211e9b574fb683655f262())}},{key:"tag",get:function get(){return"simple-concept-network"}},{key:"observers",get:function get(){return["_valueChanged(nodes.*)"]}},{key:"properties",get:function get(){var props={/**
