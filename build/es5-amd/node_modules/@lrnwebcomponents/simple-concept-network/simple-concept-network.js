...
*/var SimpleConceptNetwork=/*#__PURE__*/function(_A11yBehaviors){babelHelpers.inherits(SimpleConceptNetwork,_A11yBehaviors);function SimpleConceptNetwork(){var _this;babelHelpers.classCallCheck(this,SimpleConceptNetwork);_this=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(SimpleConceptNetwork).call(this));new Promise(function(res,rej){return _require.default(["./lib/simple-concept-network-node.js"],res,rej)});return _this}babelHelpers.createClass(SimpleConceptNetwork,[{key:"_valueChanged",/**
   ...
   */value:function _valueChanged(e){for(var i in e.base){for(var j in e.base[i]){this.notifyPath("nodes."+i+"."+j)}}}}],[{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_344064505e1911eaa205e56db4f8cf1d())}},{key:"tag",get:function get(){return"simple-concept-network"}},{key:"observers",get:function get(){return["_valueChanged(nodes.*)"]}},{key:"properties",get:function get(){return _objectSpread({},babelHelpers.get(babelHelpers.getPrototypeOf(SimpleConceptNetwork),"properties",this),{/**
