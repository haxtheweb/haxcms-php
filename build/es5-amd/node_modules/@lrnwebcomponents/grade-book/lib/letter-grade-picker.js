define(["exports", "require", "../../../lit/index.js", "./grade-book-store.js", "../../../mobx/dist/mobx.esm.js", "./letter-grade.js"], function (_exports, _require, _index, _gradeBookStore, _mobxEsm, _letterGrade) {
  ...
  var _templateObject_febdd59017eb11ecb835b978bc1ff323, _templateObject2_febdd59017eb11ecb835b978bc1ff323, _templateObject3_febdd59017eb11ecb835b978bc1ff323, _templateObject4_febdd59017eb11ecb835b978bc1ff323, _templateObject5_febdd59017eb11ecb835b978bc1ff323;
  ...
  var LetterGradePicker = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(LetterGradePicker, [{
      ...
      value: function render() {
        ...
        return (0, _index.html)(_templateObject_febdd59017eb11ecb835b978bc1ff323 || (_templateObject_febdd59017eb11ecb835b978bc1ff323 = babelHelpers.taggedTemplateLiteral(["\n      <div class=\"wrapper\">\n        <slot name=\"prefix\"><span class=\"prefix\">", "</span></slot>\n        ", "\n        ", "\n        <slot name=\"suffix\"></slot>\n        ", "\n      </div>\n    "])), this.label, _gradeBookStore.GradeBookStore.gradeScale.map(function (scale, index) {
          return (0, _index.html)(_templateObject2_febdd59017eb11ecb835b978bc1ff323 || (_templateObject2_febdd59017eb11ecb835b978bc1ff323 = babelHelpers.taggedTemplateLiteral(["\n            <button\n              ?data-selected-value=\"", "\"\n              letter=\"", "\"\n              id=\"btn", "\"\n              @click=\"", "\"\n              @mousedown=\"", "\"\n              @mouseover=\"", "\"\n              @focusin=\"", "\"\n              @mouseout=\"", "\"\n              @focusout=\"", "\"\n            >\n              <letter-grade\n                interactive\n                display-only\n                letter=\"", "\"\n                mini\n              ></letter-grade>\n            </button>\n          "])), scale.letter == _this2.value, scale.letter, index, _this2.clickScore, _this2.activeEventOn, _this2.activeEventOn, _this2.activeEventOn, _this2.activeEventOff, _this2.activeEventOff, scale.letter);
        }), this.input ? (0, _index.html)(_templateObject3_febdd59017eb11ecb835b978bc1ff323 || (_templateObject3_febdd59017eb11ecb835b978bc1ff323 = babelHelpers.taggedTemplateLiteral(["\n              <span class=\"score-wrapper\">\n                <simple-fields-field\n                  type=\"number\"\n                  part=\"simple-fields-field\"\n                  min=\"0\"\n                  value=\"", "\"\n                  max=\"", "\"\n                  @value-changed=\"", "\"\n                  maxlength=\"10\"\n                ></simple-fields-field>\n                / ", "</span\n              >\n            "])), this.score, this.possible, this.scoreUpdated, this.possible) : _index.nothing, this.input ? (0, _index.html)(_templateObject4_febdd59017eb11ecb835b978bc1ff323 || (_templateObject4_febdd59017eb11ecb835b978bc1ff323 = babelHelpers.taggedTemplateLiteral([""]))) : _index.nothing);
      }
    }, {
      key: "activeEventOn",
