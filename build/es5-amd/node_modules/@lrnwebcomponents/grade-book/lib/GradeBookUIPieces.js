define(["exports", "require", "../../../lit/index.js"], function (_exports, _require, _index) {
  ...
  var _templateObject_62c86eb02ee311eda9c37b2c2696a94a, _templateObject2_62c86eb02ee311eda9c37b2c2696a94a, _templateObject3_62c86eb02ee311eda9c37b2c2696a94a, _templateObject4_62c86eb02ee311eda9c37b2c2696a94a, _templateObject5_62c86eb02ee311eda9c37b2c2696a94a, _templateObject6_62c86eb02ee311eda9c37b2c2696a94a, _templateObject7_62c86eb02ee311eda9c37b2c2696a94a, _templateObject8_62c86eb02ee311eda9c37b2c2696a94a, _templateObject9_62c86eb02ee311eda9c37b2c2696a94a, _templateObject10_62c86eb02ee311eda9c37b2c2696a94a, _templateObject11_62c86eb02ee311eda9c37b2c2696a94a, _templateObject12_62c86eb02ee311eda9c37b2c2696a94a, _templateObject13_62c86eb02ee311eda9c37b2c2696a94a, _templateObject14_62c86eb02ee311eda9c37b2c2696a94a;
    ...
    return /*#__PURE__*/function (_SuperClass) {
      ...
      babelHelpers.createClass(_class, [{
        ...
        function renderActiveStudentBtn() {
          ...
          return (0, _index.html)(_templateObject_62c86eb02ee311eda9c37b2c2696a94a || (_templateObject_62c86eb02ee311eda9c37b2c2696a94a = babelHelpers.taggedTemplateLiteral(["<simple-icon-button-lite\n          @click=\"", "\"\n          id=\"activestudentbtn\"\n          ?disabled=\"", "\"\n        >\n          ", "\n          <span class=\"hide-900\">", "</span>\n        </simple-icon-button-lite>\n        <simple-popover\n          ?hidden=\"", "\"\n          for=\"activestudentbtn\"\n          auto\n        >\n          <div>\n            ", "\n\n            <div class=\"active-student-grade-history\">\n              ", "\n            </div>\n          </div>\n        </simple-popover>"])), this.toggleActiveStudentOverview, !this.ready, this.database.roster[this.activeStudent] && this.database.roster[this.activeStudent].photo ? (0, _index.html)(_templateObject2_62c86eb02ee311eda9c37b2c2696a94a || (_templateObject2_62c86eb02ee311eda9c37b2c2696a94a = babelHelpers.taggedTemplateLiteral(["<img\n                src=\"", "\"\n                loading=\"lazy\"\n              />"])), this.database.roster[this.activeStudent].photo) : (0, _index.html)(_templateObject3_62c86eb02ee311eda9c37b2c2696a94a || (_templateObject3_62c86eb02ee311eda9c37b2c2696a94a = babelHelpers.taggedTemplateLiteral(["<simple-icon-lite icon=\"social:person\"></simple-icon-lite>"]))), this.t.activeStudent, this.hideActiveStudentOverview, this.database.roster[this.activeStudent] ? (0, _index.html)(_templateObject4_62c86eb02ee311eda9c37b2c2696a94a || (_templateObject4_62c86eb02ee311eda9c37b2c2696a94a = babelHelpers.taggedTemplateLiteral([" <grade-book-student-block\n                  .student=\"", "\"\n                ></grade-book-student-block>"])), this.database.roster[this.activeStudent]) : _index.nothing, this.activeStudentSubmissions.map(function (sRecord) {
            return (0, _index.html)(_templateObject5_62c86eb02ee311eda9c37b2c2696a94a || (_templateObject5_62c86eb02ee311eda9c37b2c2696a94a = babelHelpers.taggedTemplateLiteral(["\n                  <button\n                    .value=\"", "\"\n                    @click=\"", "\"\n                    class=\"", "\"\n                  >\n                    <letter-grade\n                      mini\n                      label=\"", "\"\n                      .total=\"", "\"\n                      .score=\"", "\"\n                      .value=\"", "\"\n                    >\n                    </letter-grade>\n                  </button>\n                "])), sRecord.assignmentIndex, _this2.studentLetterGradeHistoryClick, _this2.activeAssignment === sRecord.assignmentIndex ? "activeAssignment" : "", sRecord.assignmentName, sRecord.assignmentPoints, sRecord.studentScore, sRecord.assignmentIndex);
          }));
        ...
        value: function renderGradeScaleBtn() {
          return (0, _index.html)(_templateObject6_62c86eb02ee311eda9c37b2c2696a94a || (_templateObject6_62c86eb02ee311eda9c37b2c2696a94a = babelHelpers.taggedTemplateLiteral([" <simple-icon-button-lite\n          icon=\"list\"\n          @click=\"", "\"\n          id=\"gradescalebtn\"\n          ?disabled=\"", "\"\n        >\n          <span class=\"hide-900\">", "</span>\n        </simple-icon-button-lite>\n        <simple-popover\n          ?hidden=\"", "\"\n          for=\"gradescalebtn\"\n          auto\n        >\n          <editable-table-display\n            accent-color=\"", "\"\n            bordered\n            column-header\n            condensed\n            disable-responsive\n            scroll\n            striped\n          >\n            <table>\n              <tbody>\n                <tr>\n                  <td>", "</td>\n                  <td>", "</td>\n                  <td>", "</td>\n                </tr>\n                ", "\n              </tbody>\n            </table>\n          </editable-table-display>\n        </simple-popover>"])), this.toggleGradeScale, !this.ready, this.t.gradingScale, this.hideGradeScale, this.accentColor, this.t.letterGrade, this.t.highRange, this.t.lowRange, this.database.gradeScale.map(function (scale) {
            return (0, _index.html)(_templateObject7_62c86eb02ee311eda9c37b2c2696a94a || (_templateObject7_62c86eb02ee311eda9c37b2c2696a94a = babelHelpers.taggedTemplateLiteral(["\n                    <tr>\n                      <td>", "</td>\n                      <td>", "</td>\n                      <td>", "</td>\n                    </tr>\n                  "])), scale.letter, scale.highRange, scale.lowRange);
          }));
        ...
        value: function renderActiveAssignmentBtn() {
          return (0, _index.html)(_templateObject9_62c86eb02ee311eda9c37b2c2696a94a || (_templateObject9_62c86eb02ee311eda9c37b2c2696a94a = babelHelpers.taggedTemplateLiteral(["<simple-icon-button-lite\n          icon=\"assignment\"\n          @click=\"", "\"\n          id=\"activeassignmentbtn\"\n          ?disabled=\"", "\"\n        >\n          <span class=\"hide-900\">", "</span>\n        </simple-icon-button-lite>\n        <simple-popover\n          ?hidden=\"", "\"\n          for=\"activeassignmentbtn\"\n          auto\n        >\n          ", "\n        </simple-popover>"])), this.toggleActiveAssignment, !this.ready, this.t.activeAssignment, this.hideActiveAssignment, this.database.assignments[this.activeAssignment] ? (0, _index.html)(_templateObject10_62c86eb02ee311eda9c37b2c2696a94a || (_templateObject10_62c86eb02ee311eda9c37b2c2696a94a = babelHelpers.taggedTemplateLiteral(["\n                <h3>\n                  ", "\n                </h3>\n                ", ":\n                <local-time\n                  .datetime=\"", "\"\n                  month=\"short\"\n                  day=\"numeric\"\n                  year=\"numeric\"\n                  hour=\"numeric\"\n                  minute=\"numeric\"\n                  time-zone-name=\"short\"\n                >\n                </local-time>\n              "])), this.database.assignments[this.activeAssignment].name, this.t.dueDate, this.database.assignments[this.activeAssignment]._ISODueDate) : _index.nothing);
        } // toggle logic for button
        ...
        value: function renderRubricInfoBtn(index, criteria, details) {
          return (0, _index.html)(_templateObject11_62c86eb02ee311eda9c37b2c2696a94a || (_templateObject11_62c86eb02ee311eda9c37b2c2696a94a = babelHelpers.taggedTemplateLiteral(["<simple-icon-button-lite\n          icon=\"info\"\n          @click=\"", "\"\n          id=\"rubricinfo", "\"\n          data-id=\"", "\"\n        >\n          <span class=\"hide-900\" data-id=\"", "\">", "</span>\n        </simple-icon-button-lite>\n        <simple-popover\n          ?hidden=\"", "\"\n          for=\"rubricinfo", "\"\n          auto\n        >\n          <p style=\"max-width:20vw;\">", "</p>\n        </simple-popover>"])), this.toggleRubricInfo, index, index, index, criteria, !this.hideRubricInfo[index], index, details);
        } // toggle logic for button
        ...
        value: function renderDisplayModeBtn() {
          ...
          return (0, _index.html)(_templateObject12_62c86eb02ee311eda9c37b2c2696a94a || (_templateObject12_62c86eb02ee311eda9c37b2c2696a94a = babelHelpers.taggedTemplateLiteral([" ", ""])), this.displayModeData().map(function (value, i) {
            return (0, _index.html)(_templateObject13_62c86eb02ee311eda9c37b2c2696a94a || (_templateObject13_62c86eb02ee311eda9c37b2c2696a94a = babelHelpers.taggedTemplateLiteral(["\n          <simple-icon-button-lite\n            icon=\"", "\"\n            @click=\"", "\"\n            data-id=\"", "\"\n            ?disabled=\"", "\"\n          >\n            <span class=\"hide-900\" data-id=\"", "\">", "</span>\n          </simple-icon-button-lite>\n        "])), value.icon, _this3.toggleDisplayMode, i, _this3.displayMode === i, i, value.label);
          }));
        }
      }, {
        key: "displayModeData",
