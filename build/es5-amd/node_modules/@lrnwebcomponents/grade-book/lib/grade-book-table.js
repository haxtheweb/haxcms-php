define(["exports", "../../../lit/index.js", "../../editable-table/editable-table.js"], function (_exports, _index, _editableTable) {
  ...
  var _templateObject_d3b41880a7e811ed8d60b559aaaec7a9, _templateObject2_d3b41880a7e811ed8d60b559aaaec7a9, _templateObject3_d3b41880a7e811ed8d60b559aaaec7a9;
  ...
  var GradeBookTable = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(GradeBookTable, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_d3b41880a7e811ed8d60b559aaaec7a9 || (_templateObject_d3b41880a7e811ed8d60b559aaaec7a9 = babelHelpers.taggedTemplateLiteral(["\n      <editable-table\n        ?edit-mode=\"", "\"\n        bordered\n        column-header\n        condensed\n        disable-responsive\n        scroll\n        striped\n      >\n        <table>\n          <tbody>\n            <tr>\n              <td>", "</td>\n              <td>", "</td>\n              <td>", "</td>\n            </tr>\n            ", "\n          </tbody>\n        </table>\n      </editable-table>\n    "])), this.editMode, this.t.letterGrade, this.t.highRange, this.t.lowRange, this.database.gradeScale.map(function (scale) {
          return (0, _index.html)(_templateObject2_d3b41880a7e811ed8d60b559aaaec7a9 || (_templateObject2_d3b41880a7e811ed8d60b559aaaec7a9 = babelHelpers.taggedTemplateLiteral(["\n                <tr>\n                  <td>", "</td>\n                  <td>", "</td>\n                  <td>", "</td>\n                </tr>\n              "])), scale.letter, scale.highRange, scale.lowRange);
        }));
      }
    }], [{
      key: "tag",
      ...
      key: "styles",
      get: function get() {
        return [(0, _index.css)(_templateObject3_d3b41880a7e811ed8d60b559aaaec7a9 || (_templateObject3_d3b41880a7e811ed8d60b559aaaec7a9 = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n      "])))];
      }
    }]);
