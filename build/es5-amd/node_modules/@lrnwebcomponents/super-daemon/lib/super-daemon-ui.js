define(["exports", "../../../lit/index.js", "../../simple-icon/lib/simple-icons.js", "../../simple-icon/lib/simple-icon-lite.js", "../../simple-fields/lib/simple-fields-field.js", "../../simple-fields/lib/simple-tag.js", "../../simple-filter/simple-filter.js", "../../i18n-manager/lib/I18NMixin.js", "./super-daemon-row.js"], function (_exports, _index, _simpleIcons, _simpleIconLite, _simpleFieldsField, _simpleTag, _simpleFilter, _I18NMixin, _superDaemonRow) {
  ...
  var _templateObject_fffd58e0e4f411ed85766367b4d3e9fc, _templateObject2_fffd58e0e4f411ed85766367b4d3e9fc, _templateObject3_fffd58e0e4f411ed85766367b4d3e9fc, _templateObject4_fffd58e0e4f411ed85766367b4d3e9fc, _templateObject5_fffd58e0e4f411ed85766367b4d3e9fc, _templateObject6_fffd58e0e4f411ed85766367b4d3e9fc, _templateObject7_fffd58e0e4f411ed85766367b4d3e9fc, _templateObject8_fffd58e0e4f411ed85766367b4d3e9fc, _templateObject9_fffd58e0e4f411ed85766367b4d3e9fc, _templateObject10_fffd58e0e4f411ed85766367b4d3e9fc;
  ...
  var SuperDaemonUI = /*#__PURE__*/function (_SimpleFilterMixin) {
    ...
    babelHelpers.createClass(SuperDaemonUI, [{
      ...
      value: function render() {
        var _this3 = this;
        return (0, _index.html)(_templateObject_fffd58e0e4f411ed85766367b4d3e9fc || (_templateObject_fffd58e0e4f411ed85766367b4d3e9fc = babelHelpers.taggedTemplateLiteral(["\n      <div class=\"common-tasks-text\">", "</div>\n      <div class=\"question-tags\">\n        ", "\n      </div>\n      <div class=\"search\">\n        ", "\n        ", "\n        <simple-fields-field\n          id=\"inputfilter\"\n          @value-changed=\"", "\"\n          @keydown=\"", "\"\n          .value=\"", "\"\n          aria-controls=\"filter\"\n          label=\"", "\"\n          placeholder=\"", "\"\n          type=\"text\"\n          auto-validate=\"\"\n          autofocus\n          part=\"filter\"\n        ></simple-fields-field>\n        <simple-icon-lite icon=\"", "\" class=\"icon\"></simple-icon-lite>\n      </div>\n      <div class=\"results-stats\">\n        ", " / ", " ", "\n      </div>\n      <div\n        class=\"results\"\n        @keydown=\"", "\"\n        @super-daemon-row-selected=\"", "\"\n      >\n        ", "\n      </div>\n    "])), this.t.commonTasksText, this.questionTags.map(function (item, i) {
          return (0, _index.html)(_templateObject2_fffd58e0e4f411ed85766367b4d3e9fc || (_templateObject2_fffd58e0e4f411ed85766367b4d3e9fc = babelHelpers.taggedTemplateLiteral([" <simple-tag\n            tabindex=\"0\"\n            @keydown=\"", "\"\n            @click=\"", "\"\n            accent-color=\"grey\"\n            value=\"", "\"\n            part=\"tag tag-", "\"\n            data-value=\"", "\"\n          ></simple-tag>"])), _this3.tagKeydown, _this3.tagClick, item.label, i, item.value);
        }), this.commandContext != "*" ? (0, _index.html)(_templateObject3_fffd58e0e4f411ed85766367b4d3e9fc || (_templateObject3_fffd58e0e4f411ed85766367b4d3e9fc = babelHelpers.taggedTemplateLiteral(["<simple-icon-lite\n              title=\"", "\"\n              icon=\"", "\"\n              class=\"user-context-icon\"\n            ></simple-icon-lite>"])), this.getActiveTitle(this.commandContext), this.getActiveIcon(this.commandContext)) : "", this.programName ? (0, _index.html)(_templateObject4_fffd58e0e4f411ed85766367b4d3e9fc || (_templateObject4_fffd58e0e4f411ed85766367b4d3e9fc = babelHelpers.taggedTemplateLiteral(["<span class=\"program\">", "</span>"])), this.programName) : "", this.inputfilterChanged, this._inputKeydown, this.like, this.t.filterCommands, this.t.whatAreYouLookingFor, this.icon, this.filtered.length, this.items.length, this.t.commands, this._resultsKeydown, this.itemSelected, this.loading ? (0, _index.html)(_templateObject5_fffd58e0e4f411ed85766367b4d3e9fc || (_templateObject5_fffd58e0e4f411ed85766367b4d3e9fc = babelHelpers.taggedTemplateLiteral(["<div class=\"loading\">", "..</div>"])), this.t.loadingResults) : (0, _index.html)(_templateObject6_fffd58e0e4f411ed85766367b4d3e9fc || (_templateObject6_fffd58e0e4f411ed85766367b4d3e9fc = babelHelpers.taggedTemplateLiteral(["\n              ", "\n            "])), !this.filtered.length || this.filtered.length === 0 ? (0, _index.html)(_templateObject7_fffd58e0e4f411ed85766367b4d3e9fc || (_templateObject7_fffd58e0e4f411ed85766367b4d3e9fc = babelHelpers.taggedTemplateLiteral(["<div class=\"no-results\">\n                      ", "\n                    </div>\n                    <div class=\"slotted\"><slot></slot></div>"])), this.t.noResultsForThisTerm) : (0, _index.html)(_templateObject8_fffd58e0e4f411ed85766367b4d3e9fc || (_templateObject8_fffd58e0e4f411ed85766367b4d3e9fc = babelHelpers.taggedTemplateLiteral(["\n                    ", "\n                  "])), this.filtered.map(function (item, i) {
          return (0, _index.html)(_templateObject9_fffd58e0e4f411ed85766367b4d3e9fc || (_templateObject9_fffd58e0e4f411ed85766367b4d3e9fc = babelHelpers.taggedTemplateLiteral(["\n                        <super-daemon-row\n                          data-row-index=\"", "\"\n                          .value=\"", "\"\n                          icon=\"", "\"\n                          image=\"", "\"\n                          title=\"", "\"\n                          .tags=\"", "\"\n                          event-name=\"", "\"\n                          path=\"", "\"\n                          key=\"", "\"\n                          ?more=\"", "\"\n                          ?mini=\"", "\"\n                          >", "</super-daemon-row\n                        >\n                      "])), i, item.value, item.icon, item.image, item.title, item.tags, item.eventName, item.path, item.key, item.more && !_this3.mini, _this3.mini, item.more ? item.more : _index.nothing);
        }))));
      }
    }], [{
      key: "tag",
