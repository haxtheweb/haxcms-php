define(["exports","../../@polymer/polymer/polymer-legacy.js","../hax-body-behaviors/lib/HAXWiring.js","../schema-behaviors/schema-behaviors.js"],function(_exports,_polymerLegacy,_HAXWiring,_schemaBehaviors){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.TaskList=void 0;function _templateObject_c35fb89068f411e996b0af119cd7f5ea(){var data=babelHelpers.taggedTemplateLiteral(["\n    <style>\n      :host {\n        display: block;\n      }\n    </style>\n    <h3><span property=\"oer:name\">[[name]]</span></h3>\n    <ol>\n      <template is=\"dom-repeat\" items=\"[[tasks]]\" as=\"task\">\n        <li><span property=\"oer:task\">[[task.name]]</span></li>\n      </template>\n    </ol>\n  "]);_templateObject_c35fb89068f411e996b0af119cd7f5ea=function _templateObject_c35fb89068f411e996b0af119cd7f5ea(){return data};return data}/**
`task-list`
...
*/var TaskList=(0,_polymerLegacy.Polymer)({_template:(0,_polymerLegacy.html)(_templateObject_c35fb89068f411e996b0af119cd7f5ea()),is:"task-list",behaviors:[HAXBehaviors.PropertiesBehaviors,SchemaBehaviors.Schema],hostAttributes:{typeof:"oer:SupportingMaterial"},observers:["_valueChanged(tasks.*)"],properties:{/**
