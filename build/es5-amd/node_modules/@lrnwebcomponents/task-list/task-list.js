define(["exports", "../../lit/index.js", "../schema-behaviors/schema-behaviors.js", "../utils/utils.js"], function (_exports, _index, _schemaBehaviors, _utils) {
  ...
  var _templateObject_d519e2b0e4f411ed85766367b4d3e9fc, _templateObject2_d519e2b0e4f411ed85766367b4d3e9fc, _templateObject3_d519e2b0e4f411ed85766367b4d3e9fc, _templateObject4_d519e2b0e4f411ed85766367b4d3e9fc, _templateObject5_d519e2b0e4f411ed85766367b4d3e9fc;
  ...
  var TaskList = /*#__PURE__*/function (_SchemaBehaviors) {
    ...
    babelHelpers.createClass(TaskList, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_d519e2b0e4f411ed85766367b4d3e9fc || (_templateObject_d519e2b0e4f411ed85766367b4d3e9fc = babelHelpers.taggedTemplateLiteral(["\n      <div id=\"wrapper\">\n        <h3 id=\"name\" property=\"oer:name\" ?contenteditable=\"", "\">\n          ", "\n        </h3>\n        <ol ?contenteditable=\"", "\" id=\"tasks\">\n          ", "\n        </ol>\n      </div>\n    "])), this.editMode, this.name, this.editMode, this.tasks.map(function (task) {
          return (0, _index.html)(_templateObject2_d519e2b0e4f411ed85766367b4d3e9fc || (_templateObject2_d519e2b0e4f411ed85766367b4d3e9fc = babelHelpers.taggedTemplateLiteral(["\n              <li>\n                ", "\n              </li>\n            "])), task.link ? (0, _index.html)(_templateObject3_d519e2b0e4f411ed85766367b4d3e9fc || (_templateObject3_d519e2b0e4f411ed85766367b4d3e9fc = babelHelpers.taggedTemplateLiteral(["\n                      <a href=\"", "\" property=\"oer:task\"\n                        >", "</a\n                      >\n                    "])), task.link, task.name) : (0, _index.html)(_templateObject4_d519e2b0e4f411ed85766367b4d3e9fc || (_templateObject4_d519e2b0e4f411ed85766367b4d3e9fc = babelHelpers.taggedTemplateLiteral([" <span property=\"oer:task\">", "</span> "])), task.name));
        }));
      }
      /**
       ...
       */
      function get() {
        return [(0, _index.css)(_templateObject5_d519e2b0e4f411ed85766367b4d3e9fc || (_templateObject5_d519e2b0e4f411ed85766367b4d3e9fc = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n          border: var(--task-list-border, 1px solid #eeeeee);\n          font-size: var(--task-list-font-size, 18px);\n          padding: var(--task-list-padding, 16px);\n        }\n      "])))];
      }
    }, {
      key: "tag",
      get: function get() {
