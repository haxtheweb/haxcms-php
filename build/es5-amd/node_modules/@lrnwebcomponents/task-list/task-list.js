define(["exports", "../../lit-element/lit-element.js", "../schema-behaviors/schema-behaviors.js"], function (_exports, _litElement, _schemaBehaviors) {
  ...
  function _templateObject5_d5222060247111eb9734a78ef81f0b0d() {
    ...
    _templateObject5_d5222060247111eb9734a78ef81f0b0d = function _templateObject5_d5222060247111eb9734a78ef81f0b0d() {
      return data;
    };
  ...
  function _templateObject4_d5222060247111eb9734a78ef81f0b0d() {
    var data = babelHelpers.taggedTemplateLiteral([" <span property=\"oer:task\">", "</span> "]);

    _templateObject4_d5222060247111eb9734a78ef81f0b0d = function _templateObject4_d5222060247111eb9734a78ef81f0b0d() {
      return data;
    };
  ...
  function _templateObject3_d5222060247111eb9734a78ef81f0b0d() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                    <a href=\"", "\" property=\"oer:task\">", "</a>\n                  "]);

    _templateObject3_d5222060247111eb9734a78ef81f0b0d = function _templateObject3_d5222060247111eb9734a78ef81f0b0d() {
      return data;
    };
  ...
  function _templateObject2_d5222060247111eb9734a78ef81f0b0d() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            <li>\n              ", "\n            </li>\n          "]);

    _templateObject2_d5222060247111eb9734a78ef81f0b0d = function _templateObject2_d5222060247111eb9734a78ef81f0b0d() {
      return data;
    };
  ...
  function _templateObject_d5222060247111eb9734a78ef81f0b0d() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <h3><span property=\"oer:name\">", "</span></h3>\n      <ol>\n        ", "\n      </ol>\n    "]);

    _templateObject_d5222060247111eb9734a78ef81f0b0d = function _templateObject_d5222060247111eb9734a78ef81f0b0d() {
      return data;
    };
  ...
  var TaskList = /*#__PURE__*/function (_SchemaBehaviors) {
    ...
    babelHelpers.createClass(TaskList, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_d5222060247111eb9734a78ef81f0b0d(), this.name, this.tasks.map(function (task) {
          return (0, _litElement.html)(_templateObject2_d5222060247111eb9734a78ef81f0b0d(), task.link ? (0, _litElement.html)(_templateObject3_d5222060247111eb9734a78ef81f0b0d(), task.link, task.name) : (0, _litElement.html)(_templateObject4_d5222060247111eb9734a78ef81f0b0d(), task.name));
        }));
      }
    }], [{
      key: "styles",
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject5_d5222060247111eb9734a78ef81f0b0d())];
      }
    }, {
      key: "tag",
      get: function get() {
