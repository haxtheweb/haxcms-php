define(["exports", "../../lit-element/lit-element.js", "../schema-behaviors/schema-behaviors.js"], function (_exports, _litElement, _schemaBehaviors) {
  ...
  function _templateObject5_ee4a53a0d0e811eaaf77ab7a62972e0b() {
    ...
    _templateObject5_ee4a53a0d0e811eaaf77ab7a62972e0b = function _templateObject5_ee4a53a0d0e811eaaf77ab7a62972e0b() {
      return data;
    };
  ...
  function _templateObject4_ee4a53a0d0e811eaaf77ab7a62972e0b() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                    <span property=\"oer:task\">", "</span>\n                  "]);

    _templateObject4_ee4a53a0d0e811eaaf77ab7a62972e0b = function _templateObject4_ee4a53a0d0e811eaaf77ab7a62972e0b() {
      return data;
    };
  ...
  function _templateObject3_ee4a53a0d0e811eaaf77ab7a62972e0b() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                    <a href=\"", "\" property=\"oer:task\">", "</a>\n                  "]);

    _templateObject3_ee4a53a0d0e811eaaf77ab7a62972e0b = function _templateObject3_ee4a53a0d0e811eaaf77ab7a62972e0b() {
      return data;
    };
  ...
  function _templateObject2_ee4a53a0d0e811eaaf77ab7a62972e0b() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            <li>\n              ", "\n            </li>\n          "]);

    _templateObject2_ee4a53a0d0e811eaaf77ab7a62972e0b = function _templateObject2_ee4a53a0d0e811eaaf77ab7a62972e0b() {
      return data;
    };
  ...
  function _templateObject_ee4a53a0d0e811eaaf77ab7a62972e0b() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <h3><span property=\"oer:name\">", "</span></h3>\n      <ol>\n        ", "\n      </ol>\n    "]);

    _templateObject_ee4a53a0d0e811eaaf77ab7a62972e0b = function _templateObject_ee4a53a0d0e811eaaf77ab7a62972e0b() {
      return data;
    };
  ...
  function (_SchemaBehaviors) {
    ...
    babelHelpers.createClass(TaskList, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_ee4a53a0d0e811eaaf77ab7a62972e0b(), this.name, this.tasks.map(function (task) {
          return (0, _litElement.html)(_templateObject2_ee4a53a0d0e811eaaf77ab7a62972e0b(), task.link ? (0, _litElement.html)(_templateObject3_ee4a53a0d0e811eaaf77ab7a62972e0b(), task.link, task.name) : (0, _litElement.html)(_templateObject4_ee4a53a0d0e811eaaf77ab7a62972e0b(), task.name));
        }));
      }
    }], [{
      key: "styles",
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject5_ee4a53a0d0e811eaaf77ab7a62972e0b())];
      }
    }, {
      key: "tag",
      get: function get() {
