define(["exports", "../../lit-element/lit-element.js", "../simple-icon/simple-icon.js", "../simple-icon/lib/simple-icons.js"], function (_exports, _litElement, _simpleIcon, _simpleIcons) {
  ...
  function _templateObject2_624d99003efe11eb800233a440abe59f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <img\n        src=\"", "\"\n        loading=\"lazy\"\n        id=\"image\"\n        aria-describedby=\"", "\"\n      />\n      <div class=\"overlay\">\n        <h2 id=\"header\" ?hidden=\"", "\">", "</h2>\n        <div id=\"subheader\" ?hidden=\"", "\">", "</div>\n        <div id=\"body\">\n          <p ?hidden=\"", "\">", "</p>\n          <slot></slot>\n        </div>\n        <a\n          tabindex=\"-1\"\n          href=\"", "\"\n          id=\"actionlink\"\n          @click=\"", "\"\n        >\n          <button raised=\"\" id=\"action\">\n            <span id=\"label\"\n              >", "<simple-icon\n                accent-color=\"grey\"\n                dark\n                id=\"icon\"\n                icon=\"", "\"\n                ?hidden=\"", "\"\n              ></simple-icon\n            ></span>\n          </button>\n        </a>\n      </div>\n    "]);

    _templateObject2_624d99003efe11eb800233a440abe59f = function _templateObject2_624d99003efe11eb800233a440abe59f() {
      return data;
    };
  ...
  function _templateObject_624d99003efe11eb800233a440abe59f() {
    ...
    _templateObject_624d99003efe11eb800233a440abe59f = function _templateObject_624d99003efe11eb800233a440abe59f() {
      return data;
    };
  ...
  var MagazineCover = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(MagazineCover, null, [{
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject_624d99003efe11eb800233a440abe59f())];
      }
      /**
       * HTMLElement
       */
    ...
    babelHelpers.createClass(MagazineCover, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_624d99003efe11eb800233a440abe59f(), this.image, this.describedBy || "", !this.header, this.header, !this.subheader, this.subheader, !this.text, this.text, this.link, this._linkTapped, this.action, this.icon, !this.icon);
      }
      /**
       * convention
       */
