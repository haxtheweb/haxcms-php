define(["exports","require","../../lit-element/lit-element.js"],function(_exports,_require,_litElement){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.MagazineCover=void 0;_require=babelHelpers.interopRequireWildcard(_require);function _templateObject2_8a1904405f2711ea882ceb1d1b255b64(){var data=babelHelpers.taggedTemplateLiteral(["\n      <iron-image\n        src=\"","\"\n        preload=\"\"\n        fade=\"\"\n        sizing=\"cover\"\n        id=\"image\"\n      ></iron-image>\n      <div class=\"overlay\">\n        <h2 id=\"header\" ?hidden=\"","\">","</h2>\n        <div id=\"subheader\" ?hidden=\"","\">","</div>\n        <div id=\"body\">\n          <p ?hidden=\"","\">","</p>\n          <slot></slot>\n        </div>\n        <a\n          tabindex=\"-1\"\n          href=\"","\"\n          id=\"actionlink\"\n          @click=\"","\"\n        >\n          <paper-button raised=\"\" id=\"action\">\n            <span id=\"label\"\n              >","<iron-icon\n                id=\"icon\"\n                icon=\"","\"\n                ?hidden=\"","\"\n              ></iron-icon\n            ></span>\n          </paper-button>\n        </a>\n      </div>\n    "]);_templateObject2_8a1904405f2711ea882ceb1d1b255b64=function _templateObject2_8a1904405f2711ea882ceb1d1b255b64(){return data};return data}function _templateObject_8a1904405f2711ea882ceb1d1b255b64(){var data=babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n          background-color: #222222;\n          overflow: hidden;\n          --magazine-cover-text-color: #eeeeee;\n        }\n        .overlay {\n          left: 0;\n          right: 0;\n          min-height: 30vh;\n          margin: -38vh 0 0 0;\n          background-color: rgba(0, 0, 0, 0.8);\n          padding: 32px;\n          position: relative;\n        }\n        #image {\n          opacity: 0.5;\n          filter: alpha(opacity=50);\n          transition: opacity 0.3s linear;\n          width: 100%;\n          height: 80vh;\n          background-color: #222222;\n        }\n        #image:hover {\n          opacity: 0.9;\n          filter: alpha(opacity=90);\n        }\n        #header {\n          color: var(--magazine-cover-text-color);\n          font-size: 48px;\n          padding: 0;\n          margin: 0;\n          font-weight: bold;\n        }\n        #subheader {\n          color: var(--magazine-cover-text-color);\n          font-size: 22.4px;\n          padding: 0;\n          margin: 3.2px 0 16px 0;\n          font-style: italic;\n          font-weight: normal;\n        }\n        #body {\n          color: var(--magazine-cover-text-color);\n          padding: 0;\n          margin: 0;\n          font-size: 19.2px;\n          padding: 0 0 0 3.2px;\n          margin: 0 0 32px 0;\n        }\n        #body p {\n          color: var(--magazine-cover-text-color);\n        }\n        #action {\n          color: var(--magazine-cover-text-color);\n          text-transform: none;\n          font-size: 24px;\n          font-style: italic;\n          font-weight: bold;\n          background-color: #000000;\n          border: 1px solid var(--magazine-cover-text-color);\n          border-radius: 8px;\n          transition: background 0.3s linear;\n          width: 100%;\n          margin: 0;\n        }\n        #action:hover,\n        #action:focus {\n          border-color: #ffffff;\n          color: #ffffff;\n          background-color: rgba(255, 255, 255, 0.2);\n        }\n        #actionlink {\n          color: var(--magazine-cover-text-color);\n          display: flex;\n          text-decoration: none;\n          border-radius: 8px;\n        }\n        #icon {\n          display: inline-block;\n          width: 19.2px;\n          height: 19.2px;\n          font-size: 19.2px;\n          margin-left: 8px;\n        }\n        #label {\n          text-shadow: -1px 1px 2px #000000;\n        }\n        @media screen and (max-width: 900px) {\n          #header {\n            font-size: 32px;\n          }\n          #subheader {\n            font-size: 16px;\n          }\n          #body {\n            font-size: 16px;\n          }\n          #action {\n            font-size: 19.2px;\n          }\n        }\n        @media screen and (max-width: 650px) {\n          #body {\n            font-size: 12.8px;\n          }\n          #action {\n            font-size: 16px;\n          }\n          .overlay {\n            margin: -50vh 0 0 0;\n            padding: 16px;\n          }\n        }\n      "]);_templateObject_8a1904405f2711ea882ceb1d1b255b64=function _templateObject_8a1904405f2711ea882ceb1d1b255b64(){return data};return data}/**
 * `magazine-cover`
 ...
 */var MagazineCover=/*#__PURE__*/function(_LitElement){babelHelpers.inherits(MagazineCover,_LitElement);babelHelpers.createClass(MagazineCover,null,[{key:"styles",/**
   ...
   */get:function get(){return[(0,_litElement.css)(_templateObject_8a1904405f2711ea882ceb1d1b255b64())]}/**
   * HTMLElement
   ...
   * LitElement render
   */babelHelpers.createClass(MagazineCover,[{key:"render",value:function render(){return(0,_litElement.html)(_templateObject2_8a1904405f2711ea882ceb1d1b255b64(),this.image,!this.header,this.header,!this.subheader,this.subheader,!this.text,this.text,this.link,this._linkTapped,this.action,this.icon,!this.icon)}/**
   * convention
   */},{key:"_linkTapped",/**
