define(["exports", "require", "../../lit-element/lit-element.js"], function (_exports, _require, _litElement) {
  ...
  function _templateObject3_6ddb8490326511eaaca64f8f794265a0() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: inline-block;\n        }\n\n        :host([hidden]) {\n          display: none;\n        }\n\n        lrn-vocab {\n          display: inline;\n        }\n      "]);

    _templateObject3_6ddb8490326511eaaca64f8f794265a0 = function _templateObject3_6ddb8490326511eaaca64f8f794265a0() {
      return data;
    };
  ...
  function _templateObject2_6ddb8490326511eaaca64f8f794265a0() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            <slot></slot>\n          "]);

    _templateObject2_6ddb8490326511eaaca64f8f794265a0 = function _templateObject2_6ddb8490326511eaaca64f8f794265a0() {
      return data;
    };
  ...
  function _templateObject_6ddb8490326511eaaca64f8f794265a0() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      ", "\n    "]);

    _templateObject_6ddb8490326511eaaca64f8f794265a0 = function _templateObject_6ddb8490326511eaaca64f8f794265a0() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(GlossaryTerm, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_6ddb8490326511eaaca64f8f794265a0(), this._fallback ? (0, _litElement.html)(_templateObject2_6ddb8490326511eaaca64f8f794265a0()) : "\n<lrn-vocab term=\"".concat(this.display, "\">\n  <div>").concat(this.definition, "</div>\n</lrn-vocab>\n"));
      ...
      //styles function
      get: function get() {
        return [(0, _litElement.css)(_templateObject3_6ddb8490326511eaaca64f8f794265a0())];
      }
    }, {
      key: "haxProperties",
      get: function get() {
