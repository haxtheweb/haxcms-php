define(["exports", "require", "../../lit-element/lit-element.js"], function (_exports, _require, _litElement) {
  ...
  function _templateObject3_f96019905a5b11ea9b0bfd873cbf79fd() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: inline-block;\n        }\n\n        :host([hidden]) {\n          display: none;\n        }\n\n        lrn-vocab {\n          display: inline;\n        }\n      "]);

    _templateObject3_f96019905a5b11ea9b0bfd873cbf79fd = function _templateObject3_f96019905a5b11ea9b0bfd873cbf79fd() {
      return data;
    };
  ...
  function _templateObject2_f96019905a5b11ea9b0bfd873cbf79fd() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            <slot></slot>\n          "]);

    _templateObject2_f96019905a5b11ea9b0bfd873cbf79fd = function _templateObject2_f96019905a5b11ea9b0bfd873cbf79fd() {
      return data;
    };
  ...
  function _templateObject_f96019905a5b11ea9b0bfd873cbf79fd() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      ", "\n    "]);

    _templateObject_f96019905a5b11ea9b0bfd873cbf79fd = function _templateObject_f96019905a5b11ea9b0bfd873cbf79fd() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(GlossaryTerm, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_f96019905a5b11ea9b0bfd873cbf79fd(), this._fallback ? (0, _litElement.html)(_templateObject2_f96019905a5b11ea9b0bfd873cbf79fd()) : "\n<lrn-vocab term=\"".concat(this.display, "\">\n  <div>").concat(this.definition, "</div>\n</lrn-vocab>\n"));
      ...
      //styles function
      get: function get() {
        return [(0, _litElement.css)(_templateObject3_f96019905a5b11ea9b0bfd873cbf79fd())];
      }
    }, {
      key: "haxProperties",
      get: function get() {
