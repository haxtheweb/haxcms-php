define(["exports","../../@polymer/polymer/polymer-element.js","../hax-body-behaviors/lib/HAXWiring.js","../lrn-vocab/lrn-vocab.js"],function(_exports,_polymerElement,_HAXWiring,_lrnVocab){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.GlossaryTerm=void 0;function _templateObject_5a0db020a1e511e99b64eb836207f42f(){var data=babelHelpers.taggedTemplateLiteral(["\n      <style>\n        :host {\n          display: inline-block;\n        }\n\n        :host([hidden]) {\n          display: none;\n        }\n\n        lrn-vocab {\n          display: inline;\n        }\n      </style>\n      <template is=\"dom-if\" if=\"[[!_fallback]]\">\n        <lrn-vocab term=\"[[display]]\">\n          <div>[[definition]]</div>\n        </lrn-vocab>\n      </template>\n      <template is=\"dom-if\" if=\"[[_fallback]]\">\n        <slot></slot>\n      </template>\n    "]);_templateObject_5a0db020a1e511e99b64eb836207f42f=function _templateObject_5a0db020a1e511e99b64eb836207f42f(){return data};return data}/**
 * `glossary-term`
 * ``
 *
...
get:function get(){return(0,_polymerElement.html)(_templateObject_5a0db020a1e511e99b64eb836207f42f())}// haxProperty definition
