define(["exports","../../@polymer/polymer/polymer-element.js","./lib/pouchdb.min.js"],function(_exports,_polymerElement,_pouchdbMin){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.PouchDb=void 0;function _templateObject_972cf740a1e511e99b64eb836207f42f(){var data=babelHelpers.taggedTemplateLiteral(["\n      <style>\n        :host {\n          display: block;\n        }\n\n        :host([hidden]) {\n          display: none;\n        }\n      </style>\n      <slot></slot>\n    "]);_templateObject_972cf740a1e511e99b64eb836207f42f=function _templateObject_972cf740a1e511e99b64eb836207f42f(){return data};return data}// register globally so we can make sure there is only one
...
get:function get(){return(0,_polymerElement.html)(_templateObject_972cf740a1e511e99b64eb836207f42f())}// properties available to the custom element for data binding
