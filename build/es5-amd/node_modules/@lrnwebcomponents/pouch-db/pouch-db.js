define(["exports", "../../@polymer/polymer/polymer-element.js", "./lib/pouchdb.min.js"], function (_exports, _polymerElement, _pouchdbMin) {
  ...
  function _templateObject_39057b00b53711e9aa40b7626f5cd426() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <style>\n        :host {\n          display: block;\n        }\n\n        :host([hidden]) {\n          display: none;\n        }\n      </style>\n      <slot></slot>\n    "]);

    _templateObject_39057b00b53711e9aa40b7626f5cd426 = function _templateObject_39057b00b53711e9aa40b7626f5cd426() {
      return data;
    };
  ...
  function (_PolymerElement) {
    ...
    babelHelpers.createClass(PouchDb, [{
        ...
        db.allDocs({
          ...
          processxAPI(doc.rows, function displayxAPI(mapxAPI) {
            processItems(mapxAPI, function display(backMap) {
              ...
              var _arr2 = Object.values(backMap);
      ...
      // render function
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_39057b00b53711e9aa40b7626f5cd426());
