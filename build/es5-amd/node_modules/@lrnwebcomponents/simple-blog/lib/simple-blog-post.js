 ...
 */var SimpleBlogPost=/*#__PURE__*/function(_PolymerElement){babelHelpers.inherits(SimpleBlogPost,_PolymerElement);babelHelpers.createClass(SimpleBlogPost,null,[{key:"tag",/**
...
},{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_da59d4e068f411e996b0af119cd7f5ea())}},{key:"properties",get:function get(){return{/**
   ...
   * Ready life cycle
   */}]);function SimpleBlogPost(){var _this;babelHelpers.classCallCheck(this,SimpleBlogPost);_this=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(SimpleBlogPost).call(this));new Promise(function(res,rej){return _require.default(["@lrnwebcomponents/haxcms-elements/lib/ui-components/active-item/site-active-title.js"],res,rej)});_this.__disposer=[];(0,_renderStatus.afterNextRender)(babelHelpers.assertThisInitialized(babelHelpers.assertThisInitialized(_this)),function(){var _this2=this;window.addEventListener("scroll",this._scrollListener.bind(this));(0,_mobxModule.autorun)(function(reaction){var fields=(0,_mobxModule.toJS)(_haxcmsSiteStore.store.activeItemFields);_this2.hasImage=_this2._computeHasImage(fields);if(_this2.hasImage){_this2.image=fields.images[0].src}_this2.__disposer.push(reaction)})});return _this}/**
