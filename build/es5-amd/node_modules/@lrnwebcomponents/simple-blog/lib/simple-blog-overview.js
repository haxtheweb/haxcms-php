define(["exports", "require", "../../../lit/index.js", "../../simple-colors/simple-colors.js"], function (_exports, _require, _index, _simpleColors) {
  ...
  var _templateObject_f3ae7200a0c911eda392efd0bad1b4bf, _templateObject2_f3ae7200a0c911eda392efd0bad1b4bf;
  ...
  var SimpleBlogOverview = /*#__PURE__*/function (_SimpleColors) {
    ...
    babelHelpers.createClass(SimpleBlogOverview, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_f3ae7200a0c911eda392efd0bad1b4bf || (_templateObject_f3ae7200a0c911eda392efd0bad1b4bf = babelHelpers.taggedTemplateLiteral(["\n      <a href=\"", "\" itemprop=\"url\" title=\"", "\">\n        <div class=\"card\">\n          <article\n            class=\"post\"\n            itemtype=\"http://schema.org/BlogPosting\"\n            role=\"article\"\n          >\n            <div class=\"article-item\">\n              <header class=\"post-header\">\n                <h3 class=\"post-title\" itemprop=\"name\">", "</h3>\n              </header>\n              <section class=\"post-excerpt\" itemprop=\"description\">\n                <p>", "</p>\n              </section>\n              <div class=\"post-meta\">\n                <simple-datetime\n                  format=\"M jS, Y\"\n                  timestamp=\"", "\"\n                  unix=\"\"\n                ></simple-datetime>\n              </div>\n            </div>\n          </article>\n        </div>\n      </a>\n    "])), this.link, this.title, this.title, this.description, this.changed);
      }
      /**
       ...
       */
      function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(SimpleBlogOverview), "styles", this)), [(0, _index.css)(_templateObject2_f3ae7200a0c911eda392efd0bad1b4bf || (_templateObject2_f3ae7200a0c911eda392efd0bad1b4bf = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n          outline: none;\n          text-transform: none;\n        }\n        div.card {\n          box-shadow: 0 5px 5px rgba(0, 0, 0, 0.7);\n          padding: 32px 16px;\n          margin: 0;\n          min-width: unset;\n          width: 100%;\n          background-color: transparent;\n        }\n        .post-title {\n          letter-spacing: -0.32px;\n          font-weight: 700;\n          font-style: normal;\n          display: block;\n          font-size: 28px;\n          line-height: 1.1;\n          margin: 0;\n        }\n        .post-title a {\n          text-decoration: none;\n          color: #333332;\n        }\n        .post-excerpt,\n        simple-datetime {\n          letter-spacing: -0.32px;\n          font-weight: 300;\n          font-style: normal;\n          font-size: 16px;\n          line-height: 1.3;\n          color: var(--simple-colors-default-theme-grey-10);\n        }\n        .post-excerpt p {\n          text-transform: none;\n        }\n        :host([elevation=\"2\"]) .post-excerpt,\n        :host([elevation=\"2\"]) simple-datetime {\n          color: var(--simple-colors-default-theme-grey-12);\n          box-shadow: 0 10px 10px rgba(0, 0, 0, 0.7);\n        }\n        .post-meta {\n          font-size: 14px;\n          color: #b3b3b1;\n          line-height: 30px;\n        }\n        a,\n        a:visited,\n        a:hover,\n        a:focus,\n        a:active {\n          color: inherit;\n        }\n      "])))]);
      }
      /**
