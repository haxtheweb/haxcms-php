define(["exports", "require", "../../lit/index.js", "../haxcms-elements/lib/core/HAXCMSLitElementTheme.js", "../haxcms-elements/lib/core/haxcms-site-store.js", "../../mobx/dist/mobx.esm.js", "../simple-colors/simple-colors.js", "./lib/simple-blog-post.js", "../../@polymer/iron-pages/iron-pages.js", "../anchor-behaviors/anchor-behaviors.js", "../simple-icon/simple-icon.js", "../simple-icon/lib/simple-icons.js", "../simple-icon/lib/simple-icon-button.js"], function (_exports, _require, _index, _HAXCMSLitElementTheme, _haxcmsSiteStore, _mobxEsm, _simpleColors, _simpleBlogPost, _ironPages, _anchorBehaviors, _simpleIcon, _simpleIcons, _simpleIconButton) {
  ...
  var _templateObject_e6a8aac0e4f411ed85766367b4d3e9fc, _templateObject2_e6a8aac0e4f411ed85766367b4d3e9fc;
  ...
  var SimpleBlog = /*#__PURE__*/function (_SimpleColorsSuper) {
    ...
    babelHelpers.createClass(SimpleBlog, [{
       ...
       */
      function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(SimpleBlog), "styles", this)), [(0, _index.css)(_templateObject2_e6a8aac0e4f411ed85766367b4d3e9fc || (_templateObject2_e6a8aac0e4f411ed85766367b4d3e9fc = babelHelpers.taggedTemplateLiteral(["\n        html,\n        body {\n          background-color: #fafafa;\n        }\n        :host {\n          display: block;\n          font-family: \"Roboto\", \"Noto\", sans-serif;\n          -webkit-font-smoothing: antialiased;\n          font-size: 14px;\n          background-color: #fafafa;\n          font-family: \"Open Sans\", \"MundoSans\", helvetica neue, Arial,\n            Helvetica, sans-serif;\n          margin: 0;\n          padding: 0;\n          text-rendering: optimizeLegibility;\n          -webkit-font-smoothing: antialiased;\n          -moz-font-feature-settings: \"liga=1, dlig=1\";\n          -ms-font-feature-settings: \"liga\", \"dlig\";\n          -webkit-font-feature-settings: \"liga\", \"dlig\";\n          -o-font-feature-settings: \"liga\", \"dlig\";\n          font-feature-settings: \"liga\", \"dlig\";\n        }\n        #backbutton {\n          position: fixed;\n          top: 0px;\n          left: 0px;\n          padding: 2px;\n          width: 40px;\n          height: 40px;\n          margin: 8px;\n          z-index: 1000;\n          color: black;\n          background-color: rgba(250, 250, 250, 0.5);\n          opacity: 0.5;\n          border-radius: 50%;\n          transition: all 0.6s linear;\n        }\n        #backbutton:focus,\n        #backbutton:hover {\n          opacity: 1;\n          color: white;\n          background-color: var(--haxcms-color, black);\n        }\n        iron-pages,\n        iron-pages section {\n          width: 100vw;\n          height: 100vh;\n        }\n        simple-blog-post {\n          transition: all 0.6s ease-in-out;\n          visibility: hidden;\n        }\n        :host([selected-page=\"0\"]) simple-blog-post {\n          opacity: 0;\n          visibility: hidden;\n        }\n        :host([selected-page=\"1\"]) simple-blog-post {\n          visibility: visible;\n          opacity: 1;\n        }\n        a,\n        a:active,\n        a:hover,\n        a:focus {\n          color: inherit;\n        }\n      "])))]);
      }
      /**
