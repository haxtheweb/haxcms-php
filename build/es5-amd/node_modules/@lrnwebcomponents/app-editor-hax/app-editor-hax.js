define(["exports","../../@polymer/polymer/polymer-element.js","../../@polymer/polymer/lib/utils/render-status.js","../h-a-x/h-a-x.js"],function(_exports,_polymerElement,_renderStatus,_hAX){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.AppEditorHax=void 0;function _templateObject_a4d08990869511e990457be562d9e9a6(){var data=babelHelpers.taggedTemplateLiteral(["\n      <style>\n        :host {\n          display: block;\n          font-size: 16px;\n          box-sizing: content-box;\n        }\n      </style>\n      <h-a-x app-store$=\"[[appStoreConnection]]\"></h-a-x>\n    "]);_templateObject_a4d08990869511e990457be562d9e9a6=function _templateObject_a4d08990869511e990457be562d9e9a6(){return data};return data}/**
`app-editor-hax`
...
this.dispatchEvent(new CustomEvent("app-editor-hax-import",{bubbles:!0,cancelable:!0,composed:!0,detail:!0}))}}],[{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_a4d08990869511e990457be562d9e9a6())}},{key:"tag",get:function get(){return"app-editor-hax"}},{key:"properties",get:function get(){return{/**
