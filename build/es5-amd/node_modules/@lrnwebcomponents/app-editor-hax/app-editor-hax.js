define(["exports", "../../lit-element/lit-element.js", "../h-a-x/h-a-x.js", "../hax-body/lib/hax-store.js"], function (_exports, _litElement, _hAX, _haxStore) {
  ...
  function _templateObject2_0cde72f03ee511ebb7f7a1171f0cd59d() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n          font-size: 16px;\n          box-sizing: content-box;\n        }\n      "]);

    _templateObject2_0cde72f03ee511ebb7f7a1171f0cd59d = function _templateObject2_0cde72f03ee511ebb7f7a1171f0cd59d() {
      return data;
    };
  ...
  function _templateObject_0cde72f03ee511ebb7f7a1171f0cd59d() {
    var data = babelHelpers.taggedTemplateLiteral([" <h-a-x .app-store=\"", "\"></h-a-x> "]);

    _templateObject_0cde72f03ee511ebb7f7a1171f0cd59d = function _templateObject_0cde72f03ee511ebb7f7a1171f0cd59d() {
      return data;
    };
  ...
  var AppEditorHax = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(AppEditorHax, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_0cde72f03ee511ebb7f7a1171f0cd59d(), this.appStoreConnection);
      }
    }, {
      key: "save",
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_0cde72f03ee511ebb7f7a1171f0cd59d())];
      }
    }, {
      key: "tag",
      get: function get() {
