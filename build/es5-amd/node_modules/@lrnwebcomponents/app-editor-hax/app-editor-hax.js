define(["exports", "../../@polymer/polymer/polymer-element.js", "../../@polymer/polymer/lib/utils/render-status.js", "../h-a-x/h-a-x.js"], function (_exports, _polymerElement, _renderStatus, _hAX) {
  ...
  function _templateObject_9aaffb40db0311e9a15421ff51d8fbc4() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <style>\n        :host {\n          display: block;\n          font-size: 16px;\n          box-sizing: content-box;\n        }\n      </style>\n      <h-a-x app-store$=\"[[appStoreConnection]]\"></h-a-x>\n    "]);

    _templateObject_9aaffb40db0311e9a15421ff51d8fbc4 = function _templateObject_9aaffb40db0311e9a15421ff51d8fbc4() {
      return data;
    };
  ...
  */
  ...
  function (_PolymerElement) {
    ...
    babelHelpers.createClass(AppEditorHax, [{
      ...
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_9aaffb40db0311e9a15421ff51d8fbc4());
      }
    }, {
      key: "tag",
      get: function get() {
