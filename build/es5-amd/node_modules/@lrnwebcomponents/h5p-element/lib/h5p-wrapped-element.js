define(["exports", "../../haxcms-elements/lib/core/haxcms-site-store.js", "../../../@polymer/polymer/lib/utils/flattened-nodes-observer.js", "../../../lit/index.js", "../../../mobx/dist/mobx.esm.js", "../../iframe-loader/iframe-loader.js"], function (_exports, _haxcmsSiteStore, _flattenedNodesObserver, _index, _mobxEsm, _iframeLoader) {
  ...
  var _templateObject_1d7c3b60669311ed886745d23fee48e5, _templateObject2_1d7c3b60669311ed886745d23fee48e5, _templateObject3_1d7c3b60669311ed886745d23fee48e5, _templateObject4_1d7c3b60669311ed886745d23fee48e5;
  ...
  var H5pWrappedElement = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(H5pWrappedElement, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_1d7c3b60669311ed886745d23fee48e5 || (_templateObject_1d7c3b60669311ed886745d23fee48e5 = babelHelpers.taggedTemplateLiteral(["\n      <div part=\"container\" class=\"", "\">\n        ", "\n      </div>\n    "])), this.__editMode ? "editing" : "editing", this.__editMode ? (0, _index.html)(_templateObject2_1d7c3b60669311ed886745d23fee48e5 || (_templateObject2_1d7c3b60669311ed886745d23fee48e5 = babelHelpers.taggedTemplateLiteral(["\n              <slot></slot>\n              <div part=\"edit-screen\">\n                <div part=\"source-link\">\n                  <a part=\"anchor\" href=\"", "\" target=\"_blank\"\n                    >Edit H5P Source</a\n                  >\n                </div>\n              </div>\n            "])), this.__editLink) : (0, _index.html)(_templateObject3_1d7c3b60669311ed886745d23fee48e5 || (_templateObject3_1d7c3b60669311ed886745d23fee48e5 = babelHelpers.taggedTemplateLiteral(["\n              <iframe-loader><slot></slot></iframe-loader>\n            "]))));
      }
    }], [{
      key: "properties",
      get: function get() {
      ...
      key: "styles",
      get: function get() {
        return (0, _index.css)(_templateObject4_1d7c3b60669311ed886745d23fee48e5 || (_templateObject4_1d7c3b60669311ed886745d23fee48e5 = babelHelpers.taggedTemplateLiteral(["\n      :host {\n        display: block;\n      }\n      :host [part=\"container\"] {\n        display: block;\n        position: relative;\n      }\n      .editing[part=\"container\"] {\n        min-height: 100px;\n      }\n      :host [part=\"edit-screen\"] {\n        position: absolute;\n        left: 0;\n        top: 0;\n        width: 100%;\n        height: 100%;\n        display: flex;\n        align-items: flex-end;\n        justify-content: flex-end;\n      }\n      :host [part=\"source-link\"] a {\n        background: black;\n        color: white;\n        padding: 1em;\n      }\n      :host [part=\"anchor\"] {\n        display: block;\n      }\n    "])));
      }
    }]);
