define(["exports", "meta", "../../lit-element/lit-element.js", "../../@polymer/polymer/lib/utils/resolve-url.js", "../hax-body-behaviors/lib/HAXWiring.js", "../es-global-bridge/es-global-bridge.js"], function (_exports, meta, _litElement, _resolveUrl, _HAXWiring, _esGlobalBridge) {
  "use strict";
  ...
  function _templateObject_62d6fae0becd11e9854ec335faa90bd4() {
    var data = babelHelpers.taggedTemplateLiteral(["\n<style>:host {\n  display: block;\n}</style>\n<div class=\"h5p-container\" data-content-id=\"wrapper-", "\"></div>"]);

    _templateObject_62d6fae0becd11e9854ec335faa90bd4 = function _templateObject_62d6fae0becd11e9854ec335faa90bd4() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(H5PElement, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_62d6fae0becd11e9854ec335faa90bd4(), this.contentId);
    ...
    function H5PElement() {
      ...
      _this = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(H5PElement).call(this));
      _this.HAXWiring = new _HAXWiring.HAXWiring();

      _this.HAXWiring.setup(H5PElement.haxProperties, H5PElement.tag, babelHelpers.assertThisInitialized(_this)); // make a random ID for the targeting
    ...
    babelHelpers.createClass(H5PElement, [{
      ...
      value: function () {
        ...
        regeneratorRuntime.mark(function _callee3() {
          var id,
              displayOptions,
              _displayOptions$frame,
              _displayOptions$copyr,
              _displayOptions$embed,
              _displayOptions$downl,
              _displayOptions$icon,
              _displayOptions$expor,
              basePath,
              frag,
              stand,
              _args3 = arguments;
            ...
            while (1) {
              switch (_context3.prev = _context3.next) {
                case 0:
                  ...
                  _displayOptions$frame = displayOptions.frame;
                  displayOptions.frame = _displayOptions$frame === void 0 ? false : _displayOptions$frame;
                  _displayOptions$copyr = displayOptions.copyright;
                  displayOptions.copyright = _displayOptions$copyr === void 0 ? false : _displayOptions$copyr;
                  _displayOptions$embed = displayOptions.embed;
                  displayOptions.embed = _displayOptions$embed === void 0 ? false : _displayOptions$embed;
                  _displayOptions$downl = displayOptions.download;
                  displayOptions.download = _displayOptions$downl === void 0 ? false : _displayOptions$downl;
                  _displayOptions$icon = displayOptions.icon;
                  displayOptions.icon = _displayOptions$icon === void 0 ? false : _displayOptions$icon;
                  _displayOptions$expor = displayOptions.export;
                  displayOptions.export = _displayOptions$expor === void 0 ? false : _displayOptions$expor;
                  basePath = (0, _resolveUrl.pathFromUrl)(decodeURIComponent(meta.url)) + "lib/h5p/";
                  H5PIntegration.core = {
                  ...
                  _context3.next = 20;
                  return new H5PStandalone(id, this.source, displayOptions);

                case 20:
                  stand = _context3.sent;
                  _context3.next = 23;
                  return stand.init();
