define(["exports", "../../lit/index.js"], function (_exports, _index) {
  ...
  var _templateObject_d4f9fea0e4f411ed85766367b4d3e9fc, _templateObject2_d4f9fea0e4f411ed85766367b4d3e9fc;
  ...
  var ServiceCard = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(ServiceCard, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_d4f9fea0e4f411ed85766367b4d3e9fc || (_templateObject_d4f9fea0e4f411ed85766367b4d3e9fc = babelHelpers.taggedTemplateLiteral(["\n      <div class=\"card\">\n        <div class=\"container\">\n          <img\n            loading=\"lazy\"\n            class=\"avatar\"\n            src=\"", "\"\n            alt=\"", "\"\n          />\n          <h3 class=\"title\"><b>", "</b></h3>\n          <p class=\"info\"><slot></slot></p>\n        </div>\n      </div>\n    "])), this.source, this.alt, this.title);
      }
    }], [{
      key: "tag",
      get: function get() {
      ...
      key: "styles",
      get: function get() {
        return (0, _index.css)(_templateObject2_d4f9fea0e4f411ed85766367b4d3e9fc || (_templateObject2_d4f9fea0e4f411ed85766367b4d3e9fc = babelHelpers.taggedTemplateLiteral(["\n      :host {\n        display: inline-flex;\n        margin: 16px;\n      }\n      .card {\n        box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2);\n        transition: 0.3s all ease-in-out;\n        width: var(--service-card-card-width, 300px);\n      }\n      .card:hover {\n        box-shadow: 0 8px 16px 0 rgba(0, 0, 0, 0.2);\n      }\n      .container {\n        padding: 2px 2px 2px 2px;\n      }\n      .avatar {\n        border-radius: 50%;\n        width: calc(var(--service-card-card-width, 300px) - 10px);\n        padding: 5px;\n      }\n      .title {\n        padding: 4px 4px 4px 4px;\n        text-align: center;\n        font-family: \"Courier New\", courier, sans-serif;\n      }\n      .info {\n        padding: 4px 4px 4px 4px;\n        height: 125px;\n        overflow-y: auto;\n      }\n    "])));
      }
    }]);
    return ServiceCard;
  }(_index.LitElement);
