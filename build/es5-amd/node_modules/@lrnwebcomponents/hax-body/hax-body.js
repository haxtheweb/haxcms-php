define(["exports", "require", "../../lit-element/lit-element.js", "../simple-colors/simple-colors.js", "../utils/utils.js"], function (_exports, _require, _litElement, _simpleColors, _utils) {
  ...
  function _templateObject2_8a864c605a4211eab75e27ebd06b761e() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <div id=\"bodycontainer\" class=\"ignore-activation\">\n        <slot id=\"body\"></slot>\n      </div>\n      <hax-text-context\n        id=\"textcontextmenu\"\n        class=\"hax-context-menu ignore-activation\"\n      ></hax-text-context>\n      <hax-ce-context\n        id=\"cecontextmenu\"\n        class=\"hax-context-menu ignore-activation\"\n      ></hax-ce-context>\n      <hax-plate-context\n        id=\"platecontextmenu\"\n        class=\"hax-context-menu ignore-activation\"\n      ></hax-plate-context>\n    "]);

    _templateObject2_8a864c605a4211eab75e27ebd06b761e = function _templateObject2_8a864c605a4211eab75e27ebd06b761e() {
      return data;
    };
  ...
  function _templateObject_8a864c605a4211eab75e27ebd06b761e() {
    ...
    _templateObject_8a864c605a4211eab75e27ebd06b761e = function _templateObject_8a864c605a4211eab75e27ebd06b761e() {
      return data;
    };
  ...
  function (_SimpleColors) {
    ...
    babelHelpers.createClass(HaxBody, null, [{
       ...
       */
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(HaxBody), "styles", this)), [(0, _litElement.css)(_templateObject_8a864c605a4211eab75e27ebd06b761e())]);
      }
      /**
       * HTMLElement
       */
    ...
    babelHelpers.createClass(HaxBody, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_8a864c605a4211eab75e27ebd06b761e());
      }
      /**
        ...
        if (!this.openDrawer && this.editMode) {
          ...
          this.__contextVisibleLock = setTimeout(function () {
            ...
            if (el) {
              ...
              var rect = _this6.activeNode.getBoundingClientRect();

              _this6._positionContextMenu(_this6.shadowRoot.querySelector("#platecontextmenu"), _this6.activeNode, rect.width - _this6.shadowRoot.querySelector("#platecontextmenu").getBoundingClientRect().width + 2, -28);
            }
          }, 10);
        }
      }
      ...
      value: function haxDuplicateNode(node) {
        ...
        setTimeout(function () {
          ...
          if (parent === _this12) {
            window.HaxStore.write("activeContainerNode", nodeClone, _this12);
          }

          window.HaxStore.write("activeNode", nodeClone, _this12);
        }, 100);
        return true;
      }
      /**
      ...
      value: function positionContextMenus() {
        ...
        if (node && !window.HaxStore.instance._lockContextPosition) {
          ...
          if (babelHelpers.typeof(props) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined)) && !window.HaxStore.instance.isTextElement(node)) {
            ...
            var textRect = this.shadowRoot.querySelector("#textcontextmenu").getBoundingClientRect();
      ...
      value: function haxDeleteNode(node) {
        ...
        this.hideContextMenus();
        setTimeout(function () {
          _this15.activeNode = null;
          _this15.activeContainerNode = null;
          window.HaxStore.write("activeNode", null, _this15);
          window.HaxStore.write("activeContainerNode", null, _this15);
          ...
          while (fragment.firstChild !== null) {
            if (babelHelpers.typeof(fragment.firstChild.tagName) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {
              ...
              if (window.HaxStore.instance._isSandboxed && fragment.firstChild.tagName.toLowerCase() === "iframe") {
                ...
                _this16.appendChild(replacement);
              } else {
                _this16.appendChild(fragment.firstChild);
              }
            } else {
        ...
        if (!this.openDrawer && this.editMode && !this.__tabTrap) {
          ...
          if (this._validElementTest(containerNode) && containerNode.parentNode && containerNode.parentNode.tagName) {
            ...
            if (this.activeNode !== activeNode && !activeNode.classList.contains("ignore-activation")) {
              ...
              setTimeout(function () {
                _this18.positionContextMenus(activeNode, activeNode);
              }, 0);
              stopProp = true;
            }
          }
      ...
      value: function _editModeChanged(newValue, oldValue) {
        ...
        if (babelHelpers.typeof(oldValue) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {
          ...
          if (newValue) {
            ...
            setTimeout(function () {
              if (_this19.children && _this19.children[0] && _this19.children[0].focus) {
                _this19.activeNode = _this19.children[0];
                _this19.activeContainerNode = _this19.activeNode;
                window.HaxStore.write("activeNode", _this19.children[0], _this19);
                window.HaxStore.write("activeContainerNode", _this19.children[0], _this19);
                setTimeout(function () {
                  if (window.HaxStore.instance.isTextElement(_this19.activeNode)) {
                    try {
                      var range = document.createRange();
                      var sel = window.HaxStore.getSelection();
                      range.setStart(_this19.activeNode, 0);
                      range.collapse(true);
                      sel.removeAllRanges();
                      sel.addRange(range);

                      _this19.activeNode.focus();
                    } catch (e) {
                      console.warn(e);
                    }
                ...
                setTimeout(function () {
                  try {
                    ...
                    _this19.activeContainerNode = _this19.activeNode;
                    window.HaxStore.write("activeContainerNode", _this19.activeContainerNode, _this19);
                  } catch (e) {
                    console.warn(e);
                  }
      ...
      value: function dropEvent(e) {
        ...
        if (!this.openDrawer && this.editMode) {
          ...
          setTimeout(function () {
            var children = _this20.querySelectorAll(".hax-mover, .hax-hovered, .hax-moving, .grid-plate-active-item");
      ...
      value: function _activeNodeChanged(newValue, oldValue) {
        ...
        if (this.editMode && babelHelpers.typeof(newValue) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined)) && newValue !== null) {
          ...
          if (window.HaxStore.instance.isTextElement(newValue) || window.HaxStore.instance.isGridPlateElement(newValue)) {
            newValue.setAttribute("contenteditable", true);
            this.setAttribute("contenteditable", true);
            this.shadowRoot.querySelector("#textcontextmenu").classList.remove("hax-context-visible", "hax-active-hover", "hax-context-pin-top");
            this.shadowRoot.querySelector("#cecontextmenu").classList.remove("hax-context-visible", "hax-active-hover", "hax-context-pin-top");
            this.shadowRoot.querySelector("#platecontextmenu").classList.remove("hax-context-visible", "hax-active-hover", "hax-context-pin-top"); // position the operations / in context element
            ...
            this.__positionContextTimer = setTimeout(function () {
              if (newValue === _this21.activeNode) {
                _this21.positionContextMenus(newValue);

                _this21._keepContextVisible();
              }
            }, 10);
          } else {
            newValue.removeAttribute("contenteditable");
