define(["exports", "meta", "require", "../../lit-element/lit-element.js", "../simple-colors/simple-colors.js", "../undo-manager/undo-manager.js", "./lib/hax-store.js", "../../mobx/dist/mobx.esm.js", "../utils/utils.js", "./lib/hax-ui-styles.js", "../i18n-manager/lib/I18NMixin.js"], function (_exports, meta, _require, _litElement, _simpleColors, _undoManager, _haxStore, _mobxEsm, _utils, _haxUiStyles, _I18NMixin2) {
  "use strict";
  ...
  function _templateObject2_fd4e848099af11eb851ed31c596cbbd8() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <div id=\"bodycontainer\" class=\"ignore-activation\">\n        <slot id=\"body\"></slot>\n      </div>\n      <hax-text-context \n        id=\"textcontextmenu\"\n        class=\"hax-context-menu ignore-activation\"\n        .activeNode=\"", "\"\n      ></hax-text-context>\n      <hax-ce-context\n        id=\"cecontextmenu\"\n        class=\"hax-context-menu ignore-activation\"\n        .activeNode=\"", "\"\n      ></hax-ce-context>\n      <hax-plate-context\n        id=\"platecontextmenu\"\n        class=\"hax-context-menu ignore-activation\"\n        ></hax-plate-context>\n      </hax-context-container>\n      <hax-context-container\n        id=\"addincontext\"\n        class=\"hax-context-menu ignore-activation\">\n        <hax-context-item\n          icon=\"icons:add\"\n          label=\"", "\"\n          show-text-label\n        >\n        </hax-context-item>\n      </hax-context-container>\n    "]);

    _templateObject2_fd4e848099af11eb851ed31c596cbbd8 = function _templateObject2_fd4e848099af11eb851ed31c596cbbd8() {
      return data;
    };
  ...
  function _templateObject_fd4e848099af11eb851ed31c596cbbd8() {
    ...
    _templateObject_fd4e848099af11eb851ed31c596cbbd8 = function _templateObject_fd4e848099af11eb851ed31c596cbbd8() {
      return data;
    };
  ...
  var HaxBody = /*#__PURE__*/function (_I18NMixin) {
    ...
    babelHelpers.createClass(HaxBody, null, [{
      ...
      key: "styles",
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(HaxBody), "styles", this)), [(0, _litElement.css)(_templateObject_fd4e848099af11eb851ed31c596cbbd8())]);
      }
      /**
       * HTMLElement
       */
    ...
    function HaxBody() {
      ...
      setTimeout(function () {
        new Promise(function (res, rej) {
          return _require.default(["./lib/hax-context-container.js"], res, rej);
        });
        new Promise(function (res, rej) {
    ...
    babelHelpers.createClass(HaxBody, [{
        ...
        if (this.editMode && _haxStore.HAXStore.ready) {
          ...
          this.__mouseQuickTimer = setTimeout(function () {
            if (_this2.__activeHover && _this2.__activeHover != eventPath[0].closest("[data-hax-ray]:not(li)") && !eventPath[0].closest("#addincontext")) {
              ...
              if (!keep) {
                ...
                _this2.classList.remove("hax-add-content-visible");
              }
            }
          }, 300);
          clearTimeout(this.__mouseTimer);
          this.__mouseTimer = setTimeout(function () {
            ...
            if (target) {
              ...
              _this2.classList.add("hax-add-content-visible");
              ...
              if (!eventPath[0].closest(".column:not(.has-nodes")) {
                ...
                _this2.__slot = eventPath[0].closest(".column").getAttribute("id").replace("col", "col-");
                _this2.__activeHover = eventPath[0].closest(".column").parentNode.parentNode.host; // we focus on the column unlike anything else
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_fd4e848099af11eb851ed31c596cbbd8(), this.activeNode, this.activeNode, this.t.addContent);
      }
      /**
      ...
      value: function _addInContextClick(e) {
        ...
        if (this.__activeHover && this.__activeHover.parentNode && ["ul", "ol"].includes(this.__activeHover.parentNode.tagName.toLowerCase())) {
        ...
        this.__slotInGrid = false; // drop active hover to reset state
      ...
      value: function () {
        var _replaceElementWorkflow = babelHelpers.asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5() {
          var activeNode,
              testOnly,
              element,
              type,
            ...
            while (1) {
              switch (_context5.prev = _context5.next) {
                ...
                case 5:
                  ...
                  return _context5.abrupt("return", haxElements);
      ...
      key: "haxToContent",
      value: function () {
        var _haxToContent = babelHelpers.asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6() {
            ...
            while (1) {
              switch (_context6.prev = _context6.next) {
                ...
                case 6:
                  ...
                  _context6.t0 = content;
                  _context6.next = 14;
                  return _haxStore.HAXStore.nodeToContent(children[i]);

                case 14:
                  content = _context6.t0 += _context6.sent;
                ...
                case 25:
                  ...
                  _context6.t1 = content;
                  _context6.next = 30;
                  return _haxStore.HAXStore.nodeToContent(tmp);

                case 30:
                  content = _context6.t1 += _context6.sent;
                  _context6.next = 37;
                  break;
                ...
                case 36:
                  content = _context6.t2 += _context6.sent;
      ...
      value: function () {
        var _haxDuplicateNode = babelHelpers.asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(node) {
            ...
            if (!_haxStore.HAXStore._lockContextPosition) {
              ...
              if (babelHelpers.typeof(props) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined)) && !_haxStore.HAXStore.isTextElement(node)) {
                ...
                if (props.editingElement == "core") {
                  _this11._positionContextMenu(_this11.contextMenus.ce, node, 0, -30);
                } else {
                ...
                _this11._positionContextMenu(_this11.contextMenus.text, node, 0); // text menu can expand based on selection
              ...
              if (!props || props.editingElement == "core") {
                ...
                if (_this11.activeNode && (_this11.activeNode.tagName === "LI" || _this11._HTMLInlineTextDecorationTest(_this11.activeNode))) {
                  _this11._hideContextMenu(_this11.contextMenus.plate);
                    ...
                    _this11._positionContextMenu(_this11.contextMenus.plate, node, activeRect.width - _this11.contextMenus.plate.getBoundingClientRect().width + 1, -30);
                  }
              } else {
                setTimeout(function () {
                  if (node && node.parentNode) {
                    ...
                    _this11._positionContextMenu(_this11.contextMenus.plate, node.parentNode, _activeRect2.width - _this11.contextMenus.plate.getBoundingClientRect().width + 1, -30);
                  }
                }, 250);
              }
            }
      ...
      key: "haxGridPlateOps",
      value: function () {
        var _haxGridPlateOps = babelHelpers.asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8() {
          var add,
              side,
              node,
              changed,
          ...
          return regeneratorRuntime.wrap(function _callee8$(_context8) {
            while (1) {
              switch (_context8.prev = _context8.next) {
                case 0:
                  add = _args8.length > 0 && _args8[0] !== undefined ? _args8[0] : true;
                  side = _args8.length > 1 && _args8[1] !== undefined ? _args8[1] : "right";
                  node = _args8.length > 2 && _args8[2] !== undefined ? _args8[2] : this.activeNode;
                  ...
                  _context8.t0 = node.layout;
                  _context8.next = _context8.t0 === "1" ? 9 : _context8.t0 === "1-1" ? 12 : _context8.t0 === "1-1-1" ? 15 : _context8.t0 === "1-1-1-1" ? 18 : _context8.t0 === "1-1-1-1-1" ? 21 : 24;
                  break;
                ...
                case 26:
                  _context8.t1 = node.layout;
                  _context8.next = _context8.t1 === "1-1" ? 29 : _context8.t1 === "1-1-1" ? 35 : _context8.t1 === "1-1-1-1" ? 38 : _context8.t1 === "1-1-1-1-1" ? 41 : _context8.t1 === "1-1-1-1-1-1" ? 44 : 47;
                  break;
      ...
      value: function () {
        var _haxContextOperation2 = babelHelpers.asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9(e) {
          var _this13 = this;
            ...
            while (1) {
              switch (_context9.prev = _context9.next) {
                case 0:
                  ...
                  _context9.t0 = detail.eventName;
                  _context9.next = _context9.t0 === "insert-above-active" ? 4 : _context9.t0 === "insert-below-active" ? 6 : _context9.t0 === "hax-source-view-toggle" ? 8 : _context9.t0 === "hax-full-text-editor-toggle" ? 36 : _context9.t0 === "text-tag" ? 52 : _context9.t0 === "text-tag-ul" ? 55 : _context9.t0 === "text-tag-ol" ? 59 : _context9.t0 === "text-align-left" ? 63 : _context9.t0 === "hax-transform-node" ? 65 : _context9.t0 === "hax-plate-create-right" ? 67 : _context9.t0 === "hax-plate-remove-right" ? 69 : _context9.t0 === "hax-plate-duplicate" ? 71 : _context9.t0 === "hax-plate-delete" ? 73 : _context9.t0 === "hax-plate-up" ? 75 : _context9.t0 === "hax-plate-down" ? 77 : 79;
                  break;
      ...
      value: function () {
        var _editModeChanged2 = babelHelpers.asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee10(newValue, oldValue) {
          var _this17 = this;
      ...
      value: function () {
        var _activeNodeChanged2 = babelHelpers.asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee11(newValue, oldValue) {
        ...
        function _activeNodeChanged(_x8, _x9) {
