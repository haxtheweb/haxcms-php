...
info.removedNodes.map(function(node){if(_this2._haxElementTest(node)&&!node.classList.contains("hax-active")){_this2.dispatchEvent(new CustomEvent("hax-body-tag-removed",{bubbles:!0,cancelable:!0,composed:!0,detail:{node:node}}))}})}})})}/**
   ...
   */},{key:"connectedCallback",value:function connectedCallback(){babelHelpers.get(babelHelpers.getPrototypeOf(HaxBody.prototype),"connectedCallback",this).call(this);(0,_renderStatus.afterNextRender)(this,function(){// try to normalize paragraph insert on enter
...
this.$.textcontextmenu.highlightOps=!1}/**
   ...
   */},{key:"positionContextMenus",value:function positionContextMenus(node,container){var tag=node.tagName.toLowerCase();if(window.HaxStore.instance._isSandboxed&&"webview"===tag){tag="iframe"}var props=window.HaxStore.instance.elementList[tag];// try and work against anything NOT a P tag
