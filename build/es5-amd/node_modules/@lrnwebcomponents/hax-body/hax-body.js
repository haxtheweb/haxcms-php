define(["exports", "meta", "require", "../../lit/index.js", "../simple-colors/simple-colors.js", "../undo-manager/undo-manager.js", "./lib/hax-store.js", "../../mobx/dist/mobx.esm.js", "./lib/hax-text-editor-toolbar.js", "../utils/utils.js", "./lib/hax-ui-styles.js", "../i18n-manager/lib/I18NMixin.js", "../absolute-position-behavior/absolute-position-behavior.js", "../simple-icon/lib/simple-icons.js", "../simple-icon/lib/simple-iconset.js", "./lib/hax-context-behaviors.js", "./lib/hax-plate-context.js", "../grid-plate/grid-plate.js", "../media-image/media-image.js", "../super-daemon/super-daemon.js"], function (_exports, meta, _require, _index, _simpleColors, _undoManager, _haxStore, _mobxEsm, _haxTextEditorToolbar, _utils, _haxUiStyles, _I18NMixin2, _absolutePositionBehavior, _simpleIcons, _simpleIconset, _haxContextBehaviors, _haxPlateContext, _gridPlate, _mediaImage, _superDaemon) {
  ...
  var _templateObject_dc817c20e4f411ed85766367b4d3e9fc, _templateObject2_dc817c20e4f411ed85766367b4d3e9fc, _templateObject3_dc817c20e4f411ed85766367b4d3e9fc;
  ...
  var HaxBody = /*#__PURE__*/function (_I18NMixin) {
    ...
    function HaxBody() {
      ...
      (0, _mobxEsm.autorun)(function () {
        ...
        if (_this.activeNode && _this.activeNode.setAttribute) {
          _this.activeNode.setAttribute("data-hax-active", "data-hax-active");
        }
      });
      (0, _mobxEsm.autorun)(function () {
    ...
    babelHelpers.createClass(HaxBody, [{
          ...
          this.__mouseTimer = setTimeout(function () {
            ...
            if (target) {
              ...
              if (!eventPath[0].closest("[data-move-order]:not(.has-nodes")) {
                ...
                _this2.__slot = eventPath[0].closest("[data-move-order]").getAttribute("id").replace("col", "col-");
      ...
      value: function _mouseDown(e) {
        if (this.editMode) {
          ...
          } else if (_haxStore.HAXStore.validTagList.includes(target.tagName.toLowerCase())) {
      ...
      key: "scrollerFixclickEvent",
      value: function scrollerFixclickEvent(e) {
        this._useristyping = false;
      ...
      key: "revealMenuIfHidden",
      value: function revealMenuIfHidden(e) {
        this._useristyping = false;
        this.positionContextMenus();
      }
      /**
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_dc817c20e4f411ed85766367b4d3e9fc || (_templateObject_dc817c20e4f411ed85766367b4d3e9fc = babelHelpers.taggedTemplateLiteral(["\n      <style id=\"hax-body-style-element\"></style>\n      <div\n        id=\"bodycontainer\"\n        class=\"ignore-activation\"\n        element-align=\"", "\"\n      >\n        <slot id=\"body\"></slot>\n      </div>\n      <absolute-position-behavior\n        id=\"topcontext\"\n        fit-to-visible-bounds\n        justify\n        position=\"top\"\n        allow-overlap\n        auto\n        sticky\n        data-node-type=\"", "\"\n        .target=\"", "\"\n        .trayStatus=\"", "\"\n        ?hidden=\"", "\"\n      >\n        <div id=\"topcontextmenu\" @mouseenter=\"", "\">\n          <hax-plate-context\n            always-expanded\n            id=\"platecontextmenu\"\n            class=\"hax-context-menu ignore-activation\"\n            .activeNode=\"", "\"\n            .trayDetail=\"", "\"\n            .trayStatus=\"", "\"\n            ?viewSource=\"", "\"\n            ?canMoveElement=\"", "\"\n          ></hax-plate-context>\n          <hax-text-editor-toolbar\n            id=\"textcontextmenu\"\n            class=\"hax-context-menu ignore-activation ", "\"\n            .activeNode=\"", "\"\n            show=\"always\"\n          >\n          </hax-text-editor-toolbar>\n        </div>\n      </absolute-position-behavior>\n    "])), this.elementAlign || "left", !this.activeNode ? "" : this.viewSourceToggle ? this.activeNode.parentNode.tagName : this.activeNode.tagName, !this.activeNode ? document.body : this.viewSourceToggle ? this.activeNode.parentNode : this.activeNode, this.trayStatus, !this.activeNode, this.revealMenuIfHidden, this.activeNode, this.trayDetail, this.trayStatus, this.viewSourceToggle, this.canMoveElement, this.calcClasses(this.activeNode), this.activeNode);
      }
    }, {
      key: "calcClasses",
      ...
      value: function HAXBODYStyleSheetContent() {
        var styles = [];
        styles.push((0, _index.css)(_templateObject2_dc817c20e4f411ed85766367b4d3e9fc || (_templateObject2_dc817c20e4f411ed85766367b4d3e9fc = babelHelpers.taggedTemplateLiteral(["\n      :host([edit-mode]) #bodycontainer ::slotted(*[data-hax-lock])::after {\n        background-image: url(\"", "\");\n      }\n    "])), (0, _index.unsafeCSS)(this.__lockIconPath)));
        return styles;
      }
      /**
      ...
      value: function firstUpdated(changedProperties) {
        ...
        this.editMode = _haxStore.HAXStore.editMode;
                    ...
                    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                      while (1) switch (_context2.prev = _context2.next) {
                        case 0:
                            ...
                            setTimeout( /*#__PURE__*/babelHelpers.asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
                              return _regeneratorRuntime().wrap(function _callee$(_context) {
                                while (1) switch (_context.prev = _context.next) {
                                  case 0:
                                    _this5.__ignoreActive = true;
                                    _context.next = 3;
                                    return _this5._editModeChanged(_this5[propName], oldValue);
                                  case 3:
                                    // ensure we don't process all mutations happening in tee-up
                                    setTimeout(function () {
                                      _this5.__ignoreActive = false;
                                    }, 100);
                                  case 4:
                                  case "end":
                          ...
                          if (propName == "_useristyping" && _this5[propName]) {
                            _this5.hideContextMenus();
                          }
                          if (!(propName == "activeNode" && _this5.ready && oldValue !== undefined)) {
                            _context2.next = 5;
                            break;
                          }
                          _context2.next = 5;
      ...
      value: function _keepContextVisible() {
        ...
        if (this.editMode) {
          ...
          this.__contextVisibleLock = setTimeout(function () {
            ...
            var el = false;
            if (_this6.contextMenus.plate.classList.contains("hax-context-visible")) {
              el = _this6.contextMenus.plate;
            }
              ...
              switch (e.key) {
                ...
                case "Enter":
                  ...
                  if (this.activeNode && this.activeNode.tagName === "P" && ["1", "#", "`", ">", "-"].includes(this.activeNode.textContent[0])) {
                    ...
                    var guess = this.activeNode.textContent.replaceAll(/ /g, " ");
                ...
                case "Delete":
                  this._useristyping = true;
                  this.__delHit = true;
                  this.querySelectorAll("[data-hax-active]").forEach(function (el) {
                  ...
                  setTimeout(function () {
                    ...
                    if (rng.commonAncestorContainer && _this7.activeNode !== rng.commonAncestorContainer && typeof rng.commonAncestorContainer.focus === "function") {
                      if (rng.commonAncestorContainer.tagName !== "HAX-BODY") {
                        _this7.__focusLogic(rng.commonAncestorContainer, false);
                      }
                    }
                    // need to check on the parent too if this was a text node
                        ...
                        if (rng.commonAncestorContainer.parentNode.tagName !== "HAX-BODY") {
                          _this7.__focusLogic(rng.commonAncestorContainer.parentNode, false);
                        } else {
                          _this7.__focusLogic(rng.commonAncestorContainer, false);
                        }
                      }
                ...
                case "/":
                  var rng = _haxStore.HAXStore.getRange();
                  if (this.activeNode && _haxStore.HAXStore.isTextElement(this.activeNode) && rng.commonAncestorContainer.textContent.trim() == "") {
                    e.preventDefault();
                    _superDaemon.SuperDaemonInstance.mini = true;
                    _superDaemon.SuperDaemonInstance.activeRange = rng;
                    _superDaemon.SuperDaemonInstance.activeSelection = _haxStore.HAXStore.getSelection();
                    _superDaemon.SuperDaemonInstance.activeNode = rng.commonAncestorContainer;
                    _superDaemon.SuperDaemonInstance.runProgram("*", {}, null, null, null, rng.commonAncestorContainer.textContent.trim());
                    _superDaemon.SuperDaemonInstance.open();
                  }
                  break;
                case "ArrowUp":
                case "ArrowDown":
                ...
                default:
                  ...
                  setTimeout(function () {
                    if (_this7.activeNode && _this7.activeNode.tagName === "P" && ["1", "#", "`", ">", "-"].includes(_this7.activeNode.textContent[0])) {
                      // ensure the "whitespace character" has been replaced w/ a normal space
                      var _guess = _this7.activeNode.textContent.replaceAll(/ /g, " ");
                      // ensures that the user has done a matching action and a " " spacebar to ensure they
                      // are ready to commit the action
                      if (_guess[_guess.length - 1] === " ") {
                        _this7.keyboardShortCutProcess(_guess);
                      }
                    }
                  }, 0);
                  break;
          ...
          return _regeneratorRuntime().wrap(function _callee7$(_context7) {
            while (1) switch (_context7.prev = _context7.next) {
              ...
              case 43:
                ...
                _haxStore.HAXStore.activeNode = __active;
        ...
        if (node && node.tagName && this.ready && !this._useristyping) {
          ...
          this.__positionContextTimer = setTimeout(function () {
            if (!_haxStore.HAXStore._lockContextPosition) {
              ...
              if (!!node) {
                _this10._showContextMenu(_this10.contextMenus.plate);
              } else {
                _this10._hideContextMenu(_this10.contextMenus.plate);
              }
              ...
              if (babelHelpers.typeof(props) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined)) && !_haxStore.HAXStore.isTextElement(node)) {
                //TODO hide text
                _this10._hideContextMenu(_this10.contextMenus.text);
                props.element = node;
              } else {
                _this10._showContextMenu(_this10.contextMenus.text);
              ...
              if (!props || props.editingElement == "core") {
                ...
                if (_this10.activeNode && (_this10.activeNode.tagName === "LI" || _this10._HTMLInlineTextDecorationTest(_this10.activeNode))) {
                  _this10.canMoveElement = false;
                } else {
                  _this10.canMoveElement = true;
                }
              } else {
                setTimeout(function () {
            ...
            _this10.contextMenus.parent.setPosition();
          }, 50);
        }
      }
      /**
      ...
      value: function haxMoveGridPlate(node) {
        ...
        setTimeout(function () {
          _haxStore.HAXStore.activeNode = node;
          _this11.scrollHere(node);
          _this11.__focusLogic(node);
        }, 100);
        return true;
      }
      /**
          ...
          return _regeneratorRuntime().wrap(function _callee9$(_context9) {
            while (1) switch (_context9.prev = _context9.next) {
              case 0:
                ...
                _context9.next = _context9.t0 === "1" ? 10 : _context9.t0 === "1-1" ? 13 : _context9.t0 === "1-1-1" ? 16 : _context9.t0 === "1-1-1-1" ? 19 : _context9.t0 === "1-1-1-1-1" ? 22 : 25;
                break;
              case 10:
                node.layout = "1-1";
                changed = true;
              ...
              case 27:
                ...
                _context9.next = _context9.t1 === "1-1" ? 30 : _context9.t1 === "1-1-1" ? 36 : _context9.t1 === "1-1-1-1" ? 39 : _context9.t1 === "1-1-1-1-1" ? 42 : _context9.t1 === "1-1-1-1-1-1" ? 45 : 48;
                break;
              case 30:
                _context9.next = 32;
      ...
      value: function haxChangeTagName(node, tagName) {
        ...
        try {
          ...
          if (maintainContent) {
            ...
            setTimeout(function () {
              var children = replacement.children;
      ...
      value: function () {
        var _haxContextOperation2 = babelHelpers.asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10(e) {
          var _this13 = this;
          var detail, eventPath, slot, p, _p, target, data, _target, _slot, _i, grid, editMode, invisible, focusTarget, nodePosition, _data, replacement, oldSchema, i, _replacement, _oldSchema, rng, active;
          return _regeneratorRuntime().wrap(function _callee10$(_context10) {
            while (1) switch (_context10.prev = _context10.next) {
              case 0:
                ...
                _context10.next = _context10.t0 === "insert-above-active" ? 4 : _context10.t0 === "insert-below-active" ? 6 : _context10.t0 === "move-to-slot" ? 8 : _context10.t0 === "insert-into-active" ? 10 : _context10.t0 === "hax-select-grid" ? 12 : _context10.t0 === "hax-select-grid-item" ? 14 : _context10.t0 === "hax-edit-element-toggle" ? 16 : _context10.t0 === "hax-source-view-toggle" ? 18 : _context10.t0 === "hax-full-text-editor-toggle" ? 54 : _context10.t0 === "text-tag" ? 71 : _context10.t0 === "text-tag-ul" ? 74 : _context10.t0 === "text-tag-ol" ? 78 : _context10.t0 === "text-align-left" ? 82 : _context10.t0 === "hax-transform-node" ? 84 : _context10.t0 === "hax-plate-create-right" ? 86 : _context10.t0 === "hax-plate-remove-right" ? 88 : _context10.t0 === "hax-plate-duplicate" ? 90 : _context10.t0 === "hax-plate-delete" ? 92 : _context10.t0 === "hax-plate-up" ? 94 : _context10.t0 === "hax-plate-down" ? 96 : _context10.t0 === "content-edit" ? 98 : _context10.t0 === "super-daemon" ? 101 : _context10.t0 === "hide-context-menus" ? 111 : 113;
                break;
              case 4:
                ...
                return _context10.abrupt("break", 113);
              case 6:
                this.haxInsert("p", "", {});
                return _context10.abrupt("break", 113);
              case 8:
              ...
              case 14:
                if (eventPath[0] && eventPath[0].eventData) {
                  data = eventPath[0].eventData, _target = data.target, _slot = data.slot, _i = data.index, grid = data.grid, editMode = data.editMode, invisible = data.invisible, focusTarget = invisible ? grid : babelHelpers.toConsumableArray(grid.children).filter(function (child) {
                    ...
                    _this13.setActiveNode(node, true);
                    _this13.positionContextMenus(node);
              ...
              case 44:
                ...
                if (this.activeNode && this.activeNode.tagName) {
                  oldSchema = _haxStore.HAXStore.haxSchemaFromTag(this.activeNode.tagName.toLowerCase());
                } else if (this.activeNode.parentElement && this.activeNode.parentElement.tagName) {
                  oldSchema = _haxStore.HAXStore.haxSchemaFromTag(this.activeNode.parentElement.tagName.toLowerCase());
                }
                // test for slots to match to ensure this is maintained
              ...
              case 54:
                ...
                new Promise(function (res, rej) {
                  ...
                  _haxStore.HAXStore.activeEditingElement.type = "rich-text-editor-toolbar-full";
                  // test for slots to match to ensure this is maintained
                  ...
                  _this13.activeNode.removeAttribute("data-hax-active");
              ...
              case 96:
                ...
                return _context10.abrupt("break", 113);
              case 98:
                if (_haxStore.HAXStore.haxTray.trayDetail === "content-edit") {
                  _haxStore.HAXStore.haxTray.collapsed = false;
                }
                _haxStore.HAXStore.haxTray.trayDetail = "content-edit";
                return _context10.abrupt("break", 113);
              case 101:
                rng = _haxStore.HAXStore.getRange();
                _superDaemon.SuperDaemonInstance.mini = true;
                _superDaemon.SuperDaemonInstance.activeRange = rng;
                _superDaemon.SuperDaemonInstance.activeSelection = _haxStore.HAXStore.getSelection();
                ...
                _superDaemon.SuperDaemonInstance.activeNode = active;
                _superDaemon.SuperDaemonInstance.runProgram("*", {}, null, null, null, active.textContent.trim());
                _superDaemon.SuperDaemonInstance.open();
                return _context10.abrupt("break", 113);
              case 111:
                this.hideContextMenus();
      ...
      value: function __focusLogic(target) {
        ...
        if (this.editMode && !this.__tabTrap) {
          ...
          else if (containerNode.tagName === "LI" && _haxStore.HAXStore.isTextElement(containerNode.parentNode) && ["UL", "OL"].includes(containerNode.parentNode.tagName)) {
              containerNode = target.parentNode;
            }
          ...
          if (this._validElementTest(containerNode) && containerNode.parentNode && containerNode.parentNode.tagName) {
            ...
            if ((!_activeNode.haxUIElement || _activeNode.tagName === "EDITABLE-TABLE") && !_activeNode.classList.contains("ignore-activation")) {
              ...
              setTimeout(function () {
                if (autoFocus && !_this14.__mouseDown && _haxStore.HAXStore.isTextElement(_activeNode)) {
                  try {
                    var range = document.createRange();
                    var sel = _haxStore.HAXStore.getSelection();
                ...
                _this14.positionContextMenus(_activeNode);
              }, 0);
              stopProp = true;
            }
          }
      ...
      value: function undo() {
        ...
        setTimeout(function () {
          var active = _this15.querySelector("[data-hax-active]");
          if (active) {
      ...
      value: function redo() {
        ...
        setTimeout(function () {
          var active = _this16.querySelector("[data-hax-active]");
          if (active) {
            ...
            while (1) switch (_context11.prev = _context11.next) {
              case 0:
                ...
                if (babelHelpers.typeof(oldValue) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {
                  ...
                  setTimeout(function () {
                    ...
                    _this17.undoStack.commands = [];
                    // execute once just to get these values
                    _this17.undoStack.changed();
                ...
                if (newValue == false) {
                  ...
                  activeKids = this.querySelectorAll("[contenteditable],[data-hax-active]");
              ...
              case 11:
                ...
                if (newValue) {
                  ...
                  window.addEventListener("hax-context-item-selected", this._haxContextOperation);
                  window.addEventListener("hax-toggle-active-node-lock", this._toggleNodeLocking);
                  ...
                  this._observer = new MutationObserver(function (mutations) {
                    var mutFind = false;
                    if (!_this17.__ignoreActive && !_this17.__dragMoving && !_this17.undoStackIgnore && !_this17.__fakeEndCap && _this17.ready && _this17.editMode && _this17.shadowRoot) {
                        ...
                        if (mutation.removedNodes.length > 0) {
                          ...
                          try {
                            for (_iterator.s(); !(_step = _iterator.n()).done;) {
                              ...
                              if (mutation.previousSibling && _this17.activeNode == node) {
                        ...
                        if (mutation.addedNodes.length > 0) {
                          ...
                          try {
                            for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
                              ...
                              if (_this17._validElementTest(node)) {
                                // no empty HTML primative tags w/ just a BR in it for spacing purposes
                                if (!_this17.__delHit && node.tagName === "BR" && node.parentElement && _haxStore.HAXStore.__validGridTags().includes(node.parentElement.tagName.toLowerCase()) && node === node.parentElement.childNodes[node.parentElement.childNodes.length - 1]) {
                                ...
                                if (node.getAttribute("slot") != null && node.parentElement === _this17) {
                                ...
                                if (node.tagName === "LI" && node.children.length > 0 && node.children[0].tagName === "SPAN") {
                                  if (_this17.activeNode === node.children[0] || _this17.activeNode === node) {
                                    _haxStore.HAXStore.activeNode = node;
                                  }
                                ...
                                if (_this17.__slot) {
                                  node.setAttribute("slot", _this17.__slot);
                                  _this17.__slot = null;
                                }
                                ...
                                if (_this17.__indentTrap) {
                                  // span should not be created, we want a paragraph for this
                                  if (node.tagName === "SPAN") {
                                    if (node.parentNode === _this17) {
                                      _this17.haxChangeTagName(node, "p", true);
                                ...
                                if (_this17.editMode && (node.getAttribute("contenteditable") == "true" || node.getAttribute("contenteditable") === true || node.getAttribute("contenteditable") == "contenteditable")) {
                                  _this17.__applyNodeEditableState(node, !_this17.editMode);
                                }
                                _this17.__applyNodeEditableState(node, _this17.editMode);
                                ...
                                if (_haxStore.HAXStore.isGridPlateElement(node)) {
                                  ...
                                  for (var j = 0; j < grandKids.length; j++) {
                                    ...
                                    if (_this17._validElementTest(grandKids[j])) {
                                      // correctly add or remove listeners
                                      _this17.__applyNodeEditableState(grandKids[j], _this17.editMode);
                                    }
                                  }
                                }
                                ...
                                // active to change
                                if (!_this17.___moveLock && !mutFind) {
                                  mutFind = true;
                                  if (node.tagName === "LI" && node.parentNode) {
                                    _haxStore.HAXStore.activeNode = node.parentNode;
                                  } else if (node.tagName === "BR") {
                                    var tmp = _haxStore.HAXStore.getSelection();
                                    _haxStore.HAXStore._tmpSelection = tmp;
                                    _haxStore.HAXStore.haxSelectedText = tmp.toString();
                                    var rng = _haxStore.HAXStore.getRange();
                                    if (rng.collapsed && _this17.activeNode.tagName === "BR" && _this17.activeNode.parentNode === rng.commonAncestorContainer && _this17.activeNode.innerText === "") {
                                      _haxStore.HAXStore.activeNode = _this17.activeNode.parentNode;
                                    }
                                  } else {
                                    _haxStore.HAXStore.activeNode = node;
                                  }
                                  _haxStore.HAXStore.activeNode.setAttribute("data-hax-active", "data-hax-active");
                                } else {
                                  _this17.___moveLock = false;
                                }
                              }
                            }
                          } catch (err) {
                          ...
                          if (_this17.__indentTrap) {
                            setTimeout(function () {
                              _this17.__indentTrap = false;
                            }, 0);
                          }
                        }
                        // ensure we are never 100% empty but only if actively editing
                        // this way we can't delete... EVERYTHING
                        else if (_this17.ready && _this17.editMode && _haxStore.HAXStore.ready && mutation.addedNodes.length === 0 && mutation.removedNodes.length > 0 && _this17.shadowRoot && _this17.shadowRoot.querySelector("#body").assignedNodes({
                            flatten: true
                          }).length === 0) {
                            ...
                            setTimeout(function () {
                              if (_this17.shadowRoot.querySelector("#body").assignedNodes({
                                flatten: true
                              }).length === 0) {
                                _this17.appendChild(document.createElement("p"));
                              }
                            }, 100);
                          }
                      });
                    ...
                    else if (_this17.undoStackIgnore) {
                        mutations.forEach(function (mutation) {
                          if (mutation.addedNodes.length > 0) {
                    ...
                    if (_this17.__ignoreActive) {
                      _this17.__ignoreActive = false;
                    }
                  ...
                  window.removeEventListener("hax-context-item-selected", this._haxContextOperation);
                  window.removeEventListener("hax-toggle-active-node-lock", this._toggleNodeLocking);
                  window.removeEventListener("click", this.scrollerFixclickEvent);
      ...
      value: function _validElementTest(node) {
        ...
        if ((!node.haxUIElement || node.tagName === "EDITABLE-TABLE") && node.tagName && !["TEMPLATE", "HAX-BODY", "RICH-TEXT-EDITOR-CLIPBOARD", "RICH-TEXT-EDITOR-PROMPT", "RICH-TEXT-EDITOR-HIGHLIGHT", "FAKE-HAX-BODY-END"].includes(node.tagName)) {
      ...
      value: function __applyDragDropState(layout, haxRay) {
        ...
        var events = {
          drop: function drop(e) {
            return _this19.__layoutDropEvent.bind(_this19)(e, layout);
          },
      ...
      value: function dropEvent(e) {
        if (this.editMode) {
          ...
          _haxStore.HAXStore.activeNode = target;
        ...
        var _activeNodeChanged2 = babelHelpers.asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee13(newValue, oldValue) {
          ...
          return _regeneratorRuntime().wrap(function _callee13$(_context13) {
            while (1) switch (_context13.prev = _context13.next) {
              ...
              case 41:
                _haxStore.HAXStore.activeEditingElement = document.createElement(newSchema.editingElement.tag);
                // test for slots to match to ensure this is maintained
                ...
                this.__ignoreActive = true;
                (0, _utils.wrap)(newValue, _haxStore.HAXStore.activeEditingElement);
