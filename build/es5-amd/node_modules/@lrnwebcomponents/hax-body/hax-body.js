define(["exports", "require", "../../lit-element/lit-element.js", "../simple-colors/simple-colors.js", "../utils/utils.js"], function (_exports, _require, _litElement, _simpleColors, _utils) {
  ...
  function _templateObject2_62d3b56025ed11ea95877d639a99068e() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <div id=\"bodycontainer\" class=\"ignore-activation\">\n        <slot id=\"body\"></slot>\n      </div>\n      <hax-text-context\n        id=\"textcontextmenu\"\n        class=\"hax-context-menu ignore-activation\"\n      ></hax-text-context>\n      <hax-ce-context\n        id=\"cecontextmenu\"\n        class=\"hax-context-menu ignore-activation\"\n      ></hax-ce-context>\n      <hax-plate-context\n        id=\"platecontextmenu\"\n        class=\"hax-context-menu ignore-activation\"\n      ></hax-plate-context>\n      <hax-input-mixer\n        id=\"haxinputmixer\"\n        class=\"hax-context-menu ignore-activation\"\n      ></hax-input-mixer>\n    "]);

    _templateObject2_62d3b56025ed11ea95877d639a99068e = function _templateObject2_62d3b56025ed11ea95877d639a99068e() {
      return data;
    };
  ...
  function _templateObject_62d3b56025ed11ea95877d639a99068e() {
    ...
    _templateObject_62d3b56025ed11ea95877d639a99068e = function _templateObject_62d3b56025ed11ea95877d639a99068e() {
      return data;
    };
  ...
  function (_SimpleColors) {
    ...
    babelHelpers.createClass(HaxBody, null, [{
       ...
       */
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(HaxBody), "styles", this)), [(0, _litElement.css)(_templateObject_62d3b56025ed11ea95877d639a99068e())]);
      }
      /**
       * HTMLElement
       */
    ...
    babelHelpers.createClass(HaxBody, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_62d3b56025ed11ea95877d639a99068e());
      }
      /**
                ...
                if (rng.commonAncestorContainer && _this5.activeNode !== rng.commonAncestorContainer && typeof rng.commonAncestorContainer.focus === "function") {
                  if (rng.commonAncestorContainer.tagName !== "HAX-BODY") {
                    ...
                    if (rng.commonAncestorContainer.parentNode.tagName !== "HAX-BODY") {
                      ...
                      setTimeout(function () {
                        _this5.positionContextMenus(_this5.activeNode, _this5.activeContainerNode);
                      }, 0);
                    }
                  } else {}
              }, 50);
      ...
      value: function _onKeyPress(e) {
        ...
        if (!this.openDrawer && this.editMode && this.shadowRoot.querySelector("#platecontextmenu").classList.contains("hax-active-hover") && this.activeNode && window.HaxStore.instance.isTextElement(this.activeNode)) {
          ...
          this.__positionContextTimer = setTimeout(function () {
            ...
            _this6.positionContextMenus(_this6.activeNode, _this6.activeContainerNode);
          }, 2000);
        }
      }
      /**
      ...
      value: function positionContextMenus(node, container) {
        if (node) {
          ...
          if (babelHelpers.typeof(props) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined)) && !window.HaxStore.instance.isTextElement(node)) {
            ...
            this._positionContextMenu(this.shadowRoot.querySelector("#cecontextmenu"), node, -58, -40);
          } else {
            this._hideContextMenu(this.shadowRoot.querySelector("#cecontextmenu"));

            this._positionContextMenu(this.shadowRoot.querySelector("#textcontextmenu"), node, -58, -40);
          }

          this._positionContextMenu(this.shadowRoot.querySelector("#platecontextmenu"), container, -59, 0); // special case for node not matching container
      ...
      value: function dropEvent(e) {
        ...
        if (!this.openDrawer && this.editMode) {
          ...
          if (target && typeof target.focus === "function") {
            setTimeout(function () {
              _this15.positionContextMenus(_this15.activeNode, _this15.activeContainerNode);
            }, 10);
          }
        }
      }
          ...
          if (window.HaxStore.instance.isTextElement(newValue) || window.HaxStore.instance.isGridPlateElement(newValue)) {
            ...
            this.__positionContextTimer = setTimeout(function () {
              if (newValue === _this16.activeNode) {
                _this16.positionContextMenus(newValue, _this16.activeContainerNode);
              }
            }, 10);
          } else {
            newValue.removeAttribute("contenteditable");
