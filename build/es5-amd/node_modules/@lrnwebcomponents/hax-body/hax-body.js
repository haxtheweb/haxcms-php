define(["exports", "require", "../../lit-element/lit-element.js", "../simple-colors/simple-colors.js", "../../@polymer/polymer/lib/utils/wrap.js", "../../@polymer/polymer/lib/utils/flattened-nodes-observer.js", "../../@polymer/polymer/lib/utils/flush.js", "./lib/haxutils.js", "./lib/hax-text-context.js", "./lib/hax-ce-context.js", "./lib/hax-plate-context.js", "./lib/hax-input-mixer.js"], function (_exports, _require, _litElement, _simpleColors, _wrap, _flattenedNodesObserver, _flush, _haxutils, _haxTextContext, _haxCeContext, _haxPlateContext, _haxInputMixer) {
  ...
  function _templateObject2_de7f8f400b1211eaa3b2eff4bd15c191() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <div id=\"bodycontainer\" class=\"ignore-activation\">\n        <slot id=\"body\"></slot>\n      </div>\n      <hax-text-context\n        id=\"textcontextmenu\"\n        class=\"hax-context-menu ignore-activation\"\n      ></hax-text-context>\n      <hax-ce-context\n        id=\"cecontextmenu\"\n        class=\"hax-context-menu ignore-activation\"\n      ></hax-ce-context>\n      <hax-plate-context\n        id=\"platecontextmenu\"\n        class=\"hax-context-menu ignore-activation\"\n      ></hax-plate-context>\n      <hax-input-mixer\n        id=\"haxinputmixer\"\n        class=\"hax-context-menu ignore-activation\"\n      ></hax-input-mixer>\n    "]);

    _templateObject2_de7f8f400b1211eaa3b2eff4bd15c191 = function _templateObject2_de7f8f400b1211eaa3b2eff4bd15c191() {
      return data;
    };
  ...
  function _templateObject_de7f8f400b1211eaa3b2eff4bd15c191() {
    ...
    _templateObject_de7f8f400b1211eaa3b2eff4bd15c191 = function _templateObject_de7f8f400b1211eaa3b2eff4bd15c191() {
      return data;
    };
  ...
  function (_SimpleColors) {
    ...
    babelHelpers.createClass(HaxBody, null, [{
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject_de7f8f400b1211eaa3b2eff4bd15c191())];
      }
      /**
       * HTMLElement
       */
    ...
    babelHelpers.createClass(HaxBody, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_de7f8f400b1211eaa3b2eff4bd15c191());
      }
      /**
      ...
      value: function _onKeyPress(e) {
        if (this.editMode && this.shadowRoot.querySelector("#platecontextmenu").classList.contains("hax-active-hover")) {
          this.__dropActiveHover();
        }
      }
      /**
      ...
      value: function replacePlaceholder(e) {
        ...
        if (e.detail === "text") {
          ...
          setTimeout(function () {
            ...
            _this5.activeNode = p;
            window.HaxStore.write("activeNode", p, _this5);

            _this5.activeContainerNode.setAttribute("contenteditable", true); // focus on it


            p.focus();

            _this5.__focusLogic(p);
          }, 210);
        } else {
      ...
      value: function haxToContent() {
        ...
        var children = this.shadowRoot.querySelector("#body").localName === "slot" ? (0, _wrap.wrap)(this.shadowRoot.querySelector("#body")).assignedNodes({
          flatten: true
        }) : [];
      ...
      value: function haxDuplicateNode(node) {
        ...
        setTimeout(function () {
          ...
          if (parent === _this7) {
            window.HaxStore.write("activeContainerNode", nodeClone, _this7);
          }

          window.HaxStore.write("activeNode", nodeClone, _this7);
        }, 50);
        return true;
      }
      /**
      ...
      value: function positionContextMenus(node, container) {
        if (node) {
          ...
          this._positionContextMenu(this.shadowRoot.querySelector("#platecontextmenu"), container, -31, 0); // special case for node not matching container
      ...
      value: function haxMoveGridPlate(direction, node, container) {
        ...
        setTimeout(function () {
          _this8.positionContextMenus(node, container);
      ...
      value: function haxChangeTagName(node, tagName, newNode) {
        ...
        try {
          ...
          setTimeout(function () {
            var children = _flattenedNodesObserver.FlattenedNodesObserver.getFlattenedNodes(replacement); // see if there's a child element and focus that instead if there is
          ...
          while (fragment.firstChild !== null) {
            if (babelHelpers.typeof(fragment.firstChild.tagName) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {
              ...
              if (window.HaxStore.instance._isSandboxed && fragment.firstChild.tagName.toLowerCase() === "iframe") {
                ...
                _this9.appendChild(replacement);
              } else {
                _this9.appendChild(fragment.firstChild);
              }
            } else {
      ...
      value: function _haxContextOperation(e) {
        ...
        switch (detail.eventName) {
          ...
          case "code":
            ...
            this.shadowRoot.querySelector("#textcontextmenu").selectedValue = detail.eventName;
          ...
          case "hax-align-left":
            ...
            setTimeout(function () {
              _this10.positionContextMenus(_this10.activeNode, _this10.activeContainerNode);
            }, 200);
            break;
      ...
      value: function _applyContentEditable(status) {
        ...
        var children = target.localName === "slot" ? (0, _wrap.wrap)(target).assignedNodes({
          flatten: true
        }) : []; // fallback for content nodes if not polymer managed nodes above

        if (children.length === 0) {
          children = _flattenedNodesObserver.FlattenedNodesObserver.getFlattenedNodes(target);
        }
      ...
      value: function _activeNodeChanged(newValue, oldValue) {
        ...
        if (babelHelpers.typeof(oldValue) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined)) && oldValue && oldValue.classList) {
        ...
        if (this.editMode && babelHelpers.typeof(newValue) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined)) && newValue !== null) {
          ...
          this.shadowRoot.querySelector("#textcontextmenu").selectedValue = tag; // position the operations / in context element

          setTimeout(function () {
            _this11.positionContextMenus(newValue, window.HaxStore.instance.activeContainerNode);
          }, 100);
