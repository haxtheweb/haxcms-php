define(["exports", "meta", "require", "../../lit/index.js", "../simple-colors/simple-colors.js", "../undo-manager/undo-manager.js", "./lib/hax-store.js", "../../mobx/dist/mobx.esm.js", "./lib/hax-text-editor-toolbar.js", "../utils/utils.js", "./lib/hax-ui-styles.js", "../i18n-manager/lib/I18NMixin.js", "../absolute-position-behavior/absolute-position-behavior.js", "../simple-icon/lib/simple-icons.js", "../simple-icon/lib/simple-iconset.js", "./lib/hax-context-behaviors.js", "./lib/hax-plate-context.js", "../grid-plate/grid-plate.js", "../media-image/media-image.js"], function (_exports, meta, _require, _index, _simpleColors, _undoManager, _haxStore, _mobxEsm, _haxTextEditorToolbar, _utils, _haxUiStyles, _I18NMixin2, _absolutePositionBehavior, _simpleIcons, _simpleIconset, _haxContextBehaviors, _haxPlateContext, _gridPlate, _mediaImage) {
  ...
  var _templateObject_bd92a8f0a7e811ed8d60b559aaaec7a9, _templateObject2_bd92a8f0a7e811ed8d60b559aaaec7a9, _templateObject3_bd92a8f0a7e811ed8d60b559aaaec7a9;
  ...
  var HaxBody = /*#__PURE__*/function (_I18NMixin) {
    ...
    babelHelpers.createClass(HaxBody, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_bd92a8f0a7e811ed8d60b559aaaec7a9 || (_templateObject_bd92a8f0a7e811ed8d60b559aaaec7a9 = babelHelpers.taggedTemplateLiteral(["\n      <style id=\"hax-body-style-element\"></style>\n      <div\n        id=\"bodycontainer\"\n        class=\"ignore-activation\"\n        element-align=\"", "\"\n      >\n        <slot id=\"body\"></slot>\n      </div>\n      <absolute-position-behavior\n        id=\"topcontext\"\n        fit-to-visible-bounds\n        justify\n        position=\"top\"\n        allow-overlap\n        auto\n        sticky\n        data-node-type=\"", "\"\n        .target=\"", "\"\n        .trayStatus=\"", "\"\n        ?hidden=\"", "\"\n      >\n        <div id=\"topcontextmenu\">\n          <hax-plate-context\n            always-expanded\n            id=\"platecontextmenu\"\n            class=\"hax-context-menu ignore-activation\"\n            .activeNode=\"", "\"\n            .trayDetail=\"", "\"\n            .trayStatus=\"", "\"\n            ?viewSource=\"", "\"\n            ?canMoveElement=\"", "\"\n          ></hax-plate-context>\n          <hax-text-editor-toolbar\n            id=\"textcontextmenu\"\n            class=\"hax-context-menu ignore-activation ", "\"\n            .activeNode=\"", "\"\n            show=\"always\"\n          >\n          </hax-text-editor-toolbar>\n        </div>\n      </absolute-position-behavior>\n    "])), this.elementAlign || "left", !this.activeNode ? "" : this.viewSourceToggle ? this.activeNode.parentNode.tagName : this.activeNode.tagName, !this.activeNode ? document.body : this.viewSourceToggle ? this.activeNode.parentNode : this.activeNode, this.trayStatus, !this.activeNode, this.activeNode, this.trayDetail, this.trayStatus, this.viewSourceToggle, this.canMoveElement, this.calcClasses(this.activeNode), this.activeNode);
      }
    }, {
      key: "calcClasses",
      ...
      value: function HAXBODYStyleSheetContent() {
        var styles = [];
        styles.push((0, _index.css)(_templateObject2_bd92a8f0a7e811ed8d60b559aaaec7a9 || (_templateObject2_bd92a8f0a7e811ed8d60b559aaaec7a9 = babelHelpers.taggedTemplateLiteral(["\n      :host([edit-mode]) #bodycontainer ::slotted(*[data-hax-lock])::after {\n        background-image: url(\"", "\");\n      }\n    "])), (0, _index.unsafeCSS)(this.__lockIconPath)));
        return styles;
      }
      /**
                ...
                default:
                  ...
                  setTimeout(function () {
                    if (_this8.activeNode && _this8.activeNode.tagName === "P" && ["1", "#", "`", ">", "-", "!"].includes(_this8.activeNode.textContent[0])) {
                      // ensure the "whitespace character" has been replaced w/ a normal space
                      var _guess = _this8.activeNode.textContent.replaceAll(/ /g, " ");
                      // ensures that the user has done a matching action and a " " spacebar to ensure they
                      // are ready to commit the action
      ...
      value: function _onKeyPress(e) {
        ...
        if (next && e.key === "Enter") this.setActiveNode(this.activeNode.nextElementSibling);
          ...
          this.__positionContextTimer = setTimeout(function () {
            if (!_haxStore.HAXStore._lockContextPosition) {
              ...
              if (babelHelpers.typeof(props) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined)) && !_haxStore.HAXStore.isTextElement(node)) {
                ...
                _this12._showContextMenu(_this12.contextMenus.text);
          ...
          return _regeneratorRuntime().wrap(function _callee10$(_context10) {
            while (1) switch (_context10.prev = _context10.next) {
              ...
              case 4:
                ...
                return _context10.abrupt("break", 101);
              case 6:
                this.haxInsert("p", "", {});
                return _context10.abrupt("break", 101);
              case 8:
              ...
              case 0:
                ...
                if (babelHelpers.typeof(oldValue) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {
                  ...
                  setTimeout(function () {
                    ...
                    _this19.undoStack.commands = [];
                    // execute once just to get these values
                    _this19.undoStack.changed();
