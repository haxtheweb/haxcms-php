define(["exports", "meta", "require", "../../lit-element/lit-element.js", "../simple-colors/simple-colors.js", "../undo-manager/undo-manager.js", "./lib/hax-store.js", "../../mobx/dist/mobx.esm.js", "../utils/utils.js", "./lib/hax-ui-styles.js", "../i18n-manager/lib/I18NMixin.js"], function (_exports, meta, _require, _litElement, _simpleColors, _undoManager, _haxStore, _mobxEsm, _utils, _haxUiStyles, _I18NMixin2) {
  ...
  function _templateObject2_759d9dc090bb11eb9010f5aa583cef45() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <div id=\"bodycontainer\" class=\"ignore-activation\">\n        <slot id=\"body\"></slot>\n      </div>\n      <hax-text-context \n        id=\"textcontextmenu\"\n        class=\"hax-context-menu ignore-activation\"\n        .activeNode=\"", "\"\n      ></hax-text-context>\n      <hax-ce-context\n        id=\"cecontextmenu\"\n        class=\"hax-context-menu ignore-activation\"\n        .activeNode=\"", "\"\n      ></hax-ce-context>\n      <hax-plate-context\n        id=\"platecontextmenu\"\n        class=\"hax-context-menu ignore-activation\"\n        ></hax-plate-context>\n      </hax-context-container>\n      <hax-context-container\n        id=\"addincontext\"\n        class=\"hax-context-menu ignore-activation\">\n        <hax-context-item\n          icon=\"icons:add\"\n          label=\"", "\"\n          show-text-label\n        >\n        </hax-context-item>\n      </hax-context-container>\n    "]);

    _templateObject2_759d9dc090bb11eb9010f5aa583cef45 = function _templateObject2_759d9dc090bb11eb9010f5aa583cef45() {
      return data;
    };
  ...
  function _templateObject_759d9dc090bb11eb9010f5aa583cef45() {
    ...
    _templateObject_759d9dc090bb11eb9010f5aa583cef45 = function _templateObject_759d9dc090bb11eb9010f5aa583cef45() {
      return data;
    };
  ...
  var HaxBody = /*#__PURE__*/function (_I18NMixin) {
    ...
    babelHelpers.createClass(HaxBody, null, [{
      ...
      key: "styles",
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(HaxBody), "styles", this)), [(0, _litElement.css)(_templateObject_759d9dc090bb11eb9010f5aa583cef45())]);
      }
      /**
       * HTMLElement
       */
    ...
    babelHelpers.createClass(HaxBody, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_759d9dc090bb11eb9010f5aa583cef45(), this.activeNode, this.activeNode, this.t.addContent);
      }
      /**
      ...
      value: function () {
        var _replaceElementWorkflow = babelHelpers.asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
          var activeNode,
              testOnly,
              element,
              type,
          ...
          return regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  activeNode = _args.length > 0 && _args[0] !== undefined ? _args[0] : null;
                  testOnly = _args.length > 1 && _args[1] !== undefined ? _args[1] : false;
                ...
                case 5:
                  ...
                  return _context.abrupt("return", haxElements);
      ...
      key: "haxToContent",
      value: function () {
        var _haxToContent = babelHelpers.asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
          ...
          return regeneratorRuntime.wrap(function _callee2$(_context2) {
            while (1) {
              switch (_context2.prev = _context2.next) {
                ...
                case 14:
                  content = _context2.t0 += _context2.sent;
                ...
                case 30:
                  content = _context2.t1 += _context2.sent;
                  _context2.next = 37;
                  break;
      ...
      value: function () {
        var _haxDuplicateNode = babelHelpers.asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(node) {
      ...
      key: "haxGridPlateOps",
      value: function () {
        var _haxGridPlateOps = babelHelpers.asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
          var add,
              side,
              node,
              changed,
          ...
          return regeneratorRuntime.wrap(function _callee4$(_context4) {
            while (1) {
              switch (_context4.prev = _context4.next) {
                case 0:
                  add = _args4.length > 0 && _args4[0] !== undefined ? _args4[0] : true;
                  side = _args4.length > 1 && _args4[1] !== undefined ? _args4[1] : "right";
                  node = _args4.length > 2 && _args4[2] !== undefined ? _args4[2] : this.activeNode;
                  ...
                  _context4.t0 = node.layout;
                  _context4.next = _context4.t0 === "1" ? 9 : _context4.t0 === "1-1" ? 12 : _context4.t0 === "1-1-1" ? 15 : _context4.t0 === "1-1-1-1" ? 18 : _context4.t0 === "1-1-1-1-1" ? 21 : 24;
                  break;
                ...
                case 26:
                  _context4.t1 = node.layout;
                  _context4.next = _context4.t1 === "1-1" ? 29 : _context4.t1 === "1-1-1" ? 35 : _context4.t1 === "1-1-1-1" ? 38 : _context4.t1 === "1-1-1-1-1" ? 41 : _context4.t1 === "1-1-1-1-1-1" ? 44 : 47;
                  break;
      ...
      value: function () {
        var _haxContextOperation2 = babelHelpers.asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(e) {
          var _this13 = this;
            ...
            while (1) {
              switch (_context5.prev = _context5.next) {
                case 0:
                  ...
                  _context5.t0 = detail.eventName;
                  _context5.next = _context5.t0 === "insert-above-active" ? 4 : _context5.t0 === "insert-below-active" ? 6 : _context5.t0 === "hax-source-view-toggle" ? 8 : _context5.t0 === "hax-full-text-editor-toggle" ? 36 : _context5.t0 === "text-tag" ? 52 : _context5.t0 === "text-tag-ul" ? 55 : _context5.t0 === "text-tag-ol" ? 59 : _context5.t0 === "text-align-left" ? 63 : _context5.t0 === "hax-transform-node" ? 65 : _context5.t0 === "hax-plate-create-right" ? 67 : _context5.t0 === "hax-plate-remove-right" ? 69 : _context5.t0 === "hax-plate-duplicate" ? 71 : _context5.t0 === "hax-plate-delete" ? 73 : _context5.t0 === "hax-plate-up" ? 75 : _context5.t0 === "hax-plate-down" ? 77 : 79;
                  break;
        ...
        function _haxContextOperation(_x2) {
      ...
      value: function () {
        var _editModeChanged2 = babelHelpers.asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(newValue, oldValue) {
          var _this17 = this;
        ...
        function _editModeChanged(_x3, _x4) {
      ...
      value: function () {
        var _activeNodeChanged2 = babelHelpers.asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(newValue, oldValue) {
        ...
        function _activeNodeChanged(_x5, _x6) {
