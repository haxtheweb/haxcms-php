define(["exports", "require", "../../../lit-element/lit-element.js", "../../utils/utils.js", "../../a11y-collapse/lib/a11y-collapse-group.js", "../../a11y-collapse/a11y-collapse.js"], function (_exports, _require, _litElement, _utils, _a11yCollapseGroup, _a11yCollapse) {
  ...
  function _templateObject4_fdd6b31058e611eab30c517c44b6e911() {
    ...
    _templateObject4_fdd6b31058e611eab30c517c44b6e911 = function _templateObject4_fdd6b31058e611eab30c517c44b6e911() {
      return data;
    };
  ...
  function _templateObject3_fdd6b31058e611eab30c517c44b6e911() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                  <hax-tray-button\n                    mini\n                    @click=\"", "\"\n                    icon=\"save\"\n                    id=\"haxsavebutton\"\n                    label=\"", "\"\n                    color=\"green\"\n                    event-name=\"save\"\n                    voice-command=\"save content\"\n                    color-meaning\n                  ></hax-tray-button>\n                  <hax-tray-button\n                    mini\n                    icon=\"cancel\"\n                    id=\"haxcancelbutton\"\n                    label=\"Cancel\"\n                    event-name=\"cancel\"\n                    color=\"red\"\n                    voice-command=\"cancel\"\n                    color-meaning\n                  ></hax-tray-button>\n                  <hax-tray-button\n                    mini\n                    event-name=\"toggle-tray-size\"\n                    icon=\"", "\"\n                    label=\"", "\"\n                  ></hax-tray-button>\n                "]);

    _templateObject3_fdd6b31058e611eab30c517c44b6e911 = function _templateObject3_fdd6b31058e611eab30c517c44b6e911() {
      return data;
    };
  ...
  function _templateObject2_fdd6b31058e611eab30c517c44b6e911() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            <hax-tray-button\n              .data-opened=\"", "\"\n              @click=\"", "\"\n              icon=\"create\"\n              id=\"button\"\n              color=\"black\"\n              label=\"", "\"\n            ></hax-tray-button>\n          "]);

    _templateObject2_fdd6b31058e611eab30c517c44b6e911 = function _templateObject2_fdd6b31058e611eab30c517c44b6e911() {
      return data;
    };
  ...
  function _templateObject_fdd6b31058e611eab30c517c44b6e911() {
    ...
    _templateObject_fdd6b31058e611eab30c517c44b6e911 = function _templateObject_fdd6b31058e611eab30c517c44b6e911() {
      return data;
    };
  ...
  function (_winEventsElement) {
    ...
    babelHelpers.createClass(HaxTray, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_fdd6b31058e611eab30c517c44b6e911(), this.hidePanelOps ? "" : (0, _litElement.html)(_templateObject2_fdd6b31058e611eab30c517c44b6e911(), this.editMode, this._clickEditButton, this.__tipText), this.hidePanelOps ? "" : (0, _litElement.html)(_templateObject3_fdd6b31058e611eab30c517c44b6e911(), this._clickSaveButton, this.__tipText, this.traySizeIcon, this.traySizeText), this.hideExportButton, !this.canUndo, !this.canRedo, this.hidePreferencesButton, this._gizmoBrowserRefresh, this.activeTagIcon, this.activeTagName, this.__simpleFieldsClick, this.__valueChangedEvent, this._appBrowserRefresh, this._refreshLists);
      }
    }, {
        ...
        changedProperties.forEach(function (oldValue, propName) {
          ...
          if (propName == "expanded") {
            if (_this3[propName]) {
              ...
              _this3.traySizeText = "Collapse";
            } else {
              _this3.traySizeIcon = "hax:hax:arrow-expand-left";
              _this3.traySizeText = "Expand";
            }
          }
      ...
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject4_fdd6b31058e611eab30c517c44b6e911())];
      }
    }, {
      key: "properties",
      get: function get() {
