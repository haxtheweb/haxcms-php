define(["exports", "../../../lit/index.js", "../../utils/utils.js", "../../hax-body-behaviors/lib/HAXFields.js", "../../simple-popover/lib/SimpleTourFinder.js", "./hax-store.js", "../../../mobx/dist/mobx.esm.js", "./hax-ui-styles.js", "../../simple-fields/simple-fields.js", "../../simple-fields/lib/simple-fields-tab.js", "../../simple-icon/lib/simple-icons.js", "../../hax-iconset/lib/simple-hax-iconset.js", "./hax-tray-upload.js", "./hax-app-search.js", "./hax-gizmo-browser.js", "./hax-view-source.js", "./hax-stax-browser.js", "./hax-map.js", "./hax-preferences-dialog.js", "./hax-tray-button.js", "./hax-toolbar-menu.js", "../../super-daemon/super-daemon.js", "../../i18n-manager/lib/I18NMixin.js", "../../undo-manager/undo-manager.js", "../../iframe-loader/lib/loading-indicator.js", "../../simple-toolbar/lib/simple-toolbar-menu-item.js"], function (_exports, _index, _utils, _HAXFields, _SimpleTourFinder, _haxStore, _mobxEsm, _haxUiStyles, _simpleFields, _simpleFieldsTab, _simpleIcons, _simpleHaxIconset, _haxTrayUpload, _haxAppSearch, _haxGizmoBrowser, _haxViewSource, _haxStaxBrowser, _haxMap, _haxPreferencesDialog, _haxTrayButton, _haxToolbarMenu, _superDaemon, _I18NMixin2, _undoManager, _loadingIndicator, _simpleToolbarMenuItem) {
  "use strict";
  ...
  var _templateObject_299e2f10edcb11edb3e3ed4f0d506a4b, _templateObject2_299e2f10edcb11edb3e3ed4f0d506a4b, _templateObject3_299e2f10edcb11edb3e3ed4f0d506a4b, _templateObject4_299e2f10edcb11edb3e3ed4f0d506a4b, _templateObject5_299e2f10edcb11edb3e3ed4f0d506a4b, _templateObject6_299e2f10edcb11edb3e3ed4f0d506a4b, _templateObject7_299e2f10edcb11edb3e3ed4f0d506a4b, _templateObject8_299e2f10edcb11edb3e3ed4f0d506a4b, _templateObject9_299e2f10edcb11edb3e3ed4f0d506a4b, _templateObject10_299e2f10edcb11edb3e3ed4f0d506a4b, _templateObject11_299e2f10edcb11edb3e3ed4f0d506a4b, _templateObject12_299e2f10edcb11edb3e3ed4f0d506a4b, _templateObject13_299e2f10edcb11edb3e3ed4f0d506a4b, _templateObject14_299e2f10edcb11edb3e3ed4f0d506a4b, _templateObject15_299e2f10edcb11edb3e3ed4f0d506a4b, _templateObject16_299e2f10edcb11edb3e3ed4f0d506a4b;
  ...
  var HaxTray = /*#__PURE__*/function (_I18NMixin) {
    ...
    babelHelpers.createClass(HaxTray, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_299e2f10edcb11edb3e3ed4f0d506a4b || (_templateObject_299e2f10edcb11edb3e3ed4f0d506a4b = babelHelpers.taggedTemplateLiteral(["\n      ", "\n      <div class=\"wrapper ", "\">\n        ", "\n        <div class=\"detail\">\n          <loading-indicator ?loading=\"", "\"></loading-indicator>\n          ", "\n        </div>\n      </div>\n    "])), this.panelOpsTemplate, this.trayStatus, this.menuToolbarTemplate, this.loading, this.trayDetailTemplate);
      }
    }, {
      key: "panelOpsTemplate",
      get: function get() {
        return this.hidePanelOps ? "" : (0, _index.html)(_templateObject2_299e2f10edcb11edb3e3ed4f0d506a4b || (_templateObject2_299e2f10edcb11edb3e3ed4f0d506a4b = babelHelpers.taggedTemplateLiteral(["\n          <hax-tray-button\n            large\n            voice-command=\"edit page\"\n            .data-opened=\"", "\"\n            @click=\"", "\"\n            icon=\"create\"\n            id=\"button\"\n            feature\n            show-text-label\n            show-tooltip\n            label=\"", "\"\n          ></hax-tray-button>\n        "])), this.editMode, this._clickEditButton, this.editMode ? this.t.save : this.t.edit);
      }
    }, {
      key: "toolbarsTemplate",
      get: function get() {
        return (0, _index.html)(_templateObject3_299e2f10edcb11edb3e3ed4f0d506a4b || (_templateObject3_299e2f10edcb11edb3e3ed4f0d506a4b = babelHelpers.taggedTemplateLiteral(["", "", ""])), this.opsToolbarTemplate, this.trayToolbarTemplate);
      }
    }, {
      key: "menuToolbarTemplate",
      get: function get() {
        return (0, _index.html)(_templateObject4_299e2f10edcb11edb3e3ed4f0d506a4b || (_templateObject4_299e2f10edcb11edb3e3ed4f0d506a4b = babelHelpers.taggedTemplateLiteral([" <div id=\"menubar\" class=\"collapse-menu\">\n      ", " ", " ", "\n      <slot name=\"tray-buttons-pre\"></slot>\n      ", "", "\n    </div>"])), this.saveButtons, this.doButtons, this.contentButtons, this.moreButtons, this.menuButtons);
      }
    }, {
      key: "menuButtons",
      get: function get() {
        return (0, _index.html)(_templateObject5_299e2f10edcb11edb3e3ed4f0d506a4b || (_templateObject5_299e2f10edcb11edb3e3ed4f0d506a4b = babelHelpers.taggedTemplateLiteral(["\n        <hax-tray-button\n          show-text-label\n          show-tooltip\n          align-horizontal=\"", "\"\n          id=\"haxMenuAlign\"\n          event-name=\"toggle-element-align\"\n          icon=\"arrow-", "\"\n          label=\"", "\"\n          index=\"", "\"\n          tooltip=\"", " ", "\"\n        >\n        </hax-tray-button>\n    </div>\n    "])), this.collapsed ? "left" : "center", this.elementAlign == "left" ? "forward" : "back", this.elementAlign == "left" ? this.t.menuRight : this.t.menuLeft, this.elementAlign == "left" ? "1" : "0", this.t.moveMenu, this.elementAlign == "left" ? this.t.right : this.t.left);
      }
    }, {
      key: "saveButtons",
      get: function get() {
        return this.hidePanelOps ? "" : (0, _index.html)(_templateObject6_299e2f10edcb11edb3e3ed4f0d506a4b || (_templateObject6_299e2f10edcb11edb3e3ed4f0d506a4b = babelHelpers.taggedTemplateLiteral(["\n          <hax-tray-button\n            @click=\"", "\"\n            icon=\"save\"\n            icon-position=\"left\"\n            id=\"haxsavebutton\"\n            label=\"", "\"\n            event-name=\"save\"\n            voice-command=\"save page\"\n            show-text-label\n            show-tooltip\n            align-horizontal=\"", "\"\n          ></hax-tray-button>\n          <hax-tray-button\n            icon=\"cancel\"\n            id=\"haxcancelbutton\"\n            label=\"", "\"\n            icon-position=\"left\"\n            show-text-label\n            show-tooltip\n            align-horizontal=\"", "\"\n          ></hax-tray-button>\n        "])), this._clickSaveButton, this.editMode ? this.t.save : this.t.edit, this.collapsed ? "left" : "center", this.t.cancel, this.collapsed ? "left" : "center");
      }
    }, {
      key: "doButtons",
      get: function get() {
        return (0, _index.html)(_templateObject7_299e2f10edcb11edb3e3ed4f0d506a4b || (_templateObject7_299e2f10edcb11edb3e3ed4f0d506a4b = babelHelpers.taggedTemplateLiteral([" <hax-tray-button\n        icon=\"icons:undo\"\n        ?disabled=\"", "\"\n        label=\"", "\"\n        event-name=\"undo\"\n        voice-command=\"undo\"\n        data-simple-tour-stop\n        data-stop-title=\"label\"\n        icon-position=\"left\"\n        show-text-label\n        show-tooltip\n        align-horizontal=\"", "\"\n      >\n        <div slot=\"tour\" data-stop-content>\n          Undo the previous operation in the content, whether typing or adding a\n          widget.\n        </div>\n      </hax-tray-button>\n      <hax-tray-button\n        icon=\"icons:redo\"\n        ?disabled=\"", "\"\n        label=\"", "\"\n        event-name=\"redo\"\n        voice-command=\"redo\"\n        data-simple-tour-stop\n        data-stop-title=\"label\"\n        icon-position=\"left\"\n        show-text-label\n        show-tooltip\n        align-horizontal=\"", "\"\n      >\n        <div slot=\"tour\" data-stop-content>\n          Redo the last action that you hit Undo on.\n        </div>\n      </hax-tray-button>"])), !this.canUndo, this.t.undo, this.collapsed ? "left" : "center", !this.canRedo, this.t.redo, this.collapsed ? "left" : "center");
      }
    }, {
      key: "contentButtons",
      get: function get() {
        return (0, _index.html)(_templateObject8_299e2f10edcb11edb3e3ed4f0d506a4b || (_templateObject8_299e2f10edcb11edb3e3ed4f0d506a4b = babelHelpers.taggedTemplateLiteral([" <hax-tray-button\n        event-name=\"content-edit\"\n        icon=\"settings\"\n        id=\"content-edit\"\n        label=\"", "\"\n        ?disabled=\"", "\"\n        voice-command=\"(modify)(configure)(edit) selected\"\n        data-simple-tour-stop\n        data-stop-title=\"label\"\n        controls=\"tray-detail\"\n        tooltip=\"", " ", "\"\n        toggles\n        ?toggled=\"", "\"\n        icon-position=\"left\"\n        show-text-label\n        show-tooltip\n        align-horizontal=\"", "\"\n      >\n        <div slot=\"tour\" data-stop-content>\n          When you want to add any content to the page from text, to images, to\n          anything more advanced; you can always find items to add under the Add\n          content menu. Click to expand, then either drag and drop items into\n          the page or click and have them placed near whatever you are actively\n          working on.\n        </div>\n      </hax-tray-button>\n      <hax-tray-button\n        event-name=\"content-add\"\n        icon=\"hax:add-brick\"\n        id=\"content-add\"\n        label=\"", "\"\n        voice-command=\"select blocks (menu)\"\n        data-simple-tour-stop\n        data-stop-title=\"label\"\n        controls=\"tray-detail\"\n        toggles\n        ?toggled=\"", "\"\n        icon-position=\"left\"\n        show-text-label\n        show-tooltip\n        align-horizontal=\"", "\"\n      >\n        <div slot=\"tour\" data-stop-content>\n          When you want to add any content to the page from text, to images, to\n          anything more advanced; you can always find items to add under the Add\n          content menu. Click to expand, then either drag and drop items into\n          the page or click and have them placed near whatever you are actively\n          working on.\n        </div>\n      </hax-tray-button>\n      <hax-tray-button\n        icon=\"hax:multimedia\"\n        label=\"", "\"\n        voice-command=\"select media (menu)\"\n        data-simple-tour-stop\n        data-stop-title=\"label\"\n        controls=\"tray-detail\"\n        toggles\n        icon-position=\"left\"\n        show-text-label\n        show-tooltip\n        align-horizontal=\"", "\"\n        @click=\"", "\"\n      >\n        <div slot=\"tour\" data-stop-content>\n          Search for media and content anywhere that your copy of HAX has access\n          to. Pick what to search, perform the search and then click or drag the\n          item into the contnet.\n        </div>\n      </hax-tray-button>\n      <hax-tray-button\n        event-name=\"content-map\"\n        icon=\"icons:toc\"\n        id=\"content-map\"\n        label=\"", "\"\n        voice-command=\"select structure (menu)\"\n        data-simple-tour-stop\n        data-stop-title=\"label\"\n        controls=\"tray-detail\"\n        toggles\n        ?toggled=\"", "\"\n        icon-position=\"left\"\n        show-text-label\n        show-tooltip\n        align-horizontal=\"", "\"\n      >\n        <div data-stop-content>\n          This is a simple list of all the block areas of the page that are\n          clickable to jump through items quickly as well as review some simple\n          overview stats.\n        </div>\n      </hax-tray-button>"])), this.t.edit, !this.activeTagName || this.activeTagName == "" || !this.activeNode || !this.activeNode.tagName, this.t.edit, this.activeTagName, !this.collapsed && this.trayDetail === "content-edit", this.collapsed ? "left" : "center", this.t.blocks, !this.collapsed && this.trayDetail === "content-add", this.collapsed ? "left" : "center", this.t.media, this.collapsed ? "left" : "center", this._clickMediaButton, this.t.structure, !this.collapsed && this.trayDetail === "content-map", this.collapsed ? "left" : "center");
      }
    }, {
      key: "_clickMediaButton",
      value: function _clickMediaButton(e) {
        _superDaemon.SuperDaemonInstance.runProgram("/", {}, null, null, "", "sources");
        _superDaemon.SuperDaemonInstance.open();
      }
    }, {
      key: "moreButtons",
      get: function get() {
        return (0, _index.html)(_templateObject9_299e2f10edcb11edb3e3ed4f0d506a4b || (_templateObject9_299e2f10edcb11edb3e3ed4f0d506a4b = babelHelpers.taggedTemplateLiteral(["<hax-tray-button\n        id=\"exportbtn\"\n        icon=\"hax:html-code\"\n        label=\"", "\"\n        event-name=\"view-source\"\n        voice-command=\"view (page) source\"\n        data-simple-tour-stop\n        data-stop-title=\"label\"\n        icon-position=\"left\"\n        show-text-label\n        show-tooltip\n        align-horizontal=\"", "\"\n      >\n        <div data-stop-content>\n          Every change you make in HAX is ultimately writing HTML. Know HTML?\n          Awesome, pop open the source view and make any changes you like. HTML\n          is always behind the scenes ensuring that content is portable, well\n          formatted and easy to read.\n        </div>\n      </hax-tray-button>\n      <hax-tray-button\n        ?hidden=\"", "\"\n        id=\"advanced-settings\"\n        event-name=\"advanced-settings\"\n        icon=\"build\"\n        label=\"", "\"\n        voice-command=\"select settings (menu)\"\n        data-simple-tour-stop\n        data-stop-title=\"label\"\n        controls=\"tray-detail\"\n        toggles\n        ?toggled=\"", "\"\n        icon-position=\"left\"\n        show-text-label\n        show-tooltip\n        align-horizontal=\"", "\"\n      >\n        <div data-stop-content>User preferences for customizing HAX</div>\n      </hax-tray-button>\n      <hax-tray-button\n        event-name=\"super-daemon\"\n        icon=\"hax:wizard-hat\"\n        label=\"", "\"\n        voice-command=\"", "\"\n        toggles\n        ?toggled=\"", "\"\n        icon-position=\"left\"\n        tooltip=\"", "\"\n        show-text-label\n        show-tooltip\n        align-horizontal=\"", "\"\n      ></hax-tray-button> "])), this.t.source, this.collapsed ? "left" : "center", this.hidePreferencesButton, this.t.settings, !this.collapsed && this.trayDetail === "advanced-settings", this.collapsed ? "left" : "center", this.t.merlin, this.t.merlin, !this.collapsed && this.tourOpened, this.t.summonMerlin, this.collapsed ? "left" : "center");
      }
    }, {
      key: "trayDetailTemplate",
      get: function get() {
        return (0, _index.html)(_templateObject10_299e2f10edcb11edb3e3ed4f0d506a4b || (_templateObject10_299e2f10edcb11edb3e3ed4f0d506a4b = babelHelpers.taggedTemplateLiteral([" <div\n      id=\"tray-detail\"\n      aria-live=\"polite\"\n      aria-disabled=\"", "\"\n      tabindex=\"", "\"\n      selected-detail=\"", "\"\n    >\n      <div class=\"tray-detail-titlebar\">\n        <h4>\n          ", "\n        </h4>\n      </div>\n      ", " ", "\n      ", " ", "\n      ", "\n    </div>"])), this.collapsed ? "true" : "false", this.collapsed ? "-1" : "0", this.trayDetail, this.trayLabel || "".concat(this.activeTagName, " ").concat(this.t.properties), this.viewSourceTemplate, this.advancedSettingsTemplate, this.contentMapTemplate, this.contentEditTemplate, this.contentAddTemplate);
      }
    }, {
      key: "viewSourceTemplate",
      get: function get() {
        return (0, _index.html)(_templateObject11_299e2f10edcb11edb3e3ed4f0d506a4b || (_templateObject11_299e2f10edcb11edb3e3ed4f0d506a4b = babelHelpers.taggedTemplateLiteral([" <hax-view-source\n      id=\"view-source\"\n      ?hidden=\"", "\"\n    ></hax-view-source>"])), this.trayDetail !== "view-source");
      }
    }, {
      key: "advancedSettingsTemplate",
      get: function get() {
        return (0, _index.html)(_templateObject12_299e2f10edcb11edb3e3ed4f0d506a4b || (_templateObject12_299e2f10edcb11edb3e3ed4f0d506a4b = babelHelpers.taggedTemplateLiteral([" <hax-preferences-dialog\n      ?hidden=\"", "\"\n    ></hax-preferences-dialog>"])), this.trayDetail !== "advanced-settings");
      }
    }, {
      key: "contentEditTemplate",
      get: function get() {
        return (0, _index.html)(_templateObject13_299e2f10edcb11edb3e3ed4f0d506a4b || (_templateObject13_299e2f10edcb11edb3e3ed4f0d506a4b = babelHelpers.taggedTemplateLiteral([" <simple-fields\n      id=\"settingsform\"\n      disable-responsive\n      code-theme=\"", "\"\n      ?hidden=\"", "\"\n    ></simple-fields>"])), this.haxUiTheme == "system" ? "auto" : this.haxUiTheme == "haxdark" ? "vs-dark" : "vs", this.trayDetail !== "content-edit");
      }
    }, {
      key: "contentAddTemplate",
      get: function get() {
        var hidden = this.trayDetail !== "content-add";
        return (0, _index.html)(_templateObject14_299e2f10edcb11edb3e3ed4f0d506a4b || (_templateObject14_299e2f10edcb11edb3e3ed4f0d506a4b = babelHelpers.taggedTemplateLiteral(["<div class=\"block-add-wrapper\">\n      <hax-tray-upload ?hidden=\"", "\" show-sources></hax-tray-upload>\n      <hax-gizmo-browser\n        id=\"gizmobrowser\"\n        ?hidden=\"", "\"\n      ></hax-gizmo-browser>\n      <hax-stax-browser\n        id=\"staxbrowser\"\n        ?hidden=\"", "\"\n        label=\"", "\"\n      ></hax-stax-browser>\n      <hax-app-search ?hidden=\"", "\" id=\"haxappsearch\"></hax-app-search>\n    </div>"])), hidden, hidden, hidden, this.t.templates, hidden);
      }
    }, {
      key: "contentMapTemplate",
      get: function get() {
        return (0, _index.html)(_templateObject15_299e2f10edcb11edb3e3ed4f0d506a4b || (_templateObject15_299e2f10edcb11edb3e3ed4f0d506a4b = babelHelpers.taggedTemplateLiteral(["<hax-map\n      controls=\"content-map\"\n      ?hidden=\"", "\"\n    ></hax-map>"])), this.trayDetail !== "content-map");
      }
    }, {
      key: "_refreshAddData",
                        ...
                        case 5:
                          ...
                          if (propName == "activeGizmo" && _this3.trayDetail !== "view-source") {
                            if (_this3.activeGizmo) {
                              ...
                              if (!oldValue || !["content-map", "content-edit", "content-add"].includes(_this3.trayDetail)) {
      ...
      value: function () {
        var _setupForm2 = babelHelpers.asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
          var _this4 = this;
          var activeNode, props, _loop, property, tmp, isGrid, setProps;
          return _regeneratorRuntime().wrap(function _callee3$(_context4) {
            while (1) switch (_context4.prev = _context4.next) {
              case 0:
                ...
                _loop = /*#__PURE__*/_regeneratorRuntime().mark(function _loop(property) {
                  return _regeneratorRuntime().wrap(function _loop$(_context3) {
                    while (1) switch (_context3.prev = _context3.next) {
                      case 0:
                        ...
                        props.settings.developer.forEach(function (el) {
                          if (el.property === property) {
                            _this4.activeValue.settings.developer[property] = _this4.activeHaxElement.properties[property];
                          }
                          if (el.attribute === property) {
                            _this4.activeValue.settings.developer[property] = _this4.activeHaxElement.properties[property];
                          }
                ...
                _context4.t0 = _regeneratorRuntime().keys(this.activeHaxElement.properties);
              case 9:
                ...
                return _context4.delegateYield(_loop(property), "t2", 12);
              case 12:
                _context4.next = 9;
                break;
              case 14:
                ...
                tmp.childNodes.forEach(function (el) {
                  ...
                  if (el.nodeType === 1 && el.innerHTML !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {
                    ...
                    // now advanced
                    props.settings.developer.forEach(function (prop) {
                      if (prop.slot === el.getAttribute("slot")) {
                        _this4.activeValue.settings.developer[prop.slot] = el.innerHTML;
                      }
                      // no slot and it didnt match so it has no slot
                      else if (prop.slot == "" && (el.getAttribute("slot") == null || el.getAttribute("slot") == "null")) {
                          _this4.activeValue.settings.developer[prop.slot] = el.innerHTML;
                ...
                if (activeNode.style.width != "") {
                  this.activeValue.settings.advanced.__scale = activeNode.style.width.replace("%", "");
                } else {
                ...
                props.settings.developer.forEach(function (val, key) {
                ...
                setProps = function setProps(propName, propTitle) {
                  ...
                  _this4.activeSchema[0].properties.push({
                    ...
                    expanded: propName === "configure" && (!_haxStore.HAXStore.isTextElement(_this4.activeNode) || _haxStore.HAXStore.isInlineElement(_this4.activeNode)),
                    accordion: true
                  });
                      ...
                      // this is a special internal held "property" for layout stuff
                        ...
                        // this is a special internal held "property" for layout stuff
                          ...
                          // then by seeing if we have an array / object
                              ...
                              var _loop4 = function _loop4() {
                                if (_this5.__activePropSchema.settings[key][propTmp].slot == prop) {
                                  ...
                                  if (_this5.__activePropSchema.settings[key][propTmp].slotAttributes) {
                                    for (var attr in _this5.__activePropSchema.settings[key][propTmp].slotAttributes) {
                              ...
                              for (var propTmp in _this5.__activePropSchema.settings[key]) {
                                _loop4();
                              }
                            }
