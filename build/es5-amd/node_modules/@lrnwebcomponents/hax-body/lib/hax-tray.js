define(["exports", "require", "../../../lit-element/lit-element.js", "../../utils/utils.js", "../../a11y-collapse/lib/a11y-collapse-group.js", "../../a11y-collapse/a11y-collapse.js", "../../hax-body-behaviors/lib/HAXFields.js", "./hax-map.js", "./hax-preferences-dialog.js", "../../simple-popover/lib/SimpleTourFinder.js", "./hax-store.js", "../../simple-popover/simple-popover.js", "../../../mobx/dist/mobx.esm.js"], function (_exports, _require, _litElement, _utils, _a11yCollapseGroup, _a11yCollapse, _HAXFields, _haxMap, _haxPreferencesDialog, _SimpleTourFinder2, _haxStore, _simplePopover, _mobxEsm) {
  ...
  function _templateObject4_bc98c410157411eb91e46d84b27d8456() {
    ...
    _templateObject4_bc98c410157411eb91e46d84b27d8456 = function _templateObject4_bc98c410157411eb91e46d84b27d8456() {
      return data;
    };
  ...
  function _templateObject3_bc98c410157411eb91e46d84b27d8456() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                  <hax-tray-button\n                    mini\n                    @click=\"", "\"\n                    icon=\"save\"\n                    id=\"haxsavebutton\"\n                    label=\"", "\"\n                    event-name=\"save\"\n                    voice-command=\"save (content)(page)\"\n                    color-meaning\n                  ></hax-tray-button>\n                  <hax-tray-button\n                    mini\n                    icon=\"cancel\"\n                    id=\"haxcancelbutton\"\n                    label=\"Cancel\"\n                    event-name=\"cancel\"\n                    voice-command=\"cancel\"\n                    color-meaning\n                  ></hax-tray-button>\n                "]);

    _templateObject3_bc98c410157411eb91e46d84b27d8456 = function _templateObject3_bc98c410157411eb91e46d84b27d8456() {
      return data;
    };
  ...
  function _templateObject2_bc98c410157411eb91e46d84b27d8456() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            <hax-tray-button\n              voice-command=\"edit page\"\n              .data-opened=\"", "\"\n              @click=\"", "\"\n              icon=\"create\"\n              id=\"button\"\n              label=\"", "\"\n            ></hax-tray-button>\n          "]);

    _templateObject2_bc98c410157411eb91e46d84b27d8456 = function _templateObject2_bc98c410157411eb91e46d84b27d8456() {
      return data;
    };
  ...
  function _templateObject_bc98c410157411eb91e46d84b27d8456() {
    ...
    _templateObject_bc98c410157411eb91e46d84b27d8456 = function _templateObject_bc98c410157411eb91e46d84b27d8456() {
      return data;
    };
  ...
  var HaxTray = /*#__PURE__*/function (_SimpleTourFinder) {
    ...
    babelHelpers.createClass(HaxTray, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_bc98c410157411eb91e46d84b27d8456(), this.hidePanelOps ? "" : (0, _litElement.html)(_templateObject2_bc98c410157411eb91e46d84b27d8456(), this.editMode, this._clickEditButton, this.__tipText), this.hidePanelOps ? "" : (0, _litElement.html)(_templateObject3_bc98c410157411eb91e46d84b27d8456(), this._clickSaveButton, this.__tipText), this.traySizeIcon, this.traySizeText, this.menuAlignName, !this.canUndo, !this.canRedo, this.hidePreferencesButton, this.activeTagIcon, this.activeTagName, this._refreshLists);
      }
    }, {
      ...
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject4_bc98c410157411eb91e46d84b27d8456())];
      }
    }, {
      key: "properties",
      get: function get() {
