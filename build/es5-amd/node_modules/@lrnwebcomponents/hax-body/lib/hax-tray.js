define(["exports", "../../../lit/index.js", "../../utils/utils.js", "../../hax-body-behaviors/lib/HAXFields.js", "../../simple-popover/lib/SimpleTourFinder.js", "./hax-store.js", "../../../mobx/dist/mobx.esm.js", "./hax-ui-styles.js", "../../simple-fields/simple-fields.js", "../../simple-fields/lib/simple-fields-tab.js", "../../simple-icon/lib/simple-icons.js", "../../hax-iconset/lib/simple-hax-iconset.js", "./hax-tray-upload.js", "./hax-app-browser.js", "./hax-gizmo-browser.js", "./hax-view-source.js", "./hax-stax-browser.js", "./hax-map.js", "./hax-preferences-dialog.js", "./hax-tray-button.js", "./hax-toolbar-menu.js", "../../super-daemon/super-daemon.js", "../../i18n-manager/lib/I18NMixin.js", "../../undo-manager/undo-manager.js", "../../iframe-loader/lib/loading-indicator.js", "../../simple-toolbar/lib/simple-toolbar-menu-item.js"], function (_exports, _index, _utils, _HAXFields, _SimpleTourFinder, _haxStore, _mobxEsm, _haxUiStyles, _simpleFields, _simpleFieldsTab, _simpleIcons, _simpleHaxIconset, _haxTrayUpload, _haxAppBrowser, _haxGizmoBrowser, _haxViewSource, _haxStaxBrowser, _haxMap, _haxPreferencesDialog, _haxTrayButton, _haxToolbarMenu, _superDaemon, _I18NMixin2, _undoManager, _loadingIndicator, _simpleToolbarMenuItem) {
  "use strict";
  ...
  var _templateObject_a804a7b0b48911edaa972d5aad30d551, _templateObject2_a804a7b0b48911edaa972d5aad30d551, _templateObject3_a804a7b0b48911edaa972d5aad30d551, _templateObject4_a804a7b0b48911edaa972d5aad30d551, _templateObject5_a804a7b0b48911edaa972d5aad30d551, _templateObject6_a804a7b0b48911edaa972d5aad30d551, _templateObject7_a804a7b0b48911edaa972d5aad30d551, _templateObject8_a804a7b0b48911edaa972d5aad30d551, _templateObject9_a804a7b0b48911edaa972d5aad30d551, _templateObject10_a804a7b0b48911edaa972d5aad30d551, _templateObject11_a804a7b0b48911edaa972d5aad30d551, _templateObject12_a804a7b0b48911edaa972d5aad30d551, _templateObject13_a804a7b0b48911edaa972d5aad30d551, _templateObject14_a804a7b0b48911edaa972d5aad30d551, _templateObject15_a804a7b0b48911edaa972d5aad30d551, _templateObject16_a804a7b0b48911edaa972d5aad30d551, _templateObject17_a804a7b0b48911edaa972d5aad30d551;
  ...
  var HaxTray = /*#__PURE__*/function (_I18NMixin) {
    ...
    babelHelpers.createClass(HaxTray, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_a804a7b0b48911edaa972d5aad30d551 || (_templateObject_a804a7b0b48911edaa972d5aad30d551 = babelHelpers.taggedTemplateLiteral(["\n      ", "\n      <div class=\"wrapper ", "\">\n        ", "\n        <div class=\"detail\">\n          <loading-indicator ?loading=\"", "\"></loading-indicator>\n          ", "\n        </div>\n      </div>\n    "])), this.panelOpsTemplate, this.trayStatus, this.menuToolbarTemplate, this.loading, this.trayDetailTemplate);
      }
    }, {
      key: "panelOpsTemplate",
      get: function get() {
        return this.hidePanelOps ? "" : (0, _index.html)(_templateObject2_a804a7b0b48911edaa972d5aad30d551 || (_templateObject2_a804a7b0b48911edaa972d5aad30d551 = babelHelpers.taggedTemplateLiteral(["\n          <hax-tray-button\n            large\n            voice-command=\"edit page\"\n            .data-opened=\"", "\"\n            @click=\"", "\"\n            icon=\"create\"\n            id=\"button\"\n            feature\n            show-text-label\n            show-tooltip\n            label=\"", "\"\n          ></hax-tray-button>\n        "])), this.editMode, this._clickEditButton, this.editMode ? this.t.save : this.t.edit);
      }
    }, {
      key: "toolbarsTemplate",
      get: function get() {
        return (0, _index.html)(_templateObject3_a804a7b0b48911edaa972d5aad30d551 || (_templateObject3_a804a7b0b48911edaa972d5aad30d551 = babelHelpers.taggedTemplateLiteral(["", "", ""])), this.opsToolbarTemplate, this.trayToolbarTemplate);
      }
    }, {
      key: "menuToolbarTemplate",
      get: function get() {
        return (0, _index.html)(_templateObject4_a804a7b0b48911edaa972d5aad30d551 || (_templateObject4_a804a7b0b48911edaa972d5aad30d551 = babelHelpers.taggedTemplateLiteral([" <div id=\"menubar\" class=\"collapse-menu\">\n      ", " ", " ", "\n      <slot name=\"tray-buttons-pre\"></slot>\n      ", "", "\n    </div>"])), this.saveButtons, this.doButtons, this.contentButtons, this.moreButtons, this.menuButtons);
      }
    }, {
      key: "menuButtons",
      get: function get() {
        return (0, _index.html)(_templateObject5_a804a7b0b48911edaa972d5aad30d551 || (_templateObject5_a804a7b0b48911edaa972d5aad30d551 = babelHelpers.taggedTemplateLiteral(["\n        <hax-tray-button\n          show-text-label\n          show-tooltip\n          align-horizontal=\"", "\"\n          id=\"haxMenuAlign\"\n          event-name=\"toggle-element-align\"\n          icon=\"arrow-", "\"\n          label=\"", "\"\n          index=\"", "\"\n          tooltip=\"", " ", "\"\n        >\n        </hax-tray-button>\n    </div>\n    "])), this.collapsed ? "left" : "center", this.elementAlign == "left" ? "forward" : "back", this.elementAlign == "left" ? this.t.menuRight : this.t.menuLeft, this.elementAlign == "left" ? "1" : "0", this.t.moveMenu, this.elementAlign == "left" ? this.t.right : this.t.left);
      }
    }, {
      key: "saveButtons",
      get: function get() {
        return this.hidePanelOps ? "" : (0, _index.html)(_templateObject6_a804a7b0b48911edaa972d5aad30d551 || (_templateObject6_a804a7b0b48911edaa972d5aad30d551 = babelHelpers.taggedTemplateLiteral(["\n          <hax-tray-button\n            @click=\"", "\"\n            icon=\"save\"\n            icon-position=\"left\"\n            id=\"haxsavebutton\"\n            label=\"", "\"\n            event-name=\"save\"\n            voice-command=\"save page\"\n            show-text-label\n            show-tooltip\n            align-horizontal=\"", "\"\n          ></hax-tray-button>\n          <hax-tray-button\n            icon=\"cancel\"\n            id=\"haxcancelbutton\"\n            label=\"", "\"\n            icon-position=\"left\"\n            show-text-label\n            show-tooltip\n            align-horizontal=\"", "\"\n          ></hax-tray-button>\n        "])), this._clickSaveButton, this.editMode ? this.t.save : this.t.edit, this.collapsed ? "left" : "center", this.t.cancel, this.collapsed ? "left" : "center");
      }
    }, {
      key: "doButtons",
      get: function get() {
        return (0, _index.html)(_templateObject7_a804a7b0b48911edaa972d5aad30d551 || (_templateObject7_a804a7b0b48911edaa972d5aad30d551 = babelHelpers.taggedTemplateLiteral([" <hax-tray-button\n        icon=\"icons:undo\"\n        ?disabled=\"", "\"\n        label=\"", "\"\n        event-name=\"undo\"\n        voice-command=\"undo\"\n        data-simple-tour-stop\n        data-stop-title=\"label\"\n        icon-position=\"left\"\n        show-text-label\n        show-tooltip\n        align-horizontal=\"", "\"\n      >\n        <div slot=\"tour\" data-stop-content>\n          Undo the previous operation in the content, whether typing or adding a\n          widget.\n        </div>\n      </hax-tray-button>\n      <hax-tray-button\n        icon=\"icons:redo\"\n        ?disabled=\"", "\"\n        label=\"", "\"\n        event-name=\"redo\"\n        voice-command=\"redo\"\n        data-simple-tour-stop\n        data-stop-title=\"label\"\n        icon-position=\"left\"\n        show-text-label\n        show-tooltip\n        align-horizontal=\"", "\"\n      >\n        <div slot=\"tour\" data-stop-content>\n          Redo the last action that you hit Undo on.\n        </div>\n      </hax-tray-button>"])), !this.canUndo, this.t.undo, this.collapsed ? "left" : "center", !this.canRedo, this.t.redo, this.collapsed ? "left" : "center");
      }
    }, {
      key: "contentButtons",
      get: function get() {
        return (0, _index.html)(_templateObject8_a804a7b0b48911edaa972d5aad30d551 || (_templateObject8_a804a7b0b48911edaa972d5aad30d551 = babelHelpers.taggedTemplateLiteral([" <hax-tray-button\n        event-name=\"content-add\"\n        icon=\"add-box\"\n        id=\"content-add\"\n        label=\"", "\"\n        voice-command=\"select blocks (menu)\"\n        data-simple-tour-stop\n        data-stop-title=\"label\"\n        controls=\"tray-detail\"\n        toggles\n        ?toggled=\"", "\"\n        icon-position=\"left\"\n        show-text-label\n        show-tooltip\n        align-horizontal=\"", "\"\n      >\n        <div slot=\"tour\" data-stop-content>\n          When you want to add any content to the page from text, to images, to\n          anything more advanced; you can always find items to add under the Add\n          content menu. Click to expand, then either drag and drop items into\n          the page or click and have them placed near whatever you are actively\n          working on.\n        </div>\n      </hax-tray-button>\n      <hax-tray-button\n        event-name=\"media-add\"\n        icon=\"image:collections\"\n        id=\"media-add\"\n        label=\"", "\"\n        voice-command=\"select media (menu)\"\n        data-simple-tour-stop\n        data-stop-title=\"label\"\n        controls=\"tray-detail\"\n        toggles\n        ?toggled=\"", "\"\n        icon-position=\"left\"\n        show-text-label\n        show-tooltip\n        align-horizontal=\"", "\"\n      >\n        <div slot=\"tour\" data-stop-content>\n          Search for media and content anywhere that your copy of HAX has access\n          to. Pick what to search, perform the search and then click or drag the\n          item into the contnet.\n        </div>\n      </hax-tray-button>\n      <hax-tray-button\n        event-name=\"content-edit\"\n        icon=\"build\"\n        id=\"content-edit\"\n        label=\"", "\"\n        ?disabled=\"", "\"\n        voice-command=\"(modify)(configure)(edit) selected\"\n        data-simple-tour-stop\n        data-stop-title=\"label\"\n        controls=\"tray-detail\"\n        tooltip=\"", " ", "\"\n        toggles\n        ?toggled=\"", "\"\n        icon-position=\"left\"\n        show-text-label\n        show-tooltip\n        align-horizontal=\"", "\"\n      >\n        <div slot=\"tour\" data-stop-content>\n          When you want to add any content to the page from text, to images, to\n          anything more advanced; you can always find items to add under the Add\n          content menu. Click to expand, then either drag and drop items into\n          the page or click and have them placed near whatever you are actively\n          working on.\n        </div>\n      </hax-tray-button>\n      <hax-tray-button\n        event-name=\"content-map\"\n        icon=\"icons:toc\"\n        id=\"content-map\"\n        label=\"", "\"\n        voice-command=\"select structure (menu)\"\n        data-simple-tour-stop\n        data-stop-title=\"label\"\n        controls=\"tray-detail\"\n        toggles\n        ?toggled=\"", "\"\n        icon-position=\"left\"\n        show-text-label\n        show-tooltip\n        align-horizontal=\"", "\"\n      >\n        <div data-stop-content>\n          This is a simple list of all the block areas of the page that are\n          clickable to jump through items quickly as well as review some simple\n          overview stats.\n        </div>\n      </hax-tray-button>"])), this.t.blocks, !this.collapsed && this.trayDetail === "content-add", this.collapsed ? "left" : "center", this.t.media, !this.collapsed && this.trayDetail === "media-add", this.collapsed ? "left" : "center", this.t.edit, !this.activeTagName || this.activeTagName == "" || !this.activeNode || !this.activeNode.tagName, this.t.edit, this.activeTagName, !this.collapsed && this.trayDetail === "content-edit", this.collapsed ? "left" : "center", this.t.structure, !this.collapsed && this.trayDetail === "content-map", this.collapsed ? "left" : "center");
      }
    }, {
      key: "moreButtons",
      get: function get() {
        return (0, _index.html)(_templateObject9_a804a7b0b48911edaa972d5aad30d551 || (_templateObject9_a804a7b0b48911edaa972d5aad30d551 = babelHelpers.taggedTemplateLiteral(["<hax-tray-button\n        id=\"exportbtn\"\n        icon=\"code\"\n        label=\"", "\"\n        event-name=\"view-source\"\n        voice-command=\"view (page) source\"\n        data-simple-tour-stop\n        data-stop-title=\"label\"\n        icon-position=\"left\"\n        show-text-label\n        show-tooltip\n        align-horizontal=\"", "\"\n      >\n        <div data-stop-content>\n          Every change you make in HAX is ultimately writing HTML. Know HTML?\n          Awesome, pop open the source view and make any changes you like. HTML\n          is always behind the scenes ensuring that content is portable, well\n          formatted and easy to read.\n        </div>\n      </hax-tray-button>\n      <hax-tray-button\n        ?hidden=\"", "\"\n        id=\"advanced-settings\"\n        event-name=\"advanced-settings\"\n        icon=\"settings\"\n        label=\"", "\"\n        voice-command=\"select settings (menu)\"\n        data-simple-tour-stop\n        data-stop-title=\"label\"\n        controls=\"tray-detail\"\n        toggles\n        ?toggled=\"", "\"\n        icon-position=\"left\"\n        show-text-label\n        show-tooltip\n        align-horizontal=\"", "\"\n      >\n        <div data-stop-content>User preferences for customizing HAX</div>\n      </hax-tray-button>\n      <hax-tray-button\n        event-name=\"", "\"\n        icon=\"help\"\n        label=\"", "\"\n        voice-command=\"start tour\"\n        toggles\n        ?toggled=\"", "\"\n        icon-position=\"left\"\n        show-text-label\n        show-tooltip\n        align-horizontal=\"", "\"\n      ></hax-tray-button>\n      <hax-tray-button\n        event-name=\"super-daemon\"\n        icon=\"android\"\n        label=\"", "\"\n        voice-command=\"", "\"\n        toggles\n        ?toggled=\"", "\"\n        icon-position=\"left\"\n        show-text-label\n        show-tooltip\n        align-horizontal=\"", "\"\n      ></hax-tray-button> "])), this.t.source, this.collapsed ? "left" : "center", this.hidePreferencesButton, this.t.settings, !this.collapsed && this.trayDetail === "advanced-settings", this.collapsed ? "left" : "center", this.tourOpened ? "stop-tour" : "start-tour", this.t.takeATour, !this.collapsed && this.tourOpened, this.collapsed ? "left" : "center", this.t.superMenu, this.t.superMenu, !this.collapsed && this.tourOpened, this.collapsed ? "left" : "center");
      }
    }, {
      key: "trayDetailTemplate",
      get: function get() {
        return (0, _index.html)(_templateObject10_a804a7b0b48911edaa972d5aad30d551 || (_templateObject10_a804a7b0b48911edaa972d5aad30d551 = babelHelpers.taggedTemplateLiteral([" <div\n      id=\"tray-detail\"\n      aria-live=\"polite\"\n      aria-disabled=\"", "\"\n      tabindex=\"", "\"\n      selected-detail=\"", "\"\n    >\n      <div class=\"tray-detail-titlebar\">\n        <hax-tray-button\n          voice-command=\"collapse menu\"\n          id=\"toggle-tray-size\"\n          event-name=\"toggle-tray-size\"\n          icon=\"close\"\n          label=\"", "\"\n        >\n        </hax-tray-button>\n        <h4>", "</h4>\n      </div>\n      ", " ", "\n      ", " ", "\n      ", " ", "\n    </div>"])), this.collapsed ? "true" : "false", this.collapsed ? "-1" : "0", this.trayDetail, this.t.close, this.trayLabel || "".concat(this.t.edit, " ").concat(this.activeTagName), this.viewSourceTemplate, this.advancedSettingsTemplate, this.contentMapTemplate, this.contentEditTemplate, this.contentAddTemplate, this.mediaTemplate);
      }
    }, {
      key: "viewSourceTemplate",
      get: function get() {
        return (0, _index.html)(_templateObject11_a804a7b0b48911edaa972d5aad30d551 || (_templateObject11_a804a7b0b48911edaa972d5aad30d551 = babelHelpers.taggedTemplateLiteral([" <hax-view-source\n      id=\"view-source\"\n      ?hidden=\"", "\"\n    ></hax-view-source>"])), this.trayDetail !== "view-source");
      }
    }, {
      key: "advancedSettingsTemplate",
      get: function get() {
        return (0, _index.html)(_templateObject12_a804a7b0b48911edaa972d5aad30d551 || (_templateObject12_a804a7b0b48911edaa972d5aad30d551 = babelHelpers.taggedTemplateLiteral([" <hax-preferences-dialog\n      ?hidden=\"", "\"\n    ></hax-preferences-dialog>"])), this.trayDetail !== "advanced-settings");
      }
    }, {
      key: "contentEditTemplate",
      get: function get() {
        return (0, _index.html)(_templateObject13_a804a7b0b48911edaa972d5aad30d551 || (_templateObject13_a804a7b0b48911edaa972d5aad30d551 = babelHelpers.taggedTemplateLiteral([" <simple-fields\n      id=\"settingsform\"\n      disable-responsive\n      code-theme=\"", "\"\n      ?hidden=\"", "\"\n    ></simple-fields>"])), this.haxUiTheme == "system" ? "auto" : this.haxUiTheme == "haxdark" ? "vs-dark" : "vs", this.trayDetail !== "content-edit");
      }
    }, {
      key: "contentAddTemplate",
      get: function get() {
        var hidden = this.trayDetail !== "content-add";
        return (0, _index.html)(_templateObject14_a804a7b0b48911edaa972d5aad30d551 || (_templateObject14_a804a7b0b48911edaa972d5aad30d551 = babelHelpers.taggedTemplateLiteral(["<div class=\"block-add-wrapper\">\n      <hax-gizmo-browser\n        id=\"gizmobrowser\"\n        ?hidden=\"", "\"\n      ></hax-gizmo-browser>\n      <hax-stax-browser\n        id=\"staxbrowser\"\n        ?hidden=\"", "\"\n        label=\"", "\"\n      ></hax-stax-browser>\n    </div>"])), hidden, hidden, this.t.templates);
      }
    }, {
      key: "contentMapTemplate",
      get: function get() {
        return (0, _index.html)(_templateObject15_a804a7b0b48911edaa972d5aad30d551 || (_templateObject15_a804a7b0b48911edaa972d5aad30d551 = babelHelpers.taggedTemplateLiteral(["<hax-map\n      controls=\"content-map\"\n      ?hidden=\"", "\"\n    ></hax-map>"])), this.trayDetail !== "content-map");
      }
    }, {
      key: "mediaTemplate",
      get: function get() {
        var hidden = this.trayDetail !== "media-add";
        return (0, _index.html)(_templateObject16_a804a7b0b48911edaa972d5aad30d551 || (_templateObject16_a804a7b0b48911edaa972d5aad30d551 = babelHelpers.taggedTemplateLiteral([" <hax-tray-upload ?hidden=\"", "\"></hax-tray-upload>\n      <h5 ?hidden=\"", "\">", "</h5>\n      <hax-app-browser id=\"appbrowser\" ?hidden=\"", "\"></hax-app-browser>"])), hidden, hidden, this.t.search, hidden);
      }
    }, {
      ...
      value: function _processTrayEvent(e) {
        ...
        switch (evt) {
          ...
          case "toggle-tray-size":
            ...
            break;
          case "super-daemon":
            _superDaemon.SuperDaemonInstance.opened = !_superDaemon.SuperDaemonInstance.opened;
            break;
          case "content-map":
            this.trayDetail = e.detail.eventName;
            this.collapsed = false;
          ...
          return _regeneratorRuntime().wrap(function _callee3$(_context4) {
            while (1) switch (_context4.prev = _context4.next) {
              ...
              case 11:
                ...
                return _context4.delegateYield(_loop(property), "t2", 14);
              case 14:
                _context4.next = 11;
                break;
              case 16:
