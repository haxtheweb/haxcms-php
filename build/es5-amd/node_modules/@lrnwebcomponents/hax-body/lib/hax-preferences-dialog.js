define(["exports", "../../../lit-element/lit-element.js", "../../hax-body-behaviors/lib/HAXFields.js", "../../simple-icon/lib/simple-icon-lite.js", "../../simple-fields/simple-fields.js", "./hax-store.js", "../../../mobx/dist/mobx.esm.js"], function (_exports, _litElement, _HAXFields, _simpleIconLite, _simpleFields, _haxStore, _mobxEsm) {
  ...
  function _templateObject2_bf1af8902dd211eba8a9dbdc0fc9b6e0() {
    ...
    _templateObject2_bf1af8902dd211eba8a9dbdc0fc9b6e0 = function _templateObject2_bf1af8902dd211eba8a9dbdc0fc9b6e0() {
      return data;
    };
  ...
  function _templateObject_bf1af8902dd211eba8a9dbdc0fc9b6e0() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n        .title {\n          position: relative;\n          padding: 16px;\n          outline: 0;\n          font-weight: 600;\n          text-align: left;\n          margin: 0;\n          background-color: var(--hax-color-menu-heading-bg, #eeeeee);\n          color: var(--hax-color-menu-heading-color, black);\n          font-size: 18px;\n          line-height: 18px;\n          font-family: \"Noto Serif\", serif;\n        }\n        .pref-container {\n          text-align: left;\n          padding: 16px;\n        }\n        #reportghissue {\n          color: #81a3a9;\n          font-size: 18px;\n          padding: 16px;\n          font-style: italic;\n        }\n      "]);

    _templateObject_bf1af8902dd211eba8a9dbdc0fc9b6e0 = function _templateObject_bf1af8902dd211eba8a9dbdc0fc9b6e0() {
      return data;
    };
  ...
  var HaxPreferencesDialog = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(HaxPreferencesDialog, null, [{
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject_bf1af8902dd211eba8a9dbdc0fc9b6e0())];
      }
    }]);
    ...
    babelHelpers.createClass(HaxPreferencesDialog, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_bf1af8902dd211eba8a9dbdc0fc9b6e0(), this.title, _HAXFields.HaxSchematizer, _HAXFields.HaxElementizer, this.ghLink);
      }
    }, {
      key: "firstUpdated",
