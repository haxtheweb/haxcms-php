 ...
 */(0,_polymerLegacy.Polymer)({_template:(0,_polymerLegacy.html)(_templateObject_cdeed0c068f411e996b0af119cd7f5ea()),is:"hax-preview",observers:["_valueChanged(value.*)"],properties:{/**
     * A reference to the previewNode so we can do data binding correctly.
     */previewNode:{type:Object,value:{},notify:!0/* transition */ /* transition */,observer:"_previewNodeChanged"},/**
     ...
     */humanName:{type:String}},created:function created(){new Promise(function(res,rej){return _require.default(["@lrnwebcomponents/code-editor/code-editor.js"],res,rej)});new Promise(function(res,rej){return _require.default(["@polymer/paper-input/paper-textarea.js"],res,rej)});new Promise(function(res,rej){return _require.default(["app-datepicker/app-datepicker.js"],res,rej)});new Promise(function(res,rej){return _require.default(["@polymer/paper-toggle-button/paper-toggle-button.js"],res,rej)});new Promise(function(res,rej){return _require.default(["@lrnwebcomponents/hax-body/lib/hax-upload-field.js"],res,rej)});new Promise(function(res,rej){return _require.default(["@lrnwebcomponents/simple-picker/simple-picker.js"],res,rej)});new Promise(function(res,rej){return _require.default(["@lrnwebcomponents/simple-icon-picker/simple-icon-picker.js"],res,rej)});new Promise(function(res,rej){return _require.default(["@lrnwebcomponents/paper-input-flagged/paper-input-flagged.js"],res,rej)})},/**
   * Trigger cancel on manager as it is the parent here.
   */cancel:function cancel(e){window.HaxStore.instance.haxManager.cancel(e)},/**
   * Trigger insert on manager as it is the parent here.
   */insert:function insert(e){window.HaxStore.instance.haxManager.insertHaxElement(e)},/**
   * Make a boolean to match the preview node's existance.
   */_computedHasPreviewNode:function _computedHasPreviewNode(previewNode){if(babelHelpers.typeof(previewNode.tagName)===("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){return!1}else{return!0}},/**
   * Edit source.
   */_computedEditSource:function _computedEditSource(newValue,oldValue){if(babelHelpers.typeof(newValue)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){if(babelHelpers.typeof(this.previewNode.tagName)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))&&window.HaxStore.instance.elementList[this.previewNode.tagName.toLowerCase()]){return window.HaxStore.instance.elementList[this.previewNode.tagName.toLowerCase()].canEditSource}}return!0},/**
   ...
   */_formKeyChanged:function _formKeyChanged(newValue,oldValue){// ensure this doesn't run the 1st pass
...
if("prefix"!=property&&null!=element.properties[property]&&!element.properties[property].readOnly){// attempt to set it, should be no problem but never know
try{this.previewNode.set(property,element.properties[property])}catch(e){console.warn("".concat(property," is busted some how"));console.log(e)}}else if("prefix"===property){this.previewNode.setAttribute("prefix",element.properties[property])}else{console.warn("".concat(property," is busted some how"))}}this.set("value."+property,element.properties[property]);this.notifyPath("value."+property)}}var slotsApplied=!1;for(var prop in props.settings[newValue]){var previewNode=this.previewNode;if(babelHelpers.typeof(props.settings[this.formKey][prop].slot)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))&&!slotsApplied){slotsApplied=!0;// walk through the slots looking for the value of it
...
if(babelHelpers.typeof((0,_polymerDom.dom)(previewNode).getEffectiveChildNodes()[i])!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))&&1===(0,_polymerDom.dom)(previewNode).getEffectiveChildNodes()[i].nodeType&&(0,_polymerDom.dom)(previewNode).getEffectiveChildNodes()[i].slot===props.settings[this.formKey][prop].slot){if(babelHelpers.typeof((0,_polymerDom.dom)(previewNode).getEffectiveChildNodes()[i].innerHTML)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){schema.properties[props.settings[this.formKey][prop].slot].value=(0,_polymerDom.dom)(previewNode).getEffectiveChildNodes()[i].innerHTML;this.set("value."+props.settings[this.formKey][prop].slot,(0,_polymerDom.dom)(previewNode).getEffectiveChildNodes()[i].innerHTML);this.notifyPath("value."+props.settings[this.formKey][prop].slot)}}}}}}this.set("schema",{});this.set("schema",schema)}},/**
   ...
   */_previewNodeChanged:function _previewNodeChanged(newValue,oldValue){// ensure this doesn't run the 1st pass
...
if(babelHelpers.typeof((0,_polymerDom.dom)(newValue).getEffectiveChildNodes()[i])!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))&&1===(0,_polymerDom.dom)(newValue).getEffectiveChildNodes()[i].nodeType&&(0,_polymerDom.dom)(newValue).getEffectiveChildNodes()[i].slot===props.settings[this.formKey][prop].slot){if(babelHelpers.typeof((0,_polymerDom.dom)(newValue).getEffectiveChildNodes()[i].innerHTML)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){schema.properties[props.settings[this.formKey][prop].slot].value=(0,_polymerDom.dom)(newValue).getEffectiveChildNodes()[i].innerHTML;this.set("value."+props.settings[this.formKey][prop].slot,(0,_polymerDom.dom)(newValue).getEffectiveChildNodes()[i].innerHTML);this.notifyPath("value."+props.settings[this.formKey][prop].slot)}}}}}this.set("schema",{});this.set("schema",schema)}}},/**
   ...
   */_elementChanged:function _elementChanged(newValue,oldValue){if(babelHelpers.typeof(newValue)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){// wipe the preview area and assocaited node
...
this.set("previewNode",newNode)}}else{this.modeTab="advanced";this.set("previewNode",{})}},/**
   ...
   */_valueChanged:function _valueChanged(valueChange){var node=this.previewNode;// sanity check and then get props and mesh with form value response
