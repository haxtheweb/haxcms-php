 ...
 */(0,_polymerLegacy.Polymer)({_template:(0,_polymerLegacy.html)(_templateObject_185387f066fc11e984d945fe2fe0aa60()),is:"hax-preview",observers:["_valueChanged(value.*)"],properties:{/**
     ...
     */humanName:{type:String}},created:function created(){new Promise(function(res,rej){return _require.default(["../../code-editor/code-editor.js"],res,rej)});new Promise(function(res,rej){return _require.default(["../../../@polymer/paper-input/paper-textarea.js"],res,rej)});new Promise(function(res,rej){return _require.default(["../../../app-datepicker/app-datepicker.js"],res,rej)});new Promise(function(res,rej){return _require.default(["../../../@polymer/paper-toggle-button/paper-toggle-button.js"],res,rej)});new Promise(function(res,rej){return _require.default(["./hax-upload-field.js"],res,rej)});new Promise(function(res,rej){return _require.default(["../../simple-picker/simple-picker.js"],res,rej)});new Promise(function(res,rej){return _require.default(["../../simple-icon-picker/simple-icon-picker.js"],res,rej)});new Promise(function(res,rej){return _require.default(["../../paper-input-flagged/paper-input-flagged.js"],res,rej)})},/**
