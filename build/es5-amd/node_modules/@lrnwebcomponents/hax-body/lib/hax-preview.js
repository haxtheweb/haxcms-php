define(["exports", "require", "../../../@polymer/polymer/polymer-element.js", "../../../@polymer/polymer/lib/utils/flattened-nodes-observer.js", "./haxutils.js", "../../../@polymer/iron-media-query/iron-media-query.js"], function (_exports, _require, _polymerElement, _flattenedNodesObserver, _haxutils, _ironMediaQuery) {
  "use strict";
  ...
  function _templateObject_13bae7400ca311eaa0151532aa92855f() {
    ...
    _templateObject_13bae7400ca311eaa0151532aa92855f = function _templateObject_13bae7400ca311eaa0151532aa92855f() {
      return data;
    };
  ...
  function (_PolymerElement) {
    ...
    babelHelpers.createClass(HaxPreview, [{
                ...
                for (var i in newValueChildren) {
                  ...
                  if (babelHelpers.typeof(newValueChildren[i]) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined)) && newValueChildren[i].nodeType === 1 && newValueChildren[i].slot === props.settings[this.formKey][prop].slot) {
                    if (babelHelpers.typeof(newValueChildren[i].innerHTML) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {
                      ...
                      this.set("value." + props.settings[this.formKey][prop].slot, newValueChildren[i].innerHTML);
                      this.notifyPath("value." + props.settings[this.formKey][prop].slot);
                    }
                  }
                }
      ...
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_13bae7400ca311eaa0151532aa92855f());
      }
    }, {
      key: "tag",
      get: function get() {
