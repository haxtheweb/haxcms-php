define(["exports", "require", "../../../@polymer/polymer/polymer-element.js", "../../../@polymer/polymer/lib/utils/render-status.js", "../../materializecss-styles/lib/colors.js", "../../simple-colors/simple-colors.js", "./hax-shared-styles.js"], function (_exports, _require, _polymerElement, _renderStatus, _colors, _simpleColors, _haxSharedStyles) {
  ...
  function _templateObject_5d7e7c70b53711e9aa40b7626f5cd426() {
    ...
    _templateObject_5d7e7c70b53711e9aa40b7626f5cd426 = function _templateObject_5d7e7c70b53711e9aa40b7626f5cd426() {
      return data;
    };
  ...
  function (_PolymerElement) {
    ...
    function HaxToolbar() {
      ...
      new Promise(function (res, rej) {
        return _require.default(["@lrnwebcomponents/hax-body/lib/hax-toolbar-item.js"], res, rej);
      });
      new Promise(function (res, rej) {
        return _require.default(["@lrnwebcomponents/hax-body/lib/hax-toolbar-menu.js"], res, rej);
      });
      new Promise(function (res, rej) {
    ...
    babelHelpers.createClass(HaxToolbar, [{
      ...
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_5d7e7c70b53711e9aa40b7626f5cd426());
      }
    }, {
      key: "tag",
      get: function get() {
