define(["exports", "../../../lit/index.js", "./hax-toolbar.js", "../../simple-toolbar/lib/simple-toolbar-menu-item.js", "./hax-store.js", "./hax-toolbar-menu.js", "./hax-context-item.js", "../../utils/utils.js", "../../../mobx/dist/mobx.esm.js", "./hax-context-behaviors.js", "../../i18n-manager/lib/I18NMixin.js", "../../simple-toast/simple-toast.js"], function (_exports, _index, _haxToolbar, _simpleToolbarMenuItem, _haxStore, _haxToolbarMenu, _haxContextItem, _utils, _mobxEsm, _haxContextBehaviors, _I18NMixin2, _simpleToast) {
  ...
  var _templateObject_640ad9c02ee311eda9c37b2c2696a94a, _templateObject2_640ad9c02ee311eda9c37b2c2696a94a, _templateObject3_640ad9c02ee311eda9c37b2c2696a94a, _templateObject4_640ad9c02ee311eda9c37b2c2696a94a, _templateObject5_640ad9c02ee311eda9c37b2c2696a94a, _templateObject6_640ad9c02ee311eda9c37b2c2696a94a;
    ...
    babelHelpers.createClass(HaxPlateContext, [{
      ...
      value: function render() {
        ...
        return (0, _index.html)(_templateObject_640ad9c02ee311eda9c37b2c2696a94a || (_templateObject_640ad9c02ee311eda9c37b2c2696a94a = babelHelpers.taggedTemplateLiteral(["\n      <hax-toolbar always-expanded>\n        <div class=\"group\">\n          <hax-toolbar-menu\n            ?disabled=\"", "\"\n            id=\"drag\"\n            action\n            icon=\"hax:arrow-all\"\n            label=\"", "\"\n            draggable=\"true\"\n            reset-on-select\n            data-simple-tour-stop\n            data-stop-title=\"label\"\n            ?hidden=\"", "\"\n          >\n            <simple-toolbar-menu-item slot=\"menuitem\">\n              <hax-context-item\n                action\n                align-horizontal=\"left\"\n                ?disabled=\"", "\"\n                show-text-label\n                role=\"menuitem\"\n                icon=\"hax:keyboard-arrow-up\"\n                label=\"", "\"\n                event-name=\"hax-plate-up\"\n              ></hax-context-item>\n            </simple-toolbar-menu-item>\n            <simple-toolbar-menu-item slot=\"menuitem\">\n              <hax-context-item\n                action\n                align-horizontal=\"left\"\n                ?disabled=\"", "\"\n                role=\"menuitem\"\n                show-text-label\n                icon=\"hax:keyboard-arrow-down\"\n                label=\"", "\"\n                event-name=\"hax-plate-down\"\n              ></hax-context-item>\n            </simple-toolbar-menu-item>\n            ", "\n            <div slot=\"tour\" data-stop-content>\n              Click the drag handle once to show a menu to just move up or down\n              one item in the content OR click and drag to place the item\n              exactly where you want it to go.\n            </div>\n          </hax-toolbar-menu>\n          <hax-toolbar-menu\n            action\n            align-horizontal=\"left\"\n            ?disabled=\"", "\"\n            icon=\"hax:select-element\"\n            label=\"", "\"\n          >\n            <simple-toolbar-menu-item slot=\"menuitem\">\n              <hax-context-item\n                action\n                align-horizontal=\"left\"\n                ?hidden=\"", "\"\n                .icon=\"", "\"\n                label=\"", "\"\n                event-name=\"hax-select-grid\"\n                .eventData=\"", "\"\n                role=\"menuitem\"\n                show-text-label\n              >\n              </hax-context-item>\n              <hax-context-item\n                action\n                align-horizontal=\"left\"\n                ?disabled=\"", "\"\n                ?hidden=\"", "\"\n                .icon=\"", "\"\n                label=\"", "\"\n                event-name=\"hax-select-grid\"\n                .eventData=\"", "\"\n                role=\"menuitem\"\n                show-text-label\n              >\n              </hax-context-item>\n            </simple-toolbar-menu-item>\n            ", "\n            \n          </hax-toolbar-menu>\n          <slot name=\"primary\"></slot>\n          <hax-toolbar-menu\n            icon=\"add-box\"\n            label=\"", "\"\n            ?disabled=\"", "\"\n          >\n            <simple-toolbar-menu-item slot=\"menuitem\">\n              <hax-context-item\n                action\n                align-horizontal=\"left\"\n                show-text-label\n                role=\"menuitem\"\n                ?disabled=\"", "\"\n                icon=\"hardware:keyboard-arrow-up\"\n                event-name=\"insert-above-active\"\n                label=\"", "\"\n              ></hax-context-item>\n            </simple-toolbar-menu-item>\n            <simple-toolbar-menu-item slot=\"menuitem\">\n              <hax-context-item\n                action\n                align-horizontal=\"left\"\n                show-text-label\n                role=\"menuitem\"\n                icon=\"hardware:keyboard-arrow-down\"\n                event-name=\"insert-below-active\"\n                label=\"", "\"\n                ?disabled=\"", "\"\n              ></hax-context-item>\n            </simple-toolbar-menu-item>\n            ", "\n          </hax-toolbar-menu>\n          <hax-context-item\n            action\n            ?disabled=\"", "\"\n            label=\"", "\"\n            icon=\"icons:content-copy\"\n            event-name=\"hax-plate-duplicate\"\n            data-simple-tour-stop\n            data-stop-title=\"label\"\n          >\n            <div slot=\"tour\" data-stop-content>\n              Duplicate the active piece of content and place it below the\n              current item.\n            </div>\n          </hax-context-item>\n        </div>\n        <hax-context-item\n          action\n          icon=\"delete\"\n          ?disabled=\"", "\"\n          icon=\"delete\"\n          label=\"", "\"\n          event-name=\"hax-plate-delete\"\n          data-simple-tour-stop\n          data-stop-title=\"label\"\n      >\n          <div slot=\"tour\" data-stop-content>\n            Delete the current item. You can always use the undo arrow to\n            bring this back.\n          </div>\n        </hax-context-item>\n          <hax-context-item\n            action\n            id=\"right\"\n            class=\"paddle\"\n            icon=\"hax:table-column-remove\"\n            label=\"", "\"\n            ?disabled=\"", "\"\n            event-name=\"hax-plate-create-right\"\n            data-simple-tour-stop\n            data-stop-title=\"label\"\n          >\n            <div slot=\"tour\" data-stop-content>\n              Add a column to split the current column into two pieces. This can\n              be done up to six pieces columns. For differnet layouts see Grid\n              settings panel.\n            </div>\n          </hax-context-item>\n          <hax-context-item\n            action\n            class=\"paddle\"\n            icon=\"hax:table-column-plus-after\"\n            label=\"", "\"\n            ?disabled=\"", "\"\n            event-name=\"hax-plate-remove-right\"\n            ?hidden=\"", "\"\n            id=\"rightremove\"\n            data-simple-tour-stop\n            data-stop-title=\"label\"\n          >\n            <div slot=\"tour\" data-stop-content>\n              Remove a column from the split column layout. If at two columns\n              and removing it will remove the layout split and make it 100%\n              width.\n            </div>\n          </hax-context-item>\n          ", "\n          <slot name=\"secondary\"></slot>\n        </div>\n        <div class=\"group\">\n          <hax-context-item\n            action\n            more\n            label=\"", "...\"\n            tooltip=\"", ", ", "\"\n            ?disabled=\"", "\"\n            event-name=\"hax-transform-node\"\n          ></hax-context-item>\n            <hax-context-item\n              action\n              label=\"", "\"\n              ?disabled=\"", "\"\n              ?hidden=\"", "\"\n              event-name=\"hax-edit-element-toggle\"\n              .eventData=\"", "\"\n              toggles\n              ?toggled=\"", "\"\n            ></hax-context-item>\n          <hax-context-item\n            action\n            icon=\"icons:code\"\n            label=\"", "\"\n            ?disabled=\"", "\"\n            event-name=\"hax-source-view-toggle\"\n            toggles\n            ?toggled=\"", "\"\n          ></hax-context-item>\n          <slot name=\"more\"></slot>\n          <hax-context-item\n            icon=\"build\"\n            action\n            align-horizontal=\"left\"\n            ?disabled=\"", "\"\n            label=\"", "\"\n            data-simple-tour-stop\n            data-stop-title=\"label\"\n            event-name=\"content-edit\"\n            toggles\n            ?toggled=\"", "\"\n          >\n            <div slot=\"tour\" data-stop-content>\n              Opens the Edit panel for more advanced settings.\n            </div>\n          </hax-context-item>\n        </div>\n      </hax-toolbar>\n    "])), this.hasActiveEditingElement || !this.canMoveElement || this.viewSource, this.t.dragHandle, !this.canMoveElement, this.hasActiveEditingElement, this.t.moveUp, this.hasActiveEditingElement, this.t.moveDown, !this.activeNode || !this.activeNode.parentNode || !_haxStore.HAXStore.isLayoutElement(this.activeNode.parentNode) ? "" : (this.slottedItems || []).map(function (slot, i) {
          ...
          return (0, _index.html)(_templateObject4_640ad9c02ee311eda9c37b2c2696a94a || (_templateObject4_640ad9c02ee311eda9c37b2c2696a94a = babelHelpers.taggedTemplateLiteral(["\n                        <simple-toolbar-menu-item\n                          slot=\"menuitem\"\n                          class=\"insert-into-active ", "\"\n                        >\n                          <hax-context-item\n                            action\n                            align-horizontal=\"left\"\n                            ?disabled=\"", "\"\n                            label=\"", "\"\n                            event-name=\"insert-into-active\"\n                            data-slot=\"", "\"\n                            role=\"menuitem\"\n                            show-text-label\n                          >\n                          </hax-context-item>\n                        </simple-toolbar-menu-item>\n                      "])), i < 1 ? "first-slot" : "", _this2.viewSource, slot.label, slot.slot);
          ...
          return (0, _index.html)(_templateObject5_640ad9c02ee311eda9c37b2c2696a94a || (_templateObject5_640ad9c02ee311eda9c37b2c2696a94a = babelHelpers.taggedTemplateLiteral([" <hax-context-item\n              action\n              icon=\"", "\"\n              label=\"", "\"\n              event-name=\"hax-ce-custom-button\"\n              value=\"", "\"\n              ?disabled=\"", "\"\n            ></hax-context-item>"])), el.icon, el.label, el.callback, el.disabled || _this2.disableItemOps);
