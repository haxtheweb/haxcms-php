define(["exports", "../../../lit-element/lit-element.js", "../../simple-tooltip/simple-tooltip.js", "../../simple-icon/lib/simple-icon-lite.js", "../../hax-iconset/lib/simple-hax-iconset.js"], function (_exports, _litElement, _simpleTooltip, _simpleIconLite, _simpleHaxIconset) {
  ...
  function _templateObject2_68613b303efe11eb800233a440abe59f() {
    ...
    _templateObject2_68613b303efe11eb800233a440abe59f = function _templateObject2_68613b303efe11eb800233a440abe59f() {
      return data;
    };
  ...
  function _templateObject_68613b303efe11eb800233a440abe59f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <button\n        .disabled=\"", "\"\n        id=\"btn\"\n        tabindex=\"0\"\n        .title=\"", "\"\n      >\n        <simple-icon-lite\n          icon=\"", "\"\n          ?hidden=\"", "\"\n        ></simple-icon-lite>\n\n        <span id=\"label\" ?hidden=\"", "\"\n          >", "</span\n        >\n        <slot></slot>\n      </button>\n      <simple-tooltip\n        for=\"btn\"\n        ?hidden=\"", "\"\n        id=\"tooltip\"\n        offset=\"10\"\n        position=\"", "\"\n      >\n        ", "\n      </simple-tooltip>\n    "]);

    _templateObject_68613b303efe11eb800233a440abe59f = function _templateObject_68613b303efe11eb800233a440abe59f() {
      return data;
    };
  ...
  var HaxToolbarItem = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(HaxToolbarItem, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_68613b303efe11eb800233a440abe59f(), this.disabled, this.tooltip, this.icon, this.icon == "" ? true : false, this.label == "" ? true : false, this.label, this.tooltip == "" ? true : false, this.tooltipDirection, this.tooltip);
      }
    }], [{
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_68613b303efe11eb800233a440abe59f())];
      }
    }, {
      key: "tag",
      get: function get() {
