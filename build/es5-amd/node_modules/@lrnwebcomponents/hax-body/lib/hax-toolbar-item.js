define(["exports", "../../../lit-element/lit-element.js", "../../simple-toolbar/lib/simple-toolbar-button.js", "./hax-ui-styles.js"], function (_exports, _litElement, _simpleToolbarButton, _haxUiStyles) {
  ...
  function _templateObject3_ca59cac08b3211ebb67059cf696085af() {
    var data = babelHelpers.taggedTemplateLiteral(["\n          :host(:hover),\n          :host(:focus-within) {\n            z-index: var(--hax-ui-focus-z-index, 1001) !important;\n          }\n        "]);

    _templateObject3_ca59cac08b3211ebb67059cf696085af = function _templateObject3_ca59cac08b3211ebb67059cf696085af() {
      return data;
    };
  ...
  function _templateObject2_ca59cac08b3211ebb67059cf696085af() {
    var data = babelHelpers.taggedTemplateLiteral([" <button\n              id=\"button\"\n              class=\"simple-toolbar-button\"\n              ?disabled=\"", "\"\n              ?controls=\"", "\"\n              @click=\"", "\"\n              @keydown=\"", "\"\n              @mousedown=\"", "\"\n              tabindex=\"0\"\n              part=\"button\"\n            >\n              ", " ", "\n            </button>\n            ", ""]);

    _templateObject2_ca59cac08b3211ebb67059cf696085af = function _templateObject2_ca59cac08b3211ebb67059cf696085af() {
      return data;
    };
  ...
  function _templateObject_ca59cac08b3211ebb67059cf696085af() {
    var data = babelHelpers.taggedTemplateLiteral([" <button\n              id=\"button\"\n              aria-pressed=\"", "\"\n              class=\"simple-toolbar-button\"\n              ?disabled=\"", "\"\n              ?controls=\"", "\"\n              @click=\"", "\"\n              @keydown=\"", "\"\n              @mousedown=\"", "\"\n              tabindex=\"0\"\n              part=\"button\"\n            >\n              ", " ", "\n            </button>\n            ", ""]);

    _templateObject_ca59cac08b3211ebb67059cf696085af = function _templateObject_ca59cac08b3211ebb67059cf696085af() {
      return data;
    };
  ...
  var HaxToolbarItemBehaviors = function HaxToolbarItemBehaviors(SuperClass) {
    return /*#__PURE__*/function (_SimpleToolbarButtonB) {
      ...
      babelHelpers.createClass(_class, [{
         ...
         */
        get: function get() {
          return this.toggles ? (0, _litElement.html)(_templateObject_ca59cac08b3211ebb67059cf696085af(), this.isToggled ? "true" : "false", this.disabled, this.controls, this._handleClick, this._handleKeys, this._handleMousedown, this.iconTemplate, this.labelTemplate, this.tooltipTemplate) : (0, _litElement.html)(_templateObject2_ca59cac08b3211ebb67059cf696085af(), this.disabled, this.controls, this._handleClick, this._handleKeys, this._handleMousedown, this.iconTemplate, this.labelTemplate, this.tooltipTemplate);
        }
      }], [{
        key: "properties",
        get: function get() {
        ...
        key: "styles",
        get: function get() {
          return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(_class), "styles", this)), [(0, _litElement.css)(_templateObject3_ca59cac08b3211ebb67059cf696085af())]);
        }
      }]);
      return _class;
