define(["exports", "../../../lit/index.js", "../../simple-toolbar/lib/simple-toolbar-button.js", "./hax-ui-styles.js"], function (_exports, _index, _simpleToolbarButton, _haxUiStyles) {
  ...
  var _templateObject_f9892020e4f411ed85766367b4d3e9fc, _templateObject2_f9892020e4f411ed85766367b4d3e9fc, _templateObject3_f9892020e4f411ed85766367b4d3e9fc, _templateObject4_f9892020e4f411ed85766367b4d3e9fc;
  ...
  var HaxToolbarItemBehaviors = function HaxToolbarItemBehaviors(SuperClass) {
    return /*#__PURE__*/function (_SimpleToolbarButtonB) {
      ...
      babelHelpers.createClass(_class, [{
         ...
         */
        function get() {
          return this.radio ? (0, _index.html)(_templateObject_f9892020e4f411ed85766367b4d3e9fc || (_templateObject_f9892020e4f411ed85766367b4d3e9fc = babelHelpers.taggedTemplateLiteral([" <button\n              id=\"button\"\n              aria-checked=\"", "\"\n              class=\"simple-toolbar-button\"\n              ?disabled=\"", "\"\n              ?controls=\"", "\"\n              @click=\"", "\"\n              @keydown=\"", "\"\n              @mousedown=\"", "\"\n              role=\"radio\"\n              part=\"button\"\n              tabindex=\"", "\"\n            >\n              ", "\n            </button>\n            ", ""])), this.isToggled ? "true" : "false", this.disabled, this.controls, this._handleClick, this._handleKeys, this._handleMousedown, this.isCurrentItem ? 1 : -1, this.buttonInnerTemplate, this.tooltipTemplate) : this.toggles ? (0, _index.html)(_templateObject2_f9892020e4f411ed85766367b4d3e9fc || (_templateObject2_f9892020e4f411ed85766367b4d3e9fc = babelHelpers.taggedTemplateLiteral([" <button\n              id=\"button\"\n              aria-pressed=\"", "\"\n              class=\"simple-toolbar-button\"\n              ?disabled=\"", "\"\n              ?controls=\"", "\"\n              @click=\"", "\"\n              @keydown=\"", "\"\n              @mousedown=\"", "\"\n              part=\"button\"\n              tabindex=\"", "\"\n            >\n              ", "\n            </button>\n            ", ""])), this.isToggled ? "true" : "false", this.disabled, this.controls, this._handleClick, this._handleKeys, this._handleMousedown, this.isCurrentItem ? 1 : -1, this.buttonInnerTemplate, this.tooltipTemplate) : (0, _index.html)(_templateObject3_f9892020e4f411ed85766367b4d3e9fc || (_templateObject3_f9892020e4f411ed85766367b4d3e9fc = babelHelpers.taggedTemplateLiteral([" <button\n              id=\"button\"\n              class=\"simple-toolbar-button\"\n              ?disabled=\"", "\"\n              ?controls=\"", "\"\n              @click=\"", "\"\n              @keydown=\"", "\"\n              @mousedown=\"", "\"\n              tabindex=\"0\"\n              part=\"button\"\n              tabindex=\"", "\"\n            >\n              ", "\n            </button>\n            ", ""])), this.disabled, this.controls, this._handleClick, this._handleKeys, this._handleMousedown, this.isCurrentItem ? 1 : -1, this.buttonInnerTemplate, this.tooltipTemplate);
        }
      }, {
        key: "_handleClick",
        ...
        key: "styles",
        get: function get() {
          return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(_class), "styles", this)), [(0, _index.css)(_templateObject4_f9892020e4f411ed85766367b4d3e9fc || (_templateObject4_f9892020e4f411ed85766367b4d3e9fc = babelHelpers.taggedTemplateLiteral(["\n          :host(:hover),\n          :host(:focus-within) {\n            z-index: var(--hax-ui-focus-z-index, 1001) !important;\n          }\n          :host {\n            --simple-toolbar-button-width: 26px;\n            --simple-toolbar-button-height: 26px;\n          }\n        "])))]);
        }
      }]);
      return _class;
