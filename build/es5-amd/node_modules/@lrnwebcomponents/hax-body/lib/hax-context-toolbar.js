define(["exports", "../../../lit-element/lit-element.js", "./hax-text-context.js", "./hax-ce-context.js", "./hax-plate-context.js", "./hax-context-item.js", "../../absolute-position-behavior/absolute-position-behavior.js"], function (_exports, _litElement, _haxTextContext, _haxCeContext, _haxPlateContext, _haxContextItem, _absolutePositionBehavior) {
  ...
  var _templateObject_b3f494a0b2b411eb9e5c9b5d1881fac2, _templateObject2_b3f494a0b2b411eb9e5c9b5d1881fac2;
  ...
  var HaxContextToolbar = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(HaxContextToolbar, [{
       ...
       */
      function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(HaxContextToolbar), "styles", this)), [(0, _litElement.css)(_templateObject2_b3f494a0b2b411eb9e5c9b5d1881fac2 || (_templateObject2_b3f494a0b2b411eb9e5c9b5d1881fac2 = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          width: 100%;\n        }\n        :host *:not(:defined) {\n          display: none !important;\n        }\n        :host(:not(.hax-visible)),\n        .item {\n          visibility: hidden;\n          opacity: 0;\n          z-index: 1000;\n          pointer-events: none;\n          transition: 0.2s top ease-in-out, 0.2s left ease-in-out;\n        }\n        :host(:hover),\n        :host(:focus-within),\n        .item:hover,\n        .item:focus-within {\n          z-index: var(--hax-ui-focus-z-index);\n        }\n        #top .menu {\n          display: flex;\n          width: 100%;\n          align-items: bottom;\n          justify-content: space-between;\n        }\n        #text,\n        #ce {\n          max-width: 280px;\n          flex: 1 1 auto;\n        }\n        #plate,\n        #add {\n          flex: 0 0 auto;\n        }\n        .item-visible,\n        .item-active {\n          visibility: visible;\n          pointer-events: all;\n          opacity: 1;\n        }\n        .item-tracking {\n          position: absolute;\n        }\n      "])))]);
      }
    }, {
      key: "tag",
      get: function get() {
