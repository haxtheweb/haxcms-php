define(["exports", "../../../@polymer/polymer/polymer-element.js", "../../../@polymer/polymer/lib/utils/render-status.js", "./hax-item-button-inner.js"], function (_exports, _polymerElement, _renderStatus, _haxItemButtonInner) {
  ...
  function _templateObject_f575d7d0d55811e9a4251fbb0db90cd4() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <style>\n        :host {\n          display: block;\n          max-width: 100px;\n        }\n        :host([elevation=\"1\"]) {\n          -webkit-transform: scale(1, 1);\n          transform: scale(1, 1);\n        }\n        :host([elevation=\"2\"]) {\n          -webkit-transform: scale(1.4, 1.4);\n          transform: scale(1.4, 1.4);\n        }\n        paper-button {\n          color: black;\n          text-transform: none;\n          min-width: unset;\n          cursor: pointer;\n          width: 80px;\n          padding: 10px;\n          margin: 10px;\n          box-shadow: none;\n        }\n      </style>\n      <paper-button on-click=\"_fireEvent\" data-voicecommand$=\"select [[title]]\">\n        <hax-item-button-inner\n          color=\"[[color]]\"\n          icon=\"[[icon]]\"\n          image=\"[[image]]\"\n          label=\"[[title]]\"\n        >\n        </hax-item-button-inner>\n      </paper-button>\n    "]);

    _templateObject_f575d7d0d55811e9a4251fbb0db90cd4 = function _templateObject_f575d7d0d55811e9a4251fbb0db90cd4() {
      return data;
    };
  ...
  */
  ...
  function (_PolymerElement) {
    ...
    babelHelpers.createClass(HaxGizmoBrowserItem, [{
      ...
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_f575d7d0d55811e9a4251fbb0db90cd4());
      }
    }, {
      key: "tag",
      get: function get() {
