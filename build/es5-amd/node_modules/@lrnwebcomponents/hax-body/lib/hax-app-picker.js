define(["exports", "require", "../../../lit-element/lit-element.js"], function (_exports, _require, _litElement) {
  ...
  function _templateObject3_7facea00bff611eaa5854beb4e0c914c() {
    var data = babelHelpers.taggedTemplateLiteral(["\n              <hax-tray-button\n                id=\"picker-item-", "\"\n                @click=\"", "\"\n                data-selected=\"", "\"\n                label=\"", "\"\n                icon=\"", "\"\n                color=\"", "\"\n                ?color-meaning=\"", "\"\n              >\n              </hax-tray-button>\n            "]);

    _templateObject3_7facea00bff611eaa5854beb4e0c914c = function _templateObject3_7facea00bff611eaa5854beb4e0c914c() {
      return data;
    };
  ...
  function _templateObject2_7facea00bff611eaa5854beb4e0c914c() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <paper-dialog id=\"dialog\" ?opened=\"", "\">\n        <h3 id=\"title\">", "</h3>\n        <div class=\"button-list\">\n          ", "\n        </div>\n        <paper-button id=\"closedialog\" @click=\"", "\">\n          <iron-icon icon=\"icons:cancel\" title=\"Close dialog\"></iron-icon>\n        </paper-button>\n      </paper-dialog>\n    "]);

    _templateObject2_7facea00bff611eaa5854beb4e0c914c = function _templateObject2_7facea00bff611eaa5854beb4e0c914c() {
      return data;
    };
  ...
  function _templateObject_7facea00bff611eaa5854beb4e0c914c() {
    ...
    _templateObject_7facea00bff611eaa5854beb4e0c914c = function _templateObject_7facea00bff611eaa5854beb4e0c914c() {
      return data;
    };
  ...
  */
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(HaxAppPicker, null, [{
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject_7facea00bff611eaa5854beb4e0c914c())];
      }
    }]);
    ...
    babelHelpers.createClass(HaxAppPicker, [{
      ...
      value: function render() {
        ...
        return (0, _litElement.html)(_templateObject2_7facea00bff611eaa5854beb4e0c914c(), this.opened, this.title, this.selectionList.map(function (element, index) {
          return (0, _litElement.html)(_templateObject3_7facea00bff611eaa5854beb4e0c914c(), index, _this2._selected, index, element.title, element.icon, element.color, _this2.selectionList.length === 2);
        }), this.closeEvent);
      }
    }, {
      key: "closeEvent",
