define(["exports", "../../../lit/index.js", "../../simple-icon/lib/simple-icon-lite.js", "./hax-toolbar-item.js", "../../hax-iconset/lib/simple-hax-iconset.js", "../../simple-icon/lib/simple-icon-button.js", "./hax-store.js", "../../utils/utils.js", "./hax-ui-styles.js", "../../i18n-manager/lib/I18NMixin.js", "../../../mobx/dist/mobx.esm.js"], function (_exports, _index, _simpleIconLite, _haxToolbarItem, _simpleHaxIconset, _simpleIconButton, _haxStore, _utils, _haxUiStyles, _I18NMixin2, _mobxEsm) {
  ...
  var _templateObject_71707fc06f4811ed83231ba15a006752, _templateObject2_71707fc06f4811ed83231ba15a006752, _templateObject3_71707fc06f4811ed83231ba15a006752, _templateObject4_71707fc06f4811ed83231ba15a006752, _templateObject5_71707fc06f4811ed83231ba15a006752, _templateObject6_71707fc06f4811ed83231ba15a006752;
  ...
  var HaxMap = /*#__PURE__*/function (_I18NMixin) {
    ...
    babelHelpers.createClass(HaxMap, [{
      ...
      value: function render() {
        ...
        return (0, _index.html)(_templateObject_71707fc06f4811ed83231ba15a006752 || (_templateObject_71707fc06f4811ed83231ba15a006752 = babelHelpers.taggedTemplateLiteral(["\n      <h5>", "</h5>\n      <div class=\"stats\">\n        <div class=\"stat\">\n          <span>", "</span>\n          <span>", "</span>\n        </div>\n        <div class=\"stat\">\n          <span>", "</span>\n          <span>", "</span>\n        </div>\n        <div class=\"stat\">\n          <span>", "</span>\n          <span>", "</span>\n        </div>\n        <div class=\"stat\">\n          <span>", "</span>\n          <span>", "</span>\n        </div>\n        <div class=\"stat\">\n          <span>", "</span>\n          <span>", "</span>\n        </div>\n      </div>\n      <h5>", "</h5>\n      <ul>\n        ", "\n      </ul>\n    "])), this.t.contentStatistics, this.wCount, this.t.words, this.pCount, this.t.paragraphs, this.cCount, this.t.characters, this.hCount, this.t.headings, this.eCount, this.t.widgets, this.t.listView, this.indentedElements(this.elementList).map(function (element, index) {
          return (0, _index.html)(_templateObject2_71707fc06f4811ed83231ba15a006752 || (_templateObject2_71707fc06f4811ed83231ba15a006752 = babelHelpers.taggedTemplateLiteral(["\n            <li\n              class=\"", " ", "\"\n            >\n              <hax-toolbar-item\n                align-horizontal=\"left\"\n                @click=\"", "\"\n                @dblclick=\"", "\"\n                data-index=\"", "\"\n                ?data-active-item=\"", "\"\n                icon=\"", "\"\n                label=\"", "\"\n                show-text-label\n              >\n              </hax-toolbar-item>\n              ", "\n            </li>\n          "])), element.parent ? "parent-".concat(element.parent) : "no-parent", ["h1", "h2", "h3", "h4", "h5", "h6", element.tag].includes(element.parent) ? "" : "is-child", function (e) {
            return _this2.goToItem(index);
          }, function (e) {
            return _this2.editItem(index);
          }, index, element.node === _this2.activeNode, element.icon, element.name, element.tag != "page-break" ? (0, _index.html)(_templateObject3_71707fc06f4811ed83231ba15a006752 || (_templateObject3_71707fc06f4811ed83231ba15a006752 = babelHelpers.taggedTemplateLiteral(["\n                    <simple-icon-button\n                      class=\"del\"\n                      icon=\"delete\"\n                      @click=\"", "\"\n                      title=\"Delete\"\n                      ?disabled=\"", "\"\n                    ></simple-icon-button>\n                    <simple-icon-button\n                      icon=\"hax:keyboard-arrow-up\"\n                      @click=\"", "\"\n                      title=\"Move up\"\n                      ?disabled=\"", "\"\n                    ></simple-icon-button>\n                    <simple-icon-button\n                      icon=\"hax:keyboard-arrow-down\"\n                      @click=\"", "\"\n                      title=\"Move down\"\n                      ?disabled=\"", "\"\n                    ></simple-icon-button>\n                    ", "\n                    <simple-icon-button\n                      icon=\"", "\"\n                      @click=\"", "\"\n                      title=\"Lock / Unlock\"\n                    ></simple-icon-button>\n                  "])), function (e) {
          ...
          }, _this2.isLocked(index), _haxStore.HAXStore.isTextElement(element.node) || element.tag == "grid-plate" ? (0, _index.html)(_templateObject4_71707fc06f4811ed83231ba15a006752 || (_templateObject4_71707fc06f4811ed83231ba15a006752 = babelHelpers.taggedTemplateLiteral([""]))) : (0, _index.html)(_templateObject5_71707fc06f4811ed83231ba15a006752 || (_templateObject5_71707fc06f4811ed83231ba15a006752 = babelHelpers.taggedTemplateLiteral(["\n                          <simple-icon-button\n                            icon=\"image:transform\"\n                            @click=\"", "\"\n                            title=\"Change to..\"\n                          ></simple-icon-button>\n                        "])), function (e) {
