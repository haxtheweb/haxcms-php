define(["exports", "../../../lit/index.js", "../../simple-modal/lib/simple-modal-template.js", "./hax-view-source.js", "./hax-ui-styles.js", "../../i18n-manager/lib/I18NMixin.js"], function (_exports, _index, _simpleModalTemplate, _haxViewSource, _haxUiStyles, _I18NMixin2) {
  ...
  var _templateObject_ede3bfb0a0c911eda392efd0bad1b4bf, _templateObject2_ede3bfb0a0c911eda392efd0bad1b4bf;
  ...
  var HaxExportDialog = /*#__PURE__*/function (_I18NMixin) {
    ...
    babelHelpers.createClass(HaxExportDialog, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_ede3bfb0a0c911eda392efd0bad1b4bf || (_templateObject_ede3bfb0a0c911eda392efd0bad1b4bf = babelHelpers.taggedTemplateLiteral(["\n      <simple-modal-template\n        modal-id=\"hax-export\"\n        mode=\"hax-ui\"\n        id=\"dialog\"\n        .title=\"", "\"\n      >\n        <hax-view-source slot=\"custom\"></hax-view-source>\n      </simple-modal-template>\n    "])), this.t.viewPageSource);
      }
    }], [{
      key: "styles",
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(_haxUiStyles.HaxComponentStyles), [(0, _index.css)(_templateObject2_ede3bfb0a0c911eda392efd0bad1b4bf || (_templateObject2_ede3bfb0a0c911eda392efd0bad1b4bf = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: none;\n          --simple-modal-resize: both;\n          --simple-modal-height: 100vh;\n        }\n      "])))]);
      }
    }, {
      key: "tag",
      get: function get() {
