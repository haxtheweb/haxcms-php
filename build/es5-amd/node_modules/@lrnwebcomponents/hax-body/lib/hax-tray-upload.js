define(["exports", "require", "../../../lit-element/lit-element.js", "../../utils/utils.js"], function (_exports, _require, _litElement, _utils) {
  ...
  function _templateObject2_aeab86b0e0c411ea988d4b7e2b2c0fe2() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <input type=\"text\" id=\"url\" hidden />\n      <vaadin-upload\n        @upload-before=\"", "\"\n        @upload-response=\"", "\"\n        form-data-name=\"file-upload\"\n        id=\"fileupload\"\n        hidden\n      ></vaadin-upload>\n    "]);

    _templateObject2_aeab86b0e0c411ea988d4b7e2b2c0fe2 = function _templateObject2_aeab86b0e0c411ea988d4b7e2b2c0fe2() {
      return data;
    };
  ...
  function _templateObject_aeab86b0e0c411ea988d4b7e2b2c0fe2() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        *[hidden] {\n          display: none;\n        }\n      "]);

    _templateObject_aeab86b0e0c411ea988d4b7e2b2c0fe2 = function _templateObject_aeab86b0e0c411ea988d4b7e2b2c0fe2() {
      return data;
    };
  ...
  function (_winEventsElement) {
    ...
    babelHelpers.createClass(HaxTrayUpload, null, [{
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject_aeab86b0e0c411ea988d4b7e2b2c0fe2())];
      }
      /**
       * Convention we use
       */
    ...
    babelHelpers.createClass(HaxTrayUpload, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_aeab86b0e0c411ea988d4b7e2b2c0fe2(), this._fileAboutToUpload, this._fileUploadResponse);
      }
      /**
