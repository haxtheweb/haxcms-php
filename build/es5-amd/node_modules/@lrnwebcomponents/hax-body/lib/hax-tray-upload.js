define(["exports", "../../../lit/index.js", "./hax-store.js", "./hax-upload-field.js"], function (_exports, _index, _haxStore, _haxUploadField) {
  "use strict";
  ...
  var HaxTrayUpload = /*#__PURE__*/function (_HaxUploadField) {
    ...
    function HaxTrayUpload() {
      ...
      _this.__winEvents = _this.__winEvents || {};
      _this.__winEvents = _objectSpread(_objectSpread({}, _this.__winEvents), {}, {
    ...
    babelHelpers.createClass(HaxTrayUpload, [{
      ...
      value: function updated(changedProperties) {
        ...
        changedProperties.forEach(function (oldValue, propName) {
          if (propName === "t") {
            _this2.label = _this2.t.uploadMedia;
          }
        });
      }
      /**
      ...
      value: function _fileUploadResponse(e) {
        babelHelpers.get(babelHelpers.getPrototypeOf(HaxTrayUpload.prototype), "_fileUploadResponse", this).call(this, e);
      ...
      value: function _placeHolderFileDrop(e) {
        ...
        _haxStore.HAXStore.activePlaceHolder = e.detail.placeHolderElement;
