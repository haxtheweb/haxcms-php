define(["exports","require","../../../lit-element/lit-element.js","../../utils/utils.js","../../../@polymer/polymer/lib/elements/custom-style.js"],function(_exports,_require,_litElement,_utils,_customStyle){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.HaxTrayUpload=void 0;_require=babelHelpers.interopRequireWildcard(_require);function _templateObject2_b3a6be0068b511eabbc78363bd41d3f4(){var data=babelHelpers.taggedTemplateLiteral(["\n      <custom-style>\n        <style>\n          @import url(\"https://fonts.googleapis.com/css?family=Noto+Serif\");\n          paper-input {\n            --paper-input-container-label: {\n              font-size: 11px;\n            }\n            --paper-input-container: {\n              padding: 0;\n            }\n          }\n          vaadin-upload {\n            --vaadin-upload-button-add-wrapper: {\n              border: 2px solid #ffffff;\n              background-color: var(\n                --hax-color-accent1,\n                --simple-colors-default-theme-light-blue-7\n              );\n              color: #ffffff;\n              display: block;\n            }\n            --vaadin-upload-buttons-primary: {\n              display: block;\n              width: 100%;\n              flex: unset;\n              -webkit-flex: unset;\n            }\n            --vaadin-upload-button-add: {\n              color: #000000;\n              display: block;\n              flex: unset;\n              -webkit-flex: unset;\n              text-align: center;\n            }\n            --vaadin-upload-drop-label: {\n              color: #ffffff;\n              display: block;\n              padding: 8px;\n            }\n            --vaadin-upload-drop-label-dragover: {\n              color: #ffffff;\n            }\n            --vaadin-upload-file-list: {\n              padding: 8px;\n              margin: 0;\n              color: #ffffff;\n            }\n            --vaadin-upload-file: {\n              color: #ffffff;\n            }\n          }\n        </style>\n      </custom-style>\n      <div class=\"add-area-content-wrapper\">\n        <div class=\"add-url-area\">\n          <paper-input\n            id=\"url\"\n            label=\"URL\"\n            type=\"url\"\n            auto-validate=\"\"\n          ></paper-input>\n          <div class=\"url-description\">\n            Add an existing resource / link\n          </div>\n        </div>\n        <div class=\"add-upload-area\">\n          <vaadin-upload\n            @upload-before=\"","\"\n            @upload-response=\"","\"\n            form-data-name=\"file-upload\"\n            id=\"fileupload\"\n          ></vaadin-upload>\n        </div>\n        <paper-button\n          @click=\"","\"\n          id=\"newassetconfigure\"\n          raised=\"\"\n          >Configure</paper-button\n        >\n      </div>\n    "]);_templateObject2_b3a6be0068b511eabbc78363bd41d3f4=function _templateObject2_b3a6be0068b511eabbc78363bd41d3f4(){return data};return data}function _templateObject_b3a6be0068b511eabbc78363bd41d3f4(){var data=babelHelpers.taggedTemplateLiteral(["\n        vaadin-upload {\n          --lumo-primary-color: var(\n            --hax-color-accent1,\n            --simple-colors-default-theme-light-blue-7\n          );\n          --lumo-primary-font-color: black;\n          --lumo-dark-primary-color: black;\n          --lumo-light-primary-color: var(\n            --hax-color-accent1,\n            --simple-colors-default-theme-light-blue-7\n          );\n          --lumo-error-color: darkred;\n          color: #ffffff;\n          display: block;\n          padding: 16px !important;\n        }\n        vaadin-upload[dragover] {\n          border-color: var(--simple-colors-default-theme-green-3);\n        }\n        vaadin-upload-file {\n          --disabled-text-color: #222222;\n        }\n        .add-area-content-wrapper {\n          padding: 0 4px;\n        }\n        .add-url-area,\n        .add-upload-area {\n          margin: 0;\n        }\n        .url-description {\n          color: #000000;\n          line-height: 22px;\n          font-family: sans-serif;\n          letter-spacing: 1px;\n        }\n      "]);_templateObject_b3a6be0068b511eabbc78363bd41d3f4=function _templateObject_b3a6be0068b511eabbc78363bd41d3f4(){return data};return data}var HaxTrayUpload=/*#__PURE__*/function(_winEventsElement){babelHelpers.inherits(HaxTrayUpload,_winEventsElement);babelHelpers.createClass(HaxTrayUpload,null,[{key:"styles",get:function get(){return[(0,_litElement.css)(_templateObject_b3a6be0068b511eabbc78363bd41d3f4())]}/**
   * Convention we use
   ...
   * LitElement render
   */babelHelpers.createClass(HaxTrayUpload,[{key:"render",value:function render(){return(0,_litElement.html)(_templateObject2_b3a6be0068b511eabbc78363bd41d3f4(),this._fileAboutToUpload,this._fileUploadResponse,this.newAssetConfigure)}/**
