 ...
 */(0,_polymerLegacy.Polymer)({_template:(0,_polymerLegacy.html)(_templateObject_ce3b913068f411e996b0af119cd7f5ea()),is:"hax-schema-form",properties:{/**
     ...
     * JSON Schema.
     */advancedSchema:{type:Object,value:{schema:{}}}},attached:function attached(){(0,_renderStatus.afterNextRender)(this,function(){new Promise(function(res,rej){return _require.default(["@polymer/paper-input/paper-textarea.js"],res,rej)});new Promise(function(res,rej){return _require.default(["app-datepicker/app-datepicker.js"],res,rej)});new Promise(function(res,rej){return _require.default(["@lrnwebcomponents/simple-picker/simple-picker.js"],res,rej)});new Promise(function(res,rej){return _require.default(["@lrnwebcomponents/simple-icon-picker/simple-icon-picker.js"],res,rej)});new Promise(function(res,rej){return _require.default(["@lrnwebcomponents/simple-colors/lib/simple-colors-picker.js"],res,rej)});new Promise(function(res,rej){return _require.default(["@lrnwebcomponents/paper-input-flagged/paper-input-flagged.js"],res,rej)})})},/**
