 ...
 */(0,_polymerLegacy.Polymer)({_template:(0,_polymerLegacy.html)(_templateObject_17484bc066f711e999fe19a29ec80b99()),is:"hax-schema-form",properties:{/**
     ...
     * JSON Schema.
     */advancedSchema:{type:Object,value:{schema:{}}}},attached:function attached(){afterNextRender(this,function(){new Promise(function(res,rej){return _require.default(["../../../@polymer/paper-input/paper-textarea.js"],res,rej)});new Promise(function(res,rej){return _require.default(["../../../app-datepicker/app-datepicker.js"],res,rej)});new Promise(function(res,rej){return _require.default(["../../simple-picker/simple-picker.js"],res,rej)});new Promise(function(res,rej){return _require.default(["../../simple-icon-picker/simple-icon-picker.js"],res,rej)});new Promise(function(res,rej){return _require.default(["../../simple-colors/lib/simple-colors-picker.js"],res,rej)});new Promise(function(res,rej){return _require.default(["../../paper-input-flagged/paper-input-flagged.js"],res,rej)})})},/**
