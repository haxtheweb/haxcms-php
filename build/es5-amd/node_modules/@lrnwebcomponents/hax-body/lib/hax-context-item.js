define(["exports", "require", "../../../lit-element/lit-element.js", "./hax-toolbar-item.js"], function (_exports, _require, _litElement, _haxToolbarItem) {
  ...
  function _templateObject2_480d9b60b53b11e9b28a07a79d52e10f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: inline-flex;\n          height: 36px;\n          width: 36px;\n        }\n        :host([mini]) {\n          height: unset;\n          width: unset;\n        }\n        :host([menu]) {\n          display: flex;\n          width: 100%;\n        }\n      "]);

    _templateObject2_480d9b60b53b11e9b28a07a79d52e10f = function _templateObject2_480d9b60b53b11e9b28a07a79d52e10f() {
      return data;
    };
  ...
  function _templateObject_480d9b60b53b11e9b28a07a79d52e10f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <hax-toolbar-item\n        .disabled=\"", "\"\n        .light=\"", "\"\n        .mini=\"", "\"\n        id=\"button\"\n        icon=\"", "\"\n        .hidden=\"", "\"\n        icon-class=\"", "\"\n        @mousedown=\"", "\"\n        @click=\"", "\"\n        tooltip=\"", "\"\n        tooltip-direction=\"", "\"\n        .default=\"", "\"\n        .menu=\"", "\"\n      >\n        <slot></slot>\n      </hax-toolbar-item>\n    "]);

    _templateObject_480d9b60b53b11e9b28a07a79d52e10f = function _templateObject_480d9b60b53b11e9b28a07a79d52e10f() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(HaxContextItem, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_480d9b60b53b11e9b28a07a79d52e10f(), this.disabled, this.light, this.mini, this.icon, !this.icon, this.iconClass, this._storeSelection, this._fireEvent, this.label, this.direction, this.default, this.menu);
      }
    }, {
      key: "_storeSelection",
      ...
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_480d9b60b53b11e9b28a07a79d52e10f())];
      }
    }, {
      key: "tag",
      get: function get() {
