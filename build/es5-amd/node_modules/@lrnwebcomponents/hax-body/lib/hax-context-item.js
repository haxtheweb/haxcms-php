define(["exports", "../../../lit-element/lit-element.js", "./hax-toolbar-item.js", "../../simple-icon/lib/simple-icon-lite.js", "./hax-store.js"], function (_exports, _litElement, _haxToolbarItem, _simpleIconLite, _haxStore) {
  ...
  function _templateObject3_bef373602dd211eba8a9dbdc0fc9b6e0() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: inline-flex;\n        }\n        simple-icon-lite {\n          width: 10px;\n        }\n        :host([menu]) {\n          display: flex;\n        }\n      "]);

    _templateObject3_bef373602dd211eba8a9dbdc0fc9b6e0 = function _templateObject3_bef373602dd211eba8a9dbdc0fc9b6e0() {
      return data;
    };
  ...
  function _templateObject2_bef373602dd211eba8a9dbdc0fc9b6e0() {
    var data = babelHelpers.taggedTemplateLiteral([" <simple-icon-lite icon=\"hax:expand-more\"></simple-icon-lite> "]);

    _templateObject2_bef373602dd211eba8a9dbdc0fc9b6e0 = function _templateObject2_bef373602dd211eba8a9dbdc0fc9b6e0() {
      return data;
    };
  ...
  function _templateObject_bef373602dd211eba8a9dbdc0fc9b6e0() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <hax-toolbar-item\n        ?simple=\"", "\"\n        ?disabled=\"", "\"\n        ?light=\"", "\"\n        ?circle=\"", "\"\n        ?danger=\"", "\"\n        ?action=\"", "\"\n        ?mini=\"", "\"\n        ?large=\"", "\"\n        id=\"button\"\n        .height=\"", "\"\n        icon=\"", "\"\n        ?hidden=\"", "\"\n        icon-class=\"", "\"\n        @mousedown=\"", "\"\n        @click=\"", "\"\n        tooltip=\"", "\"\n        tooltip-direction=\"", "\"\n        ?default=\"", "\"\n        ?menu=\"", "\"\n      >\n        ", "\n        <slot></slot>\n      </hax-toolbar-item>\n    "]);

    _templateObject_bef373602dd211eba8a9dbdc0fc9b6e0 = function _templateObject_bef373602dd211eba8a9dbdc0fc9b6e0() {
      return data;
    };
  ...
  var HaxContextItem = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(HaxContextItem, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_bef373602dd211eba8a9dbdc0fc9b6e0(), this.simple, this.disabled, this.light, this.circle, this.danger, this.action, this.mini, this.large, this.height, this.icon, !this.icon, this.iconClass, this._storeSelection, this._fireEvent, this.label, this.direction, this.default, this.menu, this.more && !this.disabled ? (0, _litElement.html)(_templateObject2_bef373602dd211eba8a9dbdc0fc9b6e0()) : "");
      }
    }, {
      key: "_storeSelection",
      ...
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject3_bef373602dd211eba8a9dbdc0fc9b6e0())];
      }
    }, {
      key: "tag",
      get: function get() {
