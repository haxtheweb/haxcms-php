define(["exports", "require", "../../../@polymer/polymer/polymer-element.js", "./hax-toolbar-item.js"], function (_exports, _require, _polymerElement, _haxToolbarItem) {
  ...
  function _templateObject_c38c4d40ac9411e99ab4d56cbef93a2b() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <style>\n        :host {\n          display: inline-flex;\n          height: 36px;\n          width: 36px;\n        }\n        :host([mini]) {\n          height: unset;\n          width: unset;\n        }\n        :host([menu]) {\n          display: flex;\n          width: 100%;\n        }\n      </style>\n      <hax-toolbar-item\n        disabled=\"[[disabled]]\"\n        light=\"[[light]]\"\n        mini=\"[[mini]]\"\n        id=\"button\"\n        icon=\"[[icon]]\"\n        hidden$=\"[[!icon]]\"\n        icon-class=\"[[iconClass]]\"\n        on-mousedown=\"_storeSelection\"\n        on-click=\"_fireEvent\"\n        tooltip=\"[[label]]\"\n        tooltip-direction=\"[[direction]]\"\n        default=\"[[default]]\"\n        menu=\"[[menu]]\"\n      >\n        <slot></slot>\n      </hax-toolbar-item>\n    "], ["\n      <style>\n        :host {\n          display: inline-flex;\n          height: 36px;\n          width: 36px;\n        }\n        :host([mini]) {\n          height: unset;\n          width: unset;\n        }\n        :host([menu]) {\n          display: flex;\n          width: 100%;\n        }\n      </style>\n      <hax-toolbar-item\n        disabled=\"[[disabled]]\"\n        light=\"[[light]]\"\n        mini=\"[[mini]]\"\n        id=\"button\"\n        icon=\"[[icon]]\"\n        hidden\\$=\"[[!icon]]\"\n        icon-class=\"[[iconClass]]\"\n        on-mousedown=\"_storeSelection\"\n        on-click=\"_fireEvent\"\n        tooltip=\"[[label]]\"\n        tooltip-direction=\"[[direction]]\"\n        default=\"[[default]]\"\n        menu=\"[[menu]]\"\n      >\n        <slot></slot>\n      </hax-toolbar-item>\n    "]);

    _templateObject_c38c4d40ac9411e99ab4d56cbef93a2b = function _templateObject_c38c4d40ac9411e99ab4d56cbef93a2b() {
      return data;
    };
  ...
  function (_PolymerElement) {
    ...
    babelHelpers.createClass(HaxContextItem, [{
      ...
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_c38c4d40ac9411e99ab4d56cbef93a2b());
      }
    }, {
      key: "tag",
      get: function get() {
