define(["exports", "../../../lit-element/lit-element.js", "./hax-toolbar-item.js", "../../simple-icon/simple-icon.js", "./hax-store.js"], function (_exports, _litElement, _haxToolbarItem, _simpleIcon, _haxStore) {
  ...
  function _templateObject3_d88ff6f0247111eb9734a78ef81f0b0d() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: inline-flex;\n        }\n        simple-icon {\n          width: 10px;\n        }\n        :host([menu]) {\n          display: flex;\n          width: 100%;\n        }\n      "]);

    _templateObject3_d88ff6f0247111eb9734a78ef81f0b0d = function _templateObject3_d88ff6f0247111eb9734a78ef81f0b0d() {
      return data;
    };
  ...
  function _templateObject2_d88ff6f0247111eb9734a78ef81f0b0d() {
    var data = babelHelpers.taggedTemplateLiteral([" <simple-icon icon=\"hax:expand-more\"></simple-icon> "]);

    _templateObject2_d88ff6f0247111eb9734a78ef81f0b0d = function _templateObject2_d88ff6f0247111eb9734a78ef81f0b0d() {
      return data;
    };
  ...
  function _templateObject_d88ff6f0247111eb9734a78ef81f0b0d() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <hax-toolbar-item\n        ?simple=\"", "\"\n        ?disabled=\"", "\"\n        ?light=\"", "\"\n        ?circle=\"", "\"\n        ?danger=\"", "\"\n        ?action=\"", "\"\n        ?mini=\"", "\"\n        ?large=\"", "\"\n        id=\"button\"\n        .height=\"", "\"\n        icon=\"", "\"\n        ?hidden=\"", "\"\n        icon-class=\"", "\"\n        @mousedown=\"", "\"\n        @click=\"", "\"\n        tooltip=\"", "\"\n        tooltip-direction=\"", "\"\n        ?default=\"", "\"\n        ?menu=\"", "\"\n      >\n        ", "\n        <slot></slot>\n      </hax-toolbar-item>\n    "]);

    _templateObject_d88ff6f0247111eb9734a78ef81f0b0d = function _templateObject_d88ff6f0247111eb9734a78ef81f0b0d() {
      return data;
    };
  ...
  var HaxContextItem = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(HaxContextItem, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_d88ff6f0247111eb9734a78ef81f0b0d(), this.simple, this.disabled, this.light, this.circle, this.danger, this.action, this.mini, this.large, this.height, this.icon, !this.icon, this.iconClass, this._storeSelection, this._fireEvent, this.label, this.direction, this.default, this.menu, this.more && !this.disabled ? (0, _litElement.html)(_templateObject2_d88ff6f0247111eb9734a78ef81f0b0d()) : "");
      }
    }, {
      key: "_storeSelection",
      ...
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject3_d88ff6f0247111eb9734a78ef81f0b0d())];
      }
    }, {
      key: "tag",
      get: function get() {
