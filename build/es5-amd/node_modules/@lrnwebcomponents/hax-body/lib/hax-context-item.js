define(["exports", "../../../lit-element/lit-element.js", "./hax-toolbar-item.js"], function (_exports, _litElement, _haxToolbarItem) {
  ...
  function _templateObject3_7ff03490bff611eaa5854beb4e0c914c() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: inline-flex;\n        }\n        :host([menu]) {\n          display: flex;\n          width: 100%;\n        }\n      "]);

    _templateObject3_7ff03490bff611eaa5854beb4e0c914c = function _templateObject3_7ff03490bff611eaa5854beb4e0c914c() {
      return data;
    };
  ...
  function _templateObject2_7ff03490bff611eaa5854beb4e0c914c() {
    var data = babelHelpers.taggedTemplateLiteral(["\n              <iron-icon icon=\"icons:expand-more\"></iron-icon>\n            "]);

    _templateObject2_7ff03490bff611eaa5854beb4e0c914c = function _templateObject2_7ff03490bff611eaa5854beb4e0c914c() {
      return data;
    };
  ...
  function _templateObject_7ff03490bff611eaa5854beb4e0c914c() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <hax-toolbar-item\n        ?disabled=\"", "\"\n        ?light=\"", "\"\n        ?action=\"", "\"\n        ?mini=\"", "\"\n        ?large=\"", "\"\n        id=\"button\"\n        height=\"", "\"\n        icon=\"", "\"\n        ?hidden=\"", "\"\n        icon-class=\"", "\"\n        @mousedown=\"", "\"\n        @click=\"", "\"\n        tooltip=\"", "\"\n        tooltip-direction=\"", "\"\n        ?default=\"", "\"\n        ?menu=\"", "\"\n      >\n        ", "\n        <slot></slot>\n      </hax-toolbar-item>\n    "]);

    _templateObject_7ff03490bff611eaa5854beb4e0c914c = function _templateObject_7ff03490bff611eaa5854beb4e0c914c() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(HaxContextItem, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_7ff03490bff611eaa5854beb4e0c914c(), this.disabled, this.light, this.action, this.mini, this.large, this.height, this.icon, !this.icon, this.iconClass, this._storeSelection, this._fireEvent, this.label, this.direction, this.default, this.menu, this.more ? (0, _litElement.html)(_templateObject2_7ff03490bff611eaa5854beb4e0c914c()) : "");
      }
    }, {
      key: "_storeSelection",
      ...
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject3_7ff03490bff611eaa5854beb4e0c914c())];
      }
    }, {
      key: "tag",
      get: function get() {
