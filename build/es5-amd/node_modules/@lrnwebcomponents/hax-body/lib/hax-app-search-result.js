define(["exports", "require", "../../../lit-element/lit-element.js"], function (_exports, _require, _litElement) {
  ...
  function _templateObject2_fcac3cd058e611eab30c517c44b6e911() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: inline-flex;\n          width: 49%;\n          height: 220px;\n          background-color: var(--hax-color-bg-accent);\n          color: var(--hax-color-text);\n        }\n        paper-button.button {\n          margin: 0;\n          padding: 7px;\n          display: block;\n          border-radius: 0;\n          border: none;\n          width: 100%;\n          outline: 2px solid black;\n          background-image: none;\n          text-align: unset;\n        }\n        paper-button:hover,\n        paper-button:focus,\n        paper-button:active {\n          background-color: #eeeeee;\n          outline: 2px solid var(--hax-color-bg-accent);\n        }\n        .detail-wrapper {\n          padding: 0 8px;\n          overflow: hidden;\n          font-family: \"Noto Serif\", serif;\n        }\n        .title {\n          font-size: 14px;\n          overflow: hidden;\n          font-weight: bold;\n          text-transform: none;\n          padding-bottom: 4px;\n          text-align: center;\n        }\n        .image {\n          height: 152px;\n          width: 100%;\n          background-color: lightgray;\n        }\n        @media screen and (max-width: 1000px) {\n          :host {\n            width: 100%;\n          }\n          .title {\n            font-size: 12px;\n          }\n        }\n      "]);

    _templateObject2_fcac3cd058e611eab30c517c44b6e911 = function _templateObject2_fcac3cd058e611eab30c517c44b6e911() {
      return data;
    };
  ...
  function _templateObject_fcac3cd058e611eab30c517c44b6e911() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <paper-button\n        draggable=\"true\"\n        @click=\"", "\"\n        @dragstart=\"", "\"\n        @dragend=\"", "\"\n        class=\"button\"\n        title=\"", "\"\n      >\n        <iron-image\n          alt=\"\"\n          class=\"image\"\n          src=\"", "\"\n          preload=\"\"\n          fade=\"\"\n          sizing=\"cover\"\n        ></iron-image>\n        <div class=\"detail-wrapper\">\n          <div class=\"title\">", "</div>\n        </div>\n      </paper-button>\n    "]);

    _templateObject_fcac3cd058e611eab30c517c44b6e911 = function _templateObject_fcac3cd058e611eab30c517c44b6e911() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(HaxAppSearchResult, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_fcac3cd058e611eab30c517c44b6e911(), this._itemSelected, this._dragStart, this._dragEnd, this.details, this.image, this.title.substr(0, 40));
      }
    }, {
      key: "_dragStart",
      ...
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_fcac3cd058e611eab30c517c44b6e911())];
      }
    }, {
      key: "tag",
      get: function get() {
