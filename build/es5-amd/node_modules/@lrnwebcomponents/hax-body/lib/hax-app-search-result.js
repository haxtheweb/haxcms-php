define(["exports", "../../../lit-element/lit-element.js", "./hax-store.js"], function (_exports, _litElement, _haxStore) {
  ...
  function _templateObject2_6795d4e03efe11eb800233a440abe59f() {
    ...
    _templateObject2_6795d4e03efe11eb800233a440abe59f = function _templateObject2_6795d4e03efe11eb800233a440abe59f() {
      return data;
    };
  ...
  function _templateObject_6795d4e03efe11eb800233a440abe59f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <button\n        draggable=\"true\"\n        @click=\"", "\"\n        @dragstart=\"", "\"\n        @dragend=\"", "\"\n        title=\"", "\"\n      >\n        <img loading=\"lazy\" class=\"image\" src=\"", "\" />\n        <div class=\"detail-wrapper\">\n          <div class=\"title\">", "</div>\n        </div>\n      </button>\n    "]);

    _templateObject_6795d4e03efe11eb800233a440abe59f = function _templateObject_6795d4e03efe11eb800233a440abe59f() {
      return data;
    };
  ...
  var HaxAppSearchResult = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(HaxAppSearchResult, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_6795d4e03efe11eb800233a440abe59f(), this._itemSelected, this._dragStart, this._dragEnd, this.details, this.image, this.title.substr(0, 40));
      }
    }, {
      key: "_dragStart",
      ...
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_6795d4e03efe11eb800233a440abe59f())];
      }
    }, {
      key: "tag",
      get: function get() {
