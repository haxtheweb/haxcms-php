define(["exports", "../../../lit/index.js", "../../simple-modal/lib/simple-modal-template.js", "./hax-view-source.js", "./hax-ui-styles.js", "../../i18n-manager/lib/I18NMixin.js"], function (_exports, _index, _simpleModalTemplate, _haxViewSource, _haxUiStyles, _I18NMixin2) {
  ...
  var _templateObject_c9ed88d0c73e11ec8447915f6c582fa5, _templateObject2_c9ed88d0c73e11ec8447915f6c582fa5;
  ...
  var HaxCancelDialog = /*#__PURE__*/function (_I18NMixin) {
    ...
    babelHelpers.createClass(HaxCancelDialog, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_c9ed88d0c73e11ec8447915f6c582fa5 || (_templateObject_c9ed88d0c73e11ec8447915f6c582fa5 = babelHelpers.taggedTemplateLiteral(["\n      <simple-modal-template\n        modal-id=\"hax-cancel\"\n        mode=\"hax-ui\"\n        id=\"dialog\"\n        .title=\"", "\"\n      >\n        <div slot=\"content\">", "</div>\n        <hax-toolbar id=\"hax-cancel-buttons\" always-expanded slot=\"buttons\">\n          <hax-tray-button\n            id=\"hax-cancel-no\"\n            label=\"", "\"\n            dialog-dismiss\n            show-text-label\n          >\n          </hax-tray-button>\n          <hax-tray-button\n            id=\"hax-cancel-yes\"\n            dialog-confirm\n            @click=\"", "\"\n            label=\"", "\"\n            show-text-label\n          >\n          </hax-tray-button>\n        </hax-toolbar>\n      </simple-modal-template>\n    "])), this.t.cancelTitle, this.t.cancelWithoutSaving, this.t.cancelNo, function (e) {
      ...
      key: "styles",
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(_haxUiStyles.HaxComponentStyles), [(0, _index.css)(_templateObject2_c9ed88d0c73e11ec8447915f6c582fa5 || (_templateObject2_c9ed88d0c73e11ec8447915f6c582fa5 = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: none;\n          --simple-modal-resize: none;\n          --simple-modal-width: 200px;\n          --simple-modal-height: auto;\n          margin: 0;\n          padding: 0;\n        }\n      "])))]);
      }
    }, {
      key: "tag",
      get: function get() {
