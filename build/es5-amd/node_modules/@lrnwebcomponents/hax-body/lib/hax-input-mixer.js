...
*/(0,_polymerLegacy.Polymer)({_template:(0,_polymerLegacy.html)(_templateObject_002d14606a9011e9a3fbc91c56f16a14()),is:"hax-input-mixer",listeners:{"hax-context-item-selected":"_haxContextOperation"},properties:{/**
     * value, where the magic happens.
     */value:{type:String,value:null},/**
     * Label for the input
     */label:{type:String,reflectToAttribute:!0/* transition */ /* transition */},/**
   ...
   */ready:function ready(){// prime methods even though invisible most likely
this._resetInputMethods()},/**
   * Input method changes, allow our templates to rebind correctly.
   */_inputMethodChanged:function _inputMethodChanged(newValue,oldValue){var _this=this;if(null!=newValue&&babelHelpers.typeof(oldValue)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){var method=newValue,methods=this.validInputMethods();// ensure this is a valid method of input
...
setTimeout(function(){if("function"===typeof _this.shadowRoot.querySelector("#input").hideMenu){_this.shadowRoot.querySelector("#input").hideMenu()}_this.shadowRoot.querySelector("#input").focus()},200)}}},/**
   * Validate input method.
   */validInputMethods:function validInputMethods(){var methods=["flipboolean","boolean","select","textfield","textarea","datepicker","haxupload","colorpicker","iconpicker","alt","number","code-editor","array"];return methods},/**
   * Reset all our meta attributes.
   */_resetInputMethods:function _resetInputMethods(){for(var methods=this.validInputMethods(),i=0;i<methods.length;i++){this["__input"+methods[i]]=!1}},/**
   * Respond to simple modifications.
   */_haxContextOperation:function _haxContextOperation(e){var detail=e.detail;// support a simple insert event to bubble up or everything else
...
this.fire("hax-input-mixer-update",{inputMixer:mixer});break;}}})});