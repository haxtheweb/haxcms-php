define(["exports", "../../../lit/index.js", "../../simple-filter/simple-filter.js", "../../utils/utils.js", "./hax-store.js", "../../../mobx/dist/mobx.esm.js", "../../simple-fields/lib/simple-fields-field.js", "../../simple-toolbar/lib/simple-button-grid.js", "../../i18n-manager/lib/I18NMixin.js"], function (_exports, _index, _simpleFilter, _utils, _haxStore, _mobxEsm, _simpleFieldsField, _simpleButtonGrid, _I18NMixin2) {
  ...
  var _templateObject_e8d36b4032c111ed89059d238fe76666, _templateObject2_e8d36b4032c111ed89059d238fe76666, _templateObject3_e8d36b4032c111ed89059d238fe76666;
  ...
  var HaxGizmoBrowser = /*#__PURE__*/function (_I18NMixin) {
    ...
    babelHelpers.createClass(HaxGizmoBrowser, [{
      ...
      value: function render() {
        ...
        return (0, _index.html)(_templateObject_e8d36b4032c111ed89059d238fe76666 || (_templateObject_e8d36b4032c111ed89059d238fe76666 = babelHelpers.taggedTemplateLiteral(["\n      <div class=\"toolbar-inner\" part=\"toolbar\">\n        <simple-fields-field\n          id=\"inputfilter\"\n          @value-changed=\"", "\"\n          aria-controls=\"filter\"\n          label=\"", "\"\n          type=\"text\"\n          auto-validate=\"\"\n          part=\"filter\"\n        ></simple-fields-field>\n      </div>\n      <simple-button-grid columns=\"3\" always-expanded part=\"grid\">\n        ", "\n      </simple-button-grid>\n    "])), this.inputfilterChanged, this.t.filterContentTypes, this.filtered.map(function (gizmo, i) {
          return (0, _index.html)(_templateObject2_e8d36b4032c111ed89059d238fe76666 || (_templateObject2_e8d36b4032c111ed89059d238fe76666 = babelHelpers.taggedTemplateLiteral(["\n            <hax-tray-button\n              show-text-label\n              voice-command=\"insert ", "\"\n              draggable=\"true\"\n              @dragstart=\"", "\"\n              index=\"", "\"\n              label=\"", "\"\n              event-name=\"insert-tag\"\n              event-data=\"", "\"\n              data-demo-schema=\"true\"\n              icon-position=\"top\"\n              icon=\"", "\"\n              part=\"grid-button\"\n            ></hax-tray-button>\n          "])), gizmo.title, _this2._dragStart, i, gizmo.title, gizmo.tag, gizmo.icon);
        }));
      }
    }, {
      key: "_dragStart",
      ...
      key: "styles",
      get: function get() {
        return [(0, _index.css)(_templateObject3_e8d36b4032c111ed89059d238fe76666 || (_templateObject3_e8d36b4032c111ed89059d238fe76666 = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: flex;\n          flex-direction: column;\n          align-items: stretch;\n          flex: 0 1 auto;\n          overflow-y: auto;\n        }\n        :host > * {\n          max-width: 100%;\n        }\n        .toolbar-inner {\n          display: flex;\n          flex-direction: column;\n          align-items: stretch;\n          width: 100%;\n          flex: 0 0 auto;\n        }\n        hax-tray-button::part(button) {\n          font-size: var(hax-ui-font-size-xs);\n        }\n        simple-fields-field {\n          margin-top: 0;\n        }\n      "])))];
      }
    }, {
      key: "tag",
      get: function get() {
