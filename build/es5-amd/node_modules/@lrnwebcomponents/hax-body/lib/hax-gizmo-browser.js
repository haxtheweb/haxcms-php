define(["exports", "../../../lit-element/lit-element.js", "../../simple-filter/simple-filter.js", "../../utils/utils.js", "./hax-store.js", "../../../mobx/dist/mobx.esm.js", "../../simple-fields/lib/simple-fields-field.js", "../../simple-toolbar/lib/simple-button-grid.js", "../../i18n-manager/lib/I18NMixin.js"], function (_exports, _litElement, _simpleFilter, _utils, _haxStore, _mobxEsm, _simpleFieldsField, _simpleButtonGrid, _I18NMixin2) {
  ...
  function _templateObject3_8a021b1090bb11eb9010f5aa583cef45() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            <hax-tray-button\n              show-text-label\n              voice-command=\"insert ", "\"\n              draggable=\"true\"\n              @dragstart=\"", "\"\n              @dragend=\"", "\"\n              index=\"", "\"\n              label=\"", "\"\n              event-name=\"insert-tag\"\n              event-data=\"", "\"\n              data-demo-schema=\"true\"\n              icon-position=\"top\"\n              icon=\"", "\"\n              part=\"grid-button\"\n            ></hax-tray-button>\n          "]);

    _templateObject3_8a021b1090bb11eb9010f5aa583cef45 = function _templateObject3_8a021b1090bb11eb9010f5aa583cef45() {
      return data;
    };
  ...
  function _templateObject2_8a021b1090bb11eb9010f5aa583cef45() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <div class=\"toolbar-inner\" part=\"toolbar\">\n        <simple-fields-field\n          id=\"inputfilter\"\n          @value-changed=\"", "\"\n          aria-controls=\"filter\"\n          label=\"", "\"\n          type=\"text\"\n          auto-validate=\"\"\n          part=\"filter\"\n        ></simple-fields-field>\n      </div>\n      <simple-button-grid columns=\"3\" always-expanded part=\"grid\">\n        ", "\n      </simple-button-grid>\n    "]);

    _templateObject2_8a021b1090bb11eb9010f5aa583cef45 = function _templateObject2_8a021b1090bb11eb9010f5aa583cef45() {
      return data;
    };
  ...
  function _templateObject_8a021b1090bb11eb9010f5aa583cef45() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: flex;\n          flex-direction: column;\n          align-items: stretch;\n          flex: 0 1 auto;\n          overflow-y: auto;\n        }\n        :host > * {\n          max-width: 100%;\n        }\n        .toolbar-inner {\n          display: flex;\n          flex-direction: column;\n          align-items: stretch;\n          width: 100%;\n          flex: 0 0 auto;\n        }\n        hax-tray-button::part(button) {\n          font-size: var(hax-ui-font-size-xs);\n        }\n        simple-fields-field {\n          margin-top: 0;\n        }\n      "]);

    _templateObject_8a021b1090bb11eb9010f5aa583cef45 = function _templateObject_8a021b1090bb11eb9010f5aa583cef45() {
      return data;
    };
  ...
  var HaxGizmoBrowser = /*#__PURE__*/function (_I18NMixin) {
    ...
    babelHelpers.createClass(HaxGizmoBrowser, null, [{
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject_8a021b1090bb11eb9010f5aa583cef45())];
      }
    }]);
    ...
    babelHelpers.createClass(HaxGizmoBrowser, [{
      ...
      value: function render() {
        ...
        return (0, _litElement.html)(_templateObject2_8a021b1090bb11eb9010f5aa583cef45(), this.inputfilterChanged, this.t.filterContentTypes, this.filtered.map(function (gizmo, i) {
          return (0, _litElement.html)(_templateObject3_8a021b1090bb11eb9010f5aa583cef45(), gizmo.title, _this2._dragStart, _this2._dragEnd, i, gizmo.title, gizmo.tag, gizmo.icon);
        }));
      }
    }, {
      key: "_dragStart",
