define(["exports", "../../../lit/index.js", "../../simple-filter/simple-filter.js", "../../utils/utils.js", "./hax-store.js", "./hax-element-demo.js", "./hax-tray-button.js", "../../../mobx/dist/mobx.esm.js", "../../simple-fields/lib/simple-fields-field.js", "../../simple-toolbar/lib/simple-button-grid.js", "../../simple-popover/lib/simple-popover-selection.js", "../../a11y-collapse/a11y-collapse.js", "../../i18n-manager/lib/I18NMixin.js"], function (_exports, _index, _simpleFilter, _utils, _haxStore, _haxElementDemo, _haxTrayButton, _mobxEsm, _simpleFieldsField, _simpleButtonGrid, _simplePopoverSelection, _a11yCollapse, _I18NMixin2) {
  ...
  var _templateObject_6c00ba10d3e211ed8e5073e3aa96f674, _templateObject2_6c00ba10d3e211ed8e5073e3aa96f674, _templateObject3_6c00ba10d3e211ed8e5073e3aa96f674, _templateObject4_6c00ba10d3e211ed8e5073e3aa96f674, _templateObject5_6c00ba10d3e211ed8e5073e3aa96f674, _templateObject6_6c00ba10d3e211ed8e5073e3aa96f674, _templateObject7_6c00ba10d3e211ed8e5073e3aa96f674, _templateObject8_6c00ba10d3e211ed8e5073e3aa96f674;
  ...
  var HaxGizmoBrowser = /*#__PURE__*/function (_I18NMixin) {
    ...
    babelHelpers.createClass(HaxGizmoBrowser, [{
      ...
      value: function render() {
        var _this2 = this;
        return (0, _index.html)(_templateObject_6c00ba10d3e211ed8e5073e3aa96f674 || (_templateObject_6c00ba10d3e211ed8e5073e3aa96f674 = babelHelpers.taggedTemplateLiteral([" <div class=\"toolbar-inner\" part=\"toolbar\">\n        <simple-fields-field\n          id=\"inputfilter\"\n          @value-changed=\"", "\"\n          aria-controls=\"filter\"\n          label=\"", "\"\n          type=\"text\"\n          auto-validate=\"\"\n          part=\"filter\"\n        ></simple-fields-field>\n      </div>\n      <a11y-collapse id=\"recent\" heading=\"Recent\" heading-button expanded>\n        <simple-button-grid columns=\"5\" always-expanded part=\"grid\">\n          ", "\n        </simple-button-grid>\n      </a11y-collapse>\n      ", ""])), this.inputfilterChanged, this.t.filterContentTypes, this.recentGizmoList.map(function (gizmo, i) {
          return (0, _index.html)(_templateObject2_6c00ba10d3e211ed8e5073e3aa96f674 || (_templateObject2_6c00ba10d3e211ed8e5073e3aa96f674 = babelHelpers.taggedTemplateLiteral([" <simple-popover-selection event=\"hover\">\n              <hax-tray-button\n                small\n                show-text-label\n                voice-command=\"insert ", "\"\n                draggable=\"true\"\n                @dragstart=\"", "\"\n                index=\"", "\"\n                is-current-item\n                label=\"", "\"\n                event-name=\"insert-tag\"\n                event-data=\"", "\"\n                data-demo-schema=\"true\"\n                icon-position=\"top\"\n                icon=\"", "\"\n                part=\"grid-button\"\n                slot=\"button\"\n              ></hax-tray-button>\n              <hax-element-demo\n                render-tag=\"", "\"\n                slot=\"options\"\n              ></hax-element-demo>\n              ", "\n            </simple-popover-selection>"])), gizmo.title, _this2._dragStart, i, gizmo.title, gizmo.tag, gizmo.icon, gizmo.tag, gizmo.shortcutKey ? (0, _index.html)(_templateObject3_6c00ba10d3e211ed8e5073e3aa96f674 || (_templateObject3_6c00ba10d3e211ed8e5073e3aa96f674 = babelHelpers.taggedTemplateLiteral(["<div slot=\"options\">\n                    <kbd\n                      style=\"background-color: rgba(0, 0, 0, 0.1);border-radius: 4px;color: rgba(0, 0, 0, 0.7);box-shadow: #d1d5db 0px -4px 0px inset, rgba(0, 0, 0, 0.4) 0px 1px 1px;padding: 4px 8px;margin: 8px auto;display: block;z-index: 1;font-size: 8px;\n                \"\n                      >", " + ", "</kbd\n                    >\n                  </div>"])), _this2.daemonKeyCombo, gizmo.shortcutKey) : "");
        }), this.categories.map(function (tag) {
          return (0, _index.html)(_templateObject4_6c00ba10d3e211ed8e5073e3aa96f674 || (_templateObject4_6c00ba10d3e211ed8e5073e3aa96f674 = babelHelpers.taggedTemplateLiteral([" <a11y-collapse\n          heading=\"", "\"\n          heading-button\n        >\n          <simple-button-grid columns=\"3\" always-expanded part=\"grid\">\n            ", "\n          </simple-button-grid>\n        </a11y-collapse>"])), _this2.ucfirst(tag), _this2.filtered.map(function (gizmo, i) {
            return (0, _index.html)(_templateObject5_6c00ba10d3e211ed8e5073e3aa96f674 || (_templateObject5_6c00ba10d3e211ed8e5073e3aa96f674 = babelHelpers.taggedTemplateLiteral(["", ""])), gizmo && gizmo.tags && gizmo.tags.includes(tag) ? (0, _index.html)(_templateObject6_6c00ba10d3e211ed8e5073e3aa96f674 || (_templateObject6_6c00ba10d3e211ed8e5073e3aa96f674 = babelHelpers.taggedTemplateLiteral([" <simple-popover-selection event=\"hover\">\n                      <hax-tray-button\n                        show-text-label\n                        is-current-item\n                        voice-command=\"insert ", "\"\n                        draggable=\"true\"\n                        @dragstart=\"", "\"\n                        index=\"", "\"\n                        label=\"", "\"\n                        event-name=\"insert-tag\"\n                        event-data=\"", "\"\n                        data-demo-schema=\"true\"\n                        icon-position=\"top\"\n                        icon=\"", "\"\n                        part=\"grid-button\"\n                        slot=\"button\"\n                      ></hax-tray-button>\n                      ", "\n                      <hax-element-demo\n                        render-tag=\"", "\"\n                        slot=\"options\"\n                      ></hax-element-demo>\n                    </simple-popover-selection>"])), gizmo.title, _this2._dragStart, i, gizmo.title, gizmo.tag, gizmo.icon, gizmo.shortcutKey ? (0, _index.html)(_templateObject7_6c00ba10d3e211ed8e5073e3aa96f674 || (_templateObject7_6c00ba10d3e211ed8e5073e3aa96f674 = babelHelpers.taggedTemplateLiteral(["<div slot=\"options\">\n                            <kbd\n                              style=\"background-color: rgba(0, 0, 0, 0.1);border-radius: 4px;color: rgba(0, 0, 0, 0.7);box-shadow: #d1d5db 0px -4px 0px inset, rgba(0, 0, 0, 0.4) 0px 1px 1px;padding: 4px 8px;margin: 8px auto;display: block;z-index: 1;font-size: 8px;\n                \"\n                              >", " +\n                              ", "</kbd\n                            >\n                          </div>"])), _this2.daemonKeyCombo, gizmo.shortcutKey) : "", gizmo.tag) : "");
          }));
        }));
      }
    }, {
