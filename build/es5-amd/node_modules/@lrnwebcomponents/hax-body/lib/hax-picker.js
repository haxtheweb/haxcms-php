define(["exports", "../../../lit-element/lit-element.js"], function (_exports, _litElement) {
  ...
  function _templateObject3_bf0eeaa02dd211eba8a9dbdc0fc9b6e0() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            <hax-tray-button\n              dark-bg\n              id=\"picker-item-", "\"\n              @click=\"", "\"\n              data-selected=\"", "\"\n              label=\"", "\"\n              icon=\"", "\"\n              ?color-meaning=\"", "\"\n            >\n            </hax-tray-button>\n          "]);

    _templateObject3_bf0eeaa02dd211eba8a9dbdc0fc9b6e0 = function _templateObject3_bf0eeaa02dd211eba8a9dbdc0fc9b6e0() {
      return data;
    };
  ...
  function _templateObject2_bf0eeaa02dd211eba8a9dbdc0fc9b6e0() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <div class=\"button-list\">\n        ", "\n      </div>\n    "]);

    _templateObject2_bf0eeaa02dd211eba8a9dbdc0fc9b6e0 = function _templateObject2_bf0eeaa02dd211eba8a9dbdc0fc9b6e0() {
      return data;
    };
  ...
  function _templateObject_bf0eeaa02dd211eba8a9dbdc0fc9b6e0() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n        .button-list {\n          display: block;\n          text-align: left;\n          overflow-x: hidden;\n          overflow-y: auto;\n          display: flex;\n          flex-wrap: wrap;\n          margin: 20px 0 0 0;\n          padding: 0;\n        }\n      "]);

    _templateObject_bf0eeaa02dd211eba8a9dbdc0fc9b6e0 = function _templateObject_bf0eeaa02dd211eba8a9dbdc0fc9b6e0() {
      return data;
    };
  ...
  */
  var HaxPicker = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(HaxPicker, null, [{
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject_bf0eeaa02dd211eba8a9dbdc0fc9b6e0())];
      }
    }]);
    ...
    babelHelpers.createClass(HaxPicker, [{
      ...
      value: function render() {
        ...
        return (0, _litElement.html)(_templateObject2_bf0eeaa02dd211eba8a9dbdc0fc9b6e0(), this.selectionList.map(function (element, index) {
          return (0, _litElement.html)(_templateObject3_bf0eeaa02dd211eba8a9dbdc0fc9b6e0(), index, _this2._selected, index, element.title, element.icon, _this2.selectionList.length === 2);
        }));
      }
    }, {
      key: "buildOptions",
