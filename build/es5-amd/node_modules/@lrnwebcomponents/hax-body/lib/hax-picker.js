define(["exports", "../../../lit-element/lit-element.js", "../../simple-toolbar/lib/simple-button-grid.js", "./hax-ui-styles.js", "./hax-store.js"], function (_exports, _litElement, _simpleButtonGrid, _haxUiStyles, _haxStore) {
  ...
  var _templateObject_b4095520b2b411eb9e5c9b5d1881fac2, _templateObject2_b4095520b2b411eb9e5c9b5d1881fac2, _templateObject3_b4095520b2b411eb9e5c9b5d1881fac2;
  ...
  var HaxPicker = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(HaxPicker, [{
      ...
      value: function render() {
        ...
        return (0, _litElement.html)(_templateObject_b4095520b2b411eb9e5c9b5d1881fac2 || (_templateObject_b4095520b2b411eb9e5c9b5d1881fac2 = babelHelpers.taggedTemplateLiteral(["\n      <simple-button-grid cols=\"100px\">\n        ", "\n      </simple-button-grid>\n    "])), this.selectionList.map(function (element, index) {
          return (0, _litElement.html)(_templateObject2_b4095520b2b411eb9e5c9b5d1881fac2 || (_templateObject2_b4095520b2b411eb9e5c9b5d1881fac2 = babelHelpers.taggedTemplateLiteral(["\n            <hax-tray-button\n              show-text-label\n              id=\"picker-item-", "\"\n              @click=\"", "\"\n              data-selected=\"", "\"\n              ?disabled=\"", "\"\n              label=\"", "\"\n              icon=\"", "\"\n              icon-position=\"top\"\n            ></hax-tray-button>\n          "])), index, _this2._selected, index, _haxStore.HAXStore.activeGizmo && _haxStore.HAXStore.activeGizmo.tag == element.tag, element.title, element.icon);
        }));
      }
    }, {
      key: "buildOptions",
      ...
      key: "styles",
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(_haxUiStyles.HaxComponentStyles), [(0, _litElement.css)(_templateObject3_b4095520b2b411eb9e5c9b5d1881fac2 || (_templateObject3_b4095520b2b411eb9e5c9b5d1881fac2 = babelHelpers.taggedTemplateLiteral(["\n        simple-button-grid {\n          overflow-y: auto;\n          margin: var(--hax-ui-spacing-sm);\n          --simple-button-grid-cols: 100px;\n        }\n      "])))]);
      }
    }, {
      key: "tag",
      get: function get() {
