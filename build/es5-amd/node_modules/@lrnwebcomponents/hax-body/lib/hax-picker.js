define(["exports", "../../../lit/index.js", "../../simple-toolbar/lib/simple-button-grid.js", "./hax-ui-styles.js", "./hax-store.js"], function (_exports, _index, _simpleButtonGrid, _haxUiStyles, _haxStore) {
  ...
  var _templateObject_63caea902ee311eda9c37b2c2696a94a, _templateObject2_63caea902ee311eda9c37b2c2696a94a, _templateObject3_63caea902ee311eda9c37b2c2696a94a, _templateObject4_63caea902ee311eda9c37b2c2696a94a;
  ...
  var HaxPicker = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(HaxPicker, [{
      ...
      value: function render() {
        ...
        return (0, _index.html)(_templateObject_63caea902ee311eda9c37b2c2696a94a || (_templateObject_63caea902ee311eda9c37b2c2696a94a = babelHelpers.taggedTemplateLiteral(["\n      ", "\n      <simple-button-grid cols=\"100px\">\n        ", "\n      </simple-button-grid>\n    "])), !!this.keywords ? (0, _index.html)(_templateObject2_63caea902ee311eda9c37b2c2696a94a || (_templateObject2_63caea902ee311eda9c37b2c2696a94a = babelHelpers.taggedTemplateLiteral([" <div id=\"filters\">\n            <simple-icon-button-lite\n              icon=\"editable-table:filter", "\"\n              label=\"Toggle Filters\"\n              tooltip-position=\"right\"\n              @click=\"", "\"\n            >\n            </simple-icon-button-lite>\n            <simple-fields-field\n              ?hidden=\"", "\"\n              id=\"hax-gizmo-filters\"\n              label=\"Filters\"\n              type=\"checkbox\"\n              .options=\"", "\"\n              @value-changed=\"", "\"\n            >\n            </simple-fields-field>\n          </div>"])), !this.filterOn ? "" : "-off", function (e) {
          ...
          return !_this2._isFiltered(element.keywords) ? "" : (0, _index.html)(_templateObject3_63caea902ee311eda9c37b2c2696a94a || (_templateObject3_63caea902ee311eda9c37b2c2696a94a = babelHelpers.taggedTemplateLiteral(["\n                <hax-tray-button\n                  show-text-label\n                  id=\"picker-item-", "\"\n                  @click=\"", "\"\n                  data-selected=\"", "\"\n                  ?disabled=\"", "\"\n                  label=\"", "\"\n                  icon=\"", "\"\n                  icon-position=\"top\"\n                ></hax-tray-button>\n              "])), index, _this2._selected, index, _haxStore.HAXStore.activeGizmo && _haxStore.HAXStore.activeGizmo.tag == element.tag, element.title, element.icon);
        }));
      }
    }, {
      key: "buildOptions",
