define(["exports", "meta", "require", "../../../lit/index.js", "../../hax-body-behaviors/hax-body-behaviors.js", "../../utils/utils.js", "./hax-store.js"], function (_exports, meta, _require, _index, _haxBodyBehaviors, _utils, _haxStore) {
  ...
  var _templateObject_62396240ddf411ed96ad39cc5dd30a65, _templateObject2_62396240ddf411ed96ad39cc5dd30a65;
  ...
  var HaxAutoloader = /*#__PURE__*/function (_HAXElement) {
    ...
    babelHelpers.createClass(HaxAutoloader, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_62396240ddf411ed96ad39cc5dd30a65 || (_templateObject_62396240ddf411ed96ad39cc5dd30a65 = babelHelpers.taggedTemplateLiteral(["<slot></slot>"])));
      }
    }, {
      key: "firstUpdated",
      ...
      value: function processNewElements(e) {
        ...
        var _loop = function _loop() {
          ...
          if (babelHelpers.typeof(effectiveChildren[i].tagName) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined)) && babelHelpers.typeof(_this3.processedList[effectiveChildren[i].tagName]) === (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {
                  ...
                  if (!CEClass) {
                    ...
                    try {
                      ...
                      if (tmpProps) {
                        ...
                        for (var _i = 0; _i < _tmpProps.length; _i++) {
                          props.settings.configure.push({
                            attribute: _tmpProps[_i],
                            title: _tmpProps[_i],
                            description: "",
                            inputMethod: "textfield"
                          });
       ...
       */
      function get() {
        return [(0, _index.css)(_templateObject2_62396240ddf411ed96ad39cc5dd30a65 || (_templateObject2_62396240ddf411ed96ad39cc5dd30a65 = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: none;\n        }\n      "])))];
      }
    }, {
      key: "tag",
      get: function get() {
