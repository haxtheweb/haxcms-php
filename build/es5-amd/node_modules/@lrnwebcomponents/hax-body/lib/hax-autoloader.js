define(["meta","require","../../../@polymer/polymer/polymer-legacy.js","../../../@polymer/polymer/lib/utils/async.js","../../../@polymer/polymer/lib/utils/flattened-nodes-observer.js","../../../@polymer/polymer/lib/utils/resolve-url.js","../../hax-body-behaviors/hax-body-behaviors.js"],function(meta,_require,_polymerLegacy,async,_flattenedNodesObserver,_resolveUrl,_haxBodyBehaviors){"use strict";meta=babelHelpers.interopRequireWildcard(meta);_require=babelHelpers.interopRequireWildcard(_require);async=babelHelpers.interopRequireWildcard(async);function _templateObject_fcecdd806a8f11e9a3fbc91c56f16a14(){var data=babelHelpers.taggedTemplateLiteral(["\n    <style>\n      :host {\n        display: none;\n      }\n    </style>\n    <slot></slot>\n  "]);_templateObject_fcecdd806a8f11e9a3fbc91c56f16a14=function _templateObject_fcecdd806a8f11e9a3fbc91c56f16a14(){return data};return data}/**
`hax-autoloader`
...
*/(0,_polymerLegacy.Polymer)({_template:(0,_polymerLegacy.html)(_templateObject_fcecdd806a8f11e9a3fbc91c56f16a14()),is:"hax-autoloader",behaviors:[HAXBehaviors.PropertiesBehaviors],properties:{/**
     * List of elements processed so we don't double process
     */processedList:{type:Object,value:{}}},/**
   * Attached to the DOM, now fire that we exist.
   */attached:function attached(){var _this=this;// fire an event that this is the manager
this.fire("hax-register-autoloader",this);// notice elements when they update
...
if(0<info.addedNodes.length){async.microTask.run(function(){_this.processNewElements(info.addedNodes)})}})},/**
   ...
   */processNewElements:function processNewElements(e){for(var _this2=this,effectiveChildren=_flattenedNodesObserver.FlattenedNodesObserver.getFlattenedNodes(this).filter(function(n){return n.nodeType===Node.ELEMENT_NODE}),i=0;i<effectiveChildren.length;i++){// strip invalid tags / textnodes
