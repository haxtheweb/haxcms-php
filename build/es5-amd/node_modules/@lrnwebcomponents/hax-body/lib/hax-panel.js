...
*/(0,_polymerLegacy.Polymer)({_template:(0,_polymerLegacy.html)(_templateObject_0067d3706a9011e9a3fbc91c56f16a14()),is:"hax-panel",listeners:{"hax-item-selected":"_processItemEvent"},observers:["_globalPreferencesChanged(globalPreferences.*)"],properties:{/**
     * Light variant for save button
     */light:{type:Boolean},/**
     * Display to the right corner instead of the left (default)
     */align:{type:String,reflectToAttribute:!0/* transition */ /* transition */,value:"left"},/**
     * State of the panel
   ...
   */attached:function attached(){this.fire("hax-register-panel",this);document.body.addEventListener("hax-store-property-updated",this._haxStorePropertyUpdated.bind(this));document.body.addEventListener("hax-active-hover-name",this._activeNameChange.bind(this));document.body.addEventListener("hax-panel-operation",this._processItemEvent.bind(this))},/**
   * Detached life cycle
   */detached:function detached(){document.body.removeEventListener("hax-store-property-updated",this._haxStorePropertyUpdated.bind(this));document.body.removeEventListener("hax-active-hover-name",this._activeNameChange.bind(this));document.body.removeEventListener("hax-panel-operation",this._processItemEvent.bind(this))},_activeNameChange:function _activeNameChange(e){this.activeOperationName=e.detail},/**
   * Global preference changed.
   */_globalPreferencesChanged:function _globalPreferencesChanged(value){if(babelHelpers.typeof(value)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){if(null!=value.value&&babelHelpers.typeof(value.value.haxShowExportButton)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){this.hideExportButton=!value.value.haxShowExportButton}if(null!=value.value&&babelHelpers.typeof(value.value.haxDeveloperMode)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){this.haxDeveloperMode=value.value.haxDeveloperMode}}},/**
   * Store updated, sync.
   ...
   */_processItemEvent:function _processItemEvent(e){var detail=e.detail;// support a simple insert event to bubble up or everything else
switch(detail.eventName){case"open-panel":this._clickButton();break;case"cancel":this.toggle();this.fire("hax-cancel",detail);break;case"text":detail.tag="p";detail.content="";this.fire("hax-insert-content",detail);break;case"divider":detail.tag="hr";detail.content="";detail.properties={style:"width:100%;"};this.fire("hax-insert-content",detail);break;case"header":detail.tag="h2";detail.content="Header";this.fire("hax-insert-content",detail);break;case"placeholder":detail.tag="place-holder";detail.content="";detail.properties={style:"width:50%;"};this.fire("hax-insert-content",detail);break;case"image":detail.tag="img";detail.content="";detail.properties={src:pathFromUrl(decodeURIComponent(meta.url))+window.HaxStore.instance.defaults.image.src,alt:window.HaxStore.instance.defaults.image.alt,style:"width:100%;"};this.fire("hax-insert-content",detail);break;case"iframe":detail.tag="iframe";detail.content="";detail.properties={src:window.HaxStore.instance.defaults.iframe.src,height:"400px",width:"100%",style:"width:100%;"};this.fire("hax-insert-content",detail);break;case"blockquote":detail.tag="blockquote";detail.content="";this.fire("hax-insert-content",detail);break;case"hax-manager-open":window.HaxStore.write("activeHaxElement",{},this);window.HaxStore.instance.haxManager.resetManager(parseInt(detail.value));window.HaxStore.instance.haxManager.toggleDialog(!1);break;case"hax-stax-picker-open":window.HaxStore.instance.haxStaxPicker.toggleDialog();break;case"hax-blox-picker-open":window.HaxStore.instance.haxBloxPicker.toggleDialog();break;case"undo":document.execCommand("undo");break;case"redo":document.execCommand("redo");break;default:// we sit on this, something else will have to handle it
break;}},/**
   * _editModeChanged
   */_editModeChanged:function _editModeChanged(newValue,oldValue){if(babelHelpers.typeof(newValue)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))&&newValue){this.__tipText="Save";this.$.button.icon="save"}else{this.__tipText="Edit";this.$.button.icon="create"}},/**
   * Toggle the drawer when the button is clicked.
   */_clickEditButton:function _clickEditButton(e){this.toggle()},/**
   * Toggle the drawer when the button is clicked.
   */_clickSaveButton:function _clickSaveButton(e){this.toggle();this.fire("hax-save",e.detail)},/**
   * HTML Export trigger.
   */_htmlExportDialog:function _htmlExportDialog(e){window.HaxStore.instance.haxExport.toggleDialog()},/**
   * Preferences trigger.
   */_preferencesDialog:function _preferencesDialog(e){window.HaxStore.instance.haxPreferences.toggleDialog()},/**
   * Toggle the panel.
   */toggle:function toggle(e){window.HaxStore.write("editMode",!this.editMode,this);this.$.drawer.opened=this.editMode;if(!this.$.drawer.opened){window.HaxStore.instance.closeAllDrawers()}}})});