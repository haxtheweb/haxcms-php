define(["exports", "require", "../../../lit-element/lit-element.js", "../../simple-colors/simple-colors.js", "../../../@polymer/polymer/lib/elements/custom-style.js"], function (_exports, _require, _litElement, _simpleColors, _customStyle) {
  ...
  function _templateObject2_efc545800bc411eaa80de5038f5def85() {
    ...
    _templateObject2_efc545800bc411eaa80de5038f5def85 = function _templateObject2_efc545800bc411eaa80de5038f5def85() {
      return data;
    };
  ...
  function _templateObject_efc545800bc411eaa80de5038f5def85() {
    ...
    _templateObject_efc545800bc411eaa80de5038f5def85 = function _templateObject_efc545800bc411eaa80de5038f5def85() {
      return data;
    };
  ...
  */
  ...
  function (_SimpleColors) {
    babelHelpers.inherits(HaxPanel, _SimpleColors);
    babelHelpers.createClass(HaxPanel, null, [{
       ...
       */
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(HaxPanel), "styles", this)), [(0, _litElement.css)(_templateObject_efc545800bc411eaa80de5038f5def85())]);
      }
      /**
    ...
    function HaxPanel() {
      ...
      _this.addEventListener("hax-item-selected", _this._processItemEvent.bind(babelHelpers.assertThisInitialized(_this))); // fire an event that this is a core piece of the system
      ...
      document.body.addEventListener("hax-active-hover-name", _this._activeNameChange.bind(babelHelpers.assertThisInitialized(_this)));
      document.body.addEventListener("hax-panel-operation", _this._processItemEvent.bind(babelHelpers.assertThisInitialized(_this)));
      return _this;
    }
    ...
    babelHelpers.createClass(HaxPanel, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_efc545800bc411eaa80de5038f5def85(), this.hidePanelOps, this.editMode, this._clickEditButton, this.__tipText, this.editMode, this.openedChanged, this.hidePanelOps, this._clickSaveButton, this.__tipText, this.hidePanelOps, this.hideExportButton, this._htmlExportDialog, this.hidePreferencesButton, this._preferencesDialogClick, this.editModeName, this.activeOperationName);
      }
    }, {
      key: "openedChanged",
      ...
      key: "_preferencesDialogClick",
      value: function _preferencesDialogClick(e) {
