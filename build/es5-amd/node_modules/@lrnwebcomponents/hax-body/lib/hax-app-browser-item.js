define(["exports", "require", "../../../lit-element/lit-element.js"], function (_exports, _require, _litElement) {
  ...
  function _templateObject2_8ea8768034ed11eabe39ef50dfa8db3f() {
    ...
    _templateObject2_8ea8768034ed11eabe39ef50dfa8db3f = function _templateObject2_8ea8768034ed11eabe39ef50dfa8db3f() {
      return data;
    };
  ...
  function _templateObject_8ea8768034ed11eabe39ef50dfa8db3f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <paper-button\n        @click=\"", "\"\n        .data-voicecommand=\"select ", "\"\n        title=\"", "\"\n      >\n        <hax-item-button-inner\n          color=\"", "\"\n          icon=\"", "\"\n          label=\"", "\"\n        >\n        </hax-item-button-inner>\n      </paper-button>\n    "]);

    _templateObject_8ea8768034ed11eabe39ef50dfa8db3f = function _templateObject_8ea8768034ed11eabe39ef50dfa8db3f() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(HAXAppBrowserItem, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_8ea8768034ed11eabe39ef50dfa8db3f(), this._fireEvent, this.title, this.title, this.color, this.icon, this.title);
      }
      /**
      ...
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_8ea8768034ed11eabe39ef50dfa8db3f())];
      }
    }]);
