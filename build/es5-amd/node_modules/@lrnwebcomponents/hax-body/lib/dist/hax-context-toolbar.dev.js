...
function _templateObject2_5a2c1700ce0511ec9811713d37552719() {
  var data = _taggedTemplateLiteral(['\n      <absolute-position-behavior id="top" auto justify \n        position="top" \n        .target="', '">\n        <div class="menu">\n          <hax-text-context \n            id="text"\n            class="item ', '"\n            .target="', '"\n          ></hax-text-context>\n          <hax-ce-context\n            id="ce"\n            class="item ', '"\n            .target="', '"\n          ></hax-ce-context>\n          <hax-plate-context\n            id="plate"\n            class="item ', '"\n          ></hax-plate-context>\n        </div>\n      </absolute-position-behavior>\n      <absolute-position-behavior auto justify \n        position="bottom" \n        .target="', '">\n        <hax-context-item\n          icon="icons:add"\n          label="', '"\n          show-text-label\n          class="item ', " ", '"\n        >\n        </hax-context-item>\n      </absolute-position-behavior>\n    ']);

  _templateObject2_5a2c1700ce0511ec9811713d37552719 = function _templateObject2_5a2c1700ce0511ec9811713d37552719() {
    return data;
  };
...
function _templateObject_5a2c1700ce0511ec9811713d37552719() {
  var data = _taggedTemplateLiteral(["\n        :host {\n          width: 100%;\n        } \n        :host *:not(:defined) {\n          display: none !important;\n        }\n        :host(:not(.hax-visible)),\n        .item {\n          visibility: hidden;\n          opacity: 0;\n          z-index: 1000;\n          pointer-events: none;\n          transition: 0.2s top ease-in-out, 0.2s left ease-in-out;\n        }\n        :host(:hover),\n        :host(:focus-within),\n        .item:hover,\n        .item:focus-within {\n          z-index: var(--hax-ui-focus-z-index);\n        }\n        #top .menu {\n          display: flex;\n          width: 100%;\n          align-items: bottom;\n          justify-content: space-between;\n        }\n        #text,\n        #ce {\n          max-width: 280px;\n          flex: 1 1 auto;\n        }\n        #plate,\n        #add {\n          flex: 0 0 auto;\n        }\n        .item-visible, \n        .item-active {\n          visibility: visible;\n          pointer-events: all;\n          opacity: 1;\n        }\n        .item-tracking {\n          position: absolute;\n        }\n      "]);

  _templateObject_5a2c1700ce0511ec9811713d37552719 = function _templateObject_5a2c1700ce0511ec9811713d37552719() {
    return data;
  };
...
var HaxContextToolbar = /*#__PURE__*/function (_LitElement) {
  ...
  _createClass(HaxContextToolbar, null, [{
     ...
     */
    get: function get() {
      return [].concat(_toConsumableArray(_get(_getPrototypeOf(HaxContextToolbar), "styles", this)), [(0, _litElement.css)(_templateObject_5a2c1700ce0511ec9811713d37552719())]);
    }
  }]);
  ...
  _createClass(HaxContextToolbar, [{
    ...
    value: function render() {
      return (0, _litElement.html)(_templateObject2_5a2c1700ce0511ec9811713d37552719(), this.target || document.body, this.textContext ? "item-visible" : "", this.target, this.ceContext ? "item-visible" : "", this.target, this.plateContext ? "item-visible" : "", this.target || document.body, this.addLabel, this.addContext ? "item-visible" : "", this.trackMouse ? "item-tracking" : "");
    }
  }, {
    key: "getToolbar",
