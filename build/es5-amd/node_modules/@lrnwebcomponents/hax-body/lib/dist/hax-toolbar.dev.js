...
function _templateObject_465ce4f09b5211ed81cd11846941acb3() {
  var data = _taggedTemplateLiteral(["\n          :host {\n            --hax-ui-border-radius: 0px;\n          }\n          .selected-buttons {\n            transition: 0.1s all ease-in-out;\n            width: 0;\n          }\n          :host([has-selected-text]) .selected-buttons {\n            width: 100%;\n          }\n          ::slotted(*) {\n            pointer-events: all;\n          }\n          ::slotted(.group) {\n            border: none;\n          }\n        "]);

  _templateObject_465ce4f09b5211ed81cd11846941acb3 = function _templateObject_465ce4f09b5211ed81cd11846941acb3() {
    return data;
  };
...
var HaxToolbarBehaviors = function HaxToolbarBehaviors(SuperClass) {
  return /*#__PURE__*/function (_SimpleToolbarBehavio) {
    ...
    _createClass(_class, null, [{
       ...
       */
      get: function get() {
        return [].concat(_toConsumableArray(_get(_getPrototypeOf(_class), "styles", this)), [(0, _litElement.css)(_templateObject_465ce4f09b5211ed81cd11846941acb3())]);
      }
    }]);
