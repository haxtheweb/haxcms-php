...
function _templateObject5_00b20f10ce4411eca4dffb3bcb5f42ec() {
  ...
  _templateObject5_00b20f10ce4411eca4dffb3bcb5f42ec = function _templateObject5_00b20f10ce4411eca4dffb3bcb5f42ec() {
    return data;
  };
...
function _templateObject4_00b20f10ce4411eca4dffb3bcb5f42ec() {
  var data = _taggedTemplateLiteral([' <hax-context-item\n              action\n              icon="', '"\n              label="', '"\n              event-name="hax-ce-custom-button"\n              value="', '"\n              ?disabled="', '"\n            ></hax-context-item>']);

  _templateObject4_00b20f10ce4411eca4dffb3bcb5f42ec = function _templateObject4_00b20f10ce4411eca4dffb3bcb5f42ec() {
    return data;
  };
...
function _templateObject3_00b20f10ce4411eca4dffb3bcb5f42ec() {
  var data = _taggedTemplateLiteral(['\n                <simple-toolbar-menu-item\n                  slot="menuitem"\n                  class="move-to-slot ', '"\n                >\n                  <hax-context-item\n                    action\n                    align-horizontal="left"\n                    ?disabled="', '"\n                    icon="icons:arrow-forward"\n                    show-text-label\n                    role="menuitem"\n                    event-name="insert-into-active"\n                    data-slot="', '"\n                    label="', '"\n                  ></hax-context-item>\n                </simple-toolbar-menu-item>\n              ']);

  _templateObject3_00b20f10ce4411eca4dffb3bcb5f42ec = function _templateObject3_00b20f10ce4411eca4dffb3bcb5f42ec() {
    return data;
  };
...
function _templateObject2_00b20f10ce4411eca4dffb3bcb5f42ec() {
  var data = _taggedTemplateLiteral(['\n                <simple-toolbar-menu-item\n                  slot="menuitem"\n                  class="move-to-slot ', '"\n                >\n                  <hax-context-item\n                    action\n                    align-horizontal="left"\n                    ?disabled="', '"\n                    icon="icons:arrow-forward"\n                    show-text-label\n                    role="menuitem"\n                    data-slot="', '"\n                    @click="', '"\n                    label="', '"\n                  ></hax-context-item>\n                </simple-toolbar-menu-item>\n              ']);

  _templateObject2_00b20f10ce4411eca4dffb3bcb5f42ec = function _templateObject2_00b20f10ce4411eca4dffb3bcb5f42ec() {
    return data;
  };
...
function _templateObject_00b20f10ce4411eca4dffb3bcb5f42ec() {
  ...
  _templateObject_00b20f10ce4411eca4dffb3bcb5f42ec = function _templateObject_00b20f10ce4411eca4dffb3bcb5f42ec() {
    return data;
  };
  ...
  _createClass(HaxPlateContext, [{
    ...
    value: function render() {
      ...
      return (0, _litElement.html)(_templateObject_00b20f10ce4411eca4dffb3bcb5f42ec(), this.hasActiveEditingElement || !this.canMoveElement || this.viewSource, this.t.dragHandle, !this.canMoveElement, this.hasActiveEditingElement, this.t.moveUp, this.hasActiveEditingElement, this.t.moveDown, (this.siblingSlots || []).map(function (slot, i) {
        ...
        return (0, _litElement.html)(_templateObject3_00b20f10ce4411eca4dffb3bcb5f42ec(), i < 1 ? "first-slot" : "", _this2.activeNode && slot.slot === _this2.activeNode.slot, slot.slot, slot.title || slot.slot);
        ...
        return (0, _litElement.html)(_templateObject4_00b20f10ce4411eca4dffb3bcb5f42ec(), el.icon, el.label, el.callback, _this2.viewSource);
    ...
    key: "styles",
    get: function get() {
      return [].concat(_toConsumableArray(_get(_getPrototypeOf(HaxPlateContext), "styles", this)), [(0, _litElement.css)(_templateObject5_00b20f10ce4411eca4dffb3bcb5f42ec())]);
    }
  }, {
    key: "properties",
    get: function get() {
