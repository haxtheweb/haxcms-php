...
function _templateObject5_97c2e750509711edb124eb517be36dbf() {
  ...
  _templateObject5_97c2e750509711edb124eb517be36dbf = function _templateObject5_97c2e750509711edb124eb517be36dbf() {
    return data;
  };
...
function _templateObject4_97c2e750509711edb124eb517be36dbf() {
  var data = _taggedTemplateLiteral([' <hax-context-item\n              action\n              icon="', '"\n              label="', '"\n              event-name="hax-ce-custom-button"\n              value="', '"\n              ?disabled="', '"\n            ></hax-context-item>']);

  _templateObject4_97c2e750509711edb124eb517be36dbf = function _templateObject4_97c2e750509711edb124eb517be36dbf() {
    return data;
  };
...
function _templateObject3_97c2e750509711edb124eb517be36dbf() {
  var data = _taggedTemplateLiteral(['\n                <simple-toolbar-menu-item\n                  slot="menuitem"\n                  class="move-to-slot ', '"\n                >\n                  <hax-context-item\n                    action\n                    align-horizontal="left"\n                    ?disabled="', '"\n                    icon="icons:arrow-forward"\n                    show-text-label\n                    role="menuitem"\n                    event-name="insert-into-active"\n                    data-slot="', '"\n                    label="', '"\n                  ></hax-context-item>\n                </simple-toolbar-menu-item>\n              ']);

  _templateObject3_97c2e750509711edb124eb517be36dbf = function _templateObject3_97c2e750509711edb124eb517be36dbf() {
    return data;
  };
...
function _templateObject2_97c2e750509711edb124eb517be36dbf() {
  var data = _taggedTemplateLiteral(['\n                <simple-toolbar-menu-item\n                  slot="menuitem"\n                  class="move-to-slot ', '"\n                >\n                  <hax-context-item\n                    action\n                    align-horizontal="left"\n                    ?disabled="', '"\n                    icon="icons:arrow-forward"\n                    show-text-label\n                    role="menuitem"\n                    data-slot="', '"\n                    @click="', '"\n                    label="', '"\n                  ></hax-context-item>\n                </simple-toolbar-menu-item>\n              ']);

  _templateObject2_97c2e750509711edb124eb517be36dbf = function _templateObject2_97c2e750509711edb124eb517be36dbf() {
    return data;
  };
...
function _templateObject_97c2e750509711edb124eb517be36dbf() {
  ...
  _templateObject_97c2e750509711edb124eb517be36dbf = function _templateObject_97c2e750509711edb124eb517be36dbf() {
    return data;
  };
...
var HaxPlateContext = /*#__PURE__*/function (_I18NMixin) {
  ...
  _createClass(HaxPlateContext, [{
    ...
    value: function render() {
      ...
      return (0, _litElement.html)(_templateObject_97c2e750509711edb124eb517be36dbf(), this.hasActiveEditingElement || !this.canMoveElement || this.viewSource, this.t.dragHandle, !this.canMoveElement, this.hasActiveEditingElement, this.t.moveUp, this.hasActiveEditingElement, this.t.moveDown, (this.siblingSlots || []).map(function (slot, i) {
        return (0, _litElement.html)(_templateObject2_97c2e750509711edb124eb517be36dbf(), i < 1 ? "first-slot" : "", _this2.activeNode && slot.slot === _this2.activeNode.slot, slot, function (e) {
        ...
        return (0, _litElement.html)(_templateObject3_97c2e750509711edb124eb517be36dbf(), i < 1 ? "first-slot" : "", _this2.activeNode && slot.slot === _this2.activeNode.slot, slot.slot, slot.title || slot.slot);
        ...
        return (0, _litElement.html)(_templateObject4_97c2e750509711edb124eb517be36dbf(), el.icon, el.label, el.callback, _this2.viewSource);
    ...
    key: "styles",
    get: function get() {
      return [].concat(_toConsumableArray(_get(_getPrototypeOf(HaxPlateContext), "styles", this)), [(0, _litElement.css)(_templateObject5_97c2e750509711edb124eb517be36dbf())]);
    }
  }, {
    key: "properties",
    get: function get() {
