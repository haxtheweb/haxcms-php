...
function _templateObject3_425d9ea08e7d11eba1fe15f944a3ea4d() {
  var data = _taggedTemplateLiteral(['<slot name="menuitem"></slot>']);

  _templateObject3_425d9ea08e7d11eba1fe15f944a3ea4d = function _templateObject3_425d9ea08e7d11eba1fe15f944a3ea4d() {
    return data;
  };
...
function _templateObject2_425d9ea08e7d11eba1fe15f944a3ea4d() {
  var data = _taggedTemplateLiteral(['\n      <button\n        id="menubutton"\n        aria-haspopup="true"\n        aria-controls="menu"\n        aria-expanded="', '"\n      >\n        <simple-icon-lite\n          icon="', '"\n          aria-hidden="true"\n          ?hidden=', '\n        ></simple-icon-lite>\n        <span class="', '"\n          >', '</span\n        >\n        <simple-icon-lite\n          id="dropdownicon"\n          icon="arrow-drop-down"\n          aria-hidden="true"\n        ></simple-icon-lite>\n      </button>\n      <simple-tooltip for="menubutton" ?hidden="', '"\n        >', "</simple-tooltip\n      >\n    "]);

  _templateObject2_425d9ea08e7d11eba1fe15f944a3ea4d = function _templateObject2_425d9ea08e7d11eba1fe15f944a3ea4d() {
    return data;
  };
...
function _templateObject_425d9ea08e7d11eba1fe15f944a3ea4d() {
  ...
  _templateObject_425d9ea08e7d11eba1fe15f944a3ea4d = function _templateObject_425d9ea08e7d11eba1fe15f944a3ea4d() {
    return data;
  };
...
var HaxContextItemMenu = /*#__PURE__*/function (_A11yMenuButtonBehavi) {
  ...
  _createClass(HaxContextItemMenu, null, [{
     ...
     */
    get: function get() {
      return [].concat(_toConsumableArray(_get(_getPrototypeOf(HaxContextItemMenu), "styles", this)), [(0, _litElement.css)(_templateObject_425d9ea08e7d11eba1fe15f944a3ea4d())]);
    }
  }]);
  ...
  _createClass(HaxContextItemMenu, [{
    ...
    key: "buttonTemplate",
    get: function get() {
      return (0, _litElement.html)(_templateObject2_425d9ea08e7d11eba1fe15f944a3ea4d(), this.expanded ? "true" : "false", this.icon, !this.icon, !this.icon || this.showTextLabel ? "label" : "sr-only", this.label, !this.icon, this.label);
    }
    /**
    ...
    get: function get() {
      return (0, _litElement.html)(_templateObject3_425d9ea08e7d11eba1fe15f944a3ea4d());
    }
  }], [{
    key: "tag",
    get: function get() {
