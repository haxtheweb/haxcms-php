...
function _templateObject3_71ab35c035d711edbaf51720f3df2ce2() {
  var data = _taggedTemplateLiteral(['<slot name="menuitem"></slot>']);

  _templateObject3_71ab35c035d711edbaf51720f3df2ce2 = function _templateObject3_71ab35c035d711edbaf51720f3df2ce2() {
    return data;
  };
...
function _templateObject2_71ab35c035d711edbaf51720f3df2ce2() {
  var data = _taggedTemplateLiteral(['\n      <button\n        id="menubutton"\n        aria-haspopup="true"\n        aria-controls="menu"\n        aria-expanded="', '"\n      >\n        <simple-icon-lite\n          icon="', '"\n          aria-hidden="true"\n          ?hidden=', '\n        ></simple-icon-lite>\n        <span class="', '"\n          >', '</span\n        >\n        <simple-icon-lite\n          id="dropdownicon"\n          icon="arrow-drop-down"\n          aria-hidden="true"\n        ></simple-icon-lite>\n      </button>\n      <simple-tooltip for="menubutton" ?hidden="', '"\n        >', "</simple-tooltip\n      >\n    "]);

  _templateObject2_71ab35c035d711edbaf51720f3df2ce2 = function _templateObject2_71ab35c035d711edbaf51720f3df2ce2() {
    return data;
  };
...
function _templateObject_71ab35c035d711edbaf51720f3df2ce2() {
  ...
  _templateObject_71ab35c035d711edbaf51720f3df2ce2 = function _templateObject_71ab35c035d711edbaf51720f3df2ce2() {
    return data;
  };
...
var HaxContextItemMenu = /*#__PURE__*/function (_A11yMenuButtonBehavi) {
  ...
  _createClass(HaxContextItemMenu, null, [{
     ...
     */
    get: function get() {
      return [].concat(_toConsumableArray(_get(_getPrototypeOf(HaxContextItemMenu), "styles", this)), [(0, _litElement.css)(_templateObject_71ab35c035d711edbaf51720f3df2ce2())]);
    }
  }]);
  ...
  _createClass(HaxContextItemMenu, [{
    ...
    key: "buttonTemplate",
    get: function get() {
      return (0, _litElement.html)(_templateObject2_71ab35c035d711edbaf51720f3df2ce2(), this.expanded ? "true" : "false", this.icon, !this.icon, !this.icon || this.showTextLabel ? "label" : "sr-only", this.label, !this.icon, this.label);
    }
    /**
    ...
    get: function get() {
      return (0, _litElement.html)(_templateObject3_71ab35c035d711edbaf51720f3df2ce2());
    }
  }], [{
    key: "tag",
    get: function get() {
