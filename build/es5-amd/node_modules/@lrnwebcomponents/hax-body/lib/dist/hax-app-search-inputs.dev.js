...
function _templateObject2_bd08cca0b2b411eb9e5c9b5d1881fac2() {
  var data = _taggedTemplateLiteral(['\n      <h5 class="search-label">\n        ', '\n        <hax-tray-button\n          id="cancel"\n          class="', '"\n          icon="close"\n          label="Cancel Search"\n          event-name="cancel-search"\n        >\n        </hax-tray-button>\n      </h5>\n      <simple-fields\n        id="form"\n        .schema="', '"\n        .schematizer="', '"\n        .elementizer="', '"\n        @value-changed="', '"\n      ></simple-fields>\n    ']);

  _templateObject2_bd08cca0b2b411eb9e5c9b5d1881fac2 = function _templateObject2_bd08cca0b2b411eb9e5c9b5d1881fac2() {
    return data;
  };
...
function _templateObject_bd08cca0b2b411eb9e5c9b5d1881fac2() {
  var data = _taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n        .search-label {\n          display: flex;\n          align-items: center;\n          justify-content: space-between;\n          width: 100%;\n        }\n        #cancel {\n          flex: 0 0 auto;\n        }\n      "]);

  _templateObject_bd08cca0b2b411eb9e5c9b5d1881fac2 = function _templateObject_bd08cca0b2b411eb9e5c9b5d1881fac2() {
    return data;
  };
...
var HaxAppSearchInputs = /*#__PURE__*/function (_LitElement) {
  ...
  _createClass(HaxAppSearchInputs, null, [{
     ...
     */
    get: function get() {
      return [].concat(_toConsumableArray(_haxUiStyles.HaxTrayDetailHeadings), [(0, _litElement.css)(_templateObject_bd08cca0b2b411eb9e5c9b5d1881fac2())]);
    }
  }]);
  ...
  _createClass(HaxAppSearchInputs, [{
    ...
    value: function render() {
      return (0, _litElement.html)(_templateObject2_bd08cca0b2b411eb9e5c9b5d1881fac2(), this.label, !this.searching ? "visibility-hidden" : "", this.schema, _HAXFields.HaxSchematizer, _HAXFields.HaxElementizer, this.searchValuesChanged);
    }
  }, {
