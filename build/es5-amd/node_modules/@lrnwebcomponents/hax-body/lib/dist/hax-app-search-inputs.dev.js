...
function _templateObject2_b10d9da0ca4011ec8ea3cf201a1ea3dd() {
  var data = _taggedTemplateLiteral(['\n      <h5 class="search-label">\n        ', '\n        <hax-tray-button\n          id="cancel"\n          class="', '"\n          icon="close"\n          label="Cancel Search"\n          event-name="cancel-search"\n        >\n        </hax-tray-button>\n      </h5>\n      <simple-fields\n        id="form"\n        .schema="', '"\n        .schematizer="', '"\n        .elementizer="', '"\n        @value-changed="', '"\n      ></simple-fields>\n    ']);

  _templateObject2_b10d9da0ca4011ec8ea3cf201a1ea3dd = function _templateObject2_b10d9da0ca4011ec8ea3cf201a1ea3dd() {
    return data;
  };
...
function _templateObject_b10d9da0ca4011ec8ea3cf201a1ea3dd() {
  var data = _taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n        .search-label {\n          display: flex;\n          align-items: center;\n          justify-content: space-between;\n          width: 100%;\n        }\n        #cancel {\n          flex: 0 0 auto;\n        }\n      "]);

  _templateObject_b10d9da0ca4011ec8ea3cf201a1ea3dd = function _templateObject_b10d9da0ca4011ec8ea3cf201a1ea3dd() {
    return data;
  };
...
var HaxAppSearchInputs = /*#__PURE__*/function (_LitElement) {
  ...
  _createClass(HaxAppSearchInputs, null, [{
     ...
     */
    get: function get() {
      return [].concat(_toConsumableArray(_haxUiStyles.HaxTrayDetailHeadings), [(0, _litElement.css)(_templateObject_b10d9da0ca4011ec8ea3cf201a1ea3dd())]);
    }
  }]);
  ...
  _createClass(HaxAppSearchInputs, [{
    ...
    value: function render() {
      return (0, _litElement.html)(_templateObject2_b10d9da0ca4011ec8ea3cf201a1ea3dd(), this.label, !this.searching ? "visibility-hidden" : "", this.schema, _HAXFields.HaxSchematizer, _HAXFields.HaxElementizer, this.searchValuesChanged);
    }
  }, {
