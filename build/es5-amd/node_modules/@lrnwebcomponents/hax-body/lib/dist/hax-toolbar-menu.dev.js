...
function _templateObject2_fd17f5f0a0c911eda392efd0bad1b4bf() {
  var data = _taggedTemplateLiteral(['\n        ::slotted([slot="menuitem"]) {\n          --simple-toolbar-button-justify: flex-start;\n          --simple-toolbar-button-label-white-space: nowrap;\n        }\n      ']);
  _templateObject2_fd17f5f0a0c911eda392efd0bad1b4bf = function _templateObject2_fd17f5f0a0c911eda392efd0bad1b4bf() {
    return data;
  };
  return data;
}
function _templateObject_fd17f5f0a0c911eda392efd0bad1b4bf() {
  var data = _taggedTemplateLiteral(['<slot name="menuitem"></slot>']);
  _templateObject_fd17f5f0a0c911eda392efd0bad1b4bf = function _templateObject_fd17f5f0a0c911eda392efd0bad1b4bf() {
    return data;
  };
  return data;
}
...
function (_SimpleToolbarMenuBeh) {
  ...
  _createClass(HaxToolbarMenu, [{
    ...
    get: function get() {
      return (0, _litElement.html)(_templateObject_fd17f5f0a0c911eda392efd0bad1b4bf());
    }
  }], [{
    ...
    get: function get() {
      return [].concat(_toConsumableArray(_get(_getPrototypeOf(HaxToolbarMenu), "simpleButtonCoreStyles", this)), [(0, _litElement.css)(_templateObject2_fd17f5f0a0c911eda392efd0bad1b4bf())]);
    }
  }, {
    key: "tag",
    get: function get() {
