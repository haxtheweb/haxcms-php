...
function _templateObject17_cf3748d0403311edb9fff3e6b08a0a9a() {
  ...
  _templateObject17_cf3748d0403311edb9fff3e6b08a0a9a = function _templateObject17_cf3748d0403311edb9fff3e6b08a0a9a() {
    return data;
  };
...
function _templateObject16_cf3748d0403311edb9fff3e6b08a0a9a() {
  ...
  _templateObject16_cf3748d0403311edb9fff3e6b08a0a9a = function _templateObject16_cf3748d0403311edb9fff3e6b08a0a9a() {
    return data;
  };
...
function _templateObject15_cf3748d0403311edb9fff3e6b08a0a9a() {
  var data = _taggedTemplateLiteral(['<hax-map\n      controls="content-map"\n      ?hidden="', '"\n    ></hax-map>']);

  _templateObject15_cf3748d0403311edb9fff3e6b08a0a9a = function _templateObject15_cf3748d0403311edb9fff3e6b08a0a9a() {
    return data;
  };
...
function _templateObject14_cf3748d0403311edb9fff3e6b08a0a9a() {
  var data = _taggedTemplateLiteral([' <hax-gizmo-browser\n        id="gizmobrowser"\n        ?hidden="', '"\n      ></hax-gizmo-browser>\n      <h5 ?hidden="', '">', '</h5>\n      <hax-stax-browser\n        id="staxbrowser"\n        ?hidden="', '"\n      ></hax-stax-browser>']);

  _templateObject14_cf3748d0403311edb9fff3e6b08a0a9a = function _templateObject14_cf3748d0403311edb9fff3e6b08a0a9a() {
    return data;
  };
...
function _templateObject13_cf3748d0403311edb9fff3e6b08a0a9a() {
  var data = _taggedTemplateLiteral([' <simple-fields\n      id="settingsform"\n      disable-responsive\n      code-theme="', '"\n      ?hidden="', '"\n    ></simple-fields>']);

  _templateObject13_cf3748d0403311edb9fff3e6b08a0a9a = function _templateObject13_cf3748d0403311edb9fff3e6b08a0a9a() {
    return data;
  };
...
function _templateObject12_cf3748d0403311edb9fff3e6b08a0a9a() {
  var data = _taggedTemplateLiteral([' <hax-preferences-dialog\n      id="advanced-settings"\n      ?hidden="', '"\n    ></hax-preferences-dialog>']);

  _templateObject12_cf3748d0403311edb9fff3e6b08a0a9a = function _templateObject12_cf3748d0403311edb9fff3e6b08a0a9a() {
    return data;
  };
...
function _templateObject11_cf3748d0403311edb9fff3e6b08a0a9a() {
  var data = _taggedTemplateLiteral([' <hax-view-source\n      id="view-source"\n      ?hidden="', '"\n    ></hax-view-source>']);

  _templateObject11_cf3748d0403311edb9fff3e6b08a0a9a = function _templateObject11_cf3748d0403311edb9fff3e6b08a0a9a() {
    return data;
  };
...
function _templateObject10_cf3748d0403311edb9fff3e6b08a0a9a() {
  var data = _taggedTemplateLiteral([' <div\n      id="tray-detail"\n      aria-live="polite"\n      aria-disabled="', '"\n      tabindex="', '"\n      selected-detail="', '"\n    >\n      <div class="tray-detail-titlebar">\n        <h4>\n          ', '\n        </h4>\n        <hax-tray-button\n          voice-command="collapse menu"\n          id="toggle-tray-size"\n          event-name="toggle-tray-size"\n          icon="close"\n          label="Close"\n        >\n        </hax-tray-button>\n      </div>\n      ', " ", "\n      ", " ", "\n      ", " ", "\n    </div>"]);

  _templateObject10_cf3748d0403311edb9fff3e6b08a0a9a = function _templateObject10_cf3748d0403311edb9fff3e6b08a0a9a() {
    return data;
  };
...
function _templateObject9_cf3748d0403311edb9fff3e6b08a0a9a() {
  ...
  _templateObject9_cf3748d0403311edb9fff3e6b08a0a9a = function _templateObject9_cf3748d0403311edb9fff3e6b08a0a9a() {
    return data;
  };
...
function _templateObject8_cf3748d0403311edb9fff3e6b08a0a9a() {
  ...
  _templateObject8_cf3748d0403311edb9fff3e6b08a0a9a = function _templateObject8_cf3748d0403311edb9fff3e6b08a0a9a() {
    return data;
  };
...
function _templateObject7_cf3748d0403311edb9fff3e6b08a0a9a() {
  var data = _taggedTemplateLiteral([' <hax-tray-button\n        icon="icons:undo"\n        ?disabled="', '"\n        label="', '"\n        event-name="undo"\n        voice-command="undo"\n        data-simple-tour-stop\n        data-stop-title="label"\n        icon-position="left"\n        show-text-label\n        show-tooltip\n        align-horizontal="', '"\n      >\n        <div slot="tour" data-stop-content>\n          Undo the previous operation in the content, whether typing or adding a\n          widget.\n        </div>\n      </hax-tray-button>\n      <hax-tray-button\n        icon="icons:redo"\n        ?disabled="', '"\n        label="', '"\n        event-name="redo"\n        voice-command="redo"\n        data-simple-tour-stop\n        data-stop-title="label"\n        icon-position="left"\n        show-text-label\n        show-tooltip\n        align-horizontal="', '"\n      >\n        <div slot="tour" data-stop-content>\n          Redo the last action that you hit Undo on.\n        </div>\n      </hax-tray-button>']);

  _templateObject7_cf3748d0403311edb9fff3e6b08a0a9a = function _templateObject7_cf3748d0403311edb9fff3e6b08a0a9a() {
    return data;
  };
...
function _templateObject6_cf3748d0403311edb9fff3e6b08a0a9a() {
  var data = _taggedTemplateLiteral(['\n          <hax-tray-button\n            @click="', '"\n            icon="save"\n            icon-position="left"\n            id="haxsavebutton"\n            label="', '"\n            event-name="save"\n            voice-command="save page"\n            show-text-label\n            show-tooltip\n            align-horizontal="', '"\n          ></hax-tray-button>\n          <hax-tray-button\n            icon="cancel"\n            id="haxcancelbutton"\n            label="', '"\n            icon-position="left"\n            show-text-label\n            show-tooltip\n            align-horizontal="', '"\n          ></hax-tray-button>\n        ']);

  _templateObject6_cf3748d0403311edb9fff3e6b08a0a9a = function _templateObject6_cf3748d0403311edb9fff3e6b08a0a9a() {
    return data;
  };
...
function _templateObject5_cf3748d0403311edb9fff3e6b08a0a9a() {
  var data = _taggedTemplateLiteral(['\n        <hax-tray-button\n          show-text-label\n          show-tooltip\n          align-horizontal="', '"\n          id="haxMenuAlign"\n          event-name="toggle-element-align"\n          icon="arrow-', '"\n          label="', '"\n          index="', '"\n          tooltip="', " ", '"\n        >\n        </hax-tray-button>\n    </div>\n    ']);

  _templateObject5_cf3748d0403311edb9fff3e6b08a0a9a = function _templateObject5_cf3748d0403311edb9fff3e6b08a0a9a() {
    return data;
  };
...
function _templateObject4_cf3748d0403311edb9fff3e6b08a0a9a() {
  var data = _taggedTemplateLiteral([' <div id="menubar" class="collapse-menu">\n      ', " ", " ", '\n      <slot name="tray-buttons-pre"></slot>\n      ', "", "\n    </div>"]);

  _templateObject4_cf3748d0403311edb9fff3e6b08a0a9a = function _templateObject4_cf3748d0403311edb9fff3e6b08a0a9a() {
    return data;
  };
...
function _templateObject3_cf3748d0403311edb9fff3e6b08a0a9a() {
  var data = _taggedTemplateLiteral(["", "", ""]);

  _templateObject3_cf3748d0403311edb9fff3e6b08a0a9a = function _templateObject3_cf3748d0403311edb9fff3e6b08a0a9a() {
    return data;
  };
...
function _templateObject2_cf3748d0403311edb9fff3e6b08a0a9a() {
  var data = _taggedTemplateLiteral(['\n          <hax-tray-button\n            large\n            voice-command="edit page"\n            .data-opened="', '"\n            @click="', '"\n            icon="create"\n            id="button"\n            feature\n            show-text-label\n            show-tooltip\n            label="', '"\n          ></hax-tray-button>\n        ']);

  _templateObject2_cf3748d0403311edb9fff3e6b08a0a9a = function _templateObject2_cf3748d0403311edb9fff3e6b08a0a9a() {
    return data;
  };
...
function _templateObject_cf3748d0403311edb9fff3e6b08a0a9a() {
  var data = _taggedTemplateLiteral(["\n      ", '\n      <div class="wrapper ', '">\n        ', '\n        <div class="detail">\n          <loading-indicator\n            ?loading="', '"\n          ></loading-indicator>\n          ', "\n        </div>\n      </div>\n    "]);

  _templateObject_cf3748d0403311edb9fff3e6b08a0a9a = function _templateObject_cf3748d0403311edb9fff3e6b08a0a9a() {
    return data;
  };
...
var HaxTray = /*#__PURE__*/function (_I18NMixin) {
  ...
  _createClass(HaxTray, [{
    ...
    value: function render() {
      return (0, _litElement.html)(_templateObject_cf3748d0403311edb9fff3e6b08a0a9a(), this.panelOpsTemplate, this.trayStatus, this.menuToolbarTemplate, !this.appStoreLoaded, this.trayDetailTemplate);
    }
  }, {
    ...
    get: function get() {
      return this.hidePanelOps ? "" : (0, _litElement.html)(_templateObject2_cf3748d0403311edb9fff3e6b08a0a9a(), this.editMode, this._clickEditButton, this.editMode ? this.t.save : this.t.edit);
    }
  }, {
    key: "toolbarsTemplate",
    get: function get() {
      return (0, _litElement.html)(_templateObject3_cf3748d0403311edb9fff3e6b08a0a9a(), this.opsToolbarTemplate, this.trayToolbarTemplate);
    }
  }, {
    key: "menuToolbarTemplate",
    get: function get() {
      return (0, _litElement.html)(_templateObject4_cf3748d0403311edb9fff3e6b08a0a9a(), this.saveButtons, this.doButtons, this.contentButtons, this.moreButtons, this.menuButtons);
    }
  }, {
    key: "menuButtons",
    get: function get() {
      return (0, _litElement.html)(_templateObject5_cf3748d0403311edb9fff3e6b08a0a9a(), this.collapsed ? "left" : "center", this.elementAlign == "left" ? "forward" : "back", this.elementAlign == "left" ? this.t.menuRight : this.t.menuLeft, this.elementAlign == "left" ? "1" : "0", this.t.moveMenu, this.elementAlign == "left" ? this.t.right : this.t.left);
    }
  }, {
    key: "saveButtons",
    get: function get() {
      return this.hidePanelOps ? "" : (0, _litElement.html)(_templateObject6_cf3748d0403311edb9fff3e6b08a0a9a(), this._clickSaveButton, this.editMode ? this.t.save : this.t.edit, this.collapsed ? "left" : "center", this.t.cancel, this.collapsed ? "left" : "center");
    }
  }, {
    key: "doButtons",
    get: function get() {
      return (0, _litElement.html)(_templateObject7_cf3748d0403311edb9fff3e6b08a0a9a(), !this.canUndo, this.t.undo, this.collapsed ? "left" : "center", !this.canRedo, this.t.redo, this.collapsed ? "left" : "center");
    }
  }, {
    key: "contentButtons",
    get: function get() {
      return (0, _litElement.html)(_templateObject8_cf3748d0403311edb9fff3e6b08a0a9a(), this.t.blocks, !this.collapsed && this.trayDetail === "content-add", this.collapsed ? "left" : "center", this.t.media, !this.collapsed && this.trayDetail === "media-add", this.collapsed ? "left" : "center", this.t.edit, !this.activeTagName || this.activeTagName == "" || !this.activeNode || !this.activeNode.tagName, this.t.editSelected, this.activeTagName, !this.collapsed && this.trayDetail === "content-edit", this.collapsed ? "left" : "center", this.t.structure, !this.collapsed && this.trayDetail === "content-map", this.collapsed ? "left" : "center");
    }
  }, {
    key: "moreButtons",
    get: function get() {
      return (0, _litElement.html)(_templateObject9_cf3748d0403311edb9fff3e6b08a0a9a(), this.t.source, this.collapsed ? "left" : "center", this.hidePreferencesButton, this.t.settings, !this.collapsed && this.trayDetail === "advanced-settings", this.collapsed ? "left" : "center", this.tourOpened ? "stop-tour" : "start-tour", this.t.takeATour, !this.collapsed && this.tourOpened, this.collapsed ? "left" : "center");
    }
  }, {
    key: "trayDetailTemplate",
    get: function get() {
      return (0, _litElement.html)(_templateObject10_cf3748d0403311edb9fff3e6b08a0a9a(), this.collapsed ? "true" : "false", this.collapsed ? "-1" : "0", this.trayDetail, this.trayLabel || "".concat(this.t.editSelected, " ").concat(this.activeTagName), this.viewSourceTemplate, this.advancedSettingsTemplate, this.contentMapTemplate, this.contentEditTemplate, this.contentAddTemplate, this.mediaTemplate);
    }
  }, {
    key: "viewSourceTemplate",
    get: function get() {
      return (0, _litElement.html)(_templateObject11_cf3748d0403311edb9fff3e6b08a0a9a(), this.trayDetail !== "view-source");
    }
  }, {
    key: "advancedSettingsTemplate",
    get: function get() {
      return (0, _litElement.html)(_templateObject12_cf3748d0403311edb9fff3e6b08a0a9a(), this.trayDetail !== "advanced-settings");
    }
  }, {
    key: "contentEditTemplate",
    get: function get() {
      return (0, _litElement.html)(_templateObject13_cf3748d0403311edb9fff3e6b08a0a9a(), this.haxUiTheme == "system" ? "auto" : this.haxUiTheme == "haxdark" ? "vs-dark" : "vs", this.trayDetail !== "content-edit");
    }
  }, {
    key: "contentAddTemplate",
    get: function get() {
      var hidden = this.trayDetail !== "content-add";
      return (0, _litElement.html)(_templateObject14_cf3748d0403311edb9fff3e6b08a0a9a(), hidden, hidden, this.t.templates, hidden);
    }
  }, {
    key: "contentMapTemplate",
    get: function get() {
      return (0, _litElement.html)(_templateObject15_cf3748d0403311edb9fff3e6b08a0a9a(), this.trayDetail !== "content-map");
    }
  }, {
    key: "mediaTemplate",
    get: function get() {
      var hidden = this.trayDetail !== "media-add";
      return (0, _litElement.html)(_templateObject16_cf3748d0403311edb9fff3e6b08a0a9a(), hidden, hidden, this.t.search, hidden);
    }
  }], [{
    key: "styles",
    get: function get() {
      return [].concat(_toConsumableArray(_get(_getPrototypeOf(HaxTray), "styles", this) || []), _toConsumableArray(_haxUiStyles.HaxTrayDetail), _toConsumableArray(_haxUiStyles.HaxComponentStyles), [(0, _litElement.css)(_templateObject17_cf3748d0403311edb9fff3e6b08a0a9a())]);
    }
  }, {
    key: "properties",
    get: function get() {
