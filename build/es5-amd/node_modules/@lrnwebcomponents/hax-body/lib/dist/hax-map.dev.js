...
function _templateObject3_2db51f10cd8211ecaf720fdc1a41727f() {
  var data = _taggedTemplateLiteral(['\n            <li>\n              <hax-toolbar-item\n                align-horizontal="left"\n                class="heading-level-', '"\n                @click="', '"\n                data-index="', '"\n                icon="', '"\n                label="', '"\n                show-text-label\n              >\n              </hax-toolbar-item>\n            </li>\n          ']);

  _templateObject3_2db51f10cd8211ecaf720fdc1a41727f = function _templateObject3_2db51f10cd8211ecaf720fdc1a41727f() {
    return data;
  };
...
function _templateObject2_2db51f10cd8211ecaf720fdc1a41727f() {
  var data = _taggedTemplateLiteral(["\n      <h5>", '</h5>\n      <div class="stats">\n        <div class="stat">\n          <span>', "</span>\n          <span>", '</span>\n        </div>\n        <div class="stat">\n          <span>', "</span>\n          <span>", '</span>\n        </div>\n        <div class="stat">\n          <span>', "</span>\n          <span>", '</span>\n        </div>\n        <div class="stat">\n          <span>', "</span>\n          <span>", "</span>\n        </div>\n      </div>\n      <h5>", "</h5>\n      <ul>\n        ", "\n      </ul>\n    "]);

  _templateObject2_2db51f10cd8211ecaf720fdc1a41727f = function _templateObject2_2db51f10cd8211ecaf720fdc1a41727f() {
    return data;
  };
...
function _templateObject_2db51f10cd8211ecaf720fdc1a41727f() {
  ...
  _templateObject_2db51f10cd8211ecaf720fdc1a41727f = function _templateObject_2db51f10cd8211ecaf720fdc1a41727f() {
    return data;
  };
...
var HaxMap = /*#__PURE__*/function (_I18NMixin) {
  ...
  _createClass(HaxMap, null, [{
     ...
     */
    get: function get() {
      return [].concat(_toConsumableArray(_haxUiStyles.HaxTrayDetailHeadings), [(0, _litElement.css)(_templateObject_2db51f10cd8211ecaf720fdc1a41727f())]);
    }
  }]);
  ...
  _createClass(HaxMap, [{
    ...
    value: function render() {
      ...
      return (0, _litElement.html)(_templateObject2_2db51f10cd8211ecaf720fdc1a41727f(), this.t.contentStatistics, this.wCount, this.t.words, this.pCount, this.t.paragraphs, this.eCount, this.t.widgets, this.cCount, this.t.characters, this.t.listView, this.indentedElements.map(function (element, index) {
        return (0, _litElement.html)(_templateObject3_2db51f10cd8211ecaf720fdc1a41727f(), element.parent || "h1", function (e) {
