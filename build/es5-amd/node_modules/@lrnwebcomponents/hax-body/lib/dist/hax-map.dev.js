...
function _templateObject3_d2ef5ce08b3211ebb67059cf696085af() {
  var data = _taggedTemplateLiteral(['\n              <li>\n                <hax-toolbar-item\n                  align-horizontal="left"\n                  class="heading-level-', '"\n                  @click="', '"\n                  data-index="', '"\n                  icon="', '"\n                  label="', '"\n                  show-text-label\n                >\n                </hax-toolbar-item>\n              </li>\n            ']);

  _templateObject3_d2ef5ce08b3211ebb67059cf696085af = function _templateObject3_d2ef5ce08b3211ebb67059cf696085af() {
    return data;
  };
...
function _templateObject2_d2ef5ce08b3211ebb67059cf696085af() {
  var data = _taggedTemplateLiteral(['\n      <div class="container">\n        <table>\n          <caption>\n            ', '\n          </caption>\n          <thead>\n            <tr>\n              <th scope="col">', '</th>\n              <th scope="col">', '</th>\n              <th scope="col">', '</th>\n              <th scope="col">', '</th>\n              <th scope="col">', "</th>\n            </tr>\n          </thead>\n          <tbody>\n            <tr>\n              <td>", "</td>\n              <td>", "</td>\n              <td>", "</td>\n              <td>", "</td>\n              <td>", "</td>\n            </tr>\n          </tbody>\n        </table>\n        <h5>", "</h5>\n        <ul>\n          ", "\n        </ul>\n      </div>\n    "]);

  _templateObject2_d2ef5ce08b3211ebb67059cf696085af = function _templateObject2_d2ef5ce08b3211ebb67059cf696085af() {
    return data;
  };
...
function _templateObject_d2ef5ce08b3211ebb67059cf696085af() {
  ...
  _templateObject_d2ef5ce08b3211ebb67059cf696085af = function _templateObject_d2ef5ce08b3211ebb67059cf696085af() {
    return data;
  };
...
var HaxMap = /*#__PURE__*/function (_I18NMixin) {
  ...
  _createClass(HaxMap, null, [{
     ...
     */
    get: function get() {
      return [].concat(_toConsumableArray(_haxUiStyles.HaxTrayDetailHeadings), [(0, _litElement.css)(_templateObject_d2ef5ce08b3211ebb67059cf696085af())]);
    }
  }]);
  ...
  _createClass(HaxMap, [{
    ...
    value: function render() {
      ...
      return (0, _litElement.html)(_templateObject2_d2ef5ce08b3211ebb67059cf696085af(), this.t.contentStatistics, this.t.words, this.t.headings, this.t.paragraphs, this.t.widgets, this.t.characters, this.wCount, this.hCount, this.pCount, this.eCount, this.cCount, this.t.listView, this.indentedElements.map(function (element, index) {
        return (0, _litElement.html)(_templateObject3_d2ef5ce08b3211ebb67059cf696085af(), element.parent || "h1", function (e) {
