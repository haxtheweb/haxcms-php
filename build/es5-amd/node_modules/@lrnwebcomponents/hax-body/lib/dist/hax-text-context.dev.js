...
function _templateObject3_2df97b10cd8211ecaf720fdc1a41727f() {
  var data = _taggedTemplateLiteral([' <simple-toolbar-menu-item slot="menuitem">\n                    <hax-context-item-textop\n                      action\n                      align-horizontal="left"\n                      role="menuitem"\n                      icon="', '"\n                      label="', '"\n                      show-text-label\n                      ?hidden="', '"\n                      event-name="', '"\n                      show-text-label\n                      ?disabled="', '"\n                      @click="', '"\n                    ></hax-context-item-textop>\n                  </simple-toolbar-menu-item>']);

  _templateObject3_2df97b10cd8211ecaf720fdc1a41727f = function _templateObject3_2df97b10cd8211ecaf720fdc1a41727f() {
    return data;
  };
...
function _templateObject2_2df97b10cd8211ecaf720fdc1a41727f() {
  ...
  _templateObject2_2df97b10cd8211ecaf720fdc1a41727f = function _templateObject2_2df97b10cd8211ecaf720fdc1a41727f() {
    return data;
  };
...
function _templateObject_2df97b10cd8211ecaf720fdc1a41727f() {
  var data = _taggedTemplateLiteral(["\n        .group,\n        .group > * {\n          flex: 1 1 auto;\n        }\n      "]);

  _templateObject_2df97b10cd8211ecaf720fdc1a41727f = function _templateObject_2df97b10cd8211ecaf720fdc1a41727f() {
    return data;
  };
...
var HaxTextContext = /*#__PURE__*/function (_I18NMixin) {
  ...
  _createClass(HaxTextContext, null, [{
    key: "styles",
    get: function get() {
      return [].concat(_toConsumableArray(_get(_getPrototypeOf(HaxTextContext), "styles", this)), [(0, _litElement.css)(_templateObject_2df97b10cd8211ecaf720fdc1a41727f())]);
    }
  }]);
  ...
  _createClass(HaxTextContext, [{
    ...
    value: function render() {
      ...
      return (0, _litElement.html)(_templateObject2_2df97b10cd8211ecaf720fdc1a41727f(), this._formatIcon(this.realSelectedValue), this.viewSource, this.formattingList.map(function (val) {
        return (0, _litElement.html)(_templateObject3_2df97b10cd8211ecaf720fdc1a41727f(), val.icon, val.text, !_this2.sourceView, val.value, _this2.viewSource, function (e) {
