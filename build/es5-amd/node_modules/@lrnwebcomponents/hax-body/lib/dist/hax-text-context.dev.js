...
function _templateObject3_fd09ec30a0c911eda392efd0bad1b4bf() {
  var data = _taggedTemplateLiteral([' <simple-toolbar-menu-item slot="menuitem">\n                    <hax-context-item-textop\n                      action\n                      align-horizontal="left"\n                      role="menuitem"\n                      icon="', '"\n                      label="', '"\n                      show-text-label\n                      ?hidden="', '"\n                      event-name="', '"\n                      show-text-label\n                      ?disabled="', '"\n                      @click="', '"\n                    ></hax-context-item-textop>\n                  </simple-toolbar-menu-item>']);
  _templateObject3_fd09ec30a0c911eda392efd0bad1b4bf = function _templateObject3_fd09ec30a0c911eda392efd0bad1b4bf() {
    return data;
  };
  return data;
}
function _templateObject2_fd09ec30a0c911eda392efd0bad1b4bf() {
  ...
  _templateObject2_fd09ec30a0c911eda392efd0bad1b4bf = function _templateObject2_fd09ec30a0c911eda392efd0bad1b4bf() {
    return data;
  };
  return data;
}
function _templateObject_fd09ec30a0c911eda392efd0bad1b4bf() {
  var data = _taggedTemplateLiteral(["\n        .group,\n        .group > * {\n          flex: 1 1 auto;\n        }\n      "]);
  _templateObject_fd09ec30a0c911eda392efd0bad1b4bf = function _templateObject_fd09ec30a0c911eda392efd0bad1b4bf() {
    return data;
  };
  return data;
}
 ...
 */
var HaxTextContext = /*#__PURE__*/
function (_I18NMixin) {
  _inherits(HaxTextContext, _I18NMixin);
  _createClass(HaxTextContext, null, [{
    key: "styles",
    get: function get() {
      return [].concat(_toConsumableArray(_get(_getPrototypeOf(HaxTextContext), "styles", this)), [(0, _litElement.css)(_templateObject_fd09ec30a0c911eda392efd0bad1b4bf())]);
    }
  }]);
  ...
  _createClass(HaxTextContext, [{
    ...
    value: function render() {
      var _this2 = this;
      return (0, _litElement.html)(_templateObject2_fd09ec30a0c911eda392efd0bad1b4bf(), this._formatIcon(this.realSelectedValue), this.viewSource, this.formattingList.map(function (val) {
        return (0, _litElement.html)(_templateObject3_fd09ec30a0c911eda392efd0bad1b4bf(), val.icon, val.text, !_this2.sourceView, val.value, _this2.viewSource, function (e) {
