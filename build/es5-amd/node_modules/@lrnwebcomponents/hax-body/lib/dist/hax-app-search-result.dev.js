...
function _templateObject2_97377030509711edb124eb517be36dbf() {
  ...
  _templateObject2_97377030509711edb124eb517be36dbf = function _templateObject2_97377030509711edb124eb517be36dbf() {
    return data;
  };
...
function _templateObject_97377030509711edb124eb517be36dbf() {
  var data = _taggedTemplateLiteral(['\n      <button\n        draggable="true"\n        @click="', '"\n        @dragstart="', '"\n        @dragend="', '"\n        title="', '"\n      >\n        <img loading="lazy" class="image" src="', '" />\n        <div class="detail-wrapper">', "</div>\n      </button>\n    "]);

  _templateObject_97377030509711edb124eb517be36dbf = function _templateObject_97377030509711edb124eb517be36dbf() {
    return data;
  };
...
var HaxAppSearchResult = /*#__PURE__*/function (_LitElement) {
  ...
  _createClass(HaxAppSearchResult, [{
    ...
    value: function render() {
      return (0, _litElement.html)(_templateObject_97377030509711edb124eb517be36dbf(), this._itemSelected, this._dragStart, this._dragEnd, this.details, this.image, this.title.substr(0, 40));
    }
  }, {
    key: "_dragStart",
    ...
    key: "styles",
    get: function get() {
      return [(0, _litElement.css)(_templateObject2_97377030509711edb124eb517be36dbf())];
    }
  }, {
    key: "tag",
    get: function get() {
