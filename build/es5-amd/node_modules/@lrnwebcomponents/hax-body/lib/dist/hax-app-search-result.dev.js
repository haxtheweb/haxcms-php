...
function _templateObject2_18768410930211eb82a7a575782a1009() {
  ...
  _templateObject2_18768410930211eb82a7a575782a1009 = function _templateObject2_18768410930211eb82a7a575782a1009() {
    return data;
  };
...
function _templateObject_18768410930211eb82a7a575782a1009() {
  var data = _taggedTemplateLiteral(['\n      <button\n        draggable="true"\n        @click="', '"\n        @dragstart="', '"\n        @dragend="', '"\n        title="', '"\n      >\n        <img loading="lazy" class="image" src="', '" />\n        <div class="detail-wrapper">', "</div>\n      </button>\n    "]);

  _templateObject_18768410930211eb82a7a575782a1009 = function _templateObject_18768410930211eb82a7a575782a1009() {
    return data;
  };
...
var HaxAppSearchResult = /*#__PURE__*/function (_LitElement) {
  ...
  _createClass(HaxAppSearchResult, [{
    ...
    value: function render() {
      return (0, _litElement.html)(_templateObject_18768410930211eb82a7a575782a1009(), this._itemSelected, this._dragStart, this._dragEnd, this.details, this.image, this.title.substr(0, 40));
    }
  }, {
    key: "_dragStart",
    ...
    key: "styles",
    get: function get() {
      return [(0, _litElement.css)(_templateObject2_18768410930211eb82a7a575782a1009())];
    }
  }, {
    key: "tag",
    get: function get() {
