...
function _templateObject5_5e2e6650c76b11eca96c833ece275368() {
  var data = _taggedTemplateLiteral(['\n            <hax-app-search-result\n              image="', '"\n              title="', '"\n              details="', '"\n              .map="', '"\n              type="', '"\n            ></hax-app-search-result>\n          ']);

  _templateObject5_5e2e6650c76b11eca96c833ece275368 = function _templateObject5_5e2e6650c76b11eca96c833ece275368() {
    return data;
  };
...
function _templateObject4_5e2e6650c76b11eca96c833ece275368() {
  var data = _taggedTemplateLiteral(['\n                  <li>\n                    <a\n                      href="', '"\n                      target="_blank"\n                      rel="noopener nofollow noreferrer"\n                      >', "</a\n                    >\n                  </li>\n                "]);

  _templateObject4_5e2e6650c76b11eca96c833ece275368 = function _templateObject4_5e2e6650c76b11eca96c833ece275368() {
    return data;
  };
...
function _templateObject3_5e2e6650c76b11eca96c833ece275368() {
  var data = _taggedTemplateLiteral(['\n            <div class="tos-text">Terms of service:</div>\n            <ul class="tos-text">\n              ', "\n            </ul>\n          "]);

  _templateObject3_5e2e6650c76b11eca96c833ece275368 = function _templateObject3_5e2e6650c76b11eca96c833ece275368() {
    return data;
  };
...
function _templateObject2_5e2e6650c76b11eca96c833ece275368() {
  var data = _taggedTemplateLiteral(["\n      ", '\n      <hax-app-search-inputs\n        id="searchinput"\n        .label="', '"\n        .schema="', '"\n        @search-values-changed="', '"\n      ></hax-app-search-inputs>\n      <hax-app-pagination\n        id="pagerbottom"\n        .request-data="', '"\n        .pagination="', '"\n      ></hax-app-pagination>\n      <hexagon-loader\n        size="medium"\n        item-count="4"\n        ?loading="', '"\n        aria-roledescription="Loading"\n      ></hexagon-loader>\n      <simple-button-grid\n        class="', '"\n        always-expanded\n        columns="2"\n      >\n        ', "\n      </simple-button-grid>\n    "]);

  _templateObject2_5e2e6650c76b11eca96c833ece275368 = function _templateObject2_5e2e6650c76b11eca96c833ece275368() {
    return data;
  };
...
function _templateObject_5e2e6650c76b11eca96c833ece275368() {
  ...
  _templateObject_5e2e6650c76b11eca96c833ece275368 = function _templateObject_5e2e6650c76b11eca96c833ece275368() {
    return data;
  };
...
var HaxAppSearch = /*#__PURE__*/function (_LitElement) {
  ...
  _createClass(HaxAppSearch, null, [{
     ...
     */
    get: function get() {
      return [(0, _litElement.css)(_templateObject_5e2e6650c76b11eca96c833ece275368())];
    }
  }]);
  ...
  _createClass(HaxAppSearch, [{
    ...
    value: function render() {
      return (0, _litElement.html)(_templateObject2_5e2e6650c76b11eca96c833ece275368(), this.tos.length > 0 ? (0, _litElement.html)(_templateObject3_5e2e6650c76b11eca96c833ece275368(), this.tos.map(function (item) {
        return (0, _litElement.html)(_templateObject4_5e2e6650c76b11eca96c833ece275368(), item.link, item.title);
        ...
        return (0, _litElement.html)(_templateObject5_5e2e6650c76b11eca96c833ece275368(), resultData.image, resultData.title, resultData.details, resultData.map, resultData.type);
      }));
    }
    /**
