...
function _templateObject3_97954b8090bb11eb9010f5aa583cef45() {
  var data = _taggedTemplateLiteral(['\n            <hax-tray-button\n              show-text-label\n              id="picker-item-', '"\n              @click="', '"\n              data-selected="', '"\n              ?disabled="', '"\n              label="', '"\n              icon="', '"\n              icon-position="top"\n            ></hax-tray-button>\n          ']);

  _templateObject3_97954b8090bb11eb9010f5aa583cef45 = function _templateObject3_97954b8090bb11eb9010f5aa583cef45() {
    return data;
  };
...
function _templateObject2_97954b8090bb11eb9010f5aa583cef45() {
  var data = _taggedTemplateLiteral(['\n      <simple-button-grid cols="100px">\n        ', "\n      </simple-button-grid>\n    "]);

  _templateObject2_97954b8090bb11eb9010f5aa583cef45 = function _templateObject2_97954b8090bb11eb9010f5aa583cef45() {
    return data;
  };
...
function _templateObject_97954b8090bb11eb9010f5aa583cef45() {
  var data = _taggedTemplateLiteral(["\n        simple-button-grid {\n          overflow-y: auto;\n          margin: var(--hax-ui-spacing-sm);\n          --simple-button-grid-cols: 100px;\n        }\n      "]);

  _templateObject_97954b8090bb11eb9010f5aa583cef45 = function _templateObject_97954b8090bb11eb9010f5aa583cef45() {
    return data;
  };
...
var HaxPicker = /*#__PURE__*/function (_LitElement) {
  ...
  _createClass(HaxPicker, null, [{
    key: "styles",
    get: function get() {
      return [].concat(_toConsumableArray(_haxUiStyles.HaxComponentStyles), [(0, _litElement.css)(_templateObject_97954b8090bb11eb9010f5aa583cef45())]);
    }
  }]);
  ...
  _createClass(HaxPicker, [{
    ...
    value: function render() {
      ...
      return (0, _litElement.html)(_templateObject2_97954b8090bb11eb9010f5aa583cef45(), this.selectionList.map(function (element, index) {
        return (0, _litElement.html)(_templateObject3_97954b8090bb11eb9010f5aa583cef45(), index, _this2._selected, index, _haxStore.HAXStore.activeGizmo && _haxStore.HAXStore.activeGizmo.tag == element.tag, element.title, element.icon);
      }));
    }
  }, {
    key: "buildOptions",
