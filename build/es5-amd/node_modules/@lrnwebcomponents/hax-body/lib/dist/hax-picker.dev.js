...
function _templateObject4_7565c0902ee311eda9c37b2c2696a94a() {
  var data = _taggedTemplateLiteral(['\n                <hax-tray-button\n                  show-text-label\n                  id="picker-item-', '"\n                  @click="', '"\n                  data-selected="', '"\n                  ?disabled="', '"\n                  label="', '"\n                  icon="', '"\n                  icon-position="top"\n                ></hax-tray-button>\n              ']);

  _templateObject4_7565c0902ee311eda9c37b2c2696a94a = function _templateObject4_7565c0902ee311eda9c37b2c2696a94a() {
    return data;
  };
...
function _templateObject3_7565c0902ee311eda9c37b2c2696a94a() {
  var data = _taggedTemplateLiteral([' <div id="filters">\n            <simple-icon-button-lite\n              icon="editable-table:filter', '"\n              label="Toggle Filters"\n              tooltip-position="right"\n              @click="', '"\n            >\n            </simple-icon-button-lite>\n            <simple-fields-field\n              ?hidden="', '"\n              id="hax-gizmo-filters"\n              label="Filters"\n              type="checkbox"\n              .options="', '"\n              @value-changed="', '"\n            >\n            </simple-fields-field>\n          </div>']);

  _templateObject3_7565c0902ee311eda9c37b2c2696a94a = function _templateObject3_7565c0902ee311eda9c37b2c2696a94a() {
    return data;
  };
...
function _templateObject2_7565c0902ee311eda9c37b2c2696a94a() {
  var data = _taggedTemplateLiteral(["\n      ", '\n      <simple-button-grid cols="100px">\n        ', "\n      </simple-button-grid>\n    "]);

  _templateObject2_7565c0902ee311eda9c37b2c2696a94a = function _templateObject2_7565c0902ee311eda9c37b2c2696a94a() {
    return data;
  };
...
function _templateObject_7565c0902ee311eda9c37b2c2696a94a() {
  ...
  _templateObject_7565c0902ee311eda9c37b2c2696a94a = function _templateObject_7565c0902ee311eda9c37b2c2696a94a() {
    return data;
  };
...
var HaxPicker = /*#__PURE__*/function (_LitElement) {
  ...
  _createClass(HaxPicker, null, [{
    key: "styles",
    get: function get() {
      return [].concat(_toConsumableArray(_haxUiStyles.HaxComponentStyles), [(0, _litElement.css)(_templateObject_7565c0902ee311eda9c37b2c2696a94a())]);
    }
  }]);
  ...
  _createClass(HaxPicker, [{
    ...
    value: function render() {
      ...
      return (0, _litElement.html)(_templateObject2_7565c0902ee311eda9c37b2c2696a94a(), !!this.keywords ? (0, _litElement.html)(_templateObject3_7565c0902ee311eda9c37b2c2696a94a(), !this.filterOn ? "" : "-off", function (e) {
        ...
        return !_this2._isFiltered(element.keywords) ? "" : (0, _litElement.html)(_templateObject4_7565c0902ee311eda9c37b2c2696a94a(), index, _this2._selected, index, _haxStore.HAXStore.activeGizmo && _haxStore.HAXStore.activeGizmo.tag == element.tag, element.title, element.icon);
      }));
    }
  }, {
    key: "buildOptions",
