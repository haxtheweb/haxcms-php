...
function _templateObject3_15515650994411ebb1a5332c5e6bdde2() {
  var data = _taggedTemplateLiteral(['\n            <hax-tray-button\n              class="', '"\n              show-text-label\n              icon-position="top"\n              index="', '"\n              label="', '"\n              icon="', '"\n              color="', '"\n              event-name="search-selected"\n              event-data="', '"\n            >\n            </hax-tray-button>\n          ']);

  _templateObject3_15515650994411ebb1a5332c5e6bdde2 = function _templateObject3_15515650994411ebb1a5332c5e6bdde2() {
    return data;
  };
...
function _templateObject2_15515650994411ebb1a5332c5e6bdde2() {
  var data = _taggedTemplateLiteral(['\n      <simple-button-grid\n        class="', '"\n        always-expanded\n        columns="3"\n      >\n        ', '\n      </simple-button-grid>\n      <hax-app-search\n        id="haxappsearch"\n        class="', '"\n      ></hax-app-search>\n      <slot></slot>\n    ']);

  _templateObject2_15515650994411ebb1a5332c5e6bdde2 = function _templateObject2_15515650994411ebb1a5332c5e6bdde2() {
    return data;
  };
...
function _templateObject_15515650994411ebb1a5332c5e6bdde2() {
  var data = _taggedTemplateLiteral(["\n        :host {\n          overflow-y: auto;\n          position: relative;\n        }\n        simple-button-grid {\n          overflow: auto;\n        }\n        simple-button-grid.collapse-hide {\n          max-height: 0 !important;\n          transition: all 0.5s;\n        }\n        .visibility-hidden {\n          z-index: -1;\n          visibility: hidden;\n          opacity: 0;\n          height: 0;\n          transition: all 0.5s;\n        }\n      "]);

  _templateObject_15515650994411ebb1a5332c5e6bdde2 = function _templateObject_15515650994411ebb1a5332c5e6bdde2() {
    return data;
  };
...
var HaxAppBrowser = /*#__PURE__*/function (_LitElement) {
  ...
  _createClass(HaxAppBrowser, null, [{
    key: "styles",
    get: function get() {
      return [(0, _litElement.css)(_templateObject_15515650994411ebb1a5332c5e6bdde2())];
    }
  }]);
  ...
  _createClass(HaxAppBrowser, [{
    ...
    value: function render() {
      ...
      return (0, _litElement.html)(_templateObject2_15515650994411ebb1a5332c5e6bdde2(), this.searching ? "collapse-hide" : "", this.appList.map(function (app) {
        return (0, _litElement.html)(_templateObject3_15515650994411ebb1a5332c5e6bdde2(), _this2.searching ? "visibility-hidden" : "", app.index, app.details.title, app.details.icon, app.details.color, app.index);
