...
function _templateObject3_81a117606f4811ed83231ba15a006752() {
  var data = _taggedTemplateLiteral(['<slot name="menuitem"></slot>']);

  _templateObject3_81a117606f4811ed83231ba15a006752 = function _templateObject3_81a117606f4811ed83231ba15a006752() {
    return data;
  };
...
function _templateObject2_81a117606f4811ed83231ba15a006752() {
  var data = _taggedTemplateLiteral(['\n      <button\n        id="menubutton"\n        aria-haspopup="true"\n        aria-controls="menu"\n        aria-expanded="', '"\n      >\n        <simple-icon-lite\n          icon="', '"\n          aria-hidden="true"\n          ?hidden=', '\n        ></simple-icon-lite>\n        <span class="', '"\n          >', '</span\n        >\n        <simple-icon-lite\n          id="dropdownicon"\n          icon="arrow-drop-down"\n          aria-hidden="true"\n        ></simple-icon-lite>\n      </button>\n      <simple-tooltip for="menubutton" ?hidden="', '"\n        >', "</simple-tooltip\n      >\n    "]);

  _templateObject2_81a117606f4811ed83231ba15a006752 = function _templateObject2_81a117606f4811ed83231ba15a006752() {
    return data;
  };
...
function _templateObject_81a117606f4811ed83231ba15a006752() {
  ...
  _templateObject_81a117606f4811ed83231ba15a006752 = function _templateObject_81a117606f4811ed83231ba15a006752() {
    return data;
  };
...
var HaxButtonMenu = /*#__PURE__*/function (_A11yMenuButtonBehavi) {
  ...
  _createClass(HaxButtonMenu, null, [{
     ...
     */
    get: function get() {
      return [].concat(_toConsumableArray(_get(_getPrototypeOf(HaxButtonMenu), "styles", this)), [(0, _litElement.css)(_templateObject_81a117606f4811ed83231ba15a006752())]);
    }
  }]);
  ...
  _createClass(HaxButtonMenu, [{
    ...
    key: "buttonTemplate",
    get: function get() {
      return (0, _litElement.html)(_templateObject2_81a117606f4811ed83231ba15a006752(), this.expanded ? "true" : "false", this.icon, !this.icon, !this.icon || this.showTextLabel ? "label" : "sr-only", this.label, !this.icon, this.label);
    }
    /**
    ...
    get: function get() {
      return (0, _litElement.html)(_templateObject3_81a117606f4811ed83231ba15a006752());
    }
  }], [{
    key: "tag",
    get: function get() {
