...
function _templateObject3_ce3a7240403311edb9fff3e6b08a0a9a() {
  var data = _taggedTemplateLiteral(['\n            <hax-tray-button\n              show-text-label\n              voice-command="insert ', '"\n              draggable="true"\n              @dragstart="', '"\n              @dragend="', '"\n              index="', '"\n              label="', '"\n              event-name="insert-tag"\n              event-data="', '"\n              data-demo-schema="true"\n              icon-position="top"\n              icon="', '"\n              part="grid-button"\n            ></hax-tray-button>\n          ']);

  _templateObject3_ce3a7240403311edb9fff3e6b08a0a9a = function _templateObject3_ce3a7240403311edb9fff3e6b08a0a9a() {
    return data;
  };
...
function _templateObject2_ce3a7240403311edb9fff3e6b08a0a9a() {
  var data = _taggedTemplateLiteral(['\n      <div class="toolbar-inner" part="toolbar">\n        <simple-fields-field\n          id="inputfilter"\n          @value-changed="', '"\n          aria-controls="filter"\n          label="', '"\n          type="text"\n          auto-validate=""\n          part="filter"\n        ></simple-fields-field>\n      </div>\n      <simple-button-grid .cols="', '" .columns="', '" always-expanded part="grid">\n        ', "\n      </simple-button-grid>\n    "]);

  _templateObject2_ce3a7240403311edb9fff3e6b08a0a9a = function _templateObject2_ce3a7240403311edb9fff3e6b08a0a9a() {
    return data;
  };
...
function _templateObject_ce3a7240403311edb9fff3e6b08a0a9a() {
  var data = _taggedTemplateLiteral(["\n        :host {\n          display: flex;\n          flex-direction: column;\n          align-items: stretch;\n          flex: 0 1 auto;\n          overflow-y: auto;\n        }\n        :host > * {\n          max-width: 100%;\n        }\n        .toolbar-inner {\n          display: flex;\n          flex-direction: column;\n          align-items: stretch;\n          width: 100%;\n          flex: 0 0 auto;\n        }\n        hax-tray-button::part(button) {\n          font-size: var(hax-ui-font-size-xs);\n        }\n        simple-fields-field {\n          margin-top: 0;\n        }\n      "]);

  _templateObject_ce3a7240403311edb9fff3e6b08a0a9a = function _templateObject_ce3a7240403311edb9fff3e6b08a0a9a() {
    return data;
  };
...
var HaxGizmoBrowser = /*#__PURE__*/function (_I18NMixin) {
  ...
  _createClass(HaxGizmoBrowser, null, [{
    key: "styles",
    get: function get() {
      return [(0, _litElement.css)(_templateObject_ce3a7240403311edb9fff3e6b08a0a9a())];
    }
  }, {
    key: "properties",
    get: function get() {
  ...
  _createClass(HaxGizmoBrowser, [{
    ...
    value: function render() {
      ...
      return (0, _litElement.html)(_templateObject2_ce3a7240403311edb9fff3e6b08a0a9a(), this.inputfilterChanged, this.t.filterContentTypes, this.isModal ? undefined : "100px", this.isModal ? undefined : 3, this.filtered.map(function (gizmo, i) {
        return (0, _litElement.html)(_templateObject3_ce3a7240403311edb9fff3e6b08a0a9a(), gizmo.title, _this2._dragStart, _this2._dragEnd, i, gizmo.title, gizmo.tag, gizmo.icon);
      }));
    }
  }, {
    key: "_dragStart",
