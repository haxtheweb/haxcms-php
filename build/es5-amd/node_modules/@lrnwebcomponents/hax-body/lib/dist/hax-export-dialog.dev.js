...
function _templateObject2_2db12770cd8211ecaf720fdc1a41727f() {
  var data = _taggedTemplateLiteral(["\n        :host {\n          display: none;\n          --simple-modal-resize: both;\n          --simple-modal-height: 100vh;\n        }\n      "]);

  _templateObject2_2db12770cd8211ecaf720fdc1a41727f = function _templateObject2_2db12770cd8211ecaf720fdc1a41727f() {
    return data;
  };
...
function _templateObject_2db12770cd8211ecaf720fdc1a41727f() {
  var data = _taggedTemplateLiteral(['\n      <simple-modal-template\n        modal-id="hax-export"\n        mode="hax-ui"\n        id="dialog"\n        .title="', '"\n      >\n        <hax-view-source slot="custom"></hax-view-source>\n      </simple-modal-template>\n    ']);

  _templateObject_2db12770cd8211ecaf720fdc1a41727f = function _templateObject_2db12770cd8211ecaf720fdc1a41727f() {
    return data;
  };
...
var HaxExportDialog = /*#__PURE__*/function (_I18NMixin) {
  ...
  _createClass(HaxExportDialog, [{
    ...
    value: function render() {
      return (0, _litElement.html)(_templateObject_2db12770cd8211ecaf720fdc1a41727f(), this.t.viewPageSource);
    }
  }, {
    key: "firstUpdated",
    ...
    key: "styles",
    get: function get() {
      return [].concat(_toConsumableArray(_haxUiStyles.HaxComponentStyles), [(0, _litElement.css)(_templateObject2_2db12770cd8211ecaf720fdc1a41727f())]);
    }
  }, {
    key: "tag",
    get: function get() {
