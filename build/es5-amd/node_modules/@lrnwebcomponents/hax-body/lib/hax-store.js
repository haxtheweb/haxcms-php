define(["exports", "meta", "require", "../../../lit-element/lit-element.js", "../../utils/utils.js", "../../hax-body-behaviors/hax-body-behaviors.js", "../../../undoer/undoer.js"], function (_exports, meta, _require, _litElement, _utils, _haxBodyBehaviors, _undoer) {
  ...
  function _templateObject2_ba61efb05b6011ea867b4566cb9aae15() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: none;\n        }\n      "]);

    _templateObject2_ba61efb05b6011ea867b4566cb9aae15 = function _templateObject2_ba61efb05b6011ea867b4566cb9aae15() {
      return data;
    };
  ...
  function _templateObject_ba61efb05b6011ea867b4566cb9aae15() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <slot></slot>\n      <undoer-element></undoer-element>\n      <iron-ajax\n        id=\"appstore\"\n        url=\"", "\"\n        .params=\"", "\"\n        method=\"GET\"\n        content-type=\"application/json\"\n        handle-as=\"json\"\n        @last-response-changed=\"", "\"\n      ></iron-ajax>\n      <hal-9000\n        id=\"hal\"\n        .responds-to=\"", "\"\n        .debug=\"", "\"\n      ></hal-9000>\n    "]);

    _templateObject_ba61efb05b6011ea867b4566cb9aae15 = function _templateObject_ba61efb05b6011ea867b4566cb9aae15() {
      return data;
    };
  ...
  function (_winEventsElement) {
    ...
    babelHelpers.createClass(HaxStore, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_ba61efb05b6011ea867b4566cb9aae15(), this.appStore.url, this.appStore.params, this.__appStoreDataChanged, this.voiceRespondsTo, this.voiceDebug);
      }
    }, {
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_ba61efb05b6011ea867b4566cb9aae15())];
      }
    }, {
      key: "tag",
      get: function get() {
      ...
      value: function openDrawersCallback() {
        ...
        for (var i in drawers) {
          if (active === this[drawers[i]]) {
            active.open();
            setTimeout(function () {
              if (active.querySelector("paper-checkbox,paper-input,textarea,paper-button,hax-tray-button") != null) {
                active.querySelector("paper-checkbox,paper-input,textarea,paper-button,hax-tray-button").focus();
              }
