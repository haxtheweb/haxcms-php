 ...
 */window.HaxStore=window.HaxStore||{};window.HaxStore.instance=null;window.HaxStore.requestAvailability=function(){if(!window.HaxStore.instance){window.HaxStore.instance=document.createElement("hax-store");document.body.appendChild(window.HaxStore.instance)}return window.HaxStore.instance};(0,_polymerLegacy.Polymer)({_template:(0,_polymerLegacy.html)(_templateObject_030fc1f06a9011e9a3fbc91c56f16a14()),is:"hax-store",behaviors:[MediaBehaviors.Video,HAXBehaviors.PropertiesBehaviors],observers:["_loadAppStoreData(__ready, __appStoreData, haxAutoloader)","_storePiecesAllHere(haxAutoloader,activeHaxBody, haxPanel, haxToast, haxExport, haxPreferences, haxManager, haxStaxPicker, haxAppPicker)"],properties:{/**
     * skipHAXConfirmation
...
setTimeout(function(){_this.__appStoreData=newValue},500)}}},/**
   ...
   */_loadAppStoreData:function _loadAppStoreData(ready,appDataResponse,haxAutoloader){if(ready&&babelHelpers.typeof(appDataResponse)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))&&null!=appDataResponse){var items={};// autoload elements
...
try{var globalData=window.sessionStorage.getItem("haxUserData")?JSON.parse(window.sessionStorage.getItem("haxUserData")):{};this.set("storageData",globalData)}catch(e){}}else{try{var _globalData=window.localStorage.getItem("haxUserData")?JSON.parse(window.localStorage.getItem("haxUserData")):{};this.set("storageData",_globalData)}catch(e){}}}})},/**
   * attached.
   */attached:function attached(){(0,_renderStatus.afterNextRender)(this,function(){var _this3=this;// capture events and intercept them globally
