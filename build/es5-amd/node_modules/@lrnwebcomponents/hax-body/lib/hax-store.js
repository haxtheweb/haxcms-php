define(["exports", "meta", "require", "../../../lit/index.js", "../../simple-popover/lib/simple-tour.js", "../../utils/utils.js", "../../../mobx/dist/mobx.esm.js", "../../hax-body-behaviors/hax-body-behaviors.js", "../../i18n-manager/lib/I18NMixin.js", "../../micro-frontend-registry/lib/microServices.js", "../../super-daemon/super-daemon.js", "../../media-behaviors/media-behaviors.js", "../../simple-toast/simple-toast.js", "../../editable-table/editable-table.js", "../../iframe-loader/iframe-loader.js", "../../course-design/lib/learning-component.js", "./hax-app.js"], function (_exports, meta, _require, _index, _simpleTour, _utils, _mobxEsm, _haxBodyBehaviors, _I18NMixin2, _microServices, _superDaemon, _mediaBehaviors, _simpleToast, _editableTable, _iframeLoader, _learningComponent, _haxApp) {
  "use strict";
  ...
  var _templateObject_29469930edcb11edb3e3ed4f0d506a4b, _templateObject2_29469930edcb11edb3e3ed4f0d506a4b, _templateObject3_29469930edcb11edb3e3ed4f0d506a4b;
  ...
  var DataInstructionalAction = [{
    ...
    options: _objectSpread({
      "": "-- none --"
    }, _learningComponent.learningComponentTypes)
  }, {
  ...
  var HaxStore = /*#__PURE__*/function (_I18NMixin) {
    ...
    function HaxStore() {
      ...
      // custom
      _superDaemon.SuperDaemonInstance.icon = "hax:wizard-hat";
      // ensure we are running HAX / ready and in edit mode before allowing commands to go through
      _superDaemon.SuperDaemonInstance.allowedCallback = function () {
        if (_this.ready && _this.editMode) {
          return true;
        }
        return false;
      };
      ...
      _superDaemon.SuperDaemonInstance.defineOption({
        title: "Bug / issue",
        icon: "hax:hax2022",
        tags: ["Bug report", "github", "git", "community", "issue queue"],
        value: {
          target: babelHelpers.assertThisInitialized(_this),
      ...
      _this.daemonKeyCombo = "".concat(_superDaemon.SuperDaemonInstance.key1, " + ").concat(_superDaemon.SuperDaemonInstance.key2, " + ");
      ...
      _this.validGizmoTypes = _this.__validGizmoTypes();
      ...
      (0, _mobxEsm.makeObservable)(babelHelpers.assertThisInitialized(_this), {
        daemonKeyCombo: _mobxEsm.observable,
        gizmoList: _mobxEsm.observable,
        recentGizmoList: _mobxEsm.observable,
    ...
    babelHelpers.createClass(HaxStore, [{
                  ...
                  if (guess === gizmo.handles[i].type || guess === "*" && !match) {
                    ...
                    if (match || skipPropMatch) {
                      if (preferExclusive && gizmo.handles[i].type_exclusive) {
                        return {
                          v: [_this2.haxElementPrototype(gizmo, props, "")]
                        };
                      } else {
                        var keywords = {};
                        ...
                        babelHelpers.toConsumableArray(gizmo.tags).forEach(function (i) {
      ...
      value: function insertLogicFromValues(values, context) {
        ...
        var haxElements = this.guessGizmo(type, values, false, preferExclusive);
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_29469930edcb11edb3e3ed4f0d506a4b || (_templateObject_29469930edcb11edb3e3ed4f0d506a4b = babelHelpers.taggedTemplateLiteral([" <slot></slot> "])));
      }
      /**
       * convention
       */
      ...
      key: "isInlineElement",
      value: function isInlineElement(node) {
        var tag;
        // resolve HAXelements vs nodes
        if (node != null && node.tagName) {
          tag = node.tagName.toLowerCase();
        ...
        if (tag && this.validTagList.includes(tag)) {
          if (this.haxSchemaFromTag(tag) && this.haxSchemaFromTag(tag).meta && this.haxSchemaFromTag(tag).meta.inlineOnly || ["a", "strike", "u", "b", "sub", "sup", "span", "i", "bold", "em", "strong"].includes(tag)) {
            return true;
          }
        }
        return false;
      ...
      value: function () {
        var _loadAppStoreData2 = babelHelpers.asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(appDataResponse) {
          var items, i, CEname, CEimport, apps, _i, app, staxs, _i2, stax;
            ...
            while (1) switch (_context2.prev = _context2.next) {
              case 0:
                ...
                if (babelHelpers.typeof(appDataResponse.stax) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {
                  ...
                  for (_i2 = 0; _i2 < staxs.length; _i2++) {
      ...
      value: function () {
        var _handleDynamicImports2 = babelHelpers.asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(items, haxAutoloader) {
          var _this3 = this;
          var basePath, _loop2, i;
          return _regeneratorRuntime().wrap(function _callee3$(_context4) {
            while (1) switch (_context4.prev = _context4.next) {
              ...
              case 4:
                ...
                return _context4.delegateYield(_loop2(i), "t2", 7);
              case 7:
                _context4.next = 4;
                break;
              case 9:
      ...
      value: function () {
        var _globalPreferencesChanged2 = babelHelpers.asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(newValue) {
          var _this4 = this;
          var storageData;
                ...
                if (this.__storageDataProcessed && newValue && babelHelpers.typeof(newValue.haxVoiceCommands) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined)) && this.ready) {
                  ...
                  if (newValue.haxVoiceCommands && !this.__hal) {
                    ...
                    new Promise(function (res, rej) {
                      ...
                      _this4.shadowRoot.appendChild(_this4.__hal);
                  ...
                  if (newValue.haxLang && HAXStore.editMode) {
                    ...
                    this._debounceLang = setTimeout( /*#__PURE__*/babelHelpers.asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
                      var i, el;
      ...
      value: function _initVoiceCommands() {
        ...
        this.voiceCommands["".concat(this.voiceRespondsTo, " now your name is *splat")] = function (text) {
          ...
          _this9.voiceRespondsTo = "(".concat(text, ")");
      ...
      key: "_onPaste",
      value: function () {
        var _onPaste2 = babelHelpers.asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(e) {
          var _this10 = this;
          var pasteContent, originalContent, p, i, inlinePaste, newContent, fragment, haxElements, values, _values, _i3, node, range, sel, newNodes, _i4, txt, _enterSplit, activeEl, siblingEl;
          return _regeneratorRuntime().wrap(function _callee6$(_context7) {
            while (1) switch (_context7.prev = _context7.next) {
              ...
              case 19:
                ...
                newContent = ""; // verify this is HTML prior to treating it as such
                // HTML pasting to ensure it's clean is very slow
                fragment = document.createElement("div");
                fragment.innerHTML = pasteContent;
                haxElements = []; // test that this is valid HTML before we dig into it as elements
              ...
              case 73:
                ...
                _i3 = _context7.t1.value;
                // special support for pasting into a list of items
                if (haxElements[_i3].tag == "p" && ["li", "ol", "ul"].includes(this.activeNode.tagName.toLowerCase())) {
                  haxElements[_i3].tag = "li";
                }
                // special traps for word / other styles bleeding through
                delete haxElements[_i3].properties.style;
                delete haxElements[_i3].properties.start;
                delete haxElements[_i3].properties.align;
                // this is not the right function.
                node = (0, _utils.haxElementToNode)({
                  tag: haxElements[_i3].tag,
                  content: haxElements[_i3].content.replace(/<span>&nbsp;<\/span>/g, " ").trim(),
                  properties: haxElements[_i3].properties
                });
              ...
              case 86:
                ...
                try {
                  ...
                  if (range && sel) {
                    for (_i4 in newNodes.children) {
                      // delete nodes that are empty text elements
                      if (newNodes.children[_i4].tagName && this.isTextElement(newNodes.children[_i4]) && newNodes.children[_i4].innerHTML === "") {
                        newNodes.children[_i4].remove();
                      }
                    }
                    if (inlinePaste) {
      ...
      value: function __validGizmoTypes() {
        return ["data", "video", "audio", "text", "link", "file", "pdf", "image", "csv", "doc", "archive", "markdown", "html", "content", "text", "gif", "inline", "*"];
      }
    }, {
      key: "_haxStoreContribute",
      value: function () {
        var _haxStoreContribute2 = babelHelpers.asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(type, tags) {
          var daemonTerm,
            body,
            title,
            stats,
          ...
          return _regeneratorRuntime().wrap(function _callee7$(_context8) {
            while (1) switch (_context8.prev = _context8.next) {
              case 0:
                daemonTerm = _args8.length > 2 && _args8[2] !== undefined ? _args8[2] : null;
                body = "";
                if (!(type == "merlin")) {
                  _context8.next = 7;
                  break;
                }
                title = "[".concat(type, "] New command request from HAX daemon");
                body = "Location: ".concat(window.location.href, "\nMerlin command: ").concat(daemonTerm, "\nWhat did you want merlin to do?\n");
                _context8.next = 16;
                break;
              case 7:
                title = "[".concat(type, "] User report from HAX daemon");
              ...
              case 12:
                ...
                body += "Battery: ".concat(stats.level * 100, "%\n");
              case 14:
                // some things report the "type" of internet connection speed
                // for terrible connections lets save frustration
                if (navigator.connection && navigator.connection.effectiveType) {
                  body += "Connection: ".concat(navigator.connection.effectiveType, "\n");
                }
                body += "".concat(type == "feature" ? "Your idea:" : "Bug you experienced:", "\n");
              case 16:
                window.open("https://github.com/elmsln/issues/issues/new?assignees=&labels=".concat(tags, "&template=issue-report.md&title=").concat(title, "&body=").concat(encodeURIComponent(body)), "_blank");
              case 17:
              case "end":
        ...
        function _haxStoreContribute(_x8, _x9) {
          return _haxStoreContribute2.apply(this, arguments);
        }
        return _haxStoreContribute;
      }()
      /**
      ...
      value: function _buildPrimitiveDefinitions() {
        ...
        var iframe = {
          ...
          gizmo: {
            ...
            icon: "hax:iframe",
            color: "blue-grey",
            tags: ["Resource", "iframe", "content", "url", "link", "embed", "https", "html", "resource", "address"],
            handles: [],
            meta: {
              hidden: true,
              author: "W3C"
        ...
        for (var tag in prims) {
          ...
          this.setHaxProperties({
            ...
            settings: {
              configure: ["h1", "h2", "h3", "h4", "h5", "h6"].includes(tag) ? [].concat(DataInstructionalAction) : [DataStyleDecoration],
              advanced: []
            },
            demoSchema: [{
              tag: tag,
        ...
        var hr = {
          ...
          settings: {
            configure: [DataStyleDecoration].concat(DataInstructionalAction),
            advanced: []
          },
          demoSchema: [{
            tag: "hr",
      ...
      value: function () {
        ...
        function _haxStoreInsertContent(_x10) {
      ...
      value: function _haxStoreRegisterBody(e) {
        ...
        if (e.detail) {
          ...
          this.__storeReady = setTimeout(function () {
            _this11._storePiecesAllHere(_this11.haxAutoloader, _this11.activeHaxBody, _this11.haxTray, _this11.haxCancel);
          }, 0);
        }
      }
      ...
      value: function _superDaemonInsert(e) {
      ...
      value: function _haxStoreRegisterApp(e) {
        if (e.detail) {
          ...
          this.appList = [].concat(babelHelpers.toConsumableArray(this.appList), [app]);
          this.write("appList", (0, _mobxEsm.toJS)(this.appList), this);
          // slash command context
          _superDaemon.SuperDaemonInstance.defineOption({
            title: "Search " + app.details.title,
            icon: app.details.icon,
            tags: ["Search"].concat(babelHelpers.toConsumableArray(app.details.tags)),
            more: app.details.tos && app.details.tos.length > 0 ? (0, _index.html)(_templateObject2_29469930edcb11edb3e3ed4f0d506a4b || (_templateObject2_29469930edcb11edb3e3ed4f0d506a4b = babelHelpers.taggedTemplateLiteral(["<div class=\"tos-text\">Terms of service:</div>\n                <ul class=\"tos-text\">\n                  ", "\n                </ul>"])), app.details.tos.map(function (item) {
              return (0, _index.html)(_templateObject3_29469930edcb11edb3e3ed4f0d506a4b || (_templateObject3_29469930edcb11edb3e3ed4f0d506a4b = babelHelpers.taggedTemplateLiteral(["\n                      <li>\n                        <a\n                          href=\"", "\"\n                          target=\"_blank\"\n                          rel=\"noopener nofollow noreferrer\"\n                          >", "</a\n                        >\n                      </li>\n                    "])), item.link, item.title);
            })) : null,
            value: {
              ...
              detail: app,
              program: function () {
                var _program = babelHelpers.asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10(input, values) {
                  var t1, t2, queryParam, searchDataMap, data, results;
                  return _regeneratorRuntime().wrap(function _callee10$(_context11) {
                    while (1) switch (_context11.prev = _context11.next) {
                      case 0:
                        t1 = (0, _mobxEsm.toJS)(HAXStore.activeApp);
                        t2 = (0, _mobxEsm.toJS)(HAXStore.appList[values.index]);
                        if (t1.index != t2.index) {
                          HAXStore.activeApp = (0, _mobxEsm.toJS)(HAXStore.appList[values.index]);
                        }
                        queryParam = Object.keys(values.detail.connection.operations.browse.search)[0];
                        searchDataMap = {};
                        searchDataMap[queryParam] = input;
                        HAXStore.appSearch.updateSearchValues(searchDataMap);
                        _context11.next = 9;
                        return HAXStore.appSearch.loadAppData();
                      case 9:
                        data = _context11.sent;
                        results = [];
                        _context11.next = 13;
                        return data.forEach( /*#__PURE__*/function () {
                          var _ref2 = babelHelpers.asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee9(item) {
                            var map, gizmoType, haxElements;
                            return _regeneratorRuntime().wrap(function _callee9$(_context10) {
                              while (1) switch (_context10.prev = _context10.next) {
                                case 0:
                                  map = item.map;
                                  gizmoType = item.type; // sanity check as well as guessing based on type if we absolutely have to
                                  if ((!gizmoType || gizmoType == null || gizmoType == "" || gizmoType == "undefined") && map.source) {
                                    gizmoType = HAXStore.guessGizmoType(map);
                                  }
                                  haxElements = HAXStore.guessGizmo(gizmoType, map, false, true); // see if we got anything
                                  if (haxElements.length > 0) {
      ...
      value: function () {
        var _htmlToHaxElements = babelHelpers.asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee11(html) {
          var elements, fragment, validTags, children, i;
          return _regeneratorRuntime().wrap(function _callee11$(_context12) {
            while (1) switch (_context12.prev = _context12.next) {
              case 0:
                ...
                children = fragment.children; // loop over the new nodes
                i = 0;
              case 7:
              ...
              case 14:
                ...
                break;
              case 17:
                return _context12.abrupt("return", elements);
              case 18:
              case "end":
        ...
        function htmlToHaxElements(_x14) {
      ...
      key: "nodeToContent",
      value: function () {
        var _nodeToContent = babelHelpers.asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee12(node) {
          var tag, content, props, propvals, j, l, nodeName, value, tmpProps, _j, i, delProps, delProp, _i5, voidTags, slotnodes, _j2, len2;
          return _regeneratorRuntime().wrap(function _callee12$(_context13) {
            while (1) switch (_context13.prev = _context13.next) {
              ...
              case 4:
                ...
                if (babelHelpers.typeof(tmpProps) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {
                  for (_j in tmpProps) {
                    nodeName = (0, _utils.camelToDash)(_j);
                    value = null; // prefer local value over properties object if possible
                    if (babelHelpers.typeof(node[_j]) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {
                      value = node[_j];
                    }
                    ...
                    if (!tmpProps[_j].readOnly && !tmpProps[_j].computed && value !== tmpProps[_j].value && !nodeName.startsWith("__")) {
                      ...
                      // only write things that aren't empty
                          ...
                          if (value === true || value === "true") {
                            ...
                            // or it might be a string
                                ...
                                if (value == "" && tmpProps[_j].value != "") {
                                  value = tmpProps[_j].value;
                                } else if (value === "" && tmpProps[_j].value == "") {
                ...
                for (_i5 in propvals) {
                  if (propvals[_i5] === true) {
                    content += " " + _i5;
                  } else {
                    content += " " + _i5 + '="' + propvals[_i5] + '"';
                  }
                }
                ...
                _j2 = 0, len2 = slotnodes.length;
              case 31:
                if (!(_j2 < len2)) {
                  _context13.next = 49;
                  break;
                }
                if (!(babelHelpers.typeof(slotnodes[_j2].tagName) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined)))) {
                  _context13.next = 45;
                  break;
                }
                if (!(!this.HTMLPrimativeTest(slotnodes[_j2].tagName) && slotnodes[_j2].tagName !== "TEMPLATE")) {
                  _context13.next = 40;
                  break;
                }
                _context13.t0 = content;
                _context13.next = 37;
                return this.nodeToContent(slotnodes[_j2]);
              case 37:
                content = _context13.t0 += _context13.sent;
                _context13.next = 43;
                break;
              case 40:
                slotnodes[_j2].removeAttribute("data-hax-ray");
                slotnodes[_j2].contentEditable = false;
                content += slotnodes[_j2].outerHTML;
              case 43:
                _context13.next = 46;
                break;
              case 45:
                // keep comments with a special case since they need wrapped
                if (slotnodes[_j2].nodeType === 8) {
                  content += "<!-- " + slotnodes[_j2].textContent + " -->";
                }
                // keep everything NOT an element at this point, this helps
                // preserve whitespace because we're crazy about accuracy
                else if (slotnodes[_j2].nodeType !== 1 && babelHelpers.typeof(slotnodes[_j2].textContent) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined)) && slotnodes[_j2].textContent !== "undefined") {
                    content += (0, _utils.htmlEntities)(slotnodes[_j2].textContent);
                  }
              case 46:
                _j2++;
                _context13.next = 31;
              ...
              case 49:
                ...
                _context13.t1 = content;
                _context13.next = 53;
                return this.runHook(node, "progressiveEnhancement", [node]);
              case 53:
                content = _context13.t1 += _context13.sent;
              case 54:
              ...
              case 78:
                return _context13.abrupt("return", content);
              case 79:
              case "end":
      ...
      value: function () {
        var _refreshActiveNodeForm = babelHelpers.asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee13() {
          return _regeneratorRuntime().wrap(function _callee13$(_context14) {
            while (1) switch (_context14.prev = _context14.next) {
              ...
              case 2:
                this.haxTray.activeHaxElement = _context14.sent;
                _context14.next = 5;
      ...
      key: "getHAXSlot",
      value: function () {
        var _getHAXSlot = babelHelpers.asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee14(node) {
          ...
          return _regeneratorRuntime().wrap(function _callee14$(_context15) {
            while (1) switch (_context15.prev = _context15.next) {
              case 0:
                ...
                return _context15.abrupt("return", node.innerHTML);
              case 2:
                content = "";
                slotnodes = node.childNodes; // ensure there's something inside of this
                if (!(slotnodes.length > 0)) {
      ...
      value: function () {
        var _haxStoreRegisterProperties2 = babelHelpers.asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee15(e) {
          ...
          return _regeneratorRuntime().wrap(function _callee15$(_context16) {
            while (1) switch (_context16.prev = _context16.next) {
              ...
              case 5:
                detail.properties = _context16.sent;
                ...
                if (gizmo) {
                  ...
                  if (!gizmo.meta || !gizmo.meta.inlineOnly && !gizmo.meta.hidden) {
                    _superDaemon.SuperDaemonInstance.defineOption({
                      title: gizmo.title,
                      icon: gizmo.icon,
                      key: gizmo.shortcutKey ? "".concat(this.daemonKeyCombo, " ").concat(gizmo.shortcutKey) : null,
                      tags: gizmo.tags || [],
                      value: {
                        value: gizmo.tag,
                        eventName: "insert-tag",
        ...
        function _haxStoreRegisterProperties(_x17) {
      ...
      value: function () {
        var _attemptGizmoTranslation = babelHelpers.asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee16(tag, properties) {
          var translationMap, i, sTabs, h, _i6, j, _i7, _j3;
          return _regeneratorRuntime().wrap(function _callee16$(_context17) {
            while (1) switch (_context17.prev = _context17.next) {
              ...
              case 2:
                translationMap = _context17.sent;
              ...
              case 9:
                if (translationMap) {
                  ...
                  if (properties.settings && translationMap.settings) {
                    ...
                    for (h in sTabs) {
                      if (properties.settings[h] && translationMap.settings[h]) {
                        for (_i6 in translationMap.settings[h]) {
                          for (j in translationMap.settings[h][_i6]) {
                            properties.settings[h][_i6][j] = translationMap.settings[h][_i6][j];
                          }
                        }
                      }
                    }
                  ...
                  if (properties.demoSchema && translationMap.demoSchema) {
                    for (_i7 in translationMap.demoSchema) {
                      if (translationMap.demoSchema[_i7].properties) {
                        for (_j3 in translationMap.demoSchema[_i7].properties) {
                          properties.demoSchema[_i7].properties[_j3] = translationMap.demoSchema[_i7].properties[_j3];
                        }
                      }
                    }
                  }
        ...
        function attemptGizmoTranslation(_x18, _x19) {
  ...
  var HAXStore = window.HaxStore.requestAvailability();
  ...
  window.Hax.export = /*#__PURE__*/babelHelpers.asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee17() {
