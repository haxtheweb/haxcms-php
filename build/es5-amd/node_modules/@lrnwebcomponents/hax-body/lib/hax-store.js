define(["exports", "meta", "require", "../../../lit-element/lit-element.js", "../../../@polymer/polymer/lib/utils/flattened-nodes-observer.js", "../../../@polymer/polymer/lib/utils/settings.js", "./shadows-safari.js", "./haxutils.js", "../../../@polymer/iron-ajax/iron-ajax.js", "../../simple-toast/simple-toast.js", "../../media-behaviors/media-behaviors.js", "../../hax-body-behaviors/hax-body-behaviors.js", "../../code-sample/code-sample.js"], function (_exports, meta, _require, _litElement, _flattenedNodesObserver, _settings, _shadowsSafari, _haxutils, _ironAjax, _simpleToast, _mediaBehaviors, _haxBodyBehaviors, _codeSample) {
  ...
  function _templateObject2_2d9735b00b1311eaa3b2eff4bd15c191() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: none;\n        }\n      "]);

    _templateObject2_2d9735b00b1311eaa3b2eff4bd15c191 = function _templateObject2_2d9735b00b1311eaa3b2eff4bd15c191() {
      return data;
    };
  ...
  function _templateObject_2d9735b00b1311eaa3b2eff4bd15c191() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <slot></slot>\n      <iron-ajax\n        id=\"appstore\"\n        url=\"", "\"\n        params=\"", "\"\n        method=\"GET\"\n        content-type=\"application/json\"\n        handle-as=\"json\"\n        @last-response-changed=\"", "\"\n      ></iron-ajax>\n      <hal-9000 id=\"hal\" .debug=\"", "\"></hal-9000>\n    "]);

    _templateObject_2d9735b00b1311eaa3b2eff4bd15c191 = function _templateObject_2d9735b00b1311eaa3b2eff4bd15c191() {
      return data;
    };
  ...
  function (_HAXElement) {
    ...
    babelHelpers.createClass(HaxStore, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_2d9735b00b1311eaa3b2eff4bd15c191(), this.appStore.url, this.appStore.params, this.__appStoreDataChanged, this.voiceDebug);
      }
    }, {
      ...
      value: function disconnectedCallback() {
        ...
        document.body.removeEventListener("hax-store-write", this._writeHaxStore.bind(this)); // register the autoloader area for elements

        document.body.removeEventListener("hax-register-core-piece", this._haxStorePieceRegistrationManager.bind(this)); // register a body, kind of a big deal

        document.body.removeEventListener("hax-register-body", this._haxStoreRegisterBody.bind(this)); // notice content insert and help it along to the body
      ...
      value: function updated(changedProperties) {
        ...
        changedProperties.forEach(function (oldValue, propName) {
          ...
          if (["haxAutoloader", "activeHaxBody", "haxPanel", "haxToast", "haxExport", "haxPreferences", "haxManager", "haxStaxPicker", "haxAppPicker"].includes(propName)) {
        ...
        if (storePiecesAllHere) {
          this._storePiecesAllHere(this.haxAutoloader, this.activeHaxBody, this.haxPanel, this.haxToast, this.haxExport, this.haxPreferences, this.haxManager, this.haxStaxPicker, this.haxAppPicker);
        }
      }
      /**
       * ready life cycle
      ...
      value: function _initVoiceCommands() {
        ...
        commands["".concat(this.__hal.respondsTo, " scroll up")] = function () {
          window.scrollBy({
        ...
        commands["".concat(this.__hal.respondsTo, " scroll (down)")] = function () {
          window.scrollBy({
            top: window.innerHeight * 0.5,
            left: 0,
            behavior: "smooth"
        ...
        commands["hey ".concat(this.__hal.respondsTo)] = function () {
          _this5.__hal.speak("Yeah what do you want");
        };

        commands["".concat(this.__hal.respondsTo, " find media")] = function () {
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_2d9735b00b1311eaa3b2eff4bd15c191())];
      }
    }, {
      key: "tag",
      get: function get() {
    ...
    function HaxStore() {
      ...
      window.addEventListener("hax-register-properties", _this._haxStoreRegisterProperties.bind(babelHelpers.assertThisInitialized(_this)));
      window.addEventListener("hax-consent-tap", _this._haxConsentTap.bind(babelHelpers.assertThisInitialized(_this)));
      window.addEventListener("onbeforeunload", _this._onBeforeUnload.bind(babelHelpers.assertThisInitialized(_this)));
      window.addEventListener("paste", _this._onPaste.bind(babelHelpers.assertThisInitialized(_this))); // app registration can come in automatically from app-stores
      // or through direct definition in the DOM
      ...
      document.body.addEventListener("hax-store-write", _this._writeHaxStore.bind(babelHelpers.assertThisInitialized(_this))); // register pieces of the system

      document.body.addEventListener("hax-register-core-piece", _this._haxStorePieceRegistrationManager.bind(babelHelpers.assertThisInitialized(_this))); // register a body, kind of a big deal

      document.body.addEventListener("hax-register-body", _this._haxStoreRegisterBody.bind(babelHelpers.assertThisInitialized(_this))); // grid plate add item event
  ...
  window.HaxStore.nodeToContent = function (node) {
    ...
    if (babelHelpers.typeof(props) === (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined)) || !props.saveOptions.wipeSlot) {
      ...
      var slotnodes = _flattenedNodesObserver.FlattenedNodesObserver.getFlattenedNodes(node); // ensure there's something inside of this
  ...
  window.HaxStore.getHAXSlot = function (node) {
    ...
    var content = "";
    var slotnodes = node.children; // ensure there's something inside of this
