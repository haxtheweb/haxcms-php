define(["exports", "meta", "require", "../../../lit-element/lit-element.js", "../../simple-popover/lib/simple-tour.js", "../../utils/utils.js", "../../../mobx/dist/mobx.esm.js", "../../hax-body-behaviors/hax-body-behaviors.js"], function (_exports, meta, _require, _litElement, _simpleTour, _utils, _mobxEsm, _haxBodyBehaviors) {
  ...
  function _templateObject_16ccaff014a311eb85a39505bc445fc0() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <slot></slot>\n      <iron-ajax\n        id=\"appstore\"\n        url=\"", "\"\n        .params=\"", "\"\n        method=\"GET\"\n        content-type=\"application/json\"\n        handle-as=\"json\"\n        @last-response-changed=\"", "\"\n      ></iron-ajax>\n      <hal-9000\n        id=\"hal\"\n        .responds-to=\"", "\"\n        .debug=\"", "\"\n      ></hal-9000>\n    "]);

    _templateObject_16ccaff014a311eb85a39505bc445fc0 = function _templateObject_16ccaff014a311eb85a39505bc445fc0() {
      return data;
    };
  ...
  var HaxStore = /*#__PURE__*/function (_winEventsElement) {
    ...
    babelHelpers.createClass(HaxStore, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_16ccaff014a311eb85a39505bc445fc0(), this.appStore.url, this.appStore.params, this.__appStoreDataChanged, this.voiceRespondsTo, this.voiceDebug);
      }
    }, {
      ...
      value: function _loadAppStoreData(ready, appDataResponse, haxAutoloader) {
        ...
        if (ready && babelHelpers.typeof(appDataResponse) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined)) && appDataResponse != null) {
          ...
          if ("requestIdleCallback" in window) {
            ...
            requestIdleCallback(this._handleDynamicImports(items, haxAutoloader).bind(this), {
              timeout: 200
            });
          } else {
            setTimeout(function () {
              _this2._handleDynamicImports(items, haxAutoloader);
            }, 200);
          }
        }
      ...
      value: function updated(changedProperties) {
        ...
        changedProperties.forEach(function (oldValue, propName) {
          if (propName == "openDrawer") {
            _this5.openDrawersCallback(_this5[propName], oldValue);
          }
          ...
          if (["haxAutoloader", "activeHaxBody", "haxTray"].includes(propName)) {
            ...
            _this5._storePiecesAllHere(_this5.haxAutoloader, _this5.activeHaxBody, _this5.haxTray);
          }
        });
      ...
      value: function firstUpdated(changedProperties) {
        ...
        new Promise(function (res, rej) {
          ...
          if (_this6.shadowRoot.querySelector("#appstore")) {
            _this6.shadowRoot.querySelector("#appstore").generateRequest();
          }
      ...
      value: function _storePiecesAllHere(haxAutoloader, activeHaxBody, haxTray) {
      ...
      value: function _initVoiceCommands() {
        ...
        this.voiceCommands["".concat(this.voiceRespondsTo, " close")] = function () {
          _this7.write("openDrawer", false, _this7);
        };
      }
      /**
    ...
    babelHelpers.createClass(HaxStore, [{
      ...
      value: function openDrawersCallback() {
        ...
        var drawers = ["haxAppPicker", "haxExport"];
