define(["meta","require","../../../@polymer/polymer/polymer-legacy.js","../../../@polymer/polymer/lib/legacy/polymer.dom.js","../../../@polymer/polymer/lib/utils/resolve-url.js","../../../@polymer/polymer/lib/utils/settings.js","./shadows-safari.js","../../../@polymer/polymer/lib/utils/render-status.js","./haxutils.js","../../../@polymer/iron-ajax/iron-ajax.js","../../simple-toast/simple-toast.js","../../media-behaviors/media-behaviors.js","../../hax-body-behaviors/hax-body-behaviors.js","../../hal-9000/hal-9000.js","../../code-sample/code-sample.js","./hax-app.js","./hax-stax.js","./hax-stax-browser.js","./hax-blox.js","./hax-blox-browser.js"],function(meta,_require,_polymerLegacy,_polymerDom,_resolveUrl,_settings,_shadowsSafari,_renderStatus,_haxutils,_ironAjax,_simpleToast,_mediaBehaviors,_haxBodyBehaviors,_hal,_codeSample,_haxApp,_haxStax,_haxStaxBrowser,_haxBlox,_haxBloxBrowser){"use strict";meta=babelHelpers.interopRequireWildcard(meta);_require=babelHelpers.interopRequireWildcard(_require);function _templateObject_26b0bfd0685411e9b25d1735312af746(){var data=babelHelpers.taggedTemplateLiteral(["\n    <style>\n      :host {\n        display: none;\n      }\n    </style>\n    <slot></slot>\n    <iron-ajax\n      id=\"appstore\"\n      url=\"[[appStore.url]]\"\n      params=\"[[appStore.params]]\"\n      method=\"GET\"\n      content-type=\"application/json\"\n      handle-as=\"json\"\n      last-response=\"{{__appStoreData}}\"\n    ></iron-ajax>\n    <hal-9000 id=\"hal\" debug=\"debug\" commands=\"[[voiceCommands]]\"></hal-9000>\n  "]);_templateObject_26b0bfd0685411e9b25d1735312af746=function _templateObject_26b0bfd0685411e9b25d1735312af746(){return data};return data}/**
 ...
 */window.HaxStore=window.HaxStore||{};window.HaxStore.instance=null;window.HaxStore.requestAvailability=function(){if(!window.HaxStore.instance){window.HaxStore.instance=document.createElement("hax-store");document.body.appendChild(window.HaxStore.instance)}return window.HaxStore.instance};(0,_polymerLegacy.Polymer)({_template:(0,_polymerLegacy.html)(_templateObject_26b0bfd0685411e9b25d1735312af746()),is:"hax-store",behaviors:[MediaBehaviors.Video,HAXBehaviors.PropertiesBehaviors],observers:["_loadAppStoreData(__ready, __appStoreData, haxAutoloader)","_storePiecesAllHere(haxAutoloader,activeHaxBody, haxPanel, haxToast, haxExport, haxPreferences, haxManager, haxStaxPicker, haxAppPicker)"],properties:{/**
     * skipHAXConfirmation
     */skipHAXConfirmation:{type:Boolean,value:!1,reflectToAttribute:!0/* transition */ /* transition */},/**
...
if("function"===typeof test.reload){return!0}return!1}},/**
     ...
     */connectionRewrites:{type:Object,value:{}}},/**
   * Local storage data changed; callback to store this data in user storage
   */_storageDataChanged:function _storageDataChanged(newValue){if(newValue&&window.HaxStore.ready&&this.__storageDataProcessed){if(window.localStorage.getItem("haxConfirm")){window.localStorage.setItem("haxUserData",JSON.stringify(newValue))}else if(window.sessionStorage.getItem("haxConfirm")){window.sessionStorage.setItem("haxUserData",JSON.stringify(newValue))}}},/**
   * If this is a text node or not so we know if the inline context
   * operations are valid.
   */isTextElement:function isTextElement(node){if(null!=node&&this.validTagList.includes(node.tagName.toLowerCase())){if(["p","ol","ul","li","a","h1","h2","h3","h4","h5","h6","span","i","bold","em","strong","blockquote","code","figure"].includes(node.tagName.toLowerCase())){return!0}}return!1},/**
   * test for being a valid grid plate, li is here because
   * nested lists make this really complicated
   */isGridPlateElement:function isGridPlateElement(node){var tag=node.tagName.toLowerCase();if(this.validTagList.includes(tag)){if(["p","ol","ul","li","div","h1","h2","h3","h4","h5","h6","blockquote","code","figure","grid-plate"].includes(tag)){return!0}}return!1},/**
   * Notice _appStore changed.
   */_appStoreChanged:function _appStoreChanged(newValue,oldValue){var _this=this;// if we have an endpoint defined, pull it
...
if(babelHelpers.typeof(newValue.apps)===("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){this.$.appstore.generateRequest()}else{// directly injected json object into the DOM, allow some time to propagate data
// otherwise we might not have a haxAutoloader object ready in time for the paint
setTimeout(function(){_this.__appStoreData=newValue},500)}}},/**
   * Load and attach items from the app store.
   */_loadAppStoreData:function _loadAppStoreData(ready,appDataResponse,haxAutoloader){if(babelHelpers.typeof(appDataResponse)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))&&null!=appDataResponse){var items={};// autoload elements
...
if(babelHelpers.typeof(appDataResponse.blox)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){for(var bloxs=appDataResponse.blox,i=0,blox;i<bloxs.length;i++){blox=document.createElement("hax-blox");blox.data=bloxs[i];window.HaxStore.instance.appendChild(blox)}}var evt=new CustomEvent("hax-store-app-store-loaded",{bubbles:!0,cancelable:!0,composed:!0,detail:!0});this.dispatchEvent(evt);// now process the dynamic imports
...
(0,_polymerDom.dom)(haxAutoloader).appendChild(document.createElement(i))}}}).catch(function(error){/* Error handling */console.log(error)});case 6:_context.next=2;break;case 8:case"end":return _context.stop();}}},_callee,this)}));return function _handleDynamicImports(_x,_x2){return _handleDynamicImports2.apply(this,arguments)}}(),_editModeChanged:function _editModeChanged(newValue){if(newValue&&this.globalPreferences.haxVoiceCommands){this.$.hal.auto=!0}else{this.$.hal.auto=!1}},_globalPreferencesChanged:function _globalPreferencesChanged(newValue,oldValue){// regardless of what it is, reflect it globally but only after setup
if(this.__storageDataProcessed&&newValue&&babelHelpers.typeof(newValue.haxVoiceCommands)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))&&window.HaxStore.ready){var storageData=this.storageData;storageData.globalPreferences=newValue;this.set("storageData",{});this.set("storageData",storageData);if(newValue.haxVoiceCommands&&this.editMode){this.$.hal.auto=!0}else{this.$.hal.auto=!1}}},/**
   * Detached life cycle
   */detached:function detached(){// notice hax property definitions coming from anywhere
...
window.removeEventListener("onbeforeunload",this._onBeforeUnload.bind(this));window.removeEventListener("hax-consent-tap",this._haxConsentTap.bind(this));window.removeEventListener("paste",this._onPaste.bind(this));// fire that hax store is ready to go so now we can setup the rest
this.dispatchEvent(new CustomEvent("hax-store-ready",{bubbles:!0,cancelable:!1,composed:!0,detail:!1}));window.HaxStore.ready=!1},/**
   * This only fires if they consented to storage of data locally
   */_haxConsentTap:function _haxConsentTap(e){// store for future local storage usage
...
window.localStorage.setItem("haxUserData",JSON.stringify(this.storageData))},/**
   * ready life cycle
   */ready:function ready(){(0,_renderStatus.afterNextRender)(this,function(){// see if a global was used to prevent this check
...
if(!window.HaxStore.instance.skipExitTrap&&window.HaxStore.instance.editMode){return"Are you sure you want to leave? Your work will not be saved!"}},/**
   ...
   */_onPaste:function _onPaste(e){// only perform this on a text element that is active
...
var sel=window.HaxStore.getSelection(),range;if(range=window.HaxStore.getRange()){range.deleteContents();range.insertNode(document.createTextNode(text))}}},/**
   ...
   */created:function created(){(0,_settings.setPassiveTouchGestures)(!0);// claim the instance spot. This way we can easily
...
document.body.addEventListener("hax-insert-content",this._haxStoreInsertContent.bind(this));document.body.addEventListener("hax-insert-content-array",this._haxStoreInsertMultiple.bind(this));window.addEventListener("hax-add-voice-command",this._addVoiceCommand.bind(this));document.body.style.setProperty("--hax-ui-headings","#d4ff77")},/**
   ...
   */_buildPrimitiveDefinitions:function _buildPrimitiveDefinitions(){// sandboxes need a webview definition
...
if(window.HaxStore.instance._isSandboxed){var webview={canScale:!0,canPosition:!0,canEditSource:!1,settings:{quick:[{attribute:"src",title:"Source",description:"The URL for this video.",inputMethod:"textfield",icon:"link",required:!0,validationType:"url"}],configure:[{attribute:"src",title:"Source",description:"The URL for this video.",inputMethod:"textfield",icon:"link",required:!0,validationType:"url"}],advanced:[]}};this.setHaxProperties(webview,"webview")}var iframe={canScale:!0,canPosition:!0,canEditSource:!0,gizmo:{title:"Basic iframe",description:"A basic iframe",icon:"icons:fullscreen",color:"grey",groups:["Content"],handles:[{type:"link",source:"src",height:"height",width:"width"}],meta:{author:"W3C"}},settings:{quick:[{attribute:"src",title:"Source",description:"The URL for this video.",inputMethod:"textfield",icon:"link",required:!0,validationType:"url"}],configure:[{attribute:"src",title:"Source",description:"The URL for this video.",inputMethod:"textfield",icon:"link",required:!0,validationType:"url"}],advanced:[]}};this.setHaxProperties(iframe,"iframe");var img={canScale:!0,canPosition:!0,canEditSource:!1,gizmo:{title:"Image",description:"A basic img tag",icon:"image:image",color:"grey",groups:["Image","Media"],handles:[{type:"link",source:"src"},{type:"image",source:"src",height:"height",width:"width"}],meta:{author:"W3C"}},settings:{quick:[{attribute:"src",title:"Source",description:"The URL for this video.",inputMethod:"textfield",icon:"link",required:!0,validationType:"url"},{attribute:"alt",title:"Alt text",description:"Useful for screen readers and improved SEO.",inputMethod:"alt",icon:"accessibility"},{attribute:"height",title:"Height",description:"height in pixels of the item",inputMethod:"textfield",icon:"icons:swap-vert"},{attribute:"width",title:"Width",description:"width in pixels of the item",inputMethod:"textfield",icon:"icons:swap-horiz"}],configure:[{attribute:"src",title:"Source",description:"The URL for this video.",inputMethod:"haxupload",icon:"link",required:!0,validationType:"url"},{attribute:"alt",title:"Alt text",description:"Useful for screen readers and improved SEO.",inputMethod:"alt",icon:"accessibility"},{attribute:"height",title:"Height",description:"height in pixels of the item",inputMethod:"textfield",icon:"icons:swap-vert"},{attribute:"width",title:"Width",description:"width in pixels of the item",inputMethod:"textfield",icon:"icons:swap-horiz"}],advanced:[]}};this.setHaxProperties(img,"img");var ahref={canScale:!1,canPosition:!1,canEditSource:!0,gizmo:{title:"Basic link",description:"A basic a tag",icon:"icons:link",color:"grey",groups:["Link"],handles:[{type:"link",source:"href",title:"innerText",alt:"title"}],meta:{author:"W3C"}},settings:{quick:[{attribute:"href",title:"Link",description:"The URL for this video.",inputMethod:"textfield",icon:"icons:link",required:!0,validationType:"url"},{attribute:"title",title:"Title text",description:"Useful for screen readers and improved SEO.",inputMethod:"textfield",icon:"icons:accessibility"}],configure:[{attribute:"innerText",title:"Text",description:"Text of the link",inputMethod:"textfield",required:!0},{attribute:"href",title:"Link",description:"The URL for this video.",inputMethod:"haxupload",icon:"icons:link",required:!0,validationType:"url"},{attribute:"title",title:"Title text",description:"Useful for screen readers and improved SEO.",inputMethod:"textfield",icon:"icons:accessibility"},{attribute:"target",title:"Target",description:"Where to place the link.",inputMethod:"select",icon:"icons:launch",options:{"":"Same window",_blank:"New window",_top:"Top window",_parent:"Parent window"}}],advanced:[]}};this.setHaxProperties(ahref,"a");var p={canScale:!1,canPosition:!1,canEditSource:!0,settings:{quick:[],configure:[],advanced:[]}};this.setHaxProperties(p,"p");var hr={canScale:!0,canPosition:!0,canEditSource:!1,settings:{quick:[],configure:[],advanced:[]}};this.setHaxProperties(hr,"hr");this.setHaxProperties(_codeSample.CodeSample.haxProperties,_codeSample.CodeSample.tag)},/**
   ...
   */_haxStoreRegisterManager:function _haxStoreRegisterManager(e){if(e.detail&&babelHelpers.typeof(this.haxManager)===("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){this.haxManager=e.detail}},/**
   * Register autoloader so we can ship to it from app-store spec
   */_haxStoreRegisterAutoloader:function _haxStoreRegisterAutoloader(e){if(e.detail&&babelHelpers.typeof(this.haxAutoloader)===("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){this.haxAutoloader=e.detail}},/**
   ...
   */_haxStoreRegisterAppPicker:function _haxStoreRegisterAppPicker(e){if(e.detail&&babelHelpers.typeof(this.haxAppPicker)===("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){this.haxAppPicker=e.detail}},/**
   * Set the stax picker so that we have an element in charge
   * of the listing of available stax.
   */_haxStoreRegisterStaxPicker:function _haxStoreRegisterStaxPicker(e){if(e.detail&&babelHelpers.typeof(this.haxStaxPicker)===("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){this.haxStaxPicker=e.detail}},/**
   * Set the blox picker so that we have an element in charge
   * of the listing of available blox.
   */_haxStoreRegisterBloxPicker:function _haxStoreRegisterBloxPicker(e){if(e.detail&&babelHelpers.typeof(this.haxBloxPicker)===("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){this.haxBloxPicker=e.detail}},/**
   * Close all drawers
   */closeAllDrawers:function closeAllDrawers(){var active=0<arguments.length&&arguments[0]!==void 0?arguments[0]:!1,drawers=["haxManager","haxBloxPicker","haxStaxPicker","haxPreferences","haxExport"];for(var i in drawers){if(active===this[drawers[i]]){active.open();if("haxManager"===drawers[i]){setTimeout(function(){if(null!=active.querySelector("#activepage .iron-selected paper-input")){active.querySelector("#activepage .iron-selected paper-input").focus()}},325)}else{setTimeout(function(){if(null!=active.querySelector("paper-checkbox,paper-input,textarea,paper-button")){active.querySelector("paper-checkbox,paper-input,textarea,paper-button").focus()}},325)}}else{this[drawers[i]].close()}}},/**
   * Insert content in the body.
   */_haxStoreInsertContent:function _haxStoreInsertContent(e){if(e.detail){var properties={};// support for properties to be set automatically optionally
...
this.activePlaceHolder=null}else{this.activeHaxBody.haxInsert(e.detail.tag,e.detail.content,properties)}}},/**
   ...
   */_haxStoreInsertMultiple:function _haxStoreInsertMultiple(e){var _this5=this;if(e.detail){var properties;for(var i in e.detail){properties={};// support for properties to be set automatically optionally
if(babelHelpers.typeof(e.detail[i].properties)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){properties=e.detail[i].properties}this.activeHaxBody.haxInsert(e.detail[i].tag,e.detail[i].content,properties,!1)}setTimeout(function(){_this5.activeHaxBody.breakUpdateLock()},300)}},/**
   * Set the activeHaxBody and add to the list so we know what to insert into.
   */_haxStoreRegisterBody:function _haxStoreRegisterBody(e){if(e.detail){this.haxBodies.push(e.detail);// default active the whatever is last here
...
window.HaxStore.write("activeHaxBody",this.activeHaxBody,this);window.HaxStore.write("editMode",this.editMode,this)}},/**
   ...
   */_haxStoreRegisterPanel:function _haxStoreRegisterPanel(e){if(e.detail&&babelHelpers.typeof(this.haxPanel)===("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){this.haxPanel=e.detail}},/**
   * Set the haxExport so we know who to call for exporting
   */_haxStoreRegisterExport:function _haxStoreRegisterExport(e){if(e.detail&&babelHelpers.typeof(this.haxExport)===("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){this.haxExport=e.detail}},/**
   * Set the haxPreferences so we know what has global preferences
   */_haxStoreRegisterPreferences:function _haxStoreRegisterPreferences(e){if(e.detail&&babelHelpers.typeof(this.haxPreferences)===("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){this.haxPreferences=e.detail}},/**
   ...
   */_writeHaxStore:function _writeHaxStore(e){// ensure we have a valid store write
if(e.detail&&babelHelpers.typeof(e.detail.value)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))&&e.detail.property&&e.detail.owner){if("object"===babelHelpers.typeof(e.detail.value)){this.set(e.detail.property,{})}this.set(e.detail.property,e.detail.value);this.dispatchEvent(new CustomEvent("hax-store-property-updated",{bubbles:!0,composed:!0,cancelable:!1,detail:{property:e.detail.property,value:e.detail.value,owner:e.detail.owner}}))}},/**
   ...
   */_haxStoreRegisterApp:function _haxStoreRegisterApp(e){if(e.detail){e.detail.index=this.appList.length;this.push("appList",e.detail);window.HaxStore.write("appList",this.appList,this);// we don't care about this after it's launched
if(babelHelpers.typeof(e.target.parentElement)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))&&"HAX-STORE"===e.target.parentElement.tagName){(0,_polymerDom.dom)(e.target.parentElement).removeChild(e.target)}}},/**
   ...
   */_haxStoreRegisterStax:function _haxStoreRegisterStax(e){if(e.detail){e.detail.index=this.staxList.length;this.push("staxList",e.detail);window.HaxStore.write("staxList",this.staxList,this);// we don't care about this after it's launched
if(babelHelpers.typeof(e.target.parentElement)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))&&"HAX-STORE"===e.target.parentElement.tagName){(0,_polymerDom.dom)(e.target.parentElement).removeChild(e.target)}}},/**
   * Notice that a blox was set in HAX; register it
   */_haxStoreRegisterBlox:function _haxStoreRegisterBlox(e){if(e.detail){e.detail.index=this.bloxList.length;this.push("bloxList",e.detail);window.HaxStore.write("bloxList",this.bloxList,this);// we don't care about this after it's launched
if(babelHelpers.typeof(e.target.parentElement)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))&&"HAX-STORE"===e.target.parentElement.tagName){(0,_polymerDom.dom)(e.target.parentElement).removeChild(e.target)}}},/**
   * Notice that a property off an element was set in HAX some place; register it here
   */_haxStoreRegisterProperties:function _haxStoreRegisterProperties(e){if(e.detail&&e.detail.properties&&e.detail.tag){// only register tag if we don't know about it already
...
if(babelHelpers.typeof(e.target.parentElement)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))&&"HAX-AUTOLOADER"===e.target.parentElement.tagName){(0,_polymerDom.dom)(this.haxAutoloader).removeChild(e.target)}}}});/**
...
if(babelHelpers.typeof(node.attributes.id)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){props.id=node.getAttribute("id")}var tmpProps=node.properties;if(babelHelpers.typeof(tmpProps)===("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){tmpProps=node.__data}// complex elements need complex support
...
if(babelHelpers.typeof(node.properties)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){for(var j in node.properties){var nodeName=window.HaxStore.camelToDash(j),value=null;// prefer local value over properties object if possible
...
if(!node.properties[j].readOnly&&value!==node.properties[j].value){// encode objects and arrays because they are special
...
if("string"===typeof value&&""!==value){value=value.replace(/"/g,"&quot;");propvals[nodeName]=value}// special handling for empty string cause it might mean boolean
// or it might be a string
else if(""===value){if(""==value&&""!=node.properties[j].value){value=node.properties[j].value}else if(""===value&&""==node.properties[j].value){// do nothing, the default value is empty
 ...
 */window.HaxStore.getRange=function(){var sel=window.HaxStore.getSelection();if(sel.getRangeAt&&sel.rangeCount){return sel.getRangeAt(0)}else if(sel){return sel}else!1}});