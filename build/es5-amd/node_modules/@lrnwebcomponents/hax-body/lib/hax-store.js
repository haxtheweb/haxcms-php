define(["exports", "meta", "require", "../../../@polymer/polymer/polymer-element.js", "../../../@polymer/polymer/lib/utils/render-status.js", "../../../@polymer/polymer/lib/legacy/polymer.dom.js", "../../../@polymer/polymer/lib/utils/resolve-url.js", "../../../@polymer/polymer/lib/utils/settings.js", "./shadows-safari.js", "./haxutils.js", "../../../@polymer/iron-ajax/iron-ajax.js", "../../simple-toast/simple-toast.js", "../../media-behaviors/media-behaviors.js", "../../hax-body-behaviors/hax-body-behaviors.js", "../../code-sample/code-sample.js"], function (_exports, meta, _require, _polymerElement, _renderStatus, _polymerDom, _resolveUrl, _settings, _shadowsSafari, _haxutils, _ironAjax, _simpleToast, _mediaBehaviors, _haxBodyBehaviors, _codeSample) {
  ...
  function _templateObject_5d5cc3a0b53711e9aa40b7626f5cd426() {
    ...
    _templateObject_5d5cc3a0b53711e9aa40b7626f5cd426 = function _templateObject_5d5cc3a0b53711e9aa40b7626f5cd426() {
      return data;
    };
  ...
  function (_HAXElement) {
    ...
    babelHelpers.createClass(HaxStore, [{
      ...
      value: function connectedCallback() {
        ...
        (0, _renderStatus.afterNextRender)(this, function () {
          ...
          new Promise(function (res, rej) {
            return _require.default(["@lrnwebcomponents/hal-9000/hal-9000.js"], res, rej);
      ...
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_5d5cc3a0b53711e9aa40b7626f5cd426());
      }
    }, {
      key: "tag",
      get: function get() {
    ...
    function HaxStore() {
      ...
      new Promise(function (res, rej) {
        return _require.default(["@lrnwebcomponents/hax-body/lib/hax-stax.js"], res, rej);
      });
      new Promise(function (res, rej) {
        return _require.default(["@lrnwebcomponents/hax-body/lib/hax-blox.js"], res, rej);
      });
      new Promise(function (res, rej) {
        return _require.default(["@lrnwebcomponents/hax-body/lib/hax-stax-browser.js"], res, rej);
      });
      new Promise(function (res, rej) {
        return _require.default(["@lrnwebcomponents/hax-body/lib/hax-blox-browser.js"], res, rej);
