define(["exports", "../../../lit-element/lit-element.js", "../../simple-colors/simple-colors.js", "../../../@polymer/paper-button/paper-button.js", "../../simple-tooltip/simple-tooltip.js"], function (_exports, _litElement, _simpleColors, _paperButton, _simpleTooltip) {
  ...
  function _templateObject7_be39f110865211eaac6dab845b52217a() {
    ...
    _templateObject7_be39f110865211eaac6dab845b52217a = function _templateObject7_be39f110865211eaac6dab845b52217a() {
      return data;
    };
  ...
  function _templateObject6_be39f110865211eaac6dab845b52217a() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            <simple-tooltip>", "</simple-tooltip>\n          "]);

    _templateObject6_be39f110865211eaac6dab845b52217a = function _templateObject6_be39f110865211eaac6dab845b52217a() {
      return data;
    };
  ...
  function _templateObject5_be39f110865211eaac6dab845b52217a() {
    var data = babelHelpers.taggedTemplateLiteral(["\n              <div class=\"item-label\">", "</div>\n            "]);

    _templateObject5_be39f110865211eaac6dab845b52217a = function _templateObject5_be39f110865211eaac6dab845b52217a() {
      return data;
    };
  ...
  function _templateObject4_be39f110865211eaac6dab845b52217a() {
    var data = babelHelpers.taggedTemplateLiteral([""]);

    _templateObject4_be39f110865211eaac6dab845b52217a = function _templateObject4_be39f110865211eaac6dab845b52217a() {
      return data;
    };
  ...
  function _templateObject3_be39f110865211eaac6dab845b52217a() {
    var data = babelHelpers.taggedTemplateLiteral([""]);

    _templateObject3_be39f110865211eaac6dab845b52217a = function _templateObject3_be39f110865211eaac6dab845b52217a() {
      return data;
    };
  ...
  function _templateObject2_be39f110865211eaac6dab845b52217a() {
    var data = babelHelpers.taggedTemplateLiteral(["\n              <div class=\"button-inner\">\n                <iron-icon icon=\"", "\"></iron-icon>\n              </div>\n            "]);

    _templateObject2_be39f110865211eaac6dab845b52217a = function _templateObject2_be39f110865211eaac6dab845b52217a() {
      return data;
    };
  ...
  function _templateObject_be39f110865211eaac6dab845b52217a() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <paper-button title=\"", "\" @click=\"", "\">\n        ", "\n        ", "\n      </paper-button>\n      ", "\n    "]);

    _templateObject_be39f110865211eaac6dab845b52217a = function _templateObject_be39f110865211eaac6dab845b52217a() {
      return data;
    };
  ...
  function (_SimpleColors) {
    ...
    babelHelpers.createClass(HAXTrayButton, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_be39f110865211eaac6dab845b52217a(), this.label, this._fireEvent, this.icon ? (0, _litElement.html)(_templateObject2_be39f110865211eaac6dab845b52217a(), this.icon) : (0, _litElement.html)(_templateObject3_be39f110865211eaac6dab845b52217a()), this.mini ? (0, _litElement.html)(_templateObject4_be39f110865211eaac6dab845b52217a()) : (0, _litElement.html)(_templateObject5_be39f110865211eaac6dab845b52217a(), this.label), this.mini ? (0, _litElement.html)(_templateObject6_be39f110865211eaac6dab845b52217a(), this.label) : "");
      }
    }, {
      key: "_focusIn",
      ...
      key: "styles",
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(HAXTrayButton), "styles", this)), [(0, _litElement.css)(_templateObject7_be39f110865211eaac6dab845b52217a())]);
      }
    }]);
