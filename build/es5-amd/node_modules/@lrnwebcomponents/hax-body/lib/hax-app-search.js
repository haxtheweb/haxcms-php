define(["exports", "require", "../../../lit-element/lit-element.js", "../../simple-colors/simple-colors.js", "../../../@polymer/iron-ajax/iron-ajax.js", "../../utils/utils.js"], function (_exports, _require, _litElement, _simpleColors, _ironAjax, _utils) {
  ...
  function _templateObject5_7fcad240bff611eaa5854beb4e0c914c() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            <hax-app-search-result\n              image=\"", "\"\n              title=\"", "\"\n              details=\"", "\"\n              .map=\"", "\"\n              type=\"", "\"\n            ></hax-app-search-result>\n          "]);

    _templateObject5_7fcad240bff611eaa5854beb4e0c914c = function _templateObject5_7fcad240bff611eaa5854beb4e0c914c() {
      return data;
    };
  ...
  function _templateObject4_7fcad240bff611eaa5854beb4e0c914c() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                  <li>\n                    <a\n                      href=\"", "\"\n                      target=\"_blank\"\n                      rel=\"noopener nofollow noreferrer\"\n                      >", "</a\n                    >\n                  </li>\n                "]);

    _templateObject4_7fcad240bff611eaa5854beb4e0c914c = function _templateObject4_7fcad240bff611eaa5854beb4e0c914c() {
      return data;
    };
  ...
  function _templateObject3_7fcad240bff611eaa5854beb4e0c914c() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            <div class=\"tos-text\">Terms of service:</div>\n            <ul class=\"tos-text\">\n              ", "\n            </ul>\n          "]);

    _templateObject3_7fcad240bff611eaa5854beb4e0c914c = function _templateObject3_7fcad240bff611eaa5854beb4e0c914c() {
      return data;
    };
  ...
  function _templateObject2_7fcad240bff611eaa5854beb4e0c914c() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <iron-ajax\n        id=\"request\"\n        handle-as=\"json\"\n        @last-response-changed=\"", "\"\n        @loading-changed=\"", "\"\n        debounce-duration=\"200\"\n      ></iron-ajax>\n      ", "\n      <hax-app-search-inputs\n        id=\"searchinput\"\n        .label=\"", "\"\n        .schema=\"", "\"\n        @search-values-changed=\"", "\"\n      ></hax-app-search-inputs>\n      <hax-app-pagination\n        id=\"pagerbottom\"\n        .request-data=\"", "\"\n        .pagination=\"", "\"\n      ></hax-app-pagination>\n      <hexagon-loader\n        size=\"medium\"\n        item-count=\"4\"\n        ?loading=\"", "\"\n        aria-roledescription=\"Loading\"\n      ></hexagon-loader>\n      <div id=\"itemlist\">\n        ", "\n      </div>\n    "]);

    _templateObject2_7fcad240bff611eaa5854beb4e0c914c = function _templateObject2_7fcad240bff611eaa5854beb4e0c914c() {
      return data;
    };
  ...
  function _templateObject_7fcad240bff611eaa5854beb4e0c914c() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n        hexagon-loader {\n          display: none;\n          justify-content: center;\n          width: 100%;\n          z-index: 1000;\n          position: absolute;\n          --hexagon-color: var(--hax-color-bg-accent, #0085ba);\n        }\n        hexagon-loader[loading] {\n          display: block;\n          opacity: 0.8;\n        }\n        .card-content {\n          padding: 16px;\n        }\n        .card-content p {\n          padding: 0;\n          margin: 0;\n        }\n        #itemlist {\n          min-height: 172px;\n          border: 1px solid #222222;\n        }\n        hax-app-search-inputs {\n          min-height: 80px;\n          padding: 0 16px;\n        }\n        hax-app-pagination {\n          min-height: 32px;\n          font-size: 12.8px;\n          display: none;\n          justify-content: flex-end;\n          justify-content: center;\n        }\n        .tos-text {\n          font-size: 12px;\n        }\n        .tos-text ul {\n          padding: 4px;\n          margin: 0 16px;\n        }\n        }\n        .tos-text a {\n          font-size: 12px;\n          color: blue;\n          text-decoration: underline;\n        }\n        .tos-text a:hover,\n        .tos-text a:focus,\n        .tos-text a:active {\n          outline: 2px solid blue;\n        }\n      "]);

    _templateObject_7fcad240bff611eaa5854beb4e0c914c = function _templateObject_7fcad240bff611eaa5854beb4e0c914c() {
      return data;
    };
  ...
  function (_winEventsElement) {
    ...
    babelHelpers.createClass(HaxAppSearch, null, [{
       ...
       */
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(HaxAppSearch), "styles", this)), [(0, _litElement.css)(_templateObject_7fcad240bff611eaa5854beb4e0c914c())]);
      }
    }]);
    ...
    babelHelpers.createClass(HaxAppSearch, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_7fcad240bff611eaa5854beb4e0c914c(), this.requestDataChanged, this._loadingChanged, this.tos.length > 0 ? (0, _litElement.html)(_templateObject3_7fcad240bff611eaa5854beb4e0c914c(), this.tos.map(function (item) {
          return (0, _litElement.html)(_templateObject4_7fcad240bff611eaa5854beb4e0c914c(), item.link, item.title);
          ...
          return (0, _litElement.html)(_templateObject5_7fcad240bff611eaa5854beb4e0c914c(), resultData.image, resultData.title, resultData.details, resultData.map, resultData.type);
        }));
      }
    }, {
