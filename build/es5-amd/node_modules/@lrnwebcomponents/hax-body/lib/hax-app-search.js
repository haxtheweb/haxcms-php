define(["exports", "../../../lit/index.js", "./hax-store.js", "../../../mobx/dist/mobx.esm.js", "../../utils/utils.js"], function (_exports, _index, _haxStore, _mobxEsm, _utils) {
  "use strict";
  ...
  var _templateObject_439203d0deab11edbfe72fb80ddf5a61;
  ...
  var HaxAppSearch = /*#__PURE__*/function (_LitElement) {
    ...
    function HaxAppSearch() {
      ...
      _haxStore.HAXStore.appSearch = babelHelpers.assertThisInitialized(_this);
      return _this;
    }
    /**
    ...
    babelHelpers.createClass(HaxAppSearch, [{
            ...
            while (1) switch (_context.prev = _context.next) {
              case 0:
                ...
                return fetch(url, {
                  ...
                  return _this2._requestDataChanged(json);
                });
              case 4:
      ...
      key: "updateSearchValues",
      value: function updateSearchValues(values) {
       ...
       */
      function get() {
        return [(0, _index.css)(_templateObject_439203d0deab11edbfe72fb80ddf5a61 || (_templateObject_439203d0deab11edbfe72fb80ddf5a61 = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: none;\n        }\n      "])))];
      }
    }, {
      key: "tag",
      get: function get() {
