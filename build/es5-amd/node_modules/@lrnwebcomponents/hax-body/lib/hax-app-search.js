...
*/(0,_polymerLegacy.Polymer)({_template:(0,_polymerLegacy.html)(_templateObject_fc84cce06a8f11e9a3fbc91c56f16a14()),is:"hax-app-search",properties:{/**
   ...
   */_searchValuesEvent:function _searchValuesEvent(e){if(babelHelpers.typeof(e.detail)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){var requestParams=this.requestParams;for(var property in e.detail){requestParams[property]=e.detail[property]}this.set("requestParams",{});this.set("requestParams",requestParams)}},/**
   * Active app has changed.
   */_resetAppSearch:function _resetAppSearch(newValue,oldValue){if(babelHelpers.typeof(newValue)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))&&null!==newValue){var app=newValue,requestParams={};this.label=app.details.title;// disasble auto for a moment while we switch inputs
...
if(babelHelpers.typeof(app.connection.auto)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){this.auto=app.connection.auto}else{this.auto=!0/* transition */ /* transition */}}},/**
   * Attached life cycle.
   */attached:function attached(){document.body.addEventListener("hax-store-property-updated",this._haxStorePropertyUpdated.bind(this));document.body.addEventListener("hax-app-search-values-changed",this._searchValuesEvent.bind(this))},/**
   * Detached life cycle.
   */detached:function detached(){document.body.removeEventListener("hax-store-property-updated",this._haxStorePropertyUpdated.bind(this));document.body.removeEventListener("hax-app-search-values-changed",this._searchValuesEvent.bind(this))},/**
   * Store updated, sync.
   ...
   */_requestDataChanged:function _requestDataChanged(newValue,oldValue){if({}!=babelHelpers.typeof(newValue)&&babelHelpers.typeof(oldValue)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){var media=[],map=this.resultMap,data=[];// look for the items element to draw our data from at its root
...
this.set("media",[]);this.set("media",media)}}},_loadingChanged:function _loadingChanged(newValue,oldValue){var _this=this;if(newValue){this.set("media",[]);this.notifyPath("media.*");setTimeout(function(){_this.$.itemlist.fire("iron-resize")},1e3)}},/**
   * Callback for when media has been processed for display
   */_mediaChanged:function _mediaChanged(newValue,oldValue){var _this2=this;if(babelHelpers.typeof(oldValue)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){setTimeout(function(){_this2.$.itemlist.fire("iron-resize")},325)}},/**
