define(["exports", "../../../lit-element/lit-element.js", "./hax-store.js", "./hax-context-item.js", "./hax-toolbar-menu.js", "../../simple-toolbar/lib/simple-toolbar-menu-item.js", "./hax-toolbar.js", "../../utils/utils.js", "./hax-context-container.js", "../../../mobx/dist/mobx.esm.js", "../../i18n-manager/lib/I18NMixin.js"], function (_exports, _litElement, _haxStore, _haxContextItem, _haxToolbarMenu, _simpleToolbarMenuItem, _haxToolbar, _utils, _haxContextContainer, _mobxEsm, _I18NMixin2) {
  ...
  function _templateObject2_f954dc1090c411ebad41f72aa2c8c806() {
    var data = babelHelpers.taggedTemplateLiteral([" <hax-context-item\n                action\n                icon=\"", "\"\n                label=\"", "\"\n                event-name=\"hax-ce-custom-button\"\n                value=\"", "\"\n              ></hax-context-item>"]);

    _templateObject2_f954dc1090c411ebad41f72aa2c8c806 = function _templateObject2_f954dc1090c411ebad41f72aa2c8c806() {
      return data;
    };
  ...
  function _templateObject_f954dc1090c411ebad41f72aa2c8c806() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <div id=\"toolbar\">\n        <hax-toolbar>\n          <div class=\"group\">\n            <hax-context-item\n              action\n              more\n              .icon=\"", "\"\n              label=\"", "...\"\n              tooltip=\"", ", ", "\"\n              ?disabled=\"", "\"\n              event-name=\"hax-transform-node\"\n              show-text-label\n            ></hax-context-item>\n            <slot name=\"primary\"></slot>\n          </div>\n          <div class=\"group\">\n            ", "\n            <slot name=\"secondary\"></slot>\n          </div>\n          <div class=\"group\">\n            <hax-context-item\n              action\n              icon=\"icons:code\"\n              label=\"", "\"\n              ?disabled=\"", "\"\n              event-name=\"hax-source-view-toggle\"\n              toggles\n              ?toggled=\"", "\"\n              @click=\"", "\"\n            ></hax-context-item>\n            <slot name=\"more\"></slot>\n          </div>\n          <div class=\"group\">\n            <hax-toolbar-menu\n              icon=\"add\"\n              label=\"", "\"\n            >\n              <simple-toolbar-menu-item slot=\"menuitem\">\n                <hax-context-item\n                  action\n                  align-horizontal=\"left\"\n                  show-text-label\n                  role=\"menuitem\"\n                  icon=\"hardware:keyboard-arrow-up\"\n                  event-name=\"insert-above-active\"\n                  label=\"", "\"\n                ></hax-context-item>\n              </simple-toolbar-menu-item>\n              <simple-toolbar-menu-item slot=\"menuitem\">\n                <hax-context-item\n                  action\n                  align-horizontal=\"left\"\n                  show-text-label\n                  role=\"menuitem\"\n                  icon=\"hardware:keyboard-arrow-down\"\n                  event-name=\"insert-below-active\"\n                  label=\"", "\"\n                ></hax-context-item>\n              </simple-toolbar-menu-item>\n            </hax-toolbar-menu>\n          </div>\n        </hax-toolbar>\n      </div>\n    "]);

    _templateObject_f954dc1090c411ebad41f72aa2c8c806 = function _templateObject_f954dc1090c411ebad41f72aa2c8c806() {
      return data;
    };
  ...
  var HaxCeContext = /*#__PURE__*/function (_I18NMixin) {
    ...
    babelHelpers.createClass(HaxCeContext, [{
      ...
      value: function render() {
        ...
        return (0, _litElement.html)(_templateObject_f954dc1090c411ebad41f72aa2c8c806(), this.activeTagIcon, this.t.changeTo, this.activeTagName, this.t.clickToChange, this.disableTransform, this.ceButtons.map(function (el) {
          return (0, _litElement.html)(_templateObject2_f954dc1090c411ebad41f72aa2c8c806(), el.icon, el.label, el.callback);
