define(["exports", "../../../lit-element/lit-element.js", "./hax-store.js", "./hax-context-item.js", "./hax-toolbar.js", "../../../mobx/dist/mobx.esm.js", "../../utils/utils.js"], function (_exports, _litElement, _haxStore, _haxContextItem, _haxToolbar, _mobxEsm, _utils) {
  ...
  function _templateObject3_298ecf303ee511ebb7f7a1171f0cd59d() {
    var data = babelHelpers.taggedTemplateLiteral([" <hax-context-item\n            mini\n            action\n            slot=\"prefix\"\n            icon=\"", "\"\n            label=\"", "\"\n            event-name=\"hax-ce-custom-button\"\n            value=\"", "\"\n          ></hax-context-item>"]);

    _templateObject3_298ecf303ee511ebb7f7a1171f0cd59d = function _templateObject3_298ecf303ee511ebb7f7a1171f0cd59d() {
      return data;
    };
  ...
  function _templateObject2_298ecf303ee511ebb7f7a1171f0cd59d() {
    ...
    _templateObject2_298ecf303ee511ebb7f7a1171f0cd59d = function _templateObject2_298ecf303ee511ebb7f7a1171f0cd59d() {
      return data;
    };
  ...
  function _templateObject_298ecf303ee511ebb7f7a1171f0cd59d() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n        hax-context-item {\n          margin: 0;\n        }\n        :host(.hax-context-pin-top) hax-toolbar {\n          position: fixed;\n          top: 0px;\n          flex-direction: column;\n        }\n        div[slot=\"primary\"] {\n          display: inline-flex;\n        }\n      "]);

    _templateObject_298ecf303ee511ebb7f7a1171f0cd59d = function _templateObject_298ecf303ee511ebb7f7a1171f0cd59d() {
      return data;
    };
  ...
  var HaxCeContext = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(HaxCeContext, null, [{
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject_298ecf303ee511ebb7f7a1171f0cd59d())];
      }
    }]);
    ...
    babelHelpers.createClass(HaxCeContext, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_298ecf303ee511ebb7f7a1171f0cd59d(), this.activeTagIcon, this.activeTagName, this.disableTransform, this.ceButtons.map(function (el) {
          return (0, _litElement.html)(_templateObject3_298ecf303ee511ebb7f7a1171f0cd59d(), el.icon, el.label, el.callback);
        }), !this.sourceView);
      }
    }, {
