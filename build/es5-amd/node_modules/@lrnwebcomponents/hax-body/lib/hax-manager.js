define(["exports", "require", "../../../@polymer/polymer/polymer-element.js", "../../../@polymer/polymer/lib/utils/render-status.js", "../../../@polymer/polymer/lib/legacy/polymer.dom.js", "../../../@polymer/paper-styles/paper-styles.js", "../../simple-colors/simple-colors.js", "./hax-shared-styles.js", "../../../@polymer/iron-pages/iron-pages.js"], function (_exports, _require, _polymerElement, _renderStatus, _polymerDom, _paperStyles, _simpleColors, _haxSharedStyles, _ironPages) {
  ...
  function _templateObject_5b719570b53711e9aa40b7626f5cd426() {
    ...
    _templateObject_5b719570b53711e9aa40b7626f5cd426 = function _templateObject_5b719570b53711e9aa40b7626f5cd426() {
      return data;
    };
  ...
  function (_PolymerElement) {
    ...
    function HaxManager() {
      ...
      new Promise(function (res, rej) {
        return _require.default(["@lrnwebcomponents/hax-body/lib/hax-preview.js"], res, rej);
      });
      new Promise(function (res, rej) {
        return _require.default(["@lrnwebcomponents/hax-body/lib/hax-app-browser.js"], res, rej);
      });
      new Promise(function (res, rej) {
        return _require.default(["@lrnwebcomponents/hax-body/lib/hax-gizmo-browser.js"], res, rej);
      });
      new Promise(function (res, rej) {
    ...
    babelHelpers.createClass(HaxManager, [{
      ...
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_5b719570b53711e9aa40b7626f5cd426());
      }
    }, {
      key: "tag",
      get: function get() {
