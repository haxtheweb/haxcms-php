define(["exports", "require", "../../../lit-element/lit-element.js", "../../simple-colors/simple-colors.js", "../../../@polymer/paper-styles/paper-styles.js", "../../../@polymer/iron-pages/iron-pages.js", "../../utils/utils.js", "../../../@polymer/polymer/lib/elements/custom-style.js"], function (_exports, _require, _litElement, _simpleColors, _paperStyles, _ironPages, _utils, _customStyle) {
  ...
  function _templateObject2_d5008200387911eab76ec18634c4f6e2() {
    ...
    _templateObject2_d5008200387911eab76ec18634c4f6e2 = function _templateObject2_d5008200387911eab76ec18634c4f6e2() {
      return data;
    };
  ...
  function _templateObject_d5008200387911eab76ec18634c4f6e2() {
    ...
    _templateObject_d5008200387911eab76ec18634c4f6e2 = function _templateObject_d5008200387911eab76ec18634c4f6e2() {
      return data;
    };
  ...
  function (_winEventsElement) {
    ...
    babelHelpers.createClass(HaxManager, null, [{
       ...
       */
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(HaxManager), "styles", this)), [(0, _litElement.css)(_templateObject_d5008200387911eab76ec18634c4f6e2())]);
      }
      /**
    ...
    babelHelpers.createClass(HaxManager, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_d5008200387911eab76ec18634c4f6e2(), this.opened, this.openedChanged, this.activeStep, this.activeStepChanged, this.activePageChanged, this.activePage, this.addTitle, this._fileAboutToUpload, this._fileUploadResponse, !this.canSupportUploads, this.newAssetConfigure, this.closeEvent, this.activeStep === 0 ? false : true);
      }
    }, {
      ...
      value: function newAssetConfigure() {
        ...
        var haxElements = window.HaxStore.guessGizmo(type, values);
        console.log(type);
        console.log(haxElements); // see if we got anything
