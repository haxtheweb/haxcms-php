define(["exports", "require", "../../../lit-element/lit-element.js"], function (_exports, _require, _litElement) {
  ...
  function _templateObject2_2de380f00b1311eaa3b2eff4bd15c191() {
    ...
    _templateObject2_2de380f00b1311eaa3b2eff4bd15c191 = function _templateObject2_2de380f00b1311eaa3b2eff4bd15c191() {
      return data;
    };
  ...
  function _templateObject_2de380f00b1311eaa3b2eff4bd15c191() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n          pointer-events: none;\n        }\n        :host [hidden] {\n          display: none;\n        }\n        paper-item {\n          -webkit-justify-content: flex-start;\n          justify-content: flex-start;\n          height: 36px;\n          padding: 0 8px;\n          min-height: 36px;\n        }\n        paper-item:hover {\n          background-color: #d3d3d3;\n          cursor: pointer;\n        }\n        iron-icon {\n          padding: 8px;\n        }\n        paper-item strong {\n          padding: 8px;\n          font-size: 12px;\n        }\n        :host(.hax-context-pin-top) hax-toolbar {\n          position: fixed;\n          top: 64px;\n          opacity: 0.95;\n        }\n        :host(.hax-context-pin-bottom) hax-toolbar {\n          position: fixed;\n          bottom: 0;\n          opacity: 0.95;\n        }\n      "]);

    _templateObject_2de380f00b1311eaa3b2eff4bd15c191 = function _templateObject_2de380f00b1311eaa3b2eff4bd15c191() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(HaxTextContext, null, [{
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject_2de380f00b1311eaa3b2eff4bd15c191())];
      }
    }]);
    ...
    function HaxTextContext() {
      ...
      _this.selectedValue = "p";
      _this.selection = false;
      _this.isSafari = _this._isSafari();
      _this.polyfillSafe = window.HaxStore.instance.computePolyfillSafe(); // fire an event that this is a core piece of the system

      _this.dispatchEvent(new CustomEvent("is-safari-changed", {
        bubbles: true,
        cancelable: true,
        composed: true,
        detail: _this.isSafari
      }));
    ...
    babelHelpers.createClass(HaxTextContext, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_2de380f00b1311eaa3b2eff4bd15c191(), this.selection, this.selectedValue, this.selectedValueChanged, !this._showIndent, !this._showIndent, !this._showIndent, !this._showIndent, this.isSafari, !this.isSafari);
      }
    }, {
      ...
      value: function updated(changedProperties) {
        ...
        changedProperties.forEach(function (oldValue, propName) {
          ...
          if (propName == "selectedValue" || propName == "polyfillSafe") {
            _this2._showIndent = _this2._computeShowIndent(_this2.selectedValue, _this2.polyfillSafe);
          }
