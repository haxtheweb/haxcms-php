define(["exports","./hax-app.js"],function(_exports,_haxApp){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0/* transition */ /* transition */});_exports.HAXBlox=void 0;/**
 `hax-blox`
...
```
*/var HAXBlox=/*#__PURE__*/function(_HAXApp){babelHelpers.inherits(HAXBlox,_HAXApp);function HAXBlox(){var _this;babelHelpers.classCallCheck(this,HAXBlox);_this=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(HAXBlox).call(this));_this.eventName="hax-register-blox";return _this}babelHelpers.createClass(HAXBlox,null,[{key:"tag",get:function get(){return"hax-blox"}}]);return HAXBlox}(_haxApp.HAXApp);_exports.HAXBlox=HAXBlox;window.customElements.define(HAXBlox.tag,HAXBlox)});