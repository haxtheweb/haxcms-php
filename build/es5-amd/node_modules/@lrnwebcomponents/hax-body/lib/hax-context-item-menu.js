define(["exports", "../../../lit-element/lit-element.js", "./hax-toolbar-menu.js", "../../../@polymer/paper-tooltip/paper-tooltip.js", "../../../@polymer/paper-item/paper-item.js", "../../../@polymer/neon-animation/neon-animation.js"], function (_exports, _litElement, _haxToolbarMenu, _paperTooltip, _paperItem, _neonAnimation) {
  ...
  function _templateObject2_0dbcc8e00ca311eaa0151532aa92855f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <hax-toolbar-menu\n        id=\"menu\"\n        .icon=\"", "\"\n        .tooltip=\"", "\"\n        .tooltip-direction=\"", "\"\n        @selected-changed=\"", "\"\n        .selected=\"", "\"\n        .reset-on-select=\"", "\"\n      >\n        <slot></slot>\n      </hax-toolbar-menu>\n    "]);

    _templateObject2_0dbcc8e00ca311eaa0151532aa92855f = function _templateObject2_0dbcc8e00ca311eaa0151532aa92855f() {
      return data;
    };
  ...
  function _templateObject_0dbcc8e00ca311eaa0151532aa92855f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: inline-flex;\n          height: 36px;\n          box-sizing: border-box;\n        }\n        :host hax-toolbar-menu ::slotted(*):hover {\n          background-color: var(--hax-color-bg-accent);\n        }\n        :host hax-toolbar-menu ::slotted(*) {\n          height: 36px;\n        }\n      "]);

    _templateObject_0dbcc8e00ca311eaa0151532aa92855f = function _templateObject_0dbcc8e00ca311eaa0151532aa92855f() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(HaxContextItemMenu, null, [{
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject_0dbcc8e00ca311eaa0151532aa92855f())];
      }
    }]);
    ...
    babelHelpers.createClass(HaxContextItemMenu, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_0dbcc8e00ca311eaa0151532aa92855f(), this.icon, this.label, this.direction, this.selectedValueChanged, this.selectedValue, this.resetOnSelect);
      }
    }, {
