define(["exports", "../../../lit-element/lit-element.js", "./hax-toolbar-menu.js", "../../simple-tooltip/simple-tooltip.js", "../../../@polymer/paper-item/paper-item.js", "../../../@polymer/neon-animation/neon-animation.js"], function (_exports, _litElement, _haxToolbarMenu, _simpleTooltip, _paperItem, _neonAnimation) {
  ...
  function _templateObject2_a0b935a03c8911ea8786bd9d8aec3af3() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <hax-toolbar-menu\n        id=\"menu\"\n        ?mini=\"", "\"\n        .icon=\"", "\"\n        .tooltip=\"", "\"\n        .tooltip-direction=\"", "\"\n        @selected-changed=\"", "\"\n        .selected=\"", "\"\n        ?reset-on-select=\"", "\"\n      >\n        <slot></slot>\n      </hax-toolbar-menu>\n    "]);

    _templateObject2_a0b935a03c8911ea8786bd9d8aec3af3 = function _templateObject2_a0b935a03c8911ea8786bd9d8aec3af3() {
      return data;
    };
  ...
  function _templateObject_a0b935a03c8911ea8786bd9d8aec3af3() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: inline-flex;\n          height: 36px;\n          box-sizing: border-box;\n        }\n        :host hax-toolbar-menu ::slotted(*):hover {\n          background-color: var(--hax-color-bg-accent);\n        }\n        :host hax-toolbar-menu ::slotted(*) {\n          height: 36px;\n        }\n        :host(mini) {\n          height: unset;\n          width: unset;\n        }\n      "]);

    _templateObject_a0b935a03c8911ea8786bd9d8aec3af3 = function _templateObject_a0b935a03c8911ea8786bd9d8aec3af3() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(HaxContextItemMenu, null, [{
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject_a0b935a03c8911ea8786bd9d8aec3af3())];
      }
    }]);
    ...
    babelHelpers.createClass(HaxContextItemMenu, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_a0b935a03c8911ea8786bd9d8aec3af3(), this.mini, this.icon, this.label, this.direction, this.selectedValueChanged, this.selectedValue, this.resetOnSelect);
      }
    }, {
