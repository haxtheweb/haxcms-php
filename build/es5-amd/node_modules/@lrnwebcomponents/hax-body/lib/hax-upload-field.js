define(["exports","../../../@polymer/polymer/polymer-element.js","../../../@polymer/paper-input/paper-input.js","../../../@vaadin/vaadin-upload/vaadin-upload.js","../../simple-colors/simple-colors.js","./hax-shared-styles.js"],function(_exports,_polymerElement,_paperInput,_vaadinUpload,_simpleColors,_haxSharedStyles){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0/* transition */ /* transition */});_exports.HaxUploadField=void 0;function _templateObject_1a0b230066fc11e984d945fe2fe0aa60(){var data=babelHelpers.taggedTemplateLiteral(["\n      <style is=\"custom-style\" include=\"simple-colors hax-shared-styles\">\n        :host {\n          display: block;\n          justify-content: flex-start;\n          visibility: visible;\n          transition: 0.3s all ease;\n          box-sizing: border-box;\n          pointer-events: all;\n        }\n        vaadin-upload {\n          --primary-color: var(--hax-color-accent1);\n          --primary-font-color: #ffffff;\n          --dark-primary-color: #ffffff;\n          --light-primary-color: var(--hax-color-accent1);\n          --error-color: darkred;\n          padding: 0;\n          margin: 0;\n          border: none;\n          --vaadin-upload-button-add-wrapper: {\n            border: none;\n            background-color: var(--hax-color-accent1);\n            color: #ffffff;\n            display: block;\n          }\n          --vaadin-upload-buttons-primary: {\n            display: block;\n            width: 100%;\n            flex: unset;\n            -webkit-flex: unset;\n          }\n          --vaadin-upload-button-add: {\n            color: #000000;\n            display: block;\n            flex: unset;\n            -webkit-flex: unset;\n            text-align: center;\n          }\n          --vaadin-upload-drop-label: {\n            color: #ffffff;\n            display: block;\n            padding: 0;\n            margin: 0;\n          }\n          --vaadin-upload-drop-label-dragover: {\n            color: #ffffff;\n          }\n          --vaadin-upload-file-list: {\n            padding: 0;\n            margin: 0;\n            color: #ffffff;\n          }\n          --vaadin-upload-file: {\n            color: #ffffff;\n          }\n        }\n        vaadin-upload[dragover] {\n          border-color: #396;\n        }\n        vaadin-upload-file {\n          --disabled-text-color: #222222;\n        }\n        paper-input {\n          color: var(--hax-color-text);\n        }\n      </style>\n      <paper-input\n        id=\"url\"\n        value=\"{{value}}\"\n        label=\"URL\"\n        type=\"url\"\n        auto-validate=\"\"\n      ></paper-input>\n      <vaadin-upload\n        form-data-name=\"file-upload\"\n        id=\"fileupload\"\n      ></vaadin-upload>\n    "]);_templateObject_1a0b230066fc11e984d945fe2fe0aa60=function _templateObject_1a0b230066fc11e984d945fe2fe0aa60(){return data};return data}var HaxUploadField=/*#__PURE__*/function(_PolymerElement){babelHelpers.inherits(HaxUploadField,_PolymerElement);function HaxUploadField(){babelHelpers.classCallCheck(this,HaxUploadField);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(HaxUploadField).apply(this,arguments))}babelHelpers.createClass(HaxUploadField,[{key:"_fileAboutToUpload",/**
