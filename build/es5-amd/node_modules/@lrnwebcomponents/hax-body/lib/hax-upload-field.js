define(["exports", "../../../lit/index.js", "../../simple-fields/lib/simple-fields-upload.js", "../../utils/utils.js", "./hax-store.js", "../../super-daemon/super-daemon.js", "../../i18n-manager/lib/I18NMixin.js"], function (_exports, _index, _simpleFieldsUpload, _utils, _haxStore, _superDaemon, _I18NMixin) {
  "use strict";
  ...
  var _templateObject_102f14c0e8e111ed8789699b2ad5335a;
    ...
    babelHelpers.createClass(HaxUploadField, [{
      ...
      function _fileAboutToUpload(e) {
        if (this._canUpload()) {
          ...
          var type = _haxStore.HAXStore.guessGizmoType(values);
      ...
      key: "sources",
      get: function get() {
        return (0, _index.html)(_templateObject_102f14c0e8e111ed8789699b2ad5335a || (_templateObject_102f14c0e8e111ed8789699b2ad5335a = babelHelpers.taggedTemplateLiteral([" <simple-toolbar-button\n        ?disabled=\"", "\"\n        label=\"", "..\"\n        ?show-text-label=\"", "\"\n        icon=\"hax:multimedia\"\n        show-text-label\n        @click=\"", "\"\n        controls=\"fieldset\"\n        part=\"merlin\"\n        ?hidden=\"", "\"\n      >\n      </simple-toolbar-button>\n      ", ""])), this.disabled, this.t.selectMedia, this.responsiveSize.indexOf("s") < 0, this._clickMediaButton, !this.showSources, babelHelpers.get(babelHelpers.getPrototypeOf(HaxUploadField.prototype), "sources", this));
      }
    }, {
      ...
      key: "properties",
      get: function get() {
        return _objectSpread(_objectSpread({}, babelHelpers.get(babelHelpers.getPrototypeOf(HaxUploadField), "properties", this)), {}, {
          showSources: {
            type: Boolean,
            reflect: true,
