define(["exports", "../../../lit-element/lit-element.js", "../../simple-icon/lib/simple-icon-lite.js", "./hax-toolbar-item.js", "../../simple-popover/lib/simple-popover-selection.js", "./hax-store.js", "../../../mobx/dist/mobx.esm.js"], function (_exports, _litElement, _simpleIconLite, _haxToolbarItem, _simplePopoverSelection, _haxStore, _mobxEsm) {
  ...
  function _templateObject2_2a443c803ee511ebb7f7a1171f0cd59d() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n          box-sizing: border-box;\n        }\n        simple-icon-lite {\n          --simple-icon-height: 10px;\n          --simple-icon-width: 10px;\n          margin-left: -2px;\n        }\n        .flip-icon {\n          transform: rotateY(180deg);\n        }\n      "]);

    _templateObject2_2a443c803ee511ebb7f7a1171f0cd59d = function _templateObject2_2a443c803ee511ebb7f7a1171f0cd59d() {
      return data;
    };
  ...
  function _templateObject_2a443c803ee511ebb7f7a1171f0cd59d() {
    ...
    _templateObject_2a443c803ee511ebb7f7a1171f0cd59d = function _templateObject_2a443c803ee511ebb7f7a1171f0cd59d() {
      return data;
    };
  ...
  var HaxToolbarMenu = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(HaxToolbarMenu, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_2a443c803ee511ebb7f7a1171f0cd59d(), this.selectedChanged, this.disabled, this.mini, this.disabled, this.action, this.icon, !this.icon, this.iconClass, this.tooltip);
      }
    }, {
      key: "selectedChanged",
      ...
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_2a443c803ee511ebb7f7a1171f0cd59d())];
      }
    }, {
      key: "tag",
      get: function get() {
