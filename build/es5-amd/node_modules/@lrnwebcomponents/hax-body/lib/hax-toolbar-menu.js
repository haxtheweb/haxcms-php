define(["exports", "../../../lit/index.js", "../../simple-toolbar/lib/simple-toolbar-menu.js", "./hax-ui-styles.js"], function (_exports, _index, _simpleToolbarMenu, _haxUiStyles) {
  ...
  var _templateObject_fa8842309e8b11ed8df835f388f76963;
  ...
  var HaxToolbarMenu = /*#__PURE__*/function (_SimpleToolbarMenuBeh) {
    ...
    babelHelpers.createClass(HaxToolbarMenu, null, [{
      ...
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(HaxToolbarMenu), "simpleButtonCoreStyles", this)), [(0, _index.css)(_templateObject_fa8842309e8b11ed8df835f388f76963 || (_templateObject_fa8842309e8b11ed8df835f388f76963 = babelHelpers.taggedTemplateLiteral(["\n        ::slotted([slot=\"menuitem\"]) {\n          --simple-toolbar-button-justify: flex-start;\n          --simple-toolbar-button-label-white-space: nowrap;\n        }\n      "])))]);
      }
    }, {
      key: "tag",
      get: function get() {
