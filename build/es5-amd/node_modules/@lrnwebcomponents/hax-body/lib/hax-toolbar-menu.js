define(["exports", "../../../lit-element/lit-element.js", "../../simple-icon/simple-icon.js", "./hax-toolbar-item.js", "../../simple-popover/lib/simple-popover-selection.js"], function (_exports, _litElement, _simpleIcon, _haxToolbarItem, _simplePopoverSelection) {
  ...
  function _templateObject2_f092715025cb11eba454134bebd3d7b6() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n          box-sizing: border-box;\n        }\n        simple-icon {\n          --simple-icon-height: 10px;\n          --simple-icon-width: 10px;\n        }\n        .flip-icon {\n          transform: rotateY(180deg);\n        }\n      "]);

    _templateObject2_f092715025cb11eba454134bebd3d7b6 = function _templateObject2_f092715025cb11eba454134bebd3d7b6() {
      return data;
    };
  ...
  function _templateObject_f092715025cb11eba454134bebd3d7b6() {
    ...
    _templateObject_f092715025cb11eba454134bebd3d7b6 = function _templateObject_f092715025cb11eba454134bebd3d7b6() {
      return data;
    };
  ...
  var HaxToolbarMenu = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(HaxToolbarMenu, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_f092715025cb11eba454134bebd3d7b6(), this.selectedChanged, this.mini, this.action, this.icon, !this.icon, this.iconClass, this.tooltip);
      }
    }, {
      key: "selectedChanged",
      ...
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_f092715025cb11eba454134bebd3d7b6())];
      }
    }, {
      key: "tag",
      get: function get() {
