define(["exports", "../../../lit-element/lit-element.js", "../../../@polymer/iron-icon/iron-icon.js", "../../../@polymer/iron-icons/iron-icons.js", "../../../@polymer/iron-icons/editor-icons.js", "../../../@polymer/iron-icons/device-icons.js", "../../../@polymer/iron-icons/hardware-icons.js", "../../../@polymer/iron-icons/social-icons.js", "../../../@polymer/iron-icons/av-icons.js", "../../../@polymer/iron-icons/maps-icons.js", "../../../@polymer/paper-item/paper-item.js", "../../../@polymer/paper-listbox/paper-listbox.js", "../../../@polymer/paper-menu-button/paper-menu-button.js", "./hax-toolbar-item.js"], function (_exports, _litElement, _ironIcon, _ironIcons, _editorIcons, _deviceIcons, _hardwareIcons, _socialIcons, _avIcons, _mapsIcons, _paperItem, _paperListbox, _paperMenuButton, _haxToolbarItem) {
  ...
  function _templateObject2_88abdec034ed11eabe39ef50dfa8db3f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n          box-sizing: border-box;\n        }\n        paper-menu-button {\n          color: rgba(0, 0, 0, 0.66);\n          margin: 0;\n          padding: 0;\n          text-transform: none;\n          background-color: #ffffff;\n          display: flex;\n          min-width: 24px;\n        }\n\n        paper-menu-button .label {\n          font-size: 12px;\n          margin-top: 4px;\n        }\n\n        paper-menu-button .button-inner {\n          padding-top: 8px;\n          text-align: center;\n        }\n\n        .flip-icon {\n          transform: rotateY(180deg);\n        }\n\n        paper-tooltip {\n          pointer-events: none;\n        }\n        paper-listbox {\n          padding: 0;\n        }\n      "]);

    _templateObject2_88abdec034ed11eabe39ef50dfa8db3f = function _templateObject2_88abdec034ed11eabe39ef50dfa8db3f() {
      return data;
    };
  ...
  function _templateObject_88abdec034ed11eabe39ef50dfa8db3f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <paper-menu-button>\n        <hax-toolbar-item\n          id=\"button\"\n          ?mini=\"", "\"\n          slot=\"dropdown-trigger\"\n          icon=\"", "\"\n          .hidden=\"", "\"\n          .class=\"", "\"\n          tooltip=\"", "\"\n        ></hax-toolbar-item>\n        <paper-listbox\n          id=\"listbox\"\n          slot=\"dropdown-content\"\n          .selected=\"", "\"\n          @selected-changed=\"", "\"\n        >\n          <slot></slot>\n        </paper-listbox>\n      </paper-menu-button>\n    "]);

    _templateObject_88abdec034ed11eabe39ef50dfa8db3f = function _templateObject_88abdec034ed11eabe39ef50dfa8db3f() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(HaxToolbarMenu, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_88abdec034ed11eabe39ef50dfa8db3f(), this.mini, this.icon, !this.icon, this.iconClass, this.tooltip, this.selected, this.selectedChanged);
      }
    }, {
      key: "selectedChanged",
      ...
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_88abdec034ed11eabe39ef50dfa8db3f())];
      }
    }, {
      key: "tag",
      get: function get() {
