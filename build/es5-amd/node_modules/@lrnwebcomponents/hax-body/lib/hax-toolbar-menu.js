define(["exports", "../../../lit-element/lit-element.js", "../../simple-icon/simple-icon.js", "./hax-toolbar-item.js", "../../simple-popover/lib/simple-popover-selection.js"], function (_exports, _litElement, _simpleIcon, _haxToolbarItem, _simplePopoverSelection) {
  ...
  function _templateObject2_d92dbd90247111eb9734a78ef81f0b0d() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n          box-sizing: border-box;\n        }\n        simple-icon {\n          --simple-icon-height: 10px;\n          --simple-icon-width: 10px;\n        }\n        .flip-icon {\n          transform: rotateY(180deg);\n        }\n      "]);

    _templateObject2_d92dbd90247111eb9734a78ef81f0b0d = function _templateObject2_d92dbd90247111eb9734a78ef81f0b0d() {
      return data;
    };
  ...
  function _templateObject_d92dbd90247111eb9734a78ef81f0b0d() {
    ...
    _templateObject_d92dbd90247111eb9734a78ef81f0b0d = function _templateObject_d92dbd90247111eb9734a78ef81f0b0d() {
      return data;
    };
  ...
  var HaxToolbarMenu = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(HaxToolbarMenu, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_d92dbd90247111eb9734a78ef81f0b0d(), this.selectedChanged, this.mini, this.action, this.icon, !this.icon, this.iconClass, this.tooltip);
      }
    }, {
      key: "selectedChanged",
      ...
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_d92dbd90247111eb9734a78ef81f0b0d())];
      }
    }, {
      key: "tag",
      get: function get() {
