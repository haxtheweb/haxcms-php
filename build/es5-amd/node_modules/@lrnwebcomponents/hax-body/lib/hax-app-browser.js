define(["exports", "require", "../../../lit-element/lit-element.js", "./hax-tray-button.js", "./hax-store.js", "../../../mobx/dist/mobx.esm.js"], function (_exports, _require, _litElement, _haxTrayButton, _haxStore, _mobxEsm) {
  ...
  var _templateObject_b03d90e0af6311ebbe560fe9c4727db1, _templateObject2_b03d90e0af6311ebbe560fe9c4727db1, _templateObject3_b03d90e0af6311ebbe560fe9c4727db1;
  ...
  var HaxAppBrowser = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(HaxAppBrowser, [{
      ...
      value: function render() {
        ...
        return (0, _litElement.html)(_templateObject_b03d90e0af6311ebbe560fe9c4727db1 || (_templateObject_b03d90e0af6311ebbe560fe9c4727db1 = babelHelpers.taggedTemplateLiteral(["\n      <simple-button-grid\n        class=\"", "\"\n        always-expanded\n        columns=\"3\"\n      >\n        ", "\n      </simple-button-grid>\n      <hax-app-search\n        id=\"haxappsearch\"\n        class=\"", "\"\n      ></hax-app-search>\n      <slot></slot>\n    "])), this.searching ? "collapse-hide" : "", this.appList.map(function (app) {
          return (0, _litElement.html)(_templateObject2_b03d90e0af6311ebbe560fe9c4727db1 || (_templateObject2_b03d90e0af6311ebbe560fe9c4727db1 = babelHelpers.taggedTemplateLiteral(["\n            <hax-tray-button\n              class=\"", "\"\n              show-text-label\n              icon-position=\"top\"\n              index=\"", "\"\n              label=\"", "\"\n              icon=\"", "\"\n              color=\"", "\"\n              event-name=\"search-selected\"\n              event-data=\"", "\"\n            >\n            </hax-tray-button>\n          "])), _this2.searching ? "visibility-hidden" : "", app.index, app.details.title, app.details.icon, app.details.color, app.index);
      ...
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject3_b03d90e0af6311ebbe560fe9c4727db1 || (_templateObject3_b03d90e0af6311ebbe560fe9c4727db1 = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          overflow-y: auto;\n          position: relative;\n        }\n        simple-button-grid {\n          overflow: auto;\n        }\n        simple-button-grid.collapse-hide {\n          max-height: 0 !important;\n          transition: all 0.5s;\n        }\n        .visibility-hidden {\n          z-index: -1;\n          visibility: hidden;\n          opacity: 0;\n          height: 0;\n          transition: all 0.5s;\n        }\n      "])))];
      }
    }, {
      key: "tag",
      get: function get() {
