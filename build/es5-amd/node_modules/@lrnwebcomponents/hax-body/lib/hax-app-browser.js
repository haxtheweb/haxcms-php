define(["exports", "require", "../../../@polymer/polymer/polymer-element.js", "../../../@polymer/polymer/lib/utils/render-status.js", "../../../@polymer/polymer/lib/utils/async.js", "../../simple-colors/simple-colors.js", "../../grafitto-filter/grafitto-filter.js", "../../../@polymer/iron-list/iron-list.js", "../../../@polymer/iron-pages/iron-pages.js", "./hax-shared-styles.js"], function (_exports, _require, _polymerElement, _renderStatus, _async, _simpleColors, _grafittoFilter, _ironList, _ironPages, _haxSharedStyles) {
  ...
  function _templateObject_5b1b8630b53711e9aa40b7626f5cd426() {
    ...
    _templateObject_5b1b8630b53711e9aa40b7626f5cd426 = function _templateObject_5b1b8630b53711e9aa40b7626f5cd426() {
      return data;
    };
  ...
  function (_PolymerElement) {
    ...
    function HaxAppBrowser() {
      ...
      new Promise(function (res, rej) {
        return _require.default(["@lrnwebcomponents/dropdown-select/dropdown-select.js"], res, rej);
      });
      new Promise(function (res, rej) {
        return _require.default(["@lrnwebcomponents/hax-body/lib/hax-app-browser-item.js"], res, rej);
      });
      new Promise(function (res, rej) {
        return _require.default(["@lrnwebcomponents/hax-body/lib/hax-app-search.js"], res, rej);
      });
      return _this;
    }
    ...
    babelHelpers.createClass(HaxAppBrowser, [{
      ...
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_5b1b8630b53711e9aa40b7626f5cd426());
      }
    }, {
      key: "tag",
      get: function get() {
