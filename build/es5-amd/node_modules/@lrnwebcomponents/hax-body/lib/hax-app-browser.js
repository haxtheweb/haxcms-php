 ...
 */var HaxAppBrowser=/*#__PURE__*/function(_PolymerElement){babelHelpers.inherits(HaxAppBrowser,_PolymerElement);function HaxAppBrowser(){var _this;babelHelpers.classCallCheck(this,HaxAppBrowser);_this=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(HaxAppBrowser).call(this));new Promise(function(res,rej){return _require.default(["../../../@polymer/paper-input/paper-input.js"],res,rej)});new Promise(function(res,rej){return _require.default(["../../../@polymer/paper-item/paper-item.js"],res,rej)});new Promise(function(res,rej){return _require.default(["../../../@polymer/iron-pages/iron-pages.js"],res,rej)});new Promise(function(res,rej){return _require.default(["../../dropdown-select/dropdown-select.js"],res,rej)});new Promise(function(res,rej){return _require.default(["./hax-app-browser-item.js"],res,rej)});new Promise(function(res,rej){return _require.default(["./hax-app-search.js"],res,rej)});return _this}babelHelpers.createClass(HaxAppBrowser,[{key:"connectedCallback",/**
   * life cycle
