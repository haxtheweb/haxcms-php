define(["exports", "require", "../../../lit-element/lit-element.js", "./hax-tray-button.js", "./hax-store.js", "../../../mobx/dist/mobx.esm.js"], function (_exports, _require, _litElement, _haxTrayButton, _haxStore, _mobxEsm) {
  ...
  function _templateObject3_be96fb802dd211eba8a9dbdc0fc9b6e0() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            <hax-tray-button\n              dark-bg\n              index=\"", "\"\n              label=\"", "\"\n              icon=\"", "\"\n              color=\"", "\"\n              event-name=\"search-selected\"\n              event-data=\"", "\"\n            ></hax-tray-button>\n          "]);

    _templateObject3_be96fb802dd211eba8a9dbdc0fc9b6e0 = function _templateObject3_be96fb802dd211eba8a9dbdc0fc9b6e0() {
      return data;
    };
  ...
  function _templateObject2_be96fb802dd211eba8a9dbdc0fc9b6e0() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <div class=\"item-wrapper\">\n        ", "\n      </div>\n      <hax-app-search\n        id=\"haxappsearch\"\n        .hidden=\"", "\"\n      ></hax-app-search>\n      <slot></slot>\n    "]);

    _templateObject2_be96fb802dd211eba8a9dbdc0fc9b6e0 = function _templateObject2_be96fb802dd211eba8a9dbdc0fc9b6e0() {
      return data;
    };
  ...
  function _templateObject_be96fb802dd211eba8a9dbdc0fc9b6e0() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n        :host *[hidden] {\n          display: none;\n        }\n        .toolbar-inner {\n          display: block;\n          padding: 0;\n          width: 100%;\n        }\n        .item-wrapper {\n          text-align: center;\n        }\n      "]);

    _templateObject_be96fb802dd211eba8a9dbdc0fc9b6e0 = function _templateObject_be96fb802dd211eba8a9dbdc0fc9b6e0() {
      return data;
    };
  ...
  var HaxAppBrowser = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(HaxAppBrowser, null, [{
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject_be96fb802dd211eba8a9dbdc0fc9b6e0())];
      }
    }]);
    ...
    babelHelpers.createClass(HaxAppBrowser, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_be96fb802dd211eba8a9dbdc0fc9b6e0(), this.appList.map(function (app) {
          return (0, _litElement.html)(_templateObject3_be96fb802dd211eba8a9dbdc0fc9b6e0(), app.index, app.details.title, app.details.icon, app.details.color, app.index);
        }), !this.searching);
      }
    }, {
      key: "updated",
