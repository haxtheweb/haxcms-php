define(["exports", "require", "../../../lit-element/lit-element.js", "../../utils/utils.js", "./hax-tray-button.js"], function (_exports, _require, _litElement, _utils, _haxTrayButton) {
  ...
  function _templateObject3_7fa3c240bff611eaa5854beb4e0c914c() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            <hax-tray-button\n              index=\"", "\"\n              label=\"", "\"\n              icon=\"", "\"\n              color=\"", "\"\n              event-name=\"search-selected\"\n              event-data=\"", "\"\n            ></hax-tray-button>\n          "]);

    _templateObject3_7fa3c240bff611eaa5854beb4e0c914c = function _templateObject3_7fa3c240bff611eaa5854beb4e0c914c() {
      return data;
    };
  ...
  function _templateObject2_7fa3c240bff611eaa5854beb4e0c914c() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <div class=\"item-wrapper\">\n        ", "\n      </div>\n      <hax-app-search\n        id=\"haxappsearch\"\n        .hidden=\"", "\"\n      ></hax-app-search>\n      <slot></slot>\n    "]);

    _templateObject2_7fa3c240bff611eaa5854beb4e0c914c = function _templateObject2_7fa3c240bff611eaa5854beb4e0c914c() {
      return data;
    };
  ...
  function _templateObject_7fa3c240bff611eaa5854beb4e0c914c() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n        :host *[hidden] {\n          display: none;\n        }\n        .toolbar-inner {\n          display: block;\n          padding: 0;\n          width: 100%;\n        }\n        .item-wrapper {\n          text-align: center;\n        }\n      "]);

    _templateObject_7fa3c240bff611eaa5854beb4e0c914c = function _templateObject_7fa3c240bff611eaa5854beb4e0c914c() {
      return data;
    };
  ...
  function (_winEventsElement) {
    ...
    babelHelpers.createClass(HaxAppBrowser, null, [{
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject_7fa3c240bff611eaa5854beb4e0c914c())];
      }
    }]);
    ...
    babelHelpers.createClass(HaxAppBrowser, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_7fa3c240bff611eaa5854beb4e0c914c(), this.appList.map(function (app) {
          return (0, _litElement.html)(_templateObject3_7fa3c240bff611eaa5854beb4e0c914c(), app.index, app.details.title, app.details.icon, app.details.color, app.index);
        }), !this.searching);
      }
    }, {
      key: "firstUpdated",
