define(["exports", "require", "../../../lit-element/lit-element.js", "../../grafitto-filter/grafitto-filter.js", "../../utils/utils.js", "./hax-tray-button.js", "../../../@polymer/paper-input/paper-input.js"], function (_exports, _require, _litElement, _grafittoFilter, _utils, _haxTrayButton, _paperInput) {
  ...
  function _templateObject3_11a8fd005a5c11ea9b0bfd873cbf79fd() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            <hax-tray-button\n              index=\"", "\"\n              label=\"", "\"\n              icon=\"", "\"\n              color=\"", "\"\n              event-name=\"search-selected\"\n              event-data=\"", "\"\n            ></hax-tray-button>\n          "]);

    _templateObject3_11a8fd005a5c11ea9b0bfd873cbf79fd = function _templateObject3_11a8fd005a5c11ea9b0bfd873cbf79fd() {
      return data;
    };
  ...
  function _templateObject2_11a8fd005a5c11ea9b0bfd873cbf79fd() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <custom-style>\n        <style>\n          paper-input {\n            --paper-input-container-label: {\n              font-size: 11px;\n            }\n            --paper-input-container: {\n              padding: 2px;\n            }\n          }\n        </style>\n      </custom-style>\n      <div class=\"toolbar-inner\">\n        <paper-input\n          label=\"Filter\"\n          id=\"inputfilter\"\n          @value-changed=\"", "\"\n          aria-controls=\"filter\"\n          value=\"\"\n        ></paper-input>\n      </div>\n      <grafitto-filter\n        id=\"filter\"\n        .items=\"", "\"\n        like=\"\"\n        @filtered-changed=\"", "\"\n        where=\"details.title\"\n        ><template></template\n      ></grafitto-filter>\n      <div class=\"item-wrapper\">\n        ", "\n      </div>\n      <hax-app-search\n        id=\"haxappsearch\"\n        .hidden=\"", "\"\n      ></hax-app-search>\n      <slot></slot>\n    "]);

    _templateObject2_11a8fd005a5c11ea9b0bfd873cbf79fd = function _templateObject2_11a8fd005a5c11ea9b0bfd873cbf79fd() {
      return data;
    };
  ...
  function _templateObject_11a8fd005a5c11ea9b0bfd873cbf79fd() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n        :host *[hidden] {\n          display: none;\n        }\n        grafitto-filter {\n          color: black;\n        }\n        .toolbar-inner {\n          display: block;\n          padding: 0;\n          width: 100%;\n        }\n        .item-wrapper {\n          text-align: center;\n        }\n      "]);

    _templateObject_11a8fd005a5c11ea9b0bfd873cbf79fd = function _templateObject_11a8fd005a5c11ea9b0bfd873cbf79fd() {
      return data;
    };
  ...
  function (_winEventsElement) {
    ...
    babelHelpers.createClass(HaxAppBrowser, null, [{
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject_11a8fd005a5c11ea9b0bfd873cbf79fd())];
      }
    }]);
    ...
    babelHelpers.createClass(HaxAppBrowser, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_11a8fd005a5c11ea9b0bfd873cbf79fd(), this.inputfilterChanged, this.appList, this.filteredChanged, this.filtered.map(function (app) {
          return (0, _litElement.html)(_templateObject3_11a8fd005a5c11ea9b0bfd873cbf79fd(), app.index, app.details.title, app.details.icon, app.details.color, app.index);
        }), !this.searching);
      }
    }, {
      key: "filteredChanged",
