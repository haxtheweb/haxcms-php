window.__haxClickEvent = function (e) {
  if (e.target.tagName !== "TO-ELEMENT") {
    e.preventDefault();
    e.stopPropagation();
    e.stopImmediatePropagation();
    if (!window.__first) {
      alert('You\'ll now be asked to name this element. Make sure the element name has a hypthen in it like "cool-new-things".');
      window.__first = true;
    }
    var name = prompt("Name for this element:", "cool-new-thing");
    if (name) {
      // ensure we remove the class
      e.target.classList.remove("hax-injected-highlighter");
      document.getElementById("haxallthethings").downloadNewComponent(e.target, name);
    } else {
...
link.type = "module";
link.src = "https://cdn.waxam.io/build/es6/node_modules/@lrnwebcomponents/to-element/to-element.js";
document.body.appendChild(link);
var toE = document.createElement("to-element");
...
alert("Welcome to HAX Element creator. To get started, click on the thing you want to make a new element.");
