define(["exports", "meta", "require", "../../lit/index.js", "../simple-toolbar/lib/simple-toolbar-button.js", "../i18n-manager/lib/I18NMixin.js"], function (_exports, meta, _require, _index, _simpleToolbarButton, _I18NMixin2) {
  ...
  var _templateObject_e1df89f0e4f411ed85766367b4d3e9fc, _templateObject2_e1df89f0e4f411ed85766367b4d3e9fc, _templateObject3_e1df89f0e4f411ed85766367b4d3e9fc, _templateObject4_e1df89f0e4f411ed85766367b4d3e9fc, _templateObject5_e1df89f0e4f411ed85766367b4d3e9fc, _templateObject6_e1df89f0e4f411ed85766367b4d3e9fc;
  ...
  var MarkTheWords = /*#__PURE__*/function (_I18NMixin) {
    ...
    babelHelpers.createClass(MarkTheWords, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_e1df89f0e4f411ed85766367b4d3e9fc || (_templateObject_e1df89f0e4f411ed85766367b4d3e9fc = babelHelpers.taggedTemplateLiteral(["\n      <confetti-container id=\"confetti\">\n        <p class=\"question\">", "</p>\n        ", "\n        <div class=\"buttons\">\n          <simple-toolbar-button\n            @click=\"", "\"\n            icon=\"check\"\n            label=\"", "\"\n            show-text-label\n            icon-position=\"left\"\n            align-vertical=\"center\"\n            align-horizontal=\"center\"\n          ></simple-toolbar-button>\n          ", "\n          ", "\n        </div>\n      </confetti-container>\n    "])), this.question, this._haxstate && this.demoMode ? (0, _index.html)(_templateObject2_e1df89f0e4f411ed85766367b4d3e9fc || (_templateObject2_e1df89f0e4f411ed85766367b4d3e9fc = babelHelpers.taggedTemplateLiteral(["<slot></slot>"]))) : (0, _index.html)(_templateObject3_e1df89f0e4f411ed85766367b4d3e9fc || (_templateObject3_e1df89f0e4f411ed85766367b4d3e9fc = babelHelpers.taggedTemplateLiteral(["<div class=\"text\"></div>"]))), this.checkAnswer, this.isEnabled ? this.t.check : this.t.tryAgain, this.isEnabled ? "" : (0, _index.html)(_templateObject4_e1df89f0e4f411ed85766367b4d3e9fc || (_templateObject4_e1df89f0e4f411ed85766367b4d3e9fc = babelHelpers.taggedTemplateLiteral(["", "/", "\n              ", "%"])), this.numberGuessed, this.numberCorrect, Math.round(10 * (this.numberGuessed / this.numberCorrect * 100)) / 10), this._haxstate ? (0, _index.html)(_templateObject5_e1df89f0e4f411ed85766367b4d3e9fc || (_templateObject5_e1df89f0e4f411ed85766367b4d3e9fc = babelHelpers.taggedTemplateLiteral(["<simple-toolbar-button\n                @click=\"", "\"\n                icon=\"", "\"\n                label=\"", "\"\n                show-text-label\n                icon-position=\"left\"\n                align-vertical=\"center\"\n                align-horizontal=\"center\"\n              ></simple-toolbar-button>"])), this.toggleDemo, this.demoMode ? "av:play-circle-filled" : "image:edit", this.demoMode ? this.t.tryMode : this.t.editMode) : "");
      }
    }, {
      key: "toggleDemo",
