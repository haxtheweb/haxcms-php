define(["exports", "../../@polymer/polymer/polymer-element.js", "../rich-text-editor/rich-text-editor.js", "./lib/hax-text-editor-toolbar.js"], function (_exports, _polymerElement, _richTextEditor, _haxTextEditorToolbar) {
  ...
  function _templateObject_5be37140319211eab4d6d523fb58366a() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <style></style>\n      ", "\n    "]);

    _templateObject_5be37140319211eab4d6d523fb58366a = function _templateObject_5be37140319211eab4d6d523fb58366a() {
      return data;
    };
  ...
  function (_RichTextEditor) {
    ...
    babelHelpers.createClass(HaxTextEditor, null, [{
      ...
      // render function
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_5be37140319211eab4d6d523fb58366a(), babelHelpers.get(babelHelpers.getPrototypeOf(HaxTextEditor), "template", this));
