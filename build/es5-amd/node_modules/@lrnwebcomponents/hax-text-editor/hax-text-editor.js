define(["exports", "../../@polymer/polymer/polymer-element.js", "../rich-text-editor/rich-text-editor.js", "./lib/hax-text-editor-toolbar.js"], function (_exports, _polymerElement, _richTextEditor, _haxTextEditorToolbar) {
  ...
  function _templateObject_2d1aa210332811ea9673c9ed9148a8db() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <style></style>\n      ", "\n    "]);

    _templateObject_2d1aa210332811ea9673c9ed9148a8db = function _templateObject_2d1aa210332811ea9673c9ed9148a8db() {
      return data;
    };
  ...
  function (_RichTextEditor) {
    ...
    babelHelpers.createClass(HaxTextEditor, null, [{
      ...
      // render function
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_2d1aa210332811ea9673c9ed9148a8db(), babelHelpers.get(babelHelpers.getPrototypeOf(HaxTextEditor), "template", this));
