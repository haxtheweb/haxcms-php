define(["exports", "../../@polymer/polymer/polymer-element.js", "../rich-text-editor/rich-text-editor.js", "./lib/hax-text-editor-toolbar.js"], function (_exports, _polymerElement, _richTextEditor, _haxTextEditorToolbar) {
  ...
  function _templateObject_aab2db70865211eaac6dab845b52217a() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <style></style>\n      ", "\n    "]);

    _templateObject_aab2db70865211eaac6dab845b52217a = function _templateObject_aab2db70865211eaac6dab845b52217a() {
      return data;
    };
  ...
  function (_RichTextEditor) {
    ...
    babelHelpers.createClass(HaxTextEditor, null, [{
      ...
      // render function
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_aab2db70865211eaac6dab845b52217a(), babelHelpers.get(babelHelpers.getPrototypeOf(HaxTextEditor), "template", this));
