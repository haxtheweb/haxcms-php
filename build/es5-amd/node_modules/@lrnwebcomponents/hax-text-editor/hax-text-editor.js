define(["exports", "../../@polymer/polymer/polymer-element.js", "../rich-text-editor/rich-text-editor.js", "./lib/hax-text-editor-toolbar.js"], function (_exports, _polymerElement, _richTextEditor, _haxTextEditorToolbar) {
  ...
  function _templateObject_0b2e5650bd4511e9b9d80133ff7d9ffb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <style></style>\n      ", "\n    "]);

    _templateObject_0b2e5650bd4511e9b9d80133ff7d9ffb = function _templateObject_0b2e5650bd4511e9b9d80133ff7d9ffb() {
      return data;
    };
  ...
  function (_RichTextEditor) {
    ...
    babelHelpers.createClass(HaxTextEditor, null, [{
      ...
      // render function
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_0b2e5650bd4511e9b9d80133ff7d9ffb(), babelHelpers.get(babelHelpers.getPrototypeOf(HaxTextEditor), "template", this));
