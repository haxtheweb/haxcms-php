define(["exports", "../../@polymer/polymer/polymer-element.js", "../../@polymer/polymer/lib/utils/flattened-nodes-observer.js", "./lib/themes/one-dark.js", "./lib/highlightjs/highlight.js", "./lib/highlightjs/languages/javascript.js", "./lib/highlightjs/languages/xml.js"], function (_exports, _polymerElement, _flattenedNodesObserver, _oneDark, _highlight2, _javascript, _xml) {
  ...
  function _templateObject_9dc331a0115c11eaa6edd7776a42e835() {
    ...
    _templateObject_9dc331a0115c11eaa6edd7776a42e835 = function _templateObject_9dc331a0115c11eaa6edd7776a42e835() {
      return data;
    };
    ...
    babelHelpers.createClass(CodeSample, [{
      ...
      value: function connectedCallback() {
        ...
        setTimeout(function () {
          if (_this.querySelector("template")) {
            _this._observer = new _flattenedNodesObserver.FlattenedNodesObserver(_this.shadowRoot.querySelector("#content"), function () {
      ...
      value: function _themeChanged(theme) {
        if (theme && this._themeCanBeChanged()) {
          var previousTheme = this.shadowRoot.querySelector("#theme").querySelector("style");
          this.shadowRoot.querySelector("#theme").replaceChild(document.importNode(theme.content, true), previousTheme);
        }
      }
    }, {
      ...
      value: function _updateContent() {
        ...
        if (this.render) {
          this._demo = this.shadowRoot.querySelector("#demo").appendChild(document.importNode(template.content, true));
        }
      ...
      value: function _getCodeTemplate() {
        var nodes = _flattenedNodesObserver.FlattenedNodesObserver.getFlattenedNodes(this.shadowRoot.querySelector("#content"));
      ...
      // render function
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_9dc331a0115c11eaa6edd7776a42e835(), this.constructor.theme || _oneDark.oneDark);
