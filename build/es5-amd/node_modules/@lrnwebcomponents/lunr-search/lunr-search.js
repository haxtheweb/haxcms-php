...
get:function get(){return(0,_polymerElement.html)(_templateObject_e9dbef30685311e9b25d1735312af746())}// properties available to the custom element for data binding
},{key:"properties",get:function get(){return{dataSource:{name:"dataSource",type:"String"},data:{name:"data",type:"Array",notify:!0},method:{name:"method",type:"String",value:"GET"},search:{type:"String",notify:!0},results:{type:"Array",computed:"searched(data, search, index, minScore, limit)",notify:!0},noStopWords:{type:"Boolean",value:!1,notify:!0},fields:{type:"Array",value:[]},indexNoStopWords:{type:"Object"},index:{type:"Object",computed:"_createIndex(data, fields, noStopWords, __lunrLoaded)"},__lunrLoaded:{type:"Boolean"},limit:{type:"Number",value:500},minScore:{type:"Number",value:0},log:{type:"Boolean",value:!1}}}}]);function LunrSearch(){var _this;babelHelpers.classCallCheck(this,LunrSearch);_this=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(LunrSearch).call(this));var name="lunr",basePath=(0,_resolveUrl.pathFromUrl)(meta.url),location="".concat(basePath,"../../lunr/lunr.js");window.addEventListener("es-bridge-".concat(name,"-loaded"),_this._lunrLoaded.bind(babelHelpers.assertThisInitialized(babelHelpers.assertThisInitialized(_this))));window.ESGlobalBridge.requestAvailability();window.ESGlobalBridge.instance.load(name,location);if(window.ESGlobalBridge.imports&&window.ESGlobalBridge.imports[name]){_this.__lunrLoaded=!0}return _this}babelHelpers.createClass(LunrSearch,[{key:"_lunrLoaded",value:function _lunrLoaded(e){// callback when loaded
this.__lunrLoaded=!0}/**
