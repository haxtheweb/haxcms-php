define(["exports", "meta", "../../lit/index.js", "../es-global-bridge/es-global-bridge.js"], function (_exports, meta, _index, _esGlobalBridge) {
  ...
  var _templateObject_50a137a0509711edb124eb517be36dbf, _templateObject2_50a137a0509711edb124eb517be36dbf, _templateObject3_50a137a0509711edb124eb517be36dbf, _templateObject4_50a137a0509711edb124eb517be36dbf;
  ...
  var LunrSearch = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(LunrSearch, [{
      ...
      function render() {
        return (0, _index.html)(_templateObject_50a137a0509711edb124eb517be36dbf || (_templateObject_50a137a0509711edb124eb517be36dbf = babelHelpers.taggedTemplateLiteral(["\n    ", " \n    <slot></slot>"])), this.demo && this.results ? (0, _index.html)(_templateObject2_50a137a0509711edb124eb517be36dbf || (_templateObject2_50a137a0509711edb124eb517be36dbf = babelHelpers.taggedTemplateLiteral(["", ""])), this.results.map(function (item) {
          return (0, _index.html)(_templateObject3_50a137a0509711edb124eb517be36dbf || (_templateObject3_50a137a0509711edb124eb517be36dbf = babelHelpers.taggedTemplateLiteral(["<h2>", "</h2><p>", "</p>"])), item.title, item.description);
        })) : "");
      ...
      get: //styles function
      function get() {
        return [(0, _index.css)(_templateObject4_50a137a0509711edb124eb517be36dbf || (_templateObject4_50a137a0509711edb124eb517be36dbf = babelHelpers.taggedTemplateLiteral(["\n :host {\n   display: block;\n }\n \n :host([hidden]) {\n   display: none;\n }\n       "])))];
      }
    }, {
      key: "properties",
      get: function get() {
