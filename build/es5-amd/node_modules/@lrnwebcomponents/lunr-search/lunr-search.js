define(["exports", "meta", "../../lit/index.js", "../es-global-bridge/es-global-bridge.js"], function (_exports, meta, _index, _esGlobalBridge) {
  ...
  var _templateObject_e2291610e4f411ed85766367b4d3e9fc, _templateObject2_e2291610e4f411ed85766367b4d3e9fc, _templateObject3_e2291610e4f411ed85766367b4d3e9fc, _templateObject4_e2291610e4f411ed85766367b4d3e9fc;
  ...
  var LunrSearch = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(LunrSearch, [{
      ...
      // render function
      function render() {
        return (0, _index.html)(_templateObject_e2291610e4f411ed85766367b4d3e9fc || (_templateObject_e2291610e4f411ed85766367b4d3e9fc = babelHelpers.taggedTemplateLiteral([" ", "\n      <slot></slot>"])), this.demo && this.results ? (0, _index.html)(_templateObject2_e2291610e4f411ed85766367b4d3e9fc || (_templateObject2_e2291610e4f411ed85766367b4d3e9fc = babelHelpers.taggedTemplateLiteral(["", ""])), this.results.map(function (item) {
          return (0, _index.html)(_templateObject3_e2291610e4f411ed85766367b4d3e9fc || (_templateObject3_e2291610e4f411ed85766367b4d3e9fc = babelHelpers.taggedTemplateLiteral(["<h2>", "</h2>\n                <p>", "</p>"])), item.title, item.description);
        })) : "");
      }
      ...
      //styles function
      function get() {
        return [(0, _index.css)(_templateObject4_e2291610e4f411ed85766367b4d3e9fc || (_templateObject4_e2291610e4f411ed85766367b4d3e9fc = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n\n        :host([hidden]) {\n          display: none;\n        }\n      "])))];
      }
    }, {
      key: "properties",
      get: function get() {
