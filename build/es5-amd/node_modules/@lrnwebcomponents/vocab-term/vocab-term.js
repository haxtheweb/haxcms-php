define(["exports", "meta", "../../lit/index.js", "../simple-popover/simple-popover.js", "../simple-modal/lib/simple-modal-template.js"], function (_exports, meta, _index, _simplePopover, _simpleModalTemplate) {
  ...
  var _templateObject_e7e98f30e4f411ed85766367b4d3e9fc, _templateObject2_e7e98f30e4f411ed85766367b4d3e9fc, _templateObject3_e7e98f30e4f411ed85766367b4d3e9fc, _templateObject4_e7e98f30e4f411ed85766367b4d3e9fc, _templateObject5_e7e98f30e4f411ed85766367b4d3e9fc, _templateObject6_e7e98f30e4f411ed85766367b4d3e9fc, _templateObject7_e7e98f30e4f411ed85766367b4d3e9fc, _templateObject8_e7e98f30e4f411ed85766367b4d3e9fc;
  ...
  var VocabTerm = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(VocabTerm, [{
       ...
       */
      function render() {
        return (0, _index.html)(_templateObject_e7e98f30e4f411ed85766367b4d3e9fc || (_templateObject_e7e98f30e4f411ed85766367b4d3e9fc = babelHelpers.taggedTemplateLiteral([" ", ""])), !this.popoverMode ? (0, _index.html)(_templateObject2_e7e98f30e4f411ed85766367b4d3e9fc || (_templateObject2_e7e98f30e4f411ed85766367b4d3e9fc = babelHelpers.taggedTemplateLiteral(["\n          <div>\n            <div part=\"term\">\n              <summary id=\"summary\">", "</summary>\n            </div>\n            <simple-modal-template title=\"", "\">\n              <p slot=\"content\">", "</p>\n              ", "\n            </simple-modal-template>\n          </div>\n        "])), this.term, this.term ? this.term : "", this.information, this.links && this.links.length > 0 && this.links.map ? (0, _index.html)(_templateObject3_e7e98f30e4f411ed85766367b4d3e9fc || (_templateObject3_e7e98f30e4f411ed85766367b4d3e9fc = babelHelpers.taggedTemplateLiteral([" <ul slot=\"content\">\n                    ", "\n                  </ul>"])), this.links.map(function (el) {
          return (0, _index.html)(_templateObject4_e7e98f30e4f411ed85766367b4d3e9fc || (_templateObject4_e7e98f30e4f411ed85766367b4d3e9fc = babelHelpers.taggedTemplateLiteral(["\n                        <li>\n                          <a\n                            href=\"", "\"\n                            target=\"_blank\"\n                            rel=\"noopener noreferrer\"\n                            >", "</a\n                          >\n                        </li>\n                      "])), el.href, el.title);
        })) : "") : (0, _index.html)(_templateObject5_e7e98f30e4f411ed85766367b4d3e9fc || (_templateObject5_e7e98f30e4f411ed85766367b4d3e9fc = babelHelpers.taggedTemplateLiteral(["\n          <details>\n            <summary id=\"summary\">", "</summary>\n            <div part=\"information\">\n              <simple-popover for=\"summary\" position=\"top\" auto>\n                <p>", "</p>\n                <div part=\"links\">\n                  ", "\n                </div>\n              </simple-popover>\n            </div>\n          </details>\n        "])), this.term, this.information, this.links && this.links.length > 0 && this.links.map ? (0, _index.html)(_templateObject6_e7e98f30e4f411ed85766367b4d3e9fc || (_templateObject6_e7e98f30e4f411ed85766367b4d3e9fc = babelHelpers.taggedTemplateLiteral(["\n                        <ul>\n                          ", "\n                        </ul>\n                      "])), this.links.map(function (el) {
          return (0, _index.html)(_templateObject7_e7e98f30e4f411ed85766367b4d3e9fc || (_templateObject7_e7e98f30e4f411ed85766367b4d3e9fc = babelHelpers.taggedTemplateLiteral(["\n                              <li>\n                                <a\n                                  href=\"", "\"\n                                  target=\"_blank\"\n                                  rel=\"noopener noreferrer\"\n                                  >", "</a\n                                >\n                              </li>\n                            "])), el.href, el.title);
        })) : ""));
      }
      /**
       * Convention we use
      ...
      get: function get() {
        ...
        return [].concat(babelHelpers.toConsumableArray(styles), [(0, _index.css)(_templateObject8_e7e98f30e4f411ed85766367b4d3e9fc || (_templateObject8_e7e98f30e4f411ed85766367b4d3e9fc = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: inline-flex;\n        }\n        simple-modal-template {\n          --simple-modal-resize: both;\n          --simple-modal-width: 300px;\n          --simple-modal-height: 300px;\n          --simple-modal-min-width: 300px;\n          --simple-modal-min-height: 300px;\n        }\n        summary {\n          list-style: none;\n          border-bottom: var(--vocab-term-border-bottom, 1px dashed gray);\n          color: var(--vocab-term-color, black);\n        }\n      "])))]);
      }
    }, {
      key: "tag",
      get: function get() {
