define(["exports", "meta", "../../lit/index.js", "../simple-popover/simple-popover.js", "../simple-modal/lib/simple-modal-template.js"], function (_exports, meta, _index, _simplePopover, _simpleModalTemplate) {
  ...
  var _templateObject_925f6af0403311edb9fff3e6b08a0a9a, _templateObject2_925f6af0403311edb9fff3e6b08a0a9a, _templateObject3_925f6af0403311edb9fff3e6b08a0a9a, _templateObject4_925f6af0403311edb9fff3e6b08a0a9a, _templateObject5_925f6af0403311edb9fff3e6b08a0a9a, _templateObject6_925f6af0403311edb9fff3e6b08a0a9a, _templateObject7_925f6af0403311edb9fff3e6b08a0a9a, _templateObject8_925f6af0403311edb9fff3e6b08a0a9a;
  ...
  var VocabTerm = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(VocabTerm, [{
       ...
       */
      function render() {
        return (0, _index.html)(_templateObject_925f6af0403311edb9fff3e6b08a0a9a || (_templateObject_925f6af0403311edb9fff3e6b08a0a9a = babelHelpers.taggedTemplateLiteral([" ", ""])), !this.popoverMode ? (0, _index.html)(_templateObject2_925f6af0403311edb9fff3e6b08a0a9a || (_templateObject2_925f6af0403311edb9fff3e6b08a0a9a = babelHelpers.taggedTemplateLiteral(["\n          <div>\n            <div part=\"term\">\n              <summary id=\"summary\">", "</summary>\n            </div>\n            <simple-modal-template title=\"", "\">\n              <p slot=\"content\">", "</p>\n              ", "\n            </simple-modal-template>\n          </div>\n        "])), this.term, this.term ? this.term : "", this.information, this.links && this.links.length > 0 && this.links.map ? (0, _index.html)(_templateObject3_925f6af0403311edb9fff3e6b08a0a9a || (_templateObject3_925f6af0403311edb9fff3e6b08a0a9a = babelHelpers.taggedTemplateLiteral([" <ul slot=\"content\">\n                    ", "\n                  </ul>"])), this.links.map(function (el) {
          return (0, _index.html)(_templateObject4_925f6af0403311edb9fff3e6b08a0a9a || (_templateObject4_925f6af0403311edb9fff3e6b08a0a9a = babelHelpers.taggedTemplateLiteral(["\n                        <li>\n                          <a\n                            href=\"", "\"\n                            target=\"_blank\"\n                            rel=\"noopener noreferrer\"\n                            >", "</a\n                          >\n                        </li>\n                      "])), el.href, el.title);
        })) : "") : (0, _index.html)(_templateObject5_925f6af0403311edb9fff3e6b08a0a9a || (_templateObject5_925f6af0403311edb9fff3e6b08a0a9a = babelHelpers.taggedTemplateLiteral(["\n          <details>\n            <summary id=\"summary\">", "</summary>\n            <div part=\"information\">\n              <simple-popover for=\"summary\" position=\"top\" auto>\n                <p>", "</p>\n                <div part=\"links\">\n                  ", "\n                </div>\n              </simple-popover>\n            </div>\n          </details>\n        "])), this.term, this.information, this.links && this.links.length > 0 && this.links.map ? (0, _index.html)(_templateObject6_925f6af0403311edb9fff3e6b08a0a9a || (_templateObject6_925f6af0403311edb9fff3e6b08a0a9a = babelHelpers.taggedTemplateLiteral(["\n                        <ul>\n                          ", "\n                        </ul>\n                      "])), this.links.map(function (el) {
          return (0, _index.html)(_templateObject7_925f6af0403311edb9fff3e6b08a0a9a || (_templateObject7_925f6af0403311edb9fff3e6b08a0a9a = babelHelpers.taggedTemplateLiteral(["\n                              <li>\n                                <a\n                                  href=\"", "\"\n                                  target=\"_blank\"\n                                  rel=\"noopener noreferrer\"\n                                  >", "</a\n                                >\n                              </li>\n                            "])), el.href, el.title);
        })) : ""));
      }
      /**
       * Convention we use
      ...
      get: function get() {
        ...
        return [].concat(babelHelpers.toConsumableArray(styles), [(0, _index.css)(_templateObject8_925f6af0403311edb9fff3e6b08a0a9a || (_templateObject8_925f6af0403311edb9fff3e6b08a0a9a = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: inline-flex;\n        }\n        simple-modal-template {\n          --simple-modal-resize: both;\n          --simple-modal-width: 300px;\n          --simple-modal-height: 300px;\n          --simple-modal-min-width: 300px;\n          --simple-modal-min-height: 300px;\n        }\n        summary {\n          list-style: none;\n          border-bottom: var(--vocab-term-border-bottom, 1px dashed gray);\n          color: var(--vocab-term-color, black);\n        }\n      "])))]);
      }
    }, {
      key: "tag",
      get: function get() {
