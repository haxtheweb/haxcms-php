define(["exports", "../../lit/index.js", "../simple-popover/simple-popover.js", "../simple-modal/lib/simple-modal-template.js"], function (_exports, _index, _simplePopover, _simpleModalTemplate) {
  ...
  var _templateObject_5346db7056fd11ec8e273d168e82a23d, _templateObject2_5346db7056fd11ec8e273d168e82a23d, _templateObject3_5346db7056fd11ec8e273d168e82a23d, _templateObject4_5346db7056fd11ec8e273d168e82a23d, _templateObject5_5346db7056fd11ec8e273d168e82a23d, _templateObject6_5346db7056fd11ec8e273d168e82a23d, _templateObject7_5346db7056fd11ec8e273d168e82a23d, _templateObject8_5346db7056fd11ec8e273d168e82a23d;
  ...
  var VocabTerm = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(VocabTerm, [{
       ...
       */
      function render() {
        return (0, _index.html)(_templateObject_5346db7056fd11ec8e273d168e82a23d || (_templateObject_5346db7056fd11ec8e273d168e82a23d = babelHelpers.taggedTemplateLiteral([" ", ""])), !this.popoverMode ? (0, _index.html)(_templateObject2_5346db7056fd11ec8e273d168e82a23d || (_templateObject2_5346db7056fd11ec8e273d168e82a23d = babelHelpers.taggedTemplateLiteral(["\n          <div>\n            <div part=\"term\">\n              <summary id=\"summary\">", "</summary>\n            </div>\n            <simple-modal-template>\n              <div slot=\"header\">", "</div>\n              <p slot=\"content\">", "</p>\n              ", "\n              <div slot=\"buttons\">\n                <button dialog-dismiss>Close Modal</button>\n              </div>\n            </simple-modal-template>\n          </div>\n        "])), this.term, this.term, this.information, this.links.length > 0 ? (0, _index.html)(_templateObject3_5346db7056fd11ec8e273d168e82a23d || (_templateObject3_5346db7056fd11ec8e273d168e82a23d = babelHelpers.taggedTemplateLiteral([" <ul slot=\"content\">\n                    ", "\n                  </ul>"])), this.links.map(function (el) {
          return (0, _index.html)(_templateObject4_5346db7056fd11ec8e273d168e82a23d || (_templateObject4_5346db7056fd11ec8e273d168e82a23d = babelHelpers.taggedTemplateLiteral(["\n                        <li><a href=\"", "\">", "</a></li>\n                      "])), el.href, el.title);
        })) : "") : (0, _index.html)(_templateObject5_5346db7056fd11ec8e273d168e82a23d || (_templateObject5_5346db7056fd11ec8e273d168e82a23d = babelHelpers.taggedTemplateLiteral(["\n          <details>\n            <summary id=\"summary\">", "</summary>\n            <div part=\"information\">\n              <simple-popover for=\"summary\" position=\"top\">\n                <p>", "</p>\n                <div part=\"links\">\n                  ", "\n                </div>\n              </simple-popover>\n            </div>\n          </details>\n        "])), this.term, this.information, this.links.length > 0 ? (0, _index.html)(_templateObject6_5346db7056fd11ec8e273d168e82a23d || (_templateObject6_5346db7056fd11ec8e273d168e82a23d = babelHelpers.taggedTemplateLiteral(["\n                        <ul>\n                          ", "\n                        </ul>\n                      "])), this.links.map(function (el) {
          return (0, _index.html)(_templateObject7_5346db7056fd11ec8e273d168e82a23d || (_templateObject7_5346db7056fd11ec8e273d168e82a23d = babelHelpers.taggedTemplateLiteral(["\n                              <li><a href=\"", "\">", "</a></li>\n                            "])), el.href, el.title);
        })) : ""));
      }
      /**
       * Convention we use
      ...
      get: function get() {
        ...
        return [].concat(babelHelpers.toConsumableArray(styles), [(0, _index.css)(_templateObject8_5346db7056fd11ec8e273d168e82a23d || (_templateObject8_5346db7056fd11ec8e273d168e82a23d = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: inline-flex;\n        }\n        simple-modal-template {\n          --simple-modal-resize: both;\n          --simple-modal-width: 300px;\n          --simple-modal-height: 300px;\n          --simple-modal-min-width: 300px;\n          --simple-modal-min-height: 300px;\n        }\n        summary {\n          list-style: none;\n          border-bottom: var(--vocab-term-border-bottom, 1px dashed gray);\n          color: var(--vocab-term-color, black);\n        }\n      "])))]);
      }
    }, {
      key: "tag",
      get: function get() {
