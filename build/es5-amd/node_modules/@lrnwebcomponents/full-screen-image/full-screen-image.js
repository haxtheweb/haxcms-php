define(["exports", "../../lit/index.js", "../simple-icon/simple-icon.js", "../simple-icon/lib/simple-icons.js", "../simple-icon/lib/simple-icon-button.js"], function (_exports, _index, _simpleIcon, _simpleIcons, _simpleIconButton) {
  ...
  var _templateObject_5514f5a0d3e211ed8e5073e3aa96f674, _templateObject2_5514f5a0d3e211ed8e5073e3aa96f674;
  ...
  var FullScreenImage = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(FullScreenImage, [{
      ...
      // render function
      function render() {
        return (0, _index.html)(_templateObject_5514f5a0d3e211ed8e5073e3aa96f674 || (_templateObject_5514f5a0d3e211ed8e5073e3aa96f674 = babelHelpers.taggedTemplateLiteral([" <div class=\"fullpage-container\">\n      <div class=\"overlay-container\">\n        <h2>", "</h2>\n        <p>", "</p>\n      </div>\n      <simple-icon-button\n        id=\"down\"\n        icon=\"hardware:keyboard-arrow-down\"\n      ></simple-icon-button>\n      <div class=\"image-wrapper\">\n        <img loading=\"lazy\" id=\"img\" src=\"", "\" />\n      </div>\n    </div>"])), this.title, this.subtitle, this.source);
      }
      ...
      //styles function
      function get() {
        return [(0, _index.css)(_templateObject2_5514f5a0d3e211ed8e5073e3aa96f674 || (_templateObject2_5514f5a0d3e211ed8e5073e3aa96f674 = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n          font-variant-ligatures: common-ligatures;\n        }\n\n        :host([hidden]) {\n          display: none;\n        }\n\n        h2 {\n          font-size: 4em;\n          font-weight: 200;\n          margin: 0px !important;\n          line-height: 1em;\n          text-transform: lowercase;\n          color: white;\n          letter-spacing: -0.04em;\n          font-family: \"Source Sans Pro\", Arial, Helvetica, sans-serif;\n        }\n\n        p {\n          font-weight: 400;\n          color: white;\n          line-height: 1em;\n          font-family: \"Source Sans Pro\", Arial, Helvetica, sans-serif;\n          font-size: 1em;\n          letter-spacing: 0.01em;\n          margin-top: 0;\n          margin-bottom: 1em;\n        }\n\n        img {\n          position: absolute;\n          margin: 0px;\n          padding: 0px;\n          border: none;\n          width: 1239px;\n          height: 774.375px;\n          max-width: none;\n          z-index: -999999;\n          left: 0px;\n          top: -57.1875px;\n        }\n\n        simple-icon-button {\n          --simple-icon-height: 45px;\n          --simple-icon-width: 75px;\n          line-height: 45px;\n          bottom: 1px;\n          right: 0px;\n          display: block;\n          position: absolute;\n          text-align: center;\n          color: white;\n          background-color: rgba(0, 0, 0, 0.6);\n        }\n\n        .fullpage-container {\n          display: block;\n        }\n\n        .image-wrapper {\n          left: 0px;\n          top: 0px;\n          bottom: 0px;\n          right: 0px;\n          overflow: hidden;\n          margin: 0px;\n          padding: 0px;\n          width: 100%;\n          z-index: -999998;\n          position: absolute;\n        }\n\n        .overlay-container {\n          display: block;\n          position: absolute;\n          text-align: right;\n          padding: 0.1em 1.5em 0.1em 6em;\n          bottom: 60px;\n          right: 0px;\n          background-color: rgba(191, 147, 45, 0.7);\n        }\n      "])))];
      }
    }, {
      key: "haxProperties",
      get: function get() {
