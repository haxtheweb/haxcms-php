define(["exports", "../../lit-element/lit-element.js", "../exif-data/exif-data.js", "../simple-icon/simple-icon.js", "../simple-icon/lib/simple-icons.js", "../simple-icon/lib/simple-icon-button.js", "../img-pan-zoom/img-pan-zoom.js"], function (_exports, _litElement, _exifData, _simpleIcon, _simpleIcons, _simpleIconButton, _imgPanZoom) {
  ...
  function _templateObject2_cd45cc20247111eb9734a78ef81f0b0d() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <div class=\"wrap\">\n        <simple-icon-button\n          title=\"Zoom in\"\n          icon=\"zoom-in\"\n          @click=\"", "\"\n        ></simple-icon-button>\n        <simple-icon-button\n          title=\"Zoom out\"\n          icon=\"zoom-out\"\n          @click=\"", "\"\n        ></simple-icon-button>\n        <simple-icon-button\n          title=\"Rotate right\"\n          icon=\"image:rotate-right\"\n          @click=\"", "\"\n        ></simple-icon-button>\n        <simple-icon-button\n          title=\"Rotate left\"\n          icon=\"image:rotate-left\"\n          @click=\"", "\"\n        ></simple-icon-button>\n        <simple-icon-button\n          title=\"Mirror image\"\n          icon=\"image:flip\"\n          @click=\"", "\"\n        ></simple-icon-button>\n        <simple-icon-button\n          title=\"Open in new window\"\n          icon=\"launch\"\n          href=\"", "\"\n          target=\"_blank\"\n        ></simple-icon-button>\n        <simple-icon-button\n          title=\"EXIF Data\"\n          icon=\"image:camera-roll\"\n          @click=\"", "\"\n        ></simple-icon-button>\n        <slot name=\"toolbar\"></slot>\n      </div>\n      <exif-data\n        id=\"exif\"\n        @click=", "\n        no-events\n        ?no-left=\"", "\"\n        ><img src=\"", "\" />\n      </exif-data>\n      <img-pan-zoom id=\"img\" src=\"", "\"></img-pan-zoom>\n      <slot></slot>\n    "]);

    _templateObject2_cd45cc20247111eb9734a78ef81f0b0d = function _templateObject2_cd45cc20247111eb9734a78ef81f0b0d() {
      return data;
    };
  ...
  function _templateObject_cd45cc20247111eb9734a78ef81f0b0d() {
    ...
    _templateObject_cd45cc20247111eb9734a78ef81f0b0d = function _templateObject_cd45cc20247111eb9734a78ef81f0b0d() {
      return data;
    };
  ...
  var ImageInspector = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(ImageInspector, null, [{
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject_cd45cc20247111eb9734a78ef81f0b0d())];
      }
    }]);
    ...
    babelHelpers.createClass(ImageInspector, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_cd45cc20247111eb9734a78ef81f0b0d(), this.zoomIn, this.zoomOut, this.rotateRight, this.rotateLeft, this.mirrorImage, this.src, this.exifDataEvent, this.hideData, this.noLeft, this.src, this.src);
      }
    }, {
      key: "exifDataEvent",
