define(["exports", "../../lit-element/lit-element.js", "./lib/editable-table-behaviors.js", "../rich-text-editor/rich-text-editor.js", "../rich-text-editor/lib/toolbars/rich-text-editor-toolbar-mini.js", "../simple-tooltip/simple-tooltip.js", "../simple-icon/lib/simple-icon-lite.js", "../simple-icon/lib/simple-icons.js", "../hax-iconset/lib/simple-hax-iconset.js", "./lib/editable-table-editor-rowcol.js", "./lib/editable-table-editor-toggle.js", "./lib/editable-table-display.js", "../utils/utils.js"], function (_exports, _litElement, _editableTableBehaviors, _richTextEditor, _richTextEditorToolbarMini, _simpleTooltip, _simpleIconLite, _simpleIcons, _simpleHaxIconset, _editableTableEditorRowcol, _editableTableEditorToggle, _editableTableDisplay, _utils) {
  ...
  function _templateObject5_613324e08b4811ebbbe2170cf981e021() {
    ...
    _templateObject5_613324e08b4811ebbbe2170cf981e021 = function _templateObject5_613324e08b4811ebbbe2170cf981e021() {
      return data;
    };
  ...
  function _templateObject4_613324e08b4811ebbbe2170cf981e021() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                        <td\n                          class=\"", " th-or-td\"\n                          ?negative=\"", "\"\n                          ?numeric=\"", "\"\n                          @click=\"", "\"\n                        >\n                          <rich-text-editor\n                            autofocus\n                            @editing-disabled=\"", "\"\n                            class=\"cell\"\n                            disable-mouseover\n                            toolbar=\"mini\"\n                            id=\"cell-", "-", "\"\n                            label=\"", "\"\n                            rawhtml=\"", "\"\n                            type=\"rich-text-editor-toolbar\"\n                          >\n                          </rich-text-editor>\n                          <div id=\"icons\">\n                            <simple-icon-lite\n                              class=\"sortable-icon\"\n                              icon=\"editable-table:sortable\"\n                              aria-hidden=\"true\"\n                            ></simple-icon-lite>\n                            <simple-icon-lite\n                              class=\"filter-icon\"\n                              icon=\"editable-table:filter-off\"\n                            ></simple-icon-lite>\n                          </div>\n                        </td>\n                      "]);

    _templateObject4_613324e08b4811ebbbe2170cf981e021 = function _templateObject4_613324e08b4811ebbbe2170cf981e021() {
      return data;
    };
  ...
  function _templateObject3_613324e08b4811ebbbe2170cf981e021() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                  <tr\n                    class=\"tr ", "\"\n                  >\n                    <th scope=\"row\">\n                      <editable-table-editor-rowcol\n                        class=\"cell\"\n                        ?condensed=\"", "\"\n                        index=\"", "\"\n                        row\n                        @rowcol-action=\"", "\"\n                      >\n                      </editable-table-editor-rowcol>\n                    </th>\n                    ", "\n                  </tr>\n                "]);

    _templateObject3_613324e08b4811ebbbe2170cf981e021 = function _templateObject3_613324e08b4811ebbbe2170cf981e021() {
      return data;
    };
  ...
  function _templateObject2_613324e08b4811ebbbe2170cf981e021() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                    <th\n                      class=\"col-", "\"\n                      scope=\"col\"\n                      ?numeric=\"", "\"\n                    >\n                      <editable-table-editor-rowcol\n                        ?condensed=\"", "\"\n                        index=\"", "\"\n                        @rowcol-action=\"", "\"\n                      >\n                      </editable-table-editor-rowcol>\n                    </th>\n                  "]);

    _templateObject2_613324e08b4811ebbbe2170cf981e021 = function _templateObject2_613324e08b4811ebbbe2170cf981e021() {
      return data;
    };
  ...
  function _templateObject_613324e08b4811ebbbe2170cf981e021() {
    ...
    _templateObject_613324e08b4811ebbbe2170cf981e021 = function _templateObject_613324e08b4811ebbbe2170cf981e021() {
      return data;
    };
  ...
  var EditableTable = /*#__PURE__*/function (_displayBehaviors) {
    ...
    babelHelpers.createClass(EditableTable, [{
      ...
      value: function render() {
        ...
        return (0, _litElement.html)(_templateObject_613324e08b4811ebbbe2170cf981e021(), this.config, this.editMode ? "true" : "false", this.bordered, this.caption, this.columnHeader, this.columnStriped, this.condensed, this.downloadable, this.data, this.filter, this.footer, this.editMode, this.numericStyles, this.printable, this.responsive, this.rowHeader, this.sort, this.striped, !this.editMode, !this.editMode ? "true" : "false", this.bordered, this.columnHeader, this.columnStriped, this.condensed, this.downloadable, this.filter, this.footer, this.numericStyles, this.printable, this.responsive, this.rowHeader, this.sort, this.striped, this._captionChanged, this.caption, (this.data[0] || []).map(function (cell, th) {
          return (0, _litElement.html)(_templateObject2_613324e08b4811ebbbe2170cf981e021(), th, _this2._isNumericColumn(th), _this2.condensed, th, _this2._handleRowColumnMenu);
        }), this.data.map(function (row, tr) {
          return (0, _litElement.html)(_templateObject3_613324e08b4811ebbbe2170cf981e021(), tr == 0 && _this2.columnHeader ? "thead-tr" : tr == _this2.data.length - 1 && _this2.footer ? "tfoot-tr" : "tbody-tr", _this2.condensed, tr, _this2._handleRowColumnMenu, (row || []).map(function (cell, td) {
            return (0, _litElement.html)(_templateObject4_613324e08b4811ebbbe2170cf981e021(), td === 0 && _this2.rowHeader || tr == 0 && _this2.columnHeader ? "th" : "td", _this2._isNegative(cell), _this2._isNumericColumn(td), _this2._onCellClick, function (e) {
      ...
      key: "styles",
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(EditableTable), "styles", this) || []), babelHelpers.toConsumableArray(_editableTableBehaviors.editableTableStyles), [(0, _litElement.css)(_templateObject5_613324e08b4811ebbbe2170cf981e021())]);
      }
    }, {
      key: "tag",
      get: function get() {
