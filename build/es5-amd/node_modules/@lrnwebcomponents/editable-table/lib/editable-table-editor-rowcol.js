define(["exports", "../../../lit-element/lit-element.js", "./editable-table-behaviors.js", "../../a11y-menu-button/a11y-menu-button.js", "../../simple-icon/lib/simple-icon-lite.js", "../../simple-icon/lib/simple-icons.js", "../../hax-iconset/lib/simple-hax-iconset.js"], function (_exports, _litElement, _editableTableBehaviors, _a11yMenuButton, _simpleIconLite, _simpleIcons, _simpleHaxIconset) {
  ...
  function _templateObject4_0e609380930211eb82a7a575782a1009() {
    ...
    _templateObject4_0e609380930211eb82a7a575782a1009 = function _templateObject4_0e609380930211eb82a7a575782a1009() {
      return data;
    };
  ...
  function _templateObject3_0e609380930211eb82a7a575782a1009() {
    var data = babelHelpers.taggedTemplateLiteral(["<span class=\"sr-only\">", "</span>"]);

    _templateObject3_0e609380930211eb82a7a575782a1009 = function _templateObject3_0e609380930211eb82a7a575782a1009() {
      return data;
    };
  ...
  function _templateObject2_0e609380930211eb82a7a575782a1009() {
    var data = babelHelpers.taggedTemplateLiteral([" <a11y-menu-button-item\n      @click=\"", "\"\n    >\n      ", "\n      ", "", "\n      ", "\n    </a11y-menu-button-item>"]);

    _templateObject2_0e609380930211eb82a7a575782a1009 = function _templateObject2_0e609380930211eb82a7a575782a1009() {
      return data;
    };
  ...
  function _templateObject_0e609380930211eb82a7a575782a1009() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <button\n        id=\"menubutton\"\n        aria-haspopup=\"true\"\n        aria-controls=\"menu\"\n        aria-expanded=\"", "\"\n      >\n        <span class=\"sr-only\">", "</span>\n        <span id=\"label\">", " </span>\n        <span class=\"sr-only\">Menu</span>\n        <simple-icon-lite icon=\"arrow-drop-down\"></simple-icon-lite>\n      </button>\n      <absolute-position-behavior\n        ?auto=\"", "\"\n        class=\"", "\"\n        for=\"menubutton\"\n        position=\"", "\"\n        position-align=\"", "\"\n        offset=\"-3\"\n      >\n        <ul\n          id=\"menu\"\n          role=\"menu\"\n          aria-labelledby=\"menubutton\"\n          ?hidden=\"", "\"\n          @mousover=\"", "\"\n          @mousout=\"", "\"\n        >\n          ", " ", "\n          ", "\n        </ul>\n      </absolute-position-behavior>\n    "]);

    _templateObject_0e609380930211eb82a7a575782a1009 = function _templateObject_0e609380930211eb82a7a575782a1009() {
      return data;
    };
  ...
  var EditableTableEditorRowcol = /*#__PURE__*/function (_cellBehaviors) {
    ...
    babelHelpers.createClass(EditableTableEditorRowcol, [{
      ...
      value: function render() {
        ...
        return (0, _litElement.html)(_templateObject_0e609380930211eb82a7a575782a1009(), this.expanded ? "true" : "false", this.type, this.label || "", this.expanded, this.row ? "row" : "column", this.row ? "right" : "bottom", this.row ? "start" : "center", !this.expanded, function (e) {
      ...
      value: function _getItem() {
        ...
        return (0, _litElement.html)(_templateObject2_0e609380930211eb82a7a575782a1009(), deleteItem ? this._onDelete : after ? this._onInsertAfter : this._onInsertBefore, deleteItem ? "Delete" : "Insert", this.type, deleteItem ? " " : after ? " After " : " Before ", this.labelInfo);
      }
      /**
      ...
      key: "labelInfo",
      get: function get() {
        return (0, _litElement.html)(_templateObject3_0e609380930211eb82a7a575782a1009(), this.label);
      }
      /**
       *
      ...
      key: "styles",
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(EditableTableEditorRowcol), "styles", this) || []), babelHelpers.toConsumableArray(_editableTableBehaviors.editableTableCellStyles), [(0, _litElement.css)(_templateObject4_0e609380930211eb82a7a575782a1009())]);
      }
    }, {
      key: "tag",
      get: function get() {
