...
function _templateObject11_15389e30994411ebb1a5332c5e6bdde2() {
  var data = _taggedTemplateLiteral(['<span class="cell"\n            >', "</span\n          >"]);

  _templateObject11_15389e30994411ebb1a5332c5e6bdde2 = function _templateObject11_15389e30994411ebb1a5332c5e6bdde2() {
    return data;
  };
...
function _templateObject10_15389e30994411ebb1a5332c5e6bdde2() {
  var data = _taggedTemplateLiteral(['\n            <editable-table-filter\n              class="cell"\n              column-index="', '"\n              ?filtered="', '"\n            >\n              ', "\n            </editable-table-filter>\n          "]);

  _templateObject10_15389e30994411ebb1a5332c5e6bdde2 = function _templateObject10_15389e30994411ebb1a5332c5e6bdde2() {
    return data;
  };
...
function _templateObject9_15389e30994411ebb1a5332c5e6bdde2() {
  var data = _taggedTemplateLiteral(['<td\n      class="td th-or-td"\n      cell-index="', '"\n      ?numeric="', '"\n      ?negative="', '"\n      ?xs-hidden="', '"\n    >\n      ', "\n    </td>"]);

  _templateObject9_15389e30994411ebb1a5332c5e6bdde2 = function _templateObject9_15389e30994411ebb1a5332c5e6bdde2() {
    return data;
  };
...
function _templateObject8_15389e30994411ebb1a5332c5e6bdde2() {
  var data = _taggedTemplateLiteral(['<th\n      class="th th-or-td"\n      cell-index="', '"\n      ?numeric="', '"\n      scope="row"\n      ?xs-hidden="', '"\n    >\n      ', "\n    </th>"]);

  _templateObject8_15389e30994411ebb1a5332c5e6bdde2 = function _templateObject8_15389e30994411ebb1a5332c5e6bdde2() {
    return data;
  };
...
function _templateObject7_15389e30994411ebb1a5332c5e6bdde2() {
  var data = _taggedTemplateLiteral(['\n      <tr class="tr ', '">\n        ', "\n      </tr>\n    "]);

  _templateObject7_15389e30994411ebb1a5332c5e6bdde2 = function _templateObject7_15389e30994411ebb1a5332c5e6bdde2() {
    return data;
  };
...
function _templateObject6_15389e30994411ebb1a5332c5e6bdde2() {
  var data = _taggedTemplateLiteral(['\n              <tfoot class="tfoot">\n                ', "\n              </tfoot>\n            "]);

  _templateObject6_15389e30994411ebb1a5332c5e6bdde2 = function _templateObject6_15389e30994411ebb1a5332c5e6bdde2() {
    return data;
  };
...
function _templateObject5_15389e30994411ebb1a5332c5e6bdde2() {
  var data = _taggedTemplateLiteral(['\n                        <editable-table-sort\n                          column-index="', '"\n                          sort-column="', '"\n                        >\n                          ', "\n                        </editable-table-sort>\n                      "]);

  _templateObject5_15389e30994411ebb1a5332c5e6bdde2 = function _templateObject5_15389e30994411ebb1a5332c5e6bdde2() {
    return data;
  };
...
function _templateObject4_15389e30994411ebb1a5332c5e6bdde2() {
  var data = _taggedTemplateLiteral(['\n                <th\n                  class="th th-or-td"\n                  cell-index="', '"\n                  ?numeric="', '"\n                  scope="col"\n                  ?xs-hidden="', '"\n                >\n                  ', "\n                </th>\n              "]);

  _templateObject4_15389e30994411ebb1a5332c5e6bdde2 = function _templateObject4_15389e30994411ebb1a5332c5e6bdde2() {
    return data;
  };
...
function _templateObject3_15389e30994411ebb1a5332c5e6bdde2() {
  var data = _taggedTemplateLiteral(['\n                  <button id="print" @click="', '">\n                    <span class="sr-only">Print table.</span>\n                    <simple-icon-lite icon="print"></simple-icon-lite>\n                  </button>\n                  <simple-tooltip\n                    id="print-tooltip"\n                    for="print"\n                    aria-hidden="true"\n                    >Print table.\n                  </simple-tooltip>\n                ']);

  _templateObject3_15389e30994411ebb1a5332c5e6bdde2 = function _templateObject3_15389e30994411ebb1a5332c5e6bdde2() {
    return data;
  };
...
function _templateObject2_15389e30994411ebb1a5332c5e6bdde2() {
  var data = _taggedTemplateLiteral(['\n                  <button id="download" @click="', '">\n                    <span class="sr-only">Download as CSV.</span>\n                    <simple-icon-lite icon="file-download"></simple-icon-lite>\n                  </button>\n                  <simple-tooltip\n                    id="download-tooltip"\n                    for="download"\n                    aria-hidden="true"\n                    >Download as CSV.\n                  </simple-tooltip>\n                ']);

  _templateObject2_15389e30994411ebb1a5332c5e6bdde2 = function _templateObject2_15389e30994411ebb1a5332c5e6bdde2() {
    return data;
  };
...
function _templateObject_15389e30994411ebb1a5332c5e6bdde2() {
  var data = _taggedTemplateLiteral(['\n      <table\n        id="table"\n        ?bordered="', '"\n        class="table"\n        ?column-header="', '"\n        ?column-striped="', '"\n        ?condensed="', '"\n        ?filter="', '"\n        ?footer="', '"\n        ?hidden="', '"\n        ?numeric-styles="', '"\n        ?row-header="', '"\n        ?sort="', '"\n        ?striped="', '"\n      >\n        <caption>\n          <div>\n            <div>', '</div>\n            <simple-picker\n              id="column"\n              align-right\n              aria-label="Select Column"\n              @change="', '"\n              hide-sample\n              .options="', '"\n              .value="', '"\n            >\n            </simple-picker>\n            ', "\n            ", '\n          </div>\n        </caption>\n        <thead ?hidden="', '" class="thead">\n          <tr class="tr thead-tr">\n            ', '\n          </tr>\n        </thead>\n        <tbody class="tbody">\n          ', "\n        </tbody>\n        ", '\n      </table>\n      <div id="htmlImport" hidden><slot></slot></div>\n    ']);

  _templateObject_15389e30994411ebb1a5332c5e6bdde2 = function _templateObject_15389e30994411ebb1a5332c5e6bdde2() {
    return data;
  };
...
var EditableTableDisplay = /*#__PURE__*/function (_displayBehaviors) {
  ...
  _createClass(EditableTableDisplay, [{
    ...
    value: function render() {
      ...
      return (0, _litElement.html)(_templateObject_15389e30994411ebb1a5332c5e6bdde2(), this.bordered, this.columnHeader, this.columnStriped, this.condensed, this.filter, this.footer, this.hidden, this.numericStyles, this.rowHeader, this.sort, this.striped, this.getHTML(this.caption), this._selectedChanged, this.options, this.selected, !this.downloadable ? "" : (0, _litElement.html)(_templateObject2_15389e30994411ebb1a5332c5e6bdde2(), this.download), !this.printable ? "" : (0, _litElement.html)(_templateObject3_15389e30994411ebb1a5332c5e6bdde2(), this.print), !this.columnHeader, (this.thead[0] || []).map(function (th, index) {
        return (0, _litElement.html)(_templateObject4_15389e30994411ebb1a5332c5e6bdde2(), index, _this2._isNumericColumn(index), _this2._isColHidden(index, 1), !_this2.sort ? _this2.getHTML(_this2._replaceBlankCell(th)) : (0, _litElement.html)(_templateObject5_15389e30994411ebb1a5332c5e6bdde2(), index, _this2.sortColumn, _this2.getHTML(_this2._replaceBlankCell(th))));
      }), this.tbody.map(function (tr) {
        return _this2._isRowFiltered(tr) ? "" : _this2._tbodyTr(tr);
      }), !this.footer ? "" : (0, _litElement.html)(_templateObject6_15389e30994411ebb1a5332c5e6bdde2(), this._tbodyTr(this.tfoot[0], true, true)));
    }
  }], [{
    key: "styles",
    get: function get() {
  ...
  _createClass(EditableTableDisplay, [{
    ...
    value: function _tbodyTr() {
      ...
      return (0, _litElement.html)(_templateObject7_15389e30994411ebb1a5332c5e6bdde2(), tfoot ? "tfoot-tr" : "tbody-tr", row.map(function (cell, index) {
    ...
    value: function _tbodyTh(cell, index) {
      return (0, _litElement.html)(_templateObject8_15389e30994411ebb1a5332c5e6bdde2(), index, this._isNumericColumn(index), this._isColHidden(index, 1), this.getHTML(this._replaceBlankCell(cell)));
    }
    /**
     * table cell template
     *
    ...
    value: function _tbodyTd(cell, index) {
      ...
      return (0, _litElement.html)(_templateObject9_15389e30994411ebb1a5332c5e6bdde2(), index, this._isNumericColumn(index), this._isNegative(cell), this._isColHidden(index, 1), this.filter ? (0, _litElement.html)(_templateObject10_15389e30994411ebb1a5332c5e6bdde2(), index, this._isCellFiltered(index, this.filterColumn, this.filtered), this.getHTML(this._replaceBlankCell(cell))) : !noFilter ? (0, _litElement.html)(_templateObject11_15389e30994411ebb1a5332c5e6bdde2(), this.getHTML(this._replaceBlankCell(cell))) : this.getHTML(this._replaceBlankCell(cell)));
    }
    /**
