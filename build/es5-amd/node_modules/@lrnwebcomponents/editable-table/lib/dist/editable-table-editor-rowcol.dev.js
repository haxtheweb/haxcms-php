...
function _templateObject4_f0a4adb039ed11ed89d1c353cb18487d() {
  ...
  _templateObject4_f0a4adb039ed11ed89d1c353cb18487d = function _templateObject4_f0a4adb039ed11ed89d1c353cb18487d() {
    return data;
  };
...
function _templateObject3_f0a4adb039ed11ed89d1c353cb18487d() {
  var data = _taggedTemplateLiteral(['<span class="offscreen">', "</span>"]);

  _templateObject3_f0a4adb039ed11ed89d1c353cb18487d = function _templateObject3_f0a4adb039ed11ed89d1c353cb18487d() {
    return data;
  };
...
function _templateObject2_f0a4adb039ed11ed89d1c353cb18487d() {
  var data = _taggedTemplateLiteral(['<a11y-menu-button-item\n      @click="', '"\n    >\n      ', "\n      ", "", "\n      ", "\n    </a11y-menu-button-item>"]);

  _templateObject2_f0a4adb039ed11ed89d1c353cb18487d = function _templateObject2_f0a4adb039ed11ed89d1c353cb18487d() {
    return data;
  };
...
function _templateObject_f0a4adb039ed11ed89d1c353cb18487d() {
  ...
  _templateObject_f0a4adb039ed11ed89d1c353cb18487d = function _templateObject_f0a4adb039ed11ed89d1c353cb18487d() {
    return data;
  };
...
var EditableTableEditorRowcol = /*#__PURE__*/function (_cellBehaviors) {
  ...
  _createClass(EditableTableEditorRowcol, [{
    ...
    value: function render() {
      return (0, _litElement.html)(_templateObject_f0a4adb039ed11ed89d1c353cb18487d(), this.row ? "right" : "bottom", this._onOpen, this.type, this.label || "", this._getItem(), this._getItem(false, true), this._getItem(true));
    }
  }, {
    key: "rowColAction",
    ...
    value: function _getItem() {
      ...
      return (0, _litElement.html)(_templateObject2_f0a4adb039ed11ed89d1c353cb18487d(), deleteItem ? this._onDelete : after ? this._onInsertAfter : this._onInsertBefore, deleteItem ? "Delete" : "Insert", this.type, deleteItem ? " " : after ? " After " : " Before ", this.labelInfo);
    }
  }, {
    key: "_onOpen",
    ...
    key: "labelInfo",
    get: function get() {
      return (0, _litElement.html)(_templateObject3_f0a4adb039ed11ed89d1c353cb18487d(), this.label);
    }
    /**
     *
    ...
    key: "styles",
    get: function get() {
      return [].concat(_toConsumableArray(_get(_getPrototypeOf(EditableTableEditorRowcol), "styles", this) || []), _toConsumableArray(_editableTableBehaviors.editableTableCellStyles), [(0, _litElement.css)(_templateObject4_f0a4adb039ed11ed89d1c353cb18487d())]);
    }
  }, {
    key: "tag",
    get: function get() {
