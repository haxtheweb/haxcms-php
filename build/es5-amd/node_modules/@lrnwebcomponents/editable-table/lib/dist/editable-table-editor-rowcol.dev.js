...
function _templateObject4_f57f3cd0ce4311eca4dffb3bcb5f42ec() {
  ...
  _templateObject4_f57f3cd0ce4311eca4dffb3bcb5f42ec = function _templateObject4_f57f3cd0ce4311eca4dffb3bcb5f42ec() {
    return data;
  };
...
function _templateObject3_f57f3cd0ce4311eca4dffb3bcb5f42ec() {
  var data = _taggedTemplateLiteral(['<span class="offscreen">', "</span>"]);

  _templateObject3_f57f3cd0ce4311eca4dffb3bcb5f42ec = function _templateObject3_f57f3cd0ce4311eca4dffb3bcb5f42ec() {
    return data;
  };
...
function _templateObject2_f57f3cd0ce4311eca4dffb3bcb5f42ec() {
  var data = _taggedTemplateLiteral(['<a11y-menu-button-item\n      @click="', '"\n    >\n      ', "\n      ", "", "\n      ", "\n    </a11y-menu-button-item>"]);

  _templateObject2_f57f3cd0ce4311eca4dffb3bcb5f42ec = function _templateObject2_f57f3cd0ce4311eca4dffb3bcb5f42ec() {
    return data;
  };
...
function _templateObject_f57f3cd0ce4311eca4dffb3bcb5f42ec() {
  ...
  _templateObject_f57f3cd0ce4311eca4dffb3bcb5f42ec = function _templateObject_f57f3cd0ce4311eca4dffb3bcb5f42ec() {
    return data;
  };
...
var EditableTableEditorRowcol = /*#__PURE__*/function (_cellBehaviors) {
  ...
  _createClass(EditableTableEditorRowcol, [{
    ...
    value: function render() {
      return (0, _litElement.html)(_templateObject_f57f3cd0ce4311eca4dffb3bcb5f42ec(), this.row ? "right" : "bottom", this._onOpen, this.type, this.label || "", this._getItem(), this._getItem(false, true), this._getItem(true));
    }
  }, {
    key: "rowColAction",
    ...
    value: function _getItem() {
      ...
      return (0, _litElement.html)(_templateObject2_f57f3cd0ce4311eca4dffb3bcb5f42ec(), deleteItem ? this._onDelete : after ? this._onInsertAfter : this._onInsertBefore, deleteItem ? "Delete" : "Insert", this.type, deleteItem ? " " : after ? " After " : " Before ", this.labelInfo);
    }
  }, {
    key: "_onOpen",
    ...
    key: "labelInfo",
    get: function get() {
      return (0, _litElement.html)(_templateObject3_f57f3cd0ce4311eca4dffb3bcb5f42ec(), this.label);
    }
    /**
     *
    ...
    key: "styles",
    get: function get() {
      return [].concat(_toConsumableArray(_get(_getPrototypeOf(EditableTableEditorRowcol), "styles", this) || []), _toConsumableArray(_editableTableBehaviors.editableTableCellStyles), [(0, _litElement.css)(_templateObject4_f57f3cd0ce4311eca4dffb3bcb5f42ec())]);
    }
  }, {
    key: "tag",
    get: function get() {
