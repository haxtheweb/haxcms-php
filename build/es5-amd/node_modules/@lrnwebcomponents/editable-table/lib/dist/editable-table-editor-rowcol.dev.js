...
function _templateObject4_153e91a0994411ebb1a5332c5e6bdde2() {
  ...
  _templateObject4_153e91a0994411ebb1a5332c5e6bdde2 = function _templateObject4_153e91a0994411ebb1a5332c5e6bdde2() {
    return data;
  };
...
function _templateObject3_153e91a0994411ebb1a5332c5e6bdde2() {
  var data = _taggedTemplateLiteral(['<span class="sr-only">', "</span>"]);

  _templateObject3_153e91a0994411ebb1a5332c5e6bdde2 = function _templateObject3_153e91a0994411ebb1a5332c5e6bdde2() {
    return data;
  };
...
function _templateObject2_153e91a0994411ebb1a5332c5e6bdde2() {
  var data = _taggedTemplateLiteral([' <a11y-menu-button-item\n      @click="', '"\n    >\n      ', "\n      ", "", "\n      ", "\n    </a11y-menu-button-item>"]);

  _templateObject2_153e91a0994411ebb1a5332c5e6bdde2 = function _templateObject2_153e91a0994411ebb1a5332c5e6bdde2() {
    return data;
  };
...
function _templateObject_153e91a0994411ebb1a5332c5e6bdde2() {
  var data = _taggedTemplateLiteral(['\n      <button\n        id="menubutton"\n        aria-haspopup="true"\n        aria-controls="menu"\n        aria-expanded="', '"\n      >\n        <span class="sr-only">', '</span>\n        <span id="label">', ' </span>\n        <span class="sr-only">Menu</span>\n        <simple-icon-lite icon="arrow-drop-down"></simple-icon-lite>\n      </button>\n      <absolute-position-behavior\n        ?auto="', '"\n        class="', '"\n        for="menubutton"\n        position="', '"\n        position-align="', '"\n        offset="-3"\n      >\n        <ul\n          id="menu"\n          role="menu"\n          aria-labelledby="menubutton"\n          ?hidden="', '"\n          @mousover="', '"\n          @mousout="', '"\n        >\n          ', " ", "\n          ", "\n        </ul>\n      </absolute-position-behavior>\n    "]);

  _templateObject_153e91a0994411ebb1a5332c5e6bdde2 = function _templateObject_153e91a0994411ebb1a5332c5e6bdde2() {
    return data;
  };
...
var EditableTableEditorRowcol = /*#__PURE__*/function (_cellBehaviors) {
  ...
  _createClass(EditableTableEditorRowcol, [{
    ...
    value: function render() {
      ...
      return (0, _litElement.html)(_templateObject_153e91a0994411ebb1a5332c5e6bdde2(), this.expanded ? "true" : "false", this.type, this.label || "", this.expanded, this.row ? "row" : "column", this.row ? "right" : "bottom", this.row ? "start" : "center", !this.expanded, function (e) {
    ...
    value: function _getItem() {
      ...
      return (0, _litElement.html)(_templateObject2_153e91a0994411ebb1a5332c5e6bdde2(), deleteItem ? this._onDelete : after ? this._onInsertAfter : this._onInsertBefore, deleteItem ? "Delete" : "Insert", this.type, deleteItem ? " " : after ? " After " : " Before ", this.labelInfo);
    }
    /**
    ...
    key: "labelInfo",
    get: function get() {
      return (0, _litElement.html)(_templateObject3_153e91a0994411ebb1a5332c5e6bdde2(), this.label);
    }
    /**
     *
    ...
    key: "styles",
    get: function get() {
      return [].concat(_toConsumableArray(_get(_getPrototypeOf(EditableTableEditorRowcol), "styles", this) || []), _toConsumableArray(_editableTableBehaviors.editableTableCellStyles), [(0, _litElement.css)(_templateObject4_153e91a0994411ebb1a5332c5e6bdde2())]);
    }
  }, {
    key: "tag",
    get: function get() {
