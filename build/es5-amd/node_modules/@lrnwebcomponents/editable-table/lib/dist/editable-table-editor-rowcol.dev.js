...
function _templateObject4_bcf7b5a0b2b411eb9e5c9b5d1881fac2() {
  ...
  _templateObject4_bcf7b5a0b2b411eb9e5c9b5d1881fac2 = function _templateObject4_bcf7b5a0b2b411eb9e5c9b5d1881fac2() {
    return data;
  };
...
function _templateObject3_bcf7b5a0b2b411eb9e5c9b5d1881fac2() {
  var data = _taggedTemplateLiteral(['<span class="sr-only">', "</span>"]);

  _templateObject3_bcf7b5a0b2b411eb9e5c9b5d1881fac2 = function _templateObject3_bcf7b5a0b2b411eb9e5c9b5d1881fac2() {
    return data;
  };
...
function _templateObject2_bcf7b5a0b2b411eb9e5c9b5d1881fac2() {
  var data = _taggedTemplateLiteral(['<a11y-menu-button-item\n      @click="', '"\n    >\n      ', "\n      ", "", "\n      ", "\n    </a11y-menu-button-item>"]);

  _templateObject2_bcf7b5a0b2b411eb9e5c9b5d1881fac2 = function _templateObject2_bcf7b5a0b2b411eb9e5c9b5d1881fac2() {
    return data;
  };
...
function _templateObject_bcf7b5a0b2b411eb9e5c9b5d1881fac2() {
  ...
  _templateObject_bcf7b5a0b2b411eb9e5c9b5d1881fac2 = function _templateObject_bcf7b5a0b2b411eb9e5c9b5d1881fac2() {
    return data;
  };
...
var EditableTableEditorRowcol = /*#__PURE__*/function (_cellBehaviors) {
  ...
  _createClass(EditableTableEditorRowcol, [{
    ...
    value: function render() {
      return (0, _litElement.html)(_templateObject_bcf7b5a0b2b411eb9e5c9b5d1881fac2(), this.row ? "right" : "bottom", this._onOpen, this.type, this.label || "", this._getItem(), this._getItem(false, true), this._getItem(true));
    }
  }, {
    key: "rowColAction",
    ...
    value: function _getItem() {
      ...
      return (0, _litElement.html)(_templateObject2_bcf7b5a0b2b411eb9e5c9b5d1881fac2(), deleteItem ? this._onDelete : after ? this._onInsertAfter : this._onInsertBefore, deleteItem ? "Delete" : "Insert", this.type, deleteItem ? " " : after ? " After " : " Before ", this.labelInfo);
    }
  }, {
    key: "_onOpen",
    ...
    key: "labelInfo",
    get: function get() {
      return (0, _litElement.html)(_templateObject3_bcf7b5a0b2b411eb9e5c9b5d1881fac2(), this.label);
    }
    /**
     *
    ...
    key: "styles",
    get: function get() {
      return [].concat(_toConsumableArray(_get(_getPrototypeOf(EditableTableEditorRowcol), "styles", this) || []), _toConsumableArray(_editableTableBehaviors.editableTableCellStyles), [(0, _litElement.css)(_templateObject4_bcf7b5a0b2b411eb9e5c9b5d1881fac2())]);
    }
  }, {
    key: "tag",
    get: function get() {
