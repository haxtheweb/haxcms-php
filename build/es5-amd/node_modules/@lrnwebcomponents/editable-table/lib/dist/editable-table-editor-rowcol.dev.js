...
function _templateObject4_8f940640509711edb124eb517be36dbf() {
  ...
  _templateObject4_8f940640509711edb124eb517be36dbf = function _templateObject4_8f940640509711edb124eb517be36dbf() {
    return data;
  };
...
function _templateObject3_8f940640509711edb124eb517be36dbf() {
  var data = _taggedTemplateLiteral(['<span class="offscreen">', "</span>"]);

  _templateObject3_8f940640509711edb124eb517be36dbf = function _templateObject3_8f940640509711edb124eb517be36dbf() {
    return data;
  };
...
function _templateObject2_8f940640509711edb124eb517be36dbf() {
  var data = _taggedTemplateLiteral(['<a11y-menu-button-item\n      @click="', '"\n    >\n      ', "\n      ", "", "\n      ", "\n    </a11y-menu-button-item>"]);

  _templateObject2_8f940640509711edb124eb517be36dbf = function _templateObject2_8f940640509711edb124eb517be36dbf() {
    return data;
  };
...
function _templateObject_8f940640509711edb124eb517be36dbf() {
  ...
  _templateObject_8f940640509711edb124eb517be36dbf = function _templateObject_8f940640509711edb124eb517be36dbf() {
    return data;
  };
...
var EditableTableEditorRowcol = /*#__PURE__*/function (_cellBehaviors) {
  ...
  _createClass(EditableTableEditorRowcol, [{
    ...
    value: function render() {
      return (0, _litElement.html)(_templateObject_8f940640509711edb124eb517be36dbf(), this.row ? "right" : "bottom", this._onOpen, this.type, this.label || "", this._getItem(), this._getItem(false, true), this._getItem(true));
    }
  }, {
    key: "rowColAction",
    ...
    value: function _getItem() {
      ...
      return (0, _litElement.html)(_templateObject2_8f940640509711edb124eb517be36dbf(), deleteItem ? this._onDelete : after ? this._onInsertAfter : this._onInsertBefore, deleteItem ? "Delete" : "Insert", this.type, deleteItem ? " " : after ? " After " : " Before ", this.labelInfo);
    }
  }, {
    key: "_onOpen",
    ...
    key: "labelInfo",
    get: function get() {
      return (0, _litElement.html)(_templateObject3_8f940640509711edb124eb517be36dbf(), this.label);
    }
    /**
     *
    ...
    key: "styles",
    get: function get() {
      return [].concat(_toConsumableArray(_get(_getPrototypeOf(EditableTableEditorRowcol), "styles", this) || []), _toConsumableArray(_editableTableBehaviors.editableTableCellStyles), [(0, _litElement.css)(_templateObject4_8f940640509711edb124eb517be36dbf())]);
    }
  }, {
    key: "tag",
    get: function get() {
