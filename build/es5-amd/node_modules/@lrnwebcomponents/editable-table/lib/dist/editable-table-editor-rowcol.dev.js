...
function _templateObject4_c7055a80403311edb9fff3e6b08a0a9a() {
  ...
  _templateObject4_c7055a80403311edb9fff3e6b08a0a9a = function _templateObject4_c7055a80403311edb9fff3e6b08a0a9a() {
    return data;
  };
...
function _templateObject3_c7055a80403311edb9fff3e6b08a0a9a() {
  var data = _taggedTemplateLiteral(['<span class="offscreen">', "</span>"]);

  _templateObject3_c7055a80403311edb9fff3e6b08a0a9a = function _templateObject3_c7055a80403311edb9fff3e6b08a0a9a() {
    return data;
  };
...
function _templateObject2_c7055a80403311edb9fff3e6b08a0a9a() {
  var data = _taggedTemplateLiteral(['<a11y-menu-button-item\n      @click="', '"\n    >\n      ', "\n      ", "", "\n      ", "\n    </a11y-menu-button-item>"]);

  _templateObject2_c7055a80403311edb9fff3e6b08a0a9a = function _templateObject2_c7055a80403311edb9fff3e6b08a0a9a() {
    return data;
  };
...
function _templateObject_c7055a80403311edb9fff3e6b08a0a9a() {
  ...
  _templateObject_c7055a80403311edb9fff3e6b08a0a9a = function _templateObject_c7055a80403311edb9fff3e6b08a0a9a() {
    return data;
  };
...
var EditableTableEditorRowcol = /*#__PURE__*/function (_cellBehaviors) {
  ...
  _createClass(EditableTableEditorRowcol, [{
    ...
    value: function render() {
      return (0, _litElement.html)(_templateObject_c7055a80403311edb9fff3e6b08a0a9a(), this.row ? "right" : "bottom", this._onOpen, this.type, this.label || "", this._getItem(), this._getItem(false, true), this._getItem(true));
    }
  }, {
    key: "rowColAction",
    ...
    value: function _getItem() {
      ...
      return (0, _litElement.html)(_templateObject2_c7055a80403311edb9fff3e6b08a0a9a(), deleteItem ? this._onDelete : after ? this._onInsertAfter : this._onInsertBefore, deleteItem ? "Delete" : "Insert", this.type, deleteItem ? " " : after ? " After " : " Before ", this.labelInfo);
    }
  }, {
    key: "_onOpen",
    ...
    key: "labelInfo",
    get: function get() {
      return (0, _litElement.html)(_templateObject3_c7055a80403311edb9fff3e6b08a0a9a(), this.label);
    }
    /**
     *
    ...
    key: "styles",
    get: function get() {
      return [].concat(_toConsumableArray(_get(_getPrototypeOf(EditableTableEditorRowcol), "styles", this) || []), _toConsumableArray(_editableTableBehaviors.editableTableCellStyles), [(0, _litElement.css)(_templateObject4_c7055a80403311edb9fff3e6b08a0a9a())]);
    }
  }, {
    key: "tag",
    get: function get() {
