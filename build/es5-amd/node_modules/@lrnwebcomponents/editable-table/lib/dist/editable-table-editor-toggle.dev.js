...
function _templateObject2_d2826a408b3211ebb67059cf696085af() {
  ...
  _templateObject2_d2826a408b3211ebb67059cf696085af = function _templateObject2_d2826a408b3211ebb67059cf696085af() {
    return data;
  };
...
function _templateObject_d2826a408b3211ebb67059cf696085af() {
  var data = _taggedTemplateLiteral(['\n      <button\n        id="button"\n        ?active="', '"\n        ?disabled="', '"\n        label="', '"\n        toggles\n        @click="', '"\n      >\n        <span class="sr-only">', '</span>\n        <simple-icon-lite\n          icon="', '"\n          aria-hidden="true"\n        ></simple-icon-lite>\n      </button>\n      <simple-tooltip id="tooltip" for="button" aria-hidden="true"\n        >', "</simple-tooltip\n      >\n    "]);

  _templateObject_d2826a408b3211ebb67059cf696085af = function _templateObject_d2826a408b3211ebb67059cf696085af() {
    return data;
  };
...
var EditableTableEditorToggle = /*#__PURE__*/function (_LitElement) {
  ...
  _createClass(EditableTableEditorToggle, [{
    ...
    value: function render() {
      return (0, _litElement.html)(_templateObject_d2826a408b3211ebb67059cf696085af(), this.toggled, this.disabled, this.label, this._onClick, this.label, this.icon, this.label);
    }
  }, {
    key: "_onClick",
    ...
    key: "styles",
    get: function get() {
      return [].concat(_toConsumableArray(_get(_getPrototypeOf(EditableTableEditorToggle), "styles", this) || []), [(0, _litElement.css)(_templateObject2_d2826a408b3211ebb67059cf696085af())]);
    }
  }, {
    key: "tag",
    get: function get() {
