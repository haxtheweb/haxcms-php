...
function _templateObject2_f5841ed0ce4311eca4dffb3bcb5f42ec() {
  ...
  _templateObject2_f5841ed0ce4311eca4dffb3bcb5f42ec = function _templateObject2_f5841ed0ce4311eca4dffb3bcb5f42ec() {
    return data;
  };
...
function _templateObject_f5841ed0ce4311eca4dffb3bcb5f42ec() {
  var data = _taggedTemplateLiteral(['\n      <button\n        id="button"\n        ?active="', '"\n        ?disabled="', '"\n        label="', '"\n        toggles\n        @click="', '"\n      >\n        <span class="offscreen">', '</span>\n        <simple-icon-lite\n          icon="', '"\n          aria-hidden="true"\n        ></simple-icon-lite>\n      </button>\n      <simple-tooltip id="tooltip" for="button" aria-hidden="true"\n        >', "</simple-tooltip\n      >\n    "]);

  _templateObject_f5841ed0ce4311eca4dffb3bcb5f42ec = function _templateObject_f5841ed0ce4311eca4dffb3bcb5f42ec() {
    return data;
  };
...
var EditableTableEditorToggle = /*#__PURE__*/function (_LitElement) {
  ...
  _createClass(EditableTableEditorToggle, [{
    ...
    value: function render() {
      return (0, _litElement.html)(_templateObject_f5841ed0ce4311eca4dffb3bcb5f42ec(), this.toggled, this.disabled, this.label, this._onClick, this.label, this.icon, this.label);
    }
  }, {
    key: "_onClick",
    ...
    key: "styles",
    get: function get() {
      return [].concat(_toConsumableArray(_get(_getPrototypeOf(EditableTableEditorToggle), "styles", this) || []), [(0, _litElement.css)(_templateObject2_f5841ed0ce4311eca4dffb3bcb5f42ec())]);
    }
  }, {
    key: "tag",
    get: function get() {
