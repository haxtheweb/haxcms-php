...
function _templateObject2_c7077d60403311edb9fff3e6b08a0a9a() {
  ...
  _templateObject2_c7077d60403311edb9fff3e6b08a0a9a = function _templateObject2_c7077d60403311edb9fff3e6b08a0a9a() {
    return data;
  };
...
function _templateObject_c7077d60403311edb9fff3e6b08a0a9a() {
  var data = _taggedTemplateLiteral(['\n      <button\n        id="button"\n        ?active="', '"\n        ?disabled="', '"\n        label="', '"\n        toggles\n        @click="', '"\n      >\n        <span class="offscreen">', '</span>\n        <simple-icon-lite\n          icon="', '"\n          aria-hidden="true"\n        ></simple-icon-lite>\n      </button>\n      <simple-tooltip id="tooltip" for="button" aria-hidden="true"\n        >', "</simple-tooltip\n      >\n    "]);

  _templateObject_c7077d60403311edb9fff3e6b08a0a9a = function _templateObject_c7077d60403311edb9fff3e6b08a0a9a() {
    return data;
  };
...
var EditableTableEditorToggle = /*#__PURE__*/function (_LitElement) {
  ...
  _createClass(EditableTableEditorToggle, [{
    ...
    value: function render() {
      return (0, _litElement.html)(_templateObject_c7077d60403311edb9fff3e6b08a0a9a(), this.toggled, this.disabled, this.label, this._onClick, this.label, this.icon, this.label);
    }
  }, {
    key: "_onClick",
    ...
    key: "styles",
    get: function get() {
      return [].concat(_toConsumableArray(_get(_getPrototypeOf(EditableTableEditorToggle), "styles", this) || []), [(0, _litElement.css)(_templateObject2_c7077d60403311edb9fff3e6b08a0a9a())]);
    }
  }, {
    key: "tag",
    get: function get() {
