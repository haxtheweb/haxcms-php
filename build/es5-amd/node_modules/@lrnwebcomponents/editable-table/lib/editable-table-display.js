define(["exports", "require", "../../../lit/index.js", "./editable-table-behaviors.js", "../../responsive-utility/lib/responsive-utility-behaviors.js", "../../simple-picker/simple-picker.js", "../../simple-toolbar/lib/simple-toolbar-button.js"], function (_exports, _require, _index, _editableTableBehaviors, _responsiveUtilityBehaviors, _simplePicker, _simpleToolbarButton) {
  ...
  var _templateObject_e2dcd8b039ed11ed89d1c353cb18487d, _templateObject2_e2dcd8b039ed11ed89d1c353cb18487d, _templateObject3_e2dcd8b039ed11ed89d1c353cb18487d, _templateObject4_e2dcd8b039ed11ed89d1c353cb18487d, _templateObject5_e2dcd8b039ed11ed89d1c353cb18487d, _templateObject6_e2dcd8b039ed11ed89d1c353cb18487d, _templateObject7_e2dcd8b039ed11ed89d1c353cb18487d, _templateObject8_e2dcd8b039ed11ed89d1c353cb18487d, _templateObject9_e2dcd8b039ed11ed89d1c353cb18487d, _templateObject10_e2dcd8b039ed11ed89d1c353cb18487d, _templateObject11_e2dcd8b039ed11ed89d1c353cb18487d, _templateObject12_e2dcd8b039ed11ed89d1c353cb18487d, _templateObject13_e2dcd8b039ed11ed89d1c353cb18487d;
  ...
  var EditableTableDisplay = /*#__PURE__*/function (_displayBehaviors) {
    ...
    babelHelpers.createClass(EditableTableDisplay, [{
      ...
      value: function render() {
        ...
        return (0, _index.html)(_templateObject_e2dcd8b039ed11ed89d1c353cb18487d || (_templateObject_e2dcd8b039ed11ed89d1c353cb18487d = babelHelpers.taggedTemplateLiteral(["\n      <table\n        id=\"table\"\n        ?bordered=\"", "\"\n        class=\"table\"\n        ?column-header=\"", "\"\n        ?column-striped=\"", "\"\n        ?condensed=\"", "\"\n        ?filter=\"", "\"\n        ?footer=\"", "\"\n        ?hidden=\"", "\"\n        ?numeric-styles=\"", "\"\n        ?row-header=\"", "\"\n        ?sort=\"", "\"\n        ?striped=\"", "\"\n        part=\"table\"\n      >\n        <caption part=\"caption\">\n          <div>\n            <div>", "</div>\n            <div>\n              ", "\n              ", "\n            </div>\n          </div>\n        </caption>\n        <thead ?hidden=\"", "\" class=\"thead\" part=\"thead\">\n          <tr class=\"tr thead-tr\" part=\"tr\">\n            ", "\n          </tr>\n        </thead>\n        <tbody class=\"tbody\" part=\"tbody\">\n          ", "\n        </tbody>\n        ", "\n      </table>\n      <div id=\"htmlImport\" hidden><slot></slot></div>\n    "])), this.bordered, this.columnHeader, this.columnStriped, this.condensed, this.filter, this.footer, this.hidden || this.disabled, this.numericStyles, this.rowHeader, this.sort, this.striped, this.getHTML(this.caption), !this.downloadable ? "" : (0, _index.html)(_templateObject2_e2dcd8b039ed11ed89d1c353cb18487d || (_templateObject2_e2dcd8b039ed11ed89d1c353cb18487d = babelHelpers.taggedTemplateLiteral(["\n                    <simple-toolbar-button\n                      id=\"download\"\n                      icon=\"file-download\"\n                      label=\"Download as CSV.\"\n                      @click=\"", "\"\n                    >\n                    </simple-toolbar-button>\n                  "])), this.download), !this.printable ? "" : (0, _index.html)(_templateObject3_e2dcd8b039ed11ed89d1c353cb18487d || (_templateObject3_e2dcd8b039ed11ed89d1c353cb18487d = babelHelpers.taggedTemplateLiteral(["\n                    <simple-toolbar-button\n                      id=\"print\"\n                      icon=\"print\"\n                      label=\"Print Table\"\n                      @click=\"", "\"\n                    >\n                    </simple-toolbar-button>\n                  "])), this.print), !this.columnHeader, (this.thead[0] || []).map(function (th, index) {
          return (0, _index.html)(_templateObject4_e2dcd8b039ed11ed89d1c353cb18487d || (_templateObject4_e2dcd8b039ed11ed89d1c353cb18487d = babelHelpers.taggedTemplateLiteral(["\n                <th\n                  class=\"th th-or-td\"\n                  cell-index=\"", "\"\n                  ?numeric=\"", "\"\n                  scope=\"col\"\n                  part=\"th\"\n                  ?xs-hidden=\"", "\"\n                >\n                  ", "\n                  ", "\n                </th>\n              "])), index, _this2._isNumericColumn(index), _this2._isColHidden(index, _this2.selected || 1), !_this2.sort ? _this2.getHTML(_this2._replaceBlankCell(th)) : (0, _index.html)(_templateObject5_e2dcd8b039ed11ed89d1c353cb18487d || (_templateObject5_e2dcd8b039ed11ed89d1c353cb18487d = babelHelpers.taggedTemplateLiteral(["\n                        <editable-table-sort\n                          column-index=\"", "\"\n                          sort-column=\"", "\"\n                          sort-mode=\"", "\"\n                        >\n                          ", "\n                        </editable-table-sort>\n                      "])), index, _this2.sortColumn, _this2.sortColumn === index ? _this2.sortMode : "none", _this2.getHTML(_this2._replaceBlankCell(th))), !_this2.disableResponsive && index > 0 && _this2.selected == index ? (0, _index.html)(_templateObject6_e2dcd8b039ed11ed89d1c353cb18487d || (_templateObject6_e2dcd8b039ed11ed89d1c353cb18487d = babelHelpers.taggedTemplateLiteral([" <simple-picker\n                          id=\"simple-picker-", "\"\n                          class=\"column\"\n                          align-right\n                          aria-label=\"Select Column\"\n                          @change=\"", "\"\n                          hide-sample\n                          .options=\"", "\"\n                          .value=\"", "\"\n                        >\n                        </simple-picker>\n                        <simple-tooltip\n                          position=\"top\"\n                          for=\"simple-picker-", "\"\n                          aria-hidden=\"true\"\n                          >Select Column</simple-tooltip\n                        >"])), index, _this2._selectedChanged, _this2.options, index, index) : "");
        }), this.sortedTbody.map(function (tr) {
          return _this2._isRowFiltered(tr) ? "" : _this2._tbodyTr(tr);
        }), !this.footer ? "" : (0, _index.html)(_templateObject7_e2dcd8b039ed11ed89d1c353cb18487d || (_templateObject7_e2dcd8b039ed11ed89d1c353cb18487d = babelHelpers.taggedTemplateLiteral(["\n              <tfoot class=\"tfoot\" part=\"tfoot\">\n                ", "\n              </tfoot>\n            "])), this._tbodyTr(this.tfoot[0], true, true)));
      }
    }, {
      key: "updated",
      ...
      value: function _tbodyTr() {
        ...
        return (0, _index.html)(_templateObject8_e2dcd8b039ed11ed89d1c353cb18487d || (_templateObject8_e2dcd8b039ed11ed89d1c353cb18487d = babelHelpers.taggedTemplateLiteral(["\n      <tr class=\"tr ", "\">\n        ", "\n      </tr>\n    "])), tfoot ? "tfoot-tr" : "tbody-tr", row.map(function (cell, index) {
      ...
      value: function _tbodyTh(cell, index) {
        return (0, _index.html)(_templateObject9_e2dcd8b039ed11ed89d1c353cb18487d || (_templateObject9_e2dcd8b039ed11ed89d1c353cb18487d = babelHelpers.taggedTemplateLiteral(["<th\n      class=\"th th-or-td\"\n      cell-index=\"", "\"\n      ?numeric=\"", "\"\n      scope=\"row\"\n      ?xs-hidden=\"", "\"\n    >\n      ", "\n    </th>"])), index, this._isNumericColumn(index), this._isColHidden(index, this.selected || 1), this.getHTML(this._replaceBlankCell(cell)));
      }
      /**
       * table cell template
       *
      ...
      value: function _tbodyTd(cell, index) {
        ...
        return (0, _index.html)(_templateObject10_e2dcd8b039ed11ed89d1c353cb18487d || (_templateObject10_e2dcd8b039ed11ed89d1c353cb18487d = babelHelpers.taggedTemplateLiteral(["<td\n      part=\"td\"\n      class=\"td th-or-td\"\n      cell-index=\"", "\"\n      ?numeric=\"", "\"\n      ?negative=\"", "\"\n      ?xs-hidden=\"", "\"\n    >\n      ", "\n    </td>"])), index, this._isNumericColumn(index), this._isNegative(cell), this._isColHidden(index, this.selected || 1), this.filter ? (0, _index.html)(_templateObject11_e2dcd8b039ed11ed89d1c353cb18487d || (_templateObject11_e2dcd8b039ed11ed89d1c353cb18487d = babelHelpers.taggedTemplateLiteral(["\n            <editable-table-filter\n              class=\"cell\"\n              column-index=\"", "\"\n              text=\"", "\"\n              ?toggled=\"", "\"\n            >\n              ", "\n            </editable-table-filter>\n          "])), index, this._replaceBlankCell(cell), this._isCellFiltered(index, this.filterColumn, this.filtered), this.getHTML(this._replaceBlankCell(cell))) : !noFilter ? (0, _index.html)(_templateObject12_e2dcd8b039ed11ed89d1c353cb18487d || (_templateObject12_e2dcd8b039ed11ed89d1c353cb18487d = babelHelpers.taggedTemplateLiteral(["<span class=\"cell\"\n            >", "</span\n          >"])), this.getHTML(this._replaceBlankCell(cell))) : this.getHTML(this._replaceBlankCell(cell)));
      }
      /**
