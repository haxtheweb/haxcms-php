...
*/(0,_polymerLegacy.Polymer)({_template:(0,_polymerLegacy.html)(_templateObject_b64ccaf06b8111e98ce155804ade6153()),is:"editable-table-filter",listeners:{tap:"_onFilterTapped"},properties:{/**
   ...
   */_getPressed:function _getPressed(filtered){return filtered?"true":"false"},/**
   * listen for button tap
   */_onFilterTapped:function _onFilterTapped(){var root=this;root.fire("toggle-filter",root)}})});