...
*/(0,_polymerLegacy.Polymer)({_template:(0,_polymerLegacy.html)(_templateObject_6da562f062ec11e9ba56c1f762879bb4()),is:"editable-table-sort",listeners:{tap:"_onSortTapped"},properties:{/**
   ...
   */_onSortTapped:function _onSortTapped(){var root=this;root.fire("change-sort-mode",root)},/**
   * changes the sort mode
   */setSortMode:function setSortMode(mode){this.sortMode=mode;this.__checked="asc"===mode?!0:"desc"===mode?mode:!1},/**
   * Is the column number is the same as the current sort column?
   */_isSorting:function _isSorting(columnNumber,sortColumn){return columnNumber===sortColumn}})});