define(["../../../@polymer/polymer/polymer-legacy.js","../../../@polymer/paper-button/paper-button.js"],function(_polymerLegacy,_paperButton){"use strict";function _templateObject_10e2c6c066fc11e984d945fe2fe0aa60(){var data=babelHelpers.taggedTemplateLiteral(["\n    <style>\n      :host {\n        display: block;\n      }\n      :host paper-button {\n        display: block;\n        text-transform: none;\n        text-align: left;\n      }\n    </style>\n    <paper-button><slot></slot></paper-button>\n  "]);_templateObject_10e2c6c066fc11e984d945fe2fe0aa60=function _templateObject_10e2c6c066fc11e984d945fe2fe0aa60(){return data};return data}/**
...
*/(0,_polymerLegacy.Polymer)({_template:(0,_polymerLegacy.html)(_templateObject_10e2c6c066fc11e984d945fe2fe0aa60()),is:"editable-table-editor-insdel",listeners:{tap:"_onTap"},properties:{/**
   ...
   * Handle item tap
   */_onTap:function _onTap(e){var root=this,action=root.action,type=root.type,before=root.before,index=root.index,event=action+"-"+type.toLowerCase();if("insert"===action&&before&&"Row"===type){index--}else if("insert"===action&&!before&&"Row"!==type){index++}root.fire(event,index)}})});