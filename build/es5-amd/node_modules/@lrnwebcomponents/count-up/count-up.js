define(["exports", "../../lit/index.js", "../intersection-element/lib/IntersectionObserverMixin.js", "./lib/countup.js"], function (_exports, _index, _IntersectionObserverMixin, _countup) {
  ...
  var _templateObject_d1dcc2d0a0c911eda392efd0bad1b4bf, _templateObject2_d1dcc2d0a0c911eda392efd0bad1b4bf;
  ...
  var CountUpElement = /*#__PURE__*/function (_IntersectionObserver) {
    ...
    babelHelpers.createClass(CountUpElement, [{
      ...
      // render function
      function render() {
        return (0, _index.html)(_templateObject_d1dcc2d0a0c911eda392efd0bad1b4bf || (_templateObject_d1dcc2d0a0c911eda392efd0bad1b4bf = babelHelpers.taggedTemplateLiteral([" <div class=\"wrapper\">\n      <slot name=\"prefix\"></slot>\n      <div id=\"counter\"></div>\n      <slot name=\"suffix\"></slot>\n    </div>"])));
      }
      ...
      //styles function
      function get() {
        return [(0, _index.css)(_templateObject2_d1dcc2d0a0c911eda392efd0bad1b4bf || (_templateObject2_d1dcc2d0a0c911eda392efd0bad1b4bf = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: inline-flex;\n          --count-up-color: #000000;\n        }\n\n        :host([hidden]) {\n          display: none;\n        }\n\n        .wrapper {\n          display: block;\n          text-align: center;\n          width: 100%;\n          height: 100%;\n        }\n\n        #counter {\n          color: var(--count-up-color);\n          font-weight: var(--count-up-number-font-weight);\n          font-size: var(--count-up-number-font-size);\n        }\n      "])))];
      }
    }, {
      key: "haxProperties",
      get: function get() {
