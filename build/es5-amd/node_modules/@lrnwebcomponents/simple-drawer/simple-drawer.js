define(["exports", "../../lit-element/lit-element.js", "../simple-colors/simple-colors.js", "../../@polymer/polymer/lib/elements/custom-style.js", "../../@polymer/app-layout/app-drawer/app-drawer.js", "../simple-icon/simple-icon.js", "../simple-icon/lib/simple-icons.js"], function (_exports, _litElement, _simpleColors, _customStyle, _appDrawer, _simpleIcon, _simpleIcons) {
  ...
  var _templateObject_a269b4e0b72d11eb858e736d8681b490, _templateObject2_a269b4e0b72d11eb858e736d8681b490, _templateObject3_a269b4e0b72d11eb858e736d8681b490;
  ...
  var SimpleDrawer = /*#__PURE__*/function (_SimpleColors) {
    ...
    babelHelpers.createClass(SimpleDrawer, [{
      ...
      function render() {
        return (0, _litElement.html)(_templateObject_a269b4e0b72d11eb858e736d8681b490 || (_templateObject_a269b4e0b72d11eb858e736d8681b490 = babelHelpers.taggedTemplateLiteral([" <custom-style>\n        <style>\n          app-drawer {\n            --app-drawer-content-container: {\n              padding: 0;\n              overflow-y: scroll;\n              position: fixed;\n              color: var(--simple-drawer-color, #222222);\n              background-color: var(--simple-drawer-background-color, #ffffff);\n            }\n          }\n          :host ::slotted(*) {\n            @apply --simple-drawer-content;\n          }\n\n          .content {\n            @apply --simple-drawer-content-container;\n          }\n          .top {\n            @apply --simple-drawer-header;\n          }\n\n          .top h2 {\n            @apply --simple-drawer-heading;\n          }\n        </style>\n      </custom-style>\n      <app-drawer\n        tabindex=\"0\"\n        id=\"drawer\"\n        ?opened=\"", "\"\n        @opened-changed=\"", "\"\n        .align=\"", "\"\n        role=\"dialog\"\n      >\n        <div class=\"wrapper\">\n          <div class=\"top\">\n            ", "\n            <slot name=\"header\"></slot>\n          </div>\n          <div class=\"content\">\n            <slot name=\"content\"></slot>\n          </div>\n          <button id=\"close\" @click=\"", "\">\n            <simple-icon\n              icon=\"", "\"\n              dark\n              contrast=\"4\"\n            ></simple-icon>\n            ", "\n          </button>\n        </div>\n      </app-drawer>"])), this.opened, this.__openedChanged, this.align, this.title ? (0, _litElement.html)(_templateObject2_a269b4e0b72d11eb858e736d8681b490 || (_templateObject2_a269b4e0b72d11eb858e736d8681b490 = babelHelpers.taggedTemplateLiteral(["<h2>", "</h2>"])), this.title) : "", this.close, this.closeIcon, this.closeLabel);
