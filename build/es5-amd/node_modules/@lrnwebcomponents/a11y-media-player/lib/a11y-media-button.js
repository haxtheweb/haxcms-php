define(["exports", "require", "../../../lit-element/lit-element.js", "../../../@polymer/iron-icons/iron-icons.js", "../../../@polymer/iron-icons/av-icons.js"], function (_exports, _require, _litElement, _ironIcons, _avIcons) {
  ...
  function _templateObject4_7e7b95f0bff611eaa5854beb4e0c914c() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        #button {\n          margin: 0;\n          border: none;\n        }\n        .sr-only {\n          position: absolute;\n          left: -99999;\n          top: 0;\n          height: 0;\n          width: 0;\n          overflow: hidden;\n        }\n        simple-tooltip {\n          z-index: 100;\n        }\n        simple-tooltip:not(:defined) {\n          display: none;\n        }\n      "]);

    _templateObject4_7e7b95f0bff611eaa5854beb4e0c914c = function _templateObject4_7e7b95f0bff611eaa5854beb4e0c914c() {
      return data;
    };
  ...
  function _templateObject3_7e7b95f0bff611eaa5854beb4e0c914c() {
    ...
    _templateObject3_7e7b95f0bff611eaa5854beb4e0c914c = function _templateObject3_7e7b95f0bff611eaa5854beb4e0c914c() {
      return data;
    };
  ...
  function _templateObject2_7e7b95f0bff611eaa5854beb4e0c914c() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            <simple-tooltip for=\"button\" position=\"", "\"\n              >", "</simple-tooltip\n            >\n          "]);

    _templateObject2_7e7b95f0bff611eaa5854beb4e0c914c = function _templateObject2_7e7b95f0bff611eaa5854beb4e0c914c() {
      return data;
    };
  ...
  function _templateObject_7e7b95f0bff611eaa5854beb4e0c914c() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <button\n        id=\"button\"\n        aria-label=\"", "\"\n        aria-pressed=\"", "\"\n        controls=\"", "\"\n        tabindex=\"0\"\n        @click=\"", "\"\n        ?disabled=\"", "\"\n        ?toggle=\"", "\"\n      >\n        <iron-icon icon=\"", "\"></iron-icon>\n      </button>\n      ", "\n    "]);

    _templateObject_7e7b95f0bff611eaa5854beb4e0c914c = function _templateObject_7e7b95f0bff611eaa5854beb4e0c914c() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(A11yMediaButton, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_7e7b95f0bff611eaa5854beb4e0c914c(), this.label, this.toggle ? "true" : "false", this.controls, this._buttonClick, this.disabled, this.toggle, this.icon, this.label ? (0, _litElement.html)(_templateObject2_7e7b95f0bff611eaa5854beb4e0c914c(), this.tooltipPosition, this.label) : "");
      }
      /**
      ...
      key: "styles",
      get: function get() {
        return [this.buttonStyles, (0, _litElement.css)(_templateObject3_7e7b95f0bff611eaa5854beb4e0c914c())];
      }
    }, {
      key: "buttonStyles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject4_7e7b95f0bff611eaa5854beb4e0c914c())];
      }
    }]);
