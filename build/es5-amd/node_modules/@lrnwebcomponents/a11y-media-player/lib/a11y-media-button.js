define(["exports", "require", "../../../lit-element/lit-element.js", "../../simple-icon/lib/simple-icon-lite.js", "../../simple-icon/lib/simple-icons.js"], function (_exports, _require, _litElement, _simpleIconLite, _simpleIcons) {
  ...
  function _templateObject4_275496a03ee511ebb7f7a1171f0cd59d() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        #button {\n          margin: 0;\n          border: none;\n        }\n        .sr-only {\n          position: absolute;\n          left: -99999;\n          top: 0;\n          height: 0;\n          width: 0;\n          overflow: hidden;\n        }\n        simple-tooltip {\n          z-index: 100;\n        }\n        simple-tooltip:not(:defined) {\n          display: none;\n        }\n      "]);

    _templateObject4_275496a03ee511ebb7f7a1171f0cd59d = function _templateObject4_275496a03ee511ebb7f7a1171f0cd59d() {
      return data;
    };
  ...
  function _templateObject3_275496a03ee511ebb7f7a1171f0cd59d() {
    ...
    _templateObject3_275496a03ee511ebb7f7a1171f0cd59d = function _templateObject3_275496a03ee511ebb7f7a1171f0cd59d() {
      return data;
    };
  ...
  function _templateObject2_275496a03ee511ebb7f7a1171f0cd59d() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            <simple-tooltip for=\"button\" position=\"", "\"\n              >", "</simple-tooltip\n            >\n          "]);

    _templateObject2_275496a03ee511ebb7f7a1171f0cd59d = function _templateObject2_275496a03ee511ebb7f7a1171f0cd59d() {
      return data;
    };
  ...
  function _templateObject_275496a03ee511ebb7f7a1171f0cd59d() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <button\n        id=\"button\"\n        aria-label=\"", "\"\n        aria-pressed=\"", "\"\n        controls=\"", "\"\n        tabindex=\"0\"\n        @click=\"", "\"\n        ?disabled=\"", "\"\n        ?toggle=\"", "\"\n      >\n        <simple-icon-lite icon=\"", "\"></simple-icon-lite>\n      </button>\n      ", "\n    "]);

    _templateObject_275496a03ee511ebb7f7a1171f0cd59d = function _templateObject_275496a03ee511ebb7f7a1171f0cd59d() {
      return data;
    };
  ...
  var A11yMediaButton = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(A11yMediaButton, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_275496a03ee511ebb7f7a1171f0cd59d(), this.label, this.toggle ? "true" : "false", this.controls, this._buttonClick, this.disabled, this.toggle, this.icon, this.label ? (0, _litElement.html)(_templateObject2_275496a03ee511ebb7f7a1171f0cd59d(), this.tooltipPosition, this.label) : "");
      }
      /**
      ...
      key: "styles",
      get: function get() {
        return [this.buttonStyles, (0, _litElement.css)(_templateObject3_275496a03ee511ebb7f7a1171f0cd59d())];
      }
    }, {
      key: "buttonStyles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject4_275496a03ee511ebb7f7a1171f0cd59d())];
      }
    }]);
