 ...
 */var A11yMediaTranscript=/*#__PURE__*/function(_A11yMediaBehaviors){babelHelpers.inherits(A11yMediaTranscript,_A11yMediaBehaviors);function A11yMediaTranscript(){babelHelpers.classCallCheck(this,A11yMediaTranscript);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(A11yMediaTranscript).apply(this,arguments))}babelHelpers.createClass(A11yMediaTranscript,[{key:"connectedCallback",/**
   ...
   *
   * @param {string} the title of the media
   */},{key:"print",value:function print(mediaTitle){var root=this,track=root.shadowRoot.querySelector("#track[active]").cloneNode(!0),css=(0,_polymerElement.html)(_templateObject_7301ff80784811e9a4b64111d3b898a6()),h1=(0,_polymerElement.html)(_templateObject2_7301ff80784811e9a4b64111d3b898a6());if(mediaTitle!==void 0)h1.innerHTML=mediaTitle;if(null!==track&track!==void 0){//From https://stackoverflow.com/questions/1071962/how-do-i-print-part-of-a-rendered-html-page-in-javascript#answer-1072151
...
},{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject3_7301ff80784811e9a4b64111d3b898a6())}}]);return A11yMediaTranscript}(_a11yMediaBehaviors.A11yMediaBehaviors);_exports.A11yMediaTranscript=A11yMediaTranscript;window.customElements.define(A11yMediaTranscript.tag,A11yMediaTranscript)});