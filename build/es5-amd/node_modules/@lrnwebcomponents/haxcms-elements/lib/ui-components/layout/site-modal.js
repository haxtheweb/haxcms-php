define(["exports", "require", "../../../../../lit-element/lit-element.js", "../../../../simple-modal/lib/simple-modal-template.js", "../../../../simple-icon/simple-icon.js", "../../../../simple-icon/lib/simple-icons.js", "../../../../simple-icon/lib/simple-icon-button.js"], function (_exports, _require, _litElement, _simpleModalTemplate, _simpleIcon, _simpleIcons, _simpleIconButton) {
  ...
  function _templateObject2_d6b59aa02dd211eba8a9dbdc0fc9b6e0() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <simple-icon-button\n        ?disabled=\"", "\"\n        id=\"btn\"\n        ?dark=\"", "\"\n        accent-color=\"", "\"\n        @click=\"", "\"\n        .icon=\"", "\"\n        .title=\"", "\"\n      ></simple-icon-button>\n      <simple-tooltip for=\"btn\" .position=\"", "\" offset=\"14\">\n        ", "\n      </simple-tooltip>\n      <simple-modal-template id=\"smt\" .title=\"", "\">\n        <div id=\"content\" slot=\"content\"></div>\n      </simple-modal-template>\n    "]);

    _templateObject2_d6b59aa02dd211eba8a9dbdc0fc9b6e0 = function _templateObject2_d6b59aa02dd211eba8a9dbdc0fc9b6e0() {
      return data;
    };
  ...
  function _templateObject_d6b59aa02dd211eba8a9dbdc0fc9b6e0() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n        simple-icon-button {\n          color: var(--site-modal-icon-color);\n        }\n      "]);

    _templateObject_d6b59aa02dd211eba8a9dbdc0fc9b6e0 = function _templateObject_d6b59aa02dd211eba8a9dbdc0fc9b6e0() {
      return data;
    };
  ...
  var SiteModal = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(SiteModal, null, [{
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject_d6b59aa02dd211eba8a9dbdc0fc9b6e0())];
      }
      /**
    ...
    babelHelpers.createClass(SiteModal, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_d6b59aa02dd211eba8a9dbdc0fc9b6e0(), this.editMode, this.dark, this.accentColor, this.fireEvent, this.icon, this.buttonLabel, this.position, this.buttonLabel, this.title);
      }
      /**
