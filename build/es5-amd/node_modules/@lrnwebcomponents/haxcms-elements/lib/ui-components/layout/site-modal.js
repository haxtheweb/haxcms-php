define(["exports", "require", "../../../../../lit-element/lit-element.js", "../../../../../@polymer/polymer/lib/utils/flattened-nodes-observer.js", "../../../../simple-modal/lib/simple-modal-template.js", "../../../../../@polymer/paper-icon-button/paper-icon-button.js", "../../../../../@polymer/polymer/lib/elements/custom-style.js"], function (_exports, _require, _litElement, _flattenedNodesObserver, _simpleModalTemplate, _paperIconButton, _customStyle) {
  ...
  function _templateObject2_9b5c437034ed11eabe39ef50dfa8db3f() {
    ...
    _templateObject2_9b5c437034ed11eabe39ef50dfa8db3f = function _templateObject2_9b5c437034ed11eabe39ef50dfa8db3f() {
      return data;
    };
  ...
  function _templateObject_9b5c437034ed11eabe39ef50dfa8db3f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n        paper-icon-button {\n          color: var(--site-modal-icon-color);\n        }\n      "]);

    _templateObject_9b5c437034ed11eabe39ef50dfa8db3f = function _templateObject_9b5c437034ed11eabe39ef50dfa8db3f() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(SiteModal, null, [{
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject_9b5c437034ed11eabe39ef50dfa8db3f())];
      }
      /**
    ...
    babelHelpers.createClass(SiteModal, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_9b5c437034ed11eabe39ef50dfa8db3f(), this.editMode, this.fireEvent, this.icon, this.buttonLabel, this.position, this.buttonLabel, this.title);
      }
      /**
