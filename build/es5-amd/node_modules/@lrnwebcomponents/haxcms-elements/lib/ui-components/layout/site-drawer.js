define(["exports", "require", "../../../../../lit/index.js", "../../../../simple-icon/simple-icon.js", "../../../../simple-icon/lib/simple-icons.js", "../../../../simple-icon/lib/simple-icon-button.js"], function (_exports, _require, _index, _simpleIcon, _simpleIcons, _simpleIconButton) {
  ...
  var _templateObject_6b043180e8f211edb01b473406559cea, _templateObject2_6b043180e8f211edb01b473406559cea;
  ...
  var SiteDrawer = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(SiteDrawer, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_6b043180e8f211edb01b473406559cea || (_templateObject_6b043180e8f211edb01b473406559cea = babelHelpers.taggedTemplateLiteral(["\n      <simple-icon-button\n        icon=\"", "\"\n        @click=\"", "\"\n      ></simple-icon-button>\n      <app-drawer align=\"", "\">\n        <div class=\"drawer-contents\"><slot></slot></div>\n      </app-drawer>\n    "])), this.icon, this.toggle, this.align);
      }
    }, {
      key: "toggle",
       ...
       */
      function get() {
        return [(0, _index.css)(_templateObject2_6b043180e8f211edb01b473406559cea || (_templateObject2_6b043180e8f211edb01b473406559cea = babelHelpers.taggedTemplateLiteral(["\n        .drawer-contents {\n          height: 100%;\n          overflow-y: auto;\n          padding: 16px;\n        }\n        simple-icon-button {\n          color: var(--site-drawer-button-color, #ffffff);\n        }\n        app-drawer {\n          background-color: #eeeeee;\n          --app-drawer-scrim-background: #eeeeee;\n          --app-drawer-width: var(--site-drawer-width, 300px);\n        }\n      "])))];
      }
    }, {
      key: "tag",
      get: function get() {
