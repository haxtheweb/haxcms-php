define(["exports", "../../../../page-contents-menu/page-contents-menu.js", "../../core/utils/HAXCMSThemeParts.js", "../../core/haxcms-site-store.js", "../../../../../mobx/dist/mobx.esm.js", "../../../../../lit/index.js"], function (_exports, _pageContentsMenu, _HAXCMSThemeParts2, _haxcmsSiteStore, _mobxEsm, _index) {
  ...
  var _templateObject_09ff4f4039ee11ed89d1c353cb18487d, _templateObject2_09ff4f4039ee11ed89d1c353cb18487d;
  ...
  var SiteMenuContent = /*#__PURE__*/function (_HAXCMSThemeParts) {
    ...
    babelHelpers.createClass(SiteMenuContent, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_09ff4f4039ee11ed89d1c353cb18487d || (_templateObject_09ff4f4039ee11ed89d1c353cb18487d = babelHelpers.taggedTemplateLiteral(["\n      <div .part=\"", "\">\n        ", "\n      </div>\n    "])), this.editMode ? "edit-mode-active" : "", babelHelpers.get(babelHelpers.getPrototypeOf(SiteMenuContent.prototype), "render", this).call(this));
      }
    }], [{
      key: "tag",
      get: function get() {
      ...
      key: "styles",
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(SiteMenuContent), "styles", this)), [(0, _index.css)(_templateObject2_09ff4f4039ee11ed89d1c353cb18487d || (_templateObject2_09ff4f4039ee11ed89d1c353cb18487d = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          --page-contents-menu-link-hover: var(\n            --haxcms-color,\n            var(--simple-colors-default-theme-purple-7)\n          );\n        }\n        .contents {\n          max-height: 80vh;\n          border-bottom: 2px solid lightgray;\n          max-width: 240px;\n        }\n        @media screen and (max-width: 600px) {\n          .indent-1,\n          .indent-2,\n          .indent-3,\n          .indent-4,\n          .indent-5,\n          .indent-6 {\n            padding-left: 0;\n          }\n        }\n        :host([hide-if-empty][is-empty]) {\n          display: none !important;\n        }\n        :host([mobile]) .item {\n          max-width: 240px;\n        }\n        :host([mobile]) simple-popover {\n          --simple-popover-max-height: 200px;\n          --simple-popover-max-width: 240px;\n          overflow: hidden;\n          top: 0px !important;\n        }\n      "])))]);
      }
    }]);
