define(["exports", "../../../../../lit-element/lit-element.js", "../../../../../@polymer/iron-list/iron-list.js", "./site-query.js"], function (_exports, _litElement, _ironList, _siteQuery) {
  ...
  function _templateObject2_8eb8b0b0bff611eaa5854beb4e0c914c() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n      "]);

    _templateObject2_8eb8b0b0bff611eaa5854beb4e0c914c = function _templateObject2_8eb8b0b0bff611eaa5854beb4e0c914c() {
      return data;
    };
  ...
  function _templateObject_8eb8b0b0bff611eaa5854beb4e0c914c() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <site-query\n        .result=\"", "\"\n        @result-changed=\"", "\"\n        .sort=\"", "\"\n        .conditions=\"", "\"\n      ></site-query>\n      <iron-list\n        id=\"list\"\n        .items=\"", "\"\n        ?grid=\"", "\"\n        mutable-data\n      >\n        <slot></slot>\n      </iron-list>\n    "]);

    _templateObject_8eb8b0b0bff611eaa5854beb4e0c914c = function _templateObject_8eb8b0b0bff611eaa5854beb4e0c914c() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(SiteRenderQuery, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_8eb8b0b0bff611eaa5854beb4e0c914c(), this.result, this.resultEvent, this.sort, this.conditions, this.__items, this.grid);
      }
    }, {
      key: "resultEvent",
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_8eb8b0b0bff611eaa5854beb4e0c914c())];
      }
      /**
