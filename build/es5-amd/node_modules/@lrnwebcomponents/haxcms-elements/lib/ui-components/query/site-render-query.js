define(["exports", "../../../../../lit/index.js", "../../../../../@polymer/iron-list/iron-list.js", "./site-query.js"], function (_exports, _index, _ironList, _siteQuery) {
  ...
  var _templateObject_8d284690d3e211ed8e5073e3aa96f674, _templateObject2_8d284690d3e211ed8e5073e3aa96f674;
  ...
  var SiteRenderQuery = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(SiteRenderQuery, [{
      ...
      function render() {
        return (0, _index.html)(_templateObject_8d284690d3e211ed8e5073e3aa96f674 || (_templateObject_8d284690d3e211ed8e5073e3aa96f674 = babelHelpers.taggedTemplateLiteral(["\n      <site-query\n        .result=\"", "\"\n        @result-changed=\"", "\"\n        .sort=\"", "\"\n        .conditions=\"", "\"\n      ></site-query>\n      <iron-list\n        id=\"list\"\n        .items=\"", "\"\n        ?grid=\"", "\"\n        mutable-data\n      >\n        <slot></slot>\n      </iron-list>\n    "])), this.result, this.resultEvent, this.sort, this.conditions, this.__items, this.grid);
      }
    }, {
      key: "resultEvent",
       ...
       */
      function get() {
        return [(0, _index.css)(_templateObject2_8d284690d3e211ed8e5073e3aa96f674 || (_templateObject2_8d284690d3e211ed8e5073e3aa96f674 = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n      "])))];
      }
      /**
