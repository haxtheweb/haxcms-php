define(["exports", "../../../../../lit/index.js", "../../core/haxcms-site-store.js", "../../core/utils/HAXCMSI18NMixin.js", "../../../../utils/utils.js", "../../../../micro-frontend-registry/lib/microServices.js", "../../../../micro-frontend-registry/micro-frontend-registry.js"], function (_exports, _index, _haxcmsSiteStore, _HAXCMSI18NMixin2, _utils, _microServices, _microFrontendRegistry) {
  "use strict";
  ...
  var _templateObject_45e69b40669311ed886745d23fee48e5, _templateObject2_45e69b40669311ed886745d23fee48e5, _templateObject3_45e69b40669311ed886745d23fee48e5;
  ...
  var SiteRemoteContent = /*#__PURE__*/function (_HAXCMSI18NMixin) {
    ...
    function SiteRemoteContent() {
      ...
      _this.loading = false;
      _this.uuid = null;
      _this.siteurl = 'https://haxtheweb.org/';
    ...
    */
    ...
    babelHelpers.createClass(SiteRemoteContent, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_45e69b40669311ed886745d23fee48e5 || (_templateObject_45e69b40669311ed886745d23fee48e5 = babelHelpers.taggedTemplateLiteral(["\n    <div class=\"loading\"></div>\n    ", "\n    <div id=\"content\"></div>\n    "])), this.showTitle && this._remoteTitle ? (0, _index.html)(_templateObject2_45e69b40669311ed886745d23fee48e5 || (_templateObject2_45e69b40669311ed886745d23fee48e5 = babelHelpers.taggedTemplateLiteral(["<h3>", "</h3>"])), this._remoteTitle) : "");
      }
    }, {
      key: "updated",
      value: function updated(changedProperties) {
        ...
        changedProperties.forEach(function (oldValue, propName) {
          if (propName === 'uuid' && _this2[propName]) {
            _this2.loading = true; // when UUID changes, remote load the content from it, replacing our own light dom material
      ...
      value: function renderContentResponse(response) {
        if (response.data) {
          ...
          div.innerHTML = (0, _utils.encapScript)(response.data.content); // append as child of this element
      ...
      */
      ...
      value: function () {
        var _haxsetupActiveElementForm = babelHelpers.asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(props) {
          ...
          var itemManifest, response, items;
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  itemManifest = []; // support remore vs local look up
                ...
                case 9:
                  itemManifest = _haxcmsSiteStore.store.getManifestItems(true);
