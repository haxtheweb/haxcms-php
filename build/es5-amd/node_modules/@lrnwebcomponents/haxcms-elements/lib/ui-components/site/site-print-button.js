define(["exports", "require", "../../../../../lit-element/lit-element.js", "../../core/haxcms-site-store.js", "../../core/utils/HAXCMSThemeParts.js"], function (_exports, _require, _litElement, _haxcmsSiteStore, _HAXCMSThemeParts2) {
  ...
  function _templateObject2_bb9cd1d0e0c411ea988d4b7e2b2c0fe2() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <paper-icon-button\n        .id=\"btn", "\"\n        icon=\"", "\"\n        @click=\"", "\"\n        aria-label=\"", "\"\n        ?disabled=\"", "\"\n        .part=\"", "\"\n      ></paper-icon-button>\n      <simple-tooltip\n        .for=\"btn", "\"\n        position=\"", "\"\n        offset=\"14\"\n      >\n        ", "\n      </simple-tooltip>\n    "]);

    _templateObject2_bb9cd1d0e0c411ea988d4b7e2b2c0fe2 = function _templateObject2_bb9cd1d0e0c411ea988d4b7e2b2c0fe2() {
      return data;
    };
  ...
  function _templateObject_bb9cd1d0e0c411ea988d4b7e2b2c0fe2() {
    ...
    _templateObject_bb9cd1d0e0c411ea988d4b7e2b2c0fe2 = function _templateObject_bb9cd1d0e0c411ea988d4b7e2b2c0fe2() {
      return data;
    };
  ...
  function (_HAXCMSThemeParts) {
    ...
    babelHelpers.createClass(SitePrintButton, null, [{
       ...
       */
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(SitePrintButton), "styles", this)), [(0, _litElement.css)(_templateObject_bb9cd1d0e0c411ea988d4b7e2b2c0fe2())]);
      }
      /**
    ...
    babelHelpers.createClass(SitePrintButton, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_bb9cd1d0e0c411ea988d4b7e2b2c0fe2(), this.type, this.icon, this.print, this.label, this.disabled, this.editMode ? "edit-mode-active" : "", this.type, this.position, this.label);
      }
    }, {
      key: "updated",
