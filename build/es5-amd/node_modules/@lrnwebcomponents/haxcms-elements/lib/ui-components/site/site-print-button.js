define(["exports", "../../../../../lit/index.js", "../../core/utils/HAXCMSThemeParts.js", "../../core/utils/HAXCMSI18NMixin.js", "../../../../simple-icon/lib/simple-icons.js", "../../../../simple-icon/lib/simple-icon-button-lite.js", "../../../../simple-tooltip/simple-tooltip.js"], function (_exports, _index, _HAXCMSThemeParts, _HAXCMSI18NMixin2, _simpleIcons, _simpleIconButtonLite, _simpleTooltip) {
  ...
  var _templateObject_3ac9091059e111ec9ab2d54d61101c87, _templateObject2_3ac9091059e111ec9ab2d54d61101c87;
  ...
  var SitePrintButton = /*#__PURE__*/function (_HAXCMSI18NMixin) {
    ...
    babelHelpers.createClass(SitePrintButton, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_3ac9091059e111ec9ab2d54d61101c87 || (_templateObject_3ac9091059e111ec9ab2d54d61101c87 = babelHelpers.taggedTemplateLiteral(["\n      <simple-icon-button-lite\n        .id=\"btn", "\"\n        icon=\"", "\"\n        @click=\"", "\"\n        label=\"", "\"\n        ?disabled=\"", "\"\n      ></simple-icon-button-lite>\n      <simple-tooltip\n        .for=\"btn", "\"\n        position=\"", "\"\n        offset=\"14\"\n      >\n        ", "\n      </simple-tooltip>\n    "])), this.type, this.icon, this.print, this.makeLabel(this.type, this.t), this.disabled, this.type, this.position, this.makeLabel(this.type, this.t));
      }
    }, {
      key: "updated",
       ...
       */
      function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(SitePrintButton), "styles", this)), [(0, _index.css)(_templateObject2_3ac9091059e111ec9ab2d54d61101c87 || (_templateObject2_3ac9091059e111ec9ab2d54d61101c87 = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: inline-flex;\n          text-rendering: optimizelegibility;\n          position: relative;\n          color: var(--site-print-button-color, inherit);\n        }\n        simple-icon-button {\n          color: var(--site-print-button-color, inherit);\n        }\n        simple-tooltip {\n          --simple-tooltip-background: var(\n            --haxcms-tooltip-background-color,\n            #000000\n          );\n          --simple-tooltip-opacity: 1;\n          --simple-tooltip-text-color: var(--haxcms-tooltip-color, #ffffff);\n          --simple-tooltip-delay-in: 0;\n          --simple-tooltip-border-radius: 0;\n        }\n      "])))]);
      }
      /**
