define(["exports", "require", "../../../../../lit-element/lit-element.js", "../../core/haxcms-site-store.js", "../../core/utils/HAXCMSThemeParts.js", "../../../../simple-icon/simple-icon.js", "../../../../simple-icon/lib/simple-icons.js", "../../../../simple-icon/lib/simple-icon-button.js"], function (_exports, _require, _litElement, _haxcmsSiteStore, _HAXCMSThemeParts2, _simpleIcon, _simpleIcons, _simpleIconButton) {
  ...
  function _templateObject2_d8a1b3302dd211eba8a9dbdc0fc9b6e0() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <simple-icon-button\n        .id=\"btn", "\"\n        icon=\"", "\"\n        @click=\"", "\"\n        aria-label=\"", "\"\n        ?disabled=\"", "\"\n        .part=\"", "\"\n      ></simple-icon-button>\n      <simple-tooltip\n        .for=\"btn", "\"\n        position=\"", "\"\n        offset=\"14\"\n      >\n        ", "\n      </simple-tooltip>\n    "]);

    _templateObject2_d8a1b3302dd211eba8a9dbdc0fc9b6e0 = function _templateObject2_d8a1b3302dd211eba8a9dbdc0fc9b6e0() {
      return data;
    };
  ...
  function _templateObject_d8a1b3302dd211eba8a9dbdc0fc9b6e0() {
    ...
    _templateObject_d8a1b3302dd211eba8a9dbdc0fc9b6e0 = function _templateObject_d8a1b3302dd211eba8a9dbdc0fc9b6e0() {
      return data;
    };
  ...
  var SitePrintButton = /*#__PURE__*/function (_HAXCMSThemeParts) {
    ...
    babelHelpers.createClass(SitePrintButton, null, [{
       ...
       */
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(SitePrintButton), "styles", this)), [(0, _litElement.css)(_templateObject_d8a1b3302dd211eba8a9dbdc0fc9b6e0())]);
      }
      /**
    ...
    babelHelpers.createClass(SitePrintButton, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_d8a1b3302dd211eba8a9dbdc0fc9b6e0(), this.type, this.icon, this.print, this.label, this.disabled, this.editMode ? "edit-mode-active" : "", this.type, this.position, this.label);
      }
    }, {
      key: "updated",
