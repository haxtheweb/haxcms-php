define(["exports", "require", "../../../../../lit-element/lit-element.js", "../../../../../@polymer/polymer/lib/elements/custom-style.js"], function (_exports, _require, _litElement, _customStyle) {
  ...
  function _templateObject5_2e677c60105511ea904acf434d973f11() {
    var data = babelHelpers.taggedTemplateLiteral(["\n          <a class=\"result\" .href=\"", "\">\n            <div class=\"title\">\n              ", "<span class=\"link-text\" aria-hidden=\"true\"\n                >(", ")</span\n              >\n            </div>\n            <div class=\"date\">\n              <simple-datetime format=\"M jS\" .timestamp=\"", "\" unix\n                >", "</simple-datetime\n              >\n            </div>\n            <p>", "..</p>\n          </a>\n        "]);

    _templateObject5_2e677c60105511ea904acf434d973f11 = function _templateObject5_2e677c60105511ea904acf434d973f11() {
      return data;
    };
  ...
  function _templateObject4_2e677c60105511ea904acf434d973f11() {
    var data = babelHelpers.taggedTemplateLiteral([""]);

    _templateObject4_2e677c60105511ea904acf434d973f11 = function _templateObject4_2e677c60105511ea904acf434d973f11() {
      return data;
    };
  ...
  function _templateObject3_2e677c60105511ea904acf434d973f11() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            Found ", " results.\n          "]);

    _templateObject3_2e677c60105511ea904acf434d973f11 = function _templateObject3_2e677c60105511ea904acf434d973f11() {
      return data;
    };
  ...
  function _templateObject2_2e677c60105511ea904acf434d973f11() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <custom-style>\n        <style>\n          .result {\n            @apply --site-search-result;\n          }\n          .result:hover,\n          .result:focus {\n            @apply --site-search-result-hover;\n          }\n          .result .title {\n            @apply --site-search-link-text;\n          }\n          .result .link-text {\n            @apply --site-search-link-text;\n          }\n        </style>\n      </custom-style>\n      <paper-input\n        id=\"search\"\n        always-float-label\n        label=\"Search\"\n        @value-changed=\"", "\"\n      >\n        <iron-icon icon=\"search\" slot=\"prefix\"></iron-icon>\n      </paper-input>\n      ", "\n      <lunr-search id=\"lunr\"></lunr-search>\n\n      ", "\n    "]);

    _templateObject2_2e677c60105511ea904acf434d973f11 = function _templateObject2_2e677c60105511ea904acf434d973f11() {
      return data;
    };
  ...
  function _templateObject_2e677c60105511ea904acf434d973f11() {
    ...
    _templateObject_2e677c60105511ea904acf434d973f11 = function _templateObject_2e677c60105511ea904acf434d973f11() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(SiteSearch, null, [{
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject_2e677c60105511ea904acf434d973f11())];
      }
      /**
    ...
    babelHelpers.createClass(SiteSearch, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_2e677c60105511ea904acf434d973f11(), this._searchValueChanged, this.search.length > 0 ? (0, _litElement.html)(_templateObject3_2e677c60105511ea904acf434d973f11(), this.__results.length) : (0, _litElement.html)(_templateObject4_2e677c60105511ea904acf434d973f11()), this.__results.map(function (item) {
          return (0, _litElement.html)(_templateObject5_2e677c60105511ea904acf434d973f11(), item.location, item.title, item.location, item.created, item.created, item.description);
        }));
      }
    }, {
