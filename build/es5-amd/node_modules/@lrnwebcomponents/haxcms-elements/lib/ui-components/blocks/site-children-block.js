define(["exports", "../../../../../lit/index.js", "../../core/haxcms-site-store.js", "../../../../../mobx/dist/mobx.esm.js", "../query/site-query-menu-slice.js"], function (_exports, _index, _haxcmsSiteStore, _mobxEsm, _siteQueryMenuSlice) {
  ...
  var _templateObject_1fff5120e4f511ed85766367b4d3e9fc, _templateObject2_1fff5120e4f511ed85766367b4d3e9fc, _templateObject3_1fff5120e4f511ed85766367b4d3e9fc;
  ...
  var SiteChildrenBlock = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(SiteChildrenBlock, [{
      ...
      value: function render() {
        var _this2 = this;
        return (0, _index.html)(_templateObject_1fff5120e4f511ed85766367b4d3e9fc || (_templateObject_1fff5120e4f511ed85766367b4d3e9fc = babelHelpers.taggedTemplateLiteral(["\n      <div class=\"wrapper\">\n        <site-query-menu-slice\n          @result-changed=\"", "\"\n          dynamic-methodology=\"", "\"\n          start=\"", "\"\n          end=\"", "\"\n          parent=\"", "\"\n          ?fixed-id=\"", "\"\n        ></site-query-menu-slice>\n        ", "\n      </div>\n    "])), this.resultChanged, this.dynamicMethodology, this.start, this.end, this.parent, this.fixedId, this.__items.map(function (item) {
          return (0, _index.html)(_templateObject2_1fff5120e4f511ed85766367b4d3e9fc || (_templateObject2_1fff5120e4f511ed85766367b4d3e9fc = babelHelpers.taggedTemplateLiteral(["\n            <div class=\"spacing\">\n              <a\n                data-id=\"", "\"\n                class=\"link\"\n                tabindex=\"-1\"\n                href=\"", "\"\n              >\n                <button noink=\"", "\">\n                  <div class=\"indent indent-", "\"></div>\n                  ", "\n                </button>\n              </a>\n            </div>\n          "])), item.id, item.slug, _this2.noink, item.indent, item.title);
        }));
      }
    }, {
      ...
      function _activeIdChanged(newValue) {
        if (newValue) {
          ...
          if (this.shadowRoot.querySelector('[data-id="' + newValue + '"]')) {
            ...
            var tmpItem = this.manifest.items.find(function (i) {
            ...
            while (el === null && tmpItem && tmpItem.parent != null) {
              ...
              tmpItem = this.manifest.items.find(function (i) {
      ...
      value: function updated(changedProperties) {
        ...
        changedProperties.forEach(function (oldValue, propName) {
          if (propName === "__items") {
            _this3.dispatchEvent(new CustomEvent("".concat(_this3[propName], "-changed"), {
              detail: _this3[propName]
            }));
          }
          if (propName === "_activeId" && _this3.shadowRoot) {
            _this3._activeIdChanged(_this3[(propName, oldValue)]);
          }
        });
      }
    }, {
      ...
      value: function connectedCallback() {
        ...
        setTimeout(function () {
          (0, _mobxEsm.autorun)(function (reaction) {
            _this4.activeId = (0, _mobxEsm.toJS)(_haxcmsSiteStore.store.activeId);
            _this4.__disposer.push(reaction);
          });
        }, 250);
      }
