define(["exports", "require", "../../../../../lit-element/lit-element.js", "../../core/haxcms-site-store.js", "../../../../../mobx/dist/mobx.esm.js", "../../../../utils/utils.js", "../../core/utils/HAXCMSThemeParts.js"], function (_exports, _require, _litElement, _haxcmsSiteStore, _mobxEsm, _utils, _HAXCMSThemeParts2) {
  ...
  function _templateObject2_3d54e9a03ee511ebb7f7a1171f0cd59d() {
    ...
    _templateObject2_3d54e9a03ee511ebb7f7a1171f0cd59d = function _templateObject2_3d54e9a03ee511ebb7f7a1171f0cd59d() {
      return data;
    };
  ...
  function _templateObject_3d54e9a03ee511ebb7f7a1171f0cd59d() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <git-corner\n        .part=\"", "\"\n        size=\"", "\"\n        alt=\"", "\"\n        ?circle=\"", "\"\n        source=\"", "\"\n      ></git-corner>\n    "]);

    _templateObject_3d54e9a03ee511ebb7f7a1171f0cd59d = function _templateObject_3d54e9a03ee511ebb7f7a1171f0cd59d() {
      return data;
    };
  ...
  var SiteGitCorner = /*#__PURE__*/function (_HAXCMSThemeParts) {
    ...
    babelHelpers.createClass(SiteGitCorner, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_3d54e9a03ee511ebb7f7a1171f0cd59d(), this.editMode ? "edit-mode-active" : "", this.size, this.alt, this.circle, this.activeGitFileLink);
      }
    }], [{
      key: "tag",
      get: function get() {
      ...
      key: "styles",
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(SiteGitCorner), "styles", this)), [(0, _litElement.css)(_templateObject2_3d54e9a03ee511ebb7f7a1171f0cd59d())]);
      }
    }]);
