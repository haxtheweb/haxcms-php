define(["exports", "require", "../../../../../lit-element/lit-element.js", "../../core/haxcms-site-store.js", "../../../../../mobx/dist/mobx.esm.js", "../../../../utils/utils.js", "../../core/utils/HAXCMSThemeParts.js"], function (_exports, _require, _litElement, _haxcmsSiteStore, _mobxEsm, _utils, _HAXCMSThemeParts2) {
  ...
  var _templateObject_beed6d60ad1d11ebb47045b99ace3b6f, _templateObject2_beed6d60ad1d11ebb47045b99ace3b6f;
  ...
  var SiteGitCorner = /*#__PURE__*/function (_HAXCMSThemeParts) {
    ...
    babelHelpers.createClass(SiteGitCorner, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_beed6d60ad1d11ebb47045b99ace3b6f || (_templateObject_beed6d60ad1d11ebb47045b99ace3b6f = babelHelpers.taggedTemplateLiteral(["\n      <git-corner\n        .part=\"", "\"\n        size=\"", "\"\n        alt=\"", "\"\n        ?circle=\"", "\"\n        source=\"", "\"\n      ></git-corner>\n    "])), this.editMode ? "edit-mode-active" : "", this.size, this.alt, this.circle, this.activeGitFileLink);
      }
    }, {
      ...
      key: "styles",
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(SiteGitCorner), "styles", this)), [(0, _litElement.css)(_templateObject2_beed6d60ad1d11ebb47045b99ace3b6f || (_templateObject2_beed6d60ad1d11ebb47045b99ace3b6f = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n          float: var(--site-git-corner-float);\n        }\n        :host([direction=\"right\"]) {\n          float: right;\n        }\n        :host([direction=\"left\"]) {\n          float: left;\n        }\n        git-corner {\n          --github-corner-color: var(--site-git-corner-color);\n          --github-corner-background: var(--site-git-corner-background);\n        }\n      "])))]);
      }
    }, {
      key: "properties",
      get: function get() {
