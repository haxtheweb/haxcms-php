define(["exports", "require", "../../../../../lit/index.js", "../../core/haxcms-site-store.js", "../../../../../mobx/dist/mobx.esm.js", "../../../../utils/utils.js", "../../core/utils/HAXCMSThemeParts.js", "../../core/utils/HAXCMSI18NMixin.js"], function (_exports, _require, _index, _haxcmsSiteStore, _mobxEsm, _utils, _HAXCMSThemeParts, _HAXCMSI18NMixin2) {
  ...
  var _templateObject_499e5ac0cd8211ecaf720fdc1a41727f, _templateObject2_499e5ac0cd8211ecaf720fdc1a41727f;
  ...
  var SiteGitCorner = /*#__PURE__*/function (_HAXCMSI18NMixin) {
    ...
    babelHelpers.createClass(SiteGitCorner, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_499e5ac0cd8211ecaf720fdc1a41727f || (_templateObject_499e5ac0cd8211ecaf720fdc1a41727f = babelHelpers.taggedTemplateLiteral(["\n      <git-corner\n        .part=\"", "\"\n        size=\"", "\"\n        alt=\"", "\"\n        ?circle=\"", "\"\n        source=\"", "\"\n      ></git-corner>\n    "])), this.editMode ? "edit-mode-active" : "", this.size, this.t.seePageSource, this.circle, this.activeGitFileLink);
      }
    }, {
      ...
      key: "styles",
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(SiteGitCorner), "styles", this)), [(0, _index.css)(_templateObject2_499e5ac0cd8211ecaf720fdc1a41727f || (_templateObject2_499e5ac0cd8211ecaf720fdc1a41727f = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n          float: var(--site-git-corner-float);\n        }\n        :host([direction=\"right\"]) {\n          float: right;\n        }\n        :host([direction=\"left\"]) {\n          float: left;\n        }\n        git-corner {\n          --github-corner-color: var(--site-git-corner-color);\n          --github-corner-background: var(--site-git-corner-background);\n        }\n      "])))]);
      }
    }, {
      key: "properties",
      get: function get() {
