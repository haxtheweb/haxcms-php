define(["exports", "../../../../lit-element/lit-element.js", "./haxcms-site-store.js", "../../../../mobx/dist/mobx.esm.js", "../../../json-outline-schema/json-outline-schema.js", "../../../editable-outline/editable-outline.js", "../../../simple-icon/simple-icon.js", "../../../simple-icon/lib/simple-icons.js"], function (_exports, _litElement, _haxcmsSiteStore, _mobxEsm, _jsonOutlineSchema, _editableOutline, _simpleIcon, _simpleIcons) {
  ...
  function _templateObject2_725c9ee03efe11eb800233a440abe59f() {
    ...
    _templateObject2_725c9ee03efe11eb800233a440abe59f = function _templateObject2_725c9ee03efe11eb800233a440abe59f() {
      return data;
    };
  ...
  function _templateObject_725c9ee03efe11eb800233a440abe59f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <editable-outline\n        id=\"outline\"\n        edit-mode\n        .hidden=\"", "\"\n        .items=\"", "\"\n      ></editable-outline>\n      <div class=\"buttons\">\n        <button id=\"savebtn\" @click=\"", "\">\n          <simple-icon icon=\"icons:save\" dark></simple-icon>Save\n        </button>\n        <button @click=\"", "\">\n          <simple-icon icon=\"icons:cancel\"></simple-icon>Cancel\n        </button>\n      </div>\n    "]);

    _templateObject_725c9ee03efe11eb800233a440abe59f = function _templateObject_725c9ee03efe11eb800233a440abe59f() {
      return data;
    };
  ...
  var HAXCMSOutlineEditorDialog = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(HAXCMSOutlineEditorDialog, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_725c9ee03efe11eb800233a440abe59f(), this.viewMode, this.manifestItems, this._saveTap, this._cancelTap);
      }
    }], [{
      key: "styles",
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_725c9ee03efe11eb800233a440abe59f())];
      }
      /**
