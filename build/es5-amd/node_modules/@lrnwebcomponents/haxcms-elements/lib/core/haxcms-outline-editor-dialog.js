define(["exports", "../../../../lit-element/lit-element.js", "./haxcms-site-store.js", "../../../../mobx/lib/mobx.module.js", "../../../json-outline-schema/json-outline-schema.js", "../../../json-editor/json-editor.js", "../../../editable-outline/editable-outline.js", "../../../../@polymer/paper-button/paper-button.js", "../../../../@polymer/iron-icon/iron-icon.js", "../../../../@polymer/iron-icons/iron-icons.js"], function (_exports, _litElement, _haxcmsSiteStore, _mobxModule, _jsonOutlineSchema, _jsonEditor, _editableOutline, _paperButton, _ironIcon, _ironIcons) {
  ...
  function _templateObject2_8cfdda500e0a11ea9e97f7953ea5688f() {
    ...
    _templateObject2_8cfdda500e0a11ea9e97f7953ea5688f = function _templateObject2_8cfdda500e0a11ea9e97f7953ea5688f() {
      return data;
    };
  ...
  function _templateObject_8cfdda500e0a11ea9e97f7953ea5688f() {
    ...
    _templateObject_8cfdda500e0a11ea9e97f7953ea5688f = function _templateObject_8cfdda500e0a11ea9e97f7953ea5688f() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(HAXCMSOutlineEditorDialog, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_8cfdda500e0a11ea9e97f7953ea5688f(), this.viewMode, this.manifestItems, this.manifestItemsStatic, !this.viewMode, this._saveTap, this.toggleView, this._viewIcon, this.viewLabel);
      }
    }], [{
      key: "styles",
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_8cfdda500e0a11ea9e97f7953ea5688f())];
      }
      /**
    ...
    function HAXCMSOutlineEditorDialog() {
      ...
      (0, _mobxModule.autorun)(function (reaction) {
        _this.manifestItems = Object.assign([], (0, _mobxModule.toJS)(_haxcmsSiteStore.store.manifest.items));
    ...
    babelHelpers.createClass(HAXCMSOutlineEditorDialog, [{
      ...
      value: function firstUpdated(changedProperties) {
        ...
        this.shadowRoot.querySelector("#editor").addEventListener("current-data-changed", function (e) {
          if (e.detail.value) {
            _this3.manifestItems = e.detail.value;

            _this3.shadowRoot.querySelector("#outline").importJsonOutlineSchemaItems();
          }
        });
      }
      /**
      ...
      value: function disconnectedCallback() {
        ...
        this.shadowRoot.querySelector("#editor").removeEventListener("current-data-changed", function (e) {
          if (e.detail.value) {
            _this4.manifestItems = e.detail.value;

            _this4.shadowRoot.querySelector("#outline").importJsonOutlineSchemaItems();
          }
        });
