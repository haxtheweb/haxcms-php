define(["exports", "require", "../../../../../lit/index.js", "../haxcms-site-store.js", "../../../../../mobx/dist/mobx.esm.js", "../../../../jwt-login/jwt-login.js"], function (_exports, _require, _index, _haxcmsSiteStore, _mobxEsm, _jwtLogin) {
  ...
  var _templateObject_94b4d1c06f4811ed83231ba15a006752;
  ...
  var HAXCMSBackendPHP = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(HAXCMSBackendPHP, [{
       ...
       */
      function render() {
        return (0, _index.html)(_templateObject_94b4d1c06f4811ed83231ba15a006752 || (_templateObject_94b4d1c06f4811ed83231ba15a006752 = babelHelpers.taggedTemplateLiteral(["\n      <jwt-login\n        id=\"jwt\"\n        jwt=\"", "\"\n        @jwt-changed=\"", "\"\n      ></jwt-login>\n    "])), this.jwt, this.jwtChanged);
      }
    }, {
      key: "jwtChanged",
