define(["exports", "require", "../../../../../lit/index.js", "../haxcms-site-store.js", "../../../../../mobx/dist/mobx.esm.js", "../../../../utils/utils.js", "../../../../beaker-broker/beaker-broker.js", "../../../../hax-body/lib/hax-store.js"], function (_exports, _require, _index, _haxcmsSiteStore, _mobxEsm, _utils, _beakerBroker, _haxStore) {
  ...
  var _templateObject_6ccf1d00deab11edbfe72fb80ddf5a61;
  ...
  var HAXCMSBackendBeaker = /*#__PURE__*/function (_LitElement) {
    ...
    function HAXCMSBackendBeaker() {
      ...
      document.body.addEventListener("haxcms-create-node", _this.createNode.bind(babelHelpers.assertThisInitialized(_this)));
    ...
    babelHelpers.createClass(HAXCMSBackendBeaker, [{
      ...
      // render function
      function render() {
        return (0, _index.html)(_templateObject_6ccf1d00deab11edbfe72fb80ddf5a61 || (_templateObject_6ccf1d00deab11edbfe72fb80ddf5a61 = babelHelpers.taggedTemplateLiteral([" <beaker-broker id=\"beaker\"></beaker-broker> "])));
      }
    }, {
          ...
          return _regeneratorRuntime().wrap(function _callee2$(_context2) {
            while (1) switch (_context2.prev = _context2.next) {
              case 0:
                ...
                this.manifest = _haxcmsSiteStore.store.cmsSiteEditor.instance.manifest;
                ...
                this.manifest.items.forEach(function (element, index) {
                  ...
                  if (babelHelpers.typeof(element.location) === (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {
                    ...
                    // make a directory
                    _this3.shadowRoot.querySelector("#beaker").archive.mkdir("pages/" + id);
                    // make the page
              ...
              case 0:
                ...
                this.manifest.items.forEach(function (element, index) {
                  ...
                  if (babelHelpers.typeof(element.location) === (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {
                    ...
                    // make a directory
                    _this5.shadowRoot.querySelector("#beaker").archive.mkdir(directory);
                    // make the page
