define(["exports", "require", "../../../../../@polymer/polymer/polymer-element.js", "../haxcms-site-store.js", "../../../../jwt-login/jwt-login.js"], function (_exports, _require, _polymerElement, _haxcmsSiteStore, _jwtLogin) {
  ...
  function _templateObject_ecdc0670d3d811e9a8e6c521c406eb68() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <jwt-login\n        id=\"jwt\"\n        url=\"[[jwtLoginLocation]]\"\n        url-logout=\"[[jwtLogoutLocation]]\"\n        jwt=\"{{jwt}}\"\n      ></jwt-login>\n    "]);

    _templateObject_ecdc0670d3d811e9a8e6c521c406eb68 = function _templateObject_ecdc0670d3d811e9a8e6c521c406eb68() {
      return data;
    };
  ...
  function (_PolymerElement) {
    ...
    babelHelpers.createClass(HAXCMSBackendDemo, null, [{
      ...
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_ecdc0670d3d811e9a8e6c521c406eb68());
      }
    }, {
      key: "properties",
      get: function get() {
      ...
      value: function connectedCallback() {
        ...
        try {
          new Promise(function (res, rej) {
            ...
            haxCmsSiteEditorElement.syncSitePath = window.appSettings.syncSitePath;
            haxCmsSiteEditorElement.revertSitePath = window.appSettings.revertSitePath;
            haxCmsSiteEditorElement.appStore = window.appSettings.appStore; // validate availability

            _haxcmsSiteStore.store.cmsSiteEditorAvailability();

            if (!_haxcmsSiteStore.store.cmsSiteEditor.instance.haxCmsSiteEditorElement) {
