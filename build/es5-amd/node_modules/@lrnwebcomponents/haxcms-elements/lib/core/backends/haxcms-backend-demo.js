define(["exports", "require", "../../../../../@polymer/polymer/polymer-element.js", "../haxcms-site-store.js", "../../../../jwt-login/jwt-login.js"], function (_exports, _require, _polymerElement, _haxcmsSiteStore, _jwtLogin) {
  ...
  function _templateObject_63ef8240b7e711e9a0d0a5dc54e83f7a() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <jwt-login\n        id=\"jwt\"\n        url=\"[[jwtLoginLocation]]\"\n        url-logout=\"[[jwtLogoutLocation]]\"\n        jwt=\"{{jwt}}\"\n      ></jwt-login>\n    "]);

    _templateObject_63ef8240b7e711e9a0d0a5dc54e83f7a = function _templateObject_63ef8240b7e711e9a0d0a5dc54e83f7a() {
      return data;
    };
  ...
  function (_PolymerElement) {
    ...
    babelHelpers.createClass(HAXCMSBackendDemo, null, [{
      ...
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_63ef8240b7e711e9a0d0a5dc54e83f7a());
      }
    }, {
      key: "properties",
      get: function get() {
      ...
      value: function connectedCallback() {
        ...
        try {
          new Promise(function (res, rej) {
            ...
            haxCmsSiteEditorElement.appStore = window.appSettings.appStore; // timing issue

            if (!_haxcmsSiteStore.store.cmsSiteEditor.instance) {
              _haxcmsSiteStore.store.cmsSiteEditor.instance = _this2;
            }
