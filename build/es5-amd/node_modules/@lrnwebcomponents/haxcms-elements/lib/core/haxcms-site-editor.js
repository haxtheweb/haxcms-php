define(["exports", "meta", "require", "../../../../lit/index.js", "./haxcms-site-store.js", "../../../../mobx/dist/mobx.esm.js", "../../../../@polymer/iron-ajax/iron-ajax.js", "../../../jwt-login/jwt-login.js", "../../../h-a-x/h-a-x.js", "../../../simple-modal/simple-modal.js", "../../../simple-fields/lib/simple-fields-form.js", "./haxcms-site-dashboard.js", "../../../micro-frontend-registry/lib/microServices.js", "../../../micro-frontend-registry/micro-frontend-registry.js", "../../../hax-body/lib/hax-store.js", "../../../utils/utils.js"], function (_exports, meta, _require, _index, _haxcmsSiteStore, _mobxEsm, _ironAjax, _jwtLogin, _hAX, _simpleModal, _simpleFieldsForm, _haxcmsSiteDashboard, _microServices, _microFrontendRegistry, _haxStore, _utils) {
  "use strict";
  ...
  var _templateObject_386a0690edcb11edb3e3ed4f0d506a4b;
  ...
  var HAXCMSSiteEditor = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(HAXCMSSiteEditor, [{
      ...
      value: function firstUpdated(changedProperties) {
        ...
        link.rel = "stylesheet";
        link.href = new URL("../base.css", meta.url).href;
      ...
      value: function _handleDeleteResponse(response) {
        ...
        window.history.replaceState({}, null, _haxcmsSiteStore.store.fallbackItemSlug());
      ...
      value: function _handleSyncResponse(e) {
        ...
        _haxcmsSiteStore.store.playSound("success");
        // trigger a refresh of the data in node
        this.dispatchEvent(new CustomEvent("haxcms-trigger-update", {
          bubbles: true,
          composed: true,
      ...
      value: function setProcessingVisual() {
        ...
        _haxcmsSiteStore.store.toast("Processing", 5000, {
          hat: "construction",
          slot: loadingIcon
        });
      }
