 ...
 */var HAXCMSSiteListing=/*#__PURE__*/function(_PolymerElement){babelHelpers.inherits(HAXCMSSiteListing,_PolymerElement);/**
   ...
   */},{key:"__sitesResponseChanged",value:function __sitesResponseChanged(newValue){if(newValue){this.title=newValue.title;(0,_renderStatus.afterNextRender)(this,function(){var _this2=this;setTimeout(function(){if(_this2.jwt){_this2.shadowRoot.querySelector("#siteslisting").shadowRoot.querySelector("#list").querySelector("[data-site-id=\"item-new\"]").hidden=!1;_this2.shadowRoot.querySelector("#mapmenu").shadowRoot.querySelector("#builder").shadowRoot.querySelector("#item-new").hidden=!1;_this2.shadowRoot.querySelector("#add").hidden=!1}else{_this2.shadowRoot.querySelector("#siteslisting").shadowRoot.querySelector("#list").querySelector("[data-site-id=\"item-new\"]").hidden=!0;_this2.shadowRoot.querySelector("#mapmenu").shadowRoot.querySelector("#builder").shadowRoot.querySelector("#item-new").hidden=!0;_this2.shadowRoot.querySelector("#add").hidden=!0}},1e3)})}}},{key:"_dataSourceChanged",value:function _dataSourceChanged(newValue){if(newValue){this._dataSource=newValue+"?"+Math.floor(Date.now()/1e3)}}/**
...
},{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_047595706daf11e98b2b231443c29fcf())}},{key:"properties",get:function get(){return{method:{type:String,value:"POST"},/**
       * Title
