  ...
  function (_PolymerElement) {
    ...
    babelHelpers.createClass(HAXCMSSiteListing, [{
      ...
      value: function _colorChanged(e) {
        ...
        this.set("activeItem.metadata.theme.variables.hexCode", this.SimpleColors.colors[e.detail.value.replace("--simple-colors-default-theme-", "").replace("-7", "")][6]);
      ...
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_0768cd40bece11e9854ec335faa90bd4());
      }
    }, {
      key: "properties",
      get: function get() {
