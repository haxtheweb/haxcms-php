define(["exports", "require", "../../../../../@polymer/polymer/polymer-element.js", "../../../../../@polymer/polymer/lib/utils/settings.js", "../../../../../@polymer/polymer/lib/utils/render-status.js", "../../../../../@polymer/iron-ajax/iron-ajax.js", "../../../../elmsln-loading/elmsln-loading.js", "../../../../json-outline-schema/json-outline-schema.js", "../../../../simple-toast/simple-toast.js", "../../../../simple-modal/simple-modal.js", "../../../../simple-datetime/simple-datetime.js", "../../../../jwt-login/jwt-login.js", "../../../../../@vaadin/vaadin-grid/vaadin-grid.js", "../../../../../@vaadin/vaadin-grid/vaadin-grid-column.js", "../../../../../@vaadin/vaadin-grid/vaadin-grid-sort-column.js", "../../../../../@vaadin/vaadin-grid/vaadin-grid-filter-column.js", "../../../../../@vaadin/vaadin-grid/vaadin-grid-selection-column.js", "../../../../simple-colors/simple-colors.js"], function (_exports, _require, _polymerElement, _settings, _renderStatus, _ironAjax, _elmslnLoading, _jsonOutlineSchema, _simpleToast, _simpleModal, _simpleDatetime, _jwtLogin, _vaadinGrid, _vaadinGridColumn, _vaadinGridSortColumn, _vaadinGridFilterColumn, _vaadinGridSelectionColumn, _simpleColors) {
  ...
  function _templateObject_ee630900b53611e9aa40b7626f5cd426() {
    ...
    _templateObject_ee630900b53611e9aa40b7626f5cd426 = function _templateObject_ee630900b53611e9aa40b7626f5cd426() {
      return data;
    };
  ...
  function (_PolymerElement) {
    ...
    function HAXCMSSiteListing() {
      ...
      new Promise(function (res, rej) {
        return _require.default(["@lrnwebcomponents/simple-login/simple-login.js"], res, rej);
      });
      new Promise(function (res, rej) {
        return _require.default(["@lrnwebcomponents/simple-login/lib/simple-login-avatar.js"], res, rej);
      });
      new Promise(function (res, rej) {
        return _require.default(["@polymer/iron-image/iron-image.js"], res, rej);
      });
      new Promise(function (res, rej) {
        return _require.default(["@lrnwebcomponents/simple-colors/lib/simple-colors-picker.js"], res, rej);
      });
      new Promise(function (res, rej) {
      ...
      new Promise(function (res, rej) {
        return _require.default(["@lrnwebcomponents/simple-picker/simple-picker.js"], res, rej);
      });
      new Promise(function (res, rej) {
        return _require.default(["@lrnwebcomponents/simple-icon-picker/simple-icon-picker.js"], res, rej);
      });
      new Promise(function (res, rej) {
        return _require.default(["@lrnwebcomponents/magazine-cover/magazine-cover.js"], res, rej);
      });
      new Promise(function (res, rej) {
        return _require.default(["@lrnwebcomponents/eco-json-schema-form/eco-json-schema-form.js"], res, rej);
      });
      new Promise(function (res, rej) {
        return _require.default(["@lrnwebcomponents/eco-json-schema-form/lib/eco-json-schema-object.js"], res, rej);
      });
      window.HAXCMS = {};
    ...
    babelHelpers.createClass(HAXCMSSiteListing, [{
      ...
      value: function connectedCallback() {
        ...
        (0, _renderStatus.afterNextRender)(this, function () {
          ...
          if (this.hideCamera) {
            ...
            new Promise(function (res, rej) {
              return _require.default(["@lrnwebcomponents/simple-login/lib/simple-login-camera.js"], res, rej);
            });
          }
      ...
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_ee630900b53611e9aa40b7626f5cd426());
      }
    }, {
      key: "properties",
      get: function get() {
