 ...
 */var HAXCMSSiteListing=/*#__PURE__*/function(_PolymerElement){babelHelpers.inherits(HAXCMSSiteListing,_PolymerElement);/**
   ...
   */value:function _sitesResponseChanged(newValue,oldValue){if(newValue){if(babelHelpers.typeof(newValue.items)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){this.title=newValue.title;this.set("sites",[]);this.set("sites",newValue.items);this.notifyPath("sites.*")}}}},{key:"_selectedItemsChanged",value:function _selectedItemsChanged(newValue){if(newValue&&0<newValue.length){this.hasSelectedItems=!0}else{this.hasSelectedItems=!1}}},{key:"_dataSourceChanged",value:function _dataSourceChanged(newValue){if(newValue){this._dataSource=newValue+"?"+Math.floor(Date.now()/1e3)}}/**
...
if(!navigator.mediaDevices){this.shadowRoot.querySelector("#snap").style.display="none";this.shadowRoot.querySelector("#newsnap").style.display="none"}if(this.jwt){this.loggedIn=!0}window.addEventListener("sites-listing-refresh-data",this.refreshData.bind(this));(0,_renderStatus.afterNextRender)(this,function(){this.addEventListener("simple-login-login",this.loginPromptEvent.bind(this));this.shadowRoot.querySelector("#grid").addEventListener("selected-items-changed",this._gridSelectedItemsChanged.bind(this));this.__loginPath=window.appSettings.login;this.__logoutPath=window.appSettings.logout;var themeOptions=[],firstTheme=null;for(var theme in window.appSettings.themes){var item=[{alt:window.appSettings.themes[theme].name,value:theme}];themeOptions.push(item);if(!firstTheme){firstTheme=theme}}this.shadowRoot.querySelector("#newsitetheme").options=themeOptions;if(!this.shadowRoot.querySelector("#newsitetheme").value){this.shadowRoot.querySelector("#newsitetheme").value=firstTheme}this.__setConfigPath=window.appSettings.setConfigPath;this.__getConfigPath=window.appSettings.getConfigPath;this.__createNewSitePath=window.appSettings.createNewSitePath;this.__downloadSitePath=window.appSettings.downloadSitePath;this.__archiveSitePath=window.appSettings.archiveSitePath;this.__cloneSitePath=window.appSettings.cloneSitePath;this.__publishSitePath=window.appSettings.publishSitePath;this.__deleteSitePath=window.appSettings.deleteSitePath;document.body.addEventListener("haxcms-load-site",this.loadActiveSite.bind(this));this.shadowRoot.querySelector("#newsitetheme").addEventListener("change",this._themeChanged.bind(this));this.shadowRoot.querySelector("#newsitecolor").addEventListener("change",this._colorChanged.bind(this));this.shadowRoot.querySelector("#jwt").addEventListener("jwt-logged-in",this._jwtLoggedIn.bind(this));this.shadowRoot.querySelector("#snap").addEventListener("click",this.snapPhoto.bind(this));this.shadowRoot.querySelector("#newsnap").addEventListener("click",this.clearPhoto.bind(this))})}},{key:"snapPhoto",value:function(){var _snapPhoto=babelHelpers.asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee(e){var camera,img,selfie;return regeneratorRuntime.wrap(function _callee$(_context){while(1){switch(_context.prev=_context.next){case 0:camera=this.shadowRoot.querySelector("#camera");_context.next=3;return camera.takeASnap().then(camera.renderImage);case 3:img=_context.sent;camera.removeAttribute("autoplay");selfie=this.shadowRoot.querySelector("#selfie");selfie.innerHTML="";selfie.appendChild(img);selfie.classList.add("has-snap");case 9:case"end":return _context.stop();}}},_callee,this)}));return function snapPhoto(_x){return _snapPhoto.apply(this,arguments)}}()},{key:"clearPhoto",value:function clearPhoto(e){var camera=this.shadowRoot.querySelector("#camera");camera.setAttribute("autoplay","autoplay");var selfie=this.shadowRoot.querySelector("#selfie");selfie.innerHTML="";selfie.classList.remove("has-snap")}},{key:"loginPromptEvent",value:function loginPromptEvent(e){this.set("jwtBody",{});this.set("jwtBody",{u:e.detail.u,p:e.detail.p});this._loginUserRoutine(e)}/**
   ...
   * Ready life cycle
   */},{key:"ready",value:function ready(){babelHelpers.get(babelHelpers.getPrototypeOf(HAXCMSSiteListing.prototype),"ready",this).call(this);window.JSONOutlineSchema.requestAvailability();window.SimpleModal.requestAvailability();window.SimpleToast.requestAvailability();// set jwt from local storage bin
...
this.set("archiveParams.jwt",this.jwt);this.notifyPath("archiveParams.jwt");_context3.t0=regeneratorRuntime.keys(this.selectedItems);case 3:if((_context3.t1=_context3.t0()).done){_context3.next=13;break}i=_context3.t1.value;this.set("activeItem",{});this.set("activeItem",this.selectedItems[i]);this.set("archiveParams.siteName",this.selectedItems[i].metadata.siteName);this.notifyPath("archiveParams.siteName");_context3.next=11;return this.shadowRoot.querySelector("#archiverequest").generateRequest();case 11:_context3.next=3;break;case 13:case"end":return _context3.stop();}}},_callee3,this)}));return function _archiveSites(_x3){return _archiveSites2.apply(this,arguments)}}()/**
   * Delete sites
   */},{key:"_deleteSites",value:function(){var _deleteSites2=babelHelpers.asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee4(e){var i;return regeneratorRuntime.wrap(function _callee4$(_context4){while(1){switch(_context4.prev=_context4.next){case 0:// @todo obtain confirmation first
// ship off a new call
// pass along the jwt for user "session" purposes
this.set("deleteParams.jwt",this.jwt);this.notifyPath("deleteParams.jwt");_context4.t0=regeneratorRuntime.keys(this.selectedItems);case 3:if((_context4.t1=_context4.t0()).done){_context4.next=13;break}i=_context4.t1.value;this.set("activeItem",{});this.set("activeItem",this.selectedItems[i]);this.set("deleteParams.siteName",this.selectedItems[i].metadata.siteName);this.notifyPath("deleteParams.siteName");_context4.next=11;return this.shadowRoot.querySelector("#deleterequest").generateRequest();case 11:_context4.next=3;break;case 13:case"end":return _context4.stop();}}},_callee4,this)}));return function _deleteSites(_x4){return _deleteSites2.apply(this,arguments)}}()/**
   * Clone sites
   */},{key:"_cloneSites",value:function(){var _cloneSites2=babelHelpers.asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee5(e){var i;return regeneratorRuntime.wrap(function _callee5$(_context5){while(1){switch(_context5.prev=_context5.next){case 0:// @todo obtain confirmation first
// ship off a new call
// pass along the jwt for user "session" purposes
this.set("cloneParams.jwt",this.jwt);this.notifyPath("cloneParams.jwt");_context5.t0=regeneratorRuntime.keys(this.selectedItems);case 3:if((_context5.t1=_context5.t0()).done){_context5.next=13;break}i=_context5.t1.value;this.set("activeItem",{});this.set("activeItem",this.selectedItems[i]);this.set("cloneParams.siteName",this.selectedItems[i].metadata.siteName);this.notifyPath("cloneParams.siteName");_context5.next=11;return this.shadowRoot.querySelector("#clonerequest").generateRequest();case 11:_context5.next=3;break;case 13:case"end":return _context5.stop();}}},_callee5,this)}));return function _cloneSites(_x5){return _cloneSites2.apply(this,arguments)}}()/**
   * Clone sites
   */},{key:"_publishSites",value:function(){var _publishSites2=babelHelpers.asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee6(e){var i;return regeneratorRuntime.wrap(function _callee6$(_context6){while(1){switch(_context6.prev=_context6.next){case 0:// @todo obtain confirmation first
// ship off a new call
// pass along the jwt for user "session" purposes
this.set("publishParams.jwt",this.jwt);this.notifyPath("publishParams.jwt");_context6.t0=regeneratorRuntime.keys(this.selectedItems);case 3:if((_context6.t1=_context6.t0()).done){_context6.next=13;break}i=_context6.t1.value;this.set("activeItem",{});this.set("activeItem",this.selectedItems[i]);this.set("publishParams.siteName",this.selectedItems[i].metadata.siteName);this.notifyPath("publishParams.siteName");_context6.next=11;return this.shadowRoot.querySelector("#publishrequest").generateRequest();case 11:_context6.next=3;break;case 13:case"end":return _context6.stop();}}},_callee6,this)}));return function _publishSites(_x6){return _publishSites2.apply(this,arguments)}}()/**
   * Load configuration
...
this.dispatchEvent(new CustomEvent("haxcms-download-site",{bubbles:!0,composed:!0,cancelable:!1,detail:e.detail.response}));var element=document.createElement("a");element.setAttribute("href",e.detail.response.link);element.style.display="none";document.body.appendChild(element);element.click();document.body.removeChild(element);var evt=new CustomEvent("simple-toast-show",{bubbles:!0,composed:!0,cancelable:!0,detail:{text:this.activeItem.title+" downloaded successfully!",duration:4e3}});this.dispatchEvent(evt)}},{key:"handleArchiveResponse",value:function handleArchiveResponse(e){// fire incase anyone cares
this.dispatchEvent(new CustomEvent("haxcms-archive-site",{bubbles:!0,composed:!0,cancelable:!1,detail:e.detail.response}));var evt=new CustomEvent("simple-toast-show",{bubbles:!0,composed:!0,cancelable:!0,detail:{text:this.activeItem.title+" archived!",duration:4e3}});this.dispatchEvent(evt)}},{key:"handleDeleteResponse",value:function handleDeleteResponse(e){// fire incase anyone cares
this.dispatchEvent(new CustomEvent("haxcms-delete-site",{bubbles:!0,composed:!0,cancelable:!1,detail:e.detail.response}));var evt=new CustomEvent("simple-toast-show",{bubbles:!0,composed:!0,cancelable:!0,detail:{text:this.activeItem.title+" archived!",duration:4e3}});this.dispatchEvent(evt)}},{key:"handleCloneResponse",value:function handleCloneResponse(e){// fire incase anyone cares
this.dispatchEvent(new CustomEvent("haxcms-clone-site",{bubbles:!0,composed:!0,cancelable:!1,detail:e.detail.response}));var evt=new CustomEvent("simple-toast-show",{bubbles:!0,composed:!0,cancelable:!0,detail:{text:this.activeItem.title+" archived!",duration:4e3}});this.dispatchEvent(evt)}},{key:"handlePublishResponse",value:function handlePublishResponse(e){// fire incase anyone cares
this.dispatchEvent(new CustomEvent("haxcms-publish-site",{bubbles:!0,composed:!0,cancelable:!1,detail:e.detail.response}));var evt=new CustomEvent("simple-toast-show",{bubbles:!0,composed:!0,cancelable:!0,detail:{text:this.activeItem.title+" archived!",duration:4e3}});this.dispatchEvent(evt)}/**
...
break;}}}],[{key:"tag",get:function get(){return"haxcms-site-listing"}// render function
},{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_529bfad075c211e99fd5555145028221())}},{key:"properties",get:function get(){return{__loading:{type:Boolean},jwtBody:{type:Object,value:{}},/**
       ...
       * Edit mode
       */editMode:{type:Boolean,notify:!0,reflectToAttribute:!0,value:!1,observer:"_editModeChanged"},hasSelectedItems:{type:Boolean,value:!1}}}}]);return HAXCMSSiteListing}(_polymerElement.PolymerElement);_exports.HAXCMSSiteListing=HAXCMSSiteListing;window.customElements.define(HAXCMSSiteListing.tag,HAXCMSSiteListing)});