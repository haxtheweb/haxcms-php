 ...
 */var HAXCMSSiteListing=/*#__PURE__*/function(_PolymerElement){babelHelpers.inherits(HAXCMSSiteListing,_PolymerElement);babelHelpers.createClass(HAXCMSSiteListing,[{key:"drawerToggle",/**
   ...
   * Request a user login if we need one or log out
   */},{key:"_loginUserRoutine",value:function _loginUserRoutine(e){this.$.jwt.toggleLogin()}/**
...
if(e.detail.value){this.set("activeItem.metadata.theme",e.detail.value);this.notifyPath("activeItem.metadata.theme")}}/**
   ...
   */},{key:"_addTap",value:function _addTap(e){var itemNew=this.$.siteslisting.$.list.querySelector("[data-site-id=\"item-new\"]");if(itemNew){itemNew.click()}}/**
   * Toggle edit state
   */},{key:"_editTap",value:function _editTap(e){this.editMode=!this.editMode}/**
   * _settingsTap
   */},{key:"_settingsTap",value:function _settingsTap(e){this._loadConfig();this.$.settingsdialog.opened=!0}/**
...
if("item-new"===newValue.id){this.$.newdialog.opened=!0;this.$.itemdialog.opened=!1}else{this.$.newdialog.opened=!1;this.$.itemdialog.opened=!0}}// it's possible to have NO item in scope, ensure everything closes :)
else if(babelHelpers.typeof(newValue)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))&&babelHelpers.typeof(newValue.id)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){this.$.newdialog.opened=!1;this.$.itemdialog.opened=!1;this.$.drawer.opened=!1}}/**
   * Attached life cycle
   */},{key:"connectedCallback",value:function connectedCallback(){babelHelpers.get(babelHelpers.getPrototypeOf(HAXCMSSiteListing.prototype),"connectedCallback",this).call(this);this.__loginPath=window.appSettings.login;this.__logoutPath=window.appSettings.logout;var themeOptions=[],firstTheme=null;for(var theme in window.appSettings.themes){var item=[{alt:window.appSettings.themes[theme].name,value:theme}];themeOptions.push(item);if(!firstTheme){firstTheme=theme}}this.$.newsitetheme.options=themeOptions;if(!this.$.newsitetheme.value){this.$.newsitetheme.value=firstTheme}this.__setConfigPath=window.appSettings.setConfigPath;this.__getConfigPath=window.appSettings.getConfigPath;this.__createNewSitePath=window.appSettings.createNewSitePath;this.__downloadSitePath=window.appSettings.downloadSitePath;// @todo support state routing for loadActiveSite
...
document.body.removeEventListener("sites-listing-item-selected",this._itemSelected.bind(this));document.body.removeEventListener("haxcms-load-site",this.loadActiveSite.bind(this));this.$.mapmenu.removeEventListener("selected",this._mapMenuSelection.bind(this));this.$.newsitetheme.removeEventListener("change",this._themeChanged.bind(this));this.$.newsitecolor.removeEventListener("change",this._colorChanged.bind(this));this.$.jwt.removeEventListener("jwt-logged-in",this._loginStateChange.bind(this));this.$.siteslisting.removeEventListener("item-overlay-option-selected",this._itemOptionSelected.bind(this));this.$.siteslisting.removeEventListener("item-overlay-op-changed",this._itemOpChanged.bind(this));babelHelpers.get(babelHelpers.getPrototypeOf(HAXCMSSiteListing.prototype),"disconnectedCallback",this).call(this)}/**
   ...
   */get:function get(){return"haxcms-site-listing"}// render function
},{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_2cf4644066f711e999fe19a29ec80b99())}},{key:"properties",get:function get(){return{/**
       * Title
       ...
       * Logged in state
       */loggedIn:{type:Boolean,notify:!0,reflectToAttribute:!0,observer:"_loginStateChanged"},/**
       * Edit mode
       */editMode:{type:Boolean,notify:!0,reflectToAttribute:!0,value:!1,observer:"_editModeChanged"}}}}]);function HAXCMSSiteListing(){var _this;babelHelpers.classCallCheck(this,HAXCMSSiteListing);_this=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(HAXCMSSiteListing).call(this));(0,_settings.setPassiveTouchGestures)(!0);window.JSONOutlineSchema.requestAvailability();window.SimpleModal.requestAvailability();window.SimpleToast.requestAvailability();window.HAXCMS={};return _this}/**
   * Ready life cycle
   */babelHelpers.createClass(HAXCMSSiteListing,[{key:"ready",value:function ready(){babelHelpers.get(babelHelpers.getPrototypeOf(HAXCMSSiteListing.prototype),"ready",this).call(this);// set jwt from local storage bin
...
if(item.location){window.open(item.location)}else{window.open("/_sites/"+item.metadata.siteName+"/index.html")}}/**
...
this.set("createParams.siteName",this.$.newsitetitle.value);this.notifyPath("createParams.siteName");this.set("createParams.description",this.$.newsitedescription.value);this.notifyPath("createParams.description");// need to pull this from the active item bc of data binding silly
...
this.set("createParams.jwt",this.jwt);this.notifyPath("createParams.jwt");this.$.newsitetitle.value="";this.$.newsitedescription.value=null;this.$.createrequest.generateRequest()}/**
...
this.$.edit.click()}}}}]);return HAXCMSSiteListing}(_polymerElement.PolymerElement);_exports.HAXCMSSiteListing=HAXCMSSiteListing;window.customElements.define(HAXCMSSiteListing.tag,HAXCMSSiteListing)});