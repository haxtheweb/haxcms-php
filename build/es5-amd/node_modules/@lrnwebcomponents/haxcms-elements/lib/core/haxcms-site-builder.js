define(["exports","meta","require","../../../../lit-element/lit-element.js","../../../../@polymer/polymer/lib/utils/settings.js","../../../json-outline-schema/json-outline-schema.js","../../../utils/utils.js","../../../../mobx/lib/mobx.module.js","./haxcms-site-store.js","../../../../@polymer/iron-ajax/iron-ajax.js"],function(_exports,meta,_require,_litElement,_settings,_jsonOutlineSchema,_utils,_mobxModule,_haxcmsSiteStore,_ironAjax){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.HAXCMSSiteBuilder=void 0;meta=babelHelpers.interopRequireWildcard(meta);_require=babelHelpers.interopRequireWildcard(_require);function _templateObject2_8ec859d0679e11eaa25e79cdef13391f(){var data=babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n        :host #slot {\n          background-color: var(--haxcms-color, white);\n          opacity: 0.2;\n          visibility: hidden;\n        }\n        :host([dashboard-opened]) {\n          display: inline-block !important;\n          margin-left: 50vw;\n          height: 100vh;\n          pointer-events: none;\n          opacity: 0.5;\n          width: 100vw;\n        }\n        :host([theme-loaded]) #slot {\n          opacity: 1;\n          visibility: visible;\n        }\n        paper-progress {\n          display: block;\n          width: 100%;\n          position: fixed;\n          top: 0;\n          left: 0;\n          right: 0;\n          background-color: transparent;\n          z-index: 1000;\n          --paper-progress-active-color: var(\n            --haxcms-color,\n            rgba(255, 255, 255, 0.5)\n          );\n          --paper-progress-container-color: transparent;\n        }\n      "]);_templateObject2_8ec859d0679e11eaa25e79cdef13391f=function _templateObject2_8ec859d0679e11eaa25e79cdef13391f(){return data};return data}function ownKeys(object,enumerableOnly){var keys=Object.keys(object);if(Object.getOwnPropertySymbols){var symbols=Object.getOwnPropertySymbols(object);if(enumerableOnly)symbols=symbols.filter(function(sym){return Object.getOwnPropertyDescriptor(object,sym).enumerable});keys.push.apply(keys,symbols)}return keys}function _objectSpread(target){for(var i=1,source;i<arguments.length;i++){source=null!=arguments[i]?arguments[i]:{};if(i%2){ownKeys(Object(source),!0).forEach(function(key){babelHelpers.defineProperty(target,key,source[key])})}else if(Object.getOwnPropertyDescriptors){Object.defineProperties(target,Object.getOwnPropertyDescriptors(source))}else{ownKeys(Object(source)).forEach(function(key){Object.defineProperty(target,key,Object.getOwnPropertyDescriptor(source,key))})}}return target}function _templateObject_8ec859d0679e11eaa25e79cdef13391f(){var data=babelHelpers.taggedTemplateLiteral(["\n      <haxcms-site-router base-uri=\"","\"></haxcms-site-router>\n      <paper-progress .hidden=\"","\" indeterminate></paper-progress>\n      <iron-ajax\n        id=\"manifest\"\n        .url=\"","","","\"\n        handle-as=\"json\"\n        @last-response-changed=\"","\"\n        @last-error-changed=\"","\"\n      ></iron-ajax>\n      <iron-ajax\n        id=\"activecontent\"\n        .url=\"","","","\"\n        handle-as=\"text\"\n        @loading-changed=\"","\"\n        @last-response-changed=\"","\"\n        @last-error-changed=\"","\"\n      ></iron-ajax>\n      <div id=\"slot\"><slot></slot></div>\n      <simple-colors-polymer></simple-colors-polymer>\n    "]);_templateObject_8ec859d0679e11eaa25e79cdef13391f=function _templateObject_8ec859d0679e11eaa25e79cdef13391f(){return data};return data}/**
 * `haxcms-site-builder`
...
(0,_utils.wipeSlot)(this,"*");_haxcmsSiteStore.store.themeElement=document.createElement(newValue);this.appendChild(_haxcmsSiteStore.store.themeElement)}}/**
   ...
   * ready life cycle
   */}],[{key:"styles",get:function get(){return[(0,_litElement.css)(_templateObject2_8ec859d0679e11eaa25e79cdef13391f())]}/**
