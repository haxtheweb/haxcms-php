define(["exports", "meta", "require", "../../../../lit/index.js", "../../../utils/utils.js", "../../../../mobx/dist/mobx.esm.js", "./haxcms-site-store.js", "../../../simple-progress/simple-progress.js", "../../../replace-tag/replace-tag.js", "../../../i18n-manager/lib/I18NMixin.js"], function (_exports, meta, _require, _index, _utils, _mobxEsm, _haxcmsSiteStore, _simpleProgress, _replaceTag, _I18NMixin2) {
  ...
  var _templateObject_023b6e30ce4411eca4dffb3bcb5f42ec, _templateObject2_023b6e30ce4411eca4dffb3bcb5f42ec;
  ...
  var HAXCMSSiteBuilder = /*#__PURE__*/function (_I18NMixin) {
    ...
    babelHelpers.createClass(HAXCMSSiteBuilder, [{
      ...
      key: "styles",
      get: function get() {
        return [(0, _index.css)(_templateObject2_023b6e30ce4411eca4dffb3bcb5f42ec || (_templateObject2_023b6e30ce4411eca4dffb3bcb5f42ec = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n          position: relative;\n        }\n        :host([is-logged-in]) {\n          max-height: calc(100vh - 48px);\n        }\n        :host #slot {\n          opacity: 0.2;\n          visibility: hidden;\n        }\n        :host([dashboard-opened]) {\n          display: inline-block !important;\n          margin-left: 50vw;\n          height: 100vh;\n          pointer-events: none;\n          opacity: 0.5;\n          width: 100vw;\n        }\n        :host([theme-loaded]) #slot {\n          opacity: 1;\n          visibility: visible;\n        }\n        simple-progress {\n          display: block;\n          width: 100%;\n          position: fixed;\n          top: 0;\n          left: 0;\n          right: 0;\n          background-color: transparent;\n          z-index: 1000;\n          --simple-progress-active-color: var(\n            --haxcms-color,\n            rgba(255, 255, 255, 0.5)\n          );\n        }\n        simple-progress[disabled] {\n          display: none;\n        }\n      "])))];
      }
      /**
