define(["exports", "meta", "require", "../../../../@polymer/polymer/polymer-element.js", "../../../../@polymer/polymer/lib/utils/settings.js", "../../../../@polymer/polymer/lib/mixins/element-mixin.js", "../../../../@polymer/polymer/lib/utils/render-status.js", "../../../../@polymer/polymer/lib/legacy/polymer.dom.js", "../../../../@polymer/polymer/lib/utils/resolve-url.js", "../../../json-outline-schema/json-outline-schema.js", "../../../hax-body/lib/haxutils.js", "../../../../mobx/lib/mobx.module.js", "./haxcms-site-store.js", "../../../../@polymer/iron-ajax/iron-ajax.js", "./haxcms-site-router.js"], function (_exports, meta, _require, _polymerElement, _settings, _elementMixin, _renderStatus, _polymerDom, _resolveUrl, _jsonOutlineSchema, _haxutils, _mobxModule, _haxcmsSiteStore, _ironAjax, _haxcmsSiteRouter) {
  "use strict";
  ...
  function _templateObject_ac590180b86611e994e53f31586a4553() {
    ...
    _templateObject_ac590180b86611e994e53f31586a4553 = function _templateObject_ac590180b86611e994e53f31586a4553() {
      return data;
    };
  ...
  function (_PolymerElement) {
    ...
    babelHelpers.createClass(HAXCMSSiteBuilder, [{
      ...
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_ac590180b86611e994e53f31586a4553());
      }
    }, {
      key: "properties",
      get: function get() {
    ...
    babelHelpers.createClass(HAXCMSSiteBuilder, [{
      ...
      value: function () {
        var _manifestChanged2 = babelHelpers.asyncToGenerator(
        /*#__PURE__*/
        regeneratorRuntime.mark(function _callee(newValue, oldValue) {
          var site, nodes, items;
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  site = new _jsonOutlineSchema.JsonOutlineSchema();
                  _context.next = 5;
                  return site.load("site.json");
                ...
                case 5:
                  ...
                  nodes = site.itemsToNodes();
                  items = site.nodesToItems(nodes);
        ...
        function _manifestChanged(_x, _x2) {
          return _manifestChanged2.apply(this, arguments);
        }

        return _manifestChanged;
      }()
      /**
