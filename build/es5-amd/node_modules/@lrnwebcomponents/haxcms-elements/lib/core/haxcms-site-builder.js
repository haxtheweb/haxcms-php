...
},{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_3be58570685411e9b25d1735312af746())}},{key:"properties",get:function get(){return{/**
       * queryParams
...
new Promise(function(res,rej){return _require.default(["@lrnwebcomponents/haxcms-elements/lib/core/haxcms-editor-builder.js"],res,rej)}).then(function(response){_this2.editorBuilder=document.createElement("haxcms-editor-builder");// attach editor builder after we've appended to the screen
...
setTimeout(function(){var frag=document.createRange().createContextualFragment(html);(0,_polymerDom.dom)(_this3.themeElement).appendChild(frag);_this3.dispatchEvent(new CustomEvent("json-outline-schema-active-body-changed",{bubbles:!0,composed:!0,cancelable:!1,detail:html}))},5);// if there are, dynamically import them
