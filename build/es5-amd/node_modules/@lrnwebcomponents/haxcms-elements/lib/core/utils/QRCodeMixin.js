define(["exports", "require", "../../../../../lit/index.js", "../haxcms-site-store.js", "../../../../hax-iconset/lib/simple-hax-iconset.js", "./HAXCMSI18NMixin.js"], function (_exports, _require, _index, _haxcmsSiteStore, _simpleHaxIconset, _HAXCMSI18NMixin2) {
  ...
  var _templateObject_f50e6cf027c411edb7faa9deadcbafd2, _templateObject2_f50e6cf027c411edb7faa9deadcbafd2, _templateObject3_f50e6cf027c411edb7faa9deadcbafd2;
    ...
    return /*#__PURE__*/function (_HAXCMSI18NMixin) {
      ...
      babelHelpers.createClass(_class, [{
        ...
        value: function QRCodeButton() {
          ...
          return (0, _index.html)(_templateObject_f50e6cf027c411edb7faa9deadcbafd2 || (_templateObject_f50e6cf027c411edb7faa9deadcbafd2 = babelHelpers.taggedTemplateLiteral(["\n        <div\n          id=\"qrcodebtnwrapper\"\n          part=\"", "\"\n        >\n          <simple-icon-button-lite\n            part=\"qr-code-btn\"\n            class=\"qr-code-btn btn\"\n            label=\"", "\"\n            icon=\"hax:qr-code\"\n            @click=\"", "\"\n            id=\"qrcodebtn\"\n          ></simple-icon-button-lite>\n          <simple-tooltip for=\"qrcodebtn\">\n            ", "\n          </simple-tooltip>\n          <simple-popover\n            ?hidden=\"", "\"\n            id=\"qrcodepopover\"\n            position=\"", "\"\n            fit-to-visible-bounds\n            auto\n          >\n            ", "\n          </simple-popover>\n        </div>\n      "])), this.editMode ? "edit-mode-active" : "", this.t.currentPage, this.QRCodeButtonToggle, this.t.currentPage, !this.showQRCode, direction, this.showQRCode ? (0, _index.html)(_templateObject2_f50e6cf027c411edb7faa9deadcbafd2 || (_templateObject2_f50e6cf027c411edb7faa9deadcbafd2 = babelHelpers.taggedTemplateLiteral(["\n                  <div style=\"width:190px;height:190px;\">\n                    <q-r\n                      modulesize=\"4\"\n                      margin=\"0\"\n                      title=\"", "\"\n                      data=\"", "\"\n                    ></q-r>\n                  </div>\n                "])), _haxcmsSiteStore.store.activeTitle, window.location.href) : "");
        }
      }, {
        ...
        get: function get() {
          ...
          return [].concat(babelHelpers.toConsumableArray(styles), [(0, _index.css)(_templateObject3_f50e6cf027c411edb7faa9deadcbafd2 || (_templateObject3_f50e6cf027c411edb7faa9deadcbafd2 = babelHelpers.taggedTemplateLiteral(["\n          simple-popover:not(:defined) {\n            display: none;\n          }\n          simple-popover {\n            padding: 2px;\n          }\n          .qr-code-btn {\n            color: inherit;\n            --simple-icon-height: 24px;\n            --simple-icon-width: 24px;\n          }\n          #qrcodebtnwrapper {\n            display: inline-flex;\n          }\n        "])))]);
        }
      }, {
        key: "properties",
        get: function get() {
