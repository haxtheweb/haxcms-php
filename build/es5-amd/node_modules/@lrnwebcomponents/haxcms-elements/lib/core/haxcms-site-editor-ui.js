 ...
 */var HAXCMSSiteEditorUI=/*#__PURE__*/function(_PolymerElement){babelHelpers.inherits(HAXCMSSiteEditorUI,_PolymerElement);babelHelpers.createClass(HAXCMSSiteEditorUI,null,[{key:"tag",/**
   ...
   */get:function get(){return"haxcms-site-editor-ui"}}]);function HAXCMSSiteEditorUI(){var _this;babelHelpers.classCallCheck(this,HAXCMSSiteEditorUI);_this=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(HAXCMSSiteEditorUI).call(this));new Promise(function(res,rej){return _require.default(["@polymer/paper-tooltip/paper-tooltip.js"],res,rej)});new Promise(function(res,rej){return _require.default(["@polymer/paper-icon-button/paper-icon-button.js"],res,rej)});new Promise(function(res,rej){return _require.default(["@lrnwebcomponents/simple-modal/simple-modal.js"],res,rej)});new Promise(function(res,rej){return _require.default(["@lrnwebcomponents/haxcms-elements/lib/core/haxcms-outline-editor-dialog.js"],res,rej)});new Promise(function(res,rej){return _require.default(["@polymer/iron-icons/editor-icons.js"],res,rej)});new Promise(function(res,rej){return _require.default(["@polymer/paper-fab/paper-fab.js"],res,rej)});return _this}// render function
babelHelpers.createClass(HAXCMSSiteEditorUI,[{key:"connectedCallback",value:function connectedCallback(){babelHelpers.get(babelHelpers.getPrototypeOf(HAXCMSSiteEditorUI.prototype),"connectedCallback",this).call(this);this.__disposer=[];(0,_renderStatus.afterNextRender)(this,function(){var _this2=this;(0,_mobxModule.autorun)(function(reaction){var activeItem=(0,_mobxModule.toJS)(_haxcmsSiteStore.store.activeItem);if(activeItem&&activeItem.id){_this2.activeTitle=activeItem.title;_this2.pageAllowed=!0}else{_this2.pageAllowed=!1}_this2.__disposer.push(reaction)})})}},{key:"disconnectedCallback",value:function disconnectedCallback(){for(var i in this.__disposer){this.__disposer[i].dispose()}babelHelpers.get(babelHelpers.getPrototypeOf(HAXCMSSiteEditorUI.prototype),"disconnectedCallback",this).call(this)}/**
   * toggle state on button tap
   */},{key:"_editButtonTap",value:function _editButtonTap(e){this.editMode=!this.editMode;_haxcmsSiteStore.store.cmsSiteEditor.instance.haxCmsSiteEditorElement.editMode=this.editMode;// save button shifted to edit
if(!this.editMode){this.dispatchEvent(new CustomEvent("haxcms-save-node",{bubbles:!0,composed:!0,cancelable:!1,detail:_haxcmsSiteStore.store.activeItem}))}}},{key:"_editDetailsButtonTap",value:function _editDetailsButtonTap(e){var normalizedEvent=(0,_polymerDom.dom)(e),evt=new CustomEvent("haxcms-load-node-fields",{bubbles:!0,composed:!0,cancelable:!1,detail:normalizedEvent.localTarget});window.dispatchEvent(evt)}/**
   * toggle menu state
   */},{key:"_menuButtonTap",value:function _menuButtonTap(e){this.menuMode=!this.menuMode}},{key:"_cancelButtonTap",value:function _cancelButtonTap(e){this.editMode=!1;_haxcmsSiteStore.store.cmsSiteEditor.instance.haxCmsSiteEditorElement.editMode=!1;this.dispatchEvent(new CustomEvent("hax-cancel",{bubbles:!0,composed:!0,cancelable:!1,detail:e.detail}))}/**
   * Add button hit
...
this.__editIcon="editor:mode-edit";this.__editText="Edit"}if(babelHelpers.typeof(oldValue)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){this.dispatchEvent(new CustomEvent("haxcms-edit-mode-changed",{bubbles:!0,composed:!0,cancelable:!1,detail:newValue}));window.HaxStore.write("editMode",newValue,this)}}/**
