define(["exports", "meta", "require", "../../../../lit/index.js", "./haxcms-site-store.js", "../../../hax-body/lib/hax-store.js", "../../../../mobx/dist/mobx.esm.js", "../../../utils/utils.js", "../../../simple-icon/simple-icon.js", "../../../simple-icon/lib/simple-icons.js", "./utils/HAXCMSThemeParts.js", "./utils/HAXCMSI18NMixin.js", "../../../rpg-character/rpg-character.js", "../../../app-hax/lib/v1/app-hax-top-bar.js", "../../../app-hax/lib/v1/app-hax-user-menu.js", "../../../app-hax/lib/v1/app-hax-user-menu-button.js", "../../../../wired-elements/lib/wired-button.js", "../../../simple-colors/simple-colors.js", "../../../super-daemon/super-daemon.js", "../../../simple-modal/simple-modal.js", "./haxcms-site-insights.js", "../../../simple-fields/lib/simple-fields-form.js", "./micros/haxcms-button-add.js", "./haxcms-darkmode-toggle.js", "../ui-components/site/site-remote-content.js", "../../../page-flag/page-flag.js"], function (_exports, meta, _require, _index, _haxcmsSiteStore, _haxStore, _mobxEsm, _utils, _simpleIcon, _simpleIcons, _HAXCMSThemeParts2, _HAXCMSI18NMixin, _rpgCharacter, _appHaxTopBar, _appHaxUserMenu, _appHaxUserMenuButton, _wiredButton, _simpleColors, _superDaemon, _simpleModal, _haxcmsSiteInsights, _simpleFieldsForm, _haxcmsButtonAdd, _haxcmsDarkmodeToggle, _siteRemoteContent, _pageFlag) {
  "use strict";
  ...
  var _templateObject_09aebb40e4f511ed85766367b4d3e9fc, _templateObject2_09aebb40e4f511ed85766367b4d3e9fc, _templateObject3_09aebb40e4f511ed85766367b4d3e9fc;
  ...
  var HAXCMSSiteEditorUI = /*#__PURE__*/function (_HAXCMSThemeParts) {
    ...
    function HAXCMSSiteEditorUI() {
      ...
      _superDaemon.SuperDaemonInstance.noResultsSlot = function () {
        return (0, _index.html)(_templateObject_09aebb40e4f511ed85766367b4d3e9fc || (_templateObject_09aebb40e4f511ed85766367b4d3e9fc = babelHelpers.taggedTemplateLiteral(["Expecting to see results?\n        <a\n          @click=\"", "\"\n          >Make a suggestion</a\n        >\n        for what you thought you would see here!"])), function (e) {
          _haxStore.HAXStore._haxStoreContribute("merlin", "POP,enhancement", _superDaemon.SuperDaemonInstance.commandContext + " " + _superDaemon.SuperDaemonInstance.like);
        });
      };
      _superDaemon.SuperDaemonInstance.appendContext("CMS");
      ...
      if (_haxStore.HAXStore.ready) {
        ...
        _haxStore.HAXStore.haxAutoloader.appendChild(ce);
        // page-flag for author notes
        var flag = document.createElement("page-flag");
        _haxStore.HAXStore.haxAutoloader.appendChild(flag);
      ...
      (0, _mobxEsm.autorun)(function () {
        var badDevice = (0, _mobxEsm.toJS)(_haxcmsSiteStore.store.badDevice);
    ...
    babelHelpers.createClass(HAXCMSSiteEditorUI, [{
      ...
      value: function firstUpdated(changedProperties) {
        ...
        this.shadowRoot.querySelectorAll("[data-super-daemon-path]").forEach(function (item) {
        ...
        _superDaemon.SuperDaemonInstance.defineOption({
          ...
          value: {
            ...
            context: ">",
            program: function () {
              var _program = babelHelpers.asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(input, values) {
                var results;
                return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                  while (1) switch (_context2.prev = _context2.next) {
                    case 0:
                      results = [];
                      ["clean-one", "clean-two", "learn-two-theme", "bootstrap-theme", "outline-player", "haxor-slevin"].forEach( /*#__PURE__*/function () {
                        var _ref = babelHelpers.asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(name) {
      ...
      value: function updated(changedProperties) {
        ...
        changedProperties.forEach(function (oldValue, propName) {
          ...
          if (propName == "editMode") {
            ...
            _superDaemon.SuperDaemonInstance.close();
            // observer
          ...
          if (propName == "manifestEditMode") {
            // observer
            _this4._manifestEditModeChanged(_this4[propName], oldValue);
            // notify
      ...
      value: function connectedCallback() {
        ...
        (0, _mobxEsm.autorun)(function (reaction) {
          if (_haxcmsSiteStore.store.userData) {
            ...
            _this5.userPicture = (0, _mobxEsm.toJS)(_haxcmsSiteStore.store.userData.userPicture);
      ...
      value: function _editModeChanged(newValue, oldValue) {
        if (newValue) {
          ...
          _superDaemon.SuperDaemonInstance.appendContext("HAX");
          _superDaemon.SuperDaemonInstance.removeContext("CMS");
        } else {
          this.__editIcon = "hax:page-edit";
          this.__editText = this.t.editPageContent;
          _superDaemon.SuperDaemonInstance.appendContext("CMS");
          _superDaemon.SuperDaemonInstance.removeContext("HAX");
        }
