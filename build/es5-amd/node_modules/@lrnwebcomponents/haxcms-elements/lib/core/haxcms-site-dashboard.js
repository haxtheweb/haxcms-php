define(["exports", "../../../../lit/index.js", "./haxcms-site-store.js", "../../../utils/utils.js", "../../../../mobx/dist/mobx.esm.js", "../../../simple-tooltip/simple-tooltip.js", "../../../simple-fields/lib/simple-fields-form.js", "../../../simple-icon/simple-icon.js", "../../../simple-icon/lib/simple-icons.js", "../../../simple-icon/lib/simple-icon-button.js", "../../../hax-body-behaviors/lib/HAXFields.js"], function (_exports, _index, _haxcmsSiteStore, _utils, _mobxEsm, _simpleTooltip, _simpleFieldsForm, _simpleIcon, _simpleIcons, _simpleIconButton, _HAXFields) {
  ...
  var _templateObject_fe15b6e0a0c911eda392efd0bad1b4bf, _templateObject2_fe15b6e0a0c911eda392efd0bad1b4bf, _templateObject3_fe15b6e0a0c911eda392efd0bad1b4bf;
  ...
  var HAXCMSSiteDashboard = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(HAXCMSSiteDashboard, [{
      ...
      // render function
      function render() {
        return (0, _index.html)(_templateObject_fe15b6e0a0c911eda392efd0bad1b4bf || (_templateObject_fe15b6e0a0c911eda392efd0bad1b4bf = babelHelpers.taggedTemplateLiteral(["\n      <div class=\"title-wrapper\">\n        <h2 class=\"title\">", " settings</h2>\n        ", "\n      </div>\n      <div class=\"fields-wrapper\">\n        <simple-fields-form\n          id=\"siteform\"\n          autoload\n          .headers=\"", "\"\n          .body=\"", "\"\n          .schematizer=\"", "\"\n          .elementizer=\"", "\"\n          load-endpoint=\"", "\"\n          method=\"", "\"\n        ></simple-fields-form>\n      </div>\n      <div class=\"buttons\">\n        <button class=\"hax-modal-btn\" @click=\"", "\">\n          Save\n        </button>\n        <button class=\"hax-modal-btn cancel\" @click=\"", "\">\n          cancel\n        </button>\n      </div>\n    "])), this.manifest.title, (0, _utils.varExists)(this.manifest, "metadata.site.static.publishedLocation") ? (0, _index.html)(_templateObject2_fe15b6e0a0c911eda392efd0bad1b4bf || (_templateObject2_fe15b6e0a0c911eda392efd0bad1b4bf = babelHelpers.taggedTemplateLiteral(["\n              <span class=\"toptext\">\n                <a\n                  class=\"publishlink\"\n                  href=\"", "\"\n                  rel=\"noopener noreferrer\"\n                  target=\"_blank\"\n                  >Published version\n                </a>\n              </span>\n            "])), (0, _utils.varGet)(this.manifest, "metadata.site.static.publishedLocation", "#")) : "", this.headers, this.body, _HAXFields.HaxSchematizer, _HAXFields.HaxElementizer, this.loadEndpoint, this.method, this._saveSiteFieldsTap, this._cancel);
      }
    }, {
