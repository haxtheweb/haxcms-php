...
setTimeout(function(){if(0===(0,_polymerDom.dom)(_this3).getEffectiveChildNodes().length){var frag=document.createRange().createContextualFragment(_haxcmsSiteStore.store.activeItemContent);(0,_polymerDom.dom)(_this3).appendChild(frag)}},50);(0,_elementMixin.updateStyles)();// store disposer so we can clean up later
