define(["../../lit-element/lit-element.js", "../../@polymer/polymer/lib/utils/flattened-nodes-observer.js", "./lib/loading-indicator.js"], function (_litElement, _flattenedNodesObserver, _loadingIndicator) {
  ...
  function _templateObject2_3b05a700552111ebb34d8b93068ed409() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <div id=\"container\" class=\"", "\">\n        <div id=\"loading-screen\" style=\"height:", "px;\">\n          <loading-indicator></loading-indicator>\n        </div>\n        <div id=\"slot\" style=\"display: ", "\">\n          <slot></slot>\n        </div>\n      </div>\n    "]);

    _templateObject2_3b05a700552111ebb34d8b93068ed409 = function _templateObject2_3b05a700552111ebb34d8b93068ed409() {
      return data;
    };
  ...
  function _templateObject_3b05a700552111ebb34d8b93068ed409() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      :host {\n        display: block;\n      }\n      #container {\n        position: relative;\n      }\n      #loading-screen {\n        display: flex;\n        justify-content: center;\n        align-items: center;\n      }\n      .loaded #loading-screen {\n        display: none;\n      }\n    "]);

    _templateObject_3b05a700552111ebb34d8b93068ed409 = function _templateObject_3b05a700552111ebb34d8b93068ed409() {
      return data;
    };
  ...
  var IframeLoader = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(IframeLoader, null, [{
      ...
      key: "styles",
      get: function get() {
        return (0, _litElement.css)(_templateObject_3b05a700552111ebb34d8b93068ed409());
      }
    }]);
    ...
    babelHelpers.createClass(IframeLoader, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_3b05a700552111ebb34d8b93068ed409(), this.loading ? "loading" : "loaded", this.__iframeHeight, this.loading ? "none" : "block");
      }
    }]);
    return IframeLoader;
