define(["../../lit/index.js", "../../@polymer/polymer/lib/utils/flattened-nodes-observer.js", "./lib/loading-indicator.js"], function (_index, _flattenedNodesObserver, _loadingIndicator) {
  ...
  var _templateObject_04cd8960ce0511ec9811713d37552719, _templateObject2_04cd8960ce0511ec9811713d37552719;
  ...
  var IframeLoader = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(IframeLoader, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_04cd8960ce0511ec9811713d37552719 || (_templateObject_04cd8960ce0511ec9811713d37552719 = babelHelpers.taggedTemplateLiteral(["\n      <div id=\"container\" class=\"", "\">\n        <div id=\"loading-screen\" style=\"height:", "px;\">\n          <loading-indicator></loading-indicator>\n        </div>\n        <div id=\"slot\" style=\"display: ", "\">\n          <slot></slot>\n        </div>\n      </div>\n    "])), this.loading ? "loading" : "loaded", this.__iframeHeight, this.loading ? "none" : "block");
      }
    }], [{
      key: "properties",
      get: function get() {
      ...
      key: "styles",
      get: function get() {
        return (0, _index.css)(_templateObject2_04cd8960ce0511ec9811713d37552719 || (_templateObject2_04cd8960ce0511ec9811713d37552719 = babelHelpers.taggedTemplateLiteral(["\n      :host {\n        display: block;\n      }\n      #container {\n        position: relative;\n      }\n      #loading-screen {\n        display: flex;\n        justify-content: center;\n        align-items: center;\n      }\n      .loaded #loading-screen {\n        display: none;\n      }\n    "])));
      }
    }]);
    return IframeLoader;
  }(_index.LitElement);
