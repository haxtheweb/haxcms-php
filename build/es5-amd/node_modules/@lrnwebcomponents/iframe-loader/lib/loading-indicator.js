define(["../../../lit/index.js"], function (_index) {
  ...
  var _templateObject_639f79f035d711edbaf51720f3df2ce2, _templateObject2_639f79f035d711edbaf51720f3df2ce2;
  ...
  var LoadingIndicator = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(LoadingIndicator, [{
      ...
      value: function render() {
        return this.loading ? (0, _index.html)(_templateObject_639f79f035d711edbaf51720f3df2ce2 || (_templateObject_639f79f035d711edbaf51720f3df2ce2 = babelHelpers.taggedTemplateLiteral(["<div class=\"progress-line\"></div>"]))) : _index.nothing;
      }
    }], [{
      key: "styles",
      get: function get() {
        return (0, _index.css)(_templateObject2_639f79f035d711edbaf51720f3df2ce2 || (_templateObject2_639f79f035d711edbaf51720f3df2ce2 = babelHelpers.taggedTemplateLiteral(["\n      :host {\n        display: block;\n      }\n      .progress-line,\n      .progress-line:before {\n        height: 5px;\n        width: 100%;\n        margin: auto;\n      }\n      :host([full]) .progress-line {\n        --loading-indicator-width: 100%;\n      }\n      .progress-line {\n        background-color: var(\n          --loading-indicator-background-color,\n          rgba(0, 0, 0, 0.05)\n        );\n        display: -webkit-flex;\n        display: flex;\n        width: var(--loading-indicator-width, 300px);\n      }\n      .progress-line:before {\n        background-color: var(--loading-indicator-color, black);\n        content: \"\";\n        animation: running-progress 2s cubic-bezier(0.4, 0, 0.2, 1) infinite;\n      }\n      @keyframes running-progress {\n        0% {\n          margin-left: 0px;\n          margin-right: 100%;\n        }\n        50% {\n          margin-left: 25%;\n          margin-right: 0%;\n        }\n        100% {\n          margin-left: 100%;\n          margin-right: 0;\n        }\n      }\n      @keyframes fade-out {\n        0% {\n          opacity: 1;\n        }\n        99% {\n          opacity: 0;\n        }\n        100% {\n          opacity: 0;\n        }\n      }\n    "])));
      }
    }, {
      key: "properties",
      get: function get() {
