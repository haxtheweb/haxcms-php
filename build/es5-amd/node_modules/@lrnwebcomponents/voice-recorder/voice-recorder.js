define(["exports", "meta", "../../lit-element/lit-element.js", "./lib/vmsg-fork.js", "../simple-icon/simple-icon.js", "../simple-icon/lib/simple-icons.js"], function (_exports, meta, _litElement, _vmsgFork, _simpleIcon, _simpleIcons) {
  ...
  function _templateObject2_27042cb03ee511ebb7f7a1171f0cd59d() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: inline-flex;\n        }\n      "]);

    _templateObject2_27042cb03ee511ebb7f7a1171f0cd59d = function _templateObject2_27042cb03ee511ebb7f7a1171f0cd59d() {
      return data;
    };
  ...
  function _templateObject_27042cb03ee511ebb7f7a1171f0cd59d() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <button @click=\"", "\">\n        <simple-icon icon=\"", "\"></simple-icon>", "\n      </button>\n      <slot></slot>\n    "]);

    _templateObject_27042cb03ee511ebb7f7a1171f0cd59d = function _templateObject_27042cb03ee511ebb7f7a1171f0cd59d() {
      return data;
    };
  ...
  var VoiceRecorder = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(VoiceRecorder, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_27042cb03ee511ebb7f7a1171f0cd59d(), this.recordState, this.iconState, this.textState);
      }
    }], [{
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_27042cb03ee511ebb7f7a1171f0cd59d())];
      }
    }, {
      key: "properties",
      get: function get() {
