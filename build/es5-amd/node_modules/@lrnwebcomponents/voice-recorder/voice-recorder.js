define(["exports", "meta", "require", "../../lit-element/lit-element.js", "./lib/vmsg-fork.js"], function (_exports, meta, _require, _litElement, _vmsgFork) {
  ...
  function _templateObject2_abb921b0e0c411ea988d4b7e2b2c0fe2() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: inline-flex;\n        }\n      "]);

    _templateObject2_abb921b0e0c411ea988d4b7e2b2c0fe2 = function _templateObject2_abb921b0e0c411ea988d4b7e2b2c0fe2() {
      return data;
    };
  ...
  function _templateObject_abb921b0e0c411ea988d4b7e2b2c0fe2() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <button @click=\"", "\">\n        <iron-icon icon=\"", "\"></iron-icon>", "\n      </button>\n      <slot></slot>\n    "]);

    _templateObject_abb921b0e0c411ea988d4b7e2b2c0fe2 = function _templateObject_abb921b0e0c411ea988d4b7e2b2c0fe2() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(VoiceRecorder, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_abb921b0e0c411ea988d4b7e2b2c0fe2(), this.recordState, this.iconState, this.textState);
      }
    }], [{
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_abb921b0e0c411ea988d4b7e2b2c0fe2())];
      }
    }, {
      key: "properties",
      get: function get() {
