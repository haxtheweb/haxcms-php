define(["exports", "meta", "../../lit/index.js", "./lib/vmsg-fork.js", "../simple-icon/simple-icon.js", "../simple-icon/lib/simple-icons.js"], function (_exports, meta, _index, _vmsgFork, _simpleIcon, _simpleIcons) {
  ...
  var _templateObject_92625120403311edb9fff3e6b08a0a9a, _templateObject2_92625120403311edb9fff3e6b08a0a9a;
  ...
  var VoiceRecorder = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(VoiceRecorder, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_92625120403311edb9fff3e6b08a0a9a || (_templateObject_92625120403311edb9fff3e6b08a0a9a = babelHelpers.taggedTemplateLiteral(["\n      <button @click=\"", "\">\n        <simple-icon icon=\"", "\"></simple-icon>", "\n      </button>\n      <slot></slot>\n    "])), this.recordState, this.iconState, this.textState);
      }
    }, {
      key: "recordState",
      ...
      key: "styles",
      get: function get() {
        return [(0, _index.css)(_templateObject2_92625120403311edb9fff3e6b08a0a9a || (_templateObject2_92625120403311edb9fff3e6b08a0a9a = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: inline-flex;\n        }\n      "])))];
      }
    }, {
      key: "properties",
      get: function get() {
