define(["exports", "meta", "../../lit-element/lit-element.js", "./lib/vmsg-fork.js", "../simple-icon/simple-icon.js", "../simple-icon/lib/simple-icons.js"], function (_exports, meta, _litElement, _vmsgFork, _simpleIcon, _simpleIcons) {
  ...
  function _templateObject2_0cd22b50930211eb82a7a575782a1009() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: inline-flex;\n        }\n      "]);

    _templateObject2_0cd22b50930211eb82a7a575782a1009 = function _templateObject2_0cd22b50930211eb82a7a575782a1009() {
      return data;
    };
  ...
  function _templateObject_0cd22b50930211eb82a7a575782a1009() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <button @click=\"", "\">\n        <simple-icon icon=\"", "\"></simple-icon>", "\n      </button>\n      <slot></slot>\n    "]);

    _templateObject_0cd22b50930211eb82a7a575782a1009 = function _templateObject_0cd22b50930211eb82a7a575782a1009() {
      return data;
    };
  ...
  var VoiceRecorder = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(VoiceRecorder, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_0cd22b50930211eb82a7a575782a1009(), this.recordState, this.iconState, this.textState);
      }
    }], [{
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_0cd22b50930211eb82a7a575782a1009())];
      }
    }, {
      key: "properties",
      get: function get() {
