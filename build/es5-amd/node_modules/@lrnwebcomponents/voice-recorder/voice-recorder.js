define(["exports", "meta", "require", "../../lit-element/lit-element.js", "./lib/vmsg-fork.js"], function (_exports, meta, _require, _litElement, _vmsgFork) {
  ...
  function _templateObject2_402d23f0332811ea9673c9ed9148a8db() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: inline-flex;\n        }\n      "]);

    _templateObject2_402d23f0332811ea9673c9ed9148a8db = function _templateObject2_402d23f0332811ea9673c9ed9148a8db() {
      return data;
    };
  ...
  function _templateObject_402d23f0332811ea9673c9ed9148a8db() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <button @click=\"", "\">\n        <iron-icon icon=\"", "\"></iron-icon>", "\n      </button>\n      <slot></slot>\n    "]);

    _templateObject_402d23f0332811ea9673c9ed9148a8db = function _templateObject_402d23f0332811ea9673c9ed9148a8db() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(VoiceRecorder, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_402d23f0332811ea9673c9ed9148a8db(), this.recordState, this.iconState, this.textState);
      }
    }], [{
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_402d23f0332811ea9673c9ed9148a8db())];
      }
    }, {
      key: "properties",
      get: function get() {
