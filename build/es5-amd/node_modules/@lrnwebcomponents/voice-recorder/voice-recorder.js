define(["exports", "meta", "require", "../../lit-element/lit-element.js", "./lib/vmsg-fork.js"], function (_exports, meta, _require, _litElement, _vmsgFork) {
  ...
  function _templateObject2_82b7f99034ed11eabe39ef50dfa8db3f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: inline-flex;\n        }\n      "]);

    _templateObject2_82b7f99034ed11eabe39ef50dfa8db3f = function _templateObject2_82b7f99034ed11eabe39ef50dfa8db3f() {
      return data;
    };
  ...
  function _templateObject_82b7f99034ed11eabe39ef50dfa8db3f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <button @click=\"", "\">\n        <iron-icon icon=\"", "\"></iron-icon>", "\n      </button>\n      <slot></slot>\n    "]);

    _templateObject_82b7f99034ed11eabe39ef50dfa8db3f = function _templateObject_82b7f99034ed11eabe39ef50dfa8db3f() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(VoiceRecorder, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_82b7f99034ed11eabe39ef50dfa8db3f(), this.recordState, this.iconState, this.textState);
      }
    }], [{
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_82b7f99034ed11eabe39ef50dfa8db3f())];
      }
    }, {
      key: "properties",
      get: function get() {
