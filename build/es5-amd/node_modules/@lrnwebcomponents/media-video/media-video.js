define(["exports","../../@polymer/polymer/polymer-legacy.js","../../@polymer/polymer/lib/legacy/polymer.dom.js"],function(_exports,_polymerLegacy,_polymerDom){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.MediaVideo=void 0;function _templateObject_fd450bf0620511e99fc533744445c188(){var data=babelHelpers.taggedTemplateLiteral(["\n    <style>\n      :host {\n        display: block;\n      }\n    </style>\n    <slot></slot>\n  "]);_templateObject_fd450bf0620511e99fc533744445c188=function _templateObject_fd450bf0620511e99fc533744445c188(){return data};return data}/**
 * `media-video`
 * `Video wrapper class`
 *
 * @demo demo/index.html
 */var MediaVideo=(0,_polymerLegacy.Polymer)({_template:(0,_polymerLegacy.html)(_templateObject_fd450bf0620511e99fc533744445c188()),is:"media-video",behaviors:[],properties:{},ready:function ready(){var _this=this,videoSrc=this.querySelector("*[data-mediavideo-src]");this.addEventListener("click",function(e){e.stopPropagation();var target=(0,_polymerDom.dom)(e).localTarget,videoContainer=_this.querySelector(".mediavideo"),videoPoster=_this.querySelector(".mediavideo-button-container"),videoSrc=_this.querySelector("*[data-mediavideo-src]");videoPoster.classList.toggle("mediavideo-button-display");// Add the is-open tag to the base element.
