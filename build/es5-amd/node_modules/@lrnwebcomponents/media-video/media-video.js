define(["exports","../../@polymer/polymer/polymer-element.js","../../@polymer/polymer/lib/legacy/polymer.dom.js"],function(_exports,_polymerElement,_polymerDom){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.MediaVideo=void 0;function _templateObject_8d161c50a1e511e99b64eb836207f42f(){var data=babelHelpers.taggedTemplateLiteral(["\n      <style>\n        :host {\n          display: block;\n        }\n      </style>\n      <slot></slot>\n    "]);_templateObject_8d161c50a1e511e99b64eb836207f42f=function _templateObject_8d161c50a1e511e99b64eb836207f42f(){return data};return data}/**
 * `media-video`
 * `Video wrapper class`
 *
...
video.setAttribute("src",videoIframeSrc)}},{key:"_stopIframeVideo",value:function _stopIframeVideo(video){video.setAttribute("src","")}}],[{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_8d161c50a1e511e99b64eb836207f42f())}},{key:"tag",get:function get(){return"media-video"}},{key:"properties",get:function get(){return{}}}]);return MediaVideo}(_polymerElement.PolymerElement);_exports.MediaVideo=MediaVideo;window.customElements.define(MediaVideo.tag,MediaVideo)});