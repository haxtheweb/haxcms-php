define(["exports","../../@polymer/polymer/polymer-element.js","../../@polymer/polymer/lib/legacy/polymer.dom.js"],function(_exports,_polymerElement,_polymerDom){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.MediaVideo=void 0;function _templateObject_e1061790836111e99ab3bf9dc53df1be(){var data=babelHelpers.taggedTemplateLiteral(["\n      <style>\n        :host {\n          display: block;\n        }\n      </style>\n      <slot></slot>\n    "]);_templateObject_e1061790836111e99ab3bf9dc53df1be=function _templateObject_e1061790836111e99ab3bf9dc53df1be(){return data};return data}/**
 * `media-video`
 * `Video wrapper class`
 *
...
video.setAttribute("src",videoIframeSrc)}},{key:"_stopIframeVideo",value:function _stopIframeVideo(video){video.setAttribute("src","")}}],[{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_e1061790836111e99ab3bf9dc53df1be())}},{key:"tag",get:function get(){return"media-video"}},{key:"properties",get:function get(){return{}}}]);return MediaVideo}(_polymerElement.PolymerElement);_exports.MediaVideo=MediaVideo;window.customElements.define(MediaVideo.tag,MediaVideo)});