...
*/var PaperInputFlagged=(0,_polymerLegacy.Polymer)({_template:(0,_polymerLegacy.html)(_templateObject_07d7686066fc11e984d945fe2fe0aa60()),is:"paper-input-flagged",properties:{/**
   ...
   */testStatus:function testStatus(test,value){for(var i in test){// special case for null if testing empty
...
this.__activeMessage=this.inputSuccess.message;return this.inputSuccess.status},/**
   ...
   */_iconFromStatus:function _iconFromStatus(status){switch(status){case"error":return"icons:error";break;case"warning":case"notice":return"icons:warning";break;case"info":return"icons:info-outline";break;default:return"icons:info";break;}}});_exports.PaperInputFlagged=PaperInputFlagged});