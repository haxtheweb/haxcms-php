define(["exports", "../../lit-element/lit-element.js", "../simple-icon/simple-icon.js", "../simple-icon/lib/simple-icons.js", "../simple-tooltip/simple-tooltip.js", "../simple-fields/lib/simple-fields-field.js"], function (_exports, _litElement, _simpleIcon, _simpleIcons, _simpleTooltip, _simpleFieldsField) {
  ...
  function _templateObject2_249e29303ee511ebb7f7a1171f0cd59d() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <simple-fields-field\n        label=\"", "\"\n        value=\"", "\"\n        @value-changed=\"", "\"\n        ?char-counter=\"", "\"\n        ?disabled=\"", "\"\n        minlength=\"", "\"\n        maxlength=\"", "\"\n      >\n        <simple-icon id=\"icon\" icon=\"", "\" slot=\"prefix\"></simple-icon>\n      </simple-fields-field>\n      <div class=\"element-invisible\">", "</div>\n      <simple-tooltip\n        for=\"icon\"\n        position=\"top\"\n        offset=\"20\"\n        fit-to-visible-bounds\n      >\n        ", "\n      </simple-tooltip>\n    "]);

    _templateObject2_249e29303ee511ebb7f7a1171f0cd59d = function _templateObject2_249e29303ee511ebb7f7a1171f0cd59d() {
      return data;
    };
  ...
  function _templateObject_249e29303ee511ebb7f7a1171f0cd59d() {
    ...
    _templateObject_249e29303ee511ebb7f7a1171f0cd59d = function _templateObject_249e29303ee511ebb7f7a1171f0cd59d() {
      return data;
    };
  ...
  */
  var PaperInputFlagged = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(PaperInputFlagged, null, [{
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject_249e29303ee511ebb7f7a1171f0cd59d())];
      }
    }]);
    ...
    babelHelpers.createClass(PaperInputFlagged, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_249e29303ee511ebb7f7a1171f0cd59d(), this.label, this.value, this.valueEvent, this.charCounter, this.disabled, this.minlength, this.maxlength, this.icon, this.__activeMessage, this.__activeMessage);
      }
    }, {
      key: "testStatus",
