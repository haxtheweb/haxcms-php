define(["exports", "require", "../../lit-element/lit-element.js"], function (_exports, _require, _litElement) {
  ...
  function _templateObject2_3aabd6b0332811ea9673c9ed9148a8db() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <paper-input\n        label=\"", "\"\n        value=\"", "\"\n        @value-changed=\"", "\"\n        ?char-counter=\"", "\"\n        ?disabled=\"", "\"\n        minlength=\"", "\"\n        maxlength=\"", "\"\n      >\n        <iron-icon id=\"icon\" icon=\"", "\" slot=\"prefix\"></iron-icon>\n      </paper-input>\n      <div class=\"element-invisible\">", "</div>\n      <paper-tooltip\n        for=\"icon\"\n        position=\"top\"\n        offset=\"20\"\n        fit-to-visible-bounds\n      >\n        ", "\n      </paper-tooltip>\n    "]);

    _templateObject2_3aabd6b0332811ea9673c9ed9148a8db = function _templateObject2_3aabd6b0332811ea9673c9ed9148a8db() {
      return data;
    };
  ...
  function _templateObject_3aabd6b0332811ea9673c9ed9148a8db() {
    ...
    _templateObject_3aabd6b0332811ea9673c9ed9148a8db = function _templateObject_3aabd6b0332811ea9673c9ed9148a8db() {
      return data;
    };
  ...
  */
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(PaperInputFlagged, null, [{
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject_3aabd6b0332811ea9673c9ed9148a8db())];
      }
    }]);
    ...
    babelHelpers.createClass(PaperInputFlagged, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_3aabd6b0332811ea9673c9ed9148a8db(), this.label, this.value, this.valueEvent, this.charCounter, this.disabled, this.minlength, this.maxlength, this.icon, this.__activeMessage, this.__activeMessage);
      }
    }, {
      key: "testStatus",
