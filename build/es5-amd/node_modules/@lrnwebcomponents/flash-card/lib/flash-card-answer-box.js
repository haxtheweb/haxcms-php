define(["exports", "meta", "../../i18n-manager/lib/I18NMixin.js", "../../../lit/index.js", "../../simple-colors/simple-colors.js", "../../simple-icon/lib/simple-icons.js", "../../simple-icon/lib/simple-icon-lite.js", "../../simple-icon/lib/simple-icon-button-lite.js"], function (_exports, meta, _I18NMixin2, _index, _simpleColors, _simpleIcons, _simpleIconLite, _simpleIconButtonLite) {
  ...
  var _templateObject_f532b200e46a11edbf2e2349c355f24c, _templateObject2_f532b200e46a11edbf2e2349c355f24c, _templateObject3_f532b200e46a11edbf2e2349c355f24c, _templateObject4_f532b200e46a11edbf2e2349c355f24c, _templateObject5_f532b200e46a11edbf2e2349c355f24c;
  ...
  var FlashCardAnswerBox = /*#__PURE__*/function (_I18NMixin) {
    ...
    babelHelpers.createClass(FlashCardAnswerBox, [{
      ...
      function render() {
        var _this3 = this;
        return (0, _index.html)(_templateObject_f532b200e46a11edbf2e2349c355f24c || (_templateObject_f532b200e46a11edbf2e2349c355f24c = babelHelpers.taggedTemplateLiteral(["\n      <div>\n        <p id=\"question\">\n          <slot name=\"front\" id=\"front\"></slot>\n          <slot name=\"back\" id=\"back\"></slot>\n        </p>\n        ", "\n      </div>\n      <div class=\"answer-section\">\n        <input\n          id=\"answer\"\n          type=\"text\"\n          .placeholder=\"", "\"\n          @input=\"", "\"\n          @keypress=\"", "\"\n          .value=\"", "\"\n        />\n        ", "\n      </div>\n      <div class=\"retry\">\n        <simple-icon-button-lite icon=\"refresh\" @click=\"", "\"\n          >", "</simple-icon-button-lite\n        >\n      </div>\n    "])), this.showResult || this.correct ? (0, _index.html)(_templateObject2_f532b200e46a11edbf2e2349c355f24c || (_templateObject2_f532b200e46a11edbf2e2349c355f24c = babelHelpers.taggedTemplateLiteral(["<p class=\"answer-message\">\n              Correct Answer: ", "\n            </p>"])), this.correctAnswer) : "", this.t.yourAnswer, this.inputChanged, function (e) {
          return e.key === "Enter" ? _this3.checkUserAnswer() : "";
        }, this.userAnswer, this.status === "pending" ? (0, _index.html)(_templateObject3_f532b200e46a11edbf2e2349c355f24c || (_templateObject3_f532b200e46a11edbf2e2349c355f24c = babelHelpers.taggedTemplateLiteral(["<button\n              id=\"check\"\n              ?disabled=\"", "\"\n              @click=\"", "\"\n            >\n              ", "\n            </button>"])), this.userAnswer === "", this.checkUserAnswer, this.t.checkAnswer) : (0, _index.html)(_templateObject4_f532b200e46a11edbf2e2349c355f24c || (_templateObject4_f532b200e46a11edbf2e2349c355f24c = babelHelpers.taggedTemplateLiteral(["<span id=\"status-message\"\n              ><simple-icon-lite\n                id=\"status-icon\"\n                icon=\"", "\"\n              ></simple-icon-lite\n              >", "</span\n            >"])), this.icon, this.message), this.resetCard, this.t.retry);
      }
    }], [{
      key: "tag",
      get: function get() {
