...
get:function get(){return(0,_polymerElement.html)(_templateObject_151feda07dd911e9a7b37fd50448dc31())}// properties available to the custom element for data binding
...
new Promise(function(res,rej){return _require.default(["@lrnwebcomponents/haxcms-elements/lib/ui-components/navigation/site-top-menu.js"],res,rej)});new Promise(function(res,rej){return _require.default(["@lrnwebcomponents/haxcms-elements/lib/ui-components/navigation/site-breadcrumb.js"],res,rej)});new Promise(function(res,rej){return _require.default(["@lrnwebcomponents/haxcms-elements/lib/ui-components/layout/site-modal.js"],res,rej)});// create a blank array to store mobx reactions
...
(0,_renderStatus.afterNextRender)(babelHelpers.assertThisInitialized(_this),function(){new Promise(function(res,rej){return _require.default(["@lrnwebcomponents/haxcms-elements/lib/ui-components/navigation/site-menu-button.js"],res,rej)});new Promise(function(res,rej){return _require.default(["@lrnwebcomponents/haxcms-elements/lib/ui-components/site/site-search.js"],res,rej)})});return _this}/**
