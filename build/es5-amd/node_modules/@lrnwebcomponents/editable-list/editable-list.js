define(["exports", "require", "../../lit/index.js", "../simple-modal/simple-modal.js"], function (_exports, _require, _index, _simpleModal) {
  ...
  var _templateObject_48c817b0509711edb124eb517be36dbf, _templateObject2_48c817b0509711edb124eb517be36dbf, _templateObject3_48c817b0509711edb124eb517be36dbf;
  ...
  var EditableList = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(EditableList, [{
      ...
      function render() {
        return (0, _index.html)(_templateObject_48c817b0509711edb124eb517be36dbf || (_templateObject_48c817b0509711edb124eb517be36dbf = babelHelpers.taggedTemplateLiteral([" <div id=\"list\">\n      ", "\n    </div>"])), this.items.map(function (item) {
          return (0, _index.html)(_templateObject2_48c817b0509711edb124eb517be36dbf || (_templateObject2_48c817b0509711edb124eb517be36dbf = babelHelpers.taggedTemplateLiteral(["\n          <editable-list-item\n            ?edit-mode=\"", "\"\n            ?can-edit=\"", "\"\n            ?can-delete=\"", "\"\n            value=\"", "\"\n          ></editable-list-item>\n        "])), item.metadata.canEdit, item.metadata.canEdit, item.metadata.canDelete, item.title);
        }));
      ...
      get: //styles function
      function get() {
        return [(0, _index.css)(_templateObject3_48c817b0509711edb124eb517be36dbf || (_templateObject3_48c817b0509711edb124eb517be36dbf = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n\n        :host([hidden]) {\n          display: none;\n        }\n\n        #list {\n          height: 100%;\n        }\n      "])))];
      }
    }, {
      key: "properties",
      get: function get() {
