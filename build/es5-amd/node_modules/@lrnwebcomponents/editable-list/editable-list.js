define(["exports", "require", "../../lit/index.js", "../simple-modal/simple-modal.js"], function (_exports, _require, _index, _simpleModal) {
  ...
  var _templateObject_2b35a8e0e8f211edb01b473406559cea, _templateObject2_2b35a8e0e8f211edb01b473406559cea, _templateObject3_2b35a8e0e8f211edb01b473406559cea;
  ...
  var EditableList = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(EditableList, [{
      ...
      // render function
      function render() {
        return (0, _index.html)(_templateObject_2b35a8e0e8f211edb01b473406559cea || (_templateObject_2b35a8e0e8f211edb01b473406559cea = babelHelpers.taggedTemplateLiteral([" <div id=\"list\">\n      ", "\n    </div>"])), this.items.map(function (item) {
          return (0, _index.html)(_templateObject2_2b35a8e0e8f211edb01b473406559cea || (_templateObject2_2b35a8e0e8f211edb01b473406559cea = babelHelpers.taggedTemplateLiteral(["\n          <editable-list-item\n            ?edit-mode=\"", "\"\n            ?can-edit=\"", "\"\n            ?can-delete=\"", "\"\n            value=\"", "\"\n          ></editable-list-item>\n        "])), item.metadata.canEdit, item.metadata.canEdit, item.metadata.canDelete, item.title);
        }));
      }
      ...
      //styles function
      function get() {
        return [(0, _index.css)(_templateObject3_2b35a8e0e8f211edb01b473406559cea || (_templateObject3_2b35a8e0e8f211edb01b473406559cea = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n\n        :host([hidden]) {\n          display: none;\n        }\n\n        #list {\n          height: 100%;\n        }\n      "])))];
      }
    }, {
      key: "properties",
      get: function get() {
