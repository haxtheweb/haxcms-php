define(["exports", "require", "../../lit-element/lit-element.js", "../simple-modal/simple-modal.js"], function (_exports, _require, _litElement, _simpleModal) {
  ...
  function _templateObject3_a88013402dd211eba8a9dbdc0fc9b6e0() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n\n        :host([hidden]) {\n          display: none;\n        }\n\n        #list {\n          height: 100%;\n        }\n      "]);

    _templateObject3_a88013402dd211eba8a9dbdc0fc9b6e0 = function _templateObject3_a88013402dd211eba8a9dbdc0fc9b6e0() {
      return data;
    };
  ...
  function _templateObject2_a88013402dd211eba8a9dbdc0fc9b6e0() {
    var data = babelHelpers.taggedTemplateLiteral(["\n          <editable-list-item\n            ?edit-mode=\"", "\"\n            ?can-edit=\"", "\"\n            ?can-delete=\"", "\"\n            value=\"", "\"\n          ></editable-list-item>\n        "]);

    _templateObject2_a88013402dd211eba8a9dbdc0fc9b6e0 = function _templateObject2_a88013402dd211eba8a9dbdc0fc9b6e0() {
      return data;
    };
  ...
  function _templateObject_a88013402dd211eba8a9dbdc0fc9b6e0() {
    var data = babelHelpers.taggedTemplateLiteral([" <div id=\"list\">\n      ", "\n    </div>"]);

    _templateObject_a88013402dd211eba8a9dbdc0fc9b6e0 = function _templateObject_a88013402dd211eba8a9dbdc0fc9b6e0() {
      return data;
    };
  ...
  var EditableList = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(EditableList, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_a88013402dd211eba8a9dbdc0fc9b6e0(), this.items.map(function (item) {
          return (0, _litElement.html)(_templateObject2_a88013402dd211eba8a9dbdc0fc9b6e0(), item.metadata.canEdit, item.metadata.canEdit, item.metadata.canDelete, item.title);
        }));
      ...
      //styles function
      get: function get() {
        return [(0, _litElement.css)(_templateObject3_a88013402dd211eba8a9dbdc0fc9b6e0())];
      }
    }, {
      key: "properties",
      get: function get() {
