define(["exports", "../../../lit-element/lit-element.js", "../../simple-colors/simple-colors.js", "../../simple-icon/simple-icon.js", "../../simple-icon/lib/simple-icons.js", "../../simple-icon/lib/simple-icon-button.js", "../../../@polymer/paper-input/paper-input.js", "../../../@polymer/polymer/lib/elements/custom-style.js"], function (_exports, _litElement, _simpleColors, _simpleIcon, _simpleIcons, _simpleIconButton, _paperInput, _customStyle) {
  ...
  function _templateObject2_2871ed803ee511ebb7f7a1171f0cd59d() {
    ...
    _templateObject2_2871ed803ee511ebb7f7a1171f0cd59d = function _templateObject2_2871ed803ee511ebb7f7a1171f0cd59d() {
      return data;
    };
  ...
  function _templateObject_2871ed803ee511ebb7f7a1171f0cd59d() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <custom-style>\n        <style>\n          paper-input {\n            --paper-input-container-shared-input-style: {\n              height: 40px;\n              padding: 0;\n              margin: 0;\n            }\n          }\n        </style>\n      </custom-style>\n      <paper-input\n        id=\"input\"\n        class=\"input\"\n        value=\"", "\"\n        @value-changed=\"", "\"\n        ?hidden=\"", "\"\n      ></paper-input>\n      <div class=\"input\" ?hidden=\"", "\">", "</div>\n      <div class=\"ops\" ?hidden=\"", "\">\n        <simple-icon-button\n          @click=\"", "\"\n          id=\"edit\"\n          icon=\"icons:create\"\n        ></simple-icon-button>\n        <simple-icon-button\n          @click=\"", "\"\n          id=\"add\"\n          icon=\"icons:add\"\n        ></simple-icon-button>\n        <simple-icon-button\n          @click=\"", "\"\n          id=\"duplicate\"\n          icon=\"icons:content-copy\"\n        ></simple-icon-button>\n        <simple-icon-button\n          @click=\"", "\"\n          id=\"delete\"\n          icon=\"icons:delete\"\n        ></simple-icon-button>\n      </div>\n    "]);

    _templateObject_2871ed803ee511ebb7f7a1171f0cd59d = function _templateObject_2871ed803ee511ebb7f7a1171f0cd59d() {
      return data;
    };
  ...
  var EditableListItem = /*#__PURE__*/function (_SimpleColors) {
    ...
    babelHelpers.createClass(EditableListItem, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_2871ed803ee511ebb7f7a1171f0cd59d(), this.value, this.valueChanged, !this.editing, !this.editing, this.value, !this.editMode, this._editToggle, this._editToggle, this._editToggle, this._deleteModal);
      }
    }, {
      key: "valueChanged",
       ...
       */
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(EditableListItem), "styles", this)), [(0, _litElement.css)(_templateObject2_2871ed803ee511ebb7f7a1171f0cd59d())]);
      }
    }]);
