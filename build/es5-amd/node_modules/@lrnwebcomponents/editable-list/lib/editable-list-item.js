define(["exports", "../../../lit/index.js", "../../simple-colors/simple-colors.js", "../../simple-icon/simple-icon.js", "../../simple-icon/lib/simple-icons.js", "../../simple-icon/lib/simple-icon-button.js", "../../../@polymer/paper-input/paper-input.js", "../../../@polymer/polymer/lib/elements/custom-style.js"], function (_exports, _index, _simpleColors, _simpleIcon, _simpleIcons, _simpleIconButton, _paperInput, _customStyle) {
  ...
  var _templateObject_59be6580cd5f11ec99f033b292664e90, _templateObject2_59be6580cd5f11ec99f033b292664e90;
  ...
  var EditableListItem = /*#__PURE__*/function (_SimpleColors) {
    ...
    babelHelpers.createClass(EditableListItem, [{
       ...
       */
      function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(EditableListItem), "styles", this)), [(0, _index.css)(_templateObject2_59be6580cd5f11ec99f033b292664e90 || (_templateObject2_59be6580cd5f11ec99f033b292664e90 = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n        :host([hidden]) {\n          display: none;\n        }\n        :host([can-edit]) #edit {\n          visibility: visible;\n          opacity: 1;\n        }\n        :host([can-delete]) #delete {\n          visibility: visible;\n          opacity: 1;\n        }\n        :host #add,\n        #duplicate {\n          visibility: visible;\n          opacity: 1;\n        }\n        simple-icon-button {\n          visibility: hidden;\n          opacity: 0;\n          transition: 0.3s all linear;\n        }\n        .input {\n          display: block;\n          height: 40px;\n          padding: 0;\n          margin: 0;\n          line-height: 40px;\n        }\n        .input[hidden] {\n          display: none;\n        }\n        div.input {\n          z-index: 1;\n        }\n        .ops {\n          position: absolute;\n          display: block;\n          right: 0;\n          top: 0;\n          z-index: 2;\n          background-color: white;\n        }\n        .ops simple-icon-button {\n          border-radius: 50%;\n          --simple-icon-height: 32px;\n          --simple-icon-width: 32px;\n          padding: 4px;\n          margin: 0px;\n        }\n        .ops[hidden] {\n          display: none;\n        }\n        #edit {\n          color: white;\n          background-color: var(--simple-colors-default-theme-green-8, #ddffdd);\n        }\n        #delete {\n          color: white;\n          background-color: var(--simple-colors-default-theme-red-6, #ff5555);\n        }\n      "])))]);
      }
    }, {
      key: "properties",
      get: function get() {
