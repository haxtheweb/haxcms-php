define(["exports", "require", "../../lit-element/lit-element.js", "../materializecss-styles/lib/colors.js", "../../@polymer/paper-button/paper-button.js", "../../@polymer/iron-icon/iron-icon.js"], function (_exports, _require, _litElement, _colors, _paperButton, _ironIcon) {
  ...
  function _templateObject2_79f7fc1034ed11eabe39ef50dfa8db3f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <a\n        tabindex=\"-1\"\n        id=\"lrnsys-button-link\"\n        href=\"", "\"\n        target=\"", "\"\n        ?disabled=\"", "\"\n      >\n        <paper-button\n          id=\"button\"\n          title=\"", "\"\n          ?raised=\"", "\"\n          class=\"", " ", " ", "\"\n          ?disabled=\"", "\"\n          @focus-changed=\"", "\"\n        >\n          <div class=\"inner ", "\">\n            <slot name=\"prefix\"></slot>\n            <iron-icon\n              icon=\"", "\"\n              id=\"icon\"\n              class=\"", "\"\n              ?hidden=\"", "\"\n            ></iron-icon>\n            <span class=\"label\" ?hidden=\"", "\"> ", " </span>\n            <slot></slot>\n          </div>\n        </paper-button>\n      </a>\n      <paper-tooltip\n        for=\"lrnsys-button-link\"\n        animation-delay=\"0\"\n        ?hidden=\"", "\"\n        >", "</paper-tooltip\n      >\n    "]);

    _templateObject2_79f7fc1034ed11eabe39ef50dfa8db3f = function _templateObject2_79f7fc1034ed11eabe39ef50dfa8db3f() {
      return data;
    };
  ...
  function _templateObject_79f7fc1034ed11eabe39ef50dfa8db3f() {
    ...
    _templateObject_79f7fc1034ed11eabe39ef50dfa8db3f = function _templateObject_79f7fc1034ed11eabe39ef50dfa8db3f() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(LrnsysButton, null, [{
      key: "styles",
      get: function get() {
        return [_colors.materialCssStyles, (0, _litElement.css)(_templateObject_79f7fc1034ed11eabe39ef50dfa8db3f())];
      }
    }]);
    ...
    babelHelpers.createClass(LrnsysButton, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_79f7fc1034ed11eabe39ef50dfa8db3f(), this.href, this.target, this.disabled, this.alt, this.raised, this.buttonClass, this.color, this.textColor, this.disabled, this.focusToggle, this.innerClass, this.icon, this.iconClass, !this.icon, !this.label, this.label, !this.alt, this.alt);
      }
    }, {
      key: "tapEventOn",
