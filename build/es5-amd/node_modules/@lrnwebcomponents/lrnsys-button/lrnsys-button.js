define(["exports", "../../lit-element/lit-element.js", "../materializecss-styles/lib/colors.js", "../elmsln-apps/lib/elmsln-base-deps.js", "../simple-tooltip/simple-tooltip.js"], function (_exports, _litElement, _colors, _elmslnBaseDeps, _simpleTooltip) {
  ...
  function _templateObject2_2385db603ee511ebb7f7a1171f0cd59d() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <a tabindex=\"-1\" id=\"lrnsys-button-link\" ?disabled=\"", "\">\n        <button\n          id=\"button\"\n          title=\"", "\"\n          class=\"", " ", " ", "\"\n          ?disabled=\"", "\"\n          @focus-changed=\"", "\"\n        >\n          <div class=\"inner ", "\">\n            <slot name=\"prefix\"></slot>\n            <simple-icon\n              icon=\"", "\"\n              id=\"icon\"\n              ?dark=\"", "\"\n              accent-color=\"grey\"\n              contrast=\"4\"\n              class=\"", "\"\n              ?hidden=\"", "\"\n            ></simple-icon>\n            <span class=\"label\" ?hidden=\"", "\"> ", " </span>\n            <slot></slot>\n          </div>\n        </button>\n      </a>\n      <simple-tooltip\n        for=\"lrnsys-button-link\"\n        animation-delay=\"0\"\n        ?hidden=\"", "\"\n        >", "</simple-tooltip\n      >\n    "]);

    _templateObject2_2385db603ee511ebb7f7a1171f0cd59d = function _templateObject2_2385db603ee511ebb7f7a1171f0cd59d() {
      return data;
    };
  ...
  function _templateObject_2385db603ee511ebb7f7a1171f0cd59d() {
    ...
    _templateObject_2385db603ee511ebb7f7a1171f0cd59d = function _templateObject_2385db603ee511ebb7f7a1171f0cd59d() {
      return data;
    };
  ...
  var LrnsysButton = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(LrnsysButton, null, [{
      key: "styles",
      get: function get() {
        return [_colors.materialCssStyles, (0, _litElement.css)(_templateObject_2385db603ee511ebb7f7a1171f0cd59d())];
      }
    }]);
    ...
    babelHelpers.createClass(LrnsysButton, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_2385db603ee511ebb7f7a1171f0cd59d(), this.disabled, this.alt, this.buttonClass, this.color, this.textColor, this.disabled, this.focusToggle, this.innerClass, this.icon, this.dark, this.iconClass, !this.icon, !this.label, this.label, !this.alt, this.alt);
      }
    }, {
      key: "tapEventOn",
