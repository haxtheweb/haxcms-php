define(["exports", "../hax-body/lib/hax-store.js", "./lib/h-a-x-dependencies.js", "../utils/utils.js", "../editable-table/lib/editable-table-behaviors.js", "../simple-icon/lib/simple-iconset.js", "../course-design/lib/learning-component.js"], function (_exports, _haxStore, _hAXDependencies, _utils, _editableTableBehaviors, _simpleIconset, _learningComponent) {
  "use strict";
  ...
  var HAX = /*#__PURE__*/function (_HTMLElement) {
    ...
    babelHelpers.createClass(HAX, [{
      ...
      // render function
      function get() {
        var decorationStyles = ["red", "blue", "green", "orange", "purple"].map(function (item) {
        ...
        var instructionalStyles = Object.keys(_learningComponent.learningComponentColors).map(function (item) {
          ...
          return "\n        h1[data-instructional-action=\"".concat(item, "\"],\n        h2[data-instructional-action=\"").concat(item, "\"],\n        h3[data-instructional-action=\"").concat(item, "\"],\n        h4[data-instructional-action=\"").concat(item, "\"],\n        h5[data-instructional-action=\"").concat(item, "\"],\n        h6[data-instructional-action=\"").concat(item, "\"] {\n          --hax-action-color: var(--simple-colors-default-theme-").concat(color, "-8, ").concat(color, ");\n          --hax-action-line-color: var(--simple-colors-default-theme-").concat(color, "-8, ").concat(color, ");\n          --hax-action-accent-color: #eeeeee;\n          --hax-action-border: var(--simple-colors-default-theme-").concat(color, "-8, ").concat(color, ") solid 3px;\n        }\n        h1[data-instructional-action=\"").concat(item, "\"]::after,\n        h2[data-instructional-action=\"").concat(item, "\"]::after,\n        h3[data-instructional-action=\"").concat(item, "\"]::after,\n        h4[data-instructional-action=\"").concat(item, "\"]::after,\n        h5[data-instructional-action=\"").concat(item, "\"]::after,\n        h6[data-instructional-action=\"").concat(item, "\"]::after {\n          -webkit-mask-image: url(\"").concat(_simpleIconset.SimpleIconsetStore.getIcon((0, _learningComponent.iconFromPageType)(item)), "\");\n        }\n        \n        hr[data-instructional-action=\"").concat(item, "\"] {\n          --hax-action-color: var(--simple-colors-default-theme-").concat(color, "-8, ").concat(color, ");\n          --hax-action-line-color: var(--simple-colors-default-theme-").concat(color, "-8, ").concat(color, ");\n          --hax-action-accent-color: #eeeeee;\n          --hax-action-border: var(--simple-colors-default-theme-").concat(color, "-8, ").concat(color, ") solid 3px;\n        }\n        \n        hr[data-instructional-action=\"").concat(item, "\"]::after {\n          -webkit-mask-image: url(\"").concat(_simpleIconset.SimpleIconsetStore.getIcon((0, _learningComponent.iconFromPageType)(item)), "\");\n        }\n        ");
        });
        return "\n    <style>\n    ".concat(decorationStyles.join("\n"), "\n    ").concat(instructionalStyles.join("\n"), "\n    ").concat(_editableTableBehaviors.editableTableDisplayStyles.map(function (s) {
      ...
      value: function applyHAX() {
        ...
        var store = window.HaxStore.requestAvailability();
        // now everyone else
