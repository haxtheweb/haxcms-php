 ...
 *
 */var LrndesignChartBehaviors=/*#__PURE__*/function(_SimpleColors){babelHelpers.inherits(LrndesignChartBehaviors,_SimpleColors);function LrndesignChartBehaviors(){babelHelpers.classCallCheck(this,LrndesignChartBehaviors);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(LrndesignChartBehaviors).apply(this,arguments))}babelHelpers.createClass(LrndesignChartBehaviors,[{key:"connectedCallback",/**
   * life cycle, element is afixed to the DOM
   */value:function connectedCallback(){babelHelpers.get(babelHelpers.getPrototypeOf(LrndesignChartBehaviors.prototype),"connectedCallback",this).call(this);var root=this;this.HAXWiring=new _HAXWiring.HAXWiring}/**
   * life cycle, element is ready
   */},{key:"ready",value:function ready(){babelHelpers.get(babelHelpers.getPrototypeOf(LrndesignChartBehaviors.prototype),"ready",this).call(this);var root=this,checkReady=setInterval(function(){if(root.__dataReady){root.$.chartist.makeChart();clearInterval(checkReady)}},1)}/**
...
get:function get(){return(0,_polymerElement.html)(_templateObject_1aa3369066f711e999fe19a29ec80b99())}// properties available to the custom element for data binding
...
.ct-double-octave	  1:4```
   ...
   */},{key:"tag",get:function get(){return"lrndesign-chart-behaviors"}//get player-specific behaviors
},{key:"behaviors",get:function get(){return[HAXBehaviors.PropertiesBehaviors,SchemaBehaviors.Schema]}// haxProperty definition
