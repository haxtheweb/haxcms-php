define(["exports","../../../@polymer/polymer/polymer-element.js","./lrndesign-chart-behaviors.js"],function(_exports,_polymerElement,_lrndesignChartBehaviors){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0/* transition */ /* transition */});_exports.LrndesignPie=void 0;/**
 ...
 * @demo demo/pie.html
 *
 */var LrndesignPie=/*#__PURE__*/function(_LrndesignChartBehavi){babelHelpers.inherits(LrndesignPie,_LrndesignChartBehavi);function LrndesignPie(){babelHelpers.classCallCheck(this,LrndesignPie);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(LrndesignPie).apply(this,arguments))}babelHelpers.createClass(LrndesignPie,[{key:"connectedCallback",/**
   * life cycle, element is afixed to the DOM
   */value:function connectedCallback(){babelHelpers.get(babelHelpers.getPrototypeOf(LrndesignPie.prototype),"connectedCallback",this).call(this);this.HAXWiring.setup(LrndesignPie.haxProperties,LrndesignPie.tag,this)}/**
   * returns options as an array
   */},{key:"_getOptions",value:function _getOptions(){var options={width:this.width,height:this.height,/*'chartPadding': {
        'top': this.paddingTop,
        'right': this.paddingRight,
        'bottom': this.paddingBottom,
        'left': this.paddingLeft
      },*/startAngle:this.startAngle,total:this.total,donut:this.donut,showLabel:this.showLabel,labelOffset:this.labelOffset,labelPosition:this.labelPosition,labelDirection:this.labelDirection,reverseData:this.reverseData,ignoreEmptyValues:this.ignoreEmptyValues};console.log(options);return options}}],[{key:"properties",// properties available to the custom element for data binding
