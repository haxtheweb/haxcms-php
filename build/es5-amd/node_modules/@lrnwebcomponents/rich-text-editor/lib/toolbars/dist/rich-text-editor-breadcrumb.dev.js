...
function _templateObject2_b06bec20509711edb124eb517be36dbf() {
  var data = _taggedTemplateLiteral(["\n        #button {\n          font-family: monospace;\n          display: inline-block;\n          text-align: center;\n          min-width: 25px;\n          margin: 0;\n          padding: 2px 5px;\n        }\n\xA0\xA0\xA0\xA0\xA0\xA0"]);

  _templateObject2_b06bec20509711edb124eb517be36dbf = function _templateObject2_b06bec20509711edb124eb517be36dbf() {
    return data;
  };
...
function _templateObject_b06bec20509711edb124eb517be36dbf() {
  var data = _taggedTemplateLiteral(['\n      <button\n        id="button"\n        aria-controls="', '"\n        @click="', '"\n        tabindex="0"\n      >\n        ', "\n      </button>\n    "]);

  _templateObject_b06bec20509711edb124eb517be36dbf = function _templateObject_b06bec20509711edb124eb517be36dbf() {
    return data;
  };
...
var RichTextEditorBreadcrumb = /*#__PURE__*/function (_LitElement) {
  ...
  _createClass(RichTextEditorBreadcrumb, [{
    ...
    value: function render() {
      return (0, _litElement.html)(_templateObject_b06bec20509711edb124eb517be36dbf(), this.controls, this._handleClick, this.label);
    }
  }], [{
    key: "tag",
    ...
    key: "styles",
    get: function get() {
      return [].concat(_toConsumableArray(_richTextEditorButton.RichTextStyles), [(0, _litElement.css)(_templateObject2_b06bec20509711edb124eb517be36dbf())]);
    }
  }, {
    key: "properties",
    get: function get() {
