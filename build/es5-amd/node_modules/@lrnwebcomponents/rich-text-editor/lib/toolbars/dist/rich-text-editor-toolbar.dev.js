...
function _templateObject3_b0854080509711edb124eb517be36dbf() {
  ...
  _templateObject3_b0854080509711edb124eb517be36dbf = function _templateObject3_b0854080509711edb124eb517be36dbf() {
    return data;
  };
...
function _templateObject2_b0854080509711edb124eb517be36dbf() {
  var data = _taggedTemplateLiteral(["\n          :host {\n            position: relative;\n            height: 0;\n            margin: 0 auto;\n            padding: 0;\n            border: none;\n            background-color: none;\n          }\n          #container {\n            display: flex;\n            position: absolute;\n            bottom: 0;\n            margin: 0 auto;\n            padding: 0;\n            border: var(--rich-text-editor-border-width, 1px) solid\n              var(--rich-text-editor-border-color, #ddd);\n            background-color: var(\n              --rich-text-editor-bg,\n              var(--rich-text-editor-bg, #ffffff)\n            );\n          }\n        "]);

  _templateObject2_b0854080509711edb124eb517be36dbf = function _templateObject2_b0854080509711edb124eb517be36dbf() {
    return data;
  };
...
function _templateObject_b0854080509711edb124eb517be36dbf() {
  var data = _taggedTemplateLiteral([' <div id="container">', "</div> "]);

  _templateObject_b0854080509711edb124eb517be36dbf = function _templateObject_b0854080509711edb124eb517be36dbf() {
    return data;
  };
...
var RichTextEditorToolbarBehaviors = function RichTextEditorToolbarBehaviors(SuperClass) {
  return /*#__PURE__*/function (_RichTextEditorRangeB) {
    ...
    _createClass(_class, [{
      ...
      key: "miniTemplate",
      get: function get() {
        return (0, _litElement.html)(_templateObject_b0854080509711edb124eb517be36dbf(), _get(_getPrototypeOf(_class.prototype), "toolbarTemplate", this));
      }
      /**
      ...
      key: "miniStyles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_b0854080509711edb124eb517be36dbf())];
      }
      /**
      ...
      key: "baseStyles",
      get: function get() {
        return [].concat(_toConsumableArray(_get(_getPrototypeOf(_class), "baseStyles", this)), _toConsumableArray(_richTextEditorButton.RichTextStyles), [(0, _litElement.css)(_templateObject3_b0854080509711edb124eb517be36dbf())]);
      }
      /**
