define(["exports", "../../../../lit/index.js", "../buttons/rich-text-editor-button.js", "../singletons/rich-text-editor-range-behaviors.js"], function (_exports, _index, _richTextEditorButton, _richTextEditorRangeBehaviors) {
  ...
  var _templateObject_3a97bc00edcb11edb3e3ed4f0d506a4b, _templateObject2_3a97bc00edcb11edb3e3ed4f0d506a4b, _templateObject3_3a97bc00edcb11edb3e3ed4f0d506a4b, _templateObject4_3a97bc00edcb11edb3e3ed4f0d506a4b;
  ...
  var RichTextEditorBreadcrumbs = /*#__PURE__*/function (_RichTextEditorRangeB) {
    ...
    babelHelpers.createClass(RichTextEditorBreadcrumbs, [{
      ...
      value: function render() {
        var _this2 = this;
        return (0, _index.html)(_templateObject_3a97bc00edcb11edb3e3ed4f0d506a4b || (_templateObject_3a97bc00edcb11edb3e3ed4f0d506a4b = babelHelpers.taggedTemplateLiteral(["\n      ", ":\n      ", "\n    "])), this.label, !this.selectionAncestors ? "" : (this.selectionAncestors || []).map(function (ancestor, i) {
          return (0, _index.html)(_templateObject2_3a97bc00edcb11edb3e3ed4f0d506a4b || (_templateObject2_3a97bc00edcb11edb3e3ed4f0d506a4b = babelHelpers.taggedTemplateLiteral(["\n              <button\n                class=\"", "\"\n                controls=\"", "\"\n                @click=\"", "\"\n                tabindex=\"0\"\n              >\n                ", "\n              </button>\n              ", "\n            "])), !!ancestor.selectAll ? "" : "selectnode", _this2.controls, function (e) {
            return _this2._handleClick(ancestor);
          }, ancestor.nodeName.toLowerCase(), i + 1 >= (_this2.selectionAncestors || []).length ? "" : (0, _index.html)(_templateObject3_3a97bc00edcb11edb3e3ed4f0d506a4b || (_templateObject3_3a97bc00edcb11edb3e3ed4f0d506a4b = babelHelpers.taggedTemplateLiteral([" <span class=\"divider\"> &gt; </span> "]))));
        }));
      }
    }], [{
      key: "tag",
