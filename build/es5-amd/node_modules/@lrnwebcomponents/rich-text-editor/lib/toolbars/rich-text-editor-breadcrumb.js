define(["exports", "../../../../lit-element/lit-element.js", "../buttons/rich-text-editor-button-styles.js"], function (_exports, _litElement, _richTextEditorButtonStyles) {
  ...
  function _templateObject2_38f8e2803ee511ebb7f7a1171f0cd59d() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        #button {\n          font-family: monospace;\n          display: inline-block;\n          text-align: center;\n          min-width: 30px;\n          line-height: 30px;\n          margin: 0;\n          padding: 2px 5px;\n        }\n\xA0\xA0\xA0\xA0\xA0\xA0"]);

    _templateObject2_38f8e2803ee511ebb7f7a1171f0cd59d = function _templateObject2_38f8e2803ee511ebb7f7a1171f0cd59d() {
      return data;
    };
  ...
  function _templateObject_38f8e2803ee511ebb7f7a1171f0cd59d() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <button\n        id=\"button\"\n        class=\"rtebutton rtebreadcrumb\"\n        aria-controls=\"", "\"\n        @click=\"", "\"\n        tabindex=\"0\"\n        part=\"button\"\n      >\n        ", "\n      </button>\n    "]);

    _templateObject_38f8e2803ee511ebb7f7a1171f0cd59d = function _templateObject_38f8e2803ee511ebb7f7a1171f0cd59d() {
      return data;
    };
  ...
  var RichTextEditorBreadcrumb = /*#__PURE__*/function (_RichTextEditorButton) {
    ...
    babelHelpers.createClass(RichTextEditorBreadcrumb, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_38f8e2803ee511ebb7f7a1171f0cd59d(), this.controls, this._buttonTap, this.tag);
      }
    }], [{
      key: "tag",
      ...
      key: "styles",
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(RichTextEditorBreadcrumb), "styles", this)), [(0, _litElement.css)(_templateObject2_38f8e2803ee511ebb7f7a1171f0cd59d())]);
      }
    }, {
      key: "properties",
      get: function get() {
