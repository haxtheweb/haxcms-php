...
function _templateObject2_c739d010af6311ebbe560fe9c4727db1() {
  var data = _taggedTemplateLiteral([""]);

  _templateObject2_c739d010af6311ebbe560fe9c4727db1 = function _templateObject2_c739d010af6311ebbe560fe9c4727db1() {
    return data;
  };
...
function _templateObject_c739d010af6311ebbe560fe9c4727db1() {
  var data = _taggedTemplateLiteral(['\n      <label id="listLabel" for="button"> ', ' </label>\n      <simple-emoji-picker\n        id="button"\n        id="button"\n        ?allow-null="', '"\n        aria-labeledby="listlabel"\n        controls="', '"\n        ?disabled="', '"\n        .emoji-types="', '"\n        @keydown="', '"\n        label=""\n        @mouseover="', '"\n        tabindex="0"\n        title-as-html\n        ?toggled="', '"\n        @value-changed="', '"\n      >\n      </simple-emoji-picker>\n      ', "\n    "]);

  _templateObject_c739d010af6311ebbe560fe9c4727db1 = function _templateObject_c739d010af6311ebbe560fe9c4727db1() {
    return data;
  };
...
var RichTextEditorEmojiPicker = /*#__PURE__*/function (_RichTextEditorPicker) {
  ...
  _createClass(RichTextEditorEmojiPicker, [{
    ...
    value: function render() {
      return (0, _litElement.html)(_templateObject_c739d010af6311ebbe560fe9c4727db1(), this.labelTemplate, this.allowNull, _get(_getPrototypeOf(RichTextEditorEmojiPicker.prototype), "controls", this), this.disabled, this.emojiTypes, this._pickerFocus, this._pickerFocus, this.toggled, this._pickerChange, _get(_getPrototypeOf(RichTextEditorEmojiPicker.prototype), "tooltipTemplate", this));
    ...
    key: "styles",
    get: function get() {
      return [].concat(_toConsumableArray(_get(_getPrototypeOf(RichTextEditorEmojiPicker), "styles", this)), [(0, _litElement.css)(_templateObject2_c739d010af6311ebbe560fe9c4727db1())]);
    }
  }, {
    key: "properties",
    get: function get() {
