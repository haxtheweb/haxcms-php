...
function _templateObject2_131366f0a0ca11eda392efd0bad1b4bf() {
  ...
  _templateObject2_131366f0a0ca11eda392efd0bad1b4bf = function _templateObject2_131366f0a0ca11eda392efd0bad1b4bf() {
    return data;
  };
  return data;
}
...
function _templateObject_131366f0a0ca11eda392efd0bad1b4bf() {
  var data = _taggedTemplateLiteral(['\n      <simple-icon-picker\n        id="button"\n        ?allow-null="', '"\n        class="rtebutton ', "-label ", '"\n        .controls="', '"\n        ?disabled="', '"\n        .icons="', '"\n        .excludes="', '"\n        .includeSets="', '"\n        .excludeSets="', '"\n        @keydown="', '"\n        .label="', '"\n        @mouseover="', '"\n        tabindex="0"\n        ?toggled="', '"\n        @value-changed="', '"\n      >\n      </simple-icon-picker>\n      ', "\n    "]);
  _templateObject_131366f0a0ca11eda392efd0bad1b4bf = function _templateObject_131366f0a0ca11eda392efd0bad1b4bf() {
    return data;
  };
  return data;
}
...
function (_RichTextEditorPicker) {
  ...
  _createClass(RichTextEditorIconPicker, [{
    ...
    key: "styles",
    get: function get() {
      return [].concat(_toConsumableArray(_get(_getPrototypeOf(RichTextEditorIconPicker), "styles", this)), [(0, _litElement.css)(_templateObject2_131366f0a0ca11eda392efd0bad1b4bf())]);
    }
  }, {
    key: "properties",
    get: function get() {
