...
function _templateObject2_b3d880903dc711eda79ddd1a980dc0e1() {
  ...
  _templateObject2_b3d880903dc711eda79ddd1a980dc0e1 = function _templateObject2_b3d880903dc711eda79ddd1a980dc0e1() {
    return data;
  };
...
function _templateObject_b3d880903dc711eda79ddd1a980dc0e1() {
  var data = _taggedTemplateLiteral(['\n      <simple-icon-picker\n        id="button"\n        ?allow-null="', '"\n        class="rtebutton ', "-label ", '"\n        .controls="', '"\n        ?disabled="', '"\n        .icons="', '"\n        .excludes="', '"\n        .includeSets="', '"\n        .excludeSets="', '"\n        @keydown="', '"\n        .label="', '"\n        @mouseover="', '"\n        tabindex="0"\n        ?toggled="', '"\n        @value-changed="', '"\n      >\n      </simple-icon-picker>\n      ', "\n    "]);

  _templateObject_b3d880903dc711eda79ddd1a980dc0e1 = function _templateObject_b3d880903dc711eda79ddd1a980dc0e1() {
    return data;
  };
...
var RichTextEditorIconPicker = /*#__PURE__*/function (_RichTextEditorPicker) {
  ...
  _createClass(RichTextEditorIconPicker, [{
    ...
    key: "styles",
    get: function get() {
      return [].concat(_toConsumableArray(_get(_getPrototypeOf(RichTextEditorIconPicker), "styles", this)), [(0, _litElement.css)(_templateObject2_b3d880903dc711eda79ddd1a980dc0e1())]);
    }
  }, {
    key: "properties",
    get: function get() {
