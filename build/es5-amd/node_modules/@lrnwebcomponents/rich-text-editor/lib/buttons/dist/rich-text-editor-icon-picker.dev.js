...
function _templateObject2_d1a2ba2056fd11ec8e273d168e82a23d() {
  ...
  _templateObject2_d1a2ba2056fd11ec8e273d168e82a23d = function _templateObject2_d1a2ba2056fd11ec8e273d168e82a23d() {
    return data;
  };
...
function _templateObject_d1a2ba2056fd11ec8e273d168e82a23d() {
  var data = _taggedTemplateLiteral(['\n      <simple-icon-picker\n        id="button"\n        ?allow-null="', '"\n        class="rtebutton ', "-label ", '"\n        .controls="', '"\n        ?disabled="', '"\n        .icons="', '"\n        .excludes="', '"\n        .includeSets="', '"\n        .excludeSets="', '"\n        @keydown="', '"\n        .label="', '"\n        @mouseover="', '"\n        tabindex="0"\n        ?toggled="', '"\n        @value-changed="', '"\n      >\n      </simple-icon-picker>\n      ', "\n    "]);

  _templateObject_d1a2ba2056fd11ec8e273d168e82a23d = function _templateObject_d1a2ba2056fd11ec8e273d168e82a23d() {
    return data;
  };
...
var RichTextEditorIconPicker = /*#__PURE__*/function (_RichTextEditorPicker) {
  ...
  _createClass(RichTextEditorIconPicker, [{
    ...
    key: "styles",
    get: function get() {
      return [].concat(_toConsumableArray(_get(_getPrototypeOf(RichTextEditorIconPicker), "styles", this)), [(0, _litElement.css)(_templateObject2_d1a2ba2056fd11ec8e273d168e82a23d())]);
    }
  }, {
    key: "properties",
    get: function get() {
