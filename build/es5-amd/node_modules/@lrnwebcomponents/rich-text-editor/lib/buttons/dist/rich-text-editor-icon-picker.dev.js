...
function _templateObject2_e4cdb670403311edb9fff3e6b08a0a9a() {
  ...
  _templateObject2_e4cdb670403311edb9fff3e6b08a0a9a = function _templateObject2_e4cdb670403311edb9fff3e6b08a0a9a() {
    return data;
  };
...
function _templateObject_e4cdb670403311edb9fff3e6b08a0a9a() {
  var data = _taggedTemplateLiteral(['\n      <simple-icon-picker\n        id="button"\n        ?allow-null="', '"\n        class="rtebutton ', "-label ", '"\n        .controls="', '"\n        ?disabled="', '"\n        .icons="', '"\n        .excludes="', '"\n        .includeSets="', '"\n        .excludeSets="', '"\n        @keydown="', '"\n        .label="', '"\n        @mouseover="', '"\n        tabindex="0"\n        ?toggled="', '"\n        @value-changed="', '"\n      >\n      </simple-icon-picker>\n      ', "\n    "]);

  _templateObject_e4cdb670403311edb9fff3e6b08a0a9a = function _templateObject_e4cdb670403311edb9fff3e6b08a0a9a() {
    return data;
  };
...
var RichTextEditorIconPicker = /*#__PURE__*/function (_RichTextEditorPicker) {
  ...
  _createClass(RichTextEditorIconPicker, [{
    ...
    key: "styles",
    get: function get() {
      return [].concat(_toConsumableArray(_get(_getPrototypeOf(RichTextEditorIconPicker), "styles", this)), [(0, _litElement.css)(_templateObject2_e4cdb670403311edb9fff3e6b08a0a9a())]);
    }
  }, {
    key: "properties",
    get: function get() {
