...
function _templateObject2_b04b92e0509711edb124eb517be36dbf() {
  ...
  _templateObject2_b04b92e0509711edb124eb517be36dbf = function _templateObject2_b04b92e0509711edb124eb517be36dbf() {
    return data;
  };
...
function _templateObject_b04b92e0509711edb124eb517be36dbf() {
  var data = _taggedTemplateLiteral(['\n      <simple-icon-picker\n        id="button"\n        ?allow-null="', '"\n        class="rtebutton ', "-label ", '"\n        .controls="', '"\n        ?disabled="', '"\n        .icons="', '"\n        .excludes="', '"\n        .includeSets="', '"\n        .excludeSets="', '"\n        @keydown="', '"\n        .label="', '"\n        @mouseover="', '"\n        tabindex="0"\n        ?toggled="', '"\n        @value-changed="', '"\n      >\n      </simple-icon-picker>\n      ', "\n    "]);

  _templateObject_b04b92e0509711edb124eb517be36dbf = function _templateObject_b04b92e0509711edb124eb517be36dbf() {
    return data;
  };
...
var RichTextEditorIconPicker = /*#__PURE__*/function (_RichTextEditorPicker) {
  ...
  _createClass(RichTextEditorIconPicker, [{
    ...
    key: "styles",
    get: function get() {
      return [].concat(_toConsumableArray(_get(_getPrototypeOf(RichTextEditorIconPicker), "styles", this)), [(0, _litElement.css)(_templateObject2_b04b92e0509711edb124eb517be36dbf())]);
    }
  }, {
    key: "properties",
    get: function get() {
