...
function _templateObject_86beb5f0ad0111ebbad2ada2ff265204() {
  var data = _taggedTemplateLiteral(['\n      <label id="listLabel" for="button"> ', ' </label>\n      <simple-symbol-picker\n        id="button"\n        ?allow-null="', '"\n        aria-labeledby="listlabel"\n        controls="', '"\n        ?disabled="', '"\n        @keydown="', '"\n        label=""\n        @mouseover="', '"\n        .symbol-types="', '"\n        tabindex="0"\n        title-as-html\n        ?toggled="', '"\n        @value-changed="', '"\n      >\n      </simple-symbol-picker>\n      ', "\n    "]);

  _templateObject_86beb5f0ad0111ebbad2ada2ff265204 = function _templateObject_86beb5f0ad0111ebbad2ada2ff265204() {
    return data;
  };
