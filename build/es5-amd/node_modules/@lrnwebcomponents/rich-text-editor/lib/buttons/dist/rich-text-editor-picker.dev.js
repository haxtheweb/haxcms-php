...
function _templateObject2_df5817108b3211ebb67059cf696085af() {
  ...
  _templateObject2_df5817108b3211ebb67059cf696085af = function _templateObject2_df5817108b3211ebb67059cf696085af() {
    return data;
  };
...
function _templateObject_df5817108b3211ebb67059cf696085af() {
  var data = _taggedTemplateLiteral(['\n        <simple-picker\n          id="button"\n          ?allow-null="', '"\n          class="rtebutton ', '"\n          ?disabled="', '"\n          controls="', '"\n          .options="', '"\n          @mouseover="', '"\n          @keydown="', '"\n          @value-changed="', '"\n          tabindex="0"\n          ?title-as-html="', '"\n        >\n          ', "\n        </simple-picker>\n        ", "\n      "]);

  _templateObject_df5817108b3211ebb67059cf696085af = function _templateObject_df5817108b3211ebb67059cf696085af() {
    return data;
  };
  ...
  return /*#__PURE__*/function (_RichTextEditorButton) {
    ...
    _createClass(_class, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_df5817108b3211ebb67059cf696085af(), this.allowNull, this.toggled ? "toggled" : "", this.disabled, _get(_getPrototypeOf(_class.prototype), "controls", this), this.options, this._pickerFocus, this._pickerFocus, this._pickerChange, this.titleAsHtml, _get(_getPrototypeOf(_class.prototype), "labelTemplate", this), _get(_getPrototypeOf(_class.prototype), "tooltopTemplate", this));
      }
    }], [{
      key: "tag",
      ...
      key: "styles",
      get: function get() {
        return [].concat(_toConsumableArray(_get(_getPrototypeOf(_class), "styles", this)), [(0, _litElement.css)(_templateObject2_df5817108b3211ebb67059cf696085af())]);
      }
    }, {
      key: "properties",
      get: function get() {
