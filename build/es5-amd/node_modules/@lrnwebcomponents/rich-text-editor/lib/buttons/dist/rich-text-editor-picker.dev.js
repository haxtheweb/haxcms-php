...
function _templateObject2_0d2176d039ee11ed89d1c353cb18487d() {
  ...
  _templateObject2_0d2176d039ee11ed89d1c353cb18487d = function _templateObject2_0d2176d039ee11ed89d1c353cb18487d() {
    return data;
  };
...
function _templateObject_0d2176d039ee11ed89d1c353cb18487d() {
  var data = _taggedTemplateLiteral(['\n        <simple-picker\n          id="button"\n          ?allow-null="', '"\n          class="rtebutton ', "-label ", '"\n          ?disabled="', '"\n          ?hide-null-option="', '"\n          .controls="', '"\n          .options="', '"\n          @mouseover="', '"\n          @keydown="', '"\n          .label="', '"\n          @value-changed="', '"\n          tabindex="0"\n          ?title-as-html="', '"\n          .value="', '"\n        >\n        </simple-picker>\n        ', "\n      "]);

  _templateObject_0d2176d039ee11ed89d1c353cb18487d = function _templateObject_0d2176d039ee11ed89d1c353cb18487d() {
    return data;
  };
...
var RichTextEditorPickerBehaviors = function RichTextEditorPickerBehaviors(SuperClass) {
  return /*#__PURE__*/function (_RichTextEditorButton) {
    ...
    _createClass(_class, [{
      ...
      key: "styles",
      get: function get() {
        return [].concat(_toConsumableArray(_get(_getPrototypeOf(_class), "styles", this)), [(0, _litElement.css)(_templateObject2_0d2176d039ee11ed89d1c353cb18487d())]);
      }
    }, {
      key: "properties",
      get: function get() {
