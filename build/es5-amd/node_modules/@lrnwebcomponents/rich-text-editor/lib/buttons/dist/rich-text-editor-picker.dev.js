...
function _templateObject2_b3e2b9c03dc711eda79ddd1a980dc0e1() {
  ...
  _templateObject2_b3e2b9c03dc711eda79ddd1a980dc0e1 = function _templateObject2_b3e2b9c03dc711eda79ddd1a980dc0e1() {
    return data;
  };
...
function _templateObject_b3e2b9c03dc711eda79ddd1a980dc0e1() {
  var data = _taggedTemplateLiteral(['\n        <simple-picker\n          id="button"\n          ?allow-null="', '"\n          class="rtebutton ', "-label ", '"\n          ?disabled="', '"\n          ?hide-null-option="', '"\n          .controls="', '"\n          .options="', '"\n          @mouseover="', '"\n          @keydown="', '"\n          .label="', '"\n          @value-changed="', '"\n          tabindex="0"\n          ?title-as-html="', '"\n          .value="', '"\n        >\n        </simple-picker>\n        ', "\n      "]);

  _templateObject_b3e2b9c03dc711eda79ddd1a980dc0e1 = function _templateObject_b3e2b9c03dc711eda79ddd1a980dc0e1() {
    return data;
  };
...
var RichTextEditorPickerBehaviors = function RichTextEditorPickerBehaviors(SuperClass) {
  return /*#__PURE__*/function (_RichTextEditorButton) {
    ...
    _createClass(_class, [{
      ...
      key: "styles",
      get: function get() {
        return [].concat(_toConsumableArray(_get(_getPrototypeOf(_class), "styles", this)), [(0, _litElement.css)(_templateObject2_b3e2b9c03dc711eda79ddd1a980dc0e1())]);
      }
    }, {
      key: "properties",
      get: function get() {
