...
function _templateObject2_226587e0ce4411eca4dffb3bcb5f42ec() {
  ...
  _templateObject2_226587e0ce4411eca4dffb3bcb5f42ec = function _templateObject2_226587e0ce4411eca4dffb3bcb5f42ec() {
    return data;
  };
...
function _templateObject_226587e0ce4411eca4dffb3bcb5f42ec() {
  var data = _taggedTemplateLiteral(['\n        <simple-picker\n          id="button"\n          ?allow-null="', '"\n          class="rtebutton ', "-label ", '"\n          ?disabled="', '"\n          ?hide-null-option="', '"\n          .controls="', '"\n          .options="', '"\n          @mouseover="', '"\n          @keydown="', '"\n          .label="', '"\n          @value-changed="', '"\n          tabindex="0"\n          ?title-as-html="', '"\n          .value="', '"\n        >\n        </simple-picker>\n        ', "\n      "]);

  _templateObject_226587e0ce4411eca4dffb3bcb5f42ec = function _templateObject_226587e0ce4411eca4dffb3bcb5f42ec() {
    return data;
  };
...
var RichTextEditorPickerBehaviors = function RichTextEditorPickerBehaviors(SuperClass) {
  return /*#__PURE__*/function (_RichTextEditorButton) {
    ...
    _createClass(_class, [{
      ...
      key: "styles",
      get: function get() {
        return [].concat(_toConsumableArray(_get(_getPrototypeOf(_class), "styles", this)), [(0, _litElement.css)(_templateObject2_226587e0ce4411eca4dffb3bcb5f42ec())]);
      }
    }, {
      key: "properties",
      get: function get() {
