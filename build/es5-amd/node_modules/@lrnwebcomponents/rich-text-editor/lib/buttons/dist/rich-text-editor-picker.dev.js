...
function _templateObject2_223cd510994411ebb1a5332c5e6bdde2() {
  ...
  _templateObject2_223cd510994411ebb1a5332c5e6bdde2 = function _templateObject2_223cd510994411ebb1a5332c5e6bdde2() {
    return data;
  };
...
function _templateObject_223cd510994411ebb1a5332c5e6bdde2() {
  var data = _taggedTemplateLiteral(['\n        <simple-picker\n          id="button"\n          ?allow-null="', '"\n          class="rtebutton ', '"\n          ?disabled="', '"\n          controls="', '"\n          .options="', '"\n          @mouseover="', '"\n          @keydown="', '"\n          @value-changed="', '"\n          tabindex="0"\n          ?title-as-html="', '"\n        >\n          ', "\n        </simple-picker>\n        ", "\n      "]);

  _templateObject_223cd510994411ebb1a5332c5e6bdde2 = function _templateObject_223cd510994411ebb1a5332c5e6bdde2() {
    return data;
  };
...
var RichTextEditorPickerBehaviors = function RichTextEditorPickerBehaviors(SuperClass) {
  return /*#__PURE__*/function (_RichTextEditorButton) {
    ...
    _createClass(_class, [{
      ...
      key: "styles",
      get: function get() {
        return [].concat(_toConsumableArray(_get(_getPrototypeOf(_class), "styles", this)), [(0, _litElement.css)(_templateObject2_223cd510994411ebb1a5332c5e6bdde2())]);
      }
    }, {
      key: "properties",
      get: function get() {
