...
function _templateObject2_b054baa0509711edb124eb517be36dbf() {
  ...
  _templateObject2_b054baa0509711edb124eb517be36dbf = function _templateObject2_b054baa0509711edb124eb517be36dbf() {
    return data;
  };
...
function _templateObject_b054baa0509711edb124eb517be36dbf() {
  var data = _taggedTemplateLiteral(['\n        <simple-picker\n          id="button"\n          ?allow-null="', '"\n          class="rtebutton ', "-label ", '"\n          ?disabled="', '"\n          ?hide-null-option="', '"\n          .controls="', '"\n          .options="', '"\n          @mouseover="', '"\n          @keydown="', '"\n          .label="', '"\n          @value-changed="', '"\n          tabindex="0"\n          ?title-as-html="', '"\n          .value="', '"\n        >\n        </simple-picker>\n        ', "\n      "]);

  _templateObject_b054baa0509711edb124eb517be36dbf = function _templateObject_b054baa0509711edb124eb517be36dbf() {
    return data;
  };
...
var RichTextEditorPickerBehaviors = function RichTextEditorPickerBehaviors(SuperClass) {
  return /*#__PURE__*/function (_RichTextEditorButton) {
    ...
    _createClass(_class, [{
      ...
      key: "styles",
      get: function get() {
        return [].concat(_toConsumableArray(_get(_getPrototypeOf(_class), "styles", this)), [(0, _litElement.css)(_templateObject2_b054baa0509711edb124eb517be36dbf())]);
      }
    }, {
      key: "properties",
      get: function get() {
