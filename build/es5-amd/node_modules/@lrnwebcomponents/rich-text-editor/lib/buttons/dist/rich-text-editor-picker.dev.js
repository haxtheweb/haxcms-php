...
function _templateObject2_ca09a820b2b411eb9e5c9b5d1881fac2() {
  ...
  _templateObject2_ca09a820b2b411eb9e5c9b5d1881fac2 = function _templateObject2_ca09a820b2b411eb9e5c9b5d1881fac2() {
    return data;
  };
...
function _templateObject_ca09a820b2b411eb9e5c9b5d1881fac2() {
  var data = _taggedTemplateLiteral(['\n        <simple-picker\n          id="button"\n          ?allow-null="', '"\n          class="rtebutton ', '"\n          ?disabled="', '"\n          controls="', '"\n          .options="', '"\n          @mouseover="', '"\n          @keydown="', '"\n          @value-changed="', '"\n          tabindex="0"\n          ?title-as-html="', '"\n        >\n          ', "\n        </simple-picker>\n        ", "\n      "]);

  _templateObject_ca09a820b2b411eb9e5c9b5d1881fac2 = function _templateObject_ca09a820b2b411eb9e5c9b5d1881fac2() {
    return data;
  };
...
var RichTextEditorPickerBehaviors = function RichTextEditorPickerBehaviors(SuperClass) {
  return /*#__PURE__*/function (_RichTextEditorButton) {
    ...
    _createClass(_class, [{
      ...
      key: "styles",
      get: function get() {
        return [].concat(_toConsumableArray(_get(_getPrototypeOf(_class), "styles", this)), [(0, _litElement.css)(_templateObject2_ca09a820b2b411eb9e5c9b5d1881fac2())]);
      }
    }, {
      key: "properties",
      get: function get() {
