define(["exports", "../../../../lit/index.js", "./rich-text-editor-picker.js", "../../../simple-icon-picker/simple-icon-picker.js"], function (_exports, _index, _richTextEditorPicker, _simpleIconPicker) {
  ...
  var _templateObject_0936bfd0e46b11edbf2e2349c355f24c, _templateObject2_0936bfd0e46b11edbf2e2349c355f24c;
  ...
  var RichTextEditorIconPicker = /*#__PURE__*/function (_RichTextEditorPicker) {
    ...
    babelHelpers.createClass(RichTextEditorIconPicker, [{
      ...
      key: "styles",
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(RichTextEditorIconPicker), "styles", this)), [(0, _index.css)(_templateObject2_0936bfd0e46b11edbf2e2349c355f24c || (_templateObject2_0936bfd0e46b11edbf2e2349c355f24c = babelHelpers.taggedTemplateLiteral(["\n        #button.show-label::part(label) {\n          padding: 0;\n          margin-right: 0;\n          margin-left: 4px;\n        }\n        #button.show-label::part(sample) {\n          min-height: var(--simple-picker-option-size, 24px);\n          margin-left: calc(-0.125 * var(--simple-picker-icon-size, 16px));\n        }\n        #button.show-label::part(sample-option) {\n          display: none;\n        }\n      "])))]);
      }
    }, {
      key: "properties",
      get: function get() {
