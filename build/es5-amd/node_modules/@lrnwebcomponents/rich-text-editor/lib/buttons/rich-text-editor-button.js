define(["exports", "require", "../../../../lit-element/lit-element.js", "./rich-text-editor-button-styles.js", "../singletons/rich-text-editor-selection.js", "../../../simple-icon/lib/simple-icon-lite.js", "../../../simple-icon/lib/simple-icons.js", "../../../simple-icon/lib/simple-icon-button-lite.js", "../../../hax-iconset/lib/simple-hax-iconset.js"], function (_exports, _require, _litElement, _richTextEditorButtonStyles, _richTextEditorSelection, _simpleIconLite, _simpleIcons, _simpleIconButtonLite, _simpleHaxIconset) {
  ...
  function _templateObject2_38aa26403ee511ebb7f7a1171f0cd59d() {
    ...
    _templateObject2_38aa26403ee511ebb7f7a1171f0cd59d = function _templateObject2_38aa26403ee511ebb7f7a1171f0cd59d() {
      return data;
    };
  ...
  function _templateObject_38aa26403ee511ebb7f7a1171f0cd59d() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        <button\n          id=\"button\"\n          class=\"rtebutton\"\n          ?disabled=\"", "\"\n          ?controls=\"", "\"\n          @click=\"", "\"\n          tabindex=\"0\"\n          ?toggled=\"", "\"\n        >\n          <simple-icon-lite\n            id=\"icon\"\n            aria-hidden=\"true\"\n            icon=\"", "\"\n          >\n          </simple-icon-lite>\n          <span id=\"label\" class=\"", "\"\n            >", "</span\n          >\n        </button>\n        <simple-tooltip id=\"tooltip\" for=\"button\"\n          >", "</simple-tooltip\n        >\n      "]);

    _templateObject_38aa26403ee511ebb7f7a1171f0cd59d = function _templateObject_38aa26403ee511ebb7f7a1171f0cd59d() {
      return data;
    };
    ...
    return /*#__PURE__*/function (_RichTextEditorButton) {
      ...
      babelHelpers.createClass(_class, [{
        ...
        value: function render() {
          return (0, _litElement.html)(_templateObject_38aa26403ee511ebb7f7a1171f0cd59d(), this.disabled, this.controls, this._buttonTap, this.isToggled, this.currentIcon, this.labelStyle, this.currentLabel, this.currentLabel);
        }
      }], [{
        key: "tag",
        get: function get() {
        ...
        key: "styles",
        get: function get() {
          return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(_class), "styles", this)), [(0, _litElement.css)(_templateObject2_38aa26403ee511ebb7f7a1171f0cd59d())]);
        }
      }, {
        key: "properties",
        get: function get() {
