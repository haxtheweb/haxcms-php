define(["exports", "../../../../lit-element/lit-element.js", "./rich-text-editor-button.js", "../../../simple-picker/simple-picker.js"], function (_exports, _litElement, _richTextEditorButton, _simplePicker) {
  ...
  function _templateObject2_76170ed03efe11eb800233a440abe59f() {
    ...
    _templateObject2_76170ed03efe11eb800233a440abe59f = function _templateObject2_76170ed03efe11eb800233a440abe59f() {
      return data;
    };
  ...
  function _templateObject_76170ed03efe11eb800233a440abe59f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        <simple-picker\n          id=\"button\"\n          ?allow-null=\"", "\"\n          class=\"rtebutton ", "\"\n          ?disabled=\"", "\"\n          controls=\"", "\"\n          .options=\"", "\"\n          @mouseover=\"", "\"\n          @keydown=\"", "\"\n          @value-changed=\"", "\"\n          tabindex=\"0\"\n          ?title-as-html=\"", "\"\n        >\n          <span id=\"label\" class=\"", "\"\n            >", "</span\n          >\n        </simple-picker>\n        <simple-tooltip id=\"tooltip\" for=\"button\"\n          >", "</simple-tooltip\n        >\n      "]);

    _templateObject_76170ed03efe11eb800233a440abe59f = function _templateObject_76170ed03efe11eb800233a440abe59f() {
      return data;
    };
    ...
    return /*#__PURE__*/function (_RichTextEditorButton) {
      ...
      babelHelpers.createClass(_class, [{
        ...
        value: function render() {
          return (0, _litElement.html)(_templateObject_76170ed03efe11eb800233a440abe59f(), this.allowNull, this.toggled ? "toggled" : "", this.disabled, babelHelpers.get(babelHelpers.getPrototypeOf(_class.prototype), "controls", this), this.options, this._pickerFocus, this._pickerFocus, this._pickerChange, this.titleAsHtml, babelHelpers.get(babelHelpers.getPrototypeOf(_class.prototype), "labelStyle", this), this.currentLabel, this.currentLabel);
        }
      }], [{
        key: "tag",
        ...
        key: "styles",
        get: function get() {
          return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(_class), "styles", this)), [(0, _litElement.css)(_templateObject2_76170ed03efe11eb800233a440abe59f())]);
        }
      }, {
        key: "properties",
        get: function get() {
