...
function _templateObject2_8f99e65044e911edab4a0d426b75fd72() {
  ...
  _templateObject2_8f99e65044e911edab4a0d426b75fd72 = function _templateObject2_8f99e65044e911edab4a0d426b75fd72() {
    return data;
  };
...
function _templateObject_8f99e65044e911edab4a0d426b75fd72() {
  var data = _taggedTemplateLiteral(['\n      <simple-popover\n        id="prompt"\n        ?auto="', '"\n        for="', '"\n        ?hidden="', '"\n        position="bottom"\n        position-align="center"\n        .target="', '"\n      >\n        <form\n          id="form"\n          @blur="', '"\n          @focus="', '"\n        >\n          <simple-fields\n            id="formfields"\n            hide-line-numbers\n            .fields="', '"\n            @fields-ready="', '"\n            .value="', '"\n          ></simple-fields>\n          <div class="actions">\n            <rich-text-editor-button\n              id="cancel"\n              controls="', '"\n              label="Cancel"\n              icon="clear"\n              @click="', '"\n              tabindex="0"\n            >\n            </rich-text-editor-button>\n            <rich-text-editor-button\n              id="confirm"\n              controls="', '"\n              @click="', '"\n              icon="check"\n              label="OK"\n              tabindex="0"\n            >\n            </rich-text-editor-button>\n          </div>\n        </form>\n      </simple-popover>\n    ']);

  _templateObject_8f99e65044e911edab4a0d426b75fd72 = function _templateObject_8f99e65044e911edab4a0d426b75fd72() {
    return data;
  };
...
var RichTextEditorPrompt = /*#__PURE__*/function (_LitElement) {
  ...
  _createClass(RichTextEditorPrompt, [{
    ...
    value: function render() {
      return (0, _litElement.html)(_templateObject_8f99e65044e911edab4a0d426b75fd72(), !this.hidden, this.selection ? this.selection.id : "", this.hidden, this.selection, this._handleBlur, this._handleFocus, this.fields, this._handleReady, this.value, this.selection ? this.selection.id : "", this._cancel, this.selection ? this.selection.id : "", this._confirm);
    }
    /**
    ...
    key: "styles",
    get: function get() {
      return [].concat(_toConsumableArray(_richTextEditorButton.RichTextToolbarStyles), [(0, _litElement.css)(_templateObject2_8f99e65044e911edab4a0d426b75fd72())]);
    }
  }, {
    key: "tag",
    get: function get() {
