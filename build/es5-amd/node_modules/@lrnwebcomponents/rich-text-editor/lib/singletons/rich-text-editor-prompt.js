define(["exports", "../../../../lit/index.js", "../buttons/rich-text-editor-button.js", "../../../simple-popover/simple-popover.js", "../../../simple-fields/simple-fields.js", "./rich-text-editor-highlight.js", "./rich-text-editor-range-behaviors.js"], function (_exports, _index, _richTextEditorButton, _simplePopover, _simpleFields, _richTextEditorHighlight, _richTextEditorRangeBehaviors) {
  ...
  var _templateObject_5e8733c0ce0511ec9811713d37552719, _templateObject2_5e8733c0ce0511ec9811713d37552719;
  ...
  var RichTextEditorPrompt = /*#__PURE__*/function (_RichTextEditorRangeB) {
    ...
    babelHelpers.createClass(RichTextEditorPrompt, [{
      ...
      key: "styles",
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(_richTextEditorButton.RichTextToolbarStyles), [(0, _index.css)(_templateObject2_5e8733c0ce0511ec9811713d37552719 || (_templateObject2_5e8733c0ce0511ec9811713d37552719 = babelHelpers.taggedTemplateLiteral(["\n        #prompt {\n          display: block;\n          width: 300px;\n          max-width: 300px;\n          --simple-popover-padding: 0px;\n          z-index: 2;\n        }\n        #prompt[hidden] {\n          display: none;\n        }\n        #prompt #form {\n          display: flex;\n          flex-direction: column;\n          align-items: center;\n          justify-content: space-between;\n          z-index: 2;\n        }\n        #formfields {\n          width: calc(100% - 20px);\n          padding: 10px 10px 0;\n          overflow: visible;\n        }\n        #prompt simple-fields-field {\n          padding: 0;\n        }\n        #confirm,\n        #cancel {\n          min-width: unset;\n        }\n        #cancel {\n          color: var(--rich-text-editor-button-color);\n          background-color: var(--rich-text-editor-button-bg);\n        }\n        #cancel:focus,\n        #cancel:hover {\n          color: var(--rich-text-editor-button-hover-color);\n          background-color: var(--rich-text-editor-button-hover-bg);\n        }\n        #confirm {\n          color: var(--rich-text-editor-button-color);\n          background-color: var(--rich-text-editor-button-bg);\n        }\n        #confirm:focus,\n        #confirm:hover {\n          color: var(--rich-text-editor-button-hover-color);\n          background-color: var(--rich-text-editor-button-hover-bg);\n        }\n        .actions {\n          width: calc(100% - 20px);\n          padding: 0 10px 3px;\n          display: flex;\n          align-items: center;\n          justify-content: flex-end;\n        }\n        .confirm-or-cancel {\n          min-width: 40px;\n        }\n      "])))]);
      }
    }, {
      key: "tag",
      get: function get() {
