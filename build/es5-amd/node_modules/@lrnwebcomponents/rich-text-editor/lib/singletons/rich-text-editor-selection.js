define(["exports", "../../../../lit-element/lit-element.js", "../rich-text-editor-styles.js", "../../../utils/utils.js"], function (_exports, _litElement, _richTextEditorStyles, _utils) {
  ...
  function _templateObject2_38f49cc03ee511ebb7f7a1171f0cd59d() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          background-color: var(--rich-text-editor-selection-bg);\n          margin: 0;\n          padding: 0;\n          display: inline;\n        }\n        :host([hidden]) {\n          display: none;\n        }\n        :host([collapsed]):after {\n          content: '|';\n          color: var(--rich-text-editor-selection-bg);\n          background-color: transparent;\n        }\n\xA0\xA0\xA0\xA0\xA0\xA0"]);

    _templateObject2_38f49cc03ee511ebb7f7a1171f0cd59d = function _templateObject2_38f49cc03ee511ebb7f7a1171f0cd59d() {
      return data;
    };
  ...
  function _templateObject_38f49cc03ee511ebb7f7a1171f0cd59d() {
    var data = babelHelpers.taggedTemplateLiteral([" <slot></slot> "]);

    _templateObject_38f49cc03ee511ebb7f7a1171f0cd59d = function _templateObject_38f49cc03ee511ebb7f7a1171f0cd59d() {
      return data;
    };
  ...
  var RichTextEditorSelection = /*#__PURE__*/function (_RichTextEditorStyles) {
    ...
    babelHelpers.createClass(RichTextEditorSelection, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_38f49cc03ee511ebb7f7a1171f0cd59d());
      }
    }], [{
      key: "tag",
      ...
      key: "styles",
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(RichTextEditorSelection), "styles", this)), [(0, _litElement.css)(_templateObject2_38f49cc03ee511ebb7f7a1171f0cd59d())]);
      }
    }, {
      key: "properties",
      get: function get() {
