define(["exports", "../../../../lit-element/lit-element.js", "../rich-text-editor-styles.js"], function (_exports, _litElement, _richTextEditorStyles) {
  ...
  function _templateObject2_d213d7f02dd211eba8a9dbdc0fc9b6e0() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          background-color: var(--rich-text-editor-selection-bg);\n          margin: 0;\n          padding: 0;\n          display: inline;\n        }\n        :host([hidden]) {\n          display: none;\n        }\n        :host([collapsed]):after {\n          content: '|';\n          color: var(--rich-text-editor-selection-bg);\n          background-color: transparent;\n        }\n\xA0\xA0\xA0\xA0\xA0\xA0"]);

    _templateObject2_d213d7f02dd211eba8a9dbdc0fc9b6e0 = function _templateObject2_d213d7f02dd211eba8a9dbdc0fc9b6e0() {
      return data;
    };
  ...
  function _templateObject_d213d7f02dd211eba8a9dbdc0fc9b6e0() {
    var data = babelHelpers.taggedTemplateLiteral([" <slot></slot> "]);

    _templateObject_d213d7f02dd211eba8a9dbdc0fc9b6e0 = function _templateObject_d213d7f02dd211eba8a9dbdc0fc9b6e0() {
      return data;
    };
  ...
  var RichTextEditorSelection = /*#__PURE__*/function (_RichTextEditorStyles) {
    ...
    babelHelpers.createClass(RichTextEditorSelection, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_d213d7f02dd211eba8a9dbdc0fc9b6e0());
      }
    }], [{
      key: "tag",
      ...
      key: "styles",
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(RichTextEditorSelection), "styles", this)), [(0, _litElement.css)(_templateObject2_d213d7f02dd211eba8a9dbdc0fc9b6e0())]);
      }
    }, {
      key: "properties",
      get: function get() {
