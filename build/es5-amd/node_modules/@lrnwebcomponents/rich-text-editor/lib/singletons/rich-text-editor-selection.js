define(["exports", "../../../../lit-element/lit-element.js", "../../../utils/utils.js"], function (_exports, _litElement, _utils) {
  ...
  function _templateObject2_9b4cae3090bb11eb9010f5aa583cef45() {
    ...
    _templateObject2_9b4cae3090bb11eb9010f5aa583cef45 = function _templateObject2_9b4cae3090bb11eb9010f5aa583cef45() {
      return data;
    };
  ...
  function _templateObject_9b4cae3090bb11eb9010f5aa583cef45() {
    var data = babelHelpers.taggedTemplateLiteral(["<slot></slot>"]);

    _templateObject_9b4cae3090bb11eb9010f5aa583cef45 = function _templateObject_9b4cae3090bb11eb9010f5aa583cef45() {
      return data;
    };
  ...
  var RichTextEditorSelection = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(RichTextEditorSelection, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_9b4cae3090bb11eb9010f5aa583cef45());
      }
    }, {
      key: "updated",
      ...
      value: function edit(editor) {
        ...
        if (!!editor) {
          var _toolbar = !editor ? undefined : this.getConnectedToolbar(editor),
              oldEditor = editable ? _toolbar.editor : undefined;

          this.highlight(_toolbar, false);

          if (_toolbar && oldEditor !== editor) {
            if (!!oldEditor) this.disableEditing(oldEditor);
            _toolbar.editor = editor;
            this.enableEditing(editor, _toolbar);
          }
        }
      }
      /**
      ...
      value: function getConnectedToolbar(editor) {
        ...
        if (!editor.__connectedToolbar) {
          ...
          if (filter[0]) {
            ...
            //make toolbar
            _toolbar2 = document.createElement(editor.type || "rich-text-editor-toolbar");
            editor.parentNode.insertBefore(_toolbar2, editor);
          }

          _toolbar2.id = _toolbar2.id || editor.toolbar || this._generateUUID();
          editor.__connectedToolbar = _toolbar2;
        }
      ...
      value: function updateRange(editor, range) {
        if (editor) {
          var _toolbar3 = this.getConnectedToolbar(editor);
          ...
          if (_toolbar3) {
            _toolbar3.selectedNode = editor.selectedNode;
            _toolbar3.selectionAncestors = editor.selectionAncestors;
            _toolbar3.range = range;
          }
        }
      }
      /**
      ...
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_9b4cae3090bb11eb9010f5aa583cef45())];
      }
    }]);
