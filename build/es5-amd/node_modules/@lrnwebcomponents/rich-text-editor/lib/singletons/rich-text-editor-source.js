define(["exports", "require", "../../../../lit/index.js"], function (_exports, _require, _index) {
  ...
  var _templateObject_78ab4ea02ee311eda9c37b2c2696a94a, _templateObject2_78ab4ea02ee311eda9c37b2c2696a94a;
  ...
  var RichTextEditorSource = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(RichTextEditorSource, [{
      ...
      function render() {
        return (0, _index.html)(_templateObject_78ab4ea02ee311eda9c37b2c2696a94a || (_templateObject_78ab4ea02ee311eda9c37b2c2696a94a = babelHelpers.taggedTemplateLiteral([" <div id=\"container\">\n      <div id=\"wysiwyg\" part=\"wysiwyg\">\n        <slot></slot>\n      </div>\n      <code-editor\n        id=\"source\"\n        font-size=\"13\"\n        language=\"html\"\n        @value-changed=\"", "\"\n        word-wrap\n        part=\"source\"\n      >\n      </code-editor>\n    </div>"])), this._handleSourceChange);
      }
    }, {
      key: "firstUpdated",
