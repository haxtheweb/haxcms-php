 ...
 */var RichTextEditorToolbar=/*#__PURE__*/function(_PolymerElement){babelHelpers.inherits(RichTextEditorToolbar,_PolymerElement);function RichTextEditorToolbar(){babelHelpers.classCallCheck(this,RichTextEditorToolbar);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(RichTextEditorToolbar).apply(this,arguments))}babelHelpers.createClass(RichTextEditorToolbar,[{key:"connectedCallback",/**
   ...
   */value:function connectedCallback(){babelHelpers.get(babelHelpers.getPrototypeOf(RichTextEditorToolbar.prototype),"connectedCallback",this).call(this);var root=this;window.ResponsiveUtility.requestAvailability();window.dispatchEvent(new CustomEvent("responsive-element",{detail:{element:root,attribute:"responsive-size",relativeToParent:!0}}));document.designMode="on";document.addEventListener("selectionchange",function(e){root.getUpdatedSelection()})}/**
...
editableElement.parentNode.insertBefore(root,editableElement);root.editableElement=editableElement;root.canceled=editableElement.innerHTML;root.editableElement.contentEditable=!0;root.controls=editableElement.getAttribute("id")}}/**
   ...
   */},{key:"getUpdatedSelection",value:function getUpdatedSelection(){var root=this;//console.log(root.editableElement);
/*if(root.editableElement && root.editableElement.children.length < 2 && root.editableElement.children[0].childNodes.length < 2) {
    ...
    }*/root.selection=root.editableElement===void 0||null===root.editableElement?null:root.editableElement.getSelection?root.editableElement.getSelection():root._getRange();this.buttons.forEach(function(button){button.selection=null;button.selection=root.selection})}/**
...
get:function get(){return(0,_polymerElement.html)(_templateObject_ece35f2075c211e99fd5555145028221())}// haxProperty definition
