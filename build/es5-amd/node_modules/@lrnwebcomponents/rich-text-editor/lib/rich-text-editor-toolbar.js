 ...
 */var RichTextEditorToolbar=/*#__PURE__*/function(_PolymerElement){babelHelpers.inherits(RichTextEditorToolbar,_PolymerElement);function RichTextEditorToolbar(){babelHelpers.classCallCheck(this,RichTextEditorToolbar);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(RichTextEditorToolbar).apply(this,arguments))}babelHelpers.createClass(RichTextEditorToolbar,[{key:"connectedCallback",/**
   ...
   */value:function connectedCallback(){babelHelpers.get(babelHelpers.getPrototypeOf(RichTextEditorToolbar.prototype),"connectedCallback",this).call(this);var root=this;window.ResponsiveUtility.requestAvailability();window.dispatchEvent(new CustomEvent("responsive-element",{detail:{element:root,attribute:"responsive-size",relativeToParent:!0}}));//document.designMode = "on";
document.addEventListener("selectionchange",function(e){root.getUpdatedSelection()})}},{key:"ready",value:function ready(){babelHelpers.get(babelHelpers.getPrototypeOf(RichTextEditorToolbar.prototype),"ready",this).call(this);var root=this;root.__breadcrumbs=document.createElement("rich-text-editor-breadcrumbs");document.body.appendChild(root.__breadcrumbs);root.__breadcrumbs.addEventListener("breadcrumb-tap",root._handleBreadcrumb.bind(root))}/**
   *
   ...
   */},{key:"disconnectedCallback",value:function disconnectedCallback(){babelHelpers.get(babelHelpers.getPrototypeOf(RichTextEditorToolbar.prototype),"disconnectedCallback",this).call(this);var root=this;document.removeEventListener("selectionchange",function(e){root.getUpdatedSelection()})}/**
   ...
   */},{key:"editTarget",value:function editTarget(editableElement){var root=this,sel=window.getSelection();if(editableElement.getAttribute("id")===void 0||null===editableElement.getAttribute("id"))editableElement.setAttribute("id",root._generateUUID());if(root.editableElement!==editableElement){//save changes to previous editableElement
...
editableElement.parentNode.insertBefore(root,editableElement);editableElement.parentNode.insertBefore(root.__breadcrumbs,editableElement.nextSibling);sel.removeAllRanges();root.editableElement=editableElement;root.canceled=editableElement.innerHTML;root.editableElement.contentEditable=!0;root.controls=editableElement.getAttribute("id");root.__breadcrumbs.controls=editableElement.getAttribute("id")}}/**
   ...
   */},{key:"getUpdatedSelection",value:function getUpdatedSelection(){var root=this;root.selection=root.editableElement===void 0||null===root.editableElement?null:root.editableElement.getSelection?root.editableElement.getSelection():root._getRange();root.buttons.forEach(function(button){button.selection=null;button.selection=root.selection});root.__breadcrumbs.selection=root.selection}/**
   ...
   *
   * @param {object} an HTML object that can be edited
   */},{key:"makeEditableRegion",value:function makeEditableRegion(editableElement){var root=this,content=document.createElement("rich-text-editor");editableElement.parentNode.insertBefore(content,editableElement);content.appendChild(editableElement);root.addEditableRegion(content)}/**
   * adds an editable region to the list of editableElements
   *
   * @param {object} an HTML object that can be edited
   */},{key:"addEditableRegion",value:function addEditableRegion(editableElement){var root=this,observer=new MutationObserver(function(e){root.getUpdatedSelection()});editableElement.addEventListener("focus",function(e){root.editTarget(editableElement)});editableElement.addEventListener("mouseover",function(e){root.editTarget(editableElement)});editableElement.addEventListener("blur",function(e){root.getUpdatedSelection()});editableElement.addEventListener("mouseout",function(e){root.getUpdatedSelection()});observer.observe(editableElement,{attributes:!1,childList:!0,subtree:!0,characterData:!1});root.push("editableElements",[editableElement,observer])}/**
   ...
   */},{key:"_addButton",value:function _addButton(child,parent){var root=this,button=document.createElement(child.type);for(var key in child){button[key]=child[key]}button.setAttribute("class","button");/*button.addEventListener("mousedown", (e) => {
    ...
    });*/button.addEventListener("deselect",function(e){root._getRange().collapse(!1)});parent.appendChild(button);return button}/**
   * Generate a UUID
   */},{key:"_generateUUID",value:function _generateUUID(){return"rte-"+"ss-s-s-s-sss".replace(/s/g,this._uuidPart)}/**
   ...
   */},{key:"_preserveSelection",value:function _preserveSelection(){var sel=window.getSelection(),temp=this.selection;this.buttons.forEach(function(button){button.selection=temp});this.__breadcrumbs.selection=temp;sel.removeAllRanges();sel.addRange(temp)}/**
...
get:function get(){return(0,_polymerElement.html)(_templateObject_5fff4280773f11e996418d4f1d726d09())}// haxProperty definition
