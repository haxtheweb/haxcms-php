...
get:function get(){return(0,_polymerElement.html)(_templateObject_ec67786075c211e99fd5555145028221())}/**
...
});this.addEventListener("mouseout",function(e){//this._cancel(e);
})}/**
   * Loads element into array
   */},{key:"setTarget",value:function setTarget(el){this.clearTarget();var fields=el.fields,vals=el.value;this.set("fields",fields);this.set("value",vals);this.__el=el;this.for=el.selectedText.getAttribute("id")}/**
   * Unloads element from array
   */},{key:"clearTarget",value:function clearTarget(){if(!this.for)return;this.for=null;this.set("fields",null);this.set("value",null);this.__selection=null;this.__el=null}/**
   * Handles button tap;
   */},{key:"_cancel",value:function _cancel(e){e.preventDefault();this.__el.deselectText();this.clearTarget()}/**
   * Handles button tap;
   */},{key:"_confirm",value:function _confirm(e){e.preventDefault();this.__el.value=this.value;this.__el.updateSelection();this.clearTarget()}}]);return richTextEditorPrompt}(_polymerElement.PolymerElement);_exports.richTextEditorPrompt=richTextEditorPrompt;window.customElements.define(richTextEditorPrompt.tag,richTextEditorPrompt)});