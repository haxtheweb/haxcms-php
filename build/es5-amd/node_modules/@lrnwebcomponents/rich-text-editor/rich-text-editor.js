define(["exports","../../@polymer/polymer/polymer-element.js","../hax-body-behaviors/lib/HAXWiring.js","../../@polymer/iron-a11y-keys/iron-a11y-keys.js","./lib/rich-text-editor-styles.js","./lib/rich-text-editor-toolbar.js"],function(_exports,_polymerElement,_HAXWiring,_ironA11yKeys,_richTextEditorStyles,_richTextEditorToolbar){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.RichTextEditor=void 0;function _templateObject_ace0f54075c211e99fd5555145028221(){var data=babelHelpers.taggedTemplateLiteral(["\n      <style>\n        :host([hidden]) {\n          display: none;\n        }\n        :host {\n          display: block;\n          min-height: 20px;\n          cursor: pointer;\n          @apply --rich-text-editor-content;\n        }\n        :host([contenteditable=\"true\"]) {\n          border: var(--rich-text-editor-border);\n          border-top: none;\n          overflow: hidden;\n          @apply --rich-text-editor-content-edit;\n        }\n        :host([contenteditable=\"true\"]):empty:before {\n          content: attr(placeholder);\n          display: block;\n          @apply --rich-text-editor-content-placeholder;\n        }\n        span {\n          background-color: blue;\n        }\n        .rich-text-editor-selection {\n          background-color: var(--rich-text-editor-selection-bg);\n          @apply --rich-text-editor-content-selection;\n        }\n      </style>\n      <style include=\"rich-text-editor-styles\"></style>\n      <slot></slot>\n    "]);_templateObject_ace0f54075c211e99fd5555145028221=function _templateObject_ace0f54075c211e99fd5555145028221(){return data};return data}/**
 * `rich-text-editor`
 ...
 */var RichTextEditor=/*#__PURE__*/function(_PolymerElement){babelHelpers.inherits(RichTextEditor,_PolymerElement);function RichTextEditor(){babelHelpers.classCallCheck(this,RichTextEditor);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(RichTextEditor).apply(this,arguments))}babelHelpers.createClass(RichTextEditor,[{key:"connectedCallback",/**
   ...
   * ready
   */},{key:"ready",value:function ready(){babelHelpers.get(babelHelpers.getPrototypeOf(RichTextEditor.prototype),"ready",this).call(this);//find an editor by id
var id=document.querySelector("rich-text-editor-toolbar#"+this.editorId),editor=null!==id?id:document.querySelector("rich-text-editor-toolbar");if(null===editor){editor=document.createElement("rich-text-editor-toolbar");this.parentNode.appendChild(editor)}editor.addEditableRegion(this)}/**
   * life cycle, element is removed from the DOM
   */ //disconnectedCallback() {}
}],[{key:"template",// render function
get:function get(){return(0,_polymerElement.html)(_templateObject_ace0f54075c211e99fd5555145028221())}// haxProperty definition
