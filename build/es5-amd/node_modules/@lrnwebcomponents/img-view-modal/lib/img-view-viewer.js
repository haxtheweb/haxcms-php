define(["exports", "require", "../../../lit-element/lit-element.js", "../../img-pan-zoom/img-pan-zoom.js", "../../fullscreen-behaviors/fullscreen-behaviors.js", "../../simple-icon/simple-icon.js", "../../simple-icon/lib/simple-icons.js"], function (_exports, _require, _litElement, _imgPanZoom, _fullscreenBehaviors, _simpleIcon, _simpleIcons) {
  ...
  function _templateObject13_d9b4c7e0247111eb9734a78ef81f0b0d() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        <p>\n          <label for=\"pageX\" class=\"sr-only\">Page</label>\n          <input\n            ?disabled=\"", "\"\n            id=\"pageX\"\n            type=\"number\"\n            min=\"1\"\n            max=\"", "\"\n            value=\"", "\"\n            @change=\"", "\"\n          />\n          of ", "\n        </p>\n      "]);

    _templateObject13_d9b4c7e0247111eb9734a78ef81f0b0d = function _templateObject13_d9b4c7e0247111eb9734a78ef81f0b0d() {
      return data;
    };
  ...
  function _templateObject12_d9b4c7e0247111eb9734a78ef81f0b0d() {
    ...
    _templateObject12_d9b4c7e0247111eb9734a78ef81f0b0d = function _templateObject12_d9b4c7e0247111eb9734a78ef81f0b0d() {
      return data;
    };
  ...
  function _templateObject11_d9b4c7e0247111eb9734a78ef81f0b0d() {
    var data = babelHelpers.taggedTemplateLiteral([" toggle fullscreen "]);

    _templateObject11_d9b4c7e0247111eb9734a78ef81f0b0d = function _templateObject11_d9b4c7e0247111eb9734a78ef81f0b0d() {
      return data;
    };
  ...
  function _templateObject10_d9b4c7e0247111eb9734a78ef81f0b0d() {
    var data = babelHelpers.taggedTemplateLiteral(["\n          <simple-tooltip\n            for=\"", "\"\n            position=\"", "\"\n            >", "</simple-tooltip\n          >\n        "]);

    _templateObject10_d9b4c7e0247111eb9734a78ef81f0b0d = function _templateObject10_d9b4c7e0247111eb9734a78ef81f0b0d() {
      return data;
    };
  ...
  function _templateObject9_d9b4c7e0247111eb9734a78ef81f0b0d() {
    var data = babelHelpers.taggedTemplateLiteral(["\n          <p>\n            <simple-icon aria-hidden=\"true\" icon=\"", "\"></simple-icon>\n            <span class=\"", "\"\n              >", "</span\n            >\n          </p>\n        "]);

    _templateObject9_d9b4c7e0247111eb9734a78ef81f0b0d = function _templateObject9_d9b4c7e0247111eb9734a78ef81f0b0d() {
      return data;
    };
  ...
  function _templateObject8_d9b4c7e0247111eb9734a78ef81f0b0d() {
    var data = babelHelpers.taggedTemplateLiteral(["\n          <button\n            .id=\"", "\"\n            aria-pressed=\"", "\"\n            class=\"", "\"\n            @click=\"", "\"\n            controls=\"container\"\n            ?disabled=\"", "\"\n            ?hidden=\"", "\"\n          >\n            ", " ", "\n          </button>\n        "]);

    _templateObject8_d9b4c7e0247111eb9734a78ef81f0b0d = function _templateObject8_d9b4c7e0247111eb9734a78ef81f0b0d() {
      return data;
    };
  ...
  function _templateObject7_d9b4c7e0247111eb9734a78ef81f0b0d() {
    var data = babelHelpers.taggedTemplateLiteral(["\n          <button\n            .id=\"", "\"\n            class=\"", "\"\n            @click=\"", "\"\n            controls=\"container\"\n            ?disabled=\"", "\"\n            ?hidden=\"", "\"\n          >\n            ", "\n          </button>\n          ", "\n        "]);

    _templateObject7_d9b4c7e0247111eb9734a78ef81f0b0d = function _templateObject7_d9b4c7e0247111eb9734a78ef81f0b0d() {
      return data;
    };
  ...
  function _templateObject6_d9b4c7e0247111eb9734a78ef81f0b0d() {
    var data = babelHelpers.taggedTemplateLiteral(["\n          <div\n            .id=\"", "\"\n            class=\"button-group ", "\"\n          >\n            ", "\n          </div>\n        "]);

    _templateObject6_d9b4c7e0247111eb9734a78ef81f0b0d = function _templateObject6_d9b4c7e0247111eb9734a78ef81f0b0d() {
      return data;
    };
  ...
  function _templateObject5_d9b4c7e0247111eb9734a78ef81f0b0d() {
    var data = babelHelpers.taggedTemplateLiteral([" <div class=\"misc-item\">", "</div> "]);

    _templateObject5_d9b4c7e0247111eb9734a78ef81f0b0d = function _templateObject5_d9b4c7e0247111eb9734a78ef81f0b0d() {
      return data;
    };
  ...
  function _templateObject4_d9b4c7e0247111eb9734a78ef81f0b0d() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                  <div id=\"loader\" ?hidden=\"", "\">\n                    <hexagon-loader\n                      ?loading=", "\n                      item-count=\"4\"\n                    ></hexagon-loader>\n                  </div>\n                  <img-loader\n                    ?loaded=\"", "\"\n                    @loaded-changed=\"", "\"\n                    ?loading=\"", "\"\n                    @loading-changed=\"", "\"\n                    src=\"", "\"\n                    described-by=\"", "\"\n                  ></img-loader>\n                "]);

    _templateObject4_d9b4c7e0247111eb9734a78ef81f0b0d = function _templateObject4_d9b4c7e0247111eb9734a78ef81f0b0d() {
      return data;
    };
  ...
  function _templateObject3_d9b4c7e0247111eb9734a78ef81f0b0d() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            ", "\n          "]);

    _templateObject3_d9b4c7e0247111eb9734a78ef81f0b0d = function _templateObject3_d9b4c7e0247111eb9734a78ef81f0b0d() {
      return data;
    };
  ...
  function _templateObject2_d9b4c7e0247111eb9734a78ef81f0b0d() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      ", "\n      <div id=\"container\">\n        ", "\n        <div>\n          <div id=\"viewer\"></div>\n        </div>\n        <div id=\"placeholder\">\n          <div id=\"info\" ?hidden=\"", "\">", "</div>\n        </div>\n        ", "\n      </div>\n    "]);

    _templateObject2_d9b4c7e0247111eb9734a78ef81f0b0d = function _templateObject2_d9b4c7e0247111eb9734a78ef81f0b0d() {
      return data;
    };
  ...
  function _templateObject_d9b4c7e0247111eb9734a78ef81f0b0d() {
    ...
    _templateObject_d9b4c7e0247111eb9734a78ef81f0b0d = function _templateObject_d9b4c7e0247111eb9734a78ef81f0b0d() {
      return data;
    };
  ...
  var ImgViewViewer = /*#__PURE__*/function (_FullscreenBehaviors) {
    ...
    babelHelpers.createClass(ImgViewViewer, null, [{
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject_d9b4c7e0247111eb9734a78ef81f0b0d())];
      }
    }]);
    ...
    babelHelpers.createClass(ImgViewViewer, [{
      ...
      value: function _item() {
        ...
        if (babelHelpers.typeof(config) !== "object") {
          return (0, _litElement.html)(_templateObject5_d9b4c7e0247111eb9734a78ef81f0b0d(), config);
      ...
      value: function _group() {
        ...
        var top = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
        if (typeof config === "string" && this[config]) config = this[config];
        return !config ? "" : (0, _litElement.html)(_templateObject6_d9b4c7e0247111eb9734a78ef81f0b0d(), config.id || undefined, config.type || "", !Array.isArray(config.contents) ? config.contents : (config.contents || []).map(function (item) {
      ...
      value: function _button() {
        ...
        return !config ? "" : !config.toggleProp || !this[config.toggleProp] ? (0, _litElement.html)(_templateObject7_d9b4c7e0247111eb9734a78ef81f0b0d(), config.id || undefined, this._buttonClass(config), function (e) {
          return _this3._toolbarButtonClick(config.id, e, _this3._buttonDisabled(config));
        }, this._buttonDisabled(config), this._buttonHidden(config), this._buttonInner(config), this._buttonTooltip(config, top)) : (0, _litElement.html)(_templateObject8_d9b4c7e0247111eb9734a78ef81f0b0d(), config.id || undefined, this[config.toggleProp] ? "true" : "false", this._buttonClass(config), function (e) {
          return _this3._toolbarButtonClick(config.id, e, _this3._buttonDisabled(config));
      ...
      value: function _buttonInner(config) {
        return !config ? "" : (0, _litElement.html)(_templateObject9_d9b4c7e0247111eb9734a78ef81f0b0d(), config.icon, config.icon && !config.showText ? "sr-only" : "", config.text);
      }
    }, {
      key: "_buttonTooltip",
      value: function _buttonTooltip(config) {
        var top = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
        return !config || !config.id ? "" : (0, _litElement.html)(_templateObject10_d9b4c7e0247111eb9734a78ef81f0b0d(), config.id, top ? "bottom" : "top", config.text);
      }
    }, {
      key: "_setFullscreen",
      ...
      get: function get() {
        return {
          ...
          text: (0, _litElement.html)(_templateObject11_d9b4c7e0247111eb9734a78ef81f0b0d())
        };
      }
      /**
      ...
      get: function get() {
        return {
          ...
          details: (0, _litElement.html)(_templateObject12_d9b4c7e0247111eb9734a78ef81f0b0d())
        };
      }
      /**
      ...
      get: function get() {
        ...
        return {
          id: "navXofY",
          type: "misc-item",
          contents: (0, _litElement.html)(_templateObject13_d9b4c7e0247111eb9734a78ef81f0b0d(), this.disabled, this.pages.length, this.page + 1, function (e) {
