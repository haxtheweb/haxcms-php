define(["exports", "require", "../../../lit-element/lit-element.js", "../../img-pan-zoom/img-pan-zoom.js", "../../fullscreen-behaviors/fullscreen-behaviors.js", "../../simple-icon/simple-icon.js", "../../simple-icon/lib/simple-icons.js"], function (_exports, _require, _litElement, _imgPanZoom, _fullscreenBehaviors, _simpleIcon, _simpleIcons) {
  ...
  function _templateObject13_f10ecd4025cb11eba454134bebd3d7b6() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        <p>\n          <label for=\"pageX\" class=\"sr-only\">Page</label>\n          <input\n            ?disabled=\"", "\"\n            id=\"pageX\"\n            type=\"number\"\n            min=\"1\"\n            max=\"", "\"\n            value=\"", "\"\n            @change=\"", "\"\n          />\n          of ", "\n        </p>\n      "]);

    _templateObject13_f10ecd4025cb11eba454134bebd3d7b6 = function _templateObject13_f10ecd4025cb11eba454134bebd3d7b6() {
      return data;
    };
  ...
  function _templateObject12_f10ecd4025cb11eba454134bebd3d7b6() {
    ...
    _templateObject12_f10ecd4025cb11eba454134bebd3d7b6 = function _templateObject12_f10ecd4025cb11eba454134bebd3d7b6() {
      return data;
    };
  ...
  function _templateObject11_f10ecd4025cb11eba454134bebd3d7b6() {
    var data = babelHelpers.taggedTemplateLiteral([" toggle fullscreen "]);

    _templateObject11_f10ecd4025cb11eba454134bebd3d7b6 = function _templateObject11_f10ecd4025cb11eba454134bebd3d7b6() {
      return data;
    };
  ...
  function _templateObject10_f10ecd4025cb11eba454134bebd3d7b6() {
    var data = babelHelpers.taggedTemplateLiteral(["\n          <simple-tooltip\n            for=\"", "\"\n            position=\"", "\"\n            >", "</simple-tooltip\n          >\n        "]);

    _templateObject10_f10ecd4025cb11eba454134bebd3d7b6 = function _templateObject10_f10ecd4025cb11eba454134bebd3d7b6() {
      return data;
    };
  ...
  function _templateObject9_f10ecd4025cb11eba454134bebd3d7b6() {
    var data = babelHelpers.taggedTemplateLiteral(["\n          <p>\n            <simple-icon aria-hidden=\"true\" icon=\"", "\"></simple-icon>\n            <span class=\"", "\"\n              >", "</span\n            >\n          </p>\n        "]);

    _templateObject9_f10ecd4025cb11eba454134bebd3d7b6 = function _templateObject9_f10ecd4025cb11eba454134bebd3d7b6() {
      return data;
    };
  ...
  function _templateObject8_f10ecd4025cb11eba454134bebd3d7b6() {
    var data = babelHelpers.taggedTemplateLiteral(["\n          <button\n            .id=\"", "\"\n            aria-pressed=\"", "\"\n            class=\"", "\"\n            @click=\"", "\"\n            controls=\"container\"\n            ?disabled=\"", "\"\n            ?hidden=\"", "\"\n          >\n            ", " ", "\n          </button>\n        "]);

    _templateObject8_f10ecd4025cb11eba454134bebd3d7b6 = function _templateObject8_f10ecd4025cb11eba454134bebd3d7b6() {
      return data;
    };
  ...
  function _templateObject7_f10ecd4025cb11eba454134bebd3d7b6() {
    var data = babelHelpers.taggedTemplateLiteral(["\n          <button\n            .id=\"", "\"\n            class=\"", "\"\n            @click=\"", "\"\n            controls=\"container\"\n            ?disabled=\"", "\"\n            ?hidden=\"", "\"\n          >\n            ", "\n          </button>\n          ", "\n        "]);

    _templateObject7_f10ecd4025cb11eba454134bebd3d7b6 = function _templateObject7_f10ecd4025cb11eba454134bebd3d7b6() {
      return data;
    };
  ...
  function _templateObject6_f10ecd4025cb11eba454134bebd3d7b6() {
    var data = babelHelpers.taggedTemplateLiteral(["\n          <div\n            .id=\"", "\"\n            class=\"button-group ", "\"\n          >\n            ", "\n          </div>\n        "]);

    _templateObject6_f10ecd4025cb11eba454134bebd3d7b6 = function _templateObject6_f10ecd4025cb11eba454134bebd3d7b6() {
      return data;
    };
  ...
  function _templateObject5_f10ecd4025cb11eba454134bebd3d7b6() {
    var data = babelHelpers.taggedTemplateLiteral([" <div class=\"misc-item\">", "</div> "]);

    _templateObject5_f10ecd4025cb11eba454134bebd3d7b6 = function _templateObject5_f10ecd4025cb11eba454134bebd3d7b6() {
      return data;
    };
  ...
  function _templateObject4_f10ecd4025cb11eba454134bebd3d7b6() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                  <div id=\"loader\" ?hidden=\"", "\">\n                    <hexagon-loader\n                      ?loading=", "\n                      item-count=\"4\"\n                    ></hexagon-loader>\n                  </div>\n                  <img-loader\n                    ?loaded=\"", "\"\n                    @loaded-changed=\"", "\"\n                    ?loading=\"", "\"\n                    @loading-changed=\"", "\"\n                    src=\"", "\"\n                    described-by=\"", "\"\n                  ></img-loader>\n                "]);

    _templateObject4_f10ecd4025cb11eba454134bebd3d7b6 = function _templateObject4_f10ecd4025cb11eba454134bebd3d7b6() {
      return data;
    };
  ...
  function _templateObject3_f10ecd4025cb11eba454134bebd3d7b6() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            ", "\n          "]);

    _templateObject3_f10ecd4025cb11eba454134bebd3d7b6 = function _templateObject3_f10ecd4025cb11eba454134bebd3d7b6() {
      return data;
    };
  ...
  function _templateObject2_f10ecd4025cb11eba454134bebd3d7b6() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      ", "\n      <div id=\"container\">\n        ", "\n        <div>\n          <div id=\"viewer\"></div>\n        </div>\n        <div id=\"placeholder\">\n          <div id=\"info\" ?hidden=\"", "\">", "</div>\n        </div>\n        ", "\n      </div>\n    "]);

    _templateObject2_f10ecd4025cb11eba454134bebd3d7b6 = function _templateObject2_f10ecd4025cb11eba454134bebd3d7b6() {
      return data;
    };
  ...
  function _templateObject_f10ecd4025cb11eba454134bebd3d7b6() {
    ...
    _templateObject_f10ecd4025cb11eba454134bebd3d7b6 = function _templateObject_f10ecd4025cb11eba454134bebd3d7b6() {
      return data;
    };
  ...
  var ImgViewViewer = /*#__PURE__*/function (_FullscreenBehaviors) {
    ...
    babelHelpers.createClass(ImgViewViewer, null, [{
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject_f10ecd4025cb11eba454134bebd3d7b6())];
      }
    }]);
    ...
    babelHelpers.createClass(ImgViewViewer, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_f10ecd4025cb11eba454134bebd3d7b6(), !this.dzi ? (0, _litElement.html)(_templateObject3_f10ecd4025cb11eba454134bebd3d7b6(), this.hideSpinner ? "" : (0, _litElement.html)(_templateObject4_f10ecd4025cb11eba454134bebd3d7b6(), this.loaded, this.loading || !this.loaded, this.loaded, this.loadedChangedEvent, this.loading, this.loadingChangedEvent, this.loadSrc, this.describedBy || "")) : "", this.getToolbars(this.defaultToolbars, this.toolbars, "top"), !this.info, this.info, this.getToolbars(this.defaultToolbars, this.toolbars, "bottom"));
      }
    }, {
      key: "getToolbars",
      ...
      value: function _item() {
        ...
        if (babelHelpers.typeof(config) !== "object") {
          return (0, _litElement.html)(_templateObject5_f10ecd4025cb11eba454134bebd3d7b6(), config);
      ...
      value: function _group() {
        ...
        var top = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
        if (typeof config === "string" && this[config]) config = this[config];
        return !config ? "" : (0, _litElement.html)(_templateObject6_f10ecd4025cb11eba454134bebd3d7b6(), config.id || undefined, config.type || "", !Array.isArray(config.contents) ? config.contents : (config.contents || []).map(function (item) {
      ...
      value: function _button() {
        ...
        return !config ? "" : !config.toggleProp || !this[config.toggleProp] ? (0, _litElement.html)(_templateObject7_f10ecd4025cb11eba454134bebd3d7b6(), config.id || undefined, this._buttonClass(config), function (e) {
          return _this3._toolbarButtonClick(config.id, e, _this3._buttonDisabled(config));
        }, this._buttonDisabled(config), this._buttonHidden(config), this._buttonInner(config), this._buttonTooltip(config, top)) : (0, _litElement.html)(_templateObject8_f10ecd4025cb11eba454134bebd3d7b6(), config.id || undefined, this[config.toggleProp] ? "true" : "false", this._buttonClass(config), function (e) {
          return _this3._toolbarButtonClick(config.id, e, _this3._buttonDisabled(config));
      ...
      value: function _buttonInner(config) {
        return !config ? "" : (0, _litElement.html)(_templateObject9_f10ecd4025cb11eba454134bebd3d7b6(), config.icon, config.icon && !config.showText ? "sr-only" : "", config.text);
      }
    }, {
      key: "_buttonTooltip",
      value: function _buttonTooltip(config) {
        var top = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
        return !config || !config.id ? "" : (0, _litElement.html)(_templateObject10_f10ecd4025cb11eba454134bebd3d7b6(), config.id, top ? "bottom" : "top", config.text);
      }
    }, {
      key: "_setFullscreen",
      ...
      get: function get() {
        return {
          ...
          text: (0, _litElement.html)(_templateObject11_f10ecd4025cb11eba454134bebd3d7b6())
        };
      }
      /**
      ...
      get: function get() {
        return {
          ...
          details: (0, _litElement.html)(_templateObject12_f10ecd4025cb11eba454134bebd3d7b6())
        };
      }
      /**
      ...
      get: function get() {
        ...
        return {
          id: "navXofY",
          type: "misc-item",
          contents: (0, _litElement.html)(_templateObject13_f10ecd4025cb11eba454134bebd3d7b6(), this.disabled, this.pages.length, this.page + 1, function (e) {
