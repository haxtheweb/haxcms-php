define(["exports", "require", "../../../lit/index.js", "../../img-pan-zoom/img-pan-zoom.js", "../../fullscreen-behaviors/fullscreen-behaviors.js", "../../simple-icon/lib/simple-icon-lite.js", "../../simple-icon/lib/simple-icons.js", "../../utils/utils.js"], function (_exports, _require, _index, _imgPanZoom, _fullscreenBehaviors, _simpleIconLite, _simpleIcons, _utils) {
  ...
  var _templateObject_8e605ea03dc711eda79ddd1a980dc0e1, _templateObject2_8e605ea03dc711eda79ddd1a980dc0e1, _templateObject3_8e605ea03dc711eda79ddd1a980dc0e1, _templateObject4_8e605ea03dc711eda79ddd1a980dc0e1, _templateObject5_8e605ea03dc711eda79ddd1a980dc0e1, _templateObject6_8e605ea03dc711eda79ddd1a980dc0e1, _templateObject7_8e605ea03dc711eda79ddd1a980dc0e1, _templateObject8_8e605ea03dc711eda79ddd1a980dc0e1, _templateObject9_8e605ea03dc711eda79ddd1a980dc0e1, _templateObject10_8e605ea03dc711eda79ddd1a980dc0e1, _templateObject11_8e605ea03dc711eda79ddd1a980dc0e1, _templateObject12_8e605ea03dc711eda79ddd1a980dc0e1, _templateObject13_8e605ea03dc711eda79ddd1a980dc0e1;
  ...
  var ImgViewViewer = /*#__PURE__*/function (_FullscreenBehaviors) {
    ...
    babelHelpers.createClass(ImgViewViewer, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_8e605ea03dc711eda79ddd1a980dc0e1 || (_templateObject_8e605ea03dc711eda79ddd1a980dc0e1 = babelHelpers.taggedTemplateLiteral(["\n      ", "\n      <div id=\"container\">\n        ", "\n        <div>\n          <div\n            id=\"viewer\"\n            style=\"height:calc(var(--img-view-viewer-height, 500px) - ", "px)\"\n          ></div>\n        </div>\n        <div id=\"placeholder\">\n          <div id=\"info\" ?hidden=\"", "\">", "</div>\n        </div>\n        ", "\n      </div>\n    "])), !this.dzi ? (0, _index.html)(_templateObject2_8e605ea03dc711eda79ddd1a980dc0e1 || (_templateObject2_8e605ea03dc711eda79ddd1a980dc0e1 = babelHelpers.taggedTemplateLiteral(["\n            ", "\n          "])), this.hideSpinner ? "" : (0, _index.html)(_templateObject3_8e605ea03dc711eda79ddd1a980dc0e1 || (_templateObject3_8e605ea03dc711eda79ddd1a980dc0e1 = babelHelpers.taggedTemplateLiteral(["\n                  <div id=\"loader\" ?hidden=\"", "\">\n                    <hexagon-loader\n                      ?loading=", "\n                      item-count=\"4\"\n                    ></hexagon-loader>\n                  </div>\n                  <img-loader\n                    ?loaded=\"", "\"\n                    @loaded-changed=\"", "\"\n                    ?loading=\"", "\"\n                    @loading-changed=\"", "\"\n                    src=\"", "\"\n                    described-by=\"", "\"\n                  ></img-loader>\n                "])), this.loaded, this.loading || !this.loaded, this.loaded, this.loadedChangedEvent, this.loading, this.loadingChangedEvent, this.loadSrc, this.describedBy || "")) : "", this.getToolbars("top"), this.toolbarsHeight, !this.info, this.info, this.getToolbars("bottom"));
      }
    }, {
      key: "toolbarsHeight",
      get: function get() {
      ...
      get: function get() {
        return {
          ...
          text: (0, _index.html)(_templateObject4_8e605ea03dc711eda79ddd1a980dc0e1 || (_templateObject4_8e605ea03dc711eda79ddd1a980dc0e1 = babelHelpers.taggedTemplateLiteral([" toggle fullscreen "])))
        };
      }
      /**
      ...
      get: function get() {
        ...
        return {
          id: "navXofY",
          type: "misc-item",
          contents: (0, _index.html)(_templateObject6_8e605ea03dc711eda79ddd1a980dc0e1 || (_templateObject6_8e605ea03dc711eda79ddd1a980dc0e1 = babelHelpers.taggedTemplateLiteral(["\n        <p>\n          <label for=\"pageX\" class=\"sr-only\">Page</label>\n          <input\n            ?disabled=\"", "\"\n            id=\"pageX\"\n            type=\"number\"\n            min=\"1\"\n            max=\"", "\"\n            value=\"", "\"\n            @change=\"", "\"\n          />\n          of ", "\n        </p>\n      "])), this.disabled, this.pages.length, this.page + 1, function (e) {
      ...
      value: function _item() {
        ...
        if (babelHelpers.typeof(config) !== "object") {
          return (0, _index.html)(_templateObject7_8e605ea03dc711eda79ddd1a980dc0e1 || (_templateObject7_8e605ea03dc711eda79ddd1a980dc0e1 = babelHelpers.taggedTemplateLiteral([" <div class=\"misc-item\">", "</div> "])), config);
      ...
      value: function _group() {
        ...
        var top = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
        if (typeof config === "string" && this[config]) config = this[config];
        return !config ? "" : (0, _index.html)(_templateObject8_8e605ea03dc711eda79ddd1a980dc0e1 || (_templateObject8_8e605ea03dc711eda79ddd1a980dc0e1 = babelHelpers.taggedTemplateLiteral(["\n          <div\n            .id=\"", "\"\n            class=\"button-group ", "\"\n          >\n            ", "\n          </div>\n        "])), config.id || undefined, config.type || "", !Array.isArray(config.contents) ? config.contents : (config.contents || []).map(function (item) {
      ...
      value: function _button() {
        ...
        return !config ? "" : !config.toggleProp || !this[config.toggleProp] ? (0, _index.html)(_templateObject9_8e605ea03dc711eda79ddd1a980dc0e1 || (_templateObject9_8e605ea03dc711eda79ddd1a980dc0e1 = babelHelpers.taggedTemplateLiteral(["\n          <button\n            .id=\"", "\"\n            class=\"", "\"\n            @click=\"", "\"\n            controls=\"container\"\n            ?disabled=\"", "\"\n            ?hidden=\"", "\"\n          >\n            ", "\n          </button>\n          ", "\n        "])), config.id || undefined, this._buttonClass(config), function (e) {
          return _this4._toolbarButtonClick(config.id, e, _this4._buttonDisabled(config));
        }, this._buttonDisabled(config), this._buttonHidden(config), this._buttonInner(config), this._buttonTooltip(config, top)) : (0, _index.html)(_templateObject10_8e605ea03dc711eda79ddd1a980dc0e1 || (_templateObject10_8e605ea03dc711eda79ddd1a980dc0e1 = babelHelpers.taggedTemplateLiteral(["\n          <button\n            .id=\"", "\"\n            aria-pressed=\"", "\"\n            class=\"", "\"\n            @click=\"", "\"\n            controls=\"container\"\n            ?disabled=\"", "\"\n            ?hidden=\"", "\"\n          >\n            ", " ", "\n          </button>\n        "])), config.id || undefined, this[config.toggleProp] ? "true" : "false", this._buttonClass(config), function (e) {
          return _this4._toolbarButtonClick(config.id, e, _this4._buttonDisabled(config));
      ...
      value: function _buttonInner(config) {
        return !config ? "" : (0, _index.html)(_templateObject11_8e605ea03dc711eda79ddd1a980dc0e1 || (_templateObject11_8e605ea03dc711eda79ddd1a980dc0e1 = babelHelpers.taggedTemplateLiteral(["\n          <p>\n            <simple-icon-lite\n              aria-hidden=\"true\"\n              icon=\"", "\"\n            ></simple-icon-lite>\n            <span class=\"", "\"\n              >", "</span\n            >\n          </p>\n        "])), config.icon, config.icon && !config.showText ? "sr-only" : "", config.text);
      }
    }, {
      key: "_buttonTooltip",
      value: function _buttonTooltip(config) {
        var top = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
        return !config || !config.id ? "" : (0, _index.html)(_templateObject12_8e605ea03dc711eda79ddd1a980dc0e1 || (_templateObject12_8e605ea03dc711eda79ddd1a980dc0e1 = babelHelpers.taggedTemplateLiteral(["\n          <simple-tooltip\n            for=\"", "\"\n            position=\"", "\"\n            >", "</simple-tooltip\n          >\n        "])), config.id, top ? "bottom" : "top", config.text);
      }
    }, {
      key: "src",
      get: function get() {
