define(["exports", "meta", "require", "../../../lit-element/lit-element.js", "../../img-pan-zoom/img-pan-zoom.js", "../../es-global-bridge/es-global-bridge.js"], function (_exports, meta, _require, _litElement, _imgPanZoom, _esGlobalBridge) {
  ...
  function _templateObject13_af051860e0c411ea988d4b7e2b2c0fe2() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        <p>\n          <input\n            type=\"number\"\n            min=\"1\"\n            max=\"", "\"\n            value=\"", "\"\n            @change=\"", "\"\n          />\n          of ", "\n        </p>\n      "]);

    _templateObject13_af051860e0c411ea988d4b7e2b2c0fe2 = function _templateObject13_af051860e0c411ea988d4b7e2b2c0fe2() {
      return data;
    };
  ...
  function _templateObject12_af051860e0c411ea988d4b7e2b2c0fe2() {
    ...
    _templateObject12_af051860e0c411ea988d4b7e2b2c0fe2 = function _templateObject12_af051860e0c411ea988d4b7e2b2c0fe2() {
      return data;
    };
  ...
  function _templateObject11_af051860e0c411ea988d4b7e2b2c0fe2() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        toggle fullscreen\n      "]);

    _templateObject11_af051860e0c411ea988d4b7e2b2c0fe2 = function _templateObject11_af051860e0c411ea988d4b7e2b2c0fe2() {
      return data;
    };
  ...
  function _templateObject10_af051860e0c411ea988d4b7e2b2c0fe2() {
    var data = babelHelpers.taggedTemplateLiteral(["\n          <simple-tooltip for=\"", "\">", "</simple-tooltip>\n        "]);

    _templateObject10_af051860e0c411ea988d4b7e2b2c0fe2 = function _templateObject10_af051860e0c411ea988d4b7e2b2c0fe2() {
      return data;
    };
  ...
  function _templateObject9_af051860e0c411ea988d4b7e2b2c0fe2() {
    var data = babelHelpers.taggedTemplateLiteral(["\n          <p>\n            <iron-icon aria-hidden=\"true\" icon=\"", "\"></iron-icon>\n            <span class=\"", "\"\n              >", "</span\n            >\n          </p>\n        "]);

    _templateObject9_af051860e0c411ea988d4b7e2b2c0fe2 = function _templateObject9_af051860e0c411ea988d4b7e2b2c0fe2() {
      return data;
    };
  ...
  function _templateObject8_af051860e0c411ea988d4b7e2b2c0fe2() {
    var data = babelHelpers.taggedTemplateLiteral(["\n          <button\n            .id=\"", "\"\n            ?hidden=\"", "\"\n            aria-pressed=\"", "\"\n            class=\"", "\"\n            controls=\"container\"\n            @click=\"", "\"\n          >\n            ", "\n          </button>\n          ", "\n        "]);

    _templateObject8_af051860e0c411ea988d4b7e2b2c0fe2 = function _templateObject8_af051860e0c411ea988d4b7e2b2c0fe2() {
      return data;
    };
  ...
  function _templateObject7_af051860e0c411ea988d4b7e2b2c0fe2() {
    var data = babelHelpers.taggedTemplateLiteral(["\n          <button\n            .id=\"", "\"\n            class=\"", "\"\n            controls=\"container\"\n            @click=\"", "\"\n            ?disabled=\"", "\"\n          >\n            ", "\n          </button>\n          ", "\n        "]);

    _templateObject7_af051860e0c411ea988d4b7e2b2c0fe2 = function _templateObject7_af051860e0c411ea988d4b7e2b2c0fe2() {
      return data;
    };
  ...
  function _templateObject6_af051860e0c411ea988d4b7e2b2c0fe2() {
    var data = babelHelpers.taggedTemplateLiteral(["\n          <div\n            .id=\"", "\"\n            class=\"button-group ", "\"\n          >\n            ", "\n          </div>\n        "]);

    _templateObject6_af051860e0c411ea988d4b7e2b2c0fe2 = function _templateObject6_af051860e0c411ea988d4b7e2b2c0fe2() {
      return data;
    };
  ...
  function _templateObject5_af051860e0c411ea988d4b7e2b2c0fe2() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        <div class=\"misc-item\">", "</div>\n      "]);

    _templateObject5_af051860e0c411ea988d4b7e2b2c0fe2 = function _templateObject5_af051860e0c411ea988d4b7e2b2c0fe2() {
      return data;
    };
  ...
  function _templateObject4_af051860e0c411ea988d4b7e2b2c0fe2() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                  <hexagon-loader\n                    ?loading=", "\n                    item-count=\"4\"\n                    size=\"small\"\n                  ></hexagon-loader>\n                "]);

    _templateObject4_af051860e0c411ea988d4b7e2b2c0fe2 = function _templateObject4_af051860e0c411ea988d4b7e2b2c0fe2() {
      return data;
    };
  ...
  function _templateObject3_af051860e0c411ea988d4b7e2b2c0fe2() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            ", "\n            <img-loader\n              loaded=\"", "\"\n              @loaded-changed=\"", "\"\n              ?loading=\"", "\"\n              @loading-changed=\"", "\"\n              @page=\"", "\"\n              src=\"", "\"\n              described-by=\"", "\"\n            ></img-loader>\n          "]);

    _templateObject3_af051860e0c411ea988d4b7e2b2c0fe2 = function _templateObject3_af051860e0c411ea988d4b7e2b2c0fe2() {
      return data;
    };
  ...
  function _templateObject2_af051860e0c411ea988d4b7e2b2c0fe2() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <!-- Only preload regular images -->\n      ", "\n\n      <!-- Openseadragon -->\n      <div id=\"container\">\n        ", "\n        <div>\n          <div id=\"viewer\"></div>\n        </div>\n        <div id=\"placeholder\">\n          <div id=\"info\" ?hidden=\"", "\">\n            ", "\n          </div>\n        </div>\n        ", "\n      </div>\n    "]);

    _templateObject2_af051860e0c411ea988d4b7e2b2c0fe2 = function _templateObject2_af051860e0c411ea988d4b7e2b2c0fe2() {
      return data;
    };
  ...
  function _templateObject_af051860e0c411ea988d4b7e2b2c0fe2() {
    ...
    _templateObject_af051860e0c411ea988d4b7e2b2c0fe2 = function _templateObject_af051860e0c411ea988d4b7e2b2c0fe2() {
      return data;
    };
  ...
  function (_ImgPanZoom) {
    ...
    babelHelpers.createClass(ImgViewViewer, null, [{
       ...
       */
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(ImgViewViewer), "styles", this)), [(0, _litElement.css)(_templateObject_af051860e0c411ea988d4b7e2b2c0fe2())]);
      }
    }]);
    ...
    babelHelpers.createClass(ImgViewViewer, [{
      ...
      value: function render() {
        ...
        return (0, _litElement.html)(_templateObject2_af051860e0c411ea988d4b7e2b2c0fe2(), !this.dzi ? (0, _litElement.html)(_templateObject3_af051860e0c411ea988d4b7e2b2c0fe2(), this.hideSpinner || this.loaded ? "" : (0, _litElement.html)(_templateObject4_af051860e0c411ea988d4b7e2b2c0fe2(), this.loading || !this.loaded), this.loaded, this.loadedChangedEvent, this.loading, this.loadingChangedEvent, function (e) {
      ...
      value: function _item() {
        ...
        if (babelHelpers.typeof(config) !== "object") {
          return (0, _litElement.html)(_templateObject5_af051860e0c411ea988d4b7e2b2c0fe2(), config);
      ...
      value: function _group() {
        ...
        var config = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
        if (typeof config === "string" && this[config]) config = this[config];
        return !config ? "" : (0, _litElement.html)(_templateObject6_af051860e0c411ea988d4b7e2b2c0fe2(), config.id || undefined, config.type || "", !Array.isArray(config.contents) ? config.contents : (config.contents || []).map(function (item) {
      ...
      value: function _button() {
        ...
        return !config ? "" : !config.toggleProp || !this[config.toggleProp] ? (0, _litElement.html)(_templateObject7_af051860e0c411ea988d4b7e2b2c0fe2(), config.id || undefined, this._buttonClass(config), function (e) {
          return _this4._toolbarButtonClick(config.id, e);
        }, config.id === "prevbutton" && this.prevDisabled || config.id === "nextbutton" && this.nextDisabled, this._buttonInner(config), this._tooltip(config)) : (0, _litElement.html)(_templateObject8_af051860e0c411ea988d4b7e2b2c0fe2(), config.id || undefined, config.id === "navigatorbutton" && !this.showNavigator || config.id === "infobutton" && this.figures.length === 0, this[config.toggleProp] ? "true" : "false", this._buttonClass(config), function (e) {
          return _this4._toolbarButtonClick(config.id, e);
      ...
      value: function _buttonInner(config) {
        return !config ? "" : (0, _litElement.html)(_templateObject9_af051860e0c411ea988d4b7e2b2c0fe2(), config.icon, config.icon && !config.showText ? "sr-only" : "", config.text);
      }
    }, {
      key: "_tooltip",
      value: function _tooltip(config) {
        return !config || !config.id ? "" : (0, _litElement.html)(_templateObject10_af051860e0c411ea988d4b7e2b2c0fe2(), config.id, config.text);
      }
    }, {
      key: "updated",
      ...
      get: function get() {
        return {
          ...
          text: (0, _litElement.html)(_templateObject11_af051860e0c411ea988d4b7e2b2c0fe2())
        };
      }
      /**
      ...
      get: function get() {
        return {
          ...
          details: (0, _litElement.html)(_templateObject12_af051860e0c411ea988d4b7e2b2c0fe2())
        };
      }
      /**
      ...
      get: function get() {
        return {
          id: "navXofY",
          type: "misc-item",
          contents: (0, _litElement.html)(_templateObject13_af051860e0c411ea988d4b7e2b2c0fe2(), this.tileSources.length, this.page + 1, this.goToPageXofY, this.tileSources.length)
        };
      }
      /**
