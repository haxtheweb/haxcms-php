define(["exports", "meta", "require", "../../lit/index.js", "../../mobx/dist/mobx.esm.js", "../utils/utils.js", "../simple-tooltip/simple-tooltip.js", "../simple-colors/simple-colors.js", "./lib/v1/AppHaxStore.js", "./lib/v1/AppHaxBackendAPI.js", "../simple-popover/lib/simple-tour.js", "../simple-colors-shared-styles/simple-colors-shared-styles.js", "./lib/v1/AppHaxRouter.js", "./lib/v1/app-hax-label.js", "./lib/v1/app-hax-top-bar.js"], function (_exports, meta, _require, _index, _mobxEsm, _utils, _simpleTooltip, _simpleColors, _AppHaxStore, _AppHaxBackendAPI, _simpleTour, _simpleColorsSharedStyles, _AppHaxRouter, _appHaxLabel, _appHaxTopBar) {
  ...
  var _templateObject_ed4c3ca0c76a11eca96c833ece275368, _templateObject2_ed4c3ca0c76a11eca96c833ece275368, _templateObject3_ed4c3ca0c76a11eca96c833ece275368, _templateObject4_ed4c3ca0c76a11eca96c833ece275368, _templateObject5_ed4c3ca0c76a11eca96c833ece275368, _templateObject6_ed4c3ca0c76a11eca96c833ece275368, _templateObject7_ed4c3ca0c76a11eca96c833ece275368, _templateObject8_ed4c3ca0c76a11eca96c833ece275368, _templateObject9_ed4c3ca0c76a11eca96c833ece275368, _templateObject10_ed4c3ca0c76a11eca96c833ece275368;
  ...
  var AppHax = /*#__PURE__*/function (_SimpleColors) {
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                if (!((0, _mobxEsm.toJS)(_AppHaxStore.store.appReady) && (0, _mobxEsm.toJS)(_AppHaxStore.store.isLoggedIn) && (0, _mobxEsm.toJS)(_AppHaxStore.store.appSettings) && (0, _mobxEsm.toJS)(_AppHaxStore.store.refreshSiteList))) {
                  _context2.next = 7;
                  break;
                }
    ...
    babelHelpers.createClass(AppHax, [{
      ...
      key: "logout",
      value: function () {
        var _logout = babelHelpers.asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
          var results;
          return regeneratorRuntime.wrap(function _callee3$(_context3) {
            while (1) {
              switch (_context3.prev = _context3.next) {
                case 0:
                  _context3.next = 2;
                  return _AppHaxBackendAPI.AppHaxAPI.makeCall("logout");
                ...
                case 2:
                  ...
                  } catch (e) {// do nothing, this is a framed in / secure context
                  }

                  _AppHaxStore.store.jwt = "";
                  this.reset(true);
      ...
      value: function login() {
        ...
        new Promise(function (res, rej) {
          ...
          if (_this2.querySelector('[slot="externalproviders"]')) {
            var cloneSlot = _this2.querySelector('[slot="externalproviders"]').cloneNode(true);
      ...
      value: function updated(changedProperties) {
        ...
        changedProperties.forEach(function (oldValue, propName) {
          ...
          if (["basePath"].includes(propName) && _this3[propName]) {
            _AppHaxStore.store.AppHaxAPI[propName] = _this3[propName];
          } // settings for the store itself


          if (["token"].includes(propName) && _this3[propName]) {
            _AppHaxStore.store[propName] = _this3[propName];
          }
        });
      }
    }, {
      ...
      value: function firstUpdated(changedProperties) {
        ...
        (0, _mobxEsm.autorun)(function () {
          if (_AppHaxStore.store.activeItem) {
            _this4.activeItem = (0, _mobxEsm.toJS)(_AppHaxStore.store.activeItem);
          }
        });
        (0, _mobxEsm.autorun)(function () {
          _this4.soundIcon = (0, _mobxEsm.toJS)(_AppHaxStore.store.soundStatus) ? new URL("./lib/assets/images/FullVolume.svg", meta.url).href : new URL("./lib/assets/images/Silence.svg", meta.url).href;
      ...
      value: function appBody(routine) {
        var template = (0, _index.html)(_templateObject5_ed4c3ca0c76a11eca96c833ece275368 || (_templateObject5_ed4c3ca0c76a11eca96c833ece275368 = babelHelpers.taggedTemplateLiteral([""])));
      ...
      value: function templateHome() {
        return (0, _index.html)(_templateObject6_ed4c3ca0c76a11eca96c833ece275368 || (_templateObject6_ed4c3ca0c76a11eca96c833ece275368 = babelHelpers.taggedTemplateLiteral([" ", "\n\n      <app-hax-search-results></app-hax-search-results>"])), !this.searchTerm ? (0, _index.html)(_templateObject7_ed4c3ca0c76a11eca96c833ece275368 || (_templateObject7_ed4c3ca0c76a11eca96c833ece275368 = babelHelpers.taggedTemplateLiteral([" <div class=\"start-journey\">\n            <a\n              href=\"createSite-step-1\"\n              @click=\"", "\"\n              tabindex=\"-1\"\n            >\n              <app-hax-site-button\n                label=\"&gt; Start new journey\"\n              ></app-hax-site-button>\n            </a>\n          </div>"])), this.startJourney) : "");
      } // eslint-disable-next-line class-methods-use-this

    }, {
      key: "templateCreate",
      value: function templateCreate() {
        return (0, _index.html)(_templateObject8_ed4c3ca0c76a11eca96c833ece275368 || (_templateObject8_ed4c3ca0c76a11eca96c833ece275368 = babelHelpers.taggedTemplateLiteral(["<app-hax-steps\n      @promise-progress-finished=\"", "\"\n    ></app-hax-steps>"])), this.siteReadyToGo);
      }
    }, {
      key: "siteReadyToGo",
