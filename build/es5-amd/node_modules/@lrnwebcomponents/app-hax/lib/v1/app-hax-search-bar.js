define(["exports", "../../../../lit/index.js", "../../../simple-tooltip/simple-tooltip.js", "./AppHaxStore.js"], function (_exports, _index, _simpleTooltip, _AppHaxStore) {
  ...
  var _templateObject_6141c5803dc711eda79ddd1a980dc0e1, _templateObject2_6141c5803dc711eda79ddd1a980dc0e1;
  ...
  var AppHaxSearchBar = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(AppHaxSearchBar, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_6141c5803dc711eda79ddd1a980dc0e1 || (_templateObject_6141c5803dc711eda79ddd1a980dc0e1 = babelHelpers.taggedTemplateLiteral(["\n      <simple-icon-button-lite\n        id=\"searchico\"\n        ?disabled=\"", "\"\n        label=\"Search\"\n        icon=\"icons:search\"\n        @click=\"", "\"\n      ></simple-icon-button-lite>\n      <simple-tooltip for=\"searchico\" position=\"bottom\"\n        >Toggle Search</simple-tooltip\n      >\n      <input\n        ?disabled=\"", "\"\n        id=\"searchField\"\n        @input=\"", "\"\n        type=\"text\"\n        placeholder=\"Search..\"\n      />\n    "])), this.disabled, this.toggleSearch, !this.showSearch, this.search);
      }
    }, {
      key: "toggleSearch",
      ...
      key: "styles",
      get: function get() {
        return [(0, _index.css)(_templateObject2_6141c5803dc711eda79ddd1a980dc0e1 || (_templateObject2_6141c5803dc711eda79ddd1a980dc0e1 = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          overflow: hidden;\n        }\n        input {\n          visibility: none;\n          opacity: 0;\n          width: 0;\n          transition: all ease-in-out 0.3s;\n          padding: 4px;\n          font-family: \"Press Start 2P\", sans-serif;\n          font-size: 20px;\n          margin: 2px 0 0 16px;\n        }\n        :host([show-search]) input {\n          visibility: visible;\n          opacity: 1;\n          width: 250px;\n          max-width: 25vw;\n        }\n        @media (max-width: 780px) {\n          :host([show-search]) input {\n            width: 250px;\n            max-width: 20vw;\n          }\n        }\n        @media (max-width: 600px) {\n          :host([show-search]) input {\n            width: 200px;\n            max-width: 20vw;\n          }\n        }\n        simple-icon-button-lite {\n          color: black;\n          --simple-icon-width: 40px;\n          --simple-icon-height: 40px;\n          padding: 2px;\n          margin: 0;\n          background-color: white;\n        }\n        simple-icon-button-lite[disabled] {\n          background-color: #cccccc;\n          pointer-events: none;\n          cursor: help;\n        }\n        simple-icon-button-lite:focus,\n        simple-icon-button-lite:hover {\n          background-color: #eeeeee;\n        }\n      "])))];
      }
    }]);
