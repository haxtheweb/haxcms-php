define(["exports", "../../../simple-colors/simple-colors.js", "../../../../lit/index.js", "../../../../mobx/dist/mobx.esm.js", "../../../utils/utils.js", "./AppHaxStore.js", "./app-hax-site-bar.js", "./app-hax-site-details.js"], function (_exports, _simpleColors, _index, _mobxEsm, _utils, _AppHaxStore, _appHaxSiteBar, _appHaxSiteDetails) {
  ...
  var _templateObject_e9c4ab80e46a11edbf2e2349c355f24c, _templateObject2_e9c4ab80e46a11edbf2e2349c355f24c, _templateObject3_e9c4ab80e46a11edbf2e2349c355f24c, _templateObject4_e9c4ab80e46a11edbf2e2349c355f24c, _templateObject5_e9c4ab80e46a11edbf2e2349c355f24c;
  ...
  var AppHaxSearchResults = /*#__PURE__*/function (_SimpleColors) {
    ...
    babelHelpers.createClass(AppHaxSearchResults, [{
      ...
      value: function render() {
        var _this3 = this;
        return (0, _index.html)(_templateObject_e9c4ab80e46a11edbf2e2349c355f24c || (_templateObject_e9c4ab80e46a11edbf2e2349c355f24c = babelHelpers.taggedTemplateLiteral(["\n      <ul id=\"results\">\n        ", "\n      </ul>\n    "])), this.displayItems.length > 0 ? this.displayItems.map(function (item) {
          return (0, _index.html)(_templateObject2_e9c4ab80e46a11edbf2e2349c355f24c || (_templateObject2_e9c4ab80e46a11edbf2e2349c355f24c = babelHelpers.taggedTemplateLiteral([" <li>\n                  <app-hax-site-bar\n                    @opened-changed=\"", "\"\n                    ?dark=\"", "\"\n                    accent-color=\"", "\"\n                    icon-link=\"", "\"\n                    icon=\"", "\"\n                  >\n                    <a href=\"", "\" slot=\"heading\">", "</a>\n                    <span slot=\"subHeading\">", "</span>\n                    <app-hax-site-details\n                      slot=\"band\"\n                      .details=\"", "\"\n                      site-id=\"", "\"\n                    >\n                      <div class=\"description\" slot=\"pre\">\n                        ", "\n                      </div>\n                    </app-hax-site-details>\n                  </app-hax-site-bar>\n                </li>"])), _this3.openedChanged, _this3.dark, (0, _utils.varGet)(item, "metadata.theme.variables.cssVariable", "orange").replace("--simple-colors-default-theme-", "").replace("-7", ""), item.slug, (0, _utils.varGet)(item, "metadata.theme.variables.icon", "link"), item.slug, item.title, item.author, _this3.getItemDetails(item), item.id, item.description);
        }) : (0, _index.html)(_templateObject3_e9c4ab80e46a11edbf2e2349c355f24c || (_templateObject3_e9c4ab80e46a11edbf2e2349c355f24c = babelHelpers.taggedTemplateLiteral(["<div id=\"noResult\">\n              No results for\n              ", ".\n            </div>"])), this.searchTerm !== "" ? (0, _index.html)(_templateObject4_e9c4ab80e46a11edbf2e2349c355f24c || (_templateObject4_e9c4ab80e46a11edbf2e2349c355f24c = babelHelpers.taggedTemplateLiteral(["<strong>\"", "\"</strong>"])), this.searchTerm) : "your account, try starting a new journey!"));
      }
    }, {
      key: "getItemDetails",
      ...
      key: "styles",
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(AppHaxSearchResults), "styles", this)), [(0, _index.css)(_templateObject5_e9c4ab80e46a11edbf2e2349c355f24c || (_templateObject5_e9c4ab80e46a11edbf2e2349c355f24c = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          overflow: hidden;\n        }\n        ul,\n        li {\n          margin: 0;\n          padding: 0;\n          list-style: none;\n        }\n        app-hax-site-bar {\n          margin: 8px 0;\n        }\n        .description {\n          max-height: 64px;\n          overflow: hidden;\n          text-overflow: ellipsis;\n        }\n\n        @media (max-width: 800px) {\n          app-hax-site-bar {\n            --main-banner-width: 60vw;\n          }\n        }\n        @media (max-width: 400px) {\n          app-hax-site-bar {\n            --main-banner-width: 90vw;\n          }\n        }\n        span[slot=\"band\"] {\n          height: 48px;\n          overflow: hidden;\n          text-overflow: ellipsis;\n          margin-bottom: 8px;\n        }\n        :host([dark]) #noResult {\n          color: var(--simple-colors-default-theme-grey-12, black);\n        }\n      "])))]);
      }
    }]);
