define(["exports", "../../../../lit/index.js"], function (_exports, _index) {
  ...
  var _templateObject_4568d4e06f4811ed83231ba15a006752, _templateObject2_4568d4e06f4811ed83231ba15a006752;
  ...
  var AppHaxUserMenuButton = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(AppHaxUserMenuButton, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_4568d4e06f4811ed83231ba15a006752 || (_templateObject_4568d4e06f4811ed83231ba15a006752 = babelHelpers.taggedTemplateLiteral(["\n      <button class=\"menu-button\" part=\"menu-button\">\n        <simple-icon-lite class=\"icon\" icon=\"", "\"></simple-icon-lite\n        >", "\n      </button>\n    "])), this.icon, this.label);
      }
    }], [{
      key: "tag",
      ...
      key: "styles",
      get: function get() {
        return (0, _index.css)(_templateObject2_4568d4e06f4811ed83231ba15a006752 || (_templateObject2_4568d4e06f4811ed83231ba15a006752 = babelHelpers.taggedTemplateLiteral(["\n      :host {\n        font-family: \"Press Start 2P\", sans-serif;\n        text-align: center;\n        width: 100%;\n        --background-color: var(--app-hax-background-color);\n        --accent-color: var(--app-hax-accent-color);\n      }\n\n      .menu-button {\n        display: block;\n        width: 100%;\n        border: 2px solid var(--accent-color);\n        margin: 0;\n        padding: 8px;\n        font-size: 16px;\n        text-align: left;\n        color: var(--accent-color);\n        background-color: var(--background-color);\n        cursor: pointer;\n      }\n\n      .menu-button:hover,\n      .menu-button:active,\n      .menu-button:focus {\n        background-color: var(--accent-color);\n        color: var(--background-color);\n      }\n\n      .icon {\n        padding-right: 16px;\n      }\n    "])));
      }
    }]);
