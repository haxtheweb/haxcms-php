define(["exports", "../../../../lit/index.js"], function (_exports, _index) {
  ...
  var _templateObject_38df915035d711edbaf51720f3df2ce2, _templateObject2_38df915035d711edbaf51720f3df2ce2;
  ...
  var AppHaxLabel = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(AppHaxLabel, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_38df915035d711edbaf51720f3df2ce2 || (_templateObject_38df915035d711edbaf51720f3df2ce2 = babelHelpers.taggedTemplateLiteral(["\n      <div class=\"topBar\">\n        <div class=\"title\" part=\"title\">\n          <span class=\"bracket\">&#60;</span><slot>", "</slot\n          ><span class=\"bracket\">&#62;</span>\n        </div>\n        <div class=\"subtitle\" part=\"subtitle\">\n          <slot name=\"subtitle\">", "</slot>\n        </div>\n      </div>\n    "])), this.title, this.subtitle);
      }
    }], [{
      key: "tag",
      ...
      key: "styles",
      get: function get() {
        return (0, _index.css)(_templateObject2_38df915035d711edbaf51720f3df2ce2 || (_templateObject2_38df915035d711edbaf51720f3df2ce2 = babelHelpers.taggedTemplateLiteral(["\n      :host {\n        font-family: \"Press Start 2P\", sans-serif;\n        text-align: center;\n      }\n\n      .title {\n        -webkit-text-stroke: 1px\n          var(--app-hax-accent-color, var(--accent-color));\n        -webkit-text-fill-color: var(\n          --app-hax-background-color,\n          var(--background-color)\n        );\n        font-weight: normal;\n        font-size: 3.5vw;\n        display: inline-flex;\n        align-items: center;\n      }\n\n      .subtitle {\n        color: var(--app-hax-accent-color, var(--accent-color));\n        font-weight: normal;\n        margin-top: 2px;\n        font-size: 20px;\n      }\n      @media (max-width: 700px) {\n        .subtitle {\n          font-size: 12px;\n        }\n      }\n\n      .bracket {\n        font-size: 8vw;\n        font-weight: normal;\n        vertical-align: middle;\n        -webkit-text-stroke: 0px;\n        -webkit-text-fill-color: var(\n          --app-hax-accent-color,\n          var(--accent-color)\n        );\n      }\n      @media (max-height: 500px) {\n        .title {\n          -webkit-text-stroke: unset;\n          -webkit-text-fill-color: unset;\n        }\n        .bracket {\n          font-size: 4vw;\n          margin: 0;\n          padding: 0;\n        }\n      }\n    "])));
      }
    }]);
    return AppHaxLabel;
  }(_index.LitElement);
