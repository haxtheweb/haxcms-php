define(["exports", "meta", "../../../simple-icon/lib/simple-icon-lite.js", "../../../hax-iconset/lib/simple-hax-iconset.js", "../../../../lit/index.js"], function (_exports, meta, _simpleIconLite, _simpleHaxIconset, _index) {
  ...
  var _templateObject_fc60a3f0e51111edbf9f41986c80248c, _templateObject2_fc60a3f0e51111edbf9f41986c80248c, _templateObject3_fc60a3f0e51111edbf9f41986c80248c, _templateObject4_fc60a3f0e51111edbf9f41986c80248c;
  ...
  var betaPostIt = new URL("../assets/images/BetaPostIt.svg", meta.url).href;
  var AppHaxButton = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(AppHaxButton, [{
          ...
          if (propName === "type") {
            switch (_this2.type) {
              ...
              case "docx":
                ...
                break;
              case "evolution":
                _this2.icon = "communication:business";
                _this2.value = "evo";
                break;
              case "pressbooks":
                _this2.icon = "hax:wordpress";
                _this2.value = "pressbooks";
                break;
              case "gitbook":
                _this2.icon = "mdi-social:github-circle";
                _this2.value = "gitbook";
                break;
              case "elms:ln":
                _this2.icon = "lrn:network";
                _this2.value = "elmsln";
                break;
              case "haxcms":
                _this2.icon = "hax:hax2022";
                _this2.value = "haxcms";
                break;
              case "notion":
                _this2.icon = "book";
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_fc60a3f0e51111edbf9f41986c80248c || (_templateObject_fc60a3f0e51111edbf9f41986c80248c = babelHelpers.taggedTemplateLiteral(["\n      <wired-button\n        elevation=", "\n        ?disabled=", "\n        class=\"haxButton\"\n      >\n        <div id=\"container\">\n          <simple-icon-lite icon=", "> </simple-icon-lite>\n          <div class=\"type\">", "</div>\n        </div>\n        ", "\n         ", "\n      </wired-button>\n    "])), this.elevation, this.disabled || this.comingSoon, this.icon, this.type, this.comingSoon ? (0, _index.html)(_templateObject2_fc60a3f0e51111edbf9f41986c80248c || (_templateObject2_fc60a3f0e51111edbf9f41986c80248c = babelHelpers.taggedTemplateLiteral(["<img\n              src=\"", "\"\n              loading=\"lazy\"\n              decoding=\"async\"\n              fetchpriority=\"low\"\n              alt=\"Feature coming soon\"\n              class=\"coming-soon\"\n            />"])), postIt) : "", this.beta ? (0, _index.html)(_templateObject3_fc60a3f0e51111edbf9f41986c80248c || (_templateObject3_fc60a3f0e51111edbf9f41986c80248c = babelHelpers.taggedTemplateLiteral(["<img\n              src=\"", "\"\n              loading=\"lazy\"\n              decoding=\"async\"\n              fetchpriority=\"low\"\n              alt=\"Feature in beta\"\n              class=\"beta\"\n            />"])), betaPostIt) : "");
      }
    }], [{
      key: "tag",
      get:
