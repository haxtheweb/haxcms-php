define(["exports", "require", "../../../utils/utils.js", "../../../../mobx/dist/mobx.esm.js", "../../../replace-tag/lib/PerformanceDetect.js"], function (_exports, _require, _utils, _mobxEsm, _PerformanceDetect) {
  ...
  var Store = /*#__PURE__*/function () {
    function Store() {
      ...
      this.location = null;
      this.jwt = (0, _utils.localStorageGet)("jwt", null); // useful to know when we're logged in

      this.token = null;
      this.refreshSiteList = true;
      this.createSiteSteps = false;
      this.appSettings = window.appSettings || {}; // placeholder for when the actual API Backend gets plugged in here
