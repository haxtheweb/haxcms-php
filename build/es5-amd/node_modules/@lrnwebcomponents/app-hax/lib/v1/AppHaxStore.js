define(["exports", "meta", "require", "../../../utils/utils.js", "../../../../mobx/dist/mobx.esm.js", "../../../replace-tag/lib/PerformanceDetect.js"], function (_exports, meta, _require, _utils, _mobxEsm, _PerformanceDetect) {
  "use strict";
  ...
  var Store = /*#__PURE__*/function () {
    function Store() {
      ...
      fetch(new URL("../../../haxcms-elements/package.json", meta.url)).then(function (response) {
        return response.json();
      }).then(function (obj) {
        return console.log(_this.version = obj.version);
      });
      ...
      this.jwt = (0, _utils.localStorageGet)("jwt", null);
      ...
      get: function get() {
        ...
        if (this.activeSiteId && this.manifest && this.manifest.items) {
          var sites = this.manifest.items.filter(function (item) {
            return item.id === _this2.activeSiteId;
          });
          if (sites.length === 1) {
            return sites.pop();
          }
        ...
        if (this.routes.length > 0 && this.location && this.location.route) {
          if (this.createSiteSteps) {
            var routeItem = this.routes.find(function (item) {
              if (item.step === undefined || item.step !== _this3.step) {
                return false;
              }
              return true;
            });
