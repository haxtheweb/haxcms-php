define(["exports", "../../../../lit/index.js", "../../../simple-icon/lib/simple-icons.js", "../../../simple-icon/lib/simple-icon-lite.js", "../../../simple-colors/simple-colors.js", "../../../utils/utils.js", "../../../rpg-character/rpg-character.js", "../../../../mobx/dist/mobx.esm.js", "./AppHaxStore.js", "./AppHaxBackendAPI.js"], function (_exports, _index, _simpleIcons, _simpleIconLite, _simpleColors, _utils, _rpgCharacter, _mobxEsm, _AppHaxStore, _AppHaxBackendAPI) {
  ...
  var _templateObject_ffc58bc0c76a11eca96c833ece275368, _templateObject2_ffc58bc0c76a11eca96c833ece275368, _templateObject3_ffc58bc0c76a11eca96c833ece275368, _templateObject4_ffc58bc0c76a11eca96c833ece275368;
  ...
  var AppHaxSiteLogin = /*#__PURE__*/function (_SimpleColors) {
    ...
    babelHelpers.createClass(AppHaxSiteLogin, [{
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  value = this.shadowRoot.querySelector("#password").value; // attempt login and wait for response
                ...
                case 4:
                  ...
                  if (resp.status !== 200) {
                    ...
                    _AppHaxStore.store.appEl.reset(); // force return to home page to avoid state issues as we JUST logged in
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_ffc58bc0c76a11eca96c833ece275368 || (_templateObject_ffc58bc0c76a11eca96c833ece275368 = babelHelpers.taggedTemplateLiteral(["\n      <rpg-character seed=\"", "\"></rpg-character>\n      <div id=\"inputcontainer\">\n        ", "\n        <div class=\"external\">\n          <slot name=\"externalproviders\"></slot>\n        </div>\n      </div>\n      <p id=\"errorText\">", "</p>\n    "])), this.username, this.hidePassword ? (0, _index.html)(_templateObject2_ffc58bc0c76a11eca96c833ece275368 || (_templateObject2_ffc58bc0c76a11eca96c833ece275368 = babelHelpers.taggedTemplateLiteral(["<input\n                id=\"username\"\n                type=\"text\"\n                placeholder=\"abc123@hax.camp\"\n                @input=\"", "\"\n              />\n              <button @click=", ">next</button>"])), this.nameChange, this.checkUsername) : (0, _index.html)(_templateObject3_ffc58bc0c76a11eca96c833ece275368 || (_templateObject3_ffc58bc0c76a11eca96c833ece275368 = babelHelpers.taggedTemplateLiteral(["<p>\n                Hey ", "! <a @click=", ">not you?</a>\n              </p>\n              <input\n                id=\"password\"\n                type=\"password\"\n                placeholder=\"enter password\"\n              />\n              <button @click=", ">Login</button>"])), this.username, this.reset, this.checkPassword), this.errorMSG);
      }
    }], [{
      key: "tag",
      ...
      key: "styles",
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(AppHaxSiteLogin), "styles", this)), [(0, _index.css)(_templateObject4_ffc58bc0c76a11eca96c833ece275368 || (_templateObject4_ffc58bc0c76a11eca96c833ece275368 = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: flex;\n          flex-direction: column;\n          justify-content: center;\n          align-items: center;\n        }\n        #inputcontainer {\n          display: flex;\n          flex-direction: column;\n          justify-content: center;\n          align-items: center;\n        }\n        a {\n          color: red;\n        }\n\n        // This does not work\n        #errorText > p {\n          visibility: hidden;\n          background-color: lightblue;\n          color: red;\n          font-weight: bold;\n        }\n        rpg-character {\n          display: block;\n          margin: 10px;\n        }\n        .external {\n          text-align: center;\n        }\n      "])))]);
      }
    }]);
