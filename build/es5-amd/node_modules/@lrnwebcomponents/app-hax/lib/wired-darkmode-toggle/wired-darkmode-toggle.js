define(["exports", "meta", "../../../../wired-elements/lib/wired-lib.js", "../../../../wired-elements/lib/wired-toggle.js", "../../../../lit/index.js"], function (_exports, meta, _wiredLib, _wiredToggle, _index) {
  ...
  var _templateObject_4f580690ce0511ec9811713d37552719, _templateObject2_4f580690ce0511ec9811713d37552719;
  ...
  var WiredDarkmodeToggle = /*#__PURE__*/function (_WiredToggle) {
    ...
    babelHelpers.createClass(WiredDarkmodeToggle, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_4f580690ce0511ec9811713d37552719 || (_templateObject_4f580690ce0511ec9811713d37552719 = babelHelpers.taggedTemplateLiteral(["\n      <div style=\"position: relative;\">\n        <svg id=\"svg\"></svg>\n        <label for=\"input\">", "</label>\n        <input\n          id=\"input\"\n          type=\"checkbox\"\n          .checked=\"", "\"\n          ?disabled=\"", "\"\n          @change=\"", "\"\n        />\n      </div>\n    "])), this.label, this.checked, this.disabled, this.onChange);
      }
    }], [{
      key: "tag",
      get: function get() {
      ...
      key: "styles",
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(WiredDarkmodeToggle), "styles", this)), [(0, _index.css)(_templateObject2_4f580690ce0511ec9811713d37552719 || (_templateObject2_4f580690ce0511ec9811713d37552719 = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          opacity: 1;\n          display: inline-flex;\n          vertical-align: top;\n        }\n        :host div {\n          background-image: url(\"", "\");\n          background-repeat: no-repeat;\n          --wired-toggle-off-color: var(--simple-colors-fixed-theme-amber-7);\n          --wired-toggle-on-color: var(\n            --simple-colors-fixed-theme-light-blue-9\n          );\n          background-position-x: 50px;\n          width: 100px;\n          display: inline-flex;\n        }\n        :host([checked]) div {\n          background-image: url(\"", "\");\n          background-position: left;\n        }\n        input {\n          width: 100px;\n          height: 48px;\n          padding: 0;\n          margin: 0;\n        }\n        label {\n          clip: rect(0 0 0 0);\n          clip-path: inset(50%);\n          height: 1px;\n          overflow: hidden;\n          position: absolute;\n          white-space: nowrap;\n          width: 1px;\n        }\n      "])), (0, _index.unsafeCSS)(sun), (0, _index.unsafeCSS)(moon))]);
      }
    }]);
