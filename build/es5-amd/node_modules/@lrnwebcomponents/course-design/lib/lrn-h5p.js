define(["exports", "../../../lit/index.js", "../../haxcms-elements/lib/core/haxcms-site-store.js", "../../../mobx/dist/mobx.esm.js"], function (_exports, _index, _haxcmsSiteStore, _mobxEsm) {
  ...
  var _templateObject_8ac202303dc711eda79ddd1a980dc0e1, _templateObject2_8ac202303dc711eda79ddd1a980dc0e1, _templateObject3_8ac202303dc711eda79ddd1a980dc0e1, _templateObject4_8ac202303dc711eda79ddd1a980dc0e1;
    ...
    babelHelpers.createClass(LrnH5p, [{
      ...
      value: function render() {
        if (this.querySelector("iframe")) {
          ...
          return (0, _index.html)(_templateObject_8ac202303dc711eda79ddd1a980dc0e1 || (_templateObject_8ac202303dc711eda79ddd1a980dc0e1 = babelHelpers.taggedTemplateLiteral(["\n        <div id=\"container\">\n          ", "\n          <slot></slot>\n        </div>\n      "])), this._editing ? (0, _index.html)(_templateObject2_8ac202303dc711eda79ddd1a980dc0e1 || (_templateObject2_8ac202303dc711eda79ddd1a980dc0e1 = babelHelpers.taggedTemplateLiteral(["<a\n                id=\"edit\"\n                target=\"_blank\"\n                rel=\"noopener noreferrer\"\n                href=\"", "\"\n                >edit</a\n              >"])), editUrl) : "");
        }

        return (0, _index.html)(_templateObject3_8ac202303dc711eda79ddd1a980dc0e1 || (_templateObject3_8ac202303dc711eda79ddd1a980dc0e1 = babelHelpers.taggedTemplateLiteral(["<div id=\"container\">\n      <slot></slot>\n    </div>"])));
      }
      /**
      ...
      key: "styles",
      get: function get() {
        return [(0, _index.css)(_templateObject4_8ac202303dc711eda79ddd1a980dc0e1 || (_templateObject4_8ac202303dc711eda79ddd1a980dc0e1 = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n          width: 100%;\n          position: relative;\n          overflow: hidden;\n        }\n        #edit {\n          display: inline-block;\n          position: absolute;\n          left: 0;\n          top: 0;\n          transform: translateY(-100%);\n          transition: transform 0.2s ease-in-out;\n          background: #2196f3;\n          color: white;\n          text-decoration: none;\n          text-transform: uppercase;\n          padding: 0.5em 1em;\n        }\n        #container:focus #edit,\n        #container:hover #edit {\n          transform: translateY(0);\n        }\n      "])))];
      }
    }]);
    return LrnH5p;
  }(_index.LitElement);
