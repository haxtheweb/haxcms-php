define(["exports", "../../../lit/index.js", "../../simple-icon/lib/simple-icons.js", "../../simple-icon/lib/simple-icon-lite.js"], function (_exports, _index, _simpleIcons, _simpleIconLite) {
  ...
  var _templateObject_f4e20640e4f411ed85766367b4d3e9fc, _templateObject2_f4e20640e4f411ed85766367b4d3e9fc;
  ...
  var WorksheetDownload = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(WorksheetDownload, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_f4e20640e4f411ed85766367b4d3e9fc || (_templateObject_f4e20640e4f411ed85766367b4d3e9fc = babelHelpers.taggedTemplateLiteral(["\n      <div id=\"button_wrap\">\n        <a\n          tabindex=\"-1\"\n          href=\"", "\"\n          target=\"_blank\"\n          download\n          rel=\"noopener noreferrer\"\n          @click=\"", "\"\n        >\n          <button>\n            <simple-icon-lite icon=\"icons:file-download\"></simple-icon-lite\n            >", "\n          </button>\n        </a>\n      </div>\n    "])), this.link, this._clickLink, this.title);
      }
    }], [{
      key: "properties",
      get: function get() {
      ...
      key: "styles",
      get: function get() {
        return [(0, _index.css)(_templateObject2_f4e20640e4f411ed85766367b4d3e9fc || (_templateObject2_f4e20640e4f411ed85766367b4d3e9fc = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n\n        a {\n          text-decoration: none;\n          color: #0c7cd5;\n          display: block;\n        }\n\n        button {\n          text-transform: none;\n          border: solid 2px #dcdcdc;\n          width: 100%;\n          margin: 0 auto 0;\n          min-height: 48px;\n          text-align: center;\n        }\n\n        button:active,\n        button:focus,\n        button:hover {\n          cursor: pointer;\n          background-color: #0c7cd5;\n          color: #fff;\n        }\n\n        simple-icon {\n          margin-right: 5px;\n        }\n      "])))];
      }
    }]);
