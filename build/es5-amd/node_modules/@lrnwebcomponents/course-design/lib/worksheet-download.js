define(["exports", "../../../lit-element/lit-element.js", "../../simple-icon/lib/simple-icons.js", "../../simple-icon/lib/simple-icon-lite.js"], function (_exports, _litElement, _simpleIcons, _simpleIconLite) {
  ...
  var _templateObject_aefd48b0af6311ebbe560fe9c4727db1, _templateObject2_aefd48b0af6311ebbe560fe9c4727db1;
  ...
  var WorksheetDownload = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(WorksheetDownload, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_aefd48b0af6311ebbe560fe9c4727db1 || (_templateObject_aefd48b0af6311ebbe560fe9c4727db1 = babelHelpers.taggedTemplateLiteral(["\n      <div id=\"button_wrap\">\n        <a\n          tabindex=\"-1\"\n          href=\"", "\"\n          target=\"_blank\"\n          download\n          rel=\"noopener noreferrer\"\n          @click=\"", "\"\n        >\n          <button>\n            <simple-icon-lite icon=\"icons:file-download\"></simple-icon-lite\n            >", "\n          </button>\n        </a>\n      </div>\n    "])), this.link, this._clickLink, this.title);
      }
    }], [{
      key: "properties",
      get: function get() {
      ...
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_aefd48b0af6311ebbe560fe9c4727db1 || (_templateObject2_aefd48b0af6311ebbe560fe9c4727db1 = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n\n        a {\n          text-decoration: none;\n          color: #0c7cd5;\n          display: block;\n        }\n\n        button {\n          text-transform: none;\n          border: solid 2px #dcdcdc;\n          width: 100%;\n          margin: 0 auto 0;\n          min-height: 48px;\n          text-align: center;\n        }\n\n        button:active,\n        button:focus,\n        button:hover {\n          cursor: pointer;\n          background-color: #0c7cd5;\n          color: #fff;\n        }\n\n        simple-icon {\n          margin-right: 5px;\n        }\n      "])))];
      }
    }]);
