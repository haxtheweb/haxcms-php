define(["../../../lit-element/lit-element.js", "../../haxcms-elements/lib/core/haxcms-site-store.js", "../../../mobx/dist/mobx.esm.js", "./course-intro-lesson-plan.js"], function (_litElement, _haxcmsSiteStore, _mobxEsm, _courseIntroLessonPlan) {
  ...
  function _templateObject3_8ef2e820625811eb9a9521b3fdb3953c() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n        #title {\n          color: white;\n          font-family: \"Lato\";\n          text-transform: uppercase;\n          font-weight: 400;\n          text-align: center;\n          letter-spacing: 4.48px;\n          font-size: 1.4em;\n        }\n        #plans-container {\n          background: white;\n          margin: 0 auto;\n          max-width: 900px;\n        }\n      "]);

    _templateObject3_8ef2e820625811eb9a9521b3fdb3953c = function _templateObject3_8ef2e820625811eb9a9521b3fdb3953c() {
      return data;
    };
  ...
  function _templateObject2_8ef2e820625811eb9a9521b3fdb3953c() {
    var data = babelHelpers.taggedTemplateLiteral(["<course-intro-lesson-plan\n              title=\"", "\"\n              description=", "\n              link=", "\n            ></course-intro-lesson-plan>"]);

    _templateObject2_8ef2e820625811eb9a9521b3fdb3953c = function _templateObject2_8ef2e820625811eb9a9521b3fdb3953c() {
      return data;
    };
  ...
  function _templateObject_8ef2e820625811eb9a9521b3fdb3953c() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <h2 id=\"title\">Lesson Plan</h2>\n      <div id=\"plans-container\">\n        ", "\n      </div>\n    "]);

    _templateObject_8ef2e820625811eb9a9521b3fdb3953c = function _templateObject_8ef2e820625811eb9a9521b3fdb3953c() {
      return data;
    };
  ...
  var CourseIntroLessonPlans = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(CourseIntroLessonPlans, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_8ef2e820625811eb9a9521b3fdb3953c(), this.items.map(function (plan) {
          return (0, _litElement.html)(_templateObject2_8ef2e820625811eb9a9521b3fdb3953c(), plan.title, plan.metadata.courselist.description ? plan.metadata.courselist.description : "", plan.slug);
        }));
      }
    }], [{
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject3_8ef2e820625811eb9a9521b3fdb3953c())];
      }
    }, {
      key: "tag",
      get: function get() {
