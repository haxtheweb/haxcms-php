define(["../../../lit/index.js", "../../haxcms-elements/lib/core/haxcms-site-store.js", "../../../mobx/dist/mobx.esm.js", "./course-intro-lesson-plan.js"], function (_index, _haxcmsSiteStore, _mobxEsm, _courseIntroLessonPlan) {
  ...
  var _templateObject_ccee0e6027c411edb7faa9deadcbafd2, _templateObject2_ccee0e6027c411edb7faa9deadcbafd2, _templateObject3_ccee0e6027c411edb7faa9deadcbafd2;
  ...
  var CourseIntroLessonPlans = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(CourseIntroLessonPlans, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_ccee0e6027c411edb7faa9deadcbafd2 || (_templateObject_ccee0e6027c411edb7faa9deadcbafd2 = babelHelpers.taggedTemplateLiteral(["\n      <div id=\"plans-container\">\n        ", "\n      </div>\n    "])), this.items.map(function (plan) {
          return (0, _index.html)(_templateObject2_ccee0e6027c411edb7faa9deadcbafd2 || (_templateObject2_ccee0e6027c411edb7faa9deadcbafd2 = babelHelpers.taggedTemplateLiteral(["<course-intro-lesson-plan\n              title=\"", "\"\n              link=", "\n            ></course-intro-lesson-plan>"])), plan.title, plan.slug);
        }));
      }
    }], [{
      key: "properties",
      ...
      key: "styles",
      get: function get() {
        return [(0, _index.css)(_templateObject3_ccee0e6027c411edb7faa9deadcbafd2 || (_templateObject3_ccee0e6027c411edb7faa9deadcbafd2 = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n          background-color: var(\n            --course-intro-header--header--background-color,\n            #1e1e1e\n          );\n          padding-bottom: 40px;\n          min-height: 60vh;\n        }\n\n        @media screen and (min-width: 320px) {\n          #plans-container {\n            background: white;\n            margin: 0 auto;\n            max-width: 400px;\n          }\n        }\n\n        @media screen and (min-width: 620px) {\n          #plans-container {\n            max-width: 500px;\n          }\n        }\n\n        @media screen and (min-width: 920px) {\n          #plans-container {\n            max-width: 700px;\n          }\n        }\n\n        @media screen and (min-width: 1220px) {\n          #plans-container {\n            max-width: 900px;\n          }\n        }\n      "])))];
      }
    }, {
      key: "tag",
      get: function get() {
