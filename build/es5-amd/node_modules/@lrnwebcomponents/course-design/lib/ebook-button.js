define(["exports", "../../../lit/index.js", "../../simple-icon/lib/simple-icons.js", "../../simple-icon/lib/simple-icon-lite.js"], function (_exports, _index, _simpleIcons, _simpleIconLite) {
  ...
  var _templateObject_83a2ed10509711edb124eb517be36dbf, _templateObject2_83a2ed10509711edb124eb517be36dbf;
  ...
  var EbookButton = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(EbookButton, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_83a2ed10509711edb124eb517be36dbf || (_templateObject_83a2ed10509711edb124eb517be36dbf = babelHelpers.taggedTemplateLiteral(["\n      <div id=\"button wrapper\">\n        <a\n          href=\"", "\"\n          target=\"_blank\"\n          rel=\"noopener noreferrer\"\n          @click=\"", "\"\n        >\n          <button id=\"book\">\n            <simple-icon-lite icon=\"", "\"></simple-icon-lite>\n            <div class=\"title\">", "</div>\n          </button>\n        </a>\n      </div>\n    "])), this.link, this._clickLink, this.icon, this.title);
      }
    }], [{
      key: "properties",
      get: function get() {
      ...
      key: "styles",
      get: function get() {
        return [(0, _index.css)(_templateObject2_83a2ed10509711edb124eb517be36dbf || (_templateObject2_83a2ed10509711edb124eb517be36dbf = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: inline-block;\n          --paper-button-click-state: #000;\n          --paper-button-title: #000;\n          --link-color: #aeaeae;\n        }\n\n        button {\n          min-height: 48px;\n          text-transform: none;\n          padding: 10px 25px 10px 0;\n        }\n\n        button:active,\n        button:focus,\n        button:hover {\n          color: var(--paper-button-click-state);\n          outline: 2px solid black;\n          cursor: pointer;\n        }\n\n        simple-icon-lite {\n          height: 55px;\n          width: 55px;\n          margin-right: 5px;\n        }\n\n        .title {\n          color: var(--paper-button-title);\n          font-size: 16px;\n          font-weight: bold;\n          display: inline-flex;\n        }\n        a,\n        a:-webkit-any-link {\n          display: block;\n          color: var(--link-color);\n          text-decoration: none;\n        }\n      "])))];
      }
    }, {
      key: "tag",
      get: function get() {
