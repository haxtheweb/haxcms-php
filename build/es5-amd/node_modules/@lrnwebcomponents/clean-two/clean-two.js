define(["exports", "require", "../../lit/index.js", "../haxcms-elements/lib/core/HAXCMSLitElementTheme.js", "../haxcms-elements/lib/core/utils/HAXCMSRememberRoute.js", "../haxcms-elements/lib/core/utils/HAXCMSThemeParts.js", "../haxcms-elements/lib/core/utils/PrintBranchMixin.js", "../haxcms-elements/lib/core/utils/PDFPageMixin.js", "../haxcms-elements/lib/core/utils/QRCodeMixin.js", "../haxcms-elements/lib/core/utils/HAXCMSMobileMenu.js", "../haxcms-elements/lib/core/utils/HAXCMSOperationButtons.js", "../haxcms-elements/lib/core/haxcms-site-store.js", "../haxcms-elements/lib/ui-components/active-item/site-active-title.js", "../haxcms-elements/lib/ui-components/navigation/site-breadcrumb.js", "../../mobx/dist/mobx.esm.js", "../simple-icon/simple-icon.js", "../simple-icon/lib/simple-icons.js", "../utils/utils.js", "../micro-frontend-registry/micro-frontend-registry.js"], function (_exports, _require, _index, _HAXCMSLitElementTheme, _HAXCMSRememberRoute, _HAXCMSThemeParts, _PrintBranchMixin, _PDFPageMixin, _QRCodeMixin, _HAXCMSMobileMenu, _HAXCMSOperationButtons, _haxcmsSiteStore, _siteActiveTitle, _siteBreadcrumb, _mobxEsm, _simpleIcon, _simpleIcons, _utils, _microFrontendRegistry) {
  ...
  var _templateObject_2ebf408035d711edbaf51720f3df2ce2, _templateObject2_2ebf408035d711edbaf51720f3df2ce2, _templateObject3_2ebf408035d711edbaf51720f3df2ce2, _templateObject4_2ebf408035d711edbaf51720f3df2ce2, _templateObject5_2ebf408035d711edbaf51720f3df2ce2;
  ...
  var CleanTwo = /*#__PURE__*/function (_HAXCMSOperationButto) {
    ...
    babelHelpers.createClass(CleanTwo, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_2ebf408035d711edbaf51720f3df2ce2 || (_templateObject_2ebf408035d711edbaf51720f3df2ce2 = babelHelpers.taggedTemplateLiteral(["\n      <div class=\"body-wrapper\">\n        <div class=\"left-col\" part=\"left-col\">", "</div>\n        <div class=\"content-wrapper\">\n          <div class=\"content\">\n            <header class=\"header\">\n              ", "\n              ", "\n              <site-modal\n                @site-modal-click=\"", "\"\n                ?disabled=\"", "\"\n                icon=\"icons:search\"\n                title=\"Search site\"\n                button-label=\"Search\"\n                part=\"search-btn\"\n              >\n                <site-search></site-search>\n              </site-modal>\n              ", "\n              ", "\n              <replace-tag\n                with=\"site-rss-button\"\n                type=\"rss\"\n                import-method=\"view\"\n                part=\"rss-btn\"\n              ></replace-tag>\n              <replace-tag\n                with=\"site-git-corner\"\n                size=\"small\"\n                circle\n                direction=\"left\"\n                import-method=\"view\"\n                part=\"git-corner-btn\"\n              ></replace-tag>\n              ", "\n            </header>\n            <site-search\n              hide-input\n              part=\"search-btn\"\n              search=\"", "\"\n              @search-item-selected=\"", "\"\n              ?hidden=\"", "\"\n            ></site-search>\n            <main>\n              <div id=\"haxcms-theme-top\"></div>\n              <site-breadcrumb part=\"page-breadcrumb\"></site-breadcrumb>\n              <site-active-title part=\"page-title\"></site-active-title>\n              <article\n                id=\"contentcontainer\"\n                ?hidden=\"", "\"\n              >\n                <section id=\"slot\">\n                  <slot></slot>\n                </section>\n              </article>\n            </main>\n            <footer>\n              <div class=\"link-actions\">\n                <div class=\"inner\">\n                  <replace-tag\n                    with=\"site-menu-button\"\n                    import-only\n                  ></replace-tag>\n                  <site-menu-button\n                    hide-label\n                    type=\"prev\"\n                    position=\"right\"\n                    class=\"navigation\"\n                    @label-changed=\"", "\"\n                  >\n                    <div slot=\"suffix\" class=\"wrapper\">\n                      <div class=\"top\">Previous</div>\n                      <div class=\"bottom\">", "</div>\n                    </div>\n                  </site-menu-button>\n                  <site-menu-button\n                    hide-label\n                    type=\"next\"\n                    position=\"left\"\n                    class=\"navigation\"\n                    @label-changed=\"", "\"\n                  >\n                    <div slot=\"prefix\" class=\"wrapper\">\n                      <div class=\"top\">Next</div>\n                      <div class=\"bottom\">", "</div>\n                    </div>\n                  </site-menu-button>\n                </div>\n              </div>\n              <div class=\"footer\" part=\"footer\">\n                <div class=\"footer-left\" part=\"footer-left\">\n                  Last updated\n                  <replace-tag with=\"simple-datetime\" import-only></replace-tag>\n                  <simple-datetime\n                    unix\n                    .timestamp=\"", "\"\n                  ></simple-datetime>\n                </div>\n              </div>\n            </footer>\n          </div>\n        </div>\n        ", "\n      </div>\n    "])), this.HAXCMSMobileMenu(), !["lg", "xl"].includes(this.responsiveSize) ? (0, _index.html)(_templateObject2_2ebf408035d711edbaf51720f3df2ce2 || (_templateObject2_2ebf408035d711edbaf51720f3df2ce2 = babelHelpers.taggedTemplateLiteral(["\n                    <div part=\"site-menu-content\">\n                      <site-menu-content\n                        .part=\"", "\"\n                        mobile\n                      ></site-menu-content>\n                    </div>\n                  "])), this.editMode ? "edit-mode-active" : "") : "", this.HAXCMSMobileMenuButton(), this.siteModalClick, this.editMode, _microFrontendRegistry.MicroFrontendRegistry.has("@core/htmlToPdf") ? this.PDFPageButton() : "", _microFrontendRegistry.MicroFrontendRegistry.has("@haxcms/siteToHtml") ? this.PrintBranchButton() : (0, _index.html)(_templateObject3_2ebf408035d711edbaf51720f3df2ce2 || (_templateObject3_2ebf408035d711edbaf51720f3df2ce2 = babelHelpers.taggedTemplateLiteral(["<replace-tag\n                    with=\"site-print-button\"\n                    class=\"btn js-toolbar-action\"\n                    import-method=\"view\"\n                    part=\"print-btn\"\n                  ></replace-tag>"]))), this.QRCodeButton("right"), this.searchTerm, this.searchItemSelected, this.searchTerm != "" ? false : true, this.searchTerm != "" ? true : false, this.__prevPageLabelChanged, this.prevPage, this.__nextPageLabelChanged, this.nextPage, this.pageTimestamp, ["lg", "xl"].includes(this.responsiveSize) ? (0, _index.html)(_templateObject4_2ebf408035d711edbaf51720f3df2ce2 || (_templateObject4_2ebf408035d711edbaf51720f3df2ce2 = babelHelpers.taggedTemplateLiteral(["\n              <div class=\"right-col\" part=\"site-menu-content right-col\">\n                <div class=\"site-menu-content-wrapper\">\n                  <site-menu-content\n                    .part=\"", "\"\n                  ></site-menu-content>\n                </div>\n              </div>\n            "])), this.editMode ? "edit-mode-active" : "") : "");
      }
    }, {
