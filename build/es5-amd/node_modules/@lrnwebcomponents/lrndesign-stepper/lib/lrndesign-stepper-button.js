...
*/(0,_polymerLegacy.Polymer)({_template:(0,_polymerLegacy.html)(_templateObject_c34c95006b8111e98ce155804ade6153()),is:"lrndesign-stepper-button",properties:{/**
     ...
     */collapsible:{type:Boolean,reflectToAttribute:!0,notify:!0,value:!1},opened:{type:Boolean,value:!1}},ready:function ready(){var root=this;setTimeout(function(){var target=root.shadowRoot.querySelector("iron-collapse");if(root.opened){console.log("opening in stepper");target.show()}},0)},/**
   ...
   */hasCollapse:function hasCollapse(bool,test){if(bool==test){return!0}else{return!1}}})});