define(["exports", "require", "../../../lit-element/lit-element.js", "../../simple-icon/lib/simple-icon-lite.js", "../../simple-icon/lib/simple-icons.js", "../../utils/utils.js"], function (_exports, _require, _litElement, _simpleIconLite, _simpleIcons, _utils) {
  ...
  function _templateObject4_2beff0b03ee511ebb7f7a1171f0cd59d() {
    ...
    _templateObject4_2beff0b03ee511ebb7f7a1171f0cd59d = function _templateObject4_2beff0b03ee511ebb7f7a1171f0cd59d() {
      return data;
    };
  ...
  function _templateObject3_2beff0b03ee511ebb7f7a1171f0cd59d() {
    var data = babelHelpers.taggedTemplateLiteral([" <simple-icon-lite icon=\"", "\"></simple-icon-lite> "]);

    _templateObject3_2beff0b03ee511ebb7f7a1171f0cd59d = function _templateObject3_2beff0b03ee511ebb7f7a1171f0cd59d() {
      return data;
    };
  ...
  function _templateObject2_2beff0b03ee511ebb7f7a1171f0cd59d() {
    var data = babelHelpers.taggedTemplateLiteral(["\n              <div class=\"avatarlabel\">\n                <lrndesign-avatar\n                  label=\"", "\"\n                ></lrndesign-avatar>\n              </div>\n            "]);

    _templateObject2_2beff0b03ee511ebb7f7a1171f0cd59d = function _templateObject2_2beff0b03ee511ebb7f7a1171f0cd59d() {
      return data;
    };
  ...
  function _templateObject_2beff0b03ee511ebb7f7a1171f0cd59d() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <div id=\"container\">\n        ", "\n        ", "\n\n        <div id=\"center\">\n          <a tabindex=\"-1\" href=\"", "\">\n            <button class=\"title\" noink>\n              <div id=\"label\">", "</div>\n              <div class=\"title\">", "</div>\n            </button>\n          </a>\n        </div>\n      </div>\n    "]);

    _templateObject_2beff0b03ee511ebb7f7a1171f0cd59d = function _templateObject_2beff0b03ee511ebb7f7a1171f0cd59d() {
      return data;
    };
  ...
  var MapMenuHeader = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(MapMenuHeader, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_2beff0b03ee511ebb7f7a1171f0cd59d(), this.avatarLabel ? (0, _litElement.html)(_templateObject2_2beff0b03ee511ebb7f7a1171f0cd59d(), this.avatarLabel) : "", this.icon ? (0, _litElement.html)(_templateObject3_2beff0b03ee511ebb7f7a1171f0cd59d(), this.icon) : "", this.url, this.label, this.title);
      }
    }], [{
      key: "styles",
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject4_2beff0b03ee511ebb7f7a1171f0cd59d())];
      }
    }, {
      key: "tag",
      get: function get() {
