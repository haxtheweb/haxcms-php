define(["exports", "require", "../../../lit-element/lit-element.js", "../../../@polymer/iron-collapse/iron-collapse.js", "../../../@polymer/iron-icon/iron-icon.js", "../../../@polymer/iron-behaviors/iron-button-state.js", "../../../@polymer/paper-button/paper-button.js"], function (_exports, _require, _litElement, _ironCollapse, _ironIcon, _ironButtonState, _paperButton) {
  ...
  function _templateObject6_291117900ca311eaa0151532aa92855f() {
    ...
    _templateObject6_291117900ca311eaa0151532aa92855f = function _templateObject6_291117900ca311eaa0151532aa92855f() {
      return data;
    };
  ...
  function _templateObject5_291117900ca311eaa0151532aa92855f() {
    var data = babelHelpers.taggedTemplateLiteral([""]);

    _templateObject5_291117900ca311eaa0151532aa92855f = function _templateObject5_291117900ca311eaa0151532aa92855f() {
      return data;
    };
  ...
  function _templateObject4_291117900ca311eaa0151532aa92855f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n              <div class=\"icon\">\n                <iron-icon icon=\"", "\"></iron-icon>\n              </div>\n            "]);

    _templateObject4_291117900ca311eaa0151532aa92855f = function _templateObject4_291117900ca311eaa0151532aa92855f() {
      return data;
    };
  ...
  function _templateObject3_291117900ca311eaa0151532aa92855f() {
    var data = babelHelpers.taggedTemplateLiteral([""]);

    _templateObject3_291117900ca311eaa0151532aa92855f = function _templateObject3_291117900ca311eaa0151532aa92855f() {
      return data;
    };
  ...
  function _templateObject2_291117900ca311eaa0151532aa92855f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n              <div class=\"avatarlabel\">\n                <lrndesign-avatar\n                  .label=\"", "\"\n                ></lrndesign-avatar>\n              </div>\n            "]);

    _templateObject2_291117900ca311eaa0151532aa92855f = function _templateObject2_291117900ca311eaa0151532aa92855f() {
      return data;
    };
  ...
  function _templateObject_291117900ca311eaa0151532aa92855f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <div id=\"container\">\n        ", "\n        ", "\n\n        <div id=\"center\">\n          <a tabindex=\"-1\" href=\"", "\">\n            <paper-button class=\"title\" noink>\n              <div id=\"label\">", "</div>\n              <div class=\"title\">", "</div>\n            </paper-button>\n          </a>\n        </div>\n        <div id=\"right\">\n          <iron-icon\n            id=\"toggle\"\n            icon=\"", "\"\n            aria-role=\"button\"\n            aria-label=\"", "\"\n            tabindex=\"0\"\n          ></iron-icon>\n        </div>\n      </div>\n    "]);

    _templateObject_291117900ca311eaa0151532aa92855f = function _templateObject_291117900ca311eaa0151532aa92855f() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(MapMenuHeader, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_291117900ca311eaa0151532aa92855f(), this.avatarLabel ? (0, _litElement.html)(_templateObject2_291117900ca311eaa0151532aa92855f(), this.avatarLabel) : (0, _litElement.html)(_templateObject3_291117900ca311eaa0151532aa92855f()), this.icon ? (0, _litElement.html)(_templateObject4_291117900ca311eaa0151532aa92855f(), this.icon) : (0, _litElement.html)(_templateObject5_291117900ca311eaa0151532aa92855f()), this.url, this.label, this.title, this.__collapseIcon, this.__collapseAria);
      }
    }], [{
      key: "styles",
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject6_291117900ca311eaa0151532aa92855f())];
      }
    }, {
      key: "tag",
      get: function get() {
