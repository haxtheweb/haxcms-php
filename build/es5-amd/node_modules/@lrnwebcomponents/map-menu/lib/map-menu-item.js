define(["exports", "../../../lit-element/lit-element.js", "../../../@polymer/iron-icons/iron-icons.js", "../../../@polymer/iron-icon/iron-icon.js", "../../../@polymer/paper-button/paper-button.js"], function (_exports, _litElement, _ironIcons, _ironIcon, _paperButton) {
  ...
  function _templateObject4_92f6bd90380411eaa561b792cdf1a8cd() {
    ...
    _templateObject4_92f6bd90380411eaa561b792cdf1a8cd = function _templateObject4_92f6bd90380411eaa561b792cdf1a8cd() {
      return data;
    };
  ...
  function _templateObject3_92f6bd90380411eaa561b792cdf1a8cd() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                <iron-icon id=\"track\" icon=\"", "\"></iron-icon>\n              "]);

    _templateObject3_92f6bd90380411eaa561b792cdf1a8cd = function _templateObject3_92f6bd90380411eaa561b792cdf1a8cd() {
      return data;
    };
  ...
  function _templateObject2_92f6bd90380411eaa561b792cdf1a8cd() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                <iron-icon icon=\"", "\"></iron-icon>\n              "]);

    _templateObject2_92f6bd90380411eaa561b792cdf1a8cd = function _templateObject2_92f6bd90380411eaa561b792cdf1a8cd() {
      return data;
    };
  ...
  function _templateObject_92f6bd90380411eaa561b792cdf1a8cd() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <a tabindex=\"-1\" href=\"", "\">\n        <paper-button id=\"wrapper\" role=\"link\" noink>\n          ", "\n          <span class=\"title\">", "</span>\n          ", "\n        </paper-button>\n      </a>\n    "]);

    _templateObject_92f6bd90380411eaa561b792cdf1a8cd = function _templateObject_92f6bd90380411eaa561b792cdf1a8cd() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(MapMenuItem, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_92f6bd90380411eaa561b792cdf1a8cd(), this.url, this.icon ? (0, _litElement.html)(_templateObject2_92f6bd90380411eaa561b792cdf1a8cd(), this.icon) : "", this.title, this.trackIcon ? (0, _litElement.html)(_templateObject3_92f6bd90380411eaa561b792cdf1a8cd(), this.trackIcon) : "");
      }
    }], [{
      key: "styles",
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject4_92f6bd90380411eaa561b792cdf1a8cd())];
      }
    }, {
      key: "tag",
      get: function get() {
