define(["exports", "../../../lit-element/lit-element.js", "../../../@polymer/iron-icons/iron-icons.js", "../../../@polymer/iron-icon/iron-icon.js", "../../../@polymer/paper-button/paper-button.js"], function (_exports, _litElement, _ironIcons, _ironIcon, _paperButton) {
  ...
  function _templateObject4_4ed4b150422011ea848a83200522d0df() {
    ...
    _templateObject4_4ed4b150422011ea848a83200522d0df = function _templateObject4_4ed4b150422011ea848a83200522d0df() {
      return data;
    };
  ...
  function _templateObject3_4ed4b150422011ea848a83200522d0df() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                <iron-icon id=\"track\" icon=\"", "\"></iron-icon>\n              "]);

    _templateObject3_4ed4b150422011ea848a83200522d0df = function _templateObject3_4ed4b150422011ea848a83200522d0df() {
      return data;
    };
  ...
  function _templateObject2_4ed4b150422011ea848a83200522d0df() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                <iron-icon icon=\"", "\"></iron-icon>\n              "]);

    _templateObject2_4ed4b150422011ea848a83200522d0df = function _templateObject2_4ed4b150422011ea848a83200522d0df() {
      return data;
    };
  ...
  function _templateObject_4ed4b150422011ea848a83200522d0df() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <a tabindex=\"-1\" href=\"", "\">\n        <paper-button id=\"wrapper\" role=\"link\" noink>\n          ", "\n          <span class=\"title\">", "</span>\n          ", "\n        </paper-button>\n      </a>\n    "]);

    _templateObject_4ed4b150422011ea848a83200522d0df = function _templateObject_4ed4b150422011ea848a83200522d0df() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(MapMenuItem, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_4ed4b150422011ea848a83200522d0df(), this.url, this.icon ? (0, _litElement.html)(_templateObject2_4ed4b150422011ea848a83200522d0df(), this.icon) : "", this.title, this.trackIcon ? (0, _litElement.html)(_templateObject3_4ed4b150422011ea848a83200522d0df(), this.trackIcon) : "");
      }
    }], [{
      key: "styles",
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject4_4ed4b150422011ea848a83200522d0df())];
      }
    }, {
      key: "tag",
      get: function get() {
