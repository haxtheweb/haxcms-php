define(["exports", "../../../lit-element/lit-element.js", "./map-menu-header.js", "../../a11y-collapse/a11y-collapse.js"], function (_exports, _litElement, _mapMenuHeader, _a11yCollapse) {
  ...
  function _templateObject2_daa9af30247111eb9734a78ef81f0b0d() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <a11y-collapse id=\"container\">\n        <map-menu-header\n          .avatar-label=\"", "\"\n          id=\"", "\"\n          title=\"", "\"\n          label=\"", "\"\n          ?opened=\"", "\"\n          url=\"", "\"\n          selected=\"", "\"\n          icon=\"", "\"\n          slot=\"heading\"\n        ></map-menu-header>\n        <slot></slot>\n      </a11y-collapse>\n    "]);

    _templateObject2_daa9af30247111eb9734a78ef81f0b0d = function _templateObject2_daa9af30247111eb9734a78ef81f0b0d() {
      return data;
    };
  ...
  function _templateObject_daa9af30247111eb9734a78ef81f0b0d() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n        :host([collapsable]) > map-menu-header {\n          cursor: pointer;\n          display: block;\n        }\n        #container {\n          margin-left: 16px;\n        }\n        #container ::slotted(map-menu-item) {\n          margin-top: 0.4em;\n        }\n        a11y-collapse {\n          --a11y-collapse-border: 0;\n          --a11y-collapse-horizontal-padding: 0;\n        }\n      "]);

    _templateObject_daa9af30247111eb9734a78ef81f0b0d = function _templateObject_daa9af30247111eb9734a78ef81f0b0d() {
      return data;
    };
  ...
  var MapMenuSubmenu = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(MapMenuSubmenu, null, [{
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject_daa9af30247111eb9734a78ef81f0b0d())];
      }
    }]);
    ...
    babelHelpers.createClass(MapMenuSubmenu, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_daa9af30247111eb9734a78ef81f0b0d(), this.avatarLabel, this.id, this.title, this.label, this.opened, this.url, this.selected, this.__icon);
      }
    }, {
      key: "updated",
