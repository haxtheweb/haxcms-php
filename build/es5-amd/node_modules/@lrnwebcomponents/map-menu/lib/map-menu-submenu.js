define(["exports", "require", "../../../lit-element/lit-element.js", "./map-menu-item.js", "./map-menu-header.js"], function (_exports, _require, _litElement, _mapMenuItem, _mapMenuHeader) {
  ...
  function _templateObject2_79f3bce00e0a11ea9e97f7953ea5688f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <map-menu-header\n        .avatar-label=\"", "\"\n        id=\"", "\"\n        title=\"", "\"\n        label=\"", "\"\n        ?opened=\"", "\"\n        url=\"", "\"\n        icon=\"", "\"\n        selected=\"", "\"\n      ></map-menu-header>\n      <iron-collapse id=\"container\"> <slot></slot> </iron-collapse>\n    "]);

    _templateObject2_79f3bce00e0a11ea9e97f7953ea5688f = function _templateObject2_79f3bce00e0a11ea9e97f7953ea5688f() {
      return data;
    };
  ...
  function _templateObject_79f3bce00e0a11ea9e97f7953ea5688f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n        :host([collapsable]) > map-menu-header {\n          cursor: pointer;\n          display: block;\n        }\n        #container {\n          margin-left: 16px;\n        }\n        #container ::slotted(map-menu-item) {\n          margin-top: 0.4em;\n        }\n      "]);

    _templateObject_79f3bce00e0a11ea9e97f7953ea5688f = function _templateObject_79f3bce00e0a11ea9e97f7953ea5688f() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(MapMenuSubmenu, null, [{
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject_79f3bce00e0a11ea9e97f7953ea5688f())];
      }
    }]);
    ...
    babelHelpers.createClass(MapMenuSubmenu, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_79f3bce00e0a11ea9e97f7953ea5688f(), this.avatarLabel, this.id, this.title, this.label, this.opened, this.url, this.icon, this.selected);
      }
    }, {
      key: "firstUpdated",
