define(["exports", "../../lit/index.js", "./lib/map-menu-builder.js", "./lib/map-menu-container.js", "../utils/utils.js"], function (_exports, _index, _mapMenuBuilder, _mapMenuContainer, _utils) {
  ...
  var _templateObject_32aaafd0e8f211edb01b473406559cea, _templateObject2_32aaafd0e8f211edb01b473406559cea;
  ...
  var MapMenu = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(MapMenu, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_32aaafd0e8f211edb01b473406559cea || (_templateObject_32aaafd0e8f211edb01b473406559cea = babelHelpers.taggedTemplateLiteral(["\n      <div id=\"itemslist\">\n        <map-menu-container>\n          <div id=\"activeindicator\"></div>\n          <map-menu-builder\n            id=\"builder\"\n            .items=\"", "\"\n            .selected=\"", "\"\n          ></map-menu-builder>\n        </map-menu-container>\n      </div>\n    "])), this.items, this.selected);
      }
    }, {
      key: "updated",
      value:
      ...
      value: function __scrollHandler(target, options) {
        ...
        var scrollElementPosition = _options.scrollElement.getBoundingClientRect();
        // get the height of the scroll Element
        var scrollElementHeight = _options.scrollElement.getBoundingClientRect().bottom - _options.scrollElement.getBoundingClientRect().top;
        // get the height of the element target
        var targetHeight = targetPosition.bottom - targetPosition.top;
        // get the offset of the scroll Element
        var startPosition = _options.scrollElement.scrollTop;
      ...
      value: function __updateActiveIndicator(element) {
        ...
        setTimeout(function () {
          ...
          activeindicator.setAttribute("style", "height:".concat(height, "px;top:").concat(top, "px;"));
        }, 200);
      }
      /**
