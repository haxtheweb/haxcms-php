  ...
  return function (a) {
    ...
    var i = function () {
      ...
      return n(r, null, [{
        ...
        key: "updateCanvases",
        value: function value() {
          for (var e, t, a = this, r = Math.round(this.drawer.wrapper.scrollWidth), n = Math.ceil(r / this.maxCanvasElementWidth); this.canvases.length < n;) void 0, e = a.wrapper.appendChild(document.createElement("canvas")), a.canvases.push(e), a.util.style(e, {
            position: "absolute",
            zIndex: 4
          });
          for (; this.canvases.length > n;) t = void 0, (t = a.canvases.pop()).parentElement.removeChild(t);
        }
      }, {
        ...
        value: function value() {
          ...
          if (!(e <= 0)) {
            var t,
              ...
              m = 0,
              y = [];
            for (t = 0; t < i / p; t++) y.push([t, m, v]), m += p, v += c * p;
            var w = function w(t) {
