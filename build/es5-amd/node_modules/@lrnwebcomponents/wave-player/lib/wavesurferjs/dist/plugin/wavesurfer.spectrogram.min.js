  ...
  return function (r) {
    ...
    return i.m = r, i.c = a, i.d = function (e, t, r) {
      ...
      if (i.r(r), Object.defineProperty(r, "default", {
        enumerable: !0,
        value: t
      }), 2 & e && "string" != typeof t) for (var a in t) i.d(r, a, function (e) {
        return t[e];
      }.bind(null, a));
      return r;
    }, i.n = function (e) {
    ...
    3: function _(e, t, r) {
      ...
      var v = function v(e, t, r, a) {
          switch (this.bufferSize = e, this.sampleRate = t, this.bandwidth = 2 / e * (t / 2), this.sinTable = new Float32Array(e), this.cosTable = new Float32Array(e), this.windowValues = new Float32Array(e), this.reverseTable = new Uint32Array(e), this.peakBand = 0, this.peak = 0, r) {
            case "bartlett":
              for (var i = 0; i < e; i++) this.windowValues[i] = 2 / (e - 1) * ((e - 1) / 2 - Math.abs(i - (e - 1) / 2));
              break;
            case "bartlettHann":
            ...
            case "blackman":
              a = a || .16;
              for (i = 0; i < e; i++) this.windowValues[i] = (1 - a) / 2 - .5 * Math.cos(2 * Math.PI * i / (e - 1)) + a / 2 * Math.cos(4 * Math.PI * i / (e - 1));
              break;
            case "cosine":
            ...
            case "gauss":
              a = a || .25;
              for (i = 0; i < e; i++) this.windowValues[i] = Math.pow(Math.E, -.5 * Math.pow((i - (e - 1) / 2) / (a * (e - 1) / 2), 2));
              break;
            case "hamming":
          ...
          this.calculateSpectrum = function (e) {
            ...
            for (var d, v, w, b, y, m, g, M, S = 1, x = 0; x < i; x++) l[x] = e[o[x]] * this.windowValues[o[x]], h[x] = 0;
            for (; S < i;) {
              d = n[S], v = s[S], w = 1;
              for (var k = b = 0; k < S; k++) {
                for (x = k; x < i;) m = w * l[y = x + S] - b * h[y], g = w * h[y] + b * l[y], l[y] = l[x] - m, h[y] = h[x] - g, l[x] += m, h[x] += g, x += S << 1;
                w = (M = w) * d - b * v, b = M * v + b * d;
              }
              S <<= 1;
            }
            x = 0;
            for (var T = i / 2; x < T; x++) (a = f * u((t = l[x]) * t + (r = h[x]) * r)) > this.peak && (this.peakBand = x, this.peak = a), c[x] = a;
            return c;
          };
        },
        i = function () {
          ...
          return n(i, null, [{
            ...
            value: function value(e, t) {
              ...
              for (r = 0; r < n.length; r++) for (a = 0; a < n[r].length; a++) {
                var o = 255 - n[r][a];
              ...
              if (r) {
                ...
                for (var h = new v(t, n, this.windowFunc, this.alpha), f = (Math.floor(i / (t - o)), 0); f + t < a.length;) {
                  var u = a.slice(f, f + t),
                    ...
                    d = void 0;
                  for (d = 0; d < t / 2; d++) p[d] = Math.max(-255, 45 * Math.log10(c[d]));
                  s.push(p), f += t - o;
                }
                e(s, this);
              ...
              for (t = 0; t < r; t++) {
                ...
                for (o = 0; o < e.length; o++) {
                  var l = o * i,
                    ...
                    p = void 0;
                  if (0 < c) for (p = 0; p < e[0].length; p++) null == s[p] && (s[p] = 0), s[p] += c / n * e[o][p];
                }
