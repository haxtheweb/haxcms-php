define(["exports", "../../lit-element/lit-element.js"], function (_exports, _litElement) {
  ...
  function _templateObject2_bbf0bab02dd211eba8a9dbdc0fc9b6e0() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: inline-block;\n        }\n        .truth {\n          font-size: 5.5vw;\n          word-break: break-all;\n          line-height: 5.5vw;\n          position: absolute;\n          margin: 0 auto;\n          text-align: center;\n          display: flex;\n          visibility: hidden;\n          opacity: 0;\n          transition: 0.3s all linear;\n          z-index: 2;\n          text-align: center;\n        }\n        :host(:focus),\n        :host(:hover) {\n          background-color: grey;\n        }\n        :host(:focus) .content ::slotted(*),\n        :host(:hover) .content ::slotted(*) {\n          visibility: hidden;\n        }\n        :host(:focus) .truth,\n        :host(:hover) .truth {\n          visibility: visible;\n          opacity: 1;\n        }\n      "]);

    _templateObject2_bbf0bab02dd211eba8a9dbdc0fc9b6e0 = function _templateObject2_bbf0bab02dd211eba8a9dbdc0fc9b6e0() {
      return data;
    };
  ...
  function _templateObject_bbf0bab02dd211eba8a9dbdc0fc9b6e0() {
    var data = babelHelpers.taggedTemplateLiteral([" <div class=\"content\">\n      <div class=\"truth\">", "</div>\n      <slot></slot>\n    </div>"]);

    _templateObject_bbf0bab02dd211eba8a9dbdc0fc9b6e0 = function _templateObject_bbf0bab02dd211eba8a9dbdc0fc9b6e0() {
      return data;
    };
  ...
  var TheyLive = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(TheyLive, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_bbf0bab02dd211eba8a9dbdc0fc9b6e0(), this.truth);
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_bbf0bab02dd211eba8a9dbdc0fc9b6e0())];
      } // life cycle
