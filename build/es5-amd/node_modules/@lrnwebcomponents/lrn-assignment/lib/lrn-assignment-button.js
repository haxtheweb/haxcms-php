define(["exports", "../../../lit/index.js", "../../simple-icon/lib/simple-icon-lite.js", "../../simple-icon/lib/simple-icons.js", "../../simple-icon/lib/simple-icon-button-lite.js", "../../hax-iconset/lib/simple-hax-iconset.js"], function (_exports, _index, _simpleIconLite, _simpleIcons, _simpleIconButtonLite, _simpleHaxIconset) {
  ...
  var _templateObject_2a049200edcb11edb3e3ed4f0d506a4b, _templateObject2_2a049200edcb11edb3e3ed4f0d506a4b, _templateObject3_2a049200edcb11edb3e3ed4f0d506a4b, _templateObject4_2a049200edcb11edb3e3ed4f0d506a4b;
  ...
  var LrnAssignmentButton = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(LrnAssignmentButton, [{
       ...
       */
      function render() {
        return (0, _index.html)(_templateObject_2a049200edcb11edb3e3ed4f0d506a4b || (_templateObject_2a049200edcb11edb3e3ed4f0d506a4b = babelHelpers.taggedTemplateLiteral(["\n      <a href=\"", "\">\n        ", "\n        ", "\n      </a>\n    "])), this.url, this.open ? (0, _index.html)(_templateObject2_2a049200edcb11edb3e3ed4f0d506a4b || (_templateObject2_2a049200edcb11edb3e3ed4f0d506a4b = babelHelpers.taggedTemplateLiteral(["\n              <button raised open>\n                ", "\n                <simple-icon-lite icon=\"lrn-icons:input\"></simple-icon-lite>\n              </button>\n            "])), this.title) : "", this.complete ? (0, _index.html)(_templateObject3_2a049200edcb11edb3e3ed4f0d506a4b || (_templateObject3_2a049200edcb11edb3e3ed4f0d506a4b = babelHelpers.taggedTemplateLiteral(["\n              <button raised complete>\n                ", "\n                <simple-icon-lite icon=\"lrn-icons:done\"></simple-icon-lite>\n              </button>\n            "])), this.title) : "");
      }
    }], [{
      key: "styles",
      get:
       ...
       */
      function get() {
        return [(0, _index.css)(_templateObject4_2a049200edcb11edb3e3ed4f0d506a4b || (_templateObject4_2a049200edcb11edb3e3ed4f0d506a4b = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n        a {\n          color: inherit;\n          text-decoration: inherit;\n        }\n        button {\n          background: #b0e6f9;\n        }\n        button[complete] {\n          background: #e7ffe7;\n        }\n        simple-icon-lite {\n          margin-left: 8px;\n          opacity: 0.8;\n        }\n      "])))];
      }
    }, {
      key: "tag",
      get: function get() {
