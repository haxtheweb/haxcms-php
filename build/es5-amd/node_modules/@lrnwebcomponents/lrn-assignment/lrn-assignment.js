define(["exports","../../@polymer/polymer/polymer-element.js","../../@polymer/paper-card/paper-card.js","../../@polymer/paper-button/paper-button.js","../../@polymer/polymer/lib/elements/dom-repeat.js","../../@polymer/polymer/lib/elements/dom-if.js"],function(_exports,_polymerElement,_paperCard,_paperButton,_domRepeat,_domIf){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.LrnAssignments=_exports.LrnAssignment=void 0;function _templateObject2_ff8a8be07b2f11e98c6b670a1e6dbfb1(){var data=babelHelpers.taggedTemplateLiteral(["\n      <style>\n        :host {\n          display: flex;\n          flex-wrap: wrap;\n        }\n        :host lrn-assignment {\n          margin: 16px;\n        }\n        :host([layout=\"wide\"]) lrn-assignment {\n          width: calc(100% - 32px);\n        }\n        :host([layout=\"medium\"]) lrn-assignment {\n          width: calc(50% - 32px);\n        }\n        :host([layout=\"tight\"]) lrn-assignment {\n          width: calc(25% - 32px);\n        }\n      </style>\n      <template is=\"dom-repeat\" items=\"[[assignments]]\">\n        <lrn-assignment\n          title=\"[[item.title]]\"\n          actions=\"[[item.actions]]\"\n        ></lrn-assignment>\n      </template>\n\n      <template is=\"dom-if\" if=\"[[url]]\">\n        <iron-ajax\n          auto=\"\"\n          url=\"[[url]]\"\n          handle-as=\"json\"\n          on-response=\"handleResponse\"\n        ></iron-ajax>\n      </template>\n    "]);_templateObject2_ff8a8be07b2f11e98c6b670a1e6dbfb1=function _templateObject2_ff8a8be07b2f11e98c6b670a1e6dbfb1(){return data};return data}function _templateObject_ff8a8be07b2f11e98c6b670a1e6dbfb1(){var data=babelHelpers.taggedTemplateLiteral(["\n      <style>\n        :host {\n          display: flex;\n          width: 100%;\n        }\n        paper-card {\n          width: 100%;\n        }\n      </style>\n      <paper-card\n        heading=\"[[title]]\"\n        image=\"[[image]]\"\n        elevation=\"1\"\n        animated-shadow=\"false\"\n      >\n        <div class=\"card-content\">[[details]] <slot></slot></div>\n        <div class=\"card-actions\">\n          <template is=\"dom-repeat\" items=\"[[actions]]\">\n            <a href$=\"[[item.url]]\"\n              ><paper-button raised>[[item.label]]</paper-button></a\n            >\n          </template>\n        </div>\n      </paper-card>\n    "]);_templateObject_ff8a8be07b2f11e98c6b670a1e6dbfb1=function _templateObject_ff8a8be07b2f11e98c6b670a1e6dbfb1(){return data};return data}/**
`lrn-assignment`

* @demo demo/index.html
*/var LrnAssignment=/*#__PURE__*/function(_PolymerElement){babelHelpers.inherits(LrnAssignment,_PolymerElement);function LrnAssignment(){babelHelpers.classCallCheck(this,LrnAssignment);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(LrnAssignment).apply(this,arguments))}babelHelpers.createClass(LrnAssignment,null,[{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_ff8a8be07b2f11e98c6b670a1e6dbfb1())}},{key:"tag",get:function get(){return"lrn-assignment"}},{key:"properties",get:function get(){return{/**
       * Title
       */title:{type:String},/**
       * Image url
       */image:{type:String},/**
