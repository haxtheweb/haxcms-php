...
if(0===this.selectedView){async.microTask.run(function(){setTimeout(function(){_this.$.ironlist.fire("iron-resize");window.dispatchEvent(new Event("resize"))},50)})}}}/**
...
get:function get(){return(0,_polymerElement.html)(_templateObject_48bbc56062ec11e9ba56c1f762879bb4())}// properties available to the custom element for data binding
