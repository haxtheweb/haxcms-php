define(["exports", "meta", "../../lit/index.js", "../i18n-manager/lib/I18NMixin.js", "../../lit/directives/unsafe-html.js", "../hax-body/lib/hax-store.js", "../haxcms-elements/lib/core/haxcms-site-store.js", "../../mobx/dist/mobx.esm.js", "../json-outline-schema/lib/json-outline-schema-item.js", "../json-outline-schema/json-outline-schema.js", "../simple-popover/simple-popover.js", "../simple-icon/lib/simple-icon-lite.js", "../hax-iconset/lib/simple-hax-iconset.js", "../simple-icon/lib/simple-icon-button.js", "../simple-fields/lib/simple-fields-field.js", "../utils/utils.js"], function (_exports, meta, _index, _I18NMixin2, _unsafeHtml, _haxStore, _haxcmsSiteStore, _mobxEsm, _jsonOutlineSchemaItem, _jsonOutlineSchema, _simplePopover, _simpleIconLite, _simpleHaxIconset, _simpleIconButton, _simpleFieldsField, _utils) {
  ...
  var _templateObject_c3e32d10a7e811ed8d60b559aaaec7a9, _templateObject2_c3e32d10a7e811ed8d60b559aaaec7a9, _templateObject3_c3e32d10a7e811ed8d60b559aaaec7a9, _templateObject4_c3e32d10a7e811ed8d60b559aaaec7a9, _templateObject5_c3e32d10a7e811ed8d60b559aaaec7a9, _templateObject6_c3e32d10a7e811ed8d60b559aaaec7a9, _templateObject7_c3e32d10a7e811ed8d60b559aaaec7a9, _templateObject8_c3e32d10a7e811ed8d60b559aaaec7a9, _templateObject9_c3e32d10a7e811ed8d60b559aaaec7a9, _templateObject10_c3e32d10a7e811ed8d60b559aaaec7a9, _templateObject11_c3e32d10a7e811ed8d60b559aaaec7a9, _templateObject12_c3e32d10a7e811ed8d60b559aaaec7a9, _templateObject13_c3e32d10a7e811ed8d60b559aaaec7a9;
  ...
  var OutlineDesigner = /*#__PURE__*/function (_I18NMixin) {
    ...
    babelHelpers.createClass(OutlineDesigner, [{
      ...
      value: function render() {
        var _this2 = this;
        return (0, _index.html)(_templateObject_c3e32d10a7e811ed8d60b559aaaec7a9 || (_templateObject_c3e32d10a7e811ed8d60b559aaaec7a9 = babelHelpers.taggedTemplateLiteral([" <div class=\"controls\">\n        ", "\n        <simple-icon-button-lite\n          class=\"control\"\n          icon=\"add\"\n          @click=\"", "\"\n          >Add page</simple-icon-button-lite\n        >\n        <simple-icon-button-lite\n          icon=\"hardware:keyboard-arrow-right\"\n          @click=\"", "\"\n          class=\"control\"\n          >Collapse all</simple-icon-button-lite\n        >\n        <simple-icon-button-lite\n          icon=\"hardware:keyboard-arrow-down\"\n          @click=\"", "\"\n          class=\"control\"\n          >Expand all</simple-icon-button-lite\n        >\n        ", "\n      </div>\n      <ul id=\"list\">\n        ", "\n      </ul>\n      <simple-popover auto for=\"list\" hidden>\n        <simple-icon-button\n          @click=\"", "\"\n          title=\"Close\"\n          icon=\"cancel\"\n          class=\"close-btn\"\n        ></simple-icon-button>\n        ", "\n      </simple-popover>"])), this.storeTools ? (0, _index.html)(_templateObject2_c3e32d10a7e811ed8d60b559aaaec7a9 || (_templateObject2_c3e32d10a7e811ed8d60b559aaaec7a9 = babelHelpers.taggedTemplateLiteral(["\n              <label for=\"targetselector\">", "</label>\n              <simple-fields-field\n                id=\"targetselector\"\n                type=\"select\"\n                value=\"children\"\n                .itemsList=\"", "\"\n              ></simple-fields-field>\n              ", ":\n              <simple-fields-field\n                id=\"itemselector\"\n                type=\"select\"\n                value=\"", "\"\n                .itemsList=\"", "\"\n              ></simple-fields-field>\n              <label for=\"itemselector\"\n                >", "</label\n              >\n            "])), this.t.importThisContent, [{
          text: "as children of",
          value: "children"
        }, {
          text: "Above",
          ...
          text: "Below",
          value: "below"
        }], this.t.thisPage, this.activeId, this.getSiteItems(), this.t.importContentUnderThisPage) : "", this.addItemToTop, this.collapseAll, this.expandAll, this.hasDeletedItems() ? (0, _index.html)(_templateObject3_c3e32d10a7e811ed8d60b559aaaec7a9 || (_templateObject3_c3e32d10a7e811ed8d60b559aaaec7a9 = babelHelpers.taggedTemplateLiteral(["<simple-icon-button-lite\n              icon=\"delete\"\n              @click=\"", "\"\n              class=\"control\"\n              >", "</simple-icon-button-lite\n            >"])), this.toggleDelete, !this.hideDelete ? "Hide Deleted" : "Show Deleted") : "", this.items.map(function (item, index) {
          ...
          if (item.contents) {
            ...
            for (var i = 0; i < div.childNodes.length; i++) {
              ...
              if (i === targetNodeIndex) {
                ...
                return (0, _index.html)(_templateObject4_c3e32d10a7e811ed8d60b559aaaec7a9 || (_templateObject4_c3e32d10a7e811ed8d60b559aaaec7a9 = babelHelpers.taggedTemplateLiteral(["", ""])), (0, _unsafeHtml.unsafeHTML)((0, _utils.encapScript)(node.outerHTML)));
              }
            }
          }
        }
      ...
      value: function itemContentsOperations(item) {
        var _this5 = this;
        return (0, _index.html)(_templateObject8_c3e32d10a7e811ed8d60b559aaaec7a9 || (_templateObject8_c3e32d10a7e811ed8d60b559aaaec7a9 = babelHelpers.taggedTemplateLiteral([" <li\n      class=\"item content-adding-operations indent-", "\"\n      data-item-for-content-id=\"", "\"\n      ?data-contents-collapsed=\"", "\"\n      ?data-about-to-delete=\"", "\"\n      ?hidden=\"", "\"\n    >\n      ", "\n    </li>"])), item.indent < 20 ? item.indent : 20, item.id, !item.showContent, item.delete, this.hideDelete && item.delete, this.haxGizmos.map(function (gizmo) {
          return (0, _index.html)(_templateObject9_c3e32d10a7e811ed8d60b559aaaec7a9 || (_templateObject9_c3e32d10a7e811ed8d60b559aaaec7a9 = babelHelpers.taggedTemplateLiteral(["\n          <simple-icon-button-lite\n            class=\"operation\"\n            icon=\"", "\"\n            value=\"", "\"\n            @click=\"", "\"\n            >Add ", "</simple-icon-button-lite\n          >\n        "])), gizmo.icon, gizmo.tag, _this5.prependNodeToContent, gizmo.title);
        }));
      }
      ...
      value: function renderNodeAsItem(node, index, item, indent) {
        ...
        return (0, _index.html)(_templateObject10_c3e32d10a7e811ed8d60b559aaaec7a9 || (_templateObject10_c3e32d10a7e811ed8d60b559aaaec7a9 = babelHelpers.taggedTemplateLiteral([" <li\n      class=\"item content-child content-", " indent-", "\"\n      data-node-index=\"", "\"\n      data-content-parent-id=\"", "\"\n      ?data-contents-collapsed=\"", "\"\n      ?data-about-to-delete=\"", "\"\n      ?hidden=\"", "\"\n    >\n      <simple-icon-button-lite\n        icon=\"", "\"\n        title=\"Click to preview\"\n        @click=\"", "\"\n      ></simple-icon-button-lite>\n      ", "\n      <div class=\"content-operations\">\n        <simple-icon-button\n          class=\"content-operation\"\n          icon=\"hax:outline-designer-outdent\"\n          @click=\"", "\"\n          title=\"Increase heading\"\n          ?disabled=\"", "\"\n          ?hidden=\"", "\"\n        ></simple-icon-button>\n        <simple-icon-button\n          icon=\"hax:keyboard-arrow-up\"\n          @click=\"", "\"\n          title=\"Move up\"\n          ?disabled=\"", "\"\n          class=\"content-operation\"\n        ></simple-icon-button>\n        <simple-icon-button\n          icon=\"hax:keyboard-arrow-down\"\n          @click=\"", "\"\n          title=\"Move down\"\n          ?disabled=\"", "\"\n          class=\"content-operation\"\n        ></simple-icon-button>\n        <simple-icon-button\n          class=\"content-operation\"\n          icon=\"hax:outline-designer-indent\"\n          @click=\"", "\"\n          title=\"Decrease Heading\"\n          ?disabled=\"", "\"\n          ?hidden=\"", "\"\n        ></simple-icon-button>\n        <simple-icon-button\n          class=\"content-operation\"\n          icon=\"editor:format-page-break\"\n          @click=\"", "\"\n          title=\"Promote to page\"\n          ?disabled=\"", "\"\n          ?hidden=\"", "\"\n        ></simple-icon-button>\n        <simple-icon-button\n          icon=\"delete\"\n          @click=\"", "\"\n          class=\"content-operation del\"\n          title=\"Delete\"\n          ?disabled=\"", "\"\n          accent-color=\"red\"\n        ></simple-icon-button>\n      </div>\n    </li>"])), part, indent < 20 ? indent : 20, index, item.id, !item.showContent, item.delete, this.hideDelete && item.delete, icon, this.setActivePreview, part === "heading" ? (0, _index.html)(_templateObject11_c3e32d10a7e811ed8d60b559aaaec7a9 || (_templateObject11_c3e32d10a7e811ed8d60b559aaaec7a9 = babelHelpers.taggedTemplateLiteral(["\n            <span\n              class=\"label shown\"\n              ?disabled=\"", "\"\n              @dblclick=\"", "\"\n              >", "</span\n            >\n            <span\n              class=\"label-edit\"\n              @keypress=\"", "\"\n              @keydown=\"", "\"\n            ></span>\n          "])), item.metadata.locked, this.editTitle, label, this.monitorHeading, this.monitorEsc) : (0, _index.html)(_templateObject12_c3e32d10a7e811ed8d60b559aaaec7a9 || (_templateObject12_c3e32d10a7e811ed8d60b559aaaec7a9 = babelHelpers.taggedTemplateLiteral(["<span class=\"label shown\">", "</span>"])), label), function (e) {
