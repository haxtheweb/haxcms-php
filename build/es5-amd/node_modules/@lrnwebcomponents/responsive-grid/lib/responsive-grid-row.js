...
*/var ResponsiveGridRow=(0,_polymerLegacy.Polymer)({_template:(0,_polymerLegacy.html)(_templateObject_cc98a5e06b8111e98ce155804ade6153()),is:"responsive-grid-row",properties:{/**
     ...
     */screen:{type:String,value:"xs",notify:!0,reflectToAttribute:!0}},attached:function attached(){var root=this;window.ResponsiveUtility.requestAvailability();root.fire("responsive-element",{element:root,attribute:"screen",relativeToParent:root.responsiveToParent})}});_exports.ResponsiveGridRow=ResponsiveGridRow});