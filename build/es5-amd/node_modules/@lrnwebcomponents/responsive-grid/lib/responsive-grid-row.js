...
*/var ResponsiveGridRow=/*#__PURE__*/function(_PolymerElement){babelHelpers.inherits(ResponsiveGridRow,_PolymerElement);function ResponsiveGridRow(){babelHelpers.classCallCheck(this,ResponsiveGridRow);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(ResponsiveGridRow).apply(this,arguments))}babelHelpers.createClass(ResponsiveGridRow,[{key:"connectedCallback",value:function connectedCallback(){babelHelpers.get(babelHelpers.getPrototypeOf(ResponsiveGridRow.prototype),"connectedCallback",this).call(this);window.ResponsiveUtility.requestAvailability();this.dispatchEvent(new CustomEvent("responsive-element",{bubbles:!0,cancelable:!0,composed:!0,detail:{element:root,attribute:"screen",relativeToParent:root.responsiveToParent}}))}}],[{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_7e695f106daf11e98b2b231443c29fcf())}},{key:"tag",get:function get(){return"responsive-grid-row"}},{key:"properties",get:function get(){return{/**
