  ...
  var AbsolutePositionStateManager = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(AbsolutePositionStateManager, [{
      ...
      value: function removeEventListeners() {
        ...
        if (this.__watchSticky) this.scrollTarget.removeEventListener("scroll", this._handleScroll);
      }
        ...
        var w = document.body.getBoundingClientRect(),
          ...
          getCoord = function getCoord() {
            ...
            var coord,
              ...
              ew = !el.allowOverlap && window.getComputedStyle(el, null).overflowX == "visible" ? Math.max(e.width, el.scrollWidth) : e.width;
