define(["exports", "../../lit-element/lit-element.js", "./lib/absolute-position-state-manager.js"], function (_exports, _litElement, _absolutePositionStateManager) {
  ...
  function _templateObject2_3859f770332811ea9673c9ed9148a8db() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: inline-block;\n        }\n\n        :host([hidden]) {\n          display: none;\n        }\n      "]);

    _templateObject2_3859f770332811ea9673c9ed9148a8db = function _templateObject2_3859f770332811ea9673c9ed9148a8db() {
      return data;
    };
  ...
  function _templateObject_3859f770332811ea9673c9ed9148a8db() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <slot></slot>\n    "]);

    _templateObject_3859f770332811ea9673c9ed9148a8db = function _templateObject_3859f770332811ea9673c9ed9148a8db() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(AbsolutePositionBehavior, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_3859f770332811ea9673c9ed9148a8db());
      ...
      //styles function
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_3859f770332811ea9673c9ed9148a8db())];
      }
    }, {
      key: "properties",
      get: function get() {
