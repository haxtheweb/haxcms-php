define(["exports", "require", "../../lit-element/lit-element.js", "../schema-behaviors/schema-behaviors.js"], function (_exports, _require, _litElement, _schemaBehaviors) {
  ...
  var _templateObject_6db58d90af6311ebbe560fe9c4727db1, _templateObject2_6db58d90af6311ebbe560fe9c4727db1;
  ...
  var LrndesignAbbreviation = /*#__PURE__*/function (_SchemaBehaviors) {
    ...
    babelHelpers.createClass(LrndesignAbbreviation, [{
       ...
       */
      function render() {
        return (0, _litElement.html)(_templateObject_6db58d90af6311ebbe560fe9c4727db1 || (_templateObject_6db58d90af6311ebbe560fe9c4727db1 = babelHelpers.taggedTemplateLiteral(["\n      <abbr tabindex=\"0\" title=\"", "\" id=\"abbr\">", "</abbr>\n      <simple-tooltip for=\"abbr\" position=\"top\" offset=\"2\" animation-delay=\"300\"\n        >", "</simple-tooltip\n      >\n    "])), this.phrase, this.abbr, this.phrase);
      }
    }], [{
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_6db58d90af6311ebbe560fe9c4727db1 || (_templateObject2_6db58d90af6311ebbe560fe9c4727db1 = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: inline-block;\n        }\n        abbr {\n          transition: 0.6s all ease;\n          padding: 2px 4px;\n          font-style: italic;\n          background-color: var(--abbreviation-bg, #f9f9f9);\n          text-underline-position: under;\n          text-decoration: underline double;\n          cursor: help;\n          outline: var(--abbreviation-selection, #ffff33);\n        }\n        abbr:focus,\n        abbr:active,\n        abbr:hover {\n          text-decoration: none;\n          background-color: var(--abbreviation-selection, #ffff33);\n        }\n        abbr::-moz-selection,\n        abbr::selection {\n          text-decoration: none;\n          background-color: var(--abbreviation-selection, #ffff33);\n        }\n        simple-tooltip {\n          --simple-tooltip-background: #000000;\n          --simple-tooltip-opacity: 1;\n          --simple-tooltip-text-color: #ffffff;\n          --simple-tooltip-delay-in: 0;\n        }\n      "])))];
      }
    }, {
      key: "tag",
      get: function get() {
