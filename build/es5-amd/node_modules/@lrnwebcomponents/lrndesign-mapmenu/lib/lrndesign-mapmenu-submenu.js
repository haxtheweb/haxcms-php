define(["exports", "../../../lit-element/lit-element.js", "../../../@polymer/polymer/lib/utils/flattened-nodes-observer.js", "../../a11y-collapse/a11y-collapse.js", "./lrndesign-mapmenu-item.js", "./lrndesign-mapmenu-header.js"], function (_exports, _litElement, _flattenedNodesObserver, _a11yCollapse, _lrndesignMapmenuItem, _lrndesignMapmenuHeader) {
  ...
  function _templateObject2_6948dc103efe11eb800233a440abe59f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n        :host([collapsable]) > lrndesign-mapmenu-header {\n          cursor: pointer;\n          display: block;\n        }\n        #container {\n          padding: 16px;\n        }\n        #container ::slotted(lrndesign-mapmenu-item) {\n          margin-top: 6.4px;\n        }\n        a11y-collapse {\n          border: 0;\n        }\n      "]);

    _templateObject2_6948dc103efe11eb800233a440abe59f = function _templateObject2_6948dc103efe11eb800233a440abe59f() {
      return data;
    };
  ...
  function _templateObject_6948dc103efe11eb800233a440abe59f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <a11y-collapse id=\"container\">\n        <lrndesign-mapmenu-header\n          avatar-label=\"", "\"\n          title=\"", "\"\n          label=\"", "\"\n          slot=\"heading\"\n        ></lrndesign-mapmenu-header>\n        <slot></slot>\n      </a11y-collapse>\n    "]);

    _templateObject_6948dc103efe11eb800233a440abe59f = function _templateObject_6948dc103efe11eb800233a440abe59f() {
      return data;
    };
  ...
  var LrndesignMapmenuSubmenu = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(LrndesignMapmenuSubmenu, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_6948dc103efe11eb800233a440abe59f(), this.avatarLabel, this.title, this.label);
      }
    }, {
      key: "_openChanged",
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_6948dc103efe11eb800233a440abe59f())];
      }
    }, {
      key: "tag",
      get: function get() {
