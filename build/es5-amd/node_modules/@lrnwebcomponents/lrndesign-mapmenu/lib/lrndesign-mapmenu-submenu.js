define(["exports", "../../../lit/index.js", "../../../@polymer/polymer/lib/utils/flattened-nodes-observer.js", "../../a11y-collapse/a11y-collapse.js", "./lrndesign-mapmenu-item.js", "./lrndesign-mapmenu-header.js"], function (_exports, _index, _flattenedNodesObserver, _a11yCollapse, _lrndesignMapmenuItem, _lrndesignMapmenuHeader) {
  ...
  var _templateObject_1fabeca0669311ed886745d23fee48e5, _templateObject2_1fabeca0669311ed886745d23fee48e5;
  ...
  var LrndesignMapmenuSubmenu = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(LrndesignMapmenuSubmenu, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_1fabeca0669311ed886745d23fee48e5 || (_templateObject_1fabeca0669311ed886745d23fee48e5 = babelHelpers.taggedTemplateLiteral(["\n      <a11y-collapse id=\"container\">\n        <lrndesign-mapmenu-header\n          avatar-label=\"", "\"\n          title=\"", "\"\n          label=\"", "\"\n          slot=\"heading\"\n        ></lrndesign-mapmenu-header>\n        <slot></slot>\n      </a11y-collapse>\n    "])), this.avatarLabel, this.title, this.label);
      }
    }, {
      key: "_openChanged",
       ...
       */
      function get() {
        return [(0, _index.css)(_templateObject2_1fabeca0669311ed886745d23fee48e5 || (_templateObject2_1fabeca0669311ed886745d23fee48e5 = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n        :host([collapsable]) > lrndesign-mapmenu-header {\n          cursor: pointer;\n          display: block;\n        }\n        #container {\n          padding: 16px;\n        }\n        #container ::slotted(lrndesign-mapmenu-item) {\n          margin-top: 6.4px;\n        }\n        a11y-collapse {\n          border: 0;\n        }\n      "])))];
      }
    }, {
      key: "tag",
      get: function get() {
