define(["exports", "require", "../../lit/index.js"], function (_exports, _require, _index) {
  ...
  var _templateObject_91eb4c60403311edb9fff3e6b08a0a9a;
  ...
  function createSWC(swc) {
    var MyComponent = /*#__PURE__*/function (_LitElement) {
      ...
      babelHelpers.createClass(SWC, [{
        ...
        key: "styles",
        get: function get() {
          return [(0, _index.css)(_templateObject_91eb4c60403311edb9fff3e6b08a0a9a || (_templateObject_91eb4c60403311edb9fff3e6b08a0a9a = babelHelpers.taggedTemplateLiteral(["\n          /* this style helps ease FOUC w/ dynamic imports */\n          :host *:not(:defined) {\n            display: none;\n          }\n        "]))), swc.css(this, _index.css)];
        }
        /**
