define(["exports", "require", "../../lit/index.js"], function (_exports, _require, _index) {
  ...
  var _templateObject_e74fe740e4f411ed85766367b4d3e9fc;
  ...
  function createSWC(swc) {
    var MyComponent = /*#__PURE__*/function (_LitElement) {
      ...
      babelHelpers.createClass(SWC, [{
        ...
        key: "styles",
        get: function get() {
          return [(0, _index.css)(_templateObject_e74fe740e4f411ed85766367b4d3e9fc || (_templateObject_e74fe740e4f411ed85766367b4d3e9fc = babelHelpers.taggedTemplateLiteral(["\n          /* this style helps ease FOUC w/ dynamic imports */\n          :host *:not(:defined) {\n            display: none;\n          }\n        "]))), swc.css(this, _index.css)];
        }
        /**
