define(["exports", "../../lit/index.js", "../simple-colors/simple-colors.js", "../simple-progress/simple-progress.js", "../simple-fields/lib/simple-fields-field.js"], function (_exports, _index, _simpleColors, _simpleProgress, _simpleFieldsField) {
  ...
  var _templateObject_34f00bf0e8f211edb01b473406559cea, _templateObject2_34f00bf0e8f211edb01b473406559cea, _templateObject3_34f00bf0e8f211edb01b473406559cea, _templateObject4_34f00bf0e8f211edb01b473406559cea;
  ...
  var SimpleLogin = /*#__PURE__*/function (_SimpleColors) {
    ...
    babelHelpers.createClass(SimpleLogin, [{
      ...
      // render function
      function render() {
        return (0, _index.html)(_templateObject_34f00bf0e8f211edb01b473406559cea || (_templateObject_34f00bf0e8f211edb01b473406559cea = babelHelpers.taggedTemplateLiteral([" <div id=\"loginform\">\n      <simple-progress ?disabled=\"", "\"></simple-progress>\n      <div id=\"loginformcontent\">\n        ", "\n        ", "\n        <div id=\"errormsg\">", "</div>\n        <slot></slot>\n        <simple-fields-field\n          id=\"userinput\"\n          value=\"", "\"\n          @value-changed=\"", "\"\n          type=\"text\"\n          ?disabled=\"", "\"\n          label=\"", "\"\n          required\n          error-message=\"", "\"\n        ></simple-fields-field>\n        <simple-fields-field\n          id=\"passinput\"\n          required\n          value=\"", "\"\n          @value-changed=\"", "\"\n          ?disabled=\"", "\"\n          type=\"password\"\n          label=\"", "\"\n          error-message=\"", "\"\n        ></simple-fields-field>\n        <button\n          @click=\"", "\"\n          ?disabled=\"", "\"\n          id=\"loginbtn\"\n        >\n          ", "\n        </button>\n        <span id=\"buttons\"><slot name=\"buttons\"></slot></span>\n      </div>\n    </div>"])), !this.loading, this.title ? (0, _index.html)(_templateObject2_34f00bf0e8f211edb01b473406559cea || (_templateObject2_34f00bf0e8f211edb01b473406559cea = babelHelpers.taggedTemplateLiteral(["<h1>", "</h1>"])), this.title) : "", this.subtitle ? (0, _index.html)(_templateObject3_34f00bf0e8f211edb01b473406559cea || (_templateObject3_34f00bf0e8f211edb01b473406559cea = babelHelpers.taggedTemplateLiteral(["<h2>", "</h2>"])), this.subtitle) : "", this.errorMsg, this.username, this._usernameChanged, this.loading, this.userInputLabel, this.userInputErrMsg, this.password, this._passwordChanged, this.loading, this.passwordInputLabel, this.passwordInputErrMsg, this._login, this.loading, this.loginBtnText);
      }
