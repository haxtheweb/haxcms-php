...
function (_HTMLElement) {
  ...
  _createClass(SimpleCameraSnap, [{
    ...
    value: function snapPhoto(e) {
      ...
      return _regeneratorRuntime().async(function snapPhoto$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 4;
              return _regeneratorRuntime().awrap(camera.takeASnap());
            case 4:
              raw = _context.sent;
              _context.next = 7;
              return _regeneratorRuntime().awrap(camera.takeASnap().then(camera.renderImage));
            case 7:
              img = _context.sent;
