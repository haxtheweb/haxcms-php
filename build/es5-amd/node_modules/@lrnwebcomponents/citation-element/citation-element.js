define(["exports", "../../lit/index.js", "../schema-behaviors/schema-behaviors.js", "../license-element/license-element.js", "../utils/utils.js"], function (_exports, _index, _schemaBehaviors, _licenseElement, _utils) {
  ...
  var _templateObject_df0a24609e8b11ed8df835f388f76963, _templateObject2_df0a24609e8b11ed8df835f388f76963, _templateObject3_df0a24609e8b11ed8df835f388f76963;
  ...
  var CitationElement = /*#__PURE__*/function (_SchemaBehaviors) {
    ...
    babelHelpers.createClass(CitationElement, [{
       ...
       */
      function render() {
        return (0, _index.html)(_templateObject_df0a24609e8b11ed8df835f388f76963 || (_templateObject_df0a24609e8b11ed8df835f388f76963 = babelHelpers.taggedTemplateLiteral(["\n      <meta\n        about=\"", "\"\n        property=\"cc:attributionUrl\"\n        content=\"", "\"\n      />\n      <meta\n        about=\"", "\"\n        property=\"cc:attributionName\"\n        typeof=\"oer:Text\"\n        content=\"", "\"\n      />\n      <meta\n        rel=\"cc:license\"\n        href=\"", "\"\n        content=\"License: ", "\"\n      />\n      <cite\n        ><a target=\"_blank\" rel=\"noopener noreferrer\" href=\"", "\"\n          >", "</a\n        >\n        by\n        ", "", ".\n        Accessed <span class=\"citation-date\">", "</span>.</cite\n      >\n    "])), this.relatedResource, this.source, this.relatedResource, this.title, this.licenseLink, this.licenseName, this.source, this.title, this.creator, this.licenseName ? (0, _index.html)(_templateObject2_df0a24609e8b11ed8df835f388f76963 || (_templateObject2_df0a24609e8b11ed8df835f388f76963 = babelHelpers.taggedTemplateLiteral([", licensed under\n              <a\n                class=\"license-link\"\n                rel=\"noopener noreferrer\"\n                target=\"_blank\"\n                href=\"", "\"\n                ><img\n                  loading=\"lazy\"\n                  alt=\"", " graphic\"\n                  src=\"", "\"\n                  ?hidden=\"", "\"\n                  width=\"44px\"\n                  height=\"16px\"\n                />", "</a\n              >"])), this.licenseLink, this.licenseName, this.licenseImage, !this.licenseImage, this.licenseName) : "", this.date);
      }
      /**
       * convention
       */
       ...
       */
      function get() {
        return [(0, _index.css)(_templateObject3_df0a24609e8b11ed8df835f388f76963 || (_templateObject3_df0a24609e8b11ed8df835f388f76963 = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n          color: var(--license-text-color);\n        }\n        :host([display-method=\"footnote\"]) {\n          visibility: hidden;\n          opacity: 0;\n        }\n        :host([display-method=\"popup\"]) {\n          display: block;\n        }\n        .license-link {\n          font-size: 16px;\n          line-height: 16px;\n          font-style: italic;\n        }\n        .citation-date {\n          font-size: 16px;\n          line-height: 16px;\n          font-style: italic;\n        }\n        .license-link img {\n          margin-right: 8px;\n        }\n      "])))];
      }
    }, {
      key: "tag",
      get: function get() {
