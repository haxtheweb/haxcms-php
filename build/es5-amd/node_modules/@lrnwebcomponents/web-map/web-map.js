define(["exports", "../../@polymer/polymer/polymer-element.js", "../../@polymer/polymer/lib/utils/async.js", "./lib/map-layer.js", "./lib/map-area.js", "./lib/map-styles.js"], function (_exports, _polymerElement, async, _mapLayer, _mapArea, _mapStyles) {
  ...
  function _templateObject_72269860100e11ea81b2910778b6127d() {
    ...
    _templateObject_72269860100e11ea81b2910778b6127d = function _templateObject_72269860100e11ea81b2910778b6127d() {
      return data;
    };
  ...
  function (_PolymerElement) {
    ...
    babelHelpers.createClass(WebMap, [{
      ...
      value: function connectedCallback() {
        ...
        async.microTask.run(function () {
          ...
          if (!_this.width || _this.width !== w) {
            _this.shadowRoot.querySelector("#map").style.width = wpx;
            _this.width = w;
          } else {
            _this.shadowRoot.querySelector("#map").style.width = _this.width + "px";
          }

          if (!_this.height || _this.height !== h) {
            _this.shadowRoot.querySelector("#map").style.height = h;
            _this.height = h;
          } else {
            _this.shadowRoot.querySelector("#map").style.height = _this.height + "px";
          } // create the Leaflet map if this is the first time attached is called


          if (!_this._map) {
            _this._map = L.map(_this.shadowRoot.querySelector("#map"), {
      ...
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_72269860100e11ea81b2910778b6127d());
      }
    }, {
      key: "tag",
      get: function get() {
