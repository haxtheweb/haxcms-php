define(["../../../@polymer/polymer/polymer-legacy.js","../../../@polymer/polymer/lib/legacy/polymer.dom.js","./map-styles.js"],function(_polymerLegacy,_polymerDom,_mapStyles){"use strict";function _templateObject_287ff0f0620611e99fc533744445c188(){var data=babelHelpers.taggedTemplateLiteral(["\n    <style include=\"map-styles\">\n      :host {\n        display: none;\n      }\n    </style>\n    <!-- hide any feature, image or tile elements the author includes -->\n    <slot></slot>\n  "]);_templateObject_287ff0f0620611e99fc533744445c188=function _templateObject_287ff0f0620611e99fc533744445c188(){return data};return data}/* styles scoped to inside a custom element must be in a style module */(0,_polymerLegacy.Polymer)({_template:(0,_polymerLegacy.html)(_templateObject_287ff0f0620611e99fc533744445c188()),is:"layer-",properties:{src:{type:String,reflectToAttribute:!0/* transition */ /* transition */,observer:"_srcChanged"},label:{type:String,value:"Layer",reflectToAttribute:!0,observer:"_labelChanged"},// changing checked turns the layer on or off, and reflects that in the
...
// See issue #26
this._layer._map.fire("moveend")},attached:function attached(){if("MAP"!==(0,_polymerDom.dom)(this).parentNode.nodeName){console.log("ERROR: "+this.localName+"#"+this.id+" must be a child of a map element");return}// if the map has been attached, set this layer up wrt Leaflet map
if((0,_polymerDom.dom)(this).parentNode._map){this._attachedToMap()}},_removeEvents:function _removeEvents(){if(this._layer){this._layer.off("loadstart",!1,this)}},_setUpEvents:function _setUpEvents(){this._layer.on("loadstart",function(){this.fire("loadstart",{target:this})},this)}})});