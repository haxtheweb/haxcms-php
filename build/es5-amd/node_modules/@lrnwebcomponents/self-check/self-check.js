define(["exports", "meta", "require", "../../lit/index.js", "../simple-colors/simple-colors.js", "../schema-behaviors/schema-behaviors.js", "../lazy-image-helpers/lazy-image-helpers.js", "../i18n-manager/lib/I18NMixin.js", "../simple-icon/simple-icon.js", "../simple-icon/lib/simple-icons.js", "../simple-icon/lib/simple-icon-button.js"], function (_exports, meta, _require, _index, _simpleColors, _schemaBehaviors, _lazyImageHelpers, _I18NMixin2, _simpleIcon, _simpleIcons, _simpleIconButton) {
  ...
  var _templateObject_542a3750509711edb124eb517be36dbf, _templateObject2_542a3750509711edb124eb517be36dbf, _templateObject3_542a3750509711edb124eb517be36dbf;
  ...
  var SelfCheck = /*#__PURE__*/function (_I18NMixin) {
    ...
    babelHelpers.createClass(SelfCheck, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_542a3750509711edb124eb517be36dbf || (_templateObject_542a3750509711edb124eb517be36dbf = babelHelpers.taggedTemplateLiteral(["\n      <div class=\"card\">\n        <div class=\"image-wrap\">\n          ", "\n          <img\n            src=\"", "\"\n            alt=\"", "\"\n            aria-describedby=\"", "\"\n            loading=\"lazy\"\n          />\n        </div>\n        <div class=\"triangle\"></div>\n        <div id=\"header_wrap\">\n          <simple-icon\n            id=\"questionmark\"\n            icon=\"icons:help\"\n            ?dark=\"", "\"\n            contrast=\"4\"\n          ></simple-icon>\n          <div class=\"heading\" id=\"title\">\n            <slot name=\"heading\">", "</slot>\n          </div>\n        </div>\n        <div id=\"question_wrap\">\n          <div\n            class=\"question\"\n            aria-hidden=\"", "\"\n          >\n            <slot name=\"question\"></slot>\n            <div class=\"check_button\">\n              <simple-icon-button\n                controls=\"answer_wrap\"\n                aria-label=\"", "\"\n                id=\"checkBtn\"\n                class=\"check-btn\"\n                icon=\"icons:check-circle\"\n                ?dark=\"", "\"\n                @click=\"", "\"\n              ></simple-icon-button>\n              <simple-tooltip aria-hidden=\"true\" for=\"checkBtn\" position=\"left\">\n                ", "\n              </simple-tooltip>\n            </div>\n          </div>\n          <div\n            id=\"answer_wrap\"\n            aria-hidden=\"", "\"\n            aria-live=\"polite\"\n          >\n            <div class=\"answer\">\n              <user-action track=\"visibility\">\n                <slot></slot>\n              </user-action>\n              ", "\n              <div class=\"close_button\">\n                <simple-icon-button\n                  aria-label=\"", "\"\n                  id=\"closeBtn\"\n                  ?dark=\"", "\"\n                  icon=\"icons:close\"\n                  @click=\"", "\"\n                >\n                </simple-icon-button>\n                <simple-tooltip\n                  aria-hidden=\"true\"\n                  for=\"closeBtn\"\n                  position=\"left\"\n                >\n                  ", "\n                </simple-tooltip>\n              </div>\n            </div>\n          </div>\n        </div>\n      </div>\n    "])), this.renderSVGLoader(), this.image, this.alt, this.describedBy || "", !this.dark, this.title, this.correct ? "true" : "false", this.t.revealAnswer, this.dark, this.openAnswer, this.t.revealAnswer, this.correct ? "false" : "true", this.link ? (0, _index.html)(_templateObject2_542a3750509711edb124eb517be36dbf || (_templateObject2_542a3750509711edb124eb517be36dbf = babelHelpers.taggedTemplateLiteral(["\n                    <div class=\"more_info\">\n                      <user-action track=\"click\" every=\"every\"\n                        ><a href=\"", "\" target=\"_blank\" rel=\"noopener\"\n                          >", "...</a\n                        ></user-action\n                      >\n                    </div>\n                  "])), this.link, this.t.moreInformation) : "", this.t.close, !this.dark, this.openAnswer, this.t.close);
      }
      /**
