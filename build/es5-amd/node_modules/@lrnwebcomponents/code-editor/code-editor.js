define(["exports", "meta", "require", "../../lit-element/lit-element.js", "../schema-behaviors/schema-behaviors.js", "./lib/monaco-element/monaco-element.js", "../utils/utils.js"], function (_exports, meta, _require, _litElement, _schemaBehaviors, _monacoElement, _utils) {
  ...
  function _templateObject3_fb094070930111eb82a7a575782a1009() {
    ...
    _templateObject3_fb094070930111eb82a7a575782a1009 = function _templateObject3_fb094070930111eb82a7a575782a1009() {
      return data;
    };
  ...
  function _templateObject2_fb094070930111eb82a7a575782a1009() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <label for=\"codeeditor\" ?hidden=\"", "\" part=\"label\"\n        >", "</label\n      >\n      <monaco-element\n        id=\"codeeditor\"\n        ?data-hidden=\"", "\"\n        ?autofocus=\"", "\"\n        ?hide-line-numbers=\"", "\"\n        lib-path=\"", "\"\n        language=\"", "\"\n        tab-size=\"", "\"\n        theme=\"", "\"\n        @value-changed=\"", "\"\n        font-size=\"", "\"\n        ?word-wrap=\"", "\"\n        ?read-only=\"", "\"\n        @code-editor-focus=\"", "\"\n        @code-editor-blur=\"", "\"\n        @monaco-element-ready=\"", "\"\n        part=\"code\"\n      >\n      </monaco-element>\n      <pre\n        id=\"loading\"\n        ?hidden=\"", "\"\n        style=\"font-size:", "px\"\n        part=\"preview\"\n      ><code>\n  ", "</code></pre>\n      <slot hidden></slot>\n      ", "\n    "]);

    _templateObject2_fb094070930111eb82a7a575782a1009 = function _templateObject2_fb094070930111eb82a7a575782a1009() {
      return data;
    };
  ...
  function _templateObject_fb094070930111eb82a7a575782a1009() {
    ...
    _templateObject_fb094070930111eb82a7a575782a1009 = function _templateObject_fb094070930111eb82a7a575782a1009() {
      return data;
    };
  ...
  var CodeEditor = /*#__PURE__*/function (_SchemaBehaviors) {
    ...
    babelHelpers.createClass(CodeEditor, null, [{
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject_fb094070930111eb82a7a575782a1009())];
      }
      /**
       * HTMLElement
       */
    ...
    babelHelpers.createClass(CodeEditor, [{
      ...
      value: function render() {
        ...
        return (0, _litElement.html)(_templateObject2_fb094070930111eb82a7a575782a1009(), !this.title, this.title, !this.ready, this.autofocus, this.hideLineNumbers, this.libPath, this.language, this.tabSize, this.getTheme(this.theme), this._editorDataChanged, this.fontSize, this.wordWrap, this.readOnly, this._handleFocus, this._handleBlur, function (e) {
          return _this2.ready = true;
        }, this.ready, this.fontSize, this.placeholder, this.showCodePen ? (0, _litElement.html)(_templateObject3_fb094070930111eb82a7a575782a1009(), this.codePenData) : "");
      }
    }, {
      key: "getTheme",
