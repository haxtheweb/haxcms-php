define(["exports", "meta", "require", "../../lit-element/lit-element.js", "../schema-behaviors/schema-behaviors.js"], function (_exports, meta, _require, _litElement, _schemaBehaviors) {
  ...
  function _templateObject2_7ff30d3034ed11eabe39ef50dfa8db3f() {
    ...
    _templateObject2_7ff30d3034ed11eabe39ef50dfa8db3f = function _templateObject2_7ff30d3034ed11eabe39ef50dfa8db3f() {
      return data;
    };
  ...
  function _templateObject_7ff30d3034ed11eabe39ef50dfa8db3f() {
    ...
    _templateObject_7ff30d3034ed11eabe39ef50dfa8db3f = function _templateObject_7ff30d3034ed11eabe39ef50dfa8db3f() {
      return data;
    };
  ...
  function (_SchemaBehaviors) {
    ...
    babelHelpers.createClass(CodeEditor, null, [{
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject_7ff30d3034ed11eabe39ef50dfa8db3f())];
      }
      /**
       * HTMLElement
       */
    ...
    babelHelpers.createClass(CodeEditor, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_7ff30d3034ed11eabe39ef50dfa8db3f(), !this.title, this.title, this.autofocus, this.hideLineNumbers, this.__libPath, this.language, this.theme, this._editorDataChanged, this.fontSize, this.readOnly, this._handleFocus, this._handleBlur, !this.showCodePen, this.codePenData);
      }
    }, {
      key: "updated",
