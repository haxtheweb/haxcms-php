define(["exports", "meta", "require", "../../lit-element/lit-element.js", "../schema-behaviors/schema-behaviors.js"], function (_exports, meta, _require, _litElement, _schemaBehaviors) {
  ...
  function _templateObject2_fbb6dad05a5b11ea9b0bfd873cbf79fd() {
    ...
    _templateObject2_fbb6dad05a5b11ea9b0bfd873cbf79fd = function _templateObject2_fbb6dad05a5b11ea9b0bfd873cbf79fd() {
      return data;
    };
  ...
  function _templateObject_fbb6dad05a5b11ea9b0bfd873cbf79fd() {
    ...
    _templateObject_fbb6dad05a5b11ea9b0bfd873cbf79fd = function _templateObject_fbb6dad05a5b11ea9b0bfd873cbf79fd() {
      return data;
    };
  ...
  function (_SchemaBehaviors) {
    ...
    babelHelpers.createClass(CodeEditor, null, [{
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject_fbb6dad05a5b11ea9b0bfd873cbf79fd())];
      }
      /**
       * HTMLElement
       */
    ...
    babelHelpers.createClass(CodeEditor, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_fbb6dad05a5b11ea9b0bfd873cbf79fd(), !this.title, this.title, this.autofocus, this.hideLineNumbers, this.__libPath, this.language, this.theme, this._editorDataChanged, this.fontSize, this.readOnly, this._handleFocus, this._handleBlur, !this.showCodePen, this.codePenData);
      }
    }, {
      key: "updated",
