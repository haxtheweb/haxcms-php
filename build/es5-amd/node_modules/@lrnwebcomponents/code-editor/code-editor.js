define(["exports", "meta", "require", "../../lit-element/lit-element.js", "../schema-behaviors/schema-behaviors.js"], function (_exports, meta, _require, _litElement, _schemaBehaviors) {
  ...
  function _templateObject2_7dec6350380411eaa561b792cdf1a8cd() {
    ...
    _templateObject2_7dec6350380411eaa561b792cdf1a8cd = function _templateObject2_7dec6350380411eaa561b792cdf1a8cd() {
      return data;
    };
  ...
  function _templateObject_7dec6350380411eaa561b792cdf1a8cd() {
    ...
    _templateObject_7dec6350380411eaa561b792cdf1a8cd = function _templateObject_7dec6350380411eaa561b792cdf1a8cd() {
      return data;
    };
  ...
  function (_SchemaBehaviors) {
    ...
    babelHelpers.createClass(CodeEditor, null, [{
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject_7dec6350380411eaa561b792cdf1a8cd())];
      }
      /**
       * HTMLElement
       */
    ...
    babelHelpers.createClass(CodeEditor, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_7dec6350380411eaa561b792cdf1a8cd(), !this.title, this.title, this.autofocus, this.hideLineNumbers, this.__libPath, this.language, this.theme, this._editorDataChanged, this.fontSize, this.readOnly, this._handleFocus, this._handleBlur, !this.showCodePen, this.codePenData);
      }
    }, {
      key: "updated",
