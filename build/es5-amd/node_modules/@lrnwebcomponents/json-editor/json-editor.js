define(["exports", "require", "../../lit/index.js"], function (_exports, _require, _index) {
  ...
  var _templateObject_d74f6a10a0c911eda392efd0bad1b4bf, _templateObject2_d74f6a10a0c911eda392efd0bad1b4bf;
  ...
  var JsonEditor = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(JsonEditor, [{
      ...
      // render function
      function render() {
        return (0, _index.html)(_templateObject_d74f6a10a0c911eda392efd0bad1b4bf || (_templateObject_d74f6a10a0c911eda392efd0bad1b4bf = babelHelpers.taggedTemplateLiteral([" <custom-style>\n        <style>\n          :host([error]) paper-textarea {\n            --iron-autogrow-textarea: {\n              background-color: #ffeeee;\n            }\n          }\n          paper-textarea {\n            --iron-autogrow-textarea: {\n              font-family: \"Lucida Console\", Monaco, monospace;\n              font-weight: 600;\n              white-space: pre;\n              line-height: 20px;\n              padding: 9.5px;\n              margin: 0 0 10px;\n              font-size: 13px;\n              color: #000000;\n              word-break: break-all;\n              word-wrap: break-word;\n              background-color: #f5f5f5;\n              border: 1px solid #ccc;\n              border-radius: 4px;\n              transition: 0.3s linear all;\n            }\n          }\n        </style>\n      </custom-style>\n      <paper-textarea\n        label=\"", "\"\n        value=\"", "\"\n        @value-changed=\"", "\"\n        error-message=\"Invalid JSON!\"\n        ?readonly=\"", "\"\n        ?invalid=\"", "\"\n        max-rows=\"", "\"\n      ></paper-textarea>"])), this.label, this.value, this.valueEvent, this.disabled, this.error, this.maxRows);
      }
      ...
      //styles function
      function get() {
        return [(0, _index.css)(_templateObject2_d74f6a10a0c911eda392efd0bad1b4bf || (_templateObject2_d74f6a10a0c911eda392efd0bad1b4bf = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n\n        :host([hidden]) {\n          display: none;\n        }\n      "])))];
      }
    }, {
      key: "properties",
      get: function get() {
