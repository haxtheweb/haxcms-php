define(["exports","../../@polymer/polymer/polymer-legacy.js","./lib/gitgraph.js/src/gitgraph.js"],function(_exports,_polymerLegacy,_gitgraph){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.LrnGitgraph=void 0;function _templateObject_b2fe52306a8f11e9a3fbc91c56f16a14(){var data=babelHelpers.taggedTemplateLiteral(["\n    <style>\n      :host {\n        display: block;\n        overflow-x: scroll;\n      }\n    </style>\n    <canvas id=\"gitGraph\"></canvas>\n  "]);_templateObject_b2fe52306a8f11e9a3fbc91c56f16a14=function _templateObject_b2fe52306a8f11e9a3fbc91c56f16a14(){return data};return data}/**
`lrn-gitgraph`
A LRN element
...
*/var LrnGitgraph=(0,_polymerLegacy.Polymer)({_template:(0,_polymerLegacy.html)(_templateObject_b2fe52306a8f11e9a3fbc91c56f16a14()),is:"lrn-gitgraph",properties:{commits:{type:Array,value:[]},template:{type:String,value:"blackarrow"},orientation:{type:String,value:"horizontal"},mode:{type:String,value:""},reverseArrow:{type:Boolean,value:!1},/**
