        ...
        value: function handleIntersectionCallback(entries) {
          ...
          try {
            for (_iterator.s(); !(_step = _iterator.n()).done;) {
              ...
              var ratio = Number(entry.intersectionRatio).toFixed(2);
