define(["exports","../../@polymer/polymer/polymer-element.js","../../@polymer/iron-ajax/iron-ajax.js"],function(_exports,_polymerElement,_ironAjax){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.JwtLogin=void 0;function _templateObject_bb96bf607b3611e9adc281d999a3f2aa(){var data=babelHelpers.taggedTemplateLiteral(["\n      <style>\n        :host {\n          visibility: hidden;\n        }\n      </style>\n      <iron-ajax\n        id=\"loginrequest\"\n        method=\"[[method]]\"\n        body=\"[[body]]\"\n        url=\"[[url]]\"\n        handle-as=\"json\"\n        content-type=\"application/json\"\n        on-response=\"loginResponse\"\n      >\n      </iron-ajax>\n    "]);_templateObject_bb96bf607b3611e9adc281d999a3f2aa=function _templateObject_bb96bf607b3611e9adc281d999a3f2aa(){return data};return data}/**
 * `jwt-login`
...
this.jwt=null}}/**
   ...
   */},{key:"loginResponse",value:function loginResponse(e){this.jwt=e.detail.response}}],[{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_bb96bf607b3611e9adc281d999a3f2aa())}},{key:"tag",get:function get(){return"jwt-login"}},{key:"properties",get:function get(){return{/**
       * url
       */url:{type:String},/**
       * Request method
