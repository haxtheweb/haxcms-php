define(["exports", "../../lit/index.js", "../simple-icon/lib/simple-icon-button.js", "../simple-icon/simple-icon.js", "../simple-colors/simple-colors.js"], function (_exports, _index, _simpleIconButton, _simpleIcon, _simpleColors) {
  ...
  var _templateObject_ec289a009e8b11ed8df835f388f76963, _templateObject2_ec289a009e8b11ed8df835f388f76963, _templateObject3_ec289a009e8b11ed8df835f388f76963, _templateObject4_ec289a009e8b11ed8df835f388f76963, _templateObject5_ec289a009e8b11ed8df835f388f76963;
  ...
  var StarRating = /*#__PURE__*/function (_SimpleColors) {
    ...
    babelHelpers.createClass(StarRating, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_ec289a009e8b11ed8df835f388f76963 || (_templateObject_ec289a009e8b11ed8df835f388f76963 = babelHelpers.taggedTemplateLiteral(["\n      <div class=\"wrapper\">\n        <div class=\"stars\">\n          ", "\n        </div>\n        <div class=\"rating\">\n          ", " (", "/", ")\n        </div>\n      </div>\n    "])), this.renderStar(this.numStars, this.interactive), this._calPercent, this.score, this.possible);
      }
    }, {
      key: "renderStar",
      value: function renderStar(amount, interactive) {
        if (amount === 0) {
          return (0, _index.html)(_templateObject2_ec289a009e8b11ed8df835f388f76963 || (_templateObject2_ec289a009e8b11ed8df835f388f76963 = babelHelpers.taggedTemplateLiteral([""])));
        }
        var count = 0;
        var content = [];
        while (count < amount) {
          ...
          if (interactive) {
            content.push((0, _index.html)(_templateObject3_ec289a009e8b11ed8df835f388f76963 || (_templateObject3_ec289a009e8b11ed8df835f388f76963 = babelHelpers.taggedTemplateLiteral(["<simple-icon-button\n            @click=\"", "\"\n            icon=\"", "\"\n            accent-color=\"", "\"\n            ?dark=\"", "\"\n            contrast=\"", "\"\n            class=\"star\"\n            data-value=\"", "\"\n          ></simple-icon-button>"])), this.interactiveEvent, icon, this.accentColor, this.dark, this.contrast, Number(count + 1)));
          } else {
            content.push((0, _index.html)(_templateObject4_ec289a009e8b11ed8df835f388f76963 || (_templateObject4_ec289a009e8b11ed8df835f388f76963 = babelHelpers.taggedTemplateLiteral(["<simple-icon\n            icon=\"", "\"\n            accent-color=\"", "\"\n            ?dark=\"", "\"\n            contrast=\"", "\"\n            class=\"star\"\n          ></simple-icon>"])), icon, this.accentColor, this.dark, this.contrast));
          }
          count++;
        }
        return content;
