...
function _templateObject2_9bf71b20509711edb124eb517be36dbf() {
  var data = _taggedTemplateLiteral(["", '\n          <h2 class="subheading" slot="body">\n            ', "\n          </h2>\n          ", "", ""]);

  _templateObject2_9bf71b20509711edb124eb517be36dbf = function _templateObject2_9bf71b20509711edb124eb517be36dbf() {
    return data;
  };
...
function _templateObject_9bf71b20509711edb124eb517be36dbf() {
  ...
  _templateObject_9bf71b20509711edb124eb517be36dbf = function _templateObject_9bf71b20509711edb124eb517be36dbf() {
    return data;
  };
...
var SimpleTour = /*#__PURE__*/function (_LitElement) {
  ...
  _createClass(SimpleTour, [{
    ...
    value: function tourButtons() {
      return (0, _litElement.html)(_templateObject_9bf71b20509711edb124eb517be36dbf(), this.tourInfo[this.active].name, this.stop + 1, this.stacks[this.active].length, this.stopTour.bind(this), this.prevStop.bind(this), !this.hasPrev(), this.nextStop.bind(this), !this.hasNext());
    }
    /**
