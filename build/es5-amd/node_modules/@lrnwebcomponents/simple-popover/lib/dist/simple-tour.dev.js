...
function _templateObject2_0dae2370e4f511ed85766367b4d3e9fc() {
  var data = _taggedTemplateLiteral(["", '\n          <h2 class="subheading" slot="body">\n            ', "\n          </h2>\n          ", "", ""]);
  _templateObject2_0dae2370e4f511ed85766367b4d3e9fc = function _templateObject2_0dae2370e4f511ed85766367b4d3e9fc() {
    return data;
  };
  return data;
}
function _templateObject_0dae2370e4f511ed85766367b4d3e9fc() {
  ...
  _templateObject_0dae2370e4f511ed85766367b4d3e9fc = function _templateObject_0dae2370e4f511ed85766367b4d3e9fc() {
    return data;
  };
  return data;
}
...
function (_LitElement) {
  ...
  _createClass(SimpleTour, [{
    ...
    value: function tourButtons() {
      return (0, _litElement.html)(_templateObject_0dae2370e4f511ed85766367b4d3e9fc(), this.tourInfo[this.active].name, this.stop + 1, this.stacks[this.active].length, this.stopTour.bind(this), this.prevStop.bind(this), !this.hasPrev(), this.nextStop.bind(this), !this.hasNext());
    }
    /**
