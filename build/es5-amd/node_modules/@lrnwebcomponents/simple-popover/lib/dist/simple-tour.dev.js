...
function _templateObject2_7db336c0d3e211ed8e5073e3aa96f674() {
  var data = _taggedTemplateLiteral(["", '\n          <h2 class="subheading" slot="body">\n            ', "\n          </h2>\n          ", "", ""]);
  _templateObject2_7db336c0d3e211ed8e5073e3aa96f674 = function _templateObject2_7db336c0d3e211ed8e5073e3aa96f674() {
    return data;
  };
  return data;
}
function _templateObject_7db336c0d3e211ed8e5073e3aa96f674() {
  ...
  _templateObject_7db336c0d3e211ed8e5073e3aa96f674 = function _templateObject_7db336c0d3e211ed8e5073e3aa96f674() {
    return data;
  };
  return data;
}
...
function (_LitElement) {
  ...
  _createClass(SimpleTour, [{
    ...
    value: function tourButtons() {
      return (0, _litElement.html)(_templateObject_7db336c0d3e211ed8e5073e3aa96f674(), this.tourInfo[this.active].name, this.stop + 1, this.stacks[this.active].length, this.stopTour.bind(this), this.prevStop.bind(this), !this.hasPrev(), this.nextStop.bind(this), !this.hasNext());
    }
    /**
