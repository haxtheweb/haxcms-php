...
function _templateObject2_00877a30a0ca11eda392efd0bad1b4bf() {
  var data = _taggedTemplateLiteral(["", '\n          <h2 class="subheading" slot="body">\n            ', "\n          </h2>\n          ", "", ""]);
  _templateObject2_00877a30a0ca11eda392efd0bad1b4bf = function _templateObject2_00877a30a0ca11eda392efd0bad1b4bf() {
    return data;
  };
  return data;
}
function _templateObject_00877a30a0ca11eda392efd0bad1b4bf() {
  ...
  _templateObject_00877a30a0ca11eda392efd0bad1b4bf = function _templateObject_00877a30a0ca11eda392efd0bad1b4bf() {
    return data;
  };
  return data;
}
...
function (_LitElement) {
  ...
  _createClass(SimpleTour, [{
    ...
    value: function tourButtons() {
      return (0, _litElement.html)(_templateObject_00877a30a0ca11eda392efd0bad1b4bf(), this.tourInfo[this.active].name, this.stop + 1, this.stacks[this.active].length, this.stopTour.bind(this), this.prevStop.bind(this), !this.hasPrev(), this.nextStop.bind(this), !this.hasNext());
    }
    /**
