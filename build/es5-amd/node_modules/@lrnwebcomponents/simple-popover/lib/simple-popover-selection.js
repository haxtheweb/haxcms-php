define(["exports", "../../../lit/index.js", "../../../lit/directives/unsafe-html.js", "./simple-popover-manager.js"], function (_exports, _index, _unsafeHtml, _simplePopoverManager) {
  ...
  var _templateObject_20f4f610cd8211ecaf720fdc1a41727f, _templateObject2_20f4f610cd8211ecaf720fdc1a41727f, _templateObject3_20f4f610cd8211ecaf720fdc1a41727f;
  ...
  var SimplePopoverSelection = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(SimplePopoverSelection, [{
      ...
      value: function openedChanged(state) {
        ...
        if (state) {
          ...
          if (this.querySelector('[slot="style"]')) {
            ...
            content = (0, _index.html)(_templateObject_20f4f610cd8211ecaf720fdc1a41727f || (_templateObject_20f4f610cd8211ecaf720fdc1a41727f = babelHelpers.taggedTemplateLiteral(["", "", ""])), (0, _unsafeHtml.unsafeHTML)(div.innerHTML), (0, _unsafeHtml.unsafeHTML)(style.outerHTML));
          } else {
            content = (0, _index.html)(_templateObject2_20f4f610cd8211ecaf720fdc1a41727f || (_templateObject2_20f4f610cd8211ecaf720fdc1a41727f = babelHelpers.taggedTemplateLiteral(["", ""])), (0, _unsafeHtml.unsafeHTML)(div.innerHTML));
          }
      ...
      value: function render() {
        return (0, _index.html)(_templateObject3_20f4f610cd8211ecaf720fdc1a41727f || (_templateObject3_20f4f610cd8211ecaf720fdc1a41727f = babelHelpers.taggedTemplateLiteral(["<slot name=\"button\"></slot>"])));
      }
    }], [{
      key: "properties",
      get: function get() {
