define(["exports", "../../../lit/index.js", "../../../lit/directives/unsafe-html.js", "./simple-popover-manager.js"], function (_exports, _index, _unsafeHtml, _simplePopoverManager) {
  ...
  var _templateObject_ffbe5410e4f411ed85766367b4d3e9fc, _templateObject2_ffbe5410e4f411ed85766367b4d3e9fc, _templateObject3_ffbe5410e4f411ed85766367b4d3e9fc;
  ...
  var SimplePopoverSelection = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(SimplePopoverSelection, [{
      ...
      value: function openedChanged(state) {
        ...
        if (state) {
          ...
          if (this.querySelector('[slot="style"]')) {
            ...
            content = (0, _index.html)(_templateObject_ffbe5410e4f411ed85766367b4d3e9fc || (_templateObject_ffbe5410e4f411ed85766367b4d3e9fc = babelHelpers.taggedTemplateLiteral(["", "", ""])), (0, _unsafeHtml.unsafeHTML)(div.innerHTML), (0, _unsafeHtml.unsafeHTML)(style.outerHTML));
          } else {
            content = (0, _index.html)(_templateObject2_ffbe5410e4f411ed85766367b4d3e9fc || (_templateObject2_ffbe5410e4f411ed85766367b4d3e9fc = babelHelpers.taggedTemplateLiteral(["", ""])), (0, _unsafeHtml.unsafeHTML)(div.innerHTML));
          }
      ...
      value: function render() {
        return (0, _index.html)(_templateObject3_ffbe5410e4f411ed85766367b4d3e9fc || (_templateObject3_ffbe5410e4f411ed85766367b4d3e9fc = babelHelpers.taggedTemplateLiteral(["<slot name=\"button\"></slot>"])));
      }
    }], [{
      key: "properties",
      get: function get() {
