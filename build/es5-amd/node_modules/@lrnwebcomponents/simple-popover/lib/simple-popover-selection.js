define(["exports", "../../../lit/index.js", "../../../lit/directives/unsafe-html.js", "./simple-popover-manager.js"], function (_exports, _index, _unsafeHtml, _simplePopoverManager) {
  ...
  var _templateObject_6b6888202ee311eda9c37b2c2696a94a, _templateObject2_6b6888202ee311eda9c37b2c2696a94a, _templateObject3_6b6888202ee311eda9c37b2c2696a94a;
  ...
  var SimplePopoverSelection = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(SimplePopoverSelection, [{
      ...
      value: function openedChanged(state) {
        ...
        if (state) {
          ...
          if (this.querySelector('[slot="style"]')) {
            ...
            content = (0, _index.html)(_templateObject_6b6888202ee311eda9c37b2c2696a94a || (_templateObject_6b6888202ee311eda9c37b2c2696a94a = babelHelpers.taggedTemplateLiteral(["", "", ""])), (0, _unsafeHtml.unsafeHTML)(div.innerHTML), (0, _unsafeHtml.unsafeHTML)(style.outerHTML));
          } else {
            content = (0, _index.html)(_templateObject2_6b6888202ee311eda9c37b2c2696a94a || (_templateObject2_6b6888202ee311eda9c37b2c2696a94a = babelHelpers.taggedTemplateLiteral(["", ""])), (0, _unsafeHtml.unsafeHTML)(div.innerHTML));
          }
      ...
      value: function render() {
        return (0, _index.html)(_templateObject3_6b6888202ee311eda9c37b2c2696a94a || (_templateObject3_6b6888202ee311eda9c37b2c2696a94a = babelHelpers.taggedTemplateLiteral(["<slot name=\"button\"></slot>"])));
      }
    }], [{
      key: "properties",
      get: function get() {
