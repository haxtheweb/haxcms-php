define(["exports", "../../../lit/index.js", "../../../lit/directives/unsafe-html.js", "./simple-popover-manager.js"], function (_exports, _index, _unsafeHtml, _simplePopoverManager) {
  ...
  var _templateObject_c5be5b90403311edb9fff3e6b08a0a9a, _templateObject2_c5be5b90403311edb9fff3e6b08a0a9a, _templateObject3_c5be5b90403311edb9fff3e6b08a0a9a;
  ...
  var SimplePopoverSelection = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(SimplePopoverSelection, [{
      ...
      value: function openedChanged(state) {
        ...
        if (state) {
          ...
          if (this.querySelector('[slot="style"]')) {
            ...
            content = (0, _index.html)(_templateObject_c5be5b90403311edb9fff3e6b08a0a9a || (_templateObject_c5be5b90403311edb9fff3e6b08a0a9a = babelHelpers.taggedTemplateLiteral(["", "", ""])), (0, _unsafeHtml.unsafeHTML)(div.innerHTML), (0, _unsafeHtml.unsafeHTML)(style.outerHTML));
          } else {
            content = (0, _index.html)(_templateObject2_c5be5b90403311edb9fff3e6b08a0a9a || (_templateObject2_c5be5b90403311edb9fff3e6b08a0a9a = babelHelpers.taggedTemplateLiteral(["", ""])), (0, _unsafeHtml.unsafeHTML)(div.innerHTML));
          }
      ...
      value: function render() {
        return (0, _index.html)(_templateObject3_c5be5b90403311edb9fff3e6b08a0a9a || (_templateObject3_c5be5b90403311edb9fff3e6b08a0a9a = babelHelpers.taggedTemplateLiteral(["<slot name=\"button\"></slot>"])));
      }
    }], [{
      key: "properties",
      get: function get() {
