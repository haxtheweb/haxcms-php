define(["exports", "../../../lit-element/lit-element.js", "../../../lit-html/lib/render.js", "../../../lit-html/directives/unsafe-html.js", "./simple-popover-manager.js"], function (_exports, _litElement, _render, _unsafeHtml, _simplePopoverManager) {
  ...
  function _templateObject2_345460b03ee511ebb7f7a1171f0cd59d() {
    var data = babelHelpers.taggedTemplateLiteral(["", "\n          <h3>\n            ", "\n          </h3>\n          ", "", ""]);

    _templateObject2_345460b03ee511ebb7f7a1171f0cd59d = function _templateObject2_345460b03ee511ebb7f7a1171f0cd59d() {
      return data;
    };
  ...
  function _templateObject_345460b03ee511ebb7f7a1171f0cd59d() {
    var data = babelHelpers.taggedTemplateLiteral([" <h3>\n        ", "\n        <span style=\"margin-left:16px\"\n          >", "/", "</span\n        >\n      </h3>\n      <button\n        @click=\"", "\"\n        ?disabled=\"", "\"\n      >\n        Previous\n      </button>\n      <button\n        @click=\"", "\"\n        ?disabled=\"", "\"\n      >\n        Next</button\n      ><button @click=\"", "\">Stop tour</button>"]);

    _templateObject_345460b03ee511ebb7f7a1171f0cd59d = function _templateObject_345460b03ee511ebb7f7a1171f0cd59d() {
      return data;
    };
  ...
  var SimpleTour = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(SimpleTour, [{
      ...
      value: function tourButtons() {
        return (0, _litElement.html)(_templateObject_345460b03ee511ebb7f7a1171f0cd59d(), this.tourInfo[this.active].name, this.stop + 1, this.stacks[this.active].length, this.prevStop.bind(this), !this.hasPrev(), this.nextStop.bind(this), !this.hasNext(), this.stopTour.bind(this));
      }
      /**
