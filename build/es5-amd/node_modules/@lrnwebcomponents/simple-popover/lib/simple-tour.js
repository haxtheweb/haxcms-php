define(["exports", "../../../lit-element/lit-element.js", "../../../lit-html/lib/render.js", "../../../lit-html/directives/unsafe-html.js", "./simple-popover-manager.js"], function (_exports, _litElement, _render, _unsafeHtml, _simplePopoverManager) {
  ...
  function _templateObject2_394a1020552811eba4342b928bc07ca8() {
    var data = babelHelpers.taggedTemplateLiteral(["", "\n          <h3>\n            ", "\n          </h3>\n          ", "", ""]);

    _templateObject2_394a1020552811eba4342b928bc07ca8 = function _templateObject2_394a1020552811eba4342b928bc07ca8() {
      return data;
    };
  ...
  function _templateObject_394a1020552811eba4342b928bc07ca8() {
    var data = babelHelpers.taggedTemplateLiteral([" <h3>\n        ", "\n        <span style=\"margin-left:16px\"\n          >", "/", "</span\n        >\n      </h3>\n      <button\n        @click=\"", "\"\n        ?disabled=\"", "\"\n      >\n        Previous\n      </button>\n      <button\n        @click=\"", "\"\n        ?disabled=\"", "\"\n      >\n        Next</button\n      ><button @click=\"", "\">Stop tour</button>"]);

    _templateObject_394a1020552811eba4342b928bc07ca8 = function _templateObject_394a1020552811eba4342b928bc07ca8() {
      return data;
    };
  ...
  var SimpleTour = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(SimpleTour, [{
      ...
      value: function tourButtons() {
        return (0, _litElement.html)(_templateObject_394a1020552811eba4342b928bc07ca8(), this.tourInfo[this.active].name, this.stop + 1, this.stacks[this.active].length, this.prevStop.bind(this), !this.hasPrev(), this.nextStop.bind(this), !this.hasNext(), this.stopTour.bind(this));
      }
      /**
