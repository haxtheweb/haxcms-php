define(["exports", "../../../lit-element/lit-element.js", "../../../lit-html/lib/render.js", "../../../lit-html/directives/unsafe-html.js", "../../simple-toolbar/simple-toolbar.js", "../../simple-icon/lib/simple-icon-button-lite.js", "../../simple-tooltip/simple-tooltip.js", "./simple-popover-manager.js"], function (_exports, _litElement, _render, _unsafeHtml, _simpleToolbar, _simpleIconButtonLite, _simpleTooltip, _simplePopoverManager) {
  ...
  function _templateObject2_4575964099b011eb851ed31c596cbbd8() {
    var data = babelHelpers.taggedTemplateLiteral(["", "\n          <h2 class=\"subheading\" slot=\"body\">\n            ", "\n          </h2>\n          ", "", ""]);

    _templateObject2_4575964099b011eb851ed31c596cbbd8 = function _templateObject2_4575964099b011eb851ed31c596cbbd8() {
      return data;
    };
  ...
  function _templateObject_4575964099b011eb851ed31c596cbbd8() {
    ...
    _templateObject_4575964099b011eb851ed31c596cbbd8 = function _templateObject_4575964099b011eb851ed31c596cbbd8() {
      return data;
    };
  ...
  var SimpleTour = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(SimpleTour, [{
      ...
      value: function tourButtons() {
        return (0, _litElement.html)(_templateObject_4575964099b011eb851ed31c596cbbd8(), this.tourInfo[this.active].name, this.stop + 1, this.stacks[this.active].length, this.stopTour.bind(this), this.prevStop.bind(this), !this.hasPrev(), this.nextStop.bind(this), !this.hasNext());
      }
      /**
      ...
      value: function updated(changedProperties) {
        ...
        changedProperties.forEach(function (oldValue, propName) {
          ...
          if (propName == "stop" && _this3.stop != -1 || propName == "active" && _this3.active) {
            ...
            var content = (0, _litElement.html)(_templateObject2_4575964099b011eb851ed31c596cbbd8(), _this3.tourButtons(), (0, _unsafeHtml.unsafeHTML)("<span>" + title + "</span>"), (0, _unsafeHtml.unsafeHTML)('<p slot="body">' + description + "</p>"), _this3.tourInfo[_this3.active].style ? (0, _unsafeHtml.unsafeHTML)("<style>" + _this3.tourInfo[_this3.active].style + "</style>") : "");
