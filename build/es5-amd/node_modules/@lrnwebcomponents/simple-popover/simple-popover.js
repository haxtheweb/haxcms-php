 ...
 */var SimplePopover=/*#__PURE__*/function(_AbsolutePositionBeha){babelHelpers.inherits(SimplePopover,_AbsolutePositionBeha);function SimplePopover(){babelHelpers.classCallCheck(this,SimplePopover);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(SimplePopover).apply(this,arguments))}babelHelpers.createClass(SimplePopover,[{key:"connectedCallback",/**
   ...
   */},{key:"_getMargins",value:function _getMargins(positions){var style="",v=positions.target.top+positions.target.height/2-positions.self.top-positions.self.height/2-10,h=positions.target.left+positions.target.width/2-positions.self.left-positions.self.width/2-10;switch(this.position){case"left":style="margin: ".concat(v,"px 0 0 -1px;");break;case"right":style="margin: ".concat(v,"px 0 -1px 0;");break;case"top":style="margin: -0.5 0 0 -1px ".concat(h,"px;");break;default:style="margin: 0 0 -1px ".concat(h,"px;");}return style}/**
   * life cycle, element is removed from the DOM
   */ //disconnectedCallback() {}
}],[{key:"template",// render function
get:function get(){return(0,_polymerElement.html)(_templateObject_2bb1fa40773f11e996418d4f1d726d09())}// haxProperty definition
