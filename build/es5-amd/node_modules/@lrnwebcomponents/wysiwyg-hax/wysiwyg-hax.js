define(["exports", "../../lit-element/lit-element.js", "../cms-hax/cms-hax.js", "../hax-body/lib/hax-store.js"], function (_exports, _litElement, _cmsHax, _haxStore) {
  ...
  function _templateObject2_bcc65a302dd211eba8a9dbdc0fc9b6e0() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n      "]);

    _templateObject2_bcc65a302dd211eba8a9dbdc0fc9b6e0 = function _templateObject2_bcc65a302dd211eba8a9dbdc0fc9b6e0() {
      return data;
    };
  ...
  function _templateObject_bcc65a302dd211eba8a9dbdc0fc9b6e0() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <textarea\n        class=\"", "\"\n        id=\"", "\"\n        name=\"", "\"\n        hidden=\"\"\n      >\n      ", "\n      </textarea\n      >\n      <cms-hax\n        hide-message=\"\"\n        redirect-location=\"", "\"\n        update-page-data=\"", "\"\n        .end-point=\"", "\"\n        app-store-connection=\"", "\"\n        offset-margin=\"", "\"\n        .allowed-tags=\"", "\"\n        ?open-default=\"", "\"\n        ?sync-body=\"", "\"\n        ?hide-panel-ops=\"", "\"\n        ?hide-preferences-button=\"", "\"\n        element-align=\"", "\"\n      >\n      </cms-hax>\n    "]);

    _templateObject_bcc65a302dd211eba8a9dbdc0fc9b6e0 = function _templateObject_bcc65a302dd211eba8a9dbdc0fc9b6e0() {
      return data;
    };
  ...
  var WysiwygHax = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(WysiwygHax, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_bcc65a302dd211eba8a9dbdc0fc9b6e0(), this.fieldClass, this.fieldId, this.fieldName, this.bodyValue, this.redirectLocation, this.updatePageData, this.endPoint, this.appStoreConnection, this.offsetMargin, this.allowedTags, this.openDefault, this.syncBody, this.hidePanelOps, this.hidePreferencesButton, this.elementAlign);
      }
    }], [{
      key: "styles",
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_bcc65a302dd211eba8a9dbdc0fc9b6e0())];
      }
    }, {
      key: "tag",
      get: function get() {
