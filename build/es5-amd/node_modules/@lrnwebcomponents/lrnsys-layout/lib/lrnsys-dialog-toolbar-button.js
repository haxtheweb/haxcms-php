define(["exports", "require", "../../../lit-element/lit-element.js"], function (_exports, _require, _litElement) {
  ...
  function _templateObject2_43de6c20332811ea9673c9ed9148a8db() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: inline-block;\n        }\n        iron-icon {\n          display: inline-block;\n          height: 16px;\n          width: 16px;\n        }\n      "]);

    _templateObject2_43de6c20332811ea9673c9ed9148a8db = function _templateObject2_43de6c20332811ea9673c9ed9148a8db() {
      return data;
    };
  ...
  function _templateObject_43de6c20332811ea9673c9ed9148a8db() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <paper-button\n        raised\n        @click=\"", "\"\n        id=\"", "\"\n        aria-label=\"", "\"\n      >\n        <iron-icon icon=\"", "\"></iron-icon> ", "\n      </paper-button>\n      <paper-tooltip for=\"", "\" animation-delay=\"0\"\n        >", "</paper-tooltip\n      >\n    "]);

    _templateObject_43de6c20332811ea9673c9ed9148a8db = function _templateObject_43de6c20332811ea9673c9ed9148a8db() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(LrnsysDialogToolbarButton, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_43de6c20332811ea9673c9ed9148a8db(), this._onTap, this.id, this.title, this.icon, this.title, this.id, this.title);
      }
    }], [{
      key: "styles",
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_43de6c20332811ea9673c9ed9148a8db())];
      }
    }, {
      key: "tag",
      get: function get() {
