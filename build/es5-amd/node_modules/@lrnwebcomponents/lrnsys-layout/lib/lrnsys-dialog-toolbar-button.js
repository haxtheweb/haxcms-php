define(["exports", "require", "../../../lit/index.js", "../../simple-icon/simple-icon.js", "../../simple-icon/lib/simple-icons.js"], function (_exports, _require, _index, _simpleIcon, _simpleIcons) {
  ...
  var _templateObject_6d8cd850d3e211ed8e5073e3aa96f674, _templateObject2_6d8cd850d3e211ed8e5073e3aa96f674;
  ...
  var LrnsysDialogToolbarButton = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(LrnsysDialogToolbarButton, [{
       ...
       */
      function render() {
        return (0, _index.html)(_templateObject_6d8cd850d3e211ed8e5073e3aa96f674 || (_templateObject_6d8cd850d3e211ed8e5073e3aa96f674 = babelHelpers.taggedTemplateLiteral(["\n      <button\n        raised\n        @click=\"", "\"\n        id=\"", "\"\n        aria-label=\"", "\"\n      >\n        <simple-icon\n          icon=\"", "\"\n          accent-color=\"grey\"\n          contrast=\"4\"\n          dark\n        ></simple-icon>\n        ", "\n      </button>\n      <simple-tooltip for=\"", "\" animation-delay=\"0\"\n        >", "</simple-tooltip\n      >\n    "])), this._onTap, this.id, this.title, this.icon, this.title, this.id, this.title);
      }
    }, {
      key: "firstUpdated",
      value:
       ...
       */
      function get() {
        return [(0, _index.css)(_templateObject2_6d8cd850d3e211ed8e5073e3aa96f674 || (_templateObject2_6d8cd850d3e211ed8e5073e3aa96f674 = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: inline-block;\n        }\n        simple-icon {\n          display: inline-block;\n          --simple-icon-height: 16px;\n          --simple-icon-width: 16px;\n        }\n        button {\n          border: none;\n          background: transparent;\n        }\n      "])))];
      }
    }, {
      key: "tag",
      get: function get() {
