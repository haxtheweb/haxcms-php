define(["exports", "require", "../../../lit-element/lit-element.js", "../../simple-icon/simple-icon.js", "../../simple-icon/lib/simple-icons.js"], function (_exports, _require, _litElement, _simpleIcon, _simpleIcons) {
  ...
  var _templateObject_b2240420af6311ebbe560fe9c4727db1, _templateObject2_b2240420af6311ebbe560fe9c4727db1;
  ...
  var LrnsysDialogToolbarButton = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(LrnsysDialogToolbarButton, [{
       ...
       */
      function render() {
        return (0, _litElement.html)(_templateObject_b2240420af6311ebbe560fe9c4727db1 || (_templateObject_b2240420af6311ebbe560fe9c4727db1 = babelHelpers.taggedTemplateLiteral(["\n      <button\n        raised\n        @click=\"", "\"\n        id=\"", "\"\n        aria-label=\"", "\"\n      >\n        <simple-icon\n          icon=\"", "\"\n          accent-color=\"grey\"\n          contrast=\"4\"\n          dark\n        ></simple-icon>\n        ", "\n      </button>\n      <simple-tooltip for=\"", "\" animation-delay=\"0\"\n        >", "</simple-tooltip\n      >\n    "])), this._onTap, this.id, this.title, this.icon, this.title, this.id, this.title);
      }
    }, {
      key: "firstUpdated",
      value:
       ...
       */
      function get() {
        return [(0, _litElement.css)(_templateObject2_b2240420af6311ebbe560fe9c4727db1 || (_templateObject2_b2240420af6311ebbe560fe9c4727db1 = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: inline-block;\n        }\n        simple-icon {\n          display: inline-block;\n          --simple-icon-height: 16px;\n          --simple-icon-width: 16px;\n        }\n        button {\n          border: none;\n          background: transparent;\n        }\n      "])))];
      }
    }, {
      key: "tag",
      get: function get() {
