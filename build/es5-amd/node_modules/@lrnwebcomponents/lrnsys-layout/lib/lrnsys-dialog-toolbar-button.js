define(["exports", "require", "../../../lit-element/lit-element.js", "../../simple-icon/simple-icon.js", "../../simple-icon/lib/simple-icons.js"], function (_exports, _require, _litElement, _simpleIcon, _simpleIcons) {
  ...
  function _templateObject2_da4aed60247111eb9734a78ef81f0b0d() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: inline-block;\n        }\n        simple-icon {\n          display: inline-block;\n          --simple-icon-height: 16px;\n          --simple-icon-width: 16px;\n        }\n      "]);

    _templateObject2_da4aed60247111eb9734a78ef81f0b0d = function _templateObject2_da4aed60247111eb9734a78ef81f0b0d() {
      return data;
    };
  ...
  function _templateObject_da4aed60247111eb9734a78ef81f0b0d() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <button\n        raised\n        @click=\"", "\"\n        id=\"", "\"\n        aria-label=\"", "\"\n      >\n        <simple-icon icon=\"", "\"></simple-icon> ", "\n      </button>\n      <simple-tooltip for=\"", "\" animation-delay=\"0\"\n        >", "</simple-tooltip\n      >\n    "]);

    _templateObject_da4aed60247111eb9734a78ef81f0b0d = function _templateObject_da4aed60247111eb9734a78ef81f0b0d() {
      return data;
    };
  ...
  var LrnsysDialogToolbarButton = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(LrnsysDialogToolbarButton, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_da4aed60247111eb9734a78ef81f0b0d(), this._onTap, this.id, this.title, this.icon, this.title, this.id, this.title);
      }
    }], [{
      key: "styles",
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_da4aed60247111eb9734a78ef81f0b0d())];
      }
    }, {
      key: "tag",
      get: function get() {
