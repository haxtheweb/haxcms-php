define(["exports", "../../../lit/index.js", "../../simple-icon/simple-icon.js", "../../simple-icon/lib/simple-icons.js", "../../hax-iconset/lib/simple-hax-iconset.js", "../../paper-avatar/paper-avatar.js"], function (_exports, _index, _simpleIcon, _simpleIcons, _simpleHaxIconset, _paperAvatar) {
  ...
  var _templateObject_fb4502809e8b11ed8df835f388f76963, _templateObject2_fb4502809e8b11ed8df835f388f76963, _templateObject3_fb4502809e8b11ed8df835f388f76963, _templateObject4_fb4502809e8b11ed8df835f388f76963, _templateObject5_fb4502809e8b11ed8df835f388f76963;
  ...
  var LrnsysButtonInner = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(LrnsysButtonInner, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_fb4502809e8b11ed8df835f388f76963 || (_templateObject_fb4502809e8b11ed8df835f388f76963 = babelHelpers.taggedTemplateLiteral(["\n      <div>\n        ", "\n        ", "\n        ", "\n      </div>\n      <div><slot name=\"button\"></slot><slot></slot></div>\n    "])), this.avatar != "" ? (0, _index.html)(_templateObject2_fb4502809e8b11ed8df835f388f76963 || (_templateObject2_fb4502809e8b11ed8df835f388f76963 = babelHelpers.taggedTemplateLiteral(["\n              <paper-avatar\n                part=\"lrnsys-button-inner-paper-avatar\"\n                src=\"", "\"\n              ></paper-avatar>\n            "])), this.avatar) : "", this.icon != "" ? (0, _index.html)(_templateObject3_fb4502809e8b11ed8df835f388f76963 || (_templateObject3_fb4502809e8b11ed8df835f388f76963 = babelHelpers.taggedTemplateLiteral(["\n              <simple-icon\n                part=\"lrnsys-button-inner-simple-icon\"\n                icon=\"", "\"\n                accent-color=\"grey\"\n                contrast=\"4\"\n              ></simple-icon>\n            "])), this.icon) : "", this.text != "" ? (0, _index.html)(_templateObject4_fb4502809e8b11ed8df835f388f76963 || (_templateObject4_fb4502809e8b11ed8df835f388f76963 = babelHelpers.taggedTemplateLiteral(["\n              <span\n                class=\"", "\"\n                part=\"lrnsys-button-inner-text-label\"\n                >", "</span\n              >\n            "])), this._getTextLabelClass(this.avatar, this.icon), this.text) : "");
      }
    }, {
       ...
       */
      function get() {
        return [(0, _index.css)(_templateObject5_fb4502809e8b11ed8df835f388f76963 || (_templateObject5_fb4502809e8b11ed8df835f388f76963 = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n        :host > div > * {\n          vertical-align: middle;\n        }\n        .text-label {\n          margin-left: 8px;\n        }\n        .text-label-only {\n          margin-left: 0;\n        }\n      "])))];
      }
    }, {
      key: "tag",
      get: function get() {
