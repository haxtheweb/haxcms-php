define(["exports", "require", "../../../lit-element/lit-element.js", "../../simple-colors/simple-colors.js", "../../simple-modal/simple-modal.js"], function (_exports, _require, _litElement, _simpleColors, _simpleModal) {
  ...
  function _templateObject2_f2d6e0a0d0e811eaaf77ab7a62972e0b() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <paper-button\n        class=\"", "\"\n        id=\"dialogtrigger\"\n        @click=\"", "\"\n        @focus-changed=\"", "\"\n        @mousedown=\"", "\"\n        @mouseover=\"", "\"\n        @mouseout=\"", "\"\n        ?raised=\"", "\"\n        ?disabled=\"", "\"\n        title=\"", "\"\n        aria-label=\"", "\"\n      >\n        <lrnsys-button-inner\n          avatar=\"", "\"\n          icon=\"", "\"\n          text=\"", "\"\n        >\n          <slot name=\"button\"></slot>\n        </lrnsys-button-inner>\n      </paper-button>\n      <simple-tooltip\n        for=\"dialogtrigger\"\n        animation-delay=\"0\"\n        ?hidden=\"", "\"\n        >", "</simple-tooltip\n      >\n    "]);

    _templateObject2_f2d6e0a0d0e811eaaf77ab7a62972e0b = function _templateObject2_f2d6e0a0d0e811eaaf77ab7a62972e0b() {
      return data;
    };
  ...
  function _templateObject_f2d6e0a0d0e811eaaf77ab7a62972e0b() {
    ...
    _templateObject_f2d6e0a0d0e811eaaf77ab7a62972e0b = function _templateObject_f2d6e0a0d0e811eaaf77ab7a62972e0b() {
      return data;
    };
  ...
  */
  ...
  function (_SimpleColors) {
    ...
    babelHelpers.createClass(LrnsysDialog, null, [{
       ...
       */
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(LrnsysDialog), "styles", this)), [(0, _litElement.css)(_templateObject_f2d6e0a0d0e811eaaf77ab7a62972e0b())]);
      }
      /**
       * HTMLElement
       */
    ...
    babelHelpers.createClass(LrnsysDialog, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_f2d6e0a0d0e811eaaf77ab7a62972e0b(), this.class, this.openDialog, this.focusToggle, this.tapEventOn, this.tapEventOn, this.tapEventOff, this.raised, this.disabled, this.alt, this.alt, this.avatar, this.icon, this.text, !this.alt, this.alt);
      }
    }, {
      key: "tapEventOn",
