define(["exports", "../../../@polymer/polymer/polymer-element.js", "../../../@polymer/polymer/lib/utils/render-status.js", "../../../@polymer/polymer/lib/utils/flattened-nodes-observer.js", "../../simple-colors/lib/simple-colors-polymer.js", "../../simple-modal/simple-modal.js", "../../../@polymer/paper-tooltip/paper-tooltip.js", "../../../@polymer/paper-button/paper-button.js", "../../../@polymer/neon-animation/neon-animation.js", "../../../@polymer/neon-animation/neon-animations.js", "../../../@polymer/iron-icons/iron-icons.js", "./lrnsys-button-inner.js"], function (_exports, _polymerElement, _renderStatus, _flattenedNodesObserver, _simpleColorsPolymer, _simpleModal, _paperTooltip, _paperButton, _neonAnimation, _neonAnimations, _ironIcons, _lrnsysButtonInner) {
  "use strict";
  ...
  function _templateObject_35e55e900b1311eaa3b2eff4bd15c191() {
    ...
    _templateObject_35e55e900b1311eaa3b2eff4bd15c191 = function _templateObject_35e55e900b1311eaa3b2eff4bd15c191() {
      return data;
    };
    ...
    babelHelpers.createClass(LrnsysDialog, [{
      ...
      value: function tapEventOn(e) {
        ...
        if (babelHelpers.typeof(this.hoverClass) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {
          ...
          classes.forEach(function (item, index) {
            if (item != "") {
              _this.shadowRoot.querySelector("#dialogtrigger").classList.add(item);
            }
          });
        }
      }
      ...
      value: function tapEventOff(e) {
        ...
        if (babelHelpers.typeof(this.hoverClass) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {
          ...
          classes.forEach(function (item, index) {
            if (item != "") {
              _this2.shadowRoot.querySelector("#dialogtrigger").classList.remove(item);
            }
          });
        }
      }
          ...
          classes.forEach(function (item, index) {
            if (item != "") {
              if (_this3.focusState) {
                _this3.shadowRoot.querySelector("#dialogtrigger").classList.add(item);
              } else {
      ...
      value: function disconnectedCallback() {
        this.shadowRoot.querySelector("#dialogtrigger").removeEventListener("focused-changed", this.focusToggle.bind(this));
        this.shadowRoot.querySelector("#dialogtrigger").removeEventListener("mousedown", this.tapEventOn.bind(this));
        this.shadowRoot.querySelector("#dialogtrigger").removeEventListener("mouseover", this.tapEventOn.bind(this));
        this.shadowRoot.querySelector("#dialogtrigger").removeEventListener("mouseout", this.tapEventOff.bind(this));
        babelHelpers.get(babelHelpers.getPrototypeOf(LrnsysDialog.prototype), "disconnectedCallback", this).call(this);
      }
    }], [{
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_35e55e900b1311eaa3b2eff4bd15c191());
      }
    }, {
      key: "tag",
      get: function get() {
