define(["exports", "require", "../../../lit-element/lit-element.js", "../../simple-colors/simple-colors.js", "../../simple-modal/simple-modal.js", "../../simple-icon/simple-icon.js", "../../simple-icon/lib/simple-icons.js"], function (_exports, _require, _litElement, _simpleColors, _simpleModal, _simpleIcon, _simpleIcons) {
  ...
  function _templateObject2_bcfb22d03f0a11eba8d0ad72e7f54bf9() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <button\n        class=\"", "\"\n        id=\"dialogtrigger\"\n        @click=\"", "\"\n        @focus-changed=\"", "\"\n        @mousedown=\"", "\"\n        @mouseover=\"", "\"\n        @mouseout=\"", "\"\n        ?raised=\"", "\"\n        ?disabled=\"", "\"\n        title=\"", "\"\n        aria-label=\"", "\"\n      >\n        <lrnsys-button-inner\n          avatar=\"", "\"\n          icon=\"", "\"\n          text=\"", "\"\n        >\n          <slot name=\"button\"></slot>\n        </lrnsys-button-inner>\n      </button>\n      <simple-tooltip\n        for=\"dialogtrigger\"\n        animation-delay=\"0\"\n        ?hidden=\"", "\"\n        >", "</simple-tooltip\n      >\n    "]);

    _templateObject2_bcfb22d03f0a11eba8d0ad72e7f54bf9 = function _templateObject2_bcfb22d03f0a11eba8d0ad72e7f54bf9() {
      return data;
    };
  ...
  function _templateObject_bcfb22d03f0a11eba8d0ad72e7f54bf9() {
    ...
    _templateObject_bcfb22d03f0a11eba8d0ad72e7f54bf9 = function _templateObject_bcfb22d03f0a11eba8d0ad72e7f54bf9() {
      return data;
    };
  ...
  */
  var LrnsysDialog = /*#__PURE__*/function (_SimpleColors) {
    ...
    babelHelpers.createClass(LrnsysDialog, null, [{
       ...
       */
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(LrnsysDialog), "styles", this)), [(0, _litElement.css)(_templateObject_bcfb22d03f0a11eba8d0ad72e7f54bf9())]);
      }
      /**
       * HTMLElement
       */
    ...
    babelHelpers.createClass(LrnsysDialog, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_bcfb22d03f0a11eba8d0ad72e7f54bf9(), this.class, this.openDialog, this.focusToggle, this.tapEventOn, this.tapEventOn, this.tapEventOff, this.raised, this.disabled, this.alt, this.alt, this.avatar, this.icon, this.text, !this.alt, this.alt);
      }
    }, {
      key: "tapEventOn",
