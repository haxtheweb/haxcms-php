    ...
    babelHelpers.createClass(Confetti, [{
      ...
      value: function render() {
        ...
        this.confetti.forEach(function (confetto, index) {
          ...
          _this2.ctx.rotate(confetto.rotation);

          // update confetto "physics" values
          confetto.update();

          // get front or back fill color
          _this2.ctx.fillStyle = confetto.scale.y > 0 ? confetto.color.front : confetto.color.back;

          // draw confetto
          _this2.ctx.fillRect(-width / 2, -height / 2, width, height);
        ...
        this.sequins.forEach(function (sequin, index) {
          ...
          _this2.ctx.translate(sequin.position.x, sequin.position.y);

          // update sequin "physics" values
          sequin.update();

          // set the color
          _this2.ctx.fillStyle = sequin.color;
