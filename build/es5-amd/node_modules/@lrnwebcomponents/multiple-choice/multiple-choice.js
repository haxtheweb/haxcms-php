define(["exports", "meta", "require", "../../lit/index.js", "../schema-behaviors/schema-behaviors.js", "../simple-colors/simple-colors.js", "./lib/multiple-choice-response.js", "../simple-icon/simple-icon.js", "../simple-icon/lib/simple-icons.js", "../simple-fields/lib/simple-fields-field.js", "../simple-toolbar/lib/simple-toolbar-button.js", "../simple-toast/simple-toast.js"], function (_exports, meta, _require, _index, _schemaBehaviors, _simpleColors, _multipleChoiceResponse, _simpleIcon, _simpleIcons, _simpleFieldsField, _simpleToolbarButton, _simpleToast) {
  ...
  var _templateObject_c31aacf0a7e811ed8d60b559aaaec7a9, _templateObject2_c31aacf0a7e811ed8d60b559aaaec7a9, _templateObject3_c31aacf0a7e811ed8d60b559aaaec7a9, _templateObject4_c31aacf0a7e811ed8d60b559aaaec7a9, _templateObject5_c31aacf0a7e811ed8d60b559aaaec7a9;
    ...
    babelHelpers.createClass(MultipleChoice, [{
      ...
      value: function updated(changedProperties) {
        ...
        changedProperties.forEach(function (oldValue, propName) {
          ...
          if (propName == "title") _this2._setSlottedText(_this2.title, "question");
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_c31aacf0a7e811ed8d60b559aaaec7a9 || (_templateObject_c31aacf0a7e811ed8d60b559aaaec7a9 = babelHelpers.taggedTemplateLiteral(["\n      <confetti-container id=\"confetti\">\n        <meta property=\"oer:assessing\" content=\"", "\" />\n        <h3 id=\"question\" property=\"oer:name\"><slot name=\"question\"></slot></h3>\n        ", "\n      </confetti-container>\n    "])), this.relatedResource, this.editMode ? (0, _index.html)(_templateObject2_c31aacf0a7e811ed8d60b559aaaec7a9 || (_templateObject2_c31aacf0a7e811ed8d60b559aaaec7a9 = babelHelpers.taggedTemplateLiteral([" <div id=\"editMode\">\n              <slot name=\"question\"></slot>\n              <slot></slot>\n              <p class=\"feedback\">\n                <simple-icon\n                  icon=\"", "\"\n                  accent-color=\"green\"\n                  dark\n                ></simple-icon>\n                <slot name=\"correct-feedback\"></slot>\n              </p>\n              <p class=\"feedback\">\n                <simple-icon\n                  icon=\"", "\"\n                  accent-color=\"red\"\n                  dark\n                ></simple-icon>\n                <slot name=\"incorrect-feedback\"></slot>\n              </p>\n            </div>"])), this.correctIcon, this.incorrectIcon) : (0, _index.html)(_templateObject3_c31aacf0a7e811ed8d60b559aaaec7a9 || (_templateObject3_c31aacf0a7e811ed8d60b559aaaec7a9 = babelHelpers.taggedTemplateLiteral(["\n              <simple-fields-field\n                id=\"multiple-choice-question\"\n                aria-labelledby=\"question\"\n                block-options\n                ?disabled=\"", "\"\n                ?inline=\"", "\"\n                type=\"", "\"\n                .itemsList=\"", "\"\n                .value=\"", "\"\n                name=\"answers\"\n                @value-changed=\"", "\"\n              ></simple-fields-field>\n              ", "\n            "])), this.disabled, false, this.inputType, this.displayedAnswers, this.userGuess || [], this.checkedEvent, !this.hideButtons ? (0, _index.html)(_templateObject4_c31aacf0a7e811ed8d60b559aaaec7a9 || (_templateObject4_c31aacf0a7e811ed8d60b559aaaec7a9 = babelHelpers.taggedTemplateLiteral(["\n                    <div id=\"buttons\">\n                      <simple-toolbar-button\n                        id=\"check\"\n                        ?disabled=\"", "\"\n                        @click=\"", "\"\n                        label=\"", "\"\n                      >\n                      </simple-toolbar-button>\n                      <simple-toolbar-button\n                        id=\"reset\"\n                        ?disabled=\"", "\"\n                        @click=\"", "\"\n                        label=\"", "\"\n                      >\n                      </simple-toolbar-button>\n                    </div>\n                  "])), this.disabled, this._verifyAnswers, this.checkLabel, this.disabled, this.resetAnswers, this.resetLabel) : ""));
      }
    }, {
      key: "checkedEvent",
      ...
      value: function _handleSlotChange() {
        ...
        Object.keys(others).forEach(function (key) {
          ...
          if (!_this6.querySelector("[slot=".concat(others[key], "]")) && init) {
            _this6._setSlottedText(_this6[key], others[key], key == "question");
