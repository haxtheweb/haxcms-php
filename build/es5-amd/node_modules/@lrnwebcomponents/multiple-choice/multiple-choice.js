define(["exports", "require", "../../lit-element/lit-element.js", "../schema-behaviors/schema-behaviors.js", "../simple-colors/simple-colors.js", "../simple-icon/simple-icon.js", "../simple-icon/lib/simple-icons.js", "../simple-fields/lib/simple-fields-field.js", "../simple-toast/simple-toast.js"], function (_exports, _require, _litElement, _schemaBehaviors, _simpleColors, _simpleIcon, _simpleIcons, _simpleFieldsField, _simpleToast) {
  ...
  function _templateObject8_62b498303efe11eb800233a440abe59f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n              <div id=\"buttons\">\n                <button\n                  id=\"check\"\n                  ?disabled=\"", "\"\n                  @click=\"", "\"\n                >\n                  ", "\n                </button>\n                <button\n                  id=\"reset\"\n                  ?disabled=\"", "\"\n                  @click=\"", "\"\n                >\n                  ", "\n                </button>\n              </div>\n            "]);

    _templateObject8_62b498303efe11eb800233a440abe59f = function _templateObject8_62b498303efe11eb800233a440abe59f() {
      return data;
    };
  ...
  function _templateObject7_62b498303efe11eb800233a440abe59f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                    <li>\n                      <simple-fields-field\n                        ?disabled=\"", "\"\n                        property=\"oer:answer\"\n                        name=\"", "\"\n                        type=\"checkbox\"\n                        label=\"", "\"\n                        .value=\"", "\"\n                        @value-changed=\"", "\"\n                      ></simple-fields-field>\n                    </li>\n                  "]);

    _templateObject7_62b498303efe11eb800233a440abe59f = function _templateObject7_62b498303efe11eb800233a440abe59f() {
      return data;
    };
  ...
  function _templateObject6_62b498303efe11eb800233a440abe59f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n              <ul>\n                ", "\n              </ul>\n            "]);

    _templateObject6_62b498303efe11eb800233a440abe59f = function _templateObject6_62b498303efe11eb800233a440abe59f() {
      return data;
    };
  ...
  function _templateObject5_62b498303efe11eb800233a440abe59f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                  <simple-fields-field\n                    ?disabled=\"", "\"\n                    property=\"oer:answer\"\n                    type=\"radio\"\n                    name=\"", "\"\n                    .value=\"", "\"\n                    @value-changed=\"", "\"\n                    label=\"", "\"\n                  ></simple-fields-field>\n                "]);

    _templateObject5_62b498303efe11eb800233a440abe59f = function _templateObject5_62b498303efe11eb800233a440abe59f() {
      return data;
    };
  ...
  function _templateObject4_62b498303efe11eb800233a440abe59f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n              ", "\n            "]);

    _templateObject4_62b498303efe11eb800233a440abe59f = function _templateObject4_62b498303efe11eb800233a440abe59f() {
      return data;
    };
  ...
  function _templateObject3_62b498303efe11eb800233a440abe59f() {
    var data = babelHelpers.taggedTemplateLiteral([" <h3><span property=\"oer:name\">", "</span></h3> "]);

    _templateObject3_62b498303efe11eb800233a440abe59f = function _templateObject3_62b498303efe11eb800233a440abe59f() {
      return data;
    };
  ...
  function _templateObject2_62b498303efe11eb800233a440abe59f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <confetti-container id=\"confetti\">\n        <meta property=\"oer:assessing\" content=\"", "\" />\n        ", "\n        <div>", "</div>\n        ", "\n        ", "\n      </confetti-container>\n    "]);

    _templateObject2_62b498303efe11eb800233a440abe59f = function _templateObject2_62b498303efe11eb800233a440abe59f() {
      return data;
    };
  ...
  function _templateObject_62b498303efe11eb800233a440abe59f() {
    ...
    _templateObject_62b498303efe11eb800233a440abe59f = function _templateObject_62b498303efe11eb800233a440abe59f() {
      return data;
    };
  ...
  var MultipleChoice = /*#__PURE__*/function (_SchemaBehaviors) {
    ...
    babelHelpers.createClass(MultipleChoice, null, [{
       ...
       */
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(MultipleChoice), "styles", this)), [(0, _litElement.css)(_templateObject_62b498303efe11eb800233a440abe59f())]);
      }
    }, {
      key: "tag",
      get: function get() {
    ...
    babelHelpers.createClass(MultipleChoice, [{
      ...
      value: function render() {
        ...
        return (0, _litElement.html)(_templateObject2_62b498303efe11eb800233a440abe59f(), this.relatedResource, !this.hideTitle ? (0, _litElement.html)(_templateObject3_62b498303efe11eb800233a440abe59f(), this.title) : "", this.question, this.singleOption ? (0, _litElement.html)(_templateObject4_62b498303efe11eb800233a440abe59f(), this.displayedAnswers.map(function (answer, index) {
          return (0, _litElement.html)(_templateObject5_62b498303efe11eb800233a440abe59f(), _this3.disabled, index, answer.userGuess, _this3.checkedEvent, answer.label ? answer.label : "");
        })) : (0, _litElement.html)(_templateObject6_62b498303efe11eb800233a440abe59f(), this.displayedAnswers.map(function (answer, index) {
          return (0, _litElement.html)(_templateObject7_62b498303efe11eb800233a440abe59f(), _this3.disabled, index, answer.label ? answer.label : "", answer.userGuess, _this3.checkedEvent);
        })), !this.hideButtons ? (0, _litElement.html)(_templateObject8_62b498303efe11eb800233a440abe59f(), this.disabled, this._verifyAnswers, this.checkLabel, this.disabled, this.resetAnswers, this.resetLabel) : "");
      }
    }, {
      key: "checkedEvent",
