define(["exports", "../../lit/index.js", "../a11y-details/a11y-details.js"], function (_exports, _index, _a11yDetails) {
  ...
  var _templateObject_218509d0e8f211edb01b473406559cea, _templateObject2_218509d0e8f211edb01b473406559cea, _templateObject3_218509d0e8f211edb01b473406559cea;
  ...
  var A11yFigure = /*#__PURE__*/function (_A11yDetails) {
    ...
    babelHelpers.createClass(A11yFigure, [{
      ...
      // render function
      function render() {
        return (0, _index.html)(_templateObject_218509d0e8f211edb01b473406559cea || (_templateObject_218509d0e8f211edb01b473406559cea = babelHelpers.taggedTemplateLiteral(["\n      <figure>\n        ", "\n        <slot name=\"image\" ?hidden=\"", "\"></slot>\n        <figcaption>\n          <slot name=\"figcaption\"></slot>\n          <a11y-details\n            open-text=\"", "\"\n            close-text=\"", "\"\n            ?hidden=\"", "\"\n          >\n            <div slot=\"summary\"><slot name=\"summary\"></slot></div>\n            <div slot=\"details\"><slot name=\"details\"></slot></div>\n            <slot name=\"figdetails\"></slot>\n          </a11y-details>\n        </figcaption>\n      </figure>\n      <slot hidden></slot>\n    "])), this.imgSrc ? (0, _index.html)(_templateObject2_218509d0e8f211edb01b473406559cea || (_templateObject2_218509d0e8f211edb01b473406559cea = babelHelpers.taggedTemplateLiteral([" <img src=\"", "\" alt=\"", "\" /> "])), this.imgSrc, this.imgAlt) : "", this.imgSrc, this.openText, this.closeText, !this.__hasDetail);
      }
