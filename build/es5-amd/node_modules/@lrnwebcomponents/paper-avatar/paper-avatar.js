define(["exports", "meta", "../../lit-element/lit-element.js", "../es-global-bridge/es-global-bridge.js", "../simple-icon/simple-icon.js", "../simple-icon/lib/simple-icons.js", "./lib/md5.min.js"], function (_exports, meta, _litElement, _esGlobalBridge, _simpleIcon, _simpleIcons, md5) {
  ...
  function _templateObject5_d3550180247111eb9734a78ef81f0b0d() {
    ...
    _templateObject5_d3550180247111eb9734a78ef81f0b0d = function _templateObject5_d3550180247111eb9734a78ef81f0b0d() {
      return data;
    };
  ...
  function _templateObject4_d3550180247111eb9734a78ef81f0b0d() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            <img\n              id=\"img\"\n              loading=\"lazy\"\n              .src=\"", "\"\n              @load=\"", "\"\n              @error=\"", "\"\n              aria-hidden=\"true\"\n            />\n          "]);

    _templateObject4_d3550180247111eb9734a78ef81f0b0d = function _templateObject4_d3550180247111eb9734a78ef81f0b0d() {
      return data;
    };
  ...
  function _templateObject3_d3550180247111eb9734a78ef81f0b0d() {
    var data = babelHelpers.taggedTemplateLiteral(["\n              <span ?two-chars=\"", "\"\n                >", "\n              </span>\n            "]);

    _templateObject3_d3550180247111eb9734a78ef81f0b0d = function _templateObject3_d3550180247111eb9734a78ef81f0b0d() {
      return data;
    };
  ...
  function _templateObject2_d3550180247111eb9734a78ef81f0b0d() {
    var data = babelHelpers.taggedTemplateLiteral(["\n              <simple-icon\n                icon=\"", "\"\n                accent-color=\"", "\"\n              ></simple-icon>\n            "]);

    _templateObject2_d3550180247111eb9734a78ef81f0b0d = function _templateObject2_d3550180247111eb9734a78ef81f0b0d() {
      return data;
    };
  ...
  function _templateObject_d3550180247111eb9734a78ef81f0b0d() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <svg id=\"jdenticon\" width=\"40\" height=\"40\"><slot></slot></svg>\n      <div\n        id=\"label\"\n        title=\"", "\"\n        ?hidden=\"", "\"\n      >\n        ", "\n      </div>\n      ", "\n    "]);

    _templateObject_d3550180247111eb9734a78ef81f0b0d = function _templateObject_d3550180247111eb9734a78ef81f0b0d() {
      return data;
    };
  ...
  var PaperAvatar = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(PaperAvatar, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_d3550180247111eb9734a78ef81f0b0d(), this.label, this.jdenticonExists && this.jdenticon, this.icon ? (0, _litElement.html)(_templateObject2_d3550180247111eb9734a78ef81f0b0d(), this.icon, this.accentColor) : (0, _litElement.html)(_templateObject3_d3550180247111eb9734a78ef81f0b0d(), this.twoChars, this._label(this.label)), this.src ? (0, _litElement.html)(_templateObject4_d3550180247111eb9734a78ef81f0b0d(), this.src || "", this._onImgLoad, this._onImgError) : "");
      }
      /**
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject5_d3550180247111eb9734a78ef81f0b0d())];
      }
      /**
