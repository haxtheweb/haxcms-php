define(["exports", "meta", "../../lit-element/lit-element.js", "../es-global-bridge/es-global-bridge.js", "../simple-icon/lib/simple-icon-lite.js", "../simple-icon/lib/simple-icons.js", "./lib/md5.min.js"], function (_exports, meta, _litElement, _esGlobalBridge, _simpleIconLite, _simpleIcons, md5) {
  ...
  function _templateObject5_0ac396a0930211eb82a7a575782a1009() {
    ...
    _templateObject5_0ac396a0930211eb82a7a575782a1009 = function _templateObject5_0ac396a0930211eb82a7a575782a1009() {
      return data;
    };
  ...
  function _templateObject4_0ac396a0930211eb82a7a575782a1009() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            <img\n              id=\"img\"\n              loading=\"lazy\"\n              .src=\"", "\"\n              @load=\"", "\"\n              @error=\"", "\"\n              aria-hidden=\"true\"\n            />\n          "]);

    _templateObject4_0ac396a0930211eb82a7a575782a1009 = function _templateObject4_0ac396a0930211eb82a7a575782a1009() {
      return data;
    };
  ...
  function _templateObject3_0ac396a0930211eb82a7a575782a1009() {
    var data = babelHelpers.taggedTemplateLiteral(["\n              <span ?two-chars=\"", "\"\n                >", "\n              </span>\n            "]);

    _templateObject3_0ac396a0930211eb82a7a575782a1009 = function _templateObject3_0ac396a0930211eb82a7a575782a1009() {
      return data;
    };
  ...
  function _templateObject2_0ac396a0930211eb82a7a575782a1009() {
    var data = babelHelpers.taggedTemplateLiteral([" <simple-icon-lite icon=\"", "\"></simple-icon-lite> "]);

    _templateObject2_0ac396a0930211eb82a7a575782a1009 = function _templateObject2_0ac396a0930211eb82a7a575782a1009() {
      return data;
    };
  ...
  function _templateObject_0ac396a0930211eb82a7a575782a1009() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <svg id=\"jdenticon\" width=\"40\" height=\"40\"><slot></slot></svg>\n      <div\n        id=\"label\"\n        title=\"", "\"\n        ?hidden=\"", "\"\n      >\n        ", "\n      </div>\n      ", "\n    "]);

    _templateObject_0ac396a0930211eb82a7a575782a1009 = function _templateObject_0ac396a0930211eb82a7a575782a1009() {
      return data;
    };
  ...
  var PaperAvatar = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(PaperAvatar, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_0ac396a0930211eb82a7a575782a1009(), this.label, this.jdenticonExists && this.jdenticon, this.icon ? (0, _litElement.html)(_templateObject2_0ac396a0930211eb82a7a575782a1009(), this.icon) : (0, _litElement.html)(_templateObject3_0ac396a0930211eb82a7a575782a1009(), this.twoChars, this._label(this.label)), this.src ? (0, _litElement.html)(_templateObject4_0ac396a0930211eb82a7a575782a1009(), this.src || "", this._onImgLoad, this._onImgError) : "");
      }
      /**
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject5_0ac396a0930211eb82a7a575782a1009())];
      }
      /**
