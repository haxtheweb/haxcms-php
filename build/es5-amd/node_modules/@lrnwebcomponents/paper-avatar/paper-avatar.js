define(["exports", "meta", "../../lit-element/lit-element.js", "../es-global-bridge/es-global-bridge.js", "./lib/md5.min.js"], function (_exports, meta, _litElement, _esGlobalBridge, md5) {
  ...
  function _templateObject3_3a3e6ee0332811ea9673c9ed9148a8db() {
    ...
    _templateObject3_3a3e6ee0332811ea9673c9ed9148a8db = function _templateObject3_3a3e6ee0332811ea9673c9ed9148a8db() {
      return data;
    };
  ...
  function _templateObject2_3a3e6ee0332811ea9673c9ed9148a8db() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            <img\n              id=\"img\"\n              loading=\"lazy\"\n              src=\"", "\"\n              title=\"", "\"\n              @load=\"", "\"\n              @error=\"", "\"\n              alt=\"\"\n            />\n          "]);

    _templateObject2_3a3e6ee0332811ea9673c9ed9148a8db = function _templateObject2_3a3e6ee0332811ea9673c9ed9148a8db() {
      return data;
    };
  ...
  function _templateObject_3a3e6ee0332811ea9673c9ed9148a8db() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <div id=\"label\" title=\"", "\">\n        <span>", "</span>\n      </div>\n      <svg id=\"jdenticon\" width=\"40\" height=\"40\"><slot></slot></svg>\n      ", "\n    "]);

    _templateObject_3a3e6ee0332811ea9673c9ed9148a8db = function _templateObject_3a3e6ee0332811ea9673c9ed9148a8db() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(PaperAvatar, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_3a3e6ee0332811ea9673c9ed9148a8db(), this.label, this._label(this.label), this.src ? (0, _litElement.html)(_templateObject2_3a3e6ee0332811ea9673c9ed9148a8db(), this.src, this.label, this._onImgLoad, this._onImgError) : "");
      }
      /**
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject3_3a3e6ee0332811ea9673c9ed9148a8db())];
      }
      /**
