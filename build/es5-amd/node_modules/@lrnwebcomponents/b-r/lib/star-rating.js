define(["exports", "../../../lit-element/lit-element.js", "../../simple-icon/lib/simple-icon-button.js"], function (_exports, _litElement, _simpleIconButton) {
  ...
  var _templateObject_a77fe440b72d11eb858e736d8681b490, _templateObject2_a77fe440b72d11eb858e736d8681b490, _templateObject3_a77fe440b72d11eb858e736d8681b490, _templateObject4_a77fe440b72d11eb858e736d8681b490, _templateObject5_a77fe440b72d11eb858e736d8681b490, _templateObject6_a77fe440b72d11eb858e736d8681b490;
  ...
  var StarRating = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(StarRating, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_a77fe440b72d11eb858e736d8681b490 || (_templateObject_a77fe440b72d11eb858e736d8681b490 = babelHelpers.taggedTemplateLiteral(["\n      <div class=\"star-rating\">\n        <div id=\"stars\">\n          ", "\n        </div>\n        <div id=\"rating\">\n          <h2>", " (", "/", ")</h2>\n        </div>\n      </div>\n    "])), this.renderStar(this.numStars, this.interactive), this._calPercent, this.score, this.possible);
      }
    }, {
      key: "renderStar",
      value: function renderStar(amount, interactive) {
        if (amount === 0) {
          return (0, _litElement.html)(_templateObject2_a77fe440b72d11eb858e736d8681b490 || (_templateObject2_a77fe440b72d11eb858e736d8681b490 = babelHelpers.taggedTemplateLiteral([""])));
        }
        ...
        while (count < amount) {
          if (count + 1 < amount * this._calPercent) {
            content.push((0, _litElement.html)(_templateObject3_a77fe440b72d11eb858e736d8681b490 || (_templateObject3_a77fe440b72d11eb858e736d8681b490 = babelHelpers.taggedTemplateLiteral(["<simple-icon-button\n            icon=\"star\"\n            dark\n            contrast=\"1\"\n            class=\"star\"\n            ?disabled=\"", "\"\n          ></simple-icon-button>"])), !interactive));
          } else if (amount * this._calPercent - (count + 1) < -0.01 && amount * this._calPercent - (count + 1) >= -0.5) {
            content.push((0, _litElement.html)(_templateObject4_a77fe440b72d11eb858e736d8681b490 || (_templateObject4_a77fe440b72d11eb858e736d8681b490 = babelHelpers.taggedTemplateLiteral(["<simple-icon-button\n            icon=\"star-half\"\n            dark\n            contrast=\"1\"\n            class=\"star\"\n            ?disabled=\"", "\"\n          ></simple-icon-button>"])), !interactive));
          } else {
            content.push((0, _litElement.html)(_templateObject5_a77fe440b72d11eb858e736d8681b490 || (_templateObject5_a77fe440b72d11eb858e736d8681b490 = babelHelpers.taggedTemplateLiteral(["<simple-icon-button\n            icon=\"star-border\"\n            dark\n            contrast=\"1\"\n            class=\"star\"\n            ?disabled=\"", "\"\n          ></simple-icon-button>"])), !interactive));
          }
