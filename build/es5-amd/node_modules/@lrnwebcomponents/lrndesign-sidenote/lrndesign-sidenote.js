define(["exports","../../@polymer/polymer/polymer-legacy.js","../a11y-behaviors/a11y-behaviors.js","../materializecss-styles/materializecss-styles.js"],function(_exports,_polymerLegacy,_a11yBehaviors,_materializecssStyles){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.LrndesignSidenote=void 0;function _templateObject_e3b775b066f611e999fe19a29ec80b99(){var data=babelHelpers.taggedTemplateLiteral(["\n    <style>\n      :host {\n        display: block;\n        --container-bg-color: lightgray;\n        --container-text-color: black;\n        --container-padding: 16px;\n        --container-outset: 0;\n        @apply --host-styles;\n      }\n\n      #container {\n        display: block;\n        background: var(--container-bg-color);\n        color: var(--container-text-color);\n        padding: var(--container-padding);\n        margin-left: -var(--container-outset);\n        @apply --container-styles;\n      }\n\n      #header {\n        display: flex;\n        align-items: center;\n        @apply --container-header;\n      }\n\n      #icon {\n        margin-right: 8px;\n        @apply --icon-styles;\n      }\n\n      #label {\n        font-size: 20.8px;\n        margin: 12.8px 0;\n        flex: 1 1 auto;\n        @apply --label-styles;\n      }\n    </style>\n    <div id=\"container\">\n      <div id=\"header\">\n        <iron-icon id=\"icon\" icon=\"[[icon]]\" hidden$=\"[[!icon]]\"></iron-icon>\n        <div id=\"label\" hidden$=\"[[!label]]\">[[label]]</div>\n      </div>\n      <slot></slot>\n    </div>\n  "],["\n    <style>\n      :host {\n        display: block;\n        --container-bg-color: lightgray;\n        --container-text-color: black;\n        --container-padding: 16px;\n        --container-outset: 0;\n        @apply --host-styles;\n      }\n\n      #container {\n        display: block;\n        background: var(--container-bg-color);\n        color: var(--container-text-color);\n        padding: var(--container-padding);\n        margin-left: -var(--container-outset);\n        @apply --container-styles;\n      }\n\n      #header {\n        display: flex;\n        align-items: center;\n        @apply --container-header;\n      }\n\n      #icon {\n        margin-right: 8px;\n        @apply --icon-styles;\n      }\n\n      #label {\n        font-size: 20.8px;\n        margin: 12.8px 0;\n        flex: 1 1 auto;\n        @apply --label-styles;\n      }\n    </style>\n    <div id=\"container\">\n      <div id=\"header\">\n        <iron-icon id=\"icon\" icon=\"[[icon]]\" hidden\\$=\"[[!icon]]\"></iron-icon>\n        <div id=\"label\" hidden\\$=\"[[!label]]\">[[label]]</div>\n      </div>\n      <slot></slot>\n    </div>\n  "]);_templateObject_e3b775b066f611e999fe19a29ec80b99=function _templateObject_e3b775b066f611e999fe19a29ec80b99(){return data};return data}/**
`lrndesign-sidenote`
A basic side note

* @demo demo/index.html
*/var LrndesignSidenote=(0,_polymerLegacy.Polymer)({_template:(0,_polymerLegacy.html)(_templateObject_e3b775b066f611e999fe19a29ec80b99()),is:"lrndesign-sidenote",behaviors:[A11yBehaviors.A11y,MaterializeCSSBehaviors.ColorBehaviors],properties:{/**
     * The display label
