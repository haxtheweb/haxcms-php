define(["exports", "meta", "require", "../../lit/index.js", "../schema-behaviors/schema-behaviors.js", "../intersection-element/lib/IntersectionObserverMixin.js", "../i18n-manager/lib/I18NMixin.js"], function (_exports, meta, _require, _index, _schemaBehaviors, _IntersectionObserverMixin, _I18NMixin2) {
  ...
  var _templateObject_ae2e9fe03dcb11eda85b55760e74e9c4, _templateObject2_ae2e9fe03dcb11eda85b55760e74e9c4, _templateObject3_ae2e9fe03dcb11eda85b55760e74e9c4, _templateObject4_ae2e9fe03dcb11eda85b55760e74e9c4;
  ...
  var A11yGifPlayer = /*#__PURE__*/function (_I18NMixin) {
    ...
    babelHelpers.createClass(A11yGifPlayer, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_ae2e9fe03dcb11eda85b55760e74e9c4 || (_templateObject_ae2e9fe03dcb11eda85b55760e74e9c4 = babelHelpers.taggedTemplateLiteral(["", " "])), this.elementVisible ? (0, _index.html)(_templateObject2_ae2e9fe03dcb11eda85b55760e74e9c4 || (_templateObject2_ae2e9fe03dcb11eda85b55760e74e9c4 = babelHelpers.taggedTemplateLiteral(["\n          <div id=\"container\">\n            <slot hidden></slot>\n            <img\n              src=\"", "\"\n              alt=\"", "\"\n              loading=\"lazy\"\n              aria-describedby=\"", " ", "\"\n              slot=\"summary\"\n            />\n            ", "\n\n            <button\n              id=\"button\"\n              aria-controls=\"gif\"\n              aria-pressed=\"", "\"\n              @click=\"", "\"\n              ?disabled=\"", "\"\n              .style=\"background-image: url('", "')\"\n            >\n              <svg\n                id=\"svg\"\n                aria-hidden=\"true\"\n                xmlns=\"http://www.w3.org/2000/svg\"\n                viewBox=\"0 0 200 200\"\n              >\n                <g>\n                  <polygon points=\"30,20 30,180 170,100\"></polygon>\n                  <text x=\"50\" y=\"115\" font-size=\"40px\">GIF</text>\n                </g>\n              </svg>\n              <span class=\"sr-only\">\n                ", "\n              </span>\n            </button>\n            <a11y-details\n              id=\"longdesc\"\n              ?hidden=\"", "\"\n              .style=\"opacity:", "\"\n            >\n              <div slot=\"summary\">info</div>\n              <div slot=\"details\">", "</div>\n            </a11y-details>\n          </div>\n          <simple-tooltip for=\"button\" offset=\"30\" animation-delay=\"0\">\n            ", "\n          </simple-tooltip>\n        "])), this.__gifLoaded && this.__playing ? this.src : this.srcWithoutAnimation, this.alt, this.longdesc ? "longdesc" : "", (this.describedBy || "").trim(), this.__playing ? (0, _index.html)(_templateObject3_ae2e9fe03dcb11eda85b55760e74e9c4 || (_templateObject3_ae2e9fe03dcb11eda85b55760e74e9c4 = babelHelpers.taggedTemplateLiteral(["<img\n                  src=\"", "\"\n                  alt=\"\"\n                  hidden\n                  slot=\"summary\"\n                  @load=\"", "\"\n                />"])), this.src, this.__imageLoaded) : _index.nothing, this.__playing ? "true" : "false", this.toggle, this.disabled || !this.src, this.srcWithoutAnimation, this.__playing && this.tooltipPlaying ? this.tooltipPlaying : this.tooltip, !this.src || !this.longdesc, this.__playing ? 0 : 1, this.longdesc, this.__playing && this.tooltipPlaying ? this.tooltipPlaying : this.tooltip) : _index.nothing);
      }
      /**
       * Convention
       */
