define(["exports", "require", "../../lit-element/lit-element.js", "../schema-behaviors/schema-behaviors.js", "../a11y-details/a11y-details.js"], function (_exports, _require, _litElement, _schemaBehaviors, _a11yDetails) {
  ...
  function _templateObject2_623e6de0bff611eaa5854beb4e0c914c() {
    ...
    _templateObject2_623e6de0bff611eaa5854beb4e0c914c = function _templateObject2_623e6de0bff611eaa5854beb4e0c914c() {
      return data;
    };
  ...
  function _templateObject_623e6de0bff611eaa5854beb4e0c914c() {
    ...
    _templateObject_623e6de0bff611eaa5854beb4e0c914c = function _templateObject_623e6de0bff611eaa5854beb4e0c914c() {
      return data;
    };
  ...
  function (_SchemaBehaviors) {
    ...
    babelHelpers.createClass(A11yGifPlayer, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_623e6de0bff611eaa5854beb4e0c914c(), this.src, this.alt, this.longdesc ? "longdesc" : "", (this.describedBy || "").trim(), !this.src, this.__playing ? "true" : "false", this.toggle, this.disabled || !this.src, this.srcWithoutAnimation, this.__playing && this.tooltipPlaying ? this.tooltipPlaying : this.tooltip, !this.src || !this.longdesc, this.__playing ? 0 : 1, this.longdesc, this.__playing && this.tooltipPlaying ? this.tooltipPlaying : this.tooltip);
      }
      /**
       * Convention
       */
      ...
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_623e6de0bff611eaa5854beb4e0c914c())];
      }
    }, {
      key: "tag",
      get: function get() {
