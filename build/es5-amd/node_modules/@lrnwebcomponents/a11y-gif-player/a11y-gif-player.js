define(["exports", "meta", "require", "../../lit/index.js", "../schema-behaviors/schema-behaviors.js", "../intersection-element/lib/IntersectionObserverMixin.js", "../i18n-manager/lib/I18NMixin.js"], function (_exports, meta, _require, _index, _schemaBehaviors, _IntersectionObserverMixin, _I18NMixin2) {
  ...
  var _templateObject_ed70bba0e8e011ed8789699b2ad5335a, _templateObject2_ed70bba0e8e011ed8789699b2ad5335a, _templateObject3_ed70bba0e8e011ed8789699b2ad5335a, _templateObject4_ed70bba0e8e011ed8789699b2ad5335a;
  ...
  var A11yGifPlayer = /*#__PURE__*/function (_I18NMixin) {
    ...
    babelHelpers.createClass(A11yGifPlayer, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_ed70bba0e8e011ed8789699b2ad5335a || (_templateObject_ed70bba0e8e011ed8789699b2ad5335a = babelHelpers.taggedTemplateLiteral(["", " "])), this.elementVisible ? (0, _index.html)(_templateObject2_ed70bba0e8e011ed8789699b2ad5335a || (_templateObject2_ed70bba0e8e011ed8789699b2ad5335a = babelHelpers.taggedTemplateLiteral(["\n          <div id=\"container\">\n            <slot hidden></slot>\n            <img\n              src=\"", "\"\n              alt=\"", "\"\n              loading=\"lazy\"\n              aria-describedby=\"", " ", "\"\n              slot=\"summary\"\n            />\n            ", "\n\n            <button\n              id=\"button\"\n              aria-controls=\"gif\"\n              aria-pressed=\"", "\"\n              @click=\"", "\"\n              ?disabled=\"", "\"\n              .style=\"background-image: url('", "')\"\n            >\n              <svg\n                id=\"svg\"\n                aria-hidden=\"true\"\n                xmlns=\"http://www.w3.org/2000/svg\"\n                viewBox=\"0 0 200 200\"\n              >\n                <g>\n                  <polygon points=\"30,20 30,180 170,100\"></polygon>\n                  <text x=\"50\" y=\"115\" font-size=\"40px\">GIF</text>\n                </g>\n              </svg>\n            </button>\n            <a11y-details\n              id=\"longdesc\"\n              ?hidden=\"", "\"\n              .style=\"opacity:", "\"\n            >\n              <div slot=\"summary\">info</div>\n              <div slot=\"details\">", "</div>\n            </a11y-details>\n          </div>\n        "])), this.__gifLoaded && this.__playing ? this.src : this.srcWithoutAnimation, this.alt, this.longdesc ? "longdesc" : "", (this.describedBy || "").trim(), this.__playing ? (0, _index.html)(_templateObject3_ed70bba0e8e011ed8789699b2ad5335a || (_templateObject3_ed70bba0e8e011ed8789699b2ad5335a = babelHelpers.taggedTemplateLiteral(["<img\n                  src=\"", "\"\n                  alt=\"\"\n                  hidden\n                  slot=\"summary\"\n                  @load=\"", "\"\n                />"])), this.src, this.__imageLoaded) : "", this.__playing ? "true" : "false", this.toggle, this.disabled || !this.src, this.srcWithoutAnimation, !this.src || !this.longdesc, this.__playing ? 0 : 1, this.longdesc) : "");
      }
      /**
       * Convention
       */
      ...
      function updated(changedProperties) {
        ...
        changedProperties.forEach(function (oldValue, propName) {
          ...
          if (propName === "elementVisible" && _this2[propName]) {
            ...
            if (_this2.shadowRoot && !_this2.srcWithoutAnimation && _this2.src) {
              // import registry
              new Promise(function (res, rej) {
                return _require.default(["../micro-frontend-registry/micro-frontend-registry.js"], res, rej);
              }).then(function () {
                _this2._automaticStill = true;
                _this2.srcWithoutAnimation = _this2.generateStill(_this2.src);
              });
            }
          }
          // support src changing after the fact, we are visible, and set to automatic generation
          if (_this2.shadowRoot && propName === "src" && _this2[propName] && _this2.elementVisible && _this2._automaticStill) {
            _this2.srcWithoutAnimation = _this2.generateStill(_this2.src);
          }
        });
      }
      ...
      key: "generateStill",
      value: function generateStill(src) {
