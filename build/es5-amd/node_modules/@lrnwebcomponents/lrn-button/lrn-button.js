define(["exports", "../../lit/index.js", "../simple-tooltip/simple-tooltip.js", "../simple-icon/lib/simple-icon-lite.js", "../simple-icon/lib/simple-icons.js", "../simple-colors/simple-colors.js"], function (_exports, _index, _simpleTooltip, _simpleIconLite, _simpleIcons, _simpleColors) {
  ...
  var _templateObject_8d5e2320403311edb9fff3e6b08a0a9a, _templateObject2_8d5e2320403311edb9fff3e6b08a0a9a, _templateObject3_8d5e2320403311edb9fff3e6b08a0a9a, _templateObject4_8d5e2320403311edb9fff3e6b08a0a9a;
  ...
  var LrnButton = /*#__PURE__*/function (_SimpleColors) {
    ...
    babelHelpers.createClass(LrnButton, [{
      ...
      function render() {
        return (0, _index.html)(_templateObject_8d5e2320403311edb9fff3e6b08a0a9a || (_templateObject_8d5e2320403311edb9fff3e6b08a0a9a = babelHelpers.taggedTemplateLiteral([" <a\n        tabindex=\"-1\"\n        id=\"lrnsys-button-link\"\n        href=\"", "\"\n        data-prefetch-hover=\"", "\"\n        target=\"", "\"\n      >\n        <button\n          id=\"button\"\n          raised=\"", "\"\n          class=\"", "\"\n          ?disabled=\"", "\"\n        >\n          <div class=\"inner ", "\">\n            ", "\n            ", "\n            <slot></slot>\n          </div>\n        </button>\n      </a>\n      <simple-tooltip for=\"lrnsys-button-link\" animation-delay=\"0\"\n        >", "</simple-tooltip\n      >"])), this.showHref, this.prefetch, this.target, this.raised, this.class, this.disabled, this.innerClass, this.icon ? (0, _index.html)(_templateObject2_8d5e2320403311edb9fff3e6b08a0a9a || (_templateObject2_8d5e2320403311edb9fff3e6b08a0a9a = babelHelpers.taggedTemplateLiteral(["\n                  <simple-icon-lite\n                    icon=\"", "\"\n                    id=\"icon\"\n                  ></simple-icon-lite>\n                "])), this.icon) : "", this.label ? (0, _index.html)(_templateObject3_8d5e2320403311edb9fff3e6b08a0a9a || (_templateObject3_8d5e2320403311edb9fff3e6b08a0a9a = babelHelpers.taggedTemplateLiteral([" <span class=\"label\"> ", " </span>"])), this.label) : "", this.alt);
