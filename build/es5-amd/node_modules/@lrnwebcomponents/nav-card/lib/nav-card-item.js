define(["exports", "../../../lit-element/lit-element.js", "../../simple-icon/simple-icon.js", "../../simple-icon/lib/simple-icons.js", "../../lrndesign-avatar/lrndesign-avatar.js"], function (_exports, _litElement, _simpleIcon, _simpleIcons, _lrndesignAvatar) {
  ...
  function _templateObject4_df547290247111eb9734a78ef81f0b0d() {
    ...
    _templateObject4_df547290247111eb9734a78ef81f0b0d = function _templateObject4_df547290247111eb9734a78ef81f0b0d() {
      return data;
    };
  ...
  function _templateObject3_df547290247111eb9734a78ef81f0b0d() {
    var data = babelHelpers.taggedTemplateLiteral([" <simple-icon icon=\"", "\"></simple-icon> "]);

    _templateObject3_df547290247111eb9734a78ef81f0b0d = function _templateObject3_df547290247111eb9734a78ef81f0b0d() {
      return data;
    };
  ...
  function _templateObject2_df547290247111eb9734a78ef81f0b0d() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            <lrndesign-avatar\n              .accentColor=\"", "\"\n              ?allow-grey=\"", "\"\n              ?dark=\"", "\"\n              .icon=\"", "\"\n              ?invert=\"", "\"\n              .src=\"", "\"\n              .label=\"", "\"\n              ?two-chars=\"", "\"\n            >\n            </lrndesign-avatar>\n          "]);

    _templateObject2_df547290247111eb9734a78ef81f0b0d = function _templateObject2_df547290247111eb9734a78ef81f0b0d() {
      return data;
    };
  ...
  function _templateObject_df547290247111eb9734a78ef81f0b0d() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      ", "\n      <div>\n        <slot name=\"label\"></slot>\n        <slot name=\"description\"></slot>\n      </div>\n      ", "\n    "]);

    _templateObject_df547290247111eb9734a78ef81f0b0d = function _templateObject_df547290247111eb9734a78ef81f0b0d() {
      return data;
    };
  ...
  var NavCardItem = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(NavCardItem, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_df547290247111eb9734a78ef81f0b0d(), !this.avatar && !this.initials ? "" : (0, _litElement.html)(_templateObject2_df547290247111eb9734a78ef81f0b0d(), this.accentColor || "", this.allowGrey, this.dark, this.ico, this.invert, this.src, this.label, this.twoChars), !this.icon ? "" : (0, _litElement.html)(_templateObject3_df547290247111eb9734a78ef81f0b0d(), this.icon));
      } // life cycle
      ...
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject4_df547290247111eb9734a78ef81f0b0d())];
      }
    }]);
