define(["exports", "require", "../../../lit-element/lit-element.js", "../../utils/utils.js", "../../../@material/mwc-button/mwc-button.js", "../../simple-modal/simple-modal.js", "../../hexagon-loader/hexagon-loader.js", "../product-card.js"], function (_exports, _require, _litElement, _utils, _mwcButton, _simpleModal, _hexagonLoader, _productCard) {
  ...
  function _templateObject8_842a82e0bff611eaa5854beb4e0c914c() {
    ...
    _templateObject8_842a82e0bff611eaa5854beb4e0c914c = function _templateObject8_842a82e0bff611eaa5854beb4e0c914c() {
      return data;
    };
  ...
  function _templateObject7_842a82e0bff611eaa5854beb4e0c914c() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                              <mwc-button\n                                data-tag=\"", "\"\n                                outlined\n                                @click=\"", "\"\n                                >Pop up demo</mwc-button\n                              >\n                              <div class=\"demo\">\n                                ", "\n                              </div>\n                              <code-sample copy-clipboard-button>\n                                <template>\n                                  ", "\n                                </template>\n                              </code-sample>\n                            "]);

    _templateObject7_842a82e0bff611eaa5854beb4e0c914c = function _templateObject7_842a82e0bff611eaa5854beb4e0c914c() {
      return data;
    };
  ...
  function _templateObject6_842a82e0bff611eaa5854beb4e0c914c() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                          ", "\n                        "]);

    _templateObject6_842a82e0bff611eaa5854beb4e0c914c = function _templateObject6_842a82e0bff611eaa5854beb4e0c914c() {
      return data;
    };
  ...
  function _templateObject5_842a82e0bff611eaa5854beb4e0c914c() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                                <li>\n                                  <strong>", ":</strong>\n                                  <span>", "</span>\n                                </li>\n                              "]);

    _templateObject5_842a82e0bff611eaa5854beb4e0c914c = function _templateObject5_842a82e0bff611eaa5854beb4e0c914c() {
      return data;
    };
  ...
  function _templateObject4_842a82e0bff611eaa5854beb4e0c914c() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                            ", "\n                          "]);

    _templateObject4_842a82e0bff611eaa5854beb4e0c914c = function _templateObject4_842a82e0bff611eaa5854beb4e0c914c() {
      return data;
    };
  ...
  function _templateObject3_842a82e0bff611eaa5854beb4e0c914c() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                              ", ",\n                            "]);

    _templateObject3_842a82e0bff611eaa5854beb4e0c914c = function _templateObject3_842a82e0bff611eaa5854beb4e0c914c() {
      return data;
    };
  ...
  function _templateObject2_842a82e0bff611eaa5854beb4e0c914c() {
    ...
    _templateObject2_842a82e0bff611eaa5854beb4e0c914c = function _templateObject2_842a82e0bff611eaa5854beb4e0c914c() {
      return data;
    };
  ...
  function _templateObject_842a82e0bff611eaa5854beb4e0c914c() {
    ...
    _templateObject_842a82e0bff611eaa5854beb4e0c914c = function _templateObject_842a82e0bff611eaa5854beb4e0c914c() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(HAXElementCardList, [{
      ...
      value: function render() {
        ...
        return !this.showCardList ? "" : (0, _litElement.html)(_templateObject_842a82e0bff611eaa5854beb4e0c914c(), !this.loading, this.loading, this.cols, this.productList.map(function (el, i) {
          return (0, _litElement.html)(_templateObject2_842a82e0bff611eaa5854beb4e0c914c(), _this2.__getCol(i), !el.status, !(_this2.filteredTags && _this2.filteredTags.includes(el.tag)), el.schema.demoSchema, el.schema.gizmo.title, el.schema.gizmo.icon, el.schema.gizmo.description, el.schema.gizmo.color, function (e) {
            ...
            return (0, _litElement.html)(_templateObject3_842a82e0bff611eaa5854beb4e0c914c(), group);
          }), el.tag, el.file, el.schema.gizmo.meta ? (0, _litElement.html)(_templateObject4_842a82e0bff611eaa5854beb4e0c914c(), Object.keys(el.schema.gizmo.meta).map(function (mel) {
            return (0, _litElement.html)(_templateObject5_842a82e0bff611eaa5854beb4e0c914c(), _this2.capFirst(mel), el.schema.gizmo.meta[mel]);
          })) : "", el.schema.demoSchema && el.showDemo ? (0, _litElement.html)(_templateObject6_842a82e0bff611eaa5854beb4e0c914c(), el.schema.demoSchema.map(function (demoItem) {
            return (0, _litElement.html)(_templateObject7_842a82e0bff611eaa5854beb4e0c914c(), demoItem.tag, _this2._viewDemo, _this2._haxElementToNode(demoItem), _this2._haxElementToNode(demoItem));
          })) : "");
        }));
      }
      /**
      ...
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject8_842a82e0bff611eaa5854beb4e0c914c())];
      }
    }, {
      key: "properties",
      get: function get() {
