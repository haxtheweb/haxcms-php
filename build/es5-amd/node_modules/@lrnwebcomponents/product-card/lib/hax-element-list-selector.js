define(["meta", "require", "../../../lit/index.js", "../../simple-icon/simple-icon.js", "../../simple-icon/lib/simple-icons.js", "../../simple-icon/lib/simple-icon-button.js", "../../hax-iconset/lib/simple-hax-iconset.js", "../../hax-body-behaviors/lib/HAXFields.js", "../../simple-fields/simple-fields.js", "../../simple-fields/lib/simple-fields-form.js", "./hax-element-card-list.js"], function (meta, _require, _index, _simpleIcon, _simpleIcons, _simpleIconButton, _simpleHaxIconset, _HAXFields, _simpleFields, _simpleFieldsForm, _haxElementCardList) {
  ...
  var _templateObject_fce1dbc0e46a11edbf2e2349c355f24c, _templateObject2_fce1dbc0e46a11edbf2e2349c355f24c;
  ...
  var HaxElementListSelector = /*#__PURE__*/function (_LitElement) {
    ...
    function HaxElementListSelector() {
      ...
      _this.fieldsEndpoint = new URL("./fields.json", meta.url).href;
    ...
    babelHelpers.createClass(HaxElementListSelector, [{
      ...
      value: function render() {
        var _this2 = this;
        return (0, _index.html)(_templateObject_fce1dbc0e46a11edbf2e2349c355f24c || (_templateObject_fce1dbc0e46a11edbf2e2349c355f24c = babelHelpers.taggedTemplateLiteral(["\n      <simple-fields-form\n        id=\"form\"\n        autoload\n        load-endpoint=\"", "\"\n        method=\"", "\"\n        .schematizer=\"", "\"\n        .elementizer=\"", "\"\n        @response=\"", "\"\n        @haxcore.search.haxcore-search-columns-value-changed=\"", "\"\n        @value-changed=\"", "\"\n      >\n      </simple-fields-form>\n    "])), this.fieldsEndpoint, this.method, this.HaxSchematizer, this.HaxElementizer, this._response, function (e) {
      ...
      value: function updated(changedProperties) {
        ...
        changedProperties.forEach( /*#__PURE__*/function () {
          var _ref = babelHelpers.asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(oldValue, propName) {
            var list, noSchema, _loop, tag, renderHaxData, i, search;
      ...
      value: function _valueChanged() {
        ...
        this.__valueDebounce = setTimeout(function () {
          ...
          if (haxcore) {
            var cols = haxcore.search && haxcore.search["haxcore-search-columns"] ? haxcore.search["haxcore-search-columns"] : undefined;
            //set columns
            if (cols) _this4.cols = cols;
      ...
      key: "styles",
      get: function get() {
        return [(0, _index.css)(_templateObject2_fce1dbc0e46a11edbf2e2349c355f24c || (_templateObject2_fce1dbc0e46a11edbf2e2349c355f24c = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n      "])))];
      }
    }, {
      key: "properties",
      get: function get() {
