define(["exports","require","../../lit-element/lit-element.js","../../@polymer/iron-ajax/iron-ajax.js","../h-a-x/h-a-x.js"],function(_exports,_require,_litElement,_ironAjax,_hAX){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.CmsHax=void 0;_require=babelHelpers.interopRequireWildcard(_require);function _templateObject2_126825705e1911eaa205e56db4f8cf1d(){var data=babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n          font-size: 16px;\n          box-sizing: content-box;\n        }\n      "]);_templateObject2_126825705e1911eaa205e56db4f8cf1d=function _templateObject2_126825705e1911eaa205e56db4f8cf1d(){return data};return data}function _templateObject_126825705e1911eaa205e56db4f8cf1d(){var data=babelHelpers.taggedTemplateLiteral(["\n      <iron-ajax\n        id=\"pageupdateajax\"\n        url=\"","\"\n        method=\"","\"\n        content-type=\"application/json\"\n        handle-as=\"json\"\n        @response=\"","\"\n      ></iron-ajax>\n      <h-a-x app-store=\"","\"></h-a-x>\n    "]);_templateObject_126825705e1911eaa205e56db4f8cf1d=function _templateObject_126825705e1911eaa205e56db4f8cf1d(){return data};return data}/**
 * `cms-hax`
 * @customElement cms-hax
 * @demo ../../demo/index.html
 */var CmsHax=/*#__PURE__*/function(_LitElement){babelHelpers.inherits(CmsHax,_LitElement);babelHelpers.createClass(CmsHax,[{key:"render",value:function render(){return(0,_litElement.html)(_templateObject_126825705e1911eaa205e56db4f8cf1d(),this.endPoint,this.method,this._handleUpdateResponse,this.__appStore)}},{key:"decodeHTMLEntities",value:function decodeHTMLEntities(text){for(var entities=[["amp","&"],["apos","'"],["#x27","'"],["#x2F","/"],["#39","'"],["#47","/"],["lt","<"],["gt",">"],["nbsp"," "],["quot","\""]],i=0,max=entities.length;i<max;++i){text=text.replace(new RegExp("&"+entities[i][0]+";","g"),entities[i][1])}return text}},{key:"_activeHaxBodyUpdated",/**
...
_this2._noticeTagChanges(_this2.openDefault,_this2.allowedTags,_this2.hidePanelOps,_this2.hidePreferencesButton,_this2.align);_this2.__applyMO()},0)}/**
   ...
   */get:function get(){return[(0,_litElement.css)(_templateObject2_126825705e1911eaa205e56db4f8cf1d())]}},{key:"tag",get:function get(){return"cms-hax"}},{key:"properties",get:function get(){return{__ready:{type:Boolean},/**
