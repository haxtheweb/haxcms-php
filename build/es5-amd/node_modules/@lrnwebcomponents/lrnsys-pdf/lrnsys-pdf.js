define(["exports", "require", "../../@polymer/polymer/polymer-element.js", "../schema-behaviors/schema-behaviors.js"], function (_exports, _require, _polymerElement, _schemaBehaviors) {
  ...
  var _templateObject_e16f3bf0e4f411ed85766367b4d3e9fc;
  ...
  var LrnsysPdf = /*#__PURE__*/function (_SchemaBehaviors) {
    ...
    babelHelpers.createClass(LrnsysPdf, [{
      ...
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_e16f3bf0e4f411ed85766367b4d3e9fc || (_templateObject_e16f3bf0e4f411ed85766367b4d3e9fc = babelHelpers.taggedTemplateLiteral(["\n      <style>\n        :host {\n          display: block;\n        }\n      </style>\n      <h2>[[title]]</h2>\n      <pdf-browser-viewer\n        id=\"pdfViewer\"\n        file=\"[[file]]#page=[[page]]\"\n        width=\"100%\"\n        card=\"[[card]]\"\n        elevation=\"2\"\n        download-label=\"[[downloadLabel]]\"\n      ></pdf-browser-viewer>\n    "])));
      }
    }, {
      key: "tag",
      get: function get() {
