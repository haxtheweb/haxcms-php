define(["exports", "require", "../../lit/index.js", "../simple-icon/simple-icon.js", "../simple-icon/lib/simple-icons.js", "../simple-icon/lib/simple-icon-button.js"], function (_exports, _require, _index, _simpleIcon, _simpleIcons, _simpleIconButton) {
  ...
  var _templateObject_3ce820003dd411edbfe5e9c0d97d003a, _templateObject2_3ce820003dd411edbfe5e9c0d97d003a;
  ...
  var LrnappFabMenu = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(LrnappFabMenu, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_3ce820003dd411edbfe5e9c0d97d003a || (_templateObject_3ce820003dd411edbfe5e9c0d97d003a = babelHelpers.taggedTemplateLiteral(["\n      <simple-icon-button\n        icon=\"", "\"\n        class=\"open\"\n        @click=\"", "\"\n        ?hidden=\"", "\"\n        ?disabled=\"", "\"\n      ></simple-icon-button>\n\n      <paper-fab-speed-dial-overlay\n        class=\"overlay\"\n        ?opened=\"", "\"\n        @opened-changed=\"", "\"\n        with-backdrop\n      >\n        <slot></slot>\n        <simple-icon-button\n          icon=\"close\"\n          class=\"close\"\n          @click=\"", "\"\n        ></simple-icon-button>\n      </paper-fab-speed-dial-overlay>\n    "])), this.icon, this.open, this.opened, this.disabled, this.opened, this.openedChangedEvent, this.close);
      }
    }, {
