define(["exports", "require", "../../lit-element/lit-element.js", "../simple-icon/simple-icon.js", "../simple-icon/lib/simple-icons.js", "../simple-icon/lib/simple-icon-button.js"], function (_exports, _require, _litElement, _simpleIcon, _simpleIcons, _simpleIconButton) {
  ...
  function _templateObject2_c4cc48808b3211ebb67059cf696085af() {
    ...
    _templateObject2_c4cc48808b3211ebb67059cf696085af = function _templateObject2_c4cc48808b3211ebb67059cf696085af() {
      return data;
    };
  ...
  function _templateObject_c4cc48808b3211ebb67059cf696085af() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <simple-icon-button\n        icon=\"", "\"\n        class=\"open\"\n        @click=\"", "\"\n        ?hidden=\"", "\"\n        ?disabled=\"", "\"\n      ></simple-icon-button>\n\n      <paper-fab-speed-dial-overlay\n        class=\"overlay\"\n        ?opened=\"", "\"\n        @opened-changed=\"", "\"\n        with-backdrop\n      >\n        <slot></slot>\n        <simple-icon-button\n          icon=\"close\"\n          class=\"close\"\n          @click=\"", "\"\n        ></simple-icon-button>\n      </paper-fab-speed-dial-overlay>\n    "]);

    _templateObject_c4cc48808b3211ebb67059cf696085af = function _templateObject_c4cc48808b3211ebb67059cf696085af() {
      return data;
    };
  ...
  var LrnappFabMenu = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(LrnappFabMenu, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_c4cc48808b3211ebb67059cf696085af(), this.icon, this.open, this.opened, this.disabled, this.opened, this.openedChangedEvent, this.close);
      }
    }, {
      ...
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_c4cc48808b3211ebb67059cf696085af())];
      }
    }, {
      key: "tag",
      get: function get() {
