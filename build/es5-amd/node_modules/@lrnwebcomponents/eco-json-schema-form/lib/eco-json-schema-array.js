...
*/(0,_polymerLegacy.Polymer)({is:"eco-json-schema-array",_template:(0,_polymerLegacy.html)(_templateObject_f311d3106a8f11e9a3fbc91c56f16a14()),properties:{schema:{type:Object,notify:!0,observer:"_schemaChanged"},label:{type:String},value:{type:Array,notify:!0,value:function value(){return[]},observer:"_valueChanged"},error:{type:Object,observer:"_errorChanged"},_schemaArrayItems:{type:Array,notify:!0}},observers:["_schemaArraySplicesChanged(_schemaArrayItems.splices)"],/**
