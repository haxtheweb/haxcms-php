...
*/(0,_polymerLegacy.Polymer)({is:"eco-json-schema-array",_template:(0,_polymerLegacy.html)(_templateObject_140a5ca0620611e99fc533744445c188()),properties:{schema:{type:Object,notify:!0,observer:"_schemaChanged"},label:{type:String},value:{type:Array,notify:!0,value:function value(){return[]},observer:"_valueChanged"},error:{type:Object,observer:"_errorChanged"},_schemaArrayItems:{type:Array,notify:!0}},observers:["_schemaArraySplicesChanged(_schemaArrayItems.splices)"],/**
