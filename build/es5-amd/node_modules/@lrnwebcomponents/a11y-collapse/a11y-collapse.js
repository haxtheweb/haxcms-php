define(["exports", "meta", "../../lit/index.js", "../simple-icon/lib/simple-icon-button-lite.js", "../simple-icon/lib/simple-icon-lite.js", "../simple-icon/lib/simple-icons.js", "../simple-tooltip/simple-tooltip.js"], function (_exports, meta, _index, _simpleIconButtonLite, _simpleIconLite, _simpleIcons, _simpleTooltip) {
  ...
  var _templateObject_8baf8ad0b48911edaa972d5aad30d551, _templateObject2_8baf8ad0b48911edaa972d5aad30d551, _templateObject3_8baf8ad0b48911edaa972d5aad30d551, _templateObject4_8baf8ad0b48911edaa972d5aad30d551, _templateObject5_8baf8ad0b48911edaa972d5aad30d551, _templateObject6_8baf8ad0b48911edaa972d5aad30d551, _templateObject7_8baf8ad0b48911edaa972d5aad30d551;
  ...
  var A11yCollapse = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(A11yCollapse, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_8baf8ad0b48911edaa972d5aad30d551 || (_templateObject_8baf8ad0b48911edaa972d5aad30d551 = babelHelpers.taggedTemplateLiteral(["\n      ", "\n      <div\n        id=\"content\"\n        aria-hidden=\"", "\"\n        aria-labelledby=\"heading\"\n        aria-live=\"polite\"\n      >\n        <div id=\"content-inner\">\n          ", "\n        </div>\n      </div>\n    "])), this.headingButton || this.accordion ? this._makeHeadingButton() : this._makeIconButton(), this.expanded ? "false" : "true", this.expanded ? (0, _index.html)(_templateObject2_8baf8ad0b48911edaa972d5aad30d551 || (_templateObject2_8baf8ad0b48911edaa972d5aad30d551 = babelHelpers.taggedTemplateLiteral(["<slot name=\"content\"></slot><slot></slot>"]))) : "");
      }
    }, {
      ...
      value: function _makeHeadingButton() {
        return (0, _index.html)(_templateObject3_8baf8ad0b48911edaa972d5aad30d551 || (_templateObject3_8baf8ad0b48911edaa972d5aad30d551 = babelHelpers.taggedTemplateLiteral(["\n      <div\n        id=\"heading\"\n        aria-controls=\"content\"\n        aria-expanded=\"", "\"\n        role=\"button\"\n        @click=\"", "\"\n        ?disabled=\"", "\"\n        .label=\"", "\"\n      >\n        <div id=\"text\">\n          ", "<slot name=\"heading\"></slot>\n        </div>\n        <simple-icon-lite\n          id=\"expand\"\n          class=\"", "\"\n          .icon=\"", "\"\n          aria-hidden=\"true\"\n        >\n        </simple-icon-lite>\n      </div>\n      <simple-tooltip for=\"heading\"\n        >", "</simple-tooltip\n      >\n    "])), this.expanded ? "true" : "false", this._onClick, this.disabled, this._getExpanded(this.label, this.labelExpanded, this.expanded), this.heading ? (0, _index.html)(_templateObject4_8baf8ad0b48911edaa972d5aad30d551 || (_templateObject4_8baf8ad0b48911edaa972d5aad30d551 = babelHelpers.taggedTemplateLiteral(["<p part=\"heading\">", "</p>"])), this.heading) : "", !this.expanded && !this.iconExpanded ? "rotated" : "", this._getExpanded(this.icon || "icons:expand-more", this.iconExpanded, this.expanded), this._getExpanded(this.tooltip, this.tooltipExpanded, this.expanded));
      }
      /**
      ...
      value: function _makeIconButton() {
        return (0, _index.html)(_templateObject5_8baf8ad0b48911edaa972d5aad30d551 || (_templateObject5_8baf8ad0b48911edaa972d5aad30d551 = babelHelpers.taggedTemplateLiteral(["\n      <div id=\"heading\">\n        <div id=\"text\">\n          ", "<slot\n            name=\"heading\"\n          ></slot>\n        </div>\n        <simple-icon-button-lite\n          id=\"expand\"\n          class=\"", "\"\n          @click=\"", "\"\n          ?disabled=\"", "\"\n          .label=\"", "\"\n          .icon=\"", "\"\n          aria-controls=\"content\"\n          aria-expanded=\"", "\"\n        >\n        </simple-icon-button-lite>\n        <simple-tooltip for=\"expand\"\n          >", "</simple-tooltip\n        >\n      </div>\n    "])), this.heading ? (0, _index.html)(_templateObject6_8baf8ad0b48911edaa972d5aad30d551 || (_templateObject6_8baf8ad0b48911edaa972d5aad30d551 = babelHelpers.taggedTemplateLiteral(["<p>", "</p>"])), this.heading) : "", !this.expanded && !this.iconExpanded ? "rotated" : "", this._onClick, this.disabled, this._getExpanded(this.label, this.labelExpanded, this.expanded), this._getExpanded(this.icon || "icons:expand-more", this.iconExpanded, this.expanded), this.expanded ? "true" : "false", this._getExpanded(this.tooltip, this.tooltipExpanded, this.expanded));
      }
