define(["exports", "../../lit-element/lit-element.js", "../../@polymer/paper-icon-button/paper-icon-button.js", "../../@polymer/iron-icons/iron-icons.js", "../simple-tooltip/simple-tooltip.js"], function (_exports, _litElement, _paperIconButton, _ironIcons, _simpleTooltip) {
  ...
  function _templateObject4_cbb50d60387911eab76ec18634c4f6e2() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <div id=\"heading\">\n        <div id=\"text\"><slot name=\"heading\"></slot></div>\n        <paper-icon-button\n          id=\"expand\"\n          @click=\"", "\"\n          ?disabled=\"", "\"\n          ?rotated=\"", "\"\n          .label=\"", "\"\n          .icon=\"", "\"\n          aria-controls=\"content\"\n          aria-expanded=\"", "\"\n        >\n        </paper-icon-button>\n        <simple-tooltip for=\"expand\"\n          >", "</simple-tooltip\n        >\n      </div>\n    "]);

    _templateObject4_cbb50d60387911eab76ec18634c4f6e2 = function _templateObject4_cbb50d60387911eab76ec18634c4f6e2() {
      return data;
    };
  ...
  function _templateObject3_cbb50d60387911eab76ec18634c4f6e2() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <div\n        id=\"heading\"\n        aria-controls=\"content\"\n        aria-expanded=\"", "\"\n        role=\"button\"\n        @click=\"", "\"\n        ?disabled=\"", "\"\n        .label=\"", "\"\n      >\n        <div id=\"text\"><slot name=\"heading\"></slot></div>\n        <iron-icon\n          id=\"expand\"\n          ?rotated=\"", "\"\n          .icon=\"", "\"\n          aria-hidden=\"true\"\n        >\n        </iron-icon>\n      </div>\n      <simple-tooltip for=\"heading\"\n        >", "</simple-tooltip\n      >\n    "]);

    _templateObject3_cbb50d60387911eab76ec18634c4f6e2 = function _templateObject3_cbb50d60387911eab76ec18634c4f6e2() {
      return data;
    };
  ...
  function _templateObject2_cbb50d60387911eab76ec18634c4f6e2() {
    ...
    _templateObject2_cbb50d60387911eab76ec18634c4f6e2 = function _templateObject2_cbb50d60387911eab76ec18634c4f6e2() {
      return data;
    };
  ...
  function _templateObject_cbb50d60387911eab76ec18634c4f6e2() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      ", "\n      <div\n        id=\"content\"\n        aria-hidden=\"", "\"\n        aria-labelledby=\"heading\"\n        aria-live=\"polite\"\n      >\n        <div id=\"content-inner\">\n          <slot name=\"content\"></slot>\n          <slot></slot>\n        </div>\n      </div>\n    "]);

    _templateObject_cbb50d60387911eab76ec18634c4f6e2 = function _templateObject_cbb50d60387911eab76ec18634c4f6e2() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(A11yCollapse, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_cbb50d60387911eab76ec18634c4f6e2(), this.accordion ? this._makeAccordionButton() : this._makeIconButton(), this.expanded ? "false" : "true");
      }
    }], [{
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_cbb50d60387911eab76ec18634c4f6e2())];
      }
    }, {
      key: "tag",
      get: function get() {
