define(["exports","require","../../@polymer/polymer/polymer-element.js","../../@polymer/iron-ajax/iron-ajax.js","../../@polymer/iron-list/iron-list.js"],function(_exports,_require,_polymerElement,_ironAjax,_ironList){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.PerSpecTive=void 0;_require=babelHelpers.interopRequireWildcard(_require);function _templateObject_a5bd0500827a11e9ad5559909c28bbc7(){var data=babelHelpers.taggedTemplateLiteral(["\n      <style>\n        :host {\n          display: block;\n          transition: 0.6s all linear;\n          background-color: transparent;\n          opacity: 1;\n        }\n        :host([outline-loading]) {\n          opacity: 0.6;\n          background-color: #999999;\n        }\n        paper-card {\n          width: 250px;\n          height: 250px;\n        }\n        #list {\n          min-height: 50vh;\n          width: 100%;\n        }\n      </style>\n      <iron-ajax\n        auto=\"\"\n        id=\"endpoint\"\n        url=\"[[endPoint]]\"\n        loading=\"{{outlineLoading}}\"\n        handle-as=\"json\"\n        last-response=\"{{_outlineData}}\"\n        debounce-duration=\"300\"\n      ></iron-ajax>\n      <iron-list grid=\"\" id=\"list\" items=\"[[outline]]\">\n        <template>\n          <paper-card\n            heading=\"[[item.title]]\"\n            image=\"\"\n            elevation=\"1\"\n            animated-shadow=\"true\"\n          >\n            <div class=\"card-content\">A card</div>\n            <div class=\"card-actions\">\n              <paper-icon-button icon=\"add\"></paper-icon-button>\n              <paper-icon-button icon=\"delete\"></paper-icon-button>\n            </div>\n          </paper-card>\n        </template>\n      </iron-list>\n    "]);_templateObject_a5bd0500827a11e9ad5559909c28bbc7=function _templateObject_a5bd0500827a11e9ad5559909c28bbc7(){return data};return data}/**
 * `per-spec-tive`
 ...
 */var PerSpecTive=/*#__PURE__*/function(_PolymerElement){babelHelpers.inherits(PerSpecTive,_PolymerElement);function PerSpecTive(){var _this;babelHelpers.classCallCheck(this,PerSpecTive);_this=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(PerSpecTive).call(this));new Promise(function(res,rej){return _require.default(["../../@polymer/paper-button/paper-button.js"],res,rej)});new Promise(function(res,rej){return _require.default(["../../@polymer/paper-card/paper-card.js"],res,rej)});new Promise(function(res,rej){return _require.default(["../../@polymer/iron-icons/iron-icons.js"],res,rej)});new Promise(function(res,rej){return _require.default(["../../@polymer/paper-icon-button/paper-icon-button.js"],res,rej)});return _this}babelHelpers.createClass(PerSpecTive,[{key:"_outlineRawDataChanged",/**
   ...
   */},{key:"_toArray",value:function _toArray(obj){return Object.keys(obj).map(function(key){return obj[key]})}}],[{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_a5bd0500827a11e9ad5559909c28bbc7())}},{key:"tag",get:function get(){return"per-spec-tive"}},{key:"properties",get:function get(){return{/**
