define(["exports", "meta", "require", "../../lit/index.js", "../simple-icon/lib/simple-icons.js", "../simple-icon/lib/simple-icon-lite.js", "../intersection-element/lib/IntersectionObserverMixin.js"], function (_exports, meta, _require, _index, _simpleIcons, _simpleIconLite, _IntersectionObserverMixin) {
  ...
  var _templateObject_df031f809e8b11ed8df835f388f76963, _templateObject2_df031f809e8b11ed8df835f388f76963, _templateObject3_df031f809e8b11ed8df835f388f76963, _templateObject4_df031f809e8b11ed8df835f388f76963, _templateObject5_df031f809e8b11ed8df835f388f76963, _templateObject6_df031f809e8b11ed8df835f388f76963, _templateObject7_df031f809e8b11ed8df835f388f76963, _templateObject8_df031f809e8b11ed8df835f388f76963, _templateObject9_df031f809e8b11ed8df835f388f76963, _templateObject10_df031f809e8b11ed8df835f388f76963;
  ...
  var CheckItOut = /*#__PURE__*/function (_IntersectionObserver) {
    ...
    babelHelpers.createClass(CheckItOut, [{
      ...
      value: function render() {
        ...
        return (0, _index.html)(_templateObject_df031f809e8b11ed8df835f388f76963 || (_templateObject_df031f809e8b11ed8df835f388f76963 = babelHelpers.taggedTemplateLiteral([" ", ""])), this.elementVisible ? (0, _index.html)(_templateObject2_df031f809e8b11ed8df835f388f76963 || (_templateObject2_df031f809e8b11ed8df835f388f76963 = babelHelpers.taggedTemplateLiteral(["\n          <button\n            class=\"check-it-out-btn\"\n            @click=\"", "\"\n            controls=\"m1\"\n          >\n            <simple-icon-lite icon=\"", "\"> </simple-icon-lite>\n            ", "\n            <slot></slot>\n          </button>\n          ", "\n        "])), this._handleClick, this.icon, this.label, this.modal ? (0, _index.html)(_templateObject3_df031f809e8b11ed8df835f388f76963 || (_templateObject3_df031f809e8b11ed8df835f388f76963 = babelHelpers.taggedTemplateLiteral(["\n                <simple-modal-template\n                  title=\"", "\"\n                  @click=\"", "\"\n                  modal-id=\"m1\"\n                >\n                  <div slot=\"content\">\n                    <!-- bandaid and a terrible one -->\n                    <style>\n                      simple-modal .container {\n                        display: block;\n                        position: relative;\n                        width: var(--check-it-out-container-width, 70vw);\n                      }\n                      simple-modal .container .iframe-container {\n                        width: var(--check-it-out-content-width, 70vw);\n                        height: var(--check-it-out-content-height, 45vh);\n                      }\n\n                      simple-modal .container .video-player {\n                        width: var(--check-it-out-content-width, 70vw);\n                        height: var(--check-it-out-content-height, 45vh);\n                      }\n                      simple-modal .container iframe-loader {\n                        text-align: center;\n                        display: block;\n                        width: var(--check-it-out-content-width, 45vh);\n                      }\n                    </style>\n                    ", "\n                  </div>\n                </simple-modal-template>\n              "])), this.modalTitle, this._handleClick, this.renderLogic()) : (0, _index.html)(_templateObject4_df031f809e8b11ed8df835f388f76963 || (_templateObject4_df031f809e8b11ed8df835f388f76963 = babelHelpers.taggedTemplateLiteral([" ", " "])), this.renderLogic())) : "");
      }
    }, {
      key: "renderLogic",
      value: function renderLogic() {
        return (0, _index.html)(_templateObject5_df031f809e8b11ed8df835f388f76963 || (_templateObject5_df031f809e8b11ed8df835f388f76963 = babelHelpers.taggedTemplateLiteral(["\n      ", "\n    "])), ["code", "pdf"].includes(this.type) ? (0, _index.html)(_templateObject6_df031f809e8b11ed8df835f388f76963 || (_templateObject6_df031f809e8b11ed8df835f388f76963 = babelHelpers.taggedTemplateLiteral(["<div class=\"container\">\n            <iframe-loader>\n              <iframe\n                class=\"iframe-container\"\n                src=", "\n                loading=\"lazy\"\n              ></iframe>\n              ", "\n            </iframe-loader>\n          </div>"])), this.__computedSource, !this.modal ? (0, _index.html)(_templateObject7_df031f809e8b11ed8df835f388f76963 || (_templateObject7_df031f809e8b11ed8df835f388f76963 = babelHelpers.taggedTemplateLiteral(["\n                    <button\n                      class=\"close-btn\"\n                      @click=\"", "\"\n                    ></button>\n                  "])), this._handleClick) : "") : (0, _index.html)(_templateObject8_df031f809e8b11ed8df835f388f76963 || (_templateObject8_df031f809e8b11ed8df835f388f76963 = babelHelpers.taggedTemplateLiteral(["\n            <div class=\"container\">\n              <video-player\n                class=\"video-player\"\n                source=", "\n              >\n              </video-player>\n              ", "\n            </div>\n          "])), this.__computedSource, !this.modal ? (0, _index.html)(_templateObject9_df031f809e8b11ed8df835f388f76963 || (_templateObject9_df031f809e8b11ed8df835f388f76963 = babelHelpers.taggedTemplateLiteral(["\n                    <button\n                      class=\"close-btn\"\n                      @click=\"", "\"\n                    ></button>\n                  "])), this._handleClick) : ""));
      }
    }, {
      key: "_handleClick",
