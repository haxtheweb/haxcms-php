define(["exports", "../simple-icon/lib/simple-iconset.js", "../../lit/index.js", "../simple-icon/lib/simple-icons.js", "../intersection-element/lib/IntersectionObserverMixin.js", "../replace-tag/lib/LoadingHelper.js"], function (_exports, _simpleIconset, _index, _simpleIcons, _IntersectionObserverMixin, _LoadingHelper2) {
  ...
  var _templateObject_d8453bc0a0c911eda392efd0bad1b4bf, _templateObject2_d8453bc0a0c911eda392efd0bad1b4bf, _templateObject3_d8453bc0a0c911eda392efd0bad1b4bf, _templateObject4_d8453bc0a0c911eda392efd0bad1b4bf, _templateObject5_d8453bc0a0c911eda392efd0bad1b4bf;
    ...
    return /*#__PURE__*/function (_IntersectionObserver) {
      ...
      babelHelpers.createClass(_class, [{
        ...
        get: function get() {
          ...
          return [styles, (0, _index.css)(_templateObject3_d8453bc0a0c911eda392efd0bad1b4bf || (_templateObject3_d8453bc0a0c911eda392efd0bad1b4bf = babelHelpers.taggedTemplateLiteral(["\n          img[loading=\"lazy\"] {\n            width: 100%;\n            margin-top: -200px;\n            min-height: 200px;\n            float: left;\n            opacity: 0;\n            transition: opacity 0.3s ease-in-out;\n          }\n          :host([image-loaded]) img[loading=\"lazy\"] {\n            margin-top: unset;\n            float: unset;\n            opacity: 1;\n          }\n        "])))];
        }
      }, {
        key: "properties",
        get: function get() {
  ...
  var lazyImage = /*#__PURE__*/function (_LoadingHelper) {
    ...
    babelHelpers.createClass(lazyImage, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject4_d8453bc0a0c911eda392efd0bad1b4bf || (_templateObject4_d8453bc0a0c911eda392efd0bad1b4bf = babelHelpers.taggedTemplateLiteral(["<div class=\"image-wrap\">\n      ", "\n      <img\n        src=\"", "\"\n        alt=\"", "\"\n        aria-describedby=\"", "\"\n        loading=\"lazy\"\n      />\n    </div>"])), this.renderSVGLoader(), this.src, this.alt, this.describedBy || "");
      }
    }], [{
      key: "tag",
      get: function get() {
      ...
      key: "styles",
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(lazyImage), "styles", this)), [(0, _index.css)(_templateObject5_d8453bc0a0c911eda392efd0bad1b4bf || (_templateObject5_d8453bc0a0c911eda392efd0bad1b4bf = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n        .image-wrap {\n          min-height: 250px;\n          max-height: 400px;\n          overflow: hidden;\n        }\n      "])))]);
      }
    }]);
    return lazyImage;
