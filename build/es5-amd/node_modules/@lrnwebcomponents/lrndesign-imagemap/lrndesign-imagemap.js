define(["exports", "require", "../../lit/index.js"], function (_exports, _require, _index) {
  ...
  var _templateObject_da069ad0a0c911eda392efd0bad1b4bf, _templateObject2_da069ad0a0c911eda392efd0bad1b4bf, _templateObject3_da069ad0a0c911eda392efd0bad1b4bf, _templateObject4_da069ad0a0c911eda392efd0bad1b4bf;
  ...
  var LrndesignImagemap = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(LrndesignImagemap, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_da069ad0a0c911eda392efd0bad1b4bf || (_templateObject_da069ad0a0c911eda392efd0bad1b4bf = babelHelpers.taggedTemplateLiteral(["\n      <figure id=\"figure\">\n        <figcaption>\n          <relative-heading\n            disable-link\n            id=\"heading\"\n            parent=\"", "\"\n          >\n            ", "\n          </relative-heading>\n          <div id=\"desc\"><slot name=\"desc\"></slot></div>\n          <slot name=\"source\" hidden></slot>\n          <div id=\"buttons\"></div>\n        </figcaption>\n        <slot id=\"svg\" name=\"svg\"></slot>\n        <simple-popover\n          auto\n          ?hidden=\"", "\"\n          position=\"", "\"\n          .for=\"", "\"\n        >\n          <relative-heading\n            disable-link\n            class=\"sub-heading\"\n            parent=\"heading\"\n            id=\"subheading-", "\"\n          >\n            <h2>", "</h2>\n          </relative-heading>\n          <slot id=\"details\" name=\"details\"></slot>\n        </simple-popover>\n      </figure>\n      <slot></slot>\n    "])), this.parent || this.subtopicOf, this.label ? (0, _index.html)(_templateObject2_da069ad0a0c911eda392efd0bad1b4bf || (_templateObject2_da069ad0a0c911eda392efd0bad1b4bf = babelHelpers.taggedTemplateLiteral([" <h1>", "</h1> "])), this.label) : (0, _index.html)(_templateObject3_da069ad0a0c911eda392efd0bad1b4bf || (_templateObject3_da069ad0a0c911eda392efd0bad1b4bf = babelHelpers.taggedTemplateLiteral([" <slot name=\"heading\"></slot> "]))), !this.__activeHotspot, !this.__activeHotspot ? "bottom" : this.__activeHotspot.position, !this.__activeHotspot ? undefined : this.__activeHotspot.id, !this.__activeHotspot ? undefined : this.__activeHotspot.id, !this.__activeHotspot ? "" : this.__activeHotspot.label);
      }
    }, {
      key: "firstUpdated",
      ...
      key: "styles",
      get: function get() {
        return [(0, _index.css)(_templateObject4_da069ad0a0c911eda392efd0bad1b4bf || (_templateObject4_da069ad0a0c911eda392efd0bad1b4bf = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n        :host #buttons {\n          position: absolute;\n          left: -999999px;\n          top: 0;\n          overflow: hidden;\n          opacity: 0;\n        }\n\n        simple-popover {\n          max-width: var(--lrndesign-imagemap-popover-maxWidth, 525px);\n          max-height: var(--lrndesign-imagemap-popover-maxHeight, 300px);\n        }\n        simple-popover[for=\"\"] {\n          display: none;\n        }\n        simple-popover .sub-heading > *:first-child {\n          margin: 0 0 10px;\n        }\n\n        @media print {\n          #svg,\n          simple-popover {\n            display: none;\n          }\n        }\n      "])))];
      }
    }, {
      key: "tag",
      get: function get() {
