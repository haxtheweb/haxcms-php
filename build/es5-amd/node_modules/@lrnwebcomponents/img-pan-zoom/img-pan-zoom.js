define(["exports", "meta", "require", "../../lit-element/lit-element.js", "../es-global-bridge/es-global-bridge.js"], function (_exports, meta, _require, _litElement, _esGlobalBridge) {
  ...
  function _templateObject3_847c8cf034ed11eabe39ef50dfa8db3f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n          position: relative;\n          height: 500px;\n        }\n        #viewer {\n          position: relative;\n          height: 100%;\n          width: 100%;\n        }\n\n        hexagon-loader {\n          opacity: 0;\n          display: block;\n          transition: opacity 700ms;\n          position: absolute;\n          margin: auto;\n          top: 0;\n          left: 0;\n          bottom: 0;\n          right: 0;\n          z-index: 1;\n          height: 70px;\n          width: 70px;\n        }\n        hexagon-loader[loading] {\n          opacity: 1;\n        }\n      "]);

    _templateObject3_847c8cf034ed11eabe39ef50dfa8db3f = function _templateObject3_847c8cf034ed11eabe39ef50dfa8db3f() {
      return data;
    };
  ...
  function _templateObject2_847c8cf034ed11eabe39ef50dfa8db3f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            <hexagon-loader\n              ?hidden=\"", "\"\n              ?loading=", "\n              item-count=\"4\"\n              size=\"small\"\n            ></hexagon-loader>\n            <img-loader\n              loaded=\"", "\"\n              @loaded-changed=\"", "\"\n              ?loading=\"", "\"\n              @loading-changed=\"", "\"\n              src=\"", "\"\n            ></img-loader>\n          "]);

    _templateObject2_847c8cf034ed11eabe39ef50dfa8db3f = function _templateObject2_847c8cf034ed11eabe39ef50dfa8db3f() {
      return data;
    };
  ...
  function _templateObject_847c8cf034ed11eabe39ef50dfa8db3f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <!-- Only preload regular images -->\n      ", "\n\n      <!-- Openseadragon -->\n      <div id=\"viewer\"></div>\n    "]);

    _templateObject_847c8cf034ed11eabe39ef50dfa8db3f = function _templateObject_847c8cf034ed11eabe39ef50dfa8db3f() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(ImgPanZoom, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_847c8cf034ed11eabe39ef50dfa8db3f(), !this.dzi ? (0, _litElement.html)(_templateObject2_847c8cf034ed11eabe39ef50dfa8db3f(), this.hideSpinner, this.loading, this.loaded, this.loadedChangedEvent, this.loading, this.loadingChangedEvent, this.src) : "");
      }
    }, {
      key: "pathFromUrl",
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject3_847c8cf034ed11eabe39ef50dfa8db3f())];
      }
    }, {
      key: "tag",
      get: function get() {
