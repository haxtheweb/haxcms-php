define(["exports", "meta", "require", "../../lit/index.js", "../es-global-bridge/es-global-bridge.js"], function (_exports, meta, _require, _index, _esGlobalBridge) {
  ...
  var _templateObject_578985503dc711eda79ddd1a980dc0e1, _templateObject2_578985503dc711eda79ddd1a980dc0e1, _templateObject3_578985503dc711eda79ddd1a980dc0e1, _templateObject4_578985503dc711eda79ddd1a980dc0e1;
  ...
  var ImgPanZoom = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(ImgPanZoom, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_578985503dc711eda79ddd1a980dc0e1 || (_templateObject_578985503dc711eda79ddd1a980dc0e1 = babelHelpers.taggedTemplateLiteral(["\n      <!-- Only preload regular images -->\n      ", "\n\n      <!-- Openseadragon -->\n      <div id=\"viewer\"></div>\n    "])), !this.dzi ? (0, _index.html)(_templateObject2_578985503dc711eda79ddd1a980dc0e1 || (_templateObject2_578985503dc711eda79ddd1a980dc0e1 = babelHelpers.taggedTemplateLiteral(["\n            ", "\n            <img-loader\n              ?loaded=\"", "\"\n              @loaded-changed=\"", "\"\n              ?loading=\"", "\"\n              @loading-changed=\"", "\"\n              src=\"", "\"\n              described-by=\"", "\"\n            ></img-loader>\n          "])), this.hideSpinner || this.loaded ? "" : (0, _index.html)(_templateObject3_578985503dc711eda79ddd1a980dc0e1 || (_templateObject3_578985503dc711eda79ddd1a980dc0e1 = babelHelpers.taggedTemplateLiteral(["\n                  <div id=\"loader\">\n                    <hexagon-loader\n                      ?loading=", "\n                      item-count=\"4\"\n                      size=\"small\"\n                    ></hexagon-loader>\n                  </div>\n                "])), this.loading || !this.loaded), this.loaded, this.loadedChangedEvent, this.loading, this.loadingChangedEvent, this.src || (this.sources || [])[0], this.describedBy || "") : "");
      }
    }, {
      key: "updated",
