define(["exports", "meta", "require", "../../lit-element/lit-element.js", "../es-global-bridge/es-global-bridge.js"], function (_exports, meta, _require, _litElement, _esGlobalBridge) {
  ...
  function _templateObject4_749fef40bff611eaa5854beb4e0c914c() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n          position: relative;\n          height: 500px;\n        }\n        #viewer {\n          position: relative;\n          height: 100%;\n          width: 100%;\n        }\n\n        hexagon-loader {\n          opacity: 0;\n          display: block;\n          transition: opacity 700ms;\n          position: absolute;\n          margin: auto;\n          top: 0;\n          left: 0;\n          bottom: 0;\n          right: 0;\n          z-index: 1;\n          height: 70px;\n          width: 70px;\n        }\n        hexagon-loader[hidden] {\n          display: none;\n        }\n        hexagon-loader[loading] {\n          opacity: 1;\n        }\n      "]);

    _templateObject4_749fef40bff611eaa5854beb4e0c914c = function _templateObject4_749fef40bff611eaa5854beb4e0c914c() {
      return data;
    };
  ...
  function _templateObject3_749fef40bff611eaa5854beb4e0c914c() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                  <hexagon-loader\n                    ?loading=", "\n                    item-count=\"4\"\n                    size=\"small\"\n                  ></hexagon-loader>\n                "]);

    _templateObject3_749fef40bff611eaa5854beb4e0c914c = function _templateObject3_749fef40bff611eaa5854beb4e0c914c() {
      return data;
    };
  ...
  function _templateObject2_749fef40bff611eaa5854beb4e0c914c() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            ", "\n            <img-loader\n              loaded=\"", "\"\n              @loaded-changed=\"", "\"\n              ?loading=\"", "\"\n              @loading-changed=\"", "\"\n              src=\"", "\"\n              described-by=\"", "\"\n            ></img-loader>\n          "]);

    _templateObject2_749fef40bff611eaa5854beb4e0c914c = function _templateObject2_749fef40bff611eaa5854beb4e0c914c() {
      return data;
    };
  ...
  function _templateObject_749fef40bff611eaa5854beb4e0c914c() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <!-- Only preload regular images -->\n      ", "\n\n      <!-- Openseadragon -->\n      <div id=\"viewer\"></div>\n    "]);

    _templateObject_749fef40bff611eaa5854beb4e0c914c = function _templateObject_749fef40bff611eaa5854beb4e0c914c() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(ImgPanZoom, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_749fef40bff611eaa5854beb4e0c914c(), !this.dzi ? (0, _litElement.html)(_templateObject2_749fef40bff611eaa5854beb4e0c914c(), this.hideSpinner || this.loaded ? "" : (0, _litElement.html)(_templateObject3_749fef40bff611eaa5854beb4e0c914c(), this.loading || !this.loaded), this.loaded, this.loadedChangedEvent, this.loading, this.loadingChangedEvent, this.src, this.describedBy || "") : "");
      }
    }, {
      key: "pathFromUrl",
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject4_749fef40bff611eaa5854beb4e0c914c())];
      }
    }, {
      key: "tag",
      get: function get() {
