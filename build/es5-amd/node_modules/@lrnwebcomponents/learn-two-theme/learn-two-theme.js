define(["exports", "require", "../../lit-element/lit-element.js", "../haxcms-elements/lib/core/HAXCMSLitElementTheme.js", "../../@polymer/app-layout/app-drawer/app-drawer.js", "../../@polymer/app-layout/app-drawer-layout/app-drawer-layout.js", "../haxcms-elements/lib/ui-components/site/site-title.js", "../haxcms-elements/lib/ui-components/navigation/site-menu.js", "../simple-icon/simple-icon.js", "../simple-icon/lib/simple-icons.js", "../simple-icon/lib/simple-icon-button.js", "../../@polymer/polymer/lib/elements/custom-style.js"], function (_exports, _require, _litElement, _HAXCMSLitElementTheme, _appDrawer, _appDrawerLayout, _siteTitle, _siteMenu, _simpleIcon, _simpleIcons, _simpleIconButton, _customStyle) {
  ...
  function _templateObject3_d24b9780994311ebb1a5332c5e6bdde2() {
    ...
    _templateObject3_d24b9780994311ebb1a5332c5e6bdde2 = function _templateObject3_d24b9780994311ebb1a5332c5e6bdde2() {
      return data;
    };
  ...
  function _templateObject2_d24b9780994311ebb1a5332c5e6bdde2() {
    ...
    _templateObject2_d24b9780994311ebb1a5332c5e6bdde2 = function _templateObject2_d24b9780994311ebb1a5332c5e6bdde2() {
      return data;
    };
  ...
  function _templateObject_d24b9780994311ebb1a5332c5e6bdde2() {
    var data = babelHelpers.taggedTemplateLiteral([" <custom-style>\n        <style>\n          site-title {\n            color: #fafafa;\n            --site-title-link-display: inline-block;\n            --site-title-link-text-decoration: none;\n            --site-title-heading-font-family: var(\n              --__learn-two-theme-default-font-family\n            );\n            --site-title-heading-font-size: 28px;\n            --site-title-heading-margin: 0;\n            --site-title-heading-padding: 0;\n            --site-title-heading-text-align: center;\n            --site-title-heading-text-rendering: optimizelegibility;\n            --site-title-heading-font-weight: 100;\n          }\n          site-menu {\n            --site-menu: {\n              background-color: #383f45;\n            }\n            --site-menu-container: {\n              padding: 0;\n              background-color: #2d3237;\n            }\n          }\n          app-drawer-layout {\n            --app-drawer-content-container: {\n              overflow: hidden;\n              background-color: #383f45;\n              position: relative;\n            }\n          }\n          site-menu-button {\n            --site-menu-button-button: {\n              background-color: rgba(0, 0, 0, 0);\n              width: 64px;\n              height: 100vh;\n              border-radius: 0;\n              transition: 0.4s all ease-in-out;\n              transition-delay: 0.2s;\n              margin: 0;\n              padding: 0;\n              opacity: 0.8;\n              -webkit-transition: 0.4s all ease-in-out;\n              -moz-transition: 0.4s all ease-in-out;\n              -ms-transition: 0.4s all ease-in-out;\n              -o-transition: 0.4s all ease-in-out;\n            }\n          }\n          app-drawer-layout[narrow] site-menu-button {\n            --site-menu-button-button: {\n              background-color: transparent !important;\n              width: 64px;\n              height: 64px;\n            }\n          }\n        </style>\n      </custom-style>\n      <app-drawer-layout responsive-width=\"900px\">\n        <simple-icon-button\n          id=\"menubutton\"\n          icon=\"menu\"\n          @click=\"", "\"\n          title=\"Toggle site menu\"\n        ></simple-icon-button>\n        <app-drawer\n          swipe-open\n          slot=\"drawer\"\n          .opened=\"", "\"\n          @opened=\"", "\"\n        >\n          <simple-icon-button\n            id=\"menubutton2\"\n            icon=\"menu\"\n            @click=\"", "\"\n            title=\"Toggle site menu\"\n          ></simple-icon-button>\n          <div class=\"header-wrapper\">\n            <div class=\"header\">\n              <site-title ?disabled=\"", "\"></site-title>\n              <site-modal\n                @site-modal-click=\"", "\"\n                ?disabled=\"", "\"\n                icon=\"icons:search\"\n                title=\"Search site\"\n                button-label=\"Search\"\n              >\n                <site-search></site-search>\n              </site-modal>\n            </div>\n          </div>\n          <site-menu></site-menu>\n          <div class=\"rss-buttons\">\n            <site-rss-button\n              ?disabled=\"", "\"\n              type=\"atom\"\n            ></site-rss-button>\n            <site-rss-button\n              ?disabled=\"", "\"\n              type=\"rss\"\n            ></site-rss-button>\n            <site-print-button\n              ?disabled=\"", "\"\n              position=\"top\"\n            ></site-print-button>\n          </div>\n        </app-drawer>\n        <div>\n          <site-menu-button type=\"prev\"></site-menu-button>\n          <div id=\"contentcontainer\">\n            <site-git-corner></site-git-corner>\n            <site-breadcrumb></site-breadcrumb>\n            <div id=\"slot\">\n              <slot></slot>\n            </div>\n          </div>\n          <site-menu-button type=\"next\"></site-menu-button>\n        </div>\n      </app-drawer-layout>"]);

    _templateObject_d24b9780994311ebb1a5332c5e6bdde2 = function _templateObject_d24b9780994311ebb1a5332c5e6bdde2() {
      return data;
    };
  ...
  var LearnTwoTheme = /*#__PURE__*/function (_HAXCMSLitElementThem) {
    ...
    babelHelpers.createClass(LearnTwoTheme, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_d24b9780994311ebb1a5332c5e6bdde2(), this.toggleDrawer, this.opened, this.__openedChanged, this.toggleDrawer, this.editMode, this.siteModalClick, this.editMode, this.editMode, this.editMode, this.editMode);
      ...
      //styles function
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_d24b9780994311ebb1a5332c5e6bdde2())];
      }
    }, {
      key: "properties",
      get: function get() {
    ...
    babelHelpers.createClass(LearnTwoTheme, [{
      ...
      // render function
      value: function render() {
        return (0, _litElement.html)(_templateObject3_d24b9780994311ebb1a5332c5e6bdde2(), this.toggleDrawer, this.opened, this.__openedChanged, this.toggleDrawer, this.editMode, this.siteModalClick, this.editMode, this.editMode, this.editMode, this.editMode);
      }
      /**
