define(["exports", "meta", "../../lit/index.js", "../schema-behaviors/schema-behaviors.js", "../intersection-element/lib/IntersectionObserverMixin.js", "../i18n-manager/lib/I18NMixin.js", "../simple-icon/lib/simple-icon-button-lite.js", "../simple-icon/lib/simple-icons.js", "../simple-icon/lib/simple-iconset.js", "./lib/page-break-manager.js"], function (_exports, meta, _index, _schemaBehaviors, _IntersectionObserverMixin, _I18NMixin, _simpleIconButtonLite, _simpleIcons, _simpleIconset, _pageBreakManager) {
  ...
  var _templateObject_18181990edcb11edb3e3ed4f0d506a4b, _templateObject2_18181990edcb11edb3e3ed4f0d506a4b, _templateObject3_18181990edcb11edb3e3ed4f0d506a4b;
  ...
  var PageBreak = /*#__PURE__*/function (_IntersectionObserver) {
    ...
    babelHelpers.createClass(PageBreak, [{
            ...
            setTimeout(function () {
              if (_this2.target === null) {
                if (_this2.nextElementSibling && _this2.nextElementSibling.tagName && ["H1", "H2", "H3", "H4", "H5", "H6"].includes(_this2.nextElementSibling.tagName)) {
                  ...
                  _this2.parentNode.insertBefore(newH, _this2.nextElementSibling);
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_18181990edcb11edb3e3ed4f0d506a4b || (_templateObject_18181990edcb11edb3e3ed4f0d506a4b = babelHelpers.taggedTemplateLiteral(["\n      <style></style>\n      <a .href=\"", "\" .name=\"#", "\" class=\"sr-only\"\n        >", "</a\n      >\n      <hr class=\"mid\" />\n      ", "\n    "])), this.slug, this.itemId, this.title, this.locked ? (0, _index.html)(_templateObject2_18181990edcb11edb3e3ed4f0d506a4b || (_templateObject2_18181990edcb11edb3e3ed4f0d506a4b = babelHelpers.taggedTemplateLiteral(["<simple-icon-button-lite\n            @click=\"", "\"\n            icon=\"icons:lock\"\n            title=\"", "\"\n          ></simple-icon-button-lite>"])), this.haxClickLockInPage, this.t.clickToUnlock) : "");
      }
      /**
      ...
      key: "styles",
      get: function get() {
        return [(0, _index.css)(_templateObject3_18181990edcb11edb3e3ed4f0d506a4b || (_templateObject3_18181990edcb11edb3e3ed4f0d506a4b = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n          opacity: 0;\n          height: 1px;\n        }\n        :host([data-hax-ray]) {\n          display: block;\n          margin: 20px 0;\n          padding: 20px;\n          opacity: 0.2;\n          background-position: center;\n          background-repeat: no-repeat;\n          transition: all 0.2s linear;\n        }\n        .mid {\n          border: none;\n          border-top: 2px solid #cccccc;\n          overflow: visible;\n          margin: 4px 0 0 0;\n          padding: 0;\n          height: 0;\n        }\n        :host([data-hax-ray]:hover) {\n          opacity: 1;\n        }\n        :host([data-hax-ray]:hover) .mid::before {\n          font-weight: bold;\n          color: #000000;\n          background-color: #ffffff;\n          font-size: 16px;\n          left: calc(50% - 2.5em);\n          top: -16px;\n          position: relative;\n          height: 0;\n          line-height: 36px;\n        }\n        simple-icon-button-lite {\n          float: right;\n          color: #000000;\n          --simple-icon-width: 36px;\n          --simple-icon-height: 36px;\n          margin-top: -28px;\n          margin-right: -46px;\n        }\n        .sr-only {\n          position: absolute;\n          left: -10000px;\n          top: auto;\n          width: 1px;\n          height: 1px;\n          overflow: hidden;\n        }\n      "])))];
      }
    }, {
      key: "haxProperties",
      get: function get() {
