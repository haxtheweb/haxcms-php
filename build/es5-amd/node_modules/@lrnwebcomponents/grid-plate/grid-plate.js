define(["exports", "require", "../../lit-element/lit-element.js", "../../@polymer/polymer/lib/utils/flattened-nodes-observer.js", "../../@polymer/iron-a11y-keys/iron-a11y-keys.js", "../responsive-utility/responsive-utility.js"], function (_exports, _require, _litElement, _flattenedNodesObserver, _ironA11yKeys, _responsiveUtility) {
  "use strict";
  ...
  function _templateObject2_dc41ad300b1211eaa3b2eff4bd15c191() {
    ...
    _templateObject2_dc41ad300b1211eaa3b2eff4bd15c191 = function _templateObject2_dc41ad300b1211eaa3b2eff4bd15c191() {
      return data;
    };
  ...
  function _templateObject_dc41ad300b1211eaa3b2eff4bd15c191() {
    ...
    _templateObject_dc41ad300b1211eaa3b2eff4bd15c191 = function _templateObject_dc41ad300b1211eaa3b2eff4bd15c191() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(GridPlate, null, [{
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject_dc41ad300b1211eaa3b2eff4bd15c191())];
      }
    }]);
    ...
    function GridPlate() {
      ...
      _this.addEventListener("focusin", _this._focusIn.bind(babelHelpers.assertThisInitialized(_this))); // listen for HAX if it's around


      window.addEventListener("hax-store-property-updated", _this._haxStorePropertyUpdated.bind(babelHelpers.assertThisInitialized(_this))); // listen for HAX insert events if it exists

      window.addEventListener("hax-insert-content", _this.haxInsertContent.bind(babelHelpers.assertThisInitialized(_this)));
      window.addEventListener("load", _this.resize.bind(babelHelpers.assertThisInitialized(_this)));
    ...
    babelHelpers.createClass(GridPlate, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_dc41ad300b1211eaa3b2eff4bd15c191(), this.moveActiveElement, this.moveActiveElement, this.moveActiveElement, this.moveActiveElement, this._getColumnWidth(0, this.columnWidths), this._getColumnWidth(1, this.columnWidths), this._getColumnWidth(2, this.columnWidths), this._getColumnWidth(3, this.columnWidths), this._getColumnWidth(4, this.columnWidths), this._getColumnWidth(5, this.columnWidths), this.activeItem, this.setActiveElement, this.activeItem, this.cancelActive);
      }
    }, {
      key: "firstUpdated",
      ...
      value: function updated(changedProperties) {
        ...
        changedProperties.forEach(function (oldValue, propName) {
          ...
          if (["responsiveSize", "layout", "layouts", "disableResponsive"].includes(propName)) {
            _this2.columnWidths = _this2._getColumnWidths(_this2.responsiveSize, _this2.layout, _this2.layouts, _this2.disableResponsive);
          }

          switch (propName) {
            // observer
            case "droppable":
              _this2._droppableChanged(_this2[propName], oldValue);
            ...
            case "disableResponsive":
              ...
              _this2.dispatchEvent(new CustomEvent("disable-responsive-changed", {
      ...
      value: function _editModeChanged(newValue, oldValue) {
        ...
        var children = _flattenedNodesObserver.FlattenedNodesObserver.getFlattenedNodes(this);
      ...
      value: function dropEvent(e) {
        ...
        if (this.editMode) {
          ...
          if (babelHelpers.typeof(this.activeItem) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined)) && this.activeItem !== null && babelHelpers.typeof(local) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined)) && local.getAttribute("slot") != null && this.activeItem !== local) {
            ...
            this.insertBefore(this.activeItem, local); // ensure that if we caught this event we process it
          ...
          // which could involve a miss on the column
              ...
              this.appendChild(this.activeItem); // ensure that if we caught this event we process it
