define(["exports", "../../lit/index.js", "../responsive-utility/responsive-utility.js", "../utils/utils.js"], function (_exports, _index, _responsiveUtility, _utils) {
  ...
  var _templateObject_8a9f2a30403311edb9fff3e6b08a0a9a, _templateObject2_8a9f2a30403311edb9fff3e6b08a0a9a, _templateObject3_8a9f2a30403311edb9fff3e6b08a0a9a;
  ...
  var GridPlate = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(GridPlate, [{
      ...
      value: function render() {
        ...
        return (0, _index.html)(_templateObject_8a9f2a30403311edb9fff3e6b08a0a9a || (_templateObject_8a9f2a30403311edb9fff3e6b08a0a9a = babelHelpers.taggedTemplateLiteral(["\n      <div class=\"row\">\n        ", "\n      </div>\n    "])), [1, 2, 3, 4, 5, 6].map(function (num) {
          return (0, _index.html)(_templateObject2_8a9f2a30403311edb9fff3e6b08a0a9a || (_templateObject2_8a9f2a30403311edb9fff3e6b08a0a9a = babelHelpers.taggedTemplateLiteral(["\n            <div\n              class=\"column ", "\"\n              id=\"col", "\"\n              data-label=\"column ", "\"\n              data-layout-slotname=\"col-", "\"\n              part=\"layout-container\"\n              .style=\"", "\"\n              @drop=\"", "\"\n              @dragenter=\"", "\"\n              @dragleave=\"", "\"\n            >\n              <slot name=\"col-", "\"></slot>\n            </div>\n          "])), _this2.columns < num ? "not-shown" : "drag-enabled", num, num, num, _this2._getColumnWidth(num - 1, _this2.__columnWidths), _this2._drop, _this2._dragEnter, _this2._dragleave, num);
        }));
      }
    }, {
      key: "_drop",
