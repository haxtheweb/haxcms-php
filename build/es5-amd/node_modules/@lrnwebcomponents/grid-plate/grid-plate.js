define(["exports", "../../lit/index.js", "../responsive-utility/responsive-utility.js", "../utils/utils.js"], function (_exports, _index, _responsiveUtility, _utils) {
  ...
  var _templateObject_f37f7bd0e8e011ed8789699b2ad5335a, _templateObject2_f37f7bd0e8e011ed8789699b2ad5335a, _templateObject3_f37f7bd0e8e011ed8789699b2ad5335a;
  ...
  var GridPlateLayoutOptions = /*#__PURE__*/babelHelpers.createClass(function GridPlateLayoutOptions() {
    ...
    this.options = {};
    var layoutFlip = Object.keys(this.layouts);
  ...
  var GridPlate = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(GridPlate, [{
      ...
      value: function render() {
        var _this2 = this;
        return (0, _index.html)(_templateObject_f37f7bd0e8e011ed8789699b2ad5335a || (_templateObject_f37f7bd0e8e011ed8789699b2ad5335a = babelHelpers.taggedTemplateLiteral(["\n      <div class=\"row\">\n        ", "\n      </div>\n    "])), [1, 2, 3, 4, 5, 6].map(function (num) {
          return (0, _index.html)(_templateObject2_f37f7bd0e8e011ed8789699b2ad5335a || (_templateObject2_f37f7bd0e8e011ed8789699b2ad5335a = babelHelpers.taggedTemplateLiteral(["\n            <div\n              class=\"column ", "\"\n              id=\"col", "\"\n              data-label=\"column ", "\"\n              data-layout-slotname=\"col-", "\"\n              part=\"layout-container\"\n              .style=\"", "\"\n              @drop=\"", "\"\n              @dragenter=\"", "\"\n              @dragleave=\"", "\"\n            >\n              <slot name=\"col-", "\"></slot>\n            </div>\n          "])), _this2.columns < num ? "not-shown" : "drag-enabled", num, num, num, _this2._getColumnWidth(num - 1, _this2.__columnWidths), _this2._drop, _this2._dragEnter, _this2._dragleave, num);
        }));
      }
    }, {
      key: "_drop",
      ...
      get: function get() {
        return {
          ...
          gizmo: {
            ...
            icon: "hax:3-3-3-3",
            color: "grey",
            tags: ["Layout", "content", "grid", "column", "row", "responsive", "gridplate"],
            handles: [],
            meta: {
          ...
          demoSchema: [{
            ...
            content: '<p slot="col-1">Column one</p><p slot="col-2">Column two</p>'
          }]
        };
      }
    }, {
