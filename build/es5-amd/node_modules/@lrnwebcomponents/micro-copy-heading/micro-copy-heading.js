define(["exports", "../../lit/index.js"], function (_exports, _index) {
  ...
  var _templateObject_8fc36350403311edb9fff3e6b08a0a9a, _templateObject2_8fc36350403311edb9fff3e6b08a0a9a;
  ...
  var MicroCopyHeading = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(MicroCopyHeading, [{
      ...
      function render() {
        return (0, _index.html)(_templateObject_8fc36350403311edb9fff3e6b08a0a9a || (_templateObject_8fc36350403311edb9fff3e6b08a0a9a = babelHelpers.taggedTemplateLiteral([" <h2>\n      ", "<span aria-hidden=\"true\">", "</span>\n    </h2>"])), this.heading, this.endcap);
      ...
      get: //styles function
      function get() {
        return [(0, _index.css)(_templateObject2_8fc36350403311edb9fff3e6b08a0a9a || (_templateObject2_8fc36350403311edb9fff3e6b08a0a9a = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n          margin: 16px 0;\n        }\n\n        :host([hidden]) {\n          display: none;\n        }\n\n        span {\n          margin-left: 8px;\n        }\n\n        h2 {\n          display: inline-flex;\n          margin: unset;\n          padding: unset;\n          font-size: 0.75em;\n          color: var(--simple-colors-default-theme-red-5, #de2654);\n          border: 2px solid var(--simple-colors-default-theme-red-5, #de2654);\n          line-height: 12px;\n          margin-right: 10px;\n          text-transform: uppercase;\n          font-weight: 500;\n          letter-spacing: 0.09em;\n          padding: 6px 16px;\n        }\n      "])))];
      }
    }, {
      key: "haxProperties",
      get: function get() {
