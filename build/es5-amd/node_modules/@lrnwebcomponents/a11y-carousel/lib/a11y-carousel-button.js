define(["exports", "../../../lit/index.js"], function (_exports, _index) {
  ...
  var _templateObject_db0cd7d0cd8111ecaf720fdc1a41727f, _templateObject2_db0cd7d0cd8111ecaf720fdc1a41727f;
  ...
  var a11yCarouselButton = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(a11yCarouselButton, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_db0cd7d0cd8111ecaf720fdc1a41727f || (_templateObject_db0cd7d0cd8111ecaf720fdc1a41727f = babelHelpers.taggedTemplateLiteral([" <slot></slot> "])));
      ...
      get: //styles function
      function get() {
        return [(0, _index.css)(_templateObject2_db0cd7d0cd8111ecaf720fdc1a41727f || (_templateObject2_db0cd7d0cd8111ecaf720fdc1a41727f = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: inline;\n          background-color: transparent;\n          border: 1px solid black;\n          padding: 2px 5px;\n          margin: 15px 2px;\n          text-align: center;\n        }\n        :host([hidden]) {\n          display: none !important;\n        }\n        :host([disabled]) {\n          opacity: 0.5;\n        }\n        @media print {\n          :host {\n            display: none !important;\n          }\n        }\n      "])))];
      }
    }, {
      key: "properties",
      get: function get() {
