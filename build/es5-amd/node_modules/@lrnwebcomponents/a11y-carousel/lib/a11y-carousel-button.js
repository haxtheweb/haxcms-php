define(["exports", "../../../lit-element/lit-element.js"], function (_exports, _litElement) {
  ...
  function _templateObject2_d604df40247111eb9734a78ef81f0b0d() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: inline;\n          background-color: transparent;\n          border: 1px solid black;\n          padding: 2px 5px;\n          margin: 15px 2px;\n          text-align: center;\n        }\n        :host([hidden]) {\n          display: none !important;\n        }\n        :host([disabled]) {\n          opacity: 0.5;\n        }\n        @media print {\n          :host {\n            display: none !important;\n          }\n        }\n      "]);

    _templateObject2_d604df40247111eb9734a78ef81f0b0d = function _templateObject2_d604df40247111eb9734a78ef81f0b0d() {
      return data;
    };
  ...
  function _templateObject_d604df40247111eb9734a78ef81f0b0d() {
    var data = babelHelpers.taggedTemplateLiteral([" <slot></slot> "]);

    _templateObject_d604df40247111eb9734a78ef81f0b0d = function _templateObject_d604df40247111eb9734a78ef81f0b0d() {
      return data;
    };
  ...
  var a11yCarouselButton = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(a11yCarouselButton, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_d604df40247111eb9734a78ef81f0b0d());
      ...
      //styles function
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_d604df40247111eb9734a78ef81f0b0d())];
      }
    }, {
      key: "properties",
      get: function get() {
