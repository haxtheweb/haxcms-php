...
*/var PieMenu=(0,_polymerLegacy.Polymer)({_template:(0,_polymerLegacy.html)(_templateObject_fc329b20685311e9b25d1735312af746()),is:"pie-menu",properties:{/**
   ...
   */ready:function ready(){for(var buttons=this.querySelectorAll("[role=\"button\"][data-button]"),i=0;i<buttons.length;i++){this._addListenerAddState(this,buttons[i],"mouseover","hover");this._addListenerAddState(this,buttons[i],"focus","focus");this._addListenerRemoveState(this,buttons[i],"mouseout","hover");this._addListenerRemoveState(this,buttons[i],"blur","focus")}},/**
   * add focus or hover states
   */_addListenerAddState:function _addListenerAddState(menu,button,action,state){button.addEventListener(action,function(e){for(var elements=menu._getButtonElements(menu,button),i=0;i<elements.length;i++){elements[i].classList.add(state)}})},/**
   * remove focus or hover states
   */_addListenerRemoveState:function _addListenerRemoveState(menu,button,action,state){button.addEventListener(action,function(e){for(var elements=menu._getButtonElements(menu,button),i=0;i<elements.length;i++){elements[i].classList.remove(state)}})},_getButtonElements:function _getButtonElements(menu,button){return menu.querySelectorAll("[data-button=\""+button.getAttribute("data-button")+"\"]")},/**
   * Simple trap for bubbling up a tap / click event.
   */_itemTapped:function _itemTapped(e){var normalizedEvent=(0,_polymerDom.dom)(e),localLink=normalizedEvent.localTarget;// make sure we normalize tap vs click vs keyboard
if(!(localLink.hasAttribute("role")&&"button"!==localLink.getAttribute("role"))){localLink=localLink.parentNode}// bubble up event
this.fire("pie-menu-selection",{option:localLink})}});_exports.PieMenu=PieMenu});