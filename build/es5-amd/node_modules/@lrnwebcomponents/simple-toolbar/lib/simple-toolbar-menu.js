define(["exports", "../../../lit-element/lit-element.js", "../../a11y-menu-button/a11y-menu-button.js", "./simple-toolbar-button.js", "./simple-toolbar-menu-item.js"], function (_exports, _litElement, _a11yMenuButton, _simpleToolbarButton, _simpleToolbarMenuItem) {
  ...
  function _templateObject5_d1a577c08b3211ebb67059cf696085af() {
    ...
    _templateObject5_d1a577c08b3211ebb67059cf696085af = function _templateObject5_d1a577c08b3211ebb67059cf696085af() {
      return data;
    };
  ...
  function _templateObject4_d1a577c08b3211ebb67059cf696085af() {
    var data = babelHelpers.taggedTemplateLiteral(["\n          #menu {\n            width: var(--simple-toolbar-button-width);\n            min-width: var(--simple-toolbar-button-min-width);\n          }\n        "]);

    _templateObject4_d1a577c08b3211ebb67059cf696085af = function _templateObject4_d1a577c08b3211ebb67059cf696085af() {
      return data;
    };
  ...
  function _templateObject3_d1a577c08b3211ebb67059cf696085af() {
    var data = babelHelpers.taggedTemplateLiteral(["\n          #menubutton {\n            display: flex;\n            flex-wrap: none;\n            align-items: center;\n            min-width: 42px;\n          }\n          .label {\n            padding: 0 5px;\n          }\n          #dropdownicon {\n            --simple-icon-height: 18px;\n            --simple-icon-width: 18px;\n            margin-left: -2px;\n          }\n        "]);

    _templateObject3_d1a577c08b3211ebb67059cf696085af = function _templateObject3_d1a577c08b3211ebb67059cf696085af() {
      return data;
    };
  ...
  function _templateObject2_d1a577c08b3211ebb67059cf696085af() {
    var data = babelHelpers.taggedTemplateLiteral(["<slot></slot>"]);

    _templateObject2_d1a577c08b3211ebb67059cf696085af = function _templateObject2_d1a577c08b3211ebb67059cf696085af() {
      return data;
    };
  ...
  function _templateObject_d1a577c08b3211ebb67059cf696085af() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        <button\n          id=\"menubutton\"\n          aria-haspopup=\"true\"\n          aria-controls=\"menu\"\n          aria-expanded=\"", "\"\n          part=\"button\"\n        >\n          ", " ", "\n          <simple-icon-lite\n            id=\"dropdownicon\"\n            icon=\"arrow-drop-down\"\n            aria-hidden=\"true\"\n            part=\"dropdown-icon\"\n          ></simple-icon-lite>\n        </button>\n      "]);

    _templateObject_d1a577c08b3211ebb67059cf696085af = function _templateObject_d1a577c08b3211ebb67059cf696085af() {
      return data;
    };
  ...
  var SimpleToolbarMenuBehaviors = function SimpleToolbarMenuBehaviors(SuperClass) {
    return /*#__PURE__*/function (_A11yMenuButtonBehavi) {
      ...
      babelHelpers.createClass(_class, [{
        key: "buttonTemplate",
        get: function get() {
          return (0, _litElement.html)(_templateObject_d1a577c08b3211ebb67059cf696085af(), this.expanded ? "true" : "false", this.iconTemplate, this.labelTemplate);
        }
        /**
        ...
        get: function get() {
          return (0, _litElement.html)(_templateObject2_d1a577c08b3211ebb67059cf696085af());
        }
      }], [{
        key: "simpleButtonCoreStyles",
        get: function get() {
          return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(_class), "simpleButtonCoreStyles", this)), [(0, _litElement.css)(_templateObject3_d1a577c08b3211ebb67059cf696085af())]);
        }
      }, {
        key: "simpleButtonLayoutStyles",
        get: function get() {
          return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(_class), "simpleButtonLayoutStyles", this)), [(0, _litElement.css)(_templateObject4_d1a577c08b3211ebb67059cf696085af())]);
        }
      }, {
        key: "simpleButtonThemeStyles",
        get: function get() {
          return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(_class), "simpleButtonThemeStyles", this)), [(0, _litElement.css)(_templateObject5_d1a577c08b3211ebb67059cf696085af())]);
        }
      }, {
        key: "styles",
        get: function get() {
