define(["exports", "../../../lit/index.js", "../../a11y-menu-button/a11y-menu-button.js", "./simple-toolbar-button.js", "../../utils/utils.js", "./simple-toolbar-menu-item.js"], function (_exports, _index, _a11yMenuButton, _simpleToolbarButton, _utils, _simpleToolbarMenuItem) {
  ...
  var _templateObject_f4c44ed0a0c911eda392efd0bad1b4bf, _templateObject2_f4c44ed0a0c911eda392efd0bad1b4bf, _templateObject3_f4c44ed0a0c911eda392efd0bad1b4bf, _templateObject4_f4c44ed0a0c911eda392efd0bad1b4bf, _templateObject5_f4c44ed0a0c911eda392efd0bad1b4bf;
  ...
  var SimpleToolbarMenuBehaviors = function SimpleToolbarMenuBehaviors(SuperClass) {
    return /*#__PURE__*/function (_A11yMenuButtonBehavi) {
      ...
      babelHelpers.createClass(_class, [{
         ...
         */
        function get() {
          return (0, _index.html)(_templateObject_f4c44ed0a0c911eda392efd0bad1b4bf || (_templateObject_f4c44ed0a0c911eda392efd0bad1b4bf = babelHelpers.taggedTemplateLiteral(["\n        <button\n          id=\"menubutton\"\n          aria-haspopup=\"true\"\n          aria-controls=\"menu\"\n          ?disabled=\"", "\"\n          aria-expanded=\"", "\"\n          @blur=\"", "\"\n          part=\"button\"\n          tabindex=\"", "\"\n        >\n          ", "\n          <simple-icon-lite\n            id=\"dropdownicon\"\n            icon=\"arrow-drop-down\"\n            aria-hidden=\"true\"\n            part=\"dropdown-icon\"\n          ></simple-icon-lite>\n        </button>\n        ", "\n      "])), this.disabled, this.expanded ? "true" : "false", this._handleBlur, this.isCurrentItem ? 1 : -1, this.buttonInnerTemplate, this.tooltipTemplate);
        }
      }, {
        ...
        key: "tooltipTemplate",
        get: function get() {
          return !this.tooltipVisible ? "" : (0, _index.html)(_templateObject2_f4c44ed0a0c911eda392efd0bad1b4bf || (_templateObject2_f4c44ed0a0c911eda392efd0bad1b4bf = babelHelpers.taggedTemplateLiteral(["<simple-tooltip\n            id=\"tooltip\"\n            for=\"menubutton\"\n            position=\"", "\"\n            part=\"tooltip\"\n            fit-to-visible-bounds\n            >", "</simple-tooltip\n          >"])), this.tooltipDirection || "top", this.currentTooltip || this.currentLabel);
        }
      }, {
        ...
        get: function get() {
          return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(_class), "simpleButtonCoreStyles", this)), [(0, _index.css)(_templateObject3_f4c44ed0a0c911eda392efd0bad1b4bf || (_templateObject3_f4c44ed0a0c911eda392efd0bad1b4bf = babelHelpers.taggedTemplateLiteral(["\n          :host {\n            --icon-offset-left: 12px;\n          }\n          #menubutton {\n            display: flex;\n            flex-wrap: none;\n            align-items: center;\n            min-width: calc(42px - var(--icon-offset-left));\n            padding-right: var(--icon-offset-left);\n          }\n          #dropdownicon {\n            --simple-icon-height: 18px;\n            --simple-icon-width: 18px;\n            position: absolute;\n            right: 2px;\n          }\n        "])))]);
        }
      }, {
        key: "simpleButtonLayoutStyles",
        get: function get() {
          return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(_class), "simpleButtonLayoutStyles", this)), [(0, _index.css)(_templateObject4_f4c44ed0a0c911eda392efd0bad1b4bf || (_templateObject4_f4c44ed0a0c911eda392efd0bad1b4bf = babelHelpers.taggedTemplateLiteral(["\n          #menu {\n            width: var(--simple-toolbar-button-width);\n            min-width: var(--simple-toolbar-button-min-width);\n          }\n        "])))]);
        }
        /**
