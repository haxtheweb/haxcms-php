define(["exports", "../../../lit-element/lit-element.js", "../../a11y-menu-button/a11y-menu-button.js", "./simple-toolbar-button.js", "./simple-toolbar-menu-item.js"], function (_exports, _litElement, _a11yMenuButton, _simpleToolbarButton, _simpleToolbarMenuItem) {
  ...
  var _templateObject_f8826ac0b72d11eb858e736d8681b490, _templateObject2_f8826ac0b72d11eb858e736d8681b490, _templateObject3_f8826ac0b72d11eb858e736d8681b490, _templateObject4_f8826ac0b72d11eb858e736d8681b490, _templateObject5_f8826ac0b72d11eb858e736d8681b490;
  ...
  var SimpleToolbarMenuBehaviors = function SimpleToolbarMenuBehaviors(SuperClass) {
    return /*#__PURE__*/function (_A11yMenuButtonBehavi) {
      ...
      babelHelpers.createClass(_class, [{
        key: "buttonTemplate",
        get: function get() {
          return (0, _litElement.html)(_templateObject_f8826ac0b72d11eb858e736d8681b490 || (_templateObject_f8826ac0b72d11eb858e736d8681b490 = babelHelpers.taggedTemplateLiteral(["\n        <button\n          id=\"menubutton\"\n          aria-haspopup=\"true\"\n          aria-controls=\"menu\"\n          aria-expanded=\"", "\"\n          part=\"button\"\n        >\n          ", " ", "\n          <simple-icon-lite\n            id=\"dropdownicon\"\n            icon=\"arrow-drop-down\"\n            aria-hidden=\"true\"\n            part=\"dropdown-icon\"\n          ></simple-icon-lite>\n        </button>\n      "])), this.expanded ? "true" : "false", this.iconTemplate, this.labelTemplate);
        }
        /**
        ...
        get: function get() {
          return (0, _litElement.html)(_templateObject2_f8826ac0b72d11eb858e736d8681b490 || (_templateObject2_f8826ac0b72d11eb858e736d8681b490 = babelHelpers.taggedTemplateLiteral(["<slot></slot>"])));
        }
      }], [{
        key: "simpleButtonCoreStyles",
        get: function get() {
          return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(_class), "simpleButtonCoreStyles", this)), [(0, _litElement.css)(_templateObject3_f8826ac0b72d11eb858e736d8681b490 || (_templateObject3_f8826ac0b72d11eb858e736d8681b490 = babelHelpers.taggedTemplateLiteral(["\n          #menubutton {\n            display: flex;\n            flex-wrap: none;\n            align-items: center;\n            min-width: 42px;\n          }\n          .label {\n            padding: 0 5px;\n          }\n          #dropdownicon {\n            --simple-icon-height: 18px;\n            --simple-icon-width: 18px;\n            margin-left: -2px;\n          }\n        "])))]);
        }
      }, {
        key: "simpleButtonLayoutStyles",
        get: function get() {
          return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(_class), "simpleButtonLayoutStyles", this)), [(0, _litElement.css)(_templateObject4_f8826ac0b72d11eb858e736d8681b490 || (_templateObject4_f8826ac0b72d11eb858e736d8681b490 = babelHelpers.taggedTemplateLiteral(["\n          #menu {\n            width: var(--simple-toolbar-button-width);\n            min-width: var(--simple-toolbar-button-min-width);\n          }\n        "])))]);
        }
      }, {
        key: "simpleButtonThemeStyles",
        get: function get() {
          return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(_class), "simpleButtonThemeStyles", this)), [(0, _litElement.css)(_templateObject5_f8826ac0b72d11eb858e736d8681b490 || (_templateObject5_f8826ac0b72d11eb858e736d8681b490 = babelHelpers.taggedTemplateLiteral(["\n          :host([expanded]) absolute-position-behavior {\n            border-style: solid;\n            border-width: var(\n              --simple-toolbar-button-border-width,\n              var(--simple-toolbar-border-width, 1px)\n            );\n            border-color: var(\n              --simple-toolbar-button-border-color,\n              var(--simple-toolbar-border-color, inherit)\n            );\n            background-color: var(--simple-toolbar-button-bg, white);\n            box-shadow: var(--simple-toolbar-menu-list-box-shadow, unset);\n          }\n        "])))]);
        }
      }, {
        key: "styles",
        get: function get() {
