define(["exports", "../../../lit/index.js", "../simple-toolbar.js"], function (_exports, _index, _simpleToolbar) {
  ...
  var _templateObject_8e4a9650509711edb124eb517be36dbf, _templateObject2_8e4a9650509711edb124eb517be36dbf;
  ...
  var SimpleButtonGridBehaviors = function SimpleButtonGridBehaviors(SuperClass) {
    return /*#__PURE__*/function (_SimpleToolbarBehavio) {
      ...
      babelHelpers.createClass(_class, [{
        ...
        key: "toolbarTemplate",
        get: function get() {
          return (0, _index.html)(_templateObject_8e4a9650509711edb124eb517be36dbf || (_templateObject_8e4a9650509711edb124eb517be36dbf = babelHelpers.taggedTemplateLiteral(["\n        <div id=\"grid\">\n          <div\n            id=\"buttons\"\n            class=\"", "\"\n            style=\"", "\"\n            part=\"buttons\"\n          >\n            <slot></slot>\n            ", "\n          </div>\n        </div>\n      "])), !this.alwaysExpanded && this.collapsed ? "collapsed" : "", this.gridStyles, this.alwaysExpanded ? "" : this.moreButton);
        }
      }, {
        key: "_bottom",
