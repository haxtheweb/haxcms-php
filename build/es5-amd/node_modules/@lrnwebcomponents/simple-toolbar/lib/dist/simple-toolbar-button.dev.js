...
function _templateObject12_85b73be06f4811ed83231ba15a006752() {
  ...
  _templateObject12_85b73be06f4811ed83231ba15a006752 = function _templateObject12_85b73be06f4811ed83231ba15a006752() {
    return data;
  };
...
function _templateObject11_85b73be06f4811ed83231ba15a006752() {
  ...
  _templateObject11_85b73be06f4811ed83231ba15a006752 = function _templateObject11_85b73be06f4811ed83231ba15a006752() {
    return data;
  };
...
function _templateObject10_85b73be06f4811ed83231ba15a006752() {
  var data = _taggedTemplateLiteral(['\n          :host {\n            display: inline-flex;\n            white-space: nowrap;\n            transition: all 0.5s;\n            z-index: 1;\n          }\n          :host(:hover),\n          :host(:focus-wthin) {\n            z-index: var(--simple-toolbar-focus-z-index, 100) !important;\n          }\n          :host([hidden]) {\n            z-index: -1;\n            visibility: hidden;\n            opacity: 0;\n            height: 0;\n            overflow: hidden;\n          }\n          :host([disabled]) {\n            pointer-events: none;\n          }\n          button[part="button"] {\n            display: flex;\n            margin: 0;\n            white-space: nowrap;\n            width: 100%;\n            height: 100%;\n          }\n        ']);

  _templateObject10_85b73be06f4811ed83231ba15a006752 = function _templateObject10_85b73be06f4811ed83231ba15a006752() {
    return data;
  };
...
function _templateObject9_85b73be06f4811ed83231ba15a006752() {
  var data = _taggedTemplateLiteral(["\n          simple-tooltip {\n            z-index: -1;\n          }\n          :host(:hover) simple-tooltip,\n          :host(:focus-within) simple-tooltip {\n            z-index: var(--simple-toolbar-button-z-index, 2);\n          }\n        "]);

  _templateObject9_85b73be06f4811ed83231ba15a006752 = function _templateObject9_85b73be06f4811ed83231ba15a006752() {
    return data;
  };
...
function _templateObject8_85b73be06f4811ed83231ba15a006752() {
  var data = _taggedTemplateLiteral(["\n          #icon:not([icon]) {\n            display: none;\n          }\n          #icon[icon] {\n            width: var(\n              --simple-toolbar-button-width,\n              var(--simple-toolbar-button-height, 24px)\n            );\n            height: var(--simple-toolbar-button-height, 24px);\n            flex: 0 0 auto;\n          }\n        "]);

  _templateObject8_85b73be06f4811ed83231ba15a006752 = function _templateObject8_85b73be06f4811ed83231ba15a006752() {
    return data;
  };
...
function _templateObject7_85b73be06f4811ed83231ba15a006752() {
  var data = _taggedTemplateLiteral(["\n          #label {\n            padding: 0 var(--simple-toolbar-button-label-padding, 2px);\n            white-space: var(--simple-toolbar-button-label-white-space, normal);\n          }\n          .offscreen {\n            position: absolute;\n            left: -999999px;\n            top: 0;\n            height: 0;\n            width: 0;\n            overflow: hidden;\n          }\n        "]);

  _templateObject7_85b73be06f4811ed83231ba15a006752 = function _templateObject7_85b73be06f4811ed83231ba15a006752() {
    return data;
  };
...
function _templateObject6_85b73be06f4811ed83231ba15a006752() {
  var data = _taggedTemplateLiteral([' <button\n              id="button"\n              class="simple-toolbar-button"\n              ?disabled="', '"\n              ?controls="', '"\n              @click="', '"\n              @keypress="', '"\n              tabindex="0"\n              part="button"\n            >\n              ', " ", "\n            </button>\n            ", ""]);

  _templateObject6_85b73be06f4811ed83231ba15a006752 = function _templateObject6_85b73be06f4811ed83231ba15a006752() {
    return data;
  };
...
function _templateObject5_85b73be06f4811ed83231ba15a006752() {
  var data = _taggedTemplateLiteral([' <button\n              id="button"\n              aria-pressed="', '"\n              class="simple-toolbar-button"\n              ?disabled="', '"\n              ?controls="', '"\n              @click="', '"\n              @keypress="', '"\n              tabindex="0"\n              part="button"\n            >\n              ', " ", "\n            </button>\n            ", ""]);

  _templateObject5_85b73be06f4811ed83231ba15a006752 = function _templateObject5_85b73be06f4811ed83231ba15a006752() {
    return data;
  };
...
function _templateObject4_85b73be06f4811ed83231ba15a006752() {
  var data = _taggedTemplateLiteral(['<simple-tooltip\n            id="tooltip"\n            for="button"\n            position="', '"\n            part="tooltip"\n            fit-to-visible-bounds\n            >', "</simple-tooltip\n          >"]);

  _templateObject4_85b73be06f4811ed83231ba15a006752 = function _templateObject4_85b73be06f4811ed83231ba15a006752() {
    return data;
  };
...
function _templateObject3_85b73be06f4811ed83231ba15a006752() {
  var data = _taggedTemplateLiteral(['<span\n            id="label"\n            class="', '"\n            part="label"\n            >', "</span\n          >"]);

  _templateObject3_85b73be06f4811ed83231ba15a006752 = function _templateObject3_85b73be06f4811ed83231ba15a006752() {
    return data;
  };
...
function _templateObject2_85b73be06f4811ed83231ba15a006752() {
  var data = _taggedTemplateLiteral(['<simple-icon-lite\n            id="icon"\n            aria-hidden="true"\n            icon="', '"\n            part="icon"\n          ></simple-icon-lite>']);

  _templateObject2_85b73be06f4811ed83231ba15a006752 = function _templateObject2_85b73be06f4811ed83231ba15a006752() {
    return data;
  };
...
function _templateObject_85b73be06f4811ed83231ba15a006752() {
  var data = _taggedTemplateLiteral(["", ""]);

  _templateObject_85b73be06f4811ed83231ba15a006752 = function _templateObject_85b73be06f4811ed83231ba15a006752() {
    return data;
  };
  ...
  return /*#__PURE__*/function (_SuperClass) {
    ...
    _createClass(_class, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_85b73be06f4811ed83231ba15a006752(), this.buttonTemplate);
      }
      /**
      ...
      key: "iconTemplate",
      get: function get() {
        return !this.hasIcon ? "" : (0, _litElement.html)(_templateObject2_85b73be06f4811ed83231ba15a006752(), this.currentIcon);
      }
      /**
      ...
      key: "labelTemplate",
      get: function get() {
        return !this.hasLabel ? "" : (0, _litElement.html)(_templateObject3_85b73be06f4811ed83231ba15a006752(), this.labelVisible ? "" : "offscreen", this.currentLabel);
      }
      /**
      ...
      key: "tooltipTemplate",
      get: function get() {
        return !this.tooltipVisible ? "" : (0, _litElement.html)(_templateObject4_85b73be06f4811ed83231ba15a006752(), this.tooltipDirection || "bottom", this.currentTooltip || this.currentLabel);
      }
      /**
      ...
      key: "buttonTemplate",
      get: function get() {
        return this.toggles ? (0, _litElement.html)(_templateObject5_85b73be06f4811ed83231ba15a006752(), this.isToggled ? "true" : "false", this.disabled, this.controls, this._handleClick, this._handleKeys, this.iconTemplate, this.labelTemplate, this.tooltipTemplate) : (0, _litElement.html)(_templateObject6_85b73be06f4811ed83231ba15a006752(), this.disabled, this.controls, this._handleClick, this._handleKeys, this.iconTemplate, this.labelTemplate, this.tooltipTemplate);
      }
    }], [{
      key: "labelStyles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject7_85b73be06f4811ed83231ba15a006752())];
      }
      /**
      ...
      key: "iconStyles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject8_85b73be06f4811ed83231ba15a006752())];
      }
      /**
      ...
      key: "tooltipStyles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject9_85b73be06f4811ed83231ba15a006752())];
      }
      /**
      ...
      get: function get() {
        return [(0, _litElement.css)(_templateObject10_85b73be06f4811ed83231ba15a006752())];
      }
      /**
      ...
      get: function get() {
        return [(0, _litElement.css)(_templateObject11_85b73be06f4811ed83231ba15a006752())];
      }
      /**
      ...
      get: function get() {
        return [(0, _litElement.css)(_templateObject12_85b73be06f4811ed83231ba15a006752())];
      }
      /**
