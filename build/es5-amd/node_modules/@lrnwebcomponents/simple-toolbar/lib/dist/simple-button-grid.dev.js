...
function _templateObject2_3337f2f0cd8211ecaf720fdc1a41727f() {
  ...
  _templateObject2_3337f2f0cd8211ecaf720fdc1a41727f = function _templateObject2_3337f2f0cd8211ecaf720fdc1a41727f() {
    return data;
  };
...
function _templateObject_3337f2f0cd8211ecaf720fdc1a41727f() {
  var data = _taggedTemplateLiteral(['\n        <div id="grid">\n          <div\n            id="buttons"\n            class="', '"\n            style="', '"\n            part="buttons"\n          >\n            <slot></slot>\n            ', "\n          </div>\n        </div>\n      "]);

  _templateObject_3337f2f0cd8211ecaf720fdc1a41727f = function _templateObject_3337f2f0cd8211ecaf720fdc1a41727f() {
    return data;
  };
...
var SimpleButtonGridBehaviors = function SimpleButtonGridBehaviors(SuperClass) {
  return /*#__PURE__*/function (_SimpleToolbarBehavio) {
    ...
    _createClass(_class, [{
      ...
      key: "toolbarTemplate",
      get: function get() {
        return (0, _litElement.html)(_templateObject_3337f2f0cd8211ecaf720fdc1a41727f(), !this.alwaysExpanded && this.collapsed ? "collapsed" : "", this.gridStyles, this.alwaysExpanded ? "" : this.moreButton);
      }
    }], [{
      key: "baseStyles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_3337f2f0cd8211ecaf720fdc1a41727f())];
