...
function _templateObject2_9bfd35a0509711edb124eb517be36dbf() {
  ...
  _templateObject2_9bfd35a0509711edb124eb517be36dbf = function _templateObject2_9bfd35a0509711edb124eb517be36dbf() {
    return data;
  };
...
function _templateObject_9bfd35a0509711edb124eb517be36dbf() {
  var data = _taggedTemplateLiteral(['\n        <div id="grid">\n          <div\n            id="buttons"\n            class="', '"\n            style="', '"\n            part="buttons"\n          >\n            <slot></slot>\n            ', "\n          </div>\n        </div>\n      "]);

  _templateObject_9bfd35a0509711edb124eb517be36dbf = function _templateObject_9bfd35a0509711edb124eb517be36dbf() {
    return data;
  };
...
var SimpleButtonGridBehaviors = function SimpleButtonGridBehaviors(SuperClass) {
  return /*#__PURE__*/function (_SimpleToolbarBehavio) {
    ...
    _createClass(_class, [{
      ...
      key: "toolbarTemplate",
      get: function get() {
        return (0, _litElement.html)(_templateObject_9bfd35a0509711edb124eb517be36dbf(), !this.alwaysExpanded && this.collapsed ? "collapsed" : "", this.gridStyles, this.alwaysExpanded ? "" : this.moreButton);
      }
    }], [{
      key: "baseStyles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_9bfd35a0509711edb124eb517be36dbf())];
