...
function _templateObject2_0db1a5e0e4f511ed85766367b4d3e9fc() {
  ...
  _templateObject2_0db1a5e0e4f511ed85766367b4d3e9fc = function _templateObject2_0db1a5e0e4f511ed85766367b4d3e9fc() {
    return data;
  };
  return data;
}
function _templateObject_0db1a5e0e4f511ed85766367b4d3e9fc() {
  var data = _taggedTemplateLiteral(['\n        <div id="grid">\n          <div\n            id="buttons"\n            class="', '"\n            style="', '"\n            part="buttons"\n          >\n            <slot></slot>\n            ', "\n          </div>\n        </div>\n      "]);
  _templateObject_0db1a5e0e4f511ed85766367b4d3e9fc = function _templateObject_0db1a5e0e4f511ed85766367b4d3e9fc() {
    return data;
  };
  return data;
}
  ...
  return /*#__PURE__*/(
    function (_SimpleToolbarBehavio) {
      ...
      _createClass(_class, [{
        ...
        key: "toolbarTemplate",
        get: function get() {
          return (0, _litElement.html)(_templateObject_0db1a5e0e4f511ed85766367b4d3e9fc(), !this.alwaysExpanded && this.collapsed ? "collapsed" : "", this.gridStyles, this.alwaysExpanded ? "" : this.moreButton);
        }
      }], [{
        key: "baseStyles",
        get: function get() {
          return [(0, _litElement.css)(_templateObject2_0db1a5e0e4f511ed85766367b4d3e9fc())];
