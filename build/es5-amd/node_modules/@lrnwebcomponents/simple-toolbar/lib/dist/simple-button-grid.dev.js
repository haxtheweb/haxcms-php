...
function _templateObject2_79944f102ee311eda9c37b2c2696a94a() {
  ...
  _templateObject2_79944f102ee311eda9c37b2c2696a94a = function _templateObject2_79944f102ee311eda9c37b2c2696a94a() {
    return data;
  };
...
function _templateObject_79944f102ee311eda9c37b2c2696a94a() {
  var data = _taggedTemplateLiteral(['\n        <div id="grid">\n          <div\n            id="buttons"\n            class="', '"\n            style="', '"\n            part="buttons"\n          >\n            <slot></slot>\n            ', "\n          </div>\n        </div>\n      "]);

  _templateObject_79944f102ee311eda9c37b2c2696a94a = function _templateObject_79944f102ee311eda9c37b2c2696a94a() {
    return data;
  };
...
var SimpleButtonGridBehaviors = function SimpleButtonGridBehaviors(SuperClass) {
  return /*#__PURE__*/function (_SimpleToolbarBehavio) {
    ...
    _createClass(_class, [{
      ...
      key: "toolbarTemplate",
      get: function get() {
        return (0, _litElement.html)(_templateObject_79944f102ee311eda9c37b2c2696a94a(), !this.alwaysExpanded && this.collapsed ? "collapsed" : "", this.gridStyles, this.alwaysExpanded ? "" : this.moreButton);
      }
    }], [{
      key: "baseStyles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_79944f102ee311eda9c37b2c2696a94a())];
