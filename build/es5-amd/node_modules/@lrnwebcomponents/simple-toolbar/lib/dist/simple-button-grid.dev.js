...
function _templateObject2_1d9b3260930211eb82a7a575782a1009() {
  ...
  _templateObject2_1d9b3260930211eb82a7a575782a1009 = function _templateObject2_1d9b3260930211eb82a7a575782a1009() {
    return data;
  };
...
function _templateObject_1d9b3260930211eb82a7a575782a1009() {
  var data = _taggedTemplateLiteral(['\n        <div id="grid">\n          <div\n            id="buttons"\n            class="', '"\n            style="', '"\n            part="buttons"\n          >\n            <slot></slot>\n            ', "\n          </div>\n        </div>\n      "]);

  _templateObject_1d9b3260930211eb82a7a575782a1009 = function _templateObject_1d9b3260930211eb82a7a575782a1009() {
    return data;
  };
...
var SimpleButtonGridBehaviors = function SimpleButtonGridBehaviors(SuperClass) {
  return /*#__PURE__*/function (_SimpleToolbarBehavio) {
    ...
    _createClass(_class, [{
      ...
      key: "toolbarTemplate",
      get: function get() {
        return (0, _litElement.html)(_templateObject_1d9b3260930211eb82a7a575782a1009(), !this.alwaysExpanded && this.collapsed ? "collapsed" : "", this.gridStyles, this.alwaysExpanded ? "" : this.moreButton);
      }
    }], [{
      key: "baseStyles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_1d9b3260930211eb82a7a575782a1009())];
