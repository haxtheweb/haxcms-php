...
function _templateObject2_d235bbc0403311edb9fff3e6b08a0a9a() {
  ...
  _templateObject2_d235bbc0403311edb9fff3e6b08a0a9a = function _templateObject2_d235bbc0403311edb9fff3e6b08a0a9a() {
    return data;
  };
...
function _templateObject_d235bbc0403311edb9fff3e6b08a0a9a() {
  var data = _taggedTemplateLiteral(['\n        <div id="grid">\n          <div\n            id="buttons"\n            class="', '"\n            style="', '"\n            part="buttons"\n          >\n            <slot></slot>\n            ', "\n          </div>\n        </div>\n      "]);

  _templateObject_d235bbc0403311edb9fff3e6b08a0a9a = function _templateObject_d235bbc0403311edb9fff3e6b08a0a9a() {
    return data;
  };
...
var SimpleButtonGridBehaviors = function SimpleButtonGridBehaviors(SuperClass) {
  return /*#__PURE__*/function (_SimpleToolbarBehavio) {
    ...
    _createClass(_class, [{
      ...
      key: "toolbarTemplate",
      get: function get() {
        return (0, _litElement.html)(_templateObject_d235bbc0403311edb9fff3e6b08a0a9a(), !this.alwaysExpanded && this.collapsed ? "collapsed" : "", this.gridStyles, this.alwaysExpanded ? "" : this.moreButton);
      }
    }], [{
      key: "baseStyles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_d235bbc0403311edb9fff3e6b08a0a9a())];
