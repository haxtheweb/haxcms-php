define(["exports", "require", "../../lit/index.js", "../simple-colors/simple-colors.js"], function (_exports, _require, _index, _simpleColors) {
  ...
  var _templateObject_ecc8c9e0e51111edbf9f41986c80248c, _templateObject2_ecc8c9e0e51111edbf9f41986c80248c, _templateObject3_ecc8c9e0e51111edbf9f41986c80248c;
  ...
  var a11yCompareImage = /*#__PURE__*/function (_SimpleColors) {
    ...
    babelHelpers.createClass(a11yCompareImage, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_ecc8c9e0e51111edbf9f41986c80248c || (_templateObject_ecc8c9e0e51111edbf9f41986c80248c = babelHelpers.taggedTemplateLiteral([" <figure>\n      <figcaption>\n        <slot name=\"heading\"></slot>\n        <div id=\"description\"><slot name=\"description\"></slot></div>\n      </figcaption>\n      <div id=\"container\" style=\"background-image: url(", ")\">\n        <div>\n          <div id=\"placeholder\">\n            <slot id=\"bottom\" name=\"bottom\"></slot>\n          </div>\n          <slot name=\"top\" hidden></slot>\n          <div id=\"layer\" style=\"background-image: url(", ")\"></div>\n          <slot></slot>\n        </div>\n      </div>\n      <div id=\"input\">\n        ", "\n        <simple-range-input\n          accent-color=\"", "\"\n          ?dark=\"", "\"\n          id=\"slider\"\n          label=\"", "\"\n          @immediate-value-changed=\"", "\"\n          value=\"", "\"\n          immediate-value=\"", "\"\n        ></simple-range-input>\n      </div>\n    </figure>"])), this.__lower, this.__upper, this.__markers.map(function (marker) {
          return (0, _index.html)(_templateObject2_ecc8c9e0e51111edbf9f41986c80248c || (_templateObject2_ecc8c9e0e51111edbf9f41986c80248c = babelHelpers.taggedTemplateLiteral(["\n              <div\n                class=\"marker\"\n                .style=\"left: ", "%;\"\n                ?hidden=\"", "\"\n              ></div>\n            "])), marker, marker == 100);
      ...
      value: function _slide() {
        ...
        var layers = this.querySelectorAll("[slot=top],[slot=bottom]");
        ...
        var active = Math.floor(this.position / section) || 0;
        ...
        var lastSection = section * active;
