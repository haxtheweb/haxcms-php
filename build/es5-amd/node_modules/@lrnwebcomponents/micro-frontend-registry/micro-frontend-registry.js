define(["exports"], function (_exports) {
  ...
  var MicroFrontendKeys = ["endpoint", "name", "title", "description", "params", "callback", "method"];
          ...
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              case 0:
                ...
                urlStringAddon = _args.length > 4 && _args[4] !== undefined ? _args[4] : '';
                if (!this.has(name)) {
                  _context.next = 29;
                  break;
                }
                ...
                data = null;
                _context.t0 = method;
                _context.next = _context.t0 === "GET" ? 13 : _context.t0 === "HEAD" ? 13 : _context.t0 === "POST" ? 18 : 18;
                break;
              case 13:
                // support for formdata which is already encoded
                searchParams = new URLSearchParams(params).toString();
                _context.next = 16;
                return fetch(searchParams ? "".concat(item.endpoint, "?").concat(searchParams).concat(urlStringAddon) : item.endpoint + urlStringAddon, {
                  method: method
                }).then(function (d) {
                  return d.ok ? d.json() : {
                    status: d.status,
              ...
              case 18:
                _context.next = 20;
                return fetch(item.endpoint + urlStringAddon, {
                  method: method,
