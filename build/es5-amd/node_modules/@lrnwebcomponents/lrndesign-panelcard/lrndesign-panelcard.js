define(["exports","../../@polymer/polymer/polymer-legacy.js","../../@polymer/paper-card/paper-card.js","../simple-colors/simple-colors.js","../hax-body-behaviors/lib/HAXWiring.js"],function(_exports,_polymerLegacy,_paperCard,_simpleColors,_HAXWiring){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.LrndesignPanelcard=void 0;function _templateObject_e06f36f0685311e9b25d1735312af746(){var data=babelHelpers.taggedTemplateLiteral(["\n    <style include=\"simple-colors\"></style>\n    <style>\n      :host {\n        display: inline-block;\n        position: relative;\n        box-sizing: border-box;\n        --lrndesign-panelcard-text-color: var(\n          --simple-colors-default-theme-grey-12\n        );\n        --lrndesign-panelcard-color: var(\n          --simple-colors-default-theme-accent-1\n        );\n      }\n      :host([dark]:not([accent-color=\"grey\"])) {\n        --lrndesign-panelcard-color: var(\n          --simple-colors-default-theme-accent-3\n        );\n      }\n      :host([colored-text]) {\n        --lrndesign-panelcard-text-color: var(\n          --simple-colors-default-theme-accent-9\n        );\n        --lrndesign-panelcard-color: var(--simple-colors-default-theme-grey-1);\n      }\n      .card-panel {\n        transition: box-shadow 0.25s;\n        padding: 24px;\n        margin: 0;\n        border-radius: 2px;\n        color: var(--lrndesign-panelcard-text-color);\n        background-color: var(--lrndesign-panelcard-color);\n      }\n\n      h3 {\n        padding: 0;\n        margin: 0 0 8px 0;\n      }\n    </style>\n    <aside>\n      <paper-card elevation=\"[[elevation]]\">\n        <div class=\"card-panel\">\n          <h3>[[title]]</h3>\n          <span><slot></slot></span>\n        </div>\n      </paper-card>\n    </aside>\n  "]);_templateObject_e06f36f0685311e9b25d1735312af746=function _templateObject_e06f36f0685311e9b25d1735312af746(){return data};return data}/**
`lrndesign-panelcard`
A LRN element

* @demo demo/index.html
*/var LrndesignPanelcard=(0,_polymerLegacy.Polymer)({_template:(0,_polymerLegacy.html)(_templateObject_e06f36f0685311e9b25d1735312af746()),is:"lrndesign-panelcard",behaviors:[HAXBehaviors.PropertiesBehaviors,_simpleColors.SimpleColors],properties:{/**
     * Title of the panel
