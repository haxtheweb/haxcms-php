define(["exports", "../../../lit/index.js", "../../utils/utils.js", "../simple-autocomplete.js"], function (_exports, _index, _utils, _simpleAutocomplete) {
  ...
  var _templateObject_8d0963c0509711edb124eb517be36dbf;
  ...
  var SimpleAutocompleteTextTrigger = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(SimpleAutocompleteTextTrigger, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_8d0963c0509711edb124eb517be36dbf || (_templateObject_8d0963c0509711edb124eb517be36dbf = babelHelpers.taggedTemplateLiteral(["<simple-autocomplete\n        @item-selected=\"", "\"\n        selection-position\n        hide-input\n      ></simple-autocomplete\n      ><slot></slot>"])), this.valueChanged);
      }
      /**
       * Convention we use
       */
