define(["exports", "../../../lit/index.js", "../../utils/utils.js", "../simple-autocomplete.js"], function (_exports, _index, _utils, _simpleAutocomplete) {
  ...
  var _templateObject_fd383920e46a11edbf2e2349c355f24c;
  ...
  var SimpleAutocompleteTextTrigger = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(SimpleAutocompleteTextTrigger, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_fd383920e46a11edbf2e2349c355f24c || (_templateObject_fd383920e46a11edbf2e2349c355f24c = babelHelpers.taggedTemplateLiteral(["<simple-autocomplete\n        @item-selected=\"", "\"\n        selection-position\n        hide-input\n      ></simple-autocomplete\n      ><slot></slot>"])), this.valueChanged);
      }
      /**
       * Convention we use
       */
      ...
      value: function updated(changedProperties) {
        ...
        changedProperties.forEach(function (oldValue, propName) {
          ...
          if (propName == "value" && _this2.value != "" && _this2.target) {
            ...
            _this2.setTargetValue(old.substring(0, _this2._triggerStart - 1) + _this2.value + old.substring(_this2._triggerEnd));
