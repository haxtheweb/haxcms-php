define(["exports", "../../../lit-element/lit-element.js", "../../utils/utils.js", "../simple-autocomplete.js"], function (_exports, _litElement, _utils, _simpleAutocomplete) {
  ...
  function _templateObject_327938103ee511ebb7f7a1171f0cd59d() {
    var data = babelHelpers.taggedTemplateLiteral(["<simple-autocomplete\n        @item-selected=\"", "\"\n        selection-position\n        hide-input\n      ></simple-autocomplete\n      ><slot></slot>"]);

    _templateObject_327938103ee511ebb7f7a1171f0cd59d = function _templateObject_327938103ee511ebb7f7a1171f0cd59d() {
      return data;
    };
  ...
  var SimpleAutocompleteTextTrigger = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(SimpleAutocompleteTextTrigger, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_327938103ee511ebb7f7a1171f0cd59d(), this.valueChanged);
      }
      /**
       * Convention we use
       */
