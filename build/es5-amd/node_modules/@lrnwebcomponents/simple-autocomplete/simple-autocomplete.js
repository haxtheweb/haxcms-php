define(["exports", "require", "../../lit-element/lit-element.js", "../simple-filter/simple-filter.js", "../utils/utils.js", "../simple-popover/simple-popover.js"], function (_exports, _require, _litElement, _simpleFilter, _utils, _simplePopover) {
  ...
  function _templateObject8_63c03bd03efe11eb800233a440abe59f() {
    ...
    _templateObject8_63c03bd03efe11eb800233a440abe59f = function _templateObject8_63c03bd03efe11eb800233a440abe59f() {
      return data;
    };
  ...
  function _templateObject7_63c03bd03efe11eb800233a440abe59f() {
    var data = babelHelpers.taggedTemplateLiteral(["<div class=\"no-results\" part=\"no-result\">No results</div>"]);

    _templateObject7_63c03bd03efe11eb800233a440abe59f = function _templateObject7_63c03bd03efe11eb800233a440abe59f() {
      return data;
    };
  ...
  function _templateObject6_63c03bd03efe11eb800233a440abe59f() {
    var data = babelHelpers.taggedTemplateLiteral(["<simple-icon-lite\n                                icon=\"", "\"\n                              ></simple-icon-lite>"]);

    _templateObject6_63c03bd03efe11eb800233a440abe59f = function _templateObject6_63c03bd03efe11eb800233a440abe59f() {
      return data;
    };
  ...
  function _templateObject5_63c03bd03efe11eb800233a440abe59f() {
    var data = babelHelpers.taggedTemplateLiteral(["<li\n                        role=\"option\"\n                        part=\"list-item\"\n                        value=\"", "\"\n                        data-index=\"", "\"\n                      >\n                        <button\n                          part=\"button\"\n                          value=\"", "\"\n                          data-index=\"", "\"\n                          @click=\"", "\"\n                        >\n                          ", "", "\n                        </button>\n                      </li>"]);

    _templateObject5_63c03bd03efe11eb800233a440abe59f = function _templateObject5_63c03bd03efe11eb800233a440abe59f() {
      return data;
    };
  ...
  function _templateObject4_63c03bd03efe11eb800233a440abe59f() {
    var data = babelHelpers.taggedTemplateLiteral(["", ""]);

    _templateObject4_63c03bd03efe11eb800233a440abe59f = function _templateObject4_63c03bd03efe11eb800233a440abe59f() {
      return data;
    };
  ...
  function _templateObject3_63c03bd03efe11eb800233a440abe59f() {
    var data = babelHelpers.taggedTemplateLiteral([" <ul\n              part=\"list\"\n              role=\"listbox\"\n              @keydown=\"", "\"\n            >\n              ", "\n            </ul>"]);

    _templateObject3_63c03bd03efe11eb800233a440abe59f = function _templateObject3_63c03bd03efe11eb800233a440abe59f() {
      return data;
    };
  ...
  function _templateObject2_63c03bd03efe11eb800233a440abe59f() {
    var data = babelHelpers.taggedTemplateLiteral(["<span\n            part=\"input\"\n            id=\"input\"\n            name=\"input\"\n            @input=\"", "\"\n            contenteditable\n            @keydown=\"", "\"\n          ></span>"]);

    _templateObject2_63c03bd03efe11eb800233a440abe59f = function _templateObject2_63c03bd03efe11eb800233a440abe59f() {
      return data;
    };
  ...
  function _templateObject_63c03bd03efe11eb800233a440abe59f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      ", "\n      <simple-popover\n        part=\"popover\"\n        auto\n        part=\"simple-popover\"\n        ?hidden=\"", "\"\n        position=\"bottom\"\n        for=\"input\"\n      >\n        ", "\n      </simple-popover>\n    "]);

    _templateObject_63c03bd03efe11eb800233a440abe59f = function _templateObject_63c03bd03efe11eb800233a440abe59f() {
      return data;
    };
  ...
  var SimpleAutocomplete = /*#__PURE__*/function (_SimpleFilterMixin) {
    ...
    babelHelpers.createClass(SimpleAutocomplete, [{
      ...
      value: function render() {
        ...
        return (0, _litElement.html)(_templateObject_63c03bd03efe11eb800233a440abe59f(), !this.hideInput ? (0, _litElement.html)(_templateObject2_63c03bd03efe11eb800233a440abe59f(), this.inputChanged, this.a11yInputKeys) : "", !this.opened || this.filtered.length === 0, this.filtered.length > 0 && this.opened ? (0, _litElement.html)(_templateObject3_63c03bd03efe11eb800233a440abe59f(), this.a11yListKeys, this.filtered.map(function (item, i) {
          return (0, _litElement.html)(_templateObject4_63c03bd03efe11eb800233a440abe59f(), i < _this2.itemLimit ? (0, _litElement.html)(_templateObject5_63c03bd03efe11eb800233a440abe59f(), item.value, i, item.value, i, _this2.itemSelect, item.icon ? (0, _litElement.html)(_templateObject6_63c03bd03efe11eb800233a440abe59f(), item.icon) : "", item.label) : "");
        })) : (0, _litElement.html)(_templateObject7_63c03bd03efe11eb800233a440abe59f()));
      }
      /**
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject8_63c03bd03efe11eb800233a440abe59f())];
      }
    }]);
