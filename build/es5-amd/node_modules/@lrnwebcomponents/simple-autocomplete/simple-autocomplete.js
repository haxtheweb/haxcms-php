define(["exports", "require", "../../lit-element/lit-element.js", "../simple-filter/simple-filter.js", "../utils/utils.js", "../simple-popover/simple-popover.js"], function (_exports, _require, _litElement, _simpleFilter, _utils, _simplePopover) {
  ...
  function _templateObject8_0b7c3840930211eb82a7a575782a1009() {
    ...
    _templateObject8_0b7c3840930211eb82a7a575782a1009 = function _templateObject8_0b7c3840930211eb82a7a575782a1009() {
      return data;
    };
  ...
  function _templateObject7_0b7c3840930211eb82a7a575782a1009() {
    var data = babelHelpers.taggedTemplateLiteral(["<div class=\"no-results\" part=\"no-result\">No results</div>"]);

    _templateObject7_0b7c3840930211eb82a7a575782a1009 = function _templateObject7_0b7c3840930211eb82a7a575782a1009() {
      return data;
    };
  ...
  function _templateObject6_0b7c3840930211eb82a7a575782a1009() {
    var data = babelHelpers.taggedTemplateLiteral(["<simple-icon-lite\n                                icon=\"", "\"\n                              ></simple-icon-lite>"]);

    _templateObject6_0b7c3840930211eb82a7a575782a1009 = function _templateObject6_0b7c3840930211eb82a7a575782a1009() {
      return data;
    };
  ...
  function _templateObject5_0b7c3840930211eb82a7a575782a1009() {
    var data = babelHelpers.taggedTemplateLiteral(["<li\n                        role=\"option\"\n                        part=\"list-item\"\n                        value=\"", "\"\n                        data-index=\"", "\"\n                      >\n                        <button\n                          part=\"button\"\n                          value=\"", "\"\n                          data-index=\"", "\"\n                          @click=\"", "\"\n                        >\n                          ", "", "\n                        </button>\n                      </li>"]);

    _templateObject5_0b7c3840930211eb82a7a575782a1009 = function _templateObject5_0b7c3840930211eb82a7a575782a1009() {
      return data;
    };
  ...
  function _templateObject4_0b7c3840930211eb82a7a575782a1009() {
    var data = babelHelpers.taggedTemplateLiteral(["", ""]);

    _templateObject4_0b7c3840930211eb82a7a575782a1009 = function _templateObject4_0b7c3840930211eb82a7a575782a1009() {
      return data;
    };
  ...
  function _templateObject3_0b7c3840930211eb82a7a575782a1009() {
    var data = babelHelpers.taggedTemplateLiteral([" <ul\n              part=\"list\"\n              role=\"listbox\"\n              @keydown=\"", "\"\n            >\n              ", "\n            </ul>"]);

    _templateObject3_0b7c3840930211eb82a7a575782a1009 = function _templateObject3_0b7c3840930211eb82a7a575782a1009() {
      return data;
    };
  ...
  function _templateObject2_0b7c3840930211eb82a7a575782a1009() {
    var data = babelHelpers.taggedTemplateLiteral(["<span\n            part=\"input\"\n            id=\"input\"\n            name=\"input\"\n            @input=\"", "\"\n            contenteditable\n            @keydown=\"", "\"\n          ></span>"]);

    _templateObject2_0b7c3840930211eb82a7a575782a1009 = function _templateObject2_0b7c3840930211eb82a7a575782a1009() {
      return data;
    };
  ...
  function _templateObject_0b7c3840930211eb82a7a575782a1009() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      ", "\n      <simple-popover\n        part=\"popover\"\n        auto\n        part=\"simple-popover\"\n        ?hidden=\"", "\"\n        position=\"bottom\"\n        for=\"input\"\n      >\n        ", "\n      </simple-popover>\n    "]);

    _templateObject_0b7c3840930211eb82a7a575782a1009 = function _templateObject_0b7c3840930211eb82a7a575782a1009() {
      return data;
    };
  ...
  var SimpleAutocomplete = /*#__PURE__*/function (_SimpleFilterMixin) {
    ...
    babelHelpers.createClass(SimpleAutocomplete, [{
      ...
      value: function render() {
        ...
        return (0, _litElement.html)(_templateObject_0b7c3840930211eb82a7a575782a1009(), !this.hideInput ? (0, _litElement.html)(_templateObject2_0b7c3840930211eb82a7a575782a1009(), this.inputChanged, this.a11yInputKeys) : "", !this.opened || this.filtered.length === 0, this.filtered.length > 0 && this.opened ? (0, _litElement.html)(_templateObject3_0b7c3840930211eb82a7a575782a1009(), this.a11yListKeys, this.filtered.map(function (item, i) {
          return (0, _litElement.html)(_templateObject4_0b7c3840930211eb82a7a575782a1009(), i < _this2.itemLimit ? (0, _litElement.html)(_templateObject5_0b7c3840930211eb82a7a575782a1009(), item.value, i, item.value, i, _this2.itemSelect, item.icon ? (0, _litElement.html)(_templateObject6_0b7c3840930211eb82a7a575782a1009(), item.icon) : "", item.label) : "");
        })) : (0, _litElement.html)(_templateObject7_0b7c3840930211eb82a7a575782a1009()));
      }
      /**
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject8_0b7c3840930211eb82a7a575782a1009())];
      }
    }]);
