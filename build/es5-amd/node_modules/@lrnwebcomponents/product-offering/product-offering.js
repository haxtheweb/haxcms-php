define(["exports", "../../lit/index.js", "../simple-colors/simple-colors.js", "../intersection-element/lib/IntersectionObserverMixin.js", "../simple-icon/simple-icon.js", "../simple-icon/lib/simple-icons.js"], function (_exports, _index, _simpleColors, _IntersectionObserverMixin, _simpleIcon, _simpleIcons) {
  ...
  var _templateObject_53c31110509711edb124eb517be36dbf, _templateObject2_53c31110509711edb124eb517be36dbf, _templateObject3_53c31110509711edb124eb517be36dbf;
  ...
  var ProductOffering = /*#__PURE__*/function (_IntersectionObserver) {
    ...
    babelHelpers.createClass(ProductOffering, [{
       ...
       */
      function render() {
        return (0, _index.html)(_templateObject_53c31110509711edb124eb517be36dbf || (_templateObject_53c31110509711edb124eb517be36dbf = babelHelpers.taggedTemplateLiteral(["\n      ", "\n    "])), this.elementVisible ? (0, _index.html)(_templateObject2_53c31110509711edb124eb517be36dbf || (_templateObject2_53c31110509711edb124eb517be36dbf = babelHelpers.taggedTemplateLiteral([" <!-- Container -->\n            <div class=\"container\">\n              <img\n                class=\"image\"\n                src=\"", "\"\n                alt=\"", "\"\n                loading=\"lazy\"\n              />\n\n              <div class=\"square\">\n                <!-- Icon, Header -->\n                <div class=\"squareTitle\">\n                  <!-- icon -->\n                  <div class=\"icon-background\">\n                    <simple-icon\n                      accent-color=\"", "\"\n                      ?dark=\"", "\"\n                      .icon=\"", "\"\n                    ></simple-icon>\n                  </div>\n                  <!-- header -->\n                  <h4>\n                    <span class=\"underline\">", "</span>&nbsp;<span\n                      >", "</span\n                    >\n                  </h4>\n                </div>\n\n                <!-- descripton -->\n                <div class=\"sqaureDescription\">\n                  <slot name=\"description\">", "</slot>\n                </div>\n              </div>\n            </div>"])), this.source, this.alt, this.accentColor, this.dark, this.icon, this._titleOne, this._titleTwo, this.description) : "");
      }
      /**
       * Convention we use
       */
