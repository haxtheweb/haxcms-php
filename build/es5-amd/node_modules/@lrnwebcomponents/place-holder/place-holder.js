define(["exports", "../simple-colors/simple-colors.js", "../../lit-element/lit-element.js", "../simple-icon/simple-icon.js", "../simple-icon/lib/simple-icons.js"], function (_exports, _simpleColors, _litElement, _simpleIcon, _simpleIcons) {
  ...
  var _templateObject_2a5bbf10b99a11ebbf7975e2d57542c0, _templateObject2_2a5bbf10b99a11ebbf7975e2d57542c0;
  ...
  var PlaceHolder = /*#__PURE__*/function (_SimpleColors) {
    ...
    babelHelpers.createClass(PlaceHolder, [{
       ...
       */
      function render() {
        return (0, _litElement.html)(_templateObject_2a5bbf10b99a11ebbf7975e2d57542c0 || (_templateObject_2a5bbf10b99a11ebbf7975e2d57542c0 = babelHelpers.taggedTemplateLiteral(["\n      <div class=\"wrapper\">\n        <simple-icon icon=\"", "\"></simple-icon>\n        <div class=\"text\">", "</div>\n        <div class=\"directions\">", "</div>\n      </div>\n    "])), this.iconFromType, this.calcText, this.directions);
      }
    }, {
      key: "updated",
      value:
       ...
       */
      function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(PlaceHolder), "styles", this)), [(0, _litElement.css)(_templateObject2_2a5bbf10b99a11ebbf7975e2d57542c0 || (_templateObject2_2a5bbf10b99a11ebbf7975e2d57542c0 = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n          border: none;\n          transition: 0.2s all linear;\n        }\n        :host([drag-over]) {\n          border: var(--place-holder-drag-over-border, 4px dashed #2196f3);\n        }\n        .wrapper {\n          text-align: center;\n          padding: 16px;\n          color: var(--simple-colors-default-theme-grey-11, #222222);\n          background-color: var(--simple-colors-default-theme-grey-2, #eeeeee);\n        }\n        simple-icon {\n          margin: 0 auto;\n          --simple-icon-width: 50%;\n          --simple-icon-height: 50%;\n          display: block;\n        }\n        .text {\n          line-height: 24px;\n          font-size: 24px;\n        }\n        .directions {\n          line-height: 16px;\n          font-size: 16px;\n          font-style: italic;\n        }\n      "])))]);
      }
    }, {
      key: "tag",
      get: function get() {
