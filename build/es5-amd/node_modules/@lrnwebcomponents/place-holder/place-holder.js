define(["exports", "../simple-colors/simple-colors.js", "../../lit/index.js", "../simple-icon/simple-icon.js", "../simple-icon/lib/simple-icons.js"], function (_exports, _simpleColors, _index, _simpleIcon, _simpleIcons) {
  ...
  var _templateObject_9f061ef0ccb811ecb1815d30884c2804, _templateObject2_9f061ef0ccb811ecb1815d30884c2804;
  ...
  var PlaceHolder = /*#__PURE__*/function (_SimpleColors) {
    ...
    babelHelpers.createClass(PlaceHolder, [{
       ...
       */
      function render() {
        return (0, _index.html)(_templateObject_9f061ef0ccb811ecb1815d30884c2804 || (_templateObject_9f061ef0ccb811ecb1815d30884c2804 = babelHelpers.taggedTemplateLiteral(["\n      <div class=\"wrapper\">\n        <simple-icon\n          ?dark=\"", "\"\n          icon=\"", "\"\n          accent-color=\"", "\"\n        ></simple-icon>\n        <div class=\"text\">", "</div>\n        <div class=\"directions\">", "</div>\n      </div>\n    "])), this.dark, this.iconFromType, this.accentColor, this.calcText, this.directions);
      }
    }, {
      key: "updated",
      value:
       ...
       */
      function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(PlaceHolder), "styles", this)), [(0, _index.css)(_templateObject2_9f061ef0ccb811ecb1815d30884c2804 || (_templateObject2_9f061ef0ccb811ecb1815d30884c2804 = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n          border: none;\n          transition: 0.2s all linear;\n        }\n        :host([drag-over]) {\n          border: var(--place-holder-drag-over-border, 4px dashed #2196f3);\n        }\n        .wrapper {\n          text-align: center;\n          padding: 16px;\n          color: var(--simple-colors-default-theme-accent-12, #222222);\n          background-color: var(\n            --simple-colors-default-theme-accent-1,\n            #eeeeee\n          );\n        }\n        simple-icon {\n          margin: 0 auto;\n          --simple-icon-width: 50%;\n          --simple-icon-height: 50%;\n          display: block;\n        }\n        .text {\n          line-height: 24px;\n          font-size: 24px;\n        }\n        .directions {\n          line-height: 16px;\n          font-size: 16px;\n          font-style: italic;\n        }\n      "])))]);
      }
    }, {
      key: "tag",
      get: function get() {
