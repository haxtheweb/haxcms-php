define(["exports", "meta", "../../lit/index.js", "../es-global-bridge/es-global-bridge.js", "../simple-icon/simple-icon.js", "../simple-icon/lib/simple-icons.js", "../simple-icon/lib/simple-icon-button.js"], function (_exports, meta, _index, _esGlobalBridge, _simpleIcon, _simpleIcons, _simpleIconButton) {
  ...
  var _templateObject_1f7ed990e8f211edb01b473406559cea, _templateObject2_1f7ed990e8f211edb01b473406559cea, _templateObject3_1f7ed990e8f211edb01b473406559cea, _templateObject4_1f7ed990e8f211edb01b473406559cea, _templateObject5_1f7ed990e8f211edb01b473406559cea;
  ...
  var RssItems = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(RssItems, [{
      ...
      function render() {
        var _this2 = this;
        return (0, _index.html)(_templateObject_1f7ed990e8f211edb01b473406559cea || (_templateObject_1f7ed990e8f211edb01b473406559cea = babelHelpers.taggedTemplateLiteral([" ", ""])), this.items.map(function (item) {
          return (0, _index.html)(_templateObject2_1f7ed990e8f211edb01b473406559cea || (_templateObject2_1f7ed990e8f211edb01b473406559cea = babelHelpers.taggedTemplateLiteral(["\n        <article>\n          ", "\n          <a href=\"", "\" title=\"", "\">\n            <span class=\"title\"\n              >", "</span\n            >\n          </a>\n          <div class=\"excerpt\">\n            ", "\n          </div>\n          ", "\n        </article>\n      "])), item.imageSrc ? (0, _index.html)(_templateObject3_1f7ed990e8f211edb01b473406559cea || (_templateObject3_1f7ed990e8f211edb01b473406559cea = babelHelpers.taggedTemplateLiteral(["\n                <a\n                  class=\"thumbnail-container\"\n                  href=\"", "\"\n                  title=\"", "\"\n                >\n                  <img\n                    class=\"thumbnail\"\n                    src=\"", "\"\n                    alt=\"", "\"\n                    loading=\"lazy\"\n                  />\n                </a>\n              "])), item.link, item.title, item.imageSrc, item.title) : "", item.link, item.title, _this2._truncateText(item.title, _this2.maxTitleLength), _this2._truncateText(item.excerpt, _this2.maxExcerptLength), _this2.showReadMore ? (0, _index.html)(_templateObject4_1f7ed990e8f211edb01b473406559cea || (_templateObject4_1f7ed990e8f211edb01b473406559cea = babelHelpers.taggedTemplateLiteral(["\n                <a\n                  tabindex=\"-1\"\n                  href=\"", "\"\n                  class=\"read-more\"\n                  title=\"", "\"\n                  >", "\n                  <simple-icon-button\n                    icon=\"icons:arrow-forward\"\n                    class=\"read-more-icon\"\n                    alt=\"", "\"\n                  ></simple-icon-button>\n                </a>\n              "])), item.link, item.title, _this2.readMoreAnchorText, _this2.readMoreImageAlt) : "");
        }));
      }
      ...
      //styles function
      function get() {
        return [(0, _index.css)(_templateObject5_1f7ed990e8f211edb01b473406559cea || (_templateObject5_1f7ed990e8f211edb01b473406559cea = babelHelpers.taggedTemplateLiteral(["\n        :host([hidden]) {\n          display: none;\n        }\n\n        :host {\n          display: flex;\n          flex-wrap: wrap;\n          flex-direction: row;\n          align-items: flex-start;\n          justify-content: space-between;\n        }\n\n        :host * {\n          box-sizing: border-box;\n        }\n\n        h3,\n        p {\n          margin: 0;\n        }\n\n        a {\n          color: var(--primary-color, inherit);\n          text-decoration: none;\n        }\n\n        article {\n          margin-bottom: 2em;\n        }\n\n        .thumbnail-container {\n          display: block;\n          overflow: hidden;\n          width: 100%;\n          height: 180px;\n        }\n\n        .thumbnail {\n          width: 100%;\n          height: 100%;\n          transition: transform 0.5s ease-out;\n        }\n\n        .thumbnail-container:hover .thumbnail,\n        .thumbnail-container:focus .thumbnail {\n          transform: scale3d(1.3, 1.3, 1);\n        }\n\n        .title {\n          min-height: 3em;\n          margin: 1em 0 0.5em;\n        }\n\n        .excerpt {\n          min-height: 6em;\n          margin: 0.5em 0 2em;\n        }\n\n        @media (max-width: 599px) {\n          .title,\n          .excerpt {\n            min-height: 0;\n          }\n        }\n\n        @media (min-width: 600px) {\n          article {\n            flex: 1 1 40%;\n            margin-right: 2em;\n          }\n\n          article:nth-of-type(2n),\n          article:last-of-type {\n            margin-right: 0;\n          }\n        }\n\n        @media (min-width: 900px) {\n          article {\n            flex: 1 1 30%;\n          }\n\n          article:nth-of-type(2n) {\n            margin-right: 2em;\n          }\n\n          article:nth-of-type(3n) {\n            margin-right: 0;\n          }\n        }\n      "])))];
      }
    }, {
      key: "haxProperties",
      get: function get() {
