define(["exports","../../../@polymer/polymer/polymer-element.js","../../../@polymer/iron-a11y-keys/iron-a11y-keys.js","../../../@polymer/paper-icon-button/paper-icon-button.js","./mtz-marked-control-behavior.js"],function(_exports,_polymerElement,_ironA11yKeys,_paperIconButton,_mtzMarkedControlBehavior){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.MtzMarkedControlLink=void 0;function ownKeys(object,enumerableOnly){var keys=Object.keys(object);if(Object.getOwnPropertySymbols){var symbols=Object.getOwnPropertySymbols(object);if(enumerableOnly)symbols=symbols.filter(function(sym){return Object.getOwnPropertyDescriptor(object,sym).enumerable});keys.push.apply(keys,symbols)}return keys}function _objectSpread(target){for(var i=1,source;i<arguments.length;i++){source=null!=arguments[i]?arguments[i]:{};if(i%2){ownKeys(Object(source),!0).forEach(function(key){babelHelpers.defineProperty(target,key,source[key])})}else if(Object.getOwnPropertyDescriptors){Object.defineProperties(target,Object.getOwnPropertyDescriptors(source))}else{ownKeys(Object(source)).forEach(function(key){Object.defineProperty(target,key,Object.getOwnPropertyDescriptor(source,key))})}}return target}function _templateObject_1e7818f0703b11ea9571e3a900ccc2fd(){var data=babelHelpers.taggedTemplateLiteral(["\n      <style>\n        :host {\n          display: inline-block;\n        }\n      </style>\n\n      <paper-icon-button\n        icon=\"[[icon]]\"\n        noink=\"[[noink]]\"\n        on-click=\"_handleCommand\"\n        alt=\"[[title]]\"\n      ></paper-icon-button>\n\n      <iron-a11y-keys\n        keys=\"[[keys]]\"\n        on-keys-pressed=\"_handleCommand\"\n        target=\"[[__editor]]\"\n      ></iron-a11y-keys>\n    "]);_templateObject_1e7818f0703b11ea9571e3a900ccc2fd=function _templateObject_1e7818f0703b11ea9571e3a900ccc2fd(){return data};return data}var MtzMarkedControlLink=/*#__PURE__*/function(_mtzMarkedControlBeha){babelHelpers.inherits(MtzMarkedControlLink,_mtzMarkedControlBeha);function MtzMarkedControlLink(){babelHelpers.classCallCheck(this,MtzMarkedControlLink);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(MtzMarkedControlLink).apply(this,arguments))}babelHelpers.createClass(MtzMarkedControlLink,[{key:"_handleCommand",/**
   ...
   * @return {Boolean}
   * @protected
   */},{key:"_isLink",value:function _isLink(selection){return selection.text.startsWith("https://")}}],[{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_1e7818f0703b11ea9571e3a900ccc2fd())}},{key:"tag",get:function get(){return"mtz-marked-control-link"}},{key:"properties",get:function get(){return _objectSpread({},babelHelpers.get(babelHelpers.getPrototypeOf(MtzMarkedControlLink),"properties",this),{title:String,icon:String,keys:String,noink:Boolean// Pass-through
