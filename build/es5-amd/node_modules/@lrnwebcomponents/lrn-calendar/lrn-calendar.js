define(["exports", "meta", "require", "../../@polymer/polymer/polymer-element.js", "../../@polymer/polymer/lib/utils/render-status.js", "../../@polymer/polymer/lib/legacy/polymer.dom.js", "../../@polymer/polymer/lib/utils/resolve-url.js", "../hax-body-behaviors/lib/HAXWiring.js", "../es-global-bridge/es-global-bridge.js", "../../@polymer/iron-ajax/iron-ajax.js"], function (_exports, meta, _require, _polymerElement, _renderStatus, _polymerDom, _resolveUrl, _HAXWiring, _esGlobalBridge, _ironAjax) {
  ...
  function _templateObject_1413a010b53711e9aa40b7626f5cd426() {
    ...
    _templateObject_1413a010b53711e9aa40b7626f5cd426 = function _templateObject_1413a010b53711e9aa40b7626f5cd426() {
      return data;
    };
  ...
  function (_PolymerElement) {
    ...
    babelHelpers.createClass(LrnCalendar, [{
      ...
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_1413a010b53711e9aa40b7626f5cd426());
      }
    }, {
      key: "tag",
      get: function get() {
    ...
    function LrnCalendar() {
      ...
      new Promise(function (res, rej) {
        return _require.default(["@lrnwebcomponents/lrnsys-layout/lrnsys-layout.js"], res, rej);
      });
      new Promise(function (res, rej) {
        return _require.default(["@lrnwebcomponents/lrnsys-layout/lib/lrnsys-drawer.js"], res, rej);
      });
      new Promise(function (res, rej) {
        return _require.default(["@lrnwebcomponents/lrnsys-layout/lib/lrnsys-dialog.js"], res, rej);
      });
      new Promise(function (res, rej) {
        return _require.default(["@lrnwebcomponents/lrnsys-layout/lib/lrnsys-collapselist.js"], res, rej);
      });
      new Promise(function (res, rej) {
        return _require.default(["@lrnwebcomponents/lrnsys-layout/lib/lrnsys-collapselist-item.js"], res, rej);
      });
      new Promise(function (res, rej) {
        return _require.default(["@lrnwebcomponents/lrn-calendar/lib/lrn-calendar-date.js"], res, rej);
      });
