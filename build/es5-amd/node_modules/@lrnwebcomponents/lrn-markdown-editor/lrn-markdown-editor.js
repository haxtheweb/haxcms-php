define(["exports", "../../lit/index.js", "../a11y-tabs/a11y-tabs.js", "../a11y-tabs/lib/a11y-tab.js", "../../@polymer/marked-element/marked-element.js", "./lib/lrn-markdown-editor-editor.js"], function (_exports, _index, _a11yTabs, _a11yTab, _markedElement, _lrnMarkdownEditorEditor) {
  ...
  var _templateObject_eb8618709e8b11ed8df835f388f76963, _templateObject2_eb8618709e8b11ed8df835f388f76963;
  ...
  var LrnMarkdownEditor = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(LrnMarkdownEditor, [{
       ...
       */
      function get() {
        return [(0, _index.css)(_templateObject2_eb8618709e8b11ed8df835f388f76963 || (_templateObject2_eb8618709e8b11ed8df835f388f76963 = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n\n        #split-pane {\n          display: flex;\n          width: 100%;\n        }\n\n        .split-pane > * {\n          flex: 1 1 auto;\n          min-height: 160px;\n          width: calc(50% - 16px);\n        }\n\n        .preview-pane {\n          background: lightblue;\n        }\n\n        div.pane {\n          padding: 16px;\n          width: calc(100% - 32px);\n        }\n\n        a11y-tabs {\n          background: #f5f5f5;\n          border-style: solid;\n          border-color: #dcdcdc;\n          border-width: 1px;\n          min-width: 500px;\n        }\n\n        marked-element.lrn-markdown-editor {\n          width: 100%;\n          word-wrap: break-word;\n        }\n\n        .container-flex {\n          display: flex;\n          flex-wrap: nowrap;\n        }\n\n        .split-pane .container-flex > * {\n          width: 50%;\n        }\n\n        .split-pane marked-element {\n          width: calc(100% - 32px);\n          min-width: 150px;\n          margin: 0 16px;\n          padding: 0 16px;\n          background: #fff;\n          border-left: solid #dcdcdc 1px;\n        }\n      "])))];
      }
    }, {
      key: "tag",
      get: function get() {
