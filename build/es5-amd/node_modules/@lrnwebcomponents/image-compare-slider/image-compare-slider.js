define(["exports", "require", "../../lit-element/lit-element.js", "../schema-behaviors/schema-behaviors.js"], function (_exports, _require, _litElement, _schemaBehaviors) {
  ...
  function _templateObject2_2e5b1150332811ea9673c9ed9148a8db() {
    ...
    _templateObject2_2e5b1150332811ea9673c9ed9148a8db = function _templateObject2_2e5b1150332811ea9673c9ed9148a8db() {
      return data;
    };
  ...
  function _templateObject_2e5b1150332811ea9673c9ed9148a8db() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: inline-flex;\n          width: 100%;\n        }\n        :host > div,\n        :host #container,\n        :host #top {\n          width: 100%;\n        }\n        :host #container {\n          background-size: cover;\n          overflow: visible;\n        }\n        :host #top {\n          background-size: auto 100%;\n          overflow: hidden;\n        }\n        :host #slider {\n          width: calc(100% + 30px);\n          margin-left: -15px;\n        }\n      "]);

    _templateObject_2e5b1150332811ea9673c9ed9148a8db = function _templateObject_2e5b1150332811ea9673c9ed9148a8db() {
      return data;
    };
  ...
  function (_SchemaBehaviors) {
    ...
    babelHelpers.createClass(ImageCompareSlider, null, [{
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject_2e5b1150332811ea9673c9ed9148a8db())];
      }
    }]);
    ...
    babelHelpers.createClass(ImageCompareSlider, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_2e5b1150332811ea9673c9ed9148a8db(), this.title, this.bottomSrc, this.topSrc);
      }
    }, {
      key: "updated",
