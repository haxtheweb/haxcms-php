define(["exports", "meta", "require", "../../lit/index.js", "../schema-behaviors/schema-behaviors.js", "../intersection-element/lib/IntersectionObserverMixin.js", "../i18n-manager/lib/I18NMixin.js", "../simple-colors/simple-colors.js"], function (_exports, meta, _require, _index, _schemaBehaviors, _IntersectionObserverMixin, _I18NMixin2, _simpleColors) {
  ...
  var _templateObject_e46f85309e8b11ed8df835f388f76963, _templateObject2_e46f85309e8b11ed8df835f388f76963, _templateObject3_e46f85309e8b11ed8df835f388f76963, _templateObject4_e46f85309e8b11ed8df835f388f76963;
  ...
  var ImageCompareSlider = /*#__PURE__*/function (_I18NMixin) {
    ...
    babelHelpers.createClass(ImageCompareSlider, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_e46f85309e8b11ed8df835f388f76963 || (_templateObject_e46f85309e8b11ed8df835f388f76963 = babelHelpers.taggedTemplateLiteral(["", ""])), this.elementVisible ? (0, _index.html)(_templateObject2_e46f85309e8b11ed8df835f388f76963 || (_templateObject2_e46f85309e8b11ed8df835f388f76963 = babelHelpers.taggedTemplateLiteral(["\n          <a11y-compare-image\n            label=\"", "\"\n            accent-color=\"", "\"\n            ?dark=\"", "\"\n            ?opacity=\"", "\"\n            position=\"", "\"\n          >\n            <div slot=\"heading\">\n              ", "\n              <slot name=\"heading\"></slot>\n            </div>\n            <div slot=\"description\"><slot name=\"description\"></slot></div>\n            <img\n              slot=\"bottom\"\n              src=\"", "\"\n              alt=\"", "\"\n              aria-describedby=\"", "\"\n            />\n            <img\n              slot=\"top\"\n              src=\"", "\"\n              alt=\"", "\"\n              aria-describedby=\"", "\"\n            />\n          </a11y-compare-image>\n        "])), this.t.slideToCompareImages, this.accentColor, this.dark, this.opacity, this.position, this.title ? (0, _index.html)(_templateObject3_e46f85309e8b11ed8df835f388f76963 || (_templateObject3_e46f85309e8b11ed8df835f388f76963 = babelHelpers.taggedTemplateLiteral([" <h2>", "</h2> "])), this.title) : "", this.bottomSrc, this.bottomAlt, this.bottomDescriptionId || "description", this.topSrc, this.topAlt, this.topDescriptionId || "description") : "");
      }
    }, {
      key: "updated",
       ...
       */
      function get() {
        return [(0, _index.css)(_templateObject4_e46f85309e8b11ed8df835f388f76963 || (_templateObject4_e46f85309e8b11ed8df835f388f76963 = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: inline-flex;\n        }\n        :host([hidden]) {\n          display: none !important;\n        }\n      "])))];
      }
    }, {
      key: "tag",
      get: function get() {
