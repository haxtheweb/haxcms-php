define(["exports", "../../lit-element/lit-element.js", "../schema-behaviors/schema-behaviors.js", "../a11y-compare-image/a11y-compare-image.js", "../simple-colors/simple-colors.js"], function (_exports, _litElement, _schemaBehaviors, _a11yCompareImage, _simpleColors) {
  ...
  function _templateObject3_5d024fe03efe11eb800233a440abe59f() {
    var data = babelHelpers.taggedTemplateLiteral([" <h2>", "</h2> "]);

    _templateObject3_5d024fe03efe11eb800233a440abe59f = function _templateObject3_5d024fe03efe11eb800233a440abe59f() {
      return data;
    };
  ...
  function _templateObject2_5d024fe03efe11eb800233a440abe59f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <a11y-compare-image\n        accent-color=\"", "\"\n        ?dark=\"", "\"\n        ?opacity=\"", "\"\n        position=\"", "\"\n      >\n        <div slot=\"heading\">\n          ", "\n          <slot name=\"heading\"></slot>\n        </div>\n        <div slot=\"description\"><slot name=\"description\"></slot></div>\n        <img\n          slot=\"bottom\"\n          src=\"", "\"\n          alt=\"", "\"\n          aria-describedby=\"", "\"\n        />\n        <img\n          slot=\"top\"\n          src=\"", "\"\n          alt=\"", "\"\n          aria-describedby=\"", "\"\n        />\n      </a11y-compare-image>\n    "]);

    _templateObject2_5d024fe03efe11eb800233a440abe59f = function _templateObject2_5d024fe03efe11eb800233a440abe59f() {
      return data;
    };
  ...
  function _templateObject_5d024fe03efe11eb800233a440abe59f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: inline-flex;\n        }\n        :host([hidden]) {\n          display: none !important;\n        }\n      "]);

    _templateObject_5d024fe03efe11eb800233a440abe59f = function _templateObject_5d024fe03efe11eb800233a440abe59f() {
      return data;
    };
  ...
  var ImageCompareSlider = /*#__PURE__*/function (_SchemaBehaviors) {
    ...
    babelHelpers.createClass(ImageCompareSlider, null, [{
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject_5d024fe03efe11eb800233a440abe59f())];
      }
    }]);
    ...
    babelHelpers.createClass(ImageCompareSlider, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_5d024fe03efe11eb800233a440abe59f(), this.accentColor, this.dark, this.opacity, this.position, this.title ? (0, _litElement.html)(_templateObject3_5d024fe03efe11eb800233a440abe59f(), this.title) : "", this.bottomSrc, this.bottomAlt, this.bottomDescriptionId || "description", this.topSrc, this.topAlt, this.topDescriptionId || "description");
      }
    }], [{
      key: "tag",
      get: function get() {
