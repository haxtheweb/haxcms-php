...
(function () {
  ...
  function S(e, t, n) {
    for (var r, i, o, a, s = new DataView(e), l = {}, u = t; u < t + n;) 28 === s.getUint8(u) && 2 === s.getUint8(u + 1) && (a = s.getUint8(u + 2)) in h && ((o = s.getInt16(u + 3)) + 5, i = h[a], r = y(s, u + 5, o), l.hasOwnProperty(i) ? babelHelpers.instanceof(l[i], Array) ? l[i].push(r) : l[i] = [l[i], r] : l[i] = r), u++;
    return l;
  }
  ...
  l.enableXmp = function () {
    ...
    var t,
      n = e.exifdata,
      r = "";
    for (t in n) n.hasOwnProperty(t) && ("object" == babelHelpers.typeof(n[t]) ? babelHelpers.instanceof(n[t], Number) ? r += t + " : " + n[t] + " [" + n[t].numerator + "/" + n[t].denominator + "]\r\n" : r += t + " : [" + n[t].length + " values]\r\n" : r += t + " : " + n[t] + "\r\n");
    return r;
