define(["exports", "require", "../../lit/index.js", "../../lit/directives/cache.js", "../simple-icon/lib/simple-icon-lite.js", "../simple-icon/lib/simple-icons.js"], function (_exports, _require, _index, _cache, _simpleIconLite, _simpleIcons) {
  ...
  var _templateObject_350568b0e8f211edb01b473406559cea, _templateObject2_350568b0e8f211edb01b473406559cea, _templateObject3_350568b0e8f211edb01b473406559cea, _templateObject4_350568b0e8f211edb01b473406559cea, _templateObject5_350568b0e8f211edb01b473406559cea, _templateObject6_350568b0e8f211edb01b473406559cea, _templateObject7_350568b0e8f211edb01b473406559cea;
    ...
    return /*#__PURE__*/function (_SuperClass) {
      ...
      babelHelpers.createClass(_class, [{
        ...
        value: function _renderOptions(options) {
          var _this2 = this;
          return (0, _index.html)(_templateObject2_350568b0e8f211edb01b473406559cea || (_templateObject2_350568b0e8f211edb01b473406559cea = babelHelpers.taggedTemplateLiteral(["", ""])), (options || []).map(function (row, rownum) {
            return (0, _index.html)(_templateObject3_350568b0e8f211edb01b473406559cea || (_templateObject3_350568b0e8f211edb01b473406559cea = babelHelpers.taggedTemplateLiteral(["\n          <div class=\"row\" ?hidden=\"", "\">\n            ", "\n          </div>\n        "])), !_this2._isRowHidden(row), Array.isArray(row) ? _this2._renderRow(row, rownum) : _index.nothing);
          }));
        }
      }, {
        key: "_isRowHidden",
        ...
        value: function _renderRow(row, rownum) {
          var _this4 = this;
          return (0, _index.html)(_templateObject4_350568b0e8f211edb01b473406559cea || (_templateObject4_350568b0e8f211edb01b473406559cea = babelHelpers.taggedTemplateLiteral(["", ""])), (row || []).map(function (option, colnum) {
            return (0, _index.html)(_templateObject5_350568b0e8f211edb01b473406559cea || (_templateObject5_350568b0e8f211edb01b473406559cea = babelHelpers.taggedTemplateLiteral(["\n          <simple-picker-option\n            @option-focus=\"", "\"\n            @set-selected-option=\"", "\"\n            ?active=\"", "\"\n            ?hide-option-labels=\"", "\"\n            ?hidden=\"", "\"\n            ?selected=\"", "\"\n            ?title-as-html=\"", "\"\n            .data=\"", "\"\n            .icon=\"", "\"\n            .id=\"option-", "-", "\"\n            .label=\"", "\"\n            .style=", "\n            aria-selected=\"", "\"\n            role=\"option\"\n            tabindex=\"-1\"\n            value=\"", "\"\n          >\n          </simple-picker-option>\n        "])), _this4._handleOptionFocus, _this4._handleSetSelectedOption, "".concat(_this4.__activeDesc) === "option-".concat(rownum, "-").concat(colnum), _this4.hideOptionLabels, _this4.hideNull && !option.value, _this4.value === option.value, _this4.titleAsHtml, _this4.data, option.icon, rownum, colnum, option.alt, option.style, _this4.value === option.value ? "true" : "false", option.value);
          }));
        }
      }, {
        key: "updated",
        ...
        value: function _goToOption(rownum, colnum) {
          var targetId = (0, _index.html)(_templateObject6_350568b0e8f211edb01b473406559cea || (_templateObject6_350568b0e8f211edb01b473406559cea = babelHelpers.taggedTemplateLiteral([" option-", "-", " "])), rownum, colnum),
