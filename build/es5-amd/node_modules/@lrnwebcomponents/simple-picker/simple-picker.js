...
target.focus();active.tabindex=-1;//prevent tabbing between options.
   ...
   */},{key:"_handleListboxEvent",value:function _handleListboxEvent(e,type){console.log("_handleListboxEvent",type);this.dispatchEvent(new CustomEvent(type,{detail:this}));if("click"===type)this._toggleListbox(!this.expanded)}/**
...
get:function get(){return(0,_polymerElement.html)(_templateObject_9daac510773411e985b279adc908722c())}// properties available to the custom element for data binding
