define(["exports", "../../../lit/index.js", "../simple-picker.js"], function (_exports, _index, _simplePicker) {
  ...
  var _templateObject_f49c0650a0c911eda392efd0bad1b4bf;
  ...
  var SimpleSymbolPicker = /*#__PURE__*/function (_SimplePickerBehavior) {
    ...
    babelHelpers.createClass(SimpleSymbolPicker, [{
      ...
      //styles function
      function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(SimpleSymbolPicker), "styles", this)), [(0, _index.css)(_templateObject_f49c0650a0c911eda392efd0bad1b4bf || (_templateObject_f49c0650a0c911eda392efd0bad1b4bf = babelHelpers.taggedTemplateLiteral(["\n        simple-picker-option {\n          justify-content: space-around;\n        }\n        #icon {\n          margin-left: calc(-0.125 * var(--simple-picker-icon-size, 16px));\n        }\n      "])))]);
      }
