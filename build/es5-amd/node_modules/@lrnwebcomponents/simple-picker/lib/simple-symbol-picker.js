define(["exports", "../../../lit/index.js", "../simple-picker.js"], function (_exports, _index, _simplePicker) {
  ...
  var _templateObject_2fa1a4a0edcb11edb3e3ed4f0d506a4b;
  ...
  var SimpleSymbolPicker = /*#__PURE__*/function (_SimplePickerBehavior) {
    ...
    babelHelpers.createClass(SimpleSymbolPicker, [{
      ...
      //styles function
      function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(SimpleSymbolPicker), "styles", this)), [(0, _index.css)(_templateObject_2fa1a4a0edcb11edb3e3ed4f0d506a4b || (_templateObject_2fa1a4a0edcb11edb3e3ed4f0d506a4b = babelHelpers.taggedTemplateLiteral(["\n        simple-picker-option {\n          justify-content: space-around;\n          --simple-picker-option-size: 24px;\n          font-size: 24px;\n        }\n        #icon {\n          margin-left: calc(-0.125 * var(--simple-picker-icon-size, 16px));\n        }\n      "])))]);
      }
