define(["exports", "../../../lit/index.js", "../simple-picker.js"], function (_exports, _index, _simplePicker) {
  ...
  var _templateObject_c5b66c50403311edb9fff3e6b08a0a9a;
  ...
  var SimpleSymbolPicker = /*#__PURE__*/function (_SimplePickerBehavior) {
    ...
    babelHelpers.createClass(SimpleSymbolPicker, [{
      ...
      get: //styles function
      function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(SimpleSymbolPicker), "styles", this)), [(0, _index.css)(_templateObject_c5b66c50403311edb9fff3e6b08a0a9a || (_templateObject_c5b66c50403311edb9fff3e6b08a0a9a = babelHelpers.taggedTemplateLiteral(["\n        simple-picker-option {\n          justify-content: space-around;\n        }\n        #icon {\n          margin-left: calc(-0.125 * var(--simple-picker-icon-size, 16px));\n        }\n      "])))]);
