define(["exports", "../../../lit/index.js", "../simple-picker.js"], function (_exports, _index, _simplePicker) {
  ...
  var _templateObject_aeccf3e0b48911edaa972d5aad30d551;
  ...
  var SimpleSymbolPicker = /*#__PURE__*/function (_SimplePickerBehavior) {
    ...
    babelHelpers.createClass(SimpleSymbolPicker, [{
      ...
      //styles function
      function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(SimpleSymbolPicker), "styles", this)), [(0, _index.css)(_templateObject_aeccf3e0b48911edaa972d5aad30d551 || (_templateObject_aeccf3e0b48911edaa972d5aad30d551 = babelHelpers.taggedTemplateLiteral(["\n        simple-picker-option {\n          justify-content: space-around;\n          --simple-picker-option-size: 24px;\n          font-size: 24px;\n        }\n        #icon {\n          margin-left: calc(-0.125 * var(--simple-picker-icon-size, 16px));\n        }\n      "])))]);
      }
