define(["exports", "../../../lit/index.js", "../../simple-icon/lib/simple-icon-lite.js", "../../simple-icon/lib/simple-icons.js"], function (_exports, _index, _simpleIconLite, _simpleIcons) {
  ...
  var _templateObject_ffaaf320e4f411ed85766367b4d3e9fc, _templateObject2_ffaaf320e4f411ed85766367b4d3e9fc;
  ...
  var SimplePickerOption = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(SimplePickerOption, [{
      ...
      // render function
      function render() {
        return (0, _index.html)(_templateObject_ffaaf320e4f411ed85766367b4d3e9fc || (_templateObject_ffaaf320e4f411ed85766367b4d3e9fc = babelHelpers.taggedTemplateLiteral(["\n      <simple-icon-lite\n        ?hidden=\"", "\"\n        .icon=\"", "\"\n        aria-hidden=\"true\"\n      ></simple-icon-lite>\n      <div id=\"label\">\n        <slot ?hidden=\"", "\"></slot>\n        ", "\n      </div>\n    "])), !this.icon, this.icon, !this.titleAsHtml, this.titleAsHtml ? "" : this.label);
      }
    }, {
      key: "updated",
