define(["exports", "../../../lit-element/lit-element.js", "../../../@polymer/iron-icon/iron-icon.js", "../../../@polymer/iron-icons/iron-icons.js"], function (_exports, _litElement, _ironIcon, _ironIcons) {
  ...
  function _templateObject4_46198f10332811ea9673c9ed9148a8db() {
    var data = babelHelpers.taggedTemplateLiteral(["red"]);

    _templateObject4_46198f10332811ea9673c9ed9148a8db = function _templateObject4_46198f10332811ea9673c9ed9148a8db() {
      return data;
    };
  ...
  function _templateObject3_46198f10332811ea9673c9ed9148a8db() {
    ...
    _templateObject3_46198f10332811ea9673c9ed9148a8db = function _templateObject3_46198f10332811ea9673c9ed9148a8db() {
      return data;
    };
  ...
  function _templateObject2_46198f10332811ea9673c9ed9148a8db() {
    var data = babelHelpers.taggedTemplateLiteral(["\n              ", "\n            "]);

    _templateObject2_46198f10332811ea9673c9ed9148a8db = function _templateObject2_46198f10332811ea9673c9ed9148a8db() {
      return data;
    };
  ...
  function _templateObject_46198f10332811ea9673c9ed9148a8db() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <iron-icon\n        ?hidden=\"", "\"\n        .icon=\"", "\"\n        aria-hidden=\"true\"\n      ></iron-icon>\n      <div id=\"label\">\n        ", "\n      </div>\n    "]);

    _templateObject_46198f10332811ea9673c9ed9148a8db = function _templateObject_46198f10332811ea9673c9ed9148a8db() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(SimplePickerOption, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_46198f10332811ea9673c9ed9148a8db(), !this.icon, this.icon, this.titleAsHtml ? (0, _litElement.html)(_templateObject2_46198f10332811ea9673c9ed9148a8db(), this.label) : this.label);
      }
    }], [{
      key: "styles",
      //styles
      get: function get() {
        return (0, _litElement.css)(_templateObject3_46198f10332811ea9673c9ed9148a8db());
      }
    }]);
    ...
    babelHelpers.createClass(SimplePickerOption, [{
      ...
      value: function _getColor() {
        return (0, _litElement.css)(_templateObject4_46198f10332811ea9673c9ed9148a8db());
      }
    }], [{
      key: "properties",
      get: function get() {
