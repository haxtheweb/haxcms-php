define(["exports", "meta", "../../lit/index.js", "../simple-icon/simple-icon.js", "../simple-icon/lib/simple-icons.js", "../simple-icon/lib/simple-icon-button.js", "../hax-iconset/lib/simple-hax-iconset.js"], function (_exports, meta, _index, _simpleIcon, _simpleIcons, _simpleIconButton, _simpleHaxIconset) {
  ...
  var _templateObject_f8b4da00e51111edbf9f41986c80248c, _templateObject2_f8b4da00e51111edbf9f41986c80248c;
  ...
  var InlineAudio = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(InlineAudio, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_f8b4da00e51111edbf9f41986c80248c || (_templateObject_f8b4da00e51111edbf9f41986c80248c = babelHelpers.taggedTemplateLiteral(["\n      <div class=\"container\">\n        <simple-icon-button\n          class=\"icon-spacing\"\n          icon=\"", "\"\n          @click=\"", "\"\n        ></simple-icon-button>\n        <slot></slot>\n        <audio\n          class=\"player\"\n          type=\"audio/mpeg\"\n          @canplaythrough=\"", "\"\n          @timeupdate=\"", "\"\n        ></audio>\n        <div></div>\n      </div>\n    "])), this.icon, this.handleClickEvent, this.handlePlaythrough, this.handleProgress);
      }
      ...
      key: "styles",
      get: function get() {
        return [(0, _index.css)(_templateObject2_f8b4da00e51111edbf9f41986c80248c || (_templateObject2_f8b4da00e51111edbf9f41986c80248c = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: inline;\n          vertical-align: middle;\n          color: #1a2b42;\n          max-width: 960px;\n          margin: 0 auto;\n          background-color: var(--inline-audio-background-color);\n        }\n        .container {\n          display: inline-flex;\n          align-items: center;\n          padding: 4px 4px 4px 0px;\n          background: grey;\n          border-radius: 4px;\n          min-width: 64px;\n          font-size: 18px;\n          /* cursor: pointer; */\n        }\n        .icon-spacing {\n          padding-right: 8px;\n        }\n      "])))];
      }
    }, {
      key: "haxProperties",
      get: function get() {
