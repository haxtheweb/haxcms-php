...
function _templateObject3_00414970a0ca11eda392efd0bad1b4bf() {
  ...
  _templateObject3_00414970a0ca11eda392efd0bad1b4bf = function _templateObject3_00414970a0ca11eda392efd0bad1b4bf() {
    return data;
  };
  return data;
}
function _templateObject2_00414970a0ca11eda392efd0bad1b4bf() {
  var data = _taggedTemplateLiteral(['<feFlood result="COLOR" />']);
  _templateObject2_00414970a0ca11eda392efd0bad1b4bf = function _templateObject2_00414970a0ca11eda392efd0bad1b4bf() {
    return data;
  };
  return data;
}
function _templateObject_00414970a0ca11eda392efd0bad1b4bf() {
  var data = _taggedTemplateLiteral(['\n        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet">\n          <filter\n            color-interpolation-filters="sRGB"\n            x="0"\n            y="0"\n            height="24px"\n            width="24px"\n          >\n            ', '\n            <feComposite operator="in" in="COLOR" in2="SourceAlpha" />\n          </filter>\n          <image\n            xlink:href=""\n            width="24px"\n            height="24px"\n            focusable="false"\n            preserveAspectRatio="xMidYMid meet"\n          ></image>\n        </svg>\n      ']);
  _templateObject_00414970a0ca11eda392efd0bad1b4bf = function _templateObject_00414970a0ca11eda392efd0bad1b4bf() {
    return data;
  };
  return data;
}
    ...
    function (_SuperClass) {
      ...
      _createClass(_class, [{
        ...
        value: function render() {
          return (0, _litElement.svg)(_templateObject_00414970a0ca11eda392efd0bad1b4bf(), this.feFlood);
        }
      }, {
        key: "feFlood",
        get: function get() {
          return !this.noColorize ? (0, _litElement.svg)(_templateObject2_00414970a0ca11eda392efd0bad1b4bf()) : "";
        } // properties available to the custom element for data binding
      }], [{
        key: "styles",
        get: function get() {
          return [_get(_getPrototypeOf(_class), "styles", this) || []].concat([(0, _litElement.css)(_templateObject3_00414970a0ca11eda392efd0bad1b4bf())]);
        }
      }, {
        key: "properties",
        get: function get() {
