...
function _templateObject2_9b9fac50509711edb124eb517be36dbf() {
  ...
  _templateObject2_9b9fac50509711edb124eb517be36dbf = function _templateObject2_9b9fac50509711edb124eb517be36dbf() {
    return data;
  };
...
function _templateObject_9b9fac50509711edb124eb517be36dbf() {
  var data = _taggedTemplateLiteral(['\n        <button\n          ?autofocus="', '"\n          aria-labelledby="', '"\n          .aria-pressed="', '"\n          controls="', '"\n          part="button"\n          ?disabled="', '"\n          form="', '"\n          label="', '"\n          aria-label="', '"\n          name="', '"\n          .type="', '"\n          value="', '"\n        >\n          <simple-icon-lite icon=', ' part="icon"> </simple-icon-lite>\n        </button>\n      ']);

  _templateObject_9b9fac50509711edb124eb517be36dbf = function _templateObject_9b9fac50509711edb124eb517be36dbf() {
    return data;
  };
  ...
  return /*#__PURE__*/function (_SuperClass) {
    ...
    _createClass(_class, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_9b9fac50509711edb124eb517be36dbf(), this.autofocus, this.ariaLabelledby, this.toggles || this.toggled ? "true" : this.toggles ? "false" : undefined, this.controls, this.disabled, this.form, this.label, this.label, this.fieldName, this.type, this.value, this.icon);
      } // properties available to the custom element for data binding

    }], [{
      key: "styles",
      get: function get() {
        return [_get(_getPrototypeOf(_class), "styles", this) || []].concat([(0, _litElement.css)(_templateObject2_9b9fac50509711edb124eb517be36dbf())]);
      }
    }, {
      key: "properties",
      get: function get() {
