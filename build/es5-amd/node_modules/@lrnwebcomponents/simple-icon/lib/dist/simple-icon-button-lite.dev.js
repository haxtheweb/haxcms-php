...
function _templateObject2_59e6c8e0e8f211edb01b473406559cea() {
  ...
  _templateObject2_59e6c8e0e8f211edb01b473406559cea = function _templateObject2_59e6c8e0e8f211edb01b473406559cea() {
    return data;
  };
  return data;
}
function _templateObject_59e6c8e0e8f211edb01b473406559cea() {
  var data = _taggedTemplateLiteral(['\n        <button\n          ?autofocus="', '"\n          aria-labelledby="', '"\n          .aria-pressed="', '"\n          controls="', '"\n          part="button"\n          ?disabled="', '"\n          form="', '"\n          label="', '"\n          aria-label="', '"\n          name="', '"\n          .type="', '"\n          value="', '"\n        >\n          <simple-icon-lite icon=', ' part="icon"> </simple-icon-lite>\n        </button>\n      ']);
  _templateObject_59e6c8e0e8f211edb01b473406559cea = function _templateObject_59e6c8e0e8f211edb01b473406559cea() {
    return data;
  };
  return data;
}
    ...
    function (_SuperClass) {
      ...
      _createClass(_class, [{
        ...
        value: function render() {
          return (0, _litElement.html)(_templateObject_59e6c8e0e8f211edb01b473406559cea(), this.autofocus, this.ariaLabelledby, this.toggles || this.toggled ? "true" : this.toggles ? "false" : undefined, this.controls, this.disabled, this.form, this.label, this.label, this.fieldName, this.type, this.value, this.icon);
        } // properties available to the custom element for data binding
      }], [{
        key: "styles",
        get: function get() {
          return [_get(_getPrototypeOf(_class), "styles", this) || []].concat([(0, _litElement.css)(_templateObject2_59e6c8e0e8f211edb01b473406559cea())]);
        }
      }, {
        key: "properties",
        get: function get() {
...
var SimpleIconButtonLite = /*#__PURE__*/
