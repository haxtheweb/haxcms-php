define(["exports", "../../../lit-element/lit-element.js", "./simple-icon-lite.js", "./simple-icons.js", "./simple-iconset.js", "./simple-iconset-manifest.js"], function (_exports, _litElement, _simpleIconLite, _simpleIcons, _simpleIconset, _simpleIconsetManifest) {
  ...
  function _templateObject3_d0e646708b3211ebb67059cf696085af() {
    ...
    _templateObject3_d0e646708b3211ebb67059cf696085af = function _templateObject3_d0e646708b3211ebb67059cf696085af() {
      return data;
    };
  ...
  function _templateObject2_d0e646708b3211ebb67059cf696085af() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                  <li>\n                    <div id=\"icon\">\n                      <simple-icon-lite\n                        icon=\"", ":", "\"\n                      ></simple-icon-lite>\n                      <div id=\"icon-text\">\n                        ", "", "\n                      </div>\n                    </div>\n                  </li>\n                "]);

    _templateObject2_d0e646708b3211ebb67059cf696085af = function _templateObject2_d0e646708b3211ebb67059cf696085af() {
      return data;
    };
  ...
  function _templateObject_d0e646708b3211ebb67059cf696085af() {
    var data = babelHelpers.taggedTemplateLiteral(["<div class=\"iconset\">\n            <p><strong>", "</strong></p>\n            <ul>\n              ", "\n            </ul>\n          </div> "]);

    _templateObject_d0e646708b3211ebb67059cf696085af = function _templateObject_d0e646708b3211ebb67059cf696085af() {
      return data;
    };
    ...
    babelHelpers.createClass(SimpleIconsetDemo, [{
      ...
      value: function render() {
        return this.iconsets.length < 1 ? "Looking for iconsets..." : this.iconsets.map(function (iconset) {
          return (0, _litElement.html)(_templateObject_d0e646708b3211ebb67059cf696085af(), iconset.name, iconset.icons.map(function (icon) {
            return (0, _litElement.html)(_templateObject2_d0e646708b3211ebb67059cf696085af(), iconset.name, icon, iconset.name === "icons" ? "" : "".concat(iconset.name, ":"), icon);
          }));
        });
      ...
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject3_d0e646708b3211ebb67059cf696085af())];
      }
    }, {
      key: "properties",
      get: function get() {
