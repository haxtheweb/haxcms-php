define(["exports", "../../../lit/index.js", "./simple-icon-lite.js", "./simple-icons.js", "./simple-iconset.js", "./simple-iconset-manifest.js"], function (_exports, _index, _simpleIconLite, _simpleIcons, _simpleIconset, _simpleIconsetManifest) {
  ...
  var _templateObject_adfb7310b48911edaa972d5aad30d551, _templateObject2_adfb7310b48911edaa972d5aad30d551, _templateObject3_adfb7310b48911edaa972d5aad30d551;
    ...
    babelHelpers.createClass(SimpleIconsetDemo, [{
      ...
      function render() {
        return this.iconsets.length < 1 ? "Looking for iconsets..." : this.iconsets.map(function (iconset) {
          return (0, _index.html)(_templateObject_adfb7310b48911edaa972d5aad30d551 || (_templateObject_adfb7310b48911edaa972d5aad30d551 = babelHelpers.taggedTemplateLiteral(["<div class=\"iconset\">\n            <p><strong>", "</strong></p>\n            <ul>\n              ", "\n            </ul>\n          </div> "])), iconset.name, iconset.icons.map(function (icon) {
            return (0, _index.html)(_templateObject2_adfb7310b48911edaa972d5aad30d551 || (_templateObject2_adfb7310b48911edaa972d5aad30d551 = babelHelpers.taggedTemplateLiteral(["\n                  <li>\n                    <div id=\"icon\">\n                      <simple-icon-lite\n                        icon=\"", ":", "\"\n                      ></simple-icon-lite>\n                      <div id=\"icon-text\">\n                        ", "", "\n                      </div>\n                    </div>\n                  </li>\n                "])), iconset.name, icon, iconset.name === "icons" ? "" : "".concat(iconset.name, ":"), icon);
          }));
        });
      }
