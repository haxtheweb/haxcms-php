define(["exports", "../../../lit-element/lit-element.js", "../../simple-colors/simple-colors.js", "./simple-icons.js", "./simple-icon-lite.js"], function (_exports, _litElement, _simpleColors, _simpleIcons, _simpleIconLite) {
  ...
  function _templateObject2_d0d8b1e08b3211ebb67059cf696085af() {
    ...
    _templateObject2_d0d8b1e08b3211ebb67059cf696085af = function _templateObject2_d0d8b1e08b3211ebb67059cf696085af() {
      return data;
    };
  ...
  function _templateObject_d0d8b1e08b3211ebb67059cf696085af() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        <button\n          ?autofocus=\"", "\"\n          aria-labelledby=\"", "\"\n          .aria-pressed=\"", "\"\n          controls=\"", "\"\n          part=\"button\"\n          ?disabled=\"", "\"\n          form=\"", "\"\n          label=\"", "\"\n          aria-label=\"", "\"\n          name=\"", "\"\n          .type=\"", "\"\n          value=\"", "\"\n        >\n          <simple-icon-lite icon=", " part=\"icon\"> </simple-icon-lite>\n        </button>\n      "]);

    _templateObject_d0d8b1e08b3211ebb67059cf696085af = function _templateObject_d0d8b1e08b3211ebb67059cf696085af() {
      return data;
    };
    ...
    return /*#__PURE__*/function (_SuperClass) {
      ...
      babelHelpers.createClass(_class, [{
        ...
        value: function render() {
          return (0, _litElement.html)(_templateObject_d0d8b1e08b3211ebb67059cf696085af(), this.autofocus, this.ariaLabelledby, this.toggles || this.toggled ? "true" : this.toggles ? "false" : undefined, this.controls, this.disabled, this.form, this.label, this.label, this.fieldName, this.type, this.value, this.icon);
        } // properties available to the custom element for data binding

      }], [{
        key: "styles",
        get: function get() {
          return [babelHelpers.get(babelHelpers.getPrototypeOf(_class), "styles", this) || []].concat([(0, _litElement.css)(_templateObject2_d0d8b1e08b3211ebb67059cf696085af())]);
        }
      }, {
        key: "properties",
        get: function get() {
