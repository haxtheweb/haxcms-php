define(["exports", "../../../lit-element/lit-element.js", "../../simple-colors/simple-colors.js", "./simple-icon-button-lite.js", "./simple-icons.js", "../simple-icon.js"], function (_exports, _litElement, _simpleColors, _simpleIconButtonLite, _simpleIcons, _simpleIcon) {
  ...
  function _templateObject_cb7ad9202dd211eba8a9dbdc0fc9b6e0() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <button>\n        <simple-icon\n          icon=\"", "\"\n          accent-color=\"", "\"\n          contrast=\"", "\"\n          ?dark=\"", "\"\n        ></simple-icon>\n      </button>\n    "]);

    _templateObject_cb7ad9202dd211eba8a9dbdc0fc9b6e0 = function _templateObject_cb7ad9202dd211eba8a9dbdc0fc9b6e0() {
      return data;
    };
  ...
  var SimpleIconButton = /*#__PURE__*/function (_SimpleIconButtonBeha) {
    ...
    babelHelpers.createClass(SimpleIconButton, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_cb7ad9202dd211eba8a9dbdc0fc9b6e0(), this.icon, this.accentColor, this.contrast, this.dark);
