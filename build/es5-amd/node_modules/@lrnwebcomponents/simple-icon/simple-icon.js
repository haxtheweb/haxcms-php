define(["exports", "../../lit/index.js", "../simple-colors/simple-colors.js", "./lib/simple-icon-lite.js"], function (_exports, _index, _simpleColors, _simpleIconLite) {
  ...
  var _templateObject_dedb5460a0c911eda392efd0bad1b4bf, _templateObject2_dedb5460a0c911eda392efd0bad1b4bf;
  ...
  var SimpleIcon = /*#__PURE__*/function (_SimpleIconBehaviors) {
    ...
    babelHelpers.createClass(SimpleIcon, [{
      key: "feFlood",
      get: function get() {
        return !this.noColorize ? (0, _index.svg)(_templateObject_dedb5460a0c911eda392efd0bad1b4bf || (_templateObject_dedb5460a0c911eda392efd0bad1b4bf = babelHelpers.taggedTemplateLiteral(["<feFlood class=\"contrast-", "\" result=\"COLOR\" />"])), this.contrast) : "";
      }
    }, {
      ...
      key: "styles",
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(SimpleIcon), "styles", this)), [(0, _index.css)(_templateObject2_dedb5460a0c911eda392efd0bad1b4bf || (_templateObject2_dedb5460a0c911eda392efd0bad1b4bf = babelHelpers.taggedTemplateLiteral(["\n        feFlood {\n          flood-color: var(\n            --simple-icon-color,\n            var(--simple-colors-default-theme-accent-8, #000000)\n          );\n        }\n        feFlood.contrast-1 {\n          flood-color: var(\n            --simple-icon-color,\n            var(--simple-colors-default-theme-accent-9, #000000)\n          );\n        }\n        feFlood.contrast-2 {\n          flood-color: var(\n            --simple-icon-color,\n            var(--simple-colors-default-theme-accent-10, #000000)\n          );\n        }\n        feFlood.contrast-3 {\n          flood-color: var(\n            --simple-icon-color,\n            var(--simple-colors-default-theme-accent-11, #000000)\n          );\n        }\n        feFlood.contrast-4 {\n          flood-color: var(\n            --simple-icon-color,\n            var(--simple-colors-default-theme-accent-12, #000000)\n          );\n        }\n      "])))]);
      }
    }, {
      key: "properties",
      get: function get() {
