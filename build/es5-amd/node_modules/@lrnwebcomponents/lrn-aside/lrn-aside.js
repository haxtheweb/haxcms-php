define(["exports","require","../../@polymer/polymer/polymer-element.js","../../@polymer/polymer/lib/utils/render-status.js","../hax-body-behaviors/lib/HAXWiring.js"],function(_exports,_require,_polymerElement,_renderStatus,_HAXWiring){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.LrnAside=void 0;_require=babelHelpers.interopRequireWildcard(_require);function _templateObject_bea781d07b3611e9adc281d999a3f2aa(){var data=babelHelpers.taggedTemplateLiteral(["\n      <style>\n        :host {\n          display: flex;\n          padding: 8px;\n        }\n        :host([sticky]) {\n          top: 0;\n          position: sticky;\n        }\n        :host([direction=\"left\"]) {\n          float: left;\n          max-width: 480px;\n        }\n        :host([direction=\"right\"]) {\n          float: right;\n          max-width: 480px;\n        }\n      </style>\n      <aside>\n        <lrndesign-panelcard title=\"[[title]]\">\n          <slot></slot>\n        </lrndesign-panelcard>\n      </aside>\n    "]);_templateObject_bea781d07b3611e9adc281d999a3f2aa=function _templateObject_bea781d07b3611e9adc281d999a3f2aa(){return data};return data}/**
 * `lrn-aside`
 * A content aside as a panel
 *
 * @demo demo/index.html
 */var LrnAside=/*#__PURE__*/function(_PolymerElement){babelHelpers.inherits(LrnAside,_PolymerElement);function LrnAside(){var _this;babelHelpers.classCallCheck(this,LrnAside);_this=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(LrnAside).call(this));new Promise(function(res,rej){return _require.default(["../lrndesign-panelcard/lrndesign-panelcard.js"],res,rej)});(0,_renderStatus.afterNextRender)(babelHelpers.assertThisInitialized(babelHelpers.assertThisInitialized(_this)),function(){this.HAXWiring=new _HAXWiring.HAXWiring;this.HAXWiring.setup(LrnAside.haxProperties,LrnAside.tag,this)});return _this}babelHelpers.createClass(LrnAside,null,[{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_bea781d07b3611e9adc281d999a3f2aa())}},{key:"tag",get:function get(){return"lrn-aside"}},{key:"properties",get:function get(){return{/**
       * Title for the aside.
