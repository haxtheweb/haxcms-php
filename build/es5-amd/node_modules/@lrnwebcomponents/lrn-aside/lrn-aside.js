define(["exports","../../@polymer/polymer/polymer-legacy.js","../lrndesign-panelcard/lrndesign-panelcard.js","../hax-body-behaviors/lib/HAXWiring.js"],function(_exports,_polymerLegacy,_lrndesignPanelcard,_HAXWiring){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.LrnAside=void 0;function _templateObject_28a8b62062ec11e9ba56c1f762879bb4(){var data=babelHelpers.taggedTemplateLiteral(["\n    <style>\n      :host {\n        display: flex;\n        padding: 8px;\n      }\n      :host([sticky]) {\n        top: 0;\n        position: sticky;\n      }\n      :host([direction=\"left\"]) {\n        float: left;\n        max-width: 480px;\n      }\n      :host([direction=\"right\"]) {\n        float: right;\n        max-width: 480px;\n      }\n    </style>\n    <aside>\n      <lrndesign-panelcard title=\"[[title]]\">\n        <slot></slot>\n      </lrndesign-panelcard>\n    </aside>\n  "]);_templateObject_28a8b62062ec11e9ba56c1f762879bb4=function _templateObject_28a8b62062ec11e9ba56c1f762879bb4(){return data};return data}/**
 * `lrn-aside`
 * A content aside as a panel
 *
 * @demo demo/index.html
 */var LrnAside=(0,_polymerLegacy.Polymer)({_template:(0,_polymerLegacy.html)(_templateObject_28a8b62062ec11e9ba56c1f762879bb4()),is:"lrn-aside",behaviors:[HAXBehaviors.PropertiesBehaviors],properties:{/**
     * Title for the aside.
