define(["exports", "require", "../../lit-element/lit-element.js", "../intersection-element/lib/IntersectionObserverMixin.js"], function (_exports, _require, _litElement, _IntersectionObserverMixin) {
  ...
  function _templateObject3_70aeeb708b4811ebbbe2170cf981e021() {
    var data = babelHelpers.taggedTemplateLiteral([" <h3 .hidden=\"", "\" part=\"heading-3\">\n            ", "\n          </h3>\n          <div id=\"result\"></div>\n          <citation-element\n            creator=\"{Wikipedia contributors}\"\n            scope=\"sibling\"\n            license=\"by-sa\"\n            title=\"", " --- {Wikipedia}{,} The Free Encyclopedia\"\n            source=\"https://en.wikipedia.org/w/index.php?title=", "\"\n            date=\"", "\"\n          ></citation-element>"]);

    _templateObject3_70aeeb708b4811ebbbe2170cf981e021 = function _templateObject3_70aeeb708b4811ebbbe2170cf981e021() {
      return data;
    };
  ...
  function _templateObject2_70aeeb708b4811ebbbe2170cf981e021() {
    var data = babelHelpers.taggedTemplateLiteral([" ", ""]);

    _templateObject2_70aeeb708b4811ebbbe2170cf981e021 = function _templateObject2_70aeeb708b4811ebbbe2170cf981e021() {
      return data;
    };
  ...
  function _templateObject_70aeeb708b4811ebbbe2170cf981e021() {
    ...
    _templateObject_70aeeb708b4811ebbbe2170cf981e021 = function _templateObject_70aeeb708b4811ebbbe2170cf981e021() {
      return data;
    };
  ...
  var WikipediaQuery = /*#__PURE__*/function (_IntersectionObserver) {
    ...
    babelHelpers.createClass(WikipediaQuery, null, [{
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject_70aeeb708b4811ebbbe2170cf981e021())];
      }
    }]);
    ...
    babelHelpers.createClass(WikipediaQuery, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_70aeeb708b4811ebbbe2170cf981e021(), this.elementVisible ? (0, _litElement.html)(_templateObject3_70aeeb708b4811ebbbe2170cf981e021(), this.hideTitle, this._title, this.search, this.search, this.__now) : "");
      }
    }, {
      key: "updateArticle",
      value: function updateArticle(search, headers) {
        var _this2 = this;

        fetch("https://es.wikipedia.org/w/api.php?origin=*&action=query&titles=".concat(search, "&prop=extracts&format=json"), headers).then(function (response) {
      ...
      value: function updated(changedProperties) {
        ...
        changedProperties.forEach(function (oldValue, propName) {
          ...
          if (["elementVisible", "search", "headers"].includes(propName) && _this3.search && _this3.headers && _this3.elementVisible) {
            clearTimeout(_this3._debounce);
            _this3._debounce = setTimeout(function () {
              _this3.updateArticle(_this3.search, _this3.headers);
            }, 10);
          }
