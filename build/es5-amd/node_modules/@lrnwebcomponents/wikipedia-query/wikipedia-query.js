define(["exports", "require", "../../lit-element/lit-element.js", "../../@polymer/iron-ajax/iron-ajax.js"], function (_exports, _require, _litElement, _ironAjax) {
  ...
  function _templateObject3_7e007280bff611eaa5854beb4e0c914c() {
    ...
    _templateObject3_7e007280bff611eaa5854beb4e0c914c = function _templateObject3_7e007280bff611eaa5854beb4e0c914c() {
      return data;
    };
  ...
  function _templateObject2_7e007280bff611eaa5854beb4e0c914c() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      ", "\n    "]);

    _templateObject2_7e007280bff611eaa5854beb4e0c914c = function _templateObject2_7e007280bff611eaa5854beb4e0c914c() {
      return data;
    };
  ...
  function _templateObject_7e007280bff611eaa5854beb4e0c914c() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n          --wikipedia-query-body-height: 160px;\n        }\n        :host [hidden] {\n          display: none;\n        }\n        #result {\n          height: var(--wikipedia-query-body-height);\n          overflow: scroll;\n          border: 1px grey solid;\n          padding: 8px 16px;\n        }\n        citation-element {\n          background-color: #f8f8f8;\n          padding: 16px 8px;\n          font-size: 12px;\n        }\n      "]);

    _templateObject_7e007280bff611eaa5854beb4e0c914c = function _templateObject_7e007280bff611eaa5854beb4e0c914c() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(WikipediaQuery, null, [{
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject_7e007280bff611eaa5854beb4e0c914c())];
      }
    }]);
    ...
    babelHelpers.createClass(WikipediaQuery, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_7e007280bff611eaa5854beb4e0c914c(), this.search ? (0, _litElement.html)(_templateObject3_7e007280bff611eaa5854beb4e0c914c(), this.search, this.handleResponse, this.searchResponseChanged, this.hideTitle, this._title, this.search, this.search, this.__now) : "");
      }
    }, {
