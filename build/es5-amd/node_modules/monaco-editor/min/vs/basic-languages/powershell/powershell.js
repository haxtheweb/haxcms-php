 ...
 *-----------------------------------------------------------------------------*/
define("vs/basic-languages/powershell/powershell", ["require", "require"], function (require) {
  var moduleExports = function () {
    ...
    var d = function (n) {
      return function (e, s) {
        return n && n.get(e) || (s = p(c({}), e, 1), n && n.set(e, s), s);
      };
