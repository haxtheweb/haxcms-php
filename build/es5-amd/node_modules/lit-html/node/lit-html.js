    ...
    E = function E(t, i) {
      ...
      for (var _i = 0; _i < s; _i++) {
        ...
        var _e = void 0,
          ...
          _c = -1,
          _$ = 0;
        for (; _$ < _s.length && (d.lastIndex = _$, _u = d.exec(_s), null !== _u);) _$ = d.lastIndex, d === v ? "!--" === _u[1] ? d = a : void 0 !== _u[1] ? d = f : void 0 !== _u[2] ? (g.test(_u[2]) && (h = RegExp("</" + _u[2], "g")), d = _) : void 0 !== _u[3] && (d = _) : d === _ ? ">" === _u[0] ? (d = null != h ? h : v, _c = -1) : void 0 === _u[1] ? _c = -2 : (_c = d.lastIndex - _u[2].length, _e = _u[1], d = void 0 === _u[3] ? _ : '"' === _u[3] ? p : m) : d === p || d === m ? d = _ : d === a || d === f ? d = v : (d = _, h = void 0);
    ...
    babelHelpers.createClass(S, [{
      ...
      value: function _$AI(t) {
        ...
        if (void 0 === o) t = P(this, t, i, 0), n = !d(t) || t !== this._$AH && t !== T, n && (this._$AH = t);else {
          var _e2 = t;
          var _l, _h;
          for (t = o[0], _l = 0; _l < o.length - 1; _l++) _h = P(this, _e2[s + _l], i, _l), _h === T && (_h = this._$AH[_l]), n || (n = !d(_h) || _h !== this._$AH[_l]), _h === b ? t = b : t !== b && (t += (null != _h ? _h : "") + o[_l + 1]), this._$AH[_l] = _h;
        }
        n && !e && this.j(t);
      }
    }, {
