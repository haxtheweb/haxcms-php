define(["exports", "../lit-html.js", "../directive-helpers.js", "../async-directive.js", "./private-async-helpers.js", "../directive.js"], function (_exports, _litHtml, _directiveHelpers, _asyncDirective, _privateAsyncHelpers, _directive) {
  "use strict";
  ...
  var c = /*#__PURE__*/function (_i) {
    babelHelpers.inherits(c, _i);
    var _super = _createSuper(c);
    function c() {
      var _this;
      babelHelpers.classCallCheck(this, c);
      _this = _super.apply(this, arguments), _this._$C_t = h, _this._$Cwt = [], _this._$Cq = new _privateAsyncHelpers.PseudoWeakRef(babelHelpers.assertThisInitialized(_this)), _this._$CK = new _privateAsyncHelpers.Pauser();
      return _this;
    }
    babelHelpers.createClass(c, [{
      ...
      value: function update(s, i) {
        ...
        var _loop = function _loop() {
          ...
          _t < e && s === r[_t] || (_this2._$C_t = h, e = 0, Promise.resolve(s).then( /*#__PURE__*/function () {
              ...
              return _regeneratorRuntime().wrap(function _callee$(_context) {
                while (1) switch (_context.prev = _context.next) {
                  ...
                  case 5:
                    i = o.deref();
                    if (void 0 !== i) {
                      _r = i._$Cwt.indexOf(s);
                      _r > -1 && _r < i._$C_t && (i._$C_t = _r, i.setValue(t));
                    }
                  case 7:
                  case "end":
        ...
        for (var _t = 0; _t < i.length && !(_t > this._$C_t); _t++) {
          var _ret = _loop();
  ...
  _exports.UntilDirective = c;
  var m = (0, _directive.directive)(c);
  _exports.until = m;
});