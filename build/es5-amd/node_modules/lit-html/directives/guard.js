  ...
  var e = {},
    i = (0, _directive.directive)( /*#__PURE__*/function (_s) {
      ...
      function _class() {
        ...
        _this = _super.apply(this, arguments), _this.st = e;
        return _this;
      }
      babelHelpers.createClass(_class, [{
        ...
        value: function update(t, _ref) {
          ...
          var _ref2 = babelHelpers.slicedToArray(_ref, 2),
            ...
            e = _ref2[1];
          if (Array.isArray(s)) {
            if (Array.isArray(this.st) && this.st.length === s.length && s.every(function (r, t) {
              return r === _this2.st[t];
            })) return _litHtml.noChange;
          } else if (this.st === s) return _litHtml.noChange;
