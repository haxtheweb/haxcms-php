define(["exports", "../lit-html.js", "../directive.js"], function (_exports, _litHtml, _directive) {
  ...
  var e = /*#__PURE__*/function (_r) {
    ...
    function e(i) {
      ...
      if (_this = _super.call(this, i), _this.et = _litHtml.nothing, i.type !== _directive.PartType.CHILD) throw Error(_this.constructor.directiveName + "() can only be used in child bindings");
      return babelHelpers.possibleConstructorReturn(_this);
    }
    babelHelpers.createClass(e, [{
      key: "render",
      value: function render(r) {
        if (r === _litHtml.nothing || null == r) return this.ft = void 0, this.et = r;
