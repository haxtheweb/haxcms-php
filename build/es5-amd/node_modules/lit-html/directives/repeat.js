define(["exports", "../lit-html.js", "../directive.js", "../directive-helpers.js"], function (_exports, _litHtml, _directive, _directiveHelpers) {
  ...
  var u = function u(e, s, t) {
      var r = new Map();
      for (var _l = s; _l <= t; _l++) r.set(e[_l], _l);
      return r;
    },
      ...
      babelHelpers.createClass(_class, [{
        ...
        value: function update(s, _ref) {
          ...
          var a = (0, _directiveHelpers.getCommittedValue)(s),
            ...
            p = _this$dt.values,
            v = _this$dt.keys;
          if (!Array.isArray(a)) return this.ht = v, p;
          var h = null !== (d = this.ht) && void 0 !== d ? d : this.ht = [],
            m = [];
          var y,
            x,
            j = 0,
          ...
          return this.ht = v, (0, _directiveHelpers.setCommittedValue)(s, m), _litHtml.noChange;
        }
      }]);
      return _class;
