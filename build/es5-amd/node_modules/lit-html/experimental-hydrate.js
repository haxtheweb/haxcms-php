    ...
    m = function m(e) {
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          var _r = _step.value;
          for (var _e5 = 0; _e5 < _r.length; _e5++) t[_e5 % 2] = 33 * t[_e5 % 2] ^ _r.charCodeAt(_e5);
        }
      } catch (err) {
        _iterator.e(err);
      } finally {
      ...
      var r = String.fromCharCode.apply(String, babelHelpers.toConsumableArray(new Uint8Array(t.buffer)));
      return btoa(r);
    };
