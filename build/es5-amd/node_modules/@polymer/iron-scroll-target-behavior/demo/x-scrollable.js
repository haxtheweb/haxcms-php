define(["../../polymer/polymer-legacy.js", "../../polymer/lib/legacy/polymer-fn.js", "../../polymer/lib/utils/html-tag.js", "../iron-scroll-target-behavior.js"], function (_polymerLegacy, _polymerFn, _htmlTag, _ironScrollTargetBehavior) {
  ...
  var _templateObject_7c3e4980403311edb9fff3e6b08a0a9a;

  (0, _polymerFn.Polymer)({
    _template: (0, _htmlTag.html)(_templateObject_7c3e4980403311edb9fff3e6b08a0a9a || (_templateObject_7c3e4980403311edb9fff3e6b08a0a9a = babelHelpers.taggedTemplateLiteral(["\n    <style>\n      :host {\n        display: block;\n        font: 14px arial;\n      }\n\n      .scrollState {\n        border-left: 1px solid #ccc;\n        border-right: 1px solid #ccc;\n        border-bottom: 1px solid #ccc;\n        font-weight: bold;\n        background-color: #eee;\n        position: fixed;\n        top: 0;\n        left: calc(50% - 100px);\n        padding: 10px;\n        width: 220px;\n        text-align: center;\n      }\n\n      .item {\n        border-bottom: 1px solid #ccc;\n        background-color: white;\n        padding: 20px;\n        width: 200%;\n      }\n\n    </style>\n    <div class=\"scrollState\">scrollTop: [[xScrollTop]] - scrollLeft: [[xScrollLeft]]</div>\n    <template is=\"dom-repeat\" items=\"[[_getItems(itemCount)]]\">\n      <div class=\"item\">[[index]]</div>\n    </template>\n"]))),
    is: 'x-scrollable',
    properties: {
      xScrollTop: {
        type: Number,
