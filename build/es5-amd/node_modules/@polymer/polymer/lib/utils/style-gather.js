  ...
  */
  ...
  function stylesFromModule(moduleId) {
    ...
    if (m._styles === undefined) {
      ...
      styles.push.apply(styles, babelHelpers.toConsumableArray(_stylesFromModuleImports(m)));
      // include css from the first template in the module
      var template = /** @type {?HTMLTemplateElement} */
      m.querySelector('template');
      if (template) {
        styles.push.apply(styles, babelHelpers.toConsumableArray(stylesFromTemplate(template, /** @type {templateWithAssetPath} */m.assetpath)));
      }
      m._styles = styles;
    }
    return m._styles;
  ...
  function stylesFromTemplate(template, baseURI) {
    if (!template._styles) {
      ...
      for (var i = 0; i < e$.length; i++) {
        ...
        if (baseURI) {
          e.textContent = (0, _resolveUrl.resolveCss)(e.textContent, /** @type {string} */baseURI);
        }
        styles.push(e);
      }
