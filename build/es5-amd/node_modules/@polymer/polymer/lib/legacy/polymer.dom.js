  ...
  var DomApiNative = /*#__PURE__*/function () {
    ...
    babelHelpers.createClass(DomApiNative, [{
      ...
      value: function observeNodes(callback) {
        return new _flattenedNodesObserver.FlattenedNodesObserver( /** @type {!HTMLElement} */this.node, callback);
      }
      ...
      value: function getEffectiveChildNodes() {
        return _flattenedNodesObserver.FlattenedNodesObserver.getFlattenedNodes( /** @type {!HTMLElement} */this.node);
      }
