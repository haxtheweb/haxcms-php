  ...
  var ElementMixin = (0, _mixin.dedupingMixin)(function (base) {
    ...
    function getTemplateFromDomModule(is) {
      ...
      if (is && (!_settings.strictTemplatePolicy || _settings.allowTemplateFromDomModule)) {
        ...
        _domModule.DomModule.import(is, 'template');
    ...
    var PolymerElement = /*#__PURE__*/function (_polymerElementBase) {
      ...
      babelHelpers.createClass(PolymerElement, [{
        ...
        value: function _initializeProperties() {
          ...
          babelHelpers.get(babelHelpers.getPrototypeOf(PolymerElement.prototype), "_initializeProperties", this).call(this);
          // set path defaults
        ...
        get: function get() {
          if (!this.hasOwnProperty(JSCompiler_renameProperty('_importPath', this))) {
            ...
            if (meta) {
              ...
              var module = _domModule.DomModule.import( /** @type {PolymerElementConstructor} */this.is);
        ...
        */
        ...
        value: function _finalizeTemplate(is) {
          ...
          if (template && !template.__polymerFinalized) {
            ...
            var baseURI = importPath ? (0, _resolveUrl2.resolveUrl)(importPath) : '';
        ...
        value: function _addTemplatePropertyEffect(templateInfo, prop, effect) {
          ...
          if (_settings.legacyWarnings && !(prop in this._properties) &&
