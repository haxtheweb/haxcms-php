define(["../../../polymer/polymer-legacy.js", "./google-youtube.js", "../../../polymer/lib/legacy/polymer-fn.js", "../../../polymer/lib/utils/html-tag.js"], function (_polymerLegacy, _googleYoutube, _polymerFn, _htmlTag) {
  ...
  var _templateObject_2e7102806f4811ed83231ba15a006752;

  (0, _polymerFn.Polymer)({
    _template: (0, _htmlTag.html)(_templateObject_2e7102806f4811ed83231ba15a006752 || (_templateObject_2e7102806f4811ed83231ba15a006752 = babelHelpers.taggedTemplateLiteral(["\n    <style>\n      :host {\n        display: block;\n        position: relative;\n        width: 100%;\n      }\n\n      google-youtube {\n        height: 100%;\n      }\n    </style>\n\n    <google-youtube\n        id=\"player\"\n        video-id=\"{{videoId}}\"\n        state=\"{{__state}}\"\n        current-time=\"{{__currentTime}}\">\n    </google-youtube>\n  "]))),
    is: 'youtube-lite',
    properties: {
      videoId: {
        type: String,
