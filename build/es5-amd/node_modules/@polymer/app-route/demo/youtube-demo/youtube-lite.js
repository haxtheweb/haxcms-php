define(["../../../polymer/polymer-legacy.js", "./google-youtube.js", "../../../polymer/lib/legacy/polymer-fn.js", "../../../polymer/lib/utils/html-tag.js"], function (_polymerLegacy, _googleYoutube, _polymerFn, _htmlTag) {
  ...
  var _templateObject_7e7c79b0403311edb9fff3e6b08a0a9a;

  (0, _polymerFn.Polymer)({
    _template: (0, _htmlTag.html)(_templateObject_7e7c79b0403311edb9fff3e6b08a0a9a || (_templateObject_7e7c79b0403311edb9fff3e6b08a0a9a = babelHelpers.taggedTemplateLiteral(["\n    <style>\n      :host {\n        display: block;\n        position: relative;\n        width: 100%;\n      }\n\n      google-youtube {\n        height: 100%;\n      }\n    </style>\n\n    <google-youtube\n        id=\"player\"\n        video-id=\"{{videoId}}\"\n        state=\"{{__state}}\"\n        current-time=\"{{__currentTime}}\">\n    </google-youtube>\n  "]))),
    is: 'youtube-lite',
    properties: {
      videoId: {
        type: String,
