define(["../polymer/polymer-legacy.js", "../iron-location/iron-location.js", "../iron-location/iron-query-params.js", "../polymer/lib/legacy/polymer-fn.js", "../polymer/lib/utils/html-tag.js", "./app-route-converter-behavior.js"], function (_polymerLegacy, _ironLocation, _ironQueryParams, _polymerFn, _htmlTag, _appRouteConverterBehavior) {
  ...
  function _templateObject_c6db4d10d55811e9a4251fbb0db90cd4() {
    var data = babelHelpers.taggedTemplateLiteral(["\n    <iron-query-params params-string=\"{{__query}}\" params-object=\"{{queryParams}}\">\n    </iron-query-params>\n    <iron-location path=\"{{__path}}\" query=\"{{__query}}\" hash=\"{{__hash}}\" url-space-regex=\"[[urlSpaceRegex]]\" dwell-time=\"[[dwellTime]]\">\n    </iron-location>\n  "]);

    _templateObject_c6db4d10d55811e9a4251fbb0db90cd4 = function _templateObject_c6db4d10d55811e9a4251fbb0db90cd4() {
      return data;
    };
  ...
  */
  (0, _polymerFn.Polymer)({
    _template: (0, _htmlTag.html)(_templateObject_c6db4d10d55811e9a4251fbb0db90cd4()),
    is: 'app-location',
    properties: {
      /**
