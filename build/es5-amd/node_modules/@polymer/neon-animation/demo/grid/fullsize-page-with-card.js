define(["../../../polymer/polymer-legacy.js", "../../../paper-styles/color.js", "../shared-styles.js", "../../../polymer/lib/legacy/polymer-fn.js", "../../../polymer/lib/utils/html-tag.js", "../../neon-shared-element-animatable-behavior.js"], function (_polymerLegacy, _color, _sharedStyles, _polymerFn, _htmlTag, _neonSharedElementAnimatableBehavior) {
  ...
  var _templateObject_e534e540982e11ed8e74e16491559088;

  (0, _polymerFn.Polymer)({
    _template: (0, _htmlTag.html)(_templateObject_e534e540982e11ed8e74e16491559088 || (_templateObject_e534e540982e11ed8e74e16491559088 = babelHelpers.taggedTemplateLiteral(["\n    <style include=\"shared-styles\"></style>\n    <style>\n\n      :host {\n        display: block;\n      }\n\n      .fixed {\n        position: fixed;\n        top: 0;\n        left: 0;\n        height: 100vh;\n        width: 100vw;\n      }\n\n      .card {\n        position: relative;\n        margin: 15vh 15vw 0;\n        width: 70vw;\n        height: 70vh;\n      }\n\n    </style>\n\n    <div id=\"fixed\" class$=\"[[_computeFixedBackgroundClass(color)]]\"></div>\n    <div id=\"card\" class$=\"[[_computeCardClass(color)]]\"></div>\n  "]))),
