define(["../../../polymer/polymer-legacy.js", "../../../paper-styles/typography.js", "../../../iron-flex-layout/iron-flex-layout.js", "../shared-styles.js", "../../../polymer/lib/legacy/polymer-fn.js", "../../../polymer/lib/legacy/polymer.dom.js", "../../../polymer/lib/utils/html-tag.js", "../../neon-shared-element-animatable-behavior.js"], function (_polymerLegacy, _typography, _ironFlexLayout, _sharedStyles, _polymerFn, _polymerDom, _htmlTag, _neonSharedElementAnimatableBehavior) {
  ...
  var _templateObject_8d27fe60ccb811ecb1815d30884c2804;

  (0, _polymerFn.Polymer)({
    _template: (0, _htmlTag.html)(_templateObject_8d27fe60ccb811ecb1815d30884c2804 || (_templateObject_8d27fe60ccb811ecb1815d30884c2804 = babelHelpers.taggedTemplateLiteral(["\n    <style include=\"shared-styles\">\n\n      :host {\n        display: block;\n        background: #000;\n      }\n\n      .tile {\n        display: inline-block;\n        float: left;\n        vertical-align: top;\n        width: calc(100% / 6);\n        height: calc(100% / 3);\n\n        @apply --paper-font-title;\n        @apply --layout-vertical;\n        @apply --layout-center-center;\n      }\n\n      .tile:nth-of-type(1) {\n        width: calc(100% / 3);\n        height: calc(100% / 3 * 2);\n      }\n\n      .tile:nth-of-type(4) {\n        width: calc(100% / 3);\n      }\n\n      .tile:nth-of-type(5) {\n        width: calc(100% / 3);\n        height: calc(100% / 3 * 2);\n      }\n\n      .tile:nth-of-type(8) {\n        width: calc(100% / 3);\n        height: calc(100% / 3);\n      }\n\n      .tile:nth-of-type(9) {\n        position: absolute;\n        top: calc(100% / 3 * 2);\n        left: 0;\n        width: calc(100% / 6);\n        height: calc(100% / 3);\n      }\n\n      .tile:nth-of-type(10) {\n        position: absolute;\n        top: calc(100% / 3 * 2);\n        left: calc(100% / 6);;\n        width: calc(100% / 6);\n        height: calc(100% / 3);\n      }\n    </style>\n\n    <template is=\"dom-repeat\" items=\"[[config]]\">\n      <div item=\"[[item]]\" class$=\"[[_computeTileClass(item.color)]]\" on-click=\"_onClick\">\n        <span>[[item.value]]</span>\n      </div>\n    </template>\n  "]))),
    is: 'animated-grid',
