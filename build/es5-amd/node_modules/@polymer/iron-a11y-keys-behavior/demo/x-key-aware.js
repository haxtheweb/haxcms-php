define(["../../polymer/polymer-legacy.js", "../../polymer/lib/legacy/polymer-fn.js", "../../polymer/lib/utils/html-tag.js", "../iron-a11y-keys-behavior.js"], function (_polymerLegacy, _polymerFn, _htmlTag, _ironA11yKeysBehavior) {
  ...
  var _templateObject_22fc924044e911edab4a0d426b75fd72;

  (0, _polymerFn.Polymer)({
    _template: (0, _htmlTag.html)(_templateObject_22fc924044e911edab4a0d426b75fd72 || (_templateObject_22fc924044e911edab4a0d426b75fd72 = babelHelpers.taggedTemplateLiteral(["\n    <style>\n      :host {\n        display: block;\n        position: relative;\n      }\n\n      pre {\n        color: #3367d6;\n      }\n\n      .keys {\n        line-height: 25px;\n      }\n\n      .keys span {\n        cursor: default;\n        background-color: #f5f5f5;\n        border: 1px solid #e0e0e0;\n        padding: 1px 5px;\n        border-radius: 5px;\n      }\n    </style>\n\n    <h4>Press any of these keys</h4>\n    <input type=\"checkbox\" checked=\"{{preventDefault::change}}\"> prevent default = {{preventDefault}}\n    <p class=\"keys\">\n      <template is=\"dom-repeat\" items=\"[[boundKeys]]\">\n        <span>{{item}}</span>\n      </template>\n    </p>\n    <pre>[[pressed]]</pre>\n"]))),
    is: 'x-key-aware',
