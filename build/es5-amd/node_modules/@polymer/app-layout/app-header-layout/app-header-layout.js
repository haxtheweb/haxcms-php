...
*/(0,_polymerFn.Polymer)({_template:(0,_htmlTag.html)(_templateObject_e11406906b8111e98ce155804ade6153()),is:"app-header-layout",behaviors:[_appLayoutBehavior.AppLayoutBehavior],properties:{/**
     * If true, the current element will have its own scrolling region.
     * Otherwise, it will use the document scroll to control the header.
     */hasScrollingRegion:{type:Boolean,value:!1,reflectToAttribute:!0/* transition */ /* transition */}},observers:["resetLayout(isAttached, hasScrollingRegion)"],/**
