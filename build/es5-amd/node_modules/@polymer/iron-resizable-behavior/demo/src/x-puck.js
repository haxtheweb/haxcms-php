define(["../../../polymer/lib/legacy/polymer-fn.js", "../../../polymer/lib/utils/html-tag.js", "../../iron-resizable-behavior.js"], function (_polymerFn, _htmlTag, _ironResizableBehavior) {
  ...
  var _templateObject_ce3e5ca0e4f411ed85766367b4d3e9fc;
  (0, _polymerFn.Polymer)({
    _template: (0, _htmlTag.html)(_templateObject_ce3e5ca0e4f411ed85766367b4d3e9fc || (_templateObject_ce3e5ca0e4f411ed85766367b4d3e9fc = babelHelpers.taggedTemplateLiteral(["\n    <style>\n      :host {\n        display: inline-block;\n        border: 3px solid lightblue;\n      }\n    </style>\n\n    <b>I'm a resize-aware, thirdifying puck at (<span>{{x}}</span> x <span>{{y}}</span>).</b>\n  "]))),
    is: 'x-puck',
