(function () {
  ...
  */
  ...
  function l(a) {
    ...
    for (; a && !(a.__CE_isImportDocument || babelHelpers.instanceof(a, Document));) a = a.parentNode || (window.ShadowRoot && babelHelpers.instanceof(a, ShadowRoot) ? a.host : void 0);
    ...
    for (var c = a; c;) {
      if (c.nodeType === Node.ELEMENT_NODE) {
        ...
        if ("link" === f && "import" === e.getAttribute("rel")) {
          c = e.import;
          if (babelHelpers.instanceof(c, Node) && !d.has(c)) for (d.add(c), c = c.firstChild; c; c = c.nextSibling) p(c, b, d);
          c = n(a, e);
          continue;
        } else if ("template" === f) {
          c = n(a, e);
    ...
    function c(b) {
      return function (d) {
        ...
        for (var f = [], m = 0; m < e.length; m++) {
          ...
          if (babelHelpers.instanceof(q, DocumentFragment)) for (q = q.firstChild; q; q = q.nextSibling) c.push(q);else c.push(q);
        }
        b.apply(this, e);
        for (e = 0; e < f.length; e++) z(a, f[e]);
        if (l(this)) for (e = 0; e < c.length; e++) f = c[e], babelHelpers.instanceof(f, Element) && x(a, f);
      };
    }
  ...
  function Aa(a) {
    function b(b) {
      return function (e) {
        ...
        for (var k = [], h = 0; h < c.length; h++) {
          ...
          if (babelHelpers.instanceof(m, DocumentFragment)) for (m = m.firstChild; m; m = m.nextSibling) d.push(m);else d.push(m);
        }
        b.apply(this, c);
        for (c = 0; c < k.length; c++) z(a, k[c]);
        if (l(this)) for (c = 0; c < d.length; c++) k = d[c], babelHelpers.instanceof(k, Element) && x(a, k);
      };
    }
    ...
    void 0 !== ra && r(d, "replaceWith", function (b) {
      ...
      for (var d = [], k = 0; k < e.length; k++) {
        ...
        if (babelHelpers.instanceof(h, DocumentFragment)) for (h = h.firstChild; h; h = h.nextSibling) c.push(h);else c.push(h);
      }
      k = l(this);
      ra.apply(this, e);
      for (e = 0; e < d.length; e++) z(a, d[e]);
      if (k) for (z(a, this), e = 0; e < c.length; e++) d = c[e], babelHelpers.instanceof(d, Element) && x(a, d);
    });
