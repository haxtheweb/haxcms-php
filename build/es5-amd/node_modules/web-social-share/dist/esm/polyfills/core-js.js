  ...
  !function (t) {
    ...
    (t.exports = function (t, n, e, s, l) {
      ...
      if (l) p = t;else {
        ...
        if (o(h)) {
          for (v = 0, g = i(t.length); g > v; v++) if ((d = s ? m(r(x = t[v])[0], x[1]) : m(t[v])) && babelHelpers.instanceof(d, f)) return d;
          return new f(!1);
        }
        p = h.call(t);
      }
      for (y = p.next; !(x = y.call(p)).done;) if ("object" == babelHelpers.typeof(d = c(p, m, x.value, s)) && d && babelHelpers.instanceof(d, f)) return d;
      return new f(!1);
    }).stop = function (t) {
      return new f(!0, t);
    };
