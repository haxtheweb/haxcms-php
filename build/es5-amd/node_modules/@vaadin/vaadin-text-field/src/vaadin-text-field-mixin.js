      ...
      function (_ControlStateMixin) {
        ...
        babelHelpers.createClass(VaadinTextFieldMixin, [{
          ...
          value: function _onFocus() {
            ...
            if (this.autoselect) {
              this.focusElement.select(); // iOS 9 workaround: https://stackoverflow.com/a/7436574

              setTimeout(function () {
                _this5.focusElement.setSelectionRange(0, 9999);
              });
            }
          }
        }, {
          ...
          value: function _onClearButtonClick(e) {
            ...
            this.focusElement.dispatchEvent(new Event('change', {
          ...
          value: function _addIEListeners(node) {
            ...
            if (navigator.userAgent.match(/Trident/)) {
              ...
              this._prevent = function (e) {
                ...
                _this6.focusElement.removeEventListener('input', _this6._prevent);
              };

              this._shouldPreventInput = function () {
                return _this6.placeholder && node.addEventListener('input', _this6._prevent);
              };
          ...
          value: function _getActiveLabelId(label, labelId) {
            this._setOrToggleAttribute('aria-labelledby', label ? labelId : undefined, this.focusElement);
          }
        }, {
