define(["exports"], function (_exports) {
  ...
  function P(t) {
    for (var e = new Array(t.length), n = 0; n < t.length; n++) "object" == babelHelpers.typeof(t[n]) && (e[n] = new RegExp("^(?:" + t[n].pattern + ")$"));
    return function (n, r) {
      ...
      next: function next(a) {
        ...
        if (i && h) for (; c < h.length;) {
          if (!s) {
            ...
            _o > 0 && "/" === e.charAt(_o) && (_o += 1), s = I(_r3, e.substr(_o), n, i.keys, i.params);
          }
          var _r4 = s.next(a);
          if (!_r4.done) return {
            done: !1,
            ...
            if (n && !n.i) {
              ...
              if (t.chain) {
                if (n.parent) {
                  ...
                  for (; _e5-- && t.chain[_e5].route && t.chain[_e5].route !== n.parent;) t.chain.pop();
                }
              } else t.chain = [];
              t.chain.push(_e4);
            }
  ...
  function q(t) {
    ...
    return function (r, o) {
      ...
      if (!s) {
        ...
        for (; _e6;) {
          var _n2 = W(_e6);
          _n2 && (_t3 = _n2.replace(/\/$/, "") + "/" + _t3.replace(/^\//, "")), _e6 = _e6.parent;
        }
        var _n3 = F.parse(_t3),
          _r5 = F.tokensToFunction(_n3),
          _o3 = Object.create(null);
        for (var _t4 = 0; _t4 < _n3.length; _t4++) _l(_n3[_t4]) || (_o3[_n3[_t4].name] = !0);
        s = {
          toPath: _r5,
          keys: _o3
      ...
      if (e.stringifyQueryParams && o) {
        ...
        for (var _e7 = 0; _e7 < _n4.length; _e7++) {
          var _r6 = _n4[_e7];
          s.keys[_r6] || (_t5[_r6] = o[_r6]);
        }
        var _r7 = e.stringifyQueryParams(_t5);
        _r7 && (c += "?" === _r7.charAt(0) ? _r7 : "?".concat(_r7));
      }
      return c;
    };
  }
  ...
  function nt(t) {
    if (t && t.length) {
      ...
      for (var _n5 = 0; _n5 < t.length; _n5++) _e8.removeChild(t[_n5]);
    }
  }
  function rt(t, e) {
    var n = e.h;
    ...
    babelHelpers.createClass(it, [{
      ...
      value: function l(n) {
        ...
        f(r.children) && (i = i.then(function () {
          ...
          X(n) || f(r.children) || (n = r.children), function (n, r) {
            ...
            r.o = [];
            var o = t(n);
            for (var _t6 = 0; _t6 < o.length; _t6++) s(o[_t6]), r.o.push(o[_t6]);
          }(n, r);
        }));
        var c = {
      ...
      value: function W(t) {
        ...
        if (t.q = 0, t.T = !1, n.length) {
          ...
          if (t.T = r.length === n.length && t.q == r.length && this.J(t.result, e.result), t.T) {
            for (var _e10 = r.length - 1; _e10 >= 0; _e10--) o = this.K(o, t, {
              prevent: i
            }, n[_e10]);
            for (var _e11 = 0; _e11 < r.length; _e11++) o = this.V(o, t, {
              prevent: i,
              redirect: s
            }, r[_e11]), n[_e11].element.location = Y(t, n[_e11].route);
          } else for (var _e12 = n.length - 1; _e12 >= t.q; _e12--) o = this.K(o, t, {
            prevent: i
          }, n[_e12]);
        }
        if (!t.T) for (var _e13 = 0; _e13 < r.length; _e13++) _e13 < t.q ? _e13 < n.length && n[_e13].element && (n[_e13].element.location = Y(t, n[_e13].route)) : (o = this.V(o, t, {
          prevent: i,
          redirect: s
      ...
      value: function S(t) {
        var e = (this.Y || [])[0],
          ...
          o = t.chain;
        var i;
        for (var _t7 = o.length; _t7 > 0; _t7--) if (o[_t7 - 1].route.animate) {
