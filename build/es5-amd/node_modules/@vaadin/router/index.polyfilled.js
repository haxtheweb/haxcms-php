define(["exports","./index.js"],function(_exports,_index){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0/* transition */ /* transition */});Object.defineProperty(_exports,"Router",{enumerable:!0,get:function get(){return _index.Router}});Object.defineProperty(_exports,"Resolver",{enumerable:!0,get:function get(){return _index.Resolver}});var isUrlAvailable,urlDocument,urlBase,urlAnchor;_index.Resolver.__ensureUrlAvailableOrPolyfilled=function(){if(isUrlAvailable===void 0){try{var url=new URL("b","http://a");url.pathname="c";isUrlAvailable="http://a/c"===url.href}catch(e){isUrlAvailable=!1}if(!isUrlAvailable){// The URL constructor is not available in IE11. Polyfill it by creating
...
Object.defineProperty(urlAnchor,"pathname",{get:function get(){return urlAnchor.href.slice(urlAnchor.origin.length)}})}}}};_index.Resolver.__createUrl=function(path,base){_index.Resolver.__ensureUrlAvailableOrPolyfilled();if(isUrlAvailable){return new URL(path,base)}urlBase.href=base;urlAnchor.href=path.replace(/ /g,"%20");// IE11: only absolute href setting results in correct part properties
