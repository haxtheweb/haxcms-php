define(["exports"],function(_exports){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0/* transition */ /* transition */});_exports.ControlStateMixin=void 0;/**
@license
...
properties.tabIndex=properties.tabindex}return properties}}]);return VaadinTabIndexMixin}(superClass))},ControlStateMixin=function ControlStateMixin(superClass){return(/*#__PURE__*/function(_TabIndexMixin){babelHelpers.inherits(VaadinControlStateMixin,_TabIndexMixin);function VaadinControlStateMixin(){babelHelpers.classCallCheck(this,VaadinControlStateMixin);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(VaadinControlStateMixin).apply(this,arguments))}babelHelpers.createClass(VaadinControlStateMixin,[{key:"ready",value:function ready(){var _this=this;this.addEventListener("focusin",function(e){if(e.composedPath()[0]===_this){_this._focus(e)}else if(-1!==e.composedPath().indexOf(_this.focusElement)&&!_this.disabled){_this._setFocused(!0)}});this.addEventListener("focusout",function(e){return _this._setFocused(!1)});// In super.ready() other 'focusin' and 'focusout' listeners might be
