define(["exports", "./vaadin-grid-column.js", "./vaadin-grid-tree-toggle.js", "../../../@polymer/polymer/lib/utils/html-tag.js"], function (_exports, _vaadinGridColumn, _vaadinGridTreeToggle, _htmlTag) {
  ...
  var _templateObject_23998290e46b11edbf2e2349c355f24c;
  ...
  var GridTreeColumnElement = /*#__PURE__*/function (_GridColumnElement) {
    ...
    babelHelpers.createClass(GridTreeColumnElement, [{
      ...
      key: "template",
      get: function get() {
        return (0, _htmlTag.html)(_templateObject_23998290e46b11edbf2e2349c355f24c || (_templateObject_23998290e46b11edbf2e2349c355f24c = babelHelpers.taggedTemplateLiteral(["\n    <template id=\"template\">\n      <vaadin-grid-tree-toggle leaf=\"[[__isLeafItem(item, itemHasChildrenPath)]]\" expanded=\"{{expanded}}\" level=\"[[level]]\">\n        [[__getToggleContent(path, item)]]\n      </vaadin-grid-tree-toggle>\n    </template>\n"])));
      }
    }, {
      key: "is",
      get: function get() {
