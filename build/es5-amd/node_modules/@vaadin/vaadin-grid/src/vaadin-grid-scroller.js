define(["exports", "../../../@polymer/polymer/lib/utils/render-status.js", "../../../@polymer/polymer/lib/utils/async.js", "../../../@polymer/polymer/lib/utils/flush.js", "./iron-list.js", "../../../@polymer/polymer/lib/utils/debounce.js"], function (_exports, _renderStatus, _async, _flush, _ironList, _debounce) {
  ...
  var GridScrollerElement = /*#__PURE__*/function (_PolymerIronList) {
    ...
    babelHelpers.createClass(GridScrollerElement, [{
        ...
        if (!this._initialPoolCreated) {
          ...
          this._debounceIncreasePool = _debounce.Debouncer.debounce(this._debounceIncreasePool, _async.animationFrame, function () {
            ...
            if (_this4._physicalSize && estimatedMissingRowCount > 0 && _this4._optPhysicalSize !== Infinity) {
              babelHelpers.get(babelHelpers.getPrototypeOf(GridScrollerElement.prototype), "_increasePoolIfNeeded", _this4).call(_this4, estimatedMissingRowCount);
      ...
      value: function _createFocusBackfillItem() {} /* Ignore */

      /** @private */
    }, {
      key: "_multiSelectionChanged",
      value: function _multiSelectionChanged() {} /* Ignore */
      ...
      key: "_itemsChanged",
      value: function _itemsChanged() {} /* Ignore */

      /** @private */
    }, {
      key: "_manageFocus",
      value: function _manageFocus() {} /* Ignore */

      /** @private */
    }, {
      key: "_removeFocusedItem",
      value: function _removeFocusedItem() {} /* Ignore */
      ...
      value: function __isCreatingRows() {
        ...
        var schedulingDebounceIncreasePool = this._debouncers && this._debouncers._increasePoolIfNeeded && this._debouncers._increasePoolIfNeeded.isActive();
        // vaadin-grid-scroller's overridden _increasePoolIfNeeded may have scheduled a _debounceIncreasePool debouncer
        var debouncingIncreasePoolActive = this._debounceIncreasePool && this._debounceIncreasePool.isActive();
