define(["exports", "./vaadin-grid-column.js", "./vaadin-grid-sorter.js", "../../../@polymer/polymer/lib/utils/html-tag.js"], function (_exports, _vaadinGridColumn, _vaadinGridSorter, _htmlTag) {
  ...
  var _templateObject_95ae4850d3e211ed8e5073e3aa96f674;
  ...
  var GridSortColumnElement = /*#__PURE__*/function (_GridColumnElement) {
    ...
    babelHelpers.createClass(GridSortColumnElement, [{
      ...
      function _prepareHeaderTemplate() {
        var headerTemplate = this._prepareTemplatizer(this.$.headerTemplate);
      ...
      key: "template",
      get: function get() {
        return (0, _htmlTag.html)(_templateObject_95ae4850d3e211ed8e5073e3aa96f674 || (_templateObject_95ae4850d3e211ed8e5073e3aa96f674 = babelHelpers.taggedTemplateLiteral(["\n    <template class=\"header\" id=\"headerTemplate\">\n      <vaadin-grid-sorter path=\"[[path]]\" direction=\"{{direction}}\">[[_getHeader(header, path)]]</vaadin-grid-sorter>\n    </template>\n"])));
      }
    }, {
      key: "is",
      get: function get() {
