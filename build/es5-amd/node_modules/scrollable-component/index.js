  ...
  var ScrollableComponentElement = /*#__PURE__*/function (_HTMLElement) {
    ...
    babelHelpers.createClass(ScrollableComponentElement, [{
      ...
      value: function X(r, o) {
        var l = this.T[r.key];
        if (l.q) {
          var _t4 = ((o.touches ? o.touches[0][r.v] : o[r.v]) - l.R.v) / this.cache[r.key].P * l.L,
            a = l.R.t + _t4;
          this.viewport[r.t] = a;
        }
      }
      ...
      value: function k() {
        ...
        for (var _i4 = 0, _t5 = t; _i4 < _t5.length; _i4++) {
          var _o2 = _t5[_i4];
      ...
      key: "m",
      value: function m() {
        for (var _i5 = 0, _t6 = t; _i5 < _t6.length; _i5++) {
          var _r3 = _t6[_i5];
          ...
          if (this.shadowRoot.host.style.setProperty("--viewport-".concat(_r3.size), "".concat(_l2.M, "px")), this.content.classList.toggle("restrict-".concat(_r3.size), _l2.F), _o3.C.classList.toggle("hidden", !_l2.A), _l2.A) {
            var _t7 = _l2.M * _l2.P;
            _o3.T.style[_r3.size] = "".concat(_t7, "px");
          }
        }
      }
    }, {
      key: "S",
      value: function S() {
        for (var _i6 = 0, _t8 = t; _i6 < _t8.length; _i6++) {
          var _r4 = _t8[_i6];
          var _l3 = this.cache[_r4.key];
          if (_l3.A) {
            var _t9 = this.viewport[_r4.t] * _l3.P;
            this.elements[_r4.key].T.style.transform = _r4.key === o ? "translate3D(0, ".concat(_t9, "px, 0)") : "translate3D(".concat(_t9, "px, 0, 0)");
          }
        }
      }
    }], [{
