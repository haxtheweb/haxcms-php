define(["exports", "../@a11y/focus-trap/index.js", "./util.js"], function (_exports, _index, _util) {
  ...
  var WebDialog = /*#__PURE__*/function (_HTMLElement) {
    ...
    function WebDialog() {
      ...
      _this.onKeyDown = _this.onKeyDown.bind(babelHelpers.assertThisInitialized(_this));
      // Set aria attributes
    ...
    babelHelpers.createClass(WebDialog, [{
      ...
      value: function didOpen() {
        ...
        this.$previousActiveElement = (0, _util.traverseActiveElements)(document.activeElement);
        ...
        (0, _util.setDialogCount)(this.$scrollContainer, (0, _util.getDialogCount)(this.$scrollContainer) + 1);
      ...
      value: function didClose() {
        ...
        (0, _util.setDialogCount)(this.$scrollContainer, Math.max(0, (0, _util.getDialogCount)(this.$scrollContainer) - 1));
