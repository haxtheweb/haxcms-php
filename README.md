...
[![OpenSSF Scorecard](https://api.securityscorecards.dev/projects/github.com/haxtheweb/haxcms-php/badge)](https://securityscorecards.dev/viewer/?uri=github.com/haxtheweb/haxcms-php)
...
# Requirements (PHP)
- Supports PHP 8.3+
- Requires `curl`, `zip`, `gd`, and `xml` modules be installed
- Apache 2.4
